...
{ 
  ...
  incr2[7] = 2.8125*fr[7]-5.083290641897235*fr[8]; 
  incr2[8] = 19.6875*fr[8]-10.89276566120836*fr[7]; 
  ...
  incr2[7] = 5.083290641897235*fl[8]+2.8125*fl[7]; 
  incr2[8] = 19.6875*fl[8]+10.89276566120836*fl[7]; 
...
{ 
  ...
  incr2[6] = 2.8125*fr[6]-5.083290641897235*fr[8]; 
  incr2[7] = 19.6875*fr[7]-10.89276566120836*fr[3]; 
  incr2[8] = 19.6875*fr[8]-10.89276566120836*fr[6]; 
  ...
  incr2[6] = 5.083290641897235*fl[8]+2.8125*fl[6]; 
  incr2[7] = 19.6875*fl[7]+10.89276566120836*fl[3]; 
  incr2[8] = 19.6875*fl[8]+10.89276566120836*fl[6]; 
...
{ 
  ...
  incr2[7] = 19.06233990711463*fr[8]-4.921875*fr[7]; 
  incr2[8] = 19.06233990711463*fr[7]-73.828125*fr[8]; 
  ...
  incr2[7] = (-19.06233990711463*fl[8])-4.921875*fl[7]; 
  incr2[8] = (-73.828125*fl[8])-19.06233990711463*fl[7]; 
...
{ 
  ...
  incr2[6] = 19.06233990711463*fr[8]-4.921875*fr[6]; 
  incr2[7] = 19.06233990711463*fr[3]-73.828125*fr[7]; 
  incr2[8] = 19.06233990711463*fr[6]-73.828125*fr[8]; 
  ...
  incr2[6] = (-19.06233990711463*fl[8])-4.921875*fl[6]; 
  incr2[7] = (-73.828125*fl[7])-19.06233990711463*fl[3]; 
  incr2[8] = (-73.828125*fl[8])-19.06233990711463*fl[6]; 
