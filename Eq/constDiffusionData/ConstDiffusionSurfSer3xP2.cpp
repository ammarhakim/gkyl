...
{ 
  ...
  outl[8] += -1.0*incr1[8]*rdxFnul; 
  outl[9] += -1.0*incr1[9]*rdxFnul; 
  outl[10] += incr2[10]*rdxFnul+incr1[10]*rdxFnul; 
  outl[11] += incr3[11]*rdxFnul-1.0*incr2[11]*rdxFnul-1.0*incr1[11]*rdxFnul; 
  outl[12] += incr2[12]*rdxFnul+incr1[12]*rdxFnul; 
  outl[13] += incr3[13]*rdxFnul-1.0*incr2[13]*rdxFnul-1.0*incr1[13]*rdxFnul; 
  outl[14] += -1.0*incr1[14]*rdxFnul; 
  outl[15] += incr2[15]*rdxFnul+incr1[15]*rdxFnul; 
  outl[16] += -1.0*incr1[16]*rdxFnul; 
  outl[17] += incr3[17]*rdxFnul-1.0*incr2[17]*rdxFnul-1.0*incr1[17]*rdxFnul; 
  outl[18] += incr2[18]*rdxFnul+incr1[18]*rdxFnul; 
  outl[19] += incr2[19]*rdxFnul+incr1[19]*rdxFnul; 
...
{ 
  ...
  incr2[11] = 2.4609375*fr[11]-2.4609375*fl[11]; 
  ...
  incr2[16] = 2.4609375*fr[16]-2.4609375*fl[16]; 
  incr2[17] = 2.4609375*fr[17]-2.4609375*fl[17]; 
  ...
  outl[9] += -1.0*incr1[9]*rdxFnul; 
  outl[10] += incr2[10]*rdxFnul+incr1[10]*rdxFnul; 
  outl[11] += incr2[11]*rdxFnul+incr1[11]*rdxFnul; 
  outl[12] += incr3[12]*rdxFnul-1.0*incr2[12]*rdxFnul-1.0*incr1[12]*rdxFnul; 
  outl[13] += -1.0*incr1[13]*rdxFnul; 
  outl[14] += incr3[14]*rdxFnul-1.0*incr2[14]*rdxFnul-1.0*incr1[14]*rdxFnul; 
  outl[15] += -1.0*incr1[15]*rdxFnul; 
  outl[16] += incr2[16]*rdxFnul+incr1[16]*rdxFnul; 
  outl[17] += incr2[17]*rdxFnul+incr1[17]*rdxFnul; 
  outl[18] += incr3[18]*rdxFnul-1.0*incr2[18]*rdxFnul-1.0*incr1[18]*rdxFnul; 
  outl[19] += incr2[19]*rdxFnul+incr1[19]*rdxFnul; 
...
{ 
  ...
  incr2[13] = 2.4609375*fr[13]-2.4609375*fl[13]; 
  incr2[14] = 2.4609375*fr[14]-2.4609375*fl[14]; 
  ...
  outl[11] += -1.0*incr1[11]*rdxFnul; 
  outl[12] += -1.0*incr1[12]*rdxFnul; 
  outl[13] += incr2[13]*rdxFnul+incr1[13]*rdxFnul; 
  outl[14] += incr2[14]*rdxFnul+incr1[14]*rdxFnul; 
  outl[15] += incr3[15]*rdxFnul-1.0*incr2[15]*rdxFnul-1.0*incr1[15]*rdxFnul; 
  outl[16] += incr3[16]*rdxFnul-1.0*incr2[16]*rdxFnul-1.0*incr1[16]*rdxFnul; 
  outl[17] += incr2[17]*rdxFnul+incr1[17]*rdxFnul; 
  outl[18] += incr2[18]*rdxFnul+incr1[18]*rdxFnul; 
  outl[19] += incr3[19]*rdxFnul-1.0*incr2[19]*rdxFnul-1.0*incr1[19]*rdxFnul; 
