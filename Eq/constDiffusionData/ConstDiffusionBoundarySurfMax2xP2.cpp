...
{ 
  ...
  incr1[4] = 10.5*fr[4]-10.5*fl[4]-10.16658128379447*fr[1]-10.16658128379447*fl[1]+4.192627457812107*fr[0]-4.192627457812107*fl[0]; 
...
{ 
  ...
  incr1[5] = 10.5*fr[5]-10.5*fl[5]-10.16658128379447*fr[2]-10.16658128379447*fl[2]+4.192627457812107*fr[0]-4.192627457812107*fl[0]; 
...
{ 
  ...
  incr1[4] = (-33.75*fr[4])+33.75*fl[4]+21.78553132241671*fr[1]+21.78553132241671*fl[1]-12.57788237343632*fr[0]+12.57788237343632*fl[0]; 
  incr1[5] = 19.6875*fl[5]-19.6875*fr[5]; 

  incr2[1] = 9.531169953557313*fr[4]+9.531169953557313*fl[4]-2.4609375*fr[1]+2.4609375*fl[1]; 
  incr2[3] = 2.4609375*fl[3]-2.4609375*fr[3]; 
...
{ 
  ...
  incr1[5] = (-33.75*fr[5])+33.75*fl[5]+21.78553132241671*fr[2]+21.78553132241671*fl[2]-12.57788237343632*fr[0]+12.57788237343632*fl[0]; 
