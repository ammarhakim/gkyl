...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. 
  ...
  incr[0] = 0.5*(alpha[1]*fhatAL[1]+alpha[0]*fhatAL[0])*dfac1; 
  incr[1] = -0.8660254037844386*(alpha[1]*fhatAL[1]+alpha[0]*fhatAL[0])*dfac1; 
  incr[2] = 0.5*(alpha[0]*fhatAL[1]+fhatAL[0]*alpha[1])*dfac1; 
  incr[3] = -0.8660254037844386*(alpha[0]*fhatAL[1]+fhatAL[0]*alpha[1])*dfac1; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. 
  ...
  incr[0] = 0.5*(alpha[1]*fhatAL[1]+alpha[0]*fhatAL[0])*dfac2; 
  incr[1] = 0.5*(alpha[0]*fhatAL[1]+fhatAL[0]*alpha[1])*dfac2; 
  incr[2] = -0.8660254037844386*(alpha[1]*fhatAL[1]+alpha[0]*fhatAL[0])*dfac2; 
  incr[3] = -0.8660254037844386*(alpha[0]*fhatAL[1]+fhatAL[0]*alpha[1])*dfac2; 
