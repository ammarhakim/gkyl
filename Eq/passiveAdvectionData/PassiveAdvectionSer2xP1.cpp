...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing.
  ...
  alphaL = 0.25*(1.5*v1[3]-0.8660254037844386*(v1[2]+v1[1])+0.5*v1[0])*dfac1; 
  cflRate += -0.5*(alphaL-std::abs(alphaL)); 
  positivityWeightByDir[1] += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.25*((-1.5*v1[3])+0.8660254037844386*v1[2]-0.8660254037844386*v1[1]+0.5*v1[0])*dfac1; 
  cflRate += -0.5*(alphaL-std::abs(alphaL)); 
  positivityWeightByDir[1] += -0.5*(alphaL-std::abs(alphaL)); 
  // evaluate alpha at right surface quadrature points 
  alphaR = 0.25*((-1.5*v1[3])-0.8660254037844386*v1[2]+0.8660254037844386*v1[1]+0.5*v1[0])*dfac1; 
  cflRate += 0.5*(alphaR+std::abs(alphaR)); 
  positivityWeightByDir[1] += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.25*(1.5*v1[3]+0.8660254037844386*(v1[2]+v1[1])+0.5*v1[0])*dfac1; 
  cflRate += 0.5*(alphaR+std::abs(alphaR)); 
  positivityWeightByDir[1] += 0.5*(alphaR+std::abs(alphaR)); 
#endif 
...
#elif cflType == QUAD 
  // evaluate alpha at left surface quadrature points 
  alphaL = 0.25*(1.5*v2[3]-0.8660254037844386*(v2[2]+v2[1])+0.5*v2[0])*dfac2; 
  cflRate += -0.5*(alphaL-std::abs(alphaL)); 
  positivityWeightByDir[2] += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.25*((-1.5*v2[3])-0.8660254037844386*v2[2]+0.8660254037844386*v2[1]+0.5*v2[0])*dfac2; 
  cflRate += -0.5*(alphaL-std::abs(alphaL)); 
  positivityWeightByDir[2] += -0.5*(alphaL-std::abs(alphaL)); 
  // evaluate alpha at right surface quadrature points 
  alphaR = 0.25*((-1.5*v2[3])+0.8660254037844386*v2[2]-0.8660254037844386*v2[1]+0.5*v2[0])*dfac2; 
  cflRate += 0.5*(alphaR+std::abs(alphaR)); 
  positivityWeightByDir[2] += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.25*(1.5*v2[3]+0.8660254037844386*(v2[2]+v2[1])+0.5*v2[0])*dfac2; 
  cflRate += 0.5*(alphaR+std::abs(alphaR)); 
  positivityWeightByDir[2] += 0.5*(alphaR+std::abs(alphaR)); 
#endif 
