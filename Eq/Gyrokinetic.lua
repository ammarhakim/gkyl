...
function Gyrokinetic:surfTerm(dir, cfl, wl, wr, dxl, dxr, maxs, idxl, idxr, fl, fr, outl, outr)
   ...
   if self._isElectromagnetic then
     ...
     res = self._surfTerms[dir](self.charge, self.mass, cfl, wr:data(), dxr:data(), maxs, self.bmagPtr:data(), self.bmagInvPtr:data(), self.gradparPtr:data(), self.geoXPtr:data(), self.geoYPtr:data(), self.geoZPtr:data(), self.phiPtr:data(), self.aparPtr:data(), self.dApardtPtr:data(), fl:data(), fr:data(), outl:data(), outr:data())
   else 
     res = self._surfTerms[dir](self.charge, self.mass, cfl, wr:data(), dxr:data(), maxs, self.bmagPtr:data(), self.bmagInvPtr:data(), self.gradparPtr:data(), self.geoXPtr:data(), self.geoYPtr:data(), self.geoZPtr:data(), self.phiPtr:data(), fl:data(), fr:data(), outl:data(), outr:data())
   end
...
function GyrokineticStep2:surfTerm(dir, cfl, wl, wr, dxl, dxr, maxs, idxl, idxr, fl, fr, outl, outr)
   ...
   local res = self._surfTerms[dir](self.charge, self.mass, cfl, wr:data(), dxr:data(), maxs, self.bmagPtr:data(), self.bmagInvPtr:data(), self.gradparPtr:data(), self.geoXPtr:data(), self.geoYPtr:data(), self.geoZPtr:data(), self.phiPtr:data(), self.aparPtr:data(), self.dApardtPtr:data(), fl:data(), fr:data(), outl:data(), outr:data())
