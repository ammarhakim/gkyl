...
double PenalizedEmGyrokineticGenGeoVol1x2vSerP1_Bvars(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *penaltyPi, const double *phi, const double *Apar, const double* dApardt, const double *f, double *out) 
{ 
  ...
  hamil[3] = (0.2357022603955158*bmag[0]*(3.0*penaltyPi[3]*rdmu2*wmu+1.732050807568877*penaltyPi[0]))/rdmu2; 
  hamil[5] = (0.2357022603955158*bmag[0]*(3.0*penaltyPi[5]*rdmu2*wmu+1.732050807568877*penaltyPi[1]))/rdmu2; 
...
#elif cflType == QUAD 
  // Evaluate alpha at left surface quadrature points.
  alphaL = 0.125*(0.3535533905932737*alphavpar[0]-0.3535533905932737*alphavpar[3]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.125*(0.3535533905932737*alphavpar[0]-0.3535533905932737*alphavpar[3]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.04419417382415921*(alphavpar[3]+alphavpar[0]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.04419417382415921*(alphavpar[3]+alphavpar[0]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  // Evaluate alpha at right surface quadrature points.
  alphaR = 0.125*(0.3535533905932737*alphavpar[0]-0.3535533905932737*alphavpar[3]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.125*(0.3535533905932737*alphavpar[0]-0.3535533905932737*alphavpar[3]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.04419417382415921*(alphavpar[3]+alphavpar[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.04419417382415921*(alphavpar[3]+alphavpar[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
#endif 
  ...
  out[2] += 0.6123724356957944*(alphavpar[3]*f[3]+alphavpar[0]*f[0]); 
  out[4] += 0.6123724356957944*(alphavpar[3]*f[5]+alphax[0]*f[2]+alphavpar[0]*f[1]); 
  out[5] += 0.6123724356957944*alphax[0]*f[3]; 
  out[6] += 0.6123724356957944*(alphavpar[0]*f[3]+f[0]*alphavpar[3]); 
  out[7] += 0.6123724356957944*(alphax[0]*f[6]+alphavpar[0]*f[5]+f[1]*alphavpar[3]); 
  return cflFreq; 
} 
double PenalizedEmGyrokineticGenGeoVol1x2vSerP1_Bvarsx(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *penaltyPi, const double *phi, const double *Apar, const double* dApardt, const double *f, double *out) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  ...
  double hamil[8]; 
  hamil[0] = (0.2357022603955158*(rdvpar2Sq*(3.0*rdmu2*(2.0*m_*wvparSq+(bmag[1]*penaltyPi[1]+bmag[0]*penaltyPi[0])*wmu+2.828427124746191*phi[0]*q_)+1.732050807568877*(bmag[1]*penaltyPi[5]+bmag[0]*penaltyPi[3]))+2.0*m_*rdmu2))/(rdmu2*rdvpar2Sq); 
  hamil[1] = (0.408248290463863*(1.732050807568877*rdmu2*((bmag[0]*penaltyPi[1]+penaltyPi[0]*bmag[1])*wmu+2.828427124746191*phi[1]*q_)+bmag[0]*penaltyPi[5]+bmag[1]*penaltyPi[3]))/rdmu2; 
  hamil[2] = (1.632993161855453*m_*wvpar)/rdvpar2; 
  hamil[3] = (0.2357022603955158*(3.0*(bmag[1]*penaltyPi[5]+bmag[0]*penaltyPi[3])*rdmu2*wmu+1.732050807568877*(bmag[1]*penaltyPi[1]+bmag[0]*penaltyPi[0])))/rdmu2; 
  hamil[5] = (0.2357022603955158*(3.0*(bmag[0]*penaltyPi[5]+bmag[1]*penaltyPi[3])*rdmu2*wmu+1.732050807568877*(bmag[0]*penaltyPi[1]+penaltyPi[0]*bmag[1])))/rdmu2; 
...
double PenalizedEmGyrokineticGenGeoVol1x2vSerP1_Bvarsz(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *penaltyPi, const double *phi, const double *Apar, const double* dApardt, const double *f, double *out) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
...
double PenalizedEmGyrokineticGenGeoStep2Vol1x2vSerP1(const double q_, const double m_, const double *w, const double *dxv, const double *dApardt, const double *f, double *out) 
{ 
  // q_,m_: species charge and mass.
  // w[NDIM]: cell-center.
  // dxv[NDIM]: cell length.
