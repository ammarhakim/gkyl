...
{ 
  ...
  double alphaR[4]; 
  alphaR[0] = (0.2165063509461096*(BstarZdBmagR[0]+BstarZdBmagL[0])*hamilNoMuBR[2]*rdvpar2R)/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgR = (0.03125*(1.732050807568877*BstarZdBmagR[0]+1.732050807568877*BstarZdBmagL[0])*hamilNoMuBR[2]*rdvpar2R)/m_; 
...
{ 
  ...
  double alphaUpRNoMuB[4]; 
  alphaUpRNoMuB[0] = -(0.25*(1.732050807568877*BstarZdBmagR[0]*hamilNoMuBR[1]*rdx2R+5.656854249492382*dApardtPrev[0]*q_))/m_; 
  alphaUpRNoMuB[1] = -(1.414213562373095*dApardtPrev[1]*q_)/m_; 

  double alphaRMuB[4]; 

  double alphaUpRMuB[4]; 

  double alphaR[4]; 
  alphaR[0] = alphaRNoMuB[0]; 

  double alphaUpR[4]; 
  alphaUpR[0] = alphaUpRNoMuB[0]; 
  alphaUpR[1] = alphaUpRNoMuB[1]; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgR = -(0.0625*(1.732050807568877*BstarZdBmagR[0]*hamilNoMuBR[1]*rdx2R+5.656854249492382*dApardtPrev[0]*q_))/m_; 
...
{ 
  ...
  double alphaRNoMuB[4]; 
  alphaRNoMuB[0] = -(1.414213562373095*dApardt[0]*q_)/m_; 
  alphaRNoMuB[1] = -(1.414213562373095*dApardt[1]*q_)/m_; 
  ...
  double alphaR[4]; 
  alphaR[0] = alphaRMuB[0]; 
  alphaR[1] = alphaRMuB[1]; 
...
{ 
  ...
  alphaR[1] = -(0.125*hamilNoMuBR[2]*(3.0*(BstarZdBmagR[4]+BstarZdBmagL[4])-1.732050807568877*(BstarZdBmagR[2]+BstarZdBmagL[2]))*rdvpar2R)/m_; 
...
{ 
  ...
  double alphaUpRNoMuB[4]; 
  alphaUpRNoMuB[0] = (0.25*(hamilNoMuBR[1]*(3.0*BstarZdBmagR[2]-1.732050807568877*BstarZdBmagR[0])*rdx2R-5.656854249492382*dApardtPrev[0]*q_))/m_; 
  alphaUpRNoMuB[1] = (0.25*(hamilNoMuBR[1]*(3.0*BstarZdBmagR[4]-1.732050807568877*BstarZdBmagR[1])*rdx2R-5.656854249492382*dApardtPrev[1]*q_))/m_; 

  double alphaRMuB[4]; 
  alphaRMuB[0] = (0.0625*(hamilMuBR[5]*((4.242640687119286*BstarZdBmagR[4]-2.449489742783178*BstarZdBmagR[1])*penaltyChi[5]+(4.242640687119286*BstarZdBmagR[2]-2.449489742783178*BstarZdBmagR[0])*penaltyChi[3])+hamilMuBR[1]*(4.242640687119286*(penaltyChi[1]*BstarZdBmagR[4]+penaltyChi[0]*BstarZdBmagR[2])-2.449489742783178*(BstarZdBmagR[1]*penaltyChi[1]+BstarZdBmagR[0]*penaltyChi[0])))*rdx2R)/m_; 
  alphaRMuB[1] = (0.0625*(hamilMuBR[5]*((4.242640687119286*BstarZdBmagR[2]-2.449489742783178*BstarZdBmagR[0])*penaltyChi[5]+penaltyChi[3]*(4.242640687119286*BstarZdBmagR[4]-2.449489742783178*BstarZdBmagR[1]))+hamilMuBR[1]*(4.242640687119286*(penaltyChi[0]*BstarZdBmagR[4]+penaltyChi[1]*BstarZdBmagR[2])-2.449489742783178*(BstarZdBmagR[0]*penaltyChi[1]+penaltyChi[0]*BstarZdBmagR[1])))*rdx2R)/m_; 
  alphaRMuB[2] = (0.0625*(hamilMuBR[1]*(4.242640687119286*BstarZdBmagR[4]-2.449489742783178*BstarZdBmagR[1])*penaltyChi[5]+(4.242640687119286*(penaltyChi[1]*BstarZdBmagR[4]+penaltyChi[0]*BstarZdBmagR[2])-2.449489742783178*(BstarZdBmagR[1]*penaltyChi[1]+BstarZdBmagR[0]*penaltyChi[0]))*hamilMuBR[5]+hamilMuBR[1]*(4.242640687119286*BstarZdBmagR[2]-2.449489742783178*BstarZdBmagR[0])*penaltyChi[3])*rdx2R)/m_; 
  alphaRMuB[3] = (0.0625*(hamilMuBR[1]*(4.242640687119286*BstarZdBmagR[2]-2.449489742783178*BstarZdBmagR[0])*penaltyChi[5]+(4.242640687119286*(penaltyChi[0]*BstarZdBmagR[4]+penaltyChi[1]*BstarZdBmagR[2])-2.449489742783178*(BstarZdBmagR[0]*penaltyChi[1]+penaltyChi[0]*BstarZdBmagR[1]))*hamilMuBR[5]+hamilMuBR[1]*penaltyChi[3]*(4.242640687119286*BstarZdBmagR[4]-2.449489742783178*BstarZdBmagR[1]))*rdx2R)/m_; 

  double alphaUpRMuB[4]; 
  alphaUpRMuB[0] = (0.0625*(hamilMuBR[5]*((4.242640687119286*BstarZdBmagR[4]-2.449489742783178*BstarZdBmagR[1])*penaltyChi[5]+(4.242640687119286*BstarZdBmagR[2]-2.449489742783178*BstarZdBmagR[0])*penaltyChi[3])+hamilMuBR[1]*(4.242640687119286*(penaltyChi[1]*BstarZdBmagR[4]+penaltyChi[0]*BstarZdBmagR[2])-2.449489742783178*(BstarZdBmagR[1]*penaltyChi[1]+BstarZdBmagR[0]*penaltyChi[0])))*rdx2R)/m_; 
  alphaUpRMuB[1] = (0.0625*(hamilMuBR[5]*((4.242640687119286*BstarZdBmagR[2]-2.449489742783178*BstarZdBmagR[0])*penaltyChi[5]+penaltyChi[3]*(4.242640687119286*BstarZdBmagR[4]-2.449489742783178*BstarZdBmagR[1]))+hamilMuBR[1]*(4.242640687119286*(penaltyChi[0]*BstarZdBmagR[4]+penaltyChi[1]*BstarZdBmagR[2])-2.449489742783178*(BstarZdBmagR[0]*penaltyChi[1]+penaltyChi[0]*BstarZdBmagR[1])))*rdx2R)/m_; 
  alphaUpRMuB[2] = (0.0625*(hamilMuBR[1]*(4.242640687119286*BstarZdBmagR[4]-2.449489742783178*BstarZdBmagR[1])*penaltyChi[5]+(4.242640687119286*(penaltyChi[1]*BstarZdBmagR[4]+penaltyChi[0]*BstarZdBmagR[2])-2.449489742783178*(BstarZdBmagR[1]*penaltyChi[1]+BstarZdBmagR[0]*penaltyChi[0]))*hamilMuBR[5]+hamilMuBR[1]*(4.242640687119286*BstarZdBmagR[2]-2.449489742783178*BstarZdBmagR[0])*penaltyChi[3])*rdx2R)/m_; 
  alphaUpRMuB[3] = (0.0625*(hamilMuBR[1]*(4.242640687119286*BstarZdBmagR[2]-2.449489742783178*BstarZdBmagR[0])*penaltyChi[5]+(4.242640687119286*(penaltyChi[0]*BstarZdBmagR[4]+penaltyChi[1]*BstarZdBmagR[2])-2.449489742783178*(BstarZdBmagR[0]*penaltyChi[1]+penaltyChi[0]*BstarZdBmagR[1]))*hamilMuBR[5]+hamilMuBR[1]*penaltyChi[3]*(4.242640687119286*BstarZdBmagR[4]-2.449489742783178*BstarZdBmagR[1]))*rdx2R)/m_; 
...
{ 
  ...
  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgR = (0.015625*((4.242640687119286*BstarZdBmagR[4]-2.449489742783178*BstarZdBmagR[1])*hamilMuBR[5]*penaltyChi[5]+(4.242640687119286*BstarZdBmagR[2]-2.449489742783178*BstarZdBmagR[0])*penaltyChi[3]*hamilMuBR[5]+4.242640687119286*hamilMuBR[1]*penaltyChi[1]*BstarZdBmagR[4]+4.242640687119286*penaltyChi[0]*hamilMuBR[1]*BstarZdBmagR[2]-2.449489742783178*BstarZdBmagR[1]*hamilMuBR[1]*penaltyChi[1]-2.449489742783178*BstarZdBmagR[0]*penaltyChi[0]*hamilMuBR[1])*rdx2R)/m_; 
