...
void MaxwellVol3xSerP0(const MaxwellEq_t * const meq, const double *w, const double *dx, const double *q, double *out) 
{ 
...
void MaxwellVol3xSerP1(const MaxwellEq_t * const meq, const double *w, const double *dx, const double *q, double *out) 
{ 
  const double c2 = meq->c*meq->c, chi = meq->chi, gamma = meq->gamma; 
  const double c2chi = c2*chi, c2gamma = c2*gamma; 
...
void MaxwellVol3xSerP2(const MaxwellEq_t * const meq, const double *w, const double *dx, const double *q, double *out) 
{ 
  const double c2 = meq->c*meq->c, chi = meq->chi, gamma = meq->gamma; 
  const double c2chi = c2*chi, c2gamma = c2*gamma; 
  ...
  outBx[17] += 3.872983346207417*ps[10]*dx0*gamma-1.732050807568877*ey[11]*dx2+1.732050807568877*ez[13]*dx1; 
  outBx[18] += 1.732050807568877*ps[14]*dx0*gamma-1.732050807568877*ey[12]*dx2+3.872983346207417*ez[10]*dx1; 
  outBx[19] += 1.732050807568877*ps[16]*dx0*gamma-3.872983346207417*ey[10]*dx2+1.732050807568877*ez[15]*dx1; 
  ...
  outBy[17] += 1.732050807568877*ps[13]*dx1*gamma+1.732050807568877*ex[11]*dx2-3.872983346207417*ez[10]*dx0; 
  outBy[18] += 3.872983346207417*ps[10]*dx1*gamma+1.732050807568877*ex[12]*dx2-1.732050807568877*ez[14]*dx0; 
  outBy[19] += 1.732050807568877*ps[15]*dx1*gamma+3.872983346207417*ex[10]*dx2-1.732050807568877*ez[16]*dx0; 
  ...
  outBz[17] += 1.732050807568877*ps[11]*dx2*gamma-1.732050807568877*ex[13]*dx1+3.872983346207417*ey[10]*dx0; 
  outBz[18] += 1.732050807568877*ps[12]*dx2*gamma-3.872983346207417*ex[10]*dx1+1.732050807568877*ey[14]*dx0; 
  outBz[19] += 3.872983346207417*ps[10]*dx2*gamma-1.732050807568877*ex[15]*dx1+1.732050807568877*ey[16]*dx0; 
  ...
  outPh[17] += 1.732050807568877*ez[11]*chi*dx2+1.732050807568877*ey[13]*chi*dx1+3.872983346207417*ex[10]*chi*dx0; 
  outPh[18] += 1.732050807568877*ez[12]*chi*dx2+3.872983346207417*ey[10]*chi*dx1+1.732050807568877*ex[14]*chi*dx0; 
  outPh[19] += 3.872983346207417*ez[10]*chi*dx2+1.732050807568877*ey[15]*chi*dx1+1.732050807568877*ex[16]*chi*dx0; 
  ...
  outPs[17] += 1.732050807568877*bz[11]*c2gamma*dx2+1.732050807568877*by[13]*c2gamma*dx1+3.872983346207417*bx[10]*c2gamma*dx0; 
  outPs[18] += 1.732050807568877*bz[12]*c2gamma*dx2+3.872983346207417*by[10]*c2gamma*dx1+1.732050807568877*bx[14]*c2gamma*dx0; 
  outPs[19] += 3.872983346207417*bz[10]*c2gamma*dx2+1.732050807568877*by[15]*c2gamma*dx1+1.732050807568877*bx[16]*c2gamma*dx0; 
