...
{ 
  ...
  incr[5] = ((-0.4330127018922194*phr[7])+0.4330127018922194*phl[7]+0.25*(phr[5]+phl[5]))*c2chi; 
  incr[6] = (1.25*(phr[6]+phl[6])-0.9682458365518543*phr[3]+0.9682458365518543*phl[3]+0.5590169943749476*(phr[2]+phl[2]))*c2chi; 
  incr[7] = (0.75*phr[7]-0.75*phl[7]-0.4330127018922194*(phr[5]+phl[5]))*c2chi; 
  ...
  incr[5] = ((-0.4330127018922194*bzr[7])+0.4330127018922194*bzl[7]+0.25*(bzr[5]+bzl[5]))*c2; 
  incr[6] = (1.25*(bzr[6]+bzl[6])-0.9682458365518543*bzr[3]+0.9682458365518543*bzl[3]+0.5590169943749476*(bzr[2]+bzl[2]))*c2; 
  incr[7] = (0.75*bzr[7]-0.75*bzl[7]-0.4330127018922194*(bzr[5]+bzl[5]))*c2; 
  ...
  incr[5] = (0.4330127018922194*byr[7]-0.4330127018922194*byl[7]-0.25*(byr[5]+byl[5]))*c2; 
  incr[6] = ((-1.25*(byr[6]+byl[6]))+0.9682458365518543*byr[3]-0.9682458365518543*byl[3]-0.5590169943749476*(byr[2]+byl[2]))*c2; 
  incr[7] = ((-0.75*byr[7])+0.75*byl[7]+0.4330127018922194*(byr[5]+byl[5]))*c2; 
  ...
  incr[5] = ((-0.4330127018922194*psr[7])+0.4330127018922194*psl[7]+0.25*(psr[5]+psl[5]))*gamma; 
  incr[6] = (1.25*(psr[6]+psl[6])-0.9682458365518543*psr[3]+0.9682458365518543*psl[3]+0.5590169943749476*(psr[2]+psl[2]))*gamma; 
  incr[7] = (0.75*psr[7]-0.75*psl[7]-0.4330127018922194*(psr[5]+psl[5]))*gamma; 
  ...
  incr[5] = 0.4330127018922194*ezr[7]-0.4330127018922194*ezl[7]-0.25*(ezr[5]+ezl[5]); 
  incr[6] = (-1.25*(ezr[6]+ezl[6]))+0.9682458365518543*ezr[3]-0.9682458365518543*ezl[3]-0.5590169943749476*(ezr[2]+ezl[2]); 
  incr[7] = (-0.75*ezr[7])+0.75*ezl[7]+0.4330127018922194*(ezr[5]+ezl[5]); 
  ...
  incr[5] = (-0.4330127018922194*eyr[7])+0.4330127018922194*eyl[7]+0.25*(eyr[5]+eyl[5]); 
  incr[6] = 1.25*(eyr[6]+eyl[6])-0.9682458365518543*eyr[3]+0.9682458365518543*eyl[3]+0.5590169943749476*(eyr[2]+eyl[2]); 
  incr[7] = 0.75*eyr[7]-0.75*eyl[7]-0.4330127018922194*(eyr[5]+eyl[5]); 
  ...
  incr[5] = ((-0.4330127018922194*exr[7])+0.4330127018922194*exl[7]+0.25*(exr[5]+exl[5]))*chi; 
  incr[6] = (1.25*(exr[6]+exl[6])-0.9682458365518543*exr[3]+0.9682458365518543*exl[3]+0.5590169943749476*(exr[2]+exl[2]))*chi; 
  incr[7] = (0.75*exr[7]-0.75*exl[7]-0.4330127018922194*(exr[5]+exl[5]))*chi; 
  ...
  incr[5] = ((-0.4330127018922194*bxr[7])+0.4330127018922194*bxl[7]+0.25*(bxr[5]+bxl[5]))*c2gamma; 
  incr[6] = (1.25*(bxr[6]+bxl[6])-0.9682458365518543*bxr[3]+0.9682458365518543*bxl[3]+0.5590169943749476*(bxr[2]+bxl[2]))*c2gamma; 
  incr[7] = (0.75*bxr[7]-0.75*bxl[7]-0.4330127018922194*(bxr[5]+bxl[5]))*c2gamma; 
...
{ 
  ...
  incr[2] = ((-0.6614378277661477*phr[10])+0.6614378277661477*phl[10]+0.5590169943749476*(phr[6]+phl[6])-0.4330127018922193*phr[3]+0.4330127018922193*phl[3]+0.25*(phr[2]+phl[2]))*c2chi; 
  incr[3] = (1.14564392373896*phr[10]-1.14564392373896*phl[10]-0.9682458365518543*(phr[6]+phl[6])+0.75*phr[3]-0.75*phl[3]-0.4330127018922193*(phr[2]+phl[2]))*c2chi; 
  ...
  incr[5] = ((-0.4330127018922194*phr[7])+0.4330127018922194*phl[7]+0.25*(phr[5]+phl[5]))*c2chi; 
  incr[6] = ((-1.479019945774904*phr[10])+1.479019945774904*phl[10]+1.25*(phr[6]+phl[6])-0.9682458365518543*phr[3]+0.9682458365518543*phl[3]+0.5590169943749476*(phr[2]+phl[2]))*c2chi; 
  incr[7] = (0.75*phr[7]-0.75*phl[7]-0.4330127018922194*(phr[5]+phl[5]))*c2chi; 
  ...
  incr[9] = ((-0.4330127018922193*phr[11])+0.4330127018922193*phl[11]+0.25*(phr[9]+phl[9]))*c2chi; 
  incr[10] = (1.75*phr[10]-1.75*phl[10]-1.479019945774904*(phr[6]+phl[6])+1.14564392373896*phr[3]-1.14564392373896*phl[3]-0.6614378277661477*(phr[2]+phl[2]))*c2chi; 
  incr[11] = (0.75*phr[11]-0.75*phl[11]-0.4330127018922193*(phr[9]+phl[9]))*c2chi; 
  ...
  incr[2] = ((-0.6614378277661477*bzr[10])+0.6614378277661477*bzl[10]+0.5590169943749476*(bzr[6]+bzl[6])-0.4330127018922193*bzr[3]+0.4330127018922193*bzl[3]+0.25*(bzr[2]+bzl[2]))*c2; 
  incr[3] = (1.14564392373896*bzr[10]-1.14564392373896*bzl[10]-0.9682458365518543*(bzr[6]+bzl[6])+0.75*bzr[3]-0.75*bzl[3]-0.4330127018922193*(bzr[2]+bzl[2]))*c2; 
  ...
  incr[5] = ((-0.4330127018922194*bzr[7])+0.4330127018922194*bzl[7]+0.25*(bzr[5]+bzl[5]))*c2; 
  incr[6] = ((-1.479019945774904*bzr[10])+1.479019945774904*bzl[10]+1.25*(bzr[6]+bzl[6])-0.9682458365518543*bzr[3]+0.9682458365518543*bzl[3]+0.5590169943749476*(bzr[2]+bzl[2]))*c2; 
  incr[7] = (0.75*bzr[7]-0.75*bzl[7]-0.4330127018922194*(bzr[5]+bzl[5]))*c2; 
  ...
  incr[9] = ((-0.4330127018922193*bzr[11])+0.4330127018922193*bzl[11]+0.25*(bzr[9]+bzl[9]))*c2; 
  incr[10] = (1.75*bzr[10]-1.75*bzl[10]-1.479019945774904*(bzr[6]+bzl[6])+1.14564392373896*bzr[3]-1.14564392373896*bzl[3]-0.6614378277661477*(bzr[2]+bzl[2]))*c2; 
  incr[11] = (0.75*bzr[11]-0.75*bzl[11]-0.4330127018922193*(bzr[9]+bzl[9]))*c2; 
  ...
  incr[2] = (0.6614378277661477*byr[10]-0.6614378277661477*byl[10]-0.5590169943749476*(byr[6]+byl[6])+0.4330127018922193*byr[3]-0.4330127018922193*byl[3]-0.25*(byr[2]+byl[2]))*c2; 
  incr[3] = ((-1.14564392373896*byr[10])+1.14564392373896*byl[10]+0.9682458365518543*(byr[6]+byl[6])-0.75*byr[3]+0.75*byl[3]+0.4330127018922193*(byr[2]+byl[2]))*c2; 
  ...
  incr[5] = (0.4330127018922194*byr[7]-0.4330127018922194*byl[7]-0.25*(byr[5]+byl[5]))*c2; 
  incr[6] = (1.479019945774904*byr[10]-1.479019945774904*byl[10]-1.25*(byr[6]+byl[6])+0.9682458365518543*byr[3]-0.9682458365518543*byl[3]-0.5590169943749476*(byr[2]+byl[2]))*c2; 
  incr[7] = ((-0.75*byr[7])+0.75*byl[7]+0.4330127018922194*(byr[5]+byl[5]))*c2; 
  ...
  incr[9] = (0.4330127018922193*byr[11]-0.4330127018922193*byl[11]-0.25*(byr[9]+byl[9]))*c2; 
  incr[10] = ((-1.75*byr[10])+1.75*byl[10]+1.479019945774904*(byr[6]+byl[6])-1.14564392373896*byr[3]+1.14564392373896*byl[3]+0.6614378277661477*(byr[2]+byl[2]))*c2; 
  incr[11] = ((-0.75*byr[11])+0.75*byl[11]+0.4330127018922193*(byr[9]+byl[9]))*c2; 
  ...
  incr[2] = ((-0.6614378277661477*psr[10])+0.6614378277661477*psl[10]+0.5590169943749476*(psr[6]+psl[6])-0.4330127018922193*psr[3]+0.4330127018922193*psl[3]+0.25*(psr[2]+psl[2]))*gamma; 
  incr[3] = (1.14564392373896*psr[10]-1.14564392373896*psl[10]-0.9682458365518543*(psr[6]+psl[6])+0.75*psr[3]-0.75*psl[3]-0.4330127018922193*(psr[2]+psl[2]))*gamma; 
  ...
  incr[5] = ((-0.4330127018922194*psr[7])+0.4330127018922194*psl[7]+0.25*(psr[5]+psl[5]))*gamma; 
  incr[6] = ((-1.479019945774904*psr[10])+1.479019945774904*psl[10]+1.25*(psr[6]+psl[6])-0.9682458365518543*psr[3]+0.9682458365518543*psl[3]+0.5590169943749476*(psr[2]+psl[2]))*gamma; 
  incr[7] = (0.75*psr[7]-0.75*psl[7]-0.4330127018922194*(psr[5]+psl[5]))*gamma; 
  ...
  incr[9] = ((-0.4330127018922193*psr[11])+0.4330127018922193*psl[11]+0.25*(psr[9]+psl[9]))*gamma; 
  incr[10] = (1.75*psr[10]-1.75*psl[10]-1.479019945774904*(psr[6]+psl[6])+1.14564392373896*psr[3]-1.14564392373896*psl[3]-0.6614378277661477*(psr[2]+psl[2]))*gamma; 
  incr[11] = (0.75*psr[11]-0.75*psl[11]-0.4330127018922193*(psr[9]+psl[9]))*gamma; 
  ...
  incr[2] = 0.6614378277661477*ezr[10]-0.6614378277661477*ezl[10]-0.5590169943749476*(ezr[6]+ezl[6])+0.4330127018922193*ezr[3]-0.4330127018922193*ezl[3]-0.25*(ezr[2]+ezl[2]); 
  incr[3] = (-1.14564392373896*ezr[10])+1.14564392373896*ezl[10]+0.9682458365518543*(ezr[6]+ezl[6])-0.75*ezr[3]+0.75*ezl[3]+0.4330127018922193*(ezr[2]+ezl[2]); 
  ...
  incr[5] = 0.4330127018922194*ezr[7]-0.4330127018922194*ezl[7]-0.25*(ezr[5]+ezl[5]); 
  incr[6] = 1.479019945774904*ezr[10]-1.479019945774904*ezl[10]-1.25*(ezr[6]+ezl[6])+0.9682458365518543*ezr[3]-0.9682458365518543*ezl[3]-0.5590169943749476*(ezr[2]+ezl[2]); 
  incr[7] = (-0.75*ezr[7])+0.75*ezl[7]+0.4330127018922194*(ezr[5]+ezl[5]); 
  ...
  incr[9] = 0.4330127018922193*ezr[11]-0.4330127018922193*ezl[11]-0.25*(ezr[9]+ezl[9]); 
  incr[10] = (-1.75*ezr[10])+1.75*ezl[10]+1.479019945774904*(ezr[6]+ezl[6])-1.14564392373896*ezr[3]+1.14564392373896*ezl[3]+0.6614378277661477*(ezr[2]+ezl[2]); 
  incr[11] = (-0.75*ezr[11])+0.75*ezl[11]+0.4330127018922193*(ezr[9]+ezl[9]); 
  ...
  incr[2] = (-0.6614378277661477*eyr[10])+0.6614378277661477*eyl[10]+0.5590169943749476*(eyr[6]+eyl[6])-0.4330127018922193*eyr[3]+0.4330127018922193*eyl[3]+0.25*(eyr[2]+eyl[2]); 
  incr[3] = 1.14564392373896*eyr[10]-1.14564392373896*eyl[10]-0.9682458365518543*(eyr[6]+eyl[6])+0.75*eyr[3]-0.75*eyl[3]-0.4330127018922193*(eyr[2]+eyl[2]); 
  ...
  incr[5] = (-0.4330127018922194*eyr[7])+0.4330127018922194*eyl[7]+0.25*(eyr[5]+eyl[5]); 
  incr[6] = (-1.479019945774904*eyr[10])+1.479019945774904*eyl[10]+1.25*(eyr[6]+eyl[6])-0.9682458365518543*eyr[3]+0.9682458365518543*eyl[3]+0.5590169943749476*(eyr[2]+eyl[2]); 
  incr[7] = 0.75*eyr[7]-0.75*eyl[7]-0.4330127018922194*(eyr[5]+eyl[5]); 
  ...
  incr[9] = (-0.4330127018922193*eyr[11])+0.4330127018922193*eyl[11]+0.25*(eyr[9]+eyl[9]); 
  incr[10] = 1.75*eyr[10]-1.75*eyl[10]-1.479019945774904*(eyr[6]+eyl[6])+1.14564392373896*eyr[3]-1.14564392373896*eyl[3]-0.6614378277661477*(eyr[2]+eyl[2]); 
  incr[11] = 0.75*eyr[11]-0.75*eyl[11]-0.4330127018922193*(eyr[9]+eyl[9]); 
  ...
  incr[2] = ((-0.6614378277661477*exr[10])+0.6614378277661477*exl[10]+0.5590169943749476*(exr[6]+exl[6])-0.4330127018922193*exr[3]+0.4330127018922193*exl[3]+0.25*(exr[2]+exl[2]))*chi; 
  incr[3] = (1.14564392373896*exr[10]-1.14564392373896*exl[10]-0.9682458365518543*(exr[6]+exl[6])+0.75*exr[3]-0.75*exl[3]-0.4330127018922193*(exr[2]+exl[2]))*chi; 
  ...
  incr[5] = ((-0.4330127018922194*exr[7])+0.4330127018922194*exl[7]+0.25*(exr[5]+exl[5]))*chi; 
  incr[6] = ((-1.479019945774904*exr[10])+1.479019945774904*exl[10]+1.25*(exr[6]+exl[6])-0.9682458365518543*exr[3]+0.9682458365518543*exl[3]+0.5590169943749476*(exr[2]+exl[2]))*chi; 
  incr[7] = (0.75*exr[7]-0.75*exl[7]-0.4330127018922194*(exr[5]+exl[5]))*chi; 
  ...
  incr[9] = ((-0.4330127018922193*exr[11])+0.4330127018922193*exl[11]+0.25*(exr[9]+exl[9]))*chi; 
  incr[10] = (1.75*exr[10]-1.75*exl[10]-1.479019945774904*(exr[6]+exl[6])+1.14564392373896*exr[3]-1.14564392373896*exl[3]-0.6614378277661477*(exr[2]+exl[2]))*chi; 
  incr[11] = (0.75*exr[11]-0.75*exl[11]-0.4330127018922193*(exr[9]+exl[9]))*chi; 
  ...
  incr[2] = ((-0.6614378277661477*bxr[10])+0.6614378277661477*bxl[10]+0.5590169943749476*(bxr[6]+bxl[6])-0.4330127018922193*bxr[3]+0.4330127018922193*bxl[3]+0.25*(bxr[2]+bxl[2]))*c2gamma; 
  incr[3] = (1.14564392373896*bxr[10]-1.14564392373896*bxl[10]-0.9682458365518543*(bxr[6]+bxl[6])+0.75*bxr[3]-0.75*bxl[3]-0.4330127018922193*(bxr[2]+bxl[2]))*c2gamma; 
  ...
  incr[5] = ((-0.4330127018922194*bxr[7])+0.4330127018922194*bxl[7]+0.25*(bxr[5]+bxl[5]))*c2gamma; 
  incr[6] = ((-1.479019945774904*bxr[10])+1.479019945774904*bxl[10]+1.25*(bxr[6]+bxl[6])-0.9682458365518543*bxr[3]+0.9682458365518543*bxl[3]+0.5590169943749476*(bxr[2]+bxl[2]))*c2gamma; 
  incr[7] = (0.75*bxr[7]-0.75*bxl[7]-0.4330127018922194*(bxr[5]+bxl[5]))*c2gamma; 
  ...
  incr[9] = ((-0.4330127018922193*bxr[11])+0.4330127018922193*bxl[11]+0.25*(bxr[9]+bxl[9]))*c2gamma; 
  incr[10] = (1.75*bxr[10]-1.75*bxl[10]-1.479019945774904*(bxr[6]+bxl[6])+1.14564392373896*bxr[3]-1.14564392373896*bxl[3]-0.6614378277661477*(bxr[2]+bxl[2]))*c2gamma; 
  incr[11] = (0.75*bxr[11]-0.75*bxl[11]-0.4330127018922193*(bxr[9]+bxl[9]))*c2gamma; 
...
{ 
  ...
  incr[4] = (0.4330127018922194*bzr[6]-0.4330127018922194*bzl[6]-0.25*(bzr[4]+bzl[4]))*c2; 
  incr[5] = ((-1.25*(bzr[5]+bzl[5]))+0.9682458365518543*bzr[2]-0.9682458365518543*bzl[2]-0.5590169943749475*(bzr[0]+bzl[0]))*c2; 
  incr[6] = ((-0.75*bzr[6])+0.75*bzl[6]+0.4330127018922194*(bzr[4]+bzl[4]))*c2; 
  ...
  incr[4] = ((-0.4330127018922194*phr[6])+0.4330127018922194*phl[6]+0.25*(phr[4]+phl[4]))*c2chi; 
  incr[5] = (1.25*(phr[5]+phl[5])-0.9682458365518543*phr[2]+0.9682458365518543*phl[2]+0.5590169943749475*(phr[0]+phl[0]))*c2chi; 
  incr[6] = (0.75*phr[6]-0.75*phl[6]-0.4330127018922194*(phr[4]+phl[4]))*c2chi; 
  ...
  incr[4] = ((-0.4330127018922194*bxr[6])+0.4330127018922194*bxl[6]+0.25*(bxr[4]+bxl[4]))*c2; 
  incr[5] = (1.25*(bxr[5]+bxl[5])-0.9682458365518543*bxr[2]+0.9682458365518543*bxl[2]+0.5590169943749475*(bxr[0]+bxl[0]))*c2; 
  incr[6] = (0.75*bxr[6]-0.75*bxl[6]-0.4330127018922194*(bxr[4]+bxl[4]))*c2; 
  ...
  incr[4] = (-0.4330127018922194*ezr[6])+0.4330127018922194*ezl[6]+0.25*(ezr[4]+ezl[4]); 
  incr[5] = 1.25*(ezr[5]+ezl[5])-0.9682458365518543*ezr[2]+0.9682458365518543*ezl[2]+0.5590169943749475*(ezr[0]+ezl[0]); 
  incr[6] = 0.75*ezr[6]-0.75*ezl[6]-0.4330127018922194*(ezr[4]+ezl[4]); 
  ...
  incr[4] = ((-0.4330127018922194*psr[6])+0.4330127018922194*psl[6]+0.25*(psr[4]+psl[4]))*gamma; 
  incr[5] = (1.25*(psr[5]+psl[5])-0.9682458365518543*psr[2]+0.9682458365518543*psl[2]+0.5590169943749475*(psr[0]+psl[0]))*gamma; 
  incr[6] = (0.75*psr[6]-0.75*psl[6]-0.4330127018922194*(psr[4]+psl[4]))*gamma; 
  ...
  incr[4] = 0.4330127018922194*exr[6]-0.4330127018922194*exl[6]-0.25*(exr[4]+exl[4]); 
  incr[5] = (-1.25*(exr[5]+exl[5]))+0.9682458365518543*exr[2]-0.9682458365518543*exl[2]-0.5590169943749475*(exr[0]+exl[0]); 
  incr[6] = (-0.75*exr[6])+0.75*exl[6]+0.4330127018922194*(exr[4]+exl[4]); 
  ...
  incr[4] = ((-0.4330127018922194*eyr[6])+0.4330127018922194*eyl[6]+0.25*(eyr[4]+eyl[4]))*chi; 
  incr[5] = (1.25*(eyr[5]+eyl[5])-0.9682458365518543*eyr[2]+0.9682458365518543*eyl[2]+0.5590169943749475*(eyr[0]+eyl[0]))*chi; 
  incr[6] = (0.75*eyr[6]-0.75*eyl[6]-0.4330127018922194*(eyr[4]+eyl[4]))*chi; 
  ...
  incr[4] = ((-0.4330127018922194*byr[6])+0.4330127018922194*byl[6]+0.25*(byr[4]+byl[4]))*c2gamma; 
  incr[5] = (1.25*(byr[5]+byl[5])-0.9682458365518543*byr[2]+0.9682458365518543*byl[2]+0.5590169943749475*(byr[0]+byl[0]))*c2gamma; 
  incr[6] = (0.75*byr[6]-0.75*byl[6]-0.4330127018922194*(byr[4]+byl[4]))*c2gamma; 
...
{ 
  ...
  incr[1] = (0.6614378277661477*bzr[11]-0.6614378277661477*bzl[11]-0.5590169943749476*(bzr[7]+bzl[7])+0.4330127018922193*bzr[3]-0.4330127018922193*bzl[3]-0.25*(bzr[1]+bzl[1]))*c2; 
  ...
  incr[3] = ((-1.14564392373896*bzr[11])+1.14564392373896*bzl[11]+0.9682458365518543*(bzr[7]+bzl[7])-0.75*bzr[3]+0.75*bzl[3]+0.4330127018922193*(bzr[1]+bzl[1]))*c2; 
  incr[4] = (0.4330127018922194*bzr[6]-0.4330127018922194*bzl[6]-0.25*(bzr[4]+bzl[4]))*c2; 
  ...
  incr[6] = ((-0.75*bzr[6])+0.75*bzl[6]+0.4330127018922194*(bzr[4]+bzl[4]))*c2; 
  incr[7] = (1.479019945774904*bzr[11]-1.479019945774904*bzl[11]-1.25*(bzr[7]+bzl[7])+0.9682458365518543*bzr[3]-0.9682458365518543*bzl[3]-0.5590169943749476*(bzr[1]+bzl[1]))*c2; 
  incr[8] = (0.4330127018922193*bzr[10]-0.4330127018922193*bzl[10]-0.25*(bzr[8]+bzl[8]))*c2; 
  ...
  incr[10] = ((-0.75*bzr[10])+0.75*bzl[10]+0.4330127018922193*(bzr[8]+bzl[8]))*c2; 
  incr[11] = ((-1.75*bzr[11])+1.75*bzl[11]+1.479019945774904*(bzr[7]+bzl[7])-1.14564392373896*bzr[3]+1.14564392373896*bzl[3]+0.6614378277661477*(bzr[1]+bzl[1]))*c2; 
  ...
  incr[1] = ((-0.6614378277661477*phr[11])+0.6614378277661477*phl[11]+0.5590169943749476*(phr[7]+phl[7])-0.4330127018922193*phr[3]+0.4330127018922193*phl[3]+0.25*(phr[1]+phl[1]))*c2chi; 
  ...
  incr[3] = (1.14564392373896*phr[11]-1.14564392373896*phl[11]-0.9682458365518543*(phr[7]+phl[7])+0.75*phr[3]-0.75*phl[3]-0.4330127018922193*(phr[1]+phl[1]))*c2chi; 
  incr[4] = ((-0.4330127018922194*phr[6])+0.4330127018922194*phl[6]+0.25*(phr[4]+phl[4]))*c2chi; 
  ...
  incr[6] = (0.75*phr[6]-0.75*phl[6]-0.4330127018922194*(phr[4]+phl[4]))*c2chi; 
  incr[7] = ((-1.479019945774904*phr[11])+1.479019945774904*phl[11]+1.25*(phr[7]+phl[7])-0.9682458365518543*phr[3]+0.9682458365518543*phl[3]+0.5590169943749476*(phr[1]+phl[1]))*c2chi; 
  incr[8] = ((-0.4330127018922193*phr[10])+0.4330127018922193*phl[10]+0.25*(phr[8]+phl[8]))*c2chi; 
  ...
  incr[10] = (0.75*phr[10]-0.75*phl[10]-0.4330127018922193*(phr[8]+phl[8]))*c2chi; 
  incr[11] = (1.75*phr[11]-1.75*phl[11]-1.479019945774904*(phr[7]+phl[7])+1.14564392373896*phr[3]-1.14564392373896*phl[3]-0.6614378277661477*(phr[1]+phl[1]))*c2chi; 
  ...
  incr[1] = ((-0.6614378277661477*bxr[11])+0.6614378277661477*bxl[11]+0.5590169943749476*(bxr[7]+bxl[7])-0.4330127018922193*bxr[3]+0.4330127018922193*bxl[3]+0.25*(bxr[1]+bxl[1]))*c2; 
  ...
  incr[3] = (1.14564392373896*bxr[11]-1.14564392373896*bxl[11]-0.9682458365518543*(bxr[7]+bxl[7])+0.75*bxr[3]-0.75*bxl[3]-0.4330127018922193*(bxr[1]+bxl[1]))*c2; 
  incr[4] = ((-0.4330127018922194*bxr[6])+0.4330127018922194*bxl[6]+0.25*(bxr[4]+bxl[4]))*c2; 
  ...
  incr[6] = (0.75*bxr[6]-0.75*bxl[6]-0.4330127018922194*(bxr[4]+bxl[4]))*c2; 
  incr[7] = ((-1.479019945774904*bxr[11])+1.479019945774904*bxl[11]+1.25*(bxr[7]+bxl[7])-0.9682458365518543*bxr[3]+0.9682458365518543*bxl[3]+0.5590169943749476*(bxr[1]+bxl[1]))*c2; 
  incr[8] = ((-0.4330127018922193*bxr[10])+0.4330127018922193*bxl[10]+0.25*(bxr[8]+bxl[8]))*c2; 
  ...
  incr[10] = (0.75*bxr[10]-0.75*bxl[10]-0.4330127018922193*(bxr[8]+bxl[8]))*c2; 
  incr[11] = (1.75*bxr[11]-1.75*bxl[11]-1.479019945774904*(bxr[7]+bxl[7])+1.14564392373896*bxr[3]-1.14564392373896*bxl[3]-0.6614378277661477*(bxr[1]+bxl[1]))*c2; 
  ...
  incr[1] = (-0.6614378277661477*ezr[11])+0.6614378277661477*ezl[11]+0.5590169943749476*(ezr[7]+ezl[7])-0.4330127018922193*ezr[3]+0.4330127018922193*ezl[3]+0.25*(ezr[1]+ezl[1]); 
  ...
  incr[3] = 1.14564392373896*ezr[11]-1.14564392373896*ezl[11]-0.9682458365518543*(ezr[7]+ezl[7])+0.75*ezr[3]-0.75*ezl[3]-0.4330127018922193*(ezr[1]+ezl[1]); 
  incr[4] = (-0.4330127018922194*ezr[6])+0.4330127018922194*ezl[6]+0.25*(ezr[4]+ezl[4]); 
  ...
  incr[6] = 0.75*ezr[6]-0.75*ezl[6]-0.4330127018922194*(ezr[4]+ezl[4]); 
  incr[7] = (-1.479019945774904*ezr[11])+1.479019945774904*ezl[11]+1.25*(ezr[7]+ezl[7])-0.9682458365518543*ezr[3]+0.9682458365518543*ezl[3]+0.5590169943749476*(ezr[1]+ezl[1]); 
  incr[8] = (-0.4330127018922193*ezr[10])+0.4330127018922193*ezl[10]+0.25*(ezr[8]+ezl[8]); 
  ...
  incr[10] = 0.75*ezr[10]-0.75*ezl[10]-0.4330127018922193*(ezr[8]+ezl[8]); 
  incr[11] = 1.75*ezr[11]-1.75*ezl[11]-1.479019945774904*(ezr[7]+ezl[7])+1.14564392373896*ezr[3]-1.14564392373896*ezl[3]-0.6614378277661477*(ezr[1]+ezl[1]); 
  ...
  incr[1] = ((-0.6614378277661477*psr[11])+0.6614378277661477*psl[11]+0.5590169943749476*(psr[7]+psl[7])-0.4330127018922193*psr[3]+0.4330127018922193*psl[3]+0.25*(psr[1]+psl[1]))*gamma; 
  ...
  incr[3] = (1.14564392373896*psr[11]-1.14564392373896*psl[11]-0.9682458365518543*(psr[7]+psl[7])+0.75*psr[3]-0.75*psl[3]-0.4330127018922193*(psr[1]+psl[1]))*gamma; 
  incr[4] = ((-0.4330127018922194*psr[6])+0.4330127018922194*psl[6]+0.25*(psr[4]+psl[4]))*gamma; 
  ...
  incr[6] = (0.75*psr[6]-0.75*psl[6]-0.4330127018922194*(psr[4]+psl[4]))*gamma; 
  incr[7] = ((-1.479019945774904*psr[11])+1.479019945774904*psl[11]+1.25*(psr[7]+psl[7])-0.9682458365518543*psr[3]+0.9682458365518543*psl[3]+0.5590169943749476*(psr[1]+psl[1]))*gamma; 
  incr[8] = ((-0.4330127018922193*psr[10])+0.4330127018922193*psl[10]+0.25*(psr[8]+psl[8]))*gamma; 
  ...
  incr[10] = (0.75*psr[10]-0.75*psl[10]-0.4330127018922193*(psr[8]+psl[8]))*gamma; 
  incr[11] = (1.75*psr[11]-1.75*psl[11]-1.479019945774904*(psr[7]+psl[7])+1.14564392373896*psr[3]-1.14564392373896*psl[3]-0.6614378277661477*(psr[1]+psl[1]))*gamma; 
  ...
  incr[1] = 0.6614378277661477*exr[11]-0.6614378277661477*exl[11]-0.5590169943749476*(exr[7]+exl[7])+0.4330127018922193*exr[3]-0.4330127018922193*exl[3]-0.25*(exr[1]+exl[1]); 
  ...
  incr[3] = (-1.14564392373896*exr[11])+1.14564392373896*exl[11]+0.9682458365518543*(exr[7]+exl[7])-0.75*exr[3]+0.75*exl[3]+0.4330127018922193*(exr[1]+exl[1]); 
  incr[4] = 0.4330127018922194*exr[6]-0.4330127018922194*exl[6]-0.25*(exr[4]+exl[4]); 
  ...
  incr[6] = (-0.75*exr[6])+0.75*exl[6]+0.4330127018922194*(exr[4]+exl[4]); 
  incr[7] = 1.479019945774904*exr[11]-1.479019945774904*exl[11]-1.25*(exr[7]+exl[7])+0.9682458365518543*exr[3]-0.9682458365518543*exl[3]-0.5590169943749476*(exr[1]+exl[1]); 
  incr[8] = 0.4330127018922193*exr[10]-0.4330127018922193*exl[10]-0.25*(exr[8]+exl[8]); 
  ...
  incr[10] = (-0.75*exr[10])+0.75*exl[10]+0.4330127018922193*(exr[8]+exl[8]); 
  incr[11] = (-1.75*exr[11])+1.75*exl[11]+1.479019945774904*(exr[7]+exl[7])-1.14564392373896*exr[3]+1.14564392373896*exl[3]+0.6614378277661477*(exr[1]+exl[1]); 
  ...
  incr[1] = ((-0.6614378277661477*eyr[11])+0.6614378277661477*eyl[11]+0.5590169943749476*(eyr[7]+eyl[7])-0.4330127018922193*eyr[3]+0.4330127018922193*eyl[3]+0.25*(eyr[1]+eyl[1]))*chi; 
  ...
  incr[3] = (1.14564392373896*eyr[11]-1.14564392373896*eyl[11]-0.9682458365518543*(eyr[7]+eyl[7])+0.75*eyr[3]-0.75*eyl[3]-0.4330127018922193*(eyr[1]+eyl[1]))*chi; 
  incr[4] = ((-0.4330127018922194*eyr[6])+0.4330127018922194*eyl[6]+0.25*(eyr[4]+eyl[4]))*chi; 
  ...
  incr[6] = (0.75*eyr[6]-0.75*eyl[6]-0.4330127018922194*(eyr[4]+eyl[4]))*chi; 
  incr[7] = ((-1.479019945774904*eyr[11])+1.479019945774904*eyl[11]+1.25*(eyr[7]+eyl[7])-0.9682458365518543*eyr[3]+0.9682458365518543*eyl[3]+0.5590169943749476*(eyr[1]+eyl[1]))*chi; 
  incr[8] = ((-0.4330127018922193*eyr[10])+0.4330127018922193*eyl[10]+0.25*(eyr[8]+eyl[8]))*chi; 
  ...
  incr[10] = (0.75*eyr[10]-0.75*eyl[10]-0.4330127018922193*(eyr[8]+eyl[8]))*chi; 
  incr[11] = (1.75*eyr[11]-1.75*eyl[11]-1.479019945774904*(eyr[7]+eyl[7])+1.14564392373896*eyr[3]-1.14564392373896*eyl[3]-0.6614378277661477*(eyr[1]+eyl[1]))*chi; 
  ...
  incr[1] = ((-0.6614378277661477*byr[11])+0.6614378277661477*byl[11]+0.5590169943749476*(byr[7]+byl[7])-0.4330127018922193*byr[3]+0.4330127018922193*byl[3]+0.25*(byr[1]+byl[1]))*c2gamma; 
  ...
  incr[3] = (1.14564392373896*byr[11]-1.14564392373896*byl[11]-0.9682458365518543*(byr[7]+byl[7])+0.75*byr[3]-0.75*byl[3]-0.4330127018922193*(byr[1]+byl[1]))*c2gamma; 
  incr[4] = ((-0.4330127018922194*byr[6])+0.4330127018922194*byl[6]+0.25*(byr[4]+byl[4]))*c2gamma; 
  ...
  incr[6] = (0.75*byr[6]-0.75*byl[6]-0.4330127018922194*(byr[4]+byl[4]))*c2gamma; 
  incr[7] = ((-1.479019945774904*byr[11])+1.479019945774904*byl[11]+1.25*(byr[7]+byl[7])-0.9682458365518543*byr[3]+0.9682458365518543*byl[3]+0.5590169943749476*(byr[1]+byl[1]))*c2gamma; 
  incr[8] = ((-0.4330127018922193*byr[10])+0.4330127018922193*byl[10]+0.25*(byr[8]+byl[8]))*c2gamma; 
  ...
  incr[10] = (0.75*byr[10]-0.75*byl[10]-0.4330127018922193*(byr[8]+byl[8]))*c2gamma; 
  incr[11] = (1.75*byr[11]-1.75*byl[11]-1.479019945774904*(byr[7]+byl[7])+1.14564392373896*byr[3]-1.14564392373896*byl[3]-0.6614378277661477*(byr[1]+byl[1]))*c2gamma; 
