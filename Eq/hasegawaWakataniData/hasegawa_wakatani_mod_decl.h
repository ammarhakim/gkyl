...
extern "C" { 
  ...
  double hasegawa_wakatani_vol_2x_p1_Tensor(const double C_, const double kappa_, const double *xc, const double *dx, const double *phi, const double *fIn, const double *phiZonal, const double *nZonal, double *out); 
  ...
  double hasegawa_wakatani_vol_2x_p2_Tensor(const double C_, const double kappa_, const double *xc, const double *dx, const double *phi, const double *fIn, const double *phiZonal, const double *nZonal, double *out); 
