...
{ 
  ...
  out[9] += -0.5*(2.0*alpha_x[1]*kappa_+(2.0*fIn[9]-2.0*phi[1])*C_-1.732050807568877*(alpha_x[4]*fIn[12]+alpha_x[3]*fIn[11]+alpha_x[2]*fIn[10]+alpha_x[1]*fIn[9]+alpha_x[0]*fIn[8])); 
  out[10] += -0.5*(2.0*alpha_y[1]*kappa_+(2.0*fIn[10]-2.0*phi[2])*C_-1.732050807568877*(alpha_y[5]*fIn[13]+alpha_y[3]*fIn[11]+alpha_y[2]*fIn[10]+alpha_y[1]*fIn[9]+alpha_y[0]*fIn[8])); 
  out[11] += -0.1*(10.0*(alpha_x[3]+alpha_y[0])*kappa_+(10.0*fIn[11]-10.0*phi[3])*C_+((-8.660254037844387*alpha_y[5])-7.745966692414834*alpha_x[3])*fIn[15]-8.660254037844387*alpha_x[4]*fIn[14]-7.745966692414834*(alpha_y[3]*fIn[14]+alpha_x[2]*fIn[13]+alpha_y[1]*fIn[12])-8.660254037844386*((alpha_y[2]+alpha_x[1])*fIn[11]+(alpha_y[3]+alpha_x[0])*fIn[10]+(alpha_x[3]+alpha_y[0])*fIn[9]+(alpha_x[2]+alpha_y[1])*fIn[8])); 
  out[12] += -0.1*((20.0*alpha_x[4]+22.3606797749979*alpha_x[0])*kappa_+(10.0*fIn[12]-10.0*phi[4])*C_-17.32050807568877*alpha_x[3]*fIn[14]-17.32050807568877*alpha_x[1]*fIn[12]-19.36491673103709*(alpha_x[2]*fIn[11]+alpha_x[3]*fIn[10])-17.32050807568877*alpha_x[4]*fIn[9]-19.36491673103709*(alpha_x[0]*fIn[9]+alpha_x[1]*fIn[8])); 
  out[13] += -0.1*(22.3606797749979*alpha_y[3]*kappa_+(10.0*fIn[13]-10.0*phi[5])*C_-17.32050807568877*alpha_y[3]*fIn[15]-17.32050807568877*alpha_y[2]*fIn[13]-19.36491673103709*alpha_y[1]*fIn[11]-17.32050807568877*alpha_y[5]*fIn[10]-19.36491673103709*(alpha_y[0]*fIn[10]+alpha_y[3]*fIn[9]+alpha_y[2]*fIn[8])); 
  out[14] += -0.03333333333333333*((67.08203932499369*alpha_x[2]+26.83281572999747*alpha_y[1])*kappa_+(30.0*fIn[14]-30.0*phi[6])*C_-51.96152422706631*alpha_x[2]*fIn[15]+((-25.98076211353316*alpha_y[2])-51.96152422706631*alpha_x[1])*fIn[14]-51.96152422706632*alpha_x[3]*fIn[13]+((-51.96152422706632*alpha_x[3])-25.98076211353316*alpha_y[0])*fIn[12]+((-51.96152422706632*alpha_x[4])-23.2379000772445*alpha_y[3])*fIn[11]-58.09475019311126*(alpha_x[0]*fIn[11]+alpha_x[1]*fIn[10])+((-58.09475019311126*alpha_x[2])-23.2379000772445*alpha_y[1])*fIn[9]-58.09475019311126*alpha_x[3]*fIn[8]); 
  out[15] += -0.03333333333333333*(67.08203932499369*alpha_y[2]*kappa_+(30.0*fIn[15]-30.0*phi[7])*C_+((-51.96152422706631*alpha_y[2])-25.98076211353316*alpha_x[1])*fIn[15]-51.96152422706631*alpha_y[1]*fIn[14]+((-51.96152422706632*alpha_y[3])-25.98076211353316*alpha_x[0])*fIn[13]-51.96152422706632*alpha_y[3]*fIn[12]+((-51.96152422706632*alpha_y[5])-23.2379000772445*alpha_x[3]-58.09475019311126*alpha_y[0])*fIn[11]-23.2379000772445*alpha_x[2]*fIn[10]-58.09475019311126*(alpha_y[1]*fIn[10]+alpha_y[2]*fIn[9]+alpha_y[3]*fIn[8])); 
