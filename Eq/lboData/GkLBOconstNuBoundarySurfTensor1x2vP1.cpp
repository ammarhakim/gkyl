...
double GkLBOconstNuBoundarySurf1x2vTensor_Mu_P1(const double m_, const double *wl, const double *wr, const double *dxvl, const double *dxvr, const int *idxl, const int *idxr, const double *BmagInv, const double nuSum, const double vMuMidMax, const double *nuUSum, const double *nuVtSqSum, const double *fl, const double *fr, double *outl, double *outr) 
{ 
  // w[3]:         Cell-center coordinates.
  // dxv[3]:       Cell spacing.
  // idx[3]:       current grid index.
  ...
  double diffFac[2]; 
  diffFac[0] = 0.7071067811865475*BmagInv[1]*nuVtSqSum[1]*m_+0.7071067811865475*BmagInv[0]*nuVtSqSum[0]*m_; 
  diffFac[1] = 0.7071067811865475*BmagInv[0]*nuVtSqSum[1]*m_+0.7071067811865475*nuVtSqSum[0]*BmagInv[1]*m_; 
