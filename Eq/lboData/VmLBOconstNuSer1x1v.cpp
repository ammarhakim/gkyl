...
{ 
  ...
  out[5] += 3.354101966249685*(alpha_diffusion[4]*f[4]+alpha_diffusion[1]*f[1]+alpha_diffusion[0]*f[0])*rdvSq40+1.936491673103709*alpha_drag[4]*f[6]+1.732050807568877*alpha_drag[2]*f[5]+1.936491673103709*(alpha_drag[1]*f[3]+alpha_drag[0]*f[2]+f[0]*alpha_drag[2]); 
  ...
  out[7] += (3.0*(alpha_diffusion[1]*f[4]+f[1]*alpha_diffusion[4])+3.354101966249685*(alpha_diffusion[0]*f[1]+f[0]*alpha_diffusion[1]))*rdvSq40+1.732050807568877*(alpha_drag[2]*f[7]+alpha_drag[1]*f[6]+f[3]*alpha_drag[4])+1.936491673103709*(alpha_drag[0]*f[3]+alpha_drag[1]*f[2]+f[1]*alpha_drag[2]); 
return alpha_mid; 
...
{ 
  ...
  out[5] += 3.354101966249685*(alpha_diffusion[8]*f[8]+alpha_diffusion[4]*f[4]+alpha_diffusion[1]*f[1]+alpha_diffusion[0]*f[0])*rdvSq40+1.936491673103709*(alpha_drag[8]*f[10]+alpha_drag[4]*f[6])+1.732050807568877*alpha_drag[2]*f[5]+1.936491673103709*(alpha_drag[1]*f[3]+alpha_drag[0]*f[2]+f[0]*alpha_drag[2]); 
  ...
  out[7] += (2.945941518185896*(alpha_diffusion[4]*f[8]+f[4]*alpha_diffusion[8])+3.0*(alpha_diffusion[1]*f[4]+f[1]*alpha_diffusion[4])+3.354101966249685*(alpha_diffusion[0]*f[1]+f[0]*alpha_diffusion[1]))*rdvSq40+1.700840128541522*(alpha_drag[4]*f[10]+f[6]*alpha_drag[8])+1.732050807568877*(alpha_drag[2]*f[7]+alpha_drag[1]*f[6]+f[3]*alpha_drag[4])+1.936491673103709*(alpha_drag[0]*f[3]+alpha_drag[1]*f[2]+f[1]*alpha_drag[2]); 
  out[9] += 11.4564392373896*(alpha_diffusion[8]*f[10]+alpha_diffusion[4]*f[6]+alpha_diffusion[1]*f[3]+alpha_diffusion[0]*f[2])*rdvSq40+2.598076211353316*alpha_drag[2]*f[9]+1.322875655532295*alpha_drag[8]*f[8]+2.958039891549809*(alpha_drag[1]*f[7]+alpha_drag[0]*f[5])+1.322875655532295*alpha_drag[4]*f[4]+3.968626966596886*alpha_drag[2]*f[2]+1.322875655532295*(alpha_drag[1]*f[1]+alpha_drag[0]*f[0]); 
  ...
  out[11] += (10.06230589874905*(alpha_diffusion[4]*f[10]+f[6]*alpha_diffusion[8])+10.2469507659596*(alpha_diffusion[1]*f[6]+f[3]*alpha_diffusion[4])+11.4564392373896*(alpha_diffusion[0]*f[3]+alpha_diffusion[1]*f[2]))*rdvSq40+2.598076211353316*alpha_drag[2]*f[11]+1.161895003862225*(alpha_drag[4]*f[8]+f[4]*alpha_drag[8])+2.645751311064591*alpha_drag[4]*f[7]+2.958039891549809*(alpha_drag[0]*f[7]+alpha_drag[1]*f[5])+1.183215956619923*(alpha_drag[1]*f[4]+f[1]*alpha_drag[4])+3.968626966596886*alpha_drag[2]*f[3]+1.322875655532295*(alpha_drag[0]*f[1]+f[0]*alpha_drag[1]); 
return alpha_mid; 
