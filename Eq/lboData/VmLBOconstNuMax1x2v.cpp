...
{ 
  ...
  alpha_drag[4] = (2.0*u[2]-2.828427124746191*w[2])*rdvy2nu; 
  alpha_drag[5] = 2.0*u[3]*rdvy2nu; 
  alpha_drag[7] = -0.8164965809277261*dxv[2]*rdvy2nu; 
...
{ 
  ...
  // Expand rdv2nu*(vy-uy) in phase basis.
  alpha_drag[10] = (2.0*u[3]-2.828427124746191*w[2])*rdvy2nu; 
  alpha_drag[11] = 2.0*u[4]*rdvy2nu; 
  alpha_drag[13] = -0.8164965809277261*dxv[2]*rdvy2nu; 
  alpha_drag[17] = 2.0*u[5]*rdvy2nu; 
  ...
  out[8] += 2.371708245126284*(alpha_diffusion[7]*f[7]+alpha_diffusion[1]*f[1]+alpha_diffusion[0]*f[0])*rdvxSq4nu+1.224744871391589*alpha_drag[2]*f[8]+1.369306393762915*(alpha_drag[1]*f[4]+alpha_drag[0]*f[2]+f[0]*alpha_drag[2]); 
  out[9] += 2.371708245126284*(alpha_diffusion[7]*f[7]+alpha_diffusion[1]*f[1]+alpha_diffusion[0]*f[0])*rdvySq4nu+1.224744871391589*f[9]*alpha_drag[13]+1.369306393762915*(f[0]*alpha_drag[13]+f[5]*alpha_drag[11]+f[3]*alpha_drag[10]); 
...
{ 
  ...
  // Expand rdv2nu*(vy-uy) in phase basis.
  alpha_drag[20] = (2.0*u[4]-2.828427124746191*w[2])*rdvy2nu; 
  alpha_drag[21] = 2.0*u[5]*rdvy2nu; 
  alpha_drag[23] = -0.8164965809277261*dxv[2]*rdvy2nu; 
  alpha_drag[27] = 2.0*u[6]*rdvy2nu; 
  alpha_drag[37] = 2.0*u[7]*rdvy2nu; 
  ...
  out[8] += 2.371708245126284*(alpha_diffusion[17]*f[17]+alpha_diffusion[7]*f[7]+alpha_diffusion[1]*f[1]+alpha_diffusion[0]*f[0])*rdvxSq4nu+1.369306393762915*alpha_drag[7]*f[11]+1.224744871391589*alpha_drag[2]*f[8]+1.369306393762915*(alpha_drag[1]*f[4]+alpha_drag[0]*f[2]+f[0]*alpha_drag[2]); 
  out[9] += 2.371708245126284*(alpha_diffusion[17]*f[17]+alpha_diffusion[7]*f[7]+alpha_diffusion[1]*f[1]+alpha_diffusion[0]*f[0])*rdvySq4nu+1.369306393762915*f[13]*alpha_drag[27]+1.224744871391589*f[9]*alpha_drag[23]+1.369306393762915*(f[0]*alpha_drag[23]+f[5]*alpha_drag[21]+f[3]*alpha_drag[20]); 
  ...
  out[14] += 2.371708245126284*(alpha_diffusion[7]*f[13]+alpha_diffusion[1]*f[5]+alpha_diffusion[0]*f[3])*rdvxSq4nu+0.6123724356957944*(f[14]*alpha_drag[23]+f[12]*alpha_drag[21]+f[8]*alpha_drag[20])+1.224744871391589*alpha_drag[2]*f[14]+1.369306393762915*(alpha_drag[1]*f[10]+alpha_drag[0]*f[6]+alpha_drag[2]*f[3]); 
  ...
  out[16] += 2.371708245126284*(alpha_diffusion[7]*f[11]+alpha_diffusion[1]*f[4]+alpha_diffusion[0]*f[2])*rdvySq4nu+1.224744871391589*f[16]*alpha_drag[23]+1.369306393762915*(f[2]*alpha_drag[23]+f[10]*alpha_drag[21]+f[6]*alpha_drag[20])+0.6123724356957944*(alpha_drag[2]*f[16]+alpha_drag[1]*f[15]+alpha_drag[0]*f[9]); 
  out[18] += 8.100925873009823*(alpha_diffusion[7]*f[11]+alpha_diffusion[1]*f[4]+alpha_diffusion[0]*f[2])*rdvxSq4nu+1.837117307087383*alpha_drag[2]*f[18]+0.9354143466934851*alpha_drag[17]*f[17]+2.091650066335188*(alpha_drag[1]*f[12]+alpha_drag[0]*f[8])+0.9354143466934851*alpha_drag[7]*f[7]+2.806243040080455*alpha_drag[2]*f[2]+0.9354143466934851*(alpha_drag[1]*f[1]+alpha_drag[0]*f[0]); 
  out[19] += 8.100925873009823*(alpha_diffusion[7]*f[13]+alpha_diffusion[1]*f[5]+alpha_diffusion[0]*f[3])*rdvySq4nu+0.9354143466934851*(f[17]*alpha_drag[37]+f[7]*alpha_drag[27])+(1.837117307087383*f[19]+2.806243040080455*f[3])*alpha_drag[23]+(2.091650066335188*f[15]+0.9354143466934851*f[1])*alpha_drag[21]+(2.091650066335188*f[9]+0.9354143466934851*f[0])*alpha_drag[20]; 
