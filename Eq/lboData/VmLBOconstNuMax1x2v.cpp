...
{ 
  ...
  alpha_drag[4] = (2.0*nuU[4]-2.828427124746191*w[2]*nu)*rdv21; 
  alpha_drag[5] = 2.0*nuU[5]*rdv21; 
...
{ 
  ...
  alpha_drag[10] = (2.0*nuU[10]-2.828427124746191*w[2]*nu)*rdv21; 
  alpha_drag[11] = 2.0*nuU[11]*rdv21; 
  alpha_drag[13] = -0.8164965809277261*dxv[2]*nu*rdv21; 
  alpha_drag[17] = 2.0*nuU[12]*rdv21; 
...
{ 
  ...
  alpha_drag[37] = 2.0*nuU[23]*rdv21; 
