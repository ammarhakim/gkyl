...
double GkLBOconstNuVol1x1vTensorP2(const double m_, const double *w, const double *dxv, const double *BmagInv, const double nuSum, const double *nuUSum, const double *nuVtSqSum, const double *f, double *out) 
{ 
  ...
  out[8] += 1.732050807568877*alphaVpar[2]*f[8]+(1.237179148263484*alphaVpar[4]+1.936491673103709*alphaVpar[0])*f[6]+(3.030457633656632*facVpar[2]+1.936491673103709*alphaVpar[2]+4.743416490252569*facVpar[0])*f[4]+1.936491673103709*f[2]*alphaVpar[4]+1.732050807568877*alphaVpar[1]*f[3]+4.743416490252569*f[0]*facVpar[2]+4.242640687119286*f[1]*facVpar[1]; 
