...
{ 
  ...
  Ghat[1] = Gdiff[1]*rdv+0.8944271909999159*alphaDrSurf[1]*fUpwind[2]+0.8944271909999159*fUpwind[1]*alphaDrSurf[2]+alphaDrSurf[0]*fUpwind[1]+fUpwind[0]*alphaDrSurf[1]; 
  Ghat[4] = Gdiff[4]*rdv+0.6388765649999399*alphaDrSurf[2]*fUpwind[2]+alphaDrSurf[0]*fUpwind[2]+fUpwind[0]*alphaDrSurf[2]+0.8944271909999159*alphaDrSurf[1]*fUpwind[1]; 
