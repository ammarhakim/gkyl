...
{ 
  ...
  double incr2_r[4]; 
  incr2_r[2] = nuVtSq[1]*((-0.3535533905932737*fr[3])+0.3535533905932737*fl[3]+0.3061862178478971*(fr[1]+fl[1]))+nuVtSq[0]*((-0.3535533905932737*fr[2])+0.3535533905932737*fl[2]+0.3061862178478971*(fr[0]+fl[0])); 
  incr2_r[3] = nuVtSq[0]*((-0.3535533905932737*fr[3])+0.3535533905932737*fl[3]+0.3061862178478971*(fr[1]+fl[1]))+nuVtSq[1]*((-0.3535533905932737*fr[2])+0.3535533905932737*fl[2]+0.3061862178478971*(fr[0]+fl[0])); 

  double incr2_l[4]; 
  incr2_l[2] = nuVtSq[1]*(0.3535533905932737*fr[3]-0.3535533905932737*fl[3]-0.3061862178478971*(fr[1]+fl[1]))+nuVtSq[0]*(0.3535533905932737*fr[2]-0.3535533905932737*fl[2]-0.3061862178478971*(fr[0]+fl[0])); 
  incr2_l[3] = nuVtSq[0]*(0.3535533905932737*fr[3]-0.3535533905932737*fl[3]-0.3061862178478971*(fr[1]+fl[1]))+nuVtSq[1]*(0.3535533905932737*fr[2]-0.3535533905932737*fl[2]-0.3061862178478971*(fr[0]+fl[0])); 
...
{ 
  ...
  incr2_r[3] = nuVtSq[0]*(0.2995357736356374*(fr[7]+fl[7])-0.430893194785552*fr[3]+0.430893194785552*fl[3]+0.3061862178478971*(fr[1]+fl[1]))+nuVtSq[2]*(0.2679129406169099*(fr[7]+fl[7])-0.3854025898330209*fr[3]+0.3854025898330209*fl[3]+0.273861278752583*(fr[1]+fl[1]))+nuVtSq[1]*((-0.3854025898330209*fr[6])+0.3854025898330209*fl[6]+0.2995357736356374*(fr[5]+fl[5])+0.273861278752583*(fr[4]+fl[4])-0.430893194785552*fr[2]+0.430893194785552*fl[2]+0.3061862178478971*(fr[0]+fl[0])); 
  incr2_r[5] = nuVtSq[1]*((-1.160097062884178*(fr[7]+fl[7]))+1.668842167398551*fr[3]-1.668842167398551*fl[3]-1.185854122563142*(fr[1]+fl[1]))+nuVtSq[2]*(1.668842167398552*fr[6]-1.668842167398552*fl[6]-1.185854122563142*(fr[4]+fl[4]))+nuVtSq[0]*((-1.160097062884178*(fr[5]+fl[5]))+1.668842167398551*fr[2]-1.668842167398551*fl[2]-1.185854122563142*(fr[0]+fl[0])); 
  incr2_r[6] = nuVtSq[1]*(0.2679129406169099*(fr[7]+fl[7])-0.3854025898330209*fr[3]+0.3854025898330209*fl[3]+0.273861278752583*(fr[1]+fl[1]))+nuVtSq[2]*((-0.2752875641664436*fr[6])+0.2752875641664436*fl[6]+0.2995357736356374*(fr[5]+fl[5])+0.1956151991089878*(fr[4]+fl[4])-0.430893194785552*fr[2]+0.430893194785552*fl[2]+0.3061862178478971*(fr[0]+fl[0]))+nuVtSq[0]*((-0.430893194785552*fr[6])+0.430893194785552*fl[6]+0.3061862178478971*(fr[4]+fl[4])); 
  incr2_r[7] = nuVtSq[2]*((-1.037622357242749*(fr[7]+fl[7]))+1.492657812008498*fr[3]-1.492657812008498*fl[3]-1.060660171779821*(fr[1]+fl[1]))+nuVtSq[0]*((-1.160097062884178*(fr[7]+fl[7]))+1.668842167398552*fr[3]-1.668842167398552*fl[3]-1.185854122563142*(fr[1]+fl[1]))+nuVtSq[1]*(1.492657812008498*fr[6]-1.492657812008498*fl[6]-1.160097062884178*(fr[5]+fl[5])-1.060660171779821*(fr[4]+fl[4])+1.668842167398552*fr[2]-1.668842167398552*fl[2]-1.185854122563142*(fr[0]+fl[0])); 

  double incr2_l[8]; 
  incr2_l[2] = nuVtSq[1]*((-0.2995357736356374*(fr[7]+fl[7]))+0.430893194785552*fr[3]-0.430893194785552*fl[3]-0.3061862178478971*(fr[1]+fl[1]))+nuVtSq[2]*(0.430893194785552*fr[6]-0.430893194785552*fl[6]-0.3061862178478971*(fr[4]+fl[4]))+nuVtSq[0]*((-0.2995357736356374*(fr[5]+fl[5]))+0.430893194785552*fr[2]-0.430893194785552*fl[2]-0.3061862178478971*(fr[0]+fl[0])); 
  incr2_l[3] = nuVtSq[2]*((-0.2679129406169099*(fr[7]+fl[7]))+0.3854025898330209*fr[3]-0.3854025898330209*fl[3]-0.273861278752583*(fr[1]+fl[1]))+nuVtSq[0]*((-0.2995357736356374*(fr[7]+fl[7]))+0.430893194785552*fr[3]-0.430893194785552*fl[3]-0.3061862178478971*(fr[1]+fl[1]))+nuVtSq[1]*(0.3854025898330209*fr[6]-0.3854025898330209*fl[6]-0.2995357736356374*(fr[5]+fl[5])-0.273861278752583*(fr[4]+fl[4])+0.430893194785552*fr[2]-0.430893194785552*fl[2]-0.3061862178478971*(fr[0]+fl[0])); 
  incr2_l[5] = nuVtSq[1]*((-1.160097062884178*(fr[7]+fl[7]))+1.668842167398551*fr[3]-1.668842167398551*fl[3]-1.185854122563142*(fr[1]+fl[1]))+nuVtSq[2]*(1.668842167398552*fr[6]-1.668842167398552*fl[6]-1.185854122563142*(fr[4]+fl[4]))+nuVtSq[0]*((-1.160097062884178*(fr[5]+fl[5]))+1.668842167398551*fr[2]-1.668842167398551*fl[2]-1.185854122563142*(fr[0]+fl[0])); 
  incr2_l[6] = nuVtSq[1]*((-0.2679129406169099*(fr[7]+fl[7]))+0.3854025898330209*fr[3]-0.3854025898330209*fl[3]-0.273861278752583*(fr[1]+fl[1]))+nuVtSq[0]*(0.430893194785552*fr[6]-0.430893194785552*fl[6]-0.3061862178478971*(fr[4]+fl[4]))+nuVtSq[2]*(0.2752875641664436*fr[6]-0.2752875641664436*fl[6]-0.2995357736356374*(fr[5]+fl[5])-0.1956151991089878*(fr[4]+fl[4])+0.430893194785552*fr[2]-0.430893194785552*fl[2]-0.3061862178478971*(fr[0]+fl[0])); 
  incr2_l[7] = nuVtSq[2]*((-1.037622357242749*(fr[7]+fl[7]))+1.492657812008498*fr[3]-1.492657812008498*fl[3]-1.060660171779821*(fr[1]+fl[1]))+nuVtSq[0]*((-1.160097062884178*(fr[7]+fl[7]))+1.668842167398552*fr[3]-1.668842167398552*fl[3]-1.185854122563142*(fr[1]+fl[1]))+nuVtSq[1]*(1.492657812008498*fr[6]-1.492657812008498*fl[6]-1.160097062884178*(fr[5]+fl[5])-1.060660171779821*(fr[4]+fl[4])+1.668842167398552*fr[2]-1.668842167398552*fl[2]-1.185854122563142*(fr[0]+fl[0])); 
  ...
  outl[5] += incr2_l[5]*rdvSq4l-1.0*incr1[5]*rdv2l; 
  outl[6] += incr2_l[6]*rdvSq4l+incr1[6]*rdv2l; 
  outl[7] += incr2_l[7]*rdvSq4l-1.0*incr1[7]*rdv2l; 
