...
{ 
  ...
  alpha_drag[5] = (2.828427124746191*nuU[2]-4.0*w[2]*nu)*rdv21; 
  alpha_drag[6] = 2.828427124746191*nuU[3]*rdv21; 
  alpha_drag[8] = -1.154700538379252*dxv[2]*nu*rdv21; 
  alpha_mid += std::abs(0.125*alpha_drag[5]); 
  alpha_drag[10] = (2.828427124746191*nuU[4]-4.0*w[3]*nu)*rdv22; 
  alpha_drag[11] = 2.828427124746191*nuU[5]*rdv22; 
...
{ 
  ...
  alpha_drag[15] = (2.828427124746191*nuU[3]-4.0*w[2]*nu)*rdv21; 
  alpha_drag[16] = 2.828427124746191*nuU[4]*rdv21; 
  alpha_drag[18] = -1.154700538379252*dxv[2]*nu*rdv21; 
  alpha_drag[26] = 2.828427124746191*nuU[5]*rdv21; 
  alpha_mid += std::abs(0.125*alpha_drag[15]-0.1397542485937369*alpha_drag[26]); 
  alpha_drag[30] = (2.828427124746191*nuU[6]-4.0*w[3]*nu)*rdv22; 
  alpha_drag[31] = 2.828427124746191*nuU[7]*rdv22; 
  alpha_drag[34] = -1.154700538379252*dxv[3]*nu*rdv22; 
  alpha_drag[41] = 2.828427124746191*nuU[8]*rdv22; 
...
{ 
  ...
  alpha_mid += std::abs(0.125*alpha_drag[0]-0.1397542485937369*alpha_drag[11]); 
  alpha_drag[35] = (2.828427124746191*nuU[4]-4.0*w[2]*nu)*rdv21; 
  alpha_drag[36] = 2.828427124746191*nuU[5]*rdv21; 
  alpha_drag[38] = -1.154700538379252*dxv[2]*nu*rdv21; 
  alpha_drag[46] = 2.828427124746191*nuU[6]*rdv21; 
  alpha_drag[66] = 2.828427124746191*nuU[7]*rdv21; 
  alpha_mid += std::abs(0.125*alpha_drag[35]-0.1397542485937369*alpha_drag[46]); 
  alpha_drag[70] = (2.828427124746191*nuU[8]-4.0*w[3]*nu)*rdv22; 
  alpha_drag[71] = 2.828427124746191*nuU[9]*rdv22; 
  alpha_drag[74] = -1.154700538379252*dxv[3]*nu*rdv22; 
  alpha_drag[81] = 2.828427124746191*nuU[10]*rdv22; 
  alpha_drag[101] = 2.828427124746191*nuU[11]*rdv22; 
