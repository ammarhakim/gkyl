...
{ 
  ...
  Ghat[0] = ((-0.5412658773652741*nuVtSqSum[3]*fr[11])-0.5412658773652741*nuVtSqSum[3]*fl[11]-0.5412658773652741*nuVtSqSum[2]*fr[7]-0.5412658773652741*nuVtSqSum[2]*fl[7]-0.5412658773652741*nuVtSqSum[1]*fr[6]-0.5412658773652741*nuVtSqSum[1]*fl[6]+0.5625*nuVtSqSum[3]*fr[5]-0.5625*nuVtSqSum[3]*fl[5]-0.5412658773652741*nuVtSqSum[0]*fr[3]-0.5412658773652741*nuVtSqSum[0]*fl[3]+0.5625*fr[2]*nuVtSqSum[2]-0.5625*fl[2]*nuVtSqSum[2]+0.5625*fr[1]*nuVtSqSum[1]-0.5625*fl[1]*nuVtSqSum[1]+0.5625*fr[0]*nuVtSqSum[0]-0.5625*fl[0]*nuVtSqSum[0])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[11]+0.25*favg[5])+alphaDrag[2]*(0.4330127018922193*favg[7]+0.25*favg[2])+alphaDrag[1]*(0.4330127018922193*favg[6]+0.25*favg[1])-0.8660254037844386*fjump[3]+alphaDrag[0]*(0.4330127018922193*favg[3]+0.25*favg[0])-0.5*fjump[0]; 
  Ghat[1] = ((-0.5412658773652741*nuVtSqSum[2]*fr[11])-0.5412658773652741*nuVtSqSum[2]*fl[11]-0.5412658773652741*nuVtSqSum[3]*fr[7]-0.5412658773652741*nuVtSqSum[3]*fl[7]-0.5412658773652741*nuVtSqSum[0]*fr[6]-0.5412658773652741*nuVtSqSum[0]*fl[6]+0.5625*nuVtSqSum[2]*fr[5]-0.5625*nuVtSqSum[2]*fl[5]+0.5625*fr[2]*nuVtSqSum[3]-0.5625*fl[2]*nuVtSqSum[3]-0.5412658773652741*nuVtSqSum[1]*fr[3]-0.5412658773652741*nuVtSqSum[1]*fl[3]+0.5625*fr[0]*nuVtSqSum[1]-0.5625*fl[0]*nuVtSqSum[1]+0.5625*nuVtSqSum[0]*fr[1]-0.5625*nuVtSqSum[0]*fl[1])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[11]+0.25*favg[5])+alphaDrag[3]*(0.4330127018922193*favg[7]+0.25*favg[2])-0.8660254037844386*fjump[6]+alphaDrag[0]*(0.4330127018922193*favg[6]+0.25*favg[1])+alphaDrag[1]*(0.4330127018922193*favg[3]+0.25*favg[0])-0.5*fjump[1]; 
  Ghat[2] = ((-0.5412658773652741*nuVtSqSum[1]*fr[11])-0.5412658773652741*nuVtSqSum[1]*fl[11]-0.5412658773652741*nuVtSqSum[0]*fr[7]-0.5412658773652741*nuVtSqSum[0]*fl[7]-0.5412658773652741*nuVtSqSum[3]*fr[6]-0.5412658773652741*nuVtSqSum[3]*fl[6]+0.5625*nuVtSqSum[1]*fr[5]-0.5625*nuVtSqSum[1]*fl[5]+0.5625*fr[1]*nuVtSqSum[3]-0.5625*fl[1]*nuVtSqSum[3]-0.5412658773652741*nuVtSqSum[2]*fr[3]-0.5412658773652741*nuVtSqSum[2]*fl[3]+0.5625*fr[0]*nuVtSqSum[2]-0.5625*fl[0]*nuVtSqSum[2]+0.5625*nuVtSqSum[0]*fr[2]-0.5625*nuVtSqSum[0]*fl[2])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[11]+0.25*favg[5])-0.8660254037844386*fjump[7]+alphaDrag[0]*(0.4330127018922193*favg[7]+0.25*favg[2])+alphaDrag[3]*(0.4330127018922193*favg[6]+0.25*favg[1])+alphaDrag[2]*(0.4330127018922193*favg[3]+0.25*favg[0])-0.5*fjump[2]; 
  Ghat[4] = ((-0.5412658773652741*nuVtSqSum[3]*fr[15])-0.5412658773652741*nuVtSqSum[3]*fl[15]-0.5412658773652741*nuVtSqSum[2]*fr[14]-0.5412658773652741*nuVtSqSum[2]*fl[14]-0.5412658773652741*nuVtSqSum[1]*fr[13]-0.5412658773652741*nuVtSqSum[1]*fl[13]+0.5625*nuVtSqSum[3]*fr[12]-0.5625*nuVtSqSum[3]*fl[12]-0.5412658773652741*nuVtSqSum[0]*fr[10]-0.5412658773652741*nuVtSqSum[0]*fl[10]+0.5625*nuVtSqSum[2]*fr[9]-0.5625*nuVtSqSum[2]*fl[9]+0.5625*nuVtSqSum[1]*fr[8]-0.5625*nuVtSqSum[1]*fl[8]+0.5625*nuVtSqSum[0]*fr[4]-0.5625*nuVtSqSum[0]*fl[4])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[15]+0.25*favg[12])+alphaDrag[2]*(0.4330127018922193*favg[14]+0.25*favg[9])+alphaDrag[1]*(0.4330127018922193*favg[13]+0.25*favg[8])-0.8660254037844386*fjump[10]+alphaDrag[0]*(0.4330127018922193*favg[10]+0.25*favg[4])-0.5*fjump[4]; 
  Ghat[5] = ((-0.5412658773652741*nuVtSqSum[0]*fr[11])-0.5412658773652741*nuVtSqSum[0]*fl[11]-0.5412658773652741*nuVtSqSum[1]*fr[7]-0.5412658773652741*nuVtSqSum[1]*fl[7]-0.5412658773652741*nuVtSqSum[2]*fr[6]-0.5412658773652741*nuVtSqSum[2]*fl[6]+0.5625*nuVtSqSum[0]*fr[5]-0.5625*nuVtSqSum[0]*fl[5]-0.5412658773652741*fr[3]*nuVtSqSum[3]-0.5412658773652741*fl[3]*nuVtSqSum[3]+0.5625*fr[0]*nuVtSqSum[3]-0.5625*fl[0]*nuVtSqSum[3]+0.5625*fr[1]*nuVtSqSum[2]-0.5625*fl[1]*nuVtSqSum[2]+0.5625*nuVtSqSum[1]*fr[2]-0.5625*nuVtSqSum[1]*fl[2])*rdv2L-0.8660254037844386*fjump[11]+alphaDrag[0]*(0.4330127018922193*favg[11]+0.25*favg[5])+alphaDrag[1]*(0.4330127018922193*favg[7]+0.25*favg[2])+alphaDrag[2]*(0.4330127018922193*favg[6]+0.25*favg[1])-0.5*fjump[5]+alphaDrag[3]*(0.4330127018922193*favg[3]+0.25*favg[0]); 
  Ghat[8] = ((-0.5412658773652741*nuVtSqSum[2]*fr[15])-0.5412658773652741*nuVtSqSum[2]*fl[15]-0.5412658773652741*nuVtSqSum[3]*fr[14]-0.5412658773652741*nuVtSqSum[3]*fl[14]-0.5412658773652741*nuVtSqSum[0]*fr[13]-0.5412658773652741*nuVtSqSum[0]*fl[13]+0.5625*nuVtSqSum[2]*fr[12]-0.5625*nuVtSqSum[2]*fl[12]-0.5412658773652741*nuVtSqSum[1]*fr[10]-0.5412658773652741*nuVtSqSum[1]*fl[10]+0.5625*nuVtSqSum[3]*fr[9]-0.5625*nuVtSqSum[3]*fl[9]+0.5625*nuVtSqSum[0]*fr[8]-0.5625*nuVtSqSum[0]*fl[8]+0.5625*nuVtSqSum[1]*fr[4]-0.5625*nuVtSqSum[1]*fl[4])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[15]+0.25*favg[12])+alphaDrag[3]*(0.4330127018922193*favg[14]+0.25*favg[9])-0.8660254037844386*fjump[13]+alphaDrag[0]*(0.4330127018922193*favg[13]+0.25*favg[8])+alphaDrag[1]*(0.4330127018922193*favg[10]+0.25*favg[4])-0.5*fjump[8]; 
  Ghat[9] = ((-0.5412658773652741*nuVtSqSum[1]*fr[15])-0.5412658773652741*nuVtSqSum[1]*fl[15]-0.5412658773652741*nuVtSqSum[0]*fr[14]-0.5412658773652741*nuVtSqSum[0]*fl[14]-0.5412658773652741*nuVtSqSum[3]*fr[13]-0.5412658773652741*nuVtSqSum[3]*fl[13]+0.5625*nuVtSqSum[1]*fr[12]-0.5625*nuVtSqSum[1]*fl[12]-0.5412658773652741*nuVtSqSum[2]*fr[10]-0.5412658773652741*nuVtSqSum[2]*fl[10]+0.5625*nuVtSqSum[0]*fr[9]-0.5625*nuVtSqSum[0]*fl[9]+0.5625*nuVtSqSum[3]*fr[8]-0.5625*nuVtSqSum[3]*fl[8]+0.5625*nuVtSqSum[2]*fr[4]-0.5625*nuVtSqSum[2]*fl[4])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[15]+0.25*favg[12])-0.8660254037844386*fjump[14]+alphaDrag[0]*(0.4330127018922193*favg[14]+0.25*favg[9])+alphaDrag[3]*(0.4330127018922193*favg[13]+0.25*favg[8])+alphaDrag[2]*(0.4330127018922193*favg[10]+0.25*favg[4])-0.5*fjump[9]; 
  Ghat[12] = ((-0.5412658773652741*nuVtSqSum[0]*fr[15])-0.5412658773652741*nuVtSqSum[0]*fl[15]-0.5412658773652741*nuVtSqSum[1]*fr[14]-0.5412658773652741*nuVtSqSum[1]*fl[14]-0.5412658773652741*nuVtSqSum[2]*fr[13]-0.5412658773652741*nuVtSqSum[2]*fl[13]+0.5625*nuVtSqSum[0]*fr[12]-0.5625*nuVtSqSum[0]*fl[12]-0.5412658773652741*nuVtSqSum[3]*fr[10]-0.5412658773652741*nuVtSqSum[3]*fl[10]+0.5625*nuVtSqSum[1]*fr[9]-0.5625*nuVtSqSum[1]*fl[9]+0.5625*nuVtSqSum[2]*fr[8]-0.5625*nuVtSqSum[2]*fl[8]+0.5625*nuVtSqSum[3]*fr[4]-0.5625*nuVtSqSum[3]*fl[4])*rdv2L-0.8660254037844386*fjump[15]+alphaDrag[0]*(0.4330127018922193*favg[15]+0.25*favg[12])+alphaDrag[1]*(0.4330127018922193*favg[14]+0.25*favg[9])+alphaDrag[2]*(0.4330127018922193*favg[13]+0.25*favg[8])-0.5*fjump[12]+alphaDrag[3]*(0.4330127018922193*favg[10]+0.25*favg[4]); 
...
{ 
  ...
  Ghat[0] = ((-0.5412658773652741*nuVtSqSum[3]*fr[12])-0.5412658773652741*nuVtSqSum[3]*fl[12]-0.5412658773652741*nuVtSqSum[2]*fr[9]-0.5412658773652741*nuVtSqSum[2]*fl[9]-0.5412658773652741*nuVtSqSum[1]*fr[8]-0.5412658773652741*nuVtSqSum[1]*fl[8]+0.5625*nuVtSqSum[3]*fr[5]-0.5625*nuVtSqSum[3]*fl[5]-0.5412658773652741*nuVtSqSum[0]*fr[4]-0.5412658773652741*nuVtSqSum[0]*fl[4]+0.5625*fr[2]*nuVtSqSum[2]-0.5625*fl[2]*nuVtSqSum[2]+0.5625*fr[1]*nuVtSqSum[1]-0.5625*fl[1]*nuVtSqSum[1]+0.5625*fr[0]*nuVtSqSum[0]-0.5625*fl[0]*nuVtSqSum[0])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[12]+0.25*favg[5])+alphaDrag[2]*(0.4330127018922193*favg[9]+0.25*favg[2])+alphaDrag[1]*(0.4330127018922193*favg[8]+0.25*favg[1])-0.8660254037844386*fjump[4]+alphaDrag[0]*(0.4330127018922193*favg[4]+0.25*favg[0])-0.5*fjump[0]; 
  Ghat[1] = ((-0.5412658773652741*nuVtSqSum[2]*fr[12])-0.5412658773652741*nuVtSqSum[2]*fl[12]-0.5412658773652741*nuVtSqSum[3]*fr[9]-0.5412658773652741*nuVtSqSum[3]*fl[9]-0.5412658773652741*nuVtSqSum[0]*fr[8]-0.5412658773652741*nuVtSqSum[0]*fl[8]+0.5625*nuVtSqSum[2]*fr[5]-0.5625*nuVtSqSum[2]*fl[5]-0.5412658773652741*nuVtSqSum[1]*fr[4]-0.5412658773652741*nuVtSqSum[1]*fl[4]+0.5625*fr[2]*nuVtSqSum[3]-0.5625*fl[2]*nuVtSqSum[3]+0.5625*fr[0]*nuVtSqSum[1]-0.5625*fl[0]*nuVtSqSum[1]+0.5625*nuVtSqSum[0]*fr[1]-0.5625*nuVtSqSum[0]*fl[1])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[12]+0.25*favg[5])+alphaDrag[3]*(0.4330127018922193*favg[9]+0.25*favg[2])-0.8660254037844386*fjump[8]+alphaDrag[0]*(0.4330127018922193*favg[8]+0.25*favg[1])+alphaDrag[1]*(0.4330127018922193*favg[4]+0.25*favg[0])-0.5*fjump[1]; 
  Ghat[2] = ((-0.5412658773652741*nuVtSqSum[1]*fr[12])-0.5412658773652741*nuVtSqSum[1]*fl[12]-0.5412658773652741*nuVtSqSum[0]*fr[9]-0.5412658773652741*nuVtSqSum[0]*fl[9]-0.5412658773652741*nuVtSqSum[3]*fr[8]-0.5412658773652741*nuVtSqSum[3]*fl[8]+0.5625*nuVtSqSum[1]*fr[5]-0.5625*nuVtSqSum[1]*fl[5]-0.5412658773652741*nuVtSqSum[2]*fr[4]-0.5412658773652741*nuVtSqSum[2]*fl[4]+0.5625*fr[1]*nuVtSqSum[3]-0.5625*fl[1]*nuVtSqSum[3]+0.5625*fr[0]*nuVtSqSum[2]-0.5625*fl[0]*nuVtSqSum[2]+0.5625*nuVtSqSum[0]*fr[2]-0.5625*nuVtSqSum[0]*fl[2])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[12]+0.25*favg[5])-0.8660254037844386*fjump[9]+alphaDrag[0]*(0.4330127018922193*favg[9]+0.25*favg[2])+alphaDrag[3]*(0.4330127018922193*favg[8]+0.25*favg[1])+alphaDrag[2]*(0.4330127018922193*favg[4]+0.25*favg[0])-0.5*fjump[2]; 
  Ghat[3] = ((-0.5412658773652741*nuVtSqSum[3]*fr[15])-0.5412658773652741*nuVtSqSum[3]*fl[15]-0.5412658773652741*nuVtSqSum[2]*fr[14]-0.5412658773652741*nuVtSqSum[2]*fl[14]-0.5412658773652741*nuVtSqSum[1]*fr[13]-0.5412658773652741*nuVtSqSum[1]*fl[13]+0.5625*nuVtSqSum[3]*fr[11]-0.5625*nuVtSqSum[3]*fl[11]-0.5412658773652741*nuVtSqSum[0]*fr[10]-0.5412658773652741*nuVtSqSum[0]*fl[10]+0.5625*nuVtSqSum[2]*fr[7]-0.5625*nuVtSqSum[2]*fl[7]+0.5625*nuVtSqSum[1]*fr[6]-0.5625*nuVtSqSum[1]*fl[6]+0.5625*nuVtSqSum[0]*fr[3]-0.5625*nuVtSqSum[0]*fl[3])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[15]+0.25*favg[11])+alphaDrag[2]*(0.4330127018922193*favg[14]+0.25*favg[7])+alphaDrag[1]*(0.4330127018922193*favg[13]+0.25*favg[6])-0.8660254037844386*fjump[10]+alphaDrag[0]*(0.4330127018922193*favg[10]+0.25*favg[3])-0.5*fjump[3]; 
  Ghat[5] = ((-0.5412658773652741*nuVtSqSum[0]*fr[12])-0.5412658773652741*nuVtSqSum[0]*fl[12]-0.5412658773652741*nuVtSqSum[1]*fr[9]-0.5412658773652741*nuVtSqSum[1]*fl[9]-0.5412658773652741*nuVtSqSum[2]*fr[8]-0.5412658773652741*nuVtSqSum[2]*fl[8]+0.5625*nuVtSqSum[0]*fr[5]-0.5625*nuVtSqSum[0]*fl[5]-0.5412658773652741*nuVtSqSum[3]*fr[4]-0.5412658773652741*nuVtSqSum[3]*fl[4]+0.5625*fr[0]*nuVtSqSum[3]-0.5625*fl[0]*nuVtSqSum[3]+0.5625*fr[1]*nuVtSqSum[2]-0.5625*fl[1]*nuVtSqSum[2]+0.5625*nuVtSqSum[1]*fr[2]-0.5625*nuVtSqSum[1]*fl[2])*rdv2L-0.8660254037844386*fjump[12]+alphaDrag[0]*(0.4330127018922193*favg[12]+0.25*favg[5])+alphaDrag[1]*(0.4330127018922193*favg[9]+0.25*favg[2])+alphaDrag[2]*(0.4330127018922193*favg[8]+0.25*favg[1])-0.5*fjump[5]+alphaDrag[3]*(0.4330127018922193*favg[4]+0.25*favg[0]); 
  Ghat[6] = ((-0.5412658773652741*nuVtSqSum[2]*fr[15])-0.5412658773652741*nuVtSqSum[2]*fl[15]-0.5412658773652741*nuVtSqSum[3]*fr[14]-0.5412658773652741*nuVtSqSum[3]*fl[14]-0.5412658773652741*nuVtSqSum[0]*fr[13]-0.5412658773652741*nuVtSqSum[0]*fl[13]+0.5625*nuVtSqSum[2]*fr[11]-0.5625*nuVtSqSum[2]*fl[11]-0.5412658773652741*nuVtSqSum[1]*fr[10]-0.5412658773652741*nuVtSqSum[1]*fl[10]+0.5625*nuVtSqSum[3]*fr[7]-0.5625*nuVtSqSum[3]*fl[7]+0.5625*nuVtSqSum[0]*fr[6]-0.5625*nuVtSqSum[0]*fl[6]+0.5625*nuVtSqSum[1]*fr[3]-0.5625*nuVtSqSum[1]*fl[3])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[15]+0.25*favg[11])+alphaDrag[3]*(0.4330127018922193*favg[14]+0.25*favg[7])-0.8660254037844386*fjump[13]+alphaDrag[0]*(0.4330127018922193*favg[13]+0.25*favg[6])+alphaDrag[1]*(0.4330127018922193*favg[10]+0.25*favg[3])-0.5*fjump[6]; 
  Ghat[7] = ((-0.5412658773652741*nuVtSqSum[1]*fr[15])-0.5412658773652741*nuVtSqSum[1]*fl[15]-0.5412658773652741*nuVtSqSum[0]*fr[14]-0.5412658773652741*nuVtSqSum[0]*fl[14]-0.5412658773652741*nuVtSqSum[3]*fr[13]-0.5412658773652741*nuVtSqSum[3]*fl[13]+0.5625*nuVtSqSum[1]*fr[11]-0.5625*nuVtSqSum[1]*fl[11]-0.5412658773652741*nuVtSqSum[2]*fr[10]-0.5412658773652741*nuVtSqSum[2]*fl[10]+0.5625*nuVtSqSum[0]*fr[7]-0.5625*nuVtSqSum[0]*fl[7]+0.5625*nuVtSqSum[3]*fr[6]-0.5625*nuVtSqSum[3]*fl[6]+0.5625*nuVtSqSum[2]*fr[3]-0.5625*nuVtSqSum[2]*fl[3])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[15]+0.25*favg[11])-0.8660254037844386*fjump[14]+alphaDrag[0]*(0.4330127018922193*favg[14]+0.25*favg[7])+alphaDrag[3]*(0.4330127018922193*favg[13]+0.25*favg[6])+alphaDrag[2]*(0.4330127018922193*favg[10]+0.25*favg[3])-0.5*fjump[7]; 
  Ghat[11] = ((-0.5412658773652741*nuVtSqSum[0]*fr[15])-0.5412658773652741*nuVtSqSum[0]*fl[15]-0.5412658773652741*nuVtSqSum[1]*fr[14]-0.5412658773652741*nuVtSqSum[1]*fl[14]-0.5412658773652741*nuVtSqSum[2]*fr[13]-0.5412658773652741*nuVtSqSum[2]*fl[13]+0.5625*nuVtSqSum[0]*fr[11]-0.5625*nuVtSqSum[0]*fl[11]-0.5412658773652741*nuVtSqSum[3]*fr[10]-0.5412658773652741*nuVtSqSum[3]*fl[10]+0.5625*nuVtSqSum[1]*fr[7]-0.5625*nuVtSqSum[1]*fl[7]+0.5625*nuVtSqSum[2]*fr[6]-0.5625*nuVtSqSum[2]*fl[6]+0.5625*fr[3]*nuVtSqSum[3]-0.5625*fl[3]*nuVtSqSum[3])*rdv2L-0.8660254037844386*fjump[15]+alphaDrag[0]*(0.4330127018922193*favg[15]+0.25*favg[11])+alphaDrag[1]*(0.4330127018922193*favg[14]+0.25*favg[7])+alphaDrag[2]*(0.4330127018922193*favg[13]+0.25*favg[6])-0.5*fjump[11]+alphaDrag[3]*(0.4330127018922193*favg[10]+0.25*favg[3]); 
