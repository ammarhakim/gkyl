...
double GkLBOconstNuVol2x2vSerP1(const double m_, const double *w, const double *dxv, double *cflRateByDir, const double *BmagInv, const double nuSum, const double *nuUSum, const double *nuVtSqSum, const double *f, double *out) 
{ 
  ...
  alphaL = 0.0625*(0.25*alphaVpar[5]-0.4330127018922193*alphaVpar[3]-0.25*(alphaVpar[2]+alphaVpar[1])+0.25*alphaVpar[0]); 
  cflRateByDir[1] += std::abs(alphaL); 
  alphaL = 0.0625*((-0.25*alphaVpar[5])-0.4330127018922193*alphaVpar[3]-0.25*alphaVpar[2]+0.25*(alphaVpar[1]+alphaVpar[0])); 
  cflRateByDir[1] += std::abs(alphaL); 
  alphaL = 0.0625*((-0.25*alphaVpar[5])-0.4330127018922193*alphaVpar[3]+0.25*alphaVpar[2]-0.25*alphaVpar[1]+0.25*alphaVpar[0]); 
  cflRateByDir[1] += std::abs(alphaL); 
  alphaL = 0.0625*(0.25*alphaVpar[5]-0.4330127018922193*alphaVpar[3]+0.25*(alphaVpar[2]+alphaVpar[1]+alphaVpar[0])); 
  cflRateByDir[1] += std::abs(alphaL); 
  alphaL = 0.0625*(0.25*alphaVpar[5]-0.4330127018922193*alphaVpar[3]-0.25*(alphaVpar[2]+alphaVpar[1])+0.25*alphaVpar[0]); 
  cflRateByDir[1] += std::abs(alphaL); 
  alphaL = 0.0625*((-0.25*alphaVpar[5])-0.4330127018922193*alphaVpar[3]-0.25*alphaVpar[2]+0.25*(alphaVpar[1]+alphaVpar[0])); 
  ...
  alphaR = 0.0625*(0.25*alphaVpar[5]+0.4330127018922193*alphaVpar[3]-0.25*(alphaVpar[2]+alphaVpar[1])+0.25*alphaVpar[0]); 
  cflRateByDir[1] += std::abs(alphaR); 
  alphaR = 0.0625*((-0.25*alphaVpar[5])+0.4330127018922193*alphaVpar[3]-0.25*alphaVpar[2]+0.25*(alphaVpar[1]+alphaVpar[0])); 
  cflRateByDir[1] += std::abs(alphaR); 
  alphaR = 0.0625*((-0.25*alphaVpar[5])+0.4330127018922193*alphaVpar[3]+0.25*alphaVpar[2]-0.25*alphaVpar[1]+0.25*alphaVpar[0]); 
  cflRateByDir[1] += std::abs(alphaR); 
  alphaR = 0.0625*(0.25*alphaVpar[5]+0.4330127018922193*alphaVpar[3]+0.25*(alphaVpar[2]+alphaVpar[1]+alphaVpar[0])); 
  cflRateByDir[1] += std::abs(alphaR); 
  alphaR = 0.0625*(0.25*alphaVpar[5]+0.4330127018922193*alphaVpar[3]-0.25*(alphaVpar[2]+alphaVpar[1])+0.25*alphaVpar[0]); 
  cflRateByDir[1] += std::abs(alphaR); 
  alphaR = 0.0625*((-0.25*alphaVpar[5])+0.4330127018922193*alphaVpar[3]-0.25*alphaVpar[2]+0.25*(alphaVpar[1]+alphaVpar[0])); 
  ...
  cflRateByDir[1] += std::abs(alphaR); 
  // Evaluate alpha at left surface quadrature points. 
  alphaL = 0.0625*(0.25*alphaMu[5]-0.4330127018922193*alphaMu[4]-0.25*(alphaMu[2]+alphaMu[1])+0.25*alphaMu[0]); 
  cflRateByDir[2] += std::abs(alphaL); 
  alphaL = 0.0625*((-0.25*alphaMu[5])-0.4330127018922193*alphaMu[4]-0.25*alphaMu[2]+0.25*(alphaMu[1]+alphaMu[0])); 
  cflRateByDir[2] += std::abs(alphaL); 
  alphaL = 0.0625*((-0.25*alphaMu[5])-0.4330127018922193*alphaMu[4]+0.25*alphaMu[2]-0.25*alphaMu[1]+0.25*alphaMu[0]); 
  cflRateByDir[2] += std::abs(alphaL); 
  alphaL = 0.0625*(0.25*alphaMu[5]-0.4330127018922193*alphaMu[4]+0.25*(alphaMu[2]+alphaMu[1]+alphaMu[0])); 
  cflRateByDir[2] += std::abs(alphaL); 
  alphaL = 0.0625*(0.25*alphaMu[5]-0.4330127018922193*alphaMu[4]-0.25*(alphaMu[2]+alphaMu[1])+0.25*alphaMu[0]); 
  cflRateByDir[2] += std::abs(alphaL); 
  alphaL = 0.0625*((-0.25*alphaMu[5])-0.4330127018922193*alphaMu[4]-0.25*alphaMu[2]+0.25*(alphaMu[1]+alphaMu[0])); 
  ...
  cflRateByDir[2] += std::abs(alphaL); 
  // Evaluate alpha at right surface quadrature points. 
  alphaR = 0.0625*(0.25*alphaMu[5]+0.4330127018922193*alphaMu[4]-0.25*(alphaMu[2]+alphaMu[1])+0.25*alphaMu[0]); 
  cflRateByDir[2] += std::abs(alphaR); 
  alphaR = 0.0625*((-0.25*alphaMu[5])+0.4330127018922193*alphaMu[4]-0.25*alphaMu[2]+0.25*(alphaMu[1]+alphaMu[0])); 
  cflRateByDir[2] += std::abs(alphaR); 
  alphaR = 0.0625*((-0.25*alphaMu[5])+0.4330127018922193*alphaMu[4]+0.25*alphaMu[2]-0.25*alphaMu[1]+0.25*alphaMu[0]); 
  cflRateByDir[2] += std::abs(alphaR); 
  alphaR = 0.0625*(0.25*alphaMu[5]+0.4330127018922193*alphaMu[4]+0.25*(alphaMu[2]+alphaMu[1]+alphaMu[0])); 
  cflRateByDir[2] += std::abs(alphaR); 
  alphaR = 0.0625*(0.25*alphaMu[5]+0.4330127018922193*alphaMu[4]-0.25*(alphaMu[2]+alphaMu[1])+0.25*alphaMu[0]); 
  cflRateByDir[2] += std::abs(alphaR); 
  alphaR = 0.0625*((-0.25*alphaMu[5])+0.4330127018922193*alphaMu[4]-0.25*alphaMu[2]+0.25*(alphaMu[1]+alphaMu[0])); 
