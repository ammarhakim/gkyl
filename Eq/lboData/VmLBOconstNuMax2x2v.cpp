...
{ 
  ...
  alpha_drag[5] = (2.0*nuU[5]-4.0*w[3]*nu)*rdv21; 
  alpha_drag[6] = 2.0*nuU[6]*rdv21; 
  alpha_drag[7] = 2.0*nuU[7]*rdv21; 
...
{ 
  ...
  alpha_drag[15] = (2.0*nuU[15]-4.0*w[3]*nu)*rdv21; 
  alpha_drag[16] = 2.0*nuU[16]*rdv21; 
  alpha_drag[17] = 2.0*nuU[17]*rdv21; 
  alpha_drag[19] = -1.154700538379252*dxv[3]*nu*rdv21; 
  alpha_drag[20] = 2.0*nuU[18]*rdv21; 
  alpha_drag[26] = 2.0*nuU[19]*rdv21; 
  alpha_drag[27] = 2.0*nuU[20]*rdv21; 
...
{ 
  ...
  alpha_mid += std::abs(0.125*alpha_drag[0]-0.1397542485937369*(alpha_drag[12]+alpha_drag[11])); 
  alpha_drag[35] = (2.0*nuU[35]-4.0*w[3]*nu)*rdv21; 
  alpha_drag[36] = 2.0*nuU[36]*rdv21; 
  alpha_drag[37] = 2.0*nuU[37]*rdv21; 
  alpha_drag[39] = -1.154700538379252*dxv[3]*nu*rdv21; 
  alpha_drag[40] = 2.0*nuU[38]*rdv21; 
  alpha_drag[46] = 2.0*nuU[39]*rdv21; 
  alpha_drag[47] = 2.0*nuU[40]*rdv21; 
  alpha_drag[54] = 2.0*nuU[41]*rdv21; 
  alpha_drag[55] = 2.0*nuU[42]*rdv21; 
  alpha_drag[66] = 2.0*nuU[43]*rdv21; 
  alpha_drag[67] = 2.0*nuU[44]*rdv21; 
