...
{ 
  ...
  Ghat[0] = ((-0.5412658773652741*nuVtSqSum[3]*fr[16])-0.5412658773652741*nuVtSqSum[3]*fl[16]-0.5412658773652741*nuVtSqSum[2]*fr[8]-0.5412658773652741*nuVtSqSum[2]*fl[8]-0.5412658773652741*nuVtSqSum[1]*fr[7]-0.5412658773652741*nuVtSqSum[1]*fl[7]+0.5625*nuVtSqSum[3]*fr[6]-0.5625*nuVtSqSum[3]*fl[6]-0.5412658773652741*nuVtSqSum[0]*fr[3]-0.5412658773652741*nuVtSqSum[0]*fl[3]+0.5625*fr[2]*nuVtSqSum[2]-0.5625*fl[2]*nuVtSqSum[2]+0.5625*fr[1]*nuVtSqSum[1]-0.5625*fl[1]*nuVtSqSum[1]+0.5625*fr[0]*nuVtSqSum[0]-0.5625*fl[0]*nuVtSqSum[0])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[16]+0.25*favg[6])+alphaDrag[2]*(0.4330127018922193*favg[8]+0.25*favg[2])+alphaDrag[1]*(0.4330127018922193*favg[7]+0.25*favg[1])-0.8660254037844386*fjump[3]+alphaDrag[0]*(0.4330127018922193*favg[3]+0.25*favg[0])-0.5*fjump[0]; 
  Ghat[1] = ((-0.5412658773652741*nuVtSqSum[2]*fr[16])-0.5412658773652741*nuVtSqSum[2]*fl[16]-0.5412658773652741*nuVtSqSum[3]*fr[8]-0.5412658773652741*nuVtSqSum[3]*fl[8]-0.5412658773652741*nuVtSqSum[0]*fr[7]-0.5412658773652741*nuVtSqSum[0]*fl[7]+0.5625*nuVtSqSum[2]*fr[6]-0.5625*nuVtSqSum[2]*fl[6]+0.5625*fr[2]*nuVtSqSum[3]-0.5625*fl[2]*nuVtSqSum[3]-0.5412658773652741*nuVtSqSum[1]*fr[3]-0.5412658773652741*nuVtSqSum[1]*fl[3]+0.5625*fr[0]*nuVtSqSum[1]-0.5625*fl[0]*nuVtSqSum[1]+0.5625*nuVtSqSum[0]*fr[1]-0.5625*nuVtSqSum[0]*fl[1])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[16]+0.25*favg[6])+alphaDrag[3]*(0.4330127018922193*favg[8]+0.25*favg[2])-0.8660254037844386*fjump[7]+alphaDrag[0]*(0.4330127018922193*favg[7]+0.25*favg[1])+alphaDrag[1]*(0.4330127018922193*favg[3]+0.25*favg[0])-0.5*fjump[1]; 
  Ghat[2] = ((-0.5412658773652741*nuVtSqSum[1]*fr[16])-0.5412658773652741*nuVtSqSum[1]*fl[16]-0.5412658773652741*nuVtSqSum[0]*fr[8]-0.5412658773652741*nuVtSqSum[0]*fl[8]-0.5412658773652741*nuVtSqSum[3]*fr[7]-0.5412658773652741*nuVtSqSum[3]*fl[7]+0.5625*nuVtSqSum[1]*fr[6]-0.5625*nuVtSqSum[1]*fl[6]+0.5625*fr[1]*nuVtSqSum[3]-0.5625*fl[1]*nuVtSqSum[3]-0.5412658773652741*nuVtSqSum[2]*fr[3]-0.5412658773652741*nuVtSqSum[2]*fl[3]+0.5625*fr[0]*nuVtSqSum[2]-0.5625*fl[0]*nuVtSqSum[2]+0.5625*nuVtSqSum[0]*fr[2]-0.5625*nuVtSqSum[0]*fl[2])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[16]+0.25*favg[6])-0.8660254037844386*fjump[8]+alphaDrag[0]*(0.4330127018922193*favg[8]+0.25*favg[2])+alphaDrag[3]*(0.4330127018922193*favg[7]+0.25*favg[1])+alphaDrag[2]*(0.4330127018922193*favg[3]+0.25*favg[0])-0.5*fjump[2]; 
  Ghat[4] = ((-0.5412658773652741*nuVtSqSum[3]*fr[26])-0.5412658773652741*nuVtSqSum[3]*fl[26]-0.5412658773652741*nuVtSqSum[2]*fr[19]-0.5412658773652741*nuVtSqSum[2]*fl[19]-0.5412658773652741*nuVtSqSum[1]*fr[18]-0.5412658773652741*nuVtSqSum[1]*fl[18]+0.5625*nuVtSqSum[3]*fr[17]-0.5625*nuVtSqSum[3]*fl[17]-0.5412658773652741*nuVtSqSum[0]*fr[11]-0.5412658773652741*nuVtSqSum[0]*fl[11]+0.5625*nuVtSqSum[2]*fr[10]-0.5625*nuVtSqSum[2]*fl[10]+0.5625*nuVtSqSum[1]*fr[9]-0.5625*nuVtSqSum[1]*fl[9]+0.5625*nuVtSqSum[0]*fr[4]-0.5625*nuVtSqSum[0]*fl[4])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[26]+0.25*favg[17])+alphaDrag[2]*(0.4330127018922193*favg[19]+0.25*favg[10])+alphaDrag[1]*(0.4330127018922193*favg[18]+0.25*favg[9])-0.8660254037844386*fjump[11]+alphaDrag[0]*(0.4330127018922193*favg[11]+0.25*favg[4])-0.5*fjump[4]; 
  Ghat[5] = ((-0.5412658773652741*nuVtSqSum[3]*fr[27])-0.5412658773652741*nuVtSqSum[3]*fl[27]-0.5412658773652741*nuVtSqSum[2]*fr[22]-0.5412658773652741*nuVtSqSum[2]*fl[22]-0.5412658773652741*nuVtSqSum[1]*fr[21]-0.5412658773652741*nuVtSqSum[1]*fl[21]+0.5625*nuVtSqSum[3]*fr[20]-0.5625*nuVtSqSum[3]*fl[20]-0.5412658773652741*nuVtSqSum[0]*fr[14]-0.5412658773652741*nuVtSqSum[0]*fl[14]+0.5625*nuVtSqSum[2]*fr[13]-0.5625*nuVtSqSum[2]*fl[13]+0.5625*nuVtSqSum[1]*fr[12]-0.5625*nuVtSqSum[1]*fl[12]+0.5625*nuVtSqSum[0]*fr[5]-0.5625*nuVtSqSum[0]*fl[5])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[27]+0.25*favg[20])+alphaDrag[2]*(0.4330127018922193*favg[22]+0.25*favg[13])+alphaDrag[1]*(0.4330127018922193*favg[21]+0.25*favg[12])-0.8660254037844386*fjump[14]+alphaDrag[0]*(0.4330127018922193*favg[14]+0.25*favg[5])-0.5*fjump[5]; 
  Ghat[6] = ((-0.5412658773652741*nuVtSqSum[0]*fr[16])-0.5412658773652741*nuVtSqSum[0]*fl[16]-0.5412658773652741*nuVtSqSum[1]*fr[8]-0.5412658773652741*nuVtSqSum[1]*fl[8]-0.5412658773652741*nuVtSqSum[2]*fr[7]-0.5412658773652741*nuVtSqSum[2]*fl[7]+0.5625*nuVtSqSum[0]*fr[6]-0.5625*nuVtSqSum[0]*fl[6]-0.5412658773652741*fr[3]*nuVtSqSum[3]-0.5412658773652741*fl[3]*nuVtSqSum[3]+0.5625*fr[0]*nuVtSqSum[3]-0.5625*fl[0]*nuVtSqSum[3]+0.5625*fr[1]*nuVtSqSum[2]-0.5625*fl[1]*nuVtSqSum[2]+0.5625*nuVtSqSum[1]*fr[2]-0.5625*nuVtSqSum[1]*fl[2])*rdv2L-0.8660254037844386*fjump[16]+alphaDrag[0]*(0.4330127018922193*favg[16]+0.25*favg[6])+alphaDrag[1]*(0.4330127018922193*favg[8]+0.25*favg[2])+alphaDrag[2]*(0.4330127018922193*favg[7]+0.25*favg[1])-0.5*fjump[6]+alphaDrag[3]*(0.4330127018922193*favg[3]+0.25*favg[0]); 
  Ghat[9] = ((-0.5412658773652741*nuVtSqSum[2]*fr[26])-0.5412658773652741*nuVtSqSum[2]*fl[26]-0.5412658773652741*nuVtSqSum[3]*fr[19]-0.5412658773652741*nuVtSqSum[3]*fl[19]-0.5412658773652741*nuVtSqSum[0]*fr[18]-0.5412658773652741*nuVtSqSum[0]*fl[18]+0.5625*nuVtSqSum[2]*fr[17]-0.5625*nuVtSqSum[2]*fl[17]-0.5412658773652741*nuVtSqSum[1]*fr[11]-0.5412658773652741*nuVtSqSum[1]*fl[11]+0.5625*nuVtSqSum[3]*fr[10]-0.5625*nuVtSqSum[3]*fl[10]+0.5625*nuVtSqSum[0]*fr[9]-0.5625*nuVtSqSum[0]*fl[9]+0.5625*nuVtSqSum[1]*fr[4]-0.5625*nuVtSqSum[1]*fl[4])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[26]+0.25*favg[17])+alphaDrag[3]*(0.4330127018922193*favg[19]+0.25*favg[10])-0.8660254037844386*fjump[18]+alphaDrag[0]*(0.4330127018922193*favg[18]+0.25*favg[9])+alphaDrag[1]*(0.4330127018922193*favg[11]+0.25*favg[4])-0.5*fjump[9]; 
  Ghat[10] = ((-0.5412658773652741*nuVtSqSum[1]*fr[26])-0.5412658773652741*nuVtSqSum[1]*fl[26]-0.5412658773652741*nuVtSqSum[0]*fr[19]-0.5412658773652741*nuVtSqSum[0]*fl[19]-0.5412658773652741*nuVtSqSum[3]*fr[18]-0.5412658773652741*nuVtSqSum[3]*fl[18]+0.5625*nuVtSqSum[1]*fr[17]-0.5625*nuVtSqSum[1]*fl[17]-0.5412658773652741*nuVtSqSum[2]*fr[11]-0.5412658773652741*nuVtSqSum[2]*fl[11]+0.5625*nuVtSqSum[0]*fr[10]-0.5625*nuVtSqSum[0]*fl[10]+0.5625*nuVtSqSum[3]*fr[9]-0.5625*nuVtSqSum[3]*fl[9]+0.5625*nuVtSqSum[2]*fr[4]-0.5625*nuVtSqSum[2]*fl[4])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[26]+0.25*favg[17])-0.8660254037844386*fjump[19]+alphaDrag[0]*(0.4330127018922193*favg[19]+0.25*favg[10])+alphaDrag[3]*(0.4330127018922193*favg[18]+0.25*favg[9])+alphaDrag[2]*(0.4330127018922193*favg[11]+0.25*favg[4])-0.5*fjump[10]; 
  Ghat[12] = ((-0.5412658773652741*nuVtSqSum[2]*fr[27])-0.5412658773652741*nuVtSqSum[2]*fl[27]-0.5412658773652741*nuVtSqSum[3]*fr[22]-0.5412658773652741*nuVtSqSum[3]*fl[22]-0.5412658773652741*nuVtSqSum[0]*fr[21]-0.5412658773652741*nuVtSqSum[0]*fl[21]+0.5625*nuVtSqSum[2]*fr[20]-0.5625*nuVtSqSum[2]*fl[20]-0.5412658773652741*nuVtSqSum[1]*fr[14]-0.5412658773652741*nuVtSqSum[1]*fl[14]+0.5625*nuVtSqSum[3]*fr[13]-0.5625*nuVtSqSum[3]*fl[13]+0.5625*nuVtSqSum[0]*fr[12]-0.5625*nuVtSqSum[0]*fl[12]+0.5625*nuVtSqSum[1]*fr[5]-0.5625*nuVtSqSum[1]*fl[5])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[27]+0.25*favg[20])+alphaDrag[3]*(0.4330127018922193*favg[22]+0.25*favg[13])-0.8660254037844386*fjump[21]+alphaDrag[0]*(0.4330127018922193*favg[21]+0.25*favg[12])+alphaDrag[1]*(0.4330127018922193*favg[14]+0.25*favg[5])-0.5*fjump[12]; 
  Ghat[13] = ((-0.5412658773652741*nuVtSqSum[1]*fr[27])-0.5412658773652741*nuVtSqSum[1]*fl[27]-0.5412658773652741*nuVtSqSum[0]*fr[22]-0.5412658773652741*nuVtSqSum[0]*fl[22]-0.5412658773652741*nuVtSqSum[3]*fr[21]-0.5412658773652741*nuVtSqSum[3]*fl[21]+0.5625*nuVtSqSum[1]*fr[20]-0.5625*nuVtSqSum[1]*fl[20]-0.5412658773652741*nuVtSqSum[2]*fr[14]-0.5412658773652741*nuVtSqSum[2]*fl[14]+0.5625*nuVtSqSum[0]*fr[13]-0.5625*nuVtSqSum[0]*fl[13]+0.5625*nuVtSqSum[3]*fr[12]-0.5625*nuVtSqSum[3]*fl[12]+0.5625*nuVtSqSum[2]*fr[5]-0.5625*nuVtSqSum[2]*fl[5])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[27]+0.25*favg[20])-0.8660254037844386*fjump[22]+alphaDrag[0]*(0.4330127018922193*favg[22]+0.25*favg[13])+alphaDrag[3]*(0.4330127018922193*favg[21]+0.25*favg[12])+alphaDrag[2]*(0.4330127018922193*favg[14]+0.25*favg[5])-0.5*fjump[13]; 
  Ghat[15] = ((-0.5412658773652741*nuVtSqSum[3]*fr[31])-0.5412658773652741*nuVtSqSum[3]*fl[31]-0.5412658773652741*nuVtSqSum[2]*fr[30]-0.5412658773652741*nuVtSqSum[2]*fl[30]-0.5412658773652741*nuVtSqSum[1]*fr[29]-0.5412658773652741*nuVtSqSum[1]*fl[29]+0.5625*nuVtSqSum[3]*fr[28]-0.5625*nuVtSqSum[3]*fl[28]-0.5412658773652741*nuVtSqSum[0]*fr[25]-0.5412658773652741*nuVtSqSum[0]*fl[25]+0.5625*nuVtSqSum[2]*fr[24]-0.5625*nuVtSqSum[2]*fl[24]+0.5625*nuVtSqSum[1]*fr[23]-0.5625*nuVtSqSum[1]*fl[23]+0.5625*nuVtSqSum[0]*fr[15]-0.5625*nuVtSqSum[0]*fl[15])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[31]+0.25*favg[28])+alphaDrag[2]*(0.4330127018922193*favg[30]+0.25*favg[24])+alphaDrag[1]*(0.4330127018922193*favg[29]+0.25*favg[23])-0.8660254037844386*fjump[25]+alphaDrag[0]*(0.4330127018922193*favg[25]+0.25*favg[15])-0.5*fjump[15]; 
  Ghat[17] = ((-0.5412658773652741*nuVtSqSum[0]*fr[26])-0.5412658773652741*nuVtSqSum[0]*fl[26]-0.5412658773652741*nuVtSqSum[1]*fr[19]-0.5412658773652741*nuVtSqSum[1]*fl[19]-0.5412658773652741*nuVtSqSum[2]*fr[18]-0.5412658773652741*nuVtSqSum[2]*fl[18]+0.5625*nuVtSqSum[0]*fr[17]-0.5625*nuVtSqSum[0]*fl[17]-0.5412658773652741*nuVtSqSum[3]*fr[11]-0.5412658773652741*nuVtSqSum[3]*fl[11]+0.5625*nuVtSqSum[1]*fr[10]-0.5625*nuVtSqSum[1]*fl[10]+0.5625*nuVtSqSum[2]*fr[9]-0.5625*nuVtSqSum[2]*fl[9]+0.5625*nuVtSqSum[3]*fr[4]-0.5625*nuVtSqSum[3]*fl[4])*rdv2L-0.8660254037844386*fjump[26]+alphaDrag[0]*(0.4330127018922193*favg[26]+0.25*favg[17])+alphaDrag[1]*(0.4330127018922193*favg[19]+0.25*favg[10])+alphaDrag[2]*(0.4330127018922193*favg[18]+0.25*favg[9])-0.5*fjump[17]+alphaDrag[3]*(0.4330127018922193*favg[11]+0.25*favg[4]); 
  Ghat[20] = ((-0.5412658773652741*nuVtSqSum[0]*fr[27])-0.5412658773652741*nuVtSqSum[0]*fl[27]-0.5412658773652741*nuVtSqSum[1]*fr[22]-0.5412658773652741*nuVtSqSum[1]*fl[22]-0.5412658773652741*nuVtSqSum[2]*fr[21]-0.5412658773652741*nuVtSqSum[2]*fl[21]+0.5625*nuVtSqSum[0]*fr[20]-0.5625*nuVtSqSum[0]*fl[20]-0.5412658773652741*nuVtSqSum[3]*fr[14]-0.5412658773652741*nuVtSqSum[3]*fl[14]+0.5625*nuVtSqSum[1]*fr[13]-0.5625*nuVtSqSum[1]*fl[13]+0.5625*nuVtSqSum[2]*fr[12]-0.5625*nuVtSqSum[2]*fl[12]+0.5625*nuVtSqSum[3]*fr[5]-0.5625*nuVtSqSum[3]*fl[5])*rdv2L-0.8660254037844386*fjump[27]+alphaDrag[0]*(0.4330127018922193*favg[27]+0.25*favg[20])+alphaDrag[1]*(0.4330127018922193*favg[22]+0.25*favg[13])+alphaDrag[2]*(0.4330127018922193*favg[21]+0.25*favg[12])-0.5*fjump[20]+alphaDrag[3]*(0.4330127018922193*favg[14]+0.25*favg[5]); 
  Ghat[23] = ((-0.5412658773652741*nuVtSqSum[2]*fr[31])-0.5412658773652741*nuVtSqSum[2]*fl[31]-0.5412658773652741*nuVtSqSum[3]*fr[30]-0.5412658773652741*nuVtSqSum[3]*fl[30]-0.5412658773652741*nuVtSqSum[0]*fr[29]-0.5412658773652741*nuVtSqSum[0]*fl[29]+0.5625*nuVtSqSum[2]*fr[28]-0.5625*nuVtSqSum[2]*fl[28]-0.5412658773652741*nuVtSqSum[1]*fr[25]-0.5412658773652741*nuVtSqSum[1]*fl[25]+0.5625*nuVtSqSum[3]*fr[24]-0.5625*nuVtSqSum[3]*fl[24]+0.5625*nuVtSqSum[0]*fr[23]-0.5625*nuVtSqSum[0]*fl[23]+0.5625*nuVtSqSum[1]*fr[15]-0.5625*nuVtSqSum[1]*fl[15])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[31]+0.25*favg[28])+alphaDrag[3]*(0.4330127018922193*favg[30]+0.25*favg[24])-0.8660254037844386*fjump[29]+alphaDrag[0]*(0.4330127018922193*favg[29]+0.25*favg[23])+alphaDrag[1]*(0.4330127018922193*favg[25]+0.25*favg[15])-0.5*fjump[23]; 
  Ghat[24] = ((-0.5412658773652741*nuVtSqSum[1]*fr[31])-0.5412658773652741*nuVtSqSum[1]*fl[31]-0.5412658773652741*nuVtSqSum[0]*fr[30]-0.5412658773652741*nuVtSqSum[0]*fl[30]-0.5412658773652741*nuVtSqSum[3]*fr[29]-0.5412658773652741*nuVtSqSum[3]*fl[29]+0.5625*nuVtSqSum[1]*fr[28]-0.5625*nuVtSqSum[1]*fl[28]-0.5412658773652741*nuVtSqSum[2]*fr[25]-0.5412658773652741*nuVtSqSum[2]*fl[25]+0.5625*nuVtSqSum[0]*fr[24]-0.5625*nuVtSqSum[0]*fl[24]+0.5625*nuVtSqSum[3]*fr[23]-0.5625*nuVtSqSum[3]*fl[23]+0.5625*nuVtSqSum[2]*fr[15]-0.5625*nuVtSqSum[2]*fl[15])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[31]+0.25*favg[28])-0.8660254037844386*fjump[30]+alphaDrag[0]*(0.4330127018922193*favg[30]+0.25*favg[24])+alphaDrag[3]*(0.4330127018922193*favg[29]+0.25*favg[23])+alphaDrag[2]*(0.4330127018922193*favg[25]+0.25*favg[15])-0.5*fjump[24]; 
  Ghat[28] = ((-0.5412658773652741*nuVtSqSum[0]*fr[31])-0.5412658773652741*nuVtSqSum[0]*fl[31]-0.5412658773652741*nuVtSqSum[1]*fr[30]-0.5412658773652741*nuVtSqSum[1]*fl[30]-0.5412658773652741*nuVtSqSum[2]*fr[29]-0.5412658773652741*nuVtSqSum[2]*fl[29]+0.5625*nuVtSqSum[0]*fr[28]-0.5625*nuVtSqSum[0]*fl[28]-0.5412658773652741*nuVtSqSum[3]*fr[25]-0.5412658773652741*nuVtSqSum[3]*fl[25]+0.5625*nuVtSqSum[1]*fr[24]-0.5625*nuVtSqSum[1]*fl[24]+0.5625*nuVtSqSum[2]*fr[23]-0.5625*nuVtSqSum[2]*fl[23]+0.5625*nuVtSqSum[3]*fr[15]-0.5625*nuVtSqSum[3]*fl[15])*rdv2L-0.8660254037844386*fjump[31]+alphaDrag[0]*(0.4330127018922193*favg[31]+0.25*favg[28])+alphaDrag[1]*(0.4330127018922193*favg[30]+0.25*favg[24])+alphaDrag[2]*(0.4330127018922193*favg[29]+0.25*favg[23])-0.5*fjump[28]+alphaDrag[3]*(0.4330127018922193*favg[25]+0.25*favg[15]); 
...
{ 
  ...
  Ghat[0] = ((-0.5412658773652741*nuVtSqSum[3]*fr[17])-0.5412658773652741*nuVtSqSum[3]*fl[17]-0.5412658773652741*nuVtSqSum[2]*fr[10]-0.5412658773652741*nuVtSqSum[2]*fl[10]-0.5412658773652741*nuVtSqSum[1]*fr[9]-0.5412658773652741*nuVtSqSum[1]*fl[9]+0.5625*nuVtSqSum[3]*fr[6]-0.5625*nuVtSqSum[3]*fl[6]-0.5412658773652741*nuVtSqSum[0]*fr[4]-0.5412658773652741*nuVtSqSum[0]*fl[4]+0.5625*fr[2]*nuVtSqSum[2]-0.5625*fl[2]*nuVtSqSum[2]+0.5625*fr[1]*nuVtSqSum[1]-0.5625*fl[1]*nuVtSqSum[1]+0.5625*fr[0]*nuVtSqSum[0]-0.5625*fl[0]*nuVtSqSum[0])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[17]+0.25*favg[6])+alphaDrag[2]*(0.4330127018922193*favg[10]+0.25*favg[2])+alphaDrag[1]*(0.4330127018922193*favg[9]+0.25*favg[1])-0.8660254037844386*fjump[4]+alphaDrag[0]*(0.4330127018922193*favg[4]+0.25*favg[0])-0.5*fjump[0]; 
  Ghat[1] = ((-0.5412658773652741*nuVtSqSum[2]*fr[17])-0.5412658773652741*nuVtSqSum[2]*fl[17]-0.5412658773652741*nuVtSqSum[3]*fr[10]-0.5412658773652741*nuVtSqSum[3]*fl[10]-0.5412658773652741*nuVtSqSum[0]*fr[9]-0.5412658773652741*nuVtSqSum[0]*fl[9]+0.5625*nuVtSqSum[2]*fr[6]-0.5625*nuVtSqSum[2]*fl[6]-0.5412658773652741*nuVtSqSum[1]*fr[4]-0.5412658773652741*nuVtSqSum[1]*fl[4]+0.5625*fr[2]*nuVtSqSum[3]-0.5625*fl[2]*nuVtSqSum[3]+0.5625*fr[0]*nuVtSqSum[1]-0.5625*fl[0]*nuVtSqSum[1]+0.5625*nuVtSqSum[0]*fr[1]-0.5625*nuVtSqSum[0]*fl[1])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[17]+0.25*favg[6])+alphaDrag[3]*(0.4330127018922193*favg[10]+0.25*favg[2])-0.8660254037844386*fjump[9]+alphaDrag[0]*(0.4330127018922193*favg[9]+0.25*favg[1])+alphaDrag[1]*(0.4330127018922193*favg[4]+0.25*favg[0])-0.5*fjump[1]; 
  Ghat[2] = ((-0.5412658773652741*nuVtSqSum[1]*fr[17])-0.5412658773652741*nuVtSqSum[1]*fl[17]-0.5412658773652741*nuVtSqSum[0]*fr[10]-0.5412658773652741*nuVtSqSum[0]*fl[10]-0.5412658773652741*nuVtSqSum[3]*fr[9]-0.5412658773652741*nuVtSqSum[3]*fl[9]+0.5625*nuVtSqSum[1]*fr[6]-0.5625*nuVtSqSum[1]*fl[6]-0.5412658773652741*nuVtSqSum[2]*fr[4]-0.5412658773652741*nuVtSqSum[2]*fl[4]+0.5625*fr[1]*nuVtSqSum[3]-0.5625*fl[1]*nuVtSqSum[3]+0.5625*fr[0]*nuVtSqSum[2]-0.5625*fl[0]*nuVtSqSum[2]+0.5625*nuVtSqSum[0]*fr[2]-0.5625*nuVtSqSum[0]*fl[2])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[17]+0.25*favg[6])-0.8660254037844386*fjump[10]+alphaDrag[0]*(0.4330127018922193*favg[10]+0.25*favg[2])+alphaDrag[3]*(0.4330127018922193*favg[9]+0.25*favg[1])+alphaDrag[2]*(0.4330127018922193*favg[4]+0.25*favg[0])-0.5*fjump[2]; 
  Ghat[3] = ((-0.5412658773652741*nuVtSqSum[3]*fr[26])-0.5412658773652741*nuVtSqSum[3]*fl[26]-0.5412658773652741*nuVtSqSum[2]*fr[19]-0.5412658773652741*nuVtSqSum[2]*fl[19]-0.5412658773652741*nuVtSqSum[1]*fr[18]-0.5412658773652741*nuVtSqSum[1]*fl[18]+0.5625*nuVtSqSum[3]*fr[16]-0.5625*nuVtSqSum[3]*fl[16]-0.5412658773652741*nuVtSqSum[0]*fr[11]-0.5412658773652741*nuVtSqSum[0]*fl[11]+0.5625*nuVtSqSum[2]*fr[8]-0.5625*nuVtSqSum[2]*fl[8]+0.5625*nuVtSqSum[1]*fr[7]-0.5625*nuVtSqSum[1]*fl[7]+0.5625*nuVtSqSum[0]*fr[3]-0.5625*nuVtSqSum[0]*fl[3])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[26]+0.25*favg[16])+alphaDrag[2]*(0.4330127018922193*favg[19]+0.25*favg[8])+alphaDrag[1]*(0.4330127018922193*favg[18]+0.25*favg[7])-0.8660254037844386*fjump[11]+alphaDrag[0]*(0.4330127018922193*favg[11]+0.25*favg[3])-0.5*fjump[3]; 
  Ghat[5] = ((-0.5412658773652741*nuVtSqSum[3]*fr[28])-0.5412658773652741*nuVtSqSum[3]*fl[28]-0.5412658773652741*nuVtSqSum[2]*fr[24]-0.5412658773652741*nuVtSqSum[2]*fl[24]-0.5412658773652741*nuVtSqSum[1]*fr[23]-0.5412658773652741*nuVtSqSum[1]*fl[23]+0.5625*nuVtSqSum[3]*fr[20]-0.5625*nuVtSqSum[3]*fl[20]-0.5412658773652741*nuVtSqSum[0]*fr[15]-0.5412658773652741*nuVtSqSum[0]*fl[15]+0.5625*nuVtSqSum[2]*fr[13]-0.5625*nuVtSqSum[2]*fl[13]+0.5625*nuVtSqSum[1]*fr[12]-0.5625*nuVtSqSum[1]*fl[12]+0.5625*nuVtSqSum[0]*fr[5]-0.5625*nuVtSqSum[0]*fl[5])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[28]+0.25*favg[20])+alphaDrag[2]*(0.4330127018922193*favg[24]+0.25*favg[13])+alphaDrag[1]*(0.4330127018922193*favg[23]+0.25*favg[12])-0.8660254037844386*fjump[15]+alphaDrag[0]*(0.4330127018922193*favg[15]+0.25*favg[5])-0.5*fjump[5]; 
  Ghat[6] = ((-0.5412658773652741*nuVtSqSum[0]*fr[17])-0.5412658773652741*nuVtSqSum[0]*fl[17]-0.5412658773652741*nuVtSqSum[1]*fr[10]-0.5412658773652741*nuVtSqSum[1]*fl[10]-0.5412658773652741*nuVtSqSum[2]*fr[9]-0.5412658773652741*nuVtSqSum[2]*fl[9]+0.5625*nuVtSqSum[0]*fr[6]-0.5625*nuVtSqSum[0]*fl[6]-0.5412658773652741*nuVtSqSum[3]*fr[4]-0.5412658773652741*nuVtSqSum[3]*fl[4]+0.5625*fr[0]*nuVtSqSum[3]-0.5625*fl[0]*nuVtSqSum[3]+0.5625*fr[1]*nuVtSqSum[2]-0.5625*fl[1]*nuVtSqSum[2]+0.5625*nuVtSqSum[1]*fr[2]-0.5625*nuVtSqSum[1]*fl[2])*rdv2L-0.8660254037844386*fjump[17]+alphaDrag[0]*(0.4330127018922193*favg[17]+0.25*favg[6])+alphaDrag[1]*(0.4330127018922193*favg[10]+0.25*favg[2])+alphaDrag[2]*(0.4330127018922193*favg[9]+0.25*favg[1])-0.5*fjump[6]+alphaDrag[3]*(0.4330127018922193*favg[4]+0.25*favg[0]); 
  Ghat[7] = ((-0.5412658773652741*nuVtSqSum[2]*fr[26])-0.5412658773652741*nuVtSqSum[2]*fl[26]-0.5412658773652741*nuVtSqSum[3]*fr[19]-0.5412658773652741*nuVtSqSum[3]*fl[19]-0.5412658773652741*nuVtSqSum[0]*fr[18]-0.5412658773652741*nuVtSqSum[0]*fl[18]+0.5625*nuVtSqSum[2]*fr[16]-0.5625*nuVtSqSum[2]*fl[16]-0.5412658773652741*nuVtSqSum[1]*fr[11]-0.5412658773652741*nuVtSqSum[1]*fl[11]+0.5625*nuVtSqSum[3]*fr[8]-0.5625*nuVtSqSum[3]*fl[8]+0.5625*nuVtSqSum[0]*fr[7]-0.5625*nuVtSqSum[0]*fl[7]+0.5625*nuVtSqSum[1]*fr[3]-0.5625*nuVtSqSum[1]*fl[3])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[26]+0.25*favg[16])+alphaDrag[3]*(0.4330127018922193*favg[19]+0.25*favg[8])-0.8660254037844386*fjump[18]+alphaDrag[0]*(0.4330127018922193*favg[18]+0.25*favg[7])+alphaDrag[1]*(0.4330127018922193*favg[11]+0.25*favg[3])-0.5*fjump[7]; 
  Ghat[8] = ((-0.5412658773652741*nuVtSqSum[1]*fr[26])-0.5412658773652741*nuVtSqSum[1]*fl[26]-0.5412658773652741*nuVtSqSum[0]*fr[19]-0.5412658773652741*nuVtSqSum[0]*fl[19]-0.5412658773652741*nuVtSqSum[3]*fr[18]-0.5412658773652741*nuVtSqSum[3]*fl[18]+0.5625*nuVtSqSum[1]*fr[16]-0.5625*nuVtSqSum[1]*fl[16]-0.5412658773652741*nuVtSqSum[2]*fr[11]-0.5412658773652741*nuVtSqSum[2]*fl[11]+0.5625*nuVtSqSum[0]*fr[8]-0.5625*nuVtSqSum[0]*fl[8]+0.5625*nuVtSqSum[3]*fr[7]-0.5625*nuVtSqSum[3]*fl[7]+0.5625*nuVtSqSum[2]*fr[3]-0.5625*nuVtSqSum[2]*fl[3])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[26]+0.25*favg[16])-0.8660254037844386*fjump[19]+alphaDrag[0]*(0.4330127018922193*favg[19]+0.25*favg[8])+alphaDrag[3]*(0.4330127018922193*favg[18]+0.25*favg[7])+alphaDrag[2]*(0.4330127018922193*favg[11]+0.25*favg[3])-0.5*fjump[8]; 
  Ghat[12] = ((-0.5412658773652741*nuVtSqSum[2]*fr[28])-0.5412658773652741*nuVtSqSum[2]*fl[28]-0.5412658773652741*nuVtSqSum[3]*fr[24]-0.5412658773652741*nuVtSqSum[3]*fl[24]-0.5412658773652741*nuVtSqSum[0]*fr[23]-0.5412658773652741*nuVtSqSum[0]*fl[23]+0.5625*nuVtSqSum[2]*fr[20]-0.5625*nuVtSqSum[2]*fl[20]-0.5412658773652741*nuVtSqSum[1]*fr[15]-0.5412658773652741*nuVtSqSum[1]*fl[15]+0.5625*nuVtSqSum[3]*fr[13]-0.5625*nuVtSqSum[3]*fl[13]+0.5625*nuVtSqSum[0]*fr[12]-0.5625*nuVtSqSum[0]*fl[12]+0.5625*nuVtSqSum[1]*fr[5]-0.5625*nuVtSqSum[1]*fl[5])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[28]+0.25*favg[20])+alphaDrag[3]*(0.4330127018922193*favg[24]+0.25*favg[13])-0.8660254037844386*fjump[23]+alphaDrag[0]*(0.4330127018922193*favg[23]+0.25*favg[12])+alphaDrag[1]*(0.4330127018922193*favg[15]+0.25*favg[5])-0.5*fjump[12]; 
  Ghat[13] = ((-0.5412658773652741*nuVtSqSum[1]*fr[28])-0.5412658773652741*nuVtSqSum[1]*fl[28]-0.5412658773652741*nuVtSqSum[0]*fr[24]-0.5412658773652741*nuVtSqSum[0]*fl[24]-0.5412658773652741*nuVtSqSum[3]*fr[23]-0.5412658773652741*nuVtSqSum[3]*fl[23]+0.5625*nuVtSqSum[1]*fr[20]-0.5625*nuVtSqSum[1]*fl[20]-0.5412658773652741*nuVtSqSum[2]*fr[15]-0.5412658773652741*nuVtSqSum[2]*fl[15]+0.5625*nuVtSqSum[0]*fr[13]-0.5625*nuVtSqSum[0]*fl[13]+0.5625*nuVtSqSum[3]*fr[12]-0.5625*nuVtSqSum[3]*fl[12]+0.5625*nuVtSqSum[2]*fr[5]-0.5625*nuVtSqSum[2]*fl[5])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[28]+0.25*favg[20])-0.8660254037844386*fjump[24]+alphaDrag[0]*(0.4330127018922193*favg[24]+0.25*favg[13])+alphaDrag[3]*(0.4330127018922193*favg[23]+0.25*favg[12])+alphaDrag[2]*(0.4330127018922193*favg[15]+0.25*favg[5])-0.5*fjump[13]; 
  Ghat[14] = ((-0.5412658773652741*nuVtSqSum[3]*fr[31])-0.5412658773652741*nuVtSqSum[3]*fl[31]-0.5412658773652741*nuVtSqSum[2]*fr[30]-0.5412658773652741*nuVtSqSum[2]*fl[30]-0.5412658773652741*nuVtSqSum[1]*fr[29]-0.5412658773652741*nuVtSqSum[1]*fl[29]+0.5625*nuVtSqSum[3]*fr[27]-0.5625*nuVtSqSum[3]*fl[27]-0.5412658773652741*nuVtSqSum[0]*fr[25]-0.5412658773652741*nuVtSqSum[0]*fl[25]+0.5625*nuVtSqSum[2]*fr[22]-0.5625*nuVtSqSum[2]*fl[22]+0.5625*nuVtSqSum[1]*fr[21]-0.5625*nuVtSqSum[1]*fl[21]+0.5625*nuVtSqSum[0]*fr[14]-0.5625*nuVtSqSum[0]*fl[14])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[31]+0.25*favg[27])+alphaDrag[2]*(0.4330127018922193*favg[30]+0.25*favg[22])+alphaDrag[1]*(0.4330127018922193*favg[29]+0.25*favg[21])-0.8660254037844386*fjump[25]+alphaDrag[0]*(0.4330127018922193*favg[25]+0.25*favg[14])-0.5*fjump[14]; 
  Ghat[16] = ((-0.5412658773652741*nuVtSqSum[0]*fr[26])-0.5412658773652741*nuVtSqSum[0]*fl[26]-0.5412658773652741*nuVtSqSum[1]*fr[19]-0.5412658773652741*nuVtSqSum[1]*fl[19]-0.5412658773652741*nuVtSqSum[2]*fr[18]-0.5412658773652741*nuVtSqSum[2]*fl[18]+0.5625*nuVtSqSum[0]*fr[16]-0.5625*nuVtSqSum[0]*fl[16]-0.5412658773652741*nuVtSqSum[3]*fr[11]-0.5412658773652741*nuVtSqSum[3]*fl[11]+0.5625*nuVtSqSum[1]*fr[8]-0.5625*nuVtSqSum[1]*fl[8]+0.5625*nuVtSqSum[2]*fr[7]-0.5625*nuVtSqSum[2]*fl[7]+0.5625*fr[3]*nuVtSqSum[3]-0.5625*fl[3]*nuVtSqSum[3])*rdv2L-0.8660254037844386*fjump[26]+alphaDrag[0]*(0.4330127018922193*favg[26]+0.25*favg[16])+alphaDrag[1]*(0.4330127018922193*favg[19]+0.25*favg[8])+alphaDrag[2]*(0.4330127018922193*favg[18]+0.25*favg[7])-0.5*fjump[16]+alphaDrag[3]*(0.4330127018922193*favg[11]+0.25*favg[3]); 
  Ghat[20] = ((-0.5412658773652741*nuVtSqSum[0]*fr[28])-0.5412658773652741*nuVtSqSum[0]*fl[28]-0.5412658773652741*nuVtSqSum[1]*fr[24]-0.5412658773652741*nuVtSqSum[1]*fl[24]-0.5412658773652741*nuVtSqSum[2]*fr[23]-0.5412658773652741*nuVtSqSum[2]*fl[23]+0.5625*nuVtSqSum[0]*fr[20]-0.5625*nuVtSqSum[0]*fl[20]-0.5412658773652741*nuVtSqSum[3]*fr[15]-0.5412658773652741*nuVtSqSum[3]*fl[15]+0.5625*nuVtSqSum[1]*fr[13]-0.5625*nuVtSqSum[1]*fl[13]+0.5625*nuVtSqSum[2]*fr[12]-0.5625*nuVtSqSum[2]*fl[12]+0.5625*nuVtSqSum[3]*fr[5]-0.5625*nuVtSqSum[3]*fl[5])*rdv2L-0.8660254037844386*fjump[28]+alphaDrag[0]*(0.4330127018922193*favg[28]+0.25*favg[20])+alphaDrag[1]*(0.4330127018922193*favg[24]+0.25*favg[13])+alphaDrag[2]*(0.4330127018922193*favg[23]+0.25*favg[12])-0.5*fjump[20]+alphaDrag[3]*(0.4330127018922193*favg[15]+0.25*favg[5]); 
  Ghat[21] = ((-0.5412658773652741*nuVtSqSum[2]*fr[31])-0.5412658773652741*nuVtSqSum[2]*fl[31]-0.5412658773652741*nuVtSqSum[3]*fr[30]-0.5412658773652741*nuVtSqSum[3]*fl[30]-0.5412658773652741*nuVtSqSum[0]*fr[29]-0.5412658773652741*nuVtSqSum[0]*fl[29]+0.5625*nuVtSqSum[2]*fr[27]-0.5625*nuVtSqSum[2]*fl[27]-0.5412658773652741*nuVtSqSum[1]*fr[25]-0.5412658773652741*nuVtSqSum[1]*fl[25]+0.5625*nuVtSqSum[3]*fr[22]-0.5625*nuVtSqSum[3]*fl[22]+0.5625*nuVtSqSum[0]*fr[21]-0.5625*nuVtSqSum[0]*fl[21]+0.5625*nuVtSqSum[1]*fr[14]-0.5625*nuVtSqSum[1]*fl[14])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[31]+0.25*favg[27])+alphaDrag[3]*(0.4330127018922193*favg[30]+0.25*favg[22])-0.8660254037844386*fjump[29]+alphaDrag[0]*(0.4330127018922193*favg[29]+0.25*favg[21])+alphaDrag[1]*(0.4330127018922193*favg[25]+0.25*favg[14])-0.5*fjump[21]; 
  Ghat[22] = ((-0.5412658773652741*nuVtSqSum[1]*fr[31])-0.5412658773652741*nuVtSqSum[1]*fl[31]-0.5412658773652741*nuVtSqSum[0]*fr[30]-0.5412658773652741*nuVtSqSum[0]*fl[30]-0.5412658773652741*nuVtSqSum[3]*fr[29]-0.5412658773652741*nuVtSqSum[3]*fl[29]+0.5625*nuVtSqSum[1]*fr[27]-0.5625*nuVtSqSum[1]*fl[27]-0.5412658773652741*nuVtSqSum[2]*fr[25]-0.5412658773652741*nuVtSqSum[2]*fl[25]+0.5625*nuVtSqSum[0]*fr[22]-0.5625*nuVtSqSum[0]*fl[22]+0.5625*nuVtSqSum[3]*fr[21]-0.5625*nuVtSqSum[3]*fl[21]+0.5625*nuVtSqSum[2]*fr[14]-0.5625*nuVtSqSum[2]*fl[14])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[31]+0.25*favg[27])-0.8660254037844386*fjump[30]+alphaDrag[0]*(0.4330127018922193*favg[30]+0.25*favg[22])+alphaDrag[3]*(0.4330127018922193*favg[29]+0.25*favg[21])+alphaDrag[2]*(0.4330127018922193*favg[25]+0.25*favg[14])-0.5*fjump[22]; 
  Ghat[27] = ((-0.5412658773652741*nuVtSqSum[0]*fr[31])-0.5412658773652741*nuVtSqSum[0]*fl[31]-0.5412658773652741*nuVtSqSum[1]*fr[30]-0.5412658773652741*nuVtSqSum[1]*fl[30]-0.5412658773652741*nuVtSqSum[2]*fr[29]-0.5412658773652741*nuVtSqSum[2]*fl[29]+0.5625*nuVtSqSum[0]*fr[27]-0.5625*nuVtSqSum[0]*fl[27]-0.5412658773652741*nuVtSqSum[3]*fr[25]-0.5412658773652741*nuVtSqSum[3]*fl[25]+0.5625*nuVtSqSum[1]*fr[22]-0.5625*nuVtSqSum[1]*fl[22]+0.5625*nuVtSqSum[2]*fr[21]-0.5625*nuVtSqSum[2]*fl[21]+0.5625*nuVtSqSum[3]*fr[14]-0.5625*nuVtSqSum[3]*fl[14])*rdv2L-0.8660254037844386*fjump[31]+alphaDrag[0]*(0.4330127018922193*favg[31]+0.25*favg[27])+alphaDrag[1]*(0.4330127018922193*favg[30]+0.25*favg[22])+alphaDrag[2]*(0.4330127018922193*favg[29]+0.25*favg[21])-0.5*fjump[27]+alphaDrag[3]*(0.4330127018922193*favg[25]+0.25*favg[14]); 
...
{ 
  ...
  Ghat[0] = ((-0.5412658773652741*nuVtSqSum[3]*fr[20])-0.5412658773652741*nuVtSqSum[3]*fl[20]-0.5412658773652741*nuVtSqSum[2]*fr[13]-0.5412658773652741*nuVtSqSum[2]*fl[13]-0.5412658773652741*nuVtSqSum[1]*fr[12]-0.5412658773652741*nuVtSqSum[1]*fl[12]+0.5625*nuVtSqSum[3]*fr[6]-0.5625*nuVtSqSum[3]*fl[6]-0.5412658773652741*nuVtSqSum[0]*fr[5]-0.5412658773652741*nuVtSqSum[0]*fl[5]+0.5625*fr[2]*nuVtSqSum[2]-0.5625*fl[2]*nuVtSqSum[2]+0.5625*fr[1]*nuVtSqSum[1]-0.5625*fl[1]*nuVtSqSum[1]+0.5625*fr[0]*nuVtSqSum[0]-0.5625*fl[0]*nuVtSqSum[0])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[20]+0.25*favg[6])+alphaDrag[2]*(0.4330127018922193*favg[13]+0.25*favg[2])+alphaDrag[1]*(0.4330127018922193*favg[12]+0.25*favg[1])-0.8660254037844386*fjump[5]+alphaDrag[0]*(0.4330127018922193*favg[5]+0.25*favg[0])-0.5*fjump[0]; 
  Ghat[1] = ((-0.5412658773652741*nuVtSqSum[2]*fr[20])-0.5412658773652741*nuVtSqSum[2]*fl[20]-0.5412658773652741*nuVtSqSum[3]*fr[13]-0.5412658773652741*nuVtSqSum[3]*fl[13]-0.5412658773652741*nuVtSqSum[0]*fr[12]-0.5412658773652741*nuVtSqSum[0]*fl[12]+0.5625*nuVtSqSum[2]*fr[6]-0.5625*nuVtSqSum[2]*fl[6]-0.5412658773652741*nuVtSqSum[1]*fr[5]-0.5412658773652741*nuVtSqSum[1]*fl[5]+0.5625*fr[2]*nuVtSqSum[3]-0.5625*fl[2]*nuVtSqSum[3]+0.5625*fr[0]*nuVtSqSum[1]-0.5625*fl[0]*nuVtSqSum[1]+0.5625*nuVtSqSum[0]*fr[1]-0.5625*nuVtSqSum[0]*fl[1])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[20]+0.25*favg[6])+alphaDrag[3]*(0.4330127018922193*favg[13]+0.25*favg[2])-0.8660254037844386*fjump[12]+alphaDrag[0]*(0.4330127018922193*favg[12]+0.25*favg[1])+alphaDrag[1]*(0.4330127018922193*favg[5]+0.25*favg[0])-0.5*fjump[1]; 
  Ghat[2] = ((-0.5412658773652741*nuVtSqSum[1]*fr[20])-0.5412658773652741*nuVtSqSum[1]*fl[20]-0.5412658773652741*nuVtSqSum[0]*fr[13]-0.5412658773652741*nuVtSqSum[0]*fl[13]-0.5412658773652741*nuVtSqSum[3]*fr[12]-0.5412658773652741*nuVtSqSum[3]*fl[12]+0.5625*nuVtSqSum[1]*fr[6]-0.5625*nuVtSqSum[1]*fl[6]-0.5412658773652741*nuVtSqSum[2]*fr[5]-0.5412658773652741*nuVtSqSum[2]*fl[5]+0.5625*fr[1]*nuVtSqSum[3]-0.5625*fl[1]*nuVtSqSum[3]+0.5625*fr[0]*nuVtSqSum[2]-0.5625*fl[0]*nuVtSqSum[2]+0.5625*nuVtSqSum[0]*fr[2]-0.5625*nuVtSqSum[0]*fl[2])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[20]+0.25*favg[6])-0.8660254037844386*fjump[13]+alphaDrag[0]*(0.4330127018922193*favg[13]+0.25*favg[2])+alphaDrag[3]*(0.4330127018922193*favg[12]+0.25*favg[1])+alphaDrag[2]*(0.4330127018922193*favg[5]+0.25*favg[0])-0.5*fjump[2]; 
  Ghat[3] = ((-0.5412658773652741*nuVtSqSum[3]*fr[27])-0.5412658773652741*nuVtSqSum[3]*fl[27]-0.5412658773652741*nuVtSqSum[2]*fr[22]-0.5412658773652741*nuVtSqSum[2]*fl[22]-0.5412658773652741*nuVtSqSum[1]*fr[21]-0.5412658773652741*nuVtSqSum[1]*fl[21]+0.5625*nuVtSqSum[3]*fr[16]-0.5625*nuVtSqSum[3]*fl[16]-0.5412658773652741*nuVtSqSum[0]*fr[14]-0.5412658773652741*nuVtSqSum[0]*fl[14]+0.5625*nuVtSqSum[2]*fr[8]-0.5625*nuVtSqSum[2]*fl[8]+0.5625*nuVtSqSum[1]*fr[7]-0.5625*nuVtSqSum[1]*fl[7]+0.5625*nuVtSqSum[0]*fr[3]-0.5625*nuVtSqSum[0]*fl[3])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[27]+0.25*favg[16])+alphaDrag[2]*(0.4330127018922193*favg[22]+0.25*favg[8])+alphaDrag[1]*(0.4330127018922193*favg[21]+0.25*favg[7])-0.8660254037844386*fjump[14]+alphaDrag[0]*(0.4330127018922193*favg[14]+0.25*favg[3])-0.5*fjump[3]; 
  Ghat[4] = ((-0.5412658773652741*nuVtSqSum[3]*fr[28])-0.5412658773652741*nuVtSqSum[3]*fl[28]-0.5412658773652741*nuVtSqSum[2]*fr[24]-0.5412658773652741*nuVtSqSum[2]*fl[24]-0.5412658773652741*nuVtSqSum[1]*fr[23]-0.5412658773652741*nuVtSqSum[1]*fl[23]+0.5625*nuVtSqSum[3]*fr[17]-0.5625*nuVtSqSum[3]*fl[17]-0.5412658773652741*nuVtSqSum[0]*fr[15]-0.5412658773652741*nuVtSqSum[0]*fl[15]+0.5625*nuVtSqSum[2]*fr[10]-0.5625*nuVtSqSum[2]*fl[10]+0.5625*nuVtSqSum[1]*fr[9]-0.5625*nuVtSqSum[1]*fl[9]+0.5625*nuVtSqSum[0]*fr[4]-0.5625*nuVtSqSum[0]*fl[4])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[28]+0.25*favg[17])+alphaDrag[2]*(0.4330127018922193*favg[24]+0.25*favg[10])+alphaDrag[1]*(0.4330127018922193*favg[23]+0.25*favg[9])-0.8660254037844386*fjump[15]+alphaDrag[0]*(0.4330127018922193*favg[15]+0.25*favg[4])-0.5*fjump[4]; 
  Ghat[6] = ((-0.5412658773652741*nuVtSqSum[0]*fr[20])-0.5412658773652741*nuVtSqSum[0]*fl[20]-0.5412658773652741*nuVtSqSum[1]*fr[13]-0.5412658773652741*nuVtSqSum[1]*fl[13]-0.5412658773652741*nuVtSqSum[2]*fr[12]-0.5412658773652741*nuVtSqSum[2]*fl[12]+0.5625*nuVtSqSum[0]*fr[6]-0.5625*nuVtSqSum[0]*fl[6]-0.5412658773652741*nuVtSqSum[3]*fr[5]-0.5412658773652741*nuVtSqSum[3]*fl[5]+0.5625*fr[0]*nuVtSqSum[3]-0.5625*fl[0]*nuVtSqSum[3]+0.5625*fr[1]*nuVtSqSum[2]-0.5625*fl[1]*nuVtSqSum[2]+0.5625*nuVtSqSum[1]*fr[2]-0.5625*nuVtSqSum[1]*fl[2])*rdv2L-0.8660254037844386*fjump[20]+alphaDrag[0]*(0.4330127018922193*favg[20]+0.25*favg[6])+alphaDrag[1]*(0.4330127018922193*favg[13]+0.25*favg[2])+alphaDrag[2]*(0.4330127018922193*favg[12]+0.25*favg[1])-0.5*fjump[6]+alphaDrag[3]*(0.4330127018922193*favg[5]+0.25*favg[0]); 
  Ghat[7] = ((-0.5412658773652741*nuVtSqSum[2]*fr[27])-0.5412658773652741*nuVtSqSum[2]*fl[27]-0.5412658773652741*nuVtSqSum[3]*fr[22]-0.5412658773652741*nuVtSqSum[3]*fl[22]-0.5412658773652741*nuVtSqSum[0]*fr[21]-0.5412658773652741*nuVtSqSum[0]*fl[21]+0.5625*nuVtSqSum[2]*fr[16]-0.5625*nuVtSqSum[2]*fl[16]-0.5412658773652741*nuVtSqSum[1]*fr[14]-0.5412658773652741*nuVtSqSum[1]*fl[14]+0.5625*nuVtSqSum[3]*fr[8]-0.5625*nuVtSqSum[3]*fl[8]+0.5625*nuVtSqSum[0]*fr[7]-0.5625*nuVtSqSum[0]*fl[7]+0.5625*nuVtSqSum[1]*fr[3]-0.5625*nuVtSqSum[1]*fl[3])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[27]+0.25*favg[16])+alphaDrag[3]*(0.4330127018922193*favg[22]+0.25*favg[8])-0.8660254037844386*fjump[21]+alphaDrag[0]*(0.4330127018922193*favg[21]+0.25*favg[7])+alphaDrag[1]*(0.4330127018922193*favg[14]+0.25*favg[3])-0.5*fjump[7]; 
  Ghat[8] = ((-0.5412658773652741*nuVtSqSum[1]*fr[27])-0.5412658773652741*nuVtSqSum[1]*fl[27]-0.5412658773652741*nuVtSqSum[0]*fr[22]-0.5412658773652741*nuVtSqSum[0]*fl[22]-0.5412658773652741*nuVtSqSum[3]*fr[21]-0.5412658773652741*nuVtSqSum[3]*fl[21]+0.5625*nuVtSqSum[1]*fr[16]-0.5625*nuVtSqSum[1]*fl[16]-0.5412658773652741*nuVtSqSum[2]*fr[14]-0.5412658773652741*nuVtSqSum[2]*fl[14]+0.5625*nuVtSqSum[0]*fr[8]-0.5625*nuVtSqSum[0]*fl[8]+0.5625*nuVtSqSum[3]*fr[7]-0.5625*nuVtSqSum[3]*fl[7]+0.5625*nuVtSqSum[2]*fr[3]-0.5625*nuVtSqSum[2]*fl[3])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[27]+0.25*favg[16])-0.8660254037844386*fjump[22]+alphaDrag[0]*(0.4330127018922193*favg[22]+0.25*favg[8])+alphaDrag[3]*(0.4330127018922193*favg[21]+0.25*favg[7])+alphaDrag[2]*(0.4330127018922193*favg[14]+0.25*favg[3])-0.5*fjump[8]; 
  Ghat[9] = ((-0.5412658773652741*nuVtSqSum[2]*fr[28])-0.5412658773652741*nuVtSqSum[2]*fl[28]-0.5412658773652741*nuVtSqSum[3]*fr[24]-0.5412658773652741*nuVtSqSum[3]*fl[24]-0.5412658773652741*nuVtSqSum[0]*fr[23]-0.5412658773652741*nuVtSqSum[0]*fl[23]+0.5625*nuVtSqSum[2]*fr[17]-0.5625*nuVtSqSum[2]*fl[17]-0.5412658773652741*nuVtSqSum[1]*fr[15]-0.5412658773652741*nuVtSqSum[1]*fl[15]+0.5625*nuVtSqSum[3]*fr[10]-0.5625*nuVtSqSum[3]*fl[10]+0.5625*nuVtSqSum[0]*fr[9]-0.5625*nuVtSqSum[0]*fl[9]+0.5625*nuVtSqSum[1]*fr[4]-0.5625*nuVtSqSum[1]*fl[4])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[28]+0.25*favg[17])+alphaDrag[3]*(0.4330127018922193*favg[24]+0.25*favg[10])-0.8660254037844386*fjump[23]+alphaDrag[0]*(0.4330127018922193*favg[23]+0.25*favg[9])+alphaDrag[1]*(0.4330127018922193*favg[15]+0.25*favg[4])-0.5*fjump[9]; 
  Ghat[10] = ((-0.5412658773652741*nuVtSqSum[1]*fr[28])-0.5412658773652741*nuVtSqSum[1]*fl[28]-0.5412658773652741*nuVtSqSum[0]*fr[24]-0.5412658773652741*nuVtSqSum[0]*fl[24]-0.5412658773652741*nuVtSqSum[3]*fr[23]-0.5412658773652741*nuVtSqSum[3]*fl[23]+0.5625*nuVtSqSum[1]*fr[17]-0.5625*nuVtSqSum[1]*fl[17]-0.5412658773652741*nuVtSqSum[2]*fr[15]-0.5412658773652741*nuVtSqSum[2]*fl[15]+0.5625*nuVtSqSum[0]*fr[10]-0.5625*nuVtSqSum[0]*fl[10]+0.5625*nuVtSqSum[3]*fr[9]-0.5625*nuVtSqSum[3]*fl[9]+0.5625*nuVtSqSum[2]*fr[4]-0.5625*nuVtSqSum[2]*fl[4])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[28]+0.25*favg[17])-0.8660254037844386*fjump[24]+alphaDrag[0]*(0.4330127018922193*favg[24]+0.25*favg[10])+alphaDrag[3]*(0.4330127018922193*favg[23]+0.25*favg[9])+alphaDrag[2]*(0.4330127018922193*favg[15]+0.25*favg[4])-0.5*fjump[10]; 
  Ghat[11] = ((-0.5412658773652741*nuVtSqSum[3]*fr[31])-0.5412658773652741*nuVtSqSum[3]*fl[31]-0.5412658773652741*nuVtSqSum[2]*fr[30]-0.5412658773652741*nuVtSqSum[2]*fl[30]-0.5412658773652741*nuVtSqSum[1]*fr[29]-0.5412658773652741*nuVtSqSum[1]*fl[29]+0.5625*nuVtSqSum[3]*fr[26]-0.5625*nuVtSqSum[3]*fl[26]-0.5412658773652741*nuVtSqSum[0]*fr[25]-0.5412658773652741*nuVtSqSum[0]*fl[25]+0.5625*nuVtSqSum[2]*fr[19]-0.5625*nuVtSqSum[2]*fl[19]+0.5625*nuVtSqSum[1]*fr[18]-0.5625*nuVtSqSum[1]*fl[18]+0.5625*nuVtSqSum[0]*fr[11]-0.5625*nuVtSqSum[0]*fl[11])*rdv2L+alphaDrag[3]*(0.4330127018922193*favg[31]+0.25*favg[26])+alphaDrag[2]*(0.4330127018922193*favg[30]+0.25*favg[19])+alphaDrag[1]*(0.4330127018922193*favg[29]+0.25*favg[18])-0.8660254037844386*fjump[25]+alphaDrag[0]*(0.4330127018922193*favg[25]+0.25*favg[11])-0.5*fjump[11]; 
  Ghat[16] = ((-0.5412658773652741*nuVtSqSum[0]*fr[27])-0.5412658773652741*nuVtSqSum[0]*fl[27]-0.5412658773652741*nuVtSqSum[1]*fr[22]-0.5412658773652741*nuVtSqSum[1]*fl[22]-0.5412658773652741*nuVtSqSum[2]*fr[21]-0.5412658773652741*nuVtSqSum[2]*fl[21]+0.5625*nuVtSqSum[0]*fr[16]-0.5625*nuVtSqSum[0]*fl[16]-0.5412658773652741*nuVtSqSum[3]*fr[14]-0.5412658773652741*nuVtSqSum[3]*fl[14]+0.5625*nuVtSqSum[1]*fr[8]-0.5625*nuVtSqSum[1]*fl[8]+0.5625*nuVtSqSum[2]*fr[7]-0.5625*nuVtSqSum[2]*fl[7]+0.5625*fr[3]*nuVtSqSum[3]-0.5625*fl[3]*nuVtSqSum[3])*rdv2L-0.8660254037844386*fjump[27]+alphaDrag[0]*(0.4330127018922193*favg[27]+0.25*favg[16])+alphaDrag[1]*(0.4330127018922193*favg[22]+0.25*favg[8])+alphaDrag[2]*(0.4330127018922193*favg[21]+0.25*favg[7])-0.5*fjump[16]+alphaDrag[3]*(0.4330127018922193*favg[14]+0.25*favg[3]); 
  Ghat[17] = ((-0.5412658773652741*nuVtSqSum[0]*fr[28])-0.5412658773652741*nuVtSqSum[0]*fl[28]-0.5412658773652741*nuVtSqSum[1]*fr[24]-0.5412658773652741*nuVtSqSum[1]*fl[24]-0.5412658773652741*nuVtSqSum[2]*fr[23]-0.5412658773652741*nuVtSqSum[2]*fl[23]+0.5625*nuVtSqSum[0]*fr[17]-0.5625*nuVtSqSum[0]*fl[17]-0.5412658773652741*nuVtSqSum[3]*fr[15]-0.5412658773652741*nuVtSqSum[3]*fl[15]+0.5625*nuVtSqSum[1]*fr[10]-0.5625*nuVtSqSum[1]*fl[10]+0.5625*nuVtSqSum[2]*fr[9]-0.5625*nuVtSqSum[2]*fl[9]+0.5625*nuVtSqSum[3]*fr[4]-0.5625*nuVtSqSum[3]*fl[4])*rdv2L-0.8660254037844386*fjump[28]+alphaDrag[0]*(0.4330127018922193*favg[28]+0.25*favg[17])+alphaDrag[1]*(0.4330127018922193*favg[24]+0.25*favg[10])+alphaDrag[2]*(0.4330127018922193*favg[23]+0.25*favg[9])-0.5*fjump[17]+alphaDrag[3]*(0.4330127018922193*favg[15]+0.25*favg[4]); 
  Ghat[18] = ((-0.5412658773652741*nuVtSqSum[2]*fr[31])-0.5412658773652741*nuVtSqSum[2]*fl[31]-0.5412658773652741*nuVtSqSum[3]*fr[30]-0.5412658773652741*nuVtSqSum[3]*fl[30]-0.5412658773652741*nuVtSqSum[0]*fr[29]-0.5412658773652741*nuVtSqSum[0]*fl[29]+0.5625*nuVtSqSum[2]*fr[26]-0.5625*nuVtSqSum[2]*fl[26]-0.5412658773652741*nuVtSqSum[1]*fr[25]-0.5412658773652741*nuVtSqSum[1]*fl[25]+0.5625*nuVtSqSum[3]*fr[19]-0.5625*nuVtSqSum[3]*fl[19]+0.5625*nuVtSqSum[0]*fr[18]-0.5625*nuVtSqSum[0]*fl[18]+0.5625*nuVtSqSum[1]*fr[11]-0.5625*nuVtSqSum[1]*fl[11])*rdv2L+alphaDrag[2]*(0.4330127018922193*favg[31]+0.25*favg[26])+alphaDrag[3]*(0.4330127018922193*favg[30]+0.25*favg[19])-0.8660254037844386*fjump[29]+alphaDrag[0]*(0.4330127018922193*favg[29]+0.25*favg[18])+alphaDrag[1]*(0.4330127018922193*favg[25]+0.25*favg[11])-0.5*fjump[18]; 
  Ghat[19] = ((-0.5412658773652741*nuVtSqSum[1]*fr[31])-0.5412658773652741*nuVtSqSum[1]*fl[31]-0.5412658773652741*nuVtSqSum[0]*fr[30]-0.5412658773652741*nuVtSqSum[0]*fl[30]-0.5412658773652741*nuVtSqSum[3]*fr[29]-0.5412658773652741*nuVtSqSum[3]*fl[29]+0.5625*nuVtSqSum[1]*fr[26]-0.5625*nuVtSqSum[1]*fl[26]-0.5412658773652741*nuVtSqSum[2]*fr[25]-0.5412658773652741*nuVtSqSum[2]*fl[25]+0.5625*nuVtSqSum[0]*fr[19]-0.5625*nuVtSqSum[0]*fl[19]+0.5625*nuVtSqSum[3]*fr[18]-0.5625*nuVtSqSum[3]*fl[18]+0.5625*nuVtSqSum[2]*fr[11]-0.5625*nuVtSqSum[2]*fl[11])*rdv2L+alphaDrag[1]*(0.4330127018922193*favg[31]+0.25*favg[26])-0.8660254037844386*fjump[30]+alphaDrag[0]*(0.4330127018922193*favg[30]+0.25*favg[19])+alphaDrag[3]*(0.4330127018922193*favg[29]+0.25*favg[18])+alphaDrag[2]*(0.4330127018922193*favg[25]+0.25*favg[11])-0.5*fjump[19]; 
  Ghat[26] = ((-0.5412658773652741*nuVtSqSum[0]*fr[31])-0.5412658773652741*nuVtSqSum[0]*fl[31]-0.5412658773652741*nuVtSqSum[1]*fr[30]-0.5412658773652741*nuVtSqSum[1]*fl[30]-0.5412658773652741*nuVtSqSum[2]*fr[29]-0.5412658773652741*nuVtSqSum[2]*fl[29]+0.5625*nuVtSqSum[0]*fr[26]-0.5625*nuVtSqSum[0]*fl[26]-0.5412658773652741*nuVtSqSum[3]*fr[25]-0.5412658773652741*nuVtSqSum[3]*fl[25]+0.5625*nuVtSqSum[1]*fr[19]-0.5625*nuVtSqSum[1]*fl[19]+0.5625*nuVtSqSum[2]*fr[18]-0.5625*nuVtSqSum[2]*fl[18]+0.5625*nuVtSqSum[3]*fr[11]-0.5625*nuVtSqSum[3]*fl[11])*rdv2L-0.8660254037844386*fjump[31]+alphaDrag[0]*(0.4330127018922193*favg[31]+0.25*favg[26])+alphaDrag[1]*(0.4330127018922193*favg[30]+0.25*favg[19])+alphaDrag[2]*(0.4330127018922193*favg[29]+0.25*favg[18])-0.5*fjump[26]+alphaDrag[3]*(0.4330127018922193*favg[25]+0.25*favg[11]); 
