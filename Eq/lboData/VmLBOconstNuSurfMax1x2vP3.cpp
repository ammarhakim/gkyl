...
{ 
  ...
  Ghat[0] = ((-0.9646460450276559*nuVtSqSum[0]*fr[18])-0.9646460450276559*nuVtSqSum[0]*fl[18]+1.933495104806964*nuVtSqSum[3]*fr[17]-1.933495104806964*nuVtSqSum[3]*fl[17]+2.198771185585825*nuVtSqSum[1]*fr[12]-2.198771185585825*nuVtSqSum[1]*fl[12]-2.73653932201558*nuVtSqSum[2]*fr[11]-2.73653932201558*nuVtSqSum[2]*fl[11]+2.198771185585824*nuVtSqSum[0]*fr[8]-2.198771185585824*nuVtSqSum[0]*fl[8]+1.933495104806964*nuVtSqSum[2]*fr[7]-1.933495104806964*nuVtSqSum[2]*fl[7]-2.736539322015579*nuVtSqSum[1]*fr[4]-2.736539322015579*nuVtSqSum[1]*fl[4]-2.736539322015579*nuVtSqSum[0]*fr[2]-2.736539322015579*nuVtSqSum[0]*fl[2]+1.933495104806964*fr[1]*nuVtSqSum[1]-1.933495104806964*fl[1]*nuVtSqSum[1]+1.933495104806964*fr[0]*nuVtSqSum[0]-1.933495104806964*fl[0]*nuVtSqSum[0])*rdv2L-1.322875655532295*fjump[18]+alphaDrag[0]*(0.9354143466934851*favg[18]+0.7905694150420947*favg[8]+0.6123724356957944*favg[2]+0.3535533905932737*favg[0])+0.3535533905932737*alphaDrag[3]*favg[17]+alphaDrag[1]*(0.7905694150420948*favg[12]+0.6123724356957944*favg[4]+0.3535533905932737*favg[1])+alphaDrag[2]*(0.6123724356957944*favg[11]+0.3535533905932737*favg[7])-1.118033988749895*fjump[8]-0.8660254037844386*fjump[2]-0.5*fjump[0]; 
  Ghat[1] = ((-0.9646460450276559*nuVtSqSum[1]*fr[18])-0.9646460450276559*nuVtSqSum[1]*fl[18]+1.698208212444073*nuVtSqSum[2]*fr[17]-1.698208212444073*nuVtSqSum[2]*fl[17]+1.966640735175084*nuVtSqSum[2]*fr[12]+2.198771185585825*nuVtSqSum[0]*fr[12]-1.966640735175084*nuVtSqSum[2]*fl[12]-2.198771185585825*nuVtSqSum[0]*fl[12]-2.40353003158338*nuVtSqSum[3]*fr[11]-2.447635178851209*nuVtSqSum[1]*fr[11]-2.40353003158338*nuVtSqSum[3]*fl[11]-2.447635178851209*nuVtSqSum[1]*fl[11]+2.198771185585824*nuVtSqSum[1]*fr[8]-2.198771185585824*nuVtSqSum[1]*fl[8]+1.698208212444073*nuVtSqSum[3]*fr[7]+1.729370595404581*nuVtSqSum[1]*fr[7]-1.698208212444073*nuVtSqSum[3]*fl[7]-1.729370595404581*nuVtSqSum[1]*fl[7]-2.447635178851209*nuVtSqSum[2]*fr[4]-2.736539322015579*nuVtSqSum[0]*fr[4]-2.447635178851209*nuVtSqSum[2]*fl[4]-2.736539322015579*nuVtSqSum[0]*fl[4]+1.729370595404581*fr[1]*nuVtSqSum[2]-1.729370595404581*fl[1]*nuVtSqSum[2]-2.736539322015579*nuVtSqSum[1]*fr[2]-2.736539322015579*nuVtSqSum[1]*fl[2]+1.933495104806964*fr[0]*nuVtSqSum[1]-1.933495104806964*fl[0]*nuVtSqSum[1]+1.933495104806964*nuVtSqSum[0]*fr[1]-1.933495104806964*nuVtSqSum[0]*fl[1])*rdv2L+alphaDrag[1]*(0.9354143466934851*favg[18]+0.5477225575051661*favg[11]+0.7905694150420947*favg[8]+0.3162277660168379*favg[7]+0.6123724356957944*favg[2]+0.3535533905932737*favg[0])+alphaDrag[2]*(0.3105295017040592*favg[17]+0.7071067811865475*favg[12]+0.5477225575051661*favg[4]+0.3162277660168379*favg[1])-1.118033988749895*fjump[12]+alphaDrag[0]*(0.7905694150420948*favg[12]+0.6123724356957944*favg[4]+0.3535533905932737*favg[1])+alphaDrag[3]*(0.5378528742004769*favg[11]+0.3105295017040592*favg[7])-0.8660254037844386*fjump[4]-0.5*fjump[1]; 
  Ghat[3] = (2.198771185585825*nuVtSqSum[0]*fr[14]-2.198771185585825*nuVtSqSum[0]*fl[14]+1.933495104806965*nuVtSqSum[2]*fr[13]-1.933495104806965*nuVtSqSum[2]*fl[13]-2.736539322015579*nuVtSqSum[1]*fr[10]-2.736539322015579*nuVtSqSum[1]*fl[10]-2.736539322015579*nuVtSqSum[0]*fr[6]-2.736539322015579*nuVtSqSum[0]*fl[6]+1.933495104806964*nuVtSqSum[1]*fr[5]-1.933495104806964*nuVtSqSum[1]*fl[5]+1.933495104806964*nuVtSqSum[0]*fr[3]-1.933495104806964*nuVtSqSum[0]*fl[3])*rdv2L-1.118033988749895*fjump[14]+alphaDrag[0]*(0.7905694150420948*favg[14]+0.6123724356957944*favg[6]+0.3535533905932737*favg[3])+0.3535533905932737*alphaDrag[2]*favg[13]+alphaDrag[1]*(0.6123724356957944*favg[10]+0.3535533905932737*favg[5])-0.8660254037844386*fjump[6]-0.5*fjump[3]; 
  Ghat[5] = (2.198771185585825*nuVtSqSum[1]*fr[14]-2.198771185585825*nuVtSqSum[1]*fl[14]+1.698208212444074*nuVtSqSum[3]*fr[13]+1.729370595404581*nuVtSqSum[1]*fr[13]-1.698208212444074*nuVtSqSum[3]*fl[13]-1.729370595404581*nuVtSqSum[1]*fl[13]-2.447635178851209*nuVtSqSum[2]*fr[10]-2.736539322015579*nuVtSqSum[0]*fr[10]-2.447635178851209*nuVtSqSum[2]*fl[10]-2.736539322015579*nuVtSqSum[0]*fl[10]-2.736539322015579*nuVtSqSum[1]*fr[6]-2.736539322015579*nuVtSqSum[1]*fl[6]+1.729370595404581*nuVtSqSum[2]*fr[5]+1.933495104806964*nuVtSqSum[0]*fr[5]-1.729370595404581*nuVtSqSum[2]*fl[5]-1.933495104806964*nuVtSqSum[0]*fl[5]+1.933495104806964*nuVtSqSum[1]*fr[3]-1.933495104806964*nuVtSqSum[1]*fl[3])*rdv2L+alphaDrag[1]*(0.7905694150420948*favg[14]+0.3162277660168379*favg[13]+0.6123724356957944*favg[6]+0.3535533905932737*favg[3])+0.3105295017040593*alphaDrag[3]*favg[13]-0.8660254037844386*fjump[10]+alphaDrag[0]*(0.6123724356957944*favg[10]+0.3535533905932737*favg[5])+alphaDrag[2]*(0.5477225575051661*favg[10]+0.3162277660168379*favg[5])-0.5*fjump[5]; 
  Ghat[7] = ((-0.9646460450276559*nuVtSqSum[2]*fr[18])-0.9646460450276559*nuVtSqSum[2]*fl[18]+1.152913730269721*nuVtSqSum[3]*fr[17]+1.698208212444073*nuVtSqSum[1]*fr[17]-1.152913730269721*nuVtSqSum[3]*fl[17]-1.698208212444073*nuVtSqSum[1]*fl[17]+1.931202864369305*nuVtSqSum[3]*fr[12]+1.966640735175084*nuVtSqSum[1]*fr[12]-1.931202864369305*nuVtSqSum[3]*fl[12]-1.966640735175084*nuVtSqSum[1]*fl[12]-1.748310842036578*nuVtSqSum[2]*fr[11]-2.73653932201558*nuVtSqSum[0]*fr[11]-1.748310842036578*nuVtSqSum[2]*fl[11]-2.73653932201558*nuVtSqSum[0]*fl[11]+2.198771185585824*nuVtSqSum[2]*fr[8]-2.198771185585824*nuVtSqSum[2]*fl[8]+1.235264711003273*nuVtSqSum[2]*fr[7]+1.933495104806964*nuVtSqSum[0]*fr[7]-1.235264711003273*nuVtSqSum[2]*fl[7]-1.933495104806964*nuVtSqSum[0]*fl[7]-2.40353003158338*nuVtSqSum[3]*fr[4]-2.447635178851209*nuVtSqSum[1]*fr[4]-2.40353003158338*nuVtSqSum[3]*fl[4]-2.447635178851209*nuVtSqSum[1]*fl[4]+1.698208212444073*fr[1]*nuVtSqSum[3]-1.698208212444073*fl[1]*nuVtSqSum[3]-2.736539322015579*fr[2]*nuVtSqSum[2]-2.736539322015579*fl[2]*nuVtSqSum[2]+1.933495104806964*fr[0]*nuVtSqSum[2]-1.933495104806964*fl[0]*nuVtSqSum[2]+1.729370595404581*fr[1]*nuVtSqSum[1]-1.729370595404581*fl[1]*nuVtSqSum[1])*rdv2L+alphaDrag[2]*(0.9354143466934851*favg[18]+0.3912303982179757*favg[11]+0.7905694150420947*favg[8]+0.2258769757263128*favg[7]+0.6123724356957944*favg[2]+0.3535533905932737*favg[0])+alphaDrag[1]*(0.3105295017040592*favg[17]+0.7071067811865475*favg[12]+0.5477225575051661*favg[4]+0.3162277660168379*favg[1])+alphaDrag[3]*(0.210818510677892*favg[17]+0.6943650748294133*favg[12]+0.537852874200477*favg[4]+0.3105295017040592*favg[1])-0.8660254037844387*fjump[11]+alphaDrag[0]*(0.6123724356957944*favg[11]+0.3535533905932737*favg[7])-0.5*fjump[7]; 
  Ghat[9] = ((-2.73653932201558*nuVtSqSum[0]*fr[16])-2.73653932201558*nuVtSqSum[0]*fl[16]+1.933495104806965*nuVtSqSum[1]*fr[15]-1.933495104806965*nuVtSqSum[1]*fl[15]+1.933495104806964*nuVtSqSum[0]*fr[9]-1.933495104806964*nuVtSqSum[0]*fl[9])*rdv2L-0.8660254037844387*fjump[16]+alphaDrag[0]*(0.6123724356957944*favg[16]+0.3535533905932737*favg[9])+0.3535533905932737*alphaDrag[1]*favg[15]-0.5*fjump[9]; 
  Ghat[13] = (2.198771185585824*nuVtSqSum[2]*fr[14]-2.198771185585824*nuVtSqSum[2]*fl[14]+1.235264711003273*nuVtSqSum[2]*fr[13]+1.933495104806964*nuVtSqSum[0]*fr[13]-1.235264711003273*nuVtSqSum[2]*fl[13]-1.933495104806964*nuVtSqSum[0]*fl[13]-2.40353003158338*nuVtSqSum[3]*fr[10]-2.447635178851209*nuVtSqSum[1]*fr[10]-2.40353003158338*nuVtSqSum[3]*fl[10]-2.447635178851209*nuVtSqSum[1]*fl[10]-2.73653932201558*nuVtSqSum[2]*fr[6]-2.73653932201558*nuVtSqSum[2]*fl[6]+1.698208212444074*nuVtSqSum[3]*fr[5]+1.729370595404581*nuVtSqSum[1]*fr[5]-1.698208212444074*nuVtSqSum[3]*fl[5]-1.729370595404581*nuVtSqSum[1]*fl[5]+1.933495104806965*nuVtSqSum[2]*fr[3]-1.933495104806965*nuVtSqSum[2]*fl[3])*rdv2L+alphaDrag[2]*(0.7905694150420947*favg[14]+0.2258769757263128*favg[13]+0.6123724356957944*favg[6]+0.3535533905932737*favg[3])-0.5*fjump[13]+0.3535533905932737*alphaDrag[0]*favg[13]+alphaDrag[1]*(0.5477225575051661*favg[10]+0.3162277660168379*favg[5])+alphaDrag[3]*(0.5378528742004769*favg[10]+0.3105295017040593*favg[5]); 
  Ghat[15] = ((-2.736539322015579*nuVtSqSum[1]*fr[16])-2.736539322015579*nuVtSqSum[1]*fl[16]+1.729370595404581*nuVtSqSum[2]*fr[15]+1.933495104806964*nuVtSqSum[0]*fr[15]-1.729370595404581*nuVtSqSum[2]*fl[15]-1.933495104806964*nuVtSqSum[0]*fl[15]+1.933495104806965*nuVtSqSum[1]*fr[9]-1.933495104806965*nuVtSqSum[1]*fl[9])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[16]+0.3535533905932737*favg[9])-0.5*fjump[15]+0.3162277660168379*alphaDrag[2]*favg[15]+0.3535533905932737*alphaDrag[0]*favg[15]; 
  Ghat[17] = ((-0.9646460450276559*nuVtSqSum[3]*fr[18])-0.9646460450276559*nuVtSqSum[3]*fl[18]+1.152913730269721*nuVtSqSum[2]*fr[17]+1.933495104806964*nuVtSqSum[0]*fr[17]-1.152913730269721*nuVtSqSum[2]*fl[17]-1.933495104806964*nuVtSqSum[0]*fl[17]+1.931202864369305*nuVtSqSum[2]*fr[12]-1.931202864369305*nuVtSqSum[2]*fl[12]-1.631756785900806*nuVtSqSum[3]*fr[11]-2.40353003158338*nuVtSqSum[1]*fr[11]-1.631756785900806*nuVtSqSum[3]*fl[11]-2.40353003158338*nuVtSqSum[1]*fl[11]+2.198771185585824*nuVtSqSum[3]*fr[8]-2.198771185585824*nuVtSqSum[3]*fl[8]+1.152913730269721*nuVtSqSum[3]*fr[7]+1.698208212444073*nuVtSqSum[1]*fr[7]-1.152913730269721*nuVtSqSum[3]*fl[7]-1.698208212444073*nuVtSqSum[1]*fl[7]-2.40353003158338*nuVtSqSum[2]*fr[4]-2.40353003158338*nuVtSqSum[2]*fl[4]-2.736539322015579*fr[2]*nuVtSqSum[3]-2.736539322015579*fl[2]*nuVtSqSum[3]+1.933495104806964*fr[0]*nuVtSqSum[3]-1.933495104806964*fl[0]*nuVtSqSum[3]+1.698208212444073*fr[1]*nuVtSqSum[2]-1.698208212444073*fl[1]*nuVtSqSum[2])*rdv2L+alphaDrag[3]*(0.9354143466934851*favg[18]+0.3651483716701107*favg[11]+0.7905694150420947*favg[8]+0.210818510677892*favg[7]+0.6123724356957944*favg[2]+0.3535533905932737*favg[0])-0.5*fjump[17]+0.3535533905932737*alphaDrag[0]*favg[17]+alphaDrag[2]*(0.210818510677892*favg[17]+0.6943650748294133*favg[12]+0.537852874200477*favg[4]+0.3105295017040592*favg[1])+alphaDrag[1]*(0.5378528742004769*favg[11]+0.3105295017040592*favg[7]); 
  Ghat[19] = (1.933495104806964*nuVtSqSum[0]*fr[19]-1.933495104806964*nuVtSqSum[0]*fl[19])*rdv2L-0.5*fjump[19]+0.3535533905932737*alphaDrag[0]*favg[19]; 
...
{ 
  ...
  Ghat[0] = ((-0.9646460450276559*nuVtSqSum[0]*fr[19])-0.9646460450276559*nuVtSqSum[0]*fl[19]+1.933495104806964*nuVtSqSum[3]*fr[17]-1.933495104806964*nuVtSqSum[3]*fl[17]+2.198771185585825*nuVtSqSum[1]*fr[15]-2.198771185585825*nuVtSqSum[1]*fl[15]-2.73653932201558*nuVtSqSum[2]*fr[13]-2.73653932201558*nuVtSqSum[2]*fl[13]+2.198771185585824*nuVtSqSum[0]*fr[9]-2.198771185585824*nuVtSqSum[0]*fl[9]+1.933495104806964*nuVtSqSum[2]*fr[7]-1.933495104806964*nuVtSqSum[2]*fl[7]-2.736539322015579*nuVtSqSum[1]*fr[5]-2.736539322015579*nuVtSqSum[1]*fl[5]-2.736539322015579*nuVtSqSum[0]*fr[3]-2.736539322015579*nuVtSqSum[0]*fl[3]+1.933495104806964*fr[1]*nuVtSqSum[1]-1.933495104806964*fl[1]*nuVtSqSum[1]+1.933495104806964*fr[0]*nuVtSqSum[0]-1.933495104806964*fl[0]*nuVtSqSum[0])*rdv2L-1.322875655532295*fjump[19]+alphaDrag[0]*(0.9354143466934851*favg[19]+0.7905694150420947*favg[9]+0.6123724356957944*favg[3]+0.3535533905932737*favg[0])+0.3535533905932737*alphaDrag[3]*favg[17]+alphaDrag[1]*(0.7905694150420948*favg[15]+0.6123724356957944*favg[5]+0.3535533905932737*favg[1])+alphaDrag[2]*(0.6123724356957944*favg[13]+0.3535533905932737*favg[7])-1.118033988749895*fjump[9]-0.8660254037844386*fjump[3]-0.5*fjump[0]; 
  Ghat[1] = ((-0.9646460450276559*nuVtSqSum[1]*fr[19])-0.9646460450276559*nuVtSqSum[1]*fl[19]+1.698208212444073*nuVtSqSum[2]*fr[17]-1.698208212444073*nuVtSqSum[2]*fl[17]+1.966640735175084*nuVtSqSum[2]*fr[15]+2.198771185585825*nuVtSqSum[0]*fr[15]-1.966640735175084*nuVtSqSum[2]*fl[15]-2.198771185585825*nuVtSqSum[0]*fl[15]-2.40353003158338*nuVtSqSum[3]*fr[13]-2.447635178851209*nuVtSqSum[1]*fr[13]-2.40353003158338*nuVtSqSum[3]*fl[13]-2.447635178851209*nuVtSqSum[1]*fl[13]+2.198771185585824*nuVtSqSum[1]*fr[9]-2.198771185585824*nuVtSqSum[1]*fl[9]+1.698208212444073*nuVtSqSum[3]*fr[7]+1.729370595404581*nuVtSqSum[1]*fr[7]-1.698208212444073*nuVtSqSum[3]*fl[7]-1.729370595404581*nuVtSqSum[1]*fl[7]-2.447635178851209*nuVtSqSum[2]*fr[5]-2.736539322015579*nuVtSqSum[0]*fr[5]-2.447635178851209*nuVtSqSum[2]*fl[5]-2.736539322015579*nuVtSqSum[0]*fl[5]-2.736539322015579*nuVtSqSum[1]*fr[3]-2.736539322015579*nuVtSqSum[1]*fl[3]+1.729370595404581*fr[1]*nuVtSqSum[2]-1.729370595404581*fl[1]*nuVtSqSum[2]+1.933495104806964*fr[0]*nuVtSqSum[1]-1.933495104806964*fl[0]*nuVtSqSum[1]+1.933495104806964*nuVtSqSum[0]*fr[1]-1.933495104806964*nuVtSqSum[0]*fl[1])*rdv2L+alphaDrag[1]*(0.9354143466934851*favg[19]+0.5477225575051661*favg[13]+0.7905694150420947*favg[9]+0.3162277660168379*favg[7]+0.6123724356957944*favg[3]+0.3535533905932737*favg[0])+alphaDrag[2]*(0.3105295017040592*favg[17]+0.7071067811865475*favg[15]+0.5477225575051661*favg[5]+0.3162277660168379*favg[1])-1.118033988749895*fjump[15]+alphaDrag[0]*(0.7905694150420948*favg[15]+0.6123724356957944*favg[5]+0.3535533905932737*favg[1])+alphaDrag[3]*(0.5378528742004769*favg[13]+0.3105295017040592*favg[7])-0.8660254037844386*fjump[5]-0.5*fjump[1]; 
  Ghat[2] = (2.198771185585825*nuVtSqSum[0]*fr[16]-2.198771185585825*nuVtSqSum[0]*fl[16]+1.933495104806965*nuVtSqSum[2]*fr[11]-1.933495104806965*nuVtSqSum[2]*fl[11]-2.736539322015579*nuVtSqSum[1]*fr[10]-2.736539322015579*nuVtSqSum[1]*fl[10]-2.736539322015579*nuVtSqSum[0]*fr[6]-2.736539322015579*nuVtSqSum[0]*fl[6]+1.933495104806964*nuVtSqSum[1]*fr[4]-1.933495104806964*nuVtSqSum[1]*fl[4]+1.933495104806964*nuVtSqSum[0]*fr[2]-1.933495104806964*nuVtSqSum[0]*fl[2])*rdv2L-1.118033988749895*fjump[16]+alphaDrag[0]*(0.7905694150420948*favg[16]+0.6123724356957944*favg[6]+0.3535533905932737*favg[2])+0.3535533905932737*alphaDrag[2]*favg[11]+alphaDrag[1]*(0.6123724356957944*favg[10]+0.3535533905932737*favg[4])-0.8660254037844386*fjump[6]-0.5*fjump[2]; 
  Ghat[4] = (2.198771185585825*nuVtSqSum[1]*fr[16]-2.198771185585825*nuVtSqSum[1]*fl[16]+1.698208212444074*nuVtSqSum[3]*fr[11]+1.729370595404581*nuVtSqSum[1]*fr[11]-1.698208212444074*nuVtSqSum[3]*fl[11]-1.729370595404581*nuVtSqSum[1]*fl[11]-2.447635178851209*nuVtSqSum[2]*fr[10]-2.736539322015579*nuVtSqSum[0]*fr[10]-2.447635178851209*nuVtSqSum[2]*fl[10]-2.736539322015579*nuVtSqSum[0]*fl[10]-2.736539322015579*nuVtSqSum[1]*fr[6]-2.736539322015579*nuVtSqSum[1]*fl[6]+1.729370595404581*nuVtSqSum[2]*fr[4]+1.933495104806964*nuVtSqSum[0]*fr[4]-1.729370595404581*nuVtSqSum[2]*fl[4]-1.933495104806964*nuVtSqSum[0]*fl[4]+1.933495104806964*nuVtSqSum[1]*fr[2]-1.933495104806964*nuVtSqSum[1]*fl[2])*rdv2L+alphaDrag[1]*(0.7905694150420948*favg[16]+0.3162277660168379*favg[11]+0.6123724356957944*favg[6]+0.3535533905932737*favg[2])+0.3105295017040593*alphaDrag[3]*favg[11]-0.8660254037844386*fjump[10]+alphaDrag[0]*(0.6123724356957944*favg[10]+0.3535533905932737*favg[4])+alphaDrag[2]*(0.5477225575051661*favg[10]+0.3162277660168379*favg[4])-0.5*fjump[4]; 
  Ghat[7] = ((-0.9646460450276559*nuVtSqSum[2]*fr[19])-0.9646460450276559*nuVtSqSum[2]*fl[19]+1.152913730269721*nuVtSqSum[3]*fr[17]+1.698208212444073*nuVtSqSum[1]*fr[17]-1.152913730269721*nuVtSqSum[3]*fl[17]-1.698208212444073*nuVtSqSum[1]*fl[17]+1.931202864369305*nuVtSqSum[3]*fr[15]+1.966640735175084*nuVtSqSum[1]*fr[15]-1.931202864369305*nuVtSqSum[3]*fl[15]-1.966640735175084*nuVtSqSum[1]*fl[15]-1.748310842036578*nuVtSqSum[2]*fr[13]-2.73653932201558*nuVtSqSum[0]*fr[13]-1.748310842036578*nuVtSqSum[2]*fl[13]-2.73653932201558*nuVtSqSum[0]*fl[13]+2.198771185585824*nuVtSqSum[2]*fr[9]-2.198771185585824*nuVtSqSum[2]*fl[9]+1.235264711003273*nuVtSqSum[2]*fr[7]+1.933495104806964*nuVtSqSum[0]*fr[7]-1.235264711003273*nuVtSqSum[2]*fl[7]-1.933495104806964*nuVtSqSum[0]*fl[7]-2.40353003158338*nuVtSqSum[3]*fr[5]-2.447635178851209*nuVtSqSum[1]*fr[5]-2.40353003158338*nuVtSqSum[3]*fl[5]-2.447635178851209*nuVtSqSum[1]*fl[5]+1.698208212444073*fr[1]*nuVtSqSum[3]-1.698208212444073*fl[1]*nuVtSqSum[3]-2.736539322015579*nuVtSqSum[2]*fr[3]-2.736539322015579*nuVtSqSum[2]*fl[3]+1.933495104806964*fr[0]*nuVtSqSum[2]-1.933495104806964*fl[0]*nuVtSqSum[2]+1.729370595404581*fr[1]*nuVtSqSum[1]-1.729370595404581*fl[1]*nuVtSqSum[1])*rdv2L+alphaDrag[2]*(0.9354143466934851*favg[19]+0.3912303982179757*favg[13]+0.7905694150420947*favg[9]+0.2258769757263128*favg[7]+0.6123724356957944*favg[3]+0.3535533905932737*favg[0])+alphaDrag[1]*(0.3105295017040592*favg[17]+0.7071067811865475*favg[15]+0.5477225575051661*favg[5]+0.3162277660168379*favg[1])+alphaDrag[3]*(0.210818510677892*favg[17]+0.6943650748294133*favg[15]+0.537852874200477*favg[5]+0.3105295017040592*favg[1])-0.8660254037844387*fjump[13]+alphaDrag[0]*(0.6123724356957944*favg[13]+0.3535533905932737*favg[7])-0.5*fjump[7]; 
  Ghat[8] = ((-2.73653932201558*nuVtSqSum[0]*fr[14])-2.73653932201558*nuVtSqSum[0]*fl[14]+1.933495104806965*nuVtSqSum[1]*fr[12]-1.933495104806965*nuVtSqSum[1]*fl[12]+1.933495104806964*nuVtSqSum[0]*fr[8]-1.933495104806964*nuVtSqSum[0]*fl[8])*rdv2L-0.8660254037844387*fjump[14]+alphaDrag[0]*(0.6123724356957944*favg[14]+0.3535533905932737*favg[8])+0.3535533905932737*alphaDrag[1]*favg[12]-0.5*fjump[8]; 
  Ghat[11] = (2.198771185585824*nuVtSqSum[2]*fr[16]-2.198771185585824*nuVtSqSum[2]*fl[16]+1.235264711003273*nuVtSqSum[2]*fr[11]+1.933495104806964*nuVtSqSum[0]*fr[11]-1.235264711003273*nuVtSqSum[2]*fl[11]-1.933495104806964*nuVtSqSum[0]*fl[11]-2.40353003158338*nuVtSqSum[3]*fr[10]-2.447635178851209*nuVtSqSum[1]*fr[10]-2.40353003158338*nuVtSqSum[3]*fl[10]-2.447635178851209*nuVtSqSum[1]*fl[10]-2.73653932201558*nuVtSqSum[2]*fr[6]-2.73653932201558*nuVtSqSum[2]*fl[6]+1.698208212444074*nuVtSqSum[3]*fr[4]+1.729370595404581*nuVtSqSum[1]*fr[4]-1.698208212444074*nuVtSqSum[3]*fl[4]-1.729370595404581*nuVtSqSum[1]*fl[4]+1.933495104806965*fr[2]*nuVtSqSum[2]-1.933495104806965*fl[2]*nuVtSqSum[2])*rdv2L+alphaDrag[2]*(0.7905694150420947*favg[16]+0.2258769757263128*favg[11]+0.6123724356957944*favg[6]+0.3535533905932737*favg[2])-0.5*fjump[11]+0.3535533905932737*alphaDrag[0]*favg[11]+alphaDrag[1]*(0.5477225575051661*favg[10]+0.3162277660168379*favg[4])+alphaDrag[3]*(0.5378528742004769*favg[10]+0.3105295017040593*favg[4]); 
  Ghat[12] = ((-2.736539322015579*nuVtSqSum[1]*fr[14])-2.736539322015579*nuVtSqSum[1]*fl[14]+1.729370595404581*nuVtSqSum[2]*fr[12]+1.933495104806964*nuVtSqSum[0]*fr[12]-1.729370595404581*nuVtSqSum[2]*fl[12]-1.933495104806964*nuVtSqSum[0]*fl[12]+1.933495104806965*nuVtSqSum[1]*fr[8]-1.933495104806965*nuVtSqSum[1]*fl[8])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[14]+0.3535533905932737*favg[8])-0.5*fjump[12]+0.3162277660168379*alphaDrag[2]*favg[12]+0.3535533905932737*alphaDrag[0]*favg[12]; 
  Ghat[17] = ((-0.9646460450276559*nuVtSqSum[3]*fr[19])-0.9646460450276559*nuVtSqSum[3]*fl[19]+1.152913730269721*nuVtSqSum[2]*fr[17]+1.933495104806964*nuVtSqSum[0]*fr[17]-1.152913730269721*nuVtSqSum[2]*fl[17]-1.933495104806964*nuVtSqSum[0]*fl[17]+1.931202864369305*nuVtSqSum[2]*fr[15]-1.931202864369305*nuVtSqSum[2]*fl[15]-1.631756785900806*nuVtSqSum[3]*fr[13]-2.40353003158338*nuVtSqSum[1]*fr[13]-1.631756785900806*nuVtSqSum[3]*fl[13]-2.40353003158338*nuVtSqSum[1]*fl[13]+2.198771185585824*nuVtSqSum[3]*fr[9]-2.198771185585824*nuVtSqSum[3]*fl[9]+1.152913730269721*nuVtSqSum[3]*fr[7]+1.698208212444073*nuVtSqSum[1]*fr[7]-1.152913730269721*nuVtSqSum[3]*fl[7]-1.698208212444073*nuVtSqSum[1]*fl[7]-2.40353003158338*nuVtSqSum[2]*fr[5]-2.40353003158338*nuVtSqSum[2]*fl[5]-2.736539322015579*fr[3]*nuVtSqSum[3]-2.736539322015579*fl[3]*nuVtSqSum[3]+1.933495104806964*fr[0]*nuVtSqSum[3]-1.933495104806964*fl[0]*nuVtSqSum[3]+1.698208212444073*fr[1]*nuVtSqSum[2]-1.698208212444073*fl[1]*nuVtSqSum[2])*rdv2L+alphaDrag[3]*(0.9354143466934851*favg[19]+0.3651483716701107*favg[13]+0.7905694150420947*favg[9]+0.210818510677892*favg[7]+0.6123724356957944*favg[3]+0.3535533905932737*favg[0])-0.5*fjump[17]+0.3535533905932737*alphaDrag[0]*favg[17]+alphaDrag[2]*(0.210818510677892*favg[17]+0.6943650748294133*favg[15]+0.537852874200477*favg[5]+0.3105295017040592*favg[1])+alphaDrag[1]*(0.5378528742004769*favg[13]+0.3105295017040592*favg[7]); 
  Ghat[18] = (1.933495104806964*nuVtSqSum[0]*fr[18]-1.933495104806964*nuVtSqSum[0]*fl[18])*rdv2L-0.5*fjump[18]+0.3535533905932737*alphaDrag[0]*favg[18]; 
