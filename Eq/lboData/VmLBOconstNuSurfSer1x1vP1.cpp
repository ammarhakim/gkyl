...
{ 
  ...
  Ghat[0] = ((-0.7654655446197428*nuVtSqSum[1]*fr[3])-0.7654655446197428*nuVtSqSum[1]*fl[3]-0.7654655446197428*nuVtSqSum[0]*fr[2]-0.7654655446197428*nuVtSqSum[0]*fl[2]+0.7954951288348656*fr[1]*nuVtSqSum[1]-0.7954951288348656*fl[1]*nuVtSqSum[1]+0.7954951288348656*fr[0]*nuVtSqSum[0]-0.7954951288348656*fl[0]*nuVtSqSum[0])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[3]+0.3535533905932737*favg[1])-0.8660254037844386*fjump[2]+alphaDrag[0]*(0.6123724356957944*favg[2]+0.3535533905932737*favg[0])-0.5*fjump[0]; 
  Ghat[1] = ((-0.7654655446197428*nuVtSqSum[0]*fr[3])-0.7654655446197428*nuVtSqSum[0]*fl[3]-0.7654655446197428*nuVtSqSum[1]*fr[2]-0.7654655446197428*nuVtSqSum[1]*fl[2]+0.7954951288348656*fr[0]*nuVtSqSum[1]-0.7954951288348656*fl[0]*nuVtSqSum[1]+0.7954951288348656*nuVtSqSum[0]*fr[1]-0.7954951288348656*nuVtSqSum[0]*fl[1])*rdv2L-0.8660254037844386*fjump[3]+alphaDrag[0]*(0.6123724356957944*favg[3]+0.3535533905932737*favg[1])+alphaDrag[1]*(0.6123724356957944*favg[2]+0.3535533905932737*favg[0])-0.5*fjump[1]; 
