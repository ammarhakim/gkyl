...
{ 
  ...
  out[5] += 4.743416490252569*(facDiff[2]*f[4]+f[1]*facDiff[1]+f[0]*facDiff[0])*rdvxSq4nu+1.732050807568877*alphaDrag[2]*f[5]+1.936491673103709*(alphaDrag[1]*f[3]+alphaDrag[0]*f[2]+f[0]*alphaDrag[2]); 
...
{ 
  ...
  out[5] += 4.743416490252569*(facDiff[3]*f[8]+facDiff[2]*f[4]+f[1]*facDiff[1]+f[0]*facDiff[0])*rdvxSq4nu+1.936491673103709*alphaDrag[4]*f[6]+1.732050807568877*alphaDrag[2]*f[5]+1.936491673103709*(alphaDrag[1]*f[3]+alphaDrag[0]*f[2]+f[0]*alphaDrag[2]); 
  ...
  out[7] += (4.166190448976479*facDiff[2]*f[8]+4.242640687119286*(facDiff[1]*f[4]+f[1]*facDiff[2])+4.166190448976479*facDiff[3]*f[4]+4.743416490252569*(f[0]*facDiff[1]+facDiff[0]*f[1]))*rdvxSq4nu+1.700840128541522*f[6]*alphaDrag[8]+1.732050807568877*(alphaDrag[2]*f[7]+alphaDrag[1]*f[6]+f[3]*alphaDrag[4])+1.936491673103709*(alphaDrag[0]*f[3]+alphaDrag[1]*f[2]+f[1]*alphaDrag[2]); 
  out[9] += 16.20185174601965*(facDiff[2]*f[6]+facDiff[1]*f[3]+facDiff[0]*f[2])*rdvxSq4nu+2.598076211353316*alphaDrag[2]*f[9]+1.322875655532295*alphaDrag[8]*f[8]+2.958039891549809*(alphaDrag[1]*f[7]+alphaDrag[0]*f[5])+1.322875655532295*alphaDrag[4]*f[4]+3.968626966596886*alphaDrag[2]*f[2]+1.322875655532295*(alphaDrag[1]*f[1]+alphaDrag[0]*f[0]); 
