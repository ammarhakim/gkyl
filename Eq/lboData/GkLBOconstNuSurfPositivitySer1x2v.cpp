...
{ 
  ...
  double incr2[8]; 
 if (((-0.7654655446197428*fr[8])-0.7654655446197428*fl[8]-0.7654655446197428*fr[7]-0.7654655446197428*fl[7]+0.7954951288348656*fr[6]-0.7954951288348656*fl[6]-0.7654655446197428*fr[5]-0.7654655446197428*fl[5]+0.7954951288348656*fr[4]-0.7954951288348656*fl[4]-0.7654655446197428*fr[3]-0.7654655446197428*fl[3]+0.7954951288348656*fr[2]-0.7954951288348656*fl[2]+0.7954951288348656*fr[1]-0.7954951288348656*fl[1]<0.0) || ((-0.7654655446197428*fr[8])-0.7654655446197428*fl[8]+0.7654655446197428*fr[7]+0.7654655446197428*fl[7]+0.7954951288348656*fr[6]-0.7954951288348656*fl[6]+0.7654655446197428*fr[5]+0.7654655446197428*fl[5]-0.7954951288348656*fr[4]+0.7954951288348656*fl[4]-0.7654655446197428*fr[3]-0.7654655446197428*fl[3]-0.7954951288348656*fr[2]+0.7954951288348656*fl[2]+0.7954951288348656*fr[1]-0.7954951288348656*fl[1]<0.0)) {
  incr2[0] = 0.0; 
  incr2[1] = 0.0; 
  incr2[2] = 0.0; 
  incr2[3] = 0.0; 
  ...
  Ghat[0] = 0.7071067811865475*alphaDrSurf[1]*fhatAL[1]+0.7071067811865475*alphaDrSurf[0]*fhatAL[0]; 
  Ghat[1] = 0.7071067811865475*alphaDrSurf[0]*fhatAL[1]+0.7071067811865475*fhatAL[0]*alphaDrSurf[1]; 
  Ghat[3] = 0.7071067811865475*alphaDrSurf[1]*fhatAL[3]+0.7071067811865475*alphaDrSurf[0]*fhatAL[2]; 
  Ghat[5] = 0.7071067811865475*alphaDrSurf[0]*fhatAL[3]+0.7071067811865475*alphaDrSurf[1]*fhatAL[2]; 
  } else {
...
{ 
  ...
  double incr2[8]; 
 if (((-0.7654655446197428*fr[8])-0.7654655446197428*fl[8]-0.7654655446197428*fr[7]-0.7654655446197428*fl[7]-0.7654655446197428*fr[6]-0.7654655446197428*fl[6]+0.7954951288348656*fr[5]-0.7954951288348656*fl[5]-0.7654655446197428*fr[4]-0.7654655446197428*fl[4]+0.7954951288348656*fr[3]-0.7954951288348656*fl[3]+0.7954951288348656*fr[2]-0.7954951288348656*fl[2]+0.7954951288348656*fr[1]-0.7954951288348656*fl[1]<0.0) || ((-0.7654655446197428*fr[8])-0.7654655446197428*fl[8]+0.7654655446197428*fr[7]+0.7654655446197428*fl[7]+0.7654655446197428*fr[6]+0.7654655446197428*fl[6]+0.7954951288348656*fr[5]-0.7954951288348656*fl[5]-0.7654655446197428*fr[4]-0.7654655446197428*fl[4]-0.7954951288348656*fr[3]+0.7954951288348656*fl[3]-0.7954951288348656*fr[2]+0.7954951288348656*fl[2]+0.7954951288348656*fr[1]-0.7954951288348656*fl[1]<0.0)) {
  incr2[0] = 0.0; 
  incr2[1] = 0.0; 
  incr2[2] = 0.0; 
  incr2[3] = 0.0; 
  ...
  Ghat[0] = 0.7071067811865475*alphaDrSurf[0]*fhatAL[0]; 
  Ghat[1] = 0.7071067811865475*alphaDrSurf[0]*fhatAL[1]; 
  Ghat[2] = 0.7071067811865475*alphaDrSurf[0]*fhatAL[2]; 
  Ghat[4] = 0.7071067811865475*alphaDrSurf[0]*fhatAL[3]; 
  } else {
