...
{ 
  ...
  alpha_drag[8] = (2.0*nuU[2]-2.828427124746191*w[2]*nu)*rdvy2; 
  alpha_drag[9] = 2.0*nuU[3]*rdvy2; 
  alpha_drag[11] = -0.8164965809277261*dxv[2]*nu*rdvy2; 
...
{ 
  ...
  // Expand rdv2*nu*(vy-uy) in phase basis.
  alpha_drag[20] = (2.0*nuU[3]-2.828427124746191*w[2]*nu)*rdvy2; 
  alpha_drag[21] = 2.0*nuU[4]*rdvy2; 
  alpha_drag[23] = -0.8164965809277261*dxv[2]*nu*rdvy2; 
  alpha_drag[27] = 2.0*nuU[5]*rdvy2; 
  ...
  out[8] += 2.371708245126284*(alpha_diffusion[7]*f[7]+alpha_diffusion[1]*f[1]+alpha_diffusion[0]*f[0])*rdvxSq4+1.369306393762915*alpha_drag[7]*f[11]+1.224744871391589*alpha_drag[2]*f[8]+1.369306393762915*(alpha_drag[1]*f[4]+alpha_drag[0]*f[2]+f[0]*alpha_drag[2]); 
  out[9] += 2.371708245126284*(alpha_diffusion[7]*f[7]+alpha_diffusion[1]*f[1]+alpha_diffusion[0]*f[0])*rdvySq4+1.369306393762915*f[13]*alpha_drag[27]+1.224744871391589*f[9]*alpha_drag[23]+1.369306393762915*(f[0]*alpha_drag[23]+f[5]*alpha_drag[21]+f[3]*alpha_drag[20]); 
  ...
  out[12] += (2.121320343559642*(alpha_diffusion[1]*f[7]+f[1]*alpha_diffusion[7])+2.371708245126284*(alpha_diffusion[0]*f[1]+f[0]*alpha_diffusion[1]))*rdvxSq4+1.224744871391589*(alpha_drag[2]*f[12]+alpha_drag[1]*f[11]+f[4]*alpha_drag[7])+1.369306393762915*(alpha_drag[0]*f[4]+alpha_drag[1]*f[2]+f[1]*alpha_drag[2]); 
  ...
  out[14] += 2.371708245126284*(alpha_diffusion[7]*f[13]+alpha_diffusion[1]*f[5]+alpha_diffusion[0]*f[3])*rdvxSq4+0.6123724356957944*(f[14]*alpha_drag[23]+f[12]*alpha_drag[21]+f[8]*alpha_drag[20])+1.369306393762915*alpha_drag[7]*f[17]+1.224744871391589*alpha_drag[2]*f[14]+1.369306393762915*(alpha_drag[1]*f[10]+alpha_drag[0]*f[6]+alpha_drag[2]*f[3]); 
  out[15] += (2.121320343559642*(alpha_diffusion[1]*f[7]+f[1]*alpha_diffusion[7])+2.371708245126284*(alpha_diffusion[0]*f[1]+f[0]*alpha_diffusion[1]))*rdvySq4+1.224744871391589*f[5]*alpha_drag[27]+(1.224744871391589*f[15]+1.369306393762915*f[1])*alpha_drag[23]+1.224744871391589*f[13]*alpha_drag[21]+1.369306393762915*(f[3]*alpha_drag[21]+f[5]*alpha_drag[20]); 
  out[16] += 2.371708245126284*(alpha_diffusion[7]*f[11]+alpha_diffusion[1]*f[4]+alpha_diffusion[0]*f[2])*rdvySq4+1.369306393762915*f[17]*alpha_drag[27]+1.224744871391589*f[16]*alpha_drag[23]+1.369306393762915*(f[2]*alpha_drag[23]+f[10]*alpha_drag[21]+f[6]*alpha_drag[20])+0.6123724356957944*(alpha_drag[2]*f[16]+alpha_drag[1]*f[15]+alpha_drag[0]*f[9]); 
  ...
  out[18] += (2.121320343559642*(alpha_diffusion[1]*f[13]+f[5]*alpha_diffusion[7])+2.371708245126284*(alpha_diffusion[0]*f[5]+alpha_diffusion[1]*f[3]))*rdvxSq4+0.5477225575051661*f[12]*alpha_drag[27]+0.6123724356957944*(f[18]*alpha_drag[23]+f[8]*alpha_drag[21]+f[12]*alpha_drag[20])+1.224744871391589*(alpha_drag[2]*f[18]+alpha_drag[1]*f[17]+alpha_drag[7]*f[10])+1.369306393762915*(alpha_drag[0]*f[10]+alpha_drag[1]*f[6]+alpha_drag[2]*f[5]); 
  out[19] += (2.121320343559642*(alpha_diffusion[1]*f[11]+f[4]*alpha_diffusion[7])+2.371708245126284*(alpha_diffusion[0]*f[4]+alpha_diffusion[1]*f[2]))*rdvySq4+1.224744871391589*f[10]*alpha_drag[27]+(1.224744871391589*f[19]+1.369306393762915*f[4])*alpha_drag[23]+1.224744871391589*f[17]*alpha_drag[21]+1.369306393762915*(f[6]*alpha_drag[21]+f[10]*alpha_drag[20])+0.6123724356957944*alpha_drag[2]*f[19]+0.5477225575051661*alpha_drag[7]*f[15]+0.6123724356957944*(alpha_drag[0]*f[15]+alpha_drag[1]*f[9]); 
...
{ 
  ...
  // Expand rdv2*nu*(vy-uy) in phase basis.
  alpha_drag[32] = (2.0*nuU[4]-2.828427124746191*w[2]*nu)*rdvy2; 
  alpha_drag[33] = 2.0*nuU[5]*rdvy2; 
  alpha_drag[35] = -0.8164965809277261*dxv[2]*nu*rdvy2; 
  alpha_drag[39] = 2.0*nuU[6]*rdvy2; 
  alpha_drag[49] = 2.0*nuU[7]*rdvy2; 
  ...
  out[8] += 2.371708245126284*(alpha_diffusion[17]*f[17]+alpha_diffusion[7]*f[7]+alpha_diffusion[1]*f[1]+alpha_diffusion[0]*f[0])*rdvxSq4+1.369306393762915*(alpha_drag[17]*f[23]+alpha_drag[7]*f[11])+1.224744871391589*alpha_drag[2]*f[8]+1.369306393762915*(alpha_drag[1]*f[4]+alpha_drag[0]*f[2]+f[0]*alpha_drag[2]); 
  out[9] += 2.371708245126284*(alpha_diffusion[17]*f[17]+alpha_diffusion[7]*f[7]+alpha_diffusion[1]*f[1]+alpha_diffusion[0]*f[0])*rdvySq4+1.369306393762915*(f[25]*alpha_drag[49]+f[13]*alpha_drag[39])+1.224744871391589*f[9]*alpha_drag[35]+1.369306393762915*(f[0]*alpha_drag[35]+f[5]*alpha_drag[33]+f[3]*alpha_drag[32]); 
  ...
  out[14] += 2.371708245126284*(alpha_diffusion[17]*f[25]+alpha_diffusion[7]*f[13]+alpha_diffusion[1]*f[5]+alpha_diffusion[0]*f[3])*rdvxSq4+0.6123724356957944*(f[14]*alpha_drag[35]+f[12]*alpha_drag[33]+f[8]*alpha_drag[32])+1.369306393762915*(alpha_drag[17]*f[29]+alpha_drag[7]*f[20])+1.224744871391589*alpha_drag[2]*f[14]+1.369306393762915*(alpha_drag[1]*f[10]+alpha_drag[0]*f[6]+alpha_drag[2]*f[3]); 
  ...
  out[16] += 2.371708245126284*(alpha_diffusion[17]*f[23]+alpha_diffusion[7]*f[11]+alpha_diffusion[1]*f[4]+alpha_diffusion[0]*f[2])*rdvySq4+1.369306393762915*(f[29]*alpha_drag[49]+f[20]*alpha_drag[39])+1.224744871391589*f[16]*alpha_drag[35]+1.369306393762915*(f[2]*alpha_drag[35]+f[10]*alpha_drag[33]+f[6]*alpha_drag[32])+0.6123724356957944*(alpha_drag[2]*f[16]+alpha_drag[1]*f[15]+alpha_drag[0]*f[9]); 
  out[18] += 8.100925873009823*(alpha_diffusion[17]*f[23]+alpha_diffusion[7]*f[11]+alpha_diffusion[1]*f[4]+alpha_diffusion[0]*f[2])*rdvxSq4+1.837117307087383*alpha_drag[2]*f[18]+0.9354143466934851*alpha_drag[17]*f[17]+2.091650066335188*(alpha_drag[1]*f[12]+alpha_drag[0]*f[8])+0.9354143466934851*alpha_drag[7]*f[7]+2.806243040080455*alpha_drag[2]*f[2]+0.9354143466934851*(alpha_drag[1]*f[1]+alpha_drag[0]*f[0]); 
  out[19] += 8.100925873009823*(alpha_diffusion[17]*f[25]+alpha_diffusion[7]*f[13]+alpha_diffusion[1]*f[5]+alpha_diffusion[0]*f[3])*rdvySq4+0.9354143466934851*(f[17]*alpha_drag[49]+f[7]*alpha_drag[39])+(1.837117307087383*f[19]+2.806243040080455*f[3])*alpha_drag[35]+(2.091650066335188*f[15]+0.9354143466934851*f[1])*alpha_drag[33]+(2.091650066335188*f[9]+0.9354143466934851*f[0])*alpha_drag[32]; 
