...
{ 
  ...
  alpha_drag[8] = (2.0*nuU[2]-2.828427124746191*w[2]*nu)*rdv21; 
  alpha_drag[9] = 2.0*nuU[3]*rdv21; 
...
{ 
  ...
  alpha_drag[20] = (2.0*nuU[3]-2.828427124746191*w[2]*nu)*rdv21; 
  alpha_drag[21] = 2.0*nuU[4]*rdv21; 
  alpha_drag[23] = -0.8164965809277261*dxv[2]*nu*rdv21; 
  alpha_drag[27] = 2.0*nuU[5]*rdv21; 
...
{ 
  ...
  alpha_mid += std::abs(0.1767766952966368*alpha_drag[0]-0.1976423537605236*alpha_drag[7]); 
  alpha_drag[32] = (2.0*nuU[4]-2.828427124746191*w[2]*nu)*rdv21; 
  alpha_drag[33] = 2.0*nuU[5]*rdv21; 
  alpha_drag[35] = -0.8164965809277261*dxv[2]*nu*rdv21; 
  alpha_drag[39] = 2.0*nuU[6]*rdv21; 
  alpha_drag[49] = 2.0*nuU[7]*rdv21; 
