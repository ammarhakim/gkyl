...
{ 
  ...
  Ghat[0] = (-(1.0*((12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[1]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[1]*dxvl3R4)*fr[8]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R4)+2.449489742783178*nuVtSqSum[1]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2)*fl[8]+(12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[0]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[0]*dxvl3R4)*fr[4]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R4)+2.449489742783178*nuVtSqSum[0]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2)*fl[4]+((12.72792206135786*fl[1]-12.72792206135786*fr[1])*nuVtSqSum[1]+(12.72792206135786*fl[0]-12.72792206135786*fr[0])*nuVtSqSum[0])*dxvl3R2*dxvr3R2))/(dxvl[3]*dxvr3R4+3.0*dxvl3R2*dxvr3R3+3.0*dxvl3R3*dxvr3R2+dxvl3R4*dxvr[3]))+0.25*(2.449489742783178*alphaDrag[1]*favg[8]+2.449489742783178*alphaDrag[0]*favg[4]+1.414213562373095*alphaDrag[1]*favg[1]+1.414213562373095*alphaDrag[0]*favg[0])-0.5*(1.732050807568877*fjump[4]+fjump[0]); 
  Ghat[1] = (-(1.0*((12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[0]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[0]*dxvl3R4)*fr[8]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R4)+2.449489742783178*nuVtSqSum[0]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2)*fl[8]+(12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[1]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[1]*dxvl3R4)*fr[4]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R4)+2.449489742783178*nuVtSqSum[1]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2)*fl[4]+((12.72792206135786*fl[0]-12.72792206135786*fr[0])*nuVtSqSum[1]-12.72792206135786*nuVtSqSum[0]*fr[1]+12.72792206135786*nuVtSqSum[0]*fl[1])*dxvl3R2*dxvr3R2))/(dxvl[3]*dxvr3R4+3.0*dxvl3R2*dxvr3R3+3.0*dxvl3R3*dxvr3R2+dxvl3R4*dxvr[3]))-0.5*(1.732050807568877*fjump[8]+fjump[1])+0.25*(2.449489742783178*alphaDrag[0]*favg[8]+2.449489742783178*alphaDrag[1]*favg[4]+1.414213562373095*alphaDrag[0]*favg[1]+1.414213562373095*favg[0]*alphaDrag[1]); 
  Ghat[2] = (-(1.0*((12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[1]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[1]*dxvl3R4)*fr[12]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R4)+2.449489742783178*nuVtSqSum[1]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2)*fl[12]+(12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[0]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[0]*dxvl3R4)*fr[9]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R4)+2.449489742783178*nuVtSqSum[0]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2)*fl[9]-12.72792206135786*nuVtSqSum[1]*dxvl3R2*dxvr3R2*fr[5]+12.72792206135786*nuVtSqSum[1]*dxvl3R2*dxvr3R2*fl[5]+(12.72792206135786*nuVtSqSum[0]*fl[2]-12.72792206135786*nuVtSqSum[0]*fr[2])*dxvl3R2*dxvr3R2))/(dxvl[3]*dxvr3R4+3.0*dxvl3R2*dxvr3R3+3.0*dxvl3R3*dxvr3R2+dxvl3R4*dxvr[3]))+0.25*(2.449489742783178*alphaDrag[1]*favg[12]+2.449489742783178*alphaDrag[0]*favg[9]+1.414213562373095*alphaDrag[1]*favg[5]+1.414213562373095*alphaDrag[0]*favg[2])-0.5*(1.732050807568877*fjump[9]+fjump[2]); 
  Ghat[3] = (-(1.0*((12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[1]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[1]*dxvl3R4)*fr[13]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R4)+2.449489742783178*nuVtSqSum[1]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2)*fl[13]+(12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[0]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[0]*dxvl3R4)*fr[10]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R4)+2.449489742783178*nuVtSqSum[0]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2)*fl[10]-12.72792206135786*nuVtSqSum[1]*dxvl3R2*dxvr3R2*fr[6]+12.72792206135786*nuVtSqSum[1]*dxvl3R2*dxvr3R2*fl[6]-12.72792206135786*nuVtSqSum[0]*dxvl3R2*dxvr3R2*fr[3]+12.72792206135786*nuVtSqSum[0]*dxvl3R2*dxvr3R2*fl[3]))/(dxvl[3]*dxvr3R4+3.0*dxvl3R2*dxvr3R3+3.0*dxvl3R3*dxvr3R2+dxvl3R4*dxvr[3]))+0.25*(2.449489742783178*alphaDrag[1]*favg[13]+2.449489742783178*alphaDrag[0]*favg[10]+1.414213562373095*alphaDrag[1]*favg[6]+1.414213562373095*alphaDrag[0]*favg[3])-0.5*(1.732050807568877*fjump[10]+fjump[3]); 
  Ghat[5] = (-(1.0*((12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[0]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[0]*dxvl3R4)*fr[12]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R4)+2.449489742783178*nuVtSqSum[0]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2)*fl[12]+(12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[1]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[1]*dxvl3R4)*fr[9]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R4)+2.449489742783178*nuVtSqSum[1]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2)*fl[9]-12.72792206135786*nuVtSqSum[0]*dxvl3R2*dxvr3R2*fr[5]+12.72792206135786*nuVtSqSum[0]*dxvl3R2*dxvr3R2*fl[5]+(12.72792206135786*nuVtSqSum[1]*fl[2]-12.72792206135786*nuVtSqSum[1]*fr[2])*dxvl3R2*dxvr3R2))/(dxvl[3]*dxvr3R4+3.0*dxvl3R2*dxvr3R3+3.0*dxvl3R3*dxvr3R2+dxvl3R4*dxvr[3]))-0.5*(1.732050807568877*fjump[12]+fjump[5])+0.25*(2.449489742783178*alphaDrag[0]*favg[12]+2.449489742783178*alphaDrag[1]*favg[9]+1.414213562373095*alphaDrag[0]*favg[5]+1.414213562373095*alphaDrag[1]*favg[2]); 
  Ghat[6] = (-(1.0*((12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[0]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[0]*dxvl3R4)*fr[13]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R4)+2.449489742783178*nuVtSqSum[0]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2)*fl[13]+(12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[1]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[1]*dxvl3R4)*fr[10]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R4)+2.449489742783178*nuVtSqSum[1]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2)*fl[10]-12.72792206135786*nuVtSqSum[0]*dxvl3R2*dxvr3R2*fr[6]+12.72792206135786*nuVtSqSum[0]*dxvl3R2*dxvr3R2*fl[6]-12.72792206135786*nuVtSqSum[1]*dxvl3R2*dxvr3R2*fr[3]+12.72792206135786*nuVtSqSum[1]*dxvl3R2*dxvr3R2*fl[3]))/(dxvl[3]*dxvr3R4+3.0*dxvl3R2*dxvr3R3+3.0*dxvl3R3*dxvr3R2+dxvl3R4*dxvr[3]))-0.5*(1.732050807568877*fjump[13]+fjump[6])+0.25*(2.449489742783178*alphaDrag[0]*favg[13]+2.449489742783178*alphaDrag[1]*favg[10]+1.414213562373095*alphaDrag[0]*favg[6]+1.414213562373095*alphaDrag[1]*favg[3]); 
  Ghat[7] = (-(1.0*((12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[1]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[1]*dxvl3R4)*fr[15]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R4)+2.449489742783178*nuVtSqSum[1]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2)*fl[15]+(12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[0]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[0]*dxvl3R4)*fr[14]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R4)+2.449489742783178*nuVtSqSum[0]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2)*fl[14]-12.72792206135786*nuVtSqSum[1]*dxvl3R2*dxvr3R2*fr[11]+12.72792206135786*nuVtSqSum[1]*dxvl3R2*dxvr3R2*fl[11]-12.72792206135786*nuVtSqSum[0]*dxvl3R2*dxvr3R2*fr[7]+12.72792206135786*nuVtSqSum[0]*dxvl3R2*dxvr3R2*fl[7]))/(dxvl[3]*dxvr3R4+3.0*dxvl3R2*dxvr3R3+3.0*dxvl3R3*dxvr3R2+dxvl3R4*dxvr[3]))+0.25*(2.449489742783178*alphaDrag[1]*favg[15]+2.449489742783178*alphaDrag[0]*favg[14]+1.414213562373095*alphaDrag[1]*favg[11]+1.414213562373095*alphaDrag[0]*favg[7])-0.5*(1.732050807568877*fjump[14]+fjump[7]); 
  Ghat[11] = (-(1.0*((12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[0]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[0]*dxvl3R4)*fr[15]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R4)+2.449489742783178*nuVtSqSum[0]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[0]*dxvl3R2*dxvr3R2)*fl[15]+(12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2+2.449489742783178*nuVtSqSum[1]*dxvl3R3*dxvr[3]-2.449489742783178*nuVtSqSum[1]*dxvl3R4)*fr[14]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R4)+2.449489742783178*nuVtSqSum[1]*dxvl[3]*dxvr3R3+12.24744871391589*nuVtSqSum[1]*dxvl3R2*dxvr3R2)*fl[14]-12.72792206135786*nuVtSqSum[0]*dxvl3R2*dxvr3R2*fr[11]+12.72792206135786*nuVtSqSum[0]*dxvl3R2*dxvr3R2*fl[11]-12.72792206135786*nuVtSqSum[1]*dxvl3R2*dxvr3R2*fr[7]+12.72792206135786*nuVtSqSum[1]*dxvl3R2*dxvr3R2*fl[7]))/(dxvl[3]*dxvr3R4+3.0*dxvl3R2*dxvr3R3+3.0*dxvl3R3*dxvr3R2+dxvl3R4*dxvr[3]))-0.5*(1.732050807568877*fjump[15]+fjump[11])+0.25*(2.449489742783178*alphaDrag[0]*favg[15]+2.449489742783178*alphaDrag[1]*favg[14]+1.414213562373095*alphaDrag[0]*favg[11]+1.414213562373095*alphaDrag[1]*favg[7]); 
  ...
  incr2[4] = -(1.0*((7.071067811865476*nuVtSqSum[1]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[1]*dxvl3R3)*fr[8]+((-4.242640687119286*nuVtSqSum[1]*dxvr3R3)-7.071067811865476*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[8]+(7.071067811865476*nuVtSqSum[0]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[0]*dxvl3R3)*fr[4]+((-4.242640687119286*nuVtSqSum[0]*dxvr3R3)-7.071067811865476*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[4]+((-2.449489742783178*fl[1]*nuVtSqSum[1])-2.449489742783178*fl[0]*nuVtSqSum[0])*dxvr3R3+((-7.348469228349534*fl[1]*nuVtSqSum[1])-7.348469228349534*fl[0]*nuVtSqSum[0])*dxvl[3]*dxvr3R2+((-7.348469228349534*fr[1]*nuVtSqSum[1])-7.348469228349534*fr[0]*nuVtSqSum[0])*dxvl3R2*dxvr[3]+((-2.449489742783178*fr[1]*nuVtSqSum[1])-2.449489742783178*fr[0]*nuVtSqSum[0])*dxvl3R3))/(4.0*dxvr3R3+12.0*dxvl[3]*dxvr3R2+12.0*dxvl3R2*dxvr[3]+4.0*dxvl3R3); 
  incr2[8] = -(1.0*((7.071067811865476*nuVtSqSum[0]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[0]*dxvl3R3)*fr[8]+((-4.242640687119286*nuVtSqSum[0]*dxvr3R3)-7.071067811865476*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[8]+(7.071067811865476*nuVtSqSum[1]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[1]*dxvl3R3)*fr[4]+((-4.242640687119286*nuVtSqSum[1]*dxvr3R3)-7.071067811865476*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[4]+((-2.449489742783178*fl[0]*nuVtSqSum[1])-2.449489742783178*nuVtSqSum[0]*fl[1])*dxvr3R3+((-7.348469228349534*fl[0]*nuVtSqSum[1])-7.348469228349534*nuVtSqSum[0]*fl[1])*dxvl[3]*dxvr3R2+((-7.348469228349534*fr[0]*nuVtSqSum[1])-7.348469228349534*nuVtSqSum[0]*fr[1])*dxvl3R2*dxvr[3]+((-2.449489742783178*fr[0]*nuVtSqSum[1])-2.449489742783178*nuVtSqSum[0]*fr[1])*dxvl3R3))/(4.0*dxvr3R3+12.0*dxvl[3]*dxvr3R2+12.0*dxvl3R2*dxvr[3]+4.0*dxvl3R3); 
  incr2[9] = -(1.0*((7.071067811865476*nuVtSqSum[1]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[1]*dxvl3R3)*fr[12]+((-4.242640687119286*nuVtSqSum[1]*dxvr3R3)-7.071067811865476*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[12]+(7.071067811865476*nuVtSqSum[0]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[0]*dxvl3R3)*fr[9]+((-4.242640687119286*nuVtSqSum[0]*dxvr3R3)-7.071067811865476*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[9]+((-7.348469228349534*nuVtSqSum[1]*dxvl3R2*dxvr[3])-2.449489742783178*nuVtSqSum[1]*dxvl3R3)*fr[5]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R3)-7.348469228349534*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[5]-2.449489742783178*nuVtSqSum[0]*fl[2]*dxvr3R3-7.348469228349534*nuVtSqSum[0]*fl[2]*dxvl[3]*dxvr3R2-7.348469228349534*nuVtSqSum[0]*fr[2]*dxvl3R2*dxvr[3]-2.449489742783178*nuVtSqSum[0]*fr[2]*dxvl3R3))/(4.0*dxvr3R3+12.0*dxvl[3]*dxvr3R2+12.0*dxvl3R2*dxvr[3]+4.0*dxvl3R3); 
  incr2[10] = -(1.0*((7.071067811865476*nuVtSqSum[1]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[1]*dxvl3R3)*fr[13]+((-4.242640687119286*nuVtSqSum[1]*dxvr3R3)-7.071067811865476*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[13]+(7.071067811865476*nuVtSqSum[0]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[0]*dxvl3R3)*fr[10]+((-4.242640687119286*nuVtSqSum[0]*dxvr3R3)-7.071067811865476*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[10]+((-7.348469228349534*nuVtSqSum[1]*dxvl3R2*dxvr[3])-2.449489742783178*nuVtSqSum[1]*dxvl3R3)*fr[6]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R3)-7.348469228349534*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[6]+((-7.348469228349534*nuVtSqSum[0]*dxvl3R2*dxvr[3])-2.449489742783178*nuVtSqSum[0]*dxvl3R3)*fr[3]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R3)-7.348469228349534*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[3]))/(4.0*dxvr3R3+12.0*dxvl[3]*dxvr3R2+12.0*dxvl3R2*dxvr[3]+4.0*dxvl3R3); 
  incr2[12] = -(1.0*((7.071067811865476*nuVtSqSum[0]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[0]*dxvl3R3)*fr[12]+((-4.242640687119286*nuVtSqSum[0]*dxvr3R3)-7.071067811865476*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[12]+(7.071067811865476*nuVtSqSum[1]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[1]*dxvl3R3)*fr[9]+((-4.242640687119286*nuVtSqSum[1]*dxvr3R3)-7.071067811865476*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[9]+((-7.348469228349534*nuVtSqSum[0]*dxvl3R2*dxvr[3])-2.449489742783178*nuVtSqSum[0]*dxvl3R3)*fr[5]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R3)-7.348469228349534*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[5]-2.449489742783178*nuVtSqSum[1]*fl[2]*dxvr3R3-7.348469228349534*nuVtSqSum[1]*fl[2]*dxvl[3]*dxvr3R2-7.348469228349534*nuVtSqSum[1]*fr[2]*dxvl3R2*dxvr[3]-2.449489742783178*nuVtSqSum[1]*fr[2]*dxvl3R3))/(4.0*dxvr3R3+12.0*dxvl[3]*dxvr3R2+12.0*dxvl3R2*dxvr[3]+4.0*dxvl3R3); 
  incr2[13] = -(1.0*((7.071067811865476*nuVtSqSum[0]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[0]*dxvl3R3)*fr[13]+((-4.242640687119286*nuVtSqSum[0]*dxvr3R3)-7.071067811865476*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[13]+(7.071067811865476*nuVtSqSum[1]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[1]*dxvl3R3)*fr[10]+((-4.242640687119286*nuVtSqSum[1]*dxvr3R3)-7.071067811865476*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[10]+((-7.348469228349534*nuVtSqSum[0]*dxvl3R2*dxvr[3])-2.449489742783178*nuVtSqSum[0]*dxvl3R3)*fr[6]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R3)-7.348469228349534*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[6]+((-7.348469228349534*nuVtSqSum[1]*dxvl3R2*dxvr[3])-2.449489742783178*nuVtSqSum[1]*dxvl3R3)*fr[3]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R3)-7.348469228349534*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[3]))/(4.0*dxvr3R3+12.0*dxvl[3]*dxvr3R2+12.0*dxvl3R2*dxvr[3]+4.0*dxvl3R3); 
  incr2[14] = -(1.0*((7.071067811865476*nuVtSqSum[1]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[1]*dxvl3R3)*fr[15]+((-4.242640687119286*nuVtSqSum[1]*dxvr3R3)-7.071067811865476*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[15]+(7.071067811865476*nuVtSqSum[0]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[0]*dxvl3R3)*fr[14]+((-4.242640687119286*nuVtSqSum[0]*dxvr3R3)-7.071067811865476*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[14]+((-7.348469228349534*nuVtSqSum[1]*dxvl3R2*dxvr[3])-2.449489742783178*nuVtSqSum[1]*dxvl3R3)*fr[11]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R3)-7.348469228349534*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[11]+((-7.348469228349534*nuVtSqSum[0]*dxvl3R2*dxvr[3])-2.449489742783178*nuVtSqSum[0]*dxvl3R3)*fr[7]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R3)-7.348469228349534*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[7]))/(4.0*dxvr3R3+12.0*dxvl[3]*dxvr3R2+12.0*dxvl3R2*dxvr[3]+4.0*dxvl3R3); 
  incr2[15] = -(1.0*((7.071067811865476*nuVtSqSum[0]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[0]*dxvl3R3)*fr[15]+((-4.242640687119286*nuVtSqSum[0]*dxvr3R3)-7.071067811865476*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[15]+(7.071067811865476*nuVtSqSum[1]*dxvl3R2*dxvr[3]+4.242640687119286*nuVtSqSum[1]*dxvl3R3)*fr[14]+((-4.242640687119286*nuVtSqSum[1]*dxvr3R3)-7.071067811865476*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[14]+((-7.348469228349534*nuVtSqSum[0]*dxvl3R2*dxvr[3])-2.449489742783178*nuVtSqSum[0]*dxvl3R3)*fr[11]+((-2.449489742783178*nuVtSqSum[0]*dxvr3R3)-7.348469228349534*nuVtSqSum[0]*dxvl[3]*dxvr3R2)*fl[11]+((-7.348469228349534*nuVtSqSum[1]*dxvl3R2*dxvr[3])-2.449489742783178*nuVtSqSum[1]*dxvl3R3)*fr[7]+((-2.449489742783178*nuVtSqSum[1]*dxvr3R3)-7.348469228349534*nuVtSqSum[1]*dxvl[3]*dxvr3R2)*fl[7]))/(4.0*dxvr3R3+12.0*dxvl[3]*dxvr3R2+12.0*dxvl3R2*dxvr[3]+4.0*dxvl3R3); 
