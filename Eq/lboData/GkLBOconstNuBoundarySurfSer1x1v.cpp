...
{ 
  ...
  if (idxr[1] == 1) {
    ...
    incr2[6] = nuVtSq[1]*(1.224744871391589*fr[7]+0.9486832980505138*fr[3]+0.5477225575051661*fr[1])+nuVtSq[0]*(1.060660171779821*fr[6]+0.6123724356957944*fr[4])+nuVtSq[2]*(0.6776309271789384*fr[6]+1.369306393762915*fr[5]+0.3912303982179757*fr[4]+1.060660171779821*fr[2]+0.6123724356957944*fr[0]); 
    incr2[7] = nuVtSq[0]*(5.303300858899105*fr[7]+4.107919181288746*fr[3]+2.371708245126284*fr[1])+nuVtSq[2]*(4.743416490252569*fr[7]+3.674234614174767*fr[3]+2.121320343559642*fr[1])+nuVtSq[1]*(3.674234614174766*fr[6]+5.303300858899106*fr[5]+2.121320343559642*fr[4]+4.107919181288746*fr[2]+2.371708245126284*fr[0]); 
    ...
    incr2[5] = nuVtSq[1]*(5.303300858899106*fl[7]-4.107919181288745*fl[3]+2.371708245126284*fl[1])+nuVtSq[2]*(2.371708245126284*fl[4]-4.107919181288745*fl[6])+nuVtSq[0]*(5.303300858899105*fl[5]-4.107919181288745*fl[2]+2.371708245126284*fl[0]); 
    incr2[6] = nuVtSq[1]*((-1.224744871391589*fl[7])+0.9486832980505138*fl[3]-0.5477225575051661*fl[1])+nuVtSq[0]*(1.060660171779821*fl[6]-0.6123724356957944*fl[4])+nuVtSq[2]*(0.6776309271789384*fl[6]-1.369306393762915*fl[5]-0.3912303982179757*fl[4]+1.060660171779821*fl[2]-0.6123724356957944*fl[0]); 
    incr2[7] = nuVtSq[0]*(5.303300858899105*fl[7]-4.107919181288746*fl[3]+2.371708245126284*fl[1])+nuVtSq[2]*(4.743416490252569*fl[7]-3.674234614174767*fl[3]+2.121320343559642*fl[1])+nuVtSq[1]*((-3.674234614174766*fl[6])+5.303300858899106*fl[5]+2.121320343559642*fl[4]-4.107919181288746*fl[2]+2.371708245126284*fl[0]); 
