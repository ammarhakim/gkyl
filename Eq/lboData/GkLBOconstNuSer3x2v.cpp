...
{ 
  ...
  positivityWeightByDir[4] = std::abs(0.1767766952966368*alphaVpar[0]) + 0.4714045207910312*nuVtSqSum[0]*rdvSq4[0]; 
  positivityWeightByDir[5] = 2.0*rdv2[1]*w[4]*nuSum+rdvSq4[1]*w[4]*(0.3333333333333333*BmagInv[7]*nuVtSqSum[7]+0.3333333333333333*BmagInv[6]*nuVtSqSum[6]+0.3333333333333333*BmagInv[5]*nuVtSqSum[5]+0.3333333333333333*BmagInv[4]*nuVtSqSum[4]+0.3333333333333333*BmagInv[3]*nuVtSqSum[3]+0.3333333333333333*BmagInv[2]*nuVtSqSum[2]+0.3333333333333333*BmagInv[1]*nuVtSqSum[1]+0.3333333333333333*BmagInv[0]*nuVtSqSum[0])*m_; 
