...
{ 
  ...
  Ghat[0] = ((-0.7654655446197428*nuVtSqSum[1]*fr[4])-0.7654655446197428*nuVtSqSum[1]*fl[4]-0.7654655446197428*nuVtSqSum[0]*fr[2]-0.7654655446197428*nuVtSqSum[0]*fl[2]+0.7954951288348656*fr[1]*nuVtSqSum[1]-0.7954951288348656*fl[1]*nuVtSqSum[1]+0.7954951288348656*fr[0]*nuVtSqSum[0]-0.7954951288348656*fl[0]*nuVtSqSum[0])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[4]+0.3535533905932737*favg[1])-0.8660254037844386*fjump[2]+alphaDrag[0]*(0.6123724356957944*favg[2]+0.3535533905932737*favg[0])-0.5*fjump[0]; 
  Ghat[1] = ((-0.7654655446197428*nuVtSqSum[0]*fr[4])-0.7654655446197428*nuVtSqSum[0]*fl[4]-0.7654655446197428*nuVtSqSum[1]*fr[2]-0.7654655446197428*nuVtSqSum[1]*fl[2]+0.7954951288348656*fr[0]*nuVtSqSum[1]-0.7954951288348656*fl[0]*nuVtSqSum[1]+0.7954951288348656*nuVtSqSum[0]*fr[1]-0.7954951288348656*nuVtSqSum[0]*fl[1])*rdv2L-0.8660254037844386*fjump[4]+alphaDrag[0]*(0.6123724356957944*favg[4]+0.3535533905932737*favg[1])+alphaDrag[1]*(0.6123724356957944*favg[2]+0.3535533905932737*favg[0])-0.5*fjump[1]; 
  Ghat[3] = ((-0.7654655446197428*nuVtSqSum[1]*fr[7])-0.7654655446197428*nuVtSqSum[1]*fl[7]-0.7654655446197428*nuVtSqSum[0]*fr[6]-0.7654655446197428*nuVtSqSum[0]*fl[6]+0.7954951288348656*nuVtSqSum[1]*fr[5]-0.7954951288348656*nuVtSqSum[1]*fl[5]+0.7954951288348656*nuVtSqSum[0]*fr[3]-0.7954951288348656*nuVtSqSum[0]*fl[3])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[7]+0.3535533905932737*favg[5])-0.8660254037844386*fjump[6]+alphaDrag[0]*(0.6123724356957944*favg[6]+0.3535533905932737*favg[3])-0.5*fjump[3]; 
  Ghat[5] = ((-0.7654655446197428*nuVtSqSum[0]*fr[7])-0.7654655446197428*nuVtSqSum[0]*fl[7]-0.7654655446197428*nuVtSqSum[1]*fr[6]-0.7654655446197428*nuVtSqSum[1]*fl[6]+0.7954951288348656*nuVtSqSum[0]*fr[5]-0.7954951288348656*nuVtSqSum[0]*fl[5]+0.7954951288348656*nuVtSqSum[1]*fr[3]-0.7954951288348656*nuVtSqSum[1]*fl[3])*rdv2L-0.8660254037844386*fjump[7]+alphaDrag[0]*(0.6123724356957944*favg[7]+0.3535533905932737*favg[5])+alphaDrag[1]*(0.6123724356957944*favg[6]+0.3535533905932737*favg[3])-0.5*fjump[5]; 
...
{ 
  ...
  Ghat[0] = ((-0.7654655446197428*nuVtSqSum[1]*fr[5])-0.7654655446197428*nuVtSqSum[1]*fl[5]-0.7654655446197428*nuVtSqSum[0]*fr[3]-0.7654655446197428*nuVtSqSum[0]*fl[3]+0.7954951288348656*fr[1]*nuVtSqSum[1]-0.7954951288348656*fl[1]*nuVtSqSum[1]+0.7954951288348656*fr[0]*nuVtSqSum[0]-0.7954951288348656*fl[0]*nuVtSqSum[0])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[5]+0.3535533905932737*favg[1])-0.8660254037844386*fjump[3]+alphaDrag[0]*(0.6123724356957944*favg[3]+0.3535533905932737*favg[0])-0.5*fjump[0]; 
  Ghat[1] = ((-0.7654655446197428*nuVtSqSum[0]*fr[5])-0.7654655446197428*nuVtSqSum[0]*fl[5]-0.7654655446197428*nuVtSqSum[1]*fr[3]-0.7654655446197428*nuVtSqSum[1]*fl[3]+0.7954951288348656*fr[0]*nuVtSqSum[1]-0.7954951288348656*fl[0]*nuVtSqSum[1]+0.7954951288348656*nuVtSqSum[0]*fr[1]-0.7954951288348656*nuVtSqSum[0]*fl[1])*rdv2L-0.8660254037844386*fjump[5]+alphaDrag[0]*(0.6123724356957944*favg[5]+0.3535533905932737*favg[1])+alphaDrag[1]*(0.6123724356957944*favg[3]+0.3535533905932737*favg[0])-0.5*fjump[1]; 
  Ghat[2] = ((-0.7654655446197428*nuVtSqSum[1]*fr[7])-0.7654655446197428*nuVtSqSum[1]*fl[7]-0.7654655446197428*nuVtSqSum[0]*fr[6]-0.7654655446197428*nuVtSqSum[0]*fl[6]+0.7954951288348656*nuVtSqSum[1]*fr[4]-0.7954951288348656*nuVtSqSum[1]*fl[4]+0.7954951288348656*nuVtSqSum[0]*fr[2]-0.7954951288348656*nuVtSqSum[0]*fl[2])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[7]+0.3535533905932737*favg[4])-0.8660254037844386*fjump[6]+alphaDrag[0]*(0.6123724356957944*favg[6]+0.3535533905932737*favg[2])-0.5*fjump[2]; 
  Ghat[4] = ((-0.7654655446197428*nuVtSqSum[0]*fr[7])-0.7654655446197428*nuVtSqSum[0]*fl[7]-0.7654655446197428*nuVtSqSum[1]*fr[6]-0.7654655446197428*nuVtSqSum[1]*fl[6]+0.7954951288348656*nuVtSqSum[0]*fr[4]-0.7954951288348656*nuVtSqSum[0]*fl[4]+0.7954951288348656*nuVtSqSum[1]*fr[2]-0.7954951288348656*nuVtSqSum[1]*fl[2])*rdv2L-0.8660254037844386*fjump[7]+alphaDrag[0]*(0.6123724356957944*favg[7]+0.3535533905932737*favg[4])+alphaDrag[1]*(0.6123724356957944*favg[6]+0.3535533905932737*favg[2])-0.5*fjump[4]; 
