...
{ 
  ...
  if (idxr[1] == 1) {
    ...
    outr[2] += (nuVtSqSum[0]*(1.369306393762915*fr[8]-1.060660171779821*fr[2]+0.6123724356957944*fr[0])+nuVtSqSum[1]*(0.6123724356957944*fr[1]-1.060660171779821*fr[4]))*rdvSq4R; 
    outr[4] += (nuVtSqSum[1]*(1.369306393762915*fr[8]-1.060660171779821*fr[2]+0.6123724356957944*fr[0])+nuVtSqSum[0]*(0.6123724356957944*fr[1]-1.060660171779821*fr[4]))*rdvSq4R; 
    ...
    outr[8] += (nuVtSqSum[0]*((-5.303300858899105*fr[8])+4.107919181288745*fr[2]-2.371708245126284*fr[0])+nuVtSqSum[1]*(4.107919181288745*fr[4]-2.371708245126284*fr[1]))*rdvSq4R; 

  } else {

    outl[2] += (nuVtSqSum[0]*((-1.369306393762915*fl[8])-1.060660171779821*fl[2]-0.6123724356957944*fl[0])+nuVtSqSum[1]*((-1.060660171779821*fl[4])-0.6123724356957944*fl[1]))*rdvSq4L; 
    outl[4] += (nuVtSqSum[1]*((-1.369306393762915*fl[8])-1.060660171779821*fl[2]-0.6123724356957944*fl[0])+nuVtSqSum[0]*((-1.060660171779821*fl[4])-0.6123724356957944*fl[1]))*rdvSq4L; 
    ...
    outl[8] += (nuVtSqSum[0]*((-5.303300858899105*fl[8])-4.107919181288745*fl[2]-2.371708245126284*fl[0])+nuVtSqSum[1]*((-4.107919181288745*fl[4])-2.371708245126284*fl[1]))*rdvSq4L; 
