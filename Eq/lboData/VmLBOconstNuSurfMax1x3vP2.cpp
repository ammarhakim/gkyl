...
{ 
  ...
  Ghat[0] = (0.9486832980505137*nuVtSqSum[0]*fr[12]-0.9486832980505137*nuVtSqSum[0]*fl[12]+1.325825214724776*nuVtSqSum[2]*fr[11]-1.325825214724776*nuVtSqSum[2]*fl[11]-1.684024198163434*nuVtSqSum[1]*fr[5]-1.684024198163434*nuVtSqSum[1]*fl[5]-1.684024198163434*nuVtSqSum[0]*fr[2]-1.684024198163434*nuVtSqSum[0]*fl[2]+1.325825214724776*fr[1]*nuVtSqSum[1]-1.325825214724776*fl[1]*nuVtSqSum[1]+1.325825214724776*fr[0]*nuVtSqSum[0]-1.325825214724776*fl[0]*nuVtSqSum[0])*rdv2L-1.118033988749895*fjump[12]+alphaDrag[0]*(0.7905694150420947*favg[12]+0.6123724356957944*favg[2]+0.3535533905932737*favg[0])+0.3535533905932737*alphaDrag[2]*favg[11]+alphaDrag[1]*(0.6123724356957944*favg[5]+0.3535533905932737*favg[1])-0.8660254037844386*fjump[2]-0.5*fjump[0]; 
  Ghat[1] = (0.9486832980505137*nuVtSqSum[1]*fr[12]-0.9486832980505137*nuVtSqSum[1]*fl[12]+1.185854122563142*nuVtSqSum[1]*fr[11]-1.185854122563142*nuVtSqSum[1]*fl[11]-1.506237033139206*nuVtSqSum[2]*fr[5]-1.684024198163434*nuVtSqSum[0]*fr[5]-1.506237033139206*nuVtSqSum[2]*fl[5]-1.684024198163434*nuVtSqSum[0]*fl[5]+1.185854122563142*fr[1]*nuVtSqSum[2]-1.185854122563142*fl[1]*nuVtSqSum[2]-1.684024198163434*nuVtSqSum[1]*fr[2]-1.684024198163434*nuVtSqSum[1]*fl[2]+1.325825214724776*fr[0]*nuVtSqSum[1]-1.325825214724776*fl[0]*nuVtSqSum[1]+1.325825214724776*nuVtSqSum[0]*fr[1]-1.325825214724776*nuVtSqSum[0]*fl[1])*rdv2L+alphaDrag[1]*(0.7905694150420947*favg[12]+0.3162277660168379*favg[11]+0.6123724356957944*favg[2]+0.3535533905932737*favg[0])-0.8660254037844386*fjump[5]+alphaDrag[0]*(0.6123724356957944*favg[5]+0.3535533905932737*favg[1])+alphaDrag[2]*(0.5477225575051661*favg[5]+0.3162277660168379*favg[1])-0.5*fjump[1]; 
  Ghat[3] = ((-1.684024198163434*nuVtSqSum[0]*fr[7])-1.684024198163434*nuVtSqSum[0]*fl[7]+1.325825214724776*nuVtSqSum[1]*fr[6]-1.325825214724776*nuVtSqSum[1]*fl[6]+1.325825214724776*nuVtSqSum[0]*fr[3]-1.325825214724776*nuVtSqSum[0]*fl[3])*rdv2L-0.8660254037844386*fjump[7]+alphaDrag[0]*(0.6123724356957944*favg[7]+0.3535533905932737*favg[3])+0.3535533905932737*alphaDrag[1]*favg[6]-0.5*fjump[3]; 
  Ghat[4] = ((-1.684024198163434*nuVtSqSum[0]*fr[9])-1.684024198163434*nuVtSqSum[0]*fl[9]+1.325825214724776*nuVtSqSum[1]*fr[8]-1.325825214724776*nuVtSqSum[1]*fl[8]+1.325825214724776*nuVtSqSum[0]*fr[4]-1.325825214724776*nuVtSqSum[0]*fl[4])*rdv2L-0.8660254037844386*fjump[9]+alphaDrag[0]*(0.6123724356957944*favg[9]+0.3535533905932737*favg[4])+0.3535533905932737*alphaDrag[1]*favg[8]-0.5*fjump[4]; 
  Ghat[6] = ((-1.684024198163434*nuVtSqSum[1]*fr[7])-1.684024198163434*nuVtSqSum[1]*fl[7]+1.185854122563142*nuVtSqSum[2]*fr[6]+1.325825214724776*nuVtSqSum[0]*fr[6]-1.185854122563142*nuVtSqSum[2]*fl[6]-1.325825214724776*nuVtSqSum[0]*fl[6]+1.325825214724776*nuVtSqSum[1]*fr[3]-1.325825214724776*nuVtSqSum[1]*fl[3])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[7]+0.3535533905932737*favg[3])-0.5*fjump[6]+0.3162277660168379*alphaDrag[2]*favg[6]+0.3535533905932737*alphaDrag[0]*favg[6]; 
  Ghat[8] = ((-1.684024198163434*nuVtSqSum[1]*fr[9])-1.684024198163434*nuVtSqSum[1]*fl[9]+1.185854122563142*nuVtSqSum[2]*fr[8]+1.325825214724776*nuVtSqSum[0]*fr[8]-1.185854122563142*nuVtSqSum[2]*fl[8]-1.325825214724776*nuVtSqSum[0]*fl[8]+1.325825214724776*nuVtSqSum[1]*fr[4]-1.325825214724776*nuVtSqSum[1]*fl[4])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[9]+0.3535533905932737*favg[4])-0.5*fjump[8]+0.3162277660168379*alphaDrag[2]*favg[8]+0.3535533905932737*alphaDrag[0]*favg[8]; 
  Ghat[10] = (1.325825214724776*nuVtSqSum[0]*fr[10]-1.325825214724776*nuVtSqSum[0]*fl[10])*rdv2L-0.5*fjump[10]+0.3535533905932737*alphaDrag[0]*favg[10]; 
  Ghat[11] = (0.9486832980505137*nuVtSqSum[2]*fr[12]-0.9486832980505137*nuVtSqSum[2]*fl[12]+0.8470386589736728*nuVtSqSum[2]*fr[11]+1.325825214724776*nuVtSqSum[0]*fr[11]-0.8470386589736728*nuVtSqSum[2]*fl[11]-1.325825214724776*nuVtSqSum[0]*fl[11]-1.506237033139206*nuVtSqSum[1]*fr[5]-1.506237033139206*nuVtSqSum[1]*fl[5]-1.684024198163434*fr[2]*nuVtSqSum[2]-1.684024198163434*fl[2]*nuVtSqSum[2]+1.325825214724776*fr[0]*nuVtSqSum[2]-1.325825214724776*fl[0]*nuVtSqSum[2]+1.185854122563142*fr[1]*nuVtSqSum[1]-1.185854122563142*fl[1]*nuVtSqSum[1])*rdv2L+alphaDrag[2]*(0.7905694150420947*favg[12]+0.2258769757263128*favg[11]+0.6123724356957944*favg[2]+0.3535533905932737*favg[0])-0.5*fjump[11]+0.3535533905932737*alphaDrag[0]*favg[11]+alphaDrag[1]*(0.5477225575051661*favg[5]+0.3162277660168379*favg[1]); 
  Ghat[13] = (1.325825214724776*nuVtSqSum[0]*fr[13]-1.325825214724776*nuVtSqSum[0]*fl[13])*rdv2L-0.5*fjump[13]+0.3535533905932737*alphaDrag[0]*favg[13]; 
  Ghat[14] = (1.325825214724776*nuVtSqSum[0]*fr[14]-1.325825214724776*nuVtSqSum[0]*fl[14])*rdv2L-0.5*fjump[14]+0.3535533905932737*alphaDrag[0]*favg[14]; 
...
{ 
  ...
  Ghat[0] = (0.9486832980505137*nuVtSqSum[0]*fr[13]-0.9486832980505137*nuVtSqSum[0]*fl[13]+1.325825214724776*nuVtSqSum[2]*fr[11]-1.325825214724776*nuVtSqSum[2]*fl[11]-1.684024198163434*nuVtSqSum[1]*fr[6]-1.684024198163434*nuVtSqSum[1]*fl[6]-1.684024198163434*nuVtSqSum[0]*fr[3]-1.684024198163434*nuVtSqSum[0]*fl[3]+1.325825214724776*fr[1]*nuVtSqSum[1]-1.325825214724776*fl[1]*nuVtSqSum[1]+1.325825214724776*fr[0]*nuVtSqSum[0]-1.325825214724776*fl[0]*nuVtSqSum[0])*rdv2L-1.118033988749895*fjump[13]+alphaDrag[0]*(0.7905694150420947*favg[13]+0.6123724356957944*favg[3]+0.3535533905932737*favg[0])+0.3535533905932737*alphaDrag[2]*favg[11]+alphaDrag[1]*(0.6123724356957944*favg[6]+0.3535533905932737*favg[1])-0.8660254037844386*fjump[3]-0.5*fjump[0]; 
  Ghat[1] = (0.9486832980505137*nuVtSqSum[1]*fr[13]-0.9486832980505137*nuVtSqSum[1]*fl[13]+1.185854122563142*nuVtSqSum[1]*fr[11]-1.185854122563142*nuVtSqSum[1]*fl[11]-1.506237033139206*nuVtSqSum[2]*fr[6]-1.684024198163434*nuVtSqSum[0]*fr[6]-1.506237033139206*nuVtSqSum[2]*fl[6]-1.684024198163434*nuVtSqSum[0]*fl[6]-1.684024198163434*nuVtSqSum[1]*fr[3]-1.684024198163434*nuVtSqSum[1]*fl[3]+1.185854122563142*fr[1]*nuVtSqSum[2]-1.185854122563142*fl[1]*nuVtSqSum[2]+1.325825214724776*fr[0]*nuVtSqSum[1]-1.325825214724776*fl[0]*nuVtSqSum[1]+1.325825214724776*nuVtSqSum[0]*fr[1]-1.325825214724776*nuVtSqSum[0]*fl[1])*rdv2L+alphaDrag[1]*(0.7905694150420947*favg[13]+0.3162277660168379*favg[11]+0.6123724356957944*favg[3]+0.3535533905932737*favg[0])-0.8660254037844386*fjump[6]+alphaDrag[0]*(0.6123724356957944*favg[6]+0.3535533905932737*favg[1])+alphaDrag[2]*(0.5477225575051661*favg[6]+0.3162277660168379*favg[1])-0.5*fjump[1]; 
  Ghat[2] = ((-1.684024198163434*nuVtSqSum[0]*fr[7])-1.684024198163434*nuVtSqSum[0]*fl[7]+1.325825214724776*nuVtSqSum[1]*fr[5]-1.325825214724776*nuVtSqSum[1]*fl[5]+1.325825214724776*nuVtSqSum[0]*fr[2]-1.325825214724776*nuVtSqSum[0]*fl[2])*rdv2L-0.8660254037844386*fjump[7]+alphaDrag[0]*(0.6123724356957944*favg[7]+0.3535533905932737*favg[2])+0.3535533905932737*alphaDrag[1]*favg[5]-0.5*fjump[2]; 
  Ghat[4] = ((-1.684024198163434*nuVtSqSum[0]*fr[10])-1.684024198163434*nuVtSqSum[0]*fl[10]+1.325825214724776*nuVtSqSum[1]*fr[8]-1.325825214724776*nuVtSqSum[1]*fl[8]+1.325825214724776*nuVtSqSum[0]*fr[4]-1.325825214724776*nuVtSqSum[0]*fl[4])*rdv2L-0.8660254037844386*fjump[10]+alphaDrag[0]*(0.6123724356957944*favg[10]+0.3535533905932737*favg[4])+0.3535533905932737*alphaDrag[1]*favg[8]-0.5*fjump[4]; 
  Ghat[5] = ((-1.684024198163434*nuVtSqSum[1]*fr[7])-1.684024198163434*nuVtSqSum[1]*fl[7]+1.185854122563142*nuVtSqSum[2]*fr[5]+1.325825214724776*nuVtSqSum[0]*fr[5]-1.185854122563142*nuVtSqSum[2]*fl[5]-1.325825214724776*nuVtSqSum[0]*fl[5]+1.325825214724776*nuVtSqSum[1]*fr[2]-1.325825214724776*nuVtSqSum[1]*fl[2])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[7]+0.3535533905932737*favg[2])-0.5*fjump[5]+0.3162277660168379*alphaDrag[2]*favg[5]+0.3535533905932737*alphaDrag[0]*favg[5]; 
  Ghat[8] = ((-1.684024198163434*nuVtSqSum[1]*fr[10])-1.684024198163434*nuVtSqSum[1]*fl[10]+1.185854122563142*nuVtSqSum[2]*fr[8]+1.325825214724776*nuVtSqSum[0]*fr[8]-1.185854122563142*nuVtSqSum[2]*fl[8]-1.325825214724776*nuVtSqSum[0]*fl[8]+1.325825214724776*nuVtSqSum[1]*fr[4]-1.325825214724776*nuVtSqSum[1]*fl[4])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[10]+0.3535533905932737*favg[4])-0.5*fjump[8]+0.3162277660168379*alphaDrag[2]*favg[8]+0.3535533905932737*alphaDrag[0]*favg[8]; 
  ...
  Ghat[11] = (0.9486832980505137*nuVtSqSum[2]*fr[13]-0.9486832980505137*nuVtSqSum[2]*fl[13]+0.8470386589736728*nuVtSqSum[2]*fr[11]+1.325825214724776*nuVtSqSum[0]*fr[11]-0.8470386589736728*nuVtSqSum[2]*fl[11]-1.325825214724776*nuVtSqSum[0]*fl[11]-1.506237033139206*nuVtSqSum[1]*fr[6]-1.506237033139206*nuVtSqSum[1]*fl[6]-1.684024198163434*nuVtSqSum[2]*fr[3]-1.684024198163434*nuVtSqSum[2]*fl[3]+1.325825214724776*fr[0]*nuVtSqSum[2]-1.325825214724776*fl[0]*nuVtSqSum[2]+1.185854122563142*fr[1]*nuVtSqSum[1]-1.185854122563142*fl[1]*nuVtSqSum[1])*rdv2L+alphaDrag[2]*(0.7905694150420947*favg[13]+0.2258769757263128*favg[11]+0.6123724356957944*favg[3]+0.3535533905932737*favg[0])-0.5*fjump[11]+0.3535533905932737*alphaDrag[0]*favg[11]+alphaDrag[1]*(0.5477225575051661*favg[6]+0.3162277660168379*favg[1]); 
  Ghat[12] = (1.325825214724776*nuVtSqSum[0]*fr[12]-1.325825214724776*nuVtSqSum[0]*fl[12])*rdv2L-0.5*fjump[12]+0.3535533905932737*alphaDrag[0]*favg[12]; 
  Ghat[14] = (1.325825214724776*nuVtSqSum[0]*fr[14]-1.325825214724776*nuVtSqSum[0]*fl[14])*rdv2L-0.5*fjump[14]+0.3535533905932737*alphaDrag[0]*favg[14]; 
...
{ 
  ...
  Ghat[0] = (0.9486832980505137*nuVtSqSum[0]*fr[14]-0.9486832980505137*nuVtSqSum[0]*fl[14]+1.325825214724776*nuVtSqSum[2]*fr[11]-1.325825214724776*nuVtSqSum[2]*fl[11]-1.684024198163434*nuVtSqSum[1]*fr[8]-1.684024198163434*nuVtSqSum[1]*fl[8]-1.684024198163434*nuVtSqSum[0]*fr[4]-1.684024198163434*nuVtSqSum[0]*fl[4]+1.325825214724776*fr[1]*nuVtSqSum[1]-1.325825214724776*fl[1]*nuVtSqSum[1]+1.325825214724776*fr[0]*nuVtSqSum[0]-1.325825214724776*fl[0]*nuVtSqSum[0])*rdv2L-1.118033988749895*fjump[14]+alphaDrag[0]*(0.7905694150420947*favg[14]+0.6123724356957944*favg[4]+0.3535533905932737*favg[0])+0.3535533905932737*alphaDrag[2]*favg[11]+alphaDrag[1]*(0.6123724356957944*favg[8]+0.3535533905932737*favg[1])-0.8660254037844386*fjump[4]-0.5*fjump[0]; 
  Ghat[1] = (0.9486832980505137*nuVtSqSum[1]*fr[14]-0.9486832980505137*nuVtSqSum[1]*fl[14]+1.185854122563142*nuVtSqSum[1]*fr[11]-1.185854122563142*nuVtSqSum[1]*fl[11]-1.506237033139206*nuVtSqSum[2]*fr[8]-1.684024198163434*nuVtSqSum[0]*fr[8]-1.506237033139206*nuVtSqSum[2]*fl[8]-1.684024198163434*nuVtSqSum[0]*fl[8]-1.684024198163434*nuVtSqSum[1]*fr[4]-1.684024198163434*nuVtSqSum[1]*fl[4]+1.185854122563142*fr[1]*nuVtSqSum[2]-1.185854122563142*fl[1]*nuVtSqSum[2]+1.325825214724776*fr[0]*nuVtSqSum[1]-1.325825214724776*fl[0]*nuVtSqSum[1]+1.325825214724776*nuVtSqSum[0]*fr[1]-1.325825214724776*nuVtSqSum[0]*fl[1])*rdv2L+alphaDrag[1]*(0.7905694150420947*favg[14]+0.3162277660168379*favg[11]+0.6123724356957944*favg[4]+0.3535533905932737*favg[0])-0.8660254037844386*fjump[8]+alphaDrag[0]*(0.6123724356957944*favg[8]+0.3535533905932737*favg[1])+alphaDrag[2]*(0.5477225575051661*favg[8]+0.3162277660168379*favg[1])-0.5*fjump[1]; 
  Ghat[2] = ((-1.684024198163434*nuVtSqSum[0]*fr[9])-1.684024198163434*nuVtSqSum[0]*fl[9]+1.325825214724776*nuVtSqSum[1]*fr[5]-1.325825214724776*nuVtSqSum[1]*fl[5]+1.325825214724776*nuVtSqSum[0]*fr[2]-1.325825214724776*nuVtSqSum[0]*fl[2])*rdv2L-0.8660254037844386*fjump[9]+alphaDrag[0]*(0.6123724356957944*favg[9]+0.3535533905932737*favg[2])+0.3535533905932737*alphaDrag[1]*favg[5]-0.5*fjump[2]; 
  Ghat[3] = ((-1.684024198163434*nuVtSqSum[0]*fr[10])-1.684024198163434*nuVtSqSum[0]*fl[10]+1.325825214724776*nuVtSqSum[1]*fr[6]-1.325825214724776*nuVtSqSum[1]*fl[6]+1.325825214724776*nuVtSqSum[0]*fr[3]-1.325825214724776*nuVtSqSum[0]*fl[3])*rdv2L-0.8660254037844386*fjump[10]+alphaDrag[0]*(0.6123724356957944*favg[10]+0.3535533905932737*favg[3])+0.3535533905932737*alphaDrag[1]*favg[6]-0.5*fjump[3]; 
  Ghat[5] = ((-1.684024198163434*nuVtSqSum[1]*fr[9])-1.684024198163434*nuVtSqSum[1]*fl[9]+1.185854122563142*nuVtSqSum[2]*fr[5]+1.325825214724776*nuVtSqSum[0]*fr[5]-1.185854122563142*nuVtSqSum[2]*fl[5]-1.325825214724776*nuVtSqSum[0]*fl[5]+1.325825214724776*nuVtSqSum[1]*fr[2]-1.325825214724776*nuVtSqSum[1]*fl[2])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[9]+0.3535533905932737*favg[2])-0.5*fjump[5]+0.3162277660168379*alphaDrag[2]*favg[5]+0.3535533905932737*alphaDrag[0]*favg[5]; 
  Ghat[6] = ((-1.684024198163434*nuVtSqSum[1]*fr[10])-1.684024198163434*nuVtSqSum[1]*fl[10]+1.185854122563142*nuVtSqSum[2]*fr[6]+1.325825214724776*nuVtSqSum[0]*fr[6]-1.185854122563142*nuVtSqSum[2]*fl[6]-1.325825214724776*nuVtSqSum[0]*fl[6]+1.325825214724776*nuVtSqSum[1]*fr[3]-1.325825214724776*nuVtSqSum[1]*fl[3])*rdv2L+alphaDrag[1]*(0.6123724356957944*favg[10]+0.3535533905932737*favg[3])-0.5*fjump[6]+0.3162277660168379*alphaDrag[2]*favg[6]+0.3535533905932737*alphaDrag[0]*favg[6]; 
  Ghat[7] = (1.325825214724776*nuVtSqSum[0]*fr[7]-1.325825214724776*nuVtSqSum[0]*fl[7])*rdv2L-0.5*fjump[7]+0.3535533905932737*alphaDrag[0]*favg[7]; 
  Ghat[11] = (0.9486832980505137*nuVtSqSum[2]*fr[14]-0.9486832980505137*nuVtSqSum[2]*fl[14]+0.8470386589736728*nuVtSqSum[2]*fr[11]+1.325825214724776*nuVtSqSum[0]*fr[11]-0.8470386589736728*nuVtSqSum[2]*fl[11]-1.325825214724776*nuVtSqSum[0]*fl[11]-1.506237033139206*nuVtSqSum[1]*fr[8]-1.506237033139206*nuVtSqSum[1]*fl[8]-1.684024198163434*nuVtSqSum[2]*fr[4]-1.684024198163434*nuVtSqSum[2]*fl[4]+1.325825214724776*fr[0]*nuVtSqSum[2]-1.325825214724776*fl[0]*nuVtSqSum[2]+1.185854122563142*fr[1]*nuVtSqSum[1]-1.185854122563142*fl[1]*nuVtSqSum[1])*rdv2L+alphaDrag[2]*(0.7905694150420947*favg[14]+0.2258769757263128*favg[11]+0.6123724356957944*favg[4]+0.3535533905932737*favg[0])-0.5*fjump[11]+0.3535533905932737*alphaDrag[0]*favg[11]+alphaDrag[1]*(0.5477225575051661*favg[8]+0.3162277660168379*favg[1]); 
  Ghat[12] = (1.325825214724776*nuVtSqSum[0]*fr[12]-1.325825214724776*nuVtSqSum[0]*fl[12])*rdv2L-0.5*fjump[12]+0.3535533905932737*alphaDrag[0]*favg[12]; 
  Ghat[13] = (1.325825214724776*nuVtSqSum[0]*fr[13]-1.325825214724776*nuVtSqSum[0]*fl[13])*rdv2L-0.5*fjump[13]+0.3535533905932737*alphaDrag[0]*favg[13]; 
