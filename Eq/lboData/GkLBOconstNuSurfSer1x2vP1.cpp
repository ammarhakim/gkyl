...
{ 
  ...
  Gdiff[0] = nuVtSqSum[1]*((-0.7654655446197428*(fr[4]+fl[4]))+0.7954951288348656*fr[1]-0.7954951288348656*fl[1])+nuVtSqSum[0]*((-0.7654655446197428*(fr[2]+fl[2]))+0.7954951288348656*fr[0]-0.7954951288348656*fl[0]); 
  Gdiff[1] = nuVtSqSum[0]*((-0.7654655446197428*(fr[4]+fl[4]))+0.7954951288348656*fr[1]-0.7954951288348656*fl[1])+nuVtSqSum[1]*((-0.7654655446197428*(fr[2]+fl[2]))+0.7954951288348656*fr[0]-0.7954951288348656*fl[0]); 
  Gdiff[3] = nuVtSqSum[1]*((-0.7654655446197428*(fr[7]+fl[7]))+0.7954951288348656*fr[5]-0.7954951288348656*fl[5])+nuVtSqSum[0]*((-0.7654655446197428*(fr[6]+fl[6]))+0.7954951288348656*fr[3]-0.7954951288348656*fl[3]); 
  Gdiff[5] = nuVtSqSum[0]*((-0.7654655446197428*(fr[7]+fl[7]))+0.7954951288348656*fr[5]-0.7954951288348656*fl[5])+nuVtSqSum[1]*((-0.7654655446197428*(fr[6]+fl[6]))+0.7954951288348656*fr[3]-0.7954951288348656*fl[3]); 

  Ghat[0] = Gdiff[0]*rdv2L+0.7071067811865475*(alphaDrSurf[1]*fUpwind[1]+alphaDrSurf[0]*fUpwind[0]); 
  Ghat[1] = Gdiff[1]*rdv2L+0.7071067811865475*(alphaDrSurf[0]*fUpwind[1]+fUpwind[0]*alphaDrSurf[1]); 
  Ghat[3] = Gdiff[3]*rdv2L+0.7071067811865475*(alphaDrSurf[1]*fUpwind[3]+alphaDrSurf[0]*fUpwind[2]); 
  Ghat[5] = Gdiff[5]*rdv2L+0.7071067811865475*(alphaDrSurf[0]*fUpwind[3]+alphaDrSurf[1]*fUpwind[2]); 
...
{ 
  ...
  Gdiff[0] = (-0.7654655446197428*(diffFac[1]*(fr[5]+fl[5])+diffFac[0]*(fr[3]+fl[3])))+diffFac[1]*(0.7954951288348656*fr[1]-0.7954951288348656*fl[1])+diffFac[0]*(0.7954951288348656*fr[0]-0.7954951288348656*fl[0]); 
  Gdiff[1] = (-0.7654655446197428*(diffFac[0]*(fr[5]+fl[5])+diffFac[1]*(fr[3]+fl[3])))+diffFac[0]*(0.7954951288348656*fr[1]-0.7954951288348656*fl[1])+(0.7954951288348656*fr[0]-0.7954951288348656*fl[0])*diffFac[1]; 
  Gdiff[2] = (-0.7654655446197428*(diffFac[1]*(fr[7]+fl[7])+diffFac[0]*(fr[6]+fl[6])))+diffFac[1]*(0.7954951288348656*fr[4]-0.7954951288348656*fl[4])+diffFac[0]*(0.7954951288348656*fr[2]-0.7954951288348656*fl[2]); 
  Gdiff[4] = (-0.7654655446197428*(diffFac[0]*(fr[7]+fl[7])+diffFac[1]*(fr[6]+fl[6])))+diffFac[0]*(0.7954951288348656*fr[4]-0.7954951288348656*fl[4])+diffFac[1]*(0.7954951288348656*fr[2]-0.7954951288348656*fl[2]); 

  Ghat[0] = Gdiff[0]*rdv2L+0.7071067811865475*alphaDrSurf[0]*fUpwind[0]; 
  Ghat[1] = Gdiff[1]*rdv2L+0.7071067811865475*alphaDrSurf[0]*fUpwind[1]; 
  Ghat[2] = Gdiff[2]*rdv2L+0.7071067811865475*alphaDrSurf[0]*fUpwind[2]; 
  Ghat[4] = Gdiff[4]*rdv2L+0.7071067811865475*alphaDrSurf[0]*fUpwind[3]; 
