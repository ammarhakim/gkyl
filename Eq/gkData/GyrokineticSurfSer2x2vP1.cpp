...
#if upwindType == SURFAVG 
  if (alpha0>0) { 
  incr[0] = 0.1767766952966368*alpha[0]*(1.732050807568877*fl[3]+fl[0])*dfac_v; 
  incr[1] = 0.1767766952966368*alpha[0]*(1.732050807568877*fl[6]+fl[1])*dfac_v; 
  incr[2] = 0.1767766952966368*alpha[0]*(1.732050807568877*fl[7]+fl[2])*dfac_v; 
  incr[3] = -0.1767766952966368*alpha[0]*(3.0*fl[3]+1.732050807568877*fl[0])*dfac_v; 
  incr[4] = 0.1767766952966368*alpha[0]*(1.732050807568877*fl[10]+fl[4])*dfac_v; 
  incr[5] = 0.1767766952966368*alpha[0]*(1.732050807568877*fl[11]+fl[5])*dfac_v; 
  incr[6] = -0.1767766952966368*alpha[0]*(3.0*fl[6]+1.732050807568877*fl[1])*dfac_v; 
  incr[7] = -0.1767766952966368*alpha[0]*(3.0*fl[7]+1.732050807568877*fl[2])*dfac_v; 
  incr[8] = 0.1767766952966368*alpha[0]*(1.732050807568877*fl[13]+fl[8])*dfac_v; 
  incr[9] = 0.1767766952966368*alpha[0]*(1.732050807568877*fl[14]+fl[9])*dfac_v; 
  incr[10] = -0.1767766952966368*alpha[0]*(3.0*fl[10]+1.732050807568877*fl[4])*dfac_v; 
  incr[11] = -0.1767766952966368*alpha[0]*(3.0*fl[11]+1.732050807568877*fl[5])*dfac_v; 
  incr[12] = 0.1767766952966368*alpha[0]*(1.732050807568877*fl[15]+fl[12])*dfac_v; 
  incr[13] = -0.1767766952966368*alpha[0]*(3.0*fl[13]+1.732050807568877*fl[8])*dfac_v; 
  incr[14] = -0.1767766952966368*alpha[0]*(3.0*fl[14]+1.732050807568877*fl[9])*dfac_v; 
  incr[15] = -0.1767766952966368*alpha[0]*(3.0*fl[15]+1.732050807568877*fl[12])*dfac_v; 
  } else { 
  incr[0] = -0.1767766952966368*alpha[0]*(1.732050807568877*fr[3]-1.0*fr[0])*dfac_v; 
  incr[1] = -0.1767766952966368*alpha[0]*(1.732050807568877*fr[6]-1.0*fr[1])*dfac_v; 
  incr[2] = -0.1767766952966368*alpha[0]*(1.732050807568877*fr[7]-1.0*fr[2])*dfac_v; 
  incr[3] = 0.1767766952966368*alpha[0]*(3.0*fr[3]-1.732050807568877*fr[0])*dfac_v; 
  incr[4] = -0.1767766952966368*alpha[0]*(1.732050807568877*fr[10]-1.0*fr[4])*dfac_v; 
  incr[5] = -0.1767766952966368*alpha[0]*(1.732050807568877*fr[11]-1.0*fr[5])*dfac_v; 
  incr[6] = 0.1767766952966368*alpha[0]*(3.0*fr[6]-1.732050807568877*fr[1])*dfac_v; 
  incr[7] = 0.1767766952966368*alpha[0]*(3.0*fr[7]-1.732050807568877*fr[2])*dfac_v; 
  incr[8] = -0.1767766952966368*alpha[0]*(1.732050807568877*fr[13]-1.0*fr[8])*dfac_v; 
  incr[9] = -0.1767766952966368*alpha[0]*(1.732050807568877*fr[14]-1.0*fr[9])*dfac_v; 
  incr[10] = 0.1767766952966368*alpha[0]*(3.0*fr[10]-1.732050807568877*fr[4])*dfac_v; 
  incr[11] = 0.1767766952966368*alpha[0]*(3.0*fr[11]-1.732050807568877*fr[5])*dfac_v; 
  incr[12] = -0.1767766952966368*alpha[0]*(1.732050807568877*fr[15]-1.0*fr[12])*dfac_v; 
  incr[13] = 0.1767766952966368*alpha[0]*(3.0*fr[13]-1.732050807568877*fr[8])*dfac_v; 
  incr[14] = 0.1767766952966368*alpha[0]*(3.0*fr[14]-1.732050807568877*fr[9])*dfac_v; 
  incr[15] = 0.1767766952966368*alpha[0]*(3.0*fr[15]-1.732050807568877*fr[12])*dfac_v; 
  }
#elif upwindType == QUAD 
double fupwind[8];
double fupwindQuad[8];
double alphaQuad;
  ...
  fupwind[6] = 0.3535533905932739*(fupwindQuad[7]+fupwindQuad[6])-0.3535533905932739*(fupwindQuad[5]+fupwindQuad[4]+fupwindQuad[3]+fupwindQuad[2])+0.3535533905932739*(fupwindQuad[1]+fupwindQuad[0]); 
  fupwind[7] = 0.3535533905932739*fupwindQuad[7]-0.3535533905932739*(fupwindQuad[6]+fupwindQuad[5])+0.3535533905932739*fupwindQuad[4]-0.3535533905932739*fupwindQuad[3]+0.3535533905932739*(fupwindQuad[2]+fupwindQuad[1])-0.3535533905932739*fupwindQuad[0]; 
  incr[0] = 0.25*alpha[0]*fupwind[0]*dfac_v; 
  incr[1] = 0.25*alpha[0]*fupwind[1]*dfac_v; 
  incr[2] = 0.25*alpha[0]*fupwind[2]*dfac_v; 
  incr[3] = -0.4330127018922193*alpha[0]*fupwind[0]*dfac_v; 
  incr[4] = 0.25*alpha[0]*fupwind[3]*dfac_v; 
  incr[5] = 0.25*alpha[0]*fupwind[4]*dfac_v; 
  incr[6] = -0.4330127018922193*alpha[0]*fupwind[1]*dfac_v; 
  incr[7] = -0.4330127018922193*alpha[0]*fupwind[2]*dfac_v; 
  incr[8] = 0.25*alpha[0]*fupwind[5]*dfac_v; 
  incr[9] = 0.25*alpha[0]*fupwind[6]*dfac_v; 
  incr[10] = -0.4330127018922193*alpha[0]*fupwind[3]*dfac_v; 
  incr[11] = -0.4330127018922193*alpha[0]*fupwind[4]*dfac_v; 
  incr[12] = 0.25*alpha[0]*fupwind[7]*dfac_v; 
  incr[13] = -0.4330127018922193*alpha[0]*fupwind[5]*dfac_v; 
  incr[14] = -0.4330127018922193*alpha[0]*fupwind[6]*dfac_v; 
  incr[15] = -0.4330127018922193*alpha[0]*fupwind[7]*dfac_v; 
