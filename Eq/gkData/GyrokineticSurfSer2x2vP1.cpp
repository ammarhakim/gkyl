...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alpha[8]; 
  alpha[0] = 0.7071067811865475*geoZ[0]*(3.0*Phi[3]-1.732050807568877*Phi[2])*dfac_y; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  // surface-averaged phase velocity in this direction 
  double alpha0 = -0.2165063509461096*geoZ[0]*Phi[2]*dfac_y; 

  double alpha[8]; 
  alpha[0] = -1.224744871391589*geoZ[0]*Phi[2]*dfac_y; 
  alpha[1] = -1.224744871391589*geoZ[0]*Phi[3]*dfac_y; 
#if upwindType == SURFAVG 
  if (alpha0>0) { 
  incr[0] = 0.1767766952966368*(1.732050807568877*(alpha[1]*fl[5]+alpha[0]*fl[2])+alpha[1]*fl[1]+alpha[0]*fl[0])*dfac_y; 
  incr[1] = 0.1767766952966368*(1.732050807568877*(alpha[0]*fl[5]+alpha[1]*fl[2])+alpha[0]*fl[1]+fl[0]*alpha[1])*dfac_y; 
  incr[2] = -0.1767766952966368*(3.0*(alpha[1]*fl[5]+alpha[0]*fl[2])+1.732050807568877*(alpha[1]*fl[1]+alpha[0]*fl[0]))*dfac_y; 
  incr[3] = 0.1767766952966368*(1.732050807568877*(alpha[1]*fl[11]+alpha[0]*fl[7])+alpha[1]*fl[6]+alpha[0]*fl[3])*dfac_y; 
  incr[4] = 0.1767766952966368*(1.732050807568877*(alpha[1]*fl[12]+alpha[0]*fl[9])+alpha[1]*fl[8]+alpha[0]*fl[4])*dfac_y; 
  incr[5] = -0.1767766952966368*(3.0*(alpha[0]*fl[5]+alpha[1]*fl[2])+1.732050807568877*(alpha[0]*fl[1]+fl[0]*alpha[1]))*dfac_y; 
  incr[6] = 0.1767766952966368*(1.732050807568877*(alpha[0]*fl[11]+alpha[1]*fl[7])+alpha[0]*fl[6]+alpha[1]*fl[3])*dfac_y; 
  incr[7] = -0.1767766952966368*(3.0*(alpha[1]*fl[11]+alpha[0]*fl[7])+1.732050807568877*(alpha[1]*fl[6]+alpha[0]*fl[3]))*dfac_y; 
  incr[8] = 0.1767766952966368*(1.732050807568877*(alpha[0]*fl[12]+alpha[1]*fl[9])+alpha[0]*fl[8]+alpha[1]*fl[4])*dfac_y; 
  incr[9] = -0.1767766952966368*(3.0*(alpha[1]*fl[12]+alpha[0]*fl[9])+1.732050807568877*(alpha[1]*fl[8]+alpha[0]*fl[4]))*dfac_y; 
  incr[10] = 0.1767766952966368*(1.732050807568877*(alpha[1]*fl[15]+alpha[0]*fl[14])+alpha[1]*fl[13]+alpha[0]*fl[10])*dfac_y; 
  incr[11] = -0.1767766952966368*(3.0*(alpha[0]*fl[11]+alpha[1]*fl[7])+1.732050807568877*(alpha[0]*fl[6]+alpha[1]*fl[3]))*dfac_y; 
  incr[12] = -0.1767766952966368*(3.0*(alpha[0]*fl[12]+alpha[1]*fl[9])+1.732050807568877*(alpha[0]*fl[8]+alpha[1]*fl[4]))*dfac_y; 
  incr[13] = 0.1767766952966368*(1.732050807568877*(alpha[0]*fl[15]+alpha[1]*fl[14])+alpha[0]*fl[13]+alpha[1]*fl[10])*dfac_y; 
  incr[14] = -0.1767766952966368*(3.0*(alpha[1]*fl[15]+alpha[0]*fl[14])+1.732050807568877*(alpha[1]*fl[13]+alpha[0]*fl[10]))*dfac_y; 
  incr[15] = -0.1767766952966368*(3.0*(alpha[0]*fl[15]+alpha[1]*fl[14])+1.732050807568877*(alpha[0]*fl[13]+alpha[1]*fl[10]))*dfac_y; 
  } else { 
  incr[0] = -0.1767766952966368*(1.732050807568877*(alpha[1]*fr[5]+alpha[0]*fr[2])-1.0*(alpha[1]*fr[1]+alpha[0]*fr[0]))*dfac_y; 
  incr[1] = -0.1767766952966368*(1.732050807568877*(alpha[0]*fr[5]+alpha[1]*fr[2])-1.0*(alpha[0]*fr[1]+fr[0]*alpha[1]))*dfac_y; 
  incr[2] = 0.1767766952966368*(3.0*(alpha[1]*fr[5]+alpha[0]*fr[2])-1.732050807568877*(alpha[1]*fr[1]+alpha[0]*fr[0]))*dfac_y; 
  incr[3] = -0.1767766952966368*(1.732050807568877*(alpha[1]*fr[11]+alpha[0]*fr[7])-1.0*(alpha[1]*fr[6]+alpha[0]*fr[3]))*dfac_y; 
  incr[4] = -0.1767766952966368*(1.732050807568877*(alpha[1]*fr[12]+alpha[0]*fr[9])-1.0*(alpha[1]*fr[8]+alpha[0]*fr[4]))*dfac_y; 
  incr[5] = 0.1767766952966368*(3.0*(alpha[0]*fr[5]+alpha[1]*fr[2])-1.732050807568877*(alpha[0]*fr[1]+fr[0]*alpha[1]))*dfac_y; 
  incr[6] = -0.1767766952966368*(1.732050807568877*(alpha[0]*fr[11]+alpha[1]*fr[7])-1.0*(alpha[0]*fr[6]+alpha[1]*fr[3]))*dfac_y; 
  incr[7] = 0.1767766952966368*(3.0*(alpha[1]*fr[11]+alpha[0]*fr[7])-1.732050807568877*(alpha[1]*fr[6]+alpha[0]*fr[3]))*dfac_y; 
  incr[8] = -0.1767766952966368*(1.732050807568877*(alpha[0]*fr[12]+alpha[1]*fr[9])-1.0*(alpha[0]*fr[8]+alpha[1]*fr[4]))*dfac_y; 
  incr[9] = 0.1767766952966368*(3.0*(alpha[1]*fr[12]+alpha[0]*fr[9])-1.732050807568877*(alpha[1]*fr[8]+alpha[0]*fr[4]))*dfac_y; 
  incr[10] = -0.1767766952966368*(1.732050807568877*(alpha[1]*fr[15]+alpha[0]*fr[14])-1.0*(alpha[1]*fr[13]+alpha[0]*fr[10]))*dfac_y; 
  incr[11] = 0.1767766952966368*(3.0*(alpha[0]*fr[11]+alpha[1]*fr[7])-1.732050807568877*(alpha[0]*fr[6]+alpha[1]*fr[3]))*dfac_y; 
  incr[12] = 0.1767766952966368*(3.0*(alpha[0]*fr[12]+alpha[1]*fr[9])-1.732050807568877*(alpha[0]*fr[8]+alpha[1]*fr[4]))*dfac_y; 
  incr[13] = -0.1767766952966368*(1.732050807568877*(alpha[0]*fr[15]+alpha[1]*fr[14])-1.0*(alpha[0]*fr[13]+alpha[1]*fr[10]))*dfac_y; 
  incr[14] = 0.1767766952966368*(3.0*(alpha[1]*fr[15]+alpha[0]*fr[14])-1.732050807568877*(alpha[1]*fr[13]+alpha[0]*fr[10]))*dfac_y; 
  incr[15] = 0.1767766952966368*(3.0*(alpha[0]*fr[15]+alpha[1]*fr[14])-1.732050807568877*(alpha[0]*fr[13]+alpha[1]*fr[10]))*dfac_y; 
  }
#elif upwindType == QUAD 
double fupwind[8];
double fupwindQuad[8];
double alphaQuad;
  ...
  fupwind[6] = 0.3535533905932739*(fupwindQuad[7]+fupwindQuad[6])-0.3535533905932739*(fupwindQuad[5]+fupwindQuad[4]+fupwindQuad[3]+fupwindQuad[2])+0.3535533905932739*(fupwindQuad[1]+fupwindQuad[0]); 
  fupwind[7] = 0.3535533905932739*fupwindQuad[7]-0.3535533905932739*(fupwindQuad[6]+fupwindQuad[5])+0.3535533905932739*fupwindQuad[4]-0.3535533905932739*fupwindQuad[3]+0.3535533905932739*(fupwindQuad[2]+fupwindQuad[1])-0.3535533905932739*fupwindQuad[0]; 
  incr[0] = 0.25*(alpha[1]*fupwind[1]+alpha[0]*fupwind[0])*dfac_y; 
  incr[1] = 0.25*(alpha[0]*fupwind[1]+fupwind[0]*alpha[1])*dfac_y; 
  incr[2] = -0.4330127018922193*(alpha[1]*fupwind[1]+alpha[0]*fupwind[0])*dfac_y; 
  incr[3] = 0.25*(alpha[1]*fupwind[4]+alpha[0]*fupwind[2])*dfac_y; 
  incr[4] = 0.25*(alpha[1]*fupwind[5]+alpha[0]*fupwind[3])*dfac_y; 
  incr[5] = -0.4330127018922193*(alpha[0]*fupwind[1]+fupwind[0]*alpha[1])*dfac_y; 
  incr[6] = 0.25*(alpha[0]*fupwind[4]+alpha[1]*fupwind[2])*dfac_y; 
  incr[7] = -0.4330127018922193*(alpha[1]*fupwind[4]+alpha[0]*fupwind[2])*dfac_y; 
  incr[8] = 0.25*(alpha[0]*fupwind[5]+alpha[1]*fupwind[3])*dfac_y; 
  incr[9] = -0.4330127018922193*(alpha[1]*fupwind[5]+alpha[0]*fupwind[3])*dfac_y; 
  incr[10] = 0.25*(alpha[1]*fupwind[7]+alpha[0]*fupwind[6])*dfac_y; 
  incr[11] = -0.4330127018922193*(alpha[0]*fupwind[4]+alpha[1]*fupwind[2])*dfac_y; 
  incr[12] = -0.4330127018922193*(alpha[0]*fupwind[5]+alpha[1]*fupwind[3])*dfac_y; 
  incr[13] = 0.25*(alpha[0]*fupwind[7]+alpha[1]*fupwind[6])*dfac_y; 
  incr[14] = -0.4330127018922193*(alpha[1]*fupwind[7]+alpha[0]*fupwind[6])*dfac_y; 
  incr[15] = -0.4330127018922193*(alpha[0]*fupwind[7]+alpha[1]*fupwind[6])*dfac_y; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  // surface-averaged phase velocity in this direction 
  double alpha0 = -0.125*((5.196152422706631*geoZ[1]-3.0*geoZ[0])*Phi[3]+(1.732050807568877*geoZ[0]-3.0*geoZ[1])*Phi[2])*dfac_y; 

  double alpha[8]; 
  alpha[0] = -0.7071067811865475*((5.196152422706631*geoZ[1]-3.0*geoZ[0])*Phi[3]+(1.732050807568877*geoZ[0]-3.0*geoZ[1])*Phi[2])*dfac_y; 
#if upwindType == SURFAVG 
  if (alpha0>0) { 
  incr[0] = 0.1767766952966368*alpha[0]*(1.732050807568877*fl[1]+fl[0])*dfac_x; 
  incr[1] = -0.1767766952966368*alpha[0]*(3.0*fl[1]+1.732050807568877*fl[0])*dfac_x; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  // surface-averaged phase velocity in this direction 
  double alpha0 = -0.2165063509461096*(geoZ[1]*Phi[3]+geoZ[0]*Phi[2])*dfac_y; 

  double alpha[8]; 
  alpha[0] = -1.224744871391589*(geoZ[1]*Phi[3]+geoZ[0]*Phi[2])*dfac_y; 
  alpha[1] = -1.224744871391589*(geoZ[0]*Phi[3]+geoZ[1]*Phi[2])*dfac_y; 
#if upwindType == SURFAVG 
  if (alpha0>0) { 
  incr[0] = 0.1767766952966368*(1.732050807568877*(alpha[1]*fl[5]+alpha[0]*fl[2])+alpha[1]*fl[1]+alpha[0]*fl[0])*dfac_y; 
  incr[1] = 0.1767766952966368*(1.732050807568877*(alpha[0]*fl[5]+alpha[1]*fl[2])+alpha[0]*fl[1]+fl[0]*alpha[1])*dfac_y; 
