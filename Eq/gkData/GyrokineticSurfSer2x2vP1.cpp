...
double GyrokineticSurf2x2vSer_X_P1_Bvars_0(const double q_, const double m_, const double *cflRateCtrlL, const double *cflRateCtrlR, const double *w, const double *dxv, const double dtApprox, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *BdriftX, const double *BdriftY, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
...
double alphaQuad;
  ...
  incr[0] = 0.25*(alpha[2]*fupwind[2]+alpha[0]*fupwind[0])*dfac_x; 
  incr[1] = -0.4330127018922193*(alpha[2]*fupwind[2]+alpha[0]*fupwind[0])*dfac_x; 
  incr[2] = 0.25*(alpha[2]*fupwind[4]+alpha[0]*fupwind[1])*dfac_x; 
  incr[3] = 0.25*(alpha[0]*fupwind[2]+fupwind[0]*alpha[2])*dfac_x; 
  ...
  incr[6] = -0.4330127018922193*(alpha[0]*fupwind[2]+fupwind[0]*alpha[2])*dfac_x; 
  incr[7] = 0.25*(alpha[0]*fupwind[4]+fupwind[1]*alpha[2])*dfac_x; 
  ...
  incr[10] = 0.25*(alpha[0]*fupwind[6]+alpha[2]*fupwind[3])*dfac_x; 
  incr[11] = -0.4330127018922193*(alpha[0]*fupwind[4]+fupwind[1]*alpha[2])*dfac_x; 
  incr[12] = -0.4330127018922193*(alpha[2]*fupwind[7]+alpha[0]*fupwind[5])*dfac_x; 
  incr[13] = -0.4330127018922193*(alpha[0]*fupwind[6]+alpha[2]*fupwind[3])*dfac_x; 
  incr[14] = 0.25*(alpha[0]*fupwind[7]+alpha[2]*fupwind[5])*dfac_x; 
  incr[15] = -0.4330127018922193*(alpha[0]*fupwind[7]+alpha[2]*fupwind[5])*dfac_x; 
...
double GyrokineticSurf2x2vSer_Y_P1_Bvars_0(const double q_, const double m_, const double *cflRateCtrlL, const double *cflRateCtrlR, const double *w, const double *dxv, const double dtApprox, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *BdriftX, const double *BdriftY, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
...
double alphaQuad;
  ...
  fupwind[6] = 0.3535533905932739*(fupwindQuad[7]+fupwindQuad[6])-0.3535533905932739*(fupwindQuad[5]+fupwindQuad[4]+fupwindQuad[3]+fupwindQuad[2])+0.3535533905932739*(fupwindQuad[1]+fupwindQuad[0]); 
  fupwind[7] = 0.3535533905932739*fupwindQuad[7]-0.3535533905932739*(fupwindQuad[6]+fupwindQuad[5])+0.3535533905932739*fupwindQuad[4]-0.3535533905932739*fupwindQuad[3]+0.3535533905932739*(fupwindQuad[2]+fupwindQuad[1])-0.3535533905932739*fupwindQuad[0]; 
  incr[0] = 0.25*(alpha[2]*fupwind[2]+alpha[0]*fupwind[0])*dfac_y; 
  incr[1] = 0.25*(alpha[2]*fupwind[4]+alpha[0]*fupwind[1])*dfac_y; 
  incr[2] = -0.4330127018922193*(alpha[2]*fupwind[2]+alpha[0]*fupwind[0])*dfac_y; 
  incr[3] = 0.25*(alpha[0]*fupwind[2]+fupwind[0]*alpha[2])*dfac_y; 
  ...
  incr[6] = 0.25*(alpha[0]*fupwind[4]+fupwind[1]*alpha[2])*dfac_y; 
  incr[7] = -0.4330127018922193*(alpha[0]*fupwind[2]+fupwind[0]*alpha[2])*dfac_y; 
  ...
  incr[10] = 0.25*(alpha[0]*fupwind[6]+alpha[2]*fupwind[3])*dfac_y; 
  incr[11] = -0.4330127018922193*(alpha[0]*fupwind[4]+fupwind[1]*alpha[2])*dfac_y; 
  incr[12] = -0.4330127018922193*(alpha[2]*fupwind[7]+alpha[0]*fupwind[5])*dfac_y; 
  incr[13] = 0.25*(alpha[0]*fupwind[7]+alpha[2]*fupwind[5])*dfac_y; 
  incr[14] = -0.4330127018922193*(alpha[0]*fupwind[6]+alpha[2]*fupwind[3])*dfac_y; 
  incr[15] = -0.4330127018922193*(alpha[0]*fupwind[7]+alpha[2]*fupwind[5])*dfac_y; 
...
double GyrokineticSurf2x2vSer_Vpar_P1_Bvars_0(const double q_, const double m_, const double *cflRateCtrlL, const double *cflRateCtrlR, const double *w, const double *dxv, const double dtApprox, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *BdriftX, const double *BdriftY, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
...
double GyrokineticSurf2x2vSer_X_P1_Bvars_1(const double q_, const double m_, const double *cflRateCtrlL, const double *cflRateCtrlR, const double *w, const double *dxv, const double dtApprox, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *BdriftX, const double *BdriftY, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
...
double GyrokineticSurf2x2vSer_Y_P1_Bvars_1(const double q_, const double m_, const double *cflRateCtrlL, const double *cflRateCtrlR, const double *w, const double *dxv, const double dtApprox, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *BdriftX, const double *BdriftY, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
...
double GyrokineticSurf2x2vSer_Vpar_P1_Bvars_1(const double q_, const double m_, const double *cflRateCtrlL, const double *cflRateCtrlR, const double *w, const double *dxv, const double dtApprox, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *BdriftX, const double *BdriftY, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
