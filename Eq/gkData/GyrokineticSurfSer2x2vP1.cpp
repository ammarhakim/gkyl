...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alpha0 = (0.125*(2.0*BdriftX[0]*m_*wv2+(3.0*BmagInv[0]*Phi[3]-1.732050807568877*BmagInv[0]*Phi[2])*dfac_y*q_))/q_; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double incr[16]; 
  // surface-averaged phase velocity in this direction 
  double alpha0 = (0.125*(2.0*BdriftY[0]*m_*wv2+(1.732050807568877*BmagInv[0]*Phi[1]-3.0*BmagInv[0]*Phi[3])*dfac_x*q_))/q_; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double incr[16]; 
  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.125*((1.732050807568877*BdriftY[0]*Phi[2]*dfac_v*dfac_y+1.732050807568877*BdriftX[0]*Phi[1]*dfac_v*dfac_x)*wv-1.732050807568877*BdriftY[0]*Phi[2]*dfac_y-1.732050807568877*BdriftX[0]*Phi[1]*dfac_x))/dfac_v; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double incr[16]; 
  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.125*((3.464101615137754*BdriftX[1]-2.0*BdriftX[0])*m_*wv2+((5.196152422706631*BmagInv[1]-3.0*BmagInv[0])*Phi[3]+(1.732050807568877*BmagInv[0]-3.0*BmagInv[1])*Phi[2])*dfac_y*q_))/q_; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double incr[16]; 
  // surface-averaged phase velocity in this direction 
  double alpha0 = (0.125*(2.0*BdriftY[0]*m_*wv2+1.732050807568877*BmagInv[0]*Bmag[1]*dfac_x*wm+(1.732050807568877*BmagInv[0]*Phi[1]-3.0*BmagInv[0]*Phi[3])*dfac_x*q_))/q_; 
