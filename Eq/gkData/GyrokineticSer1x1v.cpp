...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  alphaM = 0.25*alphax[0]*dfac_x; 
  if(alphaM<0) cflFreq += -alphaM; 
  alphaP = 0.25*alphax[0]*dfac_x; 
  ...
  alphaM = 0.25*alphav[0]*dfac_v; 
  if(alphaM<0) cflFreq += -alphaM; 
  alphaP = 0.25*alphav[0]*dfac_v; 
  if(alphaP>0) cflFreq += alphaP; 
  return cflFreq; 
} 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  alphaM = 0.25*(0.25*(1.732050807568877*alphax[2]+2.0*alphax[0])-0.25*(1.732050807568877*alphax[2]-2.0*alphax[0]))*dfac_x; 
  if(alphaM<0) cflFreq += -alphaM; 
  alphaP = 0.25*(0.25*(1.732050807568877*alphax[2]+2.0*alphax[0])-0.25*(1.732050807568877*alphax[2]-2.0*alphax[0]))*dfac_x; 
  if(alphaP>0) cflFreq += alphaP; 
  double alphav[8]; 
  alphav[0] = -(1.732050807568877*Gradpar[0]*Phi[1]*dfac_x*q_)/m_; 
  ...
  alphaM = 0.25*(0.25*(1.732050807568877*alphav[1]+2.0*alphav[0])-0.25*(1.732050807568877*alphav[1]-2.0*alphav[0]))*dfac_v; 
  if(alphaM<0) cflFreq += -alphaM; 
  alphaP = 0.25*(0.25*(1.732050807568877*alphav[1]+2.0*alphav[0])-0.25*(1.732050807568877*alphav[1]-2.0*alphav[0]))*dfac_v; 
  if(alphaP>0) cflFreq += alphaP; 
  return cflFreq; 
} 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  alphaM = 0.25*(0.25*(3.872983346207417*alphax[6]+4.47213595499958*alphax[4]-3.0*alphax[3]+1.732050807568877*alphax[2]-3.464101615137754*alphax[1]+2.0*alphax[0])-0.25*(3.872983346207417*alphax[6]-4.47213595499958*alphax[4]-3.0*alphax[3]+1.732050807568877*alphax[2]+3.464101615137754*alphax[1]-2.0*alphax[0]))*dfac_x; 
  if(alphaM<0) cflFreq += -alphaM; 
  alphaP = 0.25*(0.25*(3.872983346207417*alphax[6]+4.47213595499958*alphax[4]+3.0*alphax[3]+1.732050807568877*alphax[2]+3.464101615137754*alphax[1]+2.0*alphax[0])-0.25*(3.872983346207417*alphax[6]-4.47213595499958*alphax[4]+3.0*alphax[3]+1.732050807568877*alphax[2]-3.464101615137754*alphax[1]-2.0*alphax[0]))*dfac_x; 
  if(alphaP>0) cflFreq += alphaP; 
  double alphav[8]; 
