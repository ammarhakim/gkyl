...
{ 
  ...
  BstarXdBmagR[2] = BdriftX[0]*Apar[2]; 
  BstarXdBmagR[3] = (1.154700538379252*BdriftX[0]*m_)/(q_*rdvpar2R); 
  BstarXdBmagR[5] = BdriftX[0]*Apar[3]; 
  ...
  BstarYdBmagR[1] = BdriftY[0]*Apar[1]; 
  ...
  BstarYdBmagR[5] = BdriftY[0]*Apar[3]; 

  double alphaR[8]; 
  alphaR[0] = (0.1767766952966368*(bmagInv[0]*(6.0*hamilR[5]-3.464101615137754*hamilR[2])*m_*rdy2R+(1.732050807568877*BstarXdBmagR[0]-3.0*BstarXdBmagR[1])*hamilR[3]*q_*rdvpar2R))/(m_*q_); 
  alphaR[1] = -(0.1767766952966368*hamilR[3]*(3.0*BstarXdBmagR[5]-1.732050807568877*BstarXdBmagR[2])*rdvpar2R)/m_; 
  alphaR[2] = (0.3061862178478971*BstarXdBmagR[3]*hamilR[3]*rdvpar2R)/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgR = (0.03125*((6.0*bmagInv[0]*hamilR[5]-3.464101615137754*bmagInv[0]*hamilR[2])*m_*rdy2R+(1.732050807568877*BstarXdBmagR[0]-3.0*BstarXdBmagR[1])*hamilR[3]*q_*rdvpar2R))/(m_*q_); 

  double incr[16]; 
#if upwindType == SURFAVG 
  if (alphaSurfAvgR>0) { 
  incr[0] = 0.125*(2.449489742783178*(alphaR[2]*fL[6]+alphaR[1]*fL[5])+1.414213562373095*(alphaR[2]*fL[3]+alphaR[1]*fL[2])+alphaR[0]*(2.449489742783178*fL[1]+1.414213562373095*fL[0])); 
  incr[1] = -0.125*(4.242640687119286*(alphaR[2]*fL[6]+alphaR[1]*fL[5])+2.449489742783178*(alphaR[2]*fL[3]+alphaR[1]*fL[2])+alphaR[0]*(4.242640687119286*fL[1]+2.449489742783178*fL[0])); 
  incr[2] = 0.125*(alphaR[2]*(2.449489742783178*fL[11]+1.414213562373095*fL[7])+alphaR[0]*(2.449489742783178*fL[5]+1.414213562373095*fL[2])+alphaR[1]*(2.449489742783178*fL[1]+1.414213562373095*fL[0])); 
  incr[3] = 0.125*(alphaR[1]*(2.449489742783178*fL[11]+1.414213562373095*fL[7])+alphaR[0]*(2.449489742783178*fL[6]+1.414213562373095*fL[3])+(2.449489742783178*fL[1]+1.414213562373095*fL[0])*alphaR[2]); 
  incr[4] = 0.125*(2.449489742783178*(alphaR[2]*fL[13]+alphaR[1]*fL[12])+1.414213562373095*(alphaR[2]*fL[10]+alphaR[1]*fL[9])+alphaR[0]*(2.449489742783178*fL[8]+1.414213562373095*fL[4])); 
  incr[5] = -0.125*(alphaR[2]*(4.242640687119286*fL[11]+2.449489742783178*fL[7])+alphaR[0]*(4.242640687119286*fL[5]+2.449489742783178*fL[2])+alphaR[1]*(4.242640687119286*fL[1]+2.449489742783178*fL[0])); 
  incr[6] = -0.125*(alphaR[1]*(4.242640687119286*fL[11]+2.449489742783178*fL[7])+alphaR[0]*(4.242640687119286*fL[6]+2.449489742783178*fL[3])+(4.242640687119286*fL[1]+2.449489742783178*fL[0])*alphaR[2]); 
  incr[7] = 0.125*(alphaR[0]*(2.449489742783178*fL[11]+1.414213562373095*fL[7])+2.449489742783178*(alphaR[1]*fL[6]+alphaR[2]*fL[5])+1.414213562373095*(alphaR[1]*fL[3]+alphaR[2]*fL[2])); 
  incr[8] = -0.125*(4.242640687119286*(alphaR[2]*fL[13]+alphaR[1]*fL[12])+2.449489742783178*(alphaR[2]*fL[10]+alphaR[1]*fL[9])+alphaR[0]*(4.242640687119286*fL[8]+2.449489742783178*fL[4])); 
  incr[9] = 0.125*(alphaR[2]*(2.449489742783178*fL[15]+1.414213562373095*fL[14])+alphaR[0]*(2.449489742783178*fL[12]+1.414213562373095*fL[9])+alphaR[1]*(2.449489742783178*fL[8]+1.414213562373095*fL[4])); 
  incr[10] = 0.125*(alphaR[1]*(2.449489742783178*fL[15]+1.414213562373095*fL[14])+alphaR[0]*(2.449489742783178*fL[13]+1.414213562373095*fL[10])+alphaR[2]*(2.449489742783178*fL[8]+1.414213562373095*fL[4])); 
  incr[11] = -0.125*(alphaR[0]*(4.242640687119286*fL[11]+2.449489742783178*fL[7])+4.242640687119286*(alphaR[1]*fL[6]+alphaR[2]*fL[5])+2.449489742783178*(alphaR[1]*fL[3]+alphaR[2]*fL[2])); 
  incr[12] = -0.125*(alphaR[2]*(4.242640687119286*fL[15]+2.449489742783178*fL[14])+alphaR[0]*(4.242640687119286*fL[12]+2.449489742783178*fL[9])+alphaR[1]*(4.242640687119286*fL[8]+2.449489742783178*fL[4])); 
  incr[13] = -0.125*(alphaR[1]*(4.242640687119286*fL[15]+2.449489742783178*fL[14])+alphaR[0]*(4.242640687119286*fL[13]+2.449489742783178*fL[10])+alphaR[2]*(4.242640687119286*fL[8]+2.449489742783178*fL[4])); 
  incr[14] = 0.125*(alphaR[0]*(2.449489742783178*fL[15]+1.414213562373095*fL[14])+2.449489742783178*(alphaR[1]*fL[13]+alphaR[2]*fL[12])+1.414213562373095*(alphaR[1]*fL[10]+alphaR[2]*fL[9])); 
  incr[15] = -0.125*(alphaR[0]*(4.242640687119286*fL[15]+2.449489742783178*fL[14])+4.242640687119286*(alphaR[1]*fL[13]+alphaR[2]*fL[12])+2.449489742783178*(alphaR[1]*fL[10]+alphaR[2]*fL[9])); 
  } else { 
  incr[0] = -0.125*(2.449489742783178*(alphaR[2]*fR[6]+alphaR[1]*fR[5])-1.414213562373095*(alphaR[2]*fR[3]+alphaR[1]*fR[2])+alphaR[0]*(2.449489742783178*fR[1]-1.414213562373095*fR[0])); 
  incr[1] = 0.125*(4.242640687119286*(alphaR[2]*fR[6]+alphaR[1]*fR[5])-2.449489742783178*(alphaR[2]*fR[3]+alphaR[1]*fR[2])+alphaR[0]*(4.242640687119286*fR[1]-2.449489742783178*fR[0])); 
  incr[2] = -0.125*(alphaR[2]*(2.449489742783178*fR[11]-1.414213562373095*fR[7])+alphaR[0]*(2.449489742783178*fR[5]-1.414213562373095*fR[2])+alphaR[1]*(2.449489742783178*fR[1]-1.414213562373095*fR[0])); 
  incr[3] = -0.125*(alphaR[1]*(2.449489742783178*fR[11]-1.414213562373095*fR[7])+alphaR[0]*(2.449489742783178*fR[6]-1.414213562373095*fR[3])+(2.449489742783178*fR[1]-1.414213562373095*fR[0])*alphaR[2]); 
  incr[4] = -0.125*(2.449489742783178*(alphaR[2]*fR[13]+alphaR[1]*fR[12])-1.414213562373095*(alphaR[2]*fR[10]+alphaR[1]*fR[9])+alphaR[0]*(2.449489742783178*fR[8]-1.414213562373095*fR[4])); 
  incr[5] = 0.125*(alphaR[2]*(4.242640687119286*fR[11]-2.449489742783178*fR[7])+alphaR[0]*(4.242640687119286*fR[5]-2.449489742783178*fR[2])+alphaR[1]*(4.242640687119286*fR[1]-2.449489742783178*fR[0])); 
  incr[6] = 0.125*(alphaR[1]*(4.242640687119286*fR[11]-2.449489742783178*fR[7])+alphaR[0]*(4.242640687119286*fR[6]-2.449489742783178*fR[3])+(4.242640687119286*fR[1]-2.449489742783178*fR[0])*alphaR[2]); 
  incr[7] = -0.125*(alphaR[0]*(2.449489742783178*fR[11]-1.414213562373095*fR[7])+2.449489742783178*(alphaR[1]*fR[6]+alphaR[2]*fR[5])-1.414213562373095*(alphaR[1]*fR[3]+alphaR[2]*fR[2])); 
  incr[8] = 0.125*(4.242640687119286*(alphaR[2]*fR[13]+alphaR[1]*fR[12])-2.449489742783178*(alphaR[2]*fR[10]+alphaR[1]*fR[9])+alphaR[0]*(4.242640687119286*fR[8]-2.449489742783178*fR[4])); 
  incr[9] = -0.125*(alphaR[2]*(2.449489742783178*fR[15]-1.414213562373095*fR[14])+alphaR[0]*(2.449489742783178*fR[12]-1.414213562373095*fR[9])+alphaR[1]*(2.449489742783178*fR[8]-1.414213562373095*fR[4])); 
  incr[10] = -0.125*(alphaR[1]*(2.449489742783178*fR[15]-1.414213562373095*fR[14])+alphaR[0]*(2.449489742783178*fR[13]-1.414213562373095*fR[10])+alphaR[2]*(2.449489742783178*fR[8]-1.414213562373095*fR[4])); 
  incr[11] = 0.125*(alphaR[0]*(4.242640687119286*fR[11]-2.449489742783178*fR[7])+4.242640687119286*(alphaR[1]*fR[6]+alphaR[2]*fR[5])-2.449489742783178*(alphaR[1]*fR[3]+alphaR[2]*fR[2])); 
  incr[12] = 0.125*(alphaR[2]*(4.242640687119286*fR[15]-2.449489742783178*fR[14])+alphaR[0]*(4.242640687119286*fR[12]-2.449489742783178*fR[9])+alphaR[1]*(4.242640687119286*fR[8]-2.449489742783178*fR[4])); 
  incr[13] = 0.125*(alphaR[1]*(4.242640687119286*fR[15]-2.449489742783178*fR[14])+alphaR[0]*(4.242640687119286*fR[13]-2.449489742783178*fR[10])+alphaR[2]*(4.242640687119286*fR[8]-2.449489742783178*fR[4])); 
  incr[14] = -0.125*(alphaR[0]*(2.449489742783178*fR[15]-1.414213562373095*fR[14])+2.449489742783178*(alphaR[1]*fR[13]+alphaR[2]*fR[12])-1.414213562373095*(alphaR[1]*fR[10]+alphaR[2]*fR[9])); 
  incr[15] = 0.125*(alphaR[0]*(4.242640687119286*fR[15]-2.449489742783178*fR[14])+4.242640687119286*(alphaR[1]*fR[13]+alphaR[2]*fR[12])-2.449489742783178*(alphaR[1]*fR[10]+alphaR[2]*fR[9])); 
  }
  ...
  incr[1] = -0.4330127018922193*(alphaR[2]*fUp[2]+alphaR[1]*fUp[1]+alphaR[0]*fUp[0]); 
  incr[2] = 0.25*(alphaR[2]*fUp[4]+alphaR[0]*fUp[1]+fUp[0]*alphaR[1]); 
  incr[3] = 0.25*(alphaR[1]*fUp[4]+alphaR[0]*fUp[2]+fUp[0]*alphaR[2]); 
  incr[4] = 0.25*(alphaR[2]*fUp[6]+alphaR[1]*fUp[5]+alphaR[0]*fUp[3]); 
  incr[5] = -0.4330127018922193*(alphaR[2]*fUp[4]+alphaR[0]*fUp[1]+fUp[0]*alphaR[1]); 
  incr[6] = -0.4330127018922193*(alphaR[1]*fUp[4]+alphaR[0]*fUp[2]+fUp[0]*alphaR[2]); 
  incr[7] = 0.25*(alphaR[0]*fUp[4]+alphaR[1]*fUp[2]+fUp[1]*alphaR[2]); 
  incr[8] = -0.4330127018922193*(alphaR[2]*fUp[6]+alphaR[1]*fUp[5]+alphaR[0]*fUp[3]); 
  incr[9] = 0.25*(alphaR[2]*fUp[7]+alphaR[0]*fUp[5]+alphaR[1]*fUp[3]); 
  incr[10] = 0.25*(alphaR[1]*fUp[7]+alphaR[0]*fUp[6]+alphaR[2]*fUp[3]); 
  incr[11] = -0.4330127018922193*(alphaR[0]*fUp[4]+alphaR[1]*fUp[2]+fUp[1]*alphaR[2]); 
  incr[12] = -0.4330127018922193*(alphaR[2]*fUp[7]+alphaR[0]*fUp[5]+alphaR[1]*fUp[3]); 
  incr[13] = -0.4330127018922193*(alphaR[1]*fUp[7]+alphaR[0]*fUp[6]+alphaR[2]*fUp[3]); 
  incr[14] = 0.25*(alphaR[0]*fUp[7]+alphaR[1]*fUp[6]+alphaR[2]*fUp[5]); 
...
double EmGyrokineticSimpleHelicalSurf2x2vSer_y_P1_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *gradPar, const double *BdriftX, const double *BdriftY, const double *phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // dApardtPrev: previous dApardt.
  ...
  double alphaR[8]; 
  alphaR[0] = -(0.1767766952966368*(bmagInv[0]*(6.0*hamilR[5]-3.464101615137754*hamilR[1])*m_*rdx2R+(3.0*BstarYdBmagR[2]-1.732050807568877*BstarYdBmagR[0])*hamilR[3]*q_*rdvpar2R))/(m_*q_); 
  alphaR[1] = -(0.1767766952966368*hamilR[3]*(3.0*BstarYdBmagR[5]-1.732050807568877*BstarYdBmagR[1])*rdvpar2R)/m_; 
  alphaR[2] = (0.3061862178478971*BstarYdBmagR[3]*hamilR[3]*rdvpar2R)/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgR = -(0.03125*((6.0*bmagInv[0]*hamilR[5]-3.464101615137754*bmagInv[0]*hamilR[1])*m_*rdx2R+(3.0*BstarYdBmagR[2]-1.732050807568877*BstarYdBmagR[0])*hamilR[3]*q_*rdvpar2R))/(m_*q_); 

  double incr[16]; 
#if upwindType == SURFAVG 
  if (alphaSurfAvgR>0) { 
  incr[0] = 0.125*(2.449489742783178*(alphaR[2]*fL[7]+alphaR[1]*fL[5])+1.414213562373095*alphaR[2]*fL[3]+2.449489742783178*alphaR[0]*fL[2]+1.414213562373095*(alphaR[1]*fL[1]+alphaR[0]*fL[0])); 
  incr[1] = 0.125*(alphaR[2]*(2.449489742783178*fL[11]+1.414213562373095*fL[6])+2.449489742783178*(alphaR[0]*fL[5]+alphaR[1]*fL[2])+1.414213562373095*(alphaR[0]*fL[1]+fL[0]*alphaR[1])); 
  incr[2] = -0.125*(4.242640687119286*(alphaR[2]*fL[7]+alphaR[1]*fL[5])+2.449489742783178*alphaR[2]*fL[3]+4.242640687119286*alphaR[0]*fL[2]+2.449489742783178*(alphaR[1]*fL[1]+alphaR[0]*fL[0])); 
  incr[3] = 0.125*(2.449489742783178*(alphaR[1]*fL[11]+alphaR[0]*fL[7])+1.414213562373095*(alphaR[1]*fL[6]+alphaR[0]*fL[3])+alphaR[2]*(2.449489742783178*fL[2]+1.414213562373095*fL[0])); 
  incr[4] = 0.125*(2.449489742783178*(alphaR[2]*fL[14]+alphaR[1]*fL[12])+1.414213562373095*alphaR[2]*fL[10]+2.449489742783178*alphaR[0]*fL[9]+1.414213562373095*(alphaR[1]*fL[8]+alphaR[0]*fL[4])); 
  incr[5] = -0.125*(alphaR[2]*(4.242640687119286*fL[11]+2.449489742783178*fL[6])+4.242640687119286*(alphaR[0]*fL[5]+alphaR[1]*fL[2])+2.449489742783178*(alphaR[0]*fL[1]+fL[0]*alphaR[1])); 
  incr[6] = 0.125*(2.449489742783178*(alphaR[0]*fL[11]+alphaR[1]*fL[7])+1.414213562373095*alphaR[0]*fL[6]+2.449489742783178*alphaR[2]*fL[5]+1.414213562373095*(alphaR[1]*fL[3]+fL[1]*alphaR[2])); 
  incr[7] = -0.125*(4.242640687119286*(alphaR[1]*fL[11]+alphaR[0]*fL[7])+2.449489742783178*(alphaR[1]*fL[6]+alphaR[0]*fL[3])+alphaR[2]*(4.242640687119286*fL[2]+2.449489742783178*fL[0])); 
  incr[8] = 0.125*(alphaR[2]*(2.449489742783178*fL[15]+1.414213562373095*fL[13])+2.449489742783178*(alphaR[0]*fL[12]+alphaR[1]*fL[9])+1.414213562373095*(alphaR[0]*fL[8]+alphaR[1]*fL[4])); 
  incr[9] = -0.125*(4.242640687119286*(alphaR[2]*fL[14]+alphaR[1]*fL[12])+2.449489742783178*alphaR[2]*fL[10]+4.242640687119286*alphaR[0]*fL[9]+2.449489742783178*(alphaR[1]*fL[8]+alphaR[0]*fL[4])); 
  incr[10] = 0.125*(2.449489742783178*(alphaR[1]*fL[15]+alphaR[0]*fL[14])+1.414213562373095*(alphaR[1]*fL[13]+alphaR[0]*fL[10])+alphaR[2]*(2.449489742783178*fL[9]+1.414213562373095*fL[4])); 
  incr[11] = -0.125*(4.242640687119286*(alphaR[0]*fL[11]+alphaR[1]*fL[7])+2.449489742783178*alphaR[0]*fL[6]+4.242640687119286*alphaR[2]*fL[5]+2.449489742783178*(alphaR[1]*fL[3]+fL[1]*alphaR[2])); 
  incr[12] = -0.125*(alphaR[2]*(4.242640687119286*fL[15]+2.449489742783178*fL[13])+4.242640687119286*(alphaR[0]*fL[12]+alphaR[1]*fL[9])+2.449489742783178*(alphaR[0]*fL[8]+alphaR[1]*fL[4])); 
  incr[13] = 0.125*(2.449489742783178*(alphaR[0]*fL[15]+alphaR[1]*fL[14])+1.414213562373095*alphaR[0]*fL[13]+2.449489742783178*alphaR[2]*fL[12]+1.414213562373095*(alphaR[1]*fL[10]+alphaR[2]*fL[8])); 
  incr[14] = -0.125*(4.242640687119286*(alphaR[1]*fL[15]+alphaR[0]*fL[14])+2.449489742783178*(alphaR[1]*fL[13]+alphaR[0]*fL[10])+alphaR[2]*(4.242640687119286*fL[9]+2.449489742783178*fL[4])); 
  incr[15] = -0.125*(4.242640687119286*(alphaR[0]*fL[15]+alphaR[1]*fL[14])+2.449489742783178*alphaR[0]*fL[13]+4.242640687119286*alphaR[2]*fL[12]+2.449489742783178*(alphaR[1]*fL[10]+alphaR[2]*fL[8])); 
  } else { 
  incr[0] = -0.125*(2.449489742783178*(alphaR[2]*fR[7]+alphaR[1]*fR[5])-1.414213562373095*alphaR[2]*fR[3]+2.449489742783178*alphaR[0]*fR[2]-1.414213562373095*(alphaR[1]*fR[1]+alphaR[0]*fR[0])); 
  incr[1] = -0.125*(alphaR[2]*(2.449489742783178*fR[11]-1.414213562373095*fR[6])+2.449489742783178*(alphaR[0]*fR[5]+alphaR[1]*fR[2])-1.414213562373095*(alphaR[0]*fR[1]+fR[0]*alphaR[1])); 
  incr[2] = 0.125*(4.242640687119286*(alphaR[2]*fR[7]+alphaR[1]*fR[5])-2.449489742783178*alphaR[2]*fR[3]+4.242640687119286*alphaR[0]*fR[2]-2.449489742783178*(alphaR[1]*fR[1]+alphaR[0]*fR[0])); 
  incr[3] = -0.125*(2.449489742783178*(alphaR[1]*fR[11]+alphaR[0]*fR[7])-1.414213562373095*(alphaR[1]*fR[6]+alphaR[0]*fR[3])+alphaR[2]*(2.449489742783178*fR[2]-1.414213562373095*fR[0])); 
  incr[4] = -0.125*(2.449489742783178*(alphaR[2]*fR[14]+alphaR[1]*fR[12])-1.414213562373095*alphaR[2]*fR[10]+2.449489742783178*alphaR[0]*fR[9]-1.414213562373095*(alphaR[1]*fR[8]+alphaR[0]*fR[4])); 
  incr[5] = 0.125*(alphaR[2]*(4.242640687119286*fR[11]-2.449489742783178*fR[6])+4.242640687119286*(alphaR[0]*fR[5]+alphaR[1]*fR[2])-2.449489742783178*(alphaR[0]*fR[1]+fR[0]*alphaR[1])); 
  incr[6] = -0.125*(2.449489742783178*(alphaR[0]*fR[11]+alphaR[1]*fR[7])-1.414213562373095*alphaR[0]*fR[6]+2.449489742783178*alphaR[2]*fR[5]-1.414213562373095*(alphaR[1]*fR[3]+fR[1]*alphaR[2])); 
  incr[7] = 0.125*(4.242640687119286*(alphaR[1]*fR[11]+alphaR[0]*fR[7])-2.449489742783178*(alphaR[1]*fR[6]+alphaR[0]*fR[3])+alphaR[2]*(4.242640687119286*fR[2]-2.449489742783178*fR[0])); 
  incr[8] = -0.125*(alphaR[2]*(2.449489742783178*fR[15]-1.414213562373095*fR[13])+2.449489742783178*(alphaR[0]*fR[12]+alphaR[1]*fR[9])-1.414213562373095*(alphaR[0]*fR[8]+alphaR[1]*fR[4])); 
  incr[9] = 0.125*(4.242640687119286*(alphaR[2]*fR[14]+alphaR[1]*fR[12])-2.449489742783178*alphaR[2]*fR[10]+4.242640687119286*alphaR[0]*fR[9]-2.449489742783178*(alphaR[1]*fR[8]+alphaR[0]*fR[4])); 
  incr[10] = -0.125*(2.449489742783178*(alphaR[1]*fR[15]+alphaR[0]*fR[14])-1.414213562373095*(alphaR[1]*fR[13]+alphaR[0]*fR[10])+alphaR[2]*(2.449489742783178*fR[9]-1.414213562373095*fR[4])); 
  incr[11] = 0.125*(4.242640687119286*(alphaR[0]*fR[11]+alphaR[1]*fR[7])-2.449489742783178*alphaR[0]*fR[6]+4.242640687119286*alphaR[2]*fR[5]-2.449489742783178*(alphaR[1]*fR[3]+fR[1]*alphaR[2])); 
  incr[12] = 0.125*(alphaR[2]*(4.242640687119286*fR[15]-2.449489742783178*fR[13])+4.242640687119286*(alphaR[0]*fR[12]+alphaR[1]*fR[9])-2.449489742783178*(alphaR[0]*fR[8]+alphaR[1]*fR[4])); 
  incr[13] = -0.125*(2.449489742783178*(alphaR[0]*fR[15]+alphaR[1]*fR[14])-1.414213562373095*alphaR[0]*fR[13]+2.449489742783178*alphaR[2]*fR[12]-1.414213562373095*(alphaR[1]*fR[10]+alphaR[2]*fR[8])); 
  incr[14] = 0.125*(4.242640687119286*(alphaR[1]*fR[15]+alphaR[0]*fR[14])-2.449489742783178*(alphaR[1]*fR[13]+alphaR[0]*fR[10])+alphaR[2]*(4.242640687119286*fR[9]-2.449489742783178*fR[4])); 
  incr[15] = 0.125*(4.242640687119286*(alphaR[0]*fR[15]+alphaR[1]*fR[14])-2.449489742783178*alphaR[0]*fR[13]+4.242640687119286*alphaR[2]*fR[12]-2.449489742783178*(alphaR[1]*fR[10]+alphaR[2]*fR[8])); 
  }
#elif upwindType == QUAD 
  double alphaOrdR;
  double fUpOrd[8];
  ...
  incr[2] = -0.4330127018922193*(alphaR[2]*fUp[2]+alphaR[1]*fUp[1]+alphaR[0]*fUp[0]); 
  incr[3] = 0.25*(alphaR[1]*fUp[4]+alphaR[0]*fUp[2]+fUp[0]*alphaR[2]); 
  incr[4] = 0.25*(alphaR[2]*fUp[6]+alphaR[1]*fUp[5]+alphaR[0]*fUp[3]); 
  incr[5] = -0.4330127018922193*(alphaR[2]*fUp[4]+alphaR[0]*fUp[1]+fUp[0]*alphaR[1]); 
  incr[6] = 0.25*(alphaR[0]*fUp[4]+alphaR[1]*fUp[2]+fUp[1]*alphaR[2]); 
  ...
  incr[9] = -0.4330127018922193*(alphaR[2]*fUp[6]+alphaR[1]*fUp[5]+alphaR[0]*fUp[3]); 
  incr[10] = 0.25*(alphaR[1]*fUp[7]+alphaR[0]*fUp[6]+alphaR[2]*fUp[3]); 
  incr[11] = -0.4330127018922193*(alphaR[0]*fUp[4]+alphaR[1]*fUp[2]+fUp[1]*alphaR[2]); 
  incr[12] = -0.4330127018922193*(alphaR[2]*fUp[7]+alphaR[0]*fUp[5]+alphaR[1]*fUp[3]); 
  incr[13] = 0.25*(alphaR[0]*fUp[7]+alphaR[1]*fUp[6]+alphaR[2]*fUp[5]); 
...
double EmGyrokineticSimpleHelicalSurf2x2vSer_vpar_P1_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *gradPar, const double *BdriftX, const double *BdriftY, const double *phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // dApardtPrev: previous dApardt.
  ...
  double alphaR[8]; 
  alphaR[0] = -(0.1767766952966368*((1.732050807568877*BstarYdBmagR[1]*hamilR[5]+hamilR[2]*(1.732050807568877*BstarYdBmagR[0]-3.0*BstarYdBmagR[3]))*rdy2R+(1.732050807568877*BstarXdBmagR[2]*hamilR[5]+hamilR[1]*(1.732050807568877*BstarXdBmagR[0]-3.0*BstarXdBmagR[3]))*rdx2R))/m_; 
  alphaR[1] = (0.1767766952966368*(((3.0*BstarYdBmagR[3]-1.732050807568877*BstarYdBmagR[0])*hamilR[5]-1.732050807568877*BstarYdBmagR[1]*hamilR[2])*rdy2R-1.732050807568877*(BstarXdBmagR[5]*hamilR[5]+BstarXdBmagR[1]*hamilR[1])*rdx2R))/m_; 
  alphaR[2] = -(0.1767766952966368*(1.732050807568877*(BstarYdBmagR[5]*hamilR[5]+BstarYdBmagR[2]*hamilR[2])*rdy2R+((1.732050807568877*BstarXdBmagR[0]-3.0*BstarXdBmagR[3])*hamilR[5]+1.732050807568877*hamilR[1]*BstarXdBmagR[2])*rdx2R))/m_; 
  alphaR[4] = -(0.3061862178478971*((BstarYdBmagR[2]*hamilR[5]+hamilR[2]*BstarYdBmagR[5])*rdy2R+(BstarXdBmagR[1]*hamilR[5]+hamilR[1]*BstarXdBmagR[5])*rdx2R))/m_; 

  double alphaUpR[8]; 
  alphaUpR[0] = -(0.1767766952966368*((1.732050807568877*BstarYdBmagR[1]*hamilR[5]+hamilR[2]*(1.732050807568877*BstarYdBmagR[0]-3.0*BstarYdBmagR[3]))*rdy2R+(1.732050807568877*BstarXdBmagR[2]*hamilR[5]+hamilR[1]*(1.732050807568877*BstarXdBmagR[0]-3.0*BstarXdBmagR[3]))*rdx2R+8.0*dApardtPrev[0]*q_))/m_; 
  alphaUpR[1] = (0.1767766952966368*(((3.0*BstarYdBmagR[3]-1.732050807568877*BstarYdBmagR[0])*hamilR[5]-1.732050807568877*BstarYdBmagR[1]*hamilR[2])*rdy2R-1.732050807568877*(BstarXdBmagR[5]*hamilR[5]+BstarXdBmagR[1]*hamilR[1])*rdx2R-8.0*dApardtPrev[1]*q_))/m_; 
  alphaUpR[2] = -(0.1767766952966368*(1.732050807568877*(BstarYdBmagR[5]*hamilR[5]+BstarYdBmagR[2]*hamilR[2])*rdy2R+((1.732050807568877*BstarXdBmagR[0]-3.0*BstarXdBmagR[3])*hamilR[5]+1.732050807568877*hamilR[1]*BstarXdBmagR[2])*rdx2R+8.0*dApardtPrev[2]*q_))/m_; 
  alphaUpR[4] = -(0.1767766952966368*(1.732050807568877*((BstarYdBmagR[2]*hamilR[5]+hamilR[2]*BstarYdBmagR[5])*rdy2R+(BstarXdBmagR[1]*hamilR[5]+hamilR[1]*BstarXdBmagR[5])*rdx2R)+8.0*dApardtPrev[3]*q_))/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgR = -(0.03125*((1.732050807568877*BstarYdBmagR[1]*hamilR[5]-3.0*hamilR[2]*BstarYdBmagR[3]+1.732050807568877*BstarYdBmagR[0]*hamilR[2])*rdy2R+(1.732050807568877*BstarXdBmagR[2]*hamilR[5]-3.0*hamilR[1]*BstarXdBmagR[3]+1.732050807568877*BstarXdBmagR[0]*hamilR[1])*rdx2R+8.0*dApardtPrev[0]*q_))/m_; 
...
double EmGyrokineticSimpleHelicalSurf2x2vSerStep2_vpar_P1_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *gradPar, const double *BdriftX, const double *BdriftY, const double *phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // q_,m_: species charge and mass.
  // cflL,cflR: CFL rate in left and right cells.
  // wL[NDIM],wR[NDIM]: cell-center in left and right cells.
...
double EmGyrokineticSimpleHelicalSurf2x2vSer_x_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *gradPar, const double *BdriftX, const double *BdriftY, const double *phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // dApardtPrev: previous dApardt.
  ...
  double BstarXdBmagR[16]; 
  BstarXdBmagR[0] = (2.0*BdriftX[0]*m_*wvparR+q_*(1.732050807568877*(bmagInv[1]*Apar[3]+bmagInv[0]*Apar[2])*rdy2R+Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0]))/q_; 
  BstarXdBmagR[1] = (2.0*BdriftX[1]*m_*wvparR+q_*(1.732050807568877*(bmagInv[0]*Apar[3]+bmagInv[1]*Apar[2])*rdy2R+Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1]))/q_; 
  BstarXdBmagR[2] = BdriftX[1]*Apar[3]+BdriftX[0]*Apar[2]; 
  BstarXdBmagR[3] = (1.154700538379252*BdriftX[0]*m_)/(q_*rdvpar2R); 
  BstarXdBmagR[5] = BdriftX[0]*Apar[3]+BdriftX[1]*Apar[2]; 
  BstarXdBmagR[6] = (1.154700538379252*BdriftX[1]*m_)/(q_*rdvpar2R); 

  double BstarYdBmagR[16]; 
  BstarYdBmagR[0] = (2.0*BdriftY[0]*m_*wvparR+q_*(Apar[1]*(BdriftY[1]-1.732050807568877*bmagInv[0]*rdx2R)+Apar[0]*BdriftY[0]))/q_; 
  BstarYdBmagR[1] = (2.0*BdriftY[1]*m_*wvparR+q_*((-1.732050807568877*Apar[1]*bmagInv[1]*rdx2R)+Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1]))/q_; 
  BstarYdBmagR[2] = -0.5773502691896258*(3.0*bmagInv[0]*Apar[3]*rdx2R-1.732050807568877*(BdriftY[1]*Apar[3]+BdriftY[0]*Apar[2])); 
  BstarYdBmagR[3] = (1.154700538379252*BdriftY[0]*m_)/(q_*rdvpar2R); 
  BstarYdBmagR[5] = -1.0*(1.732050807568877*bmagInv[1]*Apar[3]*rdx2R-1.0*(BdriftY[0]*Apar[3]+BdriftY[1]*Apar[2])); 
  BstarYdBmagR[6] = (1.154700538379252*BdriftY[1]*m_)/(q_*rdvpar2R); 

  double alphaR[8]; 
  alphaR[0] = -(0.1767766952966368*(((10.39230484541326*bmagInv[1]-6.0*bmagInv[0])*hamilR[5]+(3.464101615137754*bmagInv[0]-6.0*bmagInv[1])*hamilR[2])*m_*rdy2R+(3.0*BstarXdBmagR[1]-1.732050807568877*BstarXdBmagR[0])*hamilR[3]*q_*rdvpar2R))/(m_*q_); 
  alphaR[1] = -(0.1767766952966368*hamilR[3]*(3.0*BstarXdBmagR[5]-1.732050807568877*BstarXdBmagR[2])*rdvpar2R)/m_; 
  alphaR[2] = -(0.1767766952966368*hamilR[3]*(3.0*BstarXdBmagR[6]-1.732050807568877*BstarXdBmagR[3])*rdvpar2R)/m_; 
...
double EmGyrokineticSimpleHelicalSurf2x2vSer_y_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *gradPar, const double *BdriftX, const double *BdriftY, const double *phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // dApardtPrev: previous dApardt.
  ...
  double alphaR[8]; 
  alphaR[0] = -(0.1767766952966368*(bmagInv[0]*(6.0*hamilR[5]-3.464101615137754*hamilR[1])*m_*rdx2R+(3.0*BstarYdBmagR[2]-1.732050807568877*BstarYdBmagR[0])*hamilR[3]*q_*rdvpar2R))/(m_*q_); 
  alphaR[1] = -(0.1767766952966368*(bmagInv[1]*(6.0*hamilR[5]-3.464101615137754*hamilR[1])*m_*rdx2R+hamilR[3]*(3.0*BstarYdBmagR[5]-1.732050807568877*BstarYdBmagR[1])*q_*rdvpar2R))/(m_*q_); 
  alphaR[2] = (0.3061862178478971*BstarYdBmagR[3]*hamilR[3]*rdvpar2R)/m_; 
...
double EmGyrokineticSimpleHelicalSurf2x2vSer_vpar_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *gradPar, const double *BdriftX, const double *BdriftY, const double *phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // dApardtPrev: previous dApardt.
  ...
  double alphaR[8]; 
  alphaR[0] = (0.1767766952966368*((hamilR[5]*(3.0*BstarYdBmagR[6]-1.732050807568877*BstarYdBmagR[1])+hamilR[2]*(3.0*BstarYdBmagR[3]-1.732050807568877*BstarYdBmagR[0]))*rdy2R+(hamilR[1]*(3.0*BstarXdBmagR[3]-1.732050807568877*BstarXdBmagR[0])-1.732050807568877*BstarXdBmagR[2]*hamilR[5])*rdx2R))/m_; 
  alphaR[1] = (0.1767766952966368*((3.0*hamilR[2]*BstarYdBmagR[6]+(3.0*BstarYdBmagR[3]-1.732050807568877*BstarYdBmagR[0])*hamilR[5]-1.732050807568877*BstarYdBmagR[1]*hamilR[2])*rdy2R+(3.0*hamilR[1]*BstarXdBmagR[6]-1.732050807568877*(BstarXdBmagR[5]*hamilR[5]+BstarXdBmagR[1]*hamilR[1]))*rdx2R))/m_; 
  alphaR[2] = -(0.1767766952966368*(1.732050807568877*(BstarYdBmagR[5]*hamilR[5]+BstarYdBmagR[2]*hamilR[2])*rdy2R+((1.732050807568877*BstarXdBmagR[0]-3.0*BstarXdBmagR[3])*hamilR[5]+1.732050807568877*hamilR[1]*BstarXdBmagR[2])*rdx2R))/m_; 
  alphaR[3] = (0.1767766952966368*(3.0*BstarXdBmagR[3]-1.732050807568877*BstarXdBmagR[0])*hamilR[8]*rdx2R)/m_; 
  alphaR[4] = -(0.1767766952966368*(1.732050807568877*(BstarYdBmagR[2]*hamilR[5]+hamilR[2]*BstarYdBmagR[5])*rdy2R+(1.732050807568877*(BstarXdBmagR[1]*hamilR[5]+hamilR[1]*BstarXdBmagR[5])-3.0*hamilR[5]*BstarXdBmagR[6])*rdx2R))/m_; 
  alphaR[5] = (0.1767766952966368*(3.0*BstarXdBmagR[6]-1.732050807568877*BstarXdBmagR[1])*hamilR[8]*rdx2R)/m_; 
  alphaR[6] = -(0.3061862178478971*BstarXdBmagR[2]*hamilR[8]*rdx2R)/m_; 
  alphaR[7] = -(0.3061862178478971*BstarXdBmagR[5]*hamilR[8]*rdx2R)/m_; 

  double alphaUpR[8]; 
  alphaUpR[0] = (0.1767766952966368*((hamilR[5]*(3.0*BstarYdBmagR[6]-1.732050807568877*BstarYdBmagR[1])+hamilR[2]*(3.0*BstarYdBmagR[3]-1.732050807568877*BstarYdBmagR[0]))*rdy2R+(hamilR[1]*(3.0*BstarXdBmagR[3]-1.732050807568877*BstarXdBmagR[0])-1.732050807568877*BstarXdBmagR[2]*hamilR[5])*rdx2R-8.0*dApardtPrev[0]*q_))/m_; 
  alphaUpR[1] = (0.1767766952966368*((3.0*hamilR[2]*BstarYdBmagR[6]+(3.0*BstarYdBmagR[3]-1.732050807568877*BstarYdBmagR[0])*hamilR[5]-1.732050807568877*BstarYdBmagR[1]*hamilR[2])*rdy2R+(3.0*hamilR[1]*BstarXdBmagR[6]-1.732050807568877*(BstarXdBmagR[5]*hamilR[5]+BstarXdBmagR[1]*hamilR[1]))*rdx2R-8.0*dApardtPrev[1]*q_))/m_; 
  alphaUpR[2] = -(0.1767766952966368*(1.732050807568877*(BstarYdBmagR[5]*hamilR[5]+BstarYdBmagR[2]*hamilR[2])*rdy2R+((1.732050807568877*BstarXdBmagR[0]-3.0*BstarXdBmagR[3])*hamilR[5]+1.732050807568877*hamilR[1]*BstarXdBmagR[2])*rdx2R+8.0*dApardtPrev[2]*q_))/m_; 
  alphaUpR[3] = (0.1767766952966368*(3.0*BstarXdBmagR[3]-1.732050807568877*BstarXdBmagR[0])*hamilR[8]*rdx2R)/m_; 
  alphaUpR[4] = -(0.1767766952966368*(1.732050807568877*(BstarYdBmagR[2]*hamilR[5]+hamilR[2]*BstarYdBmagR[5])*rdy2R+(1.732050807568877*(BstarXdBmagR[1]*hamilR[5]+hamilR[1]*BstarXdBmagR[5])-3.0*hamilR[5]*BstarXdBmagR[6])*rdx2R+8.0*dApardtPrev[3]*q_))/m_; 
  alphaUpR[5] = (0.1767766952966368*(3.0*BstarXdBmagR[6]-1.732050807568877*BstarXdBmagR[1])*hamilR[8]*rdx2R)/m_; 
  alphaUpR[6] = -(0.3061862178478971*BstarXdBmagR[2]*hamilR[8]*rdx2R)/m_; 
  alphaUpR[7] = -(0.3061862178478971*BstarXdBmagR[5]*hamilR[8]*rdx2R)/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgR = (0.03125*((3.0*hamilR[5]*BstarYdBmagR[6]-1.732050807568877*BstarYdBmagR[1]*hamilR[5]+3.0*hamilR[2]*BstarYdBmagR[3]-1.732050807568877*BstarYdBmagR[0]*hamilR[2])*rdy2R+((-1.732050807568877*BstarXdBmagR[2]*hamilR[5])+3.0*hamilR[1]*BstarXdBmagR[3]-1.732050807568877*BstarXdBmagR[0]*hamilR[1])*rdx2R-8.0*dApardtPrev[0]*q_))/m_; 

  double incr[16]; 
#if upwindType == SURFAVG 
  double incrEmMod[16]; 
  if (alphaSurfAvgR>0) { 
  incr[0] = 0.125*(2.449489742783178*(alphaR[7]*fL[15]+alphaR[6]*fL[14]+alphaR[5]*fL[13])+1.414213562373095*alphaR[7]*fL[12]+2.449489742783178*(alphaR[4]*fL[11]+alphaR[3]*fL[10])+1.414213562373095*(alphaR[6]*fL[9]+alphaR[5]*fL[8])+2.449489742783178*(alphaR[2]*fL[7]+alphaR[1]*fL[6])+1.414213562373095*(alphaR[4]*fL[5]+alphaR[3]*fL[4])+2.449489742783178*alphaR[0]*fL[3]+1.414213562373095*(alphaR[2]*fL[2]+alphaR[1]*fL[1]+alphaR[0]*fL[0])); 
  incr[1] = 0.125*(2.449489742783178*(alphaR[6]*fL[15]+alphaR[7]*fL[14]+alphaR[3]*fL[13])+1.414213562373095*alphaR[6]*fL[12]+2.449489742783178*(alphaR[2]*fL[11]+alphaR[5]*fL[10])+1.414213562373095*(alphaR[7]*fL[9]+alphaR[3]*fL[8])+2.449489742783178*(alphaR[4]*fL[7]+alphaR[0]*fL[6])+1.414213562373095*(alphaR[2]*fL[5]+fL[4]*alphaR[5]+fL[2]*alphaR[4])+2.449489742783178*alphaR[1]*fL[3]+1.414213562373095*(alphaR[0]*fL[1]+fL[0]*alphaR[1])); 
  incr[2] = 0.125*(2.449489742783178*(alphaR[5]*fL[15]+alphaR[3]*fL[14]+alphaR[7]*fL[13])+1.414213562373095*alphaR[5]*fL[12]+2.449489742783178*(alphaR[1]*fL[11]+alphaR[6]*fL[10])+1.414213562373095*(alphaR[3]*fL[9]+alphaR[7]*fL[8])+2.449489742783178*(alphaR[0]*fL[7]+alphaR[4]*fL[6])+1.414213562373095*(fL[4]*alphaR[6]+alphaR[1]*fL[5]+fL[1]*alphaR[4])+2.449489742783178*alphaR[2]*fL[3]+1.414213562373095*(alphaR[0]*fL[2]+fL[0]*alphaR[2])); 
  incr[3] = -0.125*(4.242640687119286*(alphaR[7]*fL[15]+alphaR[6]*fL[14]+alphaR[5]*fL[13])+2.449489742783178*alphaR[7]*fL[12]+4.242640687119286*(alphaR[4]*fL[11]+alphaR[3]*fL[10])+2.449489742783178*(alphaR[6]*fL[9]+alphaR[5]*fL[8])+4.242640687119286*(alphaR[2]*fL[7]+alphaR[1]*fL[6])+2.449489742783178*(alphaR[4]*fL[5]+alphaR[3]*fL[4])+4.242640687119286*alphaR[0]*fL[3]+2.449489742783178*(alphaR[2]*fL[2]+alphaR[1]*fL[1]+alphaR[0]*fL[0])); 
  incr[4] = 0.125*(2.449489742783178*(alphaR[4]*fL[15]+alphaR[2]*fL[14]+alphaR[1]*fL[13])+1.414213562373095*alphaR[4]*fL[12]+2.449489742783178*(alphaR[7]*fL[11]+alphaR[0]*fL[10])+1.414213562373095*(alphaR[2]*fL[9]+alphaR[1]*fL[8])+2.449489742783178*alphaR[6]*fL[7]+1.414213562373095*fL[5]*alphaR[7]+2.449489742783178*alphaR[5]*fL[6]+1.414213562373095*(fL[2]*alphaR[6]+fL[1]*alphaR[5]+alphaR[0]*fL[4])+alphaR[3]*(2.449489742783178*fL[3]+1.414213562373095*fL[0])); 
  incr[5] = 0.125*(2.449489742783178*(alphaR[3]*fL[15]+alphaR[5]*fL[14]+alphaR[6]*fL[13])+1.414213562373095*alphaR[3]*fL[12]+2.449489742783178*(alphaR[0]*fL[11]+alphaR[7]*fL[10])+1.414213562373095*(alphaR[5]*fL[9]+alphaR[6]*fL[8])+2.449489742783178*alphaR[1]*fL[7]+1.414213562373095*fL[4]*alphaR[7]+2.449489742783178*alphaR[2]*fL[6]+1.414213562373095*alphaR[0]*fL[5]+(2.449489742783178*fL[3]+1.414213562373095*fL[0])*alphaR[4]+1.414213562373095*(alphaR[1]*fL[2]+fL[1]*alphaR[2])); 
  incr[6] = -0.125*(4.242640687119286*(alphaR[6]*fL[15]+alphaR[7]*fL[14]+alphaR[3]*fL[13])+2.449489742783178*alphaR[6]*fL[12]+4.242640687119286*(alphaR[2]*fL[11]+alphaR[5]*fL[10])+2.449489742783178*(alphaR[7]*fL[9]+alphaR[3]*fL[8])+4.242640687119286*(alphaR[4]*fL[7]+alphaR[0]*fL[6])+2.449489742783178*(alphaR[2]*fL[5]+fL[4]*alphaR[5]+fL[2]*alphaR[4])+4.242640687119286*alphaR[1]*fL[3]+2.449489742783178*(alphaR[0]*fL[1]+fL[0]*alphaR[1])); 
  incr[7] = -0.125*(4.242640687119286*(alphaR[5]*fL[15]+alphaR[3]*fL[14]+alphaR[7]*fL[13])+2.449489742783178*alphaR[5]*fL[12]+4.242640687119286*(alphaR[1]*fL[11]+alphaR[6]*fL[10])+2.449489742783178*(alphaR[3]*fL[9]+alphaR[7]*fL[8])+4.242640687119286*(alphaR[0]*fL[7]+alphaR[4]*fL[6])+2.449489742783178*(fL[4]*alphaR[6]+alphaR[1]*fL[5]+fL[1]*alphaR[4])+4.242640687119286*alphaR[2]*fL[3]+2.449489742783178*(alphaR[0]*fL[2]+fL[0]*alphaR[2])); 
  incr[8] = 0.125*(2.449489742783178*(alphaR[2]*fL[15]+alphaR[4]*fL[14]+alphaR[0]*fL[13])+1.414213562373095*alphaR[2]*fL[12]+2.449489742783178*(alphaR[6]*fL[11]+alphaR[1]*fL[10])+1.414213562373095*(alphaR[4]*fL[9]+alphaR[0]*fL[8])+alphaR[7]*(2.449489742783178*fL[7]+1.414213562373095*fL[2])+2.449489742783178*alphaR[3]*fL[6]+1.414213562373095*fL[5]*alphaR[6]+(2.449489742783178*fL[3]+1.414213562373095*fL[0])*alphaR[5]+1.414213562373095*(alphaR[1]*fL[4]+fL[1]*alphaR[3])); 
  incr[9] = 0.125*(2.449489742783178*(alphaR[1]*fL[15]+alphaR[0]*fL[14]+alphaR[4]*fL[13])+1.414213562373095*alphaR[1]*fL[12]+2.449489742783178*(alphaR[5]*fL[11]+alphaR[2]*fL[10])+1.414213562373095*(alphaR[0]*fL[9]+alphaR[4]*fL[8])+2.449489742783178*alphaR[3]*fL[7]+(2.449489742783178*fL[6]+1.414213562373095*fL[1])*alphaR[7]+(2.449489742783178*fL[3]+1.414213562373095*fL[0])*alphaR[6]+1.414213562373095*(alphaR[5]*fL[5]+alphaR[2]*fL[4]+fL[2]*alphaR[3])); 
  incr[10] = -0.125*(4.242640687119286*(alphaR[4]*fL[15]+alphaR[2]*fL[14]+alphaR[1]*fL[13])+2.449489742783178*alphaR[4]*fL[12]+4.242640687119286*(alphaR[7]*fL[11]+alphaR[0]*fL[10])+2.449489742783178*(alphaR[2]*fL[9]+alphaR[1]*fL[8])+4.242640687119286*alphaR[6]*fL[7]+2.449489742783178*fL[5]*alphaR[7]+4.242640687119286*alphaR[5]*fL[6]+2.449489742783178*(fL[2]*alphaR[6]+fL[1]*alphaR[5]+alphaR[0]*fL[4])+alphaR[3]*(4.242640687119286*fL[3]+2.449489742783178*fL[0])); 
  incr[11] = -0.125*(4.242640687119286*(alphaR[3]*fL[15]+alphaR[5]*fL[14]+alphaR[6]*fL[13])+2.449489742783178*alphaR[3]*fL[12]+4.242640687119286*(alphaR[0]*fL[11]+alphaR[7]*fL[10])+2.449489742783178*(alphaR[5]*fL[9]+alphaR[6]*fL[8])+4.242640687119286*alphaR[1]*fL[7]+2.449489742783178*fL[4]*alphaR[7]+4.242640687119286*alphaR[2]*fL[6]+2.449489742783178*alphaR[0]*fL[5]+(4.242640687119286*fL[3]+2.449489742783178*fL[0])*alphaR[4]+2.449489742783178*(alphaR[1]*fL[2]+fL[1]*alphaR[2])); 
  incr[12] = 0.125*(2.449489742783178*(alphaR[0]*fL[15]+alphaR[1]*fL[14]+alphaR[2]*fL[13])+1.414213562373095*alphaR[0]*fL[12]+2.449489742783178*(alphaR[3]*fL[11]+alphaR[4]*fL[10])+1.414213562373095*(alphaR[1]*fL[9]+alphaR[2]*fL[8])+2.449489742783178*alphaR[5]*fL[7]+(2.449489742783178*fL[3]+1.414213562373095*fL[0])*alphaR[7]+2.449489742783178*alphaR[6]*fL[6]+1.414213562373095*(fL[1]*alphaR[6]+alphaR[3]*fL[5]+fL[2]*alphaR[5]+alphaR[4]*fL[4])); 
  incr[13] = -0.125*(4.242640687119286*(alphaR[2]*fL[15]+alphaR[4]*fL[14]+alphaR[0]*fL[13])+2.449489742783178*alphaR[2]*fL[12]+4.242640687119286*(alphaR[6]*fL[11]+alphaR[1]*fL[10])+2.449489742783178*(alphaR[4]*fL[9]+alphaR[0]*fL[8])+alphaR[7]*(4.242640687119286*fL[7]+2.449489742783178*fL[2])+4.242640687119286*alphaR[3]*fL[6]+2.449489742783178*fL[5]*alphaR[6]+(4.242640687119286*fL[3]+2.449489742783178*fL[0])*alphaR[5]+2.449489742783178*(alphaR[1]*fL[4]+fL[1]*alphaR[3])); 
  incr[14] = -0.125*(4.242640687119286*(alphaR[1]*fL[15]+alphaR[0]*fL[14]+alphaR[4]*fL[13])+2.449489742783178*alphaR[1]*fL[12]+4.242640687119286*(alphaR[5]*fL[11]+alphaR[2]*fL[10])+2.449489742783178*(alphaR[0]*fL[9]+alphaR[4]*fL[8])+4.242640687119286*alphaR[3]*fL[7]+(4.242640687119286*fL[6]+2.449489742783178*fL[1])*alphaR[7]+(4.242640687119286*fL[3]+2.449489742783178*fL[0])*alphaR[6]+2.449489742783178*(alphaR[5]*fL[5]+alphaR[2]*fL[4]+fL[2]*alphaR[3])); 
  incr[15] = -0.125*(4.242640687119286*(alphaR[0]*fL[15]+alphaR[1]*fL[14]+alphaR[2]*fL[13])+2.449489742783178*alphaR[0]*fL[12]+4.242640687119286*(alphaR[3]*fL[11]+alphaR[4]*fL[10])+2.449489742783178*(alphaR[1]*fL[9]+alphaR[2]*fL[8])+4.242640687119286*alphaR[5]*fL[7]+(4.242640687119286*fL[3]+2.449489742783178*fL[0])*alphaR[7]+4.242640687119286*alphaR[6]*fL[6]+2.449489742783178*(fL[1]*alphaR[6]+alphaR[3]*fL[5]+fL[2]*alphaR[5]+alphaR[4]*fL[4])); 
  incrEmMod[0] = 0.5*(1.732050807568877*fL[3]+fL[0]); 
  incrEmMod[1] = 0.5*(1.732050807568877*fL[6]+fL[1]); 
  incrEmMod[2] = 0.5*(1.732050807568877*fL[7]+fL[2]); 
  incrEmMod[3] = -0.5*(3.0*fL[3]+1.732050807568877*fL[0]); 
  ...
  incrEmMod[14] = 0.5*(3.0*fR[14]-1.732050807568877*fR[9]); 
  incrEmMod[15] = 0.5*(3.0*fR[15]-1.732050807568877*fR[12]); 
  incr[0] = -0.125*(2.449489742783178*(alphaR[7]*fR[15]+alphaR[6]*fR[14]+alphaR[5]*fR[13])-1.414213562373095*alphaR[7]*fR[12]+2.449489742783178*(alphaR[4]*fR[11]+alphaR[3]*fR[10])-1.414213562373095*(alphaR[6]*fR[9]+alphaR[5]*fR[8])+2.449489742783178*(alphaR[2]*fR[7]+alphaR[1]*fR[6])-1.414213562373095*(alphaR[4]*fR[5]+alphaR[3]*fR[4])+2.449489742783178*alphaR[0]*fR[3]-1.414213562373095*(alphaR[2]*fR[2]+alphaR[1]*fR[1]+alphaR[0]*fR[0])); 
  incr[1] = -0.125*(2.449489742783178*(alphaR[6]*fR[15]+alphaR[7]*fR[14]+alphaR[3]*fR[13])-1.414213562373095*alphaR[6]*fR[12]+2.449489742783178*(alphaR[2]*fR[11]+alphaR[5]*fR[10])-1.414213562373095*(alphaR[7]*fR[9]+alphaR[3]*fR[8])+2.449489742783178*(alphaR[4]*fR[7]+alphaR[0]*fR[6])-1.414213562373095*(alphaR[2]*fR[5]+fR[4]*alphaR[5]+fR[2]*alphaR[4])+2.449489742783178*alphaR[1]*fR[3]-1.414213562373095*(alphaR[0]*fR[1]+fR[0]*alphaR[1])); 
  incr[2] = -0.125*(2.449489742783178*(alphaR[5]*fR[15]+alphaR[3]*fR[14]+alphaR[7]*fR[13])-1.414213562373095*alphaR[5]*fR[12]+2.449489742783178*(alphaR[1]*fR[11]+alphaR[6]*fR[10])-1.414213562373095*(alphaR[3]*fR[9]+alphaR[7]*fR[8])+2.449489742783178*(alphaR[0]*fR[7]+alphaR[4]*fR[6])-1.414213562373095*(fR[4]*alphaR[6]+alphaR[1]*fR[5]+fR[1]*alphaR[4])+2.449489742783178*alphaR[2]*fR[3]-1.414213562373095*(alphaR[0]*fR[2]+fR[0]*alphaR[2])); 
  incr[3] = 0.125*(4.242640687119286*(alphaR[7]*fR[15]+alphaR[6]*fR[14]+alphaR[5]*fR[13])-2.449489742783178*alphaR[7]*fR[12]+4.242640687119286*(alphaR[4]*fR[11]+alphaR[3]*fR[10])-2.449489742783178*(alphaR[6]*fR[9]+alphaR[5]*fR[8])+4.242640687119286*(alphaR[2]*fR[7]+alphaR[1]*fR[6])-2.449489742783178*(alphaR[4]*fR[5]+alphaR[3]*fR[4])+4.242640687119286*alphaR[0]*fR[3]-2.449489742783178*(alphaR[2]*fR[2]+alphaR[1]*fR[1]+alphaR[0]*fR[0])); 
  incr[4] = -0.125*(2.449489742783178*(alphaR[4]*fR[15]+alphaR[2]*fR[14]+alphaR[1]*fR[13])-1.414213562373095*alphaR[4]*fR[12]+2.449489742783178*(alphaR[7]*fR[11]+alphaR[0]*fR[10])-1.414213562373095*(alphaR[2]*fR[9]+alphaR[1]*fR[8])+2.449489742783178*alphaR[6]*fR[7]-1.414213562373095*fR[5]*alphaR[7]+2.449489742783178*alphaR[5]*fR[6]-1.414213562373095*(fR[2]*alphaR[6]+fR[1]*alphaR[5]+alphaR[0]*fR[4])+alphaR[3]*(2.449489742783178*fR[3]-1.414213562373095*fR[0])); 
  incr[5] = -0.125*(2.449489742783178*(alphaR[3]*fR[15]+alphaR[5]*fR[14]+alphaR[6]*fR[13])-1.414213562373095*alphaR[3]*fR[12]+2.449489742783178*(alphaR[0]*fR[11]+alphaR[7]*fR[10])-1.414213562373095*(alphaR[5]*fR[9]+alphaR[6]*fR[8])+2.449489742783178*alphaR[1]*fR[7]-1.414213562373095*fR[4]*alphaR[7]+2.449489742783178*alphaR[2]*fR[6]-1.414213562373095*alphaR[0]*fR[5]+(2.449489742783178*fR[3]-1.414213562373095*fR[0])*alphaR[4]-1.414213562373095*(alphaR[1]*fR[2]+fR[1]*alphaR[2])); 
  incr[6] = 0.125*(4.242640687119286*(alphaR[6]*fR[15]+alphaR[7]*fR[14]+alphaR[3]*fR[13])-2.449489742783178*alphaR[6]*fR[12]+4.242640687119286*(alphaR[2]*fR[11]+alphaR[5]*fR[10])-2.449489742783178*(alphaR[7]*fR[9]+alphaR[3]*fR[8])+4.242640687119286*(alphaR[4]*fR[7]+alphaR[0]*fR[6])-2.449489742783178*(alphaR[2]*fR[5]+fR[4]*alphaR[5]+fR[2]*alphaR[4])+4.242640687119286*alphaR[1]*fR[3]-2.449489742783178*(alphaR[0]*fR[1]+fR[0]*alphaR[1])); 
  incr[7] = 0.125*(4.242640687119286*(alphaR[5]*fR[15]+alphaR[3]*fR[14]+alphaR[7]*fR[13])-2.449489742783178*alphaR[5]*fR[12]+4.242640687119286*(alphaR[1]*fR[11]+alphaR[6]*fR[10])-2.449489742783178*(alphaR[3]*fR[9]+alphaR[7]*fR[8])+4.242640687119286*(alphaR[0]*fR[7]+alphaR[4]*fR[6])-2.449489742783178*(fR[4]*alphaR[6]+alphaR[1]*fR[5]+fR[1]*alphaR[4])+4.242640687119286*alphaR[2]*fR[3]-2.449489742783178*(alphaR[0]*fR[2]+fR[0]*alphaR[2])); 
  incr[8] = -0.125*(2.449489742783178*(alphaR[2]*fR[15]+alphaR[4]*fR[14]+alphaR[0]*fR[13])-1.414213562373095*alphaR[2]*fR[12]+2.449489742783178*(alphaR[6]*fR[11]+alphaR[1]*fR[10])-1.414213562373095*(alphaR[4]*fR[9]+alphaR[0]*fR[8])+alphaR[7]*(2.449489742783178*fR[7]-1.414213562373095*fR[2])+2.449489742783178*alphaR[3]*fR[6]-1.414213562373095*fR[5]*alphaR[6]+(2.449489742783178*fR[3]-1.414213562373095*fR[0])*alphaR[5]-1.414213562373095*(alphaR[1]*fR[4]+fR[1]*alphaR[3])); 
  incr[9] = -0.125*(2.449489742783178*(alphaR[1]*fR[15]+alphaR[0]*fR[14]+alphaR[4]*fR[13])-1.414213562373095*alphaR[1]*fR[12]+2.449489742783178*(alphaR[5]*fR[11]+alphaR[2]*fR[10])-1.414213562373095*(alphaR[0]*fR[9]+alphaR[4]*fR[8])+2.449489742783178*alphaR[3]*fR[7]+(2.449489742783178*fR[6]-1.414213562373095*fR[1])*alphaR[7]+(2.449489742783178*fR[3]-1.414213562373095*fR[0])*alphaR[6]-1.414213562373095*(alphaR[5]*fR[5]+alphaR[2]*fR[4]+fR[2]*alphaR[3])); 
  incr[10] = 0.125*(4.242640687119286*(alphaR[4]*fR[15]+alphaR[2]*fR[14]+alphaR[1]*fR[13])-2.449489742783178*alphaR[4]*fR[12]+4.242640687119286*(alphaR[7]*fR[11]+alphaR[0]*fR[10])-2.449489742783178*(alphaR[2]*fR[9]+alphaR[1]*fR[8])+4.242640687119286*alphaR[6]*fR[7]-2.449489742783178*fR[5]*alphaR[7]+4.242640687119286*alphaR[5]*fR[6]-2.449489742783178*(fR[2]*alphaR[6]+fR[1]*alphaR[5]+alphaR[0]*fR[4])+alphaR[3]*(4.242640687119286*fR[3]-2.449489742783178*fR[0])); 
  incr[11] = 0.125*(4.242640687119286*(alphaR[3]*fR[15]+alphaR[5]*fR[14]+alphaR[6]*fR[13])-2.449489742783178*alphaR[3]*fR[12]+4.242640687119286*(alphaR[0]*fR[11]+alphaR[7]*fR[10])-2.449489742783178*(alphaR[5]*fR[9]+alphaR[6]*fR[8])+4.242640687119286*alphaR[1]*fR[7]-2.449489742783178*fR[4]*alphaR[7]+4.242640687119286*alphaR[2]*fR[6]-2.449489742783178*alphaR[0]*fR[5]+(4.242640687119286*fR[3]-2.449489742783178*fR[0])*alphaR[4]-2.449489742783178*(alphaR[1]*fR[2]+fR[1]*alphaR[2])); 
  incr[12] = -0.125*(2.449489742783178*(alphaR[0]*fR[15]+alphaR[1]*fR[14]+alphaR[2]*fR[13])-1.414213562373095*alphaR[0]*fR[12]+2.449489742783178*(alphaR[3]*fR[11]+alphaR[4]*fR[10])-1.414213562373095*(alphaR[1]*fR[9]+alphaR[2]*fR[8])+2.449489742783178*alphaR[5]*fR[7]+(2.449489742783178*fR[3]-1.414213562373095*fR[0])*alphaR[7]+2.449489742783178*alphaR[6]*fR[6]-1.414213562373095*(fR[1]*alphaR[6]+alphaR[3]*fR[5]+fR[2]*alphaR[5]+alphaR[4]*fR[4])); 
  incr[13] = 0.125*(4.242640687119286*(alphaR[2]*fR[15]+alphaR[4]*fR[14]+alphaR[0]*fR[13])-2.449489742783178*alphaR[2]*fR[12]+4.242640687119286*(alphaR[6]*fR[11]+alphaR[1]*fR[10])-2.449489742783178*(alphaR[4]*fR[9]+alphaR[0]*fR[8])+alphaR[7]*(4.242640687119286*fR[7]-2.449489742783178*fR[2])+4.242640687119286*alphaR[3]*fR[6]-2.449489742783178*fR[5]*alphaR[6]+(4.242640687119286*fR[3]-2.449489742783178*fR[0])*alphaR[5]-2.449489742783178*(alphaR[1]*fR[4]+fR[1]*alphaR[3])); 
  incr[14] = 0.125*(4.242640687119286*(alphaR[1]*fR[15]+alphaR[0]*fR[14]+alphaR[4]*fR[13])-2.449489742783178*alphaR[1]*fR[12]+4.242640687119286*(alphaR[5]*fR[11]+alphaR[2]*fR[10])-2.449489742783178*(alphaR[0]*fR[9]+alphaR[4]*fR[8])+4.242640687119286*alphaR[3]*fR[7]+(4.242640687119286*fR[6]-2.449489742783178*fR[1])*alphaR[7]+(4.242640687119286*fR[3]-2.449489742783178*fR[0])*alphaR[6]-2.449489742783178*(alphaR[5]*fR[5]+alphaR[2]*fR[4]+fR[2]*alphaR[3])); 
  incr[15] = 0.125*(4.242640687119286*(alphaR[0]*fR[15]+alphaR[1]*fR[14]+alphaR[2]*fR[13])-2.449489742783178*alphaR[0]*fR[12]+4.242640687119286*(alphaR[3]*fR[11]+alphaR[4]*fR[10])-2.449489742783178*(alphaR[1]*fR[9]+alphaR[2]*fR[8])+4.242640687119286*alphaR[5]*fR[7]+(4.242640687119286*fR[3]-2.449489742783178*fR[0])*alphaR[7]+4.242640687119286*alphaR[6]*fR[6]-2.449489742783178*(fR[1]*alphaR[6]+alphaR[3]*fR[5]+fR[2]*alphaR[5]+alphaR[4]*fR[4])); 
  }
#elif upwindType == QUAD 
  double alphaOrdR;
  double fUpOrd[8];
  alphaOrdR = (-0.3535533905932737*alphaUpR[7])+0.3535533905932737*(alphaUpR[6]+alphaUpR[5]+alphaUpR[4])-0.3535533905932737*(alphaUpR[3]+alphaUpR[2]+alphaUpR[1])+0.3535533905932737*alphaUpR[0]; 
  fUpOrd[0] = 0.5*(((-0.4330127018922193*(fR[15]+fL[15]))+0.4330127018922193*(fR[14]+fL[14]+fR[13]+fL[13])+0.25*fR[12]-0.25*fL[12]+0.4330127018922193*(fR[11]+fL[11])-0.4330127018922193*(fR[10]+fL[10])-0.25*(fR[9]+fR[8])+0.25*(fL[9]+fL[8])-0.4330127018922193*(fR[7]+fL[7]+fR[6]+fL[6])-0.25*fR[5]+0.25*(fL[5]+fR[4])-0.25*fL[4]+0.4330127018922193*(fR[3]+fL[3])+0.25*(fR[2]+fR[1])-0.25*(fL[2]+fL[1]+fR[0])+0.25*fL[0])*sgn(alphaOrdR)+0.4330127018922193*fR[15]-0.4330127018922193*(fL[15]+fR[14]+fR[13])+0.4330127018922193*(fL[14]+fL[13])-0.25*(fR[12]+fL[12])-0.4330127018922193*fR[11]+0.4330127018922193*(fL[11]+fR[10])-0.4330127018922193*fL[10]+0.25*(fR[9]+fL[9]+fR[8]+fL[8])+0.4330127018922193*(fR[7]+fR[6])-0.4330127018922193*(fL[7]+fL[6])+0.25*(fR[5]+fL[5])-0.25*(fR[4]+fL[4])-0.4330127018922193*fR[3]+0.4330127018922193*fL[3]-0.25*(fR[2]+fL[2]+fR[1]+fL[1])+0.25*(fR[0]+fL[0])); 
  alphaOrdR = 0.3535533905932737*(alphaUpR[7]+alphaUpR[6])-0.3535533905932737*(alphaUpR[5]+alphaUpR[4]+alphaUpR[3]+alphaUpR[2])+0.3535533905932737*(alphaUpR[1]+alphaUpR[0]); 
  fUpOrd[1] = 0.5*((0.4330127018922193*(fR[15]+fL[15]+fR[14]+fL[14])-0.4330127018922193*(fR[13]+fL[13])-0.25*fR[12]+0.25*fL[12]-0.4330127018922193*(fR[11]+fL[11]+fR[10]+fL[10])-0.25*fR[9]+0.25*(fL[9]+fR[8])-0.25*fL[8]-0.4330127018922193*(fR[7]+fL[7])+0.4330127018922193*(fR[6]+fL[6])+0.25*(fR[5]+fR[4])-0.25*(fL[5]+fL[4])+0.4330127018922193*(fR[3]+fL[3])+0.25*fR[2]-0.25*(fL[2]+fR[1]+fR[0])+0.25*(fL[1]+fL[0]))*sgn(alphaOrdR)-0.4330127018922193*(fR[15]+fR[14])+0.4330127018922193*(fL[15]+fL[14]+fR[13])-0.4330127018922193*fL[13]+0.25*(fR[12]+fL[12])+0.4330127018922193*(fR[11]+fR[10])-0.4330127018922193*(fL[11]+fL[10])+0.25*(fR[9]+fL[9])-0.25*(fR[8]+fL[8])+0.4330127018922193*fR[7]-0.4330127018922193*(fL[7]+fR[6])+0.4330127018922193*fL[6]-0.25*(fR[5]+fL[5]+fR[4]+fL[4])-0.4330127018922193*fR[3]+0.4330127018922193*fL[3]-0.25*(fR[2]+fL[2])+0.25*(fR[1]+fL[1]+fR[0]+fL[0])); 
  alphaOrdR = 0.3535533905932737*alphaUpR[7]-0.3535533905932737*alphaUpR[6]+0.3535533905932737*alphaUpR[5]-0.3535533905932737*(alphaUpR[4]+alphaUpR[3])+0.3535533905932737*alphaUpR[2]-0.3535533905932737*alphaUpR[1]+0.3535533905932737*alphaUpR[0]; 
  fUpOrd[2] = 0.5*((0.4330127018922193*(fR[15]+fL[15])-0.4330127018922193*(fR[14]+fL[14])+0.4330127018922193*(fR[13]+fL[13])-0.25*fR[12]+0.25*fL[12]-0.4330127018922193*(fR[11]+fL[11]+fR[10]+fL[10])+0.25*fR[9]-0.25*(fL[9]+fR[8])+0.25*fL[8]+0.4330127018922193*(fR[7]+fL[7])-0.4330127018922193*(fR[6]+fL[6])+0.25*(fR[5]+fR[4])-0.25*(fL[5]+fL[4])+0.4330127018922193*(fR[3]+fL[3])-0.25*fR[2]+0.25*(fL[2]+fR[1])-0.25*(fL[1]+fR[0])+0.25*fL[0])*sgn(alphaOrdR)-0.4330127018922193*fR[15]+0.4330127018922193*(fL[15]+fR[14])-0.4330127018922193*(fL[14]+fR[13])+0.4330127018922193*fL[13]+0.25*(fR[12]+fL[12])+0.4330127018922193*(fR[11]+fR[10])-0.4330127018922193*(fL[11]+fL[10])-0.25*(fR[9]+fL[9])+0.25*(fR[8]+fL[8])-0.4330127018922193*fR[7]+0.4330127018922193*(fL[7]+fR[6])-0.4330127018922193*fL[6]-0.25*(fR[5]+fL[5]+fR[4]+fL[4])-0.4330127018922193*fR[3]+0.4330127018922193*fL[3]+0.25*(fR[2]+fL[2])-0.25*(fR[1]+fL[1])+0.25*(fR[0]+fL[0])); 
  alphaOrdR = (-0.3535533905932737*(alphaUpR[7]+alphaUpR[6]+alphaUpR[5]))+0.3535533905932737*alphaUpR[4]-0.3535533905932737*alphaUpR[3]+0.3535533905932737*(alphaUpR[2]+alphaUpR[1]+alphaUpR[0]); 
  fUpOrd[3] = 0.5*(((-0.4330127018922193*(fR[15]+fL[15]+fR[14]+fL[14]+fR[13]+fL[13]))+0.25*fR[12]-0.25*fL[12]+0.4330127018922193*(fR[11]+fL[11])-0.4330127018922193*(fR[10]+fL[10])+0.25*(fR[9]+fR[8])-0.25*(fL[9]+fL[8])+0.4330127018922193*(fR[7]+fL[7]+fR[6]+fL[6])-0.25*fR[5]+0.25*(fL[5]+fR[4])-0.25*fL[4]+0.4330127018922193*(fR[3]+fL[3])-0.25*(fR[2]+fR[1]+fR[0])+0.25*(fL[2]+fL[1]+fL[0]))*sgn(alphaOrdR)+0.4330127018922193*(fR[15]+fR[14]+fR[13])-0.4330127018922193*(fL[15]+fL[14]+fL[13])-0.25*(fR[12]+fL[12])-0.4330127018922193*fR[11]+0.4330127018922193*(fL[11]+fR[10])-0.4330127018922193*fL[10]-0.25*(fR[9]+fL[9]+fR[8]+fL[8])-0.4330127018922193*(fR[7]+fR[6])+0.4330127018922193*(fL[7]+fL[6])+0.25*(fR[5]+fL[5])-0.25*(fR[4]+fL[4])-0.4330127018922193*fR[3]+0.4330127018922193*fL[3]+0.25*(fR[2]+fL[2]+fR[1]+fL[1]+fR[0]+fL[0])); 
  alphaOrdR = 0.3535533905932737*alphaUpR[7]-0.3535533905932737*(alphaUpR[6]+alphaUpR[5])+0.3535533905932737*(alphaUpR[4]+alphaUpR[3])-0.3535533905932737*(alphaUpR[2]+alphaUpR[1])+0.3535533905932737*alphaUpR[0]; 
  fUpOrd[4] = 0.5*((0.4330127018922193*(fR[15]+fL[15])-0.4330127018922193*(fR[14]+fL[14]+fR[13]+fL[13])-0.25*fR[12]+0.25*fL[12]+0.4330127018922193*(fR[11]+fL[11]+fR[10]+fL[10])+0.25*(fR[9]+fR[8])-0.25*(fL[9]+fL[8])-0.4330127018922193*(fR[7]+fL[7]+fR[6]+fL[6])-0.25*(fR[5]+fR[4])+0.25*(fL[5]+fL[4])+0.4330127018922193*(fR[3]+fL[3])+0.25*(fR[2]+fR[1])-0.25*(fL[2]+fL[1]+fR[0])+0.25*fL[0])*sgn(alphaOrdR)-0.4330127018922193*fR[15]+0.4330127018922193*(fL[15]+fR[14]+fR[13])-0.4330127018922193*(fL[14]+fL[13])+0.25*(fR[12]+fL[12])-0.4330127018922193*(fR[11]+fR[10])+0.4330127018922193*(fL[11]+fL[10])-0.25*(fR[9]+fL[9]+fR[8]+fL[8])+0.4330127018922193*(fR[7]+fR[6])-0.4330127018922193*(fL[7]+fL[6])+0.25*(fR[5]+fL[5]+fR[4]+fL[4])-0.4330127018922193*fR[3]+0.4330127018922193*fL[3]-0.25*(fR[2]+fL[2]+fR[1]+fL[1])+0.25*(fR[0]+fL[0])); 
  alphaOrdR = (-0.3535533905932737*(alphaUpR[7]+alphaUpR[6]))+0.3535533905932737*alphaUpR[5]-0.3535533905932737*alphaUpR[4]+0.3535533905932737*alphaUpR[3]-0.3535533905932737*alphaUpR[2]+0.3535533905932737*(alphaUpR[1]+alphaUpR[0]); 
  fUpOrd[5] = 0.5*(((-0.4330127018922193*(fR[15]+fL[15]+fR[14]+fL[14]))+0.4330127018922193*(fR[13]+fL[13])+0.25*fR[12]-0.25*fL[12]-0.4330127018922193*(fR[11]+fL[11])+0.4330127018922193*(fR[10]+fL[10])+0.25*fR[9]-0.25*(fL[9]+fR[8])+0.25*fL[8]-0.4330127018922193*(fR[7]+fL[7])+0.4330127018922193*(fR[6]+fL[6])+0.25*fR[5]-0.25*(fL[5]+fR[4])+0.25*fL[4]+0.4330127018922193*(fR[3]+fL[3])+0.25*fR[2]-0.25*(fL[2]+fR[1]+fR[0])+0.25*(fL[1]+fL[0]))*sgn(alphaOrdR)+0.4330127018922193*(fR[15]+fR[14])-0.4330127018922193*(fL[15]+fL[14]+fR[13])+0.4330127018922193*fL[13]-0.25*(fR[12]+fL[12])+0.4330127018922193*fR[11]-0.4330127018922193*(fL[11]+fR[10])+0.4330127018922193*fL[10]-0.25*(fR[9]+fL[9])+0.25*(fR[8]+fL[8])+0.4330127018922193*fR[7]-0.4330127018922193*(fL[7]+fR[6])+0.4330127018922193*fL[6]-0.25*(fR[5]+fL[5])+0.25*(fR[4]+fL[4])-0.4330127018922193*fR[3]+0.4330127018922193*fL[3]-0.25*(fR[2]+fL[2])+0.25*(fR[1]+fL[1]+fR[0]+fL[0])); 
  alphaOrdR = (-0.3535533905932737*alphaUpR[7])+0.3535533905932737*alphaUpR[6]-0.3535533905932737*(alphaUpR[5]+alphaUpR[4])+0.3535533905932737*(alphaUpR[3]+alphaUpR[2])-0.3535533905932737*alphaUpR[1]+0.3535533905932737*alphaUpR[0]; 
  fUpOrd[6] = 0.5*(((-0.4330127018922193*(fR[15]+fL[15]))+0.4330127018922193*(fR[14]+fL[14])-0.4330127018922193*(fR[13]+fL[13])+0.25*fR[12]-0.25*fL[12]-0.4330127018922193*(fR[11]+fL[11])+0.4330127018922193*(fR[10]+fL[10])-0.25*fR[9]+0.25*(fL[9]+fR[8])-0.25*fL[8]+0.4330127018922193*(fR[7]+fL[7])-0.4330127018922193*(fR[6]+fL[6])+0.25*fR[5]-0.25*(fL[5]+fR[4])+0.25*fL[4]+0.4330127018922193*(fR[3]+fL[3])-0.25*fR[2]+0.25*(fL[2]+fR[1])-0.25*(fL[1]+fR[0])+0.25*fL[0])*sgn(alphaOrdR)+0.4330127018922193*fR[15]-0.4330127018922193*(fL[15]+fR[14])+0.4330127018922193*(fL[14]+fR[13])-0.4330127018922193*fL[13]-0.25*(fR[12]+fL[12])+0.4330127018922193*fR[11]-0.4330127018922193*(fL[11]+fR[10])+0.4330127018922193*fL[10]+0.25*(fR[9]+fL[9])-0.25*(fR[8]+fL[8])-0.4330127018922193*fR[7]+0.4330127018922193*(fL[7]+fR[6])-0.4330127018922193*fL[6]-0.25*(fR[5]+fL[5])+0.25*(fR[4]+fL[4])-0.4330127018922193*fR[3]+0.4330127018922193*fL[3]+0.25*(fR[2]+fL[2])-0.25*(fR[1]+fL[1])+0.25*(fR[0]+fL[0])); 
  alphaOrdR = 0.3535533905932737*(alphaUpR[7]+alphaUpR[6]+alphaUpR[5]+alphaUpR[4]+alphaUpR[3]+alphaUpR[2]+alphaUpR[1]+alphaUpR[0]); 
  fUpOrd[7] = 0.5*((0.4330127018922193*(fR[15]+fL[15]+fR[14]+fL[14]+fR[13]+fL[13])-0.25*fR[12]+0.25*fL[12]+0.4330127018922193*(fR[11]+fL[11]+fR[10]+fL[10])-0.25*(fR[9]+fR[8])+0.25*(fL[9]+fL[8])+0.4330127018922193*(fR[7]+fL[7]+fR[6]+fL[6])-0.25*(fR[5]+fR[4])+0.25*(fL[5]+fL[4])+0.4330127018922193*(fR[3]+fL[3])-0.25*(fR[2]+fR[1]+fR[0])+0.25*(fL[2]+fL[1]+fL[0]))*sgn(alphaOrdR)-0.4330127018922193*(fR[15]+fR[14]+fR[13])+0.4330127018922193*(fL[15]+fL[14]+fL[13])+0.25*(fR[12]+fL[12])-0.4330127018922193*(fR[11]+fR[10])+0.4330127018922193*(fL[11]+fL[10])+0.25*(fR[9]+fL[9]+fR[8]+fL[8])-0.4330127018922193*(fR[7]+fR[6])+0.4330127018922193*(fL[7]+fL[6])+0.25*(fR[5]+fL[5]+fR[4]+fL[4])-0.4330127018922193*fR[3]+0.4330127018922193*fL[3]+0.25*(fR[2]+fL[2]+fR[1]+fL[1]+fR[0]+fL[0])); 
  ...
  incr[0] = 0.25*(alphaR[7]*fUp[7]+alphaR[6]*fUp[6]+alphaR[5]*fUp[5]+alphaR[4]*fUp[4]+alphaR[3]*fUp[3]+alphaR[2]*fUp[2]+alphaR[1]*fUp[1]+alphaR[0]*fUp[0]); 
  incr[1] = 0.25*(alphaR[6]*fUp[7]+fUp[6]*alphaR[7]+alphaR[3]*fUp[5]+fUp[3]*alphaR[5]+alphaR[2]*fUp[4]+fUp[2]*alphaR[4]+alphaR[0]*fUp[1]+fUp[0]*alphaR[1]); 
  incr[2] = 0.25*(alphaR[5]*fUp[7]+fUp[5]*alphaR[7]+alphaR[3]*fUp[6]+fUp[3]*alphaR[6]+alphaR[1]*fUp[4]+fUp[1]*alphaR[4]+alphaR[0]*fUp[2]+fUp[0]*alphaR[2]); 
  incr[3] = -0.4330127018922193*(alphaR[7]*fUp[7]+alphaR[6]*fUp[6]+alphaR[5]*fUp[5]+alphaR[4]*fUp[4]+alphaR[3]*fUp[3]+alphaR[2]*fUp[2]+alphaR[1]*fUp[1]+alphaR[0]*fUp[0]); 
  incr[4] = 0.25*(alphaR[4]*fUp[7]+fUp[4]*alphaR[7]+alphaR[2]*fUp[6]+fUp[2]*alphaR[6]+alphaR[1]*fUp[5]+fUp[1]*alphaR[5]+alphaR[0]*fUp[3]+fUp[0]*alphaR[3]); 
  incr[5] = 0.25*(alphaR[3]*fUp[7]+fUp[3]*alphaR[7]+alphaR[5]*fUp[6]+fUp[5]*alphaR[6]+alphaR[0]*fUp[4]+fUp[0]*alphaR[4]+alphaR[1]*fUp[2]+fUp[1]*alphaR[2]); 
  incr[6] = -0.4330127018922193*(alphaR[6]*fUp[7]+fUp[6]*alphaR[7]+alphaR[3]*fUp[5]+fUp[3]*alphaR[5]+alphaR[2]*fUp[4]+fUp[2]*alphaR[4]+alphaR[0]*fUp[1]+fUp[0]*alphaR[1]); 
  incr[7] = -0.4330127018922193*(alphaR[5]*fUp[7]+fUp[5]*alphaR[7]+alphaR[3]*fUp[6]+fUp[3]*alphaR[6]+alphaR[1]*fUp[4]+fUp[1]*alphaR[4]+alphaR[0]*fUp[2]+fUp[0]*alphaR[2]); 
  incr[8] = 0.25*(alphaR[2]*fUp[7]+fUp[2]*alphaR[7]+alphaR[4]*fUp[6]+fUp[4]*alphaR[6]+alphaR[0]*fUp[5]+fUp[0]*alphaR[5]+alphaR[1]*fUp[3]+fUp[1]*alphaR[3]); 
  incr[9] = 0.25*(alphaR[1]*fUp[7]+fUp[1]*alphaR[7]+alphaR[0]*fUp[6]+fUp[0]*alphaR[6]+alphaR[4]*fUp[5]+fUp[4]*alphaR[5]+alphaR[2]*fUp[3]+fUp[2]*alphaR[3]); 
  incr[10] = -0.4330127018922193*(alphaR[4]*fUp[7]+fUp[4]*alphaR[7]+alphaR[2]*fUp[6]+fUp[2]*alphaR[6]+alphaR[1]*fUp[5]+fUp[1]*alphaR[5]+alphaR[0]*fUp[3]+fUp[0]*alphaR[3]); 
  incr[11] = -0.4330127018922193*(alphaR[3]*fUp[7]+fUp[3]*alphaR[7]+alphaR[5]*fUp[6]+fUp[5]*alphaR[6]+alphaR[0]*fUp[4]+fUp[0]*alphaR[4]+alphaR[1]*fUp[2]+fUp[1]*alphaR[2]); 
  incr[12] = 0.25*(alphaR[0]*fUp[7]+fUp[0]*alphaR[7]+alphaR[1]*fUp[6]+fUp[1]*alphaR[6]+alphaR[2]*fUp[5]+fUp[2]*alphaR[5]+alphaR[3]*fUp[4]+fUp[3]*alphaR[4]); 
  incr[13] = -0.4330127018922193*(alphaR[2]*fUp[7]+fUp[2]*alphaR[7]+alphaR[4]*fUp[6]+fUp[4]*alphaR[6]+alphaR[0]*fUp[5]+fUp[0]*alphaR[5]+alphaR[1]*fUp[3]+fUp[1]*alphaR[3]); 
  incr[14] = -0.4330127018922193*(alphaR[1]*fUp[7]+fUp[1]*alphaR[7]+alphaR[0]*fUp[6]+fUp[0]*alphaR[6]+alphaR[4]*fUp[5]+fUp[4]*alphaR[5]+alphaR[2]*fUp[3]+fUp[2]*alphaR[3]); 
  incr[15] = -0.4330127018922193*(alphaR[0]*fUp[7]+fUp[0]*alphaR[7]+alphaR[1]*fUp[6]+fUp[1]*alphaR[6]+alphaR[2]*fUp[5]+fUp[2]*alphaR[5]+alphaR[3]*fUp[4]+fUp[3]*alphaR[4]); 
...
double EmGyrokineticSimpleHelicalSurf2x2vSerStep2_vpar_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *gradPar, const double *BdriftX, const double *BdriftY, const double *phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // q_,m_: species charge and mass.
  // cflL,cflR: CFL rate in left and right cells.
  // wL[NDIM],wR[NDIM]: cell-center in left and right cells.
