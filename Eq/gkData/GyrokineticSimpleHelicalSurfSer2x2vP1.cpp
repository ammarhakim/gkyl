...
{ 
  ...
  double alphaL[8]; 
  alphaL[0] = -(0.125*(bmagInv[0]*(8.485281374238571*hamilL[5]+4.898979485566357*hamilL[2])*m_*rdy2L-2.449489742783178*BstarXdBmagL[0]*hamilL[3]*q_*rdvpar2L))/(m_*q_); 
  alphaL[2] = (0.3061862178478971*BstarXdBmagL[3]*hamilL[3]*rdvpar2L)/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgL = -(0.03125*((6.0*bmagInv[0]*hamilL[5]+3.464101615137754*bmagInv[0]*hamilL[2])*m_*rdy2L-1.732050807568877*BstarXdBmagL[0]*hamilL[3]*q_*rdvpar2L))/(m_*q_); 

  double incr[16]; 
#if upwindType == SURFAVG 
  if (alphaSurfAvgL>0) { 
  incr[0] = 0.125*(alphaL[2]*(2.449489742783178*fL[6]+1.414213562373095*fL[3])+alphaL[0]*(2.449489742783178*fL[1]+1.414213562373095*fL[0])); 
  incr[1] = -0.125*(alphaL[2]*(4.242640687119286*fL[6]+2.449489742783178*fL[3])+alphaL[0]*(4.242640687119286*fL[1]+2.449489742783178*fL[0])); 
  incr[2] = 0.125*(alphaL[2]*(2.449489742783178*fL[11]+1.414213562373095*fL[7])+alphaL[0]*(2.449489742783178*fL[5]+1.414213562373095*fL[2])); 
  incr[3] = 0.125*(alphaL[0]*(2.449489742783178*fL[6]+1.414213562373095*fL[3])+(2.449489742783178*fL[1]+1.414213562373095*fL[0])*alphaL[2]); 
  incr[4] = 0.125*(alphaL[2]*(2.449489742783178*fL[13]+1.414213562373095*fL[10])+alphaL[0]*(2.449489742783178*fL[8]+1.414213562373095*fL[4])); 
  incr[5] = -0.125*(alphaL[2]*(4.242640687119286*fL[11]+2.449489742783178*fL[7])+alphaL[0]*(4.242640687119286*fL[5]+2.449489742783178*fL[2])); 
  incr[6] = -0.125*(alphaL[0]*(4.242640687119286*fL[6]+2.449489742783178*fL[3])+(4.242640687119286*fL[1]+2.449489742783178*fL[0])*alphaL[2]); 
  incr[7] = 0.125*(alphaL[0]*(2.449489742783178*fL[11]+1.414213562373095*fL[7])+alphaL[2]*(2.449489742783178*fL[5]+1.414213562373095*fL[2])); 
  incr[8] = -0.125*(alphaL[2]*(4.242640687119286*fL[13]+2.449489742783178*fL[10])+alphaL[0]*(4.242640687119286*fL[8]+2.449489742783178*fL[4])); 
  incr[9] = 0.125*(alphaL[2]*(2.449489742783178*fL[15]+1.414213562373095*fL[14])+alphaL[0]*(2.449489742783178*fL[12]+1.414213562373095*fL[9])); 
  incr[10] = 0.125*(alphaL[0]*(2.449489742783178*fL[13]+1.414213562373095*fL[10])+alphaL[2]*(2.449489742783178*fL[8]+1.414213562373095*fL[4])); 
  incr[11] = -0.125*(alphaL[0]*(4.242640687119286*fL[11]+2.449489742783178*fL[7])+alphaL[2]*(4.242640687119286*fL[5]+2.449489742783178*fL[2])); 
  incr[12] = -0.125*(alphaL[2]*(4.242640687119286*fL[15]+2.449489742783178*fL[14])+alphaL[0]*(4.242640687119286*fL[12]+2.449489742783178*fL[9])); 
  incr[13] = -0.125*(alphaL[0]*(4.242640687119286*fL[13]+2.449489742783178*fL[10])+alphaL[2]*(4.242640687119286*fL[8]+2.449489742783178*fL[4])); 
  incr[14] = 0.125*(alphaL[0]*(2.449489742783178*fL[15]+1.414213562373095*fL[14])+alphaL[2]*(2.449489742783178*fL[12]+1.414213562373095*fL[9])); 
  incr[15] = -0.125*(alphaL[0]*(4.242640687119286*fL[15]+2.449489742783178*fL[14])+alphaL[2]*(4.242640687119286*fL[12]+2.449489742783178*fL[9])); 
  } else { 
  incr[0] = -0.125*(alphaL[2]*(2.449489742783178*fR[6]-1.414213562373095*fR[3])+alphaL[0]*(2.449489742783178*fR[1]-1.414213562373095*fR[0])); 
  incr[1] = 0.125*(alphaL[2]*(4.242640687119286*fR[6]-2.449489742783178*fR[3])+alphaL[0]*(4.242640687119286*fR[1]-2.449489742783178*fR[0])); 
  incr[2] = -0.125*(alphaL[2]*(2.449489742783178*fR[11]-1.414213562373095*fR[7])+alphaL[0]*(2.449489742783178*fR[5]-1.414213562373095*fR[2])); 
  incr[3] = -0.125*(alphaL[0]*(2.449489742783178*fR[6]-1.414213562373095*fR[3])+(2.449489742783178*fR[1]-1.414213562373095*fR[0])*alphaL[2]); 
  incr[4] = -0.125*(alphaL[2]*(2.449489742783178*fR[13]-1.414213562373095*fR[10])+alphaL[0]*(2.449489742783178*fR[8]-1.414213562373095*fR[4])); 
  incr[5] = 0.125*(alphaL[2]*(4.242640687119286*fR[11]-2.449489742783178*fR[7])+alphaL[0]*(4.242640687119286*fR[5]-2.449489742783178*fR[2])); 
  incr[6] = 0.125*(alphaL[0]*(4.242640687119286*fR[6]-2.449489742783178*fR[3])+(4.242640687119286*fR[1]-2.449489742783178*fR[0])*alphaL[2]); 
  incr[7] = -0.125*(alphaL[0]*(2.449489742783178*fR[11]-1.414213562373095*fR[7])+alphaL[2]*(2.449489742783178*fR[5]-1.414213562373095*fR[2])); 
  incr[8] = 0.125*(alphaL[2]*(4.242640687119286*fR[13]-2.449489742783178*fR[10])+alphaL[0]*(4.242640687119286*fR[8]-2.449489742783178*fR[4])); 
  incr[9] = -0.125*(alphaL[2]*(2.449489742783178*fR[15]-1.414213562373095*fR[14])+alphaL[0]*(2.449489742783178*fR[12]-1.414213562373095*fR[9])); 
  incr[10] = -0.125*(alphaL[0]*(2.449489742783178*fR[13]-1.414213562373095*fR[10])+alphaL[2]*(2.449489742783178*fR[8]-1.414213562373095*fR[4])); 
  incr[11] = 0.125*(alphaL[0]*(4.242640687119286*fR[11]-2.449489742783178*fR[7])+alphaL[2]*(4.242640687119286*fR[5]-2.449489742783178*fR[2])); 
  incr[12] = 0.125*(alphaL[2]*(4.242640687119286*fR[15]-2.449489742783178*fR[14])+alphaL[0]*(4.242640687119286*fR[12]-2.449489742783178*fR[9])); 
  incr[13] = 0.125*(alphaL[0]*(4.242640687119286*fR[13]-2.449489742783178*fR[10])+alphaL[2]*(4.242640687119286*fR[8]-2.449489742783178*fR[4])); 
  incr[14] = -0.125*(alphaL[0]*(2.449489742783178*fR[15]-1.414213562373095*fR[14])+alphaL[2]*(2.449489742783178*fR[12]-1.414213562373095*fR[9])); 
  incr[15] = 0.125*(alphaL[0]*(4.242640687119286*fR[15]-2.449489742783178*fR[14])+alphaL[2]*(4.242640687119286*fR[12]-2.449489742783178*fR[9])); 
  }
#elif upwindType == QUAD 
  double alphaOrdL;
  double fUpOrd[8];
  alphaOrdL = 0.3535533905932737*alphaL[0]-0.3535533905932737*alphaL[2]; 
  ...
  alphaOrdL = 0.3535533905932737*(alphaL[2]+alphaL[0]); 
  ...
  incr[0] = 0.25*(alphaL[2]*fUp[2]+alphaL[0]*fUp[0]); 
  incr[1] = -0.4330127018922193*(alphaL[2]*fUp[2]+alphaL[0]*fUp[0]); 
  incr[2] = 0.25*(alphaL[2]*fUp[4]+alphaL[0]*fUp[1]); 
  incr[3] = 0.25*(alphaL[0]*fUp[2]+fUp[0]*alphaL[2]); 
  incr[4] = 0.25*(alphaL[2]*fUp[6]+alphaL[0]*fUp[3]); 
  incr[5] = -0.4330127018922193*(alphaL[2]*fUp[4]+alphaL[0]*fUp[1]); 
  incr[6] = -0.4330127018922193*(alphaL[0]*fUp[2]+fUp[0]*alphaL[2]); 
  incr[7] = 0.25*(alphaL[0]*fUp[4]+fUp[1]*alphaL[2]); 
  incr[8] = -0.4330127018922193*(alphaL[2]*fUp[6]+alphaL[0]*fUp[3]); 
  incr[9] = 0.25*(alphaL[2]*fUp[7]+alphaL[0]*fUp[5]); 
  incr[10] = 0.25*(alphaL[0]*fUp[6]+alphaL[2]*fUp[3]); 
  incr[11] = -0.4330127018922193*(alphaL[0]*fUp[4]+fUp[1]*alphaL[2]); 
  incr[12] = -0.4330127018922193*(alphaL[2]*fUp[7]+alphaL[0]*fUp[5]); 
  incr[13] = -0.4330127018922193*(alphaL[0]*fUp[6]+alphaL[2]*fUp[3]); 
  incr[14] = 0.25*(alphaL[0]*fUp[7]+alphaL[2]*fUp[5]); 
  incr[15] = -0.4330127018922193*(alphaL[0]*fUp[7]+alphaL[2]*fUp[5]); 
...
double GyrokineticSimpleHelicalSurf2x2vSer_xR_P1_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *cmag, const double *BdriftX, const double *BdriftY, const double *phi, const double *fL, const double *fR, double *outL, double *outR) 
{ 
  // bmagInv: 1/bmag.
  // BdriftX,BdriftY: x,y components of gradB/curvature drift.
  // q_,m_: species charge and mass.
...
double GyrokineticSimpleHelicalSurf2x2vSer_yL_P1_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *cmag, const double *BdriftX, const double *BdriftY, const double *phi, const double *fL, const double *fR, double *outL, double *outR) 
{ 
  // bmagInv: 1/bmag.
  // BdriftX,BdriftY: x,y components of gradB/curvature drift.
  // q_,m_: species charge and mass.
  ...
  double alphaL[8]; 
  alphaL[0] = (0.125*(bmagInv[0]*(8.485281374238571*hamilL[5]+4.898979485566357*hamilL[1])*m_*rdx2L+2.449489742783178*BstarYdBmagL[0]*hamilL[3]*q_*rdvpar2L))/(m_*q_); 
  alphaL[2] = (0.3061862178478971*BstarYdBmagL[3]*hamilL[3]*rdvpar2L)/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgL = (0.03125*((6.0*bmagInv[0]*hamilL[5]+3.464101615137754*bmagInv[0]*hamilL[1])*m_*rdx2L+1.732050807568877*BstarYdBmagL[0]*hamilL[3]*q_*rdvpar2L))/(m_*q_); 

  double incr[16]; 
#if upwindType == SURFAVG 
  if (alphaSurfAvgL>0) { 
  incr[0] = 0.125*(alphaL[2]*(2.449489742783178*fL[7]+1.414213562373095*fL[3])+alphaL[0]*(2.449489742783178*fL[2]+1.414213562373095*fL[0])); 
  incr[1] = 0.125*(alphaL[2]*(2.449489742783178*fL[11]+1.414213562373095*fL[6])+alphaL[0]*(2.449489742783178*fL[5]+1.414213562373095*fL[1])); 
  incr[2] = -0.125*(alphaL[2]*(4.242640687119286*fL[7]+2.449489742783178*fL[3])+alphaL[0]*(4.242640687119286*fL[2]+2.449489742783178*fL[0])); 
  incr[3] = 0.125*(alphaL[0]*(2.449489742783178*fL[7]+1.414213562373095*fL[3])+alphaL[2]*(2.449489742783178*fL[2]+1.414213562373095*fL[0])); 
  incr[4] = 0.125*(alphaL[2]*(2.449489742783178*fL[14]+1.414213562373095*fL[10])+alphaL[0]*(2.449489742783178*fL[9]+1.414213562373095*fL[4])); 
  incr[5] = -0.125*(alphaL[2]*(4.242640687119286*fL[11]+2.449489742783178*fL[6])+alphaL[0]*(4.242640687119286*fL[5]+2.449489742783178*fL[1])); 
  incr[6] = 0.125*(alphaL[0]*(2.449489742783178*fL[11]+1.414213562373095*fL[6])+alphaL[2]*(2.449489742783178*fL[5]+1.414213562373095*fL[1])); 
  incr[7] = -0.125*(alphaL[0]*(4.242640687119286*fL[7]+2.449489742783178*fL[3])+alphaL[2]*(4.242640687119286*fL[2]+2.449489742783178*fL[0])); 
  incr[8] = 0.125*(alphaL[2]*(2.449489742783178*fL[15]+1.414213562373095*fL[13])+alphaL[0]*(2.449489742783178*fL[12]+1.414213562373095*fL[8])); 
  incr[9] = -0.125*(alphaL[2]*(4.242640687119286*fL[14]+2.449489742783178*fL[10])+alphaL[0]*(4.242640687119286*fL[9]+2.449489742783178*fL[4])); 
  incr[10] = 0.125*(alphaL[0]*(2.449489742783178*fL[14]+1.414213562373095*fL[10])+alphaL[2]*(2.449489742783178*fL[9]+1.414213562373095*fL[4])); 
  incr[11] = -0.125*(alphaL[0]*(4.242640687119286*fL[11]+2.449489742783178*fL[6])+alphaL[2]*(4.242640687119286*fL[5]+2.449489742783178*fL[1])); 
  incr[12] = -0.125*(alphaL[2]*(4.242640687119286*fL[15]+2.449489742783178*fL[13])+alphaL[0]*(4.242640687119286*fL[12]+2.449489742783178*fL[8])); 
  incr[13] = 0.125*(alphaL[0]*(2.449489742783178*fL[15]+1.414213562373095*fL[13])+alphaL[2]*(2.449489742783178*fL[12]+1.414213562373095*fL[8])); 
  incr[14] = -0.125*(alphaL[0]*(4.242640687119286*fL[14]+2.449489742783178*fL[10])+alphaL[2]*(4.242640687119286*fL[9]+2.449489742783178*fL[4])); 
  incr[15] = -0.125*(alphaL[0]*(4.242640687119286*fL[15]+2.449489742783178*fL[13])+alphaL[2]*(4.242640687119286*fL[12]+2.449489742783178*fL[8])); 
  } else { 
  incr[0] = -0.125*(alphaL[2]*(2.449489742783178*fR[7]-1.414213562373095*fR[3])+alphaL[0]*(2.449489742783178*fR[2]-1.414213562373095*fR[0])); 
  incr[1] = -0.125*(alphaL[2]*(2.449489742783178*fR[11]-1.414213562373095*fR[6])+alphaL[0]*(2.449489742783178*fR[5]-1.414213562373095*fR[1])); 
  incr[2] = 0.125*(alphaL[2]*(4.242640687119286*fR[7]-2.449489742783178*fR[3])+alphaL[0]*(4.242640687119286*fR[2]-2.449489742783178*fR[0])); 
  incr[3] = -0.125*(alphaL[0]*(2.449489742783178*fR[7]-1.414213562373095*fR[3])+alphaL[2]*(2.449489742783178*fR[2]-1.414213562373095*fR[0])); 
  incr[4] = -0.125*(alphaL[2]*(2.449489742783178*fR[14]-1.414213562373095*fR[10])+alphaL[0]*(2.449489742783178*fR[9]-1.414213562373095*fR[4])); 
  incr[5] = 0.125*(alphaL[2]*(4.242640687119286*fR[11]-2.449489742783178*fR[6])+alphaL[0]*(4.242640687119286*fR[5]-2.449489742783178*fR[1])); 
  incr[6] = -0.125*(alphaL[0]*(2.449489742783178*fR[11]-1.414213562373095*fR[6])+alphaL[2]*(2.449489742783178*fR[5]-1.414213562373095*fR[1])); 
  incr[7] = 0.125*(alphaL[0]*(4.242640687119286*fR[7]-2.449489742783178*fR[3])+alphaL[2]*(4.242640687119286*fR[2]-2.449489742783178*fR[0])); 
  incr[8] = -0.125*(alphaL[2]*(2.449489742783178*fR[15]-1.414213562373095*fR[13])+alphaL[0]*(2.449489742783178*fR[12]-1.414213562373095*fR[8])); 
  incr[9] = 0.125*(alphaL[2]*(4.242640687119286*fR[14]-2.449489742783178*fR[10])+alphaL[0]*(4.242640687119286*fR[9]-2.449489742783178*fR[4])); 
  incr[10] = -0.125*(alphaL[0]*(2.449489742783178*fR[14]-1.414213562373095*fR[10])+alphaL[2]*(2.449489742783178*fR[9]-1.414213562373095*fR[4])); 
  incr[11] = 0.125*(alphaL[0]*(4.242640687119286*fR[11]-2.449489742783178*fR[6])+alphaL[2]*(4.242640687119286*fR[5]-2.449489742783178*fR[1])); 
  incr[12] = 0.125*(alphaL[2]*(4.242640687119286*fR[15]-2.449489742783178*fR[13])+alphaL[0]*(4.242640687119286*fR[12]-2.449489742783178*fR[8])); 
  incr[13] = -0.125*(alphaL[0]*(2.449489742783178*fR[15]-1.414213562373095*fR[13])+alphaL[2]*(2.449489742783178*fR[12]-1.414213562373095*fR[8])); 
  incr[14] = 0.125*(alphaL[0]*(4.242640687119286*fR[14]-2.449489742783178*fR[10])+alphaL[2]*(4.242640687119286*fR[9]-2.449489742783178*fR[4])); 
  incr[15] = 0.125*(alphaL[0]*(4.242640687119286*fR[15]-2.449489742783178*fR[13])+alphaL[2]*(4.242640687119286*fR[12]-2.449489742783178*fR[8])); 
  }
#elif upwindType == QUAD 
  double alphaOrdL;
  double fUpOrd[8];
  ...
  incr[0] = 0.25*(alphaL[2]*fUp[2]+alphaL[0]*fUp[0]); 
  incr[1] = 0.25*(alphaL[2]*fUp[4]+alphaL[0]*fUp[1]); 
  incr[2] = -0.4330127018922193*(alphaL[2]*fUp[2]+alphaL[0]*fUp[0]); 
  incr[3] = 0.25*(alphaL[0]*fUp[2]+fUp[0]*alphaL[2]); 
  incr[4] = 0.25*(alphaL[2]*fUp[6]+alphaL[0]*fUp[3]); 
  incr[5] = -0.4330127018922193*(alphaL[2]*fUp[4]+alphaL[0]*fUp[1]); 
  incr[6] = 0.25*(alphaL[0]*fUp[4]+fUp[1]*alphaL[2]); 
  incr[7] = -0.4330127018922193*(alphaL[0]*fUp[2]+fUp[0]*alphaL[2]); 
  incr[8] = 0.25*(alphaL[2]*fUp[7]+alphaL[0]*fUp[5]); 
  incr[9] = -0.4330127018922193*(alphaL[2]*fUp[6]+alphaL[0]*fUp[3]); 
  incr[10] = 0.25*(alphaL[0]*fUp[6]+alphaL[2]*fUp[3]); 
  incr[11] = -0.4330127018922193*(alphaL[0]*fUp[4]+fUp[1]*alphaL[2]); 
  incr[12] = -0.4330127018922193*(alphaL[2]*fUp[7]+alphaL[0]*fUp[5]); 
  incr[13] = 0.25*(alphaL[0]*fUp[7]+alphaL[2]*fUp[5]); 
  incr[14] = -0.4330127018922193*(alphaL[0]*fUp[6]+alphaL[2]*fUp[3]); 
  incr[15] = -0.4330127018922193*(alphaL[0]*fUp[7]+alphaL[2]*fUp[5]); 
...
double GyrokineticSimpleHelicalSurf2x2vSer_yR_P1_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *cmag, const double *BdriftX, const double *BdriftY, const double *phi, const double *fL, const double *fR, double *outL, double *outR) 
{ 
  // bmagInv: 1/bmag.
  // BdriftX,BdriftY: x,y components of gradB/curvature drift.
  // q_,m_: species charge and mass.
...
double GyrokineticSimpleHelicalSurf2x2vSer_xL_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *cmag, const double *BdriftX, const double *BdriftY, const double *phi, const double *fL, const double *fR, double *outL, double *outR) 
{ 
  // bmagInv: 1/bmag.
  // BdriftX,BdriftY: x,y components of gradB/curvature drift.
  // q_,m_: species charge and mass.
  ...
  double alphaL[8]; 
  alphaL[0] = -(0.125*(((14.69693845669907*bmagInv[1]+8.485281374238571*bmagInv[0])*hamilL[5]+(8.485281374238571*bmagInv[1]+4.898979485566357*bmagInv[0])*hamilL[2])*m_*rdy2L+((-4.242640687119286*BstarXdBmagL[1])-2.449489742783178*BstarXdBmagL[0])*hamilL[3]*q_*rdvpar2L))/(m_*q_); 
  alphaL[2] = (0.125*hamilL[3]*(4.242640687119286*BstarXdBmagL[6]+2.449489742783178*BstarXdBmagL[3])*rdvpar2L)/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgL = -(0.03125*(((10.39230484541326*bmagInv[1]+6.0*bmagInv[0])*hamilL[5]+(6.0*bmagInv[1]+3.464101615137754*bmagInv[0])*hamilL[2])*m_*rdy2L+((-3.0*BstarXdBmagL[1])-1.732050807568877*BstarXdBmagL[0])*hamilL[3]*q_*rdvpar2L))/(m_*q_); 
...
double GyrokineticSimpleHelicalSurf2x2vSer_xR_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *cmag, const double *BdriftX, const double *BdriftY, const double *phi, const double *fL, const double *fR, double *outL, double *outR) 
{ 
  // bmagInv: 1/bmag.
  // BdriftX,BdriftY: x,y components of gradB/curvature drift.
  // q_,m_: species charge and mass.
...
double GyrokineticSimpleHelicalSurf2x2vSer_yL_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *cmag, const double *BdriftX, const double *BdriftY, const double *phi, const double *fL, const double *fR, double *outL, double *outR) 
{ 
  // bmagInv: 1/bmag.
  // BdriftX,BdriftY: x,y components of gradB/curvature drift.
  // q_,m_: species charge and mass.
  ...
  double alphaL[8]; 
  alphaL[0] = (0.1767766952966368*(bmagInv[0]*(6.0*hamilL[5]+3.464101615137754*hamilL[1])*m_*rdx2L+1.732050807568877*BstarYdBmagL[0]*hamilL[3]*q_*rdvpar2L))/(m_*q_); 
  alphaL[1] = (0.1767766952966368*(bmagInv[1]*(6.0*hamilL[5]+3.464101615137754*hamilL[1])*m_*rdx2L+1.732050807568877*BstarYdBmagL[1]*hamilL[3]*q_*rdvpar2L))/(m_*q_); 
  alphaL[2] = (0.3061862178478971*BstarYdBmagL[3]*hamilL[3]*rdvpar2L)/m_; 
  alphaL[3] = (0.6123724356957944*bmagInv[0]*hamilL[8]*rdx2L)/q_; 
  alphaL[4] = (0.3061862178478971*hamilL[3]*BstarYdBmagL[6]*rdvpar2L)/m_; 
  alphaL[5] = (0.6123724356957944*bmagInv[1]*hamilL[8]*rdx2L)/q_; 
