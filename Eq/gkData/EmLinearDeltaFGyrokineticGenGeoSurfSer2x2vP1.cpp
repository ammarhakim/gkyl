...
{ 
  ...
  double alphaOrdR;
  double fUpOrd[8];
  alphaOrdR = 0.3535533905932737*alpha0R[0]; 
  ...
  incr[0] = 0.25*alpha0R[0]*fUp[0]; 
  incr[1] = -0.4330127018922193*alpha0R[0]*fUp[0]; 
  incr[2] = 0.25*alpha0R[0]*fUp[1]; 
  incr[3] = 0.25*alpha0R[0]*fUp[2]; 
  incr[4] = 0.25*alpha0R[0]*fUp[3]; 
  incr[5] = -0.4330127018922193*alpha0R[0]*fUp[1]; 
  incr[6] = -0.4330127018922193*alpha0R[0]*fUp[2]; 
  incr[7] = 0.25*alpha0R[0]*fUp[4]; 
  incr[8] = -0.4330127018922193*alpha0R[0]*fUp[3]; 
  incr[9] = 0.25*alpha0R[0]*fUp[5]; 
  incr[10] = 0.25*alpha0R[0]*fUp[6]; 
  incr[11] = -0.4330127018922193*alpha0R[0]*fUp[4]; 
  incr[12] = -0.4330127018922193*alpha0R[0]*fUp[5]; 
  incr[13] = -0.4330127018922193*alpha0R[0]*fUp[6]; 
  incr[14] = 0.25*alpha0R[0]*fUp[7]; 
  incr[15] = -0.4330127018922193*alpha0R[0]*fUp[7]; 
...
{ 
  ...
  incr[0] = 0.25*alpha0R[0]*fUp[0]; 
  incr[1] = 0.25*alpha0R[0]*fUp[1]; 
  incr[2] = -0.4330127018922193*alpha0R[0]*fUp[0]; 
  incr[3] = 0.25*alpha0R[0]*fUp[2]; 
  incr[4] = 0.25*alpha0R[0]*fUp[3]; 
  incr[5] = -0.4330127018922193*alpha0R[0]*fUp[1]; 
  incr[6] = 0.25*alpha0R[0]*fUp[4]; 
  incr[7] = -0.4330127018922193*alpha0R[0]*fUp[2]; 
  incr[8] = 0.25*alpha0R[0]*fUp[5]; 
  incr[9] = -0.4330127018922193*alpha0R[0]*fUp[3]; 
  incr[10] = 0.25*alpha0R[0]*fUp[6]; 
  incr[11] = -0.4330127018922193*alpha0R[0]*fUp[4]; 
  incr[12] = -0.4330127018922193*alpha0R[0]*fUp[5]; 
  incr[13] = 0.25*alpha0R[0]*fUp[7]; 
  incr[14] = -0.4330127018922193*alpha0R[0]*fUp[6]; 
  incr[15] = -0.4330127018922193*alpha0R[0]*fUp[7]; 
...
{ 
  ...
  double alphaOrdR;
  double fUpOrd[8];
  alphaOrdR = 0.3535533905932737*alpha0UpR[5]-0.3535533905932737*(alpha0UpR[3]+alpha0UpR[1])+0.3535533905932737*alpha0UpR[0]; 
  ...
  alphaOrdR = 0.3535533905932737*(alpha0UpR[1]+alpha0UpR[0])-0.3535533905932737*(alpha0UpR[5]+alpha0UpR[3]); 
  ...
  alphaOrdR = (-0.3535533905932737*alpha0UpR[5])+0.3535533905932737*alpha0UpR[3]-0.3535533905932737*alpha0UpR[1]+0.3535533905932737*alpha0UpR[0]; 
  ...
  alphaOrdR = 0.3535533905932737*(alpha0UpR[5]+alpha0UpR[3]+alpha0UpR[1]+alpha0UpR[0]); 
  ...
  incr[0] = 0.25*(alpha0R[5]*fUp[5]+alpha0R[3]*fUp[3]+alpha0R[1]*fUp[1]+alpha0R[0]*fUp[0]); 
  incr[1] = 0.25*(alpha0R[3]*fUp[5]+fUp[3]*alpha0R[5]+alpha0R[0]*fUp[1]+fUp[0]*alpha0R[1]); 
  incr[2] = 0.25*(alpha0R[5]*fUp[7]+alpha0R[3]*fUp[6]+alpha0R[1]*fUp[4]+alpha0R[0]*fUp[2]); 
  incr[3] = -0.4330127018922193*(alpha0R[5]*fUp[5]+alpha0R[3]*fUp[3]+alpha0R[1]*fUp[1]+alpha0R[0]*fUp[0]); 
  incr[4] = 0.25*(alpha0R[1]*fUp[5]+fUp[1]*alpha0R[5]+alpha0R[0]*fUp[3]+fUp[0]*alpha0R[3]); 
  incr[5] = 0.25*(alpha0R[3]*fUp[7]+alpha0R[5]*fUp[6]+alpha0R[0]*fUp[4]+alpha0R[1]*fUp[2]); 
  incr[6] = -0.4330127018922193*(alpha0R[3]*fUp[5]+fUp[3]*alpha0R[5]+alpha0R[0]*fUp[1]+fUp[0]*alpha0R[1]); 
  incr[7] = -0.4330127018922193*(alpha0R[5]*fUp[7]+alpha0R[3]*fUp[6]+alpha0R[1]*fUp[4]+alpha0R[0]*fUp[2]); 
  incr[8] = 0.25*(alpha0R[0]*fUp[5]+fUp[0]*alpha0R[5]+alpha0R[1]*fUp[3]+fUp[1]*alpha0R[3]); 
  incr[9] = 0.25*(alpha0R[1]*fUp[7]+alpha0R[0]*fUp[6]+fUp[4]*alpha0R[5]+fUp[2]*alpha0R[3]); 
  incr[10] = -0.4330127018922193*(alpha0R[1]*fUp[5]+fUp[1]*alpha0R[5]+alpha0R[0]*fUp[3]+fUp[0]*alpha0R[3]); 
  incr[11] = -0.4330127018922193*(alpha0R[3]*fUp[7]+alpha0R[5]*fUp[6]+alpha0R[0]*fUp[4]+alpha0R[1]*fUp[2]); 
  incr[12] = 0.25*(alpha0R[0]*fUp[7]+alpha0R[1]*fUp[6]+fUp[2]*alpha0R[5]+alpha0R[3]*fUp[4]); 
  incr[13] = -0.4330127018922193*(alpha0R[0]*fUp[5]+fUp[0]*alpha0R[5]+alpha0R[1]*fUp[3]+fUp[1]*alpha0R[3]); 
  incr[14] = -0.4330127018922193*(alpha0R[1]*fUp[7]+alpha0R[0]*fUp[6]+fUp[4]*alpha0R[5]+fUp[2]*alpha0R[3]); 
  incr[15] = -0.4330127018922193*(alpha0R[0]*fUp[7]+alpha0R[1]*fUp[6]+fUp[2]*alpha0R[5]+alpha0R[3]*fUp[4]); 
