...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  incr[0] = -0.3535533905932737*fhatALVal[0]*(1.732050807568877*alpha[1]-1.0*alpha[0])*dfac_x; 
  incr[1] = 0.3535533905932737*fhatALVal[0]*(3.0*alpha[1]-1.732050807568877*alpha[0])*dfac_x; 
  incr[2] = -0.3535533905932737*(1.732050807568877*alpha[1]-1.0*alpha[0])*fhatALVal[1]*dfac_x; 
  incr[3] = 0.3535533905932737*(3.0*alpha[1]-1.732050807568877*alpha[0])*fhatALVal[1]*dfac_x; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  fhatALVal[0] = 0.7071067811865475*(fqVal[1]+fqVal[0]); 
  fhatALVal[1] = 1.224744871391589*(fqVal[1]-1.0*fqVal[0]); 
  incr[0] = -0.3535533905932737*fhatALVal[0]*(1.732050807568877*alpha[2]-1.0*alpha[0])*dfac_y; 
  incr[1] = -0.3535533905932737*fhatALVal[1]*(1.732050807568877*alpha[2]-1.0*alpha[0])*dfac_y; 
  incr[2] = 0.3535533905932737*fhatALVal[0]*(3.0*alpha[2]-1.732050807568877*alpha[0])*dfac_y; 
  incr[3] = 0.3535533905932737*fhatALVal[1]*(3.0*alpha[2]-1.732050807568877*alpha[0])*dfac_y; 
