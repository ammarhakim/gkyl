...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  if(alphaQuad > 0) {
     ...
     limQuad[0] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[0] = fr[0]/cflR*0.1767766952966368; 
  } 
  alphaQuad = 0.25*alpha[0]-0.25*(alpha[3]+alpha[2]); 
  if(alphaQuad > 0) {
     ...
     limQuad[1] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[1] = fr[0]/cflR*0.1767766952966368; 
  } 
  ...
  if(alphaQuad > 0) {
     ...
     limQuad[2] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[2] = fr[0]/cflR*0.1767766952966368; 
  } 
  alphaQuad = 0.25*(alpha[2]+alpha[0])-0.25*alpha[3]; 
  if(alphaQuad > 0) {
     ...
     limQuad[3] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[3] = fr[0]/cflR*0.1767766952966368; 
  } 
  ...
  if(alphaQuad > 0) {
     ...
     limQuad[4] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[4] = fr[0]/cflR*0.1767766952966368; 
  } 
  alphaQuad = 0.25*alpha[3]-0.25*alpha[2]+0.25*alpha[0]; 
  if(alphaQuad > 0) {
     ...
     limQuad[5] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[5] = fr[0]/cflR*0.1767766952966368; 
  } 
  ...
  if(alphaQuad > 0) {
     ...
     limQuad[6] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[6] = fr[0]/cflR*0.1767766952966368; 
  } 
  alphaQuad = 0.25*(alpha[3]+alpha[2]+alpha[0]); 
  if(alphaQuad > 0) {
     ...
     limQuad[7] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[7] = fr[0]/cflR*0.1767766952966368; 
  } 
  alphaQuad = 0.25*alpha[0]-0.25*(alpha[3]+alpha[2]); 
  if(alphaQuad > 0) {
     ...
     limQuad[8] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[8] = fr[0]/cflR*0.1767766952966368; 
  } 
  alphaQuad = 0.25*alpha[0]-0.25*(alpha[3]+alpha[2]); 
  if(alphaQuad > 0) {
     ...
     limQuad[9] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[9] = fr[0]/cflR*0.1767766952966368; 
  } 
  alphaQuad = 0.25*(alpha[2]+alpha[0])-0.25*alpha[3]; 
  if(alphaQuad > 0) {
     ...
     limQuad[10] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[10] = fr[0]/cflR*0.1767766952966368; 
  } 
  alphaQuad = 0.25*(alpha[2]+alpha[0])-0.25*alpha[3]; 
  if(alphaQuad > 0) {
     ...
     limQuad[11] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[11] = fr[0]/cflR*0.1767766952966368; 
  } 
  alphaQuad = 0.25*alpha[3]-0.25*alpha[2]+0.25*alpha[0]; 
  if(alphaQuad > 0) {
     ...
     limQuad[12] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[12] = fr[0]/cflR*0.1767766952966368; 
  } 
  alphaQuad = 0.25*alpha[3]-0.25*alpha[2]+0.25*alpha[0]; 
  if(alphaQuad > 0) {
     ...
     limQuad[13] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[13] = fr[0]/cflR*0.1767766952966368; 
  } 
  alphaQuad = 0.25*(alpha[3]+alpha[2]+alpha[0]); 
  if(alphaQuad > 0) {
     ...
     limQuad[14] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[14] = fr[0]/cflR*0.1767766952966368; 
  } 
  alphaQuad = 0.25*(alpha[3]+alpha[2]+alpha[0]); 
  if(alphaQuad > 0) {
     ...
     limQuad[15] = fl[0]/cflL*0.1767766952966368; 
  } else {
     ...
     limQuad[15] = fr[0]/cflR*0.1767766952966368; 
  } 
  ...
  fhatCtrl[0] = 0.01134023029066286*(1.732050807568877*fhat[30]-3.0*(fhat[25]+fhat[24]+fhat[22]+fhat[19])+5.196152422706631*(fhat[15]+fhat[14]+fhat[13]+fhat[11]+fhat[10]+fhat[8])-9.0*(fhat[5]+fhat[4]+fhat[3]+fhat[2])+15.58845726811989*fhat[0])*limTheta(rCtrl[0],-1.0); 
  fhatCtrl[1] = -0.01134023029066286*(1.732050807568877*fhat[30]+3.0*(fhat[25]-1.0*(fhat[24]+fhat[22]+fhat[19]))+5.196152422706631*((-1.0*(fhat[15]+fhat[14]))+fhat[13]-1.0*fhat[11]+fhat[10]+fhat[8])+9.0*(fhat[5]+fhat[4]+fhat[3])-1.0*(9.0*fhat[2]+15.58845726811989*fhat[0]))*limTheta(rCtrl[1],-1.0); 
  fhatCtrl[2] = -0.01134023029066286*(1.732050807568877*fhat[30]+3.0*((-1.0*fhat[25])+fhat[24]-1.0*(fhat[22]+fhat[19]))+5.196152422706631*((-1.0*fhat[15])+fhat[14]-1.0*fhat[13]+fhat[11]-1.0*fhat[10]+fhat[8])+9.0*(fhat[5]+fhat[4]-1.0*fhat[3]+fhat[2])-15.58845726811989*fhat[0])*limTheta(rCtrl[2],-1.0); 
  fhatCtrl[3] = 0.01134023029066286*(1.732050807568877*fhat[30]+3.0*(fhat[25]+fhat[24]-1.0*(fhat[22]+fhat[19]))+5.196152422706631*(fhat[15]-1.0*(fhat[14]+fhat[13]+fhat[11]+fhat[10]-1.0*fhat[8]))+9.0*((-1.0*(fhat[5]+fhat[4]))+fhat[3]+fhat[2])+15.58845726811989*fhat[0])*limTheta(rCtrl[3],-1.0); 
  fhatCtrl[4] = -0.01134023029066286*(1.732050807568877*fhat[30]+3.0*((-1.0*(fhat[25]+fhat[24]))+fhat[22]-1.0*fhat[19])+5.196152422706631*(fhat[15]-1.0*(fhat[14]+fhat[13]-1.0*fhat[11])+fhat[10]-1.0*fhat[8])+9.0*(fhat[5]-1.0*fhat[4]+fhat[3]+fhat[2])-15.58845726811989*fhat[0])*limTheta(rCtrl[4],-1.0); 
  fhatCtrl[5] = 0.01134023029066286*(1.732050807568877*fhat[30]+3.0*(fhat[25]-1.0*fhat[24]+fhat[22]-1.0*fhat[19])+5.196152422706631*((-1.0*fhat[15])+fhat[14]-1.0*(fhat[13]+fhat[11]-1.0*fhat[10]+fhat[8]))+9.0*((-1.0*fhat[5])+fhat[4]-1.0*fhat[3]+fhat[2])+15.58845726811989*fhat[0])*limTheta(rCtrl[5],-1.0); 
  fhatCtrl[6] = 0.01134023029066286*(1.732050807568877*fhat[30]+3.0*((-1.0*fhat[25])+fhat[24]+fhat[22]-1.0*fhat[19])+5.196152422706631*((-1.0*(fhat[15]+fhat[14]))+fhat[13]+fhat[11]-1.0*(fhat[10]+fhat[8]))+9.0*((-1.0*fhat[5])+fhat[4]+fhat[3]-1.0*fhat[2])+15.58845726811989*fhat[0])*limTheta(rCtrl[6],-1.0); 
  fhatCtrl[7] = -0.01134023029066286*(1.732050807568877*fhat[30]+3.0*(fhat[25]+fhat[24]+fhat[22]-1.0*fhat[19])+5.196152422706631*(fhat[15]+fhat[14]+fhat[13]-1.0*(fhat[11]+fhat[10]+fhat[8]))+9.0*fhat[5]-1.0*(9.0*(fhat[4]+fhat[3]+fhat[2])+15.58845726811989*fhat[0]))*limTheta(rCtrl[7],-1.0); 
  fhatCtrl[8] = -0.01134023029066286*(1.732050807568877*fhat[30]-3.0*(fhat[25]+fhat[24]+fhat[22]-1.0*fhat[19])+5.196152422706631*(fhat[15]+fhat[14]+fhat[13]-1.0*(fhat[11]+fhat[10]+fhat[8]))+9.0*((-1.0*fhat[5])+fhat[4]+fhat[3]+fhat[2])-15.58845726811989*fhat[0])*limTheta(rCtrl[8],-1.0); 
  fhatCtrl[9] = 0.01134023029066286*(1.732050807568877*fhat[30]+3.0*(fhat[25]-1.0*(fhat[24]+fhat[22]-1.0*fhat[19]))+5.196152422706631*((-1.0*(fhat[15]+fhat[14]))+fhat[13]+fhat[11]-1.0*(fhat[10]+fhat[8]))+9.0*(fhat[5]-1.0*(fhat[4]+fhat[3]-1.0*fhat[2]))+15.58845726811989*fhat[0])*limTheta(rCtrl[9],-1.0); 
  fhatCtrl[10] = 0.01134023029066286*(1.732050807568877*fhat[30]+3.0*((-1.0*fhat[25])+fhat[24]-1.0*fhat[22]+fhat[19])+5.196152422706631*((-1.0*fhat[15])+fhat[14]-1.0*(fhat[13]+fhat[11]-1.0*fhat[10]+fhat[8]))+9.0*(fhat[5]-1.0*fhat[4]+fhat[3]-1.0*fhat[2])+15.58845726811989*fhat[0])*limTheta(rCtrl[10],-1.0); 
  fhatCtrl[11] = -0.01134023029066286*(1.732050807568877*fhat[30]+3.0*(fhat[25]+fhat[24]-1.0*fhat[22]+fhat[19])+5.196152422706631*(fhat[15]-1.0*(fhat[14]+fhat[13]-1.0*fhat[11])+fhat[10]-1.0*fhat[8])+9.0*(fhat[4]-1.0*fhat[5])-1.0*(9.0*(fhat[3]+fhat[2])+15.58845726811989*fhat[0]))*limTheta(rCtrl[11],-1.0); 
  fhatCtrl[12] = 0.01134023029066286*(1.732050807568877*fhat[30]+3.0*((-1.0*(fhat[25]+fhat[24]))+fhat[22]+fhat[19])+5.196152422706631*(fhat[15]-1.0*(fhat[14]+fhat[13]+fhat[11]+fhat[10]-1.0*fhat[8]))+9.0*(fhat[5]+fhat[4]-1.0*(fhat[3]+fhat[2]))+15.58845726811989*fhat[0])*limTheta(rCtrl[12],-1.0); 
  fhatCtrl[13] = -0.01134023029066286*(1.732050807568877*fhat[30]+3.0*(fhat[25]-1.0*fhat[24]+fhat[22]+fhat[19])+5.196152422706631*((-1.0*fhat[15])+fhat[14]-1.0*fhat[13]+fhat[11]-1.0*fhat[10]+fhat[8])+9.0*(fhat[3]-1.0*(fhat[5]+fhat[4]))-1.0*(9.0*fhat[2]+15.58845726811989*fhat[0]))*limTheta(rCtrl[13],-1.0); 
  fhatCtrl[14] = -0.01134023029066286*(1.732050807568877*fhat[30]+3.0*((-1.0*fhat[25])+fhat[24]+fhat[22]+fhat[19])+5.196152422706631*((-1.0*(fhat[15]+fhat[14]))+fhat[13]-1.0*fhat[11]+fhat[10]+fhat[8])-9.0*(fhat[5]+fhat[4]+fhat[3]-1.0*fhat[2])-15.58845726811989*fhat[0])*limTheta(rCtrl[14],-1.0); 
  fhatCtrl[15] = 0.01134023029066286*(1.732050807568877*fhat[30]+3.0*(fhat[25]+fhat[24]+fhat[22]+fhat[19])+5.196152422706631*(fhat[15]+fhat[14]+fhat[13]+fhat[11]+fhat[10]+fhat[8])+9.0*(fhat[5]+fhat[4]+fhat[3]+fhat[2])+15.58845726811989*fhat[0])*limTheta(rCtrl[15],-1.0); 
  ...
  fhatALQuad[0] = std::max(0., std::min(0.25*((-0.5773502691896258*((-1.732050807568878*(fhatAL[15]+fhatAL[5]))-1.732050807568877*(fhatAL[9]+fhatAL[7])))-1.0*(fhatAL[14]+fhatAL[13]+1.0*(fhatAL[12]+fhatAL[11])+fhatAL[4]+fhatAL[3]+fhatAL[2]+fhatAL[1])+fhatAL[10]+1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[0])); 
  fhatALQuad[1] = std::max(0., std::min(0.25*((-0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[5])-1.732050807568877*(fhatAL[9]+fhatAL[7])))+1.732050807568877*((-0.5773502691896258*(fhatAL[14]-1.0*(fhatAL[12]+fhatAL[11])+fhatAL[2]))+0.5773502691896258*(fhatAL[13]+fhatAL[1])-0.5773502691896258*(fhatAL[4]+fhatAL[3]))+fhatAL[10]-1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[1])); 
  fhatALQuad[2] = std::max(0., std::min(0.25*(0.5773502691896258*((-1.732050807568878*(fhatAL[15]+fhatAL[5]))-1.732050807568877*(fhatAL[9]+fhatAL[7]))+1.732050807568877*(0.5773502691896258*(fhatAL[14]+1.0*(fhatAL[12]+fhatAL[11])+fhatAL[2])-0.5773502691896258*(fhatAL[13]+fhatAL[4]+fhatAL[3]+fhatAL[1]))+fhatAL[10]+1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[2])); 
  fhatALQuad[3] = std::max(0., std::min(0.25*(0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[5])-1.732050807568877*(fhatAL[9]+fhatAL[7]))+1.732050807568877*(0.5773502691896258*(fhatAL[14]+fhatAL[13]-1.0*(fhatAL[12]+fhatAL[11])+fhatAL[2]+fhatAL[1])-0.5773502691896258*(fhatAL[4]+fhatAL[3]))+fhatAL[10]-1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[3])); 
  fhatALQuad[4] = std::max(0., std::min(0.25*((-0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15]))-1.732050807568877*fhatAL[9]+1.732050807568877*fhatAL[7]))+1.732050807568877*(0.5773502691896258*fhatAL[3]-0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[13]))-0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[12])+fhatAL[4]+fhatAL[2]+fhatAL[1]))-1.0*fhatAL[10]-0.5773502691896258*(1.732050807568877*fhatAL[6]-1.732050807568877*fhatAL[8])+fhatAL[0]), limQuad[4])); 
  fhatALQuad[5] = std::max(0., std::min(0.25*((-0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15])-1.732050807568877*fhatAL[9]+1.732050807568877*fhatAL[7]))+1.732050807568877*((-0.5773502691896258*((-1.0*fhatAL[14])+0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[12])+fhatAL[2]))+0.5773502691896258*(fhatAL[1]-1.0*fhatAL[13])-0.5773502691896258*fhatAL[4]+0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]+0.5773502691896258*(1.732050807568877*fhatAL[6]-1.732050807568877*fhatAL[8])+fhatAL[0]), limQuad[5])); 
  fhatALQuad[6] = std::max(0., std::min(0.25*(0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15]))-1.732050807568877*fhatAL[9]+1.732050807568877*fhatAL[7])+1.732050807568877*(0.5773502691896258*((-1.0*fhatAL[14])-0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[12])+fhatAL[2])-0.5773502691896258*((-1.0*fhatAL[13])+fhatAL[4]+fhatAL[1])+0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]-0.5773502691896258*(1.732050807568877*fhatAL[6]-1.732050807568877*fhatAL[8])+fhatAL[0]), limQuad[6])); 
  fhatALQuad[7] = std::max(0., std::min(0.25*(0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15])-1.732050807568877*fhatAL[9]+1.732050807568877*fhatAL[7])+1.732050807568877*(0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[13]))+0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[12])+fhatAL[2]+fhatAL[1])-0.5773502691896258*fhatAL[4]+0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]+0.5773502691896258*(1.732050807568877*fhatAL[6]-1.732050807568877*fhatAL[8])+fhatAL[0]), limQuad[7])); 
  fhatALQuad[8] = std::max(0., std::min(0.25*((-0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15]))+1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[7]))+1.732050807568877*((-0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[13]))-0.5773502691896258*(1.732050807568877*fhatAL[12]-1.732050807568877*fhatAL[11])+fhatAL[2]+fhatAL[1]))+0.5773502691896258*fhatAL[4]-0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]-0.5773502691896258*(1.732050807568877*fhatAL[8]-1.732050807568877*fhatAL[6])+fhatAL[0]), limQuad[8])); 
  fhatALQuad[9] = std::max(0., std::min(0.25*((-0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15])+1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[7]))+1.732050807568877*((-0.5773502691896258*((-1.0*fhatAL[14])+0.5773502691896258*(1.732050807568877*fhatAL[12]-1.732050807568877*fhatAL[11])+fhatAL[2]))+0.5773502691896258*((-1.0*fhatAL[13])+fhatAL[4]+fhatAL[1])-0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]+0.5773502691896258*(1.732050807568877*fhatAL[8]-1.732050807568877*fhatAL[6])+fhatAL[0]), limQuad[9])); 
  fhatALQuad[10] = std::max(0., std::min(0.25*(0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15]))+1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[7])+1.732050807568877*(0.5773502691896258*((-1.0*fhatAL[14])-0.5773502691896258*(1.732050807568877*fhatAL[12]-1.732050807568877*fhatAL[11])+fhatAL[2])-0.5773502691896258*(fhatAL[1]-1.0*fhatAL[13])+0.5773502691896258*fhatAL[4]-0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]-0.5773502691896258*(1.732050807568877*fhatAL[8]-1.732050807568877*fhatAL[6])+fhatAL[0]), limQuad[10])); 
  fhatALQuad[11] = std::max(0., std::min(0.25*(0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15])+1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[7])+1.732050807568877*(0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[13]))+0.5773502691896258*(1.732050807568877*fhatAL[12]-1.732050807568877*fhatAL[11])+fhatAL[4]+fhatAL[2]+fhatAL[1])-0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]+0.5773502691896258*(1.732050807568877*fhatAL[8]-1.732050807568877*fhatAL[6])+fhatAL[0]), limQuad[11])); 
  fhatALQuad[12] = std::max(0., std::min(0.25*((-0.5773502691896258*(1.732050807568877*(fhatAL[9]+fhatAL[7])-1.732050807568878*(fhatAL[15]+fhatAL[5])))+1.732050807568877*(0.5773502691896258*(fhatAL[4]+fhatAL[3])-0.5773502691896258*(fhatAL[14]+fhatAL[13]-1.0*(fhatAL[12]+fhatAL[11])+fhatAL[2]+fhatAL[1]))+fhatAL[10]-1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[12])); 
  fhatALQuad[13] = std::max(0., std::min(0.25*((-0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[5])+1.732050807568877*(fhatAL[9]+fhatAL[7])))+1.732050807568877*(0.5773502691896258*(fhatAL[13]+fhatAL[4]+fhatAL[3]+fhatAL[1])-0.5773502691896258*(fhatAL[14]+1.0*(fhatAL[12]+fhatAL[11])+fhatAL[2]))+fhatAL[10]+1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[13])); 
  fhatALQuad[14] = std::max(0., std::min(0.25*(0.5773502691896258*(1.732050807568877*(fhatAL[9]+fhatAL[7])-1.732050807568878*(fhatAL[15]+fhatAL[5]))+1.732050807568877*(0.5773502691896258*(fhatAL[14]-1.0*(fhatAL[12]+fhatAL[11])+fhatAL[2])-0.5773502691896258*(fhatAL[13]+fhatAL[1])+0.5773502691896258*(fhatAL[4]+fhatAL[3]))+fhatAL[10]-1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[14])); 
  fhatALQuad[15] = std::max(0., std::min(0.25*(0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[5])+1.732050807568877*(fhatAL[9]+fhatAL[7]))+1.0*(fhatAL[14]+fhatAL[13]+1.0*(fhatAL[12]+fhatAL[11])+fhatAL[4]+fhatAL[3]+fhatAL[2]+fhatAL[1])+fhatAL[10]+1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[15])); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  fhatCtrl[0] = -0.01964185503295965*(1.732050807568877*(fhat[25]+fhat[23]+fhat[21]+fhat[18]+3.0*(fhat[5]+fhat[4]+fhat[3]+fhat[1]))-1.0*(fhat[29]+3.0*(fhat[15]+fhat[14]+fhat[12]+fhat[11]+fhat[9]+fhat[7]+3.0*fhat[0])))*limTheta(rCtrl[0],-1.0); 
  fhatCtrl[1] = -0.01964185503295965*(fhat[29]+1.732050807568877*(fhat[25]-1.0*(fhat[23]+fhat[21]+fhat[18])+3.0*(fhat[5]+fhat[4]+fhat[3]-1.0*fhat[1]))+3.0*((-1.0*(fhat[15]+fhat[14]))+fhat[12]-1.0*fhat[11]+fhat[9]+fhat[7]-3.0*fhat[0]))*limTheta(rCtrl[1],-1.0); 
  fhatCtrl[2] = 0.01964185503295965*(1.732050807568877*(fhat[25]-1.0*fhat[23]+fhat[21]+fhat[18]+3.0*((-1.0*(fhat[5]+fhat[4]))+fhat[3]-1.0*fhat[1]))-1.0*(fhat[29]+3.0*((-1.0*fhat[15])+fhat[14]-1.0*fhat[12]+fhat[11]-1.0*fhat[9]+fhat[7]-3.0*fhat[0])))*limTheta(rCtrl[2],-1.0); 
  fhatCtrl[3] = 0.01964185503295965*(fhat[29]+1.732050807568877*(fhat[25]+fhat[23]-1.0*(fhat[21]+fhat[18])+3.0*((-1.0*(fhat[5]+fhat[4]))+fhat[3]+fhat[1]))+3.0*(fhat[15]-1.0*(fhat[14]+fhat[12]+fhat[11]+fhat[9]-1.0*(fhat[7]+3.0*fhat[0]))))*limTheta(rCtrl[3],-1.0); 
  fhatCtrl[4] = 0.01964185503295965*(1.732050807568877*(fhat[25]+fhat[23]-1.0*fhat[21]+fhat[18]+3.0*((-1.0*fhat[5])+fhat[4]-1.0*(fhat[3]+fhat[1])))-1.0*(fhat[29]+3.0*(fhat[15]-1.0*(fhat[14]+fhat[12]-1.0*fhat[11])+fhat[9]-1.0*(fhat[7]+3.0*fhat[0]))))*limTheta(rCtrl[4],-1.0); 
  fhatCtrl[5] = 0.01964185503295965*(fhat[29]+1.732050807568877*(fhat[25]-1.0*fhat[23]+fhat[21]-1.0*fhat[18]+3.0*((-1.0*fhat[5])+fhat[4]-1.0*fhat[3]+fhat[1]))+3.0*((-1.0*fhat[15])+fhat[14]-1.0*(fhat[12]+fhat[11]-1.0*fhat[9]+fhat[7])+3.0*fhat[0]))*limTheta(rCtrl[5],-1.0); 
  fhatCtrl[6] = -0.01964185503295965*(1.732050807568877*(fhat[25]-1.0*(fhat[23]+fhat[21])+fhat[18]+3.0*(fhat[5]-1.0*(fhat[4]+fhat[3]-1.0*fhat[1])))-1.0*(fhat[29]+3.0*((-1.0*(fhat[15]+fhat[14]))+fhat[12]+fhat[11]-1.0*(fhat[9]+fhat[7]-3.0*fhat[0]))))*limTheta(rCtrl[6],-1.0); 
  fhatCtrl[7] = -0.01964185503295965*(fhat[29]+1.732050807568877*(fhat[25]+fhat[23]+fhat[21]-1.0*fhat[18]+3.0*(fhat[5]-1.0*(fhat[4]+fhat[3]+fhat[1])))+3.0*(fhat[15]+fhat[14]+fhat[12]-1.0*(fhat[11]+fhat[9]+fhat[7]+3.0*fhat[0])))*limTheta(rCtrl[7],-1.0); 
  fhatCtrl[8] = 0.01964185503295965*(1.732050807568877*(fhat[25]+fhat[23]+fhat[21]-1.0*fhat[18]+3.0*(fhat[5]-1.0*(fhat[4]+fhat[3]+fhat[1])))-1.0*(fhat[29]+3.0*(fhat[15]+fhat[14]+fhat[12]-1.0*(fhat[11]+fhat[9]+fhat[7]+3.0*fhat[0]))))*limTheta(rCtrl[8],-1.0); 
  fhatCtrl[9] = 0.01964185503295965*(fhat[29]+1.732050807568877*(fhat[25]-1.0*(fhat[23]+fhat[21])+fhat[18]+3.0*(fhat[5]-1.0*(fhat[4]+fhat[3]-1.0*fhat[1])))+3.0*((-1.0*(fhat[15]+fhat[14]))+fhat[12]+fhat[11]-1.0*(fhat[9]+fhat[7]-3.0*fhat[0])))*limTheta(rCtrl[9],-1.0); 
  fhatCtrl[10] = -0.01964185503295965*(1.732050807568877*(fhat[25]-1.0*fhat[23]+fhat[21]-1.0*fhat[18]+3.0*((-1.0*fhat[5])+fhat[4]-1.0*fhat[3]+fhat[1]))-1.0*(fhat[29]+3.0*((-1.0*fhat[15])+fhat[14]-1.0*(fhat[12]+fhat[11]-1.0*fhat[9]+fhat[7])+3.0*fhat[0])))*limTheta(rCtrl[10],-1.0); 
  fhatCtrl[11] = -0.01964185503295965*(fhat[29]+1.732050807568877*(fhat[25]+fhat[23]-1.0*fhat[21]+fhat[18]+3.0*((-1.0*fhat[5])+fhat[4]-1.0*(fhat[3]+fhat[1])))+3.0*(fhat[15]-1.0*(fhat[14]+fhat[12]-1.0*fhat[11])+fhat[9]-1.0*(fhat[7]+3.0*fhat[0])))*limTheta(rCtrl[11],-1.0); 
  fhatCtrl[12] = -0.01964185503295965*(1.732050807568877*(fhat[25]+fhat[23]-1.0*(fhat[21]+fhat[18])+3.0*((-1.0*(fhat[5]+fhat[4]))+fhat[3]+fhat[1]))-1.0*(fhat[29]+3.0*(fhat[15]-1.0*(fhat[14]+fhat[12]+fhat[11]+fhat[9]-1.0*(fhat[7]+3.0*fhat[0])))))*limTheta(rCtrl[12],-1.0); 
  fhatCtrl[13] = -0.01964185503295965*(fhat[29]+1.732050807568877*(fhat[25]-1.0*fhat[23]+fhat[21]+fhat[18]+3.0*((-1.0*(fhat[5]+fhat[4]))+fhat[3]-1.0*fhat[1]))+3.0*((-1.0*fhat[15])+fhat[14]-1.0*fhat[12]+fhat[11]-1.0*fhat[9]+fhat[7]-3.0*fhat[0]))*limTheta(rCtrl[13],-1.0); 
  fhatCtrl[14] = 0.01964185503295965*(1.732050807568877*(fhat[25]-1.0*(fhat[23]+fhat[21]+fhat[18])+3.0*(fhat[5]+fhat[4]+fhat[3]-1.0*fhat[1]))-1.0*(fhat[29]+3.0*((-1.0*(fhat[15]+fhat[14]))+fhat[12]-1.0*fhat[11]+fhat[9]+fhat[7]-3.0*fhat[0])))*limTheta(rCtrl[14],-1.0); 
  fhatCtrl[15] = 0.01964185503295965*(fhat[29]+1.732050807568877*(fhat[25]+fhat[23]+fhat[21]+fhat[18]+3.0*(fhat[5]+fhat[4]+fhat[3]+fhat[1]))+3.0*(fhat[15]+fhat[14]+fhat[12]+fhat[11]+fhat[9]+fhat[7]+3.0*fhat[0]))*limTheta(rCtrl[15],-1.0); 
  double fhatAL[16];  // fhatAL = mode coefficients of anti-limited f on surface 
  fhatAL[0] = 0.25*(fhatCtrl[15]+fhatCtrl[14]+fhatCtrl[13]+fhatCtrl[12]+fhatCtrl[11]+fhatCtrl[10]+fhatCtrl[9]+fhatCtrl[8]+fhatCtrl[7]+fhatCtrl[6]+fhatCtrl[5]+fhatCtrl[4]+fhatCtrl[3]+fhatCtrl[2]+fhatCtrl[1]+fhatCtrl[0]); 
  fhatAL[1] = 0.4330127018922193*(fhatCtrl[15]-1.0*fhatCtrl[14]+fhatCtrl[13]-1.0*fhatCtrl[12]+fhatCtrl[11]-1.0*fhatCtrl[10]+fhatCtrl[9]-1.0*fhatCtrl[8]+fhatCtrl[7]-1.0*fhatCtrl[6]+fhatCtrl[5]-1.0*fhatCtrl[4]+fhatCtrl[3]-1.0*fhatCtrl[2]+fhatCtrl[1]-1.0*fhatCtrl[0]); 
  fhatAL[2] = 0.4330127018922193*(fhatCtrl[15]+fhatCtrl[14]-1.0*(fhatCtrl[13]+fhatCtrl[12])+fhatCtrl[11]+fhatCtrl[10]-1.0*(fhatCtrl[9]+fhatCtrl[8])+fhatCtrl[7]+fhatCtrl[6]-1.0*(fhatCtrl[5]+fhatCtrl[4])+fhatCtrl[3]+fhatCtrl[2]-1.0*(fhatCtrl[1]+fhatCtrl[0])); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  fhatCtrl[0] = -0.01964185503295965*(1.732050807568877*(fhat[24]+fhat[23]+fhat[20]+fhat[17]+3.0*(fhat[5]+fhat[4]+fhat[2]+fhat[1]))-1.0*(fhat[28]+3.0*(fhat[15]+fhat[13]+fhat[12]+fhat[10]+fhat[9]+fhat[6]+3.0*fhat[0])))*limTheta(rCtrl[0],-1.0); 
  fhatCtrl[1] = -0.01964185503295965*(fhat[28]+1.732050807568877*(fhat[24]-1.0*(fhat[23]+fhat[20]+fhat[17])+3.0*(fhat[5]+fhat[4]+fhat[2]-1.0*fhat[1]))+3.0*((-1.0*(fhat[15]+fhat[13]))+fhat[12]-1.0*fhat[10]+fhat[9]+fhat[6]-3.0*fhat[0]))*limTheta(rCtrl[1],-1.0); 
  fhatCtrl[2] = 0.01964185503295965*(1.732050807568877*(fhat[24]-1.0*fhat[23]+fhat[20]+fhat[17]+3.0*((-1.0*(fhat[5]+fhat[4]))+fhat[2]-1.0*fhat[1]))-1.0*(fhat[28]+3.0*((-1.0*fhat[15])+fhat[13]-1.0*fhat[12]+fhat[10]-1.0*fhat[9]+fhat[6]-3.0*fhat[0])))*limTheta(rCtrl[2],-1.0); 
  fhatCtrl[3] = 0.01964185503295965*(fhat[28]+1.732050807568877*(fhat[24]+fhat[23]-1.0*(fhat[20]+fhat[17])+3.0*((-1.0*(fhat[5]+fhat[4]))+fhat[2]+fhat[1]))+3.0*(fhat[15]-1.0*(fhat[13]+fhat[12]+fhat[10]+fhat[9]-1.0*(fhat[6]+3.0*fhat[0]))))*limTheta(rCtrl[3],-1.0); 
  fhatCtrl[4] = 0.01964185503295965*(1.732050807568877*(fhat[24]+fhat[23]-1.0*fhat[20]+fhat[17]+3.0*((-1.0*fhat[5])+fhat[4]-1.0*(fhat[2]+fhat[1])))-1.0*(fhat[28]+3.0*(fhat[15]-1.0*(fhat[13]+fhat[12]-1.0*fhat[10])+fhat[9]-1.0*(fhat[6]+3.0*fhat[0]))))*limTheta(rCtrl[4],-1.0); 
  fhatCtrl[5] = 0.01964185503295965*(fhat[28]+1.732050807568877*(fhat[24]-1.0*fhat[23]+fhat[20]-1.0*fhat[17]+3.0*((-1.0*fhat[5])+fhat[4]-1.0*fhat[2]+fhat[1]))+3.0*((-1.0*fhat[15])+fhat[13]-1.0*(fhat[12]+fhat[10]-1.0*fhat[9]+fhat[6])+3.0*fhat[0]))*limTheta(rCtrl[5],-1.0); 
  fhatCtrl[6] = -0.01964185503295965*(1.732050807568877*(fhat[24]-1.0*(fhat[23]+fhat[20])+fhat[17]+3.0*(fhat[5]-1.0*(fhat[4]+fhat[2]-1.0*fhat[1])))-1.0*(fhat[28]+3.0*((-1.0*(fhat[15]+fhat[13]))+fhat[12]+fhat[10]-1.0*(fhat[9]+fhat[6]-3.0*fhat[0]))))*limTheta(rCtrl[6],-1.0); 
  fhatCtrl[7] = -0.01964185503295965*(fhat[28]+1.732050807568877*(fhat[24]+fhat[23]+fhat[20]-1.0*fhat[17]+3.0*(fhat[5]-1.0*(fhat[4]+fhat[2]+fhat[1])))+3.0*(fhat[15]+fhat[13]+fhat[12]-1.0*(fhat[10]+fhat[9]+fhat[6]+3.0*fhat[0])))*limTheta(rCtrl[7],-1.0); 
  fhatCtrl[8] = 0.01964185503295965*(1.732050807568877*(fhat[24]+fhat[23]+fhat[20]-1.0*fhat[17]+3.0*(fhat[5]-1.0*(fhat[4]+fhat[2]+fhat[1])))-1.0*(fhat[28]+3.0*(fhat[15]+fhat[13]+fhat[12]-1.0*(fhat[10]+fhat[9]+fhat[6]+3.0*fhat[0]))))*limTheta(rCtrl[8],-1.0); 
  fhatCtrl[9] = 0.01964185503295965*(fhat[28]+1.732050807568877*(fhat[24]-1.0*(fhat[23]+fhat[20])+fhat[17]+3.0*(fhat[5]-1.0*(fhat[4]+fhat[2]-1.0*fhat[1])))+3.0*((-1.0*(fhat[15]+fhat[13]))+fhat[12]+fhat[10]-1.0*(fhat[9]+fhat[6]-3.0*fhat[0])))*limTheta(rCtrl[9],-1.0); 
  fhatCtrl[10] = -0.01964185503295965*(1.732050807568877*(fhat[24]-1.0*fhat[23]+fhat[20]-1.0*fhat[17]+3.0*((-1.0*fhat[5])+fhat[4]-1.0*fhat[2]+fhat[1]))-1.0*(fhat[28]+3.0*((-1.0*fhat[15])+fhat[13]-1.0*(fhat[12]+fhat[10]-1.0*fhat[9]+fhat[6])+3.0*fhat[0])))*limTheta(rCtrl[10],-1.0); 
  fhatCtrl[11] = -0.01964185503295965*(fhat[28]+1.732050807568877*(fhat[24]+fhat[23]-1.0*fhat[20]+fhat[17]+3.0*((-1.0*fhat[5])+fhat[4]-1.0*(fhat[2]+fhat[1])))+3.0*(fhat[15]-1.0*(fhat[13]+fhat[12]-1.0*fhat[10])+fhat[9]-1.0*(fhat[6]+3.0*fhat[0])))*limTheta(rCtrl[11],-1.0); 
  fhatCtrl[12] = -0.01964185503295965*(1.732050807568877*(fhat[24]+fhat[23]-1.0*(fhat[20]+fhat[17])+3.0*((-1.0*(fhat[5]+fhat[4]))+fhat[2]+fhat[1]))-1.0*(fhat[28]+3.0*(fhat[15]-1.0*(fhat[13]+fhat[12]+fhat[10]+fhat[9]-1.0*(fhat[6]+3.0*fhat[0])))))*limTheta(rCtrl[12],-1.0); 
  fhatCtrl[13] = -0.01964185503295965*(fhat[28]+1.732050807568877*(fhat[24]-1.0*fhat[23]+fhat[20]+fhat[17]+3.0*((-1.0*(fhat[5]+fhat[4]))+fhat[2]-1.0*fhat[1]))+3.0*((-1.0*fhat[15])+fhat[13]-1.0*fhat[12]+fhat[10]-1.0*fhat[9]+fhat[6]-3.0*fhat[0]))*limTheta(rCtrl[13],-1.0); 
  fhatCtrl[14] = 0.01964185503295965*(1.732050807568877*(fhat[24]-1.0*(fhat[23]+fhat[20]+fhat[17])+3.0*(fhat[5]+fhat[4]+fhat[2]-1.0*fhat[1]))-1.0*(fhat[28]+3.0*((-1.0*(fhat[15]+fhat[13]))+fhat[12]-1.0*fhat[10]+fhat[9]+fhat[6]-3.0*fhat[0])))*limTheta(rCtrl[14],-1.0); 
  fhatCtrl[15] = 0.01964185503295965*(fhat[28]+1.732050807568877*(fhat[24]+fhat[23]+fhat[20]+fhat[17]+3.0*(fhat[5]+fhat[4]+fhat[2]+fhat[1]))+3.0*(fhat[15]+fhat[13]+fhat[12]+fhat[10]+fhat[9]+fhat[6]+3.0*fhat[0]))*limTheta(rCtrl[15],-1.0); 
  double fhatAL[16];  // fhatAL = mode coefficients of anti-limited f on surface 
  fhatAL[0] = 0.25*(fhatCtrl[15]+fhatCtrl[14]+fhatCtrl[13]+fhatCtrl[12]+fhatCtrl[11]+fhatCtrl[10]+fhatCtrl[9]+fhatCtrl[8]+fhatCtrl[7]+fhatCtrl[6]+fhatCtrl[5]+fhatCtrl[4]+fhatCtrl[3]+fhatCtrl[2]+fhatCtrl[1]+fhatCtrl[0]); 
  fhatAL[1] = 0.4330127018922193*(fhatCtrl[15]-1.0*fhatCtrl[14]+fhatCtrl[13]-1.0*fhatCtrl[12]+fhatCtrl[11]-1.0*fhatCtrl[10]+fhatCtrl[9]-1.0*fhatCtrl[8]+fhatCtrl[7]-1.0*fhatCtrl[6]+fhatCtrl[5]-1.0*fhatCtrl[4]+fhatCtrl[3]-1.0*fhatCtrl[2]+fhatCtrl[1]-1.0*fhatCtrl[0]); 
  fhatAL[2] = 0.4330127018922193*(fhatCtrl[15]+fhatCtrl[14]-1.0*(fhatCtrl[13]+fhatCtrl[12])+fhatCtrl[11]+fhatCtrl[10]-1.0*(fhatCtrl[9]+fhatCtrl[8])+fhatCtrl[7]+fhatCtrl[6]-1.0*(fhatCtrl[5]+fhatCtrl[4])+fhatCtrl[3]+fhatCtrl[2]-1.0*(fhatCtrl[1]+fhatCtrl[0])); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  fhatCtrl[0] = -0.01964185503295965*(1.732050807568877*(fhat[22]+fhat[21]+fhat[20]+fhat[16]+3.0*(fhat[5]+fhat[3]+fhat[2]+fhat[1]))-1.0*(fhat[27]+3.0*(fhat[14]+fhat[13]+fhat[12]+fhat[8]+fhat[7]+fhat[6]+3.0*fhat[0])))*limTheta(rCtrl[0],-1.0); 
  fhatCtrl[1] = -0.01964185503295965*(fhat[27]+1.732050807568877*(fhat[22]-1.0*(fhat[21]+fhat[20]+fhat[16])+3.0*(fhat[5]+fhat[3]+fhat[2]-1.0*fhat[1]))+3.0*((-1.0*(fhat[14]+fhat[13]))+fhat[12]-1.0*fhat[8]+fhat[7]+fhat[6]-3.0*fhat[0]))*limTheta(rCtrl[1],-1.0); 
  fhatCtrl[2] = 0.01964185503295965*(1.732050807568877*(fhat[22]-1.0*fhat[21]+fhat[20]+fhat[16]+3.0*((-1.0*(fhat[5]+fhat[3]))+fhat[2]-1.0*fhat[1]))-1.0*(fhat[27]+3.0*((-1.0*fhat[14])+fhat[13]-1.0*fhat[12]+fhat[8]-1.0*fhat[7]+fhat[6]-3.0*fhat[0])))*limTheta(rCtrl[2],-1.0); 
  fhatCtrl[3] = 0.01964185503295965*(fhat[27]+1.732050807568877*(fhat[22]+fhat[21]-1.0*(fhat[20]+fhat[16])+3.0*((-1.0*(fhat[5]+fhat[3]))+fhat[2]+fhat[1]))+3.0*(fhat[14]-1.0*(fhat[13]+fhat[12]+fhat[8]+fhat[7]-1.0*(fhat[6]+3.0*fhat[0]))))*limTheta(rCtrl[3],-1.0); 
  fhatCtrl[4] = 0.01964185503295965*(1.732050807568877*(fhat[22]+fhat[21]-1.0*fhat[20]+fhat[16]+3.0*((-1.0*fhat[5])+fhat[3]-1.0*(fhat[2]+fhat[1])))-1.0*(fhat[27]+3.0*(fhat[14]-1.0*(fhat[13]+fhat[12]-1.0*fhat[8])+fhat[7]-1.0*(fhat[6]+3.0*fhat[0]))))*limTheta(rCtrl[4],-1.0); 
  fhatCtrl[5] = 0.01964185503295965*(fhat[27]+1.732050807568877*(fhat[22]-1.0*fhat[21]+fhat[20]-1.0*fhat[16]+3.0*((-1.0*fhat[5])+fhat[3]-1.0*fhat[2]+fhat[1]))+3.0*((-1.0*fhat[14])+fhat[13]-1.0*(fhat[12]+fhat[8]-1.0*fhat[7]+fhat[6])+3.0*fhat[0]))*limTheta(rCtrl[5],-1.0); 
  fhatCtrl[6] = -0.01964185503295965*(1.732050807568877*(fhat[22]-1.0*(fhat[21]+fhat[20])+fhat[16]+3.0*(fhat[5]-1.0*(fhat[3]+fhat[2]-1.0*fhat[1])))-1.0*(fhat[27]+3.0*((-1.0*(fhat[14]+fhat[13]))+fhat[12]+fhat[8]-1.0*(fhat[7]+fhat[6]-3.0*fhat[0]))))*limTheta(rCtrl[6],-1.0); 
  fhatCtrl[7] = -0.01964185503295965*(fhat[27]+1.732050807568877*(fhat[22]+fhat[21]+fhat[20]-1.0*fhat[16]+3.0*(fhat[5]-1.0*(fhat[3]+fhat[2]+fhat[1])))+3.0*(fhat[14]+fhat[13]+fhat[12]-1.0*(fhat[8]+fhat[7]+fhat[6]+3.0*fhat[0])))*limTheta(rCtrl[7],-1.0); 
  fhatCtrl[8] = 0.01964185503295965*(1.732050807568877*(fhat[22]+fhat[21]+fhat[20]-1.0*fhat[16]+3.0*(fhat[5]-1.0*(fhat[3]+fhat[2]+fhat[1])))-1.0*(fhat[27]+3.0*(fhat[14]+fhat[13]+fhat[12]-1.0*(fhat[8]+fhat[7]+fhat[6]+3.0*fhat[0]))))*limTheta(rCtrl[8],-1.0); 
  fhatCtrl[9] = 0.01964185503295965*(fhat[27]+1.732050807568877*(fhat[22]-1.0*(fhat[21]+fhat[20])+fhat[16]+3.0*(fhat[5]-1.0*(fhat[3]+fhat[2]-1.0*fhat[1])))+3.0*((-1.0*(fhat[14]+fhat[13]))+fhat[12]+fhat[8]-1.0*(fhat[7]+fhat[6]-3.0*fhat[0])))*limTheta(rCtrl[9],-1.0); 
  fhatCtrl[10] = -0.01964185503295965*(1.732050807568877*(fhat[22]-1.0*fhat[21]+fhat[20]-1.0*fhat[16]+3.0*((-1.0*fhat[5])+fhat[3]-1.0*fhat[2]+fhat[1]))-1.0*(fhat[27]+3.0*((-1.0*fhat[14])+fhat[13]-1.0*(fhat[12]+fhat[8]-1.0*fhat[7]+fhat[6])+3.0*fhat[0])))*limTheta(rCtrl[10],-1.0); 
  fhatCtrl[11] = -0.01964185503295965*(fhat[27]+1.732050807568877*(fhat[22]+fhat[21]-1.0*fhat[20]+fhat[16]+3.0*((-1.0*fhat[5])+fhat[3]-1.0*(fhat[2]+fhat[1])))+3.0*(fhat[14]-1.0*(fhat[13]+fhat[12]-1.0*fhat[8])+fhat[7]-1.0*(fhat[6]+3.0*fhat[0])))*limTheta(rCtrl[11],-1.0); 
  fhatCtrl[12] = -0.01964185503295965*(1.732050807568877*(fhat[22]+fhat[21]-1.0*(fhat[20]+fhat[16])+3.0*((-1.0*(fhat[5]+fhat[3]))+fhat[2]+fhat[1]))-1.0*(fhat[27]+3.0*(fhat[14]-1.0*(fhat[13]+fhat[12]+fhat[8]+fhat[7]-1.0*(fhat[6]+3.0*fhat[0])))))*limTheta(rCtrl[12],-1.0); 
  fhatCtrl[13] = -0.01964185503295965*(fhat[27]+1.732050807568877*(fhat[22]-1.0*fhat[21]+fhat[20]+fhat[16]+3.0*((-1.0*(fhat[5]+fhat[3]))+fhat[2]-1.0*fhat[1]))+3.0*((-1.0*fhat[14])+fhat[13]-1.0*fhat[12]+fhat[8]-1.0*fhat[7]+fhat[6]-3.0*fhat[0]))*limTheta(rCtrl[13],-1.0); 
  fhatCtrl[14] = 0.01964185503295965*(1.732050807568877*(fhat[22]-1.0*(fhat[21]+fhat[20]+fhat[16])+3.0*(fhat[5]+fhat[3]+fhat[2]-1.0*fhat[1]))-1.0*(fhat[27]+3.0*((-1.0*(fhat[14]+fhat[13]))+fhat[12]-1.0*fhat[8]+fhat[7]+fhat[6]-3.0*fhat[0])))*limTheta(rCtrl[14],-1.0); 
  fhatCtrl[15] = 0.01964185503295965*(fhat[27]+1.732050807568877*(fhat[22]+fhat[21]+fhat[20]+fhat[16]+3.0*(fhat[5]+fhat[3]+fhat[2]+fhat[1]))+3.0*(fhat[14]+fhat[13]+fhat[12]+fhat[8]+fhat[7]+fhat[6]+3.0*fhat[0]))*limTheta(rCtrl[15],-1.0); 
  double fhatAL[16];  // fhatAL = mode coefficients of anti-limited f on surface 
  fhatAL[0] = 0.25*(fhatCtrl[15]+fhatCtrl[14]+fhatCtrl[13]+fhatCtrl[12]+fhatCtrl[11]+fhatCtrl[10]+fhatCtrl[9]+fhatCtrl[8]+fhatCtrl[7]+fhatCtrl[6]+fhatCtrl[5]+fhatCtrl[4]+fhatCtrl[3]+fhatCtrl[2]+fhatCtrl[1]+fhatCtrl[0]); 
  fhatAL[1] = 0.4330127018922193*(fhatCtrl[15]-1.0*fhatCtrl[14]+fhatCtrl[13]-1.0*fhatCtrl[12]+fhatCtrl[11]-1.0*fhatCtrl[10]+fhatCtrl[9]-1.0*fhatCtrl[8]+fhatCtrl[7]-1.0*fhatCtrl[6]+fhatCtrl[5]-1.0*fhatCtrl[4]+fhatCtrl[3]-1.0*fhatCtrl[2]+fhatCtrl[1]-1.0*fhatCtrl[0]); 
  fhatAL[2] = 0.4330127018922193*(fhatCtrl[15]+fhatCtrl[14]-1.0*(fhatCtrl[13]+fhatCtrl[12])+fhatCtrl[11]+fhatCtrl[10]-1.0*(fhatCtrl[9]+fhatCtrl[8])+fhatCtrl[7]+fhatCtrl[6]-1.0*(fhatCtrl[5]+fhatCtrl[4])+fhatCtrl[3]+fhatCtrl[2]-1.0*(fhatCtrl[1]+fhatCtrl[0])); 
  ...
  // enforce limiters at surface quadrature nodes 
  double fhatALQuad[16]; 
  fhatALQuad[0] = std::max(0., std::min(0.25*((-0.5773502691896258*((-1.732050807568878*(fhatAL[15]+fhatAL[7]))-1.732050807568877*(fhatAL[10]+fhatAL[6])))-1.0*(1.0*(fhatAL[14]+fhatAL[11])+fhatAL[13]+fhatAL[12]+fhatAL[4]+fhatAL[3]+fhatAL[2]+fhatAL[1])+1.0*(fhatAL[9]+fhatAL[5])+fhatAL[8]+fhatAL[0]), limQuad[0])); 
  fhatALQuad[1] = std::max(0., std::min(0.25*((-0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15]))-1.732050807568877*fhatAL[10]+1.732050807568877*fhatAL[6]))+1.732050807568877*(0.5773502691896258*fhatAL[1]-0.5773502691896258*((-0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[14]))-1.0*(fhatAL[13]+fhatAL[12])+fhatAL[4]+fhatAL[3]+fhatAL[2]))-0.5773502691896258*(1.732050807568877*fhatAL[5]-1.732050807568877*fhatAL[9])-1.0*fhatAL[8]+fhatAL[0]), limQuad[1])); 
  ...
  fhatALQuad[3] = std::max(0., std::min(0.25*((-0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15])-1.732050807568877*fhatAL[10]+1.732050807568877*fhatAL[6]))+1.732050807568877*((-0.5773502691896258*(0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[14])-1.0*fhatAL[13]+fhatAL[3]))+0.5773502691896258*(fhatAL[2]-1.0*fhatAL[12])-0.5773502691896258*fhatAL[4]+0.5773502691896258*fhatAL[1])+0.5773502691896258*(1.732050807568877*fhatAL[5]-1.732050807568877*fhatAL[9])-1.0*fhatAL[8]+fhatAL[0]), limQuad[3])); 
  fhatALQuad[4] = std::max(0., std::min(0.25*(0.5773502691896258*((-1.732050807568878*(fhatAL[15]+fhatAL[7]))-1.732050807568877*(fhatAL[10]+fhatAL[6]))+1.732050807568877*(0.5773502691896258*(1.0*(fhatAL[14]+fhatAL[11])+fhatAL[13]+fhatAL[3])-0.5773502691896258*(fhatAL[12]+fhatAL[4]+fhatAL[2]+fhatAL[1]))+1.0*(fhatAL[9]+fhatAL[5])+fhatAL[8]+fhatAL[0]), limQuad[4])); 
  fhatALQuad[5] = std::max(0., std::min(0.25*(0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15]))-1.732050807568877*fhatAL[10]+1.732050807568877*fhatAL[6])+1.732050807568877*(0.5773502691896258*((-0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[14]))-1.0*fhatAL[13]+fhatAL[3])-0.5773502691896258*((-1.0*fhatAL[12])+fhatAL[4]+fhatAL[2])+0.5773502691896258*fhatAL[1])-0.5773502691896258*(1.732050807568877*fhatAL[5]-1.732050807568877*fhatAL[9])-1.0*fhatAL[8]+fhatAL[0]), limQuad[5])); 
  fhatALQuad[6] = std::max(0., std::min(0.25*(0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[7])-1.732050807568877*(fhatAL[10]+fhatAL[6]))+1.732050807568877*(0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[11]))+fhatAL[13]+fhatAL[12]+fhatAL[3]+fhatAL[2])-0.5773502691896258*(fhatAL[4]+fhatAL[1]))-1.0*(fhatAL[9]+fhatAL[5])+fhatAL[8]+fhatAL[0]), limQuad[6])); 
  fhatALQuad[7] = std::max(0., std::min(0.25*(0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15])-1.732050807568877*fhatAL[10]+1.732050807568877*fhatAL[6])+1.732050807568877*(0.5773502691896258*(0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[14])-1.0*(fhatAL[13]+fhatAL[12])+fhatAL[3]+fhatAL[2])-0.5773502691896258*fhatAL[4]+0.5773502691896258*fhatAL[1])+0.5773502691896258*(1.732050807568877*fhatAL[5]-1.732050807568877*fhatAL[9])-1.0*fhatAL[8]+fhatAL[0]), limQuad[7])); 
  fhatALQuad[8] = std::max(0., std::min(0.25*((-0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15]))+1.732050807568877*fhatAL[10]-1.732050807568877*fhatAL[6]))+1.732050807568877*((-0.5773502691896258*((-0.5773502691896258*(1.732050807568877*fhatAL[14]-1.732050807568877*fhatAL[11]))-1.0*(fhatAL[13]+fhatAL[12])+fhatAL[3]+fhatAL[2]))+0.5773502691896258*fhatAL[4]-0.5773502691896258*fhatAL[1])-0.5773502691896258*(1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[5])-1.0*fhatAL[8]+fhatAL[0]), limQuad[8])); 
  fhatALQuad[9] = std::max(0., std::min(0.25*((-0.5773502691896258*(1.732050807568877*(fhatAL[10]+fhatAL[6])-1.732050807568878*(fhatAL[15]+fhatAL[7])))+1.732050807568877*(0.5773502691896258*(fhatAL[4]+fhatAL[1])-0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[11]))+fhatAL[13]+fhatAL[12]+fhatAL[3]+fhatAL[2]))-1.0*(fhatAL[9]+fhatAL[5])+fhatAL[8]+fhatAL[0]), limQuad[9])); 
  fhatALQuad[10] = std::max(0., std::min(0.25*((-0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15])+1.732050807568877*fhatAL[10]-1.732050807568877*fhatAL[6]))+1.732050807568877*((-0.5773502691896258*(0.5773502691896258*(1.732050807568877*fhatAL[14]-1.732050807568877*fhatAL[11])-1.0*fhatAL[13]+fhatAL[3]))+0.5773502691896258*((-1.0*fhatAL[12])+fhatAL[4]+fhatAL[2])-0.5773502691896258*fhatAL[1])+0.5773502691896258*(1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[5])-1.0*fhatAL[8]+fhatAL[0]), limQuad[10])); 
  fhatALQuad[11] = std::max(0., std::min(0.25*((-0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[7])+1.732050807568877*(fhatAL[10]+fhatAL[6])))+1.732050807568877*(0.5773502691896258*(fhatAL[12]+fhatAL[4]+fhatAL[2]+fhatAL[1])-0.5773502691896258*(1.0*(fhatAL[14]+fhatAL[11])+fhatAL[13]+fhatAL[3]))+1.0*(fhatAL[9]+fhatAL[5])+fhatAL[8]+fhatAL[0]), limQuad[11])); 
  fhatALQuad[12] = std::max(0., std::min(0.25*(0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15]))+1.732050807568877*fhatAL[10]-1.732050807568877*fhatAL[6])+1.732050807568877*(0.5773502691896258*((-0.5773502691896258*(1.732050807568877*fhatAL[14]-1.732050807568877*fhatAL[11]))-1.0*fhatAL[13]+fhatAL[3])-0.5773502691896258*(fhatAL[2]-1.0*fhatAL[12])+0.5773502691896258*fhatAL[4]-0.5773502691896258*fhatAL[1])-0.5773502691896258*(1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[5])-1.0*fhatAL[8]+fhatAL[0]), limQuad[12])); 
  fhatALQuad[13] = std::max(0., std::min(0.25*(0.5773502691896258*(1.732050807568877*(fhatAL[10]+fhatAL[6])-1.732050807568878*(fhatAL[15]+fhatAL[7]))+1.732050807568877*(0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[11]))+fhatAL[13]+fhatAL[3])-0.5773502691896258*(fhatAL[12]+fhatAL[2])+0.5773502691896258*(fhatAL[4]+fhatAL[1]))-1.0*(fhatAL[9]+fhatAL[5])+fhatAL[8]+fhatAL[0]), limQuad[13])); 
  fhatALQuad[14] = std::max(0., std::min(0.25*(0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15])+1.732050807568877*fhatAL[10]-1.732050807568877*fhatAL[6])+1.732050807568877*(0.5773502691896258*(0.5773502691896258*(1.732050807568877*fhatAL[14]-1.732050807568877*fhatAL[11])-1.0*(fhatAL[13]+fhatAL[12])+fhatAL[4]+fhatAL[3]+fhatAL[2])-0.5773502691896258*fhatAL[1])+0.5773502691896258*(1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[5])-1.0*fhatAL[8]+fhatAL[0]), limQuad[14])); 
  fhatALQuad[15] = std::max(0., std::min(0.25*(0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[7])+1.732050807568877*(fhatAL[10]+fhatAL[6]))+1.0*(1.0*(fhatAL[14]+fhatAL[11])+fhatAL[13]+fhatAL[12]+fhatAL[9]+fhatAL[5]+fhatAL[4]+fhatAL[3]+fhatAL[2]+fhatAL[1])+fhatAL[8]+fhatAL[0]), limQuad[15])); 
  fhatAL[0] = 0.25*(fhatALQuad[15]+fhatALQuad[14]+fhatALQuad[13]+fhatALQuad[12]+fhatALQuad[11]+fhatALQuad[10]+fhatALQuad[9]+fhatALQuad[8]+fhatALQuad[7]+fhatALQuad[6]+fhatALQuad[5]+fhatALQuad[4]+fhatALQuad[3]+fhatALQuad[2]+fhatALQuad[1]+fhatALQuad[0]); 
  fhatAL[1] = 0.25*(fhatALQuad[15]-1.0*fhatALQuad[14]+fhatALQuad[13]-1.0*fhatALQuad[12]+fhatALQuad[11]-1.0*fhatALQuad[10]+fhatALQuad[9]-1.0*fhatALQuad[8]+fhatALQuad[7]-1.0*fhatALQuad[6]+fhatALQuad[5]-1.0*fhatALQuad[4]+fhatALQuad[3]-1.0*fhatALQuad[2]+fhatALQuad[1]-1.0*fhatALQuad[0]); 
  fhatAL[2] = 0.25*(fhatALQuad[15]+fhatALQuad[14]-1.0*(fhatALQuad[13]+fhatALQuad[12])+fhatALQuad[11]+fhatALQuad[10]-1.0*(fhatALQuad[9]+fhatALQuad[8])+fhatALQuad[7]+fhatALQuad[6]-1.0*(fhatALQuad[5]+fhatALQuad[4])+fhatALQuad[3]+fhatALQuad[2]-1.0*(fhatALQuad[1]+fhatALQuad[0])); 
  fhatAL[3] = 0.25*(fhatALQuad[15]+fhatALQuad[14]+fhatALQuad[13]+fhatALQuad[12]-1.0*(fhatALQuad[11]+fhatALQuad[10]+fhatALQuad[9]+fhatALQuad[8])+fhatALQuad[7]+fhatALQuad[6]+fhatALQuad[5]+fhatALQuad[4]-1.0*(fhatALQuad[3]+fhatALQuad[2]+fhatALQuad[1]+fhatALQuad[0])); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double fhatCtrl[16];  // fhatCtrl = anti-limited fhat evaluated at each control node on x surface 
  fhatCtrl[0] = -0.01964185503295965*(1.732050807568877*(fhat[25]+fhat[24]+fhat[22]+fhat[19]+3.0*(fhat[5]+fhat[4]+fhat[3]+fhat[2]))-1.0*(fhat[30]+3.0*(fhat[15]+fhat[14]+fhat[13]+fhat[11]+fhat[10]+fhat[8]+3.0*fhat[0])))*limTheta(rCtrl[0],-1.0); 
  fhatCtrl[1] = -0.01964185503295965*(fhat[30]+1.732050807568877*(fhat[25]-1.0*(fhat[24]+fhat[22]+fhat[19])+3.0*(fhat[5]+fhat[4]+fhat[3]-1.0*fhat[2]))+3.0*((-1.0*(fhat[15]+fhat[14]))+fhat[13]-1.0*fhat[11]+fhat[10]+fhat[8]-3.0*fhat[0]))*limTheta(rCtrl[1],-1.0); 
  fhatCtrl[2] = 0.01964185503295965*(1.732050807568877*(fhat[25]-1.0*fhat[24]+fhat[22]+fhat[19]+3.0*((-1.0*(fhat[5]+fhat[4]))+fhat[3]-1.0*fhat[2]))-1.0*(fhat[30]+3.0*((-1.0*fhat[15])+fhat[14]-1.0*fhat[13]+fhat[11]-1.0*fhat[10]+fhat[8]-3.0*fhat[0])))*limTheta(rCtrl[2],-1.0); 
  fhatCtrl[3] = 0.01964185503295965*(fhat[30]+1.732050807568877*(fhat[25]+fhat[24]-1.0*(fhat[22]+fhat[19])+3.0*((-1.0*(fhat[5]+fhat[4]))+fhat[3]+fhat[2]))+3.0*(fhat[15]-1.0*(fhat[14]+fhat[13]+fhat[11]+fhat[10]-1.0*(fhat[8]+3.0*fhat[0]))))*limTheta(rCtrl[3],-1.0); 
  fhatCtrl[4] = 0.01964185503295965*(1.732050807568877*(fhat[25]+fhat[24]-1.0*fhat[22]+fhat[19]+3.0*((-1.0*fhat[5])+fhat[4]-1.0*(fhat[3]+fhat[2])))-1.0*(fhat[30]+3.0*(fhat[15]-1.0*(fhat[14]+fhat[13]-1.0*fhat[11])+fhat[10]-1.0*(fhat[8]+3.0*fhat[0]))))*limTheta(rCtrl[4],-1.0); 
  fhatCtrl[5] = 0.01964185503295965*(fhat[30]+1.732050807568877*(fhat[25]-1.0*fhat[24]+fhat[22]-1.0*fhat[19]+3.0*((-1.0*fhat[5])+fhat[4]-1.0*fhat[3]+fhat[2]))+3.0*((-1.0*fhat[15])+fhat[14]-1.0*(fhat[13]+fhat[11]-1.0*fhat[10]+fhat[8])+3.0*fhat[0]))*limTheta(rCtrl[5],-1.0); 
  fhatCtrl[6] = -0.01964185503295965*(1.732050807568877*(fhat[25]-1.0*(fhat[24]+fhat[22])+fhat[19]+3.0*(fhat[5]-1.0*(fhat[4]+fhat[3]-1.0*fhat[2])))-1.0*(fhat[30]+3.0*((-1.0*(fhat[15]+fhat[14]))+fhat[13]+fhat[11]-1.0*(fhat[10]+fhat[8]-3.0*fhat[0]))))*limTheta(rCtrl[6],-1.0); 
  fhatCtrl[7] = -0.01964185503295965*(fhat[30]+1.732050807568877*(fhat[25]+fhat[24]+fhat[22]-1.0*fhat[19]+3.0*(fhat[5]-1.0*(fhat[4]+fhat[3]+fhat[2])))+3.0*(fhat[15]+fhat[14]+fhat[13]-1.0*(fhat[11]+fhat[10]+fhat[8]+3.0*fhat[0])))*limTheta(rCtrl[7],-1.0); 
  fhatCtrl[8] = 0.01964185503295965*(1.732050807568877*(fhat[25]+fhat[24]+fhat[22]-1.0*fhat[19]+3.0*(fhat[5]-1.0*(fhat[4]+fhat[3]+fhat[2])))-1.0*(fhat[30]+3.0*(fhat[15]+fhat[14]+fhat[13]-1.0*(fhat[11]+fhat[10]+fhat[8]+3.0*fhat[0]))))*limTheta(rCtrl[8],-1.0); 
  fhatCtrl[9] = 0.01964185503295965*(fhat[30]+1.732050807568877*(fhat[25]-1.0*(fhat[24]+fhat[22])+fhat[19]+3.0*(fhat[5]-1.0*(fhat[4]+fhat[3]-1.0*fhat[2])))+3.0*((-1.0*(fhat[15]+fhat[14]))+fhat[13]+fhat[11]-1.0*(fhat[10]+fhat[8]-3.0*fhat[0])))*limTheta(rCtrl[9],-1.0); 
  fhatCtrl[10] = -0.01964185503295965*(1.732050807568877*(fhat[25]-1.0*fhat[24]+fhat[22]-1.0*fhat[19]+3.0*((-1.0*fhat[5])+fhat[4]-1.0*fhat[3]+fhat[2]))-1.0*(fhat[30]+3.0*((-1.0*fhat[15])+fhat[14]-1.0*(fhat[13]+fhat[11]-1.0*fhat[10]+fhat[8])+3.0*fhat[0])))*limTheta(rCtrl[10],-1.0); 
  fhatCtrl[11] = -0.01964185503295965*(fhat[30]+1.732050807568877*(fhat[25]+fhat[24]-1.0*fhat[22]+fhat[19]+3.0*((-1.0*fhat[5])+fhat[4]-1.0*(fhat[3]+fhat[2])))+3.0*(fhat[15]-1.0*(fhat[14]+fhat[13]-1.0*fhat[11])+fhat[10]-1.0*(fhat[8]+3.0*fhat[0])))*limTheta(rCtrl[11],-1.0); 
  fhatCtrl[12] = -0.01964185503295965*(1.732050807568877*(fhat[25]+fhat[24]-1.0*(fhat[22]+fhat[19])+3.0*((-1.0*(fhat[5]+fhat[4]))+fhat[3]+fhat[2]))-1.0*(fhat[30]+3.0*(fhat[15]-1.0*(fhat[14]+fhat[13]+fhat[11]+fhat[10]-1.0*(fhat[8]+3.0*fhat[0])))))*limTheta(rCtrl[12],-1.0); 
  fhatCtrl[13] = -0.01964185503295965*(fhat[30]+1.732050807568877*(fhat[25]-1.0*fhat[24]+fhat[22]+fhat[19]+3.0*((-1.0*(fhat[5]+fhat[4]))+fhat[3]-1.0*fhat[2]))+3.0*((-1.0*fhat[15])+fhat[14]-1.0*fhat[13]+fhat[11]-1.0*fhat[10]+fhat[8]-3.0*fhat[0]))*limTheta(rCtrl[13],-1.0); 
  fhatCtrl[14] = 0.01964185503295965*(1.732050807568877*(fhat[25]-1.0*(fhat[24]+fhat[22]+fhat[19])+3.0*(fhat[5]+fhat[4]+fhat[3]-1.0*fhat[2]))-1.0*(fhat[30]+3.0*((-1.0*(fhat[15]+fhat[14]))+fhat[13]-1.0*fhat[11]+fhat[10]+fhat[8]-3.0*fhat[0])))*limTheta(rCtrl[14],-1.0); 
  fhatCtrl[15] = 0.01964185503295965*(fhat[30]+1.732050807568877*(fhat[25]+fhat[24]+fhat[22]+fhat[19]+3.0*(fhat[5]+fhat[4]+fhat[3]+fhat[2]))+3.0*(fhat[15]+fhat[14]+fhat[13]+fhat[11]+fhat[10]+fhat[8]+3.0*fhat[0]))*limTheta(rCtrl[15],-1.0); 
  double fhatAL[16];  // fhatAL = mode coefficients of anti-limited f on surface 
  fhatAL[0] = 0.25*(fhatCtrl[15]+fhatCtrl[14]+fhatCtrl[13]+fhatCtrl[12]+fhatCtrl[11]+fhatCtrl[10]+fhatCtrl[9]+fhatCtrl[8]+fhatCtrl[7]+fhatCtrl[6]+fhatCtrl[5]+fhatCtrl[4]+fhatCtrl[3]+fhatCtrl[2]+fhatCtrl[1]+fhatCtrl[0]); 
  fhatAL[1] = 0.4330127018922193*(fhatCtrl[15]-1.0*fhatCtrl[14]+fhatCtrl[13]-1.0*fhatCtrl[12]+fhatCtrl[11]-1.0*fhatCtrl[10]+fhatCtrl[9]-1.0*fhatCtrl[8]+fhatCtrl[7]-1.0*fhatCtrl[6]+fhatCtrl[5]-1.0*fhatCtrl[4]+fhatCtrl[3]-1.0*fhatCtrl[2]+fhatCtrl[1]-1.0*fhatCtrl[0]); 
  fhatAL[2] = 0.4330127018922193*(fhatCtrl[15]+fhatCtrl[14]-1.0*(fhatCtrl[13]+fhatCtrl[12])+fhatCtrl[11]+fhatCtrl[10]-1.0*(fhatCtrl[9]+fhatCtrl[8])+fhatCtrl[7]+fhatCtrl[6]-1.0*(fhatCtrl[5]+fhatCtrl[4])+fhatCtrl[3]+fhatCtrl[2]-1.0*(fhatCtrl[1]+fhatCtrl[0])); 
