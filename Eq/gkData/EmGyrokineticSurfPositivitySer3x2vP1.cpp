...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alpha0 = (0.0625*(2.828427124746191*BdriftX[0]*m_*wv2+q_*((BmagInv[0]*(1.732050807568877*Apar[2]-3.0*Apar[4])*dfac_y+BdriftX[0]*(Apar[0]-1.732050807568877*Apar[1]))*wv+BmagInv[0]*(3.0*Phi[4]-1.732050807568877*Phi[2])*dfac_y)))/q_; 

  double alpha[16]; 
  alpha[0] = (0.5*(2.828427124746191*BdriftX[0]*m_*wv2+q_*((BmagInv[0]*(1.732050807568877*Apar[2]-3.0*Apar[4])*dfac_y+BdriftX[0]*(Apar[0]-1.732050807568877*Apar[1]))*wv+BmagInv[0]*(3.0*Phi[4]-1.732050807568877*Phi[2])*dfac_y)))/q_; 
  alpha[1] = -0.5*BdriftX[0]*(1.732050807568877*Apar[4]-1.0*Apar[2])*wv; 
  alpha[2] = -0.2886751345948129*((BmagInv[0]*(5.196152422706631*Apar[7]-3.0*Apar[6])*dfac_y+BdriftX[0]*(3.0*Apar[5]-1.732050807568877*Apar[3]))*wv+BmagInv[0]*(3.0*Phi[6]-5.196152422706631*Phi[7])*dfac_y); 
  alpha[3] = (0.8164965809277261*BdriftX[0]*m_*wv)/(dfac_v*q_); 
  alpha[5] = -0.5*BdriftX[0]*(1.732050807568877*Apar[7]-1.0*Apar[6])*wv; 
  double f0Quad[16]; 
  double f1Quad[16]; 
  double limQuad[16]; 
  // determine upwinding at each surface quadrature node 
  if(0.25*alpha[5]-0.25*(alpha[3]+alpha[2]+alpha[1])+0.25*alpha[0] > 0) {
    ...
    limQuad[0] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[0] = fr[0]/cflR/5.656854249492382; 
  }
  if(0.25*(alpha[1]+alpha[0])-0.25*(alpha[5]+alpha[3]+alpha[2]) > 0) {
    ...
    limQuad[1] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[1] = fr[0]/cflR/5.656854249492382; 
  }
  if((-0.25*(alpha[5]+alpha[3]))+0.25*alpha[2]-0.25*alpha[1]+0.25*alpha[0] > 0) {
    ...
    limQuad[2] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[2] = fr[0]/cflR/5.656854249492382; 
  }
  if(0.25*alpha[5]-0.25*alpha[3]+0.25*(alpha[2]+alpha[1]+alpha[0]) > 0) {
    ...
    limQuad[3] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[3] = fr[0]/cflR/5.656854249492382; 
  }
  if(0.25*(alpha[5]+alpha[3])-0.25*(alpha[2]+alpha[1])+0.25*alpha[0] > 0) {
    ...
    limQuad[4] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[4] = fr[0]/cflR/5.656854249492382; 
  }
  if((-0.25*alpha[5])+0.25*alpha[3]-0.25*alpha[2]+0.25*(alpha[1]+alpha[0]) > 0) {
    ...
    limQuad[5] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[5] = fr[0]/cflR/5.656854249492382; 
  }
  if((-0.25*alpha[5])+0.25*(alpha[3]+alpha[2])-0.25*alpha[1]+0.25*alpha[0] > 0) {
    ...
    limQuad[6] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[6] = fr[0]/cflR/5.656854249492382; 
  }
  if(0.25*(alpha[5]+alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) {
    ...
    limQuad[7] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[7] = fr[0]/cflR/5.656854249492382; 
  }
  if(0.25*alpha[5]-0.25*(alpha[3]+alpha[2]+alpha[1])+0.25*alpha[0] > 0) {
    ...
    limQuad[8] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[8] = fr[0]/cflR/5.656854249492382; 
  }
  if(0.25*(alpha[1]+alpha[0])-0.25*(alpha[5]+alpha[3]+alpha[2]) > 0) {
    ...
    limQuad[9] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[9] = fr[0]/cflR/5.656854249492382; 
  }
  if((-0.25*(alpha[5]+alpha[3]))+0.25*alpha[2]-0.25*alpha[1]+0.25*alpha[0] > 0) {
    ...
    limQuad[10] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[10] = fr[0]/cflR/5.656854249492382; 
  }
  if(0.25*alpha[5]-0.25*alpha[3]+0.25*(alpha[2]+alpha[1]+alpha[0]) > 0) {
    ...
    limQuad[11] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[11] = fr[0]/cflR/5.656854249492382; 
  }
  if(0.25*(alpha[5]+alpha[3])-0.25*(alpha[2]+alpha[1])+0.25*alpha[0] > 0) {
    ...
    limQuad[12] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[12] = fr[0]/cflR/5.656854249492382; 
  }
  if((-0.25*alpha[5])+0.25*alpha[3]-0.25*alpha[2]+0.25*(alpha[1]+alpha[0]) > 0) {
    ...
    limQuad[13] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[13] = fr[0]/cflR/5.656854249492382; 
  }
  if((-0.25*alpha[5])+0.25*(alpha[3]+alpha[2])-0.25*alpha[1]+0.25*alpha[0] > 0) {
    ...
    limQuad[14] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[14] = fr[0]/cflR/5.656854249492382; 
  }
  if(0.25*(alpha[5]+alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) {
    ...
    limQuad[15] = fl[0]/cflL/5.656854249492382; 
  } else {
    ...
    limQuad[15] = fr[0]/cflR/5.656854249492382; 
  }
  ...
  fhatALQuad[0] = fmax(0.0, fmin(0.25*((-0.5773502691896258*((-1.732050807568878*(fhatAL[15]+fhatAL[5]))-1.732050807568877*(fhatAL[9]+fhatAL[7])))-1.0*(fhatAL[14]+fhatAL[13]+1.0*(fhatAL[12]+fhatAL[11])+fhatAL[4]+fhatAL[3]+fhatAL[2]+fhatAL[1])+fhatAL[10]+1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[0])); 
  fhatALQuad[1] = fmax(0.0, fmin(0.25*((-0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[5])-1.732050807568877*(fhatAL[9]+fhatAL[7])))+1.732050807568877*((-0.5773502691896258*(fhatAL[14]-1.0*(fhatAL[12]+fhatAL[11])+fhatAL[2]))+0.5773502691896258*(fhatAL[13]+fhatAL[1])-0.5773502691896258*(fhatAL[4]+fhatAL[3]))+fhatAL[10]-1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[1])); 
  fhatALQuad[2] = fmax(0.0, fmin(0.25*(0.5773502691896258*((-1.732050807568878*(fhatAL[15]+fhatAL[5]))-1.732050807568877*(fhatAL[9]+fhatAL[7]))+1.732050807568877*(0.5773502691896258*(fhatAL[14]+1.0*(fhatAL[12]+fhatAL[11])+fhatAL[2])-0.5773502691896258*(fhatAL[13]+fhatAL[4]+fhatAL[3]+fhatAL[1]))+fhatAL[10]+1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[2])); 
  fhatALQuad[3] = fmax(0.0, fmin(0.25*(0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[5])-1.732050807568877*(fhatAL[9]+fhatAL[7]))+1.732050807568877*(0.5773502691896258*(fhatAL[14]+fhatAL[13]-1.0*(fhatAL[12]+fhatAL[11])+fhatAL[2]+fhatAL[1])-0.5773502691896258*(fhatAL[4]+fhatAL[3]))+fhatAL[10]-1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[3])); 
  fhatALQuad[4] = fmax(0.0, fmin(0.25*((-0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15]))-1.732050807568877*fhatAL[9]+1.732050807568877*fhatAL[7]))+1.732050807568877*(0.5773502691896258*fhatAL[3]-0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[13]))-0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[12])+fhatAL[4]+fhatAL[2]+fhatAL[1]))-1.0*fhatAL[10]-0.5773502691896258*(1.732050807568877*fhatAL[6]-1.732050807568877*fhatAL[8])+fhatAL[0]), limQuad[4])); 
  fhatALQuad[5] = fmax(0.0, fmin(0.25*((-0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15])-1.732050807568877*fhatAL[9]+1.732050807568877*fhatAL[7]))+1.732050807568877*((-0.5773502691896258*((-1.0*fhatAL[14])+0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[12])+fhatAL[2]))+0.5773502691896258*(fhatAL[1]-1.0*fhatAL[13])-0.5773502691896258*fhatAL[4]+0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]+0.5773502691896258*(1.732050807568877*fhatAL[6]-1.732050807568877*fhatAL[8])+fhatAL[0]), limQuad[5])); 
  fhatALQuad[6] = fmax(0.0, fmin(0.25*(0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15]))-1.732050807568877*fhatAL[9]+1.732050807568877*fhatAL[7])+1.732050807568877*(0.5773502691896258*((-1.0*fhatAL[14])-0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[12])+fhatAL[2])-0.5773502691896258*((-1.0*fhatAL[13])+fhatAL[4]+fhatAL[1])+0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]-0.5773502691896258*(1.732050807568877*fhatAL[6]-1.732050807568877*fhatAL[8])+fhatAL[0]), limQuad[6])); 
  fhatALQuad[7] = fmax(0.0, fmin(0.25*(0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15])-1.732050807568877*fhatAL[9]+1.732050807568877*fhatAL[7])+1.732050807568877*(0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[13]))+0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[12])+fhatAL[2]+fhatAL[1])-0.5773502691896258*fhatAL[4]+0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]+0.5773502691896258*(1.732050807568877*fhatAL[6]-1.732050807568877*fhatAL[8])+fhatAL[0]), limQuad[7])); 
  fhatALQuad[8] = fmax(0.0, fmin(0.25*((-0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15]))+1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[7]))+1.732050807568877*((-0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[13]))-0.5773502691896258*(1.732050807568877*fhatAL[12]-1.732050807568877*fhatAL[11])+fhatAL[2]+fhatAL[1]))+0.5773502691896258*fhatAL[4]-0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]-0.5773502691896258*(1.732050807568877*fhatAL[8]-1.732050807568877*fhatAL[6])+fhatAL[0]), limQuad[8])); 
  fhatALQuad[9] = fmax(0.0, fmin(0.25*((-0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15])+1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[7]))+1.732050807568877*((-0.5773502691896258*((-1.0*fhatAL[14])+0.5773502691896258*(1.732050807568877*fhatAL[12]-1.732050807568877*fhatAL[11])+fhatAL[2]))+0.5773502691896258*((-1.0*fhatAL[13])+fhatAL[4]+fhatAL[1])-0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]+0.5773502691896258*(1.732050807568877*fhatAL[8]-1.732050807568877*fhatAL[6])+fhatAL[0]), limQuad[9])); 
  fhatALQuad[10] = fmax(0.0, fmin(0.25*(0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15]))+1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[7])+1.732050807568877*(0.5773502691896258*((-1.0*fhatAL[14])-0.5773502691896258*(1.732050807568877*fhatAL[12]-1.732050807568877*fhatAL[11])+fhatAL[2])-0.5773502691896258*(fhatAL[1]-1.0*fhatAL[13])+0.5773502691896258*fhatAL[4]-0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]-0.5773502691896258*(1.732050807568877*fhatAL[8]-1.732050807568877*fhatAL[6])+fhatAL[0]), limQuad[10])); 
  fhatALQuad[11] = fmax(0.0, fmin(0.25*(0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[5]-3.0*fhatAL[15])+1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[7])+1.732050807568877*(0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[13]))+0.5773502691896258*(1.732050807568877*fhatAL[12]-1.732050807568877*fhatAL[11])+fhatAL[4]+fhatAL[2]+fhatAL[1])-0.5773502691896258*fhatAL[3])-1.0*fhatAL[10]+0.5773502691896258*(1.732050807568877*fhatAL[8]-1.732050807568877*fhatAL[6])+fhatAL[0]), limQuad[11])); 
  fhatALQuad[12] = fmax(0.0, fmin(0.25*((-0.5773502691896258*(1.732050807568877*(fhatAL[9]+fhatAL[7])-1.732050807568878*(fhatAL[15]+fhatAL[5])))+1.732050807568877*(0.5773502691896258*(fhatAL[4]+fhatAL[3])-0.5773502691896258*(fhatAL[14]+fhatAL[13]-1.0*(fhatAL[12]+fhatAL[11])+fhatAL[2]+fhatAL[1]))+fhatAL[10]-1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[12])); 
  fhatALQuad[13] = fmax(0.0, fmin(0.25*((-0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[5])+1.732050807568877*(fhatAL[9]+fhatAL[7])))+1.732050807568877*(0.5773502691896258*(fhatAL[13]+fhatAL[4]+fhatAL[3]+fhatAL[1])-0.5773502691896258*(fhatAL[14]+1.0*(fhatAL[12]+fhatAL[11])+fhatAL[2]))+fhatAL[10]+1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[13])); 
  fhatALQuad[14] = fmax(0.0, fmin(0.25*(0.5773502691896258*(1.732050807568877*(fhatAL[9]+fhatAL[7])-1.732050807568878*(fhatAL[15]+fhatAL[5]))+1.732050807568877*(0.5773502691896258*(fhatAL[14]-1.0*(fhatAL[12]+fhatAL[11])+fhatAL[2])-0.5773502691896258*(fhatAL[13]+fhatAL[1])+0.5773502691896258*(fhatAL[4]+fhatAL[3]))+fhatAL[10]-1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[14])); 
  fhatALQuad[15] = fmax(0.0, fmin(0.25*(0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[5])+1.732050807568877*(fhatAL[9]+fhatAL[7]))+1.0*(fhatAL[14]+fhatAL[13]+1.0*(fhatAL[12]+fhatAL[11])+fhatAL[4]+fhatAL[3]+fhatAL[2]+fhatAL[1])+fhatAL[10]+1.0*(fhatAL[8]+fhatAL[6])+fhatAL[0]), limQuad[15])); 
  ...
  incr[0] = 0.1767766952966368*(alpha[5]*fhatAL[5]+alpha[3]*fhatAL[3]+alpha[2]*fhatAL[2]+alpha[1]*fhatAL[1]+alpha[0]*fhatAL[0])*dfac_x; 
  incr[1] = -0.3061862178478971*(alpha[5]*fhatAL[5]+alpha[3]*fhatAL[3]+alpha[2]*fhatAL[2]+alpha[1]*fhatAL[1]+alpha[0]*fhatAL[0])*dfac_x; 
  incr[2] = 0.1767766952966368*(alpha[3]*fhatAL[6]+alpha[2]*fhatAL[5]+fhatAL[2]*alpha[5]+alpha[0]*fhatAL[1]+fhatAL[0]*alpha[1])*dfac_x; 
  incr[3] = 0.1767766952966368*(alpha[3]*fhatAL[7]+alpha[1]*fhatAL[5]+fhatAL[1]*alpha[5]+alpha[0]*fhatAL[2]+fhatAL[0]*alpha[2])*dfac_x; 
  incr[4] = 0.1767766952966368*(alpha[5]*fhatAL[11]+alpha[2]*fhatAL[7]+alpha[1]*fhatAL[6]+alpha[0]*fhatAL[3]+fhatAL[0]*alpha[3])*dfac_x; 
  incr[5] = 0.1767766952966368*(alpha[5]*fhatAL[12]+alpha[3]*fhatAL[10]+alpha[2]*fhatAL[9]+alpha[1]*fhatAL[8]+alpha[0]*fhatAL[4])*dfac_x; 
  incr[6] = -0.3061862178478971*(alpha[3]*fhatAL[6]+alpha[2]*fhatAL[5]+fhatAL[2]*alpha[5]+alpha[0]*fhatAL[1]+fhatAL[0]*alpha[1])*dfac_x; 
  incr[7] = -0.3061862178478971*(alpha[3]*fhatAL[7]+alpha[1]*fhatAL[5]+fhatAL[1]*alpha[5]+alpha[0]*fhatAL[2]+fhatAL[0]*alpha[2])*dfac_x; 
  incr[8] = 0.1767766952966368*(alpha[3]*fhatAL[11]+alpha[0]*fhatAL[5]+fhatAL[0]*alpha[5]+alpha[1]*fhatAL[2]+fhatAL[1]*alpha[2])*dfac_x; 
  incr[9] = -0.3061862178478971*(alpha[5]*fhatAL[11]+alpha[2]*fhatAL[7]+alpha[1]*fhatAL[6]+alpha[0]*fhatAL[3]+fhatAL[0]*alpha[3])*dfac_x; 
  incr[10] = 0.1767766952966368*(alpha[2]*fhatAL[11]+alpha[5]*fhatAL[7]+alpha[0]*fhatAL[6]+alpha[1]*fhatAL[3]+fhatAL[1]*alpha[3])*dfac_x; 
  incr[11] = 0.1767766952966368*(alpha[1]*fhatAL[11]+alpha[0]*fhatAL[7]+alpha[5]*fhatAL[6]+alpha[2]*fhatAL[3]+fhatAL[2]*alpha[3])*dfac_x; 
  incr[12] = -0.3061862178478971*(alpha[5]*fhatAL[12]+alpha[3]*fhatAL[10]+alpha[2]*fhatAL[9]+alpha[1]*fhatAL[8]+alpha[0]*fhatAL[4])*dfac_x; 
  incr[13] = 0.1767766952966368*(alpha[3]*fhatAL[13]+alpha[2]*fhatAL[12]+alpha[5]*fhatAL[9]+alpha[0]*fhatAL[8]+alpha[1]*fhatAL[4])*dfac_x; 
  incr[14] = 0.1767766952966368*(alpha[3]*fhatAL[14]+alpha[1]*fhatAL[12]+alpha[0]*fhatAL[9]+alpha[5]*fhatAL[8]+alpha[2]*fhatAL[4])*dfac_x; 
  incr[15] = 0.1767766952966368*(alpha[5]*fhatAL[15]+alpha[2]*fhatAL[14]+alpha[1]*fhatAL[13]+alpha[0]*fhatAL[10]+alpha[3]*fhatAL[4])*dfac_x; 
  incr[16] = -0.3061862178478971*(alpha[3]*fhatAL[11]+alpha[0]*fhatAL[5]+fhatAL[0]*alpha[5]+alpha[1]*fhatAL[2]+fhatAL[1]*alpha[2])*dfac_x; 
  incr[17] = -0.3061862178478971*(alpha[2]*fhatAL[11]+alpha[5]*fhatAL[7]+alpha[0]*fhatAL[6]+alpha[1]*fhatAL[3]+fhatAL[1]*alpha[3])*dfac_x; 
  incr[18] = -0.3061862178478971*(alpha[1]*fhatAL[11]+alpha[0]*fhatAL[7]+alpha[5]*fhatAL[6]+alpha[2]*fhatAL[3]+fhatAL[2]*alpha[3])*dfac_x; 
  incr[19] = 0.1767766952966368*(alpha[0]*fhatAL[11]+alpha[1]*fhatAL[7]+alpha[2]*fhatAL[6]+alpha[3]*fhatAL[5]+fhatAL[3]*alpha[5])*dfac_x; 
  incr[20] = -0.3061862178478971*(alpha[3]*fhatAL[13]+alpha[2]*fhatAL[12]+alpha[5]*fhatAL[9]+alpha[0]*fhatAL[8]+alpha[1]*fhatAL[4])*dfac_x; 
  incr[21] = -0.3061862178478971*(alpha[3]*fhatAL[14]+alpha[1]*fhatAL[12]+alpha[0]*fhatAL[9]+alpha[5]*fhatAL[8]+alpha[2]*fhatAL[4])*dfac_x; 
  incr[22] = 0.1767766952966368*(alpha[3]*fhatAL[15]+alpha[0]*fhatAL[12]+alpha[1]*fhatAL[9]+alpha[2]*fhatAL[8]+fhatAL[4]*alpha[5])*dfac_x; 
  incr[23] = -0.3061862178478971*(alpha[5]*fhatAL[15]+alpha[2]*fhatAL[14]+alpha[1]*fhatAL[13]+alpha[0]*fhatAL[10]+alpha[3]*fhatAL[4])*dfac_x; 
  incr[24] = 0.1767766952966368*(alpha[2]*fhatAL[15]+alpha[5]*fhatAL[14]+alpha[0]*fhatAL[13]+alpha[1]*fhatAL[10]+alpha[3]*fhatAL[8])*dfac_x; 
  incr[25] = 0.1767766952966368*(alpha[1]*fhatAL[15]+alpha[0]*fhatAL[14]+alpha[5]*fhatAL[13]+alpha[2]*fhatAL[10]+alpha[3]*fhatAL[9])*dfac_x; 
  incr[26] = -0.3061862178478971*(alpha[0]*fhatAL[11]+alpha[1]*fhatAL[7]+alpha[2]*fhatAL[6]+alpha[3]*fhatAL[5]+fhatAL[3]*alpha[5])*dfac_x; 
  incr[27] = -0.3061862178478971*(alpha[3]*fhatAL[15]+alpha[0]*fhatAL[12]+alpha[1]*fhatAL[9]+alpha[2]*fhatAL[8]+fhatAL[4]*alpha[5])*dfac_x; 
  incr[28] = -0.3061862178478971*(alpha[2]*fhatAL[15]+alpha[5]*fhatAL[14]+alpha[0]*fhatAL[13]+alpha[1]*fhatAL[10]+alpha[3]*fhatAL[8])*dfac_x; 
  incr[29] = -0.3061862178478971*(alpha[1]*fhatAL[15]+alpha[0]*fhatAL[14]+alpha[5]*fhatAL[13]+alpha[2]*fhatAL[10]+alpha[3]*fhatAL[9])*dfac_x; 
  incr[30] = 0.1767766952966368*(alpha[0]*fhatAL[15]+alpha[1]*fhatAL[14]+alpha[2]*fhatAL[13]+alpha[3]*fhatAL[12]+alpha[5]*fhatAL[10])*dfac_x; 
  incr[31] = -0.3061862178478971*(alpha[0]*fhatAL[15]+alpha[1]*fhatAL[14]+alpha[2]*fhatAL[13]+alpha[3]*fhatAL[12]+alpha[5]*fhatAL[10])*dfac_x; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double incr[32]; 
  // surface-averaged phase velocity in this direction 
  double alpha0 = (0.0625*(2.828427124746191*BdriftY[0]*m_*wv2+q_*((-1.732050807568877*((BmagInv[0]*Apar[1]*dfac_x+BdriftY[0]*Apar[2])*wv-1.0*BmagInv[0]*Phi[1]*dfac_x))+(3.0*BmagInv[0]*Apar[4]*dfac_x+Apar[0]*BdriftY[0])*wv-3.0*BmagInv[0]*Phi[4]*dfac_x)))/q_; 

  double alpha[16]; 
  alpha[0] = -(0.5*(q_*(1.732050807568877*((BmagInv[0]*Apar[1]*dfac_x+BdriftY[0]*Apar[2])*wv-1.0*BmagInv[0]*Phi[1]*dfac_x)+((-3.0*BmagInv[0]*Apar[4]*dfac_x)-1.0*Apar[0]*BdriftY[0])*wv+3.0*BmagInv[0]*Phi[4]*dfac_x)-2.828427124746191*BdriftY[0]*m_*wv2))/q_; 
  alpha[1] = -0.5*BdriftY[0]*(1.732050807568877*Apar[4]-1.0*Apar[1])*wv; 
  alpha[2] = 0.2886751345948129*(1.732050807568877*((3.0*BmagInv[0]*Apar[7]*dfac_x+BdriftY[0]*Apar[3])*wv-3.0*BmagInv[0]*Phi[7]*dfac_x)-3.0*(BmagInv[0]*Apar[5]*dfac_x+BdriftY[0]*Apar[6])*wv+3.0*BmagInv[0]*Phi[5]*dfac_x); 
  alpha[3] = (0.8164965809277261*BdriftY[0]*m_*wv)/(dfac_v*q_); 
  alpha[5] = -0.5*BdriftY[0]*(1.732050807568877*Apar[7]-1.0*Apar[5])*wv; 
  double f0Quad[16]; 
  double f1Quad[16]; 
  double limQuad[16]; 
  // determine upwinding at each surface quadrature node 
  ...
  incr[0] = 0.1767766952966368*(alpha[5]*fhatAL[5]+alpha[3]*fhatAL[3]+alpha[2]*fhatAL[2]+alpha[1]*fhatAL[1]+alpha[0]*fhatAL[0])*dfac_y; 
  incr[1] = 0.1767766952966368*(alpha[3]*fhatAL[6]+alpha[2]*fhatAL[5]+fhatAL[2]*alpha[5]+alpha[0]*fhatAL[1]+fhatAL[0]*alpha[1])*dfac_y; 
  incr[2] = -0.3061862178478971*(alpha[5]*fhatAL[5]+alpha[3]*fhatAL[3]+alpha[2]*fhatAL[2]+alpha[1]*fhatAL[1]+alpha[0]*fhatAL[0])*dfac_y; 
  incr[3] = 0.1767766952966368*(alpha[3]*fhatAL[7]+alpha[1]*fhatAL[5]+fhatAL[1]*alpha[5]+alpha[0]*fhatAL[2]+fhatAL[0]*alpha[2])*dfac_y; 
  incr[4] = 0.1767766952966368*(alpha[5]*fhatAL[11]+alpha[2]*fhatAL[7]+alpha[1]*fhatAL[6]+alpha[0]*fhatAL[3]+fhatAL[0]*alpha[3])*dfac_y; 
  incr[5] = 0.1767766952966368*(alpha[5]*fhatAL[12]+alpha[3]*fhatAL[10]+alpha[2]*fhatAL[9]+alpha[1]*fhatAL[8]+alpha[0]*fhatAL[4])*dfac_y; 
  incr[6] = -0.3061862178478971*(alpha[3]*fhatAL[6]+alpha[2]*fhatAL[5]+fhatAL[2]*alpha[5]+alpha[0]*fhatAL[1]+fhatAL[0]*alpha[1])*dfac_y; 
  incr[7] = 0.1767766952966368*(alpha[3]*fhatAL[11]+alpha[0]*fhatAL[5]+fhatAL[0]*alpha[5]+alpha[1]*fhatAL[2]+fhatAL[1]*alpha[2])*dfac_y; 
  incr[8] = -0.3061862178478971*(alpha[3]*fhatAL[7]+alpha[1]*fhatAL[5]+fhatAL[1]*alpha[5]+alpha[0]*fhatAL[2]+fhatAL[0]*alpha[2])*dfac_y; 
  incr[9] = 0.1767766952966368*(alpha[2]*fhatAL[11]+alpha[5]*fhatAL[7]+alpha[0]*fhatAL[6]+alpha[1]*fhatAL[3]+fhatAL[1]*alpha[3])*dfac_y; 
  incr[10] = -0.3061862178478971*(alpha[5]*fhatAL[11]+alpha[2]*fhatAL[7]+alpha[1]*fhatAL[6]+alpha[0]*fhatAL[3]+fhatAL[0]*alpha[3])*dfac_y; 
  incr[11] = 0.1767766952966368*(alpha[1]*fhatAL[11]+alpha[0]*fhatAL[7]+alpha[5]*fhatAL[6]+alpha[2]*fhatAL[3]+fhatAL[2]*alpha[3])*dfac_y; 
  incr[12] = 0.1767766952966368*(alpha[3]*fhatAL[13]+alpha[2]*fhatAL[12]+alpha[5]*fhatAL[9]+alpha[0]*fhatAL[8]+alpha[1]*fhatAL[4])*dfac_y; 
  incr[13] = -0.3061862178478971*(alpha[5]*fhatAL[12]+alpha[3]*fhatAL[10]+alpha[2]*fhatAL[9]+alpha[1]*fhatAL[8]+alpha[0]*fhatAL[4])*dfac_y; 
  incr[14] = 0.1767766952966368*(alpha[3]*fhatAL[14]+alpha[1]*fhatAL[12]+alpha[0]*fhatAL[9]+alpha[5]*fhatAL[8]+alpha[2]*fhatAL[4])*dfac_y; 
  incr[15] = 0.1767766952966368*(alpha[5]*fhatAL[15]+alpha[2]*fhatAL[14]+alpha[1]*fhatAL[13]+alpha[0]*fhatAL[10]+alpha[3]*fhatAL[4])*dfac_y; 
  incr[16] = -0.3061862178478971*(alpha[3]*fhatAL[11]+alpha[0]*fhatAL[5]+fhatAL[0]*alpha[5]+alpha[1]*fhatAL[2]+fhatAL[1]*alpha[2])*dfac_y; 
  incr[17] = -0.3061862178478971*(alpha[2]*fhatAL[11]+alpha[5]*fhatAL[7]+alpha[0]*fhatAL[6]+alpha[1]*fhatAL[3]+fhatAL[1]*alpha[3])*dfac_y; 
  incr[18] = 0.1767766952966368*(alpha[0]*fhatAL[11]+alpha[1]*fhatAL[7]+alpha[2]*fhatAL[6]+alpha[3]*fhatAL[5]+fhatAL[3]*alpha[5])*dfac_y; 
  incr[19] = -0.3061862178478971*(alpha[1]*fhatAL[11]+alpha[0]*fhatAL[7]+alpha[5]*fhatAL[6]+alpha[2]*fhatAL[3]+fhatAL[2]*alpha[3])*dfac_y; 
  incr[20] = -0.3061862178478971*(alpha[3]*fhatAL[13]+alpha[2]*fhatAL[12]+alpha[5]*fhatAL[9]+alpha[0]*fhatAL[8]+alpha[1]*fhatAL[4])*dfac_y; 
  incr[21] = 0.1767766952966368*(alpha[3]*fhatAL[15]+alpha[0]*fhatAL[12]+alpha[1]*fhatAL[9]+alpha[2]*fhatAL[8]+fhatAL[4]*alpha[5])*dfac_y; 
  incr[22] = -0.3061862178478971*(alpha[3]*fhatAL[14]+alpha[1]*fhatAL[12]+alpha[0]*fhatAL[9]+alpha[5]*fhatAL[8]+alpha[2]*fhatAL[4])*dfac_y; 
  incr[23] = 0.1767766952966368*(alpha[2]*fhatAL[15]+alpha[5]*fhatAL[14]+alpha[0]*fhatAL[13]+alpha[1]*fhatAL[10]+alpha[3]*fhatAL[8])*dfac_y; 
  incr[24] = -0.3061862178478971*(alpha[5]*fhatAL[15]+alpha[2]*fhatAL[14]+alpha[1]*fhatAL[13]+alpha[0]*fhatAL[10]+alpha[3]*fhatAL[4])*dfac_y; 
  incr[25] = 0.1767766952966368*(alpha[1]*fhatAL[15]+alpha[0]*fhatAL[14]+alpha[5]*fhatAL[13]+alpha[2]*fhatAL[10]+alpha[3]*fhatAL[9])*dfac_y; 
  incr[26] = -0.3061862178478971*(alpha[0]*fhatAL[11]+alpha[1]*fhatAL[7]+alpha[2]*fhatAL[6]+alpha[3]*fhatAL[5]+fhatAL[3]*alpha[5])*dfac_y; 
  incr[27] = -0.3061862178478971*(alpha[3]*fhatAL[15]+alpha[0]*fhatAL[12]+alpha[1]*fhatAL[9]+alpha[2]*fhatAL[8]+fhatAL[4]*alpha[5])*dfac_y; 
  incr[28] = -0.3061862178478971*(alpha[2]*fhatAL[15]+alpha[5]*fhatAL[14]+alpha[0]*fhatAL[13]+alpha[1]*fhatAL[10]+alpha[3]*fhatAL[8])*dfac_y; 
  incr[29] = 0.1767766952966368*(alpha[0]*fhatAL[15]+alpha[1]*fhatAL[14]+alpha[2]*fhatAL[13]+alpha[3]*fhatAL[12]+alpha[5]*fhatAL[10])*dfac_y; 
  incr[30] = -0.3061862178478971*(alpha[1]*fhatAL[15]+alpha[0]*fhatAL[14]+alpha[5]*fhatAL[13]+alpha[2]*fhatAL[10]+alpha[3]*fhatAL[9])*dfac_y; 
  incr[31] = -0.3061862178478971*(alpha[0]*fhatAL[15]+alpha[1]*fhatAL[14]+alpha[2]*fhatAL[13]+alpha[3]*fhatAL[12]+alpha[5]*fhatAL[10])*dfac_y; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double incr[32]; 
  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.015625*(1.732050807568877*(dfac_v*(4.0*(BdriftY[0]*Phi[2]*dfac_y+BdriftX[0]*Phi[1]*dfac_x)*m_*wv+(4.0*Gradpar[0]*Phi[3]*dfac_z+1.414213562373095*(BdriftY[0]*(Apar[5]*Phi[7]+Apar[3]*Phi[6]+Apar[1]*Phi[4]+Apar[0]*Phi[2])*dfac_y+BdriftX[0]*(Apar[6]*Phi[7]+Apar[3]*Phi[5]+Apar[2]*Phi[4]+Apar[0]*Phi[1])*dfac_x))*q_)-4.0*(BdriftY[0]*Phi[2]*dfac_y+BdriftX[0]*Phi[1]*dfac_x)*m_)+1.414213562373095*dfac_v*(8.0*dApardt[0]-3.0*BmagInv[0]*(Apar[5]*Phi[6]-1.0*Phi[5]*Apar[6]+Apar[1]*Phi[2]-1.0*Phi[1]*Apar[2])*dfac_x*dfac_y)*q_))/(dfac_v*m_); 

  double alpha[16]; 
  alpha[0] = -(0.125*(1.732050807568877*(dfac_v*(4.0*(BdriftY[0]*Phi[2]*dfac_y+BdriftX[0]*Phi[1]*dfac_x)*m_*wv+(4.0*Gradpar[0]*Phi[3]*dfac_z+1.414213562373095*(BdriftY[0]*(Apar[5]*Phi[7]+Apar[3]*Phi[6]+Apar[1]*Phi[4]+Apar[0]*Phi[2])*dfac_y+BdriftX[0]*(Apar[6]*Phi[7]+Apar[3]*Phi[5]+Apar[2]*Phi[4]+Apar[0]*Phi[1])*dfac_x))*q_)-4.0*(BdriftY[0]*Phi[2]*dfac_y+BdriftX[0]*Phi[1]*dfac_x)*m_)+dfac_v*(BmagInv[0]*((-4.242640687119286*Apar[5]*Phi[6])+4.242640687119286*Phi[5]*Apar[6]-4.242640687119286*Apar[1]*Phi[2]+4.242640687119286*Phi[1]*Apar[2])*dfac_x*dfac_y+11.31370849898477*dApardt[0])*q_))/(dfac_v*m_); 
  alpha[1] = -(0.125*(1.732050807568877*(dfac_v*(4.0*BdriftY[0]*Phi[4]*dfac_y*m_*wv+(4.0*Gradpar[0]*Phi[5]*dfac_z+1.414213562373095*(BdriftY[0]*(Apar[3]*Phi[7]+Apar[5]*Phi[6]+Apar[0]*Phi[4]+Apar[1]*Phi[2])*dfac_y+BdriftX[0]*(Apar[7]*Phi[7]+Apar[5]*Phi[5]+Apar[4]*Phi[4]+Apar[1]*Phi[1])*dfac_x))*q_)-4.0*BdriftY[0]*Phi[4]*dfac_y*m_)+dfac_v*(BmagInv[0]*((-4.242640687119286*Apar[5]*Phi[7])+4.242640687119286*Phi[5]*Apar[7]-4.242640687119286*Apar[1]*Phi[4]+4.242640687119286*Phi[1]*Apar[4])*dfac_x*dfac_y+11.31370849898477*dApardt[1])*q_))/(dfac_v*m_); 
  alpha[2] = -(0.125*(1.732050807568877*(dfac_v*(4.0*BdriftX[0]*Phi[4]*dfac_x*m_*wv+(4.0*Gradpar[0]*Phi[6]*dfac_z+1.414213562373095*(BdriftY[0]*(Apar[7]*Phi[7]+Apar[6]*Phi[6]+Apar[4]*Phi[4]+Apar[2]*Phi[2])*dfac_y+BdriftX[0]*(Apar[3]*Phi[7]+Phi[5]*Apar[6]+Apar[0]*Phi[4]+Phi[1]*Apar[2])*dfac_x))*q_)-4.0*BdriftX[0]*Phi[4]*dfac_x*m_)+dfac_v*(BmagInv[0]*(4.242640687119286*Apar[6]*Phi[7]-4.242640687119286*Phi[6]*Apar[7]+4.242640687119286*Apar[2]*Phi[4]-4.242640687119286*Phi[2]*Apar[4])*dfac_x*dfac_y+11.31370849898477*dApardt[2])*q_))/(dfac_v*m_); 
  alpha[3] = -(0.125*(1.732050807568877*(dfac_v*(4.0*(BdriftY[0]*Phi[6]*dfac_y+BdriftX[0]*Phi[5]*dfac_x)*m_*wv+1.414213562373095*(BdriftY[0]*(Apar[1]*Phi[7]+Apar[0]*Phi[6]+Phi[4]*Apar[5]+Phi[2]*Apar[3])*dfac_y+BdriftX[0]*(Apar[2]*Phi[7]+Phi[4]*Apar[6]+Apar[0]*Phi[5]+Phi[1]*Apar[3])*dfac_x)*q_)-4.0*(BdriftY[0]*Phi[6]*dfac_y+BdriftX[0]*Phi[5]*dfac_x)*m_)+dfac_v*(BmagInv[0]*((-4.242640687119286*Apar[1]*Phi[6])+4.242640687119286*(Phi[1]*Apar[6]+Apar[2]*Phi[5])-4.242640687119286*Phi[2]*Apar[5])*dfac_x*dfac_y+11.31370849898477*dApardt[3])*q_))/(dfac_v*m_); 
  alpha[5] = -(0.125*(1.732050807568877*(4.0*Gradpar[0]*Phi[7]*dfac_z+1.414213562373095*(BdriftY[0]*(Apar[6]*Phi[7]+Phi[6]*Apar[7]+Apar[2]*Phi[4]+Phi[2]*Apar[4])*dfac_y+BdriftX[0]*(Apar[5]*Phi[7]+Phi[5]*Apar[7]+Apar[1]*Phi[4]+Phi[1]*Apar[4])*dfac_x))+11.31370849898477*dApardt[4])*q_)/m_; 
  alpha[6] = -(0.125*(1.732050807568877*(dfac_v*(4.0*BdriftY[0]*Phi[7]*dfac_y*m_*wv+1.414213562373095*(BdriftY[0]*(Apar[0]*Phi[7]+Apar[1]*Phi[6]+Phi[2]*Apar[5]+Apar[3]*Phi[4])*dfac_y+BdriftX[0]*(Apar[4]*Phi[7]+Phi[4]*Apar[7]+Apar[1]*Phi[5]+Phi[1]*Apar[5])*dfac_x)*q_)-4.0*BdriftY[0]*Phi[7]*dfac_y*m_)+dfac_v*(BmagInv[0]*((-4.242640687119286*Apar[1]*Phi[7])+4.242640687119286*(Phi[1]*Apar[7]+Apar[4]*Phi[5])-4.242640687119286*Phi[4]*Apar[5])*dfac_x*dfac_y+11.31370849898477*dApardt[5])*q_))/(dfac_v*m_); 
  alpha[7] = -(0.125*(1.732050807568877*(dfac_v*(4.0*BdriftX[0]*Phi[7]*dfac_x*m_*wv+1.414213562373095*(BdriftY[0]*(Apar[4]*Phi[7]+Phi[4]*Apar[7]+Apar[2]*Phi[6]+Phi[2]*Apar[6])*dfac_y+BdriftX[0]*(Apar[0]*Phi[7]+Phi[1]*Apar[6]+Apar[2]*Phi[5]+Apar[3]*Phi[4])*dfac_x)*q_)-4.0*BdriftX[0]*Phi[7]*dfac_x*m_)+dfac_v*(BmagInv[0]*(4.242640687119286*Apar[2]*Phi[7]-4.242640687119286*(Phi[2]*Apar[7]+Apar[4]*Phi[6])+4.242640687119286*Phi[4]*Apar[6])*dfac_x*dfac_y+11.31370849898477*dApardt[6])*q_))/(dfac_v*m_); 
  alpha[11] = -(0.125*(2.449489742783178*(BdriftY[0]*(Apar[2]*Phi[7]+Phi[2]*Apar[7]+Apar[4]*Phi[6]+Phi[4]*Apar[6])*dfac_y+BdriftX[0]*(Apar[1]*Phi[7]+Phi[1]*Apar[7]+Apar[4]*Phi[5]+Phi[4]*Apar[5])*dfac_x)+11.31370849898477*dApardt[7])*q_)/m_; 
  double f0Quad[16]; 
  double f1Quad[16]; 
  double limQuad[16]; 
  // determine upwinding at each surface quadrature node 
  if((-0.25*alpha[11])+0.25*(alpha[7]+alpha[6]+alpha[5])-0.25*(alpha[3]+alpha[2]+alpha[1])+0.25*alpha[0] > 0) {
  ...
  if(0.25*(alpha[11]+alpha[7])-0.25*(alpha[6]+alpha[5]+alpha[3]+alpha[2])+0.25*(alpha[1]+alpha[0]) > 0) {
  ...
  if(0.25*alpha[11]-0.25*alpha[7]+0.25*alpha[6]-0.25*(alpha[5]+alpha[3])+0.25*alpha[2]-0.25*alpha[1]+0.25*alpha[0] > 0) {
  ...
  if((-0.25*(alpha[11]+alpha[7]+alpha[6]))+0.25*alpha[5]-0.25*alpha[3]+0.25*(alpha[2]+alpha[1]+alpha[0]) > 0) {
  ...
  if(0.25*alpha[11]-0.25*(alpha[7]+alpha[6])+0.25*(alpha[5]+alpha[3])-0.25*(alpha[2]+alpha[1])+0.25*alpha[0] > 0) {
  ...
  if((-0.25*(alpha[11]+alpha[7]))+0.25*alpha[6]-0.25*alpha[5]+0.25*alpha[3]-0.25*alpha[2]+0.25*(alpha[1]+alpha[0]) > 0) {
  ...
  if((-0.25*alpha[11])+0.25*alpha[7]-0.25*(alpha[6]+alpha[5])+0.25*(alpha[3]+alpha[2])-0.25*alpha[1]+0.25*alpha[0] > 0) {
  ...
  if(0.25*(alpha[11]+alpha[7]+alpha[6]+alpha[5]+alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) {
  ...
  // enforce limiters at surface quadrature nodes 
  double fhatALQuad[16]; 
  fhatALQuad[0] = fmax(0.0, fmin(0.25*((-0.5773502691896258*((-1.732050807568878*(fhatAL[15]+fhatAL[7]))-1.732050807568877*(fhatAL[10]+fhatAL[6])))-1.0*(1.0*(fhatAL[14]+fhatAL[11])+fhatAL[13]+fhatAL[12]+fhatAL[4]+fhatAL[3]+fhatAL[2]+fhatAL[1])+1.0*(fhatAL[9]+fhatAL[5])+fhatAL[8]+fhatAL[0]), limQuad[0])); 
  fhatALQuad[1] = fmax(0.0, fmin(0.25*((-0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15]))-1.732050807568877*fhatAL[10]+1.732050807568877*fhatAL[6]))+1.732050807568877*(0.5773502691896258*fhatAL[1]-0.5773502691896258*((-0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[14]))-1.0*(fhatAL[13]+fhatAL[12])+fhatAL[4]+fhatAL[3]+fhatAL[2]))-0.5773502691896258*(1.732050807568877*fhatAL[5]-1.732050807568877*fhatAL[9])-1.0*fhatAL[8]+fhatAL[0]), limQuad[1])); 
  ...
  fhatALQuad[3] = fmax(0.0, fmin(0.25*((-0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15])-1.732050807568877*fhatAL[10]+1.732050807568877*fhatAL[6]))+1.732050807568877*((-0.5773502691896258*(0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[14])-1.0*fhatAL[13]+fhatAL[3]))+0.5773502691896258*(fhatAL[2]-1.0*fhatAL[12])-0.5773502691896258*fhatAL[4]+0.5773502691896258*fhatAL[1])+0.5773502691896258*(1.732050807568877*fhatAL[5]-1.732050807568877*fhatAL[9])-1.0*fhatAL[8]+fhatAL[0]), limQuad[3])); 
  fhatALQuad[4] = fmax(0.0, fmin(0.25*(0.5773502691896258*((-1.732050807568878*(fhatAL[15]+fhatAL[7]))-1.732050807568877*(fhatAL[10]+fhatAL[6]))+1.732050807568877*(0.5773502691896258*(1.0*(fhatAL[14]+fhatAL[11])+fhatAL[13]+fhatAL[3])-0.5773502691896258*(fhatAL[12]+fhatAL[4]+fhatAL[2]+fhatAL[1]))+1.0*(fhatAL[9]+fhatAL[5])+fhatAL[8]+fhatAL[0]), limQuad[4])); 
  fhatALQuad[5] = fmax(0.0, fmin(0.25*(0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15]))-1.732050807568877*fhatAL[10]+1.732050807568877*fhatAL[6])+1.732050807568877*(0.5773502691896258*((-0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[14]))-1.0*fhatAL[13]+fhatAL[3])-0.5773502691896258*((-1.0*fhatAL[12])+fhatAL[4]+fhatAL[2])+0.5773502691896258*fhatAL[1])-0.5773502691896258*(1.732050807568877*fhatAL[5]-1.732050807568877*fhatAL[9])-1.0*fhatAL[8]+fhatAL[0]), limQuad[5])); 
  fhatALQuad[6] = fmax(0.0, fmin(0.25*(0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[7])-1.732050807568877*(fhatAL[10]+fhatAL[6]))+1.732050807568877*(0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[11]))+fhatAL[13]+fhatAL[12]+fhatAL[3]+fhatAL[2])-0.5773502691896258*(fhatAL[4]+fhatAL[1]))-1.0*(fhatAL[9]+fhatAL[5])+fhatAL[8]+fhatAL[0]), limQuad[6])); 
  fhatALQuad[7] = fmax(0.0, fmin(0.25*(0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15])-1.732050807568877*fhatAL[10]+1.732050807568877*fhatAL[6])+1.732050807568877*(0.5773502691896258*(0.5773502691896258*(1.732050807568877*fhatAL[11]-1.732050807568877*fhatAL[14])-1.0*(fhatAL[13]+fhatAL[12])+fhatAL[3]+fhatAL[2])-0.5773502691896258*fhatAL[4]+0.5773502691896258*fhatAL[1])+0.5773502691896258*(1.732050807568877*fhatAL[5]-1.732050807568877*fhatAL[9])-1.0*fhatAL[8]+fhatAL[0]), limQuad[7])); 
  fhatALQuad[8] = fmax(0.0, fmin(0.25*((-0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15]))+1.732050807568877*fhatAL[10]-1.732050807568877*fhatAL[6]))+1.732050807568877*((-0.5773502691896258*((-0.5773502691896258*(1.732050807568877*fhatAL[14]-1.732050807568877*fhatAL[11]))-1.0*(fhatAL[13]+fhatAL[12])+fhatAL[3]+fhatAL[2]))+0.5773502691896258*fhatAL[4]-0.5773502691896258*fhatAL[1])-0.5773502691896258*(1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[5])-1.0*fhatAL[8]+fhatAL[0]), limQuad[8])); 
  fhatALQuad[9] = fmax(0.0, fmin(0.25*((-0.5773502691896258*(1.732050807568877*(fhatAL[10]+fhatAL[6])-1.732050807568878*(fhatAL[15]+fhatAL[7])))+1.732050807568877*(0.5773502691896258*(fhatAL[4]+fhatAL[1])-0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[11]))+fhatAL[13]+fhatAL[12]+fhatAL[3]+fhatAL[2]))-1.0*(fhatAL[9]+fhatAL[5])+fhatAL[8]+fhatAL[0]), limQuad[9])); 
  fhatALQuad[10] = fmax(0.0, fmin(0.25*((-0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15])+1.732050807568877*fhatAL[10]-1.732050807568877*fhatAL[6]))+1.732050807568877*((-0.5773502691896258*(0.5773502691896258*(1.732050807568877*fhatAL[14]-1.732050807568877*fhatAL[11])-1.0*fhatAL[13]+fhatAL[3]))+0.5773502691896258*((-1.0*fhatAL[12])+fhatAL[4]+fhatAL[2])-0.5773502691896258*fhatAL[1])+0.5773502691896258*(1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[5])-1.0*fhatAL[8]+fhatAL[0]), limQuad[10])); 
  fhatALQuad[11] = fmax(0.0, fmin(0.25*((-0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[7])+1.732050807568877*(fhatAL[10]+fhatAL[6])))+1.732050807568877*(0.5773502691896258*(fhatAL[12]+fhatAL[4]+fhatAL[2]+fhatAL[1])-0.5773502691896258*(1.0*(fhatAL[14]+fhatAL[11])+fhatAL[13]+fhatAL[3]))+1.0*(fhatAL[9]+fhatAL[5])+fhatAL[8]+fhatAL[0]), limQuad[11])); 
  fhatALQuad[12] = fmax(0.0, fmin(0.25*(0.5773502691896258*((-0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15]))+1.732050807568877*fhatAL[10]-1.732050807568877*fhatAL[6])+1.732050807568877*(0.5773502691896258*((-0.5773502691896258*(1.732050807568877*fhatAL[14]-1.732050807568877*fhatAL[11]))-1.0*fhatAL[13]+fhatAL[3])-0.5773502691896258*(fhatAL[2]-1.0*fhatAL[12])+0.5773502691896258*fhatAL[4]-0.5773502691896258*fhatAL[1])-0.5773502691896258*(1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[5])-1.0*fhatAL[8]+fhatAL[0]), limQuad[12])); 
  fhatALQuad[13] = fmax(0.0, fmin(0.25*(0.5773502691896258*(1.732050807568877*(fhatAL[10]+fhatAL[6])-1.732050807568878*(fhatAL[15]+fhatAL[7]))+1.732050807568877*(0.5773502691896258*((-1.0*(fhatAL[14]+fhatAL[11]))+fhatAL[13]+fhatAL[3])-0.5773502691896258*(fhatAL[12]+fhatAL[2])+0.5773502691896258*(fhatAL[4]+fhatAL[1]))-1.0*(fhatAL[9]+fhatAL[5])+fhatAL[8]+fhatAL[0]), limQuad[13])); 
  fhatALQuad[14] = fmax(0.0, fmin(0.25*(0.5773502691896258*(0.5773502691896258*(3.0*fhatAL[7]-3.0*fhatAL[15])+1.732050807568877*fhatAL[10]-1.732050807568877*fhatAL[6])+1.732050807568877*(0.5773502691896258*(0.5773502691896258*(1.732050807568877*fhatAL[14]-1.732050807568877*fhatAL[11])-1.0*(fhatAL[13]+fhatAL[12])+fhatAL[4]+fhatAL[3]+fhatAL[2])-0.5773502691896258*fhatAL[1])+0.5773502691896258*(1.732050807568877*fhatAL[9]-1.732050807568877*fhatAL[5])-1.0*fhatAL[8]+fhatAL[0]), limQuad[14])); 
  fhatALQuad[15] = fmax(0.0, fmin(0.25*(0.5773502691896258*(1.732050807568878*(fhatAL[15]+fhatAL[7])+1.732050807568877*(fhatAL[10]+fhatAL[6]))+1.0*(1.0*(fhatAL[14]+fhatAL[11])+fhatAL[13]+fhatAL[12]+fhatAL[9]+fhatAL[5]+fhatAL[4]+fhatAL[3]+fhatAL[2]+fhatAL[1])+fhatAL[8]+fhatAL[0]), limQuad[15])); 
  fhatAL[0] = 0.25*(fhatALQuad[15]+fhatALQuad[14]+fhatALQuad[13]+fhatALQuad[12]+fhatALQuad[11]+fhatALQuad[10]+fhatALQuad[9]+fhatALQuad[8]+fhatALQuad[7]+fhatALQuad[6]+fhatALQuad[5]+fhatALQuad[4]+fhatALQuad[3]+fhatALQuad[2]+fhatALQuad[1]+fhatALQuad[0]); 
  fhatAL[1] = 0.25*(fhatALQuad[15]-1.0*fhatALQuad[14]+fhatALQuad[13]-1.0*fhatALQuad[12]+fhatALQuad[11]-1.0*fhatALQuad[10]+fhatALQuad[9]-1.0*fhatALQuad[8]+fhatALQuad[7]-1.0*fhatALQuad[6]+fhatALQuad[5]-1.0*fhatALQuad[4]+fhatALQuad[3]-1.0*fhatALQuad[2]+fhatALQuad[1]-1.0*fhatALQuad[0]); 
  fhatAL[2] = 0.25*(fhatALQuad[15]+fhatALQuad[14]-1.0*(fhatALQuad[13]+fhatALQuad[12])+fhatALQuad[11]+fhatALQuad[10]-1.0*(fhatALQuad[9]+fhatALQuad[8])+fhatALQuad[7]+fhatALQuad[6]-1.0*(fhatALQuad[5]+fhatALQuad[4])+fhatALQuad[3]+fhatALQuad[2]-1.0*(fhatALQuad[1]+fhatALQuad[0])); 
  fhatAL[3] = 0.25*(fhatALQuad[15]+fhatALQuad[14]+fhatALQuad[13]+fhatALQuad[12]-1.0*(fhatALQuad[11]+fhatALQuad[10]+fhatALQuad[9]+fhatALQuad[8])+fhatALQuad[7]+fhatALQuad[6]+fhatALQuad[5]+fhatALQuad[4]-1.0*(fhatALQuad[3]+fhatALQuad[2]+fhatALQuad[1]+fhatALQuad[0])); 
  ...
  incr[0] = 0.1767766952966368*(alpha[11]*fhatAL[11]+alpha[7]*fhatAL[7]+alpha[6]*fhatAL[6]+alpha[5]*fhatAL[5]+alpha[3]*fhatAL[3]+alpha[2]*fhatAL[2]+alpha[1]*fhatAL[1]+alpha[0]*fhatAL[0])*dfac_v; 
  incr[1] = 0.1767766952966368*(alpha[7]*fhatAL[11]+fhatAL[7]*alpha[11]+alpha[3]*fhatAL[6]+fhatAL[3]*alpha[6]+alpha[2]*fhatAL[5]+fhatAL[2]*alpha[5]+alpha[0]*fhatAL[1]+fhatAL[0]*alpha[1])*dfac_v; 
  incr[2] = 0.1767766952966368*(alpha[6]*fhatAL[11]+fhatAL[6]*alpha[11]+alpha[3]*fhatAL[7]+fhatAL[3]*alpha[7]+alpha[1]*fhatAL[5]+fhatAL[1]*alpha[5]+alpha[0]*fhatAL[2]+fhatAL[0]*alpha[2])*dfac_v; 
  incr[3] = 0.1767766952966368*(alpha[5]*fhatAL[11]+fhatAL[5]*alpha[11]+alpha[2]*fhatAL[7]+fhatAL[2]*alpha[7]+alpha[1]*fhatAL[6]+fhatAL[1]*alpha[6]+alpha[0]*fhatAL[3]+fhatAL[0]*alpha[3])*dfac_v; 
  incr[4] = -0.3061862178478971*(alpha[11]*fhatAL[11]+alpha[7]*fhatAL[7]+alpha[6]*fhatAL[6]+alpha[5]*fhatAL[5]+alpha[3]*fhatAL[3]+alpha[2]*fhatAL[2]+alpha[1]*fhatAL[1]+alpha[0]*fhatAL[0])*dfac_v; 
  incr[5] = 0.1767766952966368*(alpha[11]*fhatAL[15]+alpha[7]*fhatAL[14]+alpha[6]*fhatAL[13]+alpha[5]*fhatAL[12]+alpha[3]*fhatAL[10]+alpha[2]*fhatAL[9]+alpha[1]*fhatAL[8]+alpha[0]*fhatAL[4])*dfac_v; 
  incr[6] = 0.1767766952966368*(alpha[3]*fhatAL[11]+fhatAL[3]*alpha[11]+alpha[6]*fhatAL[7]+fhatAL[6]*alpha[7]+alpha[0]*fhatAL[5]+fhatAL[0]*alpha[5]+alpha[1]*fhatAL[2]+fhatAL[1]*alpha[2])*dfac_v; 
  incr[7] = 0.1767766952966368*(alpha[2]*fhatAL[11]+fhatAL[2]*alpha[11]+alpha[5]*fhatAL[7]+fhatAL[5]*alpha[7]+alpha[0]*fhatAL[6]+fhatAL[0]*alpha[6]+alpha[1]*fhatAL[3]+fhatAL[1]*alpha[3])*dfac_v; 
  incr[8] = 0.1767766952966368*(alpha[1]*fhatAL[11]+fhatAL[1]*alpha[11]+alpha[0]*fhatAL[7]+fhatAL[0]*alpha[7]+alpha[5]*fhatAL[6]+fhatAL[5]*alpha[6]+alpha[2]*fhatAL[3]+fhatAL[2]*alpha[3])*dfac_v; 
  incr[9] = -0.3061862178478971*(alpha[7]*fhatAL[11]+fhatAL[7]*alpha[11]+alpha[3]*fhatAL[6]+fhatAL[3]*alpha[6]+alpha[2]*fhatAL[5]+fhatAL[2]*alpha[5]+alpha[0]*fhatAL[1]+fhatAL[0]*alpha[1])*dfac_v; 
  incr[10] = -0.3061862178478971*(alpha[6]*fhatAL[11]+fhatAL[6]*alpha[11]+alpha[3]*fhatAL[7]+fhatAL[3]*alpha[7]+alpha[1]*fhatAL[5]+fhatAL[1]*alpha[5]+alpha[0]*fhatAL[2]+fhatAL[0]*alpha[2])*dfac_v; 
  incr[11] = -0.3061862178478971*(alpha[5]*fhatAL[11]+fhatAL[5]*alpha[11]+alpha[2]*fhatAL[7]+fhatAL[2]*alpha[7]+alpha[1]*fhatAL[6]+fhatAL[1]*alpha[6]+alpha[0]*fhatAL[3]+fhatAL[0]*alpha[3])*dfac_v; 
  incr[12] = 0.1767766952966368*(alpha[7]*fhatAL[15]+alpha[11]*fhatAL[14]+alpha[3]*fhatAL[13]+alpha[2]*fhatAL[12]+alpha[6]*fhatAL[10]+alpha[5]*fhatAL[9]+alpha[0]*fhatAL[8]+alpha[1]*fhatAL[4])*dfac_v; 
  incr[13] = 0.1767766952966368*(alpha[6]*fhatAL[15]+alpha[3]*fhatAL[14]+alpha[11]*fhatAL[13]+alpha[1]*fhatAL[12]+alpha[7]*fhatAL[10]+alpha[0]*fhatAL[9]+alpha[5]*fhatAL[8]+alpha[2]*fhatAL[4])*dfac_v; 
  incr[14] = 0.1767766952966368*(alpha[5]*fhatAL[15]+alpha[2]*fhatAL[14]+alpha[1]*fhatAL[13]+alpha[11]*fhatAL[12]+alpha[0]*fhatAL[10]+alpha[7]*fhatAL[9]+alpha[6]*fhatAL[8]+alpha[3]*fhatAL[4])*dfac_v; 
  incr[15] = -0.3061862178478971*(alpha[11]*fhatAL[15]+alpha[7]*fhatAL[14]+alpha[6]*fhatAL[13]+alpha[5]*fhatAL[12]+alpha[3]*fhatAL[10]+alpha[2]*fhatAL[9]+alpha[1]*fhatAL[8]+alpha[0]*fhatAL[4])*dfac_v; 
  incr[16] = 0.1767766952966368*(alpha[0]*fhatAL[11]+fhatAL[0]*alpha[11]+alpha[1]*fhatAL[7]+fhatAL[1]*alpha[7]+alpha[2]*fhatAL[6]+fhatAL[2]*alpha[6]+alpha[3]*fhatAL[5]+fhatAL[3]*alpha[5])*dfac_v; 
  incr[17] = -0.3061862178478971*(alpha[3]*fhatAL[11]+fhatAL[3]*alpha[11]+alpha[6]*fhatAL[7]+fhatAL[6]*alpha[7]+alpha[0]*fhatAL[5]+fhatAL[0]*alpha[5]+alpha[1]*fhatAL[2]+fhatAL[1]*alpha[2])*dfac_v; 
  incr[18] = -0.3061862178478971*(alpha[2]*fhatAL[11]+fhatAL[2]*alpha[11]+alpha[5]*fhatAL[7]+fhatAL[5]*alpha[7]+alpha[0]*fhatAL[6]+fhatAL[0]*alpha[6]+alpha[1]*fhatAL[3]+fhatAL[1]*alpha[3])*dfac_v; 
  incr[19] = -0.3061862178478971*(alpha[1]*fhatAL[11]+fhatAL[1]*alpha[11]+alpha[0]*fhatAL[7]+fhatAL[0]*alpha[7]+alpha[5]*fhatAL[6]+fhatAL[5]*alpha[6]+alpha[2]*fhatAL[3]+fhatAL[2]*alpha[3])*dfac_v; 
  incr[20] = 0.1767766952966368*(alpha[3]*fhatAL[15]+alpha[6]*fhatAL[14]+alpha[7]*fhatAL[13]+alpha[0]*fhatAL[12]+fhatAL[10]*alpha[11]+alpha[1]*fhatAL[9]+alpha[2]*fhatAL[8]+fhatAL[4]*alpha[5])*dfac_v; 
  incr[21] = 0.1767766952966368*(alpha[2]*fhatAL[15]+alpha[5]*fhatAL[14]+alpha[0]*fhatAL[13]+alpha[7]*fhatAL[12]+fhatAL[9]*alpha[11]+alpha[1]*fhatAL[10]+alpha[3]*fhatAL[8]+fhatAL[4]*alpha[6])*dfac_v; 
  incr[22] = 0.1767766952966368*(alpha[1]*fhatAL[15]+alpha[0]*fhatAL[14]+alpha[5]*fhatAL[13]+alpha[6]*fhatAL[12]+fhatAL[8]*alpha[11]+alpha[2]*fhatAL[10]+alpha[3]*fhatAL[9]+fhatAL[4]*alpha[7])*dfac_v; 
  incr[23] = -0.3061862178478971*(alpha[7]*fhatAL[15]+alpha[11]*fhatAL[14]+alpha[3]*fhatAL[13]+alpha[2]*fhatAL[12]+alpha[6]*fhatAL[10]+alpha[5]*fhatAL[9]+alpha[0]*fhatAL[8]+alpha[1]*fhatAL[4])*dfac_v; 
  incr[24] = -0.3061862178478971*(alpha[6]*fhatAL[15]+alpha[3]*fhatAL[14]+alpha[11]*fhatAL[13]+alpha[1]*fhatAL[12]+alpha[7]*fhatAL[10]+alpha[0]*fhatAL[9]+alpha[5]*fhatAL[8]+alpha[2]*fhatAL[4])*dfac_v; 
  incr[25] = -0.3061862178478971*(alpha[5]*fhatAL[15]+alpha[2]*fhatAL[14]+alpha[1]*fhatAL[13]+alpha[11]*fhatAL[12]+alpha[0]*fhatAL[10]+alpha[7]*fhatAL[9]+alpha[6]*fhatAL[8]+alpha[3]*fhatAL[4])*dfac_v; 
  incr[26] = -0.3061862178478971*(alpha[0]*fhatAL[11]+fhatAL[0]*alpha[11]+alpha[1]*fhatAL[7]+fhatAL[1]*alpha[7]+alpha[2]*fhatAL[6]+fhatAL[2]*alpha[6]+alpha[3]*fhatAL[5]+fhatAL[3]*alpha[5])*dfac_v; 
  incr[27] = 0.1767766952966368*(alpha[0]*fhatAL[15]+alpha[1]*fhatAL[14]+alpha[2]*fhatAL[13]+alpha[3]*fhatAL[12]+fhatAL[4]*alpha[11]+alpha[5]*fhatAL[10]+alpha[6]*fhatAL[9]+alpha[7]*fhatAL[8])*dfac_v; 
  incr[28] = -0.3061862178478971*(alpha[3]*fhatAL[15]+alpha[6]*fhatAL[14]+alpha[7]*fhatAL[13]+alpha[0]*fhatAL[12]+fhatAL[10]*alpha[11]+alpha[1]*fhatAL[9]+alpha[2]*fhatAL[8]+fhatAL[4]*alpha[5])*dfac_v; 
  incr[29] = -0.3061862178478971*(alpha[2]*fhatAL[15]+alpha[5]*fhatAL[14]+alpha[0]*fhatAL[13]+alpha[7]*fhatAL[12]+fhatAL[9]*alpha[11]+alpha[1]*fhatAL[10]+alpha[3]*fhatAL[8]+fhatAL[4]*alpha[6])*dfac_v; 
  incr[30] = -0.3061862178478971*(alpha[1]*fhatAL[15]+alpha[0]*fhatAL[14]+alpha[5]*fhatAL[13]+alpha[6]*fhatAL[12]+fhatAL[8]*alpha[11]+alpha[2]*fhatAL[10]+alpha[3]*fhatAL[9]+fhatAL[4]*alpha[7])*dfac_v; 
  incr[31] = -0.3061862178478971*(alpha[0]*fhatAL[15]+alpha[1]*fhatAL[14]+alpha[2]*fhatAL[13]+alpha[3]*fhatAL[12]+fhatAL[4]*alpha[11]+alpha[5]*fhatAL[10]+alpha[6]*fhatAL[9]+alpha[7]*fhatAL[8])*dfac_v; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double incr[32]; 
  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.0625*(1.732050807568877*(2.828427124746191*BdriftX[1]*m_*wv2+q_*((3.0*BmagInv[1]*Phi[4]+BmagInv[0]*Phi[2])*dfac_y-1.0*((3.0*BmagInv[1]*Apar[4]+BmagInv[0]*Apar[2])*dfac_y-1.0*(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1]))*wv))-2.828427124746191*BdriftX[0]*m_*wv2+q_*((3.0*(BmagInv[0]*Apar[4]+BmagInv[1]*Apar[2])*dfac_y-1.0*(3.0*Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0]))*wv-3.0*(BmagInv[0]*Phi[4]+BmagInv[1]*Phi[2])*dfac_y)))/q_; 

  double alpha[16]; 
  alpha[0] = -(0.5*(1.732050807568877*(2.828427124746191*BdriftX[1]*m_*wv2+q_*((((-3.0*BmagInv[1]*Apar[4])-1.0*BmagInv[0]*Apar[2])*dfac_y+Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])*wv+(3.0*BmagInv[1]*Phi[4]+BmagInv[0]*Phi[2])*dfac_y))-2.828427124746191*BdriftX[0]*m_*wv2+q_*((3.0*(BmagInv[0]*Apar[4]+BmagInv[1]*Apar[2])*dfac_y-3.0*Apar[1]*BdriftX[1]-1.0*Apar[0]*BdriftX[0])*wv-3.0*(BmagInv[0]*Phi[4]+BmagInv[1]*Phi[2])*dfac_y)))/q_; 
  alpha[1] = -0.5*(1.732050807568877*(BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2])-3.0*BdriftX[1]*Apar[4]-1.0*BdriftX[0]*Apar[2])*wv; 
  alpha[2] = -0.2886751345948129*(1.732050807568877*((3.0*(BmagInv[0]*Apar[7]+BmagInv[1]*Apar[6])*dfac_y-3.0*BdriftX[1]*Apar[5]-1.0*BdriftX[0]*Apar[3])*wv-3.0*(BmagInv[0]*Phi[7]+BmagInv[1]*Phi[6])*dfac_y)+(((-9.0*BmagInv[1]*Apar[7])-3.0*BmagInv[0]*Apar[6])*dfac_y+3.0*(BdriftX[0]*Apar[5]+BdriftX[1]*Apar[3]))*wv+(9.0*BmagInv[1]*Phi[7]+3.0*BmagInv[0]*Phi[6])*dfac_y); 
  alpha[3] = (0.3333333333333333*(2.449489742783178*BdriftX[0]-4.242640687119286*BdriftX[1])*m_*wv)/(dfac_v*q_); 
  alpha[5] = -0.5*(1.732050807568877*(BdriftX[0]*Apar[7]+BdriftX[1]*Apar[6])-3.0*BdriftX[1]*Apar[7]-1.0*BdriftX[0]*Apar[6])*wv; 
  double f0Quad[16]; 
  double f1Quad[16]; 
  double limQuad[16]; 
  // determine upwinding at each surface quadrature node 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double incr[32]; 
  // surface-averaged phase velocity in this direction 
  double alpha0 = (0.0625*(2.828427124746191*BdriftY[0]*m_*wv2-1.732050807568877*((BmagInv[0]*Apar[1]*dfac_x+BdriftY[1]*Apar[4]+BdriftY[0]*Apar[2])*q_*wv-1.0*BmagInv[0]*dfac_x*(Bmag[1]*wm+Phi[1]*q_))+q_*((3.0*BmagInv[0]*Apar[4]*dfac_x+Apar[1]*BdriftY[1]+Apar[0]*BdriftY[0])*wv-3.0*BmagInv[0]*Phi[4]*dfac_x)))/q_; 

  double alpha[16]; 
  alpha[0] = -(0.5*((-2.828427124746191*BdriftY[0]*m_*wv2)+1.732050807568877*((BmagInv[0]*Apar[1]*dfac_x+BdriftY[1]*Apar[4]+BdriftY[0]*Apar[2])*q_*wv-1.0*BmagInv[0]*dfac_x*(Bmag[1]*wm+Phi[1]*q_))+q_*(((-3.0*BmagInv[0]*Apar[4]*dfac_x)-1.0*(Apar[1]*BdriftY[1]+Apar[0]*BdriftY[0]))*wv+3.0*BmagInv[0]*Phi[4]*dfac_x)))/q_; 
  alpha[1] = -(0.5*((-2.828427124746191*BdriftY[1]*m_*wv2)+1.732050807568877*((Apar[1]*BmagInv[1]*dfac_x+BdriftY[0]*Apar[4]+BdriftY[1]*Apar[2])*q_*wv-1.0*BmagInv[1]*dfac_x*(Bmag[1]*wm+Phi[1]*q_))+q_*(((-3.0*BmagInv[1]*Apar[4]*dfac_x)-1.0*(Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1]))*wv+3.0*BmagInv[1]*Phi[4]*dfac_x)))/q_; 
  alpha[2] = 0.2886751345948129*(1.732050807568877*((3.0*BmagInv[0]*Apar[7]*dfac_x+BdriftY[1]*Apar[5]+BdriftY[0]*Apar[3])*wv-3.0*BmagInv[0]*Phi[7]*dfac_x)-3.0*(BmagInv[0]*Apar[5]*dfac_x+BdriftY[1]*Apar[7]+BdriftY[0]*Apar[6])*wv+3.0*BmagInv[0]*Phi[5]*dfac_x); 
  alpha[3] = (0.8164965809277261*BdriftY[0]*m_*wv)/(dfac_v*q_); 
  alpha[4] = (0.5*BmagInv[0]*Bmag[1]*dfac_x)/(dfac_m*q_); 
  alpha[5] = -0.5*(1.732050807568877*((BmagInv[1]*Apar[5]*dfac_x+BdriftY[0]*Apar[7]+BdriftY[1]*Apar[6])*wv-1.0*BmagInv[1]*Phi[5]*dfac_x)+((-3.0*BmagInv[1]*Apar[7]*dfac_x)-1.0*(BdriftY[0]*Apar[5]+BdriftY[1]*Apar[3]))*wv+3.0*BmagInv[1]*Phi[7]*dfac_x); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double incr[32]; 
  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.015625*(1.732050807568877*(4.0*dfac_v*m_*(BdriftX[0]*Bmag[1]*dfac_x*wm+((BdriftY[1]*Phi[4]+BdriftY[0]*Phi[2])*dfac_y+BdriftX[0]*Phi[1]*dfac_x)*q_)*wv+Bmag[1]*dfac_x*(1.414213562373095*(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*dfac_v*q_-4.0*BdriftX[0]*m_)*wm+q_*(dfac_v*(4.0*(Gradpar[1]*Phi[5]+Gradpar[0]*Phi[3])*dfac_z+1.414213562373095*(((BdriftY[0]*Apar[5]+BdriftY[1]*Apar[3])*Phi[7]+(BdriftY[1]*Apar[5]+BdriftY[0]*Apar[3])*Phi[6]+(Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1])*Phi[4]+(Apar[1]*BdriftY[1]+Apar[0]*BdriftY[0])*Phi[2])*dfac_y+((BdriftX[1]*Apar[7]+BdriftX[0]*Apar[6])*Phi[7]+(BdriftX[1]*Apar[5]+BdriftX[0]*Apar[3])*Phi[5]+(BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2])*Phi[4]+(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*Phi[1])*dfac_x))*q_-4.0*((BdriftY[1]*Phi[4]+BdriftY[0]*Phi[2])*dfac_y+BdriftX[0]*Phi[1]*dfac_x)*m_))+1.414213562373095*dfac_v*q_*(3.0*Bmag[1]*(BmagInv[1]*Apar[4]+BmagInv[0]*Apar[2])*dfac_x*dfac_y*wm+(8.0*dApardt[0]-3.0*(BmagInv[1]*(Apar[5]*Phi[7]-1.0*Phi[5]*Apar[7])+BmagInv[0]*(Apar[5]*Phi[6]-1.0*Phi[5]*Apar[6])+BmagInv[1]*(Apar[1]*Phi[4]-1.0*Phi[1]*Apar[4])+BmagInv[0]*(Apar[1]*Phi[2]-1.0*Phi[1]*Apar[2]))*dfac_x*dfac_y)*q_)))/(dfac_v*m_*q_); 

  double alpha[16]; 
  alpha[0] = -(0.125*(1.732050807568877*(4.0*dfac_v*m_*(BdriftX[0]*Bmag[1]*dfac_x*wm+((BdriftY[1]*Phi[4]+BdriftY[0]*Phi[2])*dfac_y+BdriftX[0]*Phi[1]*dfac_x)*q_)*wv+Bmag[1]*dfac_x*(1.414213562373095*(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*dfac_v*q_-4.0*BdriftX[0]*m_)*wm-4.0*((BdriftY[1]*Phi[4]+BdriftY[0]*Phi[2])*dfac_y+BdriftX[0]*Phi[1]*dfac_x)*m_*q_+dfac_v*(4.0*(Gradpar[1]*Phi[5]+Gradpar[0]*Phi[3])*dfac_z+1.414213562373095*(((BdriftY[0]*Apar[5]+BdriftY[1]*Apar[3])*Phi[7]+(BdriftY[1]*Apar[5]+BdriftY[0]*Apar[3])*Phi[6]+(Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1])*Phi[4]+(Apar[1]*BdriftY[1]+Apar[0]*BdriftY[0])*Phi[2])*dfac_y+((BdriftX[1]*Apar[7]+BdriftX[0]*Apar[6])*Phi[7]+(BdriftX[1]*Apar[5]+BdriftX[0]*Apar[3])*Phi[5]+(BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2])*Phi[4]+(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*Phi[1])*dfac_x))*q2)+dfac_v*(4.242640687119286*Bmag[1]*(BmagInv[1]*Apar[4]+BmagInv[0]*Apar[2])*dfac_x*dfac_y*q_*wm+((BmagInv[1]*(4.242640687119286*Phi[5]*Apar[7]-4.242640687119286*Apar[5]*Phi[7])+BmagInv[0]*(4.242640687119286*Phi[5]*Apar[6]-4.242640687119286*Apar[5]*Phi[6])+BmagInv[1]*(4.242640687119286*Phi[1]*Apar[4]-4.242640687119286*Apar[1]*Phi[4])+BmagInv[0]*(4.242640687119286*Phi[1]*Apar[2]-4.242640687119286*Apar[1]*Phi[2]))*dfac_x*dfac_y+11.31370849898477*dApardt[0])*q2)))/(dfac_v*m_*q_); 
  alpha[1] = -(0.025*(1.732050807568877*(20.0*dfac_v*m_*(BdriftX[1]*Bmag[1]*dfac_x*wm+((BdriftY[0]*Phi[4]+BdriftY[1]*Phi[2])*dfac_y+BdriftX[1]*Phi[1]*dfac_x)*q_)*wv+Bmag[1]*dfac_x*(7.071067811865476*(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])*dfac_v*q_-20.0*BdriftX[1]*m_)*wm-20.0*((BdriftY[0]*Phi[4]+BdriftY[1]*Phi[2])*dfac_y+BdriftX[1]*Phi[1]*dfac_x)*m_*q_+dfac_v*(20.0*(Gradpar[0]*Phi[5]+Gradpar[1]*Phi[3])*dfac_z+((12.72792206135786*BdriftY[1]*Apar[5]+7.071067811865476*BdriftY[0]*Apar[3])*Phi[7]+7.071067811865476*(BdriftY[0]*Apar[5]+BdriftY[1]*Apar[3])*Phi[6]+(12.72792206135786*Apar[1]*BdriftY[1]+7.071067811865476*Apar[0]*BdriftY[0])*Phi[4]+7.071067811865476*(Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1])*Phi[2])*dfac_y+7.071067811865476*((BdriftX[0]*Apar[7]+BdriftX[1]*Apar[6])*Phi[7]+(BdriftX[0]*Apar[5]+BdriftX[1]*Apar[3])*Phi[5]+(BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2])*Phi[4]+(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])*Phi[1])*dfac_x)*q2)+dfac_v*(21.21320343559643*Bmag[1]*(BmagInv[0]*Apar[4]+BmagInv[1]*Apar[2])*dfac_x*dfac_y*q_*wm+((BmagInv[0]*(21.21320343559643*Phi[5]*Apar[7]-21.21320343559643*Apar[5]*Phi[7])+BmagInv[1]*(21.21320343559643*Phi[5]*Apar[6]-21.21320343559643*Apar[5]*Phi[6])+BmagInv[0]*(21.21320343559643*Phi[1]*Apar[4]-21.21320343559643*Apar[1]*Phi[4])+BmagInv[1]*(21.21320343559643*Phi[1]*Apar[2]-21.21320343559643*Apar[1]*Phi[2]))*dfac_x*dfac_y+56.56854249492383*dApardt[1])*q2)))/(dfac_v*m_*q_); 
  alpha[2] = -(0.125*(1.732050807568877*(dfac_v*(dfac_x*(4.0*BdriftX[0]*Phi[4]*m_*wv+1.414213562373095*Bmag[1]*(BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2])*wm)+(4.0*(Gradpar[1]*Phi[7]+Gradpar[0]*Phi[6])*dfac_z+1.414213562373095*(((BdriftY[0]*Apar[7]+BdriftY[1]*Apar[6])*Phi[7]+Phi[6]*(BdriftY[1]*Apar[7]+BdriftY[0]*Apar[6])+(BdriftY[0]*Apar[4]+BdriftY[1]*Apar[2])*Phi[4]+Phi[2]*(BdriftY[1]*Apar[4]+BdriftY[0]*Apar[2]))*dfac_y+((BdriftX[1]*Apar[5]+BdriftX[0]*Apar[3])*Phi[7]+Phi[5]*(BdriftX[1]*Apar[7]+BdriftX[0]*Apar[6])+(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*Phi[4]+Phi[1]*(BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2]))*dfac_x))*q_)-4.0*BdriftX[0]*Phi[4]*dfac_x*m_)+dfac_v*(BmagInv[0]*(4.242640687119286*Apar[6]*Phi[7]-4.242640687119286*Phi[6]*Apar[7]+4.242640687119286*Apar[2]*Phi[4]-4.242640687119286*Phi[2]*Apar[4])*dfac_x*dfac_y+11.31370849898477*dApardt[2])*q_))/(dfac_v*m_); 
  alpha[3] = -(0.125*(1.732050807568877*(dfac_v*(4.0*((BdriftY[1]*Phi[7]+BdriftY[0]*Phi[6])*dfac_y+BdriftX[0]*Phi[5]*dfac_x)*m_*wv+1.414213562373095*(Bmag[1]*(BdriftX[1]*Apar[5]+BdriftX[0]*Apar[3])*dfac_x*wm+(((Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1])*Phi[7]+(Apar[1]*BdriftY[1]+Apar[0]*BdriftY[0])*Phi[6]+(BdriftY[0]*Phi[4]+BdriftY[1]*Phi[2])*Apar[5]+Apar[3]*(BdriftY[1]*Phi[4]+BdriftY[0]*Phi[2]))*dfac_y+((BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2])*Phi[7]+Phi[4]*(BdriftX[1]*Apar[7]+BdriftX[0]*Apar[6])+(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*Phi[5]+Phi[1]*(BdriftX[1]*Apar[5]+BdriftX[0]*Apar[3]))*dfac_x)*q_))-4.0*((BdriftY[1]*Phi[7]+BdriftY[0]*Phi[6])*dfac_y+BdriftX[0]*Phi[5]*dfac_x)*m_)+dfac_v*(4.242640687119286*Bmag[1]*(BmagInv[1]*Apar[7]+BmagInv[0]*Apar[6])*dfac_x*dfac_y*wm+((BmagInv[1]*(4.242640687119286*Phi[1]*Apar[7]-4.242640687119286*Apar[1]*Phi[7])-4.242640687119286*BmagInv[0]*Apar[1]*Phi[6]+4.242640687119286*(BmagInv[0]*Phi[1]*Apar[6]+(BmagInv[1]*Apar[4]+BmagInv[0]*Apar[2])*Phi[5])-4.242640687119286*(BmagInv[1]*Phi[4]+BmagInv[0]*Phi[2])*Apar[5])*dfac_x*dfac_y+11.31370849898477*dApardt[3])*q_)))/(dfac_v*m_); 
  alpha[4] = -(0.125*Bmag[1]*dfac_x*(dfac_v*(4.0*BdriftX[0]*m_*wv+(2.449489742783178*(BmagInv[1]*Apar[4]+BmagInv[0]*Apar[2])*dfac_y+1.414213562373095*(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0]))*q_)-4.0*BdriftX[0]*m_))/(dfac_m*dfac_v*m_*q_); 
  alpha[5] = -(0.025*(1.732050807568877*(dfac_v*(dfac_x*(20.0*BdriftX[1]*Phi[4]*m_*wv+7.071067811865476*Bmag[1]*(BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2])*wm)+(20.0*(Gradpar[0]*Phi[7]+Gradpar[1]*Phi[6])*dfac_z+((12.72792206135786*BdriftY[1]*Apar[7]+7.071067811865476*BdriftY[0]*Apar[6])*Phi[7]+7.071067811865476*Phi[6]*(BdriftY[0]*Apar[7]+BdriftY[1]*Apar[6])+(12.72792206135786*BdriftY[1]*Apar[4]+7.071067811865476*BdriftY[0]*Apar[2])*Phi[4]+7.071067811865476*Phi[2]*(BdriftY[0]*Apar[4]+BdriftY[1]*Apar[2]))*dfac_y+7.071067811865476*((BdriftX[0]*Apar[5]+BdriftX[1]*Apar[3])*Phi[7]+Phi[5]*(BdriftX[0]*Apar[7]+BdriftX[1]*Apar[6])+(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])*Phi[4]+Phi[1]*(BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2]))*dfac_x)*q_)-20.0*BdriftX[1]*Phi[4]*dfac_x*m_)+dfac_v*(BmagInv[1]*(21.21320343559643*Apar[6]*Phi[7]-21.21320343559643*Phi[6]*Apar[7]+21.21320343559643*Apar[2]*Phi[4]-21.21320343559643*Phi[2]*Apar[4])*dfac_x*dfac_y+56.56854249492383*dApardt[4])*q_))/(dfac_v*m_); 
  alpha[6] = -(0.025*(1.732050807568877*(dfac_v*(20.0*((BdriftY[0]*Phi[7]+BdriftY[1]*Phi[6])*dfac_y+BdriftX[1]*Phi[5]*dfac_x)*m_*wv+7.071067811865476*Bmag[1]*(BdriftX[0]*Apar[5]+BdriftX[1]*Apar[3])*dfac_x*wm+(((12.72792206135786*Apar[1]*BdriftY[1]+7.071067811865476*Apar[0]*BdriftY[0])*Phi[7]+7.071067811865476*(Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1])*Phi[6]+(12.72792206135786*BdriftY[1]*Phi[4]+7.071067811865476*BdriftY[0]*Phi[2])*Apar[5]+7.071067811865476*Apar[3]*(BdriftY[0]*Phi[4]+BdriftY[1]*Phi[2]))*dfac_y+7.071067811865476*((BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2])*Phi[7]+Phi[4]*(BdriftX[0]*Apar[7]+BdriftX[1]*Apar[6])+(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])*Phi[5]+Phi[1]*(BdriftX[0]*Apar[5]+BdriftX[1]*Apar[3]))*dfac_x)*q_)-20.0*((BdriftY[0]*Phi[7]+BdriftY[1]*Phi[6])*dfac_y+BdriftX[1]*Phi[5]*dfac_x)*m_)+dfac_v*(21.21320343559643*Bmag[1]*(BmagInv[0]*Apar[7]+BmagInv[1]*Apar[6])*dfac_x*dfac_y*wm+((BmagInv[0]*(21.21320343559643*Phi[1]*Apar[7]-21.21320343559643*Apar[1]*Phi[7])-21.21320343559643*Apar[1]*BmagInv[1]*Phi[6]+21.21320343559643*(BmagInv[1]*Phi[1]*Apar[6]+(BmagInv[0]*Apar[4]+BmagInv[1]*Apar[2])*Phi[5])-21.21320343559643*(BmagInv[0]*Phi[4]+BmagInv[1]*Phi[2])*Apar[5])*dfac_x*dfac_y+56.56854249492383*dApardt[5])*q_)))/(dfac_v*m_); 
  alpha[7] = -(0.125*(1.732050807568877*(dfac_v*(4.0*BdriftX[0]*Phi[7]*dfac_x*m_*wv+1.414213562373095*(Bmag[1]*(BdriftX[1]*Apar[7]+BdriftX[0]*Apar[6])*dfac_x*wm+(((BdriftY[0]*Apar[4]+BdriftY[1]*Apar[2])*Phi[7]+(BdriftY[0]*Phi[4]+BdriftY[1]*Phi[2])*Apar[7]+(BdriftY[1]*Apar[4]+BdriftY[0]*Apar[2])*Phi[6]+(BdriftY[1]*Phi[4]+BdriftY[0]*Phi[2])*Apar[6])*dfac_y+((Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*Phi[7]+Phi[1]*(BdriftX[1]*Apar[7]+BdriftX[0]*Apar[6])+(BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2])*Phi[5]+Phi[4]*(BdriftX[1]*Apar[5]+BdriftX[0]*Apar[3]))*dfac_x)*q_))-4.0*BdriftX[0]*Phi[7]*dfac_x*m_)+dfac_v*(BmagInv[0]*(4.242640687119286*Apar[2]*Phi[7]-4.242640687119286*(Phi[2]*Apar[7]+Apar[4]*Phi[6])+4.242640687119286*Phi[4]*Apar[6])*dfac_x*dfac_y+11.31370849898477*dApardt[6])*q_))/(dfac_v*m_); 
  alpha[8] = -(0.125*Bmag[1]*dfac_x*(dfac_v*(4.0*BdriftX[1]*m_*wv+(2.449489742783178*(BmagInv[0]*Apar[4]+BmagInv[1]*Apar[2])*dfac_y+1.414213562373095*(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1]))*q_)-4.0*BdriftX[1]*m_))/(dfac_m*dfac_v*m_*q_); 
  alpha[9] = -(0.1767766952966369*Bmag[1]*(BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2])*dfac_x)/(dfac_m*m_); 
  alpha[10] = -(0.125*Bmag[1]*dfac_x*(2.449489742783178*(BmagInv[1]*Apar[7]+BmagInv[0]*Apar[6])*dfac_y+1.414213562373095*(BdriftX[1]*Apar[5]+BdriftX[0]*Apar[3])))/(dfac_m*m_); 
  alpha[11] = -(0.025*(1.732050807568877*(dfac_v*(dfac_x*(20.0*BdriftX[1]*Phi[7]*m_*wv+7.071067811865476*Bmag[1]*(BdriftX[0]*Apar[7]+BdriftX[1]*Apar[6])*wm)+(((12.72792206135786*BdriftY[1]*Apar[4]+7.071067811865476*BdriftY[0]*Apar[2])*Phi[7]+(12.72792206135786*BdriftY[1]*Phi[4]+7.071067811865476*BdriftY[0]*Phi[2])*Apar[7]+7.071067811865476*((BdriftY[0]*Apar[4]+BdriftY[1]*Apar[2])*Phi[6]+(BdriftY[0]*Phi[4]+BdriftY[1]*Phi[2])*Apar[6]))*dfac_y+7.071067811865476*((Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])*Phi[7]+Phi[1]*(BdriftX[0]*Apar[7]+BdriftX[1]*Apar[6])+(BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2])*Phi[5]+Phi[4]*(BdriftX[0]*Apar[5]+BdriftX[1]*Apar[3]))*dfac_x)*q_)-20.0*BdriftX[1]*Phi[7]*dfac_x*m_)+dfac_v*(BmagInv[1]*(21.21320343559643*Apar[2]*Phi[7]-21.21320343559643*(Phi[2]*Apar[7]+Apar[4]*Phi[6])+21.21320343559643*Phi[4]*Apar[6])*dfac_x*dfac_y+56.56854249492383*dApardt[7])*q_))/(dfac_v*m_); 
  alpha[12] = -(0.1767766952966369*Bmag[1]*(BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2])*dfac_x)/(dfac_m*m_); 
  alpha[13] = -(0.125*Bmag[1]*dfac_x*(2.449489742783178*(BmagInv[0]*Apar[7]+BmagInv[1]*Apar[6])*dfac_y+1.414213562373095*(BdriftX[0]*Apar[5]+BdriftX[1]*Apar[3])))/(dfac_m*m_); 
  alpha[14] = -(0.1767766952966369*Bmag[1]*(BdriftX[1]*Apar[7]+BdriftX[0]*Apar[6])*dfac_x)/(dfac_m*m_); 
  alpha[15] = -(0.1767766952966369*Bmag[1]*(BdriftX[0]*Apar[7]+BdriftX[1]*Apar[6])*dfac_x)/(dfac_m*m_); 
  double f0Quad[16]; 
  double f1Quad[16]; 
  double limQuad[16]; 
  // determine upwinding at each surface quadrature node 
  if(0.25*alpha[15]-0.25*(alpha[14]+alpha[13]+alpha[12]+alpha[11])+0.25*(alpha[10]+alpha[9]+alpha[8]+alpha[7]+alpha[6]+alpha[5])-0.25*(alpha[4]+alpha[3]+alpha[2]+alpha[1])+0.25*alpha[0] > 0) {
    f0Quad[0] = 0.25*(fl[27]-1.0*(fl[22]+fl[21]+fl[20]+fl[16])+fl[14]+fl[13]+fl[12]+fl[8]+fl[7]+fl[6]-1.0*(fl[5]+fl[3]+fl[2]+fl[1])+fl[0]); 
    f1Quad[0] = -0.25*(fl[31]-1.0*(fl[30]+fl[29]+fl[28]+fl[26])+fl[25]+fl[24]+fl[23]+fl[19]+fl[18]+fl[17]-1.0*(fl[15]+fl[11]+fl[10]+fl[9])+fl[4]); 
    limQuad[0] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if((-0.25*(alpha[15]+alpha[14]))+0.25*(alpha[13]+alpha[12]+alpha[11]+alpha[10]+alpha[9])-0.25*alpha[8]+0.25*alpha[7]-0.25*(alpha[6]+alpha[5]+alpha[4]+alpha[3]+alpha[2])+0.25*(alpha[1]+alpha[0]) > 0) {
    f0Quad[1] = -0.25*(fl[27]+fl[22]-1.0*(fl[21]+fl[20]+fl[16]+fl[14]+fl[13])+fl[12]-1.0*fl[8]+fl[7]+fl[6]+fl[5]+fl[3]+fl[2]-1.0*(fl[1]+fl[0])); 
    f1Quad[1] = 0.25*(fl[31]+fl[30]-1.0*(fl[29]+fl[28]+fl[26]+fl[25]+fl[24])+fl[23]-1.0*fl[19]+fl[18]+fl[17]+fl[15]+fl[11]+fl[10]-1.0*(fl[9]+fl[4])); 
    limQuad[1] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if((-0.25*alpha[15])+0.25*alpha[14]-0.25*alpha[13]+0.25*(alpha[12]+alpha[11]+alpha[10])-0.25*alpha[9]+0.25*alpha[8]-0.25*alpha[7]+0.25*alpha[6]-0.25*(alpha[5]+alpha[4]+alpha[3])+0.25*alpha[2]-0.25*alpha[1]+0.25*alpha[0] > 0) {
    f0Quad[2] = -0.25*(fl[27]-1.0*fl[22]+fl[21]-1.0*(fl[20]+fl[16]+fl[14])+fl[13]-1.0*fl[12]+fl[8]-1.0*fl[7]+fl[6]+fl[5]+fl[3]-1.0*fl[2]+fl[1]-1.0*fl[0]); 
    f1Quad[2] = 0.25*(fl[31]-1.0*fl[30]+fl[29]-1.0*(fl[28]+fl[26]+fl[25])+fl[24]-1.0*fl[23]+fl[19]-1.0*fl[18]+fl[17]+fl[15]+fl[11]-1.0*fl[10]+fl[9]-1.0*fl[4]); 
    limQuad[2] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if(0.25*(alpha[15]+alpha[14]+alpha[13])-0.25*(alpha[12]+alpha[11])+0.25*alpha[10]-0.25*(alpha[9]+alpha[8]+alpha[7]+alpha[6])+0.25*alpha[5]-0.25*(alpha[4]+alpha[3])+0.25*(alpha[2]+alpha[1]+alpha[0]) > 0) {
    f0Quad[3] = 0.25*(fl[27]+fl[22]+fl[21]-1.0*(fl[20]+fl[16])+fl[14]-1.0*(fl[13]+fl[12]+fl[8]+fl[7])+fl[6]-1.0*(fl[5]+fl[3])+fl[2]+fl[1]+fl[0]); 
    f1Quad[3] = -0.25*(fl[31]+fl[30]+fl[29]-1.0*(fl[28]+fl[26])+fl[25]-1.0*(fl[24]+fl[23]+fl[19]+fl[18])+fl[17]-1.0*(fl[15]+fl[11])+fl[10]+fl[9]+fl[4]); 
    limQuad[3] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if((-0.25*alpha[15])+0.25*(alpha[14]+alpha[13])-0.25*alpha[12]+0.25*alpha[11]-0.25*alpha[10]+0.25*(alpha[9]+alpha[8])-0.25*(alpha[7]+alpha[6])+0.25*alpha[5]-0.25*alpha[4]+0.25*alpha[3]-0.25*(alpha[2]+alpha[1])+0.25*alpha[0] > 0) {
    f0Quad[4] = -0.25*(fl[27]-1.0*(fl[22]+fl[21])+fl[20]-1.0*fl[16]+fl[14]-1.0*(fl[13]+fl[12])+fl[8]+fl[7]-1.0*fl[6]+fl[5]-1.0*fl[3]+fl[2]+fl[1]-1.0*fl[0]); 
    f1Quad[4] = 0.25*(fl[31]-1.0*(fl[30]+fl[29])+fl[28]-1.0*fl[26]+fl[25]-1.0*(fl[24]+fl[23])+fl[19]+fl[18]-1.0*fl[17]+fl[15]-1.0*fl[11]+fl[10]+fl[9]-1.0*fl[4]); 
    limQuad[4] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if(0.25*(alpha[15]+alpha[14])-0.25*alpha[13]+0.25*alpha[12]-0.25*(alpha[11]+alpha[10])+0.25*alpha[9]-0.25*(alpha[8]+alpha[7])+0.25*alpha[6]-0.25*(alpha[5]+alpha[4])+0.25*alpha[3]-0.25*alpha[2]+0.25*(alpha[1]+alpha[0]) > 0) {
    f0Quad[5] = 0.25*(fl[27]+fl[22]-1.0*fl[21]+fl[20]-1.0*(fl[16]+fl[14])+fl[13]-1.0*(fl[12]+fl[8])+fl[7]-1.0*(fl[6]+fl[5])+fl[3]-1.0*fl[2]+fl[1]+fl[0]); 
    f1Quad[5] = -0.25*(fl[31]+fl[30]-1.0*fl[29]+fl[28]-1.0*(fl[26]+fl[25])+fl[24]-1.0*(fl[23]+fl[19])+fl[18]-1.0*(fl[17]+fl[15])+fl[11]-1.0*fl[10]+fl[9]+fl[4]); 
    limQuad[5] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if(0.25*alpha[15]-0.25*alpha[14]+0.25*(alpha[13]+alpha[12])-0.25*(alpha[11]+alpha[10]+alpha[9])+0.25*(alpha[8]+alpha[7])-0.25*(alpha[6]+alpha[5]+alpha[4])+0.25*(alpha[3]+alpha[2])-0.25*alpha[1]+0.25*alpha[0] > 0) {
    f0Quad[6] = 0.25*(fl[27]-1.0*fl[22]+fl[21]+fl[20]-1.0*(fl[16]+fl[14]+fl[13])+fl[12]+fl[8]-1.0*(fl[7]+fl[6]+fl[5])+fl[3]+fl[2]-1.0*fl[1]+fl[0]); 
    f1Quad[6] = -0.25*(fl[31]-1.0*fl[30]+fl[29]+fl[28]-1.0*(fl[26]+fl[25]+fl[24])+fl[23]+fl[19]-1.0*(fl[18]+fl[17]+fl[15])+fl[11]+fl[10]-1.0*fl[9]+fl[4]); 
    limQuad[6] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if((-0.25*(alpha[15]+alpha[14]+alpha[13]+alpha[12]))+0.25*alpha[11]-0.25*(alpha[10]+alpha[9]+alpha[8])+0.25*(alpha[7]+alpha[6]+alpha[5])-0.25*alpha[4]+0.25*(alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) {
    f0Quad[7] = -0.25*(fl[27]+fl[22]+fl[21]+fl[20]-1.0*fl[16]+fl[14]+fl[13]+fl[12]-1.0*(fl[8]+fl[7]+fl[6])+fl[5]-1.0*(fl[3]+fl[2]+fl[1]+fl[0])); 
    f1Quad[7] = 0.25*(fl[31]+fl[30]+fl[29]+fl[28]-1.0*fl[26]+fl[25]+fl[24]+fl[23]-1.0*(fl[19]+fl[18]+fl[17])+fl[15]-1.0*(fl[11]+fl[10]+fl[9]+fl[4])); 
    limQuad[7] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if((-0.25*alpha[15])+0.25*(alpha[14]+alpha[13]+alpha[12])-0.25*(alpha[11]+alpha[10]+alpha[9]+alpha[8])+0.25*(alpha[7]+alpha[6]+alpha[5]+alpha[4])-0.25*(alpha[3]+alpha[2]+alpha[1])+0.25*alpha[0] > 0) {
    f0Quad[8] = -0.25*(fl[27]-1.0*(fl[22]+fl[21]+fl[20])+fl[16]+fl[14]+fl[13]+fl[12]-1.0*(fl[8]+fl[7]+fl[6]+fl[5])+fl[3]+fl[2]+fl[1]-1.0*fl[0]); 
    f1Quad[8] = 0.25*(fl[31]-1.0*(fl[30]+fl[29]+fl[28])+fl[26]+fl[25]+fl[24]+fl[23]-1.0*(fl[19]+fl[18]+fl[17]+fl[15])+fl[11]+fl[10]+fl[9]-1.0*fl[4]); 
    limQuad[8] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if(0.25*(alpha[15]+alpha[14])-0.25*(alpha[13]+alpha[12])+0.25*alpha[11]-0.25*(alpha[10]+alpha[9])+0.25*(alpha[8]+alpha[7])-0.25*(alpha[6]+alpha[5])+0.25*alpha[4]-0.25*(alpha[3]+alpha[2])+0.25*(alpha[1]+alpha[0]) > 0) {
    f0Quad[9] = 0.25*(fl[27]+fl[22]-1.0*(fl[21]+fl[20])+fl[16]-1.0*(fl[14]+fl[13])+fl[12]+fl[8]-1.0*(fl[7]+fl[6])+fl[5]-1.0*(fl[3]+fl[2])+fl[1]+fl[0]); 
    f1Quad[9] = -0.25*(fl[31]+fl[30]-1.0*(fl[29]+fl[28])+fl[26]-1.0*(fl[25]+fl[24])+fl[23]+fl[19]-1.0*(fl[18]+fl[17])+fl[15]-1.0*(fl[11]+fl[10])+fl[9]+fl[4]); 
    limQuad[9] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if(0.25*alpha[15]-0.25*alpha[14]+0.25*alpha[13]-0.25*alpha[12]+0.25*alpha[11]-0.25*alpha[10]+0.25*alpha[9]-0.25*(alpha[8]+alpha[7])+0.25*alpha[6]-0.25*alpha[5]+0.25*alpha[4]-0.25*alpha[3]+0.25*alpha[2]-0.25*alpha[1]+0.25*alpha[0] > 0) {
    f0Quad[10] = 0.25*(fl[27]-1.0*fl[22]+fl[21]-1.0*fl[20]+fl[16]-1.0*fl[14]+fl[13]-1.0*(fl[12]+fl[8])+fl[7]-1.0*fl[6]+fl[5]-1.0*fl[3]+fl[2]-1.0*fl[1]+fl[0]); 
    f1Quad[10] = -0.25*(fl[31]-1.0*fl[30]+fl[29]-1.0*fl[28]+fl[26]-1.0*fl[25]+fl[24]-1.0*(fl[23]+fl[19])+fl[18]-1.0*fl[17]+fl[15]-1.0*fl[11]+fl[10]-1.0*fl[9]+fl[4]); 
    limQuad[10] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if((-0.25*(alpha[15]+alpha[14]+alpha[13]))+0.25*alpha[12]-0.25*(alpha[11]+alpha[10])+0.25*(alpha[9]+alpha[8])-0.25*(alpha[7]+alpha[6])+0.25*(alpha[5]+alpha[4])-0.25*alpha[3]+0.25*(alpha[2]+alpha[1]+alpha[0]) > 0) {
    f0Quad[11] = -0.25*(fl[27]+fl[22]+fl[21]-1.0*fl[20]+fl[16]+fl[14]-1.0*(fl[13]+fl[12])+fl[8]+fl[7]-1.0*(fl[6]+fl[5])+fl[3]-1.0*(fl[2]+fl[1]+fl[0])); 
    f1Quad[11] = 0.25*(fl[31]+fl[30]+fl[29]-1.0*fl[28]+fl[26]+fl[25]-1.0*(fl[24]+fl[23])+fl[19]+fl[18]-1.0*(fl[17]+fl[15])+fl[11]-1.0*(fl[10]+fl[9]+fl[4])); 
    limQuad[11] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if(0.25*alpha[15]-0.25*(alpha[14]+alpha[13])+0.25*(alpha[12]+alpha[11]+alpha[10])-0.25*(alpha[9]+alpha[8]+alpha[7]+alpha[6])+0.25*(alpha[5]+alpha[4]+alpha[3])-0.25*(alpha[2]+alpha[1])+0.25*alpha[0] > 0) {
    f0Quad[12] = 0.25*(fl[27]-1.0*(fl[22]+fl[21])+fl[20]+fl[16]+fl[14]-1.0*(fl[13]+fl[12]+fl[8]+fl[7])+fl[6]+fl[5]+fl[3]-1.0*(fl[2]+fl[1])+fl[0]); 
    f1Quad[12] = -0.25*(fl[31]-1.0*(fl[30]+fl[29])+fl[28]+fl[26]+fl[25]-1.0*(fl[24]+fl[23]+fl[19]+fl[18])+fl[17]+fl[15]+fl[11]-1.0*(fl[10]+fl[9])+fl[4]); 
    limQuad[12] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if((-0.25*(alpha[15]+alpha[14]))+0.25*alpha[13]-0.25*(alpha[12]+alpha[11])+0.25*alpha[10]-0.25*alpha[9]+0.25*alpha[8]-0.25*alpha[7]+0.25*alpha[6]-0.25*alpha[5]+0.25*(alpha[4]+alpha[3])-0.25*alpha[2]+0.25*(alpha[1]+alpha[0]) > 0) {
    f0Quad[13] = -0.25*(fl[27]+fl[22]-1.0*fl[21]+fl[20]+fl[16]-1.0*fl[14]+fl[13]-1.0*fl[12]+fl[8]-1.0*fl[7]+fl[6]-1.0*(fl[5]+fl[3])+fl[2]-1.0*(fl[1]+fl[0])); 
    f1Quad[13] = 0.25*(fl[31]+fl[30]-1.0*fl[29]+fl[28]+fl[26]-1.0*fl[25]+fl[24]-1.0*fl[23]+fl[19]-1.0*fl[18]+fl[17]-1.0*(fl[15]+fl[11])+fl[10]-1.0*(fl[9]+fl[4])); 
    limQuad[13] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if((-0.25*alpha[15])+0.25*alpha[14]-0.25*(alpha[13]+alpha[12]+alpha[11])+0.25*(alpha[10]+alpha[9])-0.25*alpha[8]+0.25*alpha[7]-0.25*(alpha[6]+alpha[5])+0.25*(alpha[4]+alpha[3]+alpha[2])-0.25*alpha[1]+0.25*alpha[0] > 0) {
    f0Quad[14] = -0.25*(fl[27]-1.0*fl[22]+fl[21]+fl[20]+fl[16]-1.0*(fl[14]+fl[13])+fl[12]-1.0*fl[8]+fl[7]+fl[6]-1.0*(fl[5]+fl[3]+fl[2])+fl[1]-1.0*fl[0]); 
    f1Quad[14] = 0.25*(fl[31]-1.0*fl[30]+fl[29]+fl[28]+fl[26]-1.0*(fl[25]+fl[24])+fl[23]-1.0*fl[19]+fl[18]+fl[17]-1.0*(fl[15]+fl[11]+fl[10])+fl[9]-1.0*fl[4]); 
    limQuad[14] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  if(0.25*(alpha[15]+alpha[14]+alpha[13]+alpha[12]+alpha[11]+alpha[10]+alpha[9]+alpha[8]+alpha[7]+alpha[6]+alpha[5]+alpha[4]+alpha[3]+alpha[2]+alpha[1]+alpha[0]) > 0) {
    f0Quad[15] = 0.25*(fl[27]+fl[22]+fl[21]+fl[20]+fl[16]+fl[14]+fl[13]+fl[12]+fl[8]+fl[7]+fl[6]+fl[5]+fl[3]+fl[2]+fl[1]+fl[0]); 
    f1Quad[15] = -0.25*(fl[31]+fl[30]+fl[29]+fl[28]+fl[26]+fl[25]+fl[24]+fl[23]+fl[19]+fl[18]+fl[17]+fl[15]+fl[11]+fl[10]+fl[9]+fl[4]); 
    limQuad[15] = fl[0]/cflL/5.656854249492382; 
  } else {
  ...
  incr[0] = 0.1767766952966368*(alpha[15]*fhatAL[15]+alpha[14]*fhatAL[14]+alpha[13]*fhatAL[13]+alpha[12]*fhatAL[12]+alpha[11]*fhatAL[11]+alpha[10]*fhatAL[10]+alpha[9]*fhatAL[9]+alpha[8]*fhatAL[8]+alpha[7]*fhatAL[7]+alpha[6]*fhatAL[6]+alpha[5]*fhatAL[5]+alpha[4]*fhatAL[4]+alpha[3]*fhatAL[3]+alpha[2]*fhatAL[2]+alpha[1]*fhatAL[1]+alpha[0]*fhatAL[0])*dfac_v; 
  incr[1] = 0.1767766952966368*(alpha[14]*fhatAL[15]+fhatAL[14]*alpha[15]+alpha[10]*fhatAL[13]+fhatAL[10]*alpha[13]+alpha[9]*fhatAL[12]+fhatAL[9]*alpha[12]+alpha[7]*fhatAL[11]+fhatAL[7]*alpha[11]+alpha[4]*fhatAL[8]+fhatAL[4]*alpha[8]+alpha[3]*fhatAL[6]+fhatAL[3]*alpha[6]+alpha[2]*fhatAL[5]+fhatAL[2]*alpha[5]+alpha[0]*fhatAL[1]+fhatAL[0]*alpha[1])*dfac_v; 
  incr[2] = 0.1767766952966368*(alpha[13]*fhatAL[15]+fhatAL[13]*alpha[15]+alpha[10]*fhatAL[14]+fhatAL[10]*alpha[14]+alpha[8]*fhatAL[12]+fhatAL[8]*alpha[12]+alpha[6]*fhatAL[11]+fhatAL[6]*alpha[11]+alpha[4]*fhatAL[9]+fhatAL[4]*alpha[9]+alpha[3]*fhatAL[7]+fhatAL[3]*alpha[7]+alpha[1]*fhatAL[5]+fhatAL[1]*alpha[5]+alpha[0]*fhatAL[2]+fhatAL[0]*alpha[2])*dfac_v; 
  incr[3] = 0.1767766952966368*(alpha[12]*fhatAL[15]+fhatAL[12]*alpha[15]+alpha[9]*fhatAL[14]+fhatAL[9]*alpha[14]+alpha[8]*fhatAL[13]+fhatAL[8]*alpha[13]+alpha[5]*fhatAL[11]+fhatAL[5]*alpha[11]+alpha[4]*fhatAL[10]+fhatAL[4]*alpha[10]+alpha[2]*fhatAL[7]+fhatAL[2]*alpha[7]+alpha[1]*fhatAL[6]+fhatAL[1]*alpha[6]+alpha[0]*fhatAL[3]+fhatAL[0]*alpha[3])*dfac_v; 
  incr[4] = -0.3061862178478971*(alpha[15]*fhatAL[15]+alpha[14]*fhatAL[14]+alpha[13]*fhatAL[13]+alpha[12]*fhatAL[12]+alpha[11]*fhatAL[11]+alpha[10]*fhatAL[10]+alpha[9]*fhatAL[9]+alpha[8]*fhatAL[8]+alpha[7]*fhatAL[7]+alpha[6]*fhatAL[6]+alpha[5]*fhatAL[5]+alpha[4]*fhatAL[4]+alpha[3]*fhatAL[3]+alpha[2]*fhatAL[2]+alpha[1]*fhatAL[1]+alpha[0]*fhatAL[0])*dfac_v; 
  incr[5] = 0.1767766952966368*(alpha[11]*fhatAL[15]+fhatAL[11]*alpha[15]+alpha[7]*fhatAL[14]+fhatAL[7]*alpha[14]+alpha[6]*fhatAL[13]+fhatAL[6]*alpha[13]+alpha[5]*fhatAL[12]+fhatAL[5]*alpha[12]+alpha[3]*fhatAL[10]+fhatAL[3]*alpha[10]+alpha[2]*fhatAL[9]+fhatAL[2]*alpha[9]+alpha[1]*fhatAL[8]+fhatAL[1]*alpha[8]+alpha[0]*fhatAL[4]+fhatAL[0]*alpha[4])*dfac_v; 
  incr[6] = 0.1767766952966368*(alpha[10]*fhatAL[15]+fhatAL[10]*alpha[15]+alpha[13]*fhatAL[14]+fhatAL[13]*alpha[14]+alpha[4]*fhatAL[12]+fhatAL[4]*alpha[12]+alpha[3]*fhatAL[11]+fhatAL[3]*alpha[11]+alpha[8]*fhatAL[9]+fhatAL[8]*alpha[9]+alpha[6]*fhatAL[7]+fhatAL[6]*alpha[7]+alpha[0]*fhatAL[5]+fhatAL[0]*alpha[5]+alpha[1]*fhatAL[2]+fhatAL[1]*alpha[2])*dfac_v; 
  incr[7] = 0.1767766952966368*(alpha[9]*fhatAL[15]+fhatAL[9]*alpha[15]+alpha[12]*fhatAL[14]+fhatAL[12]*alpha[14]+alpha[4]*fhatAL[13]+fhatAL[4]*alpha[13]+alpha[2]*fhatAL[11]+fhatAL[2]*alpha[11]+alpha[8]*fhatAL[10]+fhatAL[8]*alpha[10]+alpha[5]*fhatAL[7]+fhatAL[5]*alpha[7]+alpha[0]*fhatAL[6]+fhatAL[0]*alpha[6]+alpha[1]*fhatAL[3]+fhatAL[1]*alpha[3])*dfac_v; 
  incr[8] = 0.1767766952966368*(alpha[8]*fhatAL[15]+fhatAL[8]*alpha[15]+alpha[4]*fhatAL[14]+fhatAL[4]*alpha[14]+alpha[12]*fhatAL[13]+fhatAL[12]*alpha[13]+alpha[1]*fhatAL[11]+fhatAL[1]*alpha[11]+alpha[9]*fhatAL[10]+fhatAL[9]*alpha[10]+alpha[0]*fhatAL[7]+fhatAL[0]*alpha[7]+alpha[5]*fhatAL[6]+fhatAL[5]*alpha[6]+alpha[2]*fhatAL[3]+fhatAL[2]*alpha[3])*dfac_v; 
  incr[9] = -0.3061862178478971*(alpha[14]*fhatAL[15]+fhatAL[14]*alpha[15]+alpha[10]*fhatAL[13]+fhatAL[10]*alpha[13]+alpha[9]*fhatAL[12]+fhatAL[9]*alpha[12]+alpha[7]*fhatAL[11]+fhatAL[7]*alpha[11]+alpha[4]*fhatAL[8]+fhatAL[4]*alpha[8]+alpha[3]*fhatAL[6]+fhatAL[3]*alpha[6]+alpha[2]*fhatAL[5]+fhatAL[2]*alpha[5]+alpha[0]*fhatAL[1]+fhatAL[0]*alpha[1])*dfac_v; 
  incr[10] = -0.3061862178478971*(alpha[13]*fhatAL[15]+fhatAL[13]*alpha[15]+alpha[10]*fhatAL[14]+fhatAL[10]*alpha[14]+alpha[8]*fhatAL[12]+fhatAL[8]*alpha[12]+alpha[6]*fhatAL[11]+fhatAL[6]*alpha[11]+alpha[4]*fhatAL[9]+fhatAL[4]*alpha[9]+alpha[3]*fhatAL[7]+fhatAL[3]*alpha[7]+alpha[1]*fhatAL[5]+fhatAL[1]*alpha[5]+alpha[0]*fhatAL[2]+fhatAL[0]*alpha[2])*dfac_v; 
  incr[11] = -0.3061862178478971*(alpha[12]*fhatAL[15]+fhatAL[12]*alpha[15]+alpha[9]*fhatAL[14]+fhatAL[9]*alpha[14]+alpha[8]*fhatAL[13]+fhatAL[8]*alpha[13]+alpha[5]*fhatAL[11]+fhatAL[5]*alpha[11]+alpha[4]*fhatAL[10]+fhatAL[4]*alpha[10]+alpha[2]*fhatAL[7]+fhatAL[2]*alpha[7]+alpha[1]*fhatAL[6]+fhatAL[1]*alpha[6]+alpha[0]*fhatAL[3]+fhatAL[0]*alpha[3])*dfac_v; 
  incr[12] = 0.1767766952966368*(alpha[7]*fhatAL[15]+fhatAL[7]*alpha[15]+alpha[11]*fhatAL[14]+fhatAL[11]*alpha[14]+alpha[3]*fhatAL[13]+fhatAL[3]*alpha[13]+alpha[2]*fhatAL[12]+fhatAL[2]*alpha[12]+alpha[6]*fhatAL[10]+fhatAL[6]*alpha[10]+alpha[5]*fhatAL[9]+fhatAL[5]*alpha[9]+alpha[0]*fhatAL[8]+fhatAL[0]*alpha[8]+alpha[1]*fhatAL[4]+fhatAL[1]*alpha[4])*dfac_v; 
  incr[13] = 0.1767766952966368*(alpha[6]*fhatAL[15]+fhatAL[6]*alpha[15]+alpha[3]*fhatAL[14]+fhatAL[3]*alpha[14]+alpha[11]*fhatAL[13]+fhatAL[11]*alpha[13]+alpha[1]*fhatAL[12]+fhatAL[1]*alpha[12]+alpha[7]*fhatAL[10]+fhatAL[7]*alpha[10]+alpha[0]*fhatAL[9]+fhatAL[0]*alpha[9]+alpha[5]*fhatAL[8]+fhatAL[5]*alpha[8]+alpha[2]*fhatAL[4]+fhatAL[2]*alpha[4])*dfac_v; 
  incr[14] = 0.1767766952966368*(alpha[5]*fhatAL[15]+fhatAL[5]*alpha[15]+alpha[2]*fhatAL[14]+fhatAL[2]*alpha[14]+alpha[1]*fhatAL[13]+fhatAL[1]*alpha[13]+alpha[11]*fhatAL[12]+fhatAL[11]*alpha[12]+alpha[0]*fhatAL[10]+fhatAL[0]*alpha[10]+alpha[7]*fhatAL[9]+fhatAL[7]*alpha[9]+alpha[6]*fhatAL[8]+fhatAL[6]*alpha[8]+alpha[3]*fhatAL[4]+fhatAL[3]*alpha[4])*dfac_v; 
  incr[15] = -0.3061862178478971*(alpha[11]*fhatAL[15]+fhatAL[11]*alpha[15]+alpha[7]*fhatAL[14]+fhatAL[7]*alpha[14]+alpha[6]*fhatAL[13]+fhatAL[6]*alpha[13]+alpha[5]*fhatAL[12]+fhatAL[5]*alpha[12]+alpha[3]*fhatAL[10]+fhatAL[3]*alpha[10]+alpha[2]*fhatAL[9]+fhatAL[2]*alpha[9]+alpha[1]*fhatAL[8]+fhatAL[1]*alpha[8]+alpha[0]*fhatAL[4]+fhatAL[0]*alpha[4])*dfac_v; 
  incr[16] = 0.1767766952966368*(alpha[4]*fhatAL[15]+fhatAL[4]*alpha[15]+alpha[8]*fhatAL[14]+fhatAL[8]*alpha[14]+alpha[9]*fhatAL[13]+fhatAL[9]*alpha[13]+alpha[10]*fhatAL[12]+fhatAL[10]*alpha[12]+alpha[0]*fhatAL[11]+fhatAL[0]*alpha[11]+alpha[1]*fhatAL[7]+fhatAL[1]*alpha[7]+alpha[2]*fhatAL[6]+fhatAL[2]*alpha[6]+alpha[3]*fhatAL[5]+fhatAL[3]*alpha[5])*dfac_v; 
  incr[17] = -0.3061862178478971*(alpha[10]*fhatAL[15]+fhatAL[10]*alpha[15]+alpha[13]*fhatAL[14]+fhatAL[13]*alpha[14]+alpha[4]*fhatAL[12]+fhatAL[4]*alpha[12]+alpha[3]*fhatAL[11]+fhatAL[3]*alpha[11]+alpha[8]*fhatAL[9]+fhatAL[8]*alpha[9]+alpha[6]*fhatAL[7]+fhatAL[6]*alpha[7]+alpha[0]*fhatAL[5]+fhatAL[0]*alpha[5]+alpha[1]*fhatAL[2]+fhatAL[1]*alpha[2])*dfac_v; 
  incr[18] = -0.3061862178478971*(alpha[9]*fhatAL[15]+fhatAL[9]*alpha[15]+alpha[12]*fhatAL[14]+fhatAL[12]*alpha[14]+alpha[4]*fhatAL[13]+fhatAL[4]*alpha[13]+alpha[2]*fhatAL[11]+fhatAL[2]*alpha[11]+alpha[8]*fhatAL[10]+fhatAL[8]*alpha[10]+alpha[5]*fhatAL[7]+fhatAL[5]*alpha[7]+alpha[0]*fhatAL[6]+fhatAL[0]*alpha[6]+alpha[1]*fhatAL[3]+fhatAL[1]*alpha[3])*dfac_v; 
  incr[19] = -0.3061862178478971*(alpha[8]*fhatAL[15]+fhatAL[8]*alpha[15]+alpha[4]*fhatAL[14]+fhatAL[4]*alpha[14]+alpha[12]*fhatAL[13]+fhatAL[12]*alpha[13]+alpha[1]*fhatAL[11]+fhatAL[1]*alpha[11]+alpha[9]*fhatAL[10]+fhatAL[9]*alpha[10]+alpha[0]*fhatAL[7]+fhatAL[0]*alpha[7]+alpha[5]*fhatAL[6]+fhatAL[5]*alpha[6]+alpha[2]*fhatAL[3]+fhatAL[2]*alpha[3])*dfac_v; 
  incr[20] = 0.1767766952966368*(alpha[3]*fhatAL[15]+fhatAL[3]*alpha[15]+alpha[6]*fhatAL[14]+fhatAL[6]*alpha[14]+alpha[7]*fhatAL[13]+fhatAL[7]*alpha[13]+alpha[0]*fhatAL[12]+fhatAL[0]*alpha[12]+alpha[10]*fhatAL[11]+fhatAL[10]*alpha[11]+alpha[1]*fhatAL[9]+fhatAL[1]*alpha[9]+alpha[2]*fhatAL[8]+fhatAL[2]*alpha[8]+alpha[4]*fhatAL[5]+fhatAL[4]*alpha[5])*dfac_v; 
  incr[21] = 0.1767766952966368*(alpha[2]*fhatAL[15]+fhatAL[2]*alpha[15]+alpha[5]*fhatAL[14]+fhatAL[5]*alpha[14]+alpha[0]*fhatAL[13]+fhatAL[0]*alpha[13]+alpha[7]*fhatAL[12]+fhatAL[7]*alpha[12]+alpha[9]*fhatAL[11]+fhatAL[9]*alpha[11]+alpha[1]*fhatAL[10]+fhatAL[1]*alpha[10]+alpha[3]*fhatAL[8]+fhatAL[3]*alpha[8]+alpha[4]*fhatAL[6]+fhatAL[4]*alpha[6])*dfac_v; 
  incr[22] = 0.1767766952966368*(alpha[1]*fhatAL[15]+fhatAL[1]*alpha[15]+alpha[0]*fhatAL[14]+fhatAL[0]*alpha[14]+alpha[5]*fhatAL[13]+fhatAL[5]*alpha[13]+alpha[6]*fhatAL[12]+fhatAL[6]*alpha[12]+alpha[8]*fhatAL[11]+fhatAL[8]*alpha[11]+alpha[2]*fhatAL[10]+fhatAL[2]*alpha[10]+alpha[3]*fhatAL[9]+fhatAL[3]*alpha[9]+alpha[4]*fhatAL[7]+fhatAL[4]*alpha[7])*dfac_v; 
  incr[23] = -0.3061862178478971*(alpha[7]*fhatAL[15]+fhatAL[7]*alpha[15]+alpha[11]*fhatAL[14]+fhatAL[11]*alpha[14]+alpha[3]*fhatAL[13]+fhatAL[3]*alpha[13]+alpha[2]*fhatAL[12]+fhatAL[2]*alpha[12]+alpha[6]*fhatAL[10]+fhatAL[6]*alpha[10]+alpha[5]*fhatAL[9]+fhatAL[5]*alpha[9]+alpha[0]*fhatAL[8]+fhatAL[0]*alpha[8]+alpha[1]*fhatAL[4]+fhatAL[1]*alpha[4])*dfac_v; 
  incr[24] = -0.3061862178478971*(alpha[6]*fhatAL[15]+fhatAL[6]*alpha[15]+alpha[3]*fhatAL[14]+fhatAL[3]*alpha[14]+alpha[11]*fhatAL[13]+fhatAL[11]*alpha[13]+alpha[1]*fhatAL[12]+fhatAL[1]*alpha[12]+alpha[7]*fhatAL[10]+fhatAL[7]*alpha[10]+alpha[0]*fhatAL[9]+fhatAL[0]*alpha[9]+alpha[5]*fhatAL[8]+fhatAL[5]*alpha[8]+alpha[2]*fhatAL[4]+fhatAL[2]*alpha[4])*dfac_v; 
  incr[25] = -0.3061862178478971*(alpha[5]*fhatAL[15]+fhatAL[5]*alpha[15]+alpha[2]*fhatAL[14]+fhatAL[2]*alpha[14]+alpha[1]*fhatAL[13]+fhatAL[1]*alpha[13]+alpha[11]*fhatAL[12]+fhatAL[11]*alpha[12]+alpha[0]*fhatAL[10]+fhatAL[0]*alpha[10]+alpha[7]*fhatAL[9]+fhatAL[7]*alpha[9]+alpha[6]*fhatAL[8]+fhatAL[6]*alpha[8]+alpha[3]*fhatAL[4]+fhatAL[3]*alpha[4])*dfac_v; 
  incr[26] = -0.3061862178478971*(alpha[4]*fhatAL[15]+fhatAL[4]*alpha[15]+alpha[8]*fhatAL[14]+fhatAL[8]*alpha[14]+alpha[9]*fhatAL[13]+fhatAL[9]*alpha[13]+alpha[10]*fhatAL[12]+fhatAL[10]*alpha[12]+alpha[0]*fhatAL[11]+fhatAL[0]*alpha[11]+alpha[1]*fhatAL[7]+fhatAL[1]*alpha[7]+alpha[2]*fhatAL[6]+fhatAL[2]*alpha[6]+alpha[3]*fhatAL[5]+fhatAL[3]*alpha[5])*dfac_v; 
  incr[27] = 0.1767766952966368*(alpha[0]*fhatAL[15]+fhatAL[0]*alpha[15]+alpha[1]*fhatAL[14]+fhatAL[1]*alpha[14]+alpha[2]*fhatAL[13]+fhatAL[2]*alpha[13]+alpha[3]*fhatAL[12]+fhatAL[3]*alpha[12]+alpha[4]*fhatAL[11]+fhatAL[4]*alpha[11]+alpha[5]*fhatAL[10]+fhatAL[5]*alpha[10]+alpha[6]*fhatAL[9]+fhatAL[6]*alpha[9]+alpha[7]*fhatAL[8]+fhatAL[7]*alpha[8])*dfac_v; 
  incr[28] = -0.3061862178478971*(alpha[3]*fhatAL[15]+fhatAL[3]*alpha[15]+alpha[6]*fhatAL[14]+fhatAL[6]*alpha[14]+alpha[7]*fhatAL[13]+fhatAL[7]*alpha[13]+alpha[0]*fhatAL[12]+fhatAL[0]*alpha[12]+alpha[10]*fhatAL[11]+fhatAL[10]*alpha[11]+alpha[1]*fhatAL[9]+fhatAL[1]*alpha[9]+alpha[2]*fhatAL[8]+fhatAL[2]*alpha[8]+alpha[4]*fhatAL[5]+fhatAL[4]*alpha[5])*dfac_v; 
  incr[29] = -0.3061862178478971*(alpha[2]*fhatAL[15]+fhatAL[2]*alpha[15]+alpha[5]*fhatAL[14]+fhatAL[5]*alpha[14]+alpha[0]*fhatAL[13]+fhatAL[0]*alpha[13]+alpha[7]*fhatAL[12]+fhatAL[7]*alpha[12]+alpha[9]*fhatAL[11]+fhatAL[9]*alpha[11]+alpha[1]*fhatAL[10]+fhatAL[1]*alpha[10]+alpha[3]*fhatAL[8]+fhatAL[3]*alpha[8]+alpha[4]*fhatAL[6]+fhatAL[4]*alpha[6])*dfac_v; 
  incr[30] = -0.3061862178478971*(alpha[1]*fhatAL[15]+fhatAL[1]*alpha[15]+alpha[0]*fhatAL[14]+fhatAL[0]*alpha[14]+alpha[5]*fhatAL[13]+fhatAL[5]*alpha[13]+alpha[6]*fhatAL[12]+fhatAL[6]*alpha[12]+alpha[8]*fhatAL[11]+fhatAL[8]*alpha[11]+alpha[2]*fhatAL[10]+fhatAL[2]*alpha[10]+alpha[3]*fhatAL[9]+fhatAL[3]*alpha[9]+alpha[4]*fhatAL[7]+fhatAL[4]*alpha[7])*dfac_v; 
  incr[31] = -0.3061862178478971*(alpha[0]*fhatAL[15]+fhatAL[0]*alpha[15]+alpha[1]*fhatAL[14]+fhatAL[1]*alpha[14]+alpha[2]*fhatAL[13]+fhatAL[2]*alpha[13]+alpha[3]*fhatAL[12]+fhatAL[3]*alpha[12]+alpha[4]*fhatAL[11]+fhatAL[4]*alpha[11]+alpha[5]*fhatAL[10]+fhatAL[5]*alpha[10]+alpha[6]*fhatAL[9]+fhatAL[6]*alpha[9]+alpha[7]*fhatAL[8]+fhatAL[7]*alpha[8])*dfac_v; 
