...
double alphaQuad;
  ...
  fupwind[14] = 0.25*(fupwindQuad[15]+fupwindQuad[14]-1.0*(fupwindQuad[13]+fupwindQuad[12]+fupwindQuad[11]+fupwindQuad[10])+fupwindQuad[9]+fupwindQuad[8]-1.0*(fupwindQuad[7]+fupwindQuad[6])+fupwindQuad[5]+fupwindQuad[4]+fupwindQuad[3]+fupwindQuad[2]-1.0*(fupwindQuad[1]+fupwindQuad[0])); 
  fupwind[15] = 0.25*(fupwindQuad[15]-1.0*(fupwindQuad[14]+fupwindQuad[13])+fupwindQuad[12]-1.0*fupwindQuad[11]+fupwindQuad[10]+fupwindQuad[9]-1.0*(fupwindQuad[8]+fupwindQuad[7])+fupwindQuad[6]+fupwindQuad[5]-1.0*fupwindQuad[4]+fupwindQuad[3]-1.0*(fupwindQuad[2]+fupwindQuad[1])+fupwindQuad[0]); 
  incrEmMod[0] = -0.5*(1.732050807568877*fupwind[3]-1.0*fupwind[0])*dfac_v; 
  incrEmMod[1] = -0.5*(1.732050807568877*fupwind[6]-1.0*fupwind[1])*dfac_v; 
  incrEmMod[2] = -0.5*(1.732050807568877*fupwind[7]-1.0*fupwind[2])*dfac_v; 
  incrEmMod[3] = 0.5*(3.0*fupwind[3]-1.732050807568877*fupwind[0])*dfac_v; 
  incrEmMod[4] = -0.5*(1.732050807568877*fupwind[10]-1.0*fupwind[4])*dfac_v; 
  incrEmMod[5] = -0.5*(1.732050807568877*fupwind[11]-1.0*fupwind[5])*dfac_v; 
  incrEmMod[6] = 0.5*(3.0*fupwind[6]-1.732050807568877*fupwind[1])*dfac_v; 
  incrEmMod[7] = 0.5*(3.0*fupwind[7]-1.732050807568877*fupwind[2])*dfac_v; 
  incrEmMod[8] = -0.5*(1.732050807568877*fupwind[13]-1.0*fupwind[8])*dfac_v; 
  incrEmMod[9] = -0.5*(1.732050807568877*fupwind[14]-1.0*fupwind[9])*dfac_v; 
  incrEmMod[10] = 0.5*(3.0*fupwind[10]-1.732050807568877*fupwind[4])*dfac_v; 
  incrEmMod[11] = 0.5*(3.0*fupwind[11]-1.732050807568877*fupwind[5])*dfac_v; 
  incrEmMod[12] = -0.5*(1.732050807568877*fupwind[15]-1.0*fupwind[12])*dfac_v; 
  incrEmMod[13] = 0.5*(3.0*fupwind[13]-1.732050807568877*fupwind[8])*dfac_v; 
  incrEmMod[14] = 0.5*(3.0*fupwind[14]-1.732050807568877*fupwind[9])*dfac_v; 
  incrEmMod[15] = 0.5*(3.0*fupwind[15]-1.732050807568877*fupwind[12])*dfac_v; 
