...
double EmGyrokineticSurf2x2vSer_X_P1_Bvars_0(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alpha0 = -(0.03125*((3.0*BstarX_by_Bmag[1]-1.732050807568877*BstarX_by_Bmag[0])*hamil[3]*dfac_v*q_+geoZ[0]*jacobTotInv[0]*(1.732050807568877*hamil[2]-3.0*hamil[5])*dfac_y*m_))/(m_*q_); 

  double alpha[8]; 
  alpha[0] = -(0.1767766952966368*((3.0*BstarX_by_Bmag[1]-1.732050807568877*BstarX_by_Bmag[0])*hamil[3]*dfac_v*q_+geoZ[0]*jacobTotInv[0]*(1.732050807568877*hamil[2]-3.0*hamil[5])*dfac_y*m_))/(m_*q_); 
...
double EmGyrokineticSurf2x2vSer_Y_P1_Bvars_0(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
  ...
  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.03125*((3.0*BstarY_by_Bmag[2]-1.732050807568877*BstarY_by_Bmag[0])*hamil[3]*dfac_v*q_+geoZ[0]*jacobTotInv[0]*(3.0*hamil[5]-1.732050807568877*hamil[1])*dfac_x*m_))/(m_*q_); 

  double alpha[8]; 
  alpha[0] = -(0.1767766952966368*((3.0*BstarY_by_Bmag[2]-1.732050807568877*BstarY_by_Bmag[0])*hamil[3]*dfac_v*q_+geoZ[0]*jacobTotInv[0]*(3.0*hamil[5]-1.732050807568877*hamil[1])*dfac_x*m_))/(m_*q_); 
#if upwindType == SURFAVG 
  if (alpha0>0) { 
...
double EmGyrokineticSurf2x2vSer_Vpar_P1_Bvars_0(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
  ...
  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.03125*(8.0*dApardtPrev[0]*q_+1.732050807568877*(BstarY_by_Bmag[0]*hamil[2]*dfac_y+BstarX_by_Bmag[0]*hamil[1]*dfac_x)))/m_; 

  double alpha[8]; 
  alpha[0] = -(0.3061862178478971*(BstarY_by_Bmag[0]*hamil[2]*dfac_y+BstarX_by_Bmag[0]*hamil[1]*dfac_x))/m_; 
  alpha[1] = -(0.3061862178478971*(BstarY_by_Bmag[0]*hamil[5]*dfac_y+BstarX_by_Bmag[1]*hamil[1]*dfac_x))/m_; 
  alpha[2] = -(0.3061862178478971*(BstarY_by_Bmag[2]*hamil[2]*dfac_y+BstarX_by_Bmag[0]*hamil[5]*dfac_x))/m_; 
  alpha[4] = -(0.3061862178478971*hamil[5]*(BstarY_by_Bmag[2]*dfac_y+BstarX_by_Bmag[1]*dfac_x))/m_; 
  double alphaUp[8]; 
  alphaUp[0] = -(0.1767766952966368*(8.0*dApardtPrev[0]*q_+1.732050807568877*(BstarY_by_Bmag[0]*hamil[2]*dfac_y+BstarX_by_Bmag[0]*hamil[1]*dfac_x)))/m_; 
  alphaUp[1] = -(0.1767766952966368*(8.0*dApardtPrev[1]*q_+1.732050807568877*(BstarY_by_Bmag[0]*hamil[5]*dfac_y+BstarX_by_Bmag[1]*hamil[1]*dfac_x)))/m_; 
  alphaUp[2] = -(0.1767766952966368*(8.0*dApardtPrev[2]*q_+1.732050807568877*(BstarY_by_Bmag[2]*hamil[2]*dfac_y+BstarX_by_Bmag[0]*hamil[5]*dfac_x)))/m_; 
  alphaUp[4] = -(0.1767766952966368*(8.0*dApardtPrev[3]*q_+1.732050807568877*hamil[5]*(BstarY_by_Bmag[2]*dfac_y+BstarX_by_Bmag[1]*dfac_x)))/m_; 
#if upwindType == SURFAVG 
  if (alpha0>0) { 
...
double EmGyrokineticSurf2x2vSer_X_P1_Bvars_1(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
  ...
  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.03125*((3.0*BstarX_by_Bmag[1]-1.732050807568877*BstarX_by_Bmag[0])*hamil[3]*dfac_v*q_+(((5.196152422706631*geoZ[0]-9.0*geoZ[1])*jacobTotInv[1]+jacobTotInv[0]*(5.196152422706631*geoZ[1]-3.0*geoZ[0]))*hamil[5]+((5.196152422706631*geoZ[1]-3.0*geoZ[0])*jacobTotInv[1]+jacobTotInv[0]*(1.732050807568877*geoZ[0]-3.0*geoZ[1]))*hamil[2])*dfac_y*m_))/(m_*q_); 

  double alpha[8]; 
  alpha[0] = -(0.1767766952966368*((3.0*BstarX_by_Bmag[1]-1.732050807568877*BstarX_by_Bmag[0])*hamil[3]*dfac_v*q_+(((5.196152422706631*geoZ[0]-9.0*geoZ[1])*jacobTotInv[1]+jacobTotInv[0]*(5.196152422706631*geoZ[1]-3.0*geoZ[0]))*hamil[5]+((5.196152422706631*geoZ[1]-3.0*geoZ[0])*jacobTotInv[1]+jacobTotInv[0]*(1.732050807568877*geoZ[0]-3.0*geoZ[1]))*hamil[2])*dfac_y*m_))/(m_*q_); 
#if upwindType == SURFAVG 
  if (alpha0>0) { 
  incr[0] = 0.1767766952966368*alpha[0]*(1.732050807568877*fl[1]+fl[0])*dfac_x; 
  incr[1] = -0.1767766952966368*alpha[0]*(3.0*fl[1]+1.732050807568877*fl[0])*dfac_x; 
...
double EmGyrokineticSurf2x2vSer_Y_P1_Bvars_1(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
  ...
  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.03125*((3.0*BstarY_by_Bmag[2]-1.732050807568877*BstarY_by_Bmag[0])*hamil[3]*dfac_v*q_+(geoZ[1]*jacobTotInv[1]+geoZ[0]*jacobTotInv[0])*(3.0*hamil[5]-1.732050807568877*hamil[1])*dfac_x*m_))/(m_*q_); 

  double alpha[8]; 
  alpha[0] = -(0.1767766952966368*((3.0*BstarY_by_Bmag[2]-1.732050807568877*BstarY_by_Bmag[0])*hamil[3]*dfac_v*q_+(geoZ[1]*jacobTotInv[1]+geoZ[0]*jacobTotInv[0])*(3.0*hamil[5]-1.732050807568877*hamil[1])*dfac_x*m_))/(m_*q_); 
  alpha[1] = -(0.1767766952966368*(hamil[3]*(3.0*BstarY_by_Bmag[5]-1.732050807568877*BstarY_by_Bmag[1])*dfac_v*q_+(geoZ[0]*jacobTotInv[1]+jacobTotInv[0]*geoZ[1])*(3.0*hamil[5]-1.732050807568877*hamil[1])*dfac_x*m_))/(m_*q_); 
...
double EmGyrokineticSurf2x2vSer_Vpar_P1_Bvars_1(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
  ...
  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.03125*(8.0*dApardtPrev[0]*q_-1.0*(hamil[5]*(3.0*BstarY_by_Bmag[6]-1.732050807568877*BstarY_by_Bmag[1])+hamil[2]*(3.0*BstarY_by_Bmag[3]-1.732050807568877*BstarY_by_Bmag[0]))*dfac_y+1.732050807568877*BstarX_by_Bmag[0]*hamil[1]*dfac_x))/m_; 

  double alpha[8]; 
  alpha[0] = (0.1767766952966368*((hamil[5]*(3.0*BstarY_by_Bmag[6]-1.732050807568877*BstarY_by_Bmag[1])+hamil[2]*(3.0*BstarY_by_Bmag[3]-1.732050807568877*BstarY_by_Bmag[0]))*dfac_y-1.732050807568877*BstarX_by_Bmag[0]*hamil[1]*dfac_x))/m_; 
  alpha[1] = (0.1767766952966368*((3.0*hamil[2]*BstarY_by_Bmag[6]+(3.0*BstarY_by_Bmag[3]-1.732050807568877*BstarY_by_Bmag[0])*hamil[5]-1.732050807568877*BstarY_by_Bmag[1]*hamil[2])*dfac_y-1.732050807568877*BstarX_by_Bmag[1]*hamil[1]*dfac_x))/m_; 
  alpha[2] = -(0.3061862178478971*((BstarY_by_Bmag[5]*hamil[5]+BstarY_by_Bmag[2]*hamil[2])*dfac_y+BstarX_by_Bmag[0]*hamil[5]*dfac_x))/m_; 
  alpha[3] = -(0.3061862178478971*BstarX_by_Bmag[0]*hamil[8]*dfac_x)/m_; 
  alpha[4] = -(0.3061862178478971*((BstarY_by_Bmag[2]*hamil[5]+hamil[2]*BstarY_by_Bmag[5])*dfac_y+BstarX_by_Bmag[1]*hamil[5]*dfac_x))/m_; 
  alpha[5] = -(0.3061862178478971*BstarX_by_Bmag[1]*hamil[8]*dfac_x)/m_; 
  double alphaUp[8]; 
  alphaUp[0] = -(0.1767766952966368*(8.0*dApardtPrev[0]*q_+(hamil[5]*(1.732050807568877*BstarY_by_Bmag[1]-3.0*BstarY_by_Bmag[6])+hamil[2]*(1.732050807568877*BstarY_by_Bmag[0]-3.0*BstarY_by_Bmag[3]))*dfac_y+1.732050807568877*BstarX_by_Bmag[0]*hamil[1]*dfac_x))/m_; 
  alphaUp[1] = -(0.1767766952966368*(8.0*dApardtPrev[1]*q_+((-3.0*hamil[2]*BstarY_by_Bmag[6])+(1.732050807568877*BstarY_by_Bmag[0]-3.0*BstarY_by_Bmag[3])*hamil[5]+1.732050807568877*BstarY_by_Bmag[1]*hamil[2])*dfac_y+1.732050807568877*BstarX_by_Bmag[1]*hamil[1]*dfac_x))/m_; 
  alphaUp[2] = -(0.1020620726159657*(13.85640646055102*dApardtPrev[2]*q_+3.0*((BstarY_by_Bmag[5]*hamil[5]+BstarY_by_Bmag[2]*hamil[2])*dfac_y+BstarX_by_Bmag[0]*hamil[5]*dfac_x)))/m_; 
  alphaUp[3] = -(0.3061862178478971*BstarX_by_Bmag[0]*hamil[8]*dfac_x)/m_; 
  alphaUp[4] = -(0.1767766952966368*(8.0*dApardtPrev[3]*q_+1.732050807568877*((BstarY_by_Bmag[2]*hamil[5]+hamil[2]*BstarY_by_Bmag[5])*dfac_y+BstarX_by_Bmag[1]*hamil[5]*dfac_x)))/m_; 
  alphaUp[5] = -(0.3061862178478971*BstarX_by_Bmag[1]*hamil[8]*dfac_x)/m_; 
#if upwindType == SURFAVG 
  if (alpha0>0) { 
