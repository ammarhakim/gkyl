...
double GyrokineticVol3x2vSerP1_Bvars_0(const double q_, const double m_, const double *w, const double *dxv, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *f0, const double *Phi, const double *f, double *out) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  out[3] += -(0.1875*Gradpar[0]*f0[0]*hamil[4]*dfac_v*dfac_z)/m_; 
  out[7] += -(0.1875*Gradpar[0]*f0[1]*hamil[4]*dfac_v*dfac_z)/m_; 
  out[8] += -(0.1875*Gradpar[0]*f0[2]*hamil[4]*dfac_v*dfac_z)/m_; 
  out[11] += -(0.1875*Gradpar[0]*f0[4]*hamil[4]*dfac_v*dfac_z)/m_; 
  out[14] += -(0.1875*Gradpar[0]*hamil[4]*f0[5]*dfac_v*dfac_z)/m_; 
  out[16] += -(0.1875*Gradpar[0]*hamil[4]*f0[6]*dfac_v*dfac_z)/m_; 
  out[18] += -(0.1875*Gradpar[0]*hamil[4]*f0[9]*dfac_v*dfac_z)/m_; 
  out[19] += -(0.1875*Gradpar[0]*hamil[4]*f0[10]*dfac_v*dfac_z)/m_; 
  out[21] += -(0.1875*Gradpar[0]*hamil[4]*f0[12]*dfac_v*dfac_z)/m_; 
  out[22] += -(0.1875*Gradpar[0]*hamil[4]*f0[13]*dfac_v*dfac_z)/m_; 
  out[25] += -(0.1875*Gradpar[0]*hamil[4]*f0[15]*dfac_v*dfac_z)/m_; 
  out[26] += -(0.1875*Gradpar[0]*hamil[4]*f0[17]*dfac_v*dfac_z)/m_; 
  out[27] += -(0.1875*Gradpar[0]*hamil[4]*f0[20]*dfac_v*dfac_z)/m_; 
  out[29] += -(0.1875*Gradpar[0]*hamil[4]*f0[23]*dfac_v*dfac_z)/m_; 
  out[30] += -(0.1875*Gradpar[0]*hamil[4]*f0[24]*dfac_v*dfac_z)/m_; 
  out[31] += -(0.1875*Gradpar[0]*hamil[4]*f0[28]*dfac_v*dfac_z)/m_; 
  return cflFreq; 
} 
double GyrokineticVol3x2vSerP1_Bvars_1(const double q_, const double m_, const double *w, const double *dxv, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *f0, const double *Phi, const double *f, double *out) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
  ...
  out[3] += -(0.1875*(Gradpar[1]*f0[1]+Gradpar[0]*f0[0])*hamil[4]*dfac_v*dfac_z)/m_; 
  out[7] += -(0.1875*(Gradpar[0]*f0[1]+f0[0]*Gradpar[1])*hamil[4]*dfac_v*dfac_z)/m_; 
  out[8] += -(0.1875*hamil[4]*(Gradpar[1]*f0[6]+Gradpar[0]*f0[2])*dfac_v*dfac_z)/m_; 
  out[11] += -(0.1875*hamil[4]*(Gradpar[1]*f0[9]+Gradpar[0]*f0[4])*dfac_v*dfac_z)/m_; 
  out[14] += -(0.1875*hamil[4]*(Gradpar[1]*f0[12]+Gradpar[0]*f0[5])*dfac_v*dfac_z)/m_; 
  out[16] += -(0.1875*hamil[4]*(Gradpar[0]*f0[6]+Gradpar[1]*f0[2])*dfac_v*dfac_z)/m_; 
  out[18] += -(0.1875*hamil[4]*(Gradpar[0]*f0[9]+Gradpar[1]*f0[4])*dfac_v*dfac_z)/m_; 
  out[19] += -(0.1875*hamil[4]*(Gradpar[1]*f0[17]+Gradpar[0]*f0[10])*dfac_v*dfac_z)/m_; 
  out[21] += -(0.1875*hamil[4]*(Gradpar[0]*f0[12]+Gradpar[1]*f0[5])*dfac_v*dfac_z)/m_; 
  out[22] += -(0.1875*hamil[4]*(Gradpar[1]*f0[20]+Gradpar[0]*f0[13])*dfac_v*dfac_z)/m_; 
  out[25] += -(0.1875*hamil[4]*(Gradpar[1]*f0[23]+Gradpar[0]*f0[15])*dfac_v*dfac_z)/m_; 
  out[26] += -(0.1875*hamil[4]*(Gradpar[0]*f0[17]+Gradpar[1]*f0[10])*dfac_v*dfac_z)/m_; 
  out[27] += -(0.1875*hamil[4]*(Gradpar[0]*f0[20]+Gradpar[1]*f0[13])*dfac_v*dfac_z)/m_; 
  out[29] += -(0.1875*hamil[4]*(Gradpar[0]*f0[23]+Gradpar[1]*f0[15])*dfac_v*dfac_z)/m_; 
  out[30] += -(0.1875*hamil[4]*(Gradpar[1]*f0[28]+Gradpar[0]*f0[24])*dfac_v*dfac_z)/m_; 
  out[31] += -(0.1875*hamil[4]*(Gradpar[0]*f0[28]+Gradpar[1]*f0[24])*dfac_v*dfac_z)/m_; 
  return cflFreq; 
} 
double GyrokineticVol3x2vSerP1_Bvars_3(const double q_, const double m_, const double *w, const double *dxv, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *f0, const double *Phi, const double *f, double *out) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
  ...
  out[3] += -(0.1875*(Gradpar[3]*f0[3]+Gradpar[0]*f0[0])*hamil[4]*dfac_v*dfac_z)/m_; 
  out[4] += (0.125*Bmag[3]*dfac_v*dfac_z*(3.0*(Gradpar[3]*f0[3]+Gradpar[0]*f0[0])*dfac_m*wm+1.732050807568877*(Gradpar[3]*f0[14]+Gradpar[0]*f0[5])))/(dfac_m*m_); 
  out[7] += -(0.1875*hamil[4]*(Gradpar[3]*f0[7]+Gradpar[0]*f0[1])*dfac_v*dfac_z)/m_; 
  out[8] += -(0.1875*hamil[4]*(Gradpar[3]*f0[8]+Gradpar[0]*f0[2])*dfac_v*dfac_z)/m_; 
  out[9] += (0.125*Bmag[3]*dfac_v*dfac_z*(3.0*(Gradpar[3]*f0[7]+Gradpar[0]*f0[1])*dfac_m*wm+1.732050807568877*(Gradpar[3]*f0[21]+Gradpar[0]*f0[12])))/(dfac_m*m_); 
  out[10] += (0.125*Bmag[3]*dfac_v*dfac_z*(3.0*(Gradpar[3]*f0[8]+Gradpar[0]*f0[2])*dfac_m*wm+1.732050807568877*(Gradpar[3]*f0[22]+Gradpar[0]*f0[13])))/(dfac_m*m_); 
  out[11] += (0.0625*dfac_v*dfac_z*(3.0*dfac_m*(2.0*Bmag[3]*(Gradpar[0]*f0[3]+f0[0]*Gradpar[3])*wm-1.0*hamil[4]*(Gradpar[3]*f0[11]+Gradpar[0]*f0[4]))+3.464101615137754*Bmag[3]*(Gradpar[0]*f0[14]+Gradpar[3]*f0[5])))/(dfac_m*m_); 
  out[14] += -(0.1875*hamil[4]*(Gradpar[3]*f0[14]+Gradpar[0]*f0[5])*dfac_v*dfac_z)/m_; 
  out[15] += (0.125*Bmag[3]*dfac_v*dfac_z*(3.0*(Gradpar[3]*f0[14]+Gradpar[0]*f0[5])*dfac_m*wm+1.732050807568877*(Gradpar[3]*f0[3]+Gradpar[0]*f0[0])))/(dfac_m*m_); 
  out[16] += -(0.1875*hamil[4]*(Gradpar[3]*f0[16]+Gradpar[0]*f0[6])*dfac_v*dfac_z)/m_; 
  out[17] += (0.125*Bmag[3]*dfac_v*dfac_z*(3.0*(Gradpar[3]*f0[16]+Gradpar[0]*f0[6])*dfac_m*wm+1.732050807568877*(Gradpar[3]*f0[27]+Gradpar[0]*f0[20])))/(dfac_m*m_); 
  out[18] += (0.0625*dfac_v*dfac_z*(3.0*dfac_m*(2.0*Bmag[3]*(Gradpar[0]*f0[7]+f0[1]*Gradpar[3])*wm-1.0*hamil[4]*(Gradpar[3]*f0[18]+Gradpar[0]*f0[9]))+3.464101615137754*Bmag[3]*(Gradpar[0]*f0[21]+Gradpar[3]*f0[12])))/(dfac_m*m_); 
  out[19] += (0.0625*dfac_v*dfac_z*(3.0*dfac_m*(2.0*Bmag[3]*(Gradpar[0]*f0[8]+f0[2]*Gradpar[3])*wm-1.0*hamil[4]*(Gradpar[3]*f0[19]+Gradpar[0]*f0[10]))+3.464101615137754*Bmag[3]*(Gradpar[0]*f0[22]+Gradpar[3]*f0[13])))/(dfac_m*m_); 
  out[21] += -(0.1875*hamil[4]*(Gradpar[3]*f0[21]+Gradpar[0]*f0[12])*dfac_v*dfac_z)/m_; 
  out[22] += -(0.1875*hamil[4]*(Gradpar[3]*f0[22]+Gradpar[0]*f0[13])*dfac_v*dfac_z)/m_; 
  out[23] += (0.125*Bmag[3]*dfac_v*dfac_z*(3.0*(Gradpar[3]*f0[21]+Gradpar[0]*f0[12])*dfac_m*wm+1.732050807568877*(Gradpar[3]*f0[7]+Gradpar[0]*f0[1])))/(dfac_m*m_); 
  out[24] += (0.125*Bmag[3]*dfac_v*dfac_z*(3.0*(Gradpar[3]*f0[22]+Gradpar[0]*f0[13])*dfac_m*wm+1.732050807568877*(Gradpar[3]*f0[8]+Gradpar[0]*f0[2])))/(dfac_m*m_); 
  out[25] += (0.0625*dfac_v*dfac_z*(3.0*dfac_m*(2.0*Bmag[3]*(Gradpar[0]*f0[14]+Gradpar[3]*f0[5])*wm-1.0*hamil[4]*(Gradpar[3]*f0[25]+Gradpar[0]*f0[15]))+3.464101615137754*Bmag[3]*(Gradpar[0]*f0[3]+f0[0]*Gradpar[3])))/(dfac_m*m_); 
  out[26] += (0.0625*dfac_v*dfac_z*(3.0*dfac_m*(2.0*Bmag[3]*(Gradpar[0]*f0[16]+Gradpar[3]*f0[6])*wm-1.0*hamil[4]*(Gradpar[3]*f0[26]+Gradpar[0]*f0[17]))+3.464101615137754*Bmag[3]*(Gradpar[0]*f0[27]+Gradpar[3]*f0[20])))/(dfac_m*m_); 
  out[27] += -(0.1875*hamil[4]*(Gradpar[3]*f0[27]+Gradpar[0]*f0[20])*dfac_v*dfac_z)/m_; 
  out[28] += (0.125*Bmag[3]*dfac_v*dfac_z*(3.0*(Gradpar[3]*f0[27]+Gradpar[0]*f0[20])*dfac_m*wm+1.732050807568877*(Gradpar[3]*f0[16]+Gradpar[0]*f0[6])))/(dfac_m*m_); 
  out[29] += (0.0625*dfac_v*dfac_z*(3.0*dfac_m*(2.0*Bmag[3]*(Gradpar[0]*f0[21]+Gradpar[3]*f0[12])*wm-1.0*hamil[4]*(Gradpar[3]*f0[29]+Gradpar[0]*f0[23]))+3.464101615137754*Bmag[3]*(Gradpar[0]*f0[7]+f0[1]*Gradpar[3])))/(dfac_m*m_); 
  out[30] += (0.0625*dfac_v*dfac_z*(3.0*dfac_m*(2.0*Bmag[3]*(Gradpar[0]*f0[22]+Gradpar[3]*f0[13])*wm-1.0*hamil[4]*(Gradpar[3]*f0[30]+Gradpar[0]*f0[24]))+3.464101615137754*Bmag[3]*(Gradpar[0]*f0[8]+f0[2]*Gradpar[3])))/(dfac_m*m_); 
  out[31] += (0.0625*dfac_v*dfac_z*(3.0*dfac_m*(2.0*Bmag[3]*(Gradpar[0]*f0[27]+Gradpar[3]*f0[20])*wm-1.0*hamil[4]*(Gradpar[3]*f0[31]+Gradpar[0]*f0[28]))+3.464101615137754*Bmag[3]*(Gradpar[0]*f0[16]+Gradpar[3]*f0[6])))/(dfac_m*m_); 
  return cflFreq; 
} 
double GyrokineticVol3x2vSerP1_Bvars_1_3(const double q_, const double m_, const double *w, const double *dxv, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *f0, const double *Phi, const double *f, double *out) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
  ...
  out[3] += -(0.1875*hamil[4]*(Gradpar[5]*f0[7]+Gradpar[3]*f0[3]+Gradpar[1]*f0[1]+Gradpar[0]*f0[0])*dfac_v*dfac_z)/m_; 
  out[4] += (0.125*dfac_v*dfac_z*(3.0*(Bmag[3]*Gradpar[5]*f0[7]+Bmag[5]*(Gradpar[3]*f0[7]+f0[3]*Gradpar[5]+Gradpar[0]*f0[1]+f0[0]*Gradpar[1])+Bmag[3]*(Gradpar[3]*f0[3]+Gradpar[1]*f0[1]+Gradpar[0]*f0[0]))*dfac_m*wm+1.732050807568877*((Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[21]+(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3])*f0[14]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[12]+(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3])*f0[5])))/(dfac_m*m_); 
  out[7] += -(0.1875*hamil[4]*(Gradpar[3]*f0[7]+f0[3]*Gradpar[5]+Gradpar[0]*f0[1]+f0[0]*Gradpar[1])*dfac_v*dfac_z)/m_; 
  out[8] += -(0.1875*hamil[4]*(Gradpar[5]*f0[16]+Gradpar[3]*f0[8]+Gradpar[1]*f0[6]+Gradpar[0]*f0[2])*dfac_v*dfac_z)/m_; 
  out[9] += (0.025*dfac_v*dfac_z*(3.0*(9.0*Bmag[5]*Gradpar[5]*f0[7]+5.0*Bmag[3]*(Gradpar[3]*f0[7]+f0[3]*Gradpar[5])+(5.0*Gradpar[3]*f0[3]+9.0*Gradpar[1]*f0[1])*Bmag[5]+5.0*(Gradpar[0]*f0[0]*Bmag[5]+(Gradpar[0]*f0[1]+f0[0]*Gradpar[1])*Bmag[3]))*dfac_m*wm+1.732050807568877*(9.0*Bmag[5]*Gradpar[5]*f0[21]+5.0*Bmag[3]*(Gradpar[3]*f0[21]+Gradpar[5]*f0[14])+Bmag[5]*(5.0*Gradpar[3]*f0[14]+9.0*Gradpar[1]*f0[12])+5.0*(Gradpar[0]*Bmag[3]*f0[12]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[5]))))/(dfac_m*m_); 
  out[10] += (0.125*dfac_v*dfac_z*(3.0*((Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[16]+(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3])*f0[8]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[6]+f0[2]*(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3]))*dfac_m*wm+1.732050807568877*((Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[27]+(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3])*f0[22]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[20]+(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3])*f0[13])))/(dfac_m*m_); 
  out[11] += (0.0625*dfac_v*dfac_z*(3.0*dfac_m*(2.0*((Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[7]+(f0[0]*Bmag[5]+f0[1]*Bmag[3])*Gradpar[5]+(Gradpar[1]*f0[3]+f0[1]*Gradpar[3])*Bmag[5]+Bmag[3]*(Gradpar[0]*f0[3]+f0[0]*Gradpar[3]))*wm-1.0*hamil[4]*(Gradpar[5]*f0[18]+Gradpar[3]*f0[11]+Gradpar[1]*f0[9]+Gradpar[0]*f0[4]))+3.464101615137754*((Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[21]+(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3])*f0[14]+(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[12]+(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3])*f0[5])))/(dfac_m*m_); 
  out[14] += -(0.1875*hamil[4]*(Gradpar[5]*f0[21]+Gradpar[3]*f0[14]+Gradpar[1]*f0[12]+Gradpar[0]*f0[5])*dfac_v*dfac_z)/m_; 
  out[15] += (0.125*dfac_v*dfac_z*(3.0*((Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[21]+(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3])*f0[14]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[12]+(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3])*f0[5])*dfac_m*wm+1.732050807568877*(Bmag[3]*Gradpar[5]*f0[7]+Bmag[5]*(Gradpar[3]*f0[7]+f0[3]*Gradpar[5]+Gradpar[0]*f0[1]+f0[0]*Gradpar[1])+Bmag[3]*(Gradpar[3]*f0[3]+Gradpar[1]*f0[1]+Gradpar[0]*f0[0]))))/(dfac_m*m_); 
  out[16] += -(0.1875*hamil[4]*(Gradpar[3]*f0[16]+Gradpar[5]*f0[8]+Gradpar[0]*f0[6]+Gradpar[1]*f0[2])*dfac_v*dfac_z)/m_; 
  out[17] += (0.025*dfac_v*dfac_z*(3.0*(9.0*Bmag[5]*Gradpar[5]*f0[16]+5.0*Bmag[3]*(Gradpar[3]*f0[16]+Gradpar[5]*f0[8])+Bmag[5]*(5.0*Gradpar[3]*f0[8]+9.0*Gradpar[1]*f0[6])+5.0*(Gradpar[0]*Bmag[3]*f0[6]+f0[2]*(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])))*dfac_m*wm+1.732050807568877*(9.0*Bmag[5]*Gradpar[5]*f0[27]+5.0*Bmag[3]*(Gradpar[3]*f0[27]+Gradpar[5]*f0[22])+Bmag[5]*(5.0*Gradpar[3]*f0[22]+9.0*Gradpar[1]*f0[20])+5.0*(Gradpar[0]*Bmag[3]*f0[20]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[13]))))/(dfac_m*m_); 
  out[18] += (0.0125*dfac_v*dfac_z*(3.0*dfac_m*((10.0*(Bmag[3]*(Gradpar[0]*f0[7]+f0[0]*Gradpar[5])+(Gradpar[0]*f0[3]+f0[0]*Gradpar[3])*Bmag[5]+Bmag[3]*(Gradpar[1]*f0[3]+f0[1]*Gradpar[3]))+18.0*Bmag[5]*(Gradpar[1]*f0[7]+f0[1]*Gradpar[5]))*wm-5.0*hamil[4]*(Gradpar[3]*f0[18]+Gradpar[5]*f0[11]+Gradpar[0]*f0[9]+Gradpar[1]*f0[4]))+3.464101615137754*(9.0*Gradpar[1]*Bmag[5]*f0[21]+5.0*(Gradpar[0]*Bmag[3]*f0[21]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[14])+9.0*Bmag[5]*Gradpar[5]*f0[12]+5.0*(Bmag[3]*Gradpar[3]*f0[12]+(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[5]))))/(dfac_m*m_); 
  out[19] += (0.0625*dfac_v*dfac_z*(3.0*dfac_m*(2.0*((Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[16]+(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3])*f0[8]+(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[6]+f0[2]*(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3]))*wm-1.0*hamil[4]*(Gradpar[5]*f0[26]+Gradpar[3]*f0[19]+Gradpar[1]*f0[17]+Gradpar[0]*f0[10]))+3.464101615137754*((Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[27]+(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3])*f0[22]+(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[20]+(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3])*f0[13])))/(dfac_m*m_); 
  out[21] += -(0.1875*hamil[4]*(Gradpar[3]*f0[21]+Gradpar[5]*f0[14]+Gradpar[0]*f0[12]+Gradpar[1]*f0[5])*dfac_v*dfac_z)/m_; 
  out[22] += -(0.1875*hamil[4]*(Gradpar[5]*f0[27]+Gradpar[3]*f0[22]+Gradpar[1]*f0[20]+Gradpar[0]*f0[13])*dfac_v*dfac_z)/m_; 
  out[23] += (0.025*dfac_v*dfac_z*(3.0*(9.0*Bmag[5]*Gradpar[5]*f0[21]+5.0*Bmag[3]*(Gradpar[3]*f0[21]+Gradpar[5]*f0[14])+Bmag[5]*(5.0*Gradpar[3]*f0[14]+9.0*Gradpar[1]*f0[12])+5.0*(Gradpar[0]*Bmag[3]*f0[12]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[5]))*dfac_m*wm+1.732050807568877*(9.0*Bmag[5]*Gradpar[5]*f0[7]+5.0*Bmag[3]*(Gradpar[3]*f0[7]+f0[3]*Gradpar[5])+(5.0*Gradpar[3]*f0[3]+9.0*Gradpar[1]*f0[1])*Bmag[5]+5.0*(Gradpar[0]*f0[0]*Bmag[5]+(Gradpar[0]*f0[1]+f0[0]*Gradpar[1])*Bmag[3]))))/(dfac_m*m_); 
  out[24] += (0.125*dfac_v*dfac_z*(3.0*((Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[27]+(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3])*f0[22]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[20]+(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3])*f0[13])*dfac_m*wm+1.732050807568877*((Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[16]+(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3])*f0[8]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[6]+f0[2]*(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3]))))/(dfac_m*m_); 
  out[25] += (0.0625*dfac_v*dfac_z*(3.0*dfac_m*(2.0*((Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[21]+(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3])*f0[14]+(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[12]+(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3])*f0[5])*wm-1.0*hamil[4]*(Gradpar[5]*f0[29]+Gradpar[3]*f0[25]+Gradpar[1]*f0[23]+Gradpar[0]*f0[15]))+3.464101615137754*((Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[7]+(f0[0]*Bmag[5]+f0[1]*Bmag[3])*Gradpar[5]+(Gradpar[1]*f0[3]+f0[1]*Gradpar[3])*Bmag[5]+Bmag[3]*(Gradpar[0]*f0[3]+f0[0]*Gradpar[3]))))/(dfac_m*m_); 
  out[26] += (0.0125*dfac_v*dfac_z*(3.0*dfac_m*((10.0*(Bmag[3]*(Gradpar[0]*f0[16]+Gradpar[1]*f0[8]+Gradpar[3]*f0[6])+f0[2]*(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5]))+Bmag[5]*(18.0*Gradpar[1]*f0[16]+10.0*Gradpar[0]*f0[8]+18.0*Gradpar[5]*f0[6]))*wm-5.0*hamil[4]*(Gradpar[3]*f0[26]+Gradpar[5]*f0[19]+Gradpar[0]*f0[17]+Gradpar[1]*f0[10]))+3.464101615137754*(9.0*Gradpar[1]*Bmag[5]*f0[27]+5.0*(Gradpar[0]*Bmag[3]*f0[27]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[22])+9.0*Bmag[5]*Gradpar[5]*f0[20]+5.0*(Bmag[3]*Gradpar[3]*f0[20]+(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[13]))))/(dfac_m*m_); 
  out[27] += -(0.1875*hamil[4]*(Gradpar[3]*f0[27]+Gradpar[5]*f0[22]+Gradpar[0]*f0[20]+Gradpar[1]*f0[13])*dfac_v*dfac_z)/m_; 
  out[28] += (0.025*dfac_v*dfac_z*(3.0*(9.0*Bmag[5]*Gradpar[5]*f0[27]+5.0*Bmag[3]*(Gradpar[3]*f0[27]+Gradpar[5]*f0[22])+Bmag[5]*(5.0*Gradpar[3]*f0[22]+9.0*Gradpar[1]*f0[20])+5.0*(Gradpar[0]*Bmag[3]*f0[20]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[13]))*dfac_m*wm+1.732050807568877*(9.0*Bmag[5]*Gradpar[5]*f0[16]+5.0*Bmag[3]*(Gradpar[3]*f0[16]+Gradpar[5]*f0[8])+Bmag[5]*(5.0*Gradpar[3]*f0[8]+9.0*Gradpar[1]*f0[6])+5.0*(Gradpar[0]*Bmag[3]*f0[6]+f0[2]*(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])))))/(dfac_m*m_); 
  out[29] += (0.0125*dfac_v*dfac_z*(3.0*dfac_m*((10.0*(Bmag[3]*(Gradpar[0]*f0[21]+Gradpar[1]*f0[14]+Gradpar[3]*f0[12])+(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[5])+Bmag[5]*(18.0*Gradpar[1]*f0[21]+10.0*Gradpar[0]*f0[14]+18.0*Gradpar[5]*f0[12]))*wm-5.0*hamil[4]*(Gradpar[3]*f0[29]+Gradpar[5]*f0[25]+Gradpar[0]*f0[23]+Gradpar[1]*f0[15]))+3.464101615137754*((9.0*Gradpar[1]*Bmag[5]+5.0*Gradpar[0]*Bmag[3])*f0[7]+9.0*f0[1]*Bmag[5]*Gradpar[5]+5.0*(f0[0]*Bmag[3]*Gradpar[5]+(Gradpar[0]*f0[3]+f0[0]*Gradpar[3])*Bmag[5]+Bmag[3]*(Gradpar[1]*f0[3]+f0[1]*Gradpar[3])))))/(dfac_m*m_); 
  out[30] += (0.0625*dfac_v*dfac_z*(3.0*dfac_m*(2.0*((Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[27]+(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3])*f0[22]+(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[20]+(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3])*f0[13])*wm-1.0*hamil[4]*(Gradpar[5]*f0[31]+Gradpar[3]*f0[30]+Gradpar[1]*f0[28]+Gradpar[0]*f0[24]))+3.464101615137754*((Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[16]+(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3])*f0[8]+(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[6]+f0[2]*(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3]))))/(dfac_m*m_); 
  out[31] += (0.0125*dfac_v*dfac_z*(3.0*dfac_m*((10.0*(Bmag[3]*(Gradpar[0]*f0[27]+Gradpar[1]*f0[22]+Gradpar[3]*f0[20])+(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*f0[13])+Bmag[5]*(18.0*Gradpar[1]*f0[27]+10.0*Gradpar[0]*f0[22]+18.0*Gradpar[5]*f0[20]))*wm-5.0*hamil[4]*(Gradpar[3]*f0[31]+Gradpar[5]*f0[30]+Gradpar[0]*f0[28]+Gradpar[1]*f0[24]))+3.464101615137754*(9.0*Gradpar[1]*Bmag[5]*f0[16]+5.0*(Gradpar[0]*Bmag[3]*f0[16]+(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*f0[8])+9.0*Bmag[5]*Gradpar[5]*f0[6]+5.0*(Bmag[3]*Gradpar[3]*f0[6]+f0[2]*(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])))))/(dfac_m*m_); 
  return cflFreq; 
} 
