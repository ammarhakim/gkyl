...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alphaR = 0.0; 
  double alphax[16]; 
  alphax[0] = dfac_x*((2.0*BdriftX[0]*m_*wv2)/q_+(3.464101615137754*Apar[2]*dfac_y+Apar[0]*BdriftX[0])*wv-1.732050807568877*BmagInv[0]*Phi[2]*dfac_y); 
  alphax[1] = dfac_x*((3.464101615137754*Apar[3]*dfac_y+BdriftX[0]*Apar[1])*wv-1.732050807568877*BmagInv[0]*Phi[3]*dfac_y); 
  ...
  double alphay[16]; 
  alphay[0] = dfac_y*((2.0*BdriftY[0]*m_*wv2)/q_+(Apar[0]*BdriftY[0]-3.464101615137754*Apar[1]*dfac_x)*wv+1.732050807568877*BmagInv[0]*Phi[1]*dfac_x); 
  alphay[1] = BdriftY[0]*Apar[1]*dfac_y*wv; 
  alphay[2] = -1.0*dfac_y*(3.464101615137754*Apar[3]*dfac_x*wv-1.0*(BdriftY[0]*Apar[2]*wv+1.732050807568877*BmagInv[0]*Phi[3]*dfac_x)); 
  ...
  double alphav[16]; 
  alphav[0] = -1.0*dfac_v*(1.732050807568877*(BdriftY[0]*Phi[2]*dfac_y+BdriftX[0]*Phi[1]*dfac_x)*wv+((1.732050807568877*(0.5*BdriftY[0]*(Apar[1]*Phi[3]+Apar[0]*Phi[2])*dfac_y+0.5*BdriftX[0]*(Apar[2]*Phi[3]+Apar[0]*Phi[1])*dfac_x)+3.0*(Phi[1]*Apar[2]-1.0*Apar[1]*Phi[2])*dfac_x*dfac_y)*q_)/m_); 
  alphav[1] = -1.0*dfac_v*(1.732050807568877*BdriftY[0]*Phi[3]*dfac_y*wv+((1.732050807568877*(0.5*BdriftY[0]*(Apar[0]*Phi[3]+Apar[1]*Phi[2])*dfac_y+0.5*BdriftX[0]*(Apar[3]*Phi[3]+Apar[1]*Phi[1])*dfac_x)+3.0*(Phi[1]*Apar[3]-1.0*Apar[1]*Phi[3])*dfac_x*dfac_y)*q_)/m_); 
  alphav[2] = -1.0*dfac_v*(1.732050807568877*BdriftX[0]*Phi[3]*dfac_x*wv+((1.732050807568877*(0.5*BdriftY[0]*(Apar[3]*Phi[3]+Apar[2]*Phi[2])*dfac_y+0.5*BdriftX[0]*(Apar[0]*Phi[3]+Phi[1]*Apar[2])*dfac_x)+3.0*(Apar[2]*Phi[3]-1.0*Phi[2]*Apar[3])*dfac_x*dfac_y)*q_)/m_); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alphaR = 0.0; 
  double alphax[16]; 
  alphax[0] = dfac_x*((2.0*BdriftX[0]*m_*wv2)/q_+(3.464101615137754*Apar[2]*dfac_y+Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*wv-1.732050807568877*(BmagInv[1]*Phi[3]+BmagInv[0]*Phi[2])*dfac_y); 
  alphax[1] = dfac_x*((2.0*BdriftX[1]*m_*wv2)/q_+(3.464101615137754*Apar[3]*dfac_y+Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])*wv-1.732050807568877*(BmagInv[0]*Phi[3]+BmagInv[1]*Phi[2])*dfac_y); 
  ...
  double alphay[16]; 
  alphay[0] = dfac_y*((2.0*BdriftY[0]*m_*wv2)/q_+(Apar[1]*(BdriftY[1]-3.464101615137754*dfac_x)+Apar[0]*BdriftY[0])*wv+1.732050807568877*BmagInv[0]*dfac_x*((Bmag[1]*wm)/q_+Phi[1])); 
  alphay[1] = dfac_y*((2.0*BdriftY[1]*m_*wv2)/q_+(Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1])*wv+1.732050807568877*BmagInv[1]*dfac_x*((Bmag[1]*wm)/q_+Phi[1])); 
  alphay[2] = -1.0*dfac_y*(3.464101615137754*Apar[3]*dfac_x*wv-1.0*((BdriftY[1]*Apar[3]+BdriftY[0]*Apar[2])*wv+1.732050807568877*BmagInv[0]*Phi[3]*dfac_x)); 
  alphay[3] = (1.154700538379252*BdriftY[0]*dfac_y*m_*wv)/(dfac_v*q_); 
  alphay[4] = (BmagInv[0]*Bmag[1]*dfac_x*dfac_y)/(dfac_m*q_); 
  alphay[5] = dfac_y*((BdriftY[0]*Apar[3]+BdriftY[1]*Apar[2])*wv+1.732050807568877*BmagInv[1]*Phi[3]*dfac_x); 
  ...
  double alphav[16]; 
  alphav[0] = -1.0*dfac_v*(1.732050807568877*((BdriftX[0]*Bmag[1]*dfac_x*wm)/q_+(BdriftY[1]*Phi[3]+BdriftY[0]*Phi[2])*dfac_y+BdriftX[0]*Phi[1]*dfac_x)*wv+(Bmag[1]*dfac_x*(3.0*Apar[2]*dfac_y+0.8660254037844386*(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0]))*wm+((1.732050807568877*((0.5*(Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1])*Phi[3]+0.5*(Apar[1]*BdriftY[1]+Apar[0]*BdriftY[0])*Phi[2])*dfac_y+(0.5*(BdriftX[1]*Apar[3]+BdriftX[0]*Apar[2])*Phi[3]+0.5*(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*Phi[1])*dfac_x)+3.0*(Phi[1]*Apar[2]-1.0*Apar[1]*Phi[2])*dfac_x*dfac_y)*q2)/q_)/m_); 
  alphav[1] = -1.0*dfac_v*(1.732050807568877*((BdriftX[1]*Bmag[1]*dfac_x*wm)/q_+(BdriftY[0]*Phi[3]+BdriftY[1]*Phi[2])*dfac_y+BdriftX[1]*Phi[1]*dfac_x)*wv+(Bmag[1]*dfac_x*(3.0*Apar[3]*dfac_y+0.8660254037844386*(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1]))*wm+((1.732050807568877*((0.5*(Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1])*Phi[2]-1.0*((-0.9*Apar[1]*BdriftY[1])-0.5*Apar[0]*BdriftY[0])*Phi[3])*dfac_y+(0.5*(BdriftX[0]*Apar[3]+BdriftX[1]*Apar[2])*Phi[3]+0.5*(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])*Phi[1])*dfac_x)+3.0*(Phi[1]*Apar[3]-1.0*Apar[1]*Phi[3])*dfac_x*dfac_y)*q2)/q_)/m_); 
  alphav[2] = -1.0*dfac_v*(1.732050807568877*BdriftX[0]*Phi[3]*dfac_x*wv+(0.8660254037844386*Bmag[1]*(BdriftX[1]*Apar[3]+BdriftX[0]*Apar[2])*dfac_x*wm+(1.732050807568877*((0.5*(BdriftY[0]*Apar[3]+BdriftY[1]*Apar[2])*Phi[3]+0.5*Phi[2]*(BdriftY[1]*Apar[3]+BdriftY[0]*Apar[2]))*dfac_y+(0.5*(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*Phi[3]+0.5*Phi[1]*(BdriftX[1]*Apar[3]+BdriftX[0]*Apar[2]))*dfac_x)+3.0*(Apar[2]*Phi[3]-1.0*Phi[2]*Apar[3])*dfac_x*dfac_y)*q_)/m_); 
  alphav[3] = -1.0*((BdriftX[0]*Bmag[1]*dfac_x*wm)/q_+(BdriftY[1]*Phi[3]+BdriftY[0]*Phi[2])*dfac_y+BdriftX[0]*Phi[1]*dfac_x); 
  alphav[4] = -(1.0*Bmag[1]*dfac_v*dfac_x*((BdriftX[0]*wv)/q_+(1.732050807568877*Apar[2]*dfac_y+0.5*(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0]))/m_))/dfac_m; 
  alphav[5] = -1.732050807568877*dfac_v*(BdriftX[1]*Phi[3]*dfac_x*wv+(0.5*Bmag[1]*(BdriftX[0]*Apar[3]+BdriftX[1]*Apar[2])*dfac_x*wm+((0.5*Phi[2]*(BdriftY[0]*Apar[3]+BdriftY[1]*Apar[2])-1.0*((-0.9*BdriftY[1]*Apar[3])-0.5*BdriftY[0]*Apar[2])*Phi[3])*dfac_y+(0.5*(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])*Phi[3]+0.5*Phi[1]*(BdriftX[0]*Apar[3]+BdriftX[1]*Apar[2]))*dfac_x)*q_)/m_); 
  alphav[6] = -1.0*((BdriftX[1]*Bmag[1]*dfac_x*wm)/q_+(BdriftY[0]*Phi[3]+BdriftY[1]*Phi[2])*dfac_y+BdriftX[1]*Phi[1]*dfac_x); 
  alphav[7] = -1.0*BdriftX[0]*Phi[3]*dfac_x; 
  alphav[8] = -(1.0*Bmag[1]*dfac_v*dfac_x*((BdriftX[1]*wv)/q_+(1.732050807568877*Apar[3]*dfac_y+0.5*(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1]))/m_))/dfac_m; 
