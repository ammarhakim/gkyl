...
double GyrokineticGenGeoVol2x2vSerP1_Bvars(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *f, double *out) 
{ 
...
double GyrokineticGenGeoVol2x2vSerP1_Bvarsx(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *f, double *out) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
  ...
  double alphaR = 0.0; 
  double alphax[16]; 
  alphax[0] = -(0.4330127018922193*((b_z[0]*jacobTotInv[1]+jacobTotInv[0]*b_z[1])*hamil[5]+(b_z[1]*jacobTotInv[1]+b_z[0]*jacobTotInv[0])*hamil[2])*rdx2*rdy2)/q_; 
  alphax[1] = (1.732050807568877*((-0.25*(b_z[0]*jacobTotInv[0]*hamil[5]+(b_z[0]*jacobTotInv[1]+jacobTotInv[0]*b_z[1])*hamil[2]))-0.45*b_z[1]*jacobTotInv[1]*hamil[5])*rdx2*rdy2)/q_; 
#if cflType == SURFAVG 
  // Evaluate surface-averaged alpha on left.
  alphaL = -0.125*(1.732050807568877*alphax[1]-1.0*alphax[0]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  ...
  alphay[2] = (0.4330127018922193*(b_z[1]*jacobTotInv[1]+b_z[0]*jacobTotInv[0])*hamil[5]*rdx2*rdy2)/q_; 
  ...
  alphay[5] = (0.4330127018922193*(b_z[0]*jacobTotInv[1]+jacobTotInv[0]*b_z[1])*hamil[5]*rdx2*rdy2)/q_; 
  ...
  double alphavpar[16]; 
  alphavpar[0] = -(0.4330127018922193*(BstarYdBmag[1]*hamil[5]+BstarYdBmag[0]*hamil[2])*rdvpar2*rdy2)/m_; 
  alphavpar[1] = -(0.4330127018922193*(BstarYdBmag[0]*hamil[5]+BstarYdBmag[1]*hamil[2])*rdvpar2*rdy2)/m_; 
...
#elif cflType == QUAD 
  // Evaluate alpha at left surface quadrature points.
  alphaL = 0.0625*(0.4330127018922193*alphavpar[6]-0.4330127018922193*alphavpar[3]-0.25*alphavpar[1]+0.25*alphavpar[0]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.0625*(0.25*(alphavpar[1]+alphavpar[0])-0.4330127018922193*(alphavpar[6]+alphavpar[3])); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.0625*(0.4330127018922193*alphavpar[6]-0.4330127018922193*alphavpar[3]-0.25*alphavpar[1]+0.25*alphavpar[0]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.0625*(0.25*(alphavpar[1]+alphavpar[0])-0.4330127018922193*(alphavpar[6]+alphavpar[3])); 
  ...
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  // Evaluate alpha at right surface quadrature points.
  alphaR = 0.0625*((-0.4330127018922193*alphavpar[6])+0.4330127018922193*alphavpar[3]-0.25*alphavpar[1]+0.25*alphavpar[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.0625*(0.4330127018922193*(alphavpar[6]+alphavpar[3])+0.25*(alphavpar[1]+alphavpar[0])); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.0625*((-0.4330127018922193*alphavpar[6])+0.4330127018922193*alphavpar[3]-0.25*alphavpar[1]+0.25*alphavpar[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.0625*(0.4330127018922193*(alphavpar[6]+alphavpar[3])+0.25*(alphavpar[1]+alphavpar[0])); 
  ...
  out[3] += 0.4330127018922193*(alphavpar[6]*f[6]+alphavpar[3]*f[3]+alphavpar[1]*f[1]+alphavpar[0]*f[0]); 
  ...
  out[6] += 0.4330127018922193*((alphavpar[3]+alphax[1])*f[6]+f[3]*(alphavpar[6]+alphax[0])+alphavpar[0]*f[1]+f[0]*alphavpar[1]); 
  out[7] += 0.4330127018922193*(alphay[8]*f[13]+(alphavpar[6]+alphay[5])*f[11]+alphay[4]*f[10]+(alphavpar[3]+alphay[2])*f[7]+alphay[1]*f[6]+f[1]*alphay[6]+alphavpar[1]*f[5]+alphay[0]*f[3]+f[0]*alphay[3]+alphavpar[0]*f[2]); 
  out[8] += 0.4330127018922193*(alphax[1]*f[8]+alphax[0]*f[4]); 
  ...
  out[10] += 0.4330127018922193*(alphavpar[6]*f[13]+alphavpar[3]*f[10]+alphavpar[1]*f[8]+alphavpar[0]*f[4]); 
  out[11] += 0.4330127018922193*(alphay[4]*f[13]+(alphavpar[3]+alphay[2]+alphax[1])*f[11]+alphay[8]*f[10]+(alphavpar[6]+alphay[5]+alphax[0])*f[7]+alphay[0]*f[6]+f[0]*alphay[6]+alphavpar[0]*f[5]+alphay[1]*f[3]+f[1]*alphay[3]+alphavpar[1]*f[2]); 
  ...
  out[13] += 0.4330127018922193*((alphavpar[3]+alphax[1])*f[13]+(alphavpar[6]+alphax[0])*f[10]+alphavpar[0]*f[8]+alphavpar[1]*f[4]); 
  out[14] += 0.4330127018922193*((alphavpar[6]+alphay[5])*f[15]+(alphavpar[3]+alphay[2])*f[14]+alphay[1]*f[13]+alphavpar[1]*f[12]+alphay[0]*f[10]+alphavpar[0]*f[9]+alphay[6]*f[8]+f[6]*alphay[8]+alphay[3]*f[4]+f[3]*alphay[4]); 
  out[15] += 0.4330127018922193*((alphavpar[3]+alphay[2]+alphax[1])*f[15]+(alphavpar[6]+alphay[5]+alphax[0])*f[14]+alphay[0]*f[13]+alphavpar[0]*f[12]+alphay[1]*f[10]+alphavpar[1]*f[9]+alphay[3]*f[8]+f[3]*alphay[8]+alphay[4]*f[6]+f[4]*alphay[6]); 
  return cflFreq; 
} 
double GyrokineticGenGeoVol2x2vSerP1_Bvarsz(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *f, double *out) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
...
double GyrokineticGenGeoVol2x2vSerP1_Bvarsxz(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *f, double *out) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
