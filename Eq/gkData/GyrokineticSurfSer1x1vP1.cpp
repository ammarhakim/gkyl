...
#if upwindType == SURFAVG 
  if (alpha0>0) { 
  incr[0] = 0.3535533905932737*alpha[0]*(2.23606797749979*fl[4]+1.732050807568877*fl[2]+fl[0])*dfac_v; 
  incr[1] = 0.3535533905932737*alpha[0]*(1.732050807568877*fl[3]+fl[1])*dfac_v; 
  incr[2] = -0.3535533905932737*alpha[0]*(3.872983346207417*fl[4]+3.0*fl[2]+1.732050807568877*fl[0])*dfac_v; 
  incr[3] = -0.3535533905932737*alpha[0]*(3.0*fl[3]+1.732050807568877*fl[1])*dfac_v; 
  incr[4] = 0.3535533905932737*alpha[0]*(5.0*fl[4]+3.872983346207417*fl[2]+2.23606797749979*fl[0])*dfac_v; 
  } else { 
  incr[0] = 0.3535533905932737*alpha[0]*(2.23606797749979*fr[4]-1.732050807568877*fr[2]+fr[0])*dfac_v; 
  incr[1] = -0.3535533905932737*alpha[0]*(1.732050807568877*fr[3]-1.0*fr[1])*dfac_v; 
  incr[2] = -0.3535533905932737*alpha[0]*(3.872983346207417*fr[4]-3.0*fr[2]+1.732050807568877*fr[0])*dfac_v; 
  incr[3] = 0.3535533905932737*alpha[0]*(3.0*fr[3]-1.732050807568877*fr[1])*dfac_v; 
  incr[4] = 0.3535533905932737*alpha[0]*(5.0*fr[4]-3.872983346207417*fr[2]+2.23606797749979*fr[0])*dfac_v; 
  }
#elif upwindType == QUAD 
double fupwind[2];
...
double alphaQuad;
  ...
  incr[4] = 1.118033988749895*alpha[0]*fupwind[0]*dfac_v; 
