...
double GyrokineticSimpleHelicalVol2x0vSerP2_Bvars_0(const double q_, const double m_, const double *w, const double *dxv, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *BdriftX, const double *BdriftY, const double *Phi, const double *f, double *out) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  alphax[2] = -1.936491673103709*BmagInv[0]*Phi[5]*dfac_x*dfac_y; 
  alphax[3] = -1.936491673103709*BmagInv[0]*Phi[7]*dfac_x*dfac_y; 
  alphax[4] = -0.8660254037844386*BmagInv[0]*Phi[6]*dfac_x*dfac_y; 
#if cflType == SURFAVG 
  ...
  alphay[1] = 1.936491673103709*BmagInv[0]*Phi[4]*dfac_x*dfac_y; 
  alphay[2] = 0.8660254037844386*BmagInv[0]*Phi[3]*dfac_x*dfac_y; 
  alphay[3] = 1.936491673103709*BmagInv[0]*Phi[6]*dfac_x*dfac_y; 
  alphay[5] = 0.8660254037844387*BmagInv[0]*Phi[7]*dfac_x*dfac_y; 
#if cflType == SURFAVG 
  // evaluate surface-averaged alpha on left 
