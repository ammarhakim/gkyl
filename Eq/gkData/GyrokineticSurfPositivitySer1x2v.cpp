...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  incr[0] = 0.25*alpha[0]*fhatALVal[0]*dfac_x; 
  incr[1] = -0.4330127018922193*alpha[0]*fhatALVal[0]*dfac_x; 
  incr[2] = 0.25*alpha[0]*fhatALVal[1]*dfac_x; 
  incr[3] = 0.25*alpha[0]*fhatALVal[2]*dfac_x; 
  incr[4] = -0.4330127018922193*alpha[0]*fhatALVal[1]*dfac_x; 
  incr[5] = -0.4330127018922193*alpha[0]*fhatALVal[2]*dfac_x; 
  incr[6] = 0.25*alpha[0]*fhatALVal[3]*dfac_x; 
  incr[7] = -0.4330127018922193*alpha[0]*fhatALVal[3]*dfac_x; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  fhatALVal[2] = 0.8660254037844386*(fqVal[3]+fqVal[2]-1.0*(fqVal[1]+fqVal[0])); 
  fhatALVal[3] = 1.5*(fqVal[3]-1.0*(fqVal[2]+fqVal[1])+fqVal[0]); 
  incr[0] = 0.25*alpha[0]*fhatALVal[0]*dfac_v; 
  incr[1] = 0.25*alpha[0]*fhatALVal[1]*dfac_v; 
  incr[2] = -0.4330127018922193*alpha[0]*fhatALVal[0]*dfac_v; 
  incr[3] = 0.25*alpha[0]*fhatALVal[2]*dfac_v; 
  incr[4] = -0.4330127018922193*alpha[0]*fhatALVal[1]*dfac_v; 
  incr[5] = 0.25*alpha[0]*fhatALVal[3]*dfac_v; 
  incr[6] = -0.4330127018922193*alpha[0]*fhatALVal[2]*dfac_v; 
  incr[7] = -0.4330127018922193*alpha[0]*fhatALVal[3]*dfac_v; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  fhatALVal[2] = 0.8660254037844386*(fqVal[3]+fqVal[2]-1.0*(fqVal[1]+fqVal[0])); 
  fhatALVal[3] = 1.5*(fqVal[3]-1.0*(fqVal[2]+fqVal[1])+fqVal[0]); 
  incr[0] = 0.25*(alpha[1]*fhatALVal[1]+alpha[0]*fhatALVal[0])*dfac_v; 
  incr[1] = 0.25*(alpha[0]*fhatALVal[1]+fhatALVal[0]*alpha[1])*dfac_v; 
  incr[2] = -0.4330127018922193*(alpha[1]*fhatALVal[1]+alpha[0]*fhatALVal[0])*dfac_v; 
  incr[3] = 0.25*(alpha[1]*fhatALVal[3]+alpha[0]*fhatALVal[2])*dfac_v; 
  incr[4] = -0.4330127018922193*(alpha[0]*fhatALVal[1]+fhatALVal[0]*alpha[1])*dfac_v; 
  incr[5] = 0.25*(alpha[0]*fhatALVal[3]+alpha[1]*fhatALVal[2])*dfac_v; 
  incr[6] = -0.4330127018922193*(alpha[1]*fhatALVal[3]+alpha[0]*fhatALVal[2])*dfac_v; 
  incr[7] = -0.4330127018922193*(alpha[0]*fhatALVal[3]+alpha[1]*fhatALVal[2])*dfac_v; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  fhatALVal[2] = 0.8660254037844386*(fqVal[3]+fqVal[2]-1.0*(fqVal[1]+fqVal[0])); 
  fhatALVal[3] = 1.5*(fqVal[3]-1.0*(fqVal[2]+fqVal[1])+fqVal[0]); 
  incr[0] = 0.25*(fhatALVal[2]*alpha[3]+alpha[0]*fhatALVal[0])*dfac_v; 
  incr[1] = 0.25*(alpha[3]*fhatALVal[3]+alpha[0]*fhatALVal[1])*dfac_v; 
  incr[2] = -0.4330127018922193*(fhatALVal[2]*alpha[3]+alpha[0]*fhatALVal[0])*dfac_v; 
  incr[3] = 0.25*(fhatALVal[0]*alpha[3]+alpha[0]*fhatALVal[2])*dfac_v; 
  incr[4] = -0.4330127018922193*(alpha[3]*fhatALVal[3]+alpha[0]*fhatALVal[1])*dfac_v; 
  incr[5] = 0.25*(alpha[0]*fhatALVal[3]+fhatALVal[1]*alpha[3])*dfac_v; 
  incr[6] = -0.4330127018922193*(fhatALVal[0]*alpha[3]+alpha[0]*fhatALVal[2])*dfac_v; 
  incr[7] = -0.4330127018922193*(alpha[0]*fhatALVal[3]+fhatALVal[1]*alpha[3])*dfac_v; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  fhatALVal[2] = 0.8660254037844386*(fqVal[3]+fqVal[2]-1.0*(fqVal[1]+fqVal[0])); 
  fhatALVal[3] = 1.5*(fqVal[3]-1.0*(fqVal[2]+fqVal[1])+fqVal[0]); 
  incr[0] = 0.25*(fhatALVal[2]*alpha[3]+alpha[1]*fhatALVal[1]+alpha[0]*fhatALVal[0])*dfac_v; 
  incr[1] = 0.25*(alpha[3]*fhatALVal[3]+alpha[0]*fhatALVal[1]+fhatALVal[0]*alpha[1])*dfac_v; 
  incr[2] = -0.4330127018922193*(fhatALVal[2]*alpha[3]+alpha[1]*fhatALVal[1]+alpha[0]*fhatALVal[0])*dfac_v; 
  incr[3] = 0.25*(alpha[1]*fhatALVal[3]+fhatALVal[0]*alpha[3]+alpha[0]*fhatALVal[2])*dfac_v; 
  incr[4] = -0.4330127018922193*(alpha[3]*fhatALVal[3]+alpha[0]*fhatALVal[1]+fhatALVal[0]*alpha[1])*dfac_v; 
  incr[5] = 0.25*(alpha[0]*fhatALVal[3]+fhatALVal[1]*alpha[3]+alpha[1]*fhatALVal[2])*dfac_v; 
  incr[6] = -0.4330127018922193*(alpha[1]*fhatALVal[3]+fhatALVal[0]*alpha[3]+alpha[0]*fhatALVal[2])*dfac_v; 
  incr[7] = -0.4330127018922193*(alpha[0]*fhatALVal[3]+fhatALVal[1]*alpha[3]+alpha[1]*fhatALVal[2])*dfac_v; 
