...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alphay[16]; 
  alphay[0] = -1.732050807568877*geoZ[0]*Phi[2]*dfac_y^2; 
  alphay[1] = -1.732050807568877*geoZ[0]*Phi[3]*dfac_y^2; 
#if cflType == SURFAVG 
  // evaluate surface-averaged alpha on left 
  alphaL = 0.125*alphay[0]; 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  // evaluate surface-averaged alpha on right 
  alphaR = 0.125*alphay[0]; 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
#elif cflType == QUAD 
  // evaluate alpha at left surface quadrature points 
  alphaL = 0.0625*(0.25*alphay[0]-0.25*alphay[1]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.015625*(alphay[1]+alphay[0]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.0625*(0.25*alphay[0]-0.25*alphay[1]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.015625*(alphay[1]+alphay[0]); 
  ...
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  // evaluate alpha at right surface quadrature points 
  alphaR = 0.0625*(0.25*alphay[0]-0.25*alphay[1]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.015625*(alphay[1]+alphay[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.0625*(0.25*alphay[0]-0.25*alphay[1]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.015625*(alphay[1]+alphay[0]); 
  ...
  out[2] += 0.4330127018922193*(alphay[1]*f[1]+alphay[0]*f[0]); 
  out[5] += 0.4330127018922193*(alphax[1]*f[5]+alphax[0]*f[2]+alphay[0]*f[1]+f[0]*alphay[1]); 
  out[6] += 0.4330127018922193*(alphax[1]*f[6]+alphax[0]*f[3]); 
  out[7] += 0.4330127018922193*(alphay[1]*f[6]+alphay[0]*f[3]); 
  out[8] += 0.4330127018922193*(alphax[1]*f[8]+alphax[0]*f[4]); 
  out[9] += 0.4330127018922193*(alphay[1]*f[8]+alphay[0]*f[4]); 
  out[11] += 0.4330127018922193*(alphax[1]*f[11]+alphax[0]*f[7]+alphay[0]*f[6]+alphay[1]*f[3]); 
  out[12] += 0.4330127018922193*(alphax[1]*f[12]+alphax[0]*f[9]+alphay[0]*f[8]+alphay[1]*f[4]); 
  out[13] += 0.4330127018922193*(alphax[1]*f[13]+alphax[0]*f[10]); 
  out[14] += 0.4330127018922193*(alphay[1]*f[13]+alphay[0]*f[10]); 
  out[15] += 0.4330127018922193*(alphax[1]*f[15]+alphax[0]*f[14]+alphay[0]*f[13]+alphay[1]*f[10]); 
  return cflFreq; 
} 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alphay[16]; 
  alphay[0] = -1.732050807568877*(geoZ[1]*Phi[3]+geoZ[0]*Phi[2])*dfac_y^2; 
  alphay[1] = -1.732050807568877*(geoZ[0]*Phi[3]+geoZ[1]*Phi[2])*dfac_y^2; 
#if cflType == SURFAVG 
  // evaluate surface-averaged alpha on left 
  alphaL = 0.125*alphay[0]; 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  ...
  out[7] += 0.4330127018922193*(alphav[6]*f[11]+alphav[3]*f[7]+alphay[1]*f[6]+alphav[1]*f[5]+alphay[0]*f[3]+alphav[0]*f[2]); 
  out[8] += 0.4330127018922193*(alphax[1]*f[8]+alphax[0]*f[4]); 
  out[9] += 0.4330127018922193*(alphay[1]*f[8]+alphay[0]*f[4]); 
  out[10] += 0.4330127018922193*(alphav[6]*f[13]+alphav[3]*f[10]+alphav[1]*f[8]+alphav[0]*f[4]); 
  out[11] += 0.4330127018922193*((alphav[3]+alphax[1])*f[11]+(alphav[6]+alphax[0])*f[7]+alphay[0]*f[6]+alphav[0]*f[5]+alphay[1]*f[3]+alphav[1]*f[2]); 
  out[12] += 0.4330127018922193*(alphax[1]*f[12]+alphax[0]*f[9]+alphay[0]*f[8]+alphay[1]*f[4]); 
  out[13] += 0.4330127018922193*((alphav[3]+alphax[1])*f[13]+(alphav[6]+alphax[0])*f[10]+alphav[0]*f[8]+alphav[1]*f[4]); 
  out[14] += 0.4330127018922193*(alphav[6]*f[15]+alphav[3]*f[14]+alphay[1]*f[13]+alphav[1]*f[12]+alphay[0]*f[10]+alphav[0]*f[9]); 
  out[15] += 0.4330127018922193*((alphav[3]+alphax[1])*f[15]+(alphav[6]+alphax[0])*f[14]+alphay[0]*f[13]+alphav[0]*f[12]+alphay[1]*f[10]+alphav[1]*f[9]); 
  return cflFreq; 
} 
