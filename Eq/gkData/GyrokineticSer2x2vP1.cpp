...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alphaR = 0.0; 
  double alphax[17]; 
  alphax[0] = dfac_x*((BdriftX[0]*m_*(2.0*wv2+0.6666666666666666/dfac_v2))/q_-1.732050807568877*BmagInv[0]*Phi[2]*dfac_y); 
  alphax[1] = -1.732050807568877*BmagInv[0]*Phi[3]*dfac_x*dfac_y; 
  alphax[3] = (2.309401076758503*BdriftX[0]*dfac_x*m_*wv)/(dfac_v*q_); 
  ...
  double alphay[17]; 
  alphay[0] = dfac_y*((BdriftY[0]*m_*(2.0*wv2+0.6666666666666666/dfac_v2))/q_+1.732050807568877*BmagInv[0]*Phi[1]*dfac_x); 
  alphay[2] = 1.732050807568877*BmagInv[0]*Phi[3]*dfac_x*dfac_y; 
  alphay[3] = (2.309401076758503*BdriftY[0]*dfac_y*m_*wv)/(dfac_v*q_); 
  ...
  out[1] += 0.4330127018922193*(alphax[16]*f[16]+alphax[3]*f[3]+alphax[1]*f[1]+alphax[0]*f[0]); 
  out[2] += 0.4330127018922193*(alphay[16]*f[16]+alphay[3]*f[3]+alphay[2]*f[2]+alphay[0]*f[0]); 
  ...
  out[6] += 0.08660254037844387*(4.47213595499958*(alphax[3]*f[16]+f[3]*alphax[16])+5.0*(alphav[7]*f[11]+(alphav[3]+alphax[1])*f[6]+f[3]*alphav[6]+alphav[2]*f[5]+alphax[0]*f[3]+f[0]*alphax[3]+alphav[0]*f[1]+f[0]*alphav[1])); 
  out[7] += 0.08660254037844387*(4.47213595499958*(alphay[3]*f[16]+f[3]*alphay[16])+5.0*(alphav[6]*f[11]+(alphav[3]+alphay[2])*f[7]+f[3]*alphav[7]+alphav[1]*f[5]+alphay[0]*f[3]+f[0]*alphay[3]+alphav[0]*f[2]+f[0]*alphav[2])); 
  ...
  out[11] += 0.08660254037844387*(4.47213595499958*(f[6]*alphay[16]+f[7]*alphax[16])+5.0*((alphav[3]+alphay[2]+alphax[1])*f[11]+(alphav[6]+alphax[0])*f[7]+f[6]*(alphav[7]+alphay[0])+alphav[0]*f[5]+f[1]*alphay[3]+f[2]*(alphax[3]+alphav[1])+f[1]*alphav[2])); 
  out[12] += 0.4330127018922193*(alphax[3]*f[14]+alphay[3]*f[13]+(alphay[2]+alphax[1])*f[12]+alphax[0]*f[9]+alphay[0]*f[8]); 
  out[13] += 0.08660254037844387*(4.47213595499958*f[10]*alphax[16]+5.0*(alphav[7]*f[15]+(alphav[3]+alphax[1])*f[13]+alphav[2]*f[12]+(alphav[6]+alphax[0])*f[10]+alphav[0]*f[8]+(alphax[3]+alphav[1])*f[4])); 
  out[14] += 0.08660254037844387*(4.47213595499958*f[10]*alphay[16]+5.0*(alphav[6]*f[15]+(alphav[3]+alphay[2])*f[14]+alphav[1]*f[12]+(alphav[7]+alphay[0])*f[10]+alphav[0]*f[9]+(alphay[3]+alphav[2])*f[4])); 
  out[15] += 0.08660254037844387*(4.47213595499958*(f[13]*alphay[16]+f[14]*alphax[16])+5.0*((alphav[3]+alphay[2]+alphax[1])*f[15]+(alphav[6]+alphax[0])*f[14]+(alphav[7]+alphay[0])*f[13]+alphav[0]*f[12]+(alphax[3]+alphav[1])*f[9]+(alphay[3]+alphav[2])*f[8])); 
  out[16] += 0.4330127018922193*(2.0*alphav[3]*f[16]+2.23606797749979*(alphav[2]*f[7]+f[2]*alphav[7]+alphav[1]*f[6]+f[1]*alphav[6]+alphav[0]*f[3]+f[0]*alphav[3])); 
  return cflFreq; 
} 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alphaR = 0.0; 
  double alphax[17]; 
  alphax[0] = dfac_x*((BdriftX[0]*m_*(2.0*wv2+0.6666666666666666/dfac_v2))/q_-1.732050807568877*(BmagInv[1]*Phi[3]+BmagInv[0]*Phi[2])*dfac_y); 
  alphax[1] = dfac_x*((BdriftX[1]*m_*(2.0*wv2+0.6666666666666666/dfac_v2))/q_-1.732050807568877*(BmagInv[0]*Phi[3]+BmagInv[1]*Phi[2])*dfac_y); 
  alphax[3] = (2.309401076758503*BdriftX[0]*dfac_x*m_*wv)/(dfac_v*q_); 
  alphax[6] = (2.309401076758503*BdriftX[1]*dfac_x*m_*wv)/(dfac_v*q_); 
  alphax[16] = (0.5962847939999438*BdriftX[0]*dfac_x*m_)/(dfac_v2*q_); 
#if cflType == SURFAVG 
  // evaluate surface-averaged alpha on left 
  alphaL = -0.125*(1.732050807568877*alphax[1]-1.0*alphax[0]); 
  ...
  double alphay[17]; 
  alphay[0] = dfac_y*((2.0*BdriftY[0]*m_*wv2+1.732050807568877*BmagInv[0]*Bmag[1]*dfac_x*wm+(0.6666666666666666*BdriftY[0]*m_)/dfac_v2)/q_+1.732050807568877*BmagInv[0]*Phi[1]*dfac_x); 
  alphay[1] = dfac_y*((2.0*BdriftY[1]*m_*wv2+1.732050807568877*Bmag[1]*BmagInv[1]*dfac_x*wm+(0.6666666666666666*BdriftY[1]*m_)/dfac_v2)/q_+1.732050807568877*BmagInv[1]*Phi[1]*dfac_x); 
  alphay[2] = 1.732050807568877*BmagInv[0]*Phi[3]*dfac_x*dfac_y; 
  alphay[3] = (2.309401076758503*BdriftY[0]*dfac_y*m_*wv)/(dfac_v*q_); 
  alphay[4] = (BmagInv[0]*Bmag[1]*dfac_x*dfac_y)/(dfac_m*q_); 
  alphay[5] = 1.732050807568877*BmagInv[1]*Phi[3]*dfac_x*dfac_y; 
  alphay[6] = (2.309401076758503*BdriftY[1]*dfac_y*m_*wv)/(dfac_v*q_); 
  ...
  out[1] += 0.4330127018922193*(alphax[16]*f[16]+alphax[6]*f[6]+alphax[3]*f[3]+alphax[1]*f[1]+alphax[0]*f[0]); 
  out[2] += 0.4330127018922193*(alphay[16]*f[16]+alphay[8]*f[8]+alphay[6]*f[6]+alphay[5]*f[5]+alphay[4]*f[4]+alphay[3]*f[3]+alphay[2]*f[2]+alphay[1]*f[1]+alphay[0]*f[0]); 
  ...
  out[6] += 0.08660254037844387*(4.47213595499958*(alphax[3]*f[16]+f[3]*alphax[16])+5.0*(alphav[10]*f[13]+f[10]*alphav[13]+alphav[7]*f[11]+f[7]*alphav[11]+alphav[4]*f[8]+f[4]*alphav[8]+(alphav[3]+alphax[1])*f[6]+f[1]*alphax[6]+f[3]*alphav[6]+alphav[2]*f[5]+f[2]*alphav[5]+alphax[0]*f[3]+f[0]*alphax[3]+alphav[0]*f[1]+f[0]*alphav[1])); 
  out[7] += 0.08660254037844387*(4.47213595499958*(alphay[3]*f[16]+f[3]*alphay[16])+5.0*(alphav[13]*f[15]+alphav[10]*f[14]+alphay[8]*f[13]+alphav[8]*f[12]+(alphav[6]+alphay[5])*f[11]+f[6]*alphav[11]+alphay[4]*f[10]+alphav[4]*f[9]+(alphav[3]+alphay[2])*f[7]+f[3]*alphav[7]+alphay[1]*f[6]+f[1]*alphay[6]+alphav[1]*f[5]+f[1]*alphav[5]+alphay[0]*f[3]+f[0]*alphay[3]+alphav[0]*f[2]+f[0]*alphav[2])); 
  ...
  out[13] += 0.08660254037844387*(4.47213595499958*f[10]*alphax[16]+5.0*(alphav[7]*f[15]+alphav[11]*f[14]+(alphav[3]+alphax[1])*f[13]+f[3]*alphav[13]+alphav[2]*f[12]+(alphav[6]+alphax[0])*f[10]+f[6]*alphav[10]+alphav[5]*f[9]+(alphax[6]+alphav[0])*f[8]+f[0]*alphav[8]+(alphax[3]+alphav[1])*f[4]+f[1]*alphav[4])); 
  out[14] += 0.08660254037844387*(4.47213595499958*f[10]*alphay[16]+5.0*((alphav[6]+alphay[5])*f[15]+(alphav[3]+alphay[2])*f[14]+(alphav[11]+alphay[1])*f[13]+f[11]*alphav[13]+alphav[1]*f[12]+(alphav[7]+alphay[0])*f[10]+f[7]*alphav[10]+alphav[0]*f[9]+(alphay[6]+alphav[5])*f[8]+f[6]*alphay[8]+f[5]*alphav[8]+(alphay[3]+alphav[2])*f[4]+f[3]*alphay[4]+f[2]*alphav[4])); 
  ...
  out[16] += 0.4330127018922193*(2.0*alphav[3]*f[16]+2.23606797749979*(alphav[8]*f[13]+f[8]*alphav[13]+alphav[5]*f[11]+f[5]*alphav[11]+alphav[4]*f[10]+f[4]*alphav[10]+alphav[2]*f[7]+f[2]*alphav[7]+alphav[1]*f[6]+f[1]*alphav[6]+alphav[0]*f[3]+f[0]*alphav[3])); 
  return cflFreq; 
} 
