...
{ 
  ...
  u[0] = 0.1666666666666667*((14.69693845669907*f[1]*wv+4.242640687119286*f[3]*dv)*zVal+8.485281374238571*f[0]*wv+2.449489742783178*f[2]*dv); 
  u[1] = 0.0; 
  if(wv > 0) {
  uhat[0] = (0.01041666666666667*((135.7645019878172*f[3]*dv*wv3-117.5755076535926*f[1]*dv2*wv2+((117.5755076535926*f[1]-101.8233764908629*f[3])*dv3-407.2935059634517*f[3]*dv*vcut2)*wv+271.5290039756345*f[3]*dv*vcut3+117.5755076535926*f[1]*dv2*vcut2+(33.9411254969543*f[3]-29.39387691339815*f[1])*dv4)*zVal-151.7893276880823*f[4]*wv4+78.38367176906175*f[2]*dv*wv3+(910.7359661284939*f[4]*vcut2+(75.89466384404115*f[4]-67.8822509939086*f[0])*dv2)*wv2+((-1214.314621504659*f[4]*vcut3)-235.1510153071852*f[2]*dv*vcut2+(67.8822509939086*f[0]-58.7877538267963*f[2])*dv3)*wv+455.3679830642469*f[4]*vcut4+156.7673435381235*f[2]*dv*vcut3+(67.8822509939086*f[0]-75.89466384404115*f[4])*dv2*vcut2+((-9.48683298050514*f[4])+19.59591794226543*f[2]-16.97056274847715*f[0])*dv4))/dv3; 
  uhat[1] = 0.0; 
  } else {
  uhat[0] = -(0.01041666666666667*((135.7645019878172*f[3]*dv*wv3-117.5755076535926*f[1]*dv2*wv2+(((-101.8233764908629*f[3])-117.5755076535926*f[1])*dv3-407.2935059634517*f[3]*dv*vcut2)*wv-271.5290039756345*f[3]*dv*vcut3+117.5755076535926*f[1]*dv2*vcut2+((-33.9411254969543*f[3])-29.39387691339815*f[1])*dv4)*zVal-151.7893276880823*f[4]*wv4+78.38367176906175*f[2]*dv*wv3+(910.7359661284939*f[4]*vcut2+(75.89466384404115*f[4]-67.8822509939086*f[0])*dv2)*wv2+(1214.314621504659*f[4]*vcut3-235.1510153071852*f[2]*dv*vcut2+((-58.7877538267963*f[2])-67.8822509939086*f[0])*dv3)*wv+455.3679830642469*f[4]*vcut4-156.7673435381235*f[2]*dv*vcut3+(67.8822509939086*f[0]-75.89466384404115*f[4])*dv2*vcut2+((-9.48683298050514*f[4])-19.59591794226543*f[2]-16.97056274847715*f[0])*dv4))/dv3; 
  uhat[1] = 0.0; 
  }
...
{ 
  ...
  double vcut4 = vcut3*vcut; 
  double vcut5 = vcut4*vcut; 
  u[0] = 0.3333333333333333*((10.39230484541326*f[1]*wv+3.0*f[4]*dv)*zVal+6.0*f[0]*wv+1.732050807568877*f[2]*dv); 
  u[1] = 0.0; 
  if(wv > 0) {
  uhat[0] = (0.02083333333333333*((96.0*f[4]*dv*wv3-83.1384387633061*f[1]*dv2*wv2+((83.1384387633061*f[1]-72.0*f[4])*dv3-288.0*f[4]*dv*vcut2)*wv+192.0*f[4]*dv*vcut3+83.1384387633061*f[1]*dv2*vcut2+(24.0*f[4]-20.78460969082652*f[1])*dv4)*zVal-107.3312629199899*f[8]*wv4+55.42562584220407*f[2]*dv*wv3+(643.9875775199395*f[8]*vcut2+(53.66563145999496*f[8]-48.0*f[0])*dv2)*wv2+((-858.6501033599193*f[8]*vcut3)-166.2768775266122*f[2]*dv*vcut2+(48.0*f[0]-41.56921938165305*f[2])*dv3)*wv+321.9937887599697*f[8]*vcut4+110.8512516844081*f[2]*dv*vcut3+(48.0*f[0]-53.66563145999496*f[8])*dv2*vcut2+((-6.708203932499369*f[8])+13.85640646055102*f[2]-12.0*f[0])*dv4))/dv3; 
  uhat[1] = 0.0; 
  } else {
  uhat[0] = -(0.02083333333333333*((96.0*f[4]*dv*wv3-83.1384387633061*f[1]*dv2*wv2+(((-72.0*f[4])-83.1384387633061*f[1])*dv3-288.0*f[4]*dv*vcut2)*wv-192.0*f[4]*dv*vcut3+83.1384387633061*f[1]*dv2*vcut2+((-24.0*f[4])-20.78460969082652*f[1])*dv4)*zVal-107.3312629199899*f[8]*wv4+55.42562584220407*f[2]*dv*wv3+(643.9875775199395*f[8]*vcut2+(53.66563145999496*f[8]-48.0*f[0])*dv2)*wv2+(858.6501033599193*f[8]*vcut3-166.2768775266122*f[2]*dv*vcut2+((-41.56921938165305*f[2])-48.0*f[0])*dv3)*wv+321.9937887599697*f[8]*vcut4-110.8512516844081*f[2]*dv*vcut3+(48.0*f[0]-53.66563145999496*f[8])*dv2*vcut2+((-6.708203932499369*f[8])-13.85640646055102*f[2]-12.0*f[0])*dv4))/dv3; 
  uhat[1] = 0.0; 
  }
...
{ 
  ...
  double vcut4 = vcut3*vcut; 
  double vcut5 = vcut4*vcut; 
  u[0] = 0.3333333333333333*((10.39230484541326*f[2]*wv+3.0*f[7]*dv)*zVal+6.0*f[0]*wv+1.732050807568877*f[3]*dv); 
  u[1] = 0.3333333333333333*((10.39230484541326*f[5]*wv+3.0*f[11]*dv)*zVal+6.0*f[1]*wv+1.732050807568877*f[6]*dv); 
  u[2] = 0.0; 
  u[3] = 0.0; 
  if(wv > 0) {
  uhat[0] = (0.02083333333333333*((96.0*f[7]*dv*wv3-83.1384387633061*f[2]*dv2*wv2+((83.1384387633061*f[2]-72.0*f[7])*dv3-288.0*f[7]*dv*vcut2)*wv+192.0*f[7]*dv*vcut3+83.1384387633061*f[2]*dv2*vcut2+(24.0*f[7]-20.78460969082652*f[2])*dv4)*zVal-107.3312629199899*f[16]*wv4+55.42562584220407*f[3]*dv*wv3+(643.9875775199395*f[16]*vcut2+(53.66563145999496*f[16]-48.0*f[0])*dv2)*wv2+((-858.6501033599193*f[16]*vcut3)-166.2768775266122*f[3]*dv*vcut2+(48.0*f[0]-41.56921938165305*f[3])*dv3)*wv+321.9937887599697*f[16]*vcut4+110.8512516844081*f[3]*dv*vcut3+(48.0*f[0]-53.66563145999496*f[16])*dv2*vcut2+((-6.708203932499369*f[16])+13.85640646055102*f[3]-12.0*f[0])*dv4))/dv3; 
  uhat[1] = (0.08333333333333333*((24.0*f[11]*wv3-20.78460969082652*f[5]*dv*wv2+((20.78460969082652*f[5]-18.0*f[11])*dv2-72.0*f[11]*vcut2)*wv+48.0*f[11]*vcut3+20.78460969082652*f[5]*dv*vcut2+(6.0*f[11]-5.196152422706631*f[5])*dv3)*zVal+13.85640646055102*f[6]*wv3-12.0*f[1]*dv*wv2+((12.0*f[1]-10.39230484541326*f[6])*dv2-41.56921938165305*f[6]*vcut2)*wv+27.71281292110204*f[6]*vcut3+12.0*f[1]*dv*vcut2+(3.464101615137754*f[6]-3.0*f[1])*dv3))/dv2; 
  uhat[2] = 0.0; 
  uhat[3] = 0.0; 
  } else {
  uhat[0] = -(0.02083333333333333*((96.0*f[7]*dv*wv3-83.1384387633061*f[2]*dv2*wv2+(((-72.0*f[7])-83.1384387633061*f[2])*dv3-288.0*f[7]*dv*vcut2)*wv-192.0*f[7]*dv*vcut3+83.1384387633061*f[2]*dv2*vcut2+((-24.0*f[7])-20.78460969082652*f[2])*dv4)*zVal-107.3312629199899*f[16]*wv4+55.42562584220407*f[3]*dv*wv3+(643.9875775199395*f[16]*vcut2+(53.66563145999496*f[16]-48.0*f[0])*dv2)*wv2+(858.6501033599193*f[16]*vcut3-166.2768775266122*f[3]*dv*vcut2+((-41.56921938165305*f[3])-48.0*f[0])*dv3)*wv+321.9937887599697*f[16]*vcut4-110.8512516844081*f[3]*dv*vcut3+(48.0*f[0]-53.66563145999496*f[16])*dv2*vcut2+((-6.708203932499369*f[16])-13.85640646055102*f[3]-12.0*f[0])*dv4))/dv3; 
  uhat[1] = -(0.08333333333333333*((24.0*f[11]*wv3-20.78460969082652*f[5]*dv*wv2+(((-18.0*f[11])-20.78460969082652*f[5])*dv2-72.0*f[11]*vcut2)*wv-48.0*f[11]*vcut3+20.78460969082652*f[5]*dv*vcut2+((-6.0*f[11])-5.196152422706631*f[5])*dv3)*zVal+13.85640646055102*f[6]*wv3-12.0*f[1]*dv*wv2+(((-10.39230484541326*f[6])-12.0*f[1])*dv2-41.56921938165305*f[6]*vcut2)*wv-27.71281292110204*f[6]*vcut3+12.0*f[1]*dv*vcut2+((-3.464101615137754*f[6])-3.0*f[1])*dv3))/dv2; 
  uhat[2] = 0.0; 
  uhat[3] = 0.0; 
  }
...
{ 
  ...
  double vcut4 = vcut3*vcut; 
  double vcut5 = vcut4*vcut; 
  u[0] = 0.3333333333333333*((10.39230484541326*f[3]*wv+3.0*f[11]*dv)*zVal+6.0*f[0]*wv+1.732050807568877*f[4]*dv); 
  u[1] = 0.3333333333333333*((10.39230484541326*f[7]*wv+3.0*f[18]*dv)*zVal+6.0*f[1]*wv+1.732050807568877*f[9]*dv); 
  u[2] = 0.3333333333333333*((10.39230484541326*f[8]*wv+3.0*f[19]*dv)*zVal+6.0*f[2]*wv+1.732050807568877*f[10]*dv); 
  u[3] = 0.0; 
  u[4] = 0.3333333333333333*((10.39230484541326*f[16]*wv+3.0*f[26]*dv)*zVal+6.0*f[6]*wv+1.732050807568877*f[17]*dv); 
  u[5] = 0.0; 
  u[6] = 0.0; 
  u[7] = 0.0; 
  if(wv > 0) {
  uhat[0] = (0.02083333333333333*((96.0*f[11]*dv*wv3-83.1384387633061*f[3]*dv2*wv2+((83.1384387633061*f[3]-72.0*f[11])*dv3-288.0*f[11]*dv*vcut2)*wv+192.0*f[11]*dv*vcut3+83.1384387633061*f[3]*dv2*vcut2+(24.0*f[11]-20.78460969082652*f[3])*dv4)*zVal-107.3312629199899*f[32]*wv4+55.42562584220407*f[4]*dv*wv3+(643.9875775199395*f[32]*vcut2+(53.66563145999496*f[32]-48.0*f[0])*dv2)*wv2+((-858.6501033599193*f[32]*vcut3)-166.2768775266122*f[4]*dv*vcut2+(48.0*f[0]-41.56921938165305*f[4])*dv3)*wv+321.9937887599697*f[32]*vcut4+110.8512516844081*f[4]*dv*vcut3+(48.0*f[0]-53.66563145999496*f[32])*dv2*vcut2+((-6.708203932499369*f[32])+13.85640646055102*f[4]-12.0*f[0])*dv4))/dv3; 
  uhat[1] = (0.08333333333333333*((24.0*f[18]*wv3-20.78460969082652*f[7]*dv*wv2+((20.78460969082652*f[7]-18.0*f[18])*dv2-72.0*f[18]*vcut2)*wv+48.0*f[18]*vcut3+20.78460969082652*f[7]*dv*vcut2+(6.0*f[18]-5.196152422706631*f[7])*dv3)*zVal+13.85640646055102*f[9]*wv3-12.0*f[1]*dv*wv2+((12.0*f[1]-10.39230484541326*f[9])*dv2-41.56921938165305*f[9]*vcut2)*wv+27.71281292110204*f[9]*vcut3+12.0*f[1]*dv*vcut2+(3.464101615137754*f[9]-3.0*f[1])*dv3))/dv2; 
  uhat[2] = (0.08333333333333333*((24.0*f[19]*wv3-20.78460969082652*f[8]*dv*wv2+((20.78460969082652*f[8]-18.0*f[19])*dv2-72.0*f[19]*vcut2)*wv+48.0*f[19]*vcut3+20.78460969082652*f[8]*dv*vcut2+(6.0*f[19]-5.196152422706631*f[8])*dv3)*zVal+13.85640646055102*f[10]*wv3-12.0*f[2]*dv*wv2+((12.0*f[2]-10.39230484541326*f[10])*dv2-41.56921938165305*f[10]*vcut2)*wv+27.71281292110204*f[10]*vcut3+12.0*f[2]*dv*vcut2+(3.464101615137754*f[10]-3.0*f[2])*dv3))/dv2; 
  uhat[3] = 0.0; 
  uhat[4] = (0.08333333333333333*((24.0*f[26]*wv3-20.78460969082652*f[16]*dv*wv2+((20.78460969082652*f[16]-18.0*f[26])*dv2-72.0*f[26]*vcut2)*wv+48.0*f[26]*vcut3+20.78460969082652*f[16]*dv*vcut2+(6.0*f[26]-5.196152422706631*f[16])*dv3)*zVal+13.85640646055102*f[17]*wv3-12.0*f[6]*dv*wv2+((12.0*f[6]-10.39230484541326*f[17])*dv2-41.56921938165305*f[17]*vcut2)*wv+27.71281292110204*f[17]*vcut3+12.0*f[6]*dv*vcut2+(3.464101615137754*f[17]-3.0*f[6])*dv3))/dv2; 
  uhat[5] = 0.0; 
  uhat[6] = 0.0; 
  uhat[7] = 0.0; 
  } else {
  uhat[0] = -(0.02083333333333333*((96.0*f[11]*dv*wv3-83.1384387633061*f[3]*dv2*wv2+(((-72.0*f[11])-83.1384387633061*f[3])*dv3-288.0*f[11]*dv*vcut2)*wv-192.0*f[11]*dv*vcut3+83.1384387633061*f[3]*dv2*vcut2+((-24.0*f[11])-20.78460969082652*f[3])*dv4)*zVal-107.3312629199899*f[32]*wv4+55.42562584220407*f[4]*dv*wv3+(643.9875775199395*f[32]*vcut2+(53.66563145999496*f[32]-48.0*f[0])*dv2)*wv2+(858.6501033599193*f[32]*vcut3-166.2768775266122*f[4]*dv*vcut2+((-41.56921938165305*f[4])-48.0*f[0])*dv3)*wv+321.9937887599697*f[32]*vcut4-110.8512516844081*f[4]*dv*vcut3+(48.0*f[0]-53.66563145999496*f[32])*dv2*vcut2+((-6.708203932499369*f[32])-13.85640646055102*f[4]-12.0*f[0])*dv4))/dv3; 
  uhat[1] = -(0.08333333333333333*((24.0*f[18]*wv3-20.78460969082652*f[7]*dv*wv2+(((-18.0*f[18])-20.78460969082652*f[7])*dv2-72.0*f[18]*vcut2)*wv-48.0*f[18]*vcut3+20.78460969082652*f[7]*dv*vcut2+((-6.0*f[18])-5.196152422706631*f[7])*dv3)*zVal+13.85640646055102*f[9]*wv3-12.0*f[1]*dv*wv2+(((-10.39230484541326*f[9])-12.0*f[1])*dv2-41.56921938165305*f[9]*vcut2)*wv-27.71281292110204*f[9]*vcut3+12.0*f[1]*dv*vcut2+((-3.464101615137754*f[9])-3.0*f[1])*dv3))/dv2; 
  uhat[2] = -(0.08333333333333333*((24.0*f[19]*wv3-20.78460969082652*f[8]*dv*wv2+(((-18.0*f[19])-20.78460969082652*f[8])*dv2-72.0*f[19]*vcut2)*wv-48.0*f[19]*vcut3+20.78460969082652*f[8]*dv*vcut2+((-6.0*f[19])-5.196152422706631*f[8])*dv3)*zVal+13.85640646055102*f[10]*wv3-12.0*f[2]*dv*wv2+(((-10.39230484541326*f[10])-12.0*f[2])*dv2-41.56921938165305*f[10]*vcut2)*wv-27.71281292110204*f[10]*vcut3+12.0*f[2]*dv*vcut2+((-3.464101615137754*f[10])-3.0*f[2])*dv3))/dv2; 
  uhat[3] = 0.0; 
  uhat[4] = -(0.08333333333333333*((24.0*f[26]*wv3-20.78460969082652*f[16]*dv*wv2+(((-18.0*f[26])-20.78460969082652*f[16])*dv2-72.0*f[26]*vcut2)*wv-48.0*f[26]*vcut3+20.78460969082652*f[16]*dv*vcut2+((-6.0*f[26])-5.196152422706631*f[16])*dv3)*zVal+13.85640646055102*f[17]*wv3-12.0*f[6]*dv*wv2+(((-10.39230484541326*f[17])-12.0*f[6])*dv2-41.56921938165305*f[17]*vcut2)*wv-27.71281292110204*f[17]*vcut3+12.0*f[6]*dv*vcut2+((-3.464101615137754*f[17])-3.0*f[6])*dv3))/dv2; 
  uhat[5] = 0.0; 
  uhat[6] = 0.0; 
  uhat[7] = 0.0; 
  }
