...
double EmGyrokineticSimpleHelicalSurf1x2vTensor_vpar_P2_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *cmag, const double *BdriftX, const double *BdriftY, const double *phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // dApardtPrev: previous dApardt.
...
double EmGyrokineticSimpleHelicalSurf1x2vTensor_xL_P2_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *cmag, const double *BdriftX, const double *BdriftY, const double *phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // dApardtPrev: previous dApardt.
  ...
  BstarZdBmagL[7] = 2.0*cmag[2]; 

  double alphaL[9]; 
  alphaL[0] = (0.25*hamilL[2]*(3.872983346207417*BstarZdBmagL[7]+3.0*BstarZdBmagL[1]+1.732050807568877*BstarZdBmagL[0])*rdvpar2L)/m_; 
  alphaL[1] = (0.25*(8.660254037844386*BstarZdBmagL[7]+2.23606797749979*(3.0*BstarZdBmagL[1]+1.732050807568877*BstarZdBmagL[0]))*hamilL[8]*rdvpar2L)/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgL = (0.0625*(3.872983346207417*hamilL[2]*BstarZdBmagL[7]*rdvpar2L+3.0*BstarZdBmagL[1]*hamilL[2]*rdvpar2L+1.732050807568877*BstarZdBmagL[0]*hamilL[2]*rdvpar2L))/m_; 
...
double EmGyrokineticSimpleHelicalSurf1x2vTensor_xR_P2_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *cmag, const double *BdriftX, const double *BdriftY, const double *phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // dApardtPrev: previous dApardt.
  ...
  alphaR[1] = (0.25*(8.660254037844386*BstarZdBmagR[7]+2.23606797749979*(1.732050807568877*BstarZdBmagR[0]-3.0*BstarZdBmagR[1]))*hamilR[8]*rdvpar2R)/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgR = (0.0625*(3.872983346207417*hamilR[2]*BstarZdBmagR[7]*rdvpar2R-3.0*BstarZdBmagR[1]*hamilR[2]*rdvpar2R+1.732050807568877*BstarZdBmagR[0]*hamilR[2]*rdvpar2R))/m_; 
...
double EmGyrokineticSimpleHelicalSurf1x2vTensor_vpar_P2_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *bmagInv, const double *cmag, const double *BdriftX, const double *BdriftY, const double *phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // dApardtPrev: previous dApardt.
  ...
  alphaR[1] = -(0.25*((1.732050807568877*(2.0*BstarZdBmagR[7]*hamilR[7]+BstarZdBmagR[1]*hamilR[1])+3.872983346207417*BstarZdBmagR[0]*hamilR[7])*rdx2R+5.656854249492382*dApardt[1]*q_))/m_; 
  alphaR[2] = -(0.25*(3.872983346207417*BstarZdBmagR[1]*hamilR[13]+1.732050807568877*BstarZdBmagR[0]*hamilR[5])*rdx2R)/m_; 
  alphaR[3] = -(0.05*(3.872983346207417*(4.47213595499958*BstarZdBmagR[7]+5.0*BstarZdBmagR[0])*hamilR[13]+8.660254037844386*BstarZdBmagR[1]*hamilR[5])*rdx2R)/m_; 
  alphaR[4] = -(0.25*(1.732050807568877*(2.0*BstarZdBmagR[1]*hamilR[7]+hamilR[1]*BstarZdBmagR[7])*rdx2R+5.656854249492382*dApardt[2]*q_))/m_; 
