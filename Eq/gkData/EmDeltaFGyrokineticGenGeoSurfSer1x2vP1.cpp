...
{ 
  ...
  if (0.5*alpha1R[0] > 0) { 
    fUpOrd[0] = 0.6123724356957944*f0L[7]+0.3535533905932737*f0L[6]-0.6123724356957944*(f0L[5]+f0L[4])-0.3535533905932737*(f0L[3]+f0L[2])+0.6123724356957944*f0L[1]+0.3535533905932737*f0L[0]; 
  } else { 
    fUpOrd[0] = (-0.6123724356957944*f0R[7])+0.3535533905932737*f0R[6]+0.6123724356957944*(f0R[5]+f0R[4])-0.3535533905932737*(f0R[3]+f0R[2])-0.6123724356957944*f0R[1]+0.3535533905932737*f0R[0]; 
  } 
  if (0.5*alpha1R[0] > 0) { 
    fUpOrd[1] = (-0.6123724356957944*f0L[7])-0.3535533905932737*f0L[6]-0.6123724356957944*f0L[5]+0.6123724356957944*f0L[4]-0.3535533905932737*f0L[3]+0.3535533905932737*f0L[2]+0.6123724356957944*f0L[1]+0.3535533905932737*f0L[0]; 
  } else { 
    fUpOrd[1] = 0.6123724356957944*f0R[7]-0.3535533905932737*f0R[6]+0.6123724356957944*f0R[5]-0.6123724356957944*f0R[4]-0.3535533905932737*f0R[3]+0.3535533905932737*f0R[2]-0.6123724356957944*f0R[1]+0.3535533905932737*f0R[0]; 
  } 
  if (0.5*alpha1R[0] > 0) { 
    fUpOrd[2] = (-0.6123724356957944*f0L[7])-0.3535533905932737*f0L[6]+0.6123724356957944*f0L[5]-0.6123724356957944*f0L[4]+0.3535533905932737*f0L[3]-0.3535533905932737*f0L[2]+0.6123724356957944*f0L[1]+0.3535533905932737*f0L[0]; 
  } else { 
    fUpOrd[2] = 0.6123724356957944*f0R[7]-0.3535533905932737*f0R[6]-0.6123724356957944*f0R[5]+0.6123724356957944*f0R[4]+0.3535533905932737*f0R[3]-0.3535533905932737*f0R[2]-0.6123724356957944*f0R[1]+0.3535533905932737*f0R[0]; 
  } 
  if (0.5*alpha1R[0] > 0) { 
    fUpOrd[3] = 0.6123724356957944*f0L[7]+0.3535533905932737*f0L[6]+0.6123724356957944*(f0L[5]+f0L[4])+0.3535533905932737*(f0L[3]+f0L[2])+0.6123724356957944*f0L[1]+0.3535533905932737*f0L[0]; 
  } else { 
    fUpOrd[3] = (-0.6123724356957944*f0R[7])+0.3535533905932737*f0R[6]-0.6123724356957944*(f0R[5]+f0R[4])+0.3535533905932737*(f0R[3]+f0R[2])-0.6123724356957944*f0R[1]+0.3535533905932737*f0R[0]; 
  } 
...
{ 
  ...
  // linear + nonlinear terms (alpha0+alpha1)*f1 
  double fUpOrd[4];
  if (0.5*alpha1UpR[0]-0.5*alpha1UpR[1] > 0) { 
  ...
  if (0.5*(alpha1UpR[1]+alpha1UpR[0]) > 0) { 
...
{ 
  ...
  double fUpOrd[4];
  if (0.5*alpha1UpR[0]-0.5*alpha1UpR[1] > 0) { 
    fUpOrd[0] = 0.6123724356957944*(f1L[7]+f0L[7])-0.6123724356957944*(f1L[6]+f0L[6])+0.3535533905932737*(f1L[5]+f0L[5])-0.6123724356957944*(f1L[4]+f0L[4])-0.3535533905932737*(f1L[3]+f0L[3])+0.6123724356957944*(f1L[2]+f0L[2])-0.3535533905932737*(f1L[1]+f0L[1])+0.3535533905932737*(f1L[0]+f0L[0]); 
  } else { 
    fUpOrd[0] = (-0.6123724356957944*(f1R[7]+f0R[7]))+0.6123724356957944*(f1R[6]+f0R[6])+0.3535533905932737*(f1R[5]+f0R[5])+0.6123724356957944*(f1R[4]+f0R[4])-0.3535533905932737*(f1R[3]+f0R[3])-0.6123724356957944*(f1R[2]+f0R[2])-0.3535533905932737*(f1R[1]+f0R[1])+0.3535533905932737*(f1R[0]+f0R[0]); 
  } 
  if (0.5*(alpha1UpR[1]+alpha1UpR[0]) > 0) { 
    fUpOrd[1] = (-0.6123724356957944*(f1L[7]+f0L[7]+f1L[6]+f0L[6]))-0.3535533905932737*(f1L[5]+f0L[5])+0.6123724356957944*(f1L[4]+f0L[4])-0.3535533905932737*(f1L[3]+f0L[3])+0.6123724356957944*(f1L[2]+f0L[2])+0.3535533905932737*(f1L[1]+f0L[1]+f1L[0]+f0L[0]); 
  } else { 
    fUpOrd[1] = 0.6123724356957944*(f1R[7]+f0R[7]+f1R[6]+f0R[6])-0.3535533905932737*(f1R[5]+f0R[5])-0.6123724356957944*(f1R[4]+f0R[4])-0.3535533905932737*(f1R[3]+f0R[3])-0.6123724356957944*(f1R[2]+f0R[2])+0.3535533905932737*(f1R[1]+f0R[1]+f1R[0]+f0R[0]); 
  } 
  if (0.5*alpha1UpR[0]-0.5*alpha1UpR[1] > 0) { 
    fUpOrd[2] = (-0.6123724356957944*(f1L[7]+f0L[7]))+0.6123724356957944*(f1L[6]+f0L[6])-0.3535533905932737*(f1L[5]+f0L[5])-0.6123724356957944*(f1L[4]+f0L[4])+0.3535533905932737*(f1L[3]+f0L[3])+0.6123724356957944*(f1L[2]+f0L[2])-0.3535533905932737*(f1L[1]+f0L[1])+0.3535533905932737*(f1L[0]+f0L[0]); 
  } else { 
    fUpOrd[2] = 0.6123724356957944*(f1R[7]+f0R[7])-0.6123724356957944*(f1R[6]+f0R[6])-0.3535533905932737*(f1R[5]+f0R[5])+0.6123724356957944*(f1R[4]+f0R[4])+0.3535533905932737*(f1R[3]+f0R[3])-0.6123724356957944*(f1R[2]+f0R[2])-0.3535533905932737*(f1R[1]+f0R[1])+0.3535533905932737*(f1R[0]+f0R[0]); 
  } 
  if (0.5*(alpha1UpR[1]+alpha1UpR[0]) > 0) { 
    fUpOrd[3] = 0.6123724356957944*(f1L[7]+f0L[7]+f1L[6]+f0L[6])+0.3535533905932737*(f1L[5]+f0L[5])+0.6123724356957944*(f1L[4]+f0L[4])+0.3535533905932737*(f1L[3]+f0L[3])+0.6123724356957944*(f1L[2]+f0L[2])+0.3535533905932737*(f1L[1]+f0L[1]+f1L[0]+f0L[0]); 
  } else { 
    fUpOrd[3] = (-0.6123724356957944*(f1R[7]+f0R[7]+f1R[6]+f0R[6]))+0.3535533905932737*(f1R[5]+f0R[5])-0.6123724356957944*(f1R[4]+f0R[4])+0.3535533905932737*(f1R[3]+f0R[3])-0.6123724356957944*(f1R[2]+f0R[2])+0.3535533905932737*(f1R[1]+f0R[1]+f1R[0]+f0R[0]); 
  } 
...
{ 
  ...
  // linear + nonlinear terms (alpha0+alpha1)*f1 
  double fUpOrd[4];
  if (0.5*(alpha1R[0]+alpha0R[0])-0.5*alpha0R[1] > 0) { 
    fUpOrd[0] = 0.6123724356957944*f1L[7]+0.3535533905932737*f1L[6]-0.6123724356957944*(f1L[5]+f1L[4])-0.3535533905932737*(f1L[3]+f1L[2])+0.6123724356957944*f1L[1]+0.3535533905932737*f1L[0]; 
  } else { 
    fUpOrd[0] = (-0.6123724356957944*f1R[7])+0.3535533905932737*f1R[6]+0.6123724356957944*(f1R[5]+f1R[4])-0.3535533905932737*(f1R[3]+f1R[2])-0.6123724356957944*f1R[1]+0.3535533905932737*f1R[0]; 
  } 
  if (0.5*(alpha0R[1]+alpha1R[0]+alpha0R[0]) > 0) { 
    fUpOrd[1] = (-0.6123724356957944*f1L[7])-0.3535533905932737*f1L[6]-0.6123724356957944*f1L[5]+0.6123724356957944*f1L[4]-0.3535533905932737*f1L[3]+0.3535533905932737*f1L[2]+0.6123724356957944*f1L[1]+0.3535533905932737*f1L[0]; 
  } else { 
    fUpOrd[1] = 0.6123724356957944*f1R[7]-0.3535533905932737*f1R[6]+0.6123724356957944*f1R[5]-0.6123724356957944*f1R[4]-0.3535533905932737*f1R[3]+0.3535533905932737*f1R[2]-0.6123724356957944*f1R[1]+0.3535533905932737*f1R[0]; 
  } 
...
{ 
  ...
  // linear + nonlinear terms (alpha0+alpha1)*f1 
  double fUpOrd[4];
  if (0.5*(alpha1UpR[3]+alpha0UpR[3])-0.5*(alpha1UpR[2]+alpha0UpR[2]+alpha1UpR[1]+alpha0UpR[1])+0.5*(alpha1UpR[0]+alpha0UpR[0]) > 0) { 
    fUpOrd[0] = 0.6123724356957944*f1L[7]-0.6123724356957944*f1L[6]+0.3535533905932737*f1L[5]-0.6123724356957944*f1L[4]-0.3535533905932737*f1L[3]+0.6123724356957944*f1L[2]-0.3535533905932737*f1L[1]+0.3535533905932737*f1L[0]; 
  } else { 
    fUpOrd[0] = (-0.6123724356957944*f1R[7])+0.6123724356957944*f1R[6]+0.3535533905932737*f1R[5]+0.6123724356957944*f1R[4]-0.3535533905932737*f1R[3]-0.6123724356957944*f1R[2]-0.3535533905932737*f1R[1]+0.3535533905932737*f1R[0]; 
  } 
  if (0.5*(alpha1UpR[1]+alpha0UpR[1]+alpha1UpR[0]+alpha0UpR[0])-0.5*(alpha1UpR[3]+alpha0UpR[3]+alpha1UpR[2]+alpha0UpR[2]) > 0) { 
    fUpOrd[1] = (-0.6123724356957944*(f1L[7]+f1L[6]))-0.3535533905932737*f1L[5]+0.6123724356957944*f1L[4]-0.3535533905932737*f1L[3]+0.6123724356957944*f1L[2]+0.3535533905932737*(f1L[1]+f1L[0]); 
  } else { 
    fUpOrd[1] = 0.6123724356957944*(f1R[7]+f1R[6])-0.3535533905932737*f1R[5]-0.6123724356957944*f1R[4]-0.3535533905932737*f1R[3]-0.6123724356957944*f1R[2]+0.3535533905932737*(f1R[1]+f1R[0]); 
  } 
  if ((-0.5*(alpha1UpR[3]+alpha0UpR[3]))+0.5*(alpha1UpR[2]+alpha0UpR[2])-0.5*(alpha1UpR[1]+alpha0UpR[1])+0.5*(alpha1UpR[0]+alpha0UpR[0]) > 0) { 
    fUpOrd[2] = (-0.6123724356957944*f1L[7])+0.6123724356957944*f1L[6]-0.3535533905932737*f1L[5]-0.6123724356957944*f1L[4]+0.3535533905932737*f1L[3]+0.6123724356957944*f1L[2]-0.3535533905932737*f1L[1]+0.3535533905932737*f1L[0]; 
  } else { 
    fUpOrd[2] = 0.6123724356957944*f1R[7]-0.6123724356957944*f1R[6]-0.3535533905932737*f1R[5]+0.6123724356957944*f1R[4]+0.3535533905932737*f1R[3]-0.6123724356957944*f1R[2]-0.3535533905932737*f1R[1]+0.3535533905932737*f1R[0]; 
  } 
  if (0.5*(alpha1UpR[3]+alpha0UpR[3]+alpha1UpR[2]+alpha0UpR[2]+alpha1UpR[1]+alpha0UpR[1]+alpha1UpR[0]+alpha0UpR[0]) > 0) { 
    fUpOrd[3] = 0.6123724356957944*(f1L[7]+f1L[6])+0.3535533905932737*f1L[5]+0.6123724356957944*f1L[4]+0.3535533905932737*f1L[3]+0.6123724356957944*f1L[2]+0.3535533905932737*(f1L[1]+f1L[0]); 
  } else { 
    fUpOrd[3] = (-0.6123724356957944*(f1R[7]+f1R[6]))+0.3535533905932737*f1R[5]-0.6123724356957944*f1R[4]+0.3535533905932737*f1R[3]-0.6123724356957944*f1R[2]+0.3535533905932737*(f1R[1]+f1R[0]); 
  } 
  ...
  if (0.5*(alpha1UpR[1]+alpha1UpR[0])-0.5*(alpha1UpR[3]+alpha1UpR[2]) > 0) { 
    fUpOrd[1] = (-0.6123724356957944*(f0L[7]+f0L[6]))-0.3535533905932737*f0L[5]+0.6123724356957944*f0L[4]-0.3535533905932737*f0L[3]+0.6123724356957944*f0L[2]+0.3535533905932737*(f0L[1]+f0L[0]); 
  } else { 
    fUpOrd[1] = 0.6123724356957944*(f0R[7]+f0R[6])-0.3535533905932737*f0R[5]-0.6123724356957944*f0R[4]-0.3535533905932737*f0R[3]-0.6123724356957944*f0R[2]+0.3535533905932737*(f0R[1]+f0R[0]); 
  } 
  if ((-0.5*alpha1UpR[3])+0.5*alpha1UpR[2]-0.5*alpha1UpR[1]+0.5*alpha1UpR[0] > 0) { 
    fUpOrd[2] = (-0.6123724356957944*f0L[7])+0.6123724356957944*f0L[6]-0.3535533905932737*f0L[5]-0.6123724356957944*f0L[4]+0.3535533905932737*f0L[3]+0.6123724356957944*f0L[2]-0.3535533905932737*f0L[1]+0.3535533905932737*f0L[0]; 
  } else { 
    fUpOrd[2] = 0.6123724356957944*f0R[7]-0.6123724356957944*f0R[6]-0.3535533905932737*f0R[5]+0.6123724356957944*f0R[4]+0.3535533905932737*f0R[3]-0.6123724356957944*f0R[2]-0.3535533905932737*f0R[1]+0.3535533905932737*f0R[0]; 
  } 
  if (0.5*(alpha1UpR[3]+alpha1UpR[2]+alpha1UpR[1]+alpha1UpR[0]) > 0) { 
    fUpOrd[3] = 0.6123724356957944*(f0L[7]+f0L[6])+0.3535533905932737*f0L[5]+0.6123724356957944*f0L[4]+0.3535533905932737*f0L[3]+0.6123724356957944*f0L[2]+0.3535533905932737*(f0L[1]+f0L[0]); 
  } else { 
    fUpOrd[3] = (-0.6123724356957944*(f0R[7]+f0R[6]))+0.3535533905932737*f0R[5]-0.6123724356957944*f0R[4]+0.3535533905932737*f0R[3]-0.6123724356957944*f0R[2]+0.3535533905932737*(f0R[1]+f0R[0]); 
  } 
