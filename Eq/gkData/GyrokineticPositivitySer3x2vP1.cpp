...
double GyrokineticVolPositivity3x2vSer_P1_Bvars_0(const double q_, const double m_, const double *w, const double *dxv, 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  out[6] += 0.3061862178478971*(alphax[7]*f[16]+alphax[4]*f[10]+alphax[3]*f[8]+alphax[1]*f[6]+alphax[0]*f[2]); 
  out[7] += 0.3061862178478971*(alphax[4]*f[11]+alphax[1]*f[7]+f[1]*alphax[7]+alphax[0]*f[3]+f[0]*alphax[3]); 
  out[9] += 0.3061862178478971*(alphax[7]*f[18]+alphax[3]*f[11]+alphax[1]*f[9]+alphax[0]*f[4]+f[0]*alphax[4]); 
  out[12] += 0.3061862178478971*(alphax[7]*f[21]+alphax[4]*f[15]+alphax[3]*f[14]+alphax[1]*f[12]+alphax[0]*f[5]); 
  out[16] += 0.3061862178478971*(alphax[4]*f[19]+alphax[1]*f[16]+alphax[0]*f[8]+f[6]*alphax[7]+f[2]*alphax[3]); 
  out[17] += 0.3061862178478971*(alphax[7]*f[26]+alphax[3]*f[19]+alphax[1]*f[17]+alphax[0]*f[10]+f[2]*alphax[4]); 
  out[18] += 0.3061862178478971*(alphax[1]*f[18]+alphax[0]*f[11]+alphax[7]*f[9]+alphax[3]*f[4]+f[3]*alphax[4]); 
  out[20] += 0.3061862178478971*(alphax[7]*f[27]+alphax[4]*f[24]+alphax[3]*f[22]+alphax[1]*f[20]+alphax[0]*f[13]); 
  out[21] += 0.3061862178478971*(alphax[4]*f[25]+alphax[1]*f[21]+alphax[0]*f[14]+alphax[7]*f[12]+alphax[3]*f[5]); 
  out[23] += 0.3061862178478971*(alphax[7]*f[29]+alphax[3]*f[25]+alphax[1]*f[23]+alphax[0]*f[15]+alphax[4]*f[5]); 
  out[26] += 0.3061862178478971*(alphax[1]*f[26]+alphax[0]*f[19]+alphax[7]*f[17]+alphax[3]*f[10]+alphax[4]*f[8]); 
  out[27] += 0.3061862178478971*(alphax[4]*f[30]+alphax[1]*f[27]+alphax[0]*f[22]+alphax[7]*f[20]+alphax[3]*f[13]); 
  out[28] += 0.3061862178478971*(alphax[7]*f[31]+alphax[3]*f[30]+alphax[1]*f[28]+alphax[0]*f[24]+alphax[4]*f[13]); 
  out[29] += 0.3061862178478971*(alphax[1]*f[29]+alphax[0]*f[25]+alphax[7]*f[23]+alphax[3]*f[15]+alphax[4]*f[14]); 
  out[31] += 0.3061862178478971*(alphax[1]*f[31]+alphax[0]*f[30]+alphax[7]*f[28]+alphax[3]*f[24]+alphax[4]*f[22]); 
  double alphay[32]; 
  ...
  out[6] += 0.3061862178478971*(alphay[8]*f[16]+alphay[4]*f[9]+alphay[3]*f[7]+alphay[2]*f[6]+alphay[0]*f[1]); 
  out[8] += 0.3061862178478971*(alphay[4]*f[11]+alphay[2]*f[8]+f[2]*alphay[8]+alphay[0]*f[3]+f[0]*alphay[3]); 
  out[10] += 0.3061862178478971*(alphay[8]*f[19]+alphay[3]*f[11]+alphay[2]*f[10]+alphay[0]*f[4]+f[0]*alphay[4]); 
  out[13] += 0.3061862178478971*(alphay[8]*f[22]+alphay[4]*f[15]+alphay[3]*f[14]+alphay[2]*f[13]+alphay[0]*f[5]); 
  out[16] += 0.3061862178478971*(alphay[4]*f[18]+alphay[2]*f[16]+f[6]*alphay[8]+alphay[0]*f[7]+f[1]*alphay[3]); 
  out[17] += 0.3061862178478971*(alphay[8]*f[26]+alphay[3]*f[18]+alphay[2]*f[17]+alphay[0]*f[9]+f[1]*alphay[4]); 
  out[19] += 0.3061862178478971*(alphay[2]*f[19]+alphay[0]*f[11]+alphay[8]*f[10]+alphay[3]*f[4]+f[3]*alphay[4]); 
  out[20] += 0.3061862178478971*(alphay[8]*f[27]+alphay[4]*f[23]+alphay[3]*f[21]+alphay[2]*f[20]+alphay[0]*f[12]); 
  out[22] += 0.3061862178478971*(alphay[4]*f[25]+alphay[2]*f[22]+alphay[0]*f[14]+alphay[8]*f[13]+alphay[3]*f[5]); 
  out[24] += 0.3061862178478971*(alphay[8]*f[30]+alphay[3]*f[25]+alphay[2]*f[24]+alphay[0]*f[15]+alphay[4]*f[5]); 
  out[26] += 0.3061862178478971*(alphay[2]*f[26]+alphay[0]*f[18]+alphay[8]*f[17]+alphay[3]*f[9]+alphay[4]*f[7]); 
  out[27] += 0.3061862178478971*(alphay[4]*f[29]+alphay[2]*f[27]+alphay[0]*f[21]+alphay[8]*f[20]+alphay[3]*f[12]); 
  out[28] += 0.3061862178478971*(alphay[8]*f[31]+alphay[3]*f[29]+alphay[2]*f[28]+alphay[0]*f[23]+alphay[4]*f[12]); 
  out[30] += 0.3061862178478971*(alphay[2]*f[30]+alphay[0]*f[25]+alphay[8]*f[24]+alphay[3]*f[15]+alphay[4]*f[14]); 
  out[31] += 0.3061862178478971*(alphay[2]*f[31]+alphay[0]*f[29]+alphay[8]*f[28]+alphay[3]*f[23]+alphay[4]*f[21]); 
  double alphaz[32]; 
  ...
  out[9] += 0.3061862178478971*(alphav[19]*f[26]+alphav[11]*f[18]+f[11]*alphav[18]+alphav[10]*f[17]+alphav[8]*f[16]+alphav[4]*f[9]+f[4]*alphav[9]+alphav[3]*f[7]+f[3]*alphav[7]+alphav[2]*f[6]+f[2]*alphav[6]+alphav[0]*f[1]+f[0]*alphav[1]); 
  out[10] += 0.3061862178478971*(alphav[18]*f[26]+alphav[11]*f[19]+f[11]*alphav[19]+alphav[9]*f[17]+alphav[7]*f[16]+alphav[4]*f[10]+f[4]*alphav[10]+alphav[3]*f[8]+f[3]*alphav[8]+alphav[1]*f[6]+f[1]*alphav[6]+alphav[0]*f[2]+f[0]*alphav[2]); 
  out[11] += 0.3061862178478971*(alphav[10]*f[19]+f[10]*alphav[19]+alphav[9]*f[18]+f[9]*alphav[18]+alphav[6]*f[16]+alphav[4]*f[11]+f[4]*alphav[11]+alphav[2]*f[8]+f[2]*alphav[8]+alphav[1]*f[7]+f[1]*alphav[7]+alphav[0]*f[3]+f[0]*alphav[3]); 
  ...
  out[17] += 0.3061862178478971*(alphav[11]*f[26]+alphav[18]*f[19]+f[18]*alphav[19]+alphav[4]*f[17]+alphav[3]*f[16]+alphav[9]*f[10]+f[9]*alphav[10]+alphav[7]*f[8]+f[7]*alphav[8]+alphav[0]*f[6]+f[0]*alphav[6]+alphav[1]*f[2]+f[1]*alphav[2]); 
  out[18] += 0.3061862178478971*(alphav[10]*f[26]+f[17]*alphav[19]+alphav[4]*f[18]+f[4]*alphav[18]+alphav[2]*f[16]+alphav[9]*f[11]+f[9]*alphav[11]+alphav[6]*f[8]+f[6]*alphav[8]+alphav[0]*f[7]+f[0]*alphav[7]+alphav[1]*f[3]+f[1]*alphav[3]); 
  out[19] += 0.3061862178478971*(alphav[9]*f[26]+alphav[4]*f[19]+f[4]*alphav[19]+f[17]*alphav[18]+alphav[1]*f[16]+alphav[10]*f[11]+f[10]*alphav[11]+alphav[0]*f[8]+f[0]*alphav[8]+alphav[6]*f[7]+f[6]*alphav[7]+alphav[2]*f[3]+f[2]*alphav[3]); 
  out[23] += 0.3061862178478971*(alphav[19]*f[31]+alphav[11]*f[29]+alphav[10]*f[28]+alphav[8]*f[27]+alphav[18]*f[25]+alphav[4]*f[23]+alphav[3]*f[21]+alphav[2]*f[20]+alphav[9]*f[15]+alphav[7]*f[14]+alphav[6]*f[13]+alphav[0]*f[12]+alphav[1]*f[5]); 
  out[24] += 0.3061862178478971*(alphav[18]*f[31]+alphav[11]*f[30]+alphav[9]*f[28]+alphav[7]*f[27]+alphav[19]*f[25]+alphav[4]*f[24]+alphav[3]*f[22]+alphav[1]*f[20]+alphav[10]*f[15]+alphav[8]*f[14]+alphav[0]*f[13]+alphav[6]*f[12]+alphav[2]*f[5]); 
  out[25] += 0.3061862178478971*(alphav[10]*f[30]+alphav[9]*f[29]+alphav[6]*f[27]+alphav[4]*f[25]+alphav[19]*f[24]+alphav[18]*f[23]+alphav[2]*f[22]+alphav[1]*f[21]+alphav[11]*f[15]+alphav[0]*f[14]+alphav[8]*f[13]+alphav[7]*f[12]+alphav[3]*f[5]); 
  out[26] += 0.3061862178478971*(alphav[4]*f[26]+alphav[9]*f[19]+f[9]*alphav[19]+alphav[10]*f[18]+f[10]*alphav[18]+alphav[11]*f[17]+alphav[0]*f[16]+alphav[1]*f[8]+f[1]*alphav[8]+alphav[2]*f[7]+f[2]*alphav[7]+alphav[3]*f[6]+f[3]*alphav[6]); 
  out[28] += 0.3061862178478971*(alphav[11]*f[31]+alphav[18]*f[30]+alphav[19]*f[29]+alphav[4]*f[28]+alphav[3]*f[27]+alphav[9]*f[24]+alphav[10]*f[23]+alphav[7]*f[22]+alphav[8]*f[21]+alphav[0]*f[20]+alphav[1]*f[13]+alphav[2]*f[12]+f[5]*alphav[6]); 
  out[29] += 0.3061862178478971*(alphav[10]*f[31]+alphav[4]*f[29]+alphav[19]*f[28]+alphav[2]*f[27]+alphav[9]*f[25]+alphav[11]*f[23]+alphav[6]*f[22]+alphav[0]*f[21]+alphav[8]*f[20]+f[15]*alphav[18]+alphav[1]*f[14]+alphav[3]*f[12]+f[5]*alphav[7]); 
  out[30] += 0.3061862178478971*(alphav[9]*f[31]+alphav[4]*f[30]+alphav[18]*f[28]+alphav[1]*f[27]+alphav[10]*f[25]+alphav[11]*f[24]+alphav[0]*f[22]+alphav[6]*f[21]+alphav[7]*f[20]+f[15]*alphav[19]+alphav[2]*f[14]+alphav[3]*f[13]+f[5]*alphav[8]); 
  out[31] += 0.3061862178478971*(alphav[4]*f[31]+alphav[9]*f[30]+alphav[10]*f[29]+alphav[11]*f[28]+alphav[0]*f[27]+alphav[18]*f[24]+alphav[19]*f[23]+alphav[1]*f[22]+alphav[2]*f[21]+alphav[3]*f[20]+alphav[6]*f[14]+alphav[7]*f[13]+alphav[8]*f[12]); 
  return cflRate; 
} 
double GyrokineticVolPositivity3x2vSer_P1_Bvars_1(const double q_, const double m_, const double *w, const double *dxv, 
                        const double *Bmag, const double *BmagInv, const double *Gradpar, 
                        const double *BdriftX, const double *BdriftY, const double *Phi, 
                        const double *f, double *out, double *positivityWeightByDir) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  out[6] += 0.3061862178478971*(alphax[9]*f[17]+alphax[7]*f[16]+alphax[4]*f[10]+alphax[3]*f[8]+alphax[1]*f[6]+alphax[0]*f[2]); 
  out[7] += 0.3061862178478971*(alphax[9]*f[18]+alphax[4]*f[11]+alphax[1]*f[7]+f[1]*alphax[7]+alphax[0]*f[3]+f[0]*alphax[3]); 
  out[9] += 0.3061862178478971*(alphax[7]*f[18]+alphax[3]*f[11]+alphax[1]*f[9]+f[1]*alphax[9]+alphax[0]*f[4]+f[0]*alphax[4]); 
  out[12] += 0.3061862178478971*(alphax[9]*f[23]+alphax[7]*f[21]+alphax[4]*f[15]+alphax[3]*f[14]+alphax[1]*f[12]+alphax[0]*f[5]); 
  out[16] += 0.3061862178478971*(alphax[9]*f[26]+alphax[4]*f[19]+alphax[1]*f[16]+alphax[0]*f[8]+f[6]*alphax[7]+f[2]*alphax[3]); 
  out[17] += 0.3061862178478971*(alphax[7]*f[26]+alphax[3]*f[19]+alphax[1]*f[17]+alphax[0]*f[10]+f[6]*alphax[9]+f[2]*alphax[4]); 
  out[18] += 0.3061862178478971*(alphax[1]*f[18]+alphax[0]*f[11]+alphax[7]*f[9]+f[7]*alphax[9]+alphax[3]*f[4]+f[3]*alphax[4]); 
  out[20] += 0.3061862178478971*(alphax[9]*f[28]+alphax[7]*f[27]+alphax[4]*f[24]+alphax[3]*f[22]+alphax[1]*f[20]+alphax[0]*f[13]); 
  out[21] += 0.3061862178478971*(alphax[9]*f[29]+alphax[4]*f[25]+alphax[1]*f[21]+alphax[0]*f[14]+alphax[7]*f[12]+alphax[3]*f[5]); 
  out[23] += 0.3061862178478971*(alphax[7]*f[29]+alphax[3]*f[25]+alphax[1]*f[23]+alphax[0]*f[15]+alphax[9]*f[12]+alphax[4]*f[5]); 
  out[26] += 0.3061862178478971*(alphax[1]*f[26]+alphax[0]*f[19]+alphax[7]*f[17]+alphax[9]*f[16]+alphax[3]*f[10]+alphax[4]*f[8]); 
  out[27] += 0.3061862178478971*(alphax[9]*f[31]+alphax[4]*f[30]+alphax[1]*f[27]+alphax[0]*f[22]+alphax[7]*f[20]+alphax[3]*f[13]); 
  out[28] += 0.3061862178478971*(alphax[7]*f[31]+alphax[3]*f[30]+alphax[1]*f[28]+alphax[0]*f[24]+alphax[9]*f[20]+alphax[4]*f[13]); 
  out[29] += 0.3061862178478971*(alphax[1]*f[29]+alphax[0]*f[25]+alphax[7]*f[23]+alphax[9]*f[21]+alphax[3]*f[15]+alphax[4]*f[14]); 
  out[31] += 0.3061862178478971*(alphax[1]*f[31]+alphax[0]*f[30]+alphax[7]*f[28]+alphax[9]*f[27]+alphax[3]*f[24]+alphax[4]*f[22]); 
  double alphay[32]; 
  ...
  out[10] += 0.3061862178478971*(alphav[23]*f[28]+alphav[18]*f[26]+f[18]*alphav[26]+alphav[15]*f[24]+alphav[12]*f[20]+alphav[11]*f[19]+f[11]*alphav[19]+alphav[9]*f[17]+f[9]*alphav[17]+alphav[7]*f[16]+f[7]*alphav[16]+alphav[5]*f[13]+alphav[4]*f[10]+f[4]*alphav[10]+alphav[3]*f[8]+f[3]*alphav[8]+alphav[1]*f[6]+f[1]*alphav[6]+alphav[0]*f[2]+f[0]*alphav[2]); 
  out[11] += 0.3061862178478971*(alphav[23]*f[29]+alphav[17]*f[26]+f[17]*alphav[26]+alphav[15]*f[25]+alphav[12]*f[21]+alphav[10]*f[19]+f[10]*alphav[19]+alphav[9]*f[18]+f[9]*alphav[18]+alphav[6]*f[16]+f[6]*alphav[16]+alphav[5]*f[14]+alphav[4]*f[11]+f[4]*alphav[11]+alphav[2]*f[8]+f[2]*alphav[8]+alphav[1]*f[7]+f[1]*alphav[7]+alphav[0]*f[3]+f[0]*alphav[3]); 
