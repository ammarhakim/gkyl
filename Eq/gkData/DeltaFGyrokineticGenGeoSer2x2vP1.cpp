...
double DeltaFGyrokineticGenGeoVol2x2vSerP1_Bvars(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *f0, const double *f1, double *out) 
{ 
...
double DeltaFGyrokineticGenGeoVol2x2vSerP1_Bvarsx(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *f0, const double *f1, double *out) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
  ...
  out[3] += 0.4330127018922193*(alpha1vpar[6]*f1[6]+alpha1vpar[3]*f1[3]+alpha1vpar[1]*f1[1]+alpha1vpar[0]*f1[0]); 
  out[5] += 0.4330127018922193*((alpha1y[2]+alpha1x[1])*f1[5]+f1[2]*(alpha1y[5]+alpha1x[0])+alpha1y[0]*f1[1]+f1[0]*alpha1y[1]); 
  out[6] += 0.4330127018922193*((alpha1vpar[3]+alpha1x[1])*f1[6]+f1[3]*(alpha1vpar[6]+alpha1x[0])+alpha1vpar[0]*f1[1]+f1[0]*alpha1vpar[1]); 
  out[7] += 0.4330127018922193*((alpha1vpar[6]+alpha1y[5])*f1[11]+(alpha1vpar[3]+alpha1y[2])*f1[7]+alpha1y[1]*f1[6]+alpha1vpar[1]*f1[5]+alpha1y[0]*f1[3]+alpha1vpar[0]*f1[2]); 
  out[8] += 0.4330127018922193*(alpha1x[1]*f1[8]+alpha1x[0]*f1[4]); 
  out[9] += 0.4330127018922193*(alpha1y[5]*f1[12]+alpha1y[2]*f1[9]+alpha1y[1]*f1[8]+alpha1y[0]*f1[4]); 
  out[10] += 0.4330127018922193*(alpha1vpar[6]*f1[13]+alpha1vpar[3]*f1[10]+alpha1vpar[1]*f1[8]+alpha1vpar[0]*f1[4]); 
  out[11] += 0.4330127018922193*((alpha1vpar[3]+alpha1y[2]+alpha1x[1])*f1[11]+(alpha1vpar[6]+alpha1y[5]+alpha1x[0])*f1[7]+alpha1y[0]*f1[6]+alpha1vpar[0]*f1[5]+alpha1y[1]*f1[3]+alpha1vpar[1]*f1[2]); 
  out[12] += 0.4330127018922193*((alpha1y[2]+alpha1x[1])*f1[12]+(alpha1y[5]+alpha1x[0])*f1[9]+alpha1y[0]*f1[8]+alpha1y[1]*f1[4]); 
  out[13] += 0.4330127018922193*((alpha1vpar[3]+alpha1x[1])*f1[13]+(alpha1vpar[6]+alpha1x[0])*f1[10]+alpha1vpar[0]*f1[8]+alpha1vpar[1]*f1[4]); 
  out[14] += 0.4330127018922193*((alpha1vpar[6]+alpha1y[5])*f1[15]+(alpha1vpar[3]+alpha1y[2])*f1[14]+alpha1y[1]*f1[13]+alpha1vpar[1]*f1[12]+alpha1y[0]*f1[10]+alpha1vpar[0]*f1[9]); 
  out[15] += 0.4330127018922193*((alpha1vpar[3]+alpha1y[2]+alpha1x[1])*f1[15]+(alpha1vpar[6]+alpha1y[5]+alpha1x[0])*f1[14]+alpha1y[0]*f1[13]+alpha1vpar[0]*f1[12]+alpha1y[1]*f1[10]+alpha1vpar[1]*f1[9]); 
  return cflFreq; 
} 
double DeltaFGyrokineticGenGeoVol2x2vSerP1_Bvarsz(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *f0, const double *f1, double *out) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
...
double DeltaFGyrokineticGenGeoVol2x2vSerP1_Bvarsxz(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *f0, const double *f1, double *out) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
