...
double GyrokineticGenGeoSurf2x2vSer_X_P2_Bvars_0(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alpha0 = -(0.03125*geoZ[0]*jacobTotInv[0]*(3.872983346207417*hamil[19]-3.0*hamil[5]+1.732050807568877*hamil[2])*dfac_y)/q_; 

  double alpha[20]; 
  alpha[0] = -(0.1767766952966368*geoZ[0]*jacobTotInv[0]*(3.872983346207417*hamil[19]-3.0*hamil[5]+1.732050807568877*hamil[2])*dfac_y)/q_; 
  alpha[1] = (0.1767766952966368*geoZ[0]*jacobTotInv[0]*(6.708203932499369*hamil[20]-3.872983346207417*hamil[12])*dfac_y)/q_; 
  double amax = 0.0; 
  bool upwind = false; 
  if(upwind) 
    amax = std::abs(alpha0); 
...
double GyrokineticGenGeoSurf2x2vSer_Y_P2_Bvars_0(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
  ...
  // surface-averaged phase velocity in this direction 
  double alpha0 = (0.03125*geoZ[0]*jacobTotInv[0]*(3.872983346207417*hamil[20]-3.0*hamil[5]+1.732050807568877*hamil[1])*dfac_x)/q_; 

  double alpha[20]; 
  alpha[0] = (0.1767766952966368*geoZ[0]*jacobTotInv[0]*(3.872983346207417*hamil[20]-3.0*hamil[5]+1.732050807568877*hamil[1])*dfac_x)/q_; 
  alpha[1] = -(0.1767766952966368*geoZ[0]*jacobTotInv[0]*(6.708203932499369*hamil[19]-3.872983346207417*hamil[11])*dfac_x)/q_; 
  double amax = 0.0; 
  bool upwind = false; 
  if(upwind) 
    amax = std::abs(alpha0); 
...
double GyrokineticGenGeoSurf2x2vSer_X_P2_Bvars_1(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
  ...
  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.03125*(3.872983346207417*((5.0*geoZ[4]+2.23606797749979*(geoZ[0]-1.732050807568877*geoZ[1]))*jacobTotInv[4]+2.23606797749979*(jacobTotInv[0]-1.732050807568877*jacobTotInv[1])*geoZ[4]+(3.0*geoZ[1]-1.732050807568877*geoZ[0])*jacobTotInv[1]+jacobTotInv[0]*(geoZ[0]-1.732050807568877*geoZ[1]))*hamil[19]-1.0*((15.0*geoZ[4]+2.23606797749979*(3.0*geoZ[0]-5.196152422706631*geoZ[1]))*jacobTotInv[4]-1.0*(2.23606797749979*(5.196152422706631*jacobTotInv[1]-3.0*jacobTotInv[0])*geoZ[4]+(5.196152422706631*geoZ[0]-9.0*geoZ[1])*jacobTotInv[1])+jacobTotInv[0]*(3.0*geoZ[0]-5.196152422706631*geoZ[1]))*hamil[5]+hamil[2]*((8.660254037844386*geoZ[4]+2.23606797749979*(1.732050807568877*geoZ[0]-3.0*geoZ[1]))*jacobTotInv[4]+2.23606797749979*(1.732050807568877*jacobTotInv[0]-3.0*jacobTotInv[1])*geoZ[4]+(5.196152422706631*geoZ[1]-3.0*geoZ[0])*jacobTotInv[1]+jacobTotInv[0]*(1.732050807568877*geoZ[0]-3.0*geoZ[1])))*dfac_y)/q_; 

  double alpha[20]; 
  alpha[0] = -(0.1767766952966368*(((19.36491673103708*geoZ[4]-15.0*geoZ[1]+8.660254037844387*geoZ[0])*jacobTotInv[4]+(8.660254037844387*jacobTotInv[0]-15.0*jacobTotInv[1])*geoZ[4]+(11.61895003862225*geoZ[1]-6.708203932499369*geoZ[0])*jacobTotInv[1]+jacobTotInv[0]*(3.872983346207417*geoZ[0]-6.708203932499369*geoZ[1]))*hamil[19]+(((-15.0*geoZ[4])+11.61895003862225*geoZ[1]-6.708203932499369*geoZ[0])*jacobTotInv[4]+(11.61895003862225*jacobTotInv[1]-6.708203932499369*jacobTotInv[0])*geoZ[4]+(5.196152422706631*geoZ[0]-9.0*geoZ[1])*jacobTotInv[1]+jacobTotInv[0]*(5.196152422706631*geoZ[1]-3.0*geoZ[0]))*hamil[5]+hamil[2]*((8.660254037844386*geoZ[4]-6.708203932499369*geoZ[1]+3.872983346207417*geoZ[0])*jacobTotInv[4]+(3.872983346207417*jacobTotInv[0]-6.708203932499369*jacobTotInv[1])*geoZ[4]+(5.196152422706631*geoZ[1]-3.0*geoZ[0])*jacobTotInv[1]+jacobTotInv[0]*(1.732050807568877*geoZ[0]-3.0*geoZ[1])))*dfac_y)/q_; 
  alpha[1] = (0.1767766952966368*(((33.54101966249684*geoZ[4]-25.98076211353316*geoZ[1]+15.0*geoZ[0])*jacobTotInv[4]+(15.0*jacobTotInv[0]-25.98076211353316*jacobTotInv[1])*geoZ[4]+(20.1246117974981*geoZ[1]-11.61895003862225*geoZ[0])*jacobTotInv[1]+jacobTotInv[0]*(6.708203932499369*geoZ[0]-11.61895003862225*geoZ[1]))*hamil[20]+(((-19.36491673103709*geoZ[4])+15.0*geoZ[1]-8.660254037844386*geoZ[0])*jacobTotInv[4]+(15.0*jacobTotInv[1]-8.660254037844386*jacobTotInv[0])*geoZ[4]+(6.708203932499369*geoZ[0]-11.61895003862225*geoZ[1])*jacobTotInv[1]+jacobTotInv[0]*(6.708203932499369*geoZ[1]-3.872983346207417*geoZ[0]))*hamil[12])*dfac_y)/q_; 
  double amax = 0.0; 
  bool upwind = false; 
  if(upwind) 
    amax = std::abs(alpha0); 
...
double GyrokineticGenGeoSurf2x2vSer_Y_P2_Bvars_1(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
  ...
  alpha[4] = (0.1767766952966368*(3.872983346207417*BstarY_by_Bmag[1]*hamil[13]+1.732050807568877*hamil[3]*BstarY_by_Bmag[6])*dfac_v)/m_; 
...
double GyrokineticGenGeoSurf2x2vSer_Vpar_P2_Bvars_1(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
  ...
  // surface-averaged phase velocity in this direction 
  double alpha0 = (0.00625*(hamil[19]*(15.0*BstarY_by_Bmag[21]-8.660254037844387*BstarY_by_Bmag[11])+5.0*(hamil[5]*(3.0*BstarY_by_Bmag[6]-1.732050807568877*BstarY_by_Bmag[1])+hamil[2]*(3.0*BstarY_by_Bmag[3]-1.732050807568877*BstarY_by_Bmag[0])))*dfac_y)/m_; 

  double alpha[20]; 
  alpha[0] = (0.03535533905932736*(hamil[19]*(15.0*BstarY_by_Bmag[21]-8.660254037844387*BstarY_by_Bmag[11])+hamil[5]*(15.0*BstarY_by_Bmag[6]-8.660254037844386*BstarY_by_Bmag[1])+hamil[2]*(15.0*BstarY_by_Bmag[3]-8.660254037844386*BstarY_by_Bmag[0]))*dfac_y)/m_; 
  alpha[1] = (0.03535533905932736*(13.41640786499874*hamil[5]*BstarY_by_Bmag[21]+(13.41640786499874*BstarY_by_Bmag[6]-7.745966692414834*BstarY_by_Bmag[1])*hamil[19]-7.745966692414834*hamil[5]*BstarY_by_Bmag[11]+15.0*hamil[2]*BstarY_by_Bmag[6]+(15.0*BstarY_by_Bmag[3]-8.660254037844386*BstarY_by_Bmag[0])*hamil[5]-8.660254037844386*BstarY_by_Bmag[1]*hamil[2])*dfac_y)/m_; 
  alpha[2] = (0.1767766952966368*((6.708203932499369*BstarY_by_Bmag[6]-3.872983346207417*BstarY_by_Bmag[1])*hamil[20]+(6.708203932499369*BstarY_by_Bmag[3]-3.872983346207417*BstarY_by_Bmag[0])*hamil[12])*dfac_y)/m_; 
  alpha[4] = (0.03535533905932736*(hamil[20]*(30.0*BstarY_by_Bmag[21]-17.32050807568877*BstarY_by_Bmag[11]+33.54101966249684*BstarY_by_Bmag[3]-19.36491673103708*BstarY_by_Bmag[0])+(33.54101966249685*BstarY_by_Bmag[6]-19.36491673103709*BstarY_by_Bmag[1])*hamil[12])*dfac_y)/m_; 
  alpha[7] = (0.005050762722761052*((67.0820393249937*hamil[19]+105.0*hamil[2])*BstarY_by_Bmag[21]+((-38.72983346207417*BstarY_by_Bmag[11])+105.0*BstarY_by_Bmag[3]-60.62177826491071*BstarY_by_Bmag[0])*hamil[19]-60.6217782649107*hamil[2]*BstarY_by_Bmag[11]+hamil[5]*(93.91485505499116*BstarY_by_Bmag[6]-54.22176684690384*BstarY_by_Bmag[1]))*dfac_y)/m_; 
  alpha[11] = (0.1767766952966368*(6.708203932499369*hamil[12]*BstarY_by_Bmag[21]+(6.0*BstarY_by_Bmag[6]-3.464101615137754*BstarY_by_Bmag[1])*hamil[20]-3.872983346207417*BstarY_by_Bmag[11]*hamil[12])*dfac_y)/m_; 
  double amax = 0.0; 
  bool upwind = false; 
  if(upwind) 
    amax = std::abs(alpha0); 
