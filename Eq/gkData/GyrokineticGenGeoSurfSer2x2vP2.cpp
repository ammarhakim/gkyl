...
{ 
  ...
  double alphaL[20]; 
  alphaL[0] = -(0.1767766952966368*b_z[0]*jacobTotInv[0]*(3.872983346207417*hamilL[19]+3.0*hamilL[5]+1.732050807568877*hamilL[2])*rdy2L)/q_; 
  alphaL[1] = -(0.1767766952966368*b_z[0]*jacobTotInv[0]*(6.708203932499369*hamilL[20]+3.872983346207417*hamilL[12])*rdy2L)/q_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgL = -(0.03125*(3.872983346207417*b_z[0]*jacobTotInv[0]*hamilL[19]+3.0*b_z[0]*jacobTotInv[0]*hamilL[5]+1.732050807568877*b_z[0]*jacobTotInv[0]*hamilL[2])*rdy2L)/q_; 
  ...
  double Ghat[20]; 
  Ghat[0] = -0.125*((6.324555320336761*fR[11]-6.324555320336761*fL[11]-4.898979485566357*(fR[1]+fL[1])+2.828427124746191*fR[0]-2.828427124746191*fL[0])*amax-1.414213562373095*(alphaL[1]*fAvg[1]+alphaL[0]*fAvg[0])); 
  Ghat[1] = -0.008333333333333333*((94.8683298050514*fR[19]-94.8683298050514*fL[19]-73.48469228349535*(fR[5]+fL[5])+42.42640687119286*fR[2]-42.42640687119286*fL[2])*amax-18.97366596101028*alphaL[1]*fAvg[7]-21.21320343559643*(alphaL[0]*fAvg[1]+fAvg[0]*alphaL[1])); 
  Ghat[2] = -0.04166666666666666*((18.97366596101028*fR[21]-18.97366596101028*fL[21]-14.69693845669907*(fR[6]+fL[6])+8.485281374238571*fR[3]-8.485281374238571*fL[3])*amax-4.242640687119286*(alphaL[1]*fAvg[4]+alphaL[0]*fAvg[2])); 
  Ghat[3] = -0.04166666666666666*((18.97366596101028*fR[25]-18.97366596101028*fL[25]-14.69693845669907*(fR[8]+fL[8])+8.485281374238571*fR[4]-8.485281374238571*fL[4])*amax-4.242640687119286*(alphaL[1]*fAvg[5]+alphaL[0]*fAvg[3])); 
  Ghat[4] = -0.008333333333333333*((94.86832980505142*fR[32]-94.86832980505142*fL[32]-73.48469228349535*(fR[15]+fL[15])+42.42640687119286*fR[7]-42.42640687119286*fL[7])*amax-18.97366596101028*alphaL[1]*fAvg[11]-21.21320343559643*(alphaL[0]*fAvg[4]+alphaL[1]*fAvg[2])); 
  Ghat[5] = -0.008333333333333333*((94.86832980505142*fR[35]-94.86832980505142*fL[35]-73.48469228349535*(fR[16]+fL[16])+42.42640687119286*fR[9]-42.42640687119286*fL[9])*amax-18.97366596101028*alphaL[1]*fAvg[13]-21.21320343559643*(alphaL[0]*fAvg[5]+alphaL[1]*fAvg[3])); 
  Ghat[6] = -0.125*((6.324555320336761*fR[37]-6.324555320336761*fL[37]-4.898979485566357*(fR[17]+fL[17])+2.828427124746191*fR[10]-2.828427124746191*fL[10])*amax-1.414213562373095*(alphaL[1]*fAvg[10]+alphaL[0]*fAvg[6])); 
  Ghat[7] = 0.025*((24.49489742783179*(fR[20]+fL[20])-14.14213562373095*fR[12]+14.14213562373095*fL[12])*amax+7.071067811865476*alphaL[0]*fAvg[7]+6.324555320336761*alphaL[1]*fAvg[1]); 
  Ghat[8] = 0.008333333333333333*((73.48469228349536*(fR[23]+fL[23])-42.42640687119286*fR[13]+42.42640687119286*fL[13])*amax+21.21320343559643*alphaL[1]*fAvg[12]+21.21320343559643*alphaL[0]*fAvg[8]); 
  Ghat[9] = 0.008333333333333333*((73.48469228349536*(fR[28]+fL[28])-42.42640687119286*fR[14]+42.42640687119286*fL[14])*amax+21.21320343559643*alphaL[1]*fAvg[15]+21.21320343559643*alphaL[0]*fAvg[9]); 
  Ghat[10] = -0.008333333333333333*((94.8683298050514*fR[44]-94.8683298050514*fL[44]-73.48469228349535*(fR[31]+fL[31])+42.42640687119286*fR[18]-42.42640687119286*fL[18])*amax-18.97366596101028*alphaL[1]*fAvg[17]-21.21320343559643*(alphaL[0]*fAvg[10]+alphaL[1]*fAvg[6])); 
  Ghat[11] = 0.008333333333333333*((73.48469228349536*(fR[33]+fL[33])-42.42640687119286*fR[22]+42.42640687119286*fL[22])*amax+21.21320343559643*alphaL[0]*fAvg[11]+18.97366596101028*alphaL[1]*fAvg[4]); 
  Ghat[12] = 0.008333333333333333*((73.48469228349536*(fR[34]+fL[34])-42.42640687119286*fR[24]+42.42640687119286*fL[24])*amax+21.21320343559643*alphaL[0]*fAvg[12]+21.21320343559643*alphaL[1]*fAvg[8]); 
  Ghat[13] = 0.008333333333333333*((73.48469228349536*(fR[36]+fL[36])-42.42640687119286*fR[26]+42.42640687119286*fL[26])*amax+21.21320343559643*alphaL[0]*fAvg[13]+18.97366596101028*alphaL[1]*fAvg[5]); 
  Ghat[14] = 0.008333333333333333*((73.48469228349536*(fR[39]+fL[39])-42.42640687119286*fR[27]+42.42640687119286*fL[27])*amax+21.21320343559643*alphaL[1]*fAvg[18]+21.21320343559643*alphaL[0]*fAvg[14]); 
  Ghat[15] = 0.008333333333333333*((73.48469228349536*(fR[41]+fL[41])-42.42640687119286*fR[29]+42.42640687119286*fL[29])*amax+21.21320343559643*alphaL[0]*fAvg[15]+21.21320343559643*alphaL[1]*fAvg[9]); 
  Ghat[16] = 0.008333333333333333*((73.48469228349536*(fR[42]+fL[42])-42.42640687119286*fR[30]+42.42640687119286*fL[30])*amax+21.21320343559643*alphaL[1]*fAvg[19]+21.21320343559643*alphaL[0]*fAvg[16]); 
  Ghat[17] = 0.025*((24.49489742783179*(fR[45]+fL[45])-14.14213562373095*fR[38]+14.14213562373095*fL[38])*amax+7.071067811865476*alphaL[0]*fAvg[17]+6.324555320336761*alphaL[1]*fAvg[10]); 
  Ghat[18] = 0.008333333333333333*((73.48469228349536*(fR[46]+fL[46])-42.42640687119286*fR[40]+42.42640687119286*fL[40])*amax+21.21320343559643*alphaL[0]*fAvg[18]+21.21320343559643*alphaL[1]*fAvg[14]); 
  Ghat[19] = 0.008333333333333333*((73.48469228349536*(fR[47]+fL[47])-42.42640687119286*fR[43]+42.42640687119286*fL[43])*amax+21.21320343559643*alphaL[0]*fAvg[19]+21.21320343559643*alphaL[1]*fAvg[16]); 
...
double GyrokineticGenGeoSurf2x2vSer_yL_P2_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *fL, const double *fR, double *outL, double *outR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
  ...
  double alphaL[20]; 
  alphaL[0] = (0.1767766952966368*b_z[0]*jacobTotInv[0]*(3.872983346207417*hamilL[20]+3.0*hamilL[5]+1.732050807568877*hamilL[1])*rdx2L)/q_; 
  alphaL[1] = (0.1767766952966368*b_z[0]*jacobTotInv[0]*(6.708203932499369*hamilL[19]+3.872983346207417*hamilL[11])*rdx2L)/q_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgL = (0.03125*(3.872983346207417*b_z[0]*jacobTotInv[0]*hamilL[20]+3.0*b_z[0]*jacobTotInv[0]*hamilL[5]+1.732050807568877*b_z[0]*jacobTotInv[0]*hamilL[1])*rdx2L)/q_; 
  ...
  double Ghat[20]; 
  Ghat[0] = -0.125*((6.324555320336761*fR[12]-6.324555320336761*fL[12]-4.898979485566357*(fR[2]+fL[2])+2.828427124746191*fR[0]-2.828427124746191*fL[0])*amax-1.414213562373095*(alphaL[1]*fAvg[1]+alphaL[0]*fAvg[0])); 
  Ghat[1] = -0.008333333333333333*((94.8683298050514*fR[20]-94.8683298050514*fL[20]-73.48469228349535*(fR[5]+fL[5])+42.42640687119286*fR[1]-42.42640687119286*fL[1])*amax-18.97366596101028*alphaL[1]*fAvg[7]-21.21320343559643*(alphaL[0]*fAvg[1]+fAvg[0]*alphaL[1])); 
  Ghat[2] = -0.04166666666666666*((18.97366596101028*fR[22]-18.97366596101028*fL[22]-14.69693845669907*(fR[7]+fL[7])+8.485281374238571*fR[3]-8.485281374238571*fL[3])*amax-4.242640687119286*(alphaL[1]*fAvg[4]+alphaL[0]*fAvg[2])); 
  Ghat[3] = -0.04166666666666666*((18.97366596101028*fR[26]-18.97366596101028*fL[26]-14.69693845669907*(fR[9]+fL[9])+8.485281374238571*fR[4]-8.485281374238571*fL[4])*amax-4.242640687119286*(alphaL[1]*fAvg[5]+alphaL[0]*fAvg[3])); 
  Ghat[4] = -0.008333333333333333*((94.86832980505142*fR[33]-94.86832980505142*fL[33]-73.48469228349535*(fR[15]+fL[15])+42.42640687119286*fR[6]-42.42640687119286*fL[6])*amax-18.97366596101028*alphaL[1]*fAvg[11]-21.21320343559643*(alphaL[0]*fAvg[4]+alphaL[1]*fAvg[2])); 
  Ghat[5] = -0.008333333333333333*((94.86832980505142*fR[36]-94.86832980505142*fL[36]-73.48469228349535*(fR[16]+fL[16])+42.42640687119286*fR[8]-42.42640687119286*fL[8])*amax-18.97366596101028*alphaL[1]*fAvg[13]-21.21320343559643*(alphaL[0]*fAvg[5]+alphaL[1]*fAvg[3])); 
  Ghat[6] = -0.125*((6.324555320336761*fR[38]-6.324555320336761*fL[38]-4.898979485566357*(fR[18]+fL[18])+2.828427124746191*fR[10]-2.828427124746191*fL[10])*amax-1.414213562373095*(alphaL[1]*fAvg[10]+alphaL[0]*fAvg[6])); 
  Ghat[7] = 0.025*((24.49489742783179*(fR[19]+fL[19])-14.14213562373095*fR[11]+14.14213562373095*fL[11])*amax+7.071067811865476*alphaL[0]*fAvg[7]+6.324555320336761*alphaL[1]*fAvg[1]); 
  Ghat[8] = 0.008333333333333333*((73.48469228349536*(fR[24]+fL[24])-42.42640687119286*fR[13]+42.42640687119286*fL[13])*amax+21.21320343559643*alphaL[1]*fAvg[12]+21.21320343559643*alphaL[0]*fAvg[8]); 
  Ghat[9] = 0.008333333333333333*((73.48469228349536*(fR[29]+fL[29])-42.42640687119286*fR[14]+42.42640687119286*fL[14])*amax+21.21320343559643*alphaL[1]*fAvg[15]+21.21320343559643*alphaL[0]*fAvg[9]); 
  Ghat[10] = -0.008333333333333333*((94.8683298050514*fR[45]-94.8683298050514*fL[45]-73.48469228349535*(fR[31]+fL[31])+42.42640687119286*fR[17]-42.42640687119286*fL[17])*amax-18.97366596101028*alphaL[1]*fAvg[17]-21.21320343559643*(alphaL[0]*fAvg[10]+alphaL[1]*fAvg[6])); 
  Ghat[11] = 0.008333333333333333*((73.48469228349536*(fR[32]+fL[32])-42.42640687119286*fR[21]+42.42640687119286*fL[21])*amax+21.21320343559643*alphaL[0]*fAvg[11]+18.97366596101028*alphaL[1]*fAvg[4]); 
  Ghat[12] = 0.008333333333333333*((73.48469228349536*(fR[34]+fL[34])-42.42640687119286*fR[23]+42.42640687119286*fL[23])*amax+21.21320343559643*alphaL[0]*fAvg[12]+21.21320343559643*alphaL[1]*fAvg[8]); 
  Ghat[13] = 0.008333333333333333*((73.48469228349536*(fR[35]+fL[35])-42.42640687119286*fR[25]+42.42640687119286*fL[25])*amax+21.21320343559643*alphaL[0]*fAvg[13]+18.97366596101028*alphaL[1]*fAvg[5]); 
  Ghat[14] = 0.008333333333333333*((73.48469228349536*(fR[40]+fL[40])-42.42640687119286*fR[27]+42.42640687119286*fL[27])*amax+21.21320343559643*alphaL[1]*fAvg[18]+21.21320343559643*alphaL[0]*fAvg[14]); 
  Ghat[15] = 0.008333333333333333*((73.48469228349536*(fR[41]+fL[41])-42.42640687119286*fR[28]+42.42640687119286*fL[28])*amax+21.21320343559643*alphaL[0]*fAvg[15]+21.21320343559643*alphaL[1]*fAvg[9]); 
  Ghat[16] = 0.008333333333333333*((73.48469228349536*(fR[43]+fL[43])-42.42640687119286*fR[30]+42.42640687119286*fL[30])*amax+21.21320343559643*alphaL[1]*fAvg[19]+21.21320343559643*alphaL[0]*fAvg[16]); 
  Ghat[17] = 0.025*((24.49489742783179*(fR[44]+fL[44])-14.14213562373095*fR[37]+14.14213562373095*fL[37])*amax+7.071067811865476*alphaL[0]*fAvg[17]+6.324555320336761*alphaL[1]*fAvg[10]); 
  Ghat[18] = 0.008333333333333333*((73.48469228349536*(fR[46]+fL[46])-42.42640687119286*fR[39]+42.42640687119286*fL[39])*amax+21.21320343559643*alphaL[0]*fAvg[18]+21.21320343559643*alphaL[1]*fAvg[14]); 
  Ghat[19] = 0.008333333333333333*((73.48469228349536*(fR[47]+fL[47])-42.42640687119286*fR[42]+42.42640687119286*fL[42])*amax+21.21320343559643*alphaL[0]*fAvg[19]+21.21320343559643*alphaL[1]*fAvg[16]); 
...
double GyrokineticGenGeoSurf2x2vSer_yR_P2_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *fL, const double *fR, double *outL, double *outR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
...
{ 
  ...
  double alphaL[20]; 
  alphaL[0] = -(0.125*(((27.38612787525831*b_z[4]+21.21320343559643*b_z[1]+12.24744871391589*b_z[0])*jacobTotInv[4]+(21.21320343559643*jacobTotInv[1]+12.24744871391589*jacobTotInv[0])*b_z[4]+(16.43167672515499*b_z[1]+9.48683298050514*b_z[0])*jacobTotInv[1]+jacobTotInv[0]*(9.48683298050514*b_z[1]+5.477225575051662*b_z[0]))*hamilL[19]+((21.21320343559643*b_z[4]+16.43167672515498*b_z[1]+9.48683298050514*b_z[0])*jacobTotInv[4]+(16.43167672515498*jacobTotInv[1]+9.48683298050514*jacobTotInv[0])*b_z[4]+(12.72792206135786*b_z[1]+7.348469228349534*b_z[0])*jacobTotInv[1]+jacobTotInv[0]*(7.348469228349534*b_z[1]+4.242640687119286*b_z[0]))*hamilL[5]+hamilL[2]*((12.24744871391589*b_z[4]+9.48683298050514*b_z[1]+5.477225575051662*b_z[0])*jacobTotInv[4]+(9.48683298050514*jacobTotInv[1]+5.477225575051662*jacobTotInv[0])*b_z[4]+(7.348469228349534*b_z[1]+4.242640687119286*b_z[0])*jacobTotInv[1]+jacobTotInv[0]*(4.242640687119286*b_z[1]+2.449489742783178*b_z[0])))*rdy2L)/q_; 
  alphaL[1] = -(0.125*(((47.43416490252569*b_z[4]+36.74234614174768*b_z[1]+21.21320343559643*b_z[0])*jacobTotInv[4]+(36.74234614174768*jacobTotInv[1]+21.21320343559643*jacobTotInv[0])*b_z[4]+(28.46049894151541*b_z[1]+16.43167672515499*b_z[0])*jacobTotInv[1]+jacobTotInv[0]*(16.43167672515499*b_z[1]+9.48683298050514*b_z[0]))*hamilL[20]+((27.38612787525831*b_z[4]+21.21320343559643*b_z[1]+12.24744871391589*b_z[0])*jacobTotInv[4]+(21.21320343559643*jacobTotInv[1]+12.24744871391589*jacobTotInv[0])*b_z[4]+(16.43167672515498*b_z[1]+9.48683298050514*b_z[0])*jacobTotInv[1]+jacobTotInv[0]*(9.48683298050514*b_z[1]+5.477225575051662*b_z[0]))*hamilL[12])*rdy2L)/q_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgL = -(0.03125*(((19.36491673103708*b_z[4]+15.0*b_z[1]+8.660254037844387*b_z[0])*jacobTotInv[4]+(15.0*jacobTotInv[1]+8.660254037844387*jacobTotInv[0])*b_z[4]+(11.61895003862225*b_z[1]+6.708203932499369*b_z[0])*jacobTotInv[1]+6.708203932499369*jacobTotInv[0]*b_z[1]+3.872983346207417*b_z[0]*jacobTotInv[0])*hamilL[19]+((15.0*b_z[4]+11.61895003862225*b_z[1]+6.708203932499369*b_z[0])*jacobTotInv[4]+(11.61895003862225*jacobTotInv[1]+6.708203932499369*jacobTotInv[0])*b_z[4]+(9.0*b_z[1]+5.196152422706631*b_z[0])*jacobTotInv[1]+5.196152422706631*jacobTotInv[0]*b_z[1]+3.0*b_z[0]*jacobTotInv[0])*hamilL[5]+(8.660254037844386*hamilL[2]*b_z[4]+(6.708203932499369*b_z[1]+3.872983346207417*b_z[0])*hamilL[2])*jacobTotInv[4]+(6.708203932499369*jacobTotInv[1]+3.872983346207417*jacobTotInv[0])*hamilL[2]*b_z[4]+((5.196152422706631*b_z[1]+3.0*b_z[0])*jacobTotInv[1]+3.0*jacobTotInv[0]*b_z[1]+1.732050807568877*b_z[0]*jacobTotInv[0])*hamilL[2])*rdy2L)/q_; 
...
double GyrokineticGenGeoSurf2x2vSer_xR_P2_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *fL, const double *fR, double *outL, double *outR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
...
double GyrokineticGenGeoSurf2x2vSer_yL_P2_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *fL, const double *fR, double *outL, double *outR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
  ...
  double BstarYdBmagL[48]; 
  BstarYdBmagL[0] = -(1.732050807568877*(2.23606797749979*jacobTotInv[1]*b_z[4]+jacobTotInv[0]*b_z[1])*m_*rdx2L*wvparL)/q_; 
  BstarYdBmagL[1] = -(1.732050807568877*(b_z[4]*(2.0*jacobTotInv[4]+2.23606797749979*jacobTotInv[0])+b_z[1]*jacobTotInv[1])*m_*rdx2L*wvparL)/q_; 
  ...
  alphaL[7] = (0.005050762722761052*((((86.60254037844389*b_z[4]+135.5544171172596*b_z[0])*jacobTotInv[4]+135.5544171172596*jacobTotInv[0]*b_z[4]+121.2435565298214*b_z[1]*jacobTotInv[1])*hamilL[20]+(368.9512162874653*(b_z[1]*jacobTotInv[4]+jacobTotInv[1]*b_z[4])+210.0*(b_z[0]*jacobTotInv[1]+jacobTotInv[0]*b_z[1]))*hamilL[19]+(213.014084041408*(b_z[1]*jacobTotInv[4]+jacobTotInv[1]*b_z[4])+121.2435565298214*(b_z[0]*jacobTotInv[1]+jacobTotInv[0]*b_z[1]))*hamilL[11]+((67.0820393249937*b_z[4]+105.0*b_z[0])*jacobTotInv[4]+105.0*jacobTotInv[0]*b_z[4]+93.91485505499116*b_z[1]*jacobTotInv[1])*hamilL[5]+hamilL[1]*((38.72983346207418*b_z[4]+60.6217782649107*b_z[0])*jacobTotInv[4]+60.6217782649107*jacobTotInv[0]*b_z[4]+54.22176684690384*b_z[1]*jacobTotInv[1]))*m_*rdx2L+(135.5544171172596*hamilL[13]*BstarYdBmagL[21]+60.6217782649107*hamilL[3]*BstarYdBmagL[11])*q_*rdvpar2L))/(m_*q_); 
...
double GyrokineticGenGeoSurf2x2vSer_yR_P2_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *fL, const double *fR, double *outL, double *outR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
