...
double limQuad[8];
  ...
  fupwind[6] = 0.3535533905932737*(fupwindQuad[7]+fupwindQuad[6]-1.0*(fupwindQuad[5]+fupwindQuad[4]+fupwindQuad[3]+fupwindQuad[2])+fupwindQuad[1]+fupwindQuad[0]); 
  fupwind[7] = 0.3535533905932737*(fupwindQuad[7]-1.0*(fupwindQuad[6]+fupwindQuad[5])+fupwindQuad[4]-1.0*fupwindQuad[3]+fupwindQuad[2]+fupwindQuad[1]-1.0*fupwindQuad[0]); 
  incr[0] = -0.25*(alpha[1]*(1.732050807568877*fupwind[4]-1.0*fupwind[2])+alpha[0]*(1.732050807568877*fupwind[1]-1.0*fupwind[0]))*dfac_x; 
  incr[1] = 0.25*(alpha[1]*(3.0*fupwind[4]-1.732050807568877*fupwind[2])+alpha[0]*(3.0*fupwind[1]-1.732050807568877*fupwind[0]))*dfac_x; 
  incr[2] = -0.25*(alpha[0]*(1.732050807568877*fupwind[4]-1.0*fupwind[2])+alpha[1]*(1.732050807568877*fupwind[1]-1.0*fupwind[0]))*dfac_x; 
  incr[3] = -0.25*(alpha[1]*(1.732050807568877*fupwind[7]-1.0*fupwind[6])+alpha[0]*(1.732050807568877*fupwind[5]-1.0*fupwind[3]))*dfac_x; 
  incr[4] = 0.25*(alpha[0]*(3.0*fupwind[4]-1.732050807568877*fupwind[2])+alpha[1]*(3.0*fupwind[1]-1.732050807568877*fupwind[0]))*dfac_x; 
  incr[5] = 0.25*(alpha[1]*(3.0*fupwind[7]-1.732050807568877*fupwind[6])+alpha[0]*(3.0*fupwind[5]-1.732050807568877*fupwind[3]))*dfac_x; 
  incr[6] = -0.25*(alpha[0]*(1.732050807568877*fupwind[7]-1.0*fupwind[6])+alpha[1]*(1.732050807568877*fupwind[5]-1.0*fupwind[3]))*dfac_x; 
  incr[7] = 0.25*(alpha[0]*(3.0*fupwind[7]-1.732050807568877*fupwind[6])+alpha[1]*(3.0*fupwind[5]-1.732050807568877*fupwind[3]))*dfac_x; 
