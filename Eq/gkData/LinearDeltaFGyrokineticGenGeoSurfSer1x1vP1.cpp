...
double LinearDeltaFGyrokineticGenGeoSurf1x1vSer_vpar_P1_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
...
double LinearDeltaFGyrokineticGenGeoSurf1x1vSer_x_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
  ...
  // linear term alpha0*f1 
  double fUpOrd[2];
  if (0.7071067811865475*alpha0R[0]-0.7071067811865475*alpha0R[1] > 0) { 
    fUpOrd[0] = (-0.8660254037844386*f1L[3])-0.5*f1L[2]+0.8660254037844386*f1L[1]+0.5*f1L[0]; 
  } else { 
    fUpOrd[0] = 0.8660254037844386*f1R[3]-0.5*f1R[2]-0.8660254037844386*f1R[1]+0.5*f1R[0]; 
  } 
  if (0.7071067811865475*(alpha0R[1]+alpha0R[0]) > 0) { 
    fUpOrd[1] = 0.8660254037844386*f1L[3]+0.5*f1L[2]+0.8660254037844386*f1L[1]+0.5*f1L[0]; 
  } else { 
    fUpOrd[1] = (-0.8660254037844386*f1R[3])+0.5*f1R[2]-0.8660254037844386*f1R[1]+0.5*f1R[0]; 
  } 
...
double LinearDeltaFGyrokineticGenGeoSurf1x1vSer_vpar_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
  ...
  // linear term alpha1*f0 
  double fUpOrd[2];
  if (0.7071067811865475*alpha1R[0]-0.7071067811865475*alpha1R[1] > 0) { 
    fUpOrd[0] = (-0.8660254037844386*f0L[3])+0.8660254037844386*f0L[2]-0.5*f0L[1]+0.5*f0L[0]; 
  } else { 
    fUpOrd[0] = 0.8660254037844386*f0R[3]-0.8660254037844386*f0R[2]-0.5*f0R[1]+0.5*f0R[0]; 
  } 
  if (0.7071067811865475*(alpha1R[1]+alpha1R[0]) > 0) { 
    fUpOrd[1] = 0.8660254037844386*(f0L[3]+f0L[2])+0.5*(f0L[1]+f0L[0]); 
  } else { 
    fUpOrd[1] = 0.5*(f0R[1]+f0R[0])-0.8660254037844386*(f0R[3]+f0R[2]); 
  } 
