...
{ 
  ...
  // linear term alpha0*f1 
  double fUpOrd[4];
  if (0.5*alpha0R[3]-0.5*(alpha0R[2]+alpha0R[1])+0.5*alpha0R[0] > 0) { 
  ...
  if (0.5*(alpha0R[1]+alpha0R[0])-0.5*(alpha0R[3]+alpha0R[2]) > 0) { 
  ...
  if ((-0.5*alpha0R[3])+0.5*alpha0R[2]-0.5*alpha0R[1]+0.5*alpha0R[0] > 0) { 
  ...
  if (0.5*(alpha0R[3]+alpha0R[2]+alpha0R[1]+alpha0R[0]) > 0) { 
