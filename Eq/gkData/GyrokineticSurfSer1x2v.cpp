...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  rVal[0] = (3.0*fl[7]-5.196152422706631*(fl[5]+fl[4])+9.0*fl[1])/(1.732050807568877*fl[6]-3.0*(fl[3]+fl[2])+5.196152422706631*fl[0]); 
  rVal[1] = (3.0*fl[7]-5.196152422706631*(fl[5]+fl[4])+9.0*fl[1])/(1.732050807568877*fl[6]-3.0*(fl[3]+fl[2])+5.196152422706631*fl[0]); 
  rVal[2] = (3.0*fl[7]+5.196152422706631*fl[5]-1.0*(5.196152422706631*fl[4]+9.0*fl[1]))/(1.732050807568877*fl[6]+3.0*fl[3]-1.0*(3.0*fl[2]+5.196152422706631*fl[0])); 
  rVal[3] = (3.0*fl[7]+5.196152422706631*fl[5]-1.0*(5.196152422706631*fl[4]+9.0*fl[1]))/(1.732050807568877*fl[6]+3.0*fl[3]-1.0*(3.0*fl[2]+5.196152422706631*fl[0])); 
  rVal[4] = (3.0*fl[7]+5.196152422706631*(fl[4]-1.0*fl[5])-9.0*fl[1])/(1.732050807568877*fl[6]+3.0*(fl[2]-1.0*fl[3])-5.196152422706631*fl[0]); 
  rVal[5] = (3.0*fl[7]+5.196152422706631*(fl[4]-1.0*fl[5])-9.0*fl[1])/(1.732050807568877*fl[6]+3.0*(fl[2]-1.0*fl[3])-5.196152422706631*fl[0]); 
  rVal[6] = (3.0*fl[7]+5.196152422706631*(fl[5]+fl[4])+9.0*fl[1])/(1.732050807568877*fl[6]+3.0*(fl[3]+fl[2])+5.196152422706631*fl[0]); 
  rVal[7] = (3.0*fl[7]+5.196152422706631*(fl[5]+fl[4])+9.0*fl[1])/(1.732050807568877*fl[6]+3.0*(fl[3]+fl[2])+5.196152422706631*fl[0]); 
  ...
  double rVal[8];  // rVal=f1/f0 at each node 
  rVal[0] = (3.0*fr[7]-5.196152422706631*(fr[5]+fr[4])+9.0*fr[1])/(1.732050807568877*fr[6]-3.0*(fr[3]+fr[2])+5.196152422706631*fr[0]); 
  rVal[1] = (3.0*fr[7]-5.196152422706631*(fr[5]+fr[4])+9.0*fr[1])/(1.732050807568877*fr[6]-3.0*(fr[3]+fr[2])+5.196152422706631*fr[0]); 
  rVal[2] = (3.0*fr[7]+5.196152422706631*fr[5]-1.0*(5.196152422706631*fr[4]+9.0*fr[1]))/(1.732050807568877*fr[6]+3.0*fr[3]-1.0*(3.0*fr[2]+5.196152422706631*fr[0])); 
  rVal[3] = (3.0*fr[7]+5.196152422706631*fr[5]-1.0*(5.196152422706631*fr[4]+9.0*fr[1]))/(1.732050807568877*fr[6]+3.0*fr[3]-1.0*(3.0*fr[2]+5.196152422706631*fr[0])); 
  rVal[4] = (3.0*fr[7]+5.196152422706631*(fr[4]-1.0*fr[5])-9.0*fr[1])/(1.732050807568877*fr[6]+3.0*(fr[2]-1.0*fr[3])-5.196152422706631*fr[0]); 
  rVal[5] = (3.0*fr[7]+5.196152422706631*(fr[4]-1.0*fr[5])-9.0*fr[1])/(1.732050807568877*fr[6]+3.0*(fr[2]-1.0*fr[3])-5.196152422706631*fr[0]); 
  rVal[6] = (3.0*fr[7]+5.196152422706631*(fr[5]+fr[4])+9.0*fr[1])/(1.732050807568877*fr[6]+3.0*(fr[3]+fr[2])+5.196152422706631*fr[0]); 
  rVal[7] = (3.0*fr[7]+5.196152422706631*(fr[5]+fr[4])+9.0*fr[1])/(1.732050807568877*fr[6]+3.0*(fr[3]+fr[2])+5.196152422706631*fr[0]); 
  double fqVal[8];  // fqVal = anti-limited f evaluated at each node 
  double cflVal = std::abs((alpha0*dt)/dxv[0]); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  if (alpha0>0) { 
  double rVal[8];  // rVal=f1/f0 at each node 
  rVal[0] = (3.0*fl[7]-5.196152422706631*(fl[6]+fl[4])+9.0*fl[2])/(1.732050807568877*fl[5]-3.0*(fl[3]+fl[1])+5.196152422706631*fl[0]); 
  rVal[1] = (3.0*fl[7]+5.196152422706631*fl[6]-1.0*(5.196152422706631*fl[4]+9.0*fl[2]))/(1.732050807568877*fl[5]+3.0*fl[3]-1.0*(3.0*fl[1]+5.196152422706631*fl[0])); 
  rVal[2] = (3.0*fl[7]-5.196152422706631*(fl[6]+fl[4])+9.0*fl[2])/(1.732050807568877*fl[5]-3.0*(fl[3]+fl[1])+5.196152422706631*fl[0]); 
  rVal[3] = (3.0*fl[7]+5.196152422706631*fl[6]-1.0*(5.196152422706631*fl[4]+9.0*fl[2]))/(1.732050807568877*fl[5]+3.0*fl[3]-1.0*(3.0*fl[1]+5.196152422706631*fl[0])); 
  rVal[4] = (3.0*fl[7]+5.196152422706631*(fl[4]-1.0*fl[6])-9.0*fl[2])/(1.732050807568877*fl[5]+3.0*(fl[1]-1.0*fl[3])-5.196152422706631*fl[0]); 
  rVal[5] = (3.0*fl[7]+5.196152422706631*(fl[6]+fl[4])+9.0*fl[2])/(1.732050807568877*fl[5]+3.0*(fl[3]+fl[1])+5.196152422706631*fl[0]); 
  rVal[6] = (3.0*fl[7]+5.196152422706631*(fl[4]-1.0*fl[6])-9.0*fl[2])/(1.732050807568877*fl[5]+3.0*(fl[1]-1.0*fl[3])-5.196152422706631*fl[0]); 
  rVal[7] = (3.0*fl[7]+5.196152422706631*(fl[6]+fl[4])+9.0*fl[2])/(1.732050807568877*fl[5]+3.0*(fl[3]+fl[1])+5.196152422706631*fl[0]); 
  double fqVal[8];  // fqVal = anti-limited f evaluated at each node 
  ...
  double rVal[8];  // rVal=f1/f0 at each node 
  rVal[0] = (3.0*fr[7]-5.196152422706631*(fr[6]+fr[4])+9.0*fr[2])/(1.732050807568877*fr[5]-3.0*(fr[3]+fr[1])+5.196152422706631*fr[0]); 
  rVal[1] = (3.0*fr[7]+5.196152422706631*fr[6]-1.0*(5.196152422706631*fr[4]+9.0*fr[2]))/(1.732050807568877*fr[5]+3.0*fr[3]-1.0*(3.0*fr[1]+5.196152422706631*fr[0])); 
  rVal[2] = (3.0*fr[7]-5.196152422706631*(fr[6]+fr[4])+9.0*fr[2])/(1.732050807568877*fr[5]-3.0*(fr[3]+fr[1])+5.196152422706631*fr[0]); 
  rVal[3] = (3.0*fr[7]+5.196152422706631*fr[6]-1.0*(5.196152422706631*fr[4]+9.0*fr[2]))/(1.732050807568877*fr[5]+3.0*fr[3]-1.0*(3.0*fr[1]+5.196152422706631*fr[0])); 
  rVal[4] = (3.0*fr[7]+5.196152422706631*(fr[4]-1.0*fr[6])-9.0*fr[2])/(1.732050807568877*fr[5]+3.0*(fr[1]-1.0*fr[3])-5.196152422706631*fr[0]); 
  rVal[5] = (3.0*fr[7]+5.196152422706631*(fr[6]+fr[4])+9.0*fr[2])/(1.732050807568877*fr[5]+3.0*(fr[3]+fr[1])+5.196152422706631*fr[0]); 
  rVal[6] = (3.0*fr[7]+5.196152422706631*(fr[4]-1.0*fr[6])-9.0*fr[2])/(1.732050807568877*fr[5]+3.0*(fr[1]-1.0*fr[3])-5.196152422706631*fr[0]); 
  rVal[7] = (3.0*fr[7]+5.196152422706631*(fr[6]+fr[4])+9.0*fr[2])/(1.732050807568877*fr[5]+3.0*(fr[3]+fr[1])+5.196152422706631*fr[0]); 
  double fqVal[8];  // fqVal = anti-limited f evaluated at each node 
  double cflVal = std::abs((alpha0*dt)/dxv[1]); 
