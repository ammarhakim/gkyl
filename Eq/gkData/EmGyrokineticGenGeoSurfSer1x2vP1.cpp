...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  BstarZ_by_BmagL[0] = 1.414213562373095*Gradpar[0]*jacobTotInv[0]; 

  // surface-averaged phase velocity in this direction 
  double alpha0 = (0.05412658773652741*(BstarZ_by_BmagL[0]+BstarZ_by_Bmag[0])*hamil[2]*dfac_v)/m_; 

  double alpha[4]; 
  alpha[0] = (0.2165063509461096*(BstarZ_by_BmagL[0]+BstarZ_by_Bmag[0])*hamil[2]*dfac_v)/m_; 
...
double EmGyrokineticGenGeoSurf1x2vSer_Vpar_P1_Bvars_0(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_z = 2.0/dxv[0]; 
  double dfac_v = 2.0/dxv[1]; 
  ...
  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.0625*(5.656854249492382*dApardtPrev[0]*q_+1.732050807568877*BstarZ_by_Bmag[0]*hamil[1]*dfac_z))/m_; 

  double alpha[4]; 
  alpha[0] = -(0.4330127018922193*BstarZ_by_Bmag[0]*hamil[1]*dfac_z)/m_; 
  double alphaUp[4]; 
  alphaUp[0] = -(0.25*(5.656854249492382*dApardtPrev[0]*q_+1.732050807568877*BstarZ_by_Bmag[0]*hamil[1]*dfac_z))/m_; 
...
double EmGyrokineticGenGeoSurf1x2vSerStep2_Vpar_P1_Bvars_0(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_z = 2.0/dxv[0]; 
  double dfac_v = 2.0/dxv[1]; 
...
double EmGyrokineticGenGeoSurf1x2vSer_X_P1_Bvars_1(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_z = 2.0/dxv[0]; 
  double dfac_v = 2.0/dxv[1]; 
  ...
  double BstarZ_by_BmagL[8]; 
  BstarZ_by_BmagL[0] = 1.414213562373095*(Gradpar[1]*jacobTotInv[1]+Gradpar[0]*jacobTotInv[0]); 
  BstarZ_by_BmagL[1] = 1.414213562373095*(Gradpar[0]*jacobTotInv[1]+jacobTotInv[0]*Gradpar[1]); 

  // surface-averaged phase velocity in this direction 
  double alpha0 = -(0.03125*(3.0*(BstarZ_by_BmagL[1]+BstarZ_by_Bmag[1])-1.732050807568877*(BstarZ_by_BmagL[0]+BstarZ_by_Bmag[0]))*hamil[2]*dfac_v)/m_; 

  double alpha[4]; 
  alpha[0] = -(0.125*(3.0*(BstarZ_by_BmagL[1]+BstarZ_by_Bmag[1])-1.732050807568877*(BstarZ_by_BmagL[0]+BstarZ_by_Bmag[0]))*hamil[2]*dfac_v)/m_; 
#if upwindType == SURFAVG 
  if (alpha0>0) { 
  incr[0] = 0.25*alpha[0]*(1.732050807568877*fl[1]+fl[0])*dfac_z; 
  incr[1] = -0.25*alpha[0]*(3.0*fl[1]+1.732050807568877*fl[0])*dfac_z; 
...
double EmGyrokineticGenGeoSurf1x2vSer_Vpar_P1_Bvars_1(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_z = 2.0/dxv[0]; 
  double dfac_v = 2.0/dxv[1]; 
  ...
  double alphaUp[4]; 
  alphaUp[0] = -(0.25*(5.656854249492382*dApardtPrev[0]*q_+1.732050807568877*BstarZ_by_Bmag[0]*hamil[1]*dfac_z))/m_; 
  alphaUp[1] = -(0.25*(5.656854249492382*dApardtPrev[1]*q_+1.732050807568877*BstarZ_by_Bmag[1]*hamil[1]*dfac_z))/m_; 
  alphaUp[2] = -(0.4330127018922193*BstarZ_by_Bmag[0]*hamil[5]*dfac_z)/m_; 
  alphaUp[3] = -(0.4330127018922193*BstarZ_by_Bmag[1]*hamil[5]*dfac_z)/m_; 
#if upwindType == SURFAVG 
  if (alpha0>0) { 
...
double EmGyrokineticGenGeoSurf1x2vSerStep2_Vpar_P1_Bvars_1(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *jacobTotInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_z = 2.0/dxv[0]; 
  double dfac_v = 2.0/dxv[1]; 
