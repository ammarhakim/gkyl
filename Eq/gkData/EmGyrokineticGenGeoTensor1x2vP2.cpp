...
double EmGyrokineticGenGeoVol1x2vTensorP2_Bvars(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double* dApardt, const double *f, double *out) 
{ 
  ...
  out[19] += 0.07071067811865474*(7.745966692414834*(alphax[4]*f[25]+alphax[2]*f[22]+alphavpar[1]*f[21])+8.660254037844386*alphax[1]*f[19]+8.660254037844387*alphax[0]*f[16]+(7.745966692414834*alphavpar[7]+8.660254037844387*(alphax[4]+alphavpar[0]))*f[15]+8.660254037844386*(alphax[2]+alphavpar[1])*f[9]); 
  out[20] += 0.01010152544552211*(121.2435565298214*alphax[1]*f[20]+135.5544171172596*alphax[0]*f[12]+(86.60254037844389*alphavpar[7]+108.4435336938077*alphax[4]+135.5544171172596*alphavpar[0])*f[11]+135.5544171172596*(alphax[1]*f[8]+f[2]*alphavpar[7])+121.2435565298214*((alphax[2]+alphavpar[1])*f[4]+f[2]*alphax[4])); 
  out[21] += 0.3535533905932737*(3.464101615137754*(alphax[4]*f[24]+alphax[1]*f[21])+3.872983346207417*(alphax[2]*f[19]+alphax[4]*f[16]+alphax[0]*f[15]+alphax[1]*f[9])); 
  out[22] += 1.369306393762915*(alphavpar[7]*f[24]+alphavpar[1]*f[19]+alphavpar[0]*f[16]); 
  out[23] += 0.01010152544552211*(121.2435565298214*alphax[1]*f[23]+135.5544171172596*alphax[0]*f[18]+(86.60254037844386*alphavpar[7]+108.4435336938077*alphax[4]+135.5544171172596*alphavpar[0])*f[17]+135.5544171172596*alphax[1]*f[14]+121.2435565298214*(alphax[2]+alphavpar[1])*f[10]+f[6]*(135.5544171172596*alphavpar[7]+121.2435565298214*alphax[4])); 
  out[24] += 0.01010152544552211*(108.4435336938077*alphax[4]*f[26]+121.2435565298214*(alphax[2]*f[25]+alphax[1]*f[24]+alphax[4]*f[22])+(38.72983346207418*alphavpar[7]+121.2435565298214*alphax[4]+60.6217782649107*alphavpar[0])*f[21]+135.5544171172596*alphax[0]*f[19]+135.5544171172596*alphax[1]*f[16]+(135.5544171172596*alphax[2]+54.22176684690384*alphavpar[1])*f[15]+(60.6217782649107*alphavpar[7]+135.5544171172596*alphax[4])*f[9]); 
  out[25] += 0.07071067811865474*(8.660254037844386*alphax[1]*f[25]+17.32050807568877*alphavpar[1]*f[24]+8.660254037844386*alphax[0]*f[22]+(17.32050807568877*alphavpar[7]+7.745966692414834*alphax[4]+19.36491673103709*alphavpar[0])*f[19]+(7.745966692414834*alphax[2]+19.36491673103708*alphavpar[1])*f[16]); 
  out[26] += 0.01010152544552211*(121.2435565298214*alphax[1]*f[26]+135.5544171172596*alphax[0]*f[25]+(86.60254037844386*alphavpar[7]+108.4435336938077*alphax[4])*f[24]+135.5544171172596*(alphavpar[0]*f[24]+alphax[1]*f[22])+121.2435565298214*(alphax[2]+alphavpar[1])*f[19]+(135.5544171172596*alphavpar[7]+121.2435565298214*alphax[4])*f[16]); 
  return cflFreq; 
} 
double EmGyrokineticGenGeoVol1x2vTensorP2_Bvarsx(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double* dApardt, const double *f, double *out) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
...
double EmGyrokineticGenGeoVol1x2vTensorP2_Bvarsz(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double* dApardt, const double *f, double *out) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
...
double EmGyrokineticGenGeoVol1x2vTensorP2_Bvarsxz(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double* dApardt, const double *f, double *out) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
...
double EmGyrokineticGenGeoStep2Vol1x2vTensorP2(const double q_, const double m_, const double *w, const double *dxv, const double *dApardt, const double *f, double *out) 
{ 
  // q_,m_: species charge and mass.
  // w[NDIM]: cell-center.
  // dxv[NDIM]: cell length.
