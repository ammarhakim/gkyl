...
{ 
  ...
  out[3] += 0.8660254037844386*(alpha1x[0]*f1[2]+alpha1vpar[0]*f1[1]); 
  return cflFreq; 
} 
...
{ 
  ...
  out[1] += 0.8660254037844386*(alpha1x[1]*f1[1]+alpha1x[0]*f1[0]); 
  out[2] += 0.8660254037844386*(alpha1vpar[3]*f1[3]+alpha1vpar[2]*f1[2]+alpha1vpar[1]*f1[1]+alpha1vpar[0]*f1[0]); 
  out[3] += 0.8660254037844386*((alpha1vpar[2]+alpha1x[1])*f1[3]+f1[2]*(alpha1vpar[3]+alpha1x[0])+alpha1vpar[0]*f1[1]+f1[0]*alpha1vpar[1]); 
  return cflFreq; 
} 
double EmDeltaFGyrokineticGenGeoVol1x1vSerP1_Bvarsz(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double* dApardt, const double *f0, const double *f1, double *out) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
...
double EmDeltaFGyrokineticGenGeoVol1x1vSerP1_Bvarsxz(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double* dApardt, const double *f0, const double *f1, double *out) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // dApardt: time derivative of Apar.
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
