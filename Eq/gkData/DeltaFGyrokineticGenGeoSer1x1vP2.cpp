...
double DeltaFGyrokineticGenGeoVol1x1vSerP2_Bvarsxz(const double q_, const double m_, const double *w, const double *dxv, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *f0, const double *f1, double *out) 
{ 
  ...
  out[2] += 0.8660254037844386*(alpha1vpar[6]*f1[6]+alpha1vpar[4]*f1[4]+alpha1vpar[3]*f1[3]+alpha1vpar[2]*f1[2]+alpha1vpar[1]*f1[1]+alpha1vpar[0]*f1[0]); 
  out[3] += 0.1*(7.745966692414834*(alpha1vpar[3]*f1[6]+f1[3]*alpha1vpar[6]+alpha1vpar[1]*f1[4]+f1[1]*alpha1vpar[4])+8.660254037844386*(alpha1vpar[2]*f1[3]+f1[2]*alpha1vpar[3]+alpha1vpar[0]*f1[1]+f1[0]*alpha1vpar[1])); 
  out[5] += 0.1*(17.32050807568877*alpha1vpar[3]*f1[7]+19.36491673103708*(alpha1vpar[4]*f1[6]+f1[4]*alpha1vpar[6])+17.32050807568877*alpha1vpar[2]*f1[5]+19.36491673103709*(alpha1vpar[1]*f1[3]+f1[1]*alpha1vpar[3]+alpha1vpar[0]*f1[2]+f1[0]*alpha1vpar[2])); 
  out[6] += 0.01428571428571429*(38.72983346207417*alpha1vpar[6]*f1[6]+60.6217782649107*(alpha1vpar[2]*f1[6]+f1[2]*alpha1vpar[6])+38.72983346207417*alpha1vpar[4]*f1[4]+60.62177826491071*(alpha1vpar[0]*f1[4]+f1[0]*alpha1vpar[4])+54.22176684690384*(alpha1vpar[3]*f1[3]+alpha1vpar[1]*f1[1])); 
  out[7] += 0.1*(15.49193338482967*alpha1vpar[6]*f1[7]+17.32050807568877*(alpha1vpar[2]*f1[7]+alpha1vpar[1]*f1[6]+f1[1]*alpha1vpar[6])+17.32050807568877*(alpha1vpar[3]*(f1[5]+f1[4])+f1[3]*alpha1vpar[4])+19.36491673103708*(alpha1vpar[0]*f1[3]+f1[0]*alpha1vpar[3]+alpha1vpar[1]*f1[2]+f1[1]*alpha1vpar[2])); 
  return cflFreq; 
} 
