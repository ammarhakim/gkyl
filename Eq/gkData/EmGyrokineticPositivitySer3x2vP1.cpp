...
{ 
  ...
  out[32] += -(1.369306393762915*(dApardt[7]*f[26]+dApardt[6]*f[19]+dApardt[5]*f[18]+dApardt[4]*f[17]+dApardt[3]*f[11]+dApardt[2]*f[10]+dApardt[1]*f[9]+dApardt[0]*f[4])*dfac_v*q_)/m_; 
  double cflRate = 0.0; 
  double alphaL = 0.0; 
  double alphaR = 0.0; 
#if cflType == SURFAVG 
