...
{ 
  ...
  double alpha0R[4]; 
  alpha0R[0] = (0.2165063509461096*(BstarZdBmagR[0]+BstarZdBmagL[0])*hamil0R[2]*rdvpar2R)/m_; 

  double alpha1R[4]; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgR = (0.03125*(1.732050807568877*BstarZdBmagR[0]+1.732050807568877*BstarZdBmagL[0])*hamil0R[2]*rdvpar2R)/m_; 

  double incr[8]; 
  // linear term alpha0*f1 
  double alphaOrdR;
  double fUpOrd[4];
  alphaOrdR = 0.5*alpha0R[0]; 
...
double EmLinearDeltaFGyrokineticGenGeoSurf1x2vSer_vpar_P1_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmLinearDeltaFGyrokineticGenGeoSurf1x2vSerStep2_vpar_P1_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
...
{ 
  ...
  double alpha0R[4]; 
  alpha0R[0] = -(0.125*(3.0*(BstarZdBmagR[1]+BstarZdBmagL[1])-1.732050807568877*(BstarZdBmagR[0]+BstarZdBmagL[0]))*hamil0R[2]*rdvpar2R)/m_; 
  alpha0R[1] = -(0.125*hamil0R[2]*(3.0*(BstarZdBmagR[4]+BstarZdBmagL[4])-1.732050807568877*(BstarZdBmagR[2]+BstarZdBmagL[2]))*rdvpar2R)/m_; 

  double alpha1R[4]; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgR = -(0.03125*(3.0*BstarZdBmagR[1]+3.0*BstarZdBmagL[1]-1.732050807568877*BstarZdBmagR[0]-1.732050807568877*BstarZdBmagL[0])*hamil0R[2]*rdvpar2R)/m_; 

  double incr[8]; 
  // linear term alpha0*f1 
  double alphaOrdR;
  double fUpOrd[4];
  alphaOrdR = 0.5*alpha0R[0]-0.5*alpha0R[1]; 
  fUpOrd[0] = 0.5*((0.6123724356957944*(f1R[7]+f1L[7])-0.3535533905932737*f1R[6]+0.3535533905932737*f1L[6]-0.6123724356957944*(f1R[5]+f1L[5]+f1R[4]+f1L[4])+0.3535533905932737*(f1R[3]+f1R[2])-0.3535533905932737*(f1L[3]+f1L[2])+0.6123724356957944*(f1R[1]+f1L[1])-0.3535533905932737*f1R[0]+0.3535533905932737*f1L[0])*sgn(alphaOrdR)-0.6123724356957944*f1R[7]+0.6123724356957944*f1L[7]+0.3535533905932737*(f1R[6]+f1L[6])+0.6123724356957944*(f1R[5]+f1R[4])-0.6123724356957944*(f1L[5]+f1L[4])-0.3535533905932737*(f1R[3]+f1L[3]+f1R[2]+f1L[2])-0.6123724356957944*f1R[1]+0.6123724356957944*f1L[1]+0.3535533905932737*(f1R[0]+f1L[0])); 
  alphaOrdR = 0.5*(alpha0R[1]+alpha0R[0]); 
  fUpOrd[1] = 0.5*(((-0.6123724356957944*(f1R[7]+f1L[7]))+0.3535533905932737*f1R[6]-0.3535533905932737*f1L[6]-0.6123724356957944*(f1R[5]+f1L[5])+0.6123724356957944*(f1R[4]+f1L[4])+0.3535533905932737*f1R[3]-0.3535533905932737*(f1L[3]+f1R[2])+0.3535533905932737*f1L[2]+0.6123724356957944*(f1R[1]+f1L[1])-0.3535533905932737*f1R[0]+0.3535533905932737*f1L[0])*sgn(alphaOrdR)+0.6123724356957944*f1R[7]-0.6123724356957944*f1L[7]-0.3535533905932737*(f1R[6]+f1L[6])+0.6123724356957944*f1R[5]-0.6123724356957944*(f1L[5]+f1R[4])+0.6123724356957944*f1L[4]-0.3535533905932737*(f1R[3]+f1L[3])+0.3535533905932737*(f1R[2]+f1L[2])-0.6123724356957944*f1R[1]+0.6123724356957944*f1L[1]+0.3535533905932737*(f1R[0]+f1L[0])); 
  alphaOrdR = 0.5*alpha0R[0]-0.5*alpha0R[1]; 
  fUpOrd[2] = 0.5*(((-0.6123724356957944*(f1R[7]+f1L[7]))+0.3535533905932737*f1R[6]-0.3535533905932737*f1L[6]+0.6123724356957944*(f1R[5]+f1L[5])-0.6123724356957944*(f1R[4]+f1L[4])-0.3535533905932737*f1R[3]+0.3535533905932737*(f1L[3]+f1R[2])-0.3535533905932737*f1L[2]+0.6123724356957944*(f1R[1]+f1L[1])-0.3535533905932737*f1R[0]+0.3535533905932737*f1L[0])*sgn(alphaOrdR)+0.6123724356957944*f1R[7]-0.6123724356957944*f1L[7]-0.3535533905932737*(f1R[6]+f1L[6])-0.6123724356957944*f1R[5]+0.6123724356957944*(f1L[5]+f1R[4])-0.6123724356957944*f1L[4]+0.3535533905932737*(f1R[3]+f1L[3])-0.3535533905932737*(f1R[2]+f1L[2])-0.6123724356957944*f1R[1]+0.6123724356957944*f1L[1]+0.3535533905932737*(f1R[0]+f1L[0])); 
  alphaOrdR = 0.5*(alpha0R[1]+alpha0R[0]); 
...
double EmLinearDeltaFGyrokineticGenGeoSurf1x2vSer_vpar_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
  ...
  double alpha1UpR[4]; 
  alpha1UpR[0] = (0.25*(hamil1R[1]*(3.0*BstarZdBmagR[2]-1.732050807568877*BstarZdBmagR[0])*rdx2R-5.656854249492382*dApardtPrev[0]*q_))/m_; 
  alpha1UpR[1] = (0.25*(hamil1R[1]*(3.0*BstarZdBmagR[4]-1.732050807568877*BstarZdBmagR[1])*rdx2R-5.656854249492382*dApardtPrev[1]*q_))/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgR = (0.0625*(((3.0*hamil1R[1]+3.0*hamil0R[1])*BstarZdBmagR[2]-1.732050807568877*BstarZdBmagR[0]*hamil1R[1]-1.732050807568877*BstarZdBmagR[0]*hamil0R[1])*rdx2R-5.656854249492382*dApardtPrev[0]*q_))/m_; 
  ...
  double alphaOrdR;
  double fUpOrd[4];
  alphaOrdR = 0.5*alpha0UpR[3]-0.5*(alpha0UpR[2]+alpha0UpR[1])+0.5*alpha0UpR[0]; 
  ...
  alphaOrdR = 0.5*(alpha0UpR[1]+alpha0UpR[0])-0.5*(alpha0UpR[3]+alpha0UpR[2]); 
  ...
  alphaOrdR = (-0.5*alpha0UpR[3])+0.5*alpha0UpR[2]-0.5*alpha0UpR[1]+0.5*alpha0UpR[0]; 
  ...
  alphaOrdR = 0.5*(alpha0UpR[3]+alpha0UpR[2]+alpha0UpR[1]+alpha0UpR[0]); 
  ...
  incr[3] = 0.3535533905932737*(alpha0R[1]*fUp[3]+fUp[1]*alpha0R[3]+alpha0R[0]*fUp[2]+fUp[0]*alpha0R[2]); 
  incr[4] = -0.6123724356957944*(alpha0R[2]*fUp[3]+fUp[2]*alpha0R[3]+alpha0R[0]*fUp[1]+fUp[0]*alpha0R[1]); 
  incr[5] = 0.3535533905932737*(alpha0R[0]*fUp[3]+fUp[0]*alpha0R[3]+alpha0R[1]*fUp[2]+fUp[1]*alpha0R[2]); 
  incr[6] = -0.6123724356957944*(alpha0R[1]*fUp[3]+fUp[1]*alpha0R[3]+alpha0R[0]*fUp[2]+fUp[0]*alpha0R[2]); 
  incr[7] = -0.6123724356957944*(alpha0R[0]*fUp[3]+fUp[0]*alpha0R[3]+alpha0R[1]*fUp[2]+fUp[1]*alpha0R[2]); 
...
double EmLinearDeltaFGyrokineticGenGeoSurf1x2vSerStep2_vpar_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
...
double EmLinearDeltaFGyrokineticGenGeoSurf1x2vSer_x_P1_Bvarsz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmLinearDeltaFGyrokineticGenGeoSurf1x2vSer_vpar_P1_Bvarsz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmLinearDeltaFGyrokineticGenGeoSurf1x2vSerStep2_vpar_P1_Bvarsz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
...
double EmLinearDeltaFGyrokineticGenGeoSurf1x2vSer_x_P1_Bvarsxz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmLinearDeltaFGyrokineticGenGeoSurf1x2vSer_vpar_P1_Bvarsxz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmLinearDeltaFGyrokineticGenGeoSurf1x2vSerStep2_vpar_P1_Bvarsxz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
