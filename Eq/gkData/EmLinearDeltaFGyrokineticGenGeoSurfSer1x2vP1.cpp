...
{ 
  ...
  // linear term alpha0*f1 
  double fUpOrd[4];
  if (0.5*alpha0UpR[3]-0.5*(alpha0UpR[2]+alpha0UpR[1])+0.5*alpha0UpR[0] > 0) { 
  ...
  if (0.5*(alpha0UpR[1]+alpha0UpR[0])-0.5*(alpha0UpR[3]+alpha0UpR[2]) > 0) { 
  ...
  if ((-0.5*alpha0UpR[3])+0.5*alpha0UpR[2]-0.5*alpha0UpR[1]+0.5*alpha0UpR[0] > 0) { 
  ...
  if (0.5*(alpha0UpR[3]+alpha0UpR[2]+alpha0UpR[1]+alpha0UpR[0]) > 0) { 
