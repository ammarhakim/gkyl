...
double alphaQuad;
  ...
  incr[6] = 0.02357022603955158*(13.41640786499874*alpha[1]*fupwind[6]+15.0*(alpha[0]*fupwind[3]+alpha[1]*fupwind[2]))*dfac_x; 
  incr[7] = 0.7905694150420947*(alpha[1]*fupwind[1]+alpha[0]*fupwind[0])*dfac_x; 
  incr[8] = 0.07071067811865474*(5.0*alpha[0]*fupwind[4]+4.47213595499958*alpha[1]*fupwind[1])*dfac_x; 
  incr[9] = 0.02357022603955158*(15.0*alpha[1]*fupwind[7]+15.0*alpha[0]*fupwind[5])*dfac_x; 
  incr[10] = -0.07071067811865474*(7.745966692414834*alpha[1]*fupwind[6]+8.660254037844386*(alpha[0]*fupwind[3]+alpha[1]*fupwind[2]))*dfac_x; 
  incr[11] = 0.1581138830084189*(4.47213595499958*alpha[1]*fupwind[4]+5.0*(alpha[0]*fupwind[1]+fupwind[0]*alpha[1]))*dfac_x; 
  incr[12] = -0.273861278752583*(2.23606797749979*alpha[0]*fupwind[4]+2.0*alpha[1]*fupwind[1])*dfac_x; 
  incr[13] = 0.7905694150420948*(alpha[1]*fupwind[3]+alpha[0]*fupwind[2])*dfac_x; 
  incr[14] = 0.02357022603955158*(15.0*alpha[0]*fupwind[6]+13.41640786499874*alpha[1]*fupwind[3])*dfac_x; 
  incr[15] = -0.07071067811865474*(8.660254037844386*alpha[1]*fupwind[7]+8.660254037844387*alpha[0]*fupwind[5])*dfac_x; 
  incr[16] = 0.02357022603955158*(15.0*alpha[0]*fupwind[7]+15.0*alpha[1]*fupwind[5])*dfac_x; 
  incr[17] = 0.05270462766947297*(13.41640786499874*alpha[1]*fupwind[6]+15.0*(alpha[0]*fupwind[3]+alpha[1]*fupwind[2]))*dfac_x; 
  incr[18] = -0.1581138830084189*(3.872983346207417*alpha[0]*fupwind[6]+3.464101615137754*alpha[1]*fupwind[3])*dfac_x; 
  incr[19] = -0.07071067811865474*(8.660254037844387*alpha[0]*fupwind[7]+8.660254037844386*alpha[1]*fupwind[5])*dfac_x; 
...
double EmGyrokineticSimpleHelicalSurf1x2vSer_Vpar_P2_Bvars_0(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *BdriftX, const double *BdriftY, const double *Phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_v = 2.0/dxv[1]; 
...
double EmGyrokineticSimpleHelicalSurf1x2vSer_X_P2_Bvars_1(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *BdriftX, const double *BdriftY, const double *Phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_v = 2.0/dxv[1]; 
...
double EmGyrokineticSimpleHelicalSurf1x2vSer_Vpar_P2_Bvars_1(const double q_, const double m_, const double cflL, const double cflR, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *BdriftX, const double *BdriftY, const double *Phi, const double *Apar, const double *dApardt, const double *dApardtPrev, const double *fl, const double *fr, double *outl, double *outr, double *emModL, double *emModR) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_v = 2.0/dxv[1]; 
