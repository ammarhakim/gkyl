...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  fhatCtrl[0] = -0.04811252243246882*(fhat[14]-1.732050807568877*(fhat[10]+fhat[9]+fhat[7])+3.0*(fhat[4]+fhat[3]+fhat[2])-5.196152422706631*fhat[0])*limTheta(rCtrl[0],-1.0); 
  fhatCtrl[1] = 0.04811252243246882*(fhat[14]+1.732050807568877*(fhat[10]-1.0*(fhat[9]+fhat[7]))+3.0*(fhat[2]-1.0*(fhat[4]+fhat[3]))+5.196152422706631*fhat[0])*limTheta(rCtrl[1],-1.0); 
  fhatCtrl[2] = 0.04811252243246882*(fhat[14]+1.732050807568877*((-1.0*fhat[10])+fhat[9]-1.0*fhat[7])+3.0*((-1.0*fhat[4])+fhat[3]-1.0*fhat[2])+5.196152422706631*fhat[0])*limTheta(rCtrl[2],-1.0); 
  fhatCtrl[3] = -0.04811252243246882*(fhat[14]+1.732050807568877*(fhat[10]+fhat[9]-1.0*fhat[7])+3.0*fhat[4]-1.0*(3.0*(fhat[3]+fhat[2])+5.196152422706631*fhat[0]))*limTheta(rCtrl[3],-1.0); 
  fhatCtrl[4] = 0.04811252243246882*(fhat[14]+1.732050807568877*(fhat[7]-1.0*(fhat[10]+fhat[9]))+3.0*(fhat[4]-1.0*(fhat[3]+fhat[2]))+5.196152422706631*fhat[0])*limTheta(rCtrl[4],-1.0); 
  fhatCtrl[5] = -0.04811252243246882*(fhat[14]+1.732050807568877*(fhat[10]-1.0*fhat[9]+fhat[7])+3.0*(fhat[3]-1.0*fhat[4])-1.0*(3.0*fhat[2]+5.196152422706631*fhat[0]))*limTheta(rCtrl[5],-1.0); 
  fhatCtrl[6] = -0.04811252243246882*(fhat[14]+1.732050807568877*((-1.0*fhat[10])+fhat[9]+fhat[7])+3.0*(fhat[2]-1.0*(fhat[4]+fhat[3]))-5.196152422706631*fhat[0])*limTheta(rCtrl[6],-1.0); 
  fhatCtrl[7] = 0.04811252243246882*(fhat[14]+1.732050807568877*(fhat[10]+fhat[9]+fhat[7])+3.0*(fhat[4]+fhat[3]+fhat[2])+5.196152422706631*fhat[0])*limTheta(rCtrl[7],-1.0); 
  ...
  double fhatALQuad[8]; 
  fhatALQuad[0] = std::max(0., std::min(0.25*((-0.5773502691896258*((-0.5773502691896258*(4.242640687119286*fhatAL[5]-4.242640687119286*fhatAL[7]))-2.449489742783178*(fhatAL[6]+fhatAL[4])+2.449489742783178*(fhatAL[3]+fhatAL[1])))-1.414213562373095*fhatAL[2]+1.414213562373095*fhatAL[0]), limQuad[0])); 
  fhatALQuad[1] = std::max(0., std::min(0.25*(0.5773502691896258*((-0.5773502691896258*(4.242640687119286*fhatAL[5]-4.242640687119286*fhatAL[7]))-2.449489742783178*fhatAL[4]+2.449489742783178*fhatAL[1])-0.5773502691896258*(2.449489742783178*fhatAL[3]-2.449489742783178*fhatAL[6])-1.414213562373095*fhatAL[2]+1.414213562373095*fhatAL[0]), limQuad[1])); 
  fhatALQuad[2] = std::max(0., std::min(0.25*((-0.5773502691896258*(2.449489742783178*(fhatAL[4]+fhatAL[1])-2.449489742783179*(fhatAL[7]+fhatAL[5])))-1.414213562373095*(fhatAL[6]+fhatAL[3])+1.414213562373095*(fhatAL[2]+fhatAL[0])), limQuad[2])); 
  fhatALQuad[3] = std::max(0., std::min(0.25*(0.5773502691896258*(2.449489742783178*(fhatAL[4]+fhatAL[1])-2.449489742783179*(fhatAL[7]+fhatAL[5]))-1.414213562373095*(fhatAL[6]+fhatAL[3])+1.414213562373095*(fhatAL[2]+fhatAL[0])), limQuad[3])); 
  fhatALQuad[4] = std::max(0., std::min(0.25*((-0.5773502691896258*(0.5773502691896258*(4.242640687119286*fhatAL[5]-4.242640687119286*fhatAL[7])-2.449489742783178*fhatAL[4]+2.449489742783178*fhatAL[1]))+0.5773502691896258*(2.449489742783178*fhatAL[3]-2.449489742783178*fhatAL[6])-1.414213562373095*fhatAL[2]+1.414213562373095*fhatAL[0]), limQuad[4])); 
  fhatALQuad[5] = std::max(0., std::min(0.25*(0.5773502691896258*(0.5773502691896258*(4.242640687119286*fhatAL[5]-4.242640687119286*fhatAL[7])-2.449489742783178*(fhatAL[6]+fhatAL[4])+2.449489742783178*(fhatAL[3]+fhatAL[1]))-1.414213562373095*fhatAL[2]+1.414213562373095*fhatAL[0]), limQuad[5])); 
  fhatALQuad[6] = std::max(0., std::min(0.25*((-0.5773502691896258*(2.449489742783179*(fhatAL[7]+fhatAL[5])+2.449489742783178*(fhatAL[4]+fhatAL[1])))+1.414213562373095*(fhatAL[6]+fhatAL[3])+1.414213562373095*(fhatAL[2]+fhatAL[0])), limQuad[6])); 
  fhatALQuad[7] = std::max(0., std::min(0.25*(0.5773502691896258*(2.449489742783179*(fhatAL[7]+fhatAL[5])+2.449489742783178*(fhatAL[4]+fhatAL[1]))+1.414213562373095*(fhatAL[6]+fhatAL[3])+1.414213562373095*(fhatAL[2]+fhatAL[0])), limQuad[7])); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  fhatCtrl[0] = -0.04811252243246882*(fhat[13]-1.732050807568877*(fhat[10]+fhat[8]+fhat[6])+3.0*(fhat[4]+fhat[3]+fhat[1])-5.196152422706631*fhat[0])*limTheta(rCtrl[0],-1.0); 
  fhatCtrl[1] = 0.04811252243246882*(fhat[13]+1.732050807568877*(fhat[10]-1.0*(fhat[8]+fhat[6]))+3.0*(fhat[1]-1.0*(fhat[4]+fhat[3]))+5.196152422706631*fhat[0])*limTheta(rCtrl[1],-1.0); 
  fhatCtrl[2] = 0.04811252243246882*(fhat[13]+1.732050807568877*((-1.0*fhat[10])+fhat[8]-1.0*fhat[6])+3.0*((-1.0*fhat[4])+fhat[3]-1.0*fhat[1])+5.196152422706631*fhat[0])*limTheta(rCtrl[2],-1.0); 
  fhatCtrl[3] = -0.04811252243246882*(fhat[13]+1.732050807568877*(fhat[10]+fhat[8]-1.0*fhat[6])+3.0*fhat[4]-1.0*(3.0*(fhat[3]+fhat[1])+5.196152422706631*fhat[0]))*limTheta(rCtrl[3],-1.0); 
  fhatCtrl[4] = 0.04811252243246882*(fhat[13]+1.732050807568877*(fhat[6]-1.0*(fhat[10]+fhat[8]))+3.0*(fhat[4]-1.0*(fhat[3]+fhat[1]))+5.196152422706631*fhat[0])*limTheta(rCtrl[4],-1.0); 
  fhatCtrl[5] = -0.04811252243246882*(fhat[13]+1.732050807568877*(fhat[10]-1.0*fhat[8]+fhat[6])+3.0*(fhat[3]-1.0*fhat[4])-1.0*(3.0*fhat[1]+5.196152422706631*fhat[0]))*limTheta(rCtrl[5],-1.0); 
  fhatCtrl[6] = -0.04811252243246882*(fhat[13]+1.732050807568877*((-1.0*fhat[10])+fhat[8]+fhat[6])+3.0*(fhat[1]-1.0*(fhat[4]+fhat[3]))-5.196152422706631*fhat[0])*limTheta(rCtrl[6],-1.0); 
  fhatCtrl[7] = 0.04811252243246882*(fhat[13]+1.732050807568877*(fhat[10]+fhat[8]+fhat[6])+3.0*(fhat[4]+fhat[3]+fhat[1])+5.196152422706631*fhat[0])*limTheta(rCtrl[7],-1.0); 
  double fhatAL[8];  // fhatAL = mode coefficients of anti-limited f on surface 
  fhatAL[0] = 0.3535533905932737*(fhatCtrl[7]+fhatCtrl[6]+fhatCtrl[5]+fhatCtrl[4]+fhatCtrl[3]+fhatCtrl[2]+fhatCtrl[1]+fhatCtrl[0]); 
  fhatAL[1] = 0.6123724356957944*(fhatCtrl[7]-1.0*fhatCtrl[6]+fhatCtrl[5]-1.0*fhatCtrl[4]+fhatCtrl[3]-1.0*fhatCtrl[2]+fhatCtrl[1]-1.0*fhatCtrl[0]); 
  fhatAL[2] = 0.6123724356957944*(fhatCtrl[7]+fhatCtrl[6]-1.0*(fhatCtrl[5]+fhatCtrl[4])+fhatCtrl[3]+fhatCtrl[2]-1.0*(fhatCtrl[1]+fhatCtrl[0])); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  fhatCtrl[0] = -0.04811252243246882*(fhat[12]-1.732050807568877*(fhat[9]+fhat[8]+fhat[5])+3.0*(fhat[4]+fhat[2]+fhat[1])-5.196152422706631*fhat[0])*limTheta(rCtrl[0],-1.0); 
  fhatCtrl[1] = 0.04811252243246882*(fhat[12]+1.732050807568877*(fhat[9]-1.0*(fhat[8]+fhat[5]))+3.0*(fhat[1]-1.0*(fhat[4]+fhat[2]))+5.196152422706631*fhat[0])*limTheta(rCtrl[1],-1.0); 
  fhatCtrl[2] = 0.04811252243246882*(fhat[12]+1.732050807568877*((-1.0*fhat[9])+fhat[8]-1.0*fhat[5])+3.0*((-1.0*fhat[4])+fhat[2]-1.0*fhat[1])+5.196152422706631*fhat[0])*limTheta(rCtrl[2],-1.0); 
  fhatCtrl[3] = -0.04811252243246882*(fhat[12]+1.732050807568877*(fhat[9]+fhat[8]-1.0*fhat[5])+3.0*fhat[4]-1.0*(3.0*(fhat[2]+fhat[1])+5.196152422706631*fhat[0]))*limTheta(rCtrl[3],-1.0); 
  fhatCtrl[4] = 0.04811252243246882*(fhat[12]+1.732050807568877*(fhat[5]-1.0*(fhat[9]+fhat[8]))+3.0*(fhat[4]-1.0*(fhat[2]+fhat[1]))+5.196152422706631*fhat[0])*limTheta(rCtrl[4],-1.0); 
  fhatCtrl[5] = -0.04811252243246882*(fhat[12]+1.732050807568877*(fhat[9]-1.0*fhat[8]+fhat[5])+3.0*(fhat[2]-1.0*fhat[4])-1.0*(3.0*fhat[1]+5.196152422706631*fhat[0]))*limTheta(rCtrl[5],-1.0); 
  fhatCtrl[6] = -0.04811252243246882*(fhat[12]+1.732050807568877*((-1.0*fhat[9])+fhat[8]+fhat[5])+3.0*(fhat[1]-1.0*(fhat[4]+fhat[2]))-5.196152422706631*fhat[0])*limTheta(rCtrl[6],-1.0); 
  fhatCtrl[7] = 0.04811252243246882*(fhat[12]+1.732050807568877*(fhat[9]+fhat[8]+fhat[5])+3.0*(fhat[4]+fhat[2]+fhat[1])+5.196152422706631*fhat[0])*limTheta(rCtrl[7],-1.0); 
  double fhatAL[8];  // fhatAL = mode coefficients of anti-limited f on surface 
  fhatAL[0] = 0.3535533905932737*(fhatCtrl[7]+fhatCtrl[6]+fhatCtrl[5]+fhatCtrl[4]+fhatCtrl[3]+fhatCtrl[2]+fhatCtrl[1]+fhatCtrl[0]); 
  fhatAL[1] = 0.6123724356957944*(fhatCtrl[7]-1.0*fhatCtrl[6]+fhatCtrl[5]-1.0*fhatCtrl[4]+fhatCtrl[3]-1.0*fhatCtrl[2]+fhatCtrl[1]-1.0*fhatCtrl[0]); 
  fhatAL[2] = 0.6123724356957944*(fhatCtrl[7]+fhatCtrl[6]-1.0*(fhatCtrl[5]+fhatCtrl[4])+fhatCtrl[3]+fhatCtrl[2]-1.0*(fhatCtrl[1]+fhatCtrl[0])); 
  ...
  // enforce limiters at surface quadrature nodes 
  double fhatALQuad[8]; 
  fhatALQuad[0] = std::max(0., std::min(0.25*((-0.5773502691896258*((-0.5773502691896258*(4.242640687119286*fhatAL[4]-4.242640687119286*fhatAL[7]))-2.449489742783178*(fhatAL[6]+fhatAL[5])+2.449489742783178*(fhatAL[2]+fhatAL[1])))-1.414213562373095*fhatAL[3]+1.414213562373095*fhatAL[0]), limQuad[0])); 
  fhatALQuad[1] = std::max(0., std::min(0.25*((-0.5773502691896258*(0.5773502691896258*(4.242640687119286*fhatAL[4]-4.242640687119286*fhatAL[7])-2.449489742783178*fhatAL[6]+2.449489742783178*fhatAL[2]))+0.5773502691896258*(2.449489742783178*fhatAL[1]-2.449489742783178*fhatAL[5])-1.414213562373095*fhatAL[3]+1.414213562373095*fhatAL[0]), limQuad[1])); 
  fhatALQuad[2] = std::max(0., std::min(0.25*(0.5773502691896258*((-0.5773502691896258*(4.242640687119286*fhatAL[4]-4.242640687119286*fhatAL[7]))-2.449489742783178*fhatAL[6]+2.449489742783178*fhatAL[2])-0.5773502691896258*(2.449489742783178*fhatAL[1]-2.449489742783178*fhatAL[5])-1.414213562373095*fhatAL[3]+1.414213562373095*fhatAL[0]), limQuad[2])); 
  fhatALQuad[3] = std::max(0., std::min(0.25*(0.5773502691896258*(0.5773502691896258*(4.242640687119286*fhatAL[4]-4.242640687119286*fhatAL[7])-2.449489742783178*(fhatAL[6]+fhatAL[5])+2.449489742783178*(fhatAL[2]+fhatAL[1]))-1.414213562373095*fhatAL[3]+1.414213562373095*fhatAL[0]), limQuad[3])); 
  fhatALQuad[4] = std::max(0., std::min(0.25*((-0.5773502691896258*(2.449489742783178*(fhatAL[6]+fhatAL[2])-2.449489742783179*(fhatAL[7]+fhatAL[4])))-1.414213562373095*(fhatAL[5]+fhatAL[1])+1.414213562373095*(fhatAL[3]+fhatAL[0])), limQuad[4])); 
  fhatALQuad[5] = std::max(0., std::min(0.25*((-0.5773502691896258*(2.449489742783179*(fhatAL[7]+fhatAL[4])+2.449489742783178*(fhatAL[6]+fhatAL[2])))+1.414213562373095*(fhatAL[5]+fhatAL[1])+1.414213562373095*(fhatAL[3]+fhatAL[0])), limQuad[5])); 
  fhatALQuad[6] = std::max(0., std::min(0.25*(0.5773502691896258*(2.449489742783178*(fhatAL[6]+fhatAL[2])-2.449489742783179*(fhatAL[7]+fhatAL[4]))-1.414213562373095*(fhatAL[5]+fhatAL[1])+1.414213562373095*(fhatAL[3]+fhatAL[0])), limQuad[6])); 
  fhatALQuad[7] = std::max(0., std::min(0.25*(0.5773502691896258*(2.449489742783179*(fhatAL[7]+fhatAL[4])+2.449489742783178*(fhatAL[6]+fhatAL[2]))+1.414213562373095*(fhatAL[5]+fhatAL[1])+1.414213562373095*(fhatAL[3]+fhatAL[0])), limQuad[7])); 
  fhatAL[0] = 0.3535533905932737*(fhatALQuad[7]+fhatALQuad[6]+fhatALQuad[5]+fhatALQuad[4]+fhatALQuad[3]+fhatALQuad[2]+fhatALQuad[1]+fhatALQuad[0]); 
  fhatAL[1] = 0.3535533905932737*(fhatALQuad[7]-1.0*fhatALQuad[6]+fhatALQuad[5]-1.0*fhatALQuad[4]+fhatALQuad[3]-1.0*fhatALQuad[2]+fhatALQuad[1]-1.0*fhatALQuad[0]); 
  fhatAL[2] = 0.3535533905932737*(fhatALQuad[7]+fhatALQuad[6]-1.0*(fhatALQuad[5]+fhatALQuad[4])+fhatALQuad[3]+fhatALQuad[2]-1.0*(fhatALQuad[1]+fhatALQuad[0])); 
  fhatAL[3] = 0.3535533905932737*(fhatALQuad[7]+fhatALQuad[6]+fhatALQuad[5]+fhatALQuad[4]-1.0*(fhatALQuad[3]+fhatALQuad[2]+fhatALQuad[1]+fhatALQuad[0])); 
