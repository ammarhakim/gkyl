...
double GyrokineticSurfPositivity2x2vSer_X_P1_Bvars_0(const double q_, const double m_, const double cfl, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  incr[4] = 0.25*alpha[0]*fhatALVal[3]*dfac_x; 
  incr[5] = -0.4330127018922193*alpha[0]*fhatALVal[1]*dfac_x; 
  incr[6] = -0.4330127018922193*alpha[0]*fhatALVal[2]*dfac_x; 
  incr[7] = 0.25*alpha[0]*fhatALVal[4]*dfac_x; 
  incr[8] = -0.4330127018922193*alpha[0]*fhatALVal[3]*dfac_x; 
  incr[9] = 0.25*alpha[0]*fhatALVal[5]*dfac_x; 
  incr[10] = 0.25*alpha[0]*fhatALVal[6]*dfac_x; 
  incr[11] = -0.4330127018922193*alpha[0]*fhatALVal[4]*dfac_x; 
  incr[12] = -0.4330127018922193*alpha[0]*fhatALVal[5]*dfac_x; 
  incr[13] = -0.4330127018922193*alpha[0]*fhatALVal[6]*dfac_x; 
  incr[14] = 0.25*alpha[0]*fhatALVal[7]*dfac_x; 
  incr[15] = -0.4330127018922193*alpha[0]*fhatALVal[7]*dfac_x; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  fhatALVal[6] = 1.060660171779821*(fqVal[7]+fqVal[6]-1.0*(fqVal[5]+fqVal[4]+fqVal[3]+fqVal[2])+fqVal[1]+fqVal[0]); 
  fhatALVal[7] = 1.837117307087383*(fqVal[7]-1.0*(fqVal[6]+fqVal[5])+fqVal[4]-1.0*fqVal[3]+fqVal[2]+fqVal[1]-1.0*fqVal[0]); 
  incr[0] = 0.25*alpha[0]*fhatALVal[0]*dfac_y; 
  incr[1] = 0.25*alpha[0]*fhatALVal[1]*dfac_y; 
  incr[2] = -0.4330127018922193*alpha[0]*fhatALVal[0]*dfac_y; 
  incr[3] = 0.25*alpha[0]*fhatALVal[2]*dfac_y; 
  incr[4] = 0.25*alpha[0]*fhatALVal[3]*dfac_y; 
  incr[5] = -0.4330127018922193*alpha[0]*fhatALVal[1]*dfac_y; 
  incr[6] = 0.25*alpha[0]*fhatALVal[4]*dfac_y; 
  incr[7] = -0.4330127018922193*alpha[0]*fhatALVal[2]*dfac_y; 
  incr[8] = 0.25*alpha[0]*fhatALVal[5]*dfac_y; 
  incr[9] = -0.4330127018922193*alpha[0]*fhatALVal[3]*dfac_y; 
  incr[10] = 0.25*alpha[0]*fhatALVal[6]*dfac_y; 
  incr[11] = -0.4330127018922193*alpha[0]*fhatALVal[4]*dfac_y; 
  incr[12] = -0.4330127018922193*alpha[0]*fhatALVal[5]*dfac_y; 
  incr[13] = 0.25*alpha[0]*fhatALVal[7]*dfac_y; 
  incr[14] = -0.4330127018922193*alpha[0]*fhatALVal[6]*dfac_y; 
  incr[15] = -0.4330127018922193*alpha[0]*fhatALVal[7]*dfac_y; 
...
double GyrokineticSurfPositivity2x2vSer_Vpar_P1_Bvars_0(const double q_, const double m_, const double cfl, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
...
double GyrokineticSurfPositivity2x2vSer_Y_P1_Bvars_1(const double q_, const double m_, const double cfl, const double *w, const double *dxv, const double amax_in, const double *Bmag, const double *BmagInv, const double *Gradpar, const double *geoX, const double *geoY, const double *geoZ, const double *Phi, const double *fl, const double *fr, double *outl, double *outr) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  double dfac_x = 2.0/dxv[0]; 
  double dfac_y = 2.0/dxv[1]; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  incr[2] = 0.25*(alpha[1]*fhatALVal[4]+alpha[0]*fhatALVal[2])*dfac_v; 
  incr[3] = -0.4330127018922193*(alpha[1]*fhatALVal[1]+alpha[0]*fhatALVal[0])*dfac_v; 
  incr[4] = 0.25*(alpha[1]*fhatALVal[5]+alpha[0]*fhatALVal[3])*dfac_v; 
  incr[5] = 0.25*(alpha[0]*fhatALVal[4]+alpha[1]*fhatALVal[2])*dfac_v; 
  incr[6] = -0.4330127018922193*(alpha[0]*fhatALVal[1]+fhatALVal[0]*alpha[1])*dfac_v; 
  incr[7] = -0.4330127018922193*(alpha[1]*fhatALVal[4]+alpha[0]*fhatALVal[2])*dfac_v; 
  incr[8] = 0.25*(alpha[0]*fhatALVal[5]+alpha[1]*fhatALVal[3])*dfac_v; 
  incr[9] = 0.25*(alpha[1]*fhatALVal[7]+alpha[0]*fhatALVal[6])*dfac_v; 
  incr[10] = -0.4330127018922193*(alpha[1]*fhatALVal[5]+alpha[0]*fhatALVal[3])*dfac_v; 
  incr[11] = -0.4330127018922193*(alpha[0]*fhatALVal[4]+alpha[1]*fhatALVal[2])*dfac_v; 
  incr[12] = 0.25*(alpha[0]*fhatALVal[7]+alpha[1]*fhatALVal[6])*dfac_v; 
  incr[13] = -0.4330127018922193*(alpha[0]*fhatALVal[5]+alpha[1]*fhatALVal[3])*dfac_v; 
  incr[14] = -0.4330127018922193*(alpha[1]*fhatALVal[7]+alpha[0]*fhatALVal[6])*dfac_v; 
  incr[15] = -0.4330127018922193*(alpha[0]*fhatALVal[7]+alpha[1]*fhatALVal[6])*dfac_v; 
