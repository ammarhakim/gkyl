...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
...
#if cflType == SURFAVG 
  // evaluate surface-averaged alpha on left 
  alphaL = -(0.0625*(2.828427124746191*dApardt[0]*dfac_v*q_+(2.449489742783178*alphav[4]-1.414213562373095*alphav[0])*m_))/m_; 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  // evaluate surface-averaged alpha on right 
  alphaR = -(0.0625*(2.828427124746191*dApardt[0]*dfac_v*q_+((-2.449489742783178*alphav[4])-1.414213562373095*alphav[0])*m_))/m_; 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
#elif cflType == QUAD 
  // evaluate alpha at left surface quadrature points 
  alphaL = 0.03125*((-(1.0*((-0.3535533905932737*dApardt[7])+0.3535533905932737*(dApardt[6]+dApardt[5]+dApardt[4])-0.3535533905932737*(dApardt[3]+dApardt[2]+dApardt[1])+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)-0.3061862178478971*(alphav[19]+alphav[18])-0.1767766952966368*alphav[16]+0.3061862178478971*(alphav[11]+alphav[10]+alphav[9])+0.1767766952966368*(alphav[8]+alphav[7]+alphav[6])-0.3061862178478971*alphav[4]-0.1767766952966368*(alphav[3]+alphav[2]+alphav[1])+0.1767766952966368*alphav[0]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.03125*((-(1.0*(0.3535533905932737*(dApardt[7]+dApardt[6])-0.3535533905932737*(dApardt[5]+dApardt[4]+dApardt[3]+dApardt[2])+0.3535533905932737*(dApardt[1]+dApardt[0]))*dfac_v*q_)/m_)-0.3061862178478971*alphav[19]+0.3061862178478971*alphav[18]+0.1767766952966368*alphav[16]+0.3061862178478971*(alphav[11]+alphav[10])-0.3061862178478971*alphav[9]+0.1767766952966368*alphav[8]-0.1767766952966368*(alphav[7]+alphav[6])-0.3061862178478971*alphav[4]-0.1767766952966368*(alphav[3]+alphav[2])+0.1767766952966368*(alphav[1]+alphav[0])); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.03125*((-(1.0*(0.3535533905932737*dApardt[7]-0.3535533905932737*dApardt[6]+0.3535533905932737*dApardt[5]-0.3535533905932737*(dApardt[4]+dApardt[3])+0.3535533905932737*dApardt[2]-0.3535533905932737*dApardt[1]+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)+0.3061862178478971*alphav[19]-0.3061862178478971*alphav[18]+0.1767766952966368*alphav[16]+0.3061862178478971*alphav[11]-0.3061862178478971*alphav[10]+0.3061862178478971*alphav[9]-0.1767766952966368*alphav[8]+0.1767766952966368*alphav[7]-0.1767766952966368*alphav[6]-0.3061862178478971*alphav[4]-0.1767766952966368*alphav[3]+0.1767766952966368*alphav[2]-0.1767766952966368*alphav[1]+0.1767766952966368*alphav[0]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.03125*((-(1.0*((-0.3535533905932737*(dApardt[7]+dApardt[6]+dApardt[5]))+0.3535533905932737*dApardt[4]-0.3535533905932737*dApardt[3]+0.3535533905932737*(dApardt[2]+dApardt[1]+dApardt[0]))*dfac_v*q_)/m_)+0.3061862178478971*(alphav[19]+alphav[18])-0.1767766952966368*alphav[16]+0.3061862178478971*alphav[11]-0.3061862178478971*(alphav[10]+alphav[9])-0.1767766952966368*(alphav[8]+alphav[7])+0.1767766952966368*alphav[6]-0.3061862178478971*alphav[4]-0.1767766952966368*alphav[3]+0.1767766952966368*(alphav[2]+alphav[1]+alphav[0])); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.03125*((-(1.0*(0.3535533905932737*dApardt[7]-0.3535533905932737*(dApardt[6]+dApardt[5])+0.3535533905932737*(dApardt[4]+dApardt[3])-0.3535533905932737*(dApardt[2]+dApardt[1])+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)+0.3061862178478971*(alphav[19]+alphav[18])+0.1767766952966368*alphav[16]-0.3061862178478971*alphav[11]+0.3061862178478971*(alphav[10]+alphav[9])-0.1767766952966368*(alphav[8]+alphav[7])+0.1767766952966368*alphav[6]-0.3061862178478971*alphav[4]+0.1767766952966368*alphav[3]-0.1767766952966368*(alphav[2]+alphav[1])+0.1767766952966368*alphav[0]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.03125*((-(1.0*((-0.3535533905932737*(dApardt[7]+dApardt[6]))+0.3535533905932737*dApardt[5]-0.3535533905932737*dApardt[4]+0.3535533905932737*dApardt[3]-0.3535533905932737*dApardt[2]+0.3535533905932737*(dApardt[1]+dApardt[0]))*dfac_v*q_)/m_)+0.3061862178478971*alphav[19]-0.3061862178478971*alphav[18]-0.1767766952966368*alphav[16]-0.3061862178478971*alphav[11]+0.3061862178478971*alphav[10]-0.3061862178478971*alphav[9]-0.1767766952966368*alphav[8]+0.1767766952966368*alphav[7]-0.1767766952966368*alphav[6]-0.3061862178478971*alphav[4]+0.1767766952966368*alphav[3]-0.1767766952966368*alphav[2]+0.1767766952966368*(alphav[1]+alphav[0])); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.03125*((-(1.0*((-0.3535533905932737*dApardt[7])+0.3535533905932737*dApardt[6]-0.3535533905932737*(dApardt[5]+dApardt[4])+0.3535533905932737*(dApardt[3]+dApardt[2])-0.3535533905932737*dApardt[1]+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)-0.3061862178478971*alphav[19]+0.3061862178478971*alphav[18]-0.1767766952966368*alphav[16]-0.3061862178478971*(alphav[11]+alphav[10])+0.3061862178478971*alphav[9]+0.1767766952966368*alphav[8]-0.1767766952966368*(alphav[7]+alphav[6])-0.3061862178478971*alphav[4]+0.1767766952966368*(alphav[3]+alphav[2])-0.1767766952966368*alphav[1]+0.1767766952966368*alphav[0]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.03125*((-(0.3535533905932737*(dApardt[7]+dApardt[6]+dApardt[5]+dApardt[4]+dApardt[3]+dApardt[2]+dApardt[1]+dApardt[0])*dfac_v*q_)/m_)-0.3061862178478971*(alphav[19]+alphav[18])+0.1767766952966368*alphav[16]-0.3061862178478971*(alphav[11]+alphav[10]+alphav[9])+0.1767766952966368*(alphav[8]+alphav[7]+alphav[6])-0.3061862178478971*alphav[4]+0.1767766952966368*(alphav[3]+alphav[2]+alphav[1]+alphav[0])); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.03125*((-(1.0*((-0.3535533905932737*dApardt[7])+0.3535533905932737*(dApardt[6]+dApardt[5]+dApardt[4])-0.3535533905932737*(dApardt[3]+dApardt[2]+dApardt[1])+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)-0.3061862178478971*(alphav[19]+alphav[18])-0.1767766952966368*alphav[16]+0.3061862178478971*(alphav[11]+alphav[10]+alphav[9])+0.1767766952966368*(alphav[8]+alphav[7]+alphav[6])-0.3061862178478971*alphav[4]-0.1767766952966368*(alphav[3]+alphav[2]+alphav[1])+0.1767766952966368*alphav[0]); 
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  alphaL = 0.03125*((-(1.0*(0.3535533905932737*(dApardt[7]+dApardt[6])-0.3535533905932737*(dApardt[5]+dApardt[4]+dApardt[3]+dApardt[2])+0.3535533905932737*(dApardt[1]+dApardt[0]))*dfac_v*q_)/m_)-0.3061862178478971*alphav[19]+0.3061862178478971*alphav[18]+0.1767766952966368*alphav[16]+0.3061862178478971*(alphav[11]+alphav[10])-0.3061862178478971*alphav[9]+0.1767766952966368*alphav[8]-0.1767766952966368*(alphav[7]+alphav[6])-0.3061862178478971*alphav[4]-0.1767766952966368*(alphav[3]+alphav[2])+0.1767766952966368*(alphav[1]+alphav[0])); 
  ...
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  // evaluate alpha at right surface quadrature points 
  alphaR = 0.03125*((-(1.0*((-0.3535533905932737*dApardt[7])+0.3535533905932737*(dApardt[6]+dApardt[5]+dApardt[4])-0.3535533905932737*(dApardt[3]+dApardt[2]+dApardt[1])+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)+0.3061862178478971*(alphav[19]+alphav[18])-0.1767766952966368*alphav[16]-0.3061862178478971*(alphav[11]+alphav[10]+alphav[9])+0.1767766952966368*(alphav[8]+alphav[7]+alphav[6])+0.3061862178478971*alphav[4]-0.1767766952966368*(alphav[3]+alphav[2]+alphav[1])+0.1767766952966368*alphav[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*(0.3535533905932737*(dApardt[7]+dApardt[6])-0.3535533905932737*(dApardt[5]+dApardt[4]+dApardt[3]+dApardt[2])+0.3535533905932737*(dApardt[1]+dApardt[0]))*dfac_v*q_)/m_)+0.3061862178478971*alphav[19]-0.3061862178478971*alphav[18]+0.1767766952966368*alphav[16]-0.3061862178478971*(alphav[11]+alphav[10])+0.3061862178478971*alphav[9]+0.1767766952966368*alphav[8]-0.1767766952966368*(alphav[7]+alphav[6])+0.3061862178478971*alphav[4]-0.1767766952966368*(alphav[3]+alphav[2])+0.1767766952966368*(alphav[1]+alphav[0])); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*(0.3535533905932737*dApardt[7]-0.3535533905932737*dApardt[6]+0.3535533905932737*dApardt[5]-0.3535533905932737*(dApardt[4]+dApardt[3])+0.3535533905932737*dApardt[2]-0.3535533905932737*dApardt[1]+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)-0.3061862178478971*alphav[19]+0.3061862178478971*alphav[18]+0.1767766952966368*alphav[16]-0.3061862178478971*alphav[11]+0.3061862178478971*alphav[10]-0.3061862178478971*alphav[9]-0.1767766952966368*alphav[8]+0.1767766952966368*alphav[7]-0.1767766952966368*alphav[6]+0.3061862178478971*alphav[4]-0.1767766952966368*alphav[3]+0.1767766952966368*alphav[2]-0.1767766952966368*alphav[1]+0.1767766952966368*alphav[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*((-0.3535533905932737*(dApardt[7]+dApardt[6]+dApardt[5]))+0.3535533905932737*dApardt[4]-0.3535533905932737*dApardt[3]+0.3535533905932737*(dApardt[2]+dApardt[1]+dApardt[0]))*dfac_v*q_)/m_)-0.3061862178478971*(alphav[19]+alphav[18])-0.1767766952966368*alphav[16]-0.3061862178478971*alphav[11]+0.3061862178478971*(alphav[10]+alphav[9])-0.1767766952966368*(alphav[8]+alphav[7])+0.1767766952966368*alphav[6]+0.3061862178478971*alphav[4]-0.1767766952966368*alphav[3]+0.1767766952966368*(alphav[2]+alphav[1]+alphav[0])); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*(0.3535533905932737*dApardt[7]-0.3535533905932737*(dApardt[6]+dApardt[5])+0.3535533905932737*(dApardt[4]+dApardt[3])-0.3535533905932737*(dApardt[2]+dApardt[1])+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)-0.3061862178478971*(alphav[19]+alphav[18])+0.1767766952966368*alphav[16]+0.3061862178478971*alphav[11]-0.3061862178478971*(alphav[10]+alphav[9])-0.1767766952966368*(alphav[8]+alphav[7])+0.1767766952966368*alphav[6]+0.3061862178478971*alphav[4]+0.1767766952966368*alphav[3]-0.1767766952966368*(alphav[2]+alphav[1])+0.1767766952966368*alphav[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*((-0.3535533905932737*(dApardt[7]+dApardt[6]))+0.3535533905932737*dApardt[5]-0.3535533905932737*dApardt[4]+0.3535533905932737*dApardt[3]-0.3535533905932737*dApardt[2]+0.3535533905932737*(dApardt[1]+dApardt[0]))*dfac_v*q_)/m_)-0.3061862178478971*alphav[19]+0.3061862178478971*alphav[18]-0.1767766952966368*alphav[16]+0.3061862178478971*alphav[11]-0.3061862178478971*alphav[10]+0.3061862178478971*alphav[9]-0.1767766952966368*alphav[8]+0.1767766952966368*alphav[7]-0.1767766952966368*alphav[6]+0.3061862178478971*alphav[4]+0.1767766952966368*alphav[3]-0.1767766952966368*alphav[2]+0.1767766952966368*(alphav[1]+alphav[0])); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*((-0.3535533905932737*dApardt[7])+0.3535533905932737*dApardt[6]-0.3535533905932737*(dApardt[5]+dApardt[4])+0.3535533905932737*(dApardt[3]+dApardt[2])-0.3535533905932737*dApardt[1]+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)+0.3061862178478971*alphav[19]-0.3061862178478971*alphav[18]-0.1767766952966368*alphav[16]+0.3061862178478971*(alphav[11]+alphav[10])-0.3061862178478971*alphav[9]+0.1767766952966368*alphav[8]-0.1767766952966368*(alphav[7]+alphav[6])+0.3061862178478971*alphav[4]+0.1767766952966368*(alphav[3]+alphav[2])-0.1767766952966368*alphav[1]+0.1767766952966368*alphav[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(0.3535533905932737*(dApardt[7]+dApardt[6]+dApardt[5]+dApardt[4]+dApardt[3]+dApardt[2]+dApardt[1]+dApardt[0])*dfac_v*q_)/m_)+0.3061862178478971*(alphav[19]+alphav[18])+0.1767766952966368*alphav[16]+0.3061862178478971*(alphav[11]+alphav[10]+alphav[9])+0.1767766952966368*(alphav[8]+alphav[7]+alphav[6])+0.3061862178478971*alphav[4]+0.1767766952966368*(alphav[3]+alphav[2]+alphav[1]+alphav[0])); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*((-0.3535533905932737*dApardt[7])+0.3535533905932737*(dApardt[6]+dApardt[5]+dApardt[4])-0.3535533905932737*(dApardt[3]+dApardt[2]+dApardt[1])+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)+0.3061862178478971*(alphav[19]+alphav[18])-0.1767766952966368*alphav[16]-0.3061862178478971*(alphav[11]+alphav[10]+alphav[9])+0.1767766952966368*(alphav[8]+alphav[7]+alphav[6])+0.3061862178478971*alphav[4]-0.1767766952966368*(alphav[3]+alphav[2]+alphav[1])+0.1767766952966368*alphav[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*(0.3535533905932737*(dApardt[7]+dApardt[6])-0.3535533905932737*(dApardt[5]+dApardt[4]+dApardt[3]+dApardt[2])+0.3535533905932737*(dApardt[1]+dApardt[0]))*dfac_v*q_)/m_)+0.3061862178478971*alphav[19]-0.3061862178478971*alphav[18]+0.1767766952966368*alphav[16]-0.3061862178478971*(alphav[11]+alphav[10])+0.3061862178478971*alphav[9]+0.1767766952966368*alphav[8]-0.1767766952966368*(alphav[7]+alphav[6])+0.3061862178478971*alphav[4]-0.1767766952966368*(alphav[3]+alphav[2])+0.1767766952966368*(alphav[1]+alphav[0])); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  cflFreq += -0.5*(alphaL-std::abs(alphaL)); 
  // evaluate alpha at right surface quadrature points 
  alphaR = 0.03125*((-(1.0*((-0.3535533905932737*dApardt[7])+0.3535533905932737*(dApardt[6]+dApardt[5]+dApardt[4])-0.3535533905932737*(dApardt[3]+dApardt[2]+dApardt[1])+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)+0.1767766952966368*alphav[27]-0.3061862178478971*alphav[26]+0.3061862178478971*alphav[23]-0.1767766952966368*(alphav[22]+alphav[21]+alphav[20])+0.3061862178478971*(alphav[19]+alphav[18]+alphav[17])-0.1767766952966368*alphav[16]-0.3061862178478971*alphav[15]+0.1767766952966368*(alphav[14]+alphav[13]+alphav[12])-0.3061862178478971*(alphav[11]+alphav[10]+alphav[9])+0.1767766952966368*(alphav[8]+alphav[7]+alphav[6])-0.1767766952966368*alphav[5]+0.3061862178478971*alphav[4]-0.1767766952966368*(alphav[3]+alphav[2]+alphav[1])+0.1767766952966368*alphav[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*(0.3535533905932737*(dApardt[7]+dApardt[6])-0.3535533905932737*(dApardt[5]+dApardt[4]+dApardt[3]+dApardt[2])+0.3535533905932737*(dApardt[1]+dApardt[0]))*dfac_v*q_)/m_)-0.1767766952966368*alphav[27]+0.3061862178478971*alphav[26]-0.3061862178478971*alphav[23]-0.1767766952966368*alphav[22]+0.1767766952966368*(alphav[21]+alphav[20])+0.3061862178478971*alphav[19]-0.3061862178478971*(alphav[18]+alphav[17])+0.1767766952966368*alphav[16]-0.3061862178478971*alphav[15]+0.1767766952966368*(alphav[14]+alphav[13])-0.1767766952966368*alphav[12]-0.3061862178478971*(alphav[11]+alphav[10])+0.3061862178478971*alphav[9]+0.1767766952966368*alphav[8]-0.1767766952966368*(alphav[7]+alphav[6]+alphav[5])+0.3061862178478971*alphav[4]-0.1767766952966368*(alphav[3]+alphav[2])+0.1767766952966368*(alphav[1]+alphav[0])); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*(0.3535533905932737*dApardt[7]-0.3535533905932737*dApardt[6]+0.3535533905932737*dApardt[5]-0.3535533905932737*(dApardt[4]+dApardt[3])+0.3535533905932737*dApardt[2]-0.3535533905932737*dApardt[1]+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)-0.1767766952966368*alphav[27]+0.3061862178478971*(alphav[26]+alphav[23])+0.1767766952966368*alphav[22]-0.1767766952966368*alphav[21]+0.1767766952966368*alphav[20]-0.3061862178478971*alphav[19]+0.3061862178478971*alphav[18]-0.3061862178478971*alphav[17]+0.1767766952966368*alphav[16]-0.3061862178478971*alphav[15]+0.1767766952966368*alphav[14]-0.1767766952966368*alphav[13]+0.1767766952966368*alphav[12]-0.3061862178478971*alphav[11]+0.3061862178478971*alphav[10]-0.3061862178478971*alphav[9]-0.1767766952966368*alphav[8]+0.1767766952966368*alphav[7]-0.1767766952966368*(alphav[6]+alphav[5])+0.3061862178478971*alphav[4]-0.1767766952966368*alphav[3]+0.1767766952966368*alphav[2]-0.1767766952966368*alphav[1]+0.1767766952966368*alphav[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*((-0.3535533905932737*(dApardt[7]+dApardt[6]+dApardt[5]))+0.3535533905932737*dApardt[4]-0.3535533905932737*dApardt[3]+0.3535533905932737*(dApardt[2]+dApardt[1]+dApardt[0]))*dfac_v*q_)/m_)+0.1767766952966368*alphav[27]-0.3061862178478971*(alphav[26]+alphav[23])+0.1767766952966368*(alphav[22]+alphav[21])-0.1767766952966368*alphav[20]-0.3061862178478971*(alphav[19]+alphav[18])+0.3061862178478971*alphav[17]-0.1767766952966368*alphav[16]-0.3061862178478971*alphav[15]+0.1767766952966368*alphav[14]-0.1767766952966368*(alphav[13]+alphav[12])-0.3061862178478971*alphav[11]+0.3061862178478971*(alphav[10]+alphav[9])-0.1767766952966368*(alphav[8]+alphav[7])+0.1767766952966368*alphav[6]-0.1767766952966368*alphav[5]+0.3061862178478971*alphav[4]-0.1767766952966368*alphav[3]+0.1767766952966368*(alphav[2]+alphav[1]+alphav[0])); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*(0.3535533905932737*dApardt[7]-0.3535533905932737*(dApardt[6]+dApardt[5])+0.3535533905932737*(dApardt[4]+dApardt[3])-0.3535533905932737*(dApardt[2]+dApardt[1])+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)-0.1767766952966368*alphav[27]+0.3061862178478971*(alphav[26]+alphav[23])+0.1767766952966368*(alphav[22]+alphav[21])-0.1767766952966368*alphav[20]-0.3061862178478971*(alphav[19]+alphav[18])+0.3061862178478971*alphav[17]+0.1767766952966368*alphav[16]-0.3061862178478971*alphav[15]-0.1767766952966368*alphav[14]+0.1767766952966368*(alphav[13]+alphav[12])+0.3061862178478971*alphav[11]-0.3061862178478971*(alphav[10]+alphav[9])-0.1767766952966368*(alphav[8]+alphav[7])+0.1767766952966368*alphav[6]-0.1767766952966368*alphav[5]+0.3061862178478971*alphav[4]+0.1767766952966368*alphav[3]-0.1767766952966368*(alphav[2]+alphav[1])+0.1767766952966368*alphav[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*((-0.3535533905932737*(dApardt[7]+dApardt[6]))+0.3535533905932737*dApardt[5]-0.3535533905932737*dApardt[4]+0.3535533905932737*dApardt[3]-0.3535533905932737*dApardt[2]+0.3535533905932737*(dApardt[1]+dApardt[0]))*dfac_v*q_)/m_)+0.1767766952966368*alphav[27]-0.3061862178478971*(alphav[26]+alphav[23])+0.1767766952966368*alphav[22]-0.1767766952966368*alphav[21]+0.1767766952966368*alphav[20]-0.3061862178478971*alphav[19]+0.3061862178478971*alphav[18]-0.3061862178478971*alphav[17]-0.1767766952966368*alphav[16]-0.3061862178478971*alphav[15]-0.1767766952966368*alphav[14]+0.1767766952966368*alphav[13]-0.1767766952966368*alphav[12]+0.3061862178478971*alphav[11]-0.3061862178478971*alphav[10]+0.3061862178478971*alphav[9]-0.1767766952966368*alphav[8]+0.1767766952966368*alphav[7]-0.1767766952966368*(alphav[6]+alphav[5])+0.3061862178478971*alphav[4]+0.1767766952966368*alphav[3]-0.1767766952966368*alphav[2]+0.1767766952966368*(alphav[1]+alphav[0])); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*((-0.3535533905932737*dApardt[7])+0.3535533905932737*dApardt[6]-0.3535533905932737*(dApardt[5]+dApardt[4])+0.3535533905932737*(dApardt[3]+dApardt[2])-0.3535533905932737*dApardt[1]+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)+0.1767766952966368*alphav[27]-0.3061862178478971*alphav[26]+0.3061862178478971*alphav[23]-0.1767766952966368*alphav[22]+0.1767766952966368*(alphav[21]+alphav[20])+0.3061862178478971*alphav[19]-0.3061862178478971*(alphav[18]+alphav[17])-0.1767766952966368*alphav[16]-0.3061862178478971*alphav[15]-0.1767766952966368*(alphav[14]+alphav[13])+0.1767766952966368*alphav[12]+0.3061862178478971*(alphav[11]+alphav[10])-0.3061862178478971*alphav[9]+0.1767766952966368*alphav[8]-0.1767766952966368*(alphav[7]+alphav[6]+alphav[5])+0.3061862178478971*alphav[4]+0.1767766952966368*(alphav[3]+alphav[2])-0.1767766952966368*alphav[1]+0.1767766952966368*alphav[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(0.3535533905932737*(dApardt[7]+dApardt[6]+dApardt[5]+dApardt[4]+dApardt[3]+dApardt[2]+dApardt[1]+dApardt[0])*dfac_v*q_)/m_)-0.1767766952966368*alphav[27]+0.3061862178478971*alphav[26]-0.3061862178478971*alphav[23]-0.1767766952966368*(alphav[22]+alphav[21]+alphav[20])+0.3061862178478971*(alphav[19]+alphav[18]+alphav[17])+0.1767766952966368*alphav[16]-0.3061862178478971*alphav[15]-0.1767766952966368*(alphav[14]+alphav[13]+alphav[12])+0.3061862178478971*(alphav[11]+alphav[10]+alphav[9])+0.1767766952966368*(alphav[8]+alphav[7]+alphav[6])-0.1767766952966368*alphav[5]+0.3061862178478971*alphav[4]+0.1767766952966368*(alphav[3]+alphav[2]+alphav[1]+alphav[0])); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*((-0.3535533905932737*dApardt[7])+0.3535533905932737*(dApardt[6]+dApardt[5]+dApardt[4])-0.3535533905932737*(dApardt[3]+dApardt[2]+dApardt[1])+0.3535533905932737*dApardt[0])*dfac_v*q_)/m_)-0.1767766952966368*alphav[27]-0.3061862178478971*(alphav[26]+alphav[23])+0.1767766952966368*(alphav[22]+alphav[21]+alphav[20])+0.3061862178478971*(alphav[19]+alphav[18]+alphav[17])-0.1767766952966368*alphav[16]+0.3061862178478971*alphav[15]-0.1767766952966368*(alphav[14]+alphav[13]+alphav[12])-0.3061862178478971*(alphav[11]+alphav[10]+alphav[9])+0.1767766952966368*(alphav[8]+alphav[7]+alphav[6]+alphav[5])+0.3061862178478971*alphav[4]-0.1767766952966368*(alphav[3]+alphav[2]+alphav[1])+0.1767766952966368*alphav[0]); 
  cflFreq += 0.5*(alphaR+std::abs(alphaR)); 
  alphaR = 0.03125*((-(1.0*(0.3535533905932737*(dApardt[7]+dApardt[6])-0.3535533905932737*(dApardt[5]+dApardt[4]+dApardt[3]+dApardt[2])+0.3535533905932737*(dApardt[1]+dApardt[0]))*dfac_v*q_)/m_)+0.1767766952966368*alphav[27]+0.3061862178478971*(alphav[26]+alphav[23])+0.1767766952966368*alphav[22]-0.1767766952966368*(alphav[21]+alphav[20])+0.3061862178478971*alphav[19]-0.3061862178478971*(alphav[18]+alphav[17])+0.1767766952966368*alphav[16]+0.3061862178478971*alphav[15]-0.1767766952966368*(alphav[14]+alphav[13])+0.1767766952966368*alphav[12]-0.3061862178478971*(alphav[11]+alphav[10])+0.3061862178478971*alphav[9]+0.1767766952966368*alphav[8]-0.1767766952966368*(alphav[7]+alphav[6])+0.1767766952966368*alphav[5]+0.3061862178478971*alphav[4]-0.1767766952966368*(alphav[3]+alphav[2])+0.1767766952966368*(alphav[1]+alphav[0])); 
