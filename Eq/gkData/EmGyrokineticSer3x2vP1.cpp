...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  out[6] += 0.3061862178478971*(alphax[7]*f[16]+f[7]*alphax[16]+alphax[4]*f[10]+alphax[3]*f[8]+f[3]*alphax[8]+alphax[1]*f[6]+f[1]*alphax[6]+alphax[0]*f[2]+f[0]*alphax[2]); 
  out[7] += 0.3061862178478971*(alphax[6]*f[16]+f[6]*alphax[16]+alphax[4]*f[11]+alphax[2]*f[8]+f[2]*alphax[8]+alphax[1]*f[7]+f[1]*alphax[7]+alphax[0]*f[3]+f[0]*alphax[3]); 
  out[9] += 0.3061862178478971*(alphax[16]*f[26]+alphax[8]*f[19]+alphax[7]*f[18]+alphax[6]*f[17]+alphax[3]*f[11]+alphax[2]*f[10]+alphax[1]*f[9]+alphax[0]*f[4]+f[0]*alphax[4]); 
  ...
  out[16] += 0.3061862178478971*(alphax[4]*f[19]+alphax[1]*f[16]+f[1]*alphax[16]+alphax[0]*f[8]+f[0]*alphax[8]+alphax[6]*f[7]+f[6]*alphax[7]+alphax[2]*f[3]+f[2]*alphax[3]); 
  out[17] += 0.3061862178478971*(alphax[7]*f[26]+alphax[3]*f[19]+alphax[16]*f[18]+alphax[1]*f[17]+alphax[8]*f[11]+alphax[0]*f[10]+alphax[6]*f[9]+alphax[2]*f[4]+f[2]*alphax[4]); 
  out[18] += 0.3061862178478971*(alphax[6]*f[26]+alphax[2]*f[19]+alphax[1]*f[18]+alphax[16]*f[17]+alphax[0]*f[11]+alphax[8]*f[10]+alphax[7]*f[9]+alphax[3]*f[4]+f[3]*alphax[4]); 
  out[20] += 0.3061862178478971*(alphax[7]*f[27]+alphax[4]*f[24]+alphax[3]*f[22]+alphax[16]*f[21]+alphax[1]*f[20]+alphax[8]*f[14]+alphax[0]*f[13]+alphax[6]*f[12]+alphax[2]*f[5]); 
  out[21] += 0.3061862178478971*(alphax[6]*f[27]+alphax[4]*f[25]+alphax[2]*f[22]+alphax[1]*f[21]+alphax[16]*f[20]+alphax[0]*f[14]+alphax[8]*f[13]+alphax[7]*f[12]+alphax[3]*f[5]); 
  out[23] += 0.3061862178478971*(alphax[16]*f[31]+alphax[8]*f[30]+alphax[7]*f[29]+alphax[6]*f[28]+alphax[3]*f[25]+alphax[2]*f[24]+alphax[1]*f[23]+alphax[0]*f[15]+alphax[4]*f[5]); 
  out[26] += 0.3061862178478971*(alphax[1]*f[26]+alphax[0]*f[19]+alphax[6]*f[18]+alphax[7]*f[17]+f[9]*alphax[16]+alphax[2]*f[11]+alphax[3]*f[10]+alphax[4]*f[8]+f[4]*alphax[8]); 
  out[27] += 0.3061862178478971*(alphax[4]*f[30]+alphax[1]*f[27]+alphax[0]*f[22]+alphax[6]*f[21]+alphax[7]*f[20]+f[12]*alphax[16]+alphax[2]*f[14]+alphax[3]*f[13]+f[5]*alphax[8]); 
  out[28] += 0.3061862178478971*(alphax[7]*f[31]+alphax[3]*f[30]+alphax[16]*f[29]+alphax[1]*f[28]+alphax[8]*f[25]+alphax[0]*f[24]+alphax[6]*f[23]+alphax[2]*f[15]+alphax[4]*f[13]); 
  out[29] += 0.3061862178478971*(alphax[6]*f[31]+alphax[2]*f[30]+alphax[1]*f[29]+alphax[16]*f[28]+alphax[0]*f[25]+alphax[8]*f[24]+alphax[7]*f[23]+alphax[3]*f[15]+alphax[4]*f[14]); 
  out[31] += 0.3061862178478971*(alphax[1]*f[31]+alphax[0]*f[30]+alphax[6]*f[29]+alphax[7]*f[28]+alphax[2]*f[25]+alphax[3]*f[24]+alphax[16]*f[23]+alphax[4]*f[22]+alphax[8]*f[15]); 
  double alphay[32]; 
  ...
  out[6] += 0.3061862178478971*(alphay[8]*f[16]+f[8]*alphay[16]+alphay[4]*f[9]+alphay[3]*f[7]+f[3]*alphay[7]+alphay[2]*f[6]+f[2]*alphay[6]+alphay[0]*f[1]+f[0]*alphay[1]); 
  out[8] += 0.3061862178478971*(alphay[6]*f[16]+f[6]*alphay[16]+alphay[4]*f[11]+alphay[2]*f[8]+f[2]*alphay[8]+alphay[1]*f[7]+f[1]*alphay[7]+alphay[0]*f[3]+f[0]*alphay[3]); 
  out[10] += 0.3061862178478971*(alphay[16]*f[26]+alphay[8]*f[19]+alphay[7]*f[18]+alphay[6]*f[17]+alphay[3]*f[11]+alphay[2]*f[10]+alphay[1]*f[9]+alphay[0]*f[4]+f[0]*alphay[4]); 
  ...
  out[16] += 0.3061862178478971*(alphay[4]*f[18]+alphay[2]*f[16]+f[2]*alphay[16]+alphay[6]*f[8]+f[6]*alphay[8]+alphay[0]*f[7]+f[0]*alphay[7]+alphay[1]*f[3]+f[1]*alphay[3]); 
  out[17] += 0.3061862178478971*(alphay[8]*f[26]+alphay[16]*f[19]+alphay[3]*f[18]+alphay[2]*f[17]+alphay[7]*f[11]+alphay[6]*f[10]+alphay[0]*f[9]+alphay[1]*f[4]+f[1]*alphay[4]); 
  out[19] += 0.3061862178478971*(alphay[6]*f[26]+alphay[2]*f[19]+alphay[1]*f[18]+alphay[16]*f[17]+alphay[0]*f[11]+alphay[8]*f[10]+alphay[7]*f[9]+alphay[3]*f[4]+f[3]*alphay[4]); 
  out[20] += 0.3061862178478971*(alphay[8]*f[27]+alphay[4]*f[23]+alphay[16]*f[22]+alphay[3]*f[21]+alphay[2]*f[20]+alphay[7]*f[14]+alphay[6]*f[13]+alphay[0]*f[12]+alphay[1]*f[5]); 
  out[22] += 0.3061862178478971*(alphay[6]*f[27]+alphay[4]*f[25]+alphay[2]*f[22]+alphay[1]*f[21]+alphay[16]*f[20]+alphay[0]*f[14]+alphay[8]*f[13]+alphay[7]*f[12]+alphay[3]*f[5]); 
  out[24] += 0.3061862178478971*(alphay[16]*f[31]+alphay[8]*f[30]+alphay[7]*f[29]+alphay[6]*f[28]+alphay[3]*f[25]+alphay[2]*f[24]+alphay[1]*f[23]+alphay[0]*f[15]+alphay[4]*f[5]); 
  out[26] += 0.3061862178478971*(alphay[2]*f[26]+alphay[6]*f[19]+alphay[0]*f[18]+alphay[8]*f[17]+f[10]*alphay[16]+alphay[1]*f[11]+alphay[3]*f[9]+alphay[4]*f[7]+f[4]*alphay[7]); 
  out[27] += 0.3061862178478971*(alphay[4]*f[29]+alphay[2]*f[27]+alphay[6]*f[22]+alphay[0]*f[21]+alphay[8]*f[20]+f[13]*alphay[16]+alphay[1]*f[14]+alphay[3]*f[12]+f[5]*alphay[7]); 
  out[28] += 0.3061862178478971*(alphay[8]*f[31]+alphay[16]*f[30]+alphay[3]*f[29]+alphay[2]*f[28]+alphay[7]*f[25]+alphay[6]*f[24]+alphay[0]*f[23]+alphay[1]*f[15]+alphay[4]*f[12]); 
  out[30] += 0.3061862178478971*(alphay[6]*f[31]+alphay[2]*f[30]+alphay[1]*f[29]+alphay[16]*f[28]+alphay[0]*f[25]+alphay[8]*f[24]+alphay[7]*f[23]+alphay[3]*f[15]+alphay[4]*f[14]); 
  out[31] += 0.3061862178478971*(alphay[2]*f[31]+alphay[6]*f[30]+alphay[0]*f[29]+alphay[8]*f[28]+alphay[1]*f[25]+alphay[16]*f[24]+alphay[3]*f[23]+alphay[4]*f[21]+alphay[7]*f[15]); 
  double alphaz[32]; 
  ...
  out[7] += 0.3061862178478971*alphaz[0]*f[1]; 
  out[8] += 0.3061862178478971*alphaz[0]*f[2]; 
  out[11] += 0.3061862178478971*alphaz[0]*f[4]; 
  out[14] += 0.3061862178478971*alphaz[0]*f[5]; 
  out[16] += 0.3061862178478971*alphaz[0]*f[6]; 
  out[18] += 0.3061862178478971*alphaz[0]*f[9]; 
  out[19] += 0.3061862178478971*alphaz[0]*f[10]; 
  out[21] += 0.3061862178478971*alphaz[0]*f[12]; 
  out[22] += 0.3061862178478971*alphaz[0]*f[13]; 
  out[25] += 0.3061862178478971*alphaz[0]*f[15]; 
  out[26] += 0.3061862178478971*alphaz[0]*f[17]; 
  out[27] += 0.3061862178478971*alphaz[0]*f[20]; 
  out[29] += 0.3061862178478971*alphaz[0]*f[23]; 
  out[30] += 0.3061862178478971*alphaz[0]*f[24]; 
  out[31] += 0.3061862178478971*alphaz[0]*f[28]; 
  double alphav[32]; 
  ...
  out[9] += 0.3061862178478971*(alphav[19]*f[26]+alphav[11]*f[18]+f[11]*alphav[18]+alphav[10]*f[17]+alphav[8]*f[16]+f[8]*alphav[16]+alphav[4]*f[9]+f[4]*alphav[9]+alphav[3]*f[7]+f[3]*alphav[7]+alphav[2]*f[6]+f[2]*alphav[6]+alphav[0]*f[1]+f[0]*alphav[1]); 
  out[10] += 0.3061862178478971*(alphav[18]*f[26]+alphav[11]*f[19]+f[11]*alphav[19]+alphav[9]*f[17]+alphav[7]*f[16]+f[7]*alphav[16]+alphav[4]*f[10]+f[4]*alphav[10]+alphav[3]*f[8]+f[3]*alphav[8]+alphav[1]*f[6]+f[1]*alphav[6]+alphav[0]*f[2]+f[0]*alphav[2]); 
  out[11] += 0.3061862178478971*(alphav[10]*f[19]+f[10]*alphav[19]+alphav[9]*f[18]+f[9]*alphav[18]+alphav[6]*f[16]+f[6]*alphav[16]+alphav[4]*f[11]+f[4]*alphav[11]+alphav[2]*f[8]+f[2]*alphav[8]+alphav[1]*f[7]+f[1]*alphav[7]+alphav[0]*f[3]+f[0]*alphav[3]); 
  ...
  out[17] += 0.3061862178478971*(alphav[11]*f[26]+alphav[18]*f[19]+f[18]*alphav[19]+alphav[4]*f[17]+alphav[3]*f[16]+f[3]*alphav[16]+alphav[9]*f[10]+f[9]*alphav[10]+alphav[7]*f[8]+f[7]*alphav[8]+alphav[0]*f[6]+f[0]*alphav[6]+alphav[1]*f[2]+f[1]*alphav[2]); 
  out[18] += 0.3061862178478971*(alphav[10]*f[26]+f[17]*alphav[19]+alphav[4]*f[18]+f[4]*alphav[18]+alphav[2]*f[16]+f[2]*alphav[16]+alphav[9]*f[11]+f[9]*alphav[11]+alphav[6]*f[8]+f[6]*alphav[8]+alphav[0]*f[7]+f[0]*alphav[7]+alphav[1]*f[3]+f[1]*alphav[3]); 
  out[19] += 0.3061862178478971*(alphav[9]*f[26]+alphav[4]*f[19]+f[4]*alphav[19]+f[17]*alphav[18]+alphav[1]*f[16]+f[1]*alphav[16]+alphav[10]*f[11]+f[10]*alphav[11]+alphav[0]*f[8]+f[0]*alphav[8]+alphav[6]*f[7]+f[6]*alphav[7]+alphav[2]*f[3]+f[2]*alphav[3]); 
  out[23] += 0.3061862178478971*(alphav[19]*f[31]+alphav[11]*f[29]+alphav[10]*f[28]+alphav[8]*f[27]+alphav[18]*f[25]+alphav[4]*f[23]+alphav[16]*f[22]+alphav[3]*f[21]+alphav[2]*f[20]+alphav[9]*f[15]+alphav[7]*f[14]+alphav[6]*f[13]+alphav[0]*f[12]+alphav[1]*f[5]); 
  out[24] += 0.3061862178478971*(alphav[18]*f[31]+alphav[11]*f[30]+alphav[9]*f[28]+alphav[7]*f[27]+alphav[19]*f[25]+alphav[4]*f[24]+alphav[3]*f[22]+alphav[16]*f[21]+alphav[1]*f[20]+alphav[10]*f[15]+alphav[8]*f[14]+alphav[0]*f[13]+alphav[6]*f[12]+alphav[2]*f[5]); 
  out[25] += 0.3061862178478971*(alphav[10]*f[30]+alphav[9]*f[29]+alphav[6]*f[27]+alphav[4]*f[25]+alphav[19]*f[24]+alphav[18]*f[23]+alphav[2]*f[22]+alphav[1]*f[21]+alphav[16]*f[20]+alphav[11]*f[15]+alphav[0]*f[14]+alphav[8]*f[13]+alphav[7]*f[12]+alphav[3]*f[5]); 
  out[26] += 0.3061862178478971*(alphav[4]*f[26]+alphav[9]*f[19]+f[9]*alphav[19]+alphav[10]*f[18]+f[10]*alphav[18]+alphav[11]*f[17]+alphav[0]*f[16]+f[0]*alphav[16]+alphav[1]*f[8]+f[1]*alphav[8]+alphav[2]*f[7]+f[2]*alphav[7]+alphav[3]*f[6]+f[3]*alphav[6]); 
  out[28] += 0.3061862178478971*(alphav[11]*f[31]+alphav[18]*f[30]+alphav[19]*f[29]+alphav[4]*f[28]+alphav[3]*f[27]+alphav[9]*f[24]+alphav[10]*f[23]+alphav[7]*f[22]+alphav[8]*f[21]+alphav[0]*f[20]+f[14]*alphav[16]+alphav[1]*f[13]+alphav[2]*f[12]+f[5]*alphav[6]); 
  out[29] += 0.3061862178478971*(alphav[10]*f[31]+alphav[4]*f[29]+alphav[19]*f[28]+alphav[2]*f[27]+alphav[9]*f[25]+alphav[11]*f[23]+alphav[6]*f[22]+alphav[0]*f[21]+alphav[8]*f[20]+f[15]*alphav[18]+f[13]*alphav[16]+alphav[1]*f[14]+alphav[3]*f[12]+f[5]*alphav[7]); 
  out[30] += 0.3061862178478971*(alphav[9]*f[31]+alphav[4]*f[30]+alphav[18]*f[28]+alphav[1]*f[27]+alphav[10]*f[25]+alphav[11]*f[24]+alphav[0]*f[22]+alphav[6]*f[21]+alphav[7]*f[20]+f[15]*alphav[19]+f[12]*alphav[16]+alphav[2]*f[14]+alphav[3]*f[13]+f[5]*alphav[8]); 
  out[31] += 0.3061862178478971*(alphav[4]*f[31]+alphav[9]*f[30]+alphav[10]*f[29]+alphav[11]*f[28]+alphav[0]*f[27]+alphav[18]*f[24]+alphav[19]*f[23]+alphav[1]*f[22]+alphav[2]*f[21]+alphav[3]*f[20]+f[5]*alphav[16]+alphav[6]*f[14]+alphav[7]*f[13]+alphav[8]*f[12]); 
  return cflRate; 
} 
...
{ 
  ...
  out[0] += -(0.3535533905932737*(dApardt[7]*ohmMod[16]+dApardt[6]*ohmMod[8]+dApardt[5]*ohmMod[7]+dApardt[4]*ohmMod[6]+dApardt[3]*ohmMod[3]+dApardt[2]*ohmMod[2]+dApardt[1]*ohmMod[1]+dApardt[0]*ohmMod[0])*q_)/m_; 
  out[1] += -(0.3535533905932737*(dApardt[6]*ohmMod[16]+dApardt[7]*ohmMod[8]+dApardt[3]*ohmMod[7]+dApardt[2]*ohmMod[6]+ohmMod[3]*dApardt[5]+ohmMod[2]*dApardt[4]+dApardt[0]*ohmMod[1]+ohmMod[0]*dApardt[1])*q_)/m_; 
  out[2] += -(0.3535533905932737*(dApardt[5]*ohmMod[16]+dApardt[3]*ohmMod[8]+dApardt[7]*ohmMod[7]+dApardt[1]*ohmMod[6]+ohmMod[3]*dApardt[6]+ohmMod[1]*dApardt[4]+dApardt[0]*ohmMod[2]+ohmMod[0]*dApardt[2])*q_)/m_; 
  out[3] += -(0.3535533905932737*(dApardt[4]*ohmMod[16]+dApardt[2]*ohmMod[8]+dApardt[1]*ohmMod[7]+ohmMod[6]*dApardt[7]+ohmMod[2]*dApardt[6]+ohmMod[1]*dApardt[5]+dApardt[0]*ohmMod[3]+ohmMod[0]*dApardt[3])*q_)/m_; 
  out[4] += -(0.3535533905932737*(dApardt[7]*ohmMod[26]+dApardt[6]*ohmMod[19]+dApardt[5]*ohmMod[18]+dApardt[4]*ohmMod[17]+dApardt[3]*ohmMod[11]+dApardt[2]*ohmMod[10]+dApardt[1]*ohmMod[9]+dApardt[0]*ohmMod[4])*q_)/m_; 
  out[5] += -(0.3535533905932737*(dApardt[7]*ohmMod[27]+dApardt[6]*ohmMod[22]+dApardt[5]*ohmMod[21]+dApardt[4]*ohmMod[20]+dApardt[3]*ohmMod[14]+dApardt[2]*ohmMod[13]+dApardt[1]*ohmMod[12]+dApardt[0]*ohmMod[5])*q_)/m_; 
  out[6] += -(0.3535533905932737*(dApardt[3]*ohmMod[16]+dApardt[5]*ohmMod[8]+dApardt[6]*ohmMod[7]+ohmMod[3]*dApardt[7]+dApardt[0]*ohmMod[6]+ohmMod[0]*dApardt[4]+dApardt[1]*ohmMod[2]+ohmMod[1]*dApardt[2])*q_)/m_; 
  out[7] += -(0.3535533905932737*(dApardt[2]*ohmMod[16]+dApardt[4]*ohmMod[8]+dApardt[0]*ohmMod[7]+ohmMod[2]*dApardt[7]+dApardt[6]*ohmMod[6]+ohmMod[0]*dApardt[5]+dApardt[1]*ohmMod[3]+ohmMod[1]*dApardt[3])*q_)/m_; 
  out[8] += -(0.3535533905932737*(dApardt[1]*ohmMod[16]+dApardt[0]*ohmMod[8]+dApardt[4]*ohmMod[7]+ohmMod[1]*dApardt[7]+dApardt[5]*ohmMod[6]+ohmMod[0]*dApardt[6]+dApardt[2]*ohmMod[3]+ohmMod[2]*dApardt[3])*q_)/m_; 
  out[9] += -(0.3535533905932737*(dApardt[6]*ohmMod[26]+dApardt[7]*ohmMod[19]+dApardt[3]*ohmMod[18]+dApardt[2]*ohmMod[17]+dApardt[5]*ohmMod[11]+dApardt[4]*ohmMod[10]+dApardt[0]*ohmMod[9]+dApardt[1]*ohmMod[4])*q_)/m_; 
  out[10] += -(0.3535533905932737*(dApardt[5]*ohmMod[26]+dApardt[3]*ohmMod[19]+dApardt[7]*ohmMod[18]+dApardt[1]*ohmMod[17]+dApardt[6]*ohmMod[11]+dApardt[0]*ohmMod[10]+dApardt[4]*ohmMod[9]+dApardt[2]*ohmMod[4])*q_)/m_; 
  out[11] += -(0.3535533905932737*(dApardt[4]*ohmMod[26]+dApardt[2]*ohmMod[19]+dApardt[1]*ohmMod[18]+dApardt[7]*ohmMod[17]+dApardt[0]*ohmMod[11]+dApardt[6]*ohmMod[10]+dApardt[5]*ohmMod[9]+dApardt[3]*ohmMod[4])*q_)/m_; 
  out[12] += -(0.3535533905932737*(dApardt[6]*ohmMod[27]+dApardt[7]*ohmMod[22]+dApardt[3]*ohmMod[21]+dApardt[2]*ohmMod[20]+dApardt[5]*ohmMod[14]+dApardt[4]*ohmMod[13]+dApardt[0]*ohmMod[12]+dApardt[1]*ohmMod[5])*q_)/m_; 
  out[13] += -(0.3535533905932737*(dApardt[5]*ohmMod[27]+dApardt[3]*ohmMod[22]+dApardt[7]*ohmMod[21]+dApardt[1]*ohmMod[20]+dApardt[6]*ohmMod[14]+dApardt[0]*ohmMod[13]+dApardt[4]*ohmMod[12]+dApardt[2]*ohmMod[5])*q_)/m_; 
  out[14] += -(0.3535533905932737*(dApardt[4]*ohmMod[27]+dApardt[2]*ohmMod[22]+dApardt[1]*ohmMod[21]+dApardt[7]*ohmMod[20]+dApardt[0]*ohmMod[14]+dApardt[6]*ohmMod[13]+dApardt[5]*ohmMod[12]+dApardt[3]*ohmMod[5])*q_)/m_; 
  out[15] += -(0.3535533905932737*(dApardt[7]*ohmMod[31]+dApardt[6]*ohmMod[30]+dApardt[5]*ohmMod[29]+dApardt[4]*ohmMod[28]+dApardt[3]*ohmMod[25]+dApardt[2]*ohmMod[24]+dApardt[1]*ohmMod[23]+dApardt[0]*ohmMod[15])*q_)/m_; 
  out[16] += -(0.3535533905932737*(dApardt[0]*ohmMod[16]+dApardt[1]*ohmMod[8]+dApardt[2]*ohmMod[7]+ohmMod[0]*dApardt[7]+dApardt[3]*ohmMod[6]+ohmMod[1]*dApardt[6]+ohmMod[2]*dApardt[5]+ohmMod[3]*dApardt[4])*q_)/m_; 
  out[17] += -(0.3535533905932737*(dApardt[3]*ohmMod[26]+dApardt[5]*ohmMod[19]+dApardt[6]*ohmMod[18]+dApardt[0]*ohmMod[17]+dApardt[7]*ohmMod[11]+dApardt[1]*ohmMod[10]+dApardt[2]*ohmMod[9]+dApardt[4]*ohmMod[4])*q_)/m_; 
  out[18] += -(0.3535533905932737*(dApardt[2]*ohmMod[26]+dApardt[4]*ohmMod[19]+dApardt[0]*ohmMod[18]+dApardt[6]*ohmMod[17]+dApardt[1]*ohmMod[11]+dApardt[7]*ohmMod[10]+dApardt[3]*ohmMod[9]+ohmMod[4]*dApardt[5])*q_)/m_; 
  out[19] += -(0.3535533905932737*(dApardt[1]*ohmMod[26]+dApardt[0]*ohmMod[19]+dApardt[4]*ohmMod[18]+dApardt[5]*ohmMod[17]+dApardt[2]*ohmMod[11]+dApardt[3]*ohmMod[10]+dApardt[7]*ohmMod[9]+ohmMod[4]*dApardt[6])*q_)/m_; 
  out[20] += -(0.3535533905932737*(dApardt[3]*ohmMod[27]+dApardt[5]*ohmMod[22]+dApardt[6]*ohmMod[21]+dApardt[0]*ohmMod[20]+dApardt[7]*ohmMod[14]+dApardt[1]*ohmMod[13]+dApardt[2]*ohmMod[12]+dApardt[4]*ohmMod[5])*q_)/m_; 
  out[21] += -(0.3535533905932737*(dApardt[2]*ohmMod[27]+dApardt[4]*ohmMod[22]+dApardt[0]*ohmMod[21]+dApardt[6]*ohmMod[20]+dApardt[1]*ohmMod[14]+dApardt[7]*ohmMod[13]+dApardt[3]*ohmMod[12]+dApardt[5]*ohmMod[5])*q_)/m_; 
  out[22] += -(0.3535533905932737*(dApardt[1]*ohmMod[27]+dApardt[0]*ohmMod[22]+dApardt[4]*ohmMod[21]+dApardt[5]*ohmMod[20]+dApardt[2]*ohmMod[14]+dApardt[3]*ohmMod[13]+dApardt[7]*ohmMod[12]+ohmMod[5]*dApardt[6])*q_)/m_; 
  out[23] += -(0.3535533905932737*(dApardt[6]*ohmMod[31]+dApardt[7]*ohmMod[30]+dApardt[3]*ohmMod[29]+dApardt[2]*ohmMod[28]+dApardt[5]*ohmMod[25]+dApardt[4]*ohmMod[24]+dApardt[0]*ohmMod[23]+dApardt[1]*ohmMod[15])*q_)/m_; 
  out[24] += -(0.3535533905932737*(dApardt[5]*ohmMod[31]+dApardt[3]*ohmMod[30]+dApardt[7]*ohmMod[29]+dApardt[1]*ohmMod[28]+dApardt[6]*ohmMod[25]+dApardt[0]*ohmMod[24]+dApardt[4]*ohmMod[23]+dApardt[2]*ohmMod[15])*q_)/m_; 
  out[25] += -(0.3535533905932737*(dApardt[4]*ohmMod[31]+dApardt[2]*ohmMod[30]+dApardt[1]*ohmMod[29]+dApardt[7]*ohmMod[28]+dApardt[0]*ohmMod[25]+dApardt[6]*ohmMod[24]+dApardt[5]*ohmMod[23]+dApardt[3]*ohmMod[15])*q_)/m_; 
  out[26] += -(0.3535533905932737*(dApardt[0]*ohmMod[26]+dApardt[1]*ohmMod[19]+dApardt[2]*ohmMod[18]+dApardt[3]*ohmMod[17]+dApardt[4]*ohmMod[11]+dApardt[5]*ohmMod[10]+dApardt[6]*ohmMod[9]+ohmMod[4]*dApardt[7])*q_)/m_; 
  out[27] += -(0.3535533905932737*(dApardt[0]*ohmMod[27]+dApardt[1]*ohmMod[22]+dApardt[2]*ohmMod[21]+dApardt[3]*ohmMod[20]+dApardt[4]*ohmMod[14]+dApardt[5]*ohmMod[13]+dApardt[6]*ohmMod[12]+ohmMod[5]*dApardt[7])*q_)/m_; 
  out[28] += -(0.3535533905932737*(dApardt[3]*ohmMod[31]+dApardt[5]*ohmMod[30]+dApardt[6]*ohmMod[29]+dApardt[0]*ohmMod[28]+dApardt[7]*ohmMod[25]+dApardt[1]*ohmMod[24]+dApardt[2]*ohmMod[23]+dApardt[4]*ohmMod[15])*q_)/m_; 
  out[29] += -(0.3535533905932737*(dApardt[2]*ohmMod[31]+dApardt[4]*ohmMod[30]+dApardt[0]*ohmMod[29]+dApardt[6]*ohmMod[28]+dApardt[1]*ohmMod[25]+dApardt[7]*ohmMod[24]+dApardt[3]*ohmMod[23]+dApardt[5]*ohmMod[15])*q_)/m_; 
  out[30] += -(0.3535533905932737*(dApardt[1]*ohmMod[31]+dApardt[0]*ohmMod[30]+dApardt[4]*ohmMod[29]+dApardt[5]*ohmMod[28]+dApardt[2]*ohmMod[25]+dApardt[3]*ohmMod[24]+dApardt[7]*ohmMod[23]+dApardt[6]*ohmMod[15])*q_)/m_; 
  out[31] += -(0.3535533905932737*(dApardt[0]*ohmMod[31]+dApardt[1]*ohmMod[30]+dApardt[2]*ohmMod[29]+dApardt[3]*ohmMod[28]+dApardt[4]*ohmMod[25]+dApardt[5]*ohmMod[24]+dApardt[6]*ohmMod[23]+dApardt[7]*ohmMod[15])*q_)/m_; 
  double cflRate = 0.0; 
  double alphaL = 0.0; 
  double alphaR = 0.0; 
#if cflType == SURFAVG 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  out[6] += 0.3061862178478971*(alphax[9]*f[17]+alphax[7]*f[16]+f[7]*alphax[16]+alphax[4]*f[10]+alphax[3]*f[8]+f[3]*alphax[8]+alphax[1]*f[6]+f[1]*alphax[6]+alphax[0]*f[2]+f[0]*alphax[2]); 
  out[7] += 0.3061862178478971*(alphax[9]*f[18]+alphax[6]*f[16]+f[6]*alphax[16]+alphax[4]*f[11]+alphax[2]*f[8]+f[2]*alphax[8]+alphax[1]*f[7]+f[1]*alphax[7]+alphax[0]*f[3]+f[0]*alphax[3]); 
  out[9] += 0.3061862178478971*(alphax[16]*f[26]+alphax[8]*f[19]+alphax[7]*f[18]+alphax[6]*f[17]+alphax[3]*f[11]+alphax[2]*f[10]+alphax[1]*f[9]+f[1]*alphax[9]+alphax[0]*f[4]+f[0]*alphax[4]); 
  ...
  out[16] += 0.3061862178478971*(alphax[9]*f[26]+alphax[4]*f[19]+alphax[1]*f[16]+f[1]*alphax[16]+alphax[0]*f[8]+f[0]*alphax[8]+alphax[6]*f[7]+f[6]*alphax[7]+alphax[2]*f[3]+f[2]*alphax[3]); 
  out[17] += 0.3061862178478971*(alphax[7]*f[26]+alphax[3]*f[19]+alphax[16]*f[18]+alphax[1]*f[17]+alphax[8]*f[11]+alphax[0]*f[10]+alphax[6]*f[9]+f[6]*alphax[9]+alphax[2]*f[4]+f[2]*alphax[4]); 
  out[18] += 0.3061862178478971*(alphax[6]*f[26]+alphax[2]*f[19]+alphax[1]*f[18]+alphax[16]*f[17]+alphax[0]*f[11]+alphax[8]*f[10]+alphax[7]*f[9]+f[7]*alphax[9]+alphax[3]*f[4]+f[3]*alphax[4]); 
  out[20] += 0.3061862178478971*(alphax[9]*f[28]+alphax[7]*f[27]+alphax[4]*f[24]+alphax[3]*f[22]+alphax[16]*f[21]+alphax[1]*f[20]+alphax[8]*f[14]+alphax[0]*f[13]+alphax[6]*f[12]+alphax[2]*f[5]); 
  out[21] += 0.3061862178478971*(alphax[9]*f[29]+alphax[6]*f[27]+alphax[4]*f[25]+alphax[2]*f[22]+alphax[1]*f[21]+alphax[16]*f[20]+alphax[0]*f[14]+alphax[8]*f[13]+alphax[7]*f[12]+alphax[3]*f[5]); 
  out[23] += 0.3061862178478971*(alphax[16]*f[31]+alphax[8]*f[30]+alphax[7]*f[29]+alphax[6]*f[28]+alphax[3]*f[25]+alphax[2]*f[24]+alphax[1]*f[23]+alphax[0]*f[15]+alphax[9]*f[12]+alphax[4]*f[5]); 
  out[26] += 0.3061862178478971*(alphax[1]*f[26]+alphax[0]*f[19]+alphax[6]*f[18]+alphax[7]*f[17]+alphax[9]*f[16]+f[9]*alphax[16]+alphax[2]*f[11]+alphax[3]*f[10]+alphax[4]*f[8]+f[4]*alphax[8]); 
  out[27] += 0.3061862178478971*(alphax[9]*f[31]+alphax[4]*f[30]+alphax[1]*f[27]+alphax[0]*f[22]+alphax[6]*f[21]+alphax[7]*f[20]+f[12]*alphax[16]+alphax[2]*f[14]+alphax[3]*f[13]+f[5]*alphax[8]); 
  out[28] += 0.3061862178478971*(alphax[7]*f[31]+alphax[3]*f[30]+alphax[16]*f[29]+alphax[1]*f[28]+alphax[8]*f[25]+alphax[0]*f[24]+alphax[6]*f[23]+alphax[9]*f[20]+alphax[2]*f[15]+alphax[4]*f[13]); 
  out[29] += 0.3061862178478971*(alphax[6]*f[31]+alphax[2]*f[30]+alphax[1]*f[29]+alphax[16]*f[28]+alphax[0]*f[25]+alphax[8]*f[24]+alphax[7]*f[23]+alphax[9]*f[21]+alphax[3]*f[15]+alphax[4]*f[14]); 
  out[31] += 0.3061862178478971*(alphax[1]*f[31]+alphax[0]*f[30]+alphax[6]*f[29]+alphax[7]*f[28]+alphax[9]*f[27]+alphax[2]*f[25]+alphax[3]*f[24]+alphax[16]*f[23]+alphax[4]*f[22]+alphax[8]*f[15]); 
  double alphay[32]; 
  ...
  out[6] += 0.3061862178478971*(alphay[8]*f[16]+f[8]*alphay[16]+alphay[5]*f[12]+f[5]*alphay[12]+alphay[4]*f[9]+f[4]*alphay[9]+alphay[3]*f[7]+f[3]*alphay[7]+alphay[2]*f[6]+f[2]*alphay[6]+alphay[0]*f[1]+f[0]*alphay[1]); 
  out[8] += 0.3061862178478971*(alphay[12]*f[21]+alphay[9]*f[18]+alphay[6]*f[16]+f[6]*alphay[16]+alphay[5]*f[14]+alphay[4]*f[11]+alphay[2]*f[8]+f[2]*alphay[8]+alphay[1]*f[7]+f[1]*alphay[7]+alphay[0]*f[3]+f[0]*alphay[3]); 
  out[10] += 0.3061862178478971*(alphay[16]*f[26]+alphay[12]*f[23]+alphay[8]*f[19]+alphay[7]*f[18]+alphay[6]*f[17]+alphay[5]*f[15]+alphay[3]*f[11]+alphay[2]*f[10]+alphay[1]*f[9]+f[1]*alphay[9]+alphay[0]*f[4]+f[0]*alphay[4]); 
  ...
  out[16] += 0.3061862178478971*(alphay[5]*f[21]+alphay[4]*f[18]+alphay[2]*f[16]+f[2]*alphay[16]+alphay[12]*f[14]+alphay[9]*f[11]+alphay[6]*f[8]+f[6]*alphay[8]+alphay[0]*f[7]+f[0]*alphay[7]+alphay[1]*f[3]+f[1]*alphay[3]); 
  out[17] += 0.3061862178478971*(alphay[8]*f[26]+alphay[5]*f[23]+alphay[16]*f[19]+alphay[3]*f[18]+alphay[2]*f[17]+alphay[12]*f[15]+alphay[7]*f[11]+alphay[6]*f[10]+alphay[0]*f[9]+f[0]*alphay[9]+alphay[1]*f[4]+f[1]*alphay[4]); 
  out[19] += 0.3061862178478971*(alphay[12]*f[29]+alphay[6]*f[26]+alphay[5]*f[25]+alphay[2]*f[19]+alphay[1]*f[18]+alphay[16]*f[17]+alphay[0]*f[11]+alphay[8]*f[10]+alphay[7]*f[9]+f[7]*alphay[9]+alphay[3]*f[4]+f[3]*alphay[4]); 
  out[20] += 0.3061862178478971*(alphay[8]*f[27]+alphay[4]*f[23]+alphay[16]*f[22]+alphay[3]*f[21]+alphay[2]*f[20]+alphay[9]*f[15]+alphay[7]*f[14]+alphay[6]*f[13]+alphay[0]*f[12]+f[0]*alphay[12]+alphay[1]*f[5]+f[1]*alphay[5]); 
  out[22] += 0.3061862178478971*(alphay[9]*f[29]+alphay[6]*f[27]+alphay[4]*f[25]+alphay[2]*f[22]+alphay[1]*f[21]+alphay[16]*f[20]+alphay[0]*f[14]+alphay[8]*f[13]+alphay[7]*f[12]+f[7]*alphay[12]+alphay[3]*f[5]+f[3]*alphay[5]); 
  out[24] += 0.3061862178478971*(alphay[16]*f[31]+alphay[8]*f[30]+alphay[7]*f[29]+alphay[6]*f[28]+alphay[3]*f[25]+alphay[2]*f[24]+alphay[1]*f[23]+alphay[0]*f[15]+alphay[9]*f[12]+f[9]*alphay[12]+alphay[4]*f[5]+f[4]*alphay[5]); 
  out[26] += 0.3061862178478971*(alphay[5]*f[29]+alphay[2]*f[26]+alphay[12]*f[25]+alphay[6]*f[19]+alphay[0]*f[18]+alphay[8]*f[17]+f[10]*alphay[16]+alphay[1]*f[11]+alphay[3]*f[9]+f[3]*alphay[9]+alphay[4]*f[7]+f[4]*alphay[7]); 
  out[27] += 0.3061862178478971*(alphay[4]*f[29]+alphay[2]*f[27]+alphay[9]*f[25]+alphay[6]*f[22]+alphay[0]*f[21]+alphay[8]*f[20]+f[13]*alphay[16]+alphay[1]*f[14]+alphay[3]*f[12]+f[3]*alphay[12]+alphay[5]*f[7]+f[5]*alphay[7]); 
  out[28] += 0.3061862178478971*(alphay[8]*f[31]+alphay[16]*f[30]+alphay[3]*f[29]+alphay[2]*f[28]+alphay[7]*f[25]+alphay[6]*f[24]+alphay[0]*f[23]+alphay[1]*f[15]+alphay[4]*f[12]+f[4]*alphay[12]+alphay[5]*f[9]+f[5]*alphay[9]); 
  out[30] += 0.3061862178478971*(alphay[6]*f[31]+alphay[2]*f[30]+alphay[1]*f[29]+alphay[16]*f[28]+alphay[0]*f[25]+alphay[8]*f[24]+alphay[7]*f[23]+alphay[9]*f[21]+alphay[12]*f[18]+alphay[3]*f[15]+alphay[4]*f[14]+alphay[5]*f[11]); 
  out[31] += 0.3061862178478971*(alphay[2]*f[31]+alphay[6]*f[30]+alphay[0]*f[29]+alphay[8]*f[28]+alphay[1]*f[25]+alphay[16]*f[24]+alphay[3]*f[23]+alphay[4]*f[21]+alphay[5]*f[18]+alphay[7]*f[15]+alphay[9]*f[14]+f[11]*alphay[12]); 
  double alphaz[32]; 
  alphaz[0] = 2.0*Gradpar[0]*dfac_z*wv; 
  ...
  out[7] += 0.3061862178478971*(alphaz[0]*f[1]+f[0]*alphaz[1]); 
  out[8] += 0.3061862178478971*(alphaz[1]*f[6]+alphaz[0]*f[2]); 
  out[11] += 0.3061862178478971*(alphaz[1]*f[9]+alphaz[0]*f[4]); 
  out[14] += 0.3061862178478971*(alphaz[1]*f[12]+alphaz[0]*f[5]); 
  out[16] += 0.3061862178478971*(alphaz[0]*f[6]+alphaz[1]*f[2]); 
  out[18] += 0.3061862178478971*(alphaz[0]*f[9]+alphaz[1]*f[4]); 
  out[19] += 0.3061862178478971*(alphaz[1]*f[17]+alphaz[0]*f[10]); 
  out[21] += 0.3061862178478971*(alphaz[0]*f[12]+alphaz[1]*f[5]); 
  out[22] += 0.3061862178478971*(alphaz[1]*f[20]+alphaz[0]*f[13]); 
  out[25] += 0.3061862178478971*(alphaz[1]*f[23]+alphaz[0]*f[15]); 
  out[26] += 0.3061862178478971*(alphaz[0]*f[17]+alphaz[1]*f[10]); 
  out[27] += 0.3061862178478971*(alphaz[0]*f[20]+alphaz[1]*f[13]); 
  out[29] += 0.3061862178478971*(alphaz[0]*f[23]+alphaz[1]*f[15]); 
  out[30] += 0.3061862178478971*(alphaz[1]*f[28]+alphaz[0]*f[24]); 
  out[31] += 0.3061862178478971*(alphaz[0]*f[28]+alphaz[1]*f[24]); 
  double alphav[32]; 
