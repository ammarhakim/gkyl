...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alphav[32]; 
  alphav[0] = -1.0*dfac_v*(1.224744871391589*(BdriftY[0]*Phi[2]*dfac_y+BdriftX[0]*Phi[1]*dfac_x)*wv+((1.732050807568877*(0.7071067811865475*Gradpar[0]*Phi[3]*dfac_z+BdriftY[0]*(0.25*(Apar[5]*Phi[7]+Apar[3]*Phi[6])+0.25*(Apar[1]*Phi[4]+Apar[0]*Phi[2]))*dfac_y+BdriftX[0]*(0.25*(Apar[6]*Phi[7]+Apar[3]*Phi[5])+0.25*(Apar[2]*Phi[4]+Apar[0]*Phi[1]))*dfac_x)-1.0*BmagInv[0]*(0.75*Apar[5]*Phi[6]-0.75*Phi[5]*Apar[6]+0.75*Apar[1]*Phi[2]-0.75*Phi[1]*Apar[2])*dfac_x*dfac_y)*q_)/m_); 
  alphav[1] = -1.0*dfac_v*(1.224744871391589*BdriftY[0]*Phi[4]*dfac_y*wv+((1.732050807568877*(0.7071067811865475*Gradpar[0]*Phi[5]*dfac_z+BdriftY[0]*(0.25*(Apar[3]*Phi[7]+Apar[5]*Phi[6])+0.25*(Apar[0]*Phi[4]+Apar[1]*Phi[2]))*dfac_y+BdriftX[0]*(0.25*(Apar[7]*Phi[7]+Apar[5]*Phi[5])+0.25*(Apar[4]*Phi[4]+Apar[1]*Phi[1]))*dfac_x)-1.0*BmagInv[0]*(0.75*Apar[5]*Phi[7]-0.75*Phi[5]*Apar[7]+0.75*Apar[1]*Phi[4]-0.75*Phi[1]*Apar[4])*dfac_x*dfac_y)*q_)/m_); 
  alphav[2] = -1.0*dfac_v*(1.224744871391589*BdriftX[0]*Phi[4]*dfac_x*wv+((1.732050807568877*(0.7071067811865475*Gradpar[0]*Phi[6]*dfac_z+BdriftY[0]*(0.25*(Apar[7]*Phi[7]+Apar[6]*Phi[6])+0.25*(Apar[4]*Phi[4]+Apar[2]*Phi[2]))*dfac_y+BdriftX[0]*(0.25*(Apar[3]*Phi[7]+Phi[5]*Apar[6])+0.25*(Apar[0]*Phi[4]+Phi[1]*Apar[2]))*dfac_x)-1.0*BmagInv[0]*((-0.75*Apar[6]*Phi[7])+0.75*Phi[6]*Apar[7]-0.75*Apar[2]*Phi[4]+0.75*Phi[2]*Apar[4])*dfac_x*dfac_y)*q_)/m_); 
  alphav[3] = -1.0*dfac_v*(1.224744871391589*(BdriftY[0]*Phi[6]*dfac_y+BdriftX[0]*Phi[5]*dfac_x)*wv+((1.732050807568877*(BdriftY[0]*(0.25*(Apar[1]*Phi[7]+Apar[0]*Phi[6])+0.25*(Phi[4]*Apar[5]+Phi[2]*Apar[3]))*dfac_y+BdriftX[0]*(0.25*(Apar[2]*Phi[7]+Phi[4]*Apar[6])+0.25*(Apar[0]*Phi[5]+Phi[1]*Apar[3]))*dfac_x)-1.0*BmagInv[0]*(0.75*Apar[1]*Phi[6]-0.75*(Phi[1]*Apar[6]+Apar[2]*Phi[5])+0.75*Phi[2]*Apar[5])*dfac_x*dfac_y)*q_)/m_); 
  ...
  alphav[8] = -1.0*dfac_v*(1.224744871391589*BdriftX[0]*Phi[7]*dfac_x*wv+((1.732050807568877*(BdriftY[0]*(0.25*(Apar[4]*Phi[7]+Phi[4]*Apar[7])+0.25*(Apar[2]*Phi[6]+Phi[2]*Apar[6]))*dfac_y+BdriftX[0]*(0.25*(Apar[0]*Phi[7]+Phi[1]*Apar[6])+0.25*(Apar[2]*Phi[5]+Apar[3]*Phi[4]))*dfac_x)-1.0*BmagInv[0]*((-0.75*Apar[2]*Phi[7])+0.75*(Phi[2]*Apar[7]+Apar[4]*Phi[6])-0.75*Phi[4]*Apar[6])*dfac_x*dfac_y)*q_)/m_); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alphaR = 0.0; 
  double alphax[32]; 
  alphax[0] = dfac_x*((2.0*BdriftX[0]*m_*wv2)/q_+0.7071067811865475*(1.732050807568877*dfac_y*(BmagInv[3]*Apar[6]*wv-1.0*(BmagInv[3]*Phi[6]+BmagInv[0]*Phi[2]))+(1.732050807568877*BmagInv[0]*Apar[2]*dfac_y+Apar[3]*BdriftX[3]+Apar[0]*BdriftX[0])*wv)); 
  alphax[1] = 0.7071067811865475*dfac_x*((1.732050807568877*(BmagInv[3]*Apar[7]+BmagInv[0]*Apar[4])*dfac_y+BdriftX[3]*Apar[5]+BdriftX[0]*Apar[1])*wv-1.732050807568877*(BmagInv[3]*Phi[7]+BmagInv[0]*Phi[4])*dfac_y); 
  alphax[2] = 0.7071067811865475*(BdriftX[3]*Apar[6]+BdriftX[0]*Apar[2])*dfac_x*wv; 
  alphax[3] = dfac_x*((2.0*BdriftX[3]*m_*wv2)/q_+0.7071067811865475*(1.732050807568877*dfac_y*(BmagInv[0]*Apar[6]*wv-1.0*(BmagInv[0]*Phi[6]+Phi[2]*BmagInv[3]))+(1.732050807568877*Apar[2]*BmagInv[3]*dfac_y+Apar[0]*BdriftX[3]+BdriftX[0]*Apar[3])*wv)); 
  alphax[4] = (1.154700538379252*BdriftX[0]*dfac_x*m_*wv)/(dfac_v*q_); 
  alphax[6] = 0.7071067811865475*(BdriftX[3]*Apar[7]+BdriftX[0]*Apar[4])*dfac_x*wv; 
  alphax[7] = 0.7071067811865475*dfac_x*((1.732050807568877*(BmagInv[0]*Apar[7]+BmagInv[3]*Apar[4])*dfac_y+BdriftX[0]*Apar[5]+Apar[1]*BdriftX[3])*wv-1.732050807568877*(BmagInv[0]*Phi[7]+BmagInv[3]*Phi[4])*dfac_y); 
  ...
  double alphay[32]; 
  alphay[0] = dfac_y*((2.0*BdriftY[0]*m_*wv2)/q_+0.7071067811865475*(1.732050807568877*dfac_x*(BmagInv[3]*(Phi[5]-1.0*Apar[5]*wv)+BmagInv[0]*Phi[1])+((-1.732050807568877*BmagInv[0]*Apar[1]*dfac_x)+Apar[3]*BdriftY[3]+Apar[0]*BdriftY[0])*wv)); 
  alphay[1] = 0.7071067811865475*(BdriftY[3]*Apar[5]+BdriftY[0]*Apar[1])*dfac_y*wv; 
  alphay[2] = -0.7071067811865475*dfac_y*(1.732050807568877*(BmagInv[3]*Apar[7]+BmagInv[0]*Apar[4])*dfac_x*wv-1.0*((BdriftY[3]*Apar[6]+BdriftY[0]*Apar[2])*wv+1.732050807568877*(BmagInv[3]*Phi[7]+BmagInv[0]*Phi[4])*dfac_x)); 
  alphay[3] = dfac_y*((2.0*BdriftY[3]*m_*wv2)/q_+0.7071067811865475*(1.732050807568877*dfac_x*(BmagInv[0]*(Phi[5]-1.0*Apar[5]*wv)+Phi[1]*BmagInv[3])+((-1.732050807568877*Apar[1]*BmagInv[3]*dfac_x)+Apar[0]*BdriftY[3]+BdriftY[0]*Apar[3])*wv)); 
  alphay[4] = (1.154700538379252*BdriftY[0]*dfac_y*m_*wv)/(dfac_v*q_); 
  ...
  alphay[8] = -0.7071067811865475*dfac_y*(1.732050807568877*(BmagInv[0]*Apar[7]+BmagInv[3]*Apar[4])*dfac_x*wv-1.0*((BdriftY[0]*Apar[6]+Apar[2]*BdriftY[3])*wv+1.732050807568877*(BmagInv[0]*Phi[7]+BmagInv[3]*Phi[4])*dfac_x)); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alphaR = 0.0; 
  double alphax[32]; 
  alphax[0] = dfac_x*((2.0*BdriftX[0]*m_*wv2)/q_+0.7071067811865475*(1.732050807568877*dfac_y*(BmagInv[1]*Apar[4]*wv-1.0*(BmagInv[5]*Phi[7]+BmagInv[3]*Phi[6]+BmagInv[1]*Phi[4]+BmagInv[0]*Phi[2]))+(1.732050807568877*(BmagInv[5]*Apar[7]+BmagInv[3]*Apar[6]+BmagInv[0]*Apar[2])*dfac_y+Apar[5]*BdriftX[5]+Apar[3]*BdriftX[3]+Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*wv)); 
  alphax[1] = dfac_x*((2.0*BdriftX[1]*m_*wv2)/q_+0.7071067811865475*(1.732050807568877*dfac_y*(BmagInv[0]*Apar[4]*wv-1.0*(BmagInv[3]*Phi[7]+BmagInv[5]*Phi[6]+BmagInv[0]*Phi[4]+BmagInv[1]*Phi[2]))+(1.732050807568877*(BmagInv[3]*Apar[7]+BmagInv[5]*Apar[6]+BmagInv[1]*Apar[2])*dfac_y+Apar[3]*BdriftX[5]+BdriftX[3]*Apar[5]+Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])*wv)); 
  alphax[2] = 0.7071067811865475*(BdriftX[5]*Apar[7]+BdriftX[3]*Apar[6]+BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2])*dfac_x*wv; 
  alphax[3] = dfac_x*((2.0*BdriftX[3]*m_*wv2)/q_+0.7071067811865475*(1.732050807568877*dfac_y*(Apar[4]*BmagInv[5]*wv-1.0*(BmagInv[1]*Phi[7]+BmagInv[0]*Phi[6]+Phi[4]*BmagInv[5]+Phi[2]*BmagInv[3]))+(1.732050807568877*(BmagInv[1]*Apar[7]+BmagInv[0]*Apar[6]+Apar[2]*BmagInv[3])*dfac_y+Apar[1]*BdriftX[5]+BdriftX[1]*Apar[5]+Apar[0]*BdriftX[3]+BdriftX[0]*Apar[3])*wv)); 
  alphax[4] = (1.154700538379252*BdriftX[0]*dfac_x*m_*wv)/(dfac_v*q_); 
  alphax[6] = 0.7071067811865475*(BdriftX[3]*Apar[7]+BdriftX[5]*Apar[6]+BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2])*dfac_x*wv; 
  alphax[7] = dfac_x*((2.0*BdriftX[5]*m_*wv2)/q_+0.7071067811865475*(1.732050807568877*dfac_y*(Apar[2]*BmagInv[5]*wv-1.0*(BmagInv[0]*Phi[7]+BmagInv[1]*Phi[6]+Phi[2]*BmagInv[5]+BmagInv[3]*Phi[4]))+(1.732050807568877*(BmagInv[0]*Apar[7]+BmagInv[1]*Apar[6]+BmagInv[3]*Apar[4])*dfac_y+Apar[0]*BdriftX[5]+BdriftX[0]*Apar[5]+Apar[1]*BdriftX[3]+BdriftX[1]*Apar[3])*wv)); 
  ...
  double alphay[32]; 
  alphay[0] = dfac_y*((2.0*BdriftY[0]*m_*wv2)/q_+0.7071067811865475*(1.732050807568877*dfac_x*((-1.0*BmagInv[3]*Apar[5]*wv)+((BmagInv[3]*Bmag[5]+BmagInv[0]*Bmag[1])*wm)/q_+BmagInv[3]*Phi[5]+BmagInv[0]*Phi[1])+((-1.732050807568877*BmagInv[0]*Apar[1]*dfac_x)+Apar[5]*BdriftY[5]+Apar[3]*BdriftY[3]+Apar[1]*BdriftY[1]+Apar[0]*BdriftY[0])*wv)); 
  alphay[1] = dfac_y*((2.0*BdriftY[1]*m_*wv2)/q_+0.7071067811865475*(1.732050807568877*dfac_x*((-1.0*Apar[5]*BmagInv[5]*wv)+((Bmag[5]*BmagInv[5]+Bmag[1]*BmagInv[1])*wm)/q_+BmagInv[5]*Phi[5]+BmagInv[1]*Phi[1])+((-1.732050807568877*Apar[1]*BmagInv[1]*dfac_x)+Apar[3]*BdriftY[5]+BdriftY[3]*Apar[5]+Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1])*wv)); 
  alphay[2] = -0.7071067811865475*dfac_y*(1.732050807568877*(BmagInv[3]*Apar[7]+BmagInv[0]*Apar[4])*dfac_x*wv-1.0*((BdriftY[5]*Apar[7]+BdriftY[3]*Apar[6]+BdriftY[1]*Apar[4]+BdriftY[0]*Apar[2])*wv+1.732050807568877*(BmagInv[3]*Phi[7]+BmagInv[0]*Phi[4])*dfac_x)); 
  alphay[3] = dfac_y*((2.0*BdriftY[3]*m_*wv2)/q_+0.7071067811865475*(1.732050807568877*dfac_x*((-1.0*BmagInv[0]*Apar[5]*wv)+((BmagInv[0]*Bmag[5]+Bmag[1]*BmagInv[3])*wm)/q_+BmagInv[0]*Phi[5]+Phi[1]*BmagInv[3])+(Apar[1]*(BdriftY[5]-1.732050807568877*BmagInv[3]*dfac_x)+BdriftY[1]*Apar[5]+Apar[0]*BdriftY[3]+BdriftY[0]*Apar[3])*wv)); 
  alphay[4] = (1.154700538379252*BdriftY[0]*dfac_y*m_*wv)/(dfac_v*q_); 
  alphay[5] = (0.7071067811865475*(BmagInv[3]*Bmag[5]+BmagInv[0]*Bmag[1])*dfac_x*dfac_y)/(dfac_m*q_); 
  alphay[6] = -0.7071067811865475*dfac_y*(1.732050807568877*(BmagInv[5]*Apar[7]+BmagInv[1]*Apar[4])*dfac_x*wv-1.0*((BdriftY[3]*Apar[7]+BdriftY[5]*Apar[6]+BdriftY[0]*Apar[4]+BdriftY[1]*Apar[2])*wv+1.732050807568877*(BmagInv[5]*Phi[7]+BmagInv[1]*Phi[4])*dfac_x)); 
  alphay[7] = dfac_y*((2.0*BdriftY[5]*m_*wv2)/q_+0.7071067811865475*(1.732050807568877*dfac_x*((-1.0*Apar[1]*BmagInv[5]*wv)+BmagInv[1]*((Bmag[5]*wm)/q_+Phi[5])+BmagInv[5]*((Bmag[1]*wm)/q_+Phi[1]))+((-1.732050807568877*BmagInv[1]*Apar[5]*dfac_x)+Apar[0]*BdriftY[5]+BdriftY[0]*Apar[5]+Apar[1]*BdriftY[3]+BdriftY[1]*Apar[3])*wv)); 
  alphay[8] = -0.7071067811865475*dfac_y*(1.732050807568877*(BmagInv[0]*Apar[7]+BmagInv[3]*Apar[4])*dfac_x*wv-1.0*((BdriftY[1]*Apar[7]+BdriftY[0]*Apar[6]+Apar[4]*BdriftY[5]+Apar[2]*BdriftY[3])*wv+1.732050807568877*(BmagInv[0]*Phi[7]+BmagInv[3]*Phi[4])*dfac_x)); 
  alphay[9] = (1.154700538379252*BdriftY[1]*dfac_y*m_*wv)/(dfac_v*q_); 
  alphay[11] = (1.154700538379252*BdriftY[3]*dfac_y*m_*wv)/(dfac_v*q_); 
  ...
  alphay[16] = -0.7071067811865475*dfac_y*(1.732050807568877*(BmagInv[1]*Apar[7]+Apar[4]*BmagInv[5])*dfac_x*wv-1.0*((BdriftY[0]*Apar[7]+BdriftY[1]*Apar[6]+Apar[2]*BdriftY[5]+BdriftY[3]*Apar[4])*wv+1.732050807568877*(BmagInv[1]*Phi[7]+Phi[4]*BmagInv[5])*dfac_x)); 
  ...
  double alphav[32]; 
  alphav[0] = -1.0*dfac_v*(1.224744871391589*(((BdriftX[3]*Bmag[5]+BdriftX[0]*Bmag[1])*dfac_x*wm)/q_+(BdriftY[5]*Phi[7]+BdriftY[3]*Phi[6]+BdriftY[1]*Phi[4]+BdriftY[0]*Phi[2])*dfac_y+(BdriftX[3]*Phi[5]+BdriftX[0]*Phi[1])*dfac_x)*wv+((1.224744871391589*(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3])*dfac_z+dfac_x*((0.75*(Bmag[1]*BmagInv[5]+BmagInv[1]*Bmag[5])*Apar[7]+0.75*((BmagInv[0]*Bmag[5]+Bmag[1]*BmagInv[3])*Apar[6]+Bmag[5]*(Apar[4]*BmagInv[5]+Apar[2]*BmagInv[3])+Bmag[1]*(BmagInv[1]*Apar[4]+BmagInv[0]*Apar[2])))*dfac_y+1.732050807568877*((0.25*(Apar[1]*BdriftX[5]+BdriftX[1]*Apar[5])+0.25*(Apar[0]*BdriftX[3]+BdriftX[0]*Apar[3]))*Bmag[5]+Bmag[1]*(0.25*(Apar[5]*BdriftX[5]+Apar[3]*BdriftX[3])+0.25*(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])))))*wm+((1.732050807568877*(0.7071067811865475*(Gradpar[1]*Phi[5]+Gradpar[0]*Phi[3])*dfac_z+((0.25*(Apar[0]*BdriftY[5]+BdriftY[0]*Apar[5])+0.25*(Apar[1]*BdriftY[3]+BdriftY[1]*Apar[3]))*Phi[7]+(0.25*(Apar[1]*BdriftY[5]+BdriftY[1]*Apar[5])+0.25*(Apar[0]*BdriftY[3]+BdriftY[0]*Apar[3]))*Phi[6]+Phi[2]*(0.25*(Apar[5]*BdriftY[5]+Apar[3]*BdriftY[3])+0.25*(Apar[1]*BdriftY[1]+Apar[0]*BdriftY[0]))+Phi[4]*(0.25*(Apar[3]*BdriftY[5]+BdriftY[3]*Apar[5])+0.25*(Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1])))*dfac_y+(0.25*(BdriftX[0]*Apar[6]*Phi[7]+Apar[1]*BdriftX[5]*Phi[5])+0.25*((Apar[4]*BdriftX[5]+Apar[2]*BdriftX[3])*Phi[7]+Phi[4]*(BdriftX[5]*Apar[7]+BdriftX[3]*Apar[6])+(BdriftX[1]*Apar[5]+Apar[0]*BdriftX[3]+BdriftX[0]*Apar[3])*Phi[5]+Phi[1]*Apar[5]*BdriftX[5])+0.25*BdriftX[1]*Apar[7]*Phi[7]+0.25*(BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2])*Phi[4]+Phi[1]*(0.25*Apar[3]*BdriftX[3]+0.25*(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])))*dfac_x)-1.0*(0.75*(Apar[1]*BmagInv[5]+BmagInv[1]*Apar[5])*Phi[7]-0.75*(BmagInv[1]*Phi[5]+Phi[1]*BmagInv[5])*Apar[7]+0.75*(BmagInv[0]*Apar[5]+Apar[1]*BmagInv[3])*Phi[6]-0.75*((BmagInv[0]*Phi[5]+Phi[1]*BmagInv[3])*Apar[6]+(Apar[4]*BmagInv[5]+Apar[2]*BmagInv[3])*Phi[5])+0.75*Apar[5]*(Phi[4]*BmagInv[5]+Phi[2]*BmagInv[3])+BmagInv[1]*(0.75*Apar[1]*Phi[4]-0.75*Phi[1]*Apar[4])+BmagInv[0]*(0.75*Apar[1]*Phi[2]-0.75*Phi[1]*Apar[2]))*dfac_x*dfac_y)*q2)/q_)/m_); 
  alphav[1] = -1.0*dfac_v*(1.224744871391589*(((BdriftX[5]*Bmag[5]+BdriftX[1]*Bmag[1])*dfac_x*wm)/q_+(BdriftY[3]*Phi[7]+BdriftY[5]*Phi[6]+BdriftY[0]*Phi[4]+BdriftY[1]*Phi[2])*dfac_y+(BdriftX[5]*Phi[5]+BdriftX[1]*Phi[1])*dfac_x)*wv+((1.224744871391589*(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*dfac_z+dfac_x*((0.75*(BmagInv[0]*Bmag[5]+Bmag[1]*BmagInv[3])*Apar[7]+0.75*((Bmag[1]*BmagInv[5]+BmagInv[1]*Bmag[5])*Apar[6]+Bmag[5]*(Apar[2]*BmagInv[5]+BmagInv[3]*Apar[4])+Bmag[1]*(BmagInv[0]*Apar[4]+BmagInv[1]*Apar[2])))*dfac_y+1.732050807568877*((0.25*(Apar[0]*BdriftX[5]+BdriftX[0]*Apar[5])+0.25*(Apar[1]*BdriftX[3]+BdriftX[1]*Apar[3]))*Bmag[5]+Bmag[1]*(0.25*(Apar[3]*BdriftX[5]+BdriftX[3]*Apar[5])+0.25*(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])))))*wm+((1.732050807568877*(0.7071067811865475*(Gradpar[0]*Phi[5]+Gradpar[1]*Phi[3])*dfac_z+0.25*((Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1])*Phi[2]*dfac_y+((BdriftX[0]*Apar[7]+BdriftX[1]*Apar[6]+Apar[2]*BdriftX[5]+BdriftX[3]*Apar[4])*Phi[7]+Phi[4]*(BdriftX[3]*Apar[7]+BdriftX[5]*Apar[6])+(Apar[0]*BdriftX[5]+BdriftX[0]*Apar[5]+Apar[1]*BdriftX[3]+BdriftX[1]*Apar[3])*Phi[5]+Phi[1]*(Apar[3]*BdriftX[5]+BdriftX[3]*Apar[5])+(BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2])*Phi[4]+(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])*Phi[1])*dfac_x)-1.0*((-0.25*((Apar[0]*BdriftY[3]+BdriftY[0]*Apar[3])*Phi[7]+(Apar[0]*BdriftY[5]+BdriftY[0]*Apar[5]+Apar[1]*BdriftY[3]+BdriftY[1]*Apar[3])*Phi[6]))-0.45*(Apar[1]*BdriftY[5]+BdriftY[1]*Apar[5])*Phi[7]+Phi[4]*((-0.45*Apar[5]*BdriftY[5])-0.25*Apar[3]*BdriftY[3]-0.45*Apar[1]*BdriftY[1]-0.25*Apar[0]*BdriftY[0])-0.25*Phi[2]*(Apar[3]*BdriftY[5]+BdriftY[3]*Apar[5]))*dfac_y)-1.0*(0.75*(BmagInv[0]*Apar[5]+Apar[1]*BmagInv[3])*Phi[7]-0.75*(BmagInv[0]*Phi[5]+Phi[1]*BmagInv[3])*Apar[7]+0.75*(Apar[1]*BmagInv[5]+BmagInv[1]*Apar[5])*Phi[6]-0.75*((BmagInv[1]*Phi[5]+Phi[1]*BmagInv[5])*Apar[6]+(Apar[2]*BmagInv[5]+BmagInv[3]*Apar[4])*Phi[5])+0.75*Apar[5]*(Phi[2]*BmagInv[5]+BmagInv[3]*Phi[4])+BmagInv[0]*(0.75*Apar[1]*Phi[4]-0.75*Phi[1]*Apar[4])+BmagInv[1]*(0.75*Apar[1]*Phi[2]-0.75*Phi[1]*Apar[2]))*dfac_x*dfac_y)*q2)/q_)/m_); 
  alphav[2] = -1.0*dfac_v*(1.224744871391589*(BdriftX[3]*Phi[7]+BdriftX[0]*Phi[4])*dfac_x*wv+(1.732050807568877*(0.25*(BdriftX[1]*Bmag[5]+Bmag[1]*BdriftX[5])*Apar[7]+0.25*((BdriftX[0]*Bmag[5]+Bmag[1]*BdriftX[3])*Apar[6]+(Apar[4]*BdriftX[5]+Apar[2]*BdriftX[3])*Bmag[5]+Bmag[1]*(BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2])))*dfac_x*wm+(1.732050807568877*(0.7071067811865475*(Gradpar[1]*Phi[7]+Gradpar[0]*Phi[6])*dfac_z+0.25*((BdriftY[0]*Apar[7]+BdriftY[1]*Apar[6]+Apar[2]*BdriftY[5]+BdriftY[3]*Apar[4])*Phi[7]+Phi[6]*(BdriftY[1]*Apar[7]+BdriftY[0]*Apar[6])+(Phi[2]*BdriftY[5]+BdriftY[3]*Phi[4])*Apar[7]+(Apar[4]*BdriftY[5]+Apar[2]*BdriftY[3])*Phi[6]+(Phi[4]*BdriftY[5]+Phi[2]*BdriftY[3])*Apar[6]+(BdriftY[0]*Apar[4]+BdriftY[1]*Apar[2])*Phi[4]+Phi[2]*(BdriftY[1]*Apar[4]+BdriftY[0]*Apar[2]))*dfac_y+(0.25*(BdriftX[1]*Apar[5]*Phi[7]+Apar[4]*BdriftX[5]*Phi[5])+0.25*((Apar[0]*BdriftX[3]+BdriftX[0]*Apar[3])*Phi[7]+(BdriftX[1]*Phi[5]+Phi[1]*BdriftX[5])*Apar[7]+(BdriftX[0]*Phi[5]+Phi[1]*BdriftX[3])*Apar[6]+Apar[2]*BdriftX[3]*Phi[5]+Phi[4]*Apar[5]*BdriftX[5])+0.25*Apar[1]*BdriftX[5]*Phi[7]+0.25*((Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*Phi[4]+Phi[1]*(BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2]))+0.25*Apar[3]*BdriftX[3]*Phi[4])*dfac_x)-1.0*(BmagInv[0]*((-0.75*Apar[6]*Phi[7])+0.75*Phi[6]*Apar[7]-0.75*Apar[2]*Phi[4]+0.75*Phi[2]*Apar[4])+BmagInv[3]*((-0.75*Apar[2]*Phi[7])+0.75*(Phi[2]*Apar[7]+Apar[4]*Phi[6])-0.75*Phi[4]*Apar[6]))*dfac_x*dfac_y)*q_)/m_); 
  alphav[3] = -1.0*dfac_v*(1.224744871391589*(((BdriftX[0]*Bmag[5]+Bmag[1]*BdriftX[3])*dfac_x*wm)/q_+(BdriftY[1]*Phi[7]+BdriftY[0]*Phi[6]+Phi[4]*BdriftY[5]+Phi[2]*BdriftY[3])*dfac_y+(BdriftX[0]*Phi[5]+Phi[1]*BdriftX[3])*dfac_x)*wv+((1.224744871391589*(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3])*dfac_z+dfac_x*((1.35*Bmag[5]*(BmagInv[5]*Apar[7]+BmagInv[3]*Apar[6])+Bmag[1]*(0.75*BmagInv[1]*Apar[7]+0.75*(BmagInv[0]*Apar[6]+Apar[4]*BmagInv[5]))+0.75*Apar[2]*(BmagInv[0]*Bmag[5]+Bmag[1]*BmagInv[3])+0.75*BmagInv[1]*Apar[4]*Bmag[5])*dfac_y+1.732050807568877*((0.45*(Apar[5]*BdriftX[5]+Apar[3]*BdriftX[3])+0.25*(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0]))*Bmag[5]+Bmag[1]*(0.25*(Apar[1]*BdriftX[5]+BdriftX[1]*Apar[5])+0.25*(Apar[0]*BdriftX[3]+BdriftX[0]*Apar[3])))))*wm+((1.732050807568877*(0.7071067811865475*(Gradpar[5]*Phi[5]+Gradpar[3]*Phi[3])*dfac_z+(9.0*(0.05*(Apar[3]*BdriftY[5]+BdriftY[3]*Apar[5])*Phi[7]+0.05*(Apar[5]*BdriftY[5]+Apar[3]*BdriftY[3])*Phi[6])+0.25*((Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1])*Phi[7]+(Apar[1]*BdriftY[1]+Apar[0]*BdriftY[0])*Phi[6]+(Apar[0]*Phi[4]+Apar[1]*Phi[2])*BdriftY[5]+(BdriftY[0]*Phi[4]+BdriftY[1]*Phi[2])*Apar[5]+(Apar[1]*BdriftY[3]+BdriftY[1]*Apar[3])*Phi[4]+Phi[2]*(Apar[0]*BdriftY[3]+BdriftY[0]*Apar[3])))*dfac_y+(9.0*(0.05*(BdriftX[5]*Apar[7]+BdriftX[3]*Apar[6])*Phi[7]+0.05*(Apar[5]*BdriftX[5]+Apar[3]*BdriftX[3])*Phi[5])+0.25*((BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2])*Phi[7]+Phi[4]*(BdriftX[1]*Apar[7]+BdriftX[0]*Apar[6])+(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0])*Phi[5]+(Apar[4]*Phi[4]+Apar[1]*Phi[1])*BdriftX[5]+BdriftX[1]*Phi[1]*Apar[5]+Apar[2]*BdriftX[3]*Phi[4]+Phi[1]*(Apar[0]*BdriftX[3]+BdriftX[0]*Apar[3])))*dfac_x)-1.0*((1.35*Apar[5]*BmagInv[5]+0.75*Apar[1]*BmagInv[1])*Phi[7]+((-1.35*BmagInv[5]*Phi[5])-0.75*BmagInv[1]*Phi[1])*Apar[7]+(1.35*BmagInv[3]*Apar[5]+0.75*BmagInv[0]*Apar[1])*Phi[6]-0.75*(BmagInv[0]*Phi[1]*Apar[6]+(BmagInv[1]*Apar[4]+BmagInv[0]*Apar[2])*Phi[5])-1.35*BmagInv[3]*Phi[5]*Apar[6]+(0.75*Apar[1]*Phi[4]-0.75*Phi[1]*Apar[4])*BmagInv[5]+0.75*(BmagInv[1]*Phi[4]+BmagInv[0]*Phi[2])*Apar[5]+(0.75*Apar[1]*Phi[2]-0.75*Phi[1]*Apar[2])*BmagInv[3])*dfac_x*dfac_y)*q2)/q_)/m_); 
  ...
  alphav[5] = -(1.0*dfac_v*((0.7071067811865475*(BdriftX[3]*Bmag[5]+BdriftX[0]*Bmag[1])*dfac_x*wv)/q_+(0.7071067811865475*(Gradpar[1]*Bmag[5]+Gradpar[0]*Bmag[3])*dfac_z+dfac_x*(Bmag[1]*(0.4330127018922193*BmagInv[5]*Apar[7]*dfac_y+0.25*(Apar[5]*BdriftX[5]+Apar[3]*BdriftX[3]+Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0]))+Bmag[5]*(0.4330127018922193*BmagInv[0]*Apar[6]*dfac_y+0.25*(Apar[1]*BdriftX[5]+BdriftX[1]*Apar[5]+Apar[0]*BdriftX[3]+BdriftX[0]*Apar[3]))+1.732050807568877*(0.25*(BmagInv[1]*Bmag[5]*Apar[7]+Bmag[1]*BmagInv[3]*Apar[6])+0.25*(Bmag[5]*(Apar[4]*BmagInv[5]+Apar[2]*BmagInv[3])+Bmag[1]*(BmagInv[1]*Apar[4]+BmagInv[0]*Apar[2])))*dfac_y))/m_))/dfac_m; 
  alphav[6] = -1.0*dfac_v*(1.224744871391589*(BdriftX[5]*Phi[7]+BdriftX[1]*Phi[4])*dfac_x*wv+(1.732050807568877*(0.25*(BdriftX[0]*Bmag[5]+Bmag[1]*BdriftX[3])*Apar[7]+0.25*((BdriftX[1]*Bmag[5]+Bmag[1]*BdriftX[5])*Apar[6]+(Apar[2]*BdriftX[5]+BdriftX[3]*Apar[4])*Bmag[5]+Bmag[1]*(BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2])))*dfac_x*wm+(1.732050807568877*(0.7071067811865475*(Gradpar[0]*Phi[7]+Gradpar[1]*Phi[6])*dfac_z+0.25*(Phi[2]*(BdriftY[0]*Apar[4]+BdriftY[1]*Apar[2])*dfac_y+((Apar[0]*BdriftX[5]+BdriftX[0]*Apar[5]+Apar[1]*BdriftX[3]+BdriftX[1]*Apar[3])*Phi[7]+(BdriftX[0]*Phi[5]+Phi[1]*BdriftX[3])*Apar[7]+(BdriftX[1]*Phi[5]+Phi[1]*BdriftX[5])*Apar[6]+(Apar[2]*BdriftX[5]+BdriftX[3]*Apar[4])*Phi[5]+Phi[4]*(Apar[3]*BdriftX[5]+BdriftX[3]*Apar[5]+Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])+Phi[1]*(BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2]))*dfac_x)-1.0*((-0.25*(Apar[2]*BdriftY[3]*Phi[7]+(BdriftY[0]*Phi[6]+Phi[2]*BdriftY[3])*Apar[7]+(BdriftY[1]*Apar[6]+Apar[2]*BdriftY[5]+BdriftY[3]*Apar[4])*Phi[6]+Phi[2]*BdriftY[5]*Apar[6]))+((-0.45*BdriftY[1]*Apar[7])-0.25*BdriftY[0]*Apar[6]-0.45*Apar[4]*BdriftY[5])*Phi[7]+Phi[4]*((-0.45*BdriftY[5]*Apar[7])-0.25*BdriftY[3]*Apar[6]-0.45*BdriftY[1]*Apar[4]-0.25*BdriftY[0]*Apar[2]))*dfac_y)-1.0*(BmagInv[1]*((-0.75*Apar[6]*Phi[7])+0.75*Phi[6]*Apar[7]-0.75*Apar[2]*Phi[4]+0.75*Phi[2]*Apar[4])+BmagInv[5]*((-0.75*Apar[2]*Phi[7])+0.75*(Phi[2]*Apar[7]+Apar[4]*Phi[6])-0.75*Phi[4]*Apar[6]))*dfac_x*dfac_y)*q_)/m_); 
  alphav[7] = -1.0*dfac_v*(1.224744871391589*(((BdriftX[1]*Bmag[5]+Bmag[1]*BdriftX[5])*dfac_x*wm)/q_+(BdriftY[0]*Phi[7]+BdriftY[1]*Phi[6]+Phi[2]*BdriftY[5]+BdriftY[3]*Phi[4])*dfac_y+(BdriftX[1]*Phi[5]+Phi[1]*BdriftX[5])*dfac_x)*wv+((1.224744871391589*(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*dfac_z+dfac_x*((1.35*Bmag[5]*(BmagInv[3]*Apar[7]+BmagInv[5]*Apar[6])+Bmag[1]*(0.75*BmagInv[0]*Apar[7]+0.75*(BmagInv[1]*Apar[6]+Apar[2]*BmagInv[5]))+0.75*(BmagInv[1]*Apar[2]*Bmag[5]+Bmag[1]*BmagInv[3]*Apar[4])+0.75*BmagInv[0]*Apar[4]*Bmag[5])*dfac_y+1.732050807568877*((0.45*(Apar[3]*BdriftX[5]+BdriftX[3]*Apar[5])+0.25*(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1]))*Bmag[5]+Bmag[1]*(0.25*(Apar[0]*BdriftX[5]+BdriftX[0]*Apar[5])+0.25*(Apar[1]*BdriftX[3]+BdriftX[1]*Apar[3])))))*wm+((1.732050807568877*(0.7071067811865475*(Gradpar[3]*Phi[5]+Phi[3]*Gradpar[5])*dfac_z-1.0*((9.0*((-0.09*Apar[5]*BdriftY[5])-0.05*(Apar[3]*BdriftY[3]+Apar[1]*BdriftY[1]))-0.25*Apar[0]*BdriftY[0])*Phi[7]+((-0.45*(Apar[3]*BdriftY[5]+BdriftY[3]*Apar[5]))-0.25*(Apar[0]*BdriftY[1]+BdriftY[0]*Apar[1]))*Phi[6]+((-0.45*Apar[1]*Phi[4])-0.25*Apar[0]*Phi[2])*BdriftY[5]+((-0.45*BdriftY[1]*Phi[4])-0.25*BdriftY[0]*Phi[2])*Apar[5]-0.25*((Apar[0]*BdriftY[3]+BdriftY[0]*Apar[3])*Phi[4]+Phi[2]*(Apar[1]*BdriftY[3]+BdriftY[1]*Apar[3])))*dfac_y+(9.0*(0.05*(BdriftX[3]*Apar[7]+BdriftX[5]*Apar[6])*Phi[7]+0.05*(Apar[3]*BdriftX[5]+BdriftX[3]*Apar[5])*Phi[5])+0.25*((BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2])*Phi[7]+Phi[4]*(BdriftX[0]*Apar[7]+BdriftX[1]*Apar[6])+(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1])*Phi[5]+(Apar[2]*Phi[4]+Apar[0]*Phi[1])*BdriftX[5]+BdriftX[0]*Phi[1]*Apar[5]+BdriftX[3]*Apar[4]*Phi[4]+Phi[1]*(Apar[1]*BdriftX[3]+BdriftX[1]*Apar[3])))*dfac_x)-1.0*((1.35*BmagInv[3]*Apar[5]+0.75*BmagInv[0]*Apar[1])*Phi[7]+((-1.35*BmagInv[3]*Phi[5])-0.75*BmagInv[0]*Phi[1])*Apar[7]+(1.35*Apar[5]*BmagInv[5]+0.75*Apar[1]*BmagInv[1])*Phi[6]+BmagInv[5]*((-1.35*Phi[5]*Apar[6])+0.75*Apar[1]*Phi[2]-0.75*Phi[1]*Apar[2])-0.75*(BmagInv[1]*Phi[1]*Apar[6]+(BmagInv[0]*Apar[4]+BmagInv[1]*Apar[2])*Phi[5])+0.75*(BmagInv[0]*Phi[4]+BmagInv[1]*Phi[2])*Apar[5]+BmagInv[3]*(0.75*Apar[1]*Phi[4]-0.75*Phi[1]*Apar[4]))*dfac_x*dfac_y)*q2)/q_)/m_); 
  alphav[8] = -1.0*dfac_v*(1.224744871391589*(BdriftX[0]*Phi[7]+BdriftX[3]*Phi[4])*dfac_x*wv+(1.732050807568877*(0.25*((BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2])*Bmag[5]+Bmag[1]*(Apar[4]*BdriftX[5]+Apar[2]*BdriftX[3]))-1.0*(((-0.45*BdriftX[5]*Bmag[5])-0.25*BdriftX[1]*Bmag[1])*Apar[7]+((-0.45*BdriftX[3]*Bmag[5])-0.25*BdriftX[0]*Bmag[1])*Apar[6]))*dfac_x*wm+(1.732050807568877*(0.7071067811865475*(Gradpar[5]*Phi[7]+Gradpar[3]*Phi[6])*dfac_z+((0.45*(BdriftY[3]*Apar[7]+BdriftY[5]*Apar[6])+0.25*(BdriftY[0]*Apar[4]+BdriftY[1]*Apar[2]))*Phi[7]+0.45*Phi[6]*(BdriftY[5]*Apar[7]+BdriftY[3]*Apar[6])+0.25*((BdriftY[0]*Phi[4]+BdriftY[1]*Phi[2])*Apar[7]+(BdriftY[1]*Apar[4]+BdriftY[0]*Apar[2])*Phi[6]+(BdriftY[1]*Phi[4]+BdriftY[0]*Phi[2])*Apar[6]+(Apar[2]*Phi[4]+Phi[2]*Apar[4])*BdriftY[5]+BdriftY[3]*(Apar[4]*Phi[4]+Apar[2]*Phi[2])))*dfac_y+((-1.0*(((-0.45*Apar[3]*BdriftX[3])-0.25*Apar[0]*BdriftX[0])*Phi[7]+((-0.45*BdriftX[5]*Phi[5])-0.25*BdriftX[1]*Phi[1])*Apar[7]+((-0.45*BdriftX[3]*Phi[5])-0.25*BdriftX[0]*Phi[1])*Apar[6]-0.25*((BdriftX[1]*Apar[4]+BdriftX[0]*Apar[2])*Phi[5]+Phi[1]*Apar[4]*BdriftX[5]+BdriftX[1]*Phi[4]*Apar[5])))+0.25*Apar[1]*(BdriftX[1]*Phi[7]+Phi[4]*BdriftX[5])+0.45*Apar[5]*BdriftX[5]*Phi[7]+0.25*(BdriftX[0]*Apar[3]*Phi[4]+Phi[1]*Apar[2]*BdriftX[3])+0.25*Apar[0]*BdriftX[3]*Phi[4])*dfac_x)-1.0*(BmagInv[3]*((-1.35*Apar[6]*Phi[7])+1.35*Phi[6]*Apar[7]-0.75*Apar[2]*Phi[4]+0.75*Phi[2]*Apar[4])+BmagInv[0]*((-0.75*Apar[2]*Phi[7])+0.75*(Phi[2]*Apar[7]+Apar[4]*Phi[6])-0.75*Phi[4]*Apar[6]))*dfac_x*dfac_y)*q_)/m_); 
  ...
  alphav[12] = -(1.0*dfac_v*((0.7071067811865475*(BdriftX[5]*Bmag[5]+BdriftX[1]*Bmag[1])*dfac_x*wv)/q_+(0.7071067811865475*(Gradpar[0]*Bmag[5]+Gradpar[1]*Bmag[3])*dfac_z+dfac_x*(Bmag[5]*(0.4330127018922193*BmagInv[0]*Apar[7]*dfac_y+0.25*(Apar[0]*BdriftX[5]+BdriftX[0]*Apar[5]+Apar[1]*BdriftX[3]+BdriftX[1]*Apar[3]))+1.732050807568877*(0.25*Bmag[1]*BmagInv[3]*Apar[7]+0.25*((Bmag[1]*BmagInv[5]+BmagInv[1]*Bmag[5])*Apar[6]+Bmag[5]*(Apar[2]*BmagInv[5]+BmagInv[3]*Apar[4])+Bmag[1]*(BmagInv[0]*Apar[4]+BmagInv[1]*Apar[2])))*dfac_y+Bmag[1]*(0.25*(Apar[3]*BdriftX[5]+BdriftX[3]*Apar[5])+0.25*(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1]))))/m_))/dfac_m; 
  ...
  alphav[14] = -(1.0*dfac_v*((0.7071067811865475*(BdriftX[0]*Bmag[5]+Bmag[1]*BdriftX[3])*dfac_x*wv)/q_+(0.7071067811865475*(Bmag[5]*Gradpar[5]+Bmag[3]*Gradpar[3])*dfac_z+dfac_x*(Bmag[5]*(0.4330127018922193*BmagInv[1]*Apar[4]*dfac_y+0.45*(Apar[5]*BdriftX[5]+Apar[3]*BdriftX[3])+0.25*(Apar[1]*BdriftX[1]+Apar[0]*BdriftX[0]))+1.732050807568877*(0.45*Bmag[5]*(BmagInv[5]*Apar[7]+BmagInv[3]*Apar[6])+Bmag[1]*(0.25*BmagInv[1]*Apar[7]+0.25*(BmagInv[0]*Apar[6]+Apar[4]*BmagInv[5]))+0.25*Apar[2]*(BmagInv[0]*Bmag[5]+Bmag[1]*BmagInv[3]))*dfac_y+Bmag[1]*(0.25*(Apar[1]*BdriftX[5]+BdriftX[1]*Apar[5])+0.25*(Apar[0]*BdriftX[3]+BdriftX[0]*Apar[3]))))/m_))/dfac_m; 
  alphav[15] = -(0.408248290463863*(BdriftX[3]*Bmag[5]+BdriftX[0]*Bmag[1])*dfac_x)/(dfac_m*q_); 
  alphav[16] = -1.0*dfac_v*(1.224744871391589*(BdriftX[1]*Phi[7]+Phi[4]*BdriftX[5])*dfac_x*wv+(1.732050807568877*(0.25*((BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2])*Bmag[5]+Bmag[1]*(Apar[2]*BdriftX[5]+BdriftX[3]*Apar[4]))-1.0*(((-0.45*BdriftX[3]*Bmag[5])-0.25*BdriftX[0]*Bmag[1])*Apar[7]+((-0.45*BdriftX[5]*Bmag[5])-0.25*BdriftX[1]*Bmag[1])*Apar[6]))*dfac_x*wm+(1.732050807568877*(0.7071067811865475*(Gradpar[3]*Phi[7]+Gradpar[5]*Phi[6])*dfac_z-1.0*((9.0*((-0.09*BdriftY[5]*Apar[7])-0.05*(BdriftY[3]*Apar[6]+BdriftY[1]*Apar[4]))-0.25*BdriftY[0]*Apar[2])*Phi[7]+((-0.45*(BdriftY[3]*Phi[6]+BdriftY[1]*Phi[4]))-0.25*BdriftY[0]*Phi[2])*Apar[7]+((-0.45*BdriftY[5]*Apar[6])-0.25*(BdriftY[0]*Apar[4]+BdriftY[1]*Apar[2]))*Phi[6]+((-0.25*BdriftY[0]*Phi[4])-0.25*BdriftY[1]*Phi[2])*Apar[6]+((-0.45*Apar[4]*Phi[4])-0.25*Apar[2]*Phi[2])*BdriftY[5]-0.25*BdriftY[3]*(Apar[2]*Phi[4]+Phi[2]*Apar[4]))*dfac_y+((-1.0*(((-0.45*BdriftX[3]*Apar[5])-0.25*BdriftX[0]*Apar[1])*Phi[7]+((-0.45*BdriftX[3]*Phi[5])-0.25*BdriftX[0]*Phi[1])*Apar[7]+((-0.45*BdriftX[5]*Phi[5])-0.25*BdriftX[1]*Phi[1])*Apar[6]-0.25*((BdriftX[0]*Apar[4]+BdriftX[1]*Apar[2])*Phi[5]+Phi[1]*Apar[2]*BdriftX[5]+BdriftX[0]*Phi[4]*Apar[5])))+0.25*Apar[0]*(BdriftX[1]*Phi[7]+Phi[4]*BdriftX[5])+0.45*Apar[3]*BdriftX[5]*Phi[7]+0.25*(BdriftX[1]*Apar[3]*Phi[4]+Phi[1]*BdriftX[3]*Apar[4])+0.25*Apar[1]*BdriftX[3]*Phi[4])*dfac_x)-1.0*(BmagInv[5]*((-1.35*Apar[6]*Phi[7])+1.35*Phi[6]*Apar[7]-0.75*Apar[2]*Phi[4]+0.75*Phi[2]*Apar[4])+BmagInv[1]*((-0.75*Apar[2]*Phi[7])+0.75*(Phi[2]*Apar[7]+Apar[4]*Phi[6])-0.75*Phi[4]*Apar[6]))*dfac_x*dfac_y)*q_)/m_); 
  ...
  alphav[21] = -(1.0*dfac_v*((0.7071067811865475*(BdriftX[1]*Bmag[5]+Bmag[1]*BdriftX[5])*dfac_x*wv)/q_+(0.7071067811865475*(Bmag[3]*Gradpar[5]+Gradpar[3]*Bmag[5])*dfac_z+dfac_x*(Bmag[5]*(0.4330127018922193*BmagInv[0]*Apar[4]*dfac_y+0.45*(Apar[3]*BdriftX[5]+BdriftX[3]*Apar[5])+0.25*(Apar[0]*BdriftX[1]+BdriftX[0]*Apar[1]))+1.732050807568877*(0.45*Bmag[5]*(BmagInv[3]*Apar[7]+BmagInv[5]*Apar[6])+Bmag[1]*(0.25*BmagInv[0]*Apar[7]+0.25*(BmagInv[1]*Apar[6]+Apar[2]*BmagInv[5]))+0.25*(BmagInv[1]*Apar[2]*Bmag[5]+Bmag[1]*BmagInv[3]*Apar[4]))*dfac_y+Bmag[1]*(0.25*(Apar[0]*BdriftX[5]+BdriftX[0]*Apar[5])+0.25*(Apar[1]*BdriftX[3]+BdriftX[1]*Apar[3]))))/m_))/dfac_m; 
