...
{ 
  ...
  double fUpOrd[2];
  if (0.7071067811865475*(alpha1R[0]+alpha0R[0]) > 0) { 
    fUpOrd[0] = (-0.8660254037844386*f1L[3])-0.5*f1L[2]+0.8660254037844386*f1L[1]+0.5*f1L[0]; 
  } else { 
    fUpOrd[0] = 0.8660254037844386*f1R[3]-0.5*f1R[2]-0.8660254037844386*f1R[1]+0.5*f1R[0]; 
  } 
  if (0.7071067811865475*(alpha1R[0]+alpha0R[0]) > 0) { 
    fUpOrd[1] = 0.8660254037844386*f1L[3]+0.5*f1L[2]+0.8660254037844386*f1L[1]+0.5*f1L[0]; 
  } else { 
    fUpOrd[1] = (-0.8660254037844386*f1R[3])+0.5*f1R[2]-0.8660254037844386*f1R[1]+0.5*f1R[0]; 
  } 
  ...
  incr[0] = 0.5*(alpha1R[0]+alpha0R[0])*fUp[0]; 
  incr[1] = -0.8660254037844386*(alpha1R[0]+alpha0R[0])*fUp[0]; 
  incr[2] = 0.5*(alpha1R[0]+alpha0R[0])*fUp[1]; 
  incr[3] = -0.8660254037844386*(alpha1R[0]+alpha0R[0])*fUp[1]; 
  ...
  if (0.7071067811865475*alpha1R[0] > 0) { 
    fUpOrd[0] = (-0.8660254037844386*f0L[3])-0.5*f0L[2]+0.8660254037844386*f0L[1]+0.5*f0L[0]; 
  } else { 
    fUpOrd[0] = 0.8660254037844386*f0R[3]-0.5*f0R[2]-0.8660254037844386*f0R[1]+0.5*f0R[0]; 
  } 
  if (0.7071067811865475*alpha1R[0] > 0) { 
    fUpOrd[1] = 0.8660254037844386*f0L[3]+0.5*f0L[2]+0.8660254037844386*f0L[1]+0.5*f0L[0]; 
  } else { 
    fUpOrd[1] = (-0.8660254037844386*f0R[3])+0.5*f0R[2]-0.8660254037844386*f0R[1]+0.5*f0R[0]; 
  } 
...
double EmDeltaFGyrokineticGenGeoSurf1x1vSer_vpar_P1_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
  ...
  // linear + nonlinear terms (alpha0+alpha1)*f1 
  double fUpOrd[2];
  if (0.7071067811865475*alpha1UpR[0]-0.7071067811865475*alpha1UpR[1] > 0) { 
    fUpOrd[0] = (-0.8660254037844386*f1L[3])+0.8660254037844386*f1L[2]-0.5*f1L[1]+0.5*f1L[0]; 
  } else { 
    fUpOrd[0] = 0.8660254037844386*f1R[3]-0.8660254037844386*f1R[2]-0.5*f1R[1]+0.5*f1R[0]; 
  } 
  if (0.7071067811865475*(alpha1UpR[1]+alpha1UpR[0]) > 0) { 
    fUpOrd[1] = 0.8660254037844386*(f1L[3]+f1L[2])+0.5*(f1L[1]+f1L[0]); 
  } else { 
    fUpOrd[1] = 0.5*(f1R[1]+f1R[0])-0.8660254037844386*(f1R[3]+f1R[2]); 
  } 
  ...
  // linear term alpha1*f0 
  if (0.7071067811865475*alpha1UpR[0]-0.7071067811865475*alpha1UpR[1] > 0) { 
    fUpOrd[0] = (-0.8660254037844386*f0L[3])+0.8660254037844386*f0L[2]-0.5*f0L[1]+0.5*f0L[0]; 
  } else { 
    fUpOrd[0] = 0.8660254037844386*f0R[3]-0.8660254037844386*f0R[2]-0.5*f0R[1]+0.5*f0R[0]; 
  } 
  if (0.7071067811865475*(alpha1UpR[1]+alpha1UpR[0]) > 0) { 
    fUpOrd[1] = 0.8660254037844386*(f0L[3]+f0L[2])+0.5*(f0L[1]+f0L[0]); 
  } else { 
    fUpOrd[1] = 0.5*(f0R[1]+f0R[0])-0.8660254037844386*(f0R[3]+f0R[2]); 
  } 
...
{ 
  ...
  double fUpOrd[2];
  if (0.7071067811865475*alpha1UpR[0]-0.7071067811865475*alpha1UpR[1] > 0) { 
    fUpOrd[0] = (-0.8660254037844386*(f1L[3]+f0L[3]))+0.8660254037844386*(f1L[2]+f0L[2])-0.5*(f1L[1]+f0L[1])+0.5*(f1L[0]+f0L[0]); 
  } else { 
    fUpOrd[0] = 0.8660254037844386*(f1R[3]+f0R[3])-0.8660254037844386*(f1R[2]+f0R[2])-0.5*(f1R[1]+f0R[1])+0.5*(f1R[0]+f0R[0]); 
  } 
  if (0.7071067811865475*(alpha1UpR[1]+alpha1UpR[0]) > 0) { 
    fUpOrd[1] = 0.8660254037844386*(f1L[3]+f0L[3]+f1L[2]+f0L[2])+0.5*(f1L[1]+f0L[1]+f1L[0]+f0L[0]); 
  } else { 
    fUpOrd[1] = 0.5*(f1R[1]+f0R[1]+f1R[0]+f0R[0])-0.8660254037844386*(f1R[3]+f0R[3]+f1R[2]+f0R[2]); 
  } 
...
double EmDeltaFGyrokineticGenGeoSurf1x1vSer_x_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
  ...
  // linear + nonlinear terms (alpha0+alpha1)*f1 
  double fUpOrd[2];
  if (0.7071067811865475*(alpha1R[0]+alpha0R[0])-0.7071067811865475*alpha0R[1] > 0) { 
    fUpOrd[0] = (-0.8660254037844386*f1L[3])-0.5*f1L[2]+0.8660254037844386*f1L[1]+0.5*f1L[0]; 
  } else { 
    fUpOrd[0] = 0.8660254037844386*f1R[3]-0.5*f1R[2]-0.8660254037844386*f1R[1]+0.5*f1R[0]; 
  } 
  if (0.7071067811865475*(alpha0R[1]+alpha1R[0]+alpha0R[0]) > 0) { 
    fUpOrd[1] = 0.8660254037844386*f1L[3]+0.5*f1L[2]+0.8660254037844386*f1L[1]+0.5*f1L[0]; 
  } else { 
    fUpOrd[1] = (-0.8660254037844386*f1R[3])+0.5*f1R[2]-0.8660254037844386*f1R[1]+0.5*f1R[0]; 
  } 
  ...
  incr[0] = 0.5*(alpha0R[1]*fUp[1]+(alpha1R[0]+alpha0R[0])*fUp[0]); 
  incr[1] = -0.8660254037844386*(alpha0R[1]*fUp[1]+(alpha1R[0]+alpha0R[0])*fUp[0]); 
  incr[2] = 0.5*((alpha1R[0]+alpha0R[0])*fUp[1]+fUp[0]*alpha0R[1]); 
  incr[3] = -0.8660254037844386*((alpha1R[0]+alpha0R[0])*fUp[1]+fUp[0]*alpha0R[1]); 
...
double EmDeltaFGyrokineticGenGeoSurf1x1vSer_vpar_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmDeltaFGyrokineticGenGeoSurf1x1vSerStep2_vpar_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *f0L, const double *f0R, const double *f1L, const double *f1R, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
