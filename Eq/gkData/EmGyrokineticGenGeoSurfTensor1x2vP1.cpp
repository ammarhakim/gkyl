...
{ 
  ...
  BstarZdBmagL[0] = 0.7071067811865475*jacobTotInv[0]*(2.449489742783178*b_y[0]*Apar[1]*rdx2L+2.0*cmag[0]); 

  double alphaL[4]; 
  alphaL[0] = (0.2165063509461096*BstarZdBmagL[0]*hamilL[2]*rdvpar2L)/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgL = (0.05412658773652741*BstarZdBmagL[0]*hamilL[2]*rdvpar2L)/m_; 
...
double EmGyrokineticGenGeoSurf1x2vTensor_vpar_P1_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmGyrokineticGenGeoSurf1x2vTensorStep2_vpar_P1_Bvars(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
...
double EmGyrokineticGenGeoSurf1x2vTensor_xL_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
  ...
  double BstarZdBmagL[8]; 
  BstarZdBmagL[0] = (0.7071067811865475*(3.464101615137754*jacobTotInv[0]*b_y[1]*m_*rdx2L*wvparL+q_*(2.449489742783178*(2.0*Apar[1]*b_y[1]*jacobTotInv[1]+jacobTotInv[0]*(Apar[0]*b_y[1]+b_y[0]*Apar[1]))*rdx2L+2.0*(cmag[1]*jacobTotInv[1]+cmag[0]*jacobTotInv[0]))))/q_; 
  BstarZdBmagL[1] = (0.7071067811865475*(3.464101615137754*b_y[1]*jacobTotInv[1]*m_*rdx2L*wvparL+q_*(2.449489742783178*((Apar[0]*b_y[1]+b_y[0]*Apar[1])*jacobTotInv[1]+2.0*jacobTotInv[0]*Apar[1]*b_y[1])*rdx2L+2.0*(cmag[0]*jacobTotInv[1]+jacobTotInv[0]*cmag[1]))))/q_; 
  BstarZdBmagL[2] = (1.414213562373095*jacobTotInv[0]*b_y[1]*m_*rdx2L)/(q_*rdvpar2L); 
  BstarZdBmagL[4] = (1.414213562373095*b_y[1]*jacobTotInv[1]*m_*rdx2L)/(q_*rdvpar2L); 

  double alphaL[4]; 
  alphaL[0] = (0.125*(3.0*BstarZdBmagL[1]+1.732050807568877*BstarZdBmagL[0])*hamilL[2]*rdvpar2L)/m_; 
  alphaL[1] = (0.125*hamilL[2]*(3.0*BstarZdBmagL[4]+1.732050807568877*BstarZdBmagL[2])*rdvpar2L)/m_; 

  // Surface-averaged phase velocity in this direction.
  double alphaSurfAvgL = (0.03125*(3.0*BstarZdBmagL[1]+1.732050807568877*BstarZdBmagL[0])*hamilL[2]*rdvpar2L)/m_; 

  double incr[8]; 
#if upwindType == SURFAVG 
  if (alphaSurfAvgL>0) { 
  incr[0] = 0.25*(alphaL[1]*(1.732050807568877*fL[4]+fL[2])+alphaL[0]*(1.732050807568877*fL[1]+fL[0])); 
  incr[1] = -0.25*(alphaL[1]*(3.0*fL[4]+1.732050807568877*fL[2])+alphaL[0]*(3.0*fL[1]+1.732050807568877*fL[0])); 
  incr[2] = 0.25*(alphaL[0]*(1.732050807568877*fL[4]+fL[2])+alphaL[1]*(1.732050807568877*fL[1]+fL[0])); 
  incr[3] = 0.25*(alphaL[1]*(1.732050807568877*fL[7]+fL[6])+alphaL[0]*(1.732050807568877*fL[5]+fL[3])); 
  incr[4] = -0.25*(alphaL[0]*(3.0*fL[4]+1.732050807568877*fL[2])+alphaL[1]*(3.0*fL[1]+1.732050807568877*fL[0])); 
  incr[5] = -0.25*(alphaL[1]*(3.0*fL[7]+1.732050807568877*fL[6])+alphaL[0]*(3.0*fL[5]+1.732050807568877*fL[3])); 
  incr[6] = 0.25*(alphaL[0]*(1.732050807568877*fL[7]+fL[6])+alphaL[1]*(1.732050807568877*fL[5]+fL[3])); 
  incr[7] = -0.25*(alphaL[0]*(3.0*fL[7]+1.732050807568877*fL[6])+alphaL[1]*(3.0*fL[5]+1.732050807568877*fL[3])); 
  } else { 
  incr[0] = -0.25*(alphaL[1]*(1.732050807568877*fR[4]-1.0*fR[2])+alphaL[0]*(1.732050807568877*fR[1]-1.0*fR[0])); 
  incr[1] = 0.25*(alphaL[1]*(3.0*fR[4]-1.732050807568877*fR[2])+alphaL[0]*(3.0*fR[1]-1.732050807568877*fR[0])); 
  incr[2] = -0.25*(alphaL[0]*(1.732050807568877*fR[4]-1.0*fR[2])+alphaL[1]*(1.732050807568877*fR[1]-1.0*fR[0])); 
  incr[3] = -0.25*(alphaL[1]*(1.732050807568877*fR[7]-1.0*fR[6])+alphaL[0]*(1.732050807568877*fR[5]-1.0*fR[3])); 
  incr[4] = 0.25*(alphaL[0]*(3.0*fR[4]-1.732050807568877*fR[2])+alphaL[1]*(3.0*fR[1]-1.732050807568877*fR[0])); 
  incr[5] = 0.25*(alphaL[1]*(3.0*fR[7]-1.732050807568877*fR[6])+alphaL[0]*(3.0*fR[5]-1.732050807568877*fR[3])); 
  incr[6] = -0.25*(alphaL[0]*(1.732050807568877*fR[7]-1.0*fR[6])+alphaL[1]*(1.732050807568877*fR[5]-1.0*fR[3])); 
  incr[7] = 0.25*(alphaL[0]*(3.0*fR[7]-1.732050807568877*fR[6])+alphaL[1]*(3.0*fR[5]-1.732050807568877*fR[3])); 
  }
#elif upwindType == QUAD 
  double alphaOrdL;
  double fUpOrd[4];
  alphaOrdL = 0.5*alphaL[0]-0.5*alphaL[1]; 
  fUpOrd[0] = 0.5*((0.6123724356957944*(fR[7]+fL[7])-0.3535533905932737*fR[6]+0.3535533905932737*fL[6]-0.6123724356957944*(fR[5]+fL[5]+fR[4]+fL[4])+0.3535533905932737*(fR[3]+fR[2])-0.3535533905932737*(fL[3]+fL[2])+0.6123724356957944*(fR[1]+fL[1])-0.3535533905932737*fR[0]+0.3535533905932737*fL[0])*sgn(alphaOrdL)-0.6123724356957944*fR[7]+0.6123724356957944*fL[7]+0.3535533905932737*(fR[6]+fL[6])+0.6123724356957944*(fR[5]+fR[4])-0.6123724356957944*(fL[5]+fL[4])-0.3535533905932737*(fR[3]+fL[3]+fR[2]+fL[2])-0.6123724356957944*fR[1]+0.6123724356957944*fL[1]+0.3535533905932737*(fR[0]+fL[0])); 
  alphaOrdL = 0.5*(alphaL[1]+alphaL[0]); 
  fUpOrd[1] = 0.5*(((-0.6123724356957944*(fR[7]+fL[7]))+0.3535533905932737*fR[6]-0.3535533905932737*fL[6]-0.6123724356957944*(fR[5]+fL[5])+0.6123724356957944*(fR[4]+fL[4])+0.3535533905932737*fR[3]-0.3535533905932737*(fL[3]+fR[2])+0.3535533905932737*fL[2]+0.6123724356957944*(fR[1]+fL[1])-0.3535533905932737*fR[0]+0.3535533905932737*fL[0])*sgn(alphaOrdL)+0.6123724356957944*fR[7]-0.6123724356957944*fL[7]-0.3535533905932737*(fR[6]+fL[6])+0.6123724356957944*fR[5]-0.6123724356957944*(fL[5]+fR[4])+0.6123724356957944*fL[4]-0.3535533905932737*(fR[3]+fL[3])+0.3535533905932737*(fR[2]+fL[2])-0.6123724356957944*fR[1]+0.6123724356957944*fL[1]+0.3535533905932737*(fR[0]+fL[0])); 
  alphaOrdL = 0.5*alphaL[0]-0.5*alphaL[1]; 
  fUpOrd[2] = 0.5*(((-0.6123724356957944*(fR[7]+fL[7]))+0.3535533905932737*fR[6]-0.3535533905932737*fL[6]+0.6123724356957944*(fR[5]+fL[5])-0.6123724356957944*(fR[4]+fL[4])-0.3535533905932737*fR[3]+0.3535533905932737*(fL[3]+fR[2])-0.3535533905932737*fL[2]+0.6123724356957944*(fR[1]+fL[1])-0.3535533905932737*fR[0]+0.3535533905932737*fL[0])*sgn(alphaOrdL)+0.6123724356957944*fR[7]-0.6123724356957944*fL[7]-0.3535533905932737*(fR[6]+fL[6])-0.6123724356957944*fR[5]+0.6123724356957944*(fL[5]+fR[4])-0.6123724356957944*fL[4]+0.3535533905932737*(fR[3]+fL[3])-0.3535533905932737*(fR[2]+fL[2])-0.6123724356957944*fR[1]+0.6123724356957944*fL[1]+0.3535533905932737*(fR[0]+fL[0])); 
  alphaOrdL = 0.5*(alphaL[1]+alphaL[0]); 
  ...
  incr[0] = 0.3535533905932737*(alphaL[1]*fUp[1]+alphaL[0]*fUp[0]); 
  incr[1] = -0.6123724356957944*(alphaL[1]*fUp[1]+alphaL[0]*fUp[0]); 
  incr[2] = 0.3535533905932737*(alphaL[0]*fUp[1]+fUp[0]*alphaL[1]); 
  incr[3] = 0.3535533905932737*(alphaL[1]*fUp[3]+alphaL[0]*fUp[2]); 
  incr[4] = -0.6123724356957944*(alphaL[0]*fUp[1]+fUp[0]*alphaL[1]); 
  incr[5] = -0.6123724356957944*(alphaL[1]*fUp[3]+alphaL[0]*fUp[2]); 
  incr[6] = 0.3535533905932737*(alphaL[0]*fUp[3]+alphaL[1]*fUp[2]); 
  incr[7] = -0.6123724356957944*(alphaL[0]*fUp[3]+alphaL[1]*fUp[2]); 
...
double EmGyrokineticGenGeoSurf1x2vTensor_xR_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmGyrokineticGenGeoSurf1x2vTensorStep2_vpar_P1_Bvarsx(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
...
double EmGyrokineticGenGeoSurf1x2vTensor_xL_P1_Bvarsz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmGyrokineticGenGeoSurf1x2vTensor_xR_P1_Bvarsz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmGyrokineticGenGeoSurf1x2vTensor_vpar_P1_Bvarsz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmGyrokineticGenGeoSurf1x2vTensorStep2_vpar_P1_Bvarsz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
...
double EmGyrokineticGenGeoSurf1x2vTensor_xL_P1_Bvarsxz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmGyrokineticGenGeoSurf1x2vTensor_xR_P1_Bvarsxz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmGyrokineticGenGeoSurf1x2vTensor_vpar_P1_Bvarsxz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // Apar: parallel component of magnetic vector potential.
  // AparL: Apar in the left cell.
  // dApardt: time derivative of Apar.
...
double EmGyrokineticGenGeoSurf1x2vTensorStep2_vpar_P1_Bvarsxz(const double q_, const double m_, const double cflL, const double cflR, const double *wL, const double *dxvL, const double *wR, const double *dxvR, const double amax_in, const double *bmag, const double *jacobTotInv, const double *cmag, const double *b_x, const double *b_y, const double *b_z, const double *phi, const double *Apar, const double *AparL, const double *dApardt, const double *dApardtPrev, const double *fL, const double *fR, double *outL, double *outR, double *emModL, double *emModR) 
{ 
  // jacobTotInv: reciprocal of the conf-space jacobian time the guiding center coordinate Jacobian.
  // b_x,b_y,b_z: covariant components of the field aligned unit vector.
  // q_,m_: species charge and mass.
