...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  emModR[1] += 0.5*(1.732050807568877*fl[4]+fl[1])*dfac_v; 
  emModR[2] += -0.5*(3.0*fl[2]+1.732050807568877*fl[0])*dfac_v; 
  emModR[3] += 0.5*(1.732050807568877*fl[6]+fl[3])*dfac_v; 
  emModR[4] += -0.5*(3.0*fl[4]+1.732050807568877*fl[1])*dfac_v; 
  emModR[5] += 0.5*(1.732050807568877*fl[7]+fl[5])*dfac_v; 
  emModR[6] += -0.5*(3.0*fl[6]+1.732050807568877*fl[3])*dfac_v; 
  emModR[7] += -0.5*(3.0*fl[7]+1.732050807568877*fl[5])*dfac_v; 
  emModL[0] += -0.5*(1.732050807568877*fl[2]+fl[0])*dfac_v; 
  emModL[1] += -0.5*(1.732050807568877*fl[4]+fl[1])*dfac_v; 
  emModL[2] += -0.5*(3.0*fl[2]+1.732050807568877*fl[0])*dfac_v; 
  emModL[3] += -0.5*(1.732050807568877*fl[6]+fl[3])*dfac_v; 
  emModL[4] += -0.5*(3.0*fl[4]+1.732050807568877*fl[1])*dfac_v; 
  emModL[5] += -0.5*(1.732050807568877*fl[7]+fl[5])*dfac_v; 
  emModL[6] += -0.5*(3.0*fl[6]+1.732050807568877*fl[3])*dfac_v; 
  emModL[7] += -0.5*(3.0*fl[7]+1.732050807568877*fl[5])*dfac_v; 
  ...
  emModR[1] += -0.5*(1.732050807568877*fr[4]-1.0*fr[1])*dfac_v; 
  emModR[2] += 0.5*(3.0*fr[2]-1.732050807568877*fr[0])*dfac_v; 
  emModR[3] += -0.5*(1.732050807568877*fr[6]-1.0*fr[3])*dfac_v; 
  emModR[4] += 0.5*(3.0*fr[4]-1.732050807568877*fr[1])*dfac_v; 
  emModR[5] += -0.5*(1.732050807568877*fr[7]-1.0*fr[5])*dfac_v; 
  emModR[6] += 0.5*(3.0*fr[6]-1.732050807568877*fr[3])*dfac_v; 
  emModR[7] += 0.5*(3.0*fr[7]-1.732050807568877*fr[5])*dfac_v; 
  emModL[0] += 0.5*(1.732050807568877*fr[2]-1.0*fr[0])*dfac_v; 
  emModL[1] += 0.5*(1.732050807568877*fr[4]-1.0*fr[1])*dfac_v; 
  emModL[2] += 0.5*(3.0*fr[2]-1.732050807568877*fr[0])*dfac_v; 
  emModL[3] += 0.5*(1.732050807568877*fr[6]-1.0*fr[3])*dfac_v; 
  emModL[4] += 0.5*(3.0*fr[4]-1.732050807568877*fr[1])*dfac_v; 
  emModL[5] += 0.5*(1.732050807568877*fr[7]-1.0*fr[5])*dfac_v; 
  emModL[6] += 0.5*(3.0*fr[6]-1.732050807568877*fr[3])*dfac_v; 
  emModL[7] += 0.5*(3.0*fr[7]-1.732050807568877*fr[5])*dfac_v; 
...
double fupwindQuad[8];
double limQuad[8];
  if(0.5*alphaUp[0]-0.5*alphaUp[1] > 0) {
  ...
  emModR[1] += -0.5*(1.732050807568877*fupwind[4]-1.0*fupwind[1])*dfac_v; 
  emModR[2] += 0.5*(3.0*fupwind[2]-1.732050807568877*fupwind[0])*dfac_v; 
  emModR[3] += -0.5*(1.732050807568877*fupwind[6]-1.0*fupwind[3])*dfac_v; 
  emModR[4] += 0.5*(3.0*fupwind[4]-1.732050807568877*fupwind[1])*dfac_v; 
  emModR[5] += -0.5*(1.732050807568877*fupwind[7]-1.0*fupwind[5])*dfac_v; 
  emModR[6] += 0.5*(3.0*fupwind[6]-1.732050807568877*fupwind[3])*dfac_v; 
  emModR[7] += 0.5*(3.0*fupwind[7]-1.732050807568877*fupwind[5])*dfac_v; 
  emModL[0] += 0.5*(1.732050807568877*fupwind[2]-1.0*fupwind[0])*dfac_v; 
  emModL[1] += 0.5*(1.732050807568877*fupwind[4]-1.0*fupwind[1])*dfac_v; 
  emModL[2] += 0.5*(3.0*fupwind[2]-1.732050807568877*fupwind[0])*dfac_v; 
  emModL[3] += 0.5*(1.732050807568877*fupwind[6]-1.0*fupwind[3])*dfac_v; 
  emModL[4] += 0.5*(3.0*fupwind[4]-1.732050807568877*fupwind[1])*dfac_v; 
  emModL[5] += 0.5*(1.732050807568877*fupwind[7]-1.0*fupwind[5])*dfac_v; 
  emModL[6] += 0.5*(3.0*fupwind[6]-1.732050807568877*fupwind[3])*dfac_v; 
  emModL[7] += 0.5*(3.0*fupwind[7]-1.732050807568877*fupwind[5])*dfac_v; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. H/f: Input Hamiltonian/distribution function. out: Incremented output 
  ...
  double alphaUp[4]; 
  alphaUp[0] = (1.414213562373095*Gradpar[0]-2.449489742783178*Gradpar[1])*wv; 
#if upwindType == SURFAVG 
  if (alpha0>0) { 
  incr[0] = 0.25*alpha[0]*(1.732050807568877*fl[1]+fl[0])*dfac_x; 
  incr[1] = -0.25*alpha[0]*(3.0*fl[1]+1.732050807568877*fl[0])*dfac_x; 
...
double fupwindQuad[8];
double limQuad[8];
  if(0.5*alphaUp[3]-0.5*(alphaUp[2]+alphaUp[1])+0.5*alphaUp[0] > 0) {
  fupwindQuad[0] = 0.3535533905932737*fl[7]-0.3535533905932737*fl[6]+0.3535533905932737*fl[5]-0.3535533905932737*(fl[4]+fl[3])+0.3535533905932737*fl[2]-0.3535533905932737*fl[1]+0.3535533905932737*fl[0]; 
  } else {
  fupwindQuad[0] = (-0.3535533905932737*fr[7])+0.3535533905932737*(fr[6]+fr[5]+fr[4])-0.3535533905932737*(fr[3]+fr[2]+fr[1])+0.3535533905932737*fr[0]; 
  }
  if(0.5*(alphaUp[1]+alphaUp[0])-0.5*(alphaUp[3]+alphaUp[2]) > 0) {
  fupwindQuad[1] = (-0.3535533905932737*(fl[7]+fl[6]+fl[5]))+0.3535533905932737*fl[4]-0.3535533905932737*fl[3]+0.3535533905932737*(fl[2]+fl[1]+fl[0]); 
  } else {
  fupwindQuad[1] = 0.3535533905932737*(fr[7]+fr[6])-0.3535533905932737*(fr[5]+fr[4]+fr[3]+fr[2])+0.3535533905932737*(fr[1]+fr[0]); 
  }
  ...
  if((-0.5*alphaUp[3])+0.5*alphaUp[2]-0.5*alphaUp[1]+0.5*alphaUp[0] > 0) {
  fupwindQuad[4] = (-0.3535533905932737*fl[7])+0.3535533905932737*fl[6]-0.3535533905932737*(fl[5]+fl[4])+0.3535533905932737*(fl[3]+fl[2])-0.3535533905932737*fl[1]+0.3535533905932737*fl[0]; 
  } else {
  fupwindQuad[4] = 0.3535533905932737*fr[7]-0.3535533905932737*(fr[6]+fr[5])+0.3535533905932737*(fr[4]+fr[3])-0.3535533905932737*(fr[2]+fr[1])+0.3535533905932737*fr[0]; 
  }
  if(0.5*(alphaUp[3]+alphaUp[2]+alphaUp[1]+alphaUp[0]) > 0) {
  fupwindQuad[5] = 0.3535533905932737*(fl[7]+fl[6]+fl[5]+fl[4]+fl[3]+fl[2]+fl[1]+fl[0]); 
  } else {
  fupwindQuad[5] = (-0.3535533905932737*(fr[7]+fr[6]))+0.3535533905932737*fr[5]-0.3535533905932737*fr[4]+0.3535533905932737*fr[3]-0.3535533905932737*fr[2]+0.3535533905932737*(fr[1]+fr[0]); 
  }
