...
double alphaQuad;
  ...
  fupwindQuad[0] = 0.5*((0.3535533905932737*(fr[7]+fl[7]+fl[6])-0.3535533905932737*(fr[6]+fr[5]+fl[5]+fr[4]+fl[4]+fl[3]+fl[2])+0.3535533905932737*(fr[3]+fr[2]+fr[1]+fl[1]+fl[0])-0.3535533905932737*fr[0])*sgn(alphaQuad)-0.3535533905932737*fr[7]+0.3535533905932737*(fl[7]+fr[6]+fl[6]+fr[5]+fr[4])-0.3535533905932737*(fl[5]+fl[4]+fr[3]+fl[3]+fr[2]+fl[2]+fr[1])+0.3535533905932737*(fl[1]+fr[0]+fl[0])); 
  alphaQuad = 0.5*alpha[0]; 
  fupwindQuad[1] = 0.5*(((-0.3535533905932737*(fr[7]+fl[7]+fr[6]))+0.3535533905932737*(fl[6]+fr[5]+fl[5]+fr[4]+fl[4]+fr[3]+fr[2])-0.3535533905932737*(fl[3]+fl[2]+fr[1]+fl[1]+fr[0])+0.3535533905932737*fl[0])*sgn(alphaQuad)+0.3535533905932737*(fr[7]+fr[6])-0.3535533905932737*fl[7]+0.3535533905932737*(fl[6]+fl[5]+fl[4])-0.3535533905932737*(fr[5]+fr[4]+fr[3]+fl[3]+fr[2]+fl[2]+fl[1])+0.3535533905932737*(fr[1]+fr[0]+fl[0])); 
  alphaQuad = 0.5*alpha[0]; 
  fupwindQuad[2] = 0.5*(((-0.3535533905932737*(fr[7]+fl[7]+fl[6]+fl[5]))+0.3535533905932737*fr[6]-0.3535533905932737*fr[5]+0.3535533905932737*(fr[4]+fl[4]+fr[3])-0.3535533905932737*(fl[3]+fr[2])+0.3535533905932737*(fl[2]+fr[1]+fl[1]+fl[0])-0.3535533905932737*fr[0])*sgn(alphaQuad)+0.3535533905932737*fr[7]-0.3535533905932737*(fl[7]+fr[6]+fl[6]+fl[5])+0.3535533905932737*fr[5]-0.3535533905932737*(fr[4]+fr[3])+0.3535533905932737*fl[4]-0.3535533905932737*fl[3]+0.3535533905932737*(fr[2]+fl[2]+fl[1]+fl[0])-0.3535533905932737*fr[1]+0.3535533905932737*fr[0]); 
  alphaQuad = 0.5*alpha[0]; 
  fupwindQuad[3] = 0.5*((0.3535533905932737*(fr[7]+fl[7]+fr[6]+fr[5])-0.3535533905932737*fl[6]+0.3535533905932737*fl[5]-0.3535533905932737*(fr[4]+fl[4]+fl[3])+0.3535533905932737*fr[3]-0.3535533905932737*(fr[2]+fr[1]+fr[0])+0.3535533905932737*fl[2]-0.3535533905932737*fl[1]+0.3535533905932737*fl[0])*sgn(alphaQuad)-0.3535533905932737*(fr[7]+fr[6]+fr[5])+0.3535533905932737*fl[7]-0.3535533905932737*fl[6]+0.3535533905932737*(fl[5]+fr[4])-0.3535533905932737*(fl[4]+fr[3]+fl[3])+0.3535533905932737*(fr[2]+fl[2]+fr[1]+fr[0])-0.3535533905932737*fl[1]+0.3535533905932737*fl[0]); 
  alphaQuad = 0.5*alpha[0]; 
  fupwindQuad[4] = 0.5*(((-0.3535533905932737*(fr[7]+fl[7]+fl[6]))+0.3535533905932737*(fr[6]+fr[5]+fl[5])-0.3535533905932737*(fr[4]+fl[4]+fr[3])+0.3535533905932737*(fl[3]+fr[2]+fr[1])-0.3535533905932737*fl[2]+0.3535533905932737*(fl[1]+fl[0])-0.3535533905932737*fr[0])*sgn(alphaQuad)+0.3535533905932737*fr[7]-0.3535533905932737*(fl[7]+fr[6]+fl[6]+fr[5])+0.3535533905932737*(fl[5]+fr[4]+fr[3])-0.3535533905932737*fl[4]+0.3535533905932737*fl[3]-0.3535533905932737*(fr[2]+fl[2]+fr[1])+0.3535533905932737*(fl[1]+fr[0]+fl[0])); 
  alphaQuad = 0.5*alpha[0]; 
  fupwindQuad[5] = 0.5*((0.3535533905932737*(fr[7]+fl[7]+fr[6])-0.3535533905932737*(fl[6]+fr[5]+fl[5])+0.3535533905932737*(fr[4]+fl[4]+fl[3])-0.3535533905932737*fr[3]+0.3535533905932737*fr[2]-0.3535533905932737*(fl[2]+fr[1]+fl[1]+fr[0])+0.3535533905932737*fl[0])*sgn(alphaQuad)-0.3535533905932737*(fr[7]+fr[6])+0.3535533905932737*fl[7]-0.3535533905932737*(fl[6]+fl[5])+0.3535533905932737*fr[5]-0.3535533905932737*fr[4]+0.3535533905932737*(fl[4]+fr[3]+fl[3])-0.3535533905932737*(fr[2]+fl[2]+fl[1])+0.3535533905932737*(fr[1]+fr[0]+fl[0])); 
  alphaQuad = 0.5*alpha[0]; 
  fupwindQuad[6] = 0.5*((0.3535533905932737*(fr[7]+fl[7]+fl[6]+fl[5]+fl[4]+fl[3]+fl[2]+fl[1]+fl[0])-0.3535533905932737*fr[6]+0.3535533905932737*(fr[5]+fr[4])-0.3535533905932737*(fr[3]+fr[2])+0.3535533905932737*fr[1]-0.3535533905932737*fr[0])*sgn(alphaQuad)-0.3535533905932737*fr[7]+0.3535533905932737*(fl[7]+fr[6]+fl[6]+fl[5]+fl[4]+fl[3]+fl[2]+fl[1]+fl[0])-0.3535533905932737*(fr[5]+fr[4])+0.3535533905932737*(fr[3]+fr[2])-0.3535533905932737*fr[1]+0.3535533905932737*fr[0]); 
  alphaQuad = 0.5*alpha[0]; 
  fupwindQuad[7] = 0.5*(((-0.3535533905932737*(fr[7]+fl[7]+fr[6]+fr[5]+fr[4]+fr[3]+fr[2]+fr[1]+fr[0]))+0.3535533905932737*fl[6]-0.3535533905932737*(fl[5]+fl[4])+0.3535533905932737*(fl[3]+fl[2])-0.3535533905932737*fl[1]+0.3535533905932737*fl[0])*sgn(alphaQuad)+0.3535533905932737*(fr[7]+fr[6]+fr[5]+fr[4]+fr[3]+fr[2]+fr[1]+fr[0])-0.3535533905932737*fl[7]+0.3535533905932737*fl[6]-0.3535533905932737*(fl[5]+fl[4])+0.3535533905932737*(fl[3]+fl[2])-0.3535533905932737*fl[1]+0.3535533905932737*fl[0]); 
...
double alphaQuad;
  ...
  fupwindQuad[0] = 0.5*((0.3535533905932737*(fr[7]+fl[7])-0.3535533905932737*(fr[6]+fl[6]+fr[5]+fr[4])+0.3535533905932737*fl[5]-0.3535533905932737*(fl[4]+fl[3])+0.3535533905932737*(fr[3]+fr[2]+fl[2]+fr[1])-0.3535533905932737*(fl[1]+fr[0])+0.3535533905932737*fl[0])*sgn(alphaQuad)-0.3535533905932737*fr[7]+0.3535533905932737*(fl[7]+fr[6]+fr[5]+fr[4])-0.3535533905932737*fl[6]+0.3535533905932737*fl[5]-0.3535533905932737*(fl[4]+fr[3]+fl[3]+fr[2]+fr[1])+0.3535533905932737*fl[2]-0.3535533905932737*fl[1]+0.3535533905932737*(fr[0]+fl[0])); 
  alphaQuad = 0.5*(alphaUp[1]+alphaUp[0]); 
  fupwindQuad[1] = 0.5*(((-0.3535533905932737*(fr[7]+fl[7]+fr[6]+fl[6]+fl[5]))+0.3535533905932737*(fr[5]+fr[4]+fl[4]+fr[3]+fr[2])-0.3535533905932737*fl[3]+0.3535533905932737*(fl[2]+fl[1]+fl[0])-0.3535533905932737*(fr[1]+fr[0]))*sgn(alphaQuad)+0.3535533905932737*(fr[7]+fr[6])-0.3535533905932737*(fl[7]+fl[6]+fr[5]+fl[5]+fr[4]+fr[3]+fr[2])+0.3535533905932737*fl[4]-0.3535533905932737*fl[3]+0.3535533905932737*(fl[2]+fr[1]+fl[1]+fr[0]+fl[0])); 
  alphaQuad = 0.5*alphaUp[0]-0.5*alphaUp[1]; 
  fupwindQuad[2] = 0.5*(((-0.3535533905932737*(fr[7]+fl[7]))+0.3535533905932737*(fr[6]+fl[6]+fl[5]+fl[4])-0.3535533905932737*fr[5]+0.3535533905932737*(fr[4]+fr[3])-0.3535533905932737*(fl[3]+fr[2]+fl[2]+fl[1])+0.3535533905932737*fr[1]-0.3535533905932737*fr[0]+0.3535533905932737*fl[0])*sgn(alphaQuad)+0.3535533905932737*fr[7]-0.3535533905932737*(fl[7]+fr[6])+0.3535533905932737*(fl[6]+fr[5]+fl[5]+fl[4])-0.3535533905932737*(fr[4]+fr[3]+fl[3]+fl[2]+fl[1])+0.3535533905932737*fr[2]-0.3535533905932737*fr[1]+0.3535533905932737*(fr[0]+fl[0])); 
  alphaQuad = 0.5*(alphaUp[1]+alphaUp[0]); 
  fupwindQuad[3] = 0.5*((0.3535533905932737*(fr[7]+fl[7]+fr[6]+fl[6]+fr[5])-0.3535533905932737*(fl[5]+fr[4]+fl[4]+fl[3]+fl[2])+0.3535533905932737*fr[3]-0.3535533905932737*(fr[2]+fr[1]+fr[0])+0.3535533905932737*(fl[1]+fl[0]))*sgn(alphaQuad)-0.3535533905932737*(fr[7]+fr[6]+fr[5])+0.3535533905932737*(fl[7]+fl[6])-0.3535533905932737*(fl[5]+fl[4]+fl[3]+fl[2])+0.3535533905932737*fr[4]-0.3535533905932737*fr[3]+0.3535533905932737*(fr[2]+fr[1]+fl[1]+fr[0]+fl[0])); 
  alphaQuad = 0.5*alphaUp[0]-0.5*alphaUp[1]; 
  fupwindQuad[4] = 0.5*(((-0.3535533905932737*(fr[7]+fl[7]))+0.3535533905932737*(fr[6]+fl[6]+fr[5])-0.3535533905932737*(fl[5]+fr[4]+fl[4]+fr[3])+0.3535533905932737*(fl[3]+fr[2]+fl[2]+fr[1])-0.3535533905932737*(fl[1]+fr[0])+0.3535533905932737*fl[0])*sgn(alphaQuad)+0.3535533905932737*fr[7]-0.3535533905932737*(fl[7]+fr[6]+fr[5])+0.3535533905932737*fl[6]-0.3535533905932737*(fl[5]+fl[4])+0.3535533905932737*(fr[4]+fr[3]+fl[3]+fl[2])-0.3535533905932737*(fr[2]+fr[1]+fl[1])+0.3535533905932737*(fr[0]+fl[0])); 
  alphaQuad = 0.5*(alphaUp[1]+alphaUp[0]); 
  fupwindQuad[5] = 0.5*((0.3535533905932737*(fr[7]+fl[7]+fr[6]+fl[6]+fl[5]+fl[4]+fl[3]+fl[2]+fl[1]+fl[0])-0.3535533905932737*fr[5]+0.3535533905932737*fr[4]-0.3535533905932737*fr[3]+0.3535533905932737*fr[2]-0.3535533905932737*(fr[1]+fr[0]))*sgn(alphaQuad)-0.3535533905932737*(fr[7]+fr[6])+0.3535533905932737*(fl[7]+fl[6]+fr[5]+fl[5]+fl[4]+fl[3]+fl[2]+fl[1]+fl[0])-0.3535533905932737*fr[4]+0.3535533905932737*fr[3]-0.3535533905932737*fr[2]+0.3535533905932737*(fr[1]+fr[0])); 
  alphaQuad = 0.5*alphaUp[0]-0.5*alphaUp[1]; 
  fupwindQuad[6] = 0.5*((0.3535533905932737*(fr[7]+fl[7])-0.3535533905932737*(fr[6]+fl[6]+fl[5])+0.3535533905932737*(fr[5]+fr[4]+fl[4]+fl[3])-0.3535533905932737*(fr[3]+fr[2]+fl[2]+fl[1])+0.3535533905932737*fr[1]-0.3535533905932737*fr[0]+0.3535533905932737*fl[0])*sgn(alphaQuad)-0.3535533905932737*fr[7]+0.3535533905932737*(fl[7]+fr[6])-0.3535533905932737*(fl[6]+fr[5]+fl[5]+fr[4])+0.3535533905932737*(fl[4]+fr[3]+fl[3]+fr[2])-0.3535533905932737*(fl[2]+fr[1]+fl[1])+0.3535533905932737*(fr[0]+fl[0])); 
  alphaQuad = 0.5*(alphaUp[1]+alphaUp[0]); 
  fupwindQuad[7] = 0.5*(((-0.3535533905932737*(fr[7]+fl[7]+fr[6]+fl[6]+fr[5]+fr[4]+fr[3]+fr[2]+fr[1]+fr[0]))+0.3535533905932737*fl[5]-0.3535533905932737*fl[4]+0.3535533905932737*fl[3]-0.3535533905932737*fl[2]+0.3535533905932737*(fl[1]+fl[0]))*sgn(alphaQuad)+0.3535533905932737*(fr[7]+fr[6]+fr[5]+fr[4]+fr[3]+fr[2]+fr[1]+fr[0])-0.3535533905932737*(fl[7]+fl[6])+0.3535533905932737*fl[5]-0.3535533905932737*fl[4]+0.3535533905932737*fl[3]-0.3535533905932737*fl[2]+0.3535533905932737*(fl[1]+fl[0])); 
  fupwind[0] = 0.3535533905932737*(fupwindQuad[7]+fupwindQuad[6]+fupwindQuad[5]+fupwindQuad[4]+fupwindQuad[3]+fupwindQuad[2]+fupwindQuad[1]+fupwindQuad[0]); 
  fupwind[1] = 0.3535533905932737*(fupwindQuad[7]-1.0*fupwindQuad[6]+fupwindQuad[5]-1.0*fupwindQuad[4]+fupwindQuad[3]-1.0*fupwindQuad[2]+fupwindQuad[1]-1.0*fupwindQuad[0]); 
  fupwind[2] = 0.3535533905932737*(fupwindQuad[7]+fupwindQuad[6]-1.0*(fupwindQuad[5]+fupwindQuad[4])+fupwindQuad[3]+fupwindQuad[2]-1.0*(fupwindQuad[1]+fupwindQuad[0])); 
  fupwind[3] = 0.3535533905932737*(fupwindQuad[7]+fupwindQuad[6]+fupwindQuad[5]+fupwindQuad[4]-1.0*(fupwindQuad[3]+fupwindQuad[2]+fupwindQuad[1]+fupwindQuad[0])); 
  ...
  fupwind[6] = 0.3535533905932737*(fupwindQuad[7]+fupwindQuad[6]-1.0*(fupwindQuad[5]+fupwindQuad[4]+fupwindQuad[3]+fupwindQuad[2])+fupwindQuad[1]+fupwindQuad[0]); 
  fupwind[7] = 0.3535533905932737*(fupwindQuad[7]-1.0*(fupwindQuad[6]+fupwindQuad[5])+fupwindQuad[4]-1.0*fupwindQuad[3]+fupwindQuad[2]+fupwindQuad[1]-1.0*fupwindQuad[0]); 
  incrEmMod[0] = -0.5*(1.732050807568877*fupwind[2]-1.0*fupwind[0])*dfac_v; 
  incrEmMod[1] = -0.5*(1.732050807568877*fupwind[4]-1.0*fupwind[1])*dfac_v; 
  incrEmMod[2] = 0.5*(3.0*fupwind[2]-1.732050807568877*fupwind[0])*dfac_v; 
  incrEmMod[3] = -0.5*(1.732050807568877*fupwind[6]-1.0*fupwind[3])*dfac_v; 
  incrEmMod[4] = 0.5*(3.0*fupwind[4]-1.732050807568877*fupwind[1])*dfac_v; 
  incrEmMod[5] = -0.5*(1.732050807568877*fupwind[7]-1.0*fupwind[5])*dfac_v; 
  incrEmMod[6] = 0.5*(3.0*fupwind[6]-1.732050807568877*fupwind[3])*dfac_v; 
  incrEmMod[7] = 0.5*(3.0*fupwind[7]-1.732050807568877*fupwind[5])*dfac_v; 
...
double alphaQuad;
  ...
  fupwind[6] = 0.3535533905932737*(fupwindQuad[7]+fupwindQuad[6]-1.0*(fupwindQuad[5]+fupwindQuad[4]+fupwindQuad[3]+fupwindQuad[2])+fupwindQuad[1]+fupwindQuad[0]); 
  fupwind[7] = 0.3535533905932737*(fupwindQuad[7]-1.0*(fupwindQuad[6]+fupwindQuad[5])+fupwindQuad[4]-1.0*fupwindQuad[3]+fupwindQuad[2]+fupwindQuad[1]-1.0*fupwindQuad[0]); 
  incr[0] = -0.25*(1.732050807568877*(alpha[1]*fupwind[4]+alpha[0]*fupwind[2])-1.0*(alpha[1]*fupwind[1]+alpha[0]*fupwind[0]))*dfac_v; 
  incr[1] = -0.25*(1.732050807568877*(alpha[0]*fupwind[4]+alpha[1]*fupwind[2])-1.0*(alpha[0]*fupwind[1]+fupwind[0]*alpha[1]))*dfac_v; 
  incr[2] = 0.25*(3.0*(alpha[1]*fupwind[4]+alpha[0]*fupwind[2])-1.732050807568877*(alpha[1]*fupwind[1]+alpha[0]*fupwind[0]))*dfac_v; 
  incr[3] = -0.25*(1.732050807568877*(alpha[1]*fupwind[7]+alpha[0]*fupwind[6])-1.0*(alpha[1]*fupwind[5]+alpha[0]*fupwind[3]))*dfac_v; 
  incr[4] = 0.25*(3.0*(alpha[0]*fupwind[4]+alpha[1]*fupwind[2])-1.732050807568877*(alpha[0]*fupwind[1]+fupwind[0]*alpha[1]))*dfac_v; 
  incr[5] = -0.25*(1.732050807568877*(alpha[0]*fupwind[7]+alpha[1]*fupwind[6])-1.0*(alpha[0]*fupwind[5]+alpha[1]*fupwind[3]))*dfac_v; 
  incr[6] = 0.25*(3.0*(alpha[1]*fupwind[7]+alpha[0]*fupwind[6])-1.732050807568877*(alpha[1]*fupwind[5]+alpha[0]*fupwind[3]))*dfac_v; 
  incr[7] = 0.25*(3.0*(alpha[0]*fupwind[7]+alpha[1]*fupwind[6])-1.732050807568877*(alpha[0]*fupwind[5]+alpha[1]*fupwind[3]))*dfac_v; 
