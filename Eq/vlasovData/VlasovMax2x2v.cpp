...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  out[3] += 0.4330127018922193*(alpha2[3]*f[3]+alpha2[2]*f[2]+alpha2[1]*f[1]+alpha2[0]*f[0]); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  out[1] += 0.4330127018922193*(alpha0[3]*f[3]+alpha0[0]*f[0]); 
  out[2] += 0.4330127018922193*(alpha1[4]*f[4]+alpha1[0]*f[0]); 
  out[3] += 0.4330127018922193*(alpha2[12]*f[12]+alpha2[11]*f[11]+alpha2[7]*f[7]+alpha2[6]*f[6]+alpha2[5]*f[5]+alpha2[3]*f[3]+alpha2[2]*f[2]+alpha2[1]*f[1]+alpha2[0]*f[0]); 
  ...
  out[6] += 0.3872983346207416*(alpha0[3]*f[13]+alpha2[1]*f[11]+f[1]*alpha2[11])+0.4330127018922193*(alpha2[3]*f[6]+f[3]*alpha2[6]+alpha2[2]*f[5]+f[2]*alpha2[5]+alpha0[0]*f[3]+f[0]*alpha0[3]+alpha2[0]*f[1]+f[0]*alpha2[1]); 
  out[7] += 0.3872983346207416*(alpha2[2]*f[12]+f[2]*alpha2[12])+0.4330127018922193*(alpha1[4]*f[10]+alpha2[3]*f[7]+f[3]*alpha2[7]+alpha2[1]*f[5]+f[1]*alpha2[5]+alpha1[0]*f[3]+alpha2[0]*f[2]+f[0]*alpha2[2]); 
  ...
  out[10] += 0.3872983346207416*alpha3[3]*f[13]+0.4330127018922193*(alpha2[3]*f[10]+alpha2[2]*f[9]+alpha2[1]*f[8]+alpha3[2]*f[7]+f[2]*alpha3[7]+alpha3[1]*f[6]+f[1]*alpha3[6]+alpha2[0]*f[4]+alpha3[0]*f[3]+f[0]*alpha3[3]); 
  out[11] += 0.9682458365518543*(alpha0[3]*f[6]+alpha0[0]*f[1]); 
  out[12] += 0.9682458365518543*(alpha1[4]*f[9]+alpha1[0]*f[2]); 
  out[13] += 0.8660254037844386*alpha2[3]*f[13]+0.9682458365518543*(alpha2[2]*f[7]+f[2]*alpha2[7]+alpha2[1]*f[6]+f[1]*alpha2[6]+alpha2[0]*f[3]+f[0]*alpha2[3]); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  out[1] += 0.4330127018922193*(alpha0[3]*f[3]+alpha0[0]*f[0]); 
  out[2] += 0.4330127018922193*(alpha1[4]*f[4]+alpha1[0]*f[0]); 
  out[3] += 0.4330127018922193*(alpha2[32]*f[32]+alpha2[31]*f[31]+alpha2[22]*f[22]+alpha2[21]*f[21]+alpha2[20]*f[20]+alpha2[19]*f[19]+alpha2[15]*f[15]+alpha2[12]*f[12]+alpha2[11]*f[11]+alpha2[7]*f[7]+alpha2[6]*f[6]+alpha2[5]*f[5]+alpha2[3]*f[3]+alpha2[2]*f[2]+alpha2[1]*f[1]+alpha2[0]*f[0]); 
  ...
  out[5] += 0.4330127018922193*(alpha1[4]*f[8]+alpha0[3]*f[7]+alpha0[0]*f[2]+alpha1[0]*f[1]); 
  out[6] += 0.3803194146278324*(alpha2[11]*f[31]+f[11]*alpha2[31])+0.3872983346207416*(alpha2[6]*f[21]+f[6]*alpha2[21])+0.4330127018922193*(alpha2[12]*f[20]+f[12]*alpha2[20])+0.3872983346207416*(alpha2[5]*f[19]+f[5]*alpha2[19])+0.4330127018922193*(alpha2[7]*f[15]+f[7]*alpha2[15])+0.3872983346207416*(alpha0[3]*f[13]+alpha2[1]*f[11]+f[1]*alpha2[11])+0.4330127018922193*(alpha2[3]*f[6]+f[3]*alpha2[6]+alpha2[2]*f[5]+f[2]*alpha2[5]+alpha0[0]*f[3]+f[0]*alpha0[3]+alpha2[0]*f[1]+f[0]*alpha2[1]); 
  out[7] += 0.3803194146278324*(alpha2[12]*f[32]+f[12]*alpha2[32])+0.3872983346207416*(alpha2[7]*f[22]+f[7]*alpha2[22]+alpha2[5]*f[20]+f[5]*alpha2[20])+0.4330127018922193*(alpha2[11]*f[19]+f[11]*alpha2[19]+alpha2[6]*f[15]+f[6]*alpha2[15])+0.3872983346207416*(alpha2[2]*f[12]+f[2]*alpha2[12])+0.4330127018922193*(alpha1[4]*f[10]+alpha2[3]*f[7]+f[3]*alpha2[7]+alpha2[1]*f[5]+f[1]*alpha2[5]+alpha1[0]*f[3]+alpha2[0]*f[2]+f[0]*alpha2[2]); 
  ...
  out[10] += 0.4330127018922193*(alpha2[12]*f[26]+alpha2[11]*f[25])+0.3872983346207416*(alpha3[7]*f[24]+alpha3[6]*f[23])+0.4330127018922193*(alpha3[12]*f[22]+f[12]*alpha3[22]+alpha3[11]*f[21]+f[11]*alpha3[21]+alpha2[7]*f[18]+alpha2[6]*f[17]+alpha2[5]*f[16]+alpha3[5]*f[15]+f[5]*alpha3[15])+0.3872983346207416*alpha3[3]*f[13]+0.4330127018922193*(alpha2[3]*f[10]+alpha2[2]*f[9]+alpha2[1]*f[8]+alpha3[2]*f[7]+f[2]*alpha3[7]+alpha3[1]*f[6]+f[1]*alpha3[6]+alpha2[0]*f[4]+alpha3[0]*f[3]+f[0]*alpha3[3]); 
  out[11] += 0.9682458365518543*(alpha0[3]*f[6]+alpha0[0]*f[1]); 
  out[12] += 0.9682458365518543*(alpha1[4]*f[9]+alpha1[0]*f[2]); 
  out[13] += 0.8660254037844386*(alpha2[7]*f[24]+alpha2[6]*f[23])+0.9682458365518543*(alpha2[12]*f[22]+f[12]*alpha2[22]+alpha2[11]*f[21]+f[11]*alpha2[21]+alpha2[5]*f[15]+f[5]*alpha2[15])+0.8660254037844386*alpha2[3]*f[13]+0.9682458365518543*(alpha2[2]*f[7]+f[2]*alpha2[7]+alpha2[1]*f[6]+f[1]*alpha2[6]+alpha2[0]*f[3]+f[0]*alpha2[3]); 
  ...
  out[15] += 0.3803194146278324*(alpha2[20]*f[32]+f[20]*alpha2[32]+alpha2[19]*f[31]+f[19]*alpha2[31])+0.3872983346207416*(alpha0[3]*f[24]+alpha2[15]*f[22]+f[15]*alpha2[22]+alpha2[15]*f[21]+f[15]*alpha2[21])+(0.3464101615137755*alpha2[19]+0.3872983346207416*alpha2[2])*f[20]+0.3464101615137755*f[19]*alpha2[20]+0.3872983346207416*(f[2]*alpha2[20]+alpha2[1]*f[19]+f[1]*alpha2[19])+0.4330127018922193*(alpha1[4]*f[17]+alpha2[3]*f[15]+f[3]*alpha2[15])+0.3872983346207416*(alpha2[5]*f[12]+f[5]*alpha2[12]+alpha2[5]*f[11]+f[5]*alpha2[11])+0.4330127018922193*((alpha2[6]+alpha0[0])*f[7]+f[6]*(alpha2[7]+alpha1[0])+alpha2[0]*f[5]+f[0]*alpha2[5]+f[2]*(alpha0[3]+alpha2[1])+f[1]*alpha2[2]); 
  ...
  out[17] += 0.3803194146278324*(alpha3[21]*f[31]+f[21]*alpha3[31]+f[25]*alpha2[31])+0.3872983346207416*alpha0[3]*f[27]+0.4330127018922193*alpha2[20]*f[26]+0.3872983346207416*(alpha2[1]*f[25]+alpha3[15]*f[24])+(0.3464101615137755*alpha3[21]+0.3872983346207416*alpha3[3])*f[23]+0.4330127018922193*(alpha3[20]*f[22]+f[20]*alpha3[22])+0.3872983346207416*(alpha3[1]*f[21]+f[1]*alpha3[21]+f[17]*alpha2[21]+alpha3[15]*f[19]+f[15]*alpha3[19]+f[16]*alpha2[19])+0.4330127018922193*(alpha2[15]*f[18]+alpha2[3]*f[17]+alpha2[2]*f[16]+alpha3[2]*f[15]+f[2]*alpha3[15])+0.3872983346207416*(alpha3[6]*(f[13]+f[11])+f[6]*alpha3[11]+f[8]*alpha2[11])+0.4330127018922193*((alpha2[6]+alpha0[0])*f[10]+alpha2[5]*f[9]+alpha2[0]*f[8]+alpha3[5]*f[7]+f[5]*alpha3[7]+alpha3[0]*f[6]+f[0]*alpha3[6]+(alpha0[3]+alpha2[1])*f[4]+alpha3[1]*f[3]+f[1]*alpha3[3]); 
  out[18] += 0.3803194146278324*(alpha3[22]*f[32]+f[22]*alpha3[32]+f[26]*alpha2[32])+0.3872983346207416*(alpha1[4]*f[30]+alpha2[2]*f[26])+0.4330127018922193*alpha2[19]*f[25]+0.3464101615137755*alpha3[22]*f[24]+0.3872983346207416*(alpha3[3]*f[24]+alpha3[15]*f[23]+alpha3[2]*f[22]+f[2]*alpha3[22]+f[18]*alpha2[22])+0.4330127018922193*(alpha3[19]*f[21]+f[19]*alpha3[21])+0.3872983346207416*(alpha3[15]*f[20]+f[15]*alpha3[20]+f[16]*alpha2[20])+0.4330127018922193*(alpha2[3]*f[18]+alpha2[15]*f[17]+alpha2[1]*f[16]+alpha3[1]*f[15]+f[1]*alpha3[15])+0.3872983346207416*(alpha3[7]*(f[13]+f[12])+f[7]*alpha3[12]+f[9]*alpha2[12])+0.4330127018922193*((alpha2[7]+alpha1[0])*f[10]+alpha2[0]*f[9]+alpha2[5]*f[8]+alpha3[0]*f[7]+f[0]*alpha3[7]+alpha3[5]*f[6]+f[5]*alpha3[6]+alpha2[2]*f[4]+f[3]*(alpha1[4]+alpha3[2])+f[2]*alpha3[3]); 
  ...
  out[21] += 0.2581988897471612*alpha2[31]*f[31]+0.3803194146278324*(alpha2[1]*f[31]+f[1]*alpha2[31])+0.8660254037844386*alpha0[3]*f[23]+0.276641667586244*alpha2[21]*f[21]+0.4330127018922193*(alpha2[3]*f[21]+f[3]*alpha2[21])+0.3872983346207416*alpha2[20]*f[20]+0.276641667586244*alpha2[19]*f[19]+0.4330127018922193*(alpha2[2]*f[19]+f[2]*alpha2[19])+0.3872983346207416*alpha2[15]*f[15]+0.276641667586244*alpha2[11]*f[11]+0.4330127018922193*(alpha2[0]*f[11]+f[0]*alpha2[11])+(0.3872983346207416*alpha2[6]+0.9682458365518543*alpha0[0])*f[6]+0.3872983346207416*alpha2[5]*f[5]+f[1]*(0.9682458365518543*alpha0[3]+0.3872983346207416*alpha2[1]); 
  out[22] += 0.2581988897471612*alpha2[32]*f[32]+0.3803194146278324*(alpha2[2]*f[32]+f[2]*alpha2[32])+0.276641667586244*alpha2[22]*f[22]+0.4330127018922193*(alpha2[3]*f[22]+f[3]*alpha2[22])+0.276641667586244*alpha2[20]*f[20]+0.4330127018922193*(alpha2[1]*f[20]+f[1]*alpha2[20])+0.3872983346207416*alpha2[19]*f[19]+0.9682458365518543*alpha1[4]*f[18]+0.3872983346207416*alpha2[15]*f[15]+0.276641667586244*alpha2[12]*f[12]+0.4330127018922193*(alpha2[0]*f[12]+f[0]*alpha2[12])+(0.3872983346207416*alpha2[7]+0.9682458365518543*alpha1[0])*f[7]+0.3872983346207416*(alpha2[5]*f[5]+alpha2[2]*f[2]); 
  out[23] += 0.3803194146278324*alpha0[3]*f[33]+0.8504200642707612*(alpha2[21]*f[31]+f[21]*alpha2[31])+0.8660254037844386*alpha2[15]*f[24]+(0.7745966692414833*alpha2[21]+0.8660254037844386*alpha2[3])*f[23]+0.9682458365518543*(alpha2[20]*f[22]+f[20]*alpha2[22])+0.8660254037844386*(alpha2[1]*f[21]+f[1]*alpha2[21]+alpha2[15]*f[19]+f[15]*alpha2[19])+0.9682458365518543*(alpha2[2]*f[15]+f[2]*alpha2[15])+(0.8660254037844386*alpha2[6]+0.4330127018922193*alpha0[0])*f[13]+0.8660254037844386*(alpha2[6]*f[11]+f[6]*alpha2[11])+0.9682458365518543*(alpha2[5]*f[7]+f[5]*alpha2[7]+alpha2[0]*f[6]+f[0]*alpha2[6])+0.3872983346207416*alpha0[3]*f[3]+0.9682458365518543*(alpha2[1]*f[3]+f[1]*alpha2[3]); 
  out[24] += 0.8504200642707612*(alpha2[22]*f[32]+f[22]*alpha2[32])+0.4330127018922193*alpha1[4]*f[27]+0.7745966692414833*alpha2[22]*f[24]+0.8660254037844386*(alpha2[3]*f[24]+alpha2[15]*f[23]+alpha2[2]*f[22]+f[2]*alpha2[22])+0.9682458365518543*(alpha2[19]*f[21]+f[19]*alpha2[21])+0.8660254037844386*(alpha2[15]*f[20]+f[15]*alpha2[20])+0.9682458365518543*(alpha2[1]*f[15]+f[1]*alpha2[15])+(0.8660254037844386*alpha2[7]+0.4330127018922193*alpha1[0])*f[13]+0.8660254037844386*(alpha2[7]*f[12]+f[7]*alpha2[12])+0.9682458365518543*(alpha2[0]*f[7]+f[0]*alpha2[7]+alpha2[5]*f[6]+f[5]*alpha2[6]+alpha2[2]*f[3]+f[2]*alpha2[3]); 
  ...
  out[27] += 0.3803194146278324*alpha3[3]*f[33]+0.8660254037844386*alpha2[3]*f[27]+0.9682458365518543*(alpha2[22]*f[26]+alpha2[21]*f[25])+0.4330127018922193*(alpha3[2]*f[24]+alpha3[1]*f[23])+0.3872983346207416*(alpha3[22]*f[22]+alpha3[21]*f[21])+0.9682458365518543*(alpha2[2]*f[18]+alpha2[1]*f[17]+alpha2[15]*f[16])+0.3872983346207416*alpha3[15]*f[15]+0.4330127018922193*alpha3[0]*f[13]+0.9682458365518543*(alpha2[0]*f[10]+alpha2[7]*f[9]+alpha2[6]*f[8])+0.3872983346207416*(alpha3[7]*f[7]+alpha3[6]*f[6])+0.9682458365518543*alpha2[3]*f[4]+0.3872983346207416*alpha3[3]*f[3]; 
  ...
  out[30] += 0.4330127018922193*(alpha2[3]*f[30]+alpha2[2]*f[29]+alpha2[1]*f[28])+0.8660254037844386*alpha3[3]*f[27]+0.9682458365518543*(alpha3[22]*f[26]+alpha3[21]*f[25]+alpha3[2]*f[18]+alpha3[1]*f[17]+alpha3[15]*f[16])+0.4330127018922193*alpha2[0]*f[14]+0.9682458365518543*(alpha3[0]*f[10]+alpha3[7]*f[9]+alpha3[6]*f[8]+alpha3[3]*f[4]); 
  ...
  out[33] += 1.299038105676658*alpha2[3]*f[33]+0.6614378277661477*(alpha2[32]*f[32]+alpha2[31]*f[31])+1.479019945774904*(alpha2[2]*f[24]+alpha2[1]*f[23])+1.984313483298443*(alpha2[22]*f[22]+alpha2[21]*f[21])+0.6614378277661477*(alpha2[20]*f[20]+alpha2[19]*f[19])+1.984313483298443*alpha2[15]*f[15]+1.479019945774904*alpha2[0]*f[13]+0.6614378277661477*(alpha2[12]*f[12]+alpha2[11]*f[11])+1.984313483298443*(alpha2[7]*f[7]+alpha2[6]*f[6])+0.6614378277661477*alpha2[5]*f[5]+1.984313483298443*alpha2[3]*f[3]+0.6614378277661477*(alpha2[2]*f[2]+alpha2[1]*f[1]+alpha2[0]*f[0]); 
