...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  alpha2[0] = 2.0*dv10*(B2[0]*wv2+E0[0]); 
  alpha2[1] = 2.0*dv10*(B2[1]*wv2+E0[1]); 
  alpha2[2] = 2.0*dv10*(B2[2]*wv2+E0[2]); 
  alpha2[4] = 0.5773502691896258*B2[0]*dv10*dv2; 

  alpha3[0] = dv11*(2.0*E1[0]-2.0*B2[0]*wv1); 
  alpha3[1] = dv11*(2.0*E1[1]-2.0*B2[1]*wv1); 
  alpha3[2] = dv11*(2.0*E1[2]-2.0*B2[2]*wv1); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  alpha2[2] = 2.0*dv10*(B2[2]*wv2+E0[2]); 
  alpha2[4] = 0.5773502691896258*B2[0]*dv10*dv2; 
  alpha2[5] = 2.0*dv10*(B2[3]*wv2+E0[3]); 
  alpha2[8] = 0.5773502691896258*B2[1]*dv10*dv2; 
  alpha2[9] = 0.5773502691896258*B2[2]*dv10*dv2; 
  alpha2[11] = 2.0*dv10*(B2[4]*wv2+E0[4]); 
  alpha2[12] = 2.0*dv10*(B2[5]*wv2+E0[5]); 

  alpha3[0] = dv11*(2.0*E1[0]-2.0*B2[0]*wv1); 
  alpha3[1] = dv11*(2.0*E1[1]-2.0*B2[1]*wv1); 
  alpha3[2] = dv11*(2.0*E1[2]-2.0*B2[2]*wv1); 
  alpha3[3] = -0.5773502691896258*B2[0]*dv1*dv11; 
  alpha3[5] = dv11*(2.0*E1[3]-2.0*B2[3]*wv1); 
  alpha3[6] = -0.5773502691896258*B2[1]*dv1*dv11; 
  alpha3[7] = -0.5773502691896258*B2[2]*dv1*dv11; 
  alpha3[11] = dv11*(2.0*E1[4]-2.0*B2[4]*wv1); 
  alpha3[12] = dv11*(2.0*E1[5]-2.0*B2[5]*wv1); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  alpha2[19] = 2.0*dv10*(B2[6]*wv2+E0[6]); 
  alpha2[20] = 2.0*dv10*(B2[7]*wv2+E0[7]); 
  alpha2[25] = 0.5773502691896258*B2[4]*dv10*dv2; 
  alpha2[26] = 0.5773502691896258*B2[5]*dv10*dv2; 
  alpha2[31] = 2.0*dv10*(B2[8]*wv2+E0[8]); 
  alpha2[32] = 2.0*dv10*(B2[9]*wv2+E0[9]); 
  ...
  alpha3[19] = dv11*(2.0*E1[6]-2.0*B2[6]*wv1); 
  alpha3[20] = dv11*(2.0*E1[7]-2.0*B2[7]*wv1); 
  alpha3[21] = -0.5773502691896258*B2[4]*dv1*dv11; 
  alpha3[22] = -0.5773502691896258*B2[5]*dv1*dv11; 
  alpha3[31] = dv11*(2.0*E1[8]-2.0*B2[8]*wv1); 
  alpha3[32] = dv11*(2.0*E1[9]-2.0*B2[9]*wv1); 
