...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. f: Input distribution function. out: Incremented output 
  ...
  out[8] += 3.464101615137754*f[4]*w0dx0+f[9]*dv0dx0; 
  out[11] += 7.745966692414834*f[1]*w0dx0+2.23606797749979*f[5]*dv0dx0; 
  out[15] += 3.464101615137754*f[7]*w0dx0+0.8944271909999161*f[22]*dv0dx0+f[3]*dv0dx0; 
  out[16] += 3.464101615137754*f[9]*w0dx0+0.8944271909999161*f[26]*dv0dx0+f[4]*dv0dx0; 
  ...
  out[20] += 3.464101615137755*f[12]*w0dx0+0.8783100656536798*f[32]*dv0dx0+0.8944271909999161*f[2]*dv0dx0; 
  ...
  out[31] += 11.83215956619923*f[11]*w0dx0+5.291502622129181*f[0]*w0dx0+3.415650255319866*f[19]*dv0dx0+1.527525231651947*f[2]*dv0dx0; 
return std:abs(w0dx0); 
} 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. f: Input distribution function. out: Incremented output 
  ...
  out[37] += 3.464101615137755*f[22]*w0dx0+0.8783100656536798*f[57]*dv0dx0+0.8944271909999159*f[7]*dv0dx0; 
  out[38] += 3.464101615137755*f[24]*w0dx0+0.8944271909999159*f[50]*dv0dx0+f[13]*dv0dx0; 
  out[39] += 7.745966692414834*f[16]*w0dx0+2.0*f[40]*dv0dx0+2.23606797749979*f[8]*dv0dx0; 
  out[40] += 3.464101615137755*f[26]*w0dx0+0.8783100656536798*f[61]*dv0dx0+0.8944271909999159*f[9]*dv0dx0; 
  out[41] += 7.745966692414834*f[17]*w0dx0+2.23606797749979*f[35]*dv0dx0; 
  out[43] += 3.464101615137755*f[27]*w0dx0+f[44]*dv0dx0; 
  out[45] += 3.464101615137755*f[29]*w0dx0+0.8944271909999159*f[52]*dv0dx0+f[14]*dv0dx0; 
  ...
  out[54] += 11.83215956619923*f[19]*w0dx0+5.291502622129181*f[2]*w0dx0+3.055050463303893*f[48]*dv0dx0+1.366260102127946*f[12]*dv0dx0+3.415650255319866*f[11]*dv0dx0+1.527525231651947*f[0]*dv0dx0; 
  out[55] += 3.464101615137754*f[32]*w0dx0+0.8728715609439696*f[67]*dv0dx0+0.8783100656536798*f[12]*dv0dx0; 
  out[56] += 11.83215956619923*f[21]*w0dx0+5.291502622129181*f[3]*w0dx0+3.415650255319866*f[36]*dv0dx0+1.527525231651947*f[7]*dv0dx0; 
  out[58] += 3.464101615137754*f[33]*w0dx0+f[59]*dv0dx0; 
  out[60] += 11.83215956619923*f[25]*w0dx0+5.291502622129181*f[4]*w0dx0+3.415650255319866*f[39]*dv0dx0+1.527525231651947*f[9]*dv0dx0; 
