...
__host__ __device__ double VlasovPhiVol1x2vSerP2(const double *w, const double *dxv, const double *phi, const double *Bvec, const double *f, double *out) 
{ 
  ...
  alpha_vdim[20] = -2.0*B2[0]*dv11*wv1; 
  alpha_vdim[21] = -2.0*B2[1]*dv11*wv1; 
  alpha_vdim[22] = -0.5773502691896258*B2[0]*dv1*dv11; 
  alpha_vdim[24] = -0.5773502691896258*B2[1]*dv1*dv11; 
  alpha_vdim[27] = -2.0*B2[2]*dv11*wv1; 
