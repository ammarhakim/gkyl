...
// returns abs(amid) for use in determining amax in cfl and global lax flux 
  ...
  favg[2] = 0.7071067811865475*fr[4]+0.7071067811865475*fl[4]; 
  ...
  Ghat[1] = 0.3535533905932737*(1.732050807568877*(fr[3]+fl[3])-1.0*fr[1]+fl[1])*amax+0.07071067811865475*(4.47213595499958*(alpha[1]*favg[2]+favg[1]*alpha[2])+5.0*(alpha[0]*favg[1]+favg[0]*alpha[1])); 
  Ghat[2] = 0.01010152544552211*((22.3606797749979*alpha[2]+35.0*alpha[0])*favg[2]+35.0*favg[0]*alpha[2]+31.30495168499706*alpha[1]*favg[1])-0.3535533905932737*(fr[4]-1.0*fl[4])*amax; 
