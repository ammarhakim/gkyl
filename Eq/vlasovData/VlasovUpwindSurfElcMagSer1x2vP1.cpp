...
__host__ __device__ double VlasovUpwindSurfElcMag1x2vSer_VX_P1(const double *wl, const double *wr, const double *dxvl, const double *dxvr, const double amax, const double *EM, const double *fl, const double *fr, double *outl, double *outr) 
{ 
  ...
  double alphaOrdR;
  double fUpOrd[4];
  alphaOrdR = 0.5*alpha[3]-0.5*(alpha[2]+alpha[1])+0.5*alpha[0]; 
  ...
  alphaOrdR = 0.5*(alpha[1]+alpha[0])-0.5*(alpha[3]+alpha[2]); 
  ...
  alphaOrdR = (-0.5*alpha[3])+0.5*alpha[2]-0.5*alpha[1]+0.5*alpha[0]; 
  ...
  alphaOrdR = 0.5*(alpha[3]+alpha[2]+alpha[1]+alpha[0]); 
  ...
  incr[0] = 0.3535533905932737*(alpha[3]*fUp[3]+alpha[2]*fUp[2]+alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[1] = 0.3535533905932737*(alpha[2]*fUp[3]+fUp[2]*alpha[3]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[2] = -0.6123724356957944*(alpha[3]*fUp[3]+alpha[2]*fUp[2]+alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[3] = 0.3535533905932737*(alpha[1]*fUp[3]+fUp[1]*alpha[3]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[4] = -0.6123724356957944*(alpha[2]*fUp[3]+fUp[2]*alpha[3]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[5] = 0.3535533905932737*(alpha[0]*fUp[3]+fUp[0]*alpha[3]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
  incr[6] = -0.6123724356957944*(alpha[1]*fUp[3]+fUp[1]*alpha[3]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[7] = -0.6123724356957944*(alpha[0]*fUp[3]+fUp[0]*alpha[3]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
...
__host__ __device__ double VlasovUpwindSurfElcMag1x2vSer_VY_P1(const double *wl, const double *wr, const double *dxvl, const double *dxvr, const double amax, const double *EM, const double *fl, const double *fr, double *outl, double *outr) 
{ 
  // w:         Cell-center coordinates.
  // dxv[NDIM]: Cell spacing.
  // amax:      amax in global lax flux.
  ...
  incr[0] = 0.3535533905932737*(alpha[3]*fUp[3]+alpha[2]*fUp[2]+alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[1] = 0.3535533905932737*(alpha[2]*fUp[3]+fUp[2]*alpha[3]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[2] = 0.3535533905932737*(alpha[1]*fUp[3]+fUp[1]*alpha[3]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[3] = -0.6123724356957944*(alpha[3]*fUp[3]+alpha[2]*fUp[2]+alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[4] = 0.3535533905932737*(alpha[0]*fUp[3]+fUp[0]*alpha[3]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
  incr[5] = -0.6123724356957944*(alpha[2]*fUp[3]+fUp[2]*alpha[3]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[6] = -0.6123724356957944*(alpha[1]*fUp[3]+fUp[1]*alpha[3]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[7] = -0.6123724356957944*(alpha[0]*fUp[3]+fUp[0]*alpha[3]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
