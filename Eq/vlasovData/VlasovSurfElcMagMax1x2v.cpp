...
// returns abs(amid) for use in determining amax in cfl and global lax flux 
  ...
  Ghat[0] += 0.1767766952966368*alpha[3]*favg[3]-0.8660254037844386*fjump[2]+0.3061862178478971*alpha[0]*favg[2]+0.1767766952966368*alpha[1]*favg[1]-0.5*fjump[0]+0.1767766952966368*alpha[0]*favg[0]; 
  Ghat[1] += 0.3061862178478971*alpha[1]*favg[2]-0.5*fjump[1]+0.1767766952966368*(alpha[0]*favg[1]+favg[0]*alpha[1]); 
...
// returns abs(amid) for use in determining amax in cfl and global lax flux 
  ...
  Ghat[0] += (-1.118033988749895*fjump[8])+0.3952847075210473*alpha[0]*favg[8]+0.1767766952966368*alpha[7]*favg[7]+0.3061862178478971*alpha[3]*favg[6]+0.1767766952966368*alpha[5]*favg[5]+0.3061862178478971*alpha[1]*favg[4]+0.1767766952966368*alpha[3]*favg[3]-0.8660254037844386*fjump[2]+0.3061862178478971*alpha[0]*favg[2]+0.1767766952966368*alpha[1]*favg[1]-0.5*fjump[0]+0.1767766952966368*alpha[0]*favg[0]; 
  ...
  Ghat[7] += 0.3952847075210473*alpha[7]*favg[8]-0.5*fjump[7]+(0.1129384878631564*alpha[7]+0.1767766952966368*alpha[0])*favg[7]+(0.3061862178478971*favg[2]+0.1767766952966368*favg[0])*alpha[7]+0.1581138830084189*alpha[5]*favg[5]+alpha[1]*(0.273861278752583*favg[4]+0.1581138830084189*favg[1]); 
  Ghat[9] += (-0.5*fjump[9])+0.1767766952966368*alpha[0]*favg[9]+0.273861278752583*alpha[3]*favg[6]+0.1581138830084189*(alpha[5]*favg[5]+alpha[3]*favg[3]); 
...
// returns abs(amid) for use in determining amax in cfl and global lax flux 
  ...
  const double amid = 0.3535533905932737*alpha[0]-0.3952847075210473*alpha[7]; 
  Ghat[0] += (-1.322875655532295*fjump[18])+0.4677071733467425*alpha[0]*favg[18]+0.1767766952966368*alpha[17]*favg[17]+0.3952847075210473*alpha[3]*favg[14]+0.1767766952966368*alpha[13]*favg[13]+0.3952847075210473*alpha[1]*favg[12]+0.3061862178478971*(alpha[7]*favg[11]+alpha[5]*favg[10])-1.118033988749895*fjump[8]+0.3952847075210473*alpha[0]*favg[8]+0.1767766952966368*alpha[7]*favg[7]+0.3061862178478971*alpha[3]*favg[6]+0.1767766952966368*alpha[5]*favg[5]+0.3061862178478971*alpha[1]*favg[4]+0.1767766952966368*alpha[3]*favg[3]-0.8660254037844386*fjump[2]+0.3061862178478971*alpha[0]*favg[2]+0.1767766952966368*alpha[1]*favg[1]-0.5*fjump[0]+0.1767766952966368*alpha[0]*favg[0]; 
  Ghat[1] += 0.4677071733467425*alpha[1]*favg[18]+0.1552647508520296*alpha[7]*favg[17]+(0.2689264371002384*favg[11]+0.1552647508520296*favg[7])*alpha[17]+alpha[5]*(0.3952847075210473*favg[14]+0.1581138830084189*favg[13])+(0.273861278752583*favg[10]+0.1581138830084189*favg[5])*alpha[13]-1.118033988749895*fjump[12]+(0.3535533905932737*alpha[7]+0.3952847075210473*alpha[0])*favg[12]+0.273861278752583*alpha[1]*favg[11]+0.3061862178478971*alpha[3]*favg[10]+alpha[1]*(0.3952847075210473*favg[8]+0.1581138830084189*favg[7])+(0.273861278752583*favg[4]+0.1581138830084189*favg[1])*alpha[7]+0.3061862178478971*alpha[5]*favg[6]+0.1767766952966368*(alpha[3]*favg[5]+favg[3]*alpha[5])-0.8660254037844386*fjump[4]+0.3061862178478971*(alpha[0]*favg[4]+alpha[1]*favg[2])-0.5*fjump[1]+0.1767766952966368*(alpha[0]*favg[1]+favg[0]*alpha[1]); 
...
// returns abs(amid) for use in determining amax in cfl and global lax flux 
  ...
  const double amid = 0.3535533905932737*alpha[0]; 
  Ghat[0] += (-0.8660254037844386*fjump[3])+0.3061862178478971*alpha[0]*favg[3]+0.1767766952966368*(alpha[2]*favg[2]+alpha[1]*favg[1])-0.5*fjump[0]+0.1767766952966368*alpha[0]*favg[0]; 
  Ghat[1] += 0.3061862178478971*alpha[1]*favg[3]-0.5*fjump[1]+0.1767766952966368*(alpha[0]*favg[1]+favg[0]*alpha[1]); 
  Ghat[2] += 0.3061862178478971*alpha[2]*favg[3]-0.5*fjump[2]+0.1767766952966368*(alpha[0]*favg[2]+favg[0]*alpha[2]); 
...
// returns abs(amid) for use in determining amax in cfl and global lax flux 
  ...
  const double amid = 0.3535533905932737*alpha[0]-0.3952847075210473*alpha[7]; 
  Ghat[0] += (-1.118033988749895*fjump[9])+0.3952847075210473*alpha[0]*favg[9]+0.1767766952966368*alpha[7]*favg[7]+0.3061862178478971*(alpha[2]*favg[6]+alpha[1]*favg[5])+0.1767766952966368*alpha[4]*favg[4]-0.8660254037844386*fjump[3]+0.3061862178478971*alpha[0]*favg[3]+0.1767766952966368*(alpha[2]*favg[2]+alpha[1]*favg[1])-0.5*fjump[0]+0.1767766952966368*alpha[0]*favg[0]; 
  ...
  Ghat[2] += alpha[2]*(0.3952847075210473*favg[9]+0.1581138830084189*favg[8])-0.8660254037844386*fjump[6]+0.3061862178478971*(alpha[0]*favg[6]+alpha[4]*favg[5])+0.1767766952966368*(alpha[1]*favg[4]+favg[1]*alpha[4])+0.3061862178478971*alpha[2]*favg[3]-0.5*fjump[2]+0.1767766952966368*(alpha[0]*favg[2]+favg[0]*alpha[2]); 
  Ghat[4] += 0.3952847075210473*alpha[4]*favg[9]+0.1581138830084189*(alpha[4]*(favg[8]+favg[7])+favg[4]*alpha[7])+0.3061862178478971*(alpha[1]*favg[6]+alpha[2]*favg[5])-0.5*fjump[4]+0.1767766952966368*alpha[0]*favg[4]+0.3061862178478971*favg[3]*alpha[4]+0.1767766952966368*(favg[0]*alpha[4]+alpha[1]*favg[2]+favg[1]*alpha[2]); 
  Ghat[7] += 0.3952847075210473*alpha[7]*favg[9]-0.5*fjump[7]+(0.1129384878631564*alpha[7]+0.1767766952966368*alpha[0])*favg[7]+(0.3061862178478971*favg[3]+0.1767766952966368*favg[0])*alpha[7]+0.273861278752583*alpha[1]*favg[5]+0.1581138830084189*(alpha[4]*favg[4]+alpha[1]*favg[1]); 
  Ghat[8] += (-0.5*fjump[8])+0.1767766952966368*alpha[0]*favg[8]+0.273861278752583*alpha[2]*favg[6]+0.1581138830084189*(alpha[4]*favg[4]+alpha[2]*favg[2]); 
