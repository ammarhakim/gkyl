...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  incr0[6] = 0.7824607964359517*abar0[2]*f[4]+1.224744871391589*abar0[0]*f[4]+1.224744871391589*f[0]*abar0[2]+1.095445115010332*abar0[1]*f[1]; 
  incr0[7] = 2.449489742783178*abar0[1]*f[6]+2.449489742783178*abar0[2]*f[3]+2.738612787525831*abar0[0]*f[3]+2.738612787525831*abar0[1]*f[2]; 
