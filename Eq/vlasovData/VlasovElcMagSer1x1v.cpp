...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  out[3] += 0.8660254037844386*(alpha1[0]*f[1]+f[0]*alpha1[1]); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  out[6] += 0.5532833351724881*alpha1[4]*f[4]+0.8660254037844386*(alpha1[0]*f[4]+f[0]*alpha1[4])+0.7745966692414833*alpha1[1]*f[1]; 
  out[7] += 1.732050807568877*(alpha1[1]*f[6]+f[3]*alpha1[4])+1.936491673103709*(alpha1[0]*f[3]+alpha1[1]*f[2]); 
return 0.5*std::abs(amid1); 
} 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  out[7] += 1.700840128541522*(alpha1[4]*f[10]+f[6]*alpha1[8])+1.732050807568877*(alpha1[1]*f[6]+f[3]*alpha1[4])+1.936491673103709*(alpha1[0]*f[3]+alpha1[1]*f[2]); 
  ...
  out[10] += (0.5163977794943223*alpha1[4]+0.8660254037844386*alpha1[0])*f[8]+(0.5163977794943223*f[4]+0.8660254037844386*f[0])*alpha1[8]+0.7606388292556648*(alpha1[1]*f[4]+f[1]*alpha1[4]); 
  out[11] += 1.161895003862225*(alpha1[4]*f[8]+f[4]*alpha1[8])+2.645751311064591*alpha1[4]*f[7]+2.958039891549809*(alpha1[0]*f[7]+alpha1[1]*f[5])+1.183215956619923*(alpha1[1]*f[4]+f[1]*alpha1[4])+1.322875655532295*(alpha1[0]*f[1]+f[0]*alpha1[1]); 
return 0.5*std::abs(amid1); 
} 
