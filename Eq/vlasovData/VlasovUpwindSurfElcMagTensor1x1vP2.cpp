...
__host__ __device__ double VlasovUpwindSurfElcMag1x1vTensor_VX_P2(const double *wl, const double *wr, const double *dxvl, const double *dxvr, const double amax, const double *EM, const double *fl, const double *fr, double *outl, double *outr) 
{ 
  ...
  incr[8] = 0.07142857142857142*((10.0*alpha[2]+15.65247584249853*alpha[0])*fUp[2]+15.65247584249853*fUp[0]*alpha[2]+14.0*alpha[1]*fUp[1]); 
