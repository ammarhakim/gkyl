...
{ 
  ...
  double alphaOrdR;
  double fUpOrd[8];
  alphaOrdR = 0.3535533905932737*alpha[0]-0.3535533905932737*alpha[1]; 
  ...
  alphaOrdR = 0.3535533905932737*(alpha[1]+alpha[0]); 
  ...
  incr[0] = 0.25*(alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[1] = 0.25*(alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[2] = -0.4330127018922193*(alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[3] = 0.25*(alpha[1]*fUp[4]+alpha[0]*fUp[2]); 
  incr[4] = 0.25*(alpha[1]*fUp[5]+alpha[0]*fUp[3]); 
  incr[5] = -0.4330127018922193*(alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[6] = 0.25*(alpha[0]*fUp[4]+alpha[1]*fUp[2]); 
  incr[7] = -0.4330127018922193*(alpha[1]*fUp[4]+alpha[0]*fUp[2]); 
  incr[8] = 0.25*(alpha[0]*fUp[5]+alpha[1]*fUp[3]); 
  incr[9] = -0.4330127018922193*(alpha[1]*fUp[5]+alpha[0]*fUp[3]); 
  incr[10] = 0.25*(alpha[1]*fUp[7]+alpha[0]*fUp[6]); 
  incr[11] = -0.4330127018922193*(alpha[0]*fUp[4]+alpha[1]*fUp[2]); 
  incr[12] = -0.4330127018922193*(alpha[0]*fUp[5]+alpha[1]*fUp[3]); 
  incr[13] = 0.25*(alpha[0]*fUp[7]+alpha[1]*fUp[6]); 
  incr[14] = -0.4330127018922193*(alpha[1]*fUp[7]+alpha[0]*fUp[6]); 
  incr[15] = -0.4330127018922193*(alpha[0]*fUp[7]+alpha[1]*fUp[6]); 
...
{ 
  ...
  incr[0] = 0.25*(alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[1] = 0.25*(alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[2] = 0.25*(alpha[1]*fUp[4]+alpha[0]*fUp[2]); 
  incr[3] = -0.4330127018922193*(alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[4] = 0.25*(alpha[1]*fUp[5]+alpha[0]*fUp[3]); 
  incr[5] = 0.25*(alpha[0]*fUp[4]+alpha[1]*fUp[2]); 
  incr[6] = -0.4330127018922193*(alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[7] = -0.4330127018922193*(alpha[1]*fUp[4]+alpha[0]*fUp[2]); 
  incr[8] = 0.25*(alpha[0]*fUp[5]+alpha[1]*fUp[3]); 
  incr[9] = 0.25*(alpha[1]*fUp[7]+alpha[0]*fUp[6]); 
  incr[10] = -0.4330127018922193*(alpha[1]*fUp[5]+alpha[0]*fUp[3]); 
  incr[11] = -0.4330127018922193*(alpha[0]*fUp[4]+alpha[1]*fUp[2]); 
  incr[12] = 0.25*(alpha[0]*fUp[7]+alpha[1]*fUp[6]); 
  incr[13] = -0.4330127018922193*(alpha[0]*fUp[5]+alpha[1]*fUp[3]); 
  incr[14] = -0.4330127018922193*(alpha[1]*fUp[7]+alpha[0]*fUp[6]); 
  incr[15] = -0.4330127018922193*(alpha[0]*fUp[7]+alpha[1]*fUp[6]); 
...
{ 
  ...
  incr[1] = 0.25*(alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[2] = 0.25*(alpha[1]*fUp[4]+alpha[0]*fUp[2]); 
  incr[3] = 0.25*(alpha[1]*fUp[5]+alpha[0]*fUp[3]); 
  incr[4] = -0.4330127018922193*(alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[5] = 0.25*(alpha[0]*fUp[4]+alpha[1]*fUp[2]); 
  incr[6] = 0.25*(alpha[0]*fUp[5]+alpha[1]*fUp[3]); 
  incr[7] = 0.25*(alpha[1]*fUp[7]+alpha[0]*fUp[6]); 
  incr[8] = -0.4330127018922193*(alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[9] = -0.4330127018922193*(alpha[1]*fUp[4]+alpha[0]*fUp[2]); 
  incr[10] = -0.4330127018922193*(alpha[1]*fUp[5]+alpha[0]*fUp[3]); 
  incr[11] = 0.25*(alpha[0]*fUp[7]+alpha[1]*fUp[6]); 
  incr[12] = -0.4330127018922193*(alpha[0]*fUp[4]+alpha[1]*fUp[2]); 
  incr[13] = -0.4330127018922193*(alpha[0]*fUp[5]+alpha[1]*fUp[3]); 
  incr[14] = -0.4330127018922193*(alpha[1]*fUp[7]+alpha[0]*fUp[6]); 
  incr[15] = -0.4330127018922193*(alpha[0]*fUp[7]+alpha[1]*fUp[6]); 
