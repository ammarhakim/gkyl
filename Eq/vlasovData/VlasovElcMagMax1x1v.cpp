...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  incr0[7] = abar0[1]*(2.449489742783178*f[6]+2.738612787525831*f[2])+2.405351177211819*abar0[3]*f[6]+2.449489742783178*abar0[2]*f[3]+2.738612787525831*abar0[0]*f[3]; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  incr0[7] = abar0[2]*(2.405351177211819*f[11]+2.449489742783178*f[3])+2.390457218668788*abar0[4]*f[11]+abar0[1]*(2.449489742783178*f[6]+2.738612787525831*f[2])+2.405351177211819*abar0[3]*f[6]+2.738612787525831*abar0[0]*f[3]; 
  ...
  incr0[10] = abar0[1]*(2.405351177211819*f[11]+2.449489742783178*f[3])+abar0[3]*(1.632993161855452*f[11]+2.405351177211819*f[3])+abar0[2]*(1.749635530559413*f[6]+2.738612787525831*f[2])+2.347382389307855*abar0[4]*f[6]+2.738612787525831*abar0[0]*f[6]; 
  ...
  incr0[14] = abar0[1]*(5.612486080160911*f[12]+3.674234614174766*f[3])+3.674234614174766*abar0[3]*f[11]+abar0[0]*(5.612486080160912*f[9]+3.674234614174766*f[2])+3.674234614174767*abar0[2]*f[6]; 
