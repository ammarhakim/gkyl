...
namespace Gkyl {
  ...
  class VlasovModDecl  {
    public:
       ...
       */
      static __host__ __device__ double volumeStreamTerm(const double* __restrict__ w, const double* __restrict__ dxv, const double* __restrict__ f, double *out);

      /**
       * Surface streaming term
       */
      static __host__ __device__ void surfStreamTerm(int dir, const double* __restrict__ wl, const double* __restrict__ wr,
       ...
       */
      static __host__ __device__ double volumeTerm(const double* __restrict__ w, const double* __restrict__ dxv, const double* __restrict__ E, const double* __restrict__ f, double *out);

      /**
       * Surface terms from EM forces
       */
      static __host__ __device__ double surfElcMagTerm(int dir, const double* __restrict__ wl, const double* __restrict__ wr,
