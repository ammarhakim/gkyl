  ...
  class VlasovModDecl<1,1,3,G_MAX_ORDER_C> : public VlasovModDeclBase {
    public:
      ...
      __host__ __device__ void surfElcMagTerm(unsigned dir, const double *wl, const double *wr,
        ...
        switch (dir) {
          case 0:
              VlasovSurfElcMag1x1vMax_VX_P3(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
        }        
      }
  };
  ...
  class VlasovModDecl<1,2,3,G_MAX_ORDER_C> : public VlasovModDeclBase {
    public:
      ...
      __host__ __device__ void surfElcMagTerm(unsigned dir, const double *wl, const double *wr,
        ...
        switch (dir) {
          case 0:
              VlasovSurfElcMag1x2vMax_VX_P3(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
          case 1:
              VlasovSurfElcMag1x2vMax_VY_P3(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
        }        
      }
  };
  ...
  class VlasovModDecl<1,3,3,G_MAX_ORDER_C> : public VlasovModDeclBase {
    public:
      ...
      __host__ __device__ void surfElcMagTerm(unsigned dir, const double *wl, const double *wr,
        ...
        switch (dir) {
          case 0:
              VlasovSurfElcMag1x3vMax_VX_P3(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
          case 1:
              VlasovSurfElcMag1x3vMax_VY_P3(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
          case 2:
              VlasovSurfElcMag1x3vMax_VZ_P3(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
        }        
      }
  };
  ...
  class VlasovModDecl<2,2,3,G_MAX_ORDER_C> : public VlasovModDeclBase {
    public:
      ...
      __host__ __device__ void surfElcMagTerm(unsigned dir, const double *wl, const double *wr,
        ...
        switch (dir) {
          case 0:
              VlasovSurfElcMag2x2vMax_VX_P3(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
          case 1:
              VlasovSurfElcMag2x2vMax_VY_P3(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
        }        
      }
  };
  ...
  class VlasovModDecl<2,3,3,G_MAX_ORDER_C> : public VlasovModDeclBase {
    public:
      ...
      __host__ __device__ void surfElcMagTerm(unsigned dir, const double *wl, const double *wr,
        ...
        switch (dir) {
          case 0:
              VlasovSurfElcMag2x3vMax_VX_P3(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
          case 1:
              VlasovSurfElcMag2x3vMax_VY_P3(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
          case 2:
              VlasovSurfElcMag2x3vMax_VZ_P3(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
        }        
      }
  };
  ...
  class VlasovModDecl<3,3,2,G_MAX_ORDER_C> : public VlasovModDeclBase {
    public:
      ...
      __host__ __device__ void surfElcMagTerm(unsigned dir, const double *wl, const double *wr,
        ...
        switch (dir) {
          case 0:
              VlasovSurfElcMag3x3vMax_VX_P2(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
          case 1:
              VlasovSurfElcMag3x3vMax_VY_P2(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
          case 2:
              VlasovSurfElcMag3x3vMax_VZ_P2(wl, wr, dxvl, dxvr, amax, E, fl, fr, outl, outr);
              break;
        }        
      }
  };
