...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  out[1] += 3.464101615137754*f[0]*w0dx0+f[2]*dv0dx0+incr0[1]; 
  out[2] += incr1[2]*dv10; 
  out[3] += 3.464101615137754*f[2]*w0dx0+incr1[3]*dv10+f[0]*dv0dx0+incr0[3]; 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  out[1] += 3.464101615137754*f[0]*w0dx0+f[2]*dv0dx0+incr0[1]; 
  out[2] += incr1[2]*dv10; 
  out[3] += 3.464101615137754*f[2]*w0dx0+incr1[3]*dv10+0.8944271909999159*f[5]*dv0dx0+f[0]*dv0dx0+incr0[3]; 
  out[4] += 7.745966692414834*f[1]*w0dx0+2.23606797749979*f[3]*dv0dx0+incr0[4]; 
  out[5] += incr1[5]*dv10; 
  out[6] += 7.745966692414834*f[3]*w0dx0+incr1[6]*dv10+2.0*f[7]*dv0dx0+2.23606797749979*f[1]*dv0dx0+incr0[6]; 
  out[7] += 3.464101615137755*f[5]*w0dx0+incr1[7]*dv10+0.8944271909999161*f[2]*dv0dx0+incr0[7]; 
return std::abs(w0dx0)+dv0dx0/2+std::abs(amid1)/dv1; 
} 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  out[5] += incr1[5]*dv10; 
  out[6] += 7.745966692414834*f[3]*w0dx0+incr1[6]*dv10+2.0*f[7]*dv0dx0+2.23606797749979*f[1]*dv0dx0+incr0[6]; 
  out[7] += 3.464101615137755*f[5]*w0dx0+incr1[7]*dv10+0.8783100656536798*f[9]*dv0dx0+0.8944271909999161*f[2]*dv0dx0+incr0[7]; 
  out[8] += 11.83215956619923*f[4]*w0dx0+5.291502622129181*f[0]*w0dx0+3.415650255319866*f[6]*dv0dx0+1.527525231651947*f[2]*dv0dx0+incr0[8]; 
  out[9] += incr1[9]*dv10; 
  out[10] += 11.83215956619923*f[6]*w0dx0+5.291502622129181*f[2]*w0dx0+incr1[10]*dv10+1.366260102127946*f[5]*dv0dx0+3.415650255319866*f[4]*dv0dx0+1.527525231651947*f[0]*dv0dx0+incr0[10]; 
  out[11] += 3.464101615137754*f[9]*w0dx0+incr1[11]*dv10+0.8783100656536798*f[5]*dv0dx0+incr0[11]; 
return std::abs(w0dx0)+dv0dx0/2+std::abs(amid1)/dv1; 
} 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  out[8] += 11.83215956619923*f[4]*w0dx0+5.291502622129181*f[0]*w0dx0+3.415650255319866*f[6]*dv0dx0+1.527525231651947*f[2]*dv0dx0+incr0[8]; 
  out[9] += incr1[9]*dv10; 
  out[10] += 7.745966692414834*f[7]*w0dx0+incr1[10]*dv10+1.963961012123931*f[12]*dv0dx0+2.0*f[3]*dv0dx0+incr0[10]; 
  out[11] += 11.83215956619923*f[6]*w0dx0+5.291502622129181*f[2]*w0dx0+incr1[11]*dv10+3.055050463303893*f[10]*dv0dx0+1.366260102127946*f[5]*dv0dx0+3.415650255319866*f[4]*dv0dx0+1.527525231651947*f[0]*dv0dx0+incr0[11]; 
  out[12] += 3.464101615137754*f[9]*w0dx0+incr1[12]*dv10+0.8728715609439696*f[14]*dv0dx0+0.8783100656536798*f[5]*dv0dx0+incr0[12]; 
  out[13] += 15.87450786638754*f[8]*w0dx0+10.39230484541326*f[1]*w0dx0+4.58257569495584*f[11]*dv0dx0+3.0*f[3]*dv0dx0+incr0[13]; 
  out[14] += incr1[14]*dv10; 
  out[15] += 15.87450786638754*f[11]*w0dx0+10.39230484541326*f[3]*w0dx0+incr1[15]*dv10+4.58257569495584*f[8]*dv0dx0+2.683281572999748*f[7]*dv0dx0+3.0*f[1]*dv0dx0+incr0[15]; 
  out[16] += 3.464101615137754*f[14]*w0dx0+incr1[16]*dv10+0.8728715609439696*f[9]*dv0dx0+incr0[16]; 
return std::abs(w0dx0)+dv0dx0/2+std::abs(amid1)/dv1; 
} 
