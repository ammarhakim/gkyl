...
__host__ __device__ double VlasovVol2x3vSerP1(const double* __restrict__ w, const double* __restrict__ dxv, const double* __restrict__ EM, const double* __restrict__ f, double *out) 
{ 
