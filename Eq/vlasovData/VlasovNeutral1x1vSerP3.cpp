...
__host__ __device__ double VlasovNeutralVol1x1vSerP3(const double *w, const double *dxv, const double *boA, const double *f, double *out) 
{ 
  ...
  alpha_vdim[8] = 1.414213562373095*Fo0[3]*dv10; 
  ...
  out[5] += 1.936491673103709*(alpha_vdim[8]*f[10]+alpha_vdim[4]*f[6]+alpha_vdim[1]*f[3]+alpha_vdim[0]*f[2]); 
  ...
  out[7] += 1.700840128541522*alpha_vdim[4]*f[10]+0.7606388292556648*alpha_cdim[2]*f[9]+f[6]*(1.700840128541522*alpha_vdim[8]+1.732050807568877*alpha_vdim[1])+0.8660254037844386*alpha_cdim[0]*f[5]+f[3]*(1.732050807568877*alpha_vdim[4]+1.936491673103709*alpha_vdim[0])+(0.7745966692414833*alpha_cdim[2]+1.936491673103709*alpha_vdim[1])*f[2]; 
