...
{ 
  ...
  favg[3] = (-1.224744871391589*fr[10])+1.224744871391589*fl[10]+0.7071067811865475*fr[5]+0.7071067811865475*fl[5]; 
  ...
  favg[6] = 0.7071067811865475*fr[13]+0.7071067811865475*fl[13]; 
  favg[7] = 0.7071067811865475*fr[15]+0.7071067811865475*fl[15]; 
  favg[8] = 0.7071067811865475*fr[17]+0.7071067811865475*fl[17]; 
  favg[9] = 0.7071067811865475*fr[19]+0.7071067811865475*fl[19]; 
  ...
  Ghat[0] = 0.3535533905932737*(2.645751311064591*(fr[18]+fl[18])+2.23606797749979*(fl[8]-1.0*fr[8])+1.732050807568877*(fr[2]+fl[2])-1.0*fr[0]+fl[0])*amax+0.25*(alpha[8]*favg[8]+alpha[6]*favg[6]+alpha[4]*favg[4]+alpha[3]*favg[3]+alpha[2]*favg[2]+alpha[1]*favg[1]+alpha[0]*favg[0]); 
  Ghat[1] = 0.002380952380952381*(92.22255689363637*(alpha[4]*favg[8]+favg[4]*alpha[8])+93.91485505499116*(alpha[3]*favg[6]+favg[3]*alpha[6]+alpha[1]*favg[4]+favg[1]*alpha[4])+105.0*(alpha[2]*favg[3]+favg[2]*alpha[3]+alpha[0]*favg[1]+favg[0]*alpha[1]))-0.1178511301977579*(1.732050807568877*(3.872983346207417*fr[12]-1.0*(3.872983346207417*fl[12]+3.0*(fr[4]+fl[4])))+3.0*(fr[1]-1.0*fl[1]))*amax; 
  ...
  Ghat[5] = 0.07071067811865475*(8.660254037844387*(fr[16]+fl[16])+5.0*(fl[9]-1.0*fr[9]))*amax+0.002380952380952381*(92.22255689363637*alpha[2]*favg[9]+105.0*alpha[1]*favg[7]+93.91485505499116*alpha[6]*favg[6]+105.0*alpha[0]*favg[5]+93.91485505499116*(alpha[3]*favg[3]+alpha[2]*favg[2])); 
  Ghat[6] = 0.002380952380952381*(92.2225568936364*(alpha[3]*favg[8]+favg[3]*alpha[8])+84.0*alpha[3]*favg[7]+(67.0820393249937*alpha[4]+105.0*alpha[0])*favg[6]+(93.91485505499116*favg[5]+67.0820393249937*favg[4]+105.0*favg[0])*alpha[6]+105.0*(alpha[2]*favg[4]+favg[2]*alpha[4])+93.91485505499116*(alpha[1]*favg[3]+favg[1]*alpha[3]))-0.3535533905932737*(fr[13]-1.0*fl[13])*amax; 
  Ghat[7] = 0.002380952380952381*(92.2225568936364*alpha[3]*favg[9]+(93.91485505499116*alpha[4]+105.0*alpha[0])*favg[7]+84.0*(alpha[3]*favg[6]+favg[3]*alpha[6])+105.0*alpha[1]*favg[5]+93.91485505499116*(alpha[2]*favg[3]+favg[2]*alpha[3]))-0.3535533905932737*(fr[15]-1.0*fl[15])*amax; 
  Ghat[8] = 0.002380952380952381*((62.60990336999411*alpha[4]+105.0*alpha[0])*favg[8]+(62.60990336999411*favg[4]+105.0*favg[0])*alpha[8]+92.2225568936364*(alpha[3]*favg[6]+favg[3]*alpha[6])+92.22255689363637*(alpha[1]*favg[4]+favg[1]*alpha[4]))-0.3535533905932737*(fr[17]-1.0*fl[17])*amax; 
  Ghat[9] = 0.007142857142857143*(35.0*alpha[0]*favg[9]+30.7408522978788*alpha[3]*favg[7]+30.7408522978788*alpha[2]*favg[5])-0.3535533905932737*(fr[19]-1.0*fl[19])*amax; 
...
{ 
  ...
  favg[6] = 0.7071067811865475*fr[11]+0.7071067811865475*fl[11]; 
  favg[7] = 0.7071067811865475*fr[12]+0.7071067811865475*fl[12]; 
  favg[8] = 0.7071067811865475*fr[17]+0.7071067811865475*fl[17]; 
  favg[9] = 0.7071067811865475*fr[18]+0.7071067811865475*fl[18]; 
  ...
  Ghat[0] = 0.3535533905932737*(2.645751311064591*(fr[19]+fl[19])+2.23606797749979*(fl[9]-1.0*fr[9])+1.732050807568877*(fr[3]+fl[3])-1.0*fr[0]+fl[0])*amax+0.25*(alpha[8]*favg[8]+alpha[6]*favg[6]+alpha[4]*favg[4]+alpha[3]*favg[3]+alpha[2]*favg[2]+alpha[1]*favg[1]+alpha[0]*favg[0]); 
  Ghat[1] = 0.002380952380952381*(92.22255689363637*(alpha[4]*favg[8]+favg[4]*alpha[8])+93.91485505499116*(alpha[3]*favg[6]+favg[3]*alpha[6]+alpha[1]*favg[4]+favg[1]*alpha[4])+105.0*(alpha[2]*favg[3]+favg[2]*alpha[3]+alpha[0]*favg[1]+favg[0]*alpha[1]))-0.1178511301977579*(1.732050807568877*(3.872983346207417*fr[15]-1.0*(3.872983346207417*fl[15]+3.0*(fr[5]+fl[5])))+3.0*(fr[1]-1.0*fl[1]))*amax; 
  ...
  Ghat[3] = 0.3535533905932737*(1.732050807568877*(fr[10]+fl[10])-1.0*fr[4]+fl[4])*amax+0.002380952380952381*(92.2225568936364*(alpha[6]*favg[8]+favg[6]*alpha[8])+(84.0*alpha[6]+93.91485505499116*alpha[2])*favg[7]+93.91485505499116*(alpha[1]*favg[6]+favg[1]*alpha[6]+alpha[3]*(favg[5]+favg[4])+favg[3]*alpha[4])+105.0*(alpha[0]*favg[3]+favg[0]*alpha[3]+alpha[1]*favg[2]+favg[1]*alpha[2])); 
  Ghat[4] = 0.07071067811865475*(8.660254037844387*(fr[13]+fl[13])+5.0*(fl[7]-1.0*fr[7]))*amax+0.002380952380952381*((62.60990336999411*alpha[8]+92.22255689363637*alpha[1])*favg[8]+92.22255689363637*favg[1]*alpha[8]+(67.0820393249937*alpha[6]+105.0*alpha[2])*favg[6]+105.0*favg[2]*alpha[6]+(67.0820393249937*alpha[4]+105.0*alpha[0])*favg[4]+105.0*favg[0]*alpha[4]+93.91485505499116*(alpha[3]*favg[3]+alpha[1]*favg[1])); 
  Ghat[5] = 0.07071067811865475*(8.660254037844387*(fr[14]+fl[14])+5.0*(fl[8]-1.0*fr[8]))*amax+0.002380952380952381*(92.22255689363637*alpha[2]*favg[9]+105.0*alpha[1]*favg[7]+93.91485505499116*alpha[6]*favg[6]+105.0*alpha[0]*favg[5]+93.91485505499116*(alpha[3]*favg[3]+alpha[2]*favg[2])); 
  Ghat[6] = 0.002380952380952381*(92.2225568936364*(alpha[3]*favg[8]+favg[3]*alpha[8])+84.0*alpha[3]*favg[7]+(67.0820393249937*alpha[4]+105.0*alpha[0])*favg[6]+(93.91485505499116*favg[5]+67.0820393249937*favg[4]+105.0*favg[0])*alpha[6]+105.0*(alpha[2]*favg[4]+favg[2]*alpha[4])+93.91485505499116*(alpha[1]*favg[3]+favg[1]*alpha[3]))-0.3535533905932737*(fr[11]-1.0*fl[11])*amax; 
  Ghat[7] = 0.002380952380952381*(92.2225568936364*alpha[3]*favg[9]+(93.91485505499116*alpha[4]+105.0*alpha[0])*favg[7]+84.0*(alpha[3]*favg[6]+favg[3]*alpha[6])+105.0*alpha[1]*favg[5]+93.91485505499116*(alpha[2]*favg[3]+favg[2]*alpha[3]))-0.3535533905932737*(fr[12]-1.0*fl[12])*amax; 
  Ghat[8] = 0.002380952380952381*((62.60990336999411*alpha[4]+105.0*alpha[0])*favg[8]+(62.60990336999411*favg[4]+105.0*favg[0])*alpha[8]+92.2225568936364*(alpha[3]*favg[6]+favg[3]*alpha[6])+92.22255689363637*(alpha[1]*favg[4]+favg[1]*alpha[4]))-0.3535533905932737*(fr[17]-1.0*fl[17])*amax; 
  Ghat[9] = 0.007142857142857143*(35.0*alpha[0]*favg[9]+30.7408522978788*alpha[3]*favg[7]+30.7408522978788*alpha[2]*favg[5])-0.3535533905932737*(fr[18]-1.0*fl[18])*amax; 
