...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  out[4] += 0.5477225575051661*(alpha1[1]*f[7]+f[1]*alpha1[7])+0.6123724356957944*(alpha1[3]*f[5]+f[3]*alpha1[5]+alpha1[0]*f[1]+f[0]*alpha1[1]); 
  out[5] += 0.5477225575051661*(alpha2[1]*f[7]+f[1]*alpha2[7])+0.6123724356957944*(alpha2[2]*f[4]+f[2]*alpha2[4]+alpha2[0]*f[1]+f[0]*alpha2[1]); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  ...
  out[4] += 0.537852874200477*(alpha1[7]*f[17]+f[7]*alpha1[17])+0.5477225575051661*(alpha1[5]*f[13]+f[5]*alpha1[13]+alpha1[1]*f[7]+f[1]*alpha1[7])+0.6123724356957944*(alpha1[3]*f[5]+f[3]*alpha1[5]+alpha1[0]*f[1]+f[0]*alpha1[1]); 
  out[5] += 0.537852874200477*(alpha2[7]*f[17]+f[7]*alpha2[17])+0.5477225575051661*(alpha2[4]*f[11]+f[4]*alpha2[11]+alpha2[1]*f[7]+f[1]*alpha2[7])+0.6123724356957944*(alpha2[2]*f[4]+f[2]*alpha2[4]+alpha2[0]*f[1]+f[0]*alpha2[1]); 
  ...
  out[10] += 0.537852874200477*((alpha1[13]+alpha2[11])*f[17]+f[11]*alpha2[17]+f[13]*alpha1[17])+0.4898979485566357*alpha1[13]*f[15]+0.5477225575051661*(alpha1[3]*f[15]+alpha1[1]*f[13]+f[1]*alpha1[13])+0.4898979485566357*alpha2[11]*f[12]+0.5477225575051661*(alpha2[2]*f[12]+alpha2[1]*f[11]+f[1]*alpha2[11]+alpha1[5]*f[9]+alpha2[4]*f[8]+(alpha1[5]+alpha2[4])*f[7]+f[4]*alpha2[7]+f[5]*alpha1[7])+0.6123724356957944*(alpha1[0]*f[5]+f[0]*alpha1[5]+alpha2[0]*f[4]+f[0]*alpha2[4]+alpha1[1]*f[3]+f[1]*alpha1[3]+alpha2[1]*f[2]+f[1]*alpha2[2]); 
  out[11] += 0.3651483716701108*alpha1[17]*f[17]+0.537852874200477*(alpha1[1]*f[17]+f[1]*alpha1[17])+0.3912303982179757*alpha1[13]*f[13]+0.6123724356957944*(alpha1[3]*f[13]+f[3]*alpha1[13])+0.3912303982179757*alpha1[7]*f[7]+0.6123724356957944*(alpha1[0]*f[7]+f[0]*alpha1[7])+0.5477225575051661*(alpha1[5]*f[5]+alpha1[1]*f[1]); 
  out[12] += 1.202675588605909*f[11]*alpha1[17]+1.224744871391589*(f[10]*alpha1[13]+alpha1[1]*f[11])+1.369306393762915*alpha1[3]*f[10]+1.224744871391589*f[4]*alpha1[7]+1.369306393762915*(alpha1[5]*f[6]+alpha1[0]*f[4]+alpha1[1]*f[2]); 
  out[13] += 0.3651483716701108*alpha2[17]*f[17]+0.537852874200477*(alpha2[1]*f[17]+f[1]*alpha2[17])+0.3912303982179757*alpha2[11]*f[11]+0.6123724356957944*(alpha2[2]*f[11]+f[2]*alpha2[11])+0.3912303982179757*alpha2[7]*f[7]+0.6123724356957944*(alpha2[0]*f[7]+f[0]*alpha2[7])+0.5477225575051661*(alpha2[4]*f[4]+alpha2[1]*f[1]); 
  ...
  out[15] += f[13]*(1.202675588605909*alpha2[17]+1.224744871391589*alpha2[1])+f[10]*(1.224744871391589*alpha2[11]+1.369306393762915*alpha2[2])+1.224744871391589*f[5]*alpha2[7]+1.369306393762915*(alpha2[4]*f[6]+alpha2[0]*f[5]+alpha2[1]*f[3]); 
