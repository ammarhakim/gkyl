...
{ 
  ...
  alpha[0] = (-3.741657386773942*phi[3])-2.449489742783178*phi[1]+1.414213562373095*E0[0]; 
  alpha[1] = 1.414213562373095*E0[1]-5.477225575051662*phi[2]; 
  alpha[4] = 1.414213562373095*E0[2]-8.366600265340756*phi[3]; 
  alpha[8] = 1.414213562373095*E0[3]; 

  const double amid = 0.5*alpha[0]-0.5590169943749475*alpha[4]; 

  Ghat[0] = 0.3535533905932737*(2.645751311064591*(fr[18]+fl[18])+2.23606797749979*(fl[8]-1.0*fr[8])+1.732050807568877*(fr[2]+fl[2])-1.0*fr[0]+fl[0])*amax+0.25*(alpha[8]*favg[8]+alpha[4]*favg[4]+alpha[1]*favg[1]+alpha[0]*favg[0]); 
  Ghat[1] = 0.1178511301977579*(1.732050807568877*(4.58257569495584*(fr[24]+fl[24])+3.872983346207417*(fl[12]-1.0*fr[12])+3.0*(fr[4]+fl[4]))+3.0*(fl[1]-1.0*fr[1]))*amax+0.007142857142857143*(30.7408522978788*(alpha[4]*favg[8]+favg[4]*alpha[8])+31.30495168499706*(alpha[1]*favg[4]+favg[1]*alpha[4])+35.0*(alpha[0]*favg[1]+favg[0]*alpha[1])); 
  Ghat[2] = 0.1178511301977579*(1.732050807568877*(4.58257569495584*(fr[26]+fl[26])+3.872983346207417*(fl[14]-1.0*fr[14])+3.0*(fr[6]+fl[6]))+3.0*(fl[3]-1.0*fr[3]))*amax+0.002380952380952381*(105.0*alpha[8]*favg[10]+105.0*alpha[4]*favg[6]+105.0*(alpha[1]*favg[3]+alpha[0]*favg[2])); 
  Ghat[3] = 0.3535533905932737*(2.645751311064591*(fr[30]+fl[30])+2.23606797749979*(fl[21]-1.0*fr[21])+1.732050807568877*(fr[10]+fl[10])-1.0*fr[5]+fl[5])*amax+0.002380952380952381*(92.22255689363638*alpha[4]*favg[10]+92.2225568936364*favg[6]*alpha[8]+93.91485505499116*(alpha[1]*favg[6]+favg[3]*alpha[4])+105.0*(alpha[0]*favg[3]+alpha[1]*favg[2])); 
  Ghat[4] = 0.07071067811865475*(8.660254037844387*(fr[11]+fl[11])+5.0*(fl[7]-1.0*fr[7]))*amax+0.002380952380952381*((62.60990336999411*alpha[8]+92.22255689363637*alpha[1])*favg[8]+92.22255689363637*favg[1]*alpha[8]+(67.0820393249937*alpha[4]+105.0*alpha[0])*favg[4]+105.0*favg[0]*alpha[4]+93.91485505499116*alpha[1]*favg[1]); 
  ...
  Ghat[6] = 0.07071067811865475*(8.660254037844387*(fr[20]+fl[20])+5.0*(fl[13]-1.0*fr[13]))*amax+7.936507936507936e-4*((187.8297101099824*alpha[8]+276.6676706809091*alpha[1])*favg[10]+276.6676706809092*favg[3]*alpha[8]+(201.2461179749811*alpha[4]+315.0*alpha[0])*favg[6]+314.9999999999999*favg[2]*alpha[4]+281.7445651649734*alpha[1]*favg[3]); 
  Ghat[7] = 0.07071067811865475*(8.660254037844387*(fr[22]+fl[22])+5.0*(fl[15]-1.0*fr[15]))*amax+0.01666666666666667*((13.41640786499874*alpha[4]+15.0*alpha[0])*favg[7]+15.0*alpha[1]*favg[5]); 
  Ghat[8] = 0.05050762722761053*(12.12435565298214*(fr[23]+fl[23])+7.0*(fl[17]-1.0*fr[17]))*amax+0.002380952380952381*((62.60990336999411*alpha[4]+105.0*alpha[0])*favg[8]+(62.60990336999411*favg[4]+105.0*favg[0])*alpha[8]+92.22255689363637*(alpha[1]*favg[4]+favg[1]*alpha[4])); 
  Ghat[9] = 0.05050762722761053*(12.12435565298214*(fr[28]+fl[28])+7.0*(fl[19]-1.0*fr[19]))*amax+0.25*(alpha[1]*favg[11]+alpha[0]*favg[9]); 
  Ghat[10] = 0.05050762722761053*(12.12435565298214*(fr[29]+fl[29])+7.0*(fl[25]-1.0*fr[25]))*amax+7.936507936507936e-4*((187.8297101099823*alpha[4]+315.0*alpha[0])*favg[10]+(187.8297101099824*favg[6]+315.0*favg[2])*alpha[8]+276.6676706809091*alpha[1]*favg[6]+276.6676706809092*favg[3]*alpha[4]); 
  Ghat[11] = 0.05050762722761053*(12.12435565298214*(fr[31]+fl[31])+7.0*(fl[27]-1.0*fr[27]))*amax+0.002380952380952381*((93.91485505499116*alpha[4]+105.0*alpha[0])*favg[11]+105.0*alpha[1]*favg[9]); 
...
{ 
  ...
  alpha[8] = 1.414213562373095*E1[3]; 

  const double amid = 0.5*alpha[0]-0.5590169943749475*alpha[4]; 

  Ghat[0] = 0.3535533905932737*(2.645751311064591*(fr[19]+fl[19])+2.23606797749979*(fl[9]-1.0*fr[9])+1.732050807568877*(fr[3]+fl[3])-1.0*fr[0]+fl[0])*amax+0.25*(alpha[8]*favg[8]+alpha[4]*favg[4]+alpha[1]*favg[1]+alpha[0]*favg[0]); 
  Ghat[1] = 0.1178511301977579*(1.732050807568877*(4.58257569495584*(fr[27]+fl[27])+3.872983346207417*(fl[15]-1.0*fr[15])+3.0*(fr[5]+fl[5]))+3.0*(fl[1]-1.0*fr[1]))*amax+0.007142857142857143*(30.7408522978788*(alpha[4]*favg[8]+favg[4]*alpha[8])+31.30495168499706*(alpha[1]*favg[4]+favg[1]*alpha[4])+35.0*(alpha[0]*favg[1]+favg[0]*alpha[1])); 
  Ghat[2] = 0.1178511301977579*(1.732050807568877*(4.58257569495584*(fr[28]+fl[28])+3.872983346207417*(fl[16]-1.0*fr[16])+3.0*(fr[6]+fl[6]))+3.0*(fl[2]-1.0*fr[2]))*amax+0.002380952380952381*(105.0*alpha[8]*favg[10]+105.0*alpha[4]*favg[6]+105.0*(alpha[1]*favg[3]+alpha[0]*favg[2])); 
  Ghat[3] = 0.3535533905932737*(2.645751311064591*(fr[31]+fl[31])+2.23606797749979*(fl[22]-1.0*fr[22])+1.732050807568877*(fr[10]+fl[10])-1.0*fr[4]+fl[4])*amax+0.002380952380952381*(92.22255689363638*alpha[4]*favg[10]+92.2225568936364*favg[6]*alpha[8]+93.91485505499116*(alpha[1]*favg[6]+favg[3]*alpha[4])+105.0*(alpha[0]*favg[3]+alpha[1]*favg[2])); 
  Ghat[4] = 0.07071067811865475*(8.660254037844387*(fr[13]+fl[13])+5.0*(fl[7]-1.0*fr[7]))*amax+0.002380952380952381*((62.60990336999411*alpha[8]+92.22255689363637*alpha[1])*favg[8]+92.22255689363637*favg[1]*alpha[8]+(67.0820393249937*alpha[4]+105.0*alpha[0])*favg[4]+105.0*favg[0]*alpha[4]+93.91485505499116*alpha[1]*favg[1]); 
  ...
  Ghat[6] = 0.07071067811865475*(8.660254037844387*(fr[20]+fl[20])+5.0*(fl[11]-1.0*fr[11]))*amax+7.936507936507936e-4*((187.8297101099824*alpha[8]+276.6676706809091*alpha[1])*favg[10]+276.6676706809092*favg[3]*alpha[8]+(201.2461179749811*alpha[4]+315.0*alpha[0])*favg[6]+314.9999999999999*favg[2]*alpha[4]+281.7445651649734*alpha[1]*favg[3]); 
  Ghat[7] = 0.07071067811865475*(8.660254037844387*(fr[21]+fl[21])+5.0*(fl[12]-1.0*fr[12]))*amax+0.01666666666666667*((13.41640786499874*alpha[4]+15.0*alpha[0])*favg[7]+15.0*alpha[1]*favg[5]); 
  Ghat[8] = 0.05050762722761053*(12.12435565298214*(fr[25]+fl[25])+7.0*(fl[17]-1.0*fr[17]))*amax+0.002380952380952381*((62.60990336999411*alpha[4]+105.0*alpha[0])*favg[8]+(62.60990336999411*favg[4]+105.0*favg[0])*alpha[8]+92.22255689363637*(alpha[1]*favg[4]+favg[1]*alpha[4])); 
  Ghat[9] = 0.05050762722761053*(12.12435565298214*(fr[26]+fl[26])+7.0*(fl[18]-1.0*fr[18]))*amax+0.25*(alpha[1]*favg[11]+alpha[0]*favg[9]); 
  Ghat[10] = 0.05050762722761053*(12.12435565298214*(fr[29]+fl[29])+7.0*(fl[23]-1.0*fr[23]))*amax+7.936507936507936e-4*((187.8297101099823*alpha[4]+315.0*alpha[0])*favg[10]+(187.8297101099824*favg[6]+315.0*favg[2])*alpha[8]+276.6676706809091*alpha[1]*favg[6]+276.6676706809092*favg[3]*alpha[4]); 
  Ghat[11] = 0.05050762722761053*(12.12435565298214*(fr[30]+fl[30])+7.0*(fl[24]-1.0*fr[24]))*amax+0.002380952380952381*((93.91485505499116*alpha[4]+105.0*alpha[0])*favg[11]+105.0*alpha[1]*favg[9]); 
...
{ 
  ...
  alpha[0] = 1.414213562373095*B2[0]*wv2-3.741657386773942*phi[3]-2.449489742783178*phi[1]+1.414213562373095*E0[0]; 
  ...
  alpha[4] = 1.414213562373095*B2[2]*wv2-8.366600265340756*phi[3]+1.414213562373095*E0[2]; 
