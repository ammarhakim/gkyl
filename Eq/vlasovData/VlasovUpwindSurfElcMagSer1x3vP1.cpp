...
{ 
  ...
  double alphaOrdR;
  double fUpOrd[8];
  alphaOrdR = 0.3535533905932737*(alpha[5]+alpha[4])-0.3535533905932737*(alpha[3]+alpha[2]+alpha[1])+0.3535533905932737*alpha[0]; 
  ...
  alphaOrdR = 0.3535533905932737*(alpha[1]+alpha[0])-0.3535533905932737*(alpha[5]+alpha[4]+alpha[3]+alpha[2]); 
  ...
  alphaOrdR = 0.3535533905932737*alpha[5]-0.3535533905932737*(alpha[4]+alpha[3])+0.3535533905932737*alpha[2]-0.3535533905932737*alpha[1]+0.3535533905932737*alpha[0]; 
  ...
  alphaOrdR = (-0.3535533905932737*alpha[5])+0.3535533905932737*alpha[4]-0.3535533905932737*alpha[3]+0.3535533905932737*(alpha[2]+alpha[1]+alpha[0]); 
  fUpOrd[3] = 0.5*(((-0.4330127018922193*(fr[15]+fl[15]+fr[14]+fl[14]))+0.25*fr[13]-0.25*fl[13]-0.4330127018922193*(fr[12]+fl[12])+0.4330127018922193*(fr[11]+fl[11])+0.25*fr[10]-0.25*fl[10]-0.4330127018922193*(fr[9]+fl[9])+0.25*fr[8]-0.25*fl[8]+0.4330127018922193*(fr[7]+fl[7])-0.25*fr[6]+0.25*fl[6]+0.4330127018922193*(fr[5]+fl[5])+0.25*fr[4]-0.25*(fl[4]+fr[3])+0.25*fl[3]+0.4330127018922193*(fr[2]+fl[2])-0.25*(fr[1]+fr[0])+0.25*(fl[1]+fl[0]))*sgn(alphaOrdR)+0.4330127018922193*(fr[15]+fr[14])-0.4330127018922193*(fl[15]+fl[14])-0.25*(fr[13]+fl[13])+0.4330127018922193*fr[12]-0.4330127018922193*(fl[12]+fr[11])+0.4330127018922193*fl[11]-0.25*(fr[10]+fl[10])+0.4330127018922193*fr[9]-0.4330127018922193*fl[9]-0.25*(fr[8]+fl[8])-0.4330127018922193*fr[7]+0.4330127018922193*fl[7]+0.25*(fr[6]+fl[6])-0.4330127018922193*fr[5]+0.4330127018922193*fl[5]-0.25*(fr[4]+fl[4])+0.25*(fr[3]+fl[3])-0.4330127018922193*fr[2]+0.4330127018922193*fl[2]+0.25*(fr[1]+fl[1]+fr[0]+fl[0])); 
  alphaOrdR = (-0.3535533905932737*alpha[5])+0.3535533905932737*(alpha[4]+alpha[3])-0.3535533905932737*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0]; 
  fUpOrd[4] = 0.5*((0.4330127018922193*(fr[15]+fl[15])-0.4330127018922193*(fr[14]+fl[14])-0.25*fr[13]+0.25*fl[13]-0.4330127018922193*(fr[12]+fl[12])+0.4330127018922193*(fr[11]+fl[11])+0.25*fr[10]-0.25*fl[10]+0.4330127018922193*(fr[9]+fl[9])+0.25*fr[8]-0.25*fl[8]-0.4330127018922193*(fr[7]+fl[7])-0.25*fr[6]+0.25*fl[6]-0.4330127018922193*(fr[5]+fl[5])-0.25*fr[4]+0.25*(fl[4]+fr[3])-0.25*fl[3]+0.4330127018922193*(fr[2]+fl[2])+0.25*fr[1]-0.25*(fl[1]+fr[0])+0.25*fl[0])*sgn(alphaOrdR)-0.4330127018922193*fr[15]+0.4330127018922193*(fl[15]+fr[14])-0.4330127018922193*fl[14]+0.25*(fr[13]+fl[13])+0.4330127018922193*fr[12]-0.4330127018922193*(fl[12]+fr[11])+0.4330127018922193*fl[11]-0.25*(fr[10]+fl[10])-0.4330127018922193*fr[9]+0.4330127018922193*fl[9]-0.25*(fr[8]+fl[8])+0.4330127018922193*fr[7]-0.4330127018922193*fl[7]+0.25*(fr[6]+fl[6])+0.4330127018922193*fr[5]-0.4330127018922193*fl[5]+0.25*(fr[4]+fl[4])-0.25*(fr[3]+fl[3])-0.4330127018922193*fr[2]+0.4330127018922193*fl[2]-0.25*(fr[1]+fl[1])+0.25*(fr[0]+fl[0])); 
  alphaOrdR = 0.3535533905932737*alpha[5]-0.3535533905932737*alpha[4]+0.3535533905932737*alpha[3]-0.3535533905932737*alpha[2]+0.3535533905932737*(alpha[1]+alpha[0]); 
  fUpOrd[5] = 0.5*(((-0.4330127018922193*(fr[15]+fl[15]+fr[14]+fl[14]))+0.25*fr[13]-0.25*fl[13]+0.4330127018922193*(fr[12]+fl[12])-0.4330127018922193*(fr[11]+fl[11])+0.25*fr[10]-0.25*fl[10]+0.4330127018922193*(fr[9]+fl[9])-0.25*fr[8]+0.25*fl[8]-0.4330127018922193*(fr[7]+fl[7])+0.25*fr[6]-0.25*fl[6]+0.4330127018922193*(fr[5]+fl[5])-0.25*fr[4]+0.25*(fl[4]+fr[3])-0.25*fl[3]+0.4330127018922193*(fr[2]+fl[2])-0.25*(fr[1]+fr[0])+0.25*(fl[1]+fl[0]))*sgn(alphaOrdR)+0.4330127018922193*(fr[15]+fr[14])-0.4330127018922193*(fl[15]+fl[14])-0.25*(fr[13]+fl[13])-0.4330127018922193*fr[12]+0.4330127018922193*(fl[12]+fr[11])-0.4330127018922193*fl[11]-0.25*(fr[10]+fl[10])-0.4330127018922193*fr[9]+0.4330127018922193*fl[9]+0.25*(fr[8]+fl[8])+0.4330127018922193*fr[7]-0.4330127018922193*fl[7]-0.25*(fr[6]+fl[6])-0.4330127018922193*fr[5]+0.4330127018922193*fl[5]+0.25*(fr[4]+fl[4])-0.25*(fr[3]+fl[3])-0.4330127018922193*fr[2]+0.4330127018922193*fl[2]+0.25*(fr[1]+fl[1]+fr[0]+fl[0])); 
  alphaOrdR = (-0.3535533905932737*(alpha[5]+alpha[4]))+0.3535533905932737*(alpha[3]+alpha[2])-0.3535533905932737*alpha[1]+0.3535533905932737*alpha[0]; 
  fUpOrd[6] = 0.5*(((-0.4330127018922193*(fr[15]+fl[15]))+0.4330127018922193*(fr[14]+fl[14])+0.25*fr[13]-0.25*fl[13]-0.4330127018922193*(fr[12]+fl[12]+fr[11]+fl[11])-0.25*fr[10]+0.25*fl[10]+0.4330127018922193*(fr[9]+fl[9])+0.25*fr[8]-0.25*fl[8]+0.4330127018922193*(fr[7]+fl[7])+0.25*fr[6]-0.25*fl[6]-0.4330127018922193*(fr[5]+fl[5])-0.25*(fr[4]+fr[3])+0.25*(fl[4]+fl[3])+0.4330127018922193*(fr[2]+fl[2])+0.25*fr[1]-0.25*(fl[1]+fr[0])+0.25*fl[0])*sgn(alphaOrdR)+0.4330127018922193*fr[15]-0.4330127018922193*(fl[15]+fr[14])+0.4330127018922193*fl[14]-0.25*(fr[13]+fl[13])+0.4330127018922193*(fr[12]+fr[11])-0.4330127018922193*(fl[12]+fl[11])+0.25*(fr[10]+fl[10])-0.4330127018922193*fr[9]+0.4330127018922193*fl[9]-0.25*(fr[8]+fl[8])-0.4330127018922193*fr[7]+0.4330127018922193*fl[7]-0.25*(fr[6]+fl[6])+0.4330127018922193*fr[5]-0.4330127018922193*fl[5]+0.25*(fr[4]+fl[4]+fr[3]+fl[3])-0.4330127018922193*fr[2]+0.4330127018922193*fl[2]-0.25*(fr[1]+fl[1])+0.25*(fr[0]+fl[0])); 
  alphaOrdR = 0.3535533905932737*(alpha[5]+alpha[4]+alpha[3]+alpha[2]+alpha[1]+alpha[0]); 
  ...
  incr[0] = 0.25*(alpha[5]*fUp[5]+alpha[4]*fUp[4]+alpha[3]*fUp[3]+alpha[2]*fUp[2]+alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[1] = 0.25*(alpha[3]*fUp[5]+fUp[3]*alpha[5]+alpha[2]*fUp[4]+fUp[2]*alpha[4]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[2] = -0.4330127018922193*(alpha[5]*fUp[5]+alpha[4]*fUp[4]+alpha[3]*fUp[3]+alpha[2]*fUp[2]+alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[3] = 0.25*(alpha[5]*fUp[7]+alpha[3]*fUp[6]+alpha[1]*fUp[4]+fUp[1]*alpha[4]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[4] = 0.25*(alpha[4]*fUp[7]+alpha[2]*fUp[6]+alpha[1]*fUp[5]+fUp[1]*alpha[5]+alpha[0]*fUp[3]+fUp[0]*alpha[3]); 
  incr[5] = -0.4330127018922193*(alpha[3]*fUp[5]+fUp[3]*alpha[5]+alpha[2]*fUp[4]+fUp[2]*alpha[4]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[6] = 0.25*(alpha[3]*fUp[7]+alpha[5]*fUp[6]+alpha[0]*fUp[4]+fUp[0]*alpha[4]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
  incr[7] = -0.4330127018922193*(alpha[5]*fUp[7]+alpha[3]*fUp[6]+alpha[1]*fUp[4]+fUp[1]*alpha[4]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[8] = 0.25*(alpha[2]*fUp[7]+alpha[4]*fUp[6]+alpha[0]*fUp[5]+fUp[0]*alpha[5]+alpha[1]*fUp[3]+fUp[1]*alpha[3]); 
  incr[9] = -0.4330127018922193*(alpha[4]*fUp[7]+alpha[2]*fUp[6]+alpha[1]*fUp[5]+fUp[1]*alpha[5]+alpha[0]*fUp[3]+fUp[0]*alpha[3]); 
  incr[10] = 0.25*(alpha[1]*fUp[7]+alpha[0]*fUp[6]+alpha[4]*fUp[5]+fUp[4]*alpha[5]+alpha[2]*fUp[3]+fUp[2]*alpha[3]); 
  incr[11] = -0.4330127018922193*(alpha[3]*fUp[7]+alpha[5]*fUp[6]+alpha[0]*fUp[4]+fUp[0]*alpha[4]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
  incr[12] = -0.4330127018922193*(alpha[2]*fUp[7]+alpha[4]*fUp[6]+alpha[0]*fUp[5]+fUp[0]*alpha[5]+alpha[1]*fUp[3]+fUp[1]*alpha[3]); 
  incr[13] = 0.25*(alpha[0]*fUp[7]+alpha[1]*fUp[6]+alpha[2]*fUp[5]+fUp[2]*alpha[5]+alpha[3]*fUp[4]+fUp[3]*alpha[4]); 
  incr[14] = -0.4330127018922193*(alpha[1]*fUp[7]+alpha[0]*fUp[6]+alpha[4]*fUp[5]+fUp[4]*alpha[5]+alpha[2]*fUp[3]+fUp[2]*alpha[3]); 
  incr[15] = -0.4330127018922193*(alpha[0]*fUp[7]+alpha[1]*fUp[6]+alpha[2]*fUp[5]+fUp[2]*alpha[5]+alpha[3]*fUp[4]+fUp[3]*alpha[4]); 
...
{ 
  ...
  incr[0] = 0.25*(alpha[5]*fUp[5]+alpha[4]*fUp[4]+alpha[3]*fUp[3]+alpha[2]*fUp[2]+alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[1] = 0.25*(alpha[3]*fUp[5]+fUp[3]*alpha[5]+alpha[2]*fUp[4]+fUp[2]*alpha[4]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[2] = 0.25*(alpha[5]*fUp[7]+alpha[3]*fUp[6]+alpha[1]*fUp[4]+fUp[1]*alpha[4]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[3] = -0.4330127018922193*(alpha[5]*fUp[5]+alpha[4]*fUp[4]+alpha[3]*fUp[3]+alpha[2]*fUp[2]+alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[4] = 0.25*(alpha[4]*fUp[7]+alpha[2]*fUp[6]+alpha[1]*fUp[5]+fUp[1]*alpha[5]+alpha[0]*fUp[3]+fUp[0]*alpha[3]); 
  incr[5] = 0.25*(alpha[3]*fUp[7]+alpha[5]*fUp[6]+alpha[0]*fUp[4]+fUp[0]*alpha[4]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
  incr[6] = -0.4330127018922193*(alpha[3]*fUp[5]+fUp[3]*alpha[5]+alpha[2]*fUp[4]+fUp[2]*alpha[4]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[7] = -0.4330127018922193*(alpha[5]*fUp[7]+alpha[3]*fUp[6]+alpha[1]*fUp[4]+fUp[1]*alpha[4]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[8] = 0.25*(alpha[2]*fUp[7]+alpha[4]*fUp[6]+alpha[0]*fUp[5]+fUp[0]*alpha[5]+alpha[1]*fUp[3]+fUp[1]*alpha[3]); 
  incr[9] = 0.25*(alpha[1]*fUp[7]+alpha[0]*fUp[6]+alpha[4]*fUp[5]+fUp[4]*alpha[5]+alpha[2]*fUp[3]+fUp[2]*alpha[3]); 
  incr[10] = -0.4330127018922193*(alpha[4]*fUp[7]+alpha[2]*fUp[6]+alpha[1]*fUp[5]+fUp[1]*alpha[5]+alpha[0]*fUp[3]+fUp[0]*alpha[3]); 
  incr[11] = -0.4330127018922193*(alpha[3]*fUp[7]+alpha[5]*fUp[6]+alpha[0]*fUp[4]+fUp[0]*alpha[4]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
  incr[12] = 0.25*(alpha[0]*fUp[7]+alpha[1]*fUp[6]+alpha[2]*fUp[5]+fUp[2]*alpha[5]+alpha[3]*fUp[4]+fUp[3]*alpha[4]); 
  incr[13] = -0.4330127018922193*(alpha[2]*fUp[7]+alpha[4]*fUp[6]+alpha[0]*fUp[5]+fUp[0]*alpha[5]+alpha[1]*fUp[3]+fUp[1]*alpha[3]); 
  incr[14] = -0.4330127018922193*(alpha[1]*fUp[7]+alpha[0]*fUp[6]+alpha[4]*fUp[5]+fUp[4]*alpha[5]+alpha[2]*fUp[3]+fUp[2]*alpha[3]); 
  incr[15] = -0.4330127018922193*(alpha[0]*fUp[7]+alpha[1]*fUp[6]+alpha[2]*fUp[5]+fUp[2]*alpha[5]+alpha[3]*fUp[4]+fUp[3]*alpha[4]); 
...
{ 
  ...
  incr[1] = 0.25*(alpha[3]*fUp[5]+fUp[3]*alpha[5]+alpha[2]*fUp[4]+fUp[2]*alpha[4]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[2] = 0.25*(alpha[5]*fUp[7]+alpha[3]*fUp[6]+alpha[1]*fUp[4]+fUp[1]*alpha[4]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[3] = 0.25*(alpha[4]*fUp[7]+alpha[2]*fUp[6]+alpha[1]*fUp[5]+fUp[1]*alpha[5]+alpha[0]*fUp[3]+fUp[0]*alpha[3]); 
  incr[4] = -0.4330127018922193*(alpha[5]*fUp[5]+alpha[4]*fUp[4]+alpha[3]*fUp[3]+alpha[2]*fUp[2]+alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[5] = 0.25*(alpha[3]*fUp[7]+alpha[5]*fUp[6]+alpha[0]*fUp[4]+fUp[0]*alpha[4]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
  incr[6] = 0.25*(alpha[2]*fUp[7]+alpha[4]*fUp[6]+alpha[0]*fUp[5]+fUp[0]*alpha[5]+alpha[1]*fUp[3]+fUp[1]*alpha[3]); 
  incr[7] = 0.25*(alpha[1]*fUp[7]+alpha[0]*fUp[6]+alpha[4]*fUp[5]+fUp[4]*alpha[5]+alpha[2]*fUp[3]+fUp[2]*alpha[3]); 
  incr[8] = -0.4330127018922193*(alpha[3]*fUp[5]+fUp[3]*alpha[5]+alpha[2]*fUp[4]+fUp[2]*alpha[4]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[9] = -0.4330127018922193*(alpha[5]*fUp[7]+alpha[3]*fUp[6]+alpha[1]*fUp[4]+fUp[1]*alpha[4]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[10] = -0.4330127018922193*(alpha[4]*fUp[7]+alpha[2]*fUp[6]+alpha[1]*fUp[5]+fUp[1]*alpha[5]+alpha[0]*fUp[3]+fUp[0]*alpha[3]); 
  incr[11] = 0.25*(alpha[0]*fUp[7]+alpha[1]*fUp[6]+alpha[2]*fUp[5]+fUp[2]*alpha[5]+alpha[3]*fUp[4]+fUp[3]*alpha[4]); 
  incr[12] = -0.4330127018922193*(alpha[3]*fUp[7]+alpha[5]*fUp[6]+alpha[0]*fUp[4]+fUp[0]*alpha[4]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
  incr[13] = -0.4330127018922193*(alpha[2]*fUp[7]+alpha[4]*fUp[6]+alpha[0]*fUp[5]+fUp[0]*alpha[5]+alpha[1]*fUp[3]+fUp[1]*alpha[3]); 
  incr[14] = -0.4330127018922193*(alpha[1]*fUp[7]+alpha[0]*fUp[6]+alpha[4]*fUp[5]+fUp[4]*alpha[5]+alpha[2]*fUp[3]+fUp[2]*alpha[3]); 
  incr[15] = -0.4330127018922193*(alpha[0]*fUp[7]+alpha[1]*fUp[6]+alpha[2]*fUp[5]+fUp[2]*alpha[5]+alpha[3]*fUp[4]+fUp[3]*alpha[4]); 
  ...
  outr[8] += incr[8]*dv12r; 
  outr[9] += incr[9]*dv12r; 
  outr[10] += incr[10]*dv12r; 
  outr[11] += incr[11]*dv12r; 
  outr[12] += incr[12]*dv12r; 
  outr[13] += incr[13]*dv12r; 
  outr[14] += incr[14]*dv12r; 
  outr[15] += incr[15]*dv12r; 

  outl[0] += -1.0*incr[0]*dv12l; 
  outl[1] += -1.0*incr[1]*dv12l; 
  outl[2] += -1.0*incr[2]*dv12l; 
  outl[3] += -1.0*incr[3]*dv12l; 
  outl[4] += incr[4]*dv12l; 
  outl[5] += -1.0*incr[5]*dv12l; 
  outl[6] += -1.0*incr[6]*dv12l; 
  outl[7] += -1.0*incr[7]*dv12l; 
  outl[8] += incr[8]*dv12l; 
  outl[9] += incr[9]*dv12l; 
  outl[10] += incr[10]*dv12l; 
  outl[11] += -1.0*incr[11]*dv12l; 
  outl[12] += incr[12]*dv12l; 
  outl[13] += incr[13]*dv12l; 
  outl[14] += incr[14]*dv12l; 
  outl[15] += incr[15]*dv12l; 
