...
{ 
  ...
  Ghat[0] = 0.3535533905932737*(1.732050807568877*(fr[2]+fl[2])-1.0*fr[0]+fl[0])*amax+0.25*(alpha[1]*favg[1]+alpha[0]*favg[0]); 
  Ghat[1] = 0.3535533905932737*(1.732050807568877*(fr[4]+fl[4])-1.0*fr[1]+fl[1])*amax+0.25*(alpha[0]*favg[1]+favg[0]*alpha[1]); 
  Ghat[2] = 0.3535533905932737*(1.732050807568877*(fr[6]+fl[6])-1.0*fr[3]+fl[3])*amax+0.25*(alpha[1]*favg[3]+alpha[0]*favg[2]); 
  Ghat[3] = 0.3535533905932737*(1.732050807568877*(fr[7]+fl[7])-1.0*fr[5]+fl[5])*amax+0.25*(alpha[0]*favg[3]+alpha[1]*favg[2]); 
...
{ 
  ...
  alpha[0] = 1.414213562373095*E1[0]; 
  alpha[1] = 1.414213562373095*E1[1]; 

  const double amid = 0.5*alpha[0]; 

  Ghat[0] = 0.3535533905932737*(1.732050807568877*(fr[3]+fl[3])-1.0*fr[0]+fl[0])*amax+0.25*(alpha[1]*favg[1]+alpha[0]*favg[0]); 
  Ghat[1] = 0.3535533905932737*(1.732050807568877*(fr[5]+fl[5])-1.0*fr[1]+fl[1])*amax+0.25*(alpha[0]*favg[1]+favg[0]*alpha[1]); 
  Ghat[2] = 0.3535533905932737*(1.732050807568877*(fr[6]+fl[6])-1.0*fr[2]+fl[2])*amax+0.25*(alpha[1]*favg[3]+alpha[0]*favg[2]); 
  Ghat[3] = 0.3535533905932737*(1.732050807568877*(fr[7]+fl[7])-1.0*fr[4]+fl[4])*amax+0.25*(alpha[0]*favg[3]+alpha[1]*favg[2]); 
