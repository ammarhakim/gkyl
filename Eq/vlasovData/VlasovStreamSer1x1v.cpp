...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. f: Input distribution function. out: Incremented output 
  ...
  out[3] += 0.8660254037844386*(alpha0[0]*f[2]+f[0]*alpha0[2]); 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. f: Input distribution function. out: Incremented output 
  ...
  out[7] += 0.8660254037844386*alpha0[0]*f[5]+0.7745966692414833*alpha0[2]*f[2]; 
return std::abs(w0dx0)+dv0dx0/2; 
} 
...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. f: Input distribution function. out: Incremented output 
  ...
  out[10] += 2.958039891549809*alpha0[0]*f[6]+alpha0[2]*(1.183215956619923*f[5]+2.958039891549809*f[4])+1.322875655532295*(alpha0[0]*f[2]+f[0]*alpha0[2]); 
  out[11] += 0.8660254037844386*alpha0[0]*f[9]+0.7606388292556648*alpha0[2]*f[5]; 
return std::abs(w0dx0)+dv0dx0/2; 
} 
