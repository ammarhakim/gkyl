...
{ 
  ...
  favg[2] = 1.58113883008419*fr[8]+1.58113883008419*fl[8]-1.224744871391589*fr[6]+1.224744871391589*fl[6]+0.7071067811865475*fr[4]+0.7071067811865475*fl[4]; 
  ...
  Ghat[2] = 0.01010152544552211*((22.3606797749979*alpha[2]+35.0*alpha[0])*favg[2]+35.0*favg[0]*alpha[2]+31.30495168499706*alpha[1]*favg[1])-0.07071067811865475*(2.23606797749979*(5.0*fr[8]-1.0*(5.0*fl[8]+3.872983346207417*(fr[6]+fl[6])))+5.0*(fr[4]-1.0*fl[4]))*amax; 
  ...
  outr[8] += 1.58113883008419*Ghat[2]*dv10r; 
  ...
  outl[8] += -1.58113883008419*Ghat[2]*dv10l; 
