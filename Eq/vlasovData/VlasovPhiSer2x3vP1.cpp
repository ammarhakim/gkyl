...
__host__ __device__ double VlasovPhiVol2x3vSerP1(const double *w, const double *dxv, const double *phi, const double *Bvec, const double *f, double *out) 
{ 
  ...
  const double *B1 = &Bvec[4]; 
  const double *B2 = &Bvec[8]; 
  ...
  alpha_vdim[2] = dv10*((-2.828427124746191*B1[2]*wv3)+2.828427124746191*B2[2]*wv2-4.898979485566357*phi[3]); 
  alpha_vdim[4] = 0.8164965809277261*B2[0]*dv10*dv2; 
  alpha_vdim[5] = -0.8164965809277261*B1[0]*dv10*dv3; 
  alpha_vdim[6] = dv10*(2.828427124746191*B2[3]*wv2-2.828427124746191*B1[3]*wv3); 
  ...
  alpha_vdim[32] = dv11*(2.828427124746191*B0[0]*wv3-2.828427124746191*B2[0]*wv1-4.898979485566357*phi[2]); 
  alpha_vdim[33] = dv11*(2.828427124746191*B0[1]*wv3-2.828427124746191*B2[1]*wv1-4.898979485566357*phi[3]); 
  alpha_vdim[34] = dv11*(2.828427124746191*B0[2]*wv3-2.828427124746191*B2[2]*wv1); 
  alpha_vdim[35] = -0.8164965809277261*B2[0]*dv1*dv11; 
  alpha_vdim[37] = 0.8164965809277261*B0[0]*dv11*dv3; 
  alpha_vdim[38] = dv11*(2.828427124746191*B0[3]*wv3-2.828427124746191*B2[3]*wv1); 
  ...
  alpha_vdim[64] = dv12*(2.828427124746191*B1[0]*wv1-2.828427124746191*B0[0]*wv2); 
  alpha_vdim[65] = dv12*(2.828427124746191*B1[1]*wv1-2.828427124746191*B0[1]*wv2); 
  alpha_vdim[66] = dv12*(2.828427124746191*B1[2]*wv1-2.828427124746191*B0[2]*wv2); 
  alpha_vdim[67] = 0.8164965809277261*B1[0]*dv1*dv12; 
  alpha_vdim[68] = -0.8164965809277261*B0[0]*dv12*dv2; 
  alpha_vdim[70] = dv12*(2.828427124746191*B1[3]*wv1-2.828427124746191*B0[3]*wv2); 
