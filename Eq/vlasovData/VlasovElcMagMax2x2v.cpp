...
double VlasovVolElcMag2x2vMaxP1(const double *w, const double *dxv, const double *EM, const double *f, double *out) 
{ 
...
return 0.5*(std::abs(amid1)+std::abs(amid2)); 
} 
double VlasovVolElcMag2x2vMaxP2(const double *w, const double *dxv, const double *EM, const double *f, double *out) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  double dv0dx0 = dxv[2]/dxv[0]; 
  double w0dx0 = w[2]/dxv[0]; 
  ...
  out[6] += 0.3872983346207416*(alpha2[1]*f[11]+f[1]*alpha2[11])+0.4330127018922193*(alpha2[4]*f[8]+f[4]*alpha2[8]+alpha2[2]*f[5]+f[2]*alpha2[5]+alpha2[0]*f[1]+f[0]*alpha2[1]); 
  out[7] += 0.3872983346207416*(alpha2[2]*f[12]+f[2]*alpha2[12])+0.4330127018922193*(alpha2[4]*f[9]+f[4]*alpha2[9]+alpha2[1]*f[5]+f[1]*alpha2[5]+alpha2[0]*f[2]+f[0]*alpha2[2]); 
  out[8] += 0.3872983346207416*(alpha3[1]*f[11]+f[1]*alpha3[11])+0.4330127018922193*(alpha3[3]*f[6]+f[3]*alpha3[6]+alpha3[2]*f[5]+f[2]*alpha3[5]+alpha3[0]*f[1]+f[0]*alpha3[1]); 
  out[9] += 0.3872983346207416*(alpha3[2]*f[12]+f[2]*alpha3[12])+0.4330127018922193*(alpha3[3]*f[7]+f[3]*alpha3[7]+alpha3[1]*f[5]+f[1]*alpha3[5]+alpha3[0]*f[2]+f[0]*alpha3[2]); 
...
double VlasovVolElcMag2x2vMaxP3(const double *w, const double *dxv, const double *EM, const double *f, double *out) 
{ 
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. EM/f: Input EM-field/distribution function. out: Incremented output 
  double dv0dx0 = dxv[2]/dxv[0]; 
  double w0dx0 = w[2]/dxv[0]; 
  ...
  out[28] += 0.8504200642707612*f[25]*alpha3[31]+0.9682458365518543*alpha3[20]*f[26]+0.8660254037844386*(alpha3[1]*f[25]+f[17]*alpha3[21]+f[16]*alpha3[19])+0.9682458365518543*(alpha3[15]*f[18]+alpha3[3]*f[17]+alpha3[2]*f[16])+0.8660254037844386*f[8]*alpha3[11]+0.9682458365518543*(alpha3[6]*f[10]+alpha3[5]*f[9]+alpha3[0]*f[8]+alpha3[1]*f[4]); 
  out[29] += f[26]*(0.8504200642707612*alpha3[32]+0.8660254037844386*alpha3[2])+0.9682458365518543*alpha3[19]*f[25]+0.8660254037844386*(f[18]*alpha3[22]+f[16]*alpha3[20])+0.9682458365518543*(alpha3[3]*f[18]+alpha3[15]*f[17]+alpha3[1]*f[16])+0.8660254037844386*f[9]*alpha3[12]+0.9682458365518543*(alpha3[7]*f[10]+alpha3[0]*f[9]+alpha3[5]*f[8]+alpha3[2]*f[4]); 
