...
__host__ __device__ double VlasovPhiVol2x2vSerP1(const double *w, const double *dxv, const double *phi, const double *Bvec, const double *f, double *out) 
{ 
  ...
  alpha_vdim[2] = dv10*(2.0*B2[2]*wv2-3.464101615137754*phi[3]); 
  alpha_vdim[4] = 0.5773502691896258*B2[0]*dv10*dv2; 
  alpha_vdim[5] = 2.0*B2[3]*dv10*wv2; 
  ...
  alpha_vdim[16] = dv11*((-2.0*B2[0]*wv1)-3.464101615137754*phi[2]); 
  alpha_vdim[17] = dv11*((-2.0*B2[1]*wv1)-3.464101615137754*phi[3]); 
  alpha_vdim[18] = -2.0*B2[2]*dv11*wv1; 
  alpha_vdim[19] = -0.5773502691896258*B2[0]*dv1*dv11; 
  alpha_vdim[21] = -2.0*B2[3]*dv11*wv1; 
