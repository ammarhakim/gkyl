...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. f: Input distribution function. out: Incremented output 
  ...
  out[23] += 3.464101615137755*f[13]*w0dx0+0.8944271909999161*f[3]*dv0dx0; 
  ...
  out[29] += 3.464101615137755*f[14]*w1dx1+0.8944271909999161*f[4]*dv1dx1; 
  out[31] += 3.464101615137754*f[17]*w1dx1+3.464101615137754*f[18]*w0dx0+(0.8944271909999159*f[42]+f[6])*dv1dx1+(0.8944271909999159*f[40]+f[9])*dv0dx0; 
  out[32] += 3.464101615137755*f[21]*w1dx1+7.745966692414834*f[15]*w0dx0+f[37]*dv1dx1+(2.0*f[34]+2.23606797749979*f[5])*dv0dx0; 
  out[33] += 7.745966692414834*f[15]*w1dx1+3.464101615137755*f[22]*w0dx0+2.23606797749979*f[31]*dv1dx1+f[12]*dv0dx0; 
  out[34] += 3.464101615137755*f[23]*w1dx1+3.464101615137755*f[24]*w0dx0+f[39]*dv1dx1+0.8944271909999159*f[7]*dv0dx0; 
  out[35] += 3.464101615137755*f[25]*w1dx1+7.745966692414834*f[16]*w0dx0+f[11]*dv1dx1+2.23606797749979*f[31]*dv0dx0; 
  out[36] += 7.745966692414834*f[16]*w1dx1+3.464101615137755*f[26]*w0dx0+(2.0*f[41]+2.23606797749979*f[5])*dv1dx1+f[38]*dv0dx0; 
  out[37] += 7.745966692414834*f[17]*w0dx0+(2.0*f[39]+2.23606797749979*f[8])*dv0dx0; 
  out[38] += 7.745966692414834*f[18]*w1dx1+(2.0*f[43]+2.23606797749979*f[7])*dv1dx1; 
  out[39] += 3.464101615137755*f[27]*w0dx0+0.8944271909999159*f[10]*dv0dx0; 
  out[40] += 3.464101615137755*f[27]*w1dx1+f[13]*dv1dx1; 
  out[41] += 3.464101615137755*f[28]*w1dx1+3.464101615137755*f[29]*w0dx0+0.8944271909999159*f[8]*dv1dx1+f[43]*dv0dx0; 
  out[42] += 3.464101615137755*f[30]*w0dx0+f[14]*dv0dx0; 
  out[43] += 3.464101615137755*f[30]*w1dx1+0.8944271909999159*f[10]*dv1dx1; 
  out[44] += 3.464101615137755*f[37]*w1dx1+7.745966692414834*f[31]*w0dx0+f[21]*dv1dx1+(2.0*f[46]+2.23606797749979*f[16])*dv0dx0; 
