...
// w[NDIM]: Cell-center coordinates. dxv[NDIM]: Cell spacing. f: Input distribution function. out: Incremented output 
  ...
  out[32] += 3.464101615137755*f[21]*w1dx1+7.745966692414834*f[15]*w0dx0+f[37]*dv1dx1+2.0*f[34]*dv0dx0+2.23606797749979*f[5]*dv0dx0; 
  ...
  out[36] += 7.745966692414834*f[16]*w1dx1+3.464101615137755*f[26]*w0dx0+2.0*f[41]*dv1dx1+2.23606797749979*f[5]*dv1dx1+f[38]*dv0dx0; 
  ...
  out[44] += 3.464101615137755*f[37]*w1dx1+7.745966692414834*f[31]*w0dx0+f[21]*dv1dx1+2.0*f[46]*dv0dx0+2.23606797749979*f[16]*dv0dx0; 
  out[45] += 7.745966692414834*f[31]*w1dx1+3.464101615137755*f[38]*w0dx0+2.0*f[47]*dv1dx1+2.23606797749979*f[15]*dv1dx1+f[26]*dv0dx0; 
