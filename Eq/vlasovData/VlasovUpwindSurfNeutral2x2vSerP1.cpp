...
__host__ __device__ double VlasovUpwindSurfNeutral2x2vSer_VX_P1(const double *wl, const double *wr, const double *dxvl, const double *dxvr, const double amax, const double *EM, const double *fl, const double *fr, double *outl, double *outr) 
{ 
  ...
  alpha[2] = 1.414213562373095*Fo0[2]; 
  alpha[4] = 1.414213562373095*Fo0[3]; 

  const double amid = 0.3535533905932737*alpha[0]; 

  double alphaOrdR;
  double fUpOrd[8];
  alphaOrdR = 0.3535533905932737*alpha[4]-0.3535533905932737*(alpha[2]+alpha[1])+0.3535533905932737*alpha[0]; 
  ...
  alphaOrdR = 0.3535533905932737*(alpha[1]+alpha[0])-0.3535533905932737*(alpha[4]+alpha[2]); 
  ...
  alphaOrdR = (-0.3535533905932737*alpha[4])+0.3535533905932737*alpha[2]-0.3535533905932737*alpha[1]+0.3535533905932737*alpha[0]; 
  ...
  alphaOrdR = 0.3535533905932737*(alpha[4]+alpha[2]+alpha[1]+alpha[0]); 
  ...
  incr[0] = 0.25*(alpha[4]*fUp[4]+alpha[2]*fUp[2]+alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[1] = 0.25*(alpha[2]*fUp[4]+fUp[2]*alpha[4]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[2] = 0.25*(alpha[1]*fUp[4]+fUp[1]*alpha[4]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[3] = -0.4330127018922193*(alpha[4]*fUp[4]+alpha[2]*fUp[2]+alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[4] = 0.25*(alpha[4]*fUp[7]+alpha[2]*fUp[6]+alpha[1]*fUp[5]+alpha[0]*fUp[3]); 
  incr[5] = 0.25*(alpha[0]*fUp[4]+fUp[0]*alpha[4]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
  incr[6] = -0.4330127018922193*(alpha[2]*fUp[4]+fUp[2]*alpha[4]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[7] = -0.4330127018922193*(alpha[1]*fUp[4]+fUp[1]*alpha[4]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[8] = 0.25*(alpha[2]*fUp[7]+alpha[4]*fUp[6]+alpha[0]*fUp[5]+alpha[1]*fUp[3]); 
  incr[9] = 0.25*(alpha[1]*fUp[7]+alpha[0]*fUp[6]+alpha[4]*fUp[5]+alpha[2]*fUp[3]); 
  incr[10] = -0.4330127018922193*(alpha[4]*fUp[7]+alpha[2]*fUp[6]+alpha[1]*fUp[5]+alpha[0]*fUp[3]); 
  incr[11] = -0.4330127018922193*(alpha[0]*fUp[4]+fUp[0]*alpha[4]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
  incr[12] = 0.25*(alpha[0]*fUp[7]+alpha[1]*fUp[6]+alpha[2]*fUp[5]+fUp[3]*alpha[4]); 
  incr[13] = -0.4330127018922193*(alpha[2]*fUp[7]+alpha[4]*fUp[6]+alpha[0]*fUp[5]+alpha[1]*fUp[3]); 
  incr[14] = -0.4330127018922193*(alpha[1]*fUp[7]+alpha[0]*fUp[6]+alpha[4]*fUp[5]+alpha[2]*fUp[3]); 
  incr[15] = -0.4330127018922193*(alpha[0]*fUp[7]+alpha[1]*fUp[6]+alpha[2]*fUp[5]+fUp[3]*alpha[4]); 
...
__host__ __device__ double VlasovUpwindSurfNeutral2x2vSer_VY_P1(const double *wl, const double *wr, const double *dxvl, const double *dxvr, const double amax, const double *EM, const double *fl, const double *fr, double *outl, double *outr) 
{ 
  // w:         Cell-center coordinates.
  // dxv[NDIM]: Cell spacing.
  // amax:      amax in global lax flux.
  ...
  alpha[2] = 1.414213562373095*Fo1[2]; 
  alpha[4] = 1.414213562373095*Fo1[3]; 
  ...
  incr[1] = 0.25*(alpha[2]*fUp[4]+fUp[2]*alpha[4]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[2] = 0.25*(alpha[1]*fUp[4]+fUp[1]*alpha[4]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[3] = 0.25*(alpha[4]*fUp[7]+alpha[2]*fUp[6]+alpha[1]*fUp[5]+alpha[0]*fUp[3]); 
  incr[4] = -0.4330127018922193*(alpha[4]*fUp[4]+alpha[2]*fUp[2]+alpha[1]*fUp[1]+alpha[0]*fUp[0]); 
  incr[5] = 0.25*(alpha[0]*fUp[4]+fUp[0]*alpha[4]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
  incr[6] = 0.25*(alpha[2]*fUp[7]+alpha[4]*fUp[6]+alpha[0]*fUp[5]+alpha[1]*fUp[3]); 
  incr[7] = 0.25*(alpha[1]*fUp[7]+alpha[0]*fUp[6]+alpha[4]*fUp[5]+alpha[2]*fUp[3]); 
  incr[8] = -0.4330127018922193*(alpha[2]*fUp[4]+fUp[2]*alpha[4]+alpha[0]*fUp[1]+fUp[0]*alpha[1]); 
  incr[9] = -0.4330127018922193*(alpha[1]*fUp[4]+fUp[1]*alpha[4]+alpha[0]*fUp[2]+fUp[0]*alpha[2]); 
  incr[10] = -0.4330127018922193*(alpha[4]*fUp[7]+alpha[2]*fUp[6]+alpha[1]*fUp[5]+alpha[0]*fUp[3]); 
  incr[11] = 0.25*(alpha[0]*fUp[7]+alpha[1]*fUp[6]+alpha[2]*fUp[5]+fUp[3]*alpha[4]); 
  incr[12] = -0.4330127018922193*(alpha[0]*fUp[4]+fUp[0]*alpha[4]+alpha[1]*fUp[2]+fUp[1]*alpha[2]); 
  incr[13] = -0.4330127018922193*(alpha[2]*fUp[7]+alpha[4]*fUp[6]+alpha[0]*fUp[5]+alpha[1]*fUp[3]); 
  incr[14] = -0.4330127018922193*(alpha[1]*fUp[7]+alpha[0]*fUp[6]+alpha[4]*fUp[5]+alpha[2]*fUp[3]); 
  incr[15] = -0.4330127018922193*(alpha[0]*fUp[7]+alpha[1]*fUp[6]+alpha[2]*fUp[5]+fUp[3]*alpha[4]); 
