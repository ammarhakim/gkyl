...
__host__ __device__ double VlasovNeutralVol1x3vSerP2(const double *w, const double *dxv, const double *boA, const double *f, double *out) 
{ 
  ...
  const double *Fo1 = &boA[3]; 
  const double dv2 = dxv[2], wv2 = w[2]; 
  const double dv12 = 2/dxv[3]; 
  const double *Fo2 = &boA[6]; 
