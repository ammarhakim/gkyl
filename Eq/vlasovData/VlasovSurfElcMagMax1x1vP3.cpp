...
{ 
  ...
  favg[3] = 0.7071067811865475*fr[8]+0.7071067811865475*fl[8]; 
  ...
  Ghat[1] = 0.01010152544552211*(30.7408522978788*(alpha[2]*favg[3]+favg[2]*alpha[3])+31.30495168499706*(alpha[1]*favg[2]+favg[1]*alpha[2])+35.0*(alpha[0]*favg[1]+favg[0]*alpha[1]))-0.1178511301977579*(1.732050807568877*(3.872983346207417*fr[7]-1.0*(3.872983346207417*fl[7]+3.0*(fr[3]+fl[3])))+3.0*(fr[1]-1.0*fl[1]))*amax; 
  ...
  Ghat[3] = 0.003367175148507369*((62.60990336999411*alpha[2]+105.0*alpha[0])*favg[3]+(62.60990336999411*favg[2]+105.0*favg[0])*alpha[3]+92.22255689363637*(alpha[1]*favg[2]+favg[1]*alpha[2]))-0.3535533905932737*(fr[8]-1.0*fl[8])*amax; 
