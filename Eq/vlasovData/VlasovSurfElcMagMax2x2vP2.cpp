...
{ 
  ...
  Ghat[0] = 0.1767766952966368*(alpha[8]*favg[8]+alpha[7]*favg[7]+alpha[6]*favg[6]+alpha[5]*favg[5]+alpha[4]*favg[4]+alpha[3]*favg[3]+alpha[2]*favg[2]+alpha[1]*favg[1]+alpha[0]*favg[0])-0.3535533905932737*(2.23606797749979*fr[13]-1.0*(2.23606797749979*fl[13]+1.732050807568877*(fr[3]+fl[3]))+fr[0]-1.0*fl[0])*amax; 
  ...
  Ghat[2] = 0.3535533905932737*(1.732050807568877*(fr[7]+fl[7])-1.0*fr[2]+fl[2])*amax+0.03535533905932737*(4.47213595499958*(alpha[2]*favg[8]+favg[2]*alpha[8])+5.0*(alpha[3]*favg[6]+favg[3]*alpha[6]+alpha[1]*favg[4]+favg[1]*alpha[4]+alpha[0]*favg[2]+favg[0]*alpha[2])); 
  Ghat[3] = 0.3535533905932737*(1.732050807568877*(fr[10]+fl[10])-1.0*fr[4]+fl[4])*amax+0.03535533905932737*(4.47213595499958*alpha[3]*favg[9]+5.0*(alpha[2]*favg[6]+favg[2]*alpha[6]+alpha[1]*favg[5]+favg[1]*alpha[5]+alpha[0]*favg[3]+favg[0]*alpha[3])); 
  Ghat[4] = 0.03535533905932737*(4.47213595499958*(alpha[4]*favg[8]+favg[4]*alpha[8]+alpha[4]*favg[7]+favg[4]*alpha[7])+5.0*(alpha[5]*favg[6]+favg[5]*alpha[6]+alpha[0]*favg[4]+favg[0]*alpha[4]+alpha[1]*favg[2]+favg[1]*alpha[2]))-0.3535533905932737*(fr[5]-1.0*fl[5])*amax; 
  Ghat[5] = 0.03535533905932737*(4.47213595499958*(alpha[5]*(favg[9]+favg[7])+favg[5]*alpha[7])+5.0*(alpha[4]*favg[6]+favg[4]*alpha[6]+alpha[0]*favg[5]+favg[0]*alpha[5]+alpha[1]*favg[3]+favg[1]*alpha[3]))-0.3535533905932737*(fr[8]-1.0*fl[8])*amax; 
  Ghat[6] = 0.03535533905932737*(4.47213595499958*(alpha[6]*(favg[9]+favg[8])+favg[6]*alpha[8])+5.0*(alpha[0]*favg[6]+favg[0]*alpha[6]+alpha[4]*favg[5]+favg[4]*alpha[5]+alpha[2]*favg[3]+favg[2]*alpha[3]))-0.3535533905932737*(fr[9]-1.0*fl[9])*amax; 
  ...
  Ghat[8] = 0.005050762722761053*((22.3606797749979*alpha[8]+35.0*alpha[0])*favg[8]+35.0*favg[0]*alpha[8]+31.30495168499706*(alpha[6]*favg[6]+alpha[4]*favg[4]+alpha[2]*favg[2]))-0.3535533905932737*(fr[12]-1.0*fl[12])*amax; 
  Ghat[9] = 0.03535533905932737*(5.0*alpha[0]*favg[9]+4.47213595499958*(alpha[6]*favg[6]+alpha[5]*favg[5]+alpha[3]*favg[3]))-0.3535533905932737*(fr[14]-1.0*fl[14])*amax; 
...
{ 
  ...
  Ghat[0] = 0.1767766952966368*(alpha[8]*favg[8]+alpha[7]*favg[7]+alpha[6]*favg[6]+alpha[5]*favg[5]+alpha[4]*favg[4]+alpha[3]*favg[3]+alpha[2]*favg[2]+alpha[1]*favg[1]+alpha[0]*favg[0])-0.3535533905932737*(2.23606797749979*fr[14]-1.0*(2.23606797749979*fl[14]+1.732050807568877*(fr[4]+fl[4]))+fr[0]-1.0*fl[0])*amax; 
  ...
  Ghat[2] = 0.3535533905932737*(1.732050807568877*(fr[9]+fl[9])-1.0*fr[2]+fl[2])*amax+0.03535533905932737*(4.47213595499958*(alpha[2]*favg[8]+favg[2]*alpha[8])+5.0*(alpha[3]*favg[6]+favg[3]*alpha[6]+alpha[1]*favg[4]+favg[1]*alpha[4]+alpha[0]*favg[2]+favg[0]*alpha[2])); 
  Ghat[3] = 0.3535533905932737*(1.732050807568877*(fr[10]+fl[10])-1.0*fr[3]+fl[3])*amax+0.03535533905932737*(4.47213595499958*alpha[3]*favg[9]+5.0*(alpha[2]*favg[6]+favg[2]*alpha[6]+alpha[1]*favg[5]+favg[1]*alpha[5]+alpha[0]*favg[3]+favg[0]*alpha[3])); 
  Ghat[4] = 0.03535533905932737*(4.47213595499958*(alpha[4]*favg[8]+favg[4]*alpha[8]+alpha[4]*favg[7]+favg[4]*alpha[7])+5.0*(alpha[5]*favg[6]+favg[5]*alpha[6]+alpha[0]*favg[4]+favg[0]*alpha[4]+alpha[1]*favg[2]+favg[1]*alpha[2]))-0.3535533905932737*(fr[5]-1.0*fl[5])*amax; 
  Ghat[5] = 0.03535533905932737*(4.47213595499958*(alpha[5]*(favg[9]+favg[7])+favg[5]*alpha[7])+5.0*(alpha[4]*favg[6]+favg[4]*alpha[6]+alpha[0]*favg[5]+favg[0]*alpha[5]+alpha[1]*favg[3]+favg[1]*alpha[3]))-0.3535533905932737*(fr[6]-1.0*fl[6])*amax; 
  Ghat[6] = 0.03535533905932737*(4.47213595499958*(alpha[6]*(favg[9]+favg[8])+favg[6]*alpha[8])+5.0*(alpha[0]*favg[6]+favg[0]*alpha[6]+alpha[4]*favg[5]+favg[4]*alpha[5]+alpha[2]*favg[3]+favg[2]*alpha[3]))-0.3535533905932737*(fr[7]-1.0*fl[7])*amax; 
  Ghat[7] = 0.005050762722761053*((22.3606797749979*alpha[7]+35.0*alpha[0])*favg[7]+35.0*favg[0]*alpha[7]+31.30495168499706*(alpha[5]*favg[5]+alpha[4]*favg[4]+alpha[1]*favg[1]))-0.3535533905932737*(fr[11]-1.0*fl[11])*amax; 
  Ghat[8] = 0.005050762722761053*((22.3606797749979*alpha[8]+35.0*alpha[0])*favg[8]+35.0*favg[0]*alpha[8]+31.30495168499706*(alpha[6]*favg[6]+alpha[4]*favg[4]+alpha[2]*favg[2]))-0.3535533905932737*(fr[12]-1.0*fl[12])*amax; 
  Ghat[9] = 0.03535533905932737*(5.0*alpha[0]*favg[9]+4.47213595499958*(alpha[6]*favg[6]+alpha[5]*favg[5]+alpha[3]*favg[3]))-0.3535533905932737*(fr[13]-1.0*fl[13])*amax; 
