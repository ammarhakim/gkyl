...
function test_17()
   ...
   local r3 = r1:intersectInDir(r2,1)
   assert_equal(5 , r3:lower(1), "Checking intersected range in dir 1")
   assert_equal(2 , r3:lower(2), "Checking intersected range in dir 1")
   assert_equal(10, r3:upper(1), "Checking intersected range in dir 1")
   assert_equal(11, r3:upper(2), "Checking intersected range in dir 1")
   local r3 = r1:intersectInDir(r2,2)
   assert_equal(1 , r3:lower(1), "Checking intersected range in dir 2")
   assert_equal(6 , r3:lower(2), "Checking intersected range in dir 2")
   assert_equal(10, r3:upper(1), "Checking intersected range in dir 2")
   assert_equal(11, r3:upper(2), "Checking intersected range in dir 2")
   ...
   local r3 = r2:intersectInDir(r1,1)
   assert_equal(5 , r3:lower(1), "Checking intersected range in dir 1")
   assert_equal(6 , r3:lower(2), "Checking intersected range in dir 1")
   assert_equal(10, r3:upper(1), "Checking intersected range in dir 1")
   assert_equal(13, r3:upper(2), "Checking intersected range in dir 1")
   local r3 = r2:intersectInDir(r1,2)
   assert_equal(5 , r3:lower(1), "Checking intersected range in dir 2")
   assert_equal(6 , r3:lower(2), "Checking intersected range in dir 2")
   assert_equal(12, r3:upper(1), "Checking intersected range in dir 2")
   assert_equal(11, r3:upper(2), "Checking intersected range in dir 2")
   ...
   local r3 = r1:intersectInDir(r2,2)                                
   assert_equal(1 , r3:lower(1), "Checking intersected range in dir 2")
   assert_equal(5 , r3:lower(2), "Checking intersected range in dir 2")
   assert_equal(10, r3:upper(1), "Checking intersected range in dir 2")
   assert_equal(10, r3:upper(2), "Checking intersected range in dir 2")
   ...
   local r3 = r1:intersectInDir(r2,1)
   assert_equal(4 , r3:lower(1), "Checking intersected range in dir 1")
   assert_equal(2 , r3:lower(2), "Checking intersected range in dir 1")
   assert_equal(10, r3:upper(1), "Checking intersected range in dir 1")
   assert_equal(11, r3:upper(2), "Checking intersected range in dir 1")
   local r3 = r1:intersectInDir(r2,2)                                
   assert_equal(1 , r3:lower(1), "Checking intersected range in dir 2")
   assert_equal(4 , r3:lower(2), "Checking intersected range in dir 2")
   assert_equal(10, r3:upper(1), "Checking intersected range in dir 2")
   assert_equal(8 , r3:upper(2), "Checking intersected range in dir 2")
