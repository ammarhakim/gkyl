...
function test_fs_gkhybrid_2d_p1()
   local basis = Basis.CartModalSerendipity { ndim = 2, polyOrder = 1, useGkHybrid = true }
   local fIn, fOut = Lin.Vec(basis:numBasis()), Lin.Vec(basis:numBasis())
