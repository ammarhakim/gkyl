...
extern "C" {
    ...
    void gkylMomentSrcTimeCentered(MomentSrcData_t *sd, FluidData_t *fd, double dt, double **f, double *em, double *staticEm, double *sigma);
    /* Method to update fluids and flield using time-centered implicit method in the exact form */
    void gkylMomentSrcTimeCenteredDirect(MomentSrcData_t *sd, FluidData_t *fd, double dt, double **f, double *em, double *staticEm, double *sigma);
    /* Method to update fluids and flield using time-centered implicit method in the exact form; the older version*/
    void gkylMomentSrcTimeCenteredDirect2(MomentSrcData_t *sd, FluidData_t *fd, double dt, double **f, double *em, double *staticEm, double *sigma);
    /* Method to update fluids and flield using the exact ODE solutions */
    void gkylMomentSrcExact(MomentSrcData_t *sd, FluidData_t *fd, double dt, double **ff, double *em, double *staticEm, double *sigma);
}
