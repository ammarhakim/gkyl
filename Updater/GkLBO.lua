...
function GkLBO:_advance(tCurr, inFld, outFld)
   ...
   local nu_vthsq = assert(inFld[4], "GkLBO.advance: Must pass nu_vthsq")
   ...
   ffiC.gkyl_dg_updater_lbo_gyrokinetic_advance(self._zero, localRange, bmagInv._zero, nu_sum._zero, nu_u._zero, nu_vthsq._zero, fIn._zero, cflRateByCell._zero, fRhsOut._zero)
...
function GkLBO:_advanceOnDevice(tCurr, inFld, outFld)
   ...
   local localRange = fRhsOut:localRange()
   ffiC.gkyl_dg_updater_lbo_gyrokinetic_advance_cu(self._zero, localRange, bmagInv._zeroDevice, nu_sum._zeroDevice, nu_u._zeroDevice, nu_vthsq._zeroDevice, fIn._zeroDevice, cflRateByCell._zeroDevice, fRhsOut._zeroDevice)
