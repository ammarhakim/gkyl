...
{ 
  ...
  { 
    ...
    tmp[3] = 0.004761904761904762*(92.22255689363638*(A[a0+5]*B[b0+11]+A[a0+4]*B[b0+10])+92.2225568936364*(A[a0+7]*B[b0+9]+A[a0+6]*B[b0+8])+(92.2225568936364*A[a0+9]+84.0*A[a0+6]+93.91485505499116*A[a0+2])*B[b0+7]+(92.2225568936364*A[a0+8]+84.0*A[a0+7]+93.91485505499116*A[a0+1])*B[b0+6]+(92.22255689363638*A[a0+11]+93.91485505499116*A[a0+3])*B[b0+5]+(92.22255689363638*A[a0+10]+93.91485505499116*A[a0+3])*B[b0+4]+(93.91485505499116*(A[a0+5]+A[a0+4])+105.0*A[a0])*B[b0+3]+(93.91485505499116*A[a0+7]+105.0*A[a0+1])*B[b0+2]+(93.91485505499116*A[a0+6]+105.0*A[a0+2])*B[b0+1]+105.0*A[a0+3]*B[b0]); 
...
{ 
  ...
  bool avgA = false;
  if (2.29128784747792*(A[11]+A[10])-1.322875655532295*(A[9]+A[8])-1.936491673103709*(A[7]+A[6])+1.118033988749895*(A[5]+A[4])+1.5*A[3]-0.8660254037844386*(A[2]+A[1])+0.5*A[0] < 0.0) { 
    avgA = true;
  }
  if ((-2.29128784747792*(A[11]+A[10]))-1.322875655532295*A[9]+1.322875655532295*A[8]+1.936491673103709*A[7]-1.936491673103709*A[6]+1.118033988749895*(A[5]+A[4])-1.5*A[3]-0.8660254037844386*A[2]+0.8660254037844386*A[1]+0.5*A[0] < 0.0) { 
    avgA = true;
  }
  if ((-2.29128784747792*(A[11]+A[10]))+1.322875655532295*A[9]-1.322875655532295*A[8]-1.936491673103709*A[7]+1.936491673103709*A[6]+1.118033988749895*(A[5]+A[4])-1.5*A[3]+0.8660254037844386*A[2]-0.8660254037844386*A[1]+0.5*A[0] < 0.0) { 
    avgA = true;
