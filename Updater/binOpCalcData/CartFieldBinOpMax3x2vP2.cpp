...
{ 
  ...
  tmp[1] = 0.03535533905932736*(4.47213595499958*(A[1]*B[16]+B[1]*A[16])+5.0*(A[5]*B[12]+B[5]*A[12]+A[4]*B[9]+B[4]*A[9]+A[3]*B[7]+B[3]*A[7]+A[2]*B[6]+B[2]*A[6]+A[0]*B[1]+B[0]*A[1])); 
  tmp[2] = 0.03535533905932736*(4.47213595499958*(A[2]*B[17]+B[2]*A[17])+5.0*(A[5]*B[13]+B[5]*A[13]+A[4]*B[10]+B[4]*A[10]+A[3]*B[8]+B[3]*A[8]+A[1]*B[6]+B[1]*A[6]+A[0]*B[2]+B[0]*A[2])); 
  tmp[3] = 0.03535533905932736*(4.47213595499958*(A[3]*B[18]+B[3]*A[18])+5.0*(A[5]*B[14]+B[5]*A[14]+A[4]*B[11]+B[4]*A[11]+A[2]*B[8]+B[2]*A[8]+A[1]*B[7]+B[1]*A[7]+A[0]*B[3]+B[0]*A[3])); 
  tmp[4] = 0.03535533905932736*(4.47213595499958*(A[4]*B[19]+B[4]*A[19])+5.0*(A[5]*B[15]+B[5]*A[15]+A[3]*B[11]+B[3]*A[11]+A[2]*B[10]+B[2]*A[10]+A[1]*B[9]+B[1]*A[9]+A[0]*B[4]+B[0]*A[4])); 
  tmp[5] = 0.03535533905932736*(4.47213595499958*(A[5]*B[20]+B[5]*A[20])+5.0*(A[4]*B[15]+B[4]*A[15]+A[3]*B[14]+B[3]*A[14]+A[2]*B[13]+B[2]*A[13]+A[1]*B[12]+B[1]*A[12]+A[0]*B[5]+B[0]*A[5])); 
  tmp[6] = 0.03535533905932736*(4.47213595499958*(A[6]*B[17]+B[6]*A[17]+A[6]*B[16]+B[6]*A[16])+5.0*(A[12]*B[13]+B[12]*A[13]+A[9]*B[10]+B[9]*A[10]+A[7]*B[8]+B[7]*A[8]+A[0]*B[6]+B[0]*A[6]+A[1]*B[2]+B[1]*A[2])); 
  tmp[7] = 0.03535533905932736*(4.47213595499958*(A[7]*B[18]+B[7]*A[18]+A[7]*B[16]+B[7]*A[16])+5.0*(A[12]*B[14]+B[12]*A[14]+A[9]*B[11]+B[9]*A[11]+A[6]*B[8]+B[6]*A[8]+A[0]*B[7]+B[0]*A[7]+A[1]*B[3]+B[1]*A[3])); 
  tmp[8] = 0.03535533905932736*(4.47213595499958*(A[8]*B[18]+B[8]*A[18]+A[8]*B[17]+B[8]*A[17])+5.0*(A[13]*B[14]+B[13]*A[14]+A[10]*B[11]+B[10]*A[11]+A[0]*B[8]+B[0]*A[8]+A[6]*B[7]+B[6]*A[7]+A[2]*B[3]+B[2]*A[3])); 
  tmp[9] = 0.03535533905932736*(4.47213595499958*(A[9]*B[19]+B[9]*A[19]+A[9]*B[16]+B[9]*A[16])+5.0*(A[12]*B[15]+B[12]*A[15]+A[7]*B[11]+B[7]*A[11]+A[6]*B[10]+B[6]*A[10]+A[0]*B[9]+B[0]*A[9]+A[1]*B[4]+B[1]*A[4])); 
  tmp[10] = 0.03535533905932736*(4.47213595499958*(A[10]*B[19]+B[10]*A[19]+A[10]*B[17]+B[10]*A[17])+5.0*(A[13]*B[15]+B[13]*A[15]+A[8]*B[11]+B[8]*A[11]+A[0]*B[10]+B[0]*A[10]+A[6]*B[9]+B[6]*A[9]+A[2]*B[4]+B[2]*A[4])); 
  tmp[11] = 0.03535533905932736*(4.47213595499958*(A[11]*B[19]+B[11]*A[19]+A[11]*B[18]+B[11]*A[18])+5.0*(A[14]*B[15]+B[14]*A[15]+A[0]*B[11]+B[0]*A[11]+A[8]*B[10]+B[8]*A[10]+A[7]*B[9]+B[7]*A[9]+A[3]*B[4]+B[3]*A[4])); 
  tmp[12] = 0.03535533905932736*(4.47213595499958*(A[12]*B[20]+B[12]*A[20]+A[12]*B[16]+B[12]*A[16])+5.0*(A[9]*B[15]+B[9]*A[15]+A[7]*B[14]+B[7]*A[14]+A[6]*B[13]+B[6]*A[13]+A[0]*B[12]+B[0]*A[12]+A[1]*B[5]+B[1]*A[5])); 
  tmp[13] = 0.03535533905932736*(4.47213595499958*(A[13]*B[20]+B[13]*A[20]+A[13]*B[17]+B[13]*A[17])+5.0*(A[10]*B[15]+B[10]*A[15]+A[8]*B[14]+B[8]*A[14]+A[0]*B[13]+B[0]*A[13]+A[6]*B[12]+B[6]*A[12]+A[2]*B[5]+B[2]*A[5])); 
  tmp[14] = 0.03535533905932736*(4.47213595499958*(A[14]*B[20]+B[14]*A[20]+A[14]*B[18]+B[14]*A[18])+5.0*(A[11]*B[15]+B[11]*A[15]+A[0]*B[14]+B[0]*A[14]+A[8]*B[13]+B[8]*A[13]+A[7]*B[12]+B[7]*A[12]+A[3]*B[5]+B[3]*A[5])); 
  tmp[15] = 0.03535533905932736*(4.47213595499958*(A[15]*B[20]+B[15]*A[20]+A[15]*B[19]+B[15]*A[19])+5.0*(A[0]*B[15]+B[0]*A[15]+A[11]*B[14]+B[11]*A[14]+A[10]*B[13]+B[10]*A[13]+A[9]*B[12]+B[9]*A[12]+A[4]*B[5]+B[4]*A[5])); 
  tmp[16] = 0.005050762722761052*((22.3606797749979*A[16]+35.0*A[0])*B[16]+35.0*B[0]*A[16]+31.30495168499706*(A[12]*B[12]+A[9]*B[9]+A[7]*B[7]+A[6]*B[6]+A[1]*B[1])); 
  tmp[17] = 0.005050762722761052*((22.3606797749979*A[17]+35.0*A[0])*B[17]+35.0*B[0]*A[17]+31.30495168499706*(A[13]*B[13]+A[10]*B[10]+A[8]*B[8]+A[6]*B[6]+A[2]*B[2])); 
  tmp[18] = 0.005050762722761052*((22.3606797749979*A[18]+35.0*A[0])*B[18]+35.0*B[0]*A[18]+31.30495168499706*(A[14]*B[14]+A[11]*B[11]+A[8]*B[8]+A[7]*B[7]+A[3]*B[3])); 
  tmp[19] = 0.005050762722761052*((22.3606797749979*A[19]+35.0*A[0])*B[19]+35.0*B[0]*A[19]+31.30495168499706*(A[15]*B[15]+A[11]*B[11]+A[10]*B[10]+A[9]*B[9]+A[4]*B[4])); 
  tmp[20] = 0.005050762722761052*((22.3606797749979*A[20]+35.0*A[0])*B[20]+35.0*B[0]*A[20]+31.30495168499706*(A[15]*B[15]+A[14]*B[14]+A[13]*B[13]+A[12]*B[12]+A[5]*B[5])); 
