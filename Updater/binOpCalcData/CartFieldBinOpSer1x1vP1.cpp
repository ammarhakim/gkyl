...
{ 
  ...
  tmp[0] = 0.5*(A[4]*B[4]+A[3]*B[3]+A[2]*B[2]+A[1]*B[1]+A[0]*B[0]); 
  tmp[1] = 0.5*(A[2]*B[3]+B[2]*A[3]+A[0]*B[1]+B[0]*A[1]); 
  tmp[2] = 0.1*(4.47213595499958*(A[2]*B[4]+B[2]*A[4])+5.0*(A[1]*B[3]+B[1]*A[3]+A[0]*B[2]+B[0]*A[2])); 
  tmp[3] = 0.1*(4.47213595499958*(A[3]*B[4]+B[3]*A[4])+5.0*(A[0]*B[3]+B[0]*A[3]+A[1]*B[2]+B[1]*A[2])); 
