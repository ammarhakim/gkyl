...
{ 
  ...
  tmp[0] = 0.3535533905932737*(A[8]*B[8]+A[7]*B[7]+A[6]*B[6]+A[5]*B[5]+A[4]*B[4]+A[3]*B[3]+A[2]*B[2]+A[1]*B[1]+A[0]*B[0]); 
  tmp[1] = 0.3535533905932737*(A[6]*B[7]+B[6]*A[7]+A[3]*B[5]+B[3]*A[5]+A[2]*B[4]+B[2]*A[4]+A[0]*B[1]+B[0]*A[1]); 
  tmp[2] = 0.07071067811865474*(4.47213595499958*(A[2]*B[8]+B[2]*A[8])+5.0*(A[5]*B[7]+B[5]*A[7]+A[3]*B[6]+B[3]*A[6]+A[1]*B[4]+B[1]*A[4]+A[0]*B[2]+B[0]*A[2])); 
  tmp[3] = 0.3535533905932737*(A[4]*B[7]+B[4]*A[7]+A[2]*B[6]+B[2]*A[6]+A[1]*B[5]+B[1]*A[5]+A[0]*B[3]+B[0]*A[3]); 
  tmp[4] = 0.07071067811865474*(4.47213595499958*(A[4]*B[8]+B[4]*A[8])+5.0*(A[3]*B[7]+B[3]*A[7]+A[5]*B[6]+B[5]*A[6]+A[0]*B[4]+B[0]*A[4]+A[1]*B[2]+B[1]*A[2])); 
  tmp[5] = 0.3535533905932737*(A[2]*B[7]+B[2]*A[7]+A[4]*B[6]+B[4]*A[6]+A[0]*B[5]+B[0]*A[5]+A[1]*B[3]+B[1]*A[3]); 
  tmp[6] = 0.07071067811865474*(4.47213595499958*(A[6]*B[8]+B[6]*A[8])+5.0*(A[1]*B[7]+B[1]*A[7]+A[0]*B[6]+B[0]*A[6]+A[4]*B[5]+B[4]*A[5]+A[2]*B[3]+B[2]*A[3])); 
  tmp[7] = 0.07071067811865474*(4.47213595499958*(A[7]*B[8]+B[7]*A[8])+5.0*(A[0]*B[7]+B[0]*A[7]+A[1]*B[6]+B[1]*A[6]+A[2]*B[5]+B[2]*A[5]+A[3]*B[4]+B[3]*A[4])); 
