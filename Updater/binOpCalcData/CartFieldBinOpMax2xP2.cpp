...
{ 
  ...
  { 
    ...
    tmp[1] = 0.1*(4.47213595499958*A[a0+1]*B[b0+4]+5.0*(A[a0+2]*B[b0+3]+A[a0+3]*B[b0+2])+(4.47213595499958*A[a0+4]+5.0*A[a0])*B[b0+1]+5.0*A[a0+1]*B[b0]); 
    tmp[2] = 0.1*(4.47213595499958*A[a0+2]*B[b0+5]+5.0*A[a0+1]*B[b0+3]+(4.47213595499958*A[a0+5]+5.0*A[a0])*B[b0+2]+5.0*(A[a0+3]*B[b0+1]+A[a0+2]*B[b0])); 
    tmp[3] = 0.1*(4.47213595499958*A[a0+3]*(B[b0+5]+B[b0+4])+(4.47213595499958*(A[a0+5]+A[a0+4])+5.0*A[a0])*B[b0+3]+5.0*(A[a0+1]*B[b0+2]+A[a0+2]*B[b0+1]+A[a0+3]*B[b0])); 
    tmp[4] = 0.01428571428571429*((22.3606797749979*A[a0+4]+35.0*A[a0])*B[b0+4]+31.30495168499706*(A[a0+3]*B[b0+3]+A[a0+1]*B[b0+1])+35.0*A[a0+4]*B[b0]); 
    tmp[5] = 0.01428571428571429*((22.3606797749979*A[a0+5]+35.0*A[a0])*B[b0+5]+31.30495168499706*(A[a0+3]*B[b0+3]+A[a0+2]*B[b0+2])+35.0*A[a0+5]*B[b0]); 
