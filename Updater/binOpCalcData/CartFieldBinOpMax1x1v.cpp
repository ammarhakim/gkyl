...
{ 
  ...
  tmp[0] = 0.5*(A[2]*B[2]+A[1]*B[1]+A[0]*B[0]); 
  tmp[1] = 0.5*(A[0]*B[1]+B[0]*A[1]); 
  tmp[2] = 0.5*(A[0]*B[2]+B[0]*A[2]); 
...
{ 
  ...
  tmp[1] = 0.1*(4.47213595499958*A[1]*B[4]+4.47213595499958*B[1]*A[4]+5.0*A[2]*B[3]+5.0*B[2]*A[3]+5.0*A[0]*B[1]+5.0*B[0]*A[1]); 
  tmp[2] = 0.1*(4.47213595499958*A[2]*B[5]+4.47213595499958*B[2]*A[5]+5.0*A[1]*B[3]+5.0*B[1]*A[3]+5.0*A[0]*B[2]+5.0*B[0]*A[2]); 
  tmp[3] = 0.1*(4.47213595499958*A[3]*B[5]+4.47213595499958*B[3]*A[5]+4.47213595499958*A[3]*B[4]+4.47213595499958*B[3]*A[4]+5.0*A[0]*B[3]+5.0*B[0]*A[3]+5.0*A[1]*B[2]+5.0*B[1]*A[2]); 
  tmp[4] = 0.01428571428571429*((22.3606797749979*A[4]+35.0*A[0])*B[4]+35.0*B[0]*A[4]+31.30495168499706*A[3]*B[3]+31.30495168499706*A[1]*B[1]); 
  tmp[5] = 0.01428571428571429*((22.3606797749979*A[5]+35.0*A[0])*B[5]+35.0*B[0]*A[5]+31.30495168499706*A[3]*B[3]+31.30495168499706*A[2]*B[2]); 
