...
{ 
  ...
  double tmp[15]; 
  tmp[0] = 0.7071067811865476*A[2]*B[11]+0.7071067811865476*A[1]*B[1]+0.7071067811865476*A[0]*B[0]; 
  tmp[1] = 0.6324555320336761*A[1]*B[11]+0.6324555320336761*B[1]*A[2]+0.7071067811865476*A[0]*B[1]+0.7071067811865476*B[0]*A[1]; 
  ...
  tmp[5] = 0.6324555320336761*A[2]*B[5]+0.7071067811865476*A[0]*B[5]+0.7071067811865476*A[1]*B[2]; 
  tmp[6] = 0.6324555320336761*A[2]*B[6]+0.7071067811865476*A[0]*B[6]+0.7071067811865476*A[1]*B[3]; 
  tmp[7] = 0.7071067811865475*A[0]*B[7]; 
  tmp[8] = 0.6324555320336761*A[2]*B[8]+0.7071067811865476*A[0]*B[8]+0.7071067811865476*A[1]*B[4]; 
  tmp[9] = 0.7071067811865475*A[0]*B[9]; 
  tmp[10] = 0.7071067811865475*A[0]*B[10]; 
  tmp[11] = 0.4517539514526258*A[2]*B[11]+0.7071067811865476*A[0]*B[11]+0.7071067811865476*B[0]*A[2]+0.632455532033676*A[1]*B[1]; 
