...
{ 
  ...
  data->AEM_S(1,0) = 0.7071067811865475*As[0]; 
  data->AEM_S(1,3) = 0.7071067811865475*As[1]; 
  data->AEM_S(1,4) = 0.7071067811865475*As[2]; 
  data->AEM_S(1,5) = 0.6324555320336759*As[1]; 
  data->AEM_S(2,4) = 0.7071067811865475*As[2]; 
...
{ 
  ...
  data->AEM_S(0,11) = 0.7071067811865475*As[1]; 
  data->AEM_S(1,2) = 0.7071067811865475*As[1]; 
  data->AEM_S(1,3) = 0.6324555320336759*As[2]+0.7071067811865475*As[0]; 
  data->AEM_S(1,4) = 0.7071067811865475*As[2]; 
  data->AEM_S(1,5) = 0.6210590034081186*As[3]+0.6324555320336759*As[1]; 
  data->AEM_S(2,2) = 0.7071067811865475*As[2]; 
  data->AEM_S(2,3) = 0.6210590034081187*As[3]+0.632455532033676*As[1]; 
  data->AEM_S(2,8) = 0.7071067811865475*As[3]; 
  data->AEM_S(2,9) = 0.6210590034081186*As[2]; 
  data->AEM_S(3,6) = 0.7071067811865474*As[3]; 
  data->AEM_S(3,7) = 0.6210590034081187*As[2]; 
