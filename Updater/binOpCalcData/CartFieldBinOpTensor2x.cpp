...
{ 
  ...
  AEM(1,7) = 0.447213595499958*As[8]+0.5000000000000001*As[5]; 
  AEM(1,8) = 0.447213595499958*As[7]; 
  AEM(2,0) = 0.5*As[2]; 
  AEM(2,1) = 0.5*As[3]; 
  ...
  AEM(2,6) = 0.447213595499958*As[8]+0.5000000000000001*As[4]; 
  AEM(2,7) = 0.447213595499958*As[3]; 
  AEM(2,8) = 0.447213595499958*As[6]; 
  AEM(3,0) = 0.5*As[3]; 
  AEM(3,1) = 0.447213595499958*As[6]+0.5*As[2]; 
  AEM(3,2) = 0.447213595499958*As[7]+0.5*As[1]; 
  AEM(3,3) = 0.4*As[8]+0.4472135954999579*As[5]+0.4472135954999579*As[4]+0.5*As[0]; 
  AEM(3,4) = 0.4472135954999579*As[3]; 
  AEM(3,5) = 0.4472135954999579*As[3]; 
  AEM(3,6) = 0.4*As[7]+0.447213595499958*As[1]; 
  AEM(3,7) = 0.4*As[6]+0.447213595499958*As[2]; 
  AEM(3,8) = 0.4*As[3]; 
  AEM(4,0) = 0.5*As[4]; 
  ...
  AEM(4,8) = 0.31943828249997*As[8]+0.5*As[5]; 
  AEM(5,0) = 0.5*As[5]; 
  ...
  AEM(5,8) = 0.31943828249997*As[8]+0.5*As[4]; 
  AEM(6,0) = 0.5*As[6]; 
  AEM(6,1) = 0.447213595499958*As[3]; 
  AEM(6,2) = 0.447213595499958*As[8]+0.5000000000000001*As[4]; 
  AEM(6,3) = 0.4*As[7]+0.447213595499958*As[1]; 
  AEM(6,4) = 0.31943828249997*As[6]+0.5000000000000001*As[2]; 
  AEM(6,5) = 0.4472135954999579*As[6]; 
  AEM(6,6) = 0.2857142857142857*As[8]+0.4472135954999579*As[5]+0.31943828249997*As[4]+0.5*As[0]; 
  AEM(6,7) = 0.4*As[3]; 
  AEM(6,8) = 0.2857142857142857*As[6]+0.447213595499958*As[2]; 
  AEM(7,0) = 0.5*As[7]; 
  AEM(7,1) = 0.447213595499958*As[8]+0.5000000000000001*As[5]; 
  AEM(7,2) = 0.447213595499958*As[3]; 
  AEM(7,3) = 0.4*As[6]+0.447213595499958*As[2]; 
  AEM(7,4) = 0.4472135954999579*As[7]; 
  AEM(7,5) = 0.31943828249997*As[7]+0.5000000000000001*As[1]; 
  AEM(7,6) = 0.4*As[3]; 
  AEM(7,7) = 0.2857142857142857*As[8]+0.31943828249997*As[5]+0.4472135954999579*As[4]+0.5*As[0]; 
  AEM(7,8) = 0.2857142857142857*As[7]+0.447213595499958*As[1]; 
  AEM(8,0) = 0.5*As[8]; 
  AEM(8,1) = 0.447213595499958*As[7]; 
  AEM(8,2) = 0.447213595499958*As[6]; 
  AEM(8,3) = 0.4*As[3]; 
  AEM(8,4) = 0.31943828249997*As[8]+0.5*As[5]; 
  AEM(8,5) = 0.31943828249997*As[8]+0.5*As[4]; 
  AEM(8,6) = 0.2857142857142857*As[6]+0.447213595499958*As[2]; 
  AEM(8,7) = 0.2857142857142857*As[7]+0.447213595499958*As[1]; 
  AEM(8,8) = 0.2040816326530612*As[8]+0.31943828249997*As[5]+0.31943828249997*As[4]+0.5*As[0]; 
 
  for(unsigned short int vd=0; vd<Ncomp; vd++) 
  { 
    b0 = 9*vd; 
    // Fill BEV. 
    BEV << Bs[b0],Bs[b0+1],Bs[b0+2],Bs[b0+3],Bs[b0+4],Bs[b0+5],Bs[b0+6],Bs[b0+7],Bs[b0+8]; 
 
    // Solve the system of equations. 
    u = AEM.colPivHouseholderQr().solve(BEV); 
 
    // Copy data from Eigen vector. 
    Eigen::Map<VectorXd>(out+vd*9,9,1) = u; 
  } 
} 
