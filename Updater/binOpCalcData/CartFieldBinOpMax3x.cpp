...
{ 
  ...
  { 
    ...
    tmp[0] = 0.3535533905932737*(A[a0+3]*B[b0+3]+A[a0+2]*B[b0+2]+A[a0+1]*B[b0+1]+A[a0]*B[b0]); 
    tmp[1] = 0.3535533905932737*(A[a0]*B[b0+1]+A[a0+1]*B[b0]); 
    tmp[2] = 0.3535533905932737*(A[a0]*B[b0+2]+A[a0+2]*B[b0]); 
    tmp[3] = 0.3535533905932737*(A[a0]*B[b0+3]+A[a0+3]*B[b0]); 
...
{ 
  ...
  { 
    ...
    tmp[1] = 0.07071067811865474*(4.47213595499958*A[a0+1]*B[b0+7]+5.0*A[a0+3]*B[b0+5]+5.0*A[a0+2]*B[b0+4]+5.0*A[a0+5]*B[b0+3]+5.0*A[a0+4]*B[b0+2]+(4.47213595499958*A[a0+7]+5.0*A[a0])*B[b0+1]+5.0*A[a0+1]*B[b0]); 
    tmp[2] = 0.07071067811865474*(4.47213595499958*A[a0+2]*B[b0+8]+5.0*A[a0+3]*B[b0+6]+5.0*A[a0+1]*B[b0+4]+5.0*A[a0+6]*B[b0+3]+(4.47213595499958*A[a0+8]+5.0*A[a0])*B[b0+2]+5.0*A[a0+4]*B[b0+1]+5.0*A[a0+2]*B[b0]); 
    tmp[3] = 0.07071067811865474*(4.47213595499958*A[a0+3]*B[b0+9]+5.0*A[a0+2]*B[b0+6]+5.0*A[a0+1]*B[b0+5]+(4.47213595499958*A[a0+9]+5.0*A[a0])*B[b0+3]+5.0*A[a0+6]*B[b0+2]+5.0*A[a0+5]*B[b0+1]+5.0*A[a0+3]*B[b0]); 
    tmp[4] = 0.07071067811865474*(4.47213595499958*A[a0+4]*B[b0+8]+4.47213595499958*A[a0+4]*B[b0+7]+5.0*A[a0+5]*B[b0+6]+5.0*A[a0+6]*B[b0+5]+(4.47213595499958*A[a0+8]+4.47213595499958*A[a0+7]+5.0*A[a0])*B[b0+4]+5.0*A[a0+1]*B[b0+2]+5.0*A[a0+2]*B[b0+1]+5.0*A[a0+4]*B[b0]); 
    tmp[5] = 0.07071067811865474*(4.47213595499958*A[a0+5]*B[b0+9]+4.47213595499958*A[a0+5]*B[b0+7]+5.0*A[a0+4]*B[b0+6]+(4.47213595499958*A[a0+9]+4.47213595499958*A[a0+7]+5.0*A[a0])*B[b0+5]+5.0*A[a0+6]*B[b0+4]+5.0*A[a0+1]*B[b0+3]+5.0*A[a0+3]*B[b0+1]+5.0*A[a0+5]*B[b0]); 
    tmp[6] = 0.07071067811865474*(4.47213595499958*A[a0+6]*B[b0+9]+4.47213595499958*A[a0+6]*B[b0+8]+(4.47213595499958*A[a0+9]+4.47213595499958*A[a0+8]+5.0*A[a0])*B[b0+6]+5.0*A[a0+4]*B[b0+5]+5.0*A[a0+5]*B[b0+4]+5.0*A[a0+2]*B[b0+3]+5.0*A[a0+3]*B[b0+2]+5.0*A[a0+6]*B[b0]); 
    tmp[7] = 0.01010152544552211*((22.3606797749979*A[a0+7]+35.0*A[a0])*B[b0+7]+31.30495168499706*A[a0+5]*B[b0+5]+31.30495168499706*A[a0+4]*B[b0+4]+31.30495168499706*A[a0+1]*B[b0+1]+35.0*A[a0+7]*B[b0]); 
    tmp[8] = 0.01010152544552211*((22.3606797749979*A[a0+8]+35.0*A[a0])*B[b0+8]+31.30495168499706*A[a0+6]*B[b0+6]+31.30495168499706*A[a0+4]*B[b0+4]+31.30495168499706*A[a0+2]*B[b0+2]+35.0*A[a0+8]*B[b0]); 
    tmp[9] = 0.01010152544552211*((22.3606797749979*A[a0+9]+35.0*A[a0])*B[b0+9]+31.30495168499706*A[a0+6]*B[b0+6]+31.30495168499706*A[a0+5]*B[b0+5]+31.30495168499706*A[a0+3]*B[b0+3]+35.0*A[a0+9]*B[b0]); 
...
{ 
  ...
  // If a corner value is below zero, use cell average A.
  bool avgA = false;
  if (0.7905694150420947*A[9]+0.7905694150420947*A[8]+0.7905694150420947*A[7]+1.060660171779821*A[6]+1.060660171779821*A[5]+1.060660171779821*A[4]-0.6123724356957944*A[3]-0.6123724356957944*A[2]-0.6123724356957944*A[1]+0.3535533905932737*A[0] < 0.0) { 
    avgA = true;
  }
  if (0.7905694150420947*A[9]+0.7905694150420947*A[8]+0.7905694150420947*A[7]-1.060660171779821*A[6]-1.060660171779821*A[5]+1.060660171779821*A[4]+0.6123724356957944*A[3]-0.6123724356957944*A[2]-0.6123724356957944*A[1]+0.3535533905932737*A[0] < 0.0) { 
    avgA = true;
