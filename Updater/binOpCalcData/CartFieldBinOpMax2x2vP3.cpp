...
{ 
  ...
  tmp[1] = 0.4391550328268399*A[4]*B[31]+0.5000000000000001*A[5]*B[20]+0.447213595499958*A[3]*B[19]+0.5000000000000001*A[7]*B[12]+0.4391550328268399*A[8]*B[11]+0.447213595499958*A[1]*B[11]+0.447213595499958*B[5]*A[6]+0.5*A[2]*B[5]+0.447213595499958*B[1]*A[4]+0.5*B[2]*A[3]+0.5*A[0]*B[1]+0.5*B[0]*A[1]; 
  tmp[2] = 0.4391550328268399*A[5]*B[32]+0.447213595499958*A[3]*B[20]+0.5000000000000001*A[4]*B[19]+0.4391550328268399*A[9]*B[12]+0.447213595499958*A[2]*B[12]+0.5000000000000001*A[6]*B[11]+0.447213595499958*B[5]*A[7]+0.5*A[1]*B[5]+0.447213595499958*B[2]*A[5]+0.5*B[1]*A[3]+0.5*A[0]*B[2]+0.5*B[0]*A[2]; 
  tmp[3] = 0.5*A[5]*B[22]+0.5*A[4]*B[21]+0.5*A[3]*B[15]+0.5*A[2]*B[7]+0.5*A[1]*B[6]+0.5*A[0]*B[3]; 
  tmp[4] = 0.5*A[5]*B[26]+0.5*A[4]*B[25]+0.5*A[3]*B[16]+0.5*A[2]*B[9]+0.5*A[1]*B[8]+0.5*A[0]*B[4]; 
  tmp[5] = 0.43915503282684*A[7]*B[32]+0.43915503282684*A[6]*B[31]+0.43915503282684*A[9]*B[20]+0.4*A[6]*B[20]+0.447213595499958*A[2]*B[20]+0.43915503282684*A[8]*B[19]+0.4*A[7]*B[19]+0.447213595499958*A[1]*B[19]+0.447213595499958*A[3]*B[12]+0.447213595499958*A[3]*B[11]+0.447213595499958*B[2]*A[7]+0.447213595499958*B[1]*A[6]+0.447213595499958*A[5]*B[5]+0.447213595499958*A[4]*B[5]+0.5*A[0]*B[5]+0.5*B[0]*A[3]+0.5*A[1]*B[2]+0.5*B[1]*A[2]; 
  tmp[6] = 0.5*A[7]*B[22]+0.43915503282684*A[8]*B[21]+0.447213595499958*A[1]*B[21]+0.447213595499958*A[6]*B[15]+0.5*A[2]*B[15]+0.5*A[3]*B[7]+0.447213595499958*A[4]*B[6]+0.5*A[0]*B[6]+0.5*A[1]*B[3]; 
  tmp[7] = 0.43915503282684*A[9]*B[22]+0.447213595499958*A[2]*B[22]+0.5*A[6]*B[21]+0.447213595499958*A[7]*B[15]+0.5*A[1]*B[15]+0.447213595499958*A[5]*B[7]+0.5*A[0]*B[7]+0.5*A[3]*B[6]+0.5*A[2]*B[3]; 
  tmp[8] = 0.5*A[7]*B[26]+0.43915503282684*A[8]*B[25]+0.447213595499958*A[1]*B[25]+0.447213595499958*A[6]*B[16]+0.5*A[2]*B[16]+0.5*A[3]*B[9]+0.447213595499958*A[4]*B[8]+0.5*A[0]*B[8]+0.5*A[1]*B[4]; 
  tmp[9] = 0.43915503282684*A[9]*B[26]+0.447213595499958*A[2]*B[26]+0.5*A[6]*B[25]+0.447213595499958*A[7]*B[16]+0.5*A[1]*B[16]+0.447213595499958*A[5]*B[9]+0.5*A[0]*B[9]+0.5*A[3]*B[8]+0.5*A[2]*B[4]; 
  tmp[10] = 0.5*A[2]*B[18]+0.5*A[1]*B[17]+0.5*A[0]*B[10]; 
  tmp[11] = 0.298142396999972*A[8]*B[31]+0.4391550328268399*A[1]*B[31]+0.447213595499958*A[7]*B[20]+0.31943828249997*A[6]*B[19]+0.5000000000000001*A[2]*B[19]+0.31943828249997*A[4]*B[11]+0.5*A[0]*B[11]+0.4391550328268399*B[1]*A[8]+0.5000000000000001*B[2]*A[6]+0.447213595499958*A[3]*B[5]+0.5*B[0]*A[4]+0.447213595499958*A[1]*B[1]; 
  tmp[12] = 0.298142396999972*A[9]*B[32]+0.4391550328268399*A[2]*B[32]+0.31943828249997*A[7]*B[20]+0.5000000000000001*A[1]*B[20]+0.447213595499958*A[6]*B[19]+0.31943828249997*A[5]*B[12]+0.5*A[0]*B[12]+0.4391550328268399*B[2]*A[9]+0.5000000000000001*B[1]*A[7]+0.447213595499958*A[3]*B[5]+0.5*B[0]*A[5]+0.447213595499958*A[2]*B[2]; 
  tmp[13] = 0.5*A[2]*B[24]+0.5*A[1]*B[23]+0.5*A[0]*B[13]; 
  tmp[14] = 0.5*A[2]*B[29]+0.5*A[1]*B[28]+0.5*A[0]*B[14]; 
  tmp[15] = 0.4472135954999579*A[3]*B[22]+0.4472135954999579*A[3]*B[21]+0.4472135954999579*A[5]*B[15]+0.4472135954999579*A[4]*B[15]+0.5*A[0]*B[15]+0.4472135954999579*A[7]*B[7]+0.5*A[1]*B[7]+0.4472135954999579*A[6]*B[6]+0.5*A[2]*B[6]+0.5*A[3]*B[3]; 
  tmp[16] = 0.4472135954999579*A[3]*B[26]+0.4472135954999579*A[3]*B[25]+0.4472135954999579*A[5]*B[16]+0.4472135954999579*A[4]*B[16]+0.5*A[0]*B[16]+0.4472135954999579*A[7]*B[9]+0.5*A[1]*B[9]+0.4472135954999579*A[6]*B[8]+0.5*A[2]*B[8]+0.5*A[3]*B[4]; 
  tmp[17] = 0.5*A[3]*B[18]+0.447213595499958*A[4]*B[17]+0.5*A[0]*B[17]+0.5*A[1]*B[10]; 
  tmp[18] = 0.447213595499958*A[5]*B[18]+0.5*A[0]*B[18]+0.5*A[3]*B[17]+0.5*A[2]*B[10]; 
  tmp[19] = 0.43915503282684*A[3]*B[31]+0.4*A[3]*B[20]+0.447213595499958*A[5]*B[19]+0.31943828249997*A[4]*B[19]+0.5*A[0]*B[19]+0.447213595499958*A[6]*B[12]+0.31943828249997*A[6]*B[11]+0.5000000000000001*A[2]*B[11]+0.43915503282684*B[5]*A[8]+0.4*B[5]*A[7]+0.5*B[0]*A[6]+0.447213595499958*A[1]*B[5]+0.5000000000000001*B[2]*A[4]+0.447213595499958*B[1]*A[3]; 
  tmp[20] = 0.43915503282684*A[3]*B[32]+0.31943828249997*A[5]*B[20]+0.447213595499958*A[4]*B[20]+0.5*A[0]*B[20]+0.4*A[3]*B[19]+0.31943828249997*A[7]*B[12]+0.5000000000000001*A[1]*B[12]+0.447213595499958*A[7]*B[11]+0.43915503282684*B[5]*A[9]+0.5*B[0]*A[7]+0.4*B[5]*A[6]+0.447213595499958*A[2]*B[5]+0.5000000000000001*B[1]*A[5]+0.447213595499958*B[2]*A[3]; 
  tmp[21] = 0.31943828249997*A[4]*B[21]+0.5*A[0]*B[21]+0.447213595499958*A[3]*B[15]+0.43915503282684*B[6]*A[8]+0.5*A[6]*B[7]+0.447213595499958*A[1]*B[6]+0.5000000000000001*B[3]*A[4]; 
  tmp[22] = 0.31943828249997*A[5]*B[22]+0.5*A[0]*B[22]+0.447213595499958*A[3]*B[15]+0.43915503282684*B[7]*A[9]+0.447213595499958*A[2]*B[7]+0.5*B[6]*A[7]+0.5000000000000001*B[3]*A[5]; 
  tmp[23] = 0.5*A[3]*B[24]+0.4472135954999579*A[4]*B[23]+0.5*A[0]*B[23]+0.5*A[1]*B[13]; 
  tmp[24] = 0.4472135954999579*A[5]*B[24]+0.5*A[0]*B[24]+0.5*A[3]*B[23]+0.5*A[2]*B[13]; 
  tmp[25] = 0.31943828249997*A[4]*B[25]+0.5*A[0]*B[25]+0.447213595499958*A[3]*B[16]+0.5*A[6]*B[9]+0.43915503282684*A[8]*B[8]+0.447213595499958*A[1]*B[8]+0.5000000000000001*A[4]*B[4]; 
  tmp[26] = 0.31943828249997*A[5]*B[26]+0.5*A[0]*B[26]+0.447213595499958*A[3]*B[16]+0.43915503282684*A[9]*B[9]+0.447213595499958*A[2]*B[9]+0.5*A[7]*B[8]+0.5000000000000001*B[4]*A[5]; 
  tmp[27] = 0.5*A[0]*B[27]; 
  tmp[28] = 0.5*A[3]*B[29]+0.4472135954999579*A[4]*B[28]+0.5*A[0]*B[28]+0.5*A[1]*B[14]; 
  tmp[29] = 0.4472135954999579*A[5]*B[29]+0.5*A[0]*B[29]+0.5*A[3]*B[28]+0.5*A[2]*B[14]; 
  tmp[30] = 0.5*A[0]*B[30]; 
  tmp[31] = 0.298142396999972*A[4]*B[31]+0.5*A[0]*B[31]+0.43915503282684*A[3]*B[19]+0.298142396999972*A[8]*B[11]+0.4391550328268399*A[1]*B[11]+0.5*B[0]*A[8]+0.43915503282684*B[5]*A[6]+0.4391550328268399*B[1]*A[4]; 
  tmp[32] = 0.298142396999972*A[5]*B[32]+0.5*A[0]*B[32]+0.43915503282684*A[3]*B[20]+0.298142396999972*A[9]*B[12]+0.4391550328268399*A[2]*B[12]+0.5*B[0]*A[9]+0.43915503282684*B[5]*A[7]+0.4391550328268399*B[2]*A[5]; 
  tmp[33] = 0.5*A[0]*B[33]; 
  tmp[34] = 0.5*A[0]*B[34]; 
...
{ 
  ...
  data->AEM_D(0,15) = 0.447213595499958*As[6]+0.5*As[2]; 
  data->AEM_D(0,20) = 0.5*As[2]; 
  data->AEM_D(0,21) = 0.5*As[3]; 
  data->AEM_D(0,22) = 0.4472135954999579*As[5]+0.5*As[0]; 
  data->AEM_D(0,25) = 0.447213595499958*As[7]+0.5*As[1]; 
  data->AEM_D(0,33) = 0.5*As[0]; 
  data->AEM_D(1,1) = 0.5*As[1]; 
  data->AEM_D(1,2) = 0.5*As[2]; 
  data->AEM_D(1,9) = 0.5*As[0]; 
  data->AEM_D(1,13) = 0.5*As[1]; 
  data->AEM_D(1,14) = 0.5*As[2]; 
  data->AEM_D(1,15) = 0.5*As[3]; 
  data->AEM_D(1,16) = 0.447213595499958*As[6]+0.5*As[2]; 
  data->AEM_D(1,17) = 0.447213595499958*As[7]+0.5*As[1]; 
  data->AEM_D(1,20) = 0.4472135954999579*As[5]+0.4472135954999579*As[4]+0.5*As[0]; 
  data->AEM_D(1,28) = 0.5*As[1]; 
  data->AEM_D(1,31) = 0.4472135954999579*As[4]+0.5*As[0]; 
  data->AEM_D(1,32) = 0.5*As[3]; 
  data->AEM_D(2,3) = 0.5*As[2]; 
  data->AEM_D(2,6) = 0.5*As[3]; 
  data->AEM_D(2,7) = 0.4472135954999579*As[5]+0.5*As[0]; 
  data->AEM_D(2,14) = 0.5*As[1]; 
  data->AEM_D(2,18) = 0.4472135954999579*As[4]+0.5*As[0]; 
  data->AEM_D(2,19) = 0.5*As[3]; 
  data->AEM_D(2,24) = 0.5*As[2]; 
  data->AEM_D(2,28) = 0.5*As[3]; 
  data->AEM_D(2,29) = 0.4472135954999579*As[5]+0.5*As[0]; 
  data->AEM_D(3,5) = 0.5*As[4]; 
  data->AEM_D(3,6) = 0.4391550328268398*As[8]+0.4472135954999579*As[1]; 
  data->AEM_D(3,7) = 0.5000000000000001*As[6]; 
  data->AEM_D(3,10) = 0.4472135954999579*As[3]; 
  data->AEM_D(3,15) = 0.5*As[5]; 
  data->AEM_D(3,16) = 0.5000000000000001*As[7]; 
  data->AEM_D(3,17) = 0.4391550328268398*As[9]+0.4472135954999579*As[2]; 
  data->AEM_D(3,20) = 0.4472135954999579*As[3]; 
  data->AEM_D(4,13) = 0.5*As[3]; 
  data->AEM_D(4,16) = 0.447213595499958*As[6]+0.5*As[2]; 
  data->AEM_D(4,17) = 0.447213595499958*As[7]+0.5*As[1]; 
  data->AEM_D(4,24) = 0.5*As[3]; 
  data->AEM_D(4,28) = 0.447213595499958*As[6]+0.5*As[2]; 
  data->AEM_D(4,29) = 0.447213595499958*As[7]+0.5*As[1]; 
  data->AEM_D(5,15) = 0.5*As[6]; 
  data->AEM_D(5,16) = 0.447213595499958*As[3]; 
  data->AEM_D(5,17) = 0.5000000000000001*As[4]; 
  data->AEM_D(5,20) = 0.4391550328268399*As[8]+0.4*As[7]+0.447213595499958*As[1]; 
  data->AEM_D(5,25) = 0.5*As[7]; 
  data->AEM_D(5,26) = 0.5000000000000001*As[5]; 
  data->AEM_D(5,27) = 0.447213595499958*As[3]; 
  data->AEM_D(5,30) = 0.4391550328268399*As[9]+0.4*As[6]+0.447213595499958*As[2]; 
  data->AEM_D(6,3) = 0.5000000000000001*As[4]; 
  data->AEM_D(6,6) = 0.4391550328268399*As[8]+0.447213595499958*As[1]; 
  data->AEM_D(6,7) = 0.5*As[6]; 
  data->AEM_D(6,13) = 0.5000000000000001*As[5]; 
  data->AEM_D(6,16) = 0.5*As[7]; 
  data->AEM_D(6,17) = 0.4391550328268399*As[9]+0.447213595499958*As[2]; 
  data->AEM_D(7,9) = 0.5000000000000001*As[4]; 
  data->AEM_D(7,13) = 0.4391550328268399*As[8]+0.447213595499958*As[1]; 
  data->AEM_D(7,14) = 0.5*As[6]; 
  data->AEM_D(7,19) = 0.5000000000000001*As[5]; 
  data->AEM_D(7,23) = 0.5*As[7]; 
  data->AEM_D(7,24) = 0.4391550328268399*As[9]+0.447213595499958*As[2]; 
  data->AEM_D(8,30) = 0.5*As[8]; 
  data->AEM_D(8,31) = 0.4391550328268398*As[4]; 
  data->AEM_D(9,0) = 0.4391550328268399*As[6]; 
  data->AEM_D(9,5) = 0.5*As[9]; 
  data->AEM_D(9,7) = 0.4391550328268398*As[5]; 
  data->AEM_D(9,10) = 0.4391550328268399*As[7]; 
