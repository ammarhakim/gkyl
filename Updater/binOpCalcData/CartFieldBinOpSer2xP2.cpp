...
{ 
  ...
  { 
    ...
    tmp[2] = 0.03333333333333333*(13.41640786499874*A[a0+3]*B[b0+7]+15.0*A[a0+4]*B[b0+6]+13.41640786499874*A[a0+2]*B[b0+5]+15.0*A[a0+6]*B[b0+4]+(13.41640786499874*A[a0+7]+15.0*A[a0+1])*B[b0+3]+(13.41640786499874*A[a0+5]+15.0*A[a0])*B[b0+2]+15.0*(A[a0+3]*B[b0+1]+A[a0+2]*B[b0])); 
    tmp[3] = 0.03333333333333333*((12.0*A[a0+6]+13.41640786499874*A[a0+2])*B[b0+7]+(12.0*A[a0+7]+13.41640786499874*A[a0+1])*B[b0+6]+13.41640786499874*A[a0+3]*(B[b0+5]+B[b0+4])+(13.41640786499874*(A[a0+5]+A[a0+4])+15.0*A[a0])*B[b0+3]+(13.41640786499874*A[a0+7]+15.0*A[a0+1])*B[b0+2]+(13.41640786499874*A[a0+6]+15.0*A[a0+2])*B[b0+1]+15.0*A[a0+3]*B[b0]); 
    ...
    tmp[5] = 0.004761904761904762*((67.0820393249937*A[a0+7]+105.0*A[a0+1])*B[b0+7]+93.91485505499116*A[a0+6]*B[b0+6]+(67.0820393249937*A[a0+5]+105.0*A[a0])*B[b0+5]+93.91485505499116*(A[a0+3]*B[b0+3]+A[a0+2]*B[b0+2])+105.0*A[a0+7]*B[b0+1]+105.0*A[a0+5]*B[b0]); 
...
{ 
  ...
  bool avgA = false;
  if ((-1.936491673103709*(A[7]+A[6]))+1.118033988749895*(A[5]+A[4])+1.5*A[3]-0.8660254037844386*(A[2]+A[1])+0.5*A[0] < 0.0) { 
    avgA = true;
  }
  if (1.936491673103709*A[7]-1.936491673103709*A[6]+1.118033988749895*(A[5]+A[4])-1.5*A[3]-0.8660254037844386*A[2]+0.8660254037844386*A[1]+0.5*A[0] < 0.0) { 
    avgA = true;
  }
  if ((-1.936491673103709*A[7])+1.936491673103709*A[6]+1.118033988749895*(A[5]+A[4])-1.5*A[3]+0.8660254037844386*A[2]-0.8660254037844386*A[1]+0.5*A[0] < 0.0) { 
    avgA = true;
