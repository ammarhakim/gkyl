...
{ 
  ...
  prodCX[4] = 0.6210590034081187*m0[3]*fOther[11]*vrelCX+0.632455532033676*m0[1]*fOther[11]*vrelCX+0.6324555320336759*m0[2]*fOther[4]*vrelCX+0.7071067811865475*m0[0]*fOther[4]*vrelCX+0.7071067811865475*m0[1]*fOther[2]*vrelCX; 
  prodCX[5] = 0.6210590034081187*m0[3]*fOther[13]*vrelCX+0.632455532033676*m0[1]*fOther[13]*vrelCX+0.6324555320336759*m0[2]*fOther[5]*vrelCX+0.7071067811865475*m0[0]*fOther[5]*vrelCX+0.7071067811865475*m0[1]*fOther[3]*vrelCX; 
  prodCX[6] = 0.7071067811865475*m0[1]*fOther[10]*vrelCX+0.7071067811865475*m0[0]*fOther[6]*vrelCX; 
  ...
  prodCX[10] = 0.6324555320336759*m0[2]*fOther[10]*vrelCX+0.7071067811865475*m0[0]*fOther[10]*vrelCX+0.7071067811865475*m0[1]*fOther[6]*vrelCX; 
  prodCX[11] = 0.4517539514526256*m0[2]*fOther[11]*vrelCX+0.7071067811865475*m0[0]*fOther[11]*vrelCX+0.6210590034081187*m0[3]*fOther[4]*vrelCX+0.632455532033676*m0[1]*fOther[4]*vrelCX+0.7071067811865475*fOther[2]*m0[2]*vrelCX; 
  ...
  prodCX[13] = 0.4517539514526256*m0[2]*fOther[13]*vrelCX+0.7071067811865475*m0[0]*fOther[13]*vrelCX+0.6210590034081187*m0[3]*fOther[5]*vrelCX+0.632455532033676*m0[1]*fOther[5]*vrelCX+0.7071067811865475*m0[2]*fOther[3]*vrelCX; 
  ...
  prodCX[16] = 0.7071067811865475*m0[0]*fOther[16]*vrelCX; 
  ...
  prodCX[19] = 0.7071067811865475*m0[0]*fOther[19]*vrelCX; 
