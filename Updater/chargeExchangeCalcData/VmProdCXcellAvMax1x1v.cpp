...
{ 
  ...
  prodCX[3] = 0.6324555320336759*m0[2]*fOther[3]*vrelCX+0.7071067811865475*m0[0]*fOther[3]*vrelCX+0.7071067811865475*m0[1]*fOther[2]*vrelCX; 
  ...
  prodCX[5] = 0.7071067811865475*m0[0]*fOther[5]*vrelCX; 
...
{ 
  ...
  prodCX[3] = 0.6210590034081187*m0[3]*fOther[6]*vrelCX+0.632455532033676*m0[1]*fOther[6]*vrelCX+0.6324555320336759*m0[2]*fOther[3]*vrelCX+0.7071067811865475*m0[0]*fOther[3]*vrelCX+0.7071067811865475*m0[1]*fOther[2]*vrelCX; 
  ...
  prodCX[6] = 0.4517539514526256*m0[2]*fOther[6]*vrelCX+0.7071067811865475*m0[0]*fOther[6]*vrelCX+0.6210590034081187*fOther[3]*m0[3]*vrelCX+0.632455532033676*m0[1]*fOther[3]*vrelCX+0.7071067811865475*fOther[2]*m0[2]*vrelCX; 
