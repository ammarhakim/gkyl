...
{ 
  ...
  const double *_in = &volIn[mbasis*m]; 
   ...
   _out[2] = 0.7071067811865475*_in[5]; 
  } 
} 
...
{ 
  ...
  const double *_in = &volIn[mbasis*m]; 
   ...
   _out[2] = 0.7071067811865475*_in[4]; 
  } 
} 
...
{ 
  ...
  const double *_in = &volIn[mbasis*m]; 
   ...
   _out[3] = 0.7071067811865475*_in[9]; 
  } 
} 
...
{ 
  ...
  const double *_in = &volIn[mbasis*m]; 
   ...
   _out[3] = 0.7071067811865475*_in[8]; 
  } 
} 
...
{ 
  ...
  const double *_in = &volIn[mbasis*m]; 
   ...
   _out[1] = 1.870828693386971*_in[11]+1.58113883008419*_in[6]+1.224744871391589*_in[3]+0.7071067811865475*_in[2]; 
   ...
   _out[4] = 0.7071067811865475*_in[14]; 
  } 
} 
...
{ 
  ...
  const double *_in = &volIn[mbasis*m]; 
   ...
   _out[1] = 1.870828693386971*_in[12]+1.58113883008419*_in[7]+1.224744871391589*_in[3]+0.7071067811865475*_in[1]; 
   ...
   _out[4] = 0.7071067811865475*_in[13]; 
  } 
} 
