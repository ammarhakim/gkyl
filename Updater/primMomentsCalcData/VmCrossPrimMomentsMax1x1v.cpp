...
void VmCrossPrimMoments1x1vMax_P3(binOpData_t *data, const double betaGreenep1, const double mSelf, const double nuSelf, const double *m0Self, const double *m1Self, const double *m2Self, const double *uSelf, const double *vtSqSelf, const double *cMSelf, const double *cESelf, const double mOther, const double nuOther, const double *m0Other, const double *m1Other, const double *m2Other, const double *uOther, const double *vtSqOther, const double *cMOther, const double *cEOther, double *uCrossSelf, double *vtSqCrossSelf, double *uCrossOther, double *vtSqCrossOther) 
{ 
  // betaGreenep1:       free parameter beta+1. This has to be >0. 
  // nu, m:              collisionality and mass. 
  // m0,m1,m2:           moments of the distribution function. 
  ...
  // ... Block from correction to (self) 2nd moment of collision operator ... // 
  data->AEM_S(12,4) = 0.5*cMSelf[3]*uSelf[3]*mnuSelf+0.5*cMSelf[2]*uSelf[2]*mnuSelf+0.5*cMSelf[1]*uSelf[1]*mnuSelf+0.5*cMSelf[0]*uSelf[0]*mnuSelf+0.7071067811865475*m0rSelf[0]*mnuSelf-0.7071067811865475*cESelf[0]*mnuSelf; 
  data->AEM_S(12,5) = 0.4391550328268398*cMSelf[2]*uSelf[3]*mnuSelf+0.4391550328268398*uSelf[2]*cMSelf[3]*mnuSelf+0.4472135954999579*cMSelf[1]*uSelf[2]*mnuSelf+0.4472135954999579*uSelf[1]*cMSelf[2]*mnuSelf+0.5*cMSelf[0]*uSelf[1]*mnuSelf+0.7071067811865475*m0rSelf[1]*mnuSelf+0.5*uSelf[0]*cMSelf[1]*mnuSelf-0.7071067811865475*cESelf[1]*mnuSelf; 
  data->AEM_S(12,6) = 0.2981423969999719*cMSelf[3]*uSelf[3]*mnuSelf+0.4391550328268398*cMSelf[1]*uSelf[3]*mnuSelf+0.4391550328268398*uSelf[1]*cMSelf[3]*mnuSelf+0.31943828249997*cMSelf[2]*uSelf[2]*mnuSelf+0.5*cMSelf[0]*uSelf[2]*mnuSelf+0.7071067811865475*m0rSelf[2]*mnuSelf+0.5*uSelf[0]*cMSelf[2]*mnuSelf-0.7071067811865475*cESelf[2]*mnuSelf+0.4472135954999579*cMSelf[1]*uSelf[1]*mnuSelf; 
  data->AEM_S(12,7) = 0.2981423969999719*cMSelf[2]*uSelf[3]*mnuSelf+0.5*cMSelf[0]*uSelf[3]*mnuSelf+0.7071067811865475*m0rSelf[3]*mnuSelf+0.2981423969999719*uSelf[2]*cMSelf[3]*mnuSelf+0.5*uSelf[0]*cMSelf[3]*mnuSelf-0.7071067811865475*cESelf[3]*mnuSelf+0.4391550328268398*cMSelf[1]*uSelf[2]*mnuSelf+0.4391550328268398*uSelf[1]*cMSelf[2]*mnuSelf; 
  ...
  data->AEM_S(14,6) = 0.6904761904761905*cMSelf[3]*uSelf[3]*mnuSelf+0.2805658588748473*cMSelf[1]*uSelf[3]*mnuSelf+0.2805658588748473*uSelf[1]*cMSelf[3]*mnuSelf+0.7040816326530612*cMSelf[2]*uSelf[2]*mnuSelf+0.31943828249997*cMSelf[0]*uSelf[2]*mnuSelf+0.4517539514526256*m0rSelf[2]*mnuSelf+0.31943828249997*uSelf[0]*cMSelf[2]*mnuSelf-0.4517539514526256*cESelf[2]*mnuSelf+0.7857142857142857*cMSelf[1]*uSelf[1]*mnuSelf+0.5*cMSelf[0]*uSelf[0]*mnuSelf+0.7071067811865475*m0rSelf[0]*mnuSelf-0.7071067811865475*cESelf[0]*mnuSelf; 
  data->AEM_S(14,7) = 0.5634920634920635*cMSelf[2]*uSelf[3]*mnuSelf+0.2981423969999719*cMSelf[0]*uSelf[3]*mnuSelf+0.421637021355784*m0rSelf[3]*mnuSelf+0.5634920634920635*uSelf[2]*cMSelf[3]*mnuSelf+0.2981423969999719*uSelf[0]*cMSelf[3]*mnuSelf-0.421637021355784*cESelf[3]*mnuSelf+0.6546536707079771*cMSelf[1]*uSelf[2]*mnuSelf+0.6546536707079771*uSelf[1]*cMSelf[2]*mnuSelf+0.4391550328268398*cMSelf[0]*uSelf[1]*mnuSelf+0.6210590034081186*m0rSelf[1]*mnuSelf+0.4391550328268398*uSelf[0]*cMSelf[1]*mnuSelf-0.6210590034081186*cESelf[1]*mnuSelf; 
  data->AEM_S(15,4) = 0.2981423969999719*cMSelf[2]*uSelf[3]*mnuSelf+0.5*cMSelf[0]*uSelf[3]*mnuSelf+0.7071067811865475*m0rSelf[3]*mnuSelf+0.2981423969999719*uSelf[2]*cMSelf[3]*mnuSelf+0.5*uSelf[0]*cMSelf[3]*mnuSelf-0.7071067811865475*cESelf[3]*mnuSelf+0.4391550328268398*cMSelf[1]*uSelf[2]*mnuSelf+0.4391550328268398*uSelf[1]*cMSelf[2]*mnuSelf; 
  data->AEM_S(15,5) = 0.2618614682831908*cMSelf[3]*uSelf[3]*mnuSelf+0.3857142857142857*cMSelf[1]*uSelf[3]*mnuSelf+0.3857142857142857*uSelf[1]*cMSelf[3]*mnuSelf+0.2805658588748473*cMSelf[2]*uSelf[2]*mnuSelf+0.4391550328268398*cMSelf[0]*uSelf[2]*mnuSelf+0.6210590034081186*m0rSelf[2]*mnuSelf+0.4391550328268398*uSelf[0]*cMSelf[2]*mnuSelf-0.6210590034081186*cESelf[2]*mnuSelf+0.3927922024247862*cMSelf[1]*uSelf[1]*mnuSelf; 
  data->AEM_S(15,6) = 0.5634920634920635*cMSelf[2]*uSelf[3]*mnuSelf+0.2981423969999719*cMSelf[0]*uSelf[3]*mnuSelf+0.421637021355784*m0rSelf[3]*mnuSelf+0.5634920634920635*uSelf[2]*cMSelf[3]*mnuSelf+0.2981423969999719*uSelf[0]*cMSelf[3]*mnuSelf-0.421637021355784*cESelf[3]*mnuSelf+0.6546536707079771*cMSelf[1]*uSelf[2]*mnuSelf+0.6546536707079771*uSelf[1]*cMSelf[2]*mnuSelf+0.4391550328268398*cMSelf[0]*uSelf[1]*mnuSelf+0.6210590034081186*m0rSelf[1]*mnuSelf+0.4391550328268398*uSelf[0]*cMSelf[1]*mnuSelf-0.6210590034081186*cESelf[1]*mnuSelf; 
  data->AEM_S(15,7) = 0.6777777777777778*cMSelf[3]*uSelf[3]*mnuSelf+0.2618614682831908*cMSelf[1]*uSelf[3]*mnuSelf+0.2618614682831908*uSelf[1]*cMSelf[3]*mnuSelf+0.6904761904761905*cMSelf[2]*uSelf[2]*mnuSelf+0.2981423969999719*cMSelf[0]*uSelf[2]*mnuSelf+0.421637021355784*m0rSelf[2]*mnuSelf+0.2981423969999719*uSelf[0]*cMSelf[2]*mnuSelf-0.421637021355784*cESelf[2]*mnuSelf+0.7666666666666667*cMSelf[1]*uSelf[1]*mnuSelf+0.5*cMSelf[0]*uSelf[0]*mnuSelf+0.7071067811865475*m0rSelf[0]*mnuSelf-0.7071067811865475*cESelf[0]*mnuSelf; 
 
  // ... Block from correction to (other) 2nd moment of collision operator ... // 
  data->AEM_S(12,12) = (-0.5*cMOther[3]*uOther[3]*mnuOther)-0.5*cMOther[2]*uOther[2]*mnuOther-0.5*cMOther[1]*uOther[1]*mnuOther-0.5*cMOther[0]*uOther[0]*mnuOther-0.7071067811865475*m0rOther[0]*mnuOther+0.7071067811865475*cEOther[0]*mnuOther; 
  data->AEM_S(12,13) = (-0.4391550328268398*cMOther[2]*uOther[3]*mnuOther)-0.4391550328268398*uOther[2]*cMOther[3]*mnuOther-0.4472135954999579*cMOther[1]*uOther[2]*mnuOther-0.4472135954999579*uOther[1]*cMOther[2]*mnuOther-0.5*cMOther[0]*uOther[1]*mnuOther-0.7071067811865475*m0rOther[1]*mnuOther-0.5*uOther[0]*cMOther[1]*mnuOther+0.7071067811865475*cEOther[1]*mnuOther; 
  data->AEM_S(12,14) = (-0.2981423969999719*cMOther[3]*uOther[3]*mnuOther)-0.4391550328268398*cMOther[1]*uOther[3]*mnuOther-0.4391550328268398*uOther[1]*cMOther[3]*mnuOther-0.31943828249997*cMOther[2]*uOther[2]*mnuOther-0.5*cMOther[0]*uOther[2]*mnuOther-0.7071067811865475*m0rOther[2]*mnuOther-0.5*uOther[0]*cMOther[2]*mnuOther+0.7071067811865475*cEOther[2]*mnuOther-0.4472135954999579*cMOther[1]*uOther[1]*mnuOther; 
  data->AEM_S(12,15) = (-0.2981423969999719*cMOther[2]*uOther[3]*mnuOther)-0.5*cMOther[0]*uOther[3]*mnuOther-0.7071067811865475*m0rOther[3]*mnuOther-0.2981423969999719*uOther[2]*cMOther[3]*mnuOther-0.5*uOther[0]*cMOther[3]*mnuOther+0.7071067811865475*cEOther[3]*mnuOther-0.4391550328268398*cMOther[1]*uOther[2]*mnuOther-0.4391550328268398*uOther[1]*cMOther[2]*mnuOther; 
  data->AEM_S(13,12) = (-0.4391550328268398*cMOther[2]*uOther[3]*mnuOther)-0.4391550328268398*uOther[2]*cMOther[3]*mnuOther-0.4472135954999579*cMOther[1]*uOther[2]*mnuOther-0.4472135954999579*uOther[1]*cMOther[2]*mnuOther-0.5*cMOther[0]*uOther[1]*mnuOther-0.7071067811865475*m0rOther[1]*mnuOther-0.5*uOther[0]*cMOther[1]*mnuOther+0.7071067811865475*cEOther[1]*mnuOther; 
  data->AEM_S(13,13) = (-0.7666666666666667*cMOther[3]*uOther[3]*mnuOther)-0.3927922024247862*cMOther[1]*uOther[3]*mnuOther-0.3927922024247862*uOther[1]*cMOther[3]*mnuOther-0.7857142857142857*cMOther[2]*uOther[2]*mnuOther-0.4472135954999579*cMOther[0]*uOther[2]*mnuOther-0.6324555320336759*m0rOther[2]*mnuOther-0.4472135954999579*uOther[0]*cMOther[2]*mnuOther+0.6324555320336759*cEOther[2]*mnuOther-0.9*cMOther[1]*uOther[1]*mnuOther-0.5*cMOther[0]*uOther[0]*mnuOther-0.7071067811865475*m0rOther[0]*mnuOther+0.7071067811865475*cEOther[0]*mnuOther; 
  data->AEM_S(13,14) = (-0.6546536707079771*cMOther[2]*uOther[3]*mnuOther)-0.4391550328268398*cMOther[0]*uOther[3]*mnuOther-0.6210590034081186*m0rOther[3]*mnuOther-0.6546536707079771*uOther[2]*cMOther[3]*mnuOther-0.4391550328268398*uOther[0]*cMOther[3]*mnuOther+0.6210590034081186*cEOther[3]*mnuOther-0.7857142857142857*cMOther[1]*uOther[2]*mnuOther-0.7857142857142857*uOther[1]*cMOther[2]*mnuOther-0.4472135954999579*cMOther[0]*uOther[1]*mnuOther-0.6324555320336759*m0rOther[1]*mnuOther-0.4472135954999579*uOther[0]*cMOther[1]*mnuOther+0.6324555320336759*cEOther[1]*mnuOther; 
  data->AEM_S(13,15) = (-0.2618614682831908*cMOther[3]*uOther[3]*mnuOther)-0.3857142857142857*cMOther[1]*uOther[3]*mnuOther-0.3857142857142857*uOther[1]*cMOther[3]*mnuOther-0.2805658588748473*cMOther[2]*uOther[2]*mnuOther-0.4391550328268398*cMOther[0]*uOther[2]*mnuOther-0.6210590034081186*m0rOther[2]*mnuOther-0.4391550328268398*uOther[0]*cMOther[2]*mnuOther+0.6210590034081186*cEOther[2]*mnuOther-0.3927922024247862*cMOther[1]*uOther[1]*mnuOther; 
  ...
  data->AEM_S(14,14) = (-0.6904761904761905*cMOther[3]*uOther[3]*mnuOther)-0.2805658588748473*cMOther[1]*uOther[3]*mnuOther-0.2805658588748473*uOther[1]*cMOther[3]*mnuOther-0.7040816326530612*cMOther[2]*uOther[2]*mnuOther-0.31943828249997*cMOther[0]*uOther[2]*mnuOther-0.4517539514526256*m0rOther[2]*mnuOther-0.31943828249997*uOther[0]*cMOther[2]*mnuOther+0.4517539514526256*cEOther[2]*mnuOther-0.7857142857142857*cMOther[1]*uOther[1]*mnuOther-0.5*cMOther[0]*uOther[0]*mnuOther-0.7071067811865475*m0rOther[0]*mnuOther+0.7071067811865475*cEOther[0]*mnuOther; 
  data->AEM_S(14,15) = (-0.5634920634920635*cMOther[2]*uOther[3]*mnuOther)-0.2981423969999719*cMOther[0]*uOther[3]*mnuOther-0.421637021355784*m0rOther[3]*mnuOther-0.5634920634920635*uOther[2]*cMOther[3]*mnuOther-0.2981423969999719*uOther[0]*cMOther[3]*mnuOther+0.421637021355784*cEOther[3]*mnuOther-0.6546536707079771*cMOther[1]*uOther[2]*mnuOther-0.6546536707079771*uOther[1]*cMOther[2]*mnuOther-0.4391550328268398*cMOther[0]*uOther[1]*mnuOther-0.6210590034081186*m0rOther[1]*mnuOther-0.4391550328268398*uOther[0]*cMOther[1]*mnuOther+0.6210590034081186*cEOther[1]*mnuOther; 
  data->AEM_S(15,12) = (-0.2981423969999719*cMOther[2]*uOther[3]*mnuOther)-0.5*cMOther[0]*uOther[3]*mnuOther-0.7071067811865475*m0rOther[3]*mnuOther-0.2981423969999719*uOther[2]*cMOther[3]*mnuOther-0.5*uOther[0]*cMOther[3]*mnuOther+0.7071067811865475*cEOther[3]*mnuOther-0.4391550328268398*cMOther[1]*uOther[2]*mnuOther-0.4391550328268398*uOther[1]*cMOther[2]*mnuOther; 
  ...
  data->AEM_S(15,14) = (-0.5634920634920635*cMOther[2]*uOther[3]*mnuOther)-0.2981423969999719*cMOther[0]*uOther[3]*mnuOther-0.421637021355784*m0rOther[3]*mnuOther-0.5634920634920635*uOther[2]*cMOther[3]*mnuOther-0.2981423969999719*uOther[0]*cMOther[3]*mnuOther+0.421637021355784*cEOther[3]*mnuOther-0.6546536707079771*cMOther[1]*uOther[2]*mnuOther-0.6546536707079771*uOther[1]*cMOther[2]*mnuOther-0.4391550328268398*cMOther[0]*uOther[1]*mnuOther-0.6210590034081186*m0rOther[1]*mnuOther-0.4391550328268398*uOther[0]*cMOther[1]*mnuOther+0.6210590034081186*cEOther[1]*mnuOther; 
  data->AEM_S(15,15) = (-0.6777777777777778*cMOther[3]*uOther[3]*mnuOther)-0.2618614682831908*cMOther[1]*uOther[3]*mnuOther-0.2618614682831908*uOther[1]*cMOther[3]*mnuOther-0.6904761904761905*cMOther[2]*uOther[2]*mnuOther-0.2981423969999719*cMOther[0]*uOther[2]*mnuOther-0.421637021355784*m0rOther[2]*mnuOther-0.2981423969999719*uOther[0]*cMOther[2]*mnuOther+0.421637021355784*cEOther[2]*mnuOther-0.7666666666666667*cMOther[1]*uOther[1]*mnuOther-0.5*cMOther[0]*uOther[0]*mnuOther-0.7071067811865475*m0rOther[0]*mnuOther+0.7071067811865475*cEOther[0]*mnuOther; 
