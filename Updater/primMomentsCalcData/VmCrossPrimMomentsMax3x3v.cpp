...
{ 
  ...
  { 
    ...
    uSMuOSq[0] += 0.3535533905932737*uSMuO[a0+3]*uSMuO[a0+3]+0.3535533905932737*uSMuO[a0+2]*uSMuO[a0+2]+0.3535533905932737*uSMuO[a0+1]*uSMuO[a0+1]+0.3535533905932737*uSMuO[a0]*uSMuO[a0]; 
    uSMuOSq[1] += 0.7071067811865475*uSMuO[a0]*uSMuO[a0+1]; 
    uSMuOSq[2] += 0.7071067811865475*uSMuO[a0]*uSMuO[a0+2]; 
    uSMuOSq[3] += 0.7071067811865475*uSMuO[a0]*uSMuO[a0+3]; 
  } 
...
{ 
  ...
  { 
    ...
    uSMuOSq[0] += 0.3535533905932737*uSMuO[a0+9]*uSMuO[a0+9]+0.3535533905932737*uSMuO[a0+8]*uSMuO[a0+8]+0.3535533905932737*uSMuO[a0+7]*uSMuO[a0+7]+0.3535533905932737*uSMuO[a0+6]*uSMuO[a0+6]+0.3535533905932737*uSMuO[a0+5]*uSMuO[a0+5]+0.3535533905932737*uSMuO[a0+4]*uSMuO[a0+4]+0.3535533905932737*uSMuO[a0+3]*uSMuO[a0+3]+0.3535533905932737*uSMuO[a0+2]*uSMuO[a0+2]+0.3535533905932737*uSMuO[a0+1]*uSMuO[a0+1]+0.3535533905932737*uSMuO[a0]*uSMuO[a0]; 
    uSMuOSq[1] += 0.6324555320336759*uSMuO[a0+1]*uSMuO[a0+7]+0.7071067811865475*uSMuO[a0+3]*uSMuO[a0+5]+0.7071067811865475*uSMuO[a0+2]*uSMuO[a0+4]+0.7071067811865475*uSMuO[a0]*uSMuO[a0+1]; 
    uSMuOSq[2] += 0.6324555320336759*uSMuO[a0+2]*uSMuO[a0+8]+0.7071067811865475*uSMuO[a0+3]*uSMuO[a0+6]+0.7071067811865475*uSMuO[a0+1]*uSMuO[a0+4]+0.7071067811865475*uSMuO[a0]*uSMuO[a0+2]; 
    uSMuOSq[3] += 0.6324555320336759*uSMuO[a0+3]*uSMuO[a0+9]+0.7071067811865475*uSMuO[a0+2]*uSMuO[a0+6]+0.7071067811865475*uSMuO[a0+1]*uSMuO[a0+5]+0.7071067811865475*uSMuO[a0]*uSMuO[a0+3]; 
    uSMuOSq[4] += 0.6324555320336759*uSMuO[a0+4]*uSMuO[a0+8]+0.6324555320336759*uSMuO[a0+4]*uSMuO[a0+7]+0.7071067811865475*uSMuO[a0+5]*uSMuO[a0+6]+0.7071067811865475*uSMuO[a0]*uSMuO[a0+4]+0.7071067811865475*uSMuO[a0+1]*uSMuO[a0+2]; 
    uSMuOSq[5] += 0.6324555320336759*uSMuO[a0+5]*uSMuO[a0+9]+0.6324555320336759*uSMuO[a0+5]*uSMuO[a0+7]+0.7071067811865475*uSMuO[a0+4]*uSMuO[a0+6]+0.7071067811865475*uSMuO[a0]*uSMuO[a0+5]+0.7071067811865475*uSMuO[a0+1]*uSMuO[a0+3]; 
    uSMuOSq[6] += 0.6324555320336759*uSMuO[a0+6]*uSMuO[a0+9]+0.6324555320336759*uSMuO[a0+6]*uSMuO[a0+8]+0.7071067811865475*uSMuO[a0]*uSMuO[a0+6]+0.7071067811865475*uSMuO[a0+4]*uSMuO[a0+5]+0.7071067811865475*uSMuO[a0+2]*uSMuO[a0+3]; 
    uSMuOSq[7] += 0.2258769757263128*uSMuO[a0+7]*uSMuO[a0+7]+0.7071067811865475*uSMuO[a0]*uSMuO[a0+7]+0.3162277660168379*uSMuO[a0+5]*uSMuO[a0+5]+0.3162277660168379*uSMuO[a0+4]*uSMuO[a0+4]+0.3162277660168379*uSMuO[a0+1]*uSMuO[a0+1]; 
    uSMuOSq[8] += 0.2258769757263128*uSMuO[a0+8]*uSMuO[a0+8]+0.7071067811865475*uSMuO[a0]*uSMuO[a0+8]+0.3162277660168379*uSMuO[a0+6]*uSMuO[a0+6]+0.3162277660168379*uSMuO[a0+4]*uSMuO[a0+4]+0.3162277660168379*uSMuO[a0+2]*uSMuO[a0+2]; 
    uSMuOSq[9] += 0.2258769757263128*uSMuO[a0+9]*uSMuO[a0+9]+0.7071067811865475*uSMuO[a0]*uSMuO[a0+9]+0.3162277660168379*uSMuO[a0+6]*uSMuO[a0+6]+0.3162277660168379*uSMuO[a0+5]*uSMuO[a0+5]+0.3162277660168379*uSMuO[a0+3]*uSMuO[a0+3]; 
  } 
...
void VmCrossPrimMomentsHeavyIon3x3vMax_P1(const double mRat, const double beta, const double *uSelf, const double *vtSqSelf, const double *uOther, const double *vtSqOther, double *uCross, double *vtSqCross) 
{ 
  // mRat:              mass ratio = m_other/m_self. 
  // uSelf, vtSqSelf:   bulk flow velocity and T/m of self species. 
  // uOther, vtSqOther: bulk flow velocity and T/m of other species. 
...
void VmCrossPrimMomentsHeavyIon3x3vMax_P2(const double mRat, const double beta, const double *uSelf, const double *vtSqSelf, const double *uOther, const double *vtSqOther, double *uCross, double *vtSqCross) 
{ 
  // mRat:              mass ratio = m_other/m_self. 
  // uSelf, vtSqSelf:   bulk flow velocity and T/m of self species. 
  // uOther, vtSqOther: bulk flow velocity and T/m of other species. 
