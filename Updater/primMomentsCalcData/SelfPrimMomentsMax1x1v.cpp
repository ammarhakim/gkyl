...
void SelfPrimMoments1x1vMax_P1(const int pVdim, const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  ...
  BigAEM(2,3) = 0.7071067811865475*m0s[1]*pVdim-0.7071067811865475*cE[1]; 
  BigAEM(3,2) = 0.7071067811865475*m0s[1]*pVdim-0.7071067811865475*cE[1]; 
...
void SelfPrimMoments1x1vMax_P2(const int pVdim, const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  // m0,m1,m2: moments of the distribution function. 
  // cM, cE: vtSq*cM and vtSq*cE are corrections to u and vtSq, respectively. 
  // u:        velocity. 
  ...
  // ....... Block from correction to vtSq .......... // 
  BigAEM(3,3) = 0.7071067811865475*m0s[0]*pVdim-0.7071067811865475*cE[0]; 
  BigAEM(3,4) = 0.7071067811865475*m0s[1]*pVdim-0.7071067811865475*cE[1]; 
  BigAEM(3,5) = 0.7071067811865475*m0s[2]*pVdim-0.7071067811865475*cE[2]; 
  BigAEM(4,3) = 0.7071067811865475*m0s[1]*pVdim-0.7071067811865475*cE[1]; 
  BigAEM(4,4) = 0.6324555320336759*m0s[2]*pVdim+0.7071067811865475*m0s[0]*pVdim-0.6324555320336759*cE[2]-0.7071067811865475*cE[0]; 
  BigAEM(4,5) = 0.6324555320336759*m0s[1]*pVdim-0.6324555320336759*cE[1]; 
  BigAEM(5,3) = 0.7071067811865475*m0s[2]*pVdim-0.7071067811865475*cE[2]; 
  BigAEM(5,4) = 0.6324555320336759*m0s[1]*pVdim-0.6324555320336759*cE[1]; 
...
void SelfPrimMoments1x1vMax_P3(const int pVdim, const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  // m0,m1,m2: moments of the distribution function. 
  // cM, cE: vtSq*cM and vtSq*cE are corrections to u and vtSq, respectively. 
  // u:        velocity. 
  ...
  BigAEM(4,6) = 0.7071067811865475*m0s[2]*pVdim-0.7071067811865475*cE[2]; 
  BigAEM(4,7) = 0.7071067811865475*m0s[3]*pVdim-0.7071067811865475*cE[3]; 
  BigAEM(5,4) = 0.7071067811865475*m0s[1]*pVdim-0.7071067811865475*cE[1]; 
  BigAEM(5,5) = 0.6324555320336759*m0s[2]*pVdim+0.7071067811865475*m0s[0]*pVdim-0.6324555320336759*cE[2]-0.7071067811865475*cE[0]; 
  BigAEM(5,6) = 0.6210590034081186*m0s[3]*pVdim+0.6324555320336759*m0s[1]*pVdim-0.6210590034081186*cE[3]-0.6324555320336759*cE[1]; 
  BigAEM(5,7) = 0.6210590034081186*m0s[2]*pVdim-0.6210590034081186*cE[2]; 
  BigAEM(6,4) = 0.7071067811865475*m0s[2]*pVdim-0.7071067811865475*cE[2]; 
  BigAEM(6,5) = 0.6210590034081186*m0s[3]*pVdim+0.6324555320336759*m0s[1]*pVdim-0.6210590034081186*cE[3]-0.6324555320336759*cE[1]; 
  BigAEM(6,6) = 0.4517539514526256*m0s[2]*pVdim+0.7071067811865475*m0s[0]*pVdim-0.4517539514526256*cE[2]-0.7071067811865475*cE[0]; 
  BigAEM(6,7) = 0.421637021355784*m0s[3]*pVdim+0.6210590034081186*m0s[1]*pVdim-0.421637021355784*cE[3]-0.6210590034081186*cE[1]; 
  BigAEM(7,4) = 0.7071067811865475*m0s[3]*pVdim-0.7071067811865475*cE[3]; 
  BigAEM(7,5) = 0.6210590034081186*m0s[2]*pVdim-0.6210590034081186*cE[2]; 
  BigAEM(7,6) = 0.421637021355784*m0s[3]*pVdim+0.6210590034081186*m0s[1]*pVdim-0.421637021355784*cE[3]-0.6210590034081186*cE[1]; 
...
{ 
  ...
  out[1] += (0.7071067811865475*fvmax[1]*dS-0.7071067811865475*fvmin[1]*dS)*intFac; 
...
{ 
  ...
  out[2] += (0.7071067811865475*fvmax[4]*dS-0.7071067811865475*fvmin[4]*dS)*intFac; 
...
{ 
  ...
  out[3] += (0.7071067811865475*fvmax[8]*dS-0.7071067811865475*fvmin[8]*dS)*intFac; 
...
{ 
  ...
  out[1] += intFac*(0.7071067811865475*fvmax[1]*dS*vmax-0.7071067811865475*fvmin[1]*dS*vmin); 
...
{ 
  ...
  out[2] += intFac*(0.7071067811865475*fvmax[4]*dS*vmax-0.7071067811865475*fvmin[4]*dS*vmin); 
...
{ 
  ...
  out[3] += intFac*(0.7071067811865475*fvmax[8]*dS*vmax-0.7071067811865475*fvmin[8]*dS*vmin); 
