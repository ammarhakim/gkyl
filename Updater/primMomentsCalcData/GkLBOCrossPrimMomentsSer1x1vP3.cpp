...
void GkLBOECrossPrimMoments1x1vSer_P3(binOpData_t *data, binOpData_t *dataDiv,const double betaGreenep1, const double mSelf, const double nuSelf, const double *m0Self, const double *m1Self, const double *m2Self, const double *uSelf, const double *vtSqSelf, const double *cMSelf, const double *cESelf, const double mOther, const double nuOther, const double *m0Other, const double *m1Other, const double *m2Other, const double *uOther, const double *vtSqOther, const double *cMOther, const double *cEOther, double *uCrossSelf, double *vtSqCrossSelf, double *uCrossOther, double *vtSqCrossOther) 
{ 
  // betaGreenep1:       free parameter beta+1. This has to be >0. 
  // nu, m:              collisionality and mass. 
  // m0,m1,m2:           moments of the distribution function. 
  ...
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(4,4) += (0.7071067811865475*m0rOther[0]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,5) += (0.7071067811865475*m0rOther[1]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,6) += (0.7071067811865475*m0rOther[2]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,7) += (0.7071067811865475*m0rOther[3]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,4) += (0.7071067811865475*m0rOther[1]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,5) += (0.6324555320336759*m0rOther[2]*mSelf*mnuOther)/mOther-(0.6324555320336759*cErOther[2]*mSelf*mnuOther)/mOther+(0.7071067811865475*m0rOther[0]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,6) += (0.6210590034081186*m0rOther[3]*mSelf*mnuOther)/mOther-(0.6210590034081186*cErOther[3]*mSelf*mnuOther)/mOther+(0.6324555320336759*m0rOther[1]*mSelf*mnuOther)/mOther-(0.6324555320336759*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,7) += (0.6210590034081186*m0rOther[2]*mSelf*mnuOther)/mOther-(0.6210590034081186*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,4) += (0.7071067811865475*m0rOther[2]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,5) += (0.6210590034081186*m0rOther[3]*mSelf*mnuOther)/mOther-(0.6210590034081186*cErOther[3]*mSelf*mnuOther)/mOther+(0.6324555320336759*m0rOther[1]*mSelf*mnuOther)/mOther-(0.6324555320336759*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,6) += (0.4517539514526256*m0rOther[2]*mSelf*mnuOther)/mOther-(0.4517539514526256*cErOther[2]*mSelf*mnuOther)/mOther+(0.7071067811865475*m0rOther[0]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,7) += (0.421637021355784*m0rOther[3]*mSelf*mnuOther)/mOther-(0.421637021355784*cErOther[3]*mSelf*mnuOther)/mOther+(0.6210590034081186*m0rOther[1]*mSelf*mnuOther)/mOther-(0.6210590034081186*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,4) += (0.7071067811865475*m0rOther[3]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,5) += (0.6210590034081186*m0rOther[2]*mSelf*mnuOther)/mOther-(0.6210590034081186*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,6) += (0.421637021355784*m0rOther[3]*mSelf*mnuOther)/mOther-(0.421637021355784*cErOther[3]*mSelf*mnuOther)/mOther+(0.6210590034081186*m0rOther[1]*mSelf*mnuOther)/mOther-(0.6210590034081186*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,7) += (0.421637021355784*m0rOther[2]*mSelf*mnuOther)/mOther-(0.421637021355784*cErOther[2]*mSelf*mnuOther)/mOther+(0.7071067811865475*m0rOther[0]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[0]*mSelf*mnuOther)/mOther; 
