...
{ 
  ...
  BigAEM(2,2) = 1.414213562373095*m0r[0]+0.7071067811865475*m0Sr[0]-0.7071067811865475*cE[0]; 
  BigAEM(2,3) = 1.414213562373095*m0r[1]+0.7071067811865475*m0Sr[1]-0.7071067811865475*cE[1]; 
  BigAEM(3,2) = 1.414213562373095*m0r[1]+0.7071067811865475*m0Sr[1]-0.7071067811865475*cE[1]; 
  BigAEM(3,3) = 1.414213562373095*m0r[0]+0.7071067811865475*m0Sr[0]-0.7071067811865475*cE[0]; 
...
{ 
  ...
  // ....... Block from correction to vtSq .......... // 
  BigAEM(3,3) = 2.121320343559642*m0r[0]-0.7071067811865475*cE[0]; 
  BigAEM(3,4) = 2.121320343559642*m0r[1]-0.7071067811865475*cE[1]; 
  BigAEM(3,5) = 2.121320343559642*m0r[2]-0.7071067811865475*cE[2]; 
  BigAEM(4,3) = 2.121320343559642*m0r[1]-0.7071067811865475*cE[1]; 
  BigAEM(4,4) = 1.897366596101028*m0r[2]-0.6324555320336759*cE[2]+2.121320343559642*m0r[0]-0.7071067811865475*cE[0]; 
  BigAEM(4,5) = 1.897366596101028*m0r[1]-0.6324555320336759*cE[1]; 
  BigAEM(5,3) = 2.121320343559642*m0r[2]-0.7071067811865475*cE[2]; 
  BigAEM(5,4) = 1.897366596101028*m0r[1]-0.6324555320336759*cE[1]; 
  BigAEM(5,5) = 1.355261854357877*m0r[2]-0.4517539514526256*cE[2]+2.121320343559642*m0r[0]-0.7071067811865475*cE[0]; 
...
{ 
  ...
  // ....... Block from correction to vtSq .......... // 
  BigAEM(4,4) = 2.121320343559642*m0r[0]-0.7071067811865475*cE[0]; 
  BigAEM(4,5) = 2.121320343559642*m0r[1]-0.7071067811865475*cE[1]; 
  BigAEM(4,6) = 2.121320343559642*m0r[2]-0.7071067811865475*cE[2]; 
  BigAEM(4,7) = 2.121320343559642*m0r[3]-0.7071067811865475*cE[3]; 
  BigAEM(5,4) = 2.121320343559642*m0r[1]-0.7071067811865475*cE[1]; 
  BigAEM(5,5) = 1.897366596101028*m0r[2]-0.6324555320336759*cE[2]+2.121320343559642*m0r[0]-0.7071067811865475*cE[0]; 
  BigAEM(5,6) = 1.863177010224355*m0r[3]-0.6210590034081186*cE[3]+1.897366596101028*m0r[1]-0.6324555320336759*cE[1]; 
  BigAEM(5,7) = 1.863177010224355*m0r[2]-0.6210590034081186*cE[2]; 
  BigAEM(6,4) = 2.121320343559642*m0r[2]-0.7071067811865475*cE[2]; 
  BigAEM(6,5) = 1.863177010224355*m0r[3]-0.6210590034081186*cE[3]+1.897366596101028*m0r[1]-0.6324555320336759*cE[1]; 
  BigAEM(6,6) = 1.355261854357877*m0r[2]-0.4517539514526256*cE[2]+2.121320343559642*m0r[0]-0.7071067811865475*cE[0]; 
  BigAEM(6,7) = 1.264911064067352*m0r[3]-0.421637021355784*cE[3]+1.863177010224355*m0r[1]-0.6210590034081186*cE[1]; 
  BigAEM(7,4) = 2.121320343559642*m0r[3]-0.7071067811865475*cE[3]; 
  BigAEM(7,5) = 1.863177010224355*m0r[2]-0.6210590034081186*cE[2]; 
  BigAEM(7,6) = 1.264911064067352*m0r[3]-0.421637021355784*cE[3]+1.863177010224355*m0r[1]-0.6210590034081186*cE[1]; 
  BigAEM(7,7) = 1.264911064067352*m0r[2]-0.421637021355784*cE[2]+2.121320343559642*m0r[0]-0.7071067811865475*cE[0]; 
