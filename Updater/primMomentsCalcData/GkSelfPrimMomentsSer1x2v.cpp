...
{ 
  ...
  data->AEM_S(2,2) = 1.414213562373095*m0r[0]+0.7071067811865475*m0Sr[0]-0.7071067811865475*cEr[0]; 
  data->AEM_S(2,3) = 1.414213562373095*m0r[1]+0.7071067811865475*m0Sr[1]-0.7071067811865475*cEr[1]; 
  data->AEM_S(3,2) = 1.414213562373095*m0r[1]+0.7071067811865475*m0Sr[1]-0.7071067811865475*cEr[1]; 
  data->AEM_S(3,3) = 1.414213562373095*m0r[0]+0.7071067811865475*m0Sr[0]-0.7071067811865475*cEr[0]; 
...
{ 
  ...
  // ....... Block from correction to vtSq .......... // 
  data->AEM_S(3,3) = 2.121320343559642*m0r[0]-0.7071067811865475*cEr[0]; 
  data->AEM_S(3,4) = 2.121320343559642*m0r[1]-0.7071067811865475*cEr[1]; 
  data->AEM_S(3,5) = 2.121320343559642*m0r[2]-0.7071067811865475*cEr[2]; 
  data->AEM_S(4,3) = 2.121320343559642*m0r[1]-0.7071067811865475*cEr[1]; 
  data->AEM_S(4,4) = 1.897366596101028*m0r[2]-0.6324555320336759*cEr[2]+2.121320343559642*m0r[0]-0.7071067811865475*cEr[0]; 
  data->AEM_S(4,5) = 1.897366596101028*m0r[1]-0.6324555320336759*cEr[1]; 
  data->AEM_S(5,3) = 2.121320343559642*m0r[2]-0.7071067811865475*cEr[2]; 
  data->AEM_S(5,4) = 1.897366596101028*m0r[1]-0.6324555320336759*cEr[1]; 
  data->AEM_S(5,5) = 1.355261854357877*m0r[2]-0.4517539514526256*cEr[2]+2.121320343559642*m0r[0]-0.7071067811865475*cEr[0]; 
...
{ 
  ...
  // ....... Block from correction to vtSq .......... // 
  data->AEM_S(4,4) = 2.121320343559642*m0r[0]-0.7071067811865475*cEr[0]; 
  data->AEM_S(4,5) = 2.121320343559642*m0r[1]-0.7071067811865475*cEr[1]; 
  data->AEM_S(4,6) = 2.121320343559642*m0r[2]-0.7071067811865475*cEr[2]; 
  data->AEM_S(4,7) = 2.121320343559642*m0r[3]-0.7071067811865475*cEr[3]; 
  data->AEM_S(5,4) = 2.121320343559642*m0r[1]-0.7071067811865475*cEr[1]; 
  data->AEM_S(5,5) = 1.897366596101028*m0r[2]-0.6324555320336759*cEr[2]+2.121320343559642*m0r[0]-0.7071067811865475*cEr[0]; 
  data->AEM_S(5,6) = 1.863177010224355*m0r[3]-0.6210590034081186*cEr[3]+1.897366596101028*m0r[1]-0.6324555320336759*cEr[1]; 
  data->AEM_S(5,7) = 1.863177010224355*m0r[2]-0.6210590034081186*cEr[2]; 
  data->AEM_S(6,4) = 2.121320343559642*m0r[2]-0.7071067811865475*cEr[2]; 
  data->AEM_S(6,5) = 1.863177010224355*m0r[3]-0.6210590034081186*cEr[3]+1.897366596101028*m0r[1]-0.6324555320336759*cEr[1]; 
  data->AEM_S(6,6) = 1.355261854357877*m0r[2]-0.4517539514526256*cEr[2]+2.121320343559642*m0r[0]-0.7071067811865475*cEr[0]; 
  data->AEM_S(6,7) = 1.264911064067352*m0r[3]-0.421637021355784*cEr[3]+1.863177010224355*m0r[1]-0.6210590034081186*cEr[1]; 
  data->AEM_S(7,4) = 2.121320343559642*m0r[3]-0.7071067811865475*cEr[3]; 
  data->AEM_S(7,5) = 1.863177010224355*m0r[2]-0.6210590034081186*cEr[2]; 
  data->AEM_S(7,6) = 1.264911064067352*m0r[3]-0.421637021355784*cEr[3]+1.863177010224355*m0r[1]-0.6210590034081186*cEr[1]; 
  data->AEM_S(7,7) = 1.264911064067352*m0r[2]-0.421637021355784*cEr[2]+2.121320343559642*m0r[0]-0.7071067811865475*cEr[0]; 
