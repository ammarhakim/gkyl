...
void GkSelfPrimMoments1x2vSer_P1(const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  ...
  BigAEM(2,0) = 0.7071067811865475*m1r[0]; 
  BigAEM(2,1) = 0.7071067811865475*m1r[1]; 
  BigAEM(3,0) = 0.7071067811865475*m1r[1]; 
  BigAEM(3,1) = 0.7071067811865475*m1r[0]; 
 
  // ....... Block from correction to vtSq .......... // 
  BigAEM(2,2) = 2.121320343559642*m0r[0]-0.7071067811865475*cE[0]; 
  BigAEM(2,3) = 2.121320343559642*m0r[1]-0.7071067811865475*cE[1]; 
  BigAEM(3,2) = 2.121320343559642*m0r[1]-0.7071067811865475*cE[1]; 
