...
{ 
  ...
  { 
    unsigned short int a0 = 2*vd; 
    // Contribution to dot-product from weak multiplication of vd component. 
    relKinE[0] += 0.3535533905932737*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0]*uSelf[a0]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0]*uRelDmnu[a0]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mOther-0.3535533905932737*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mOther+0.3535533905932737*uRelDmnu[a0]*uSelf[a0]*betaGreenep1*mOther-0.3535533905932737*uOther[a0]*uRelDmnu[a0]*betaGreenep1*mOther; 
    relKinE[1] += 0.3535533905932737*uRelDmnu[a0]*uSelf[a0+1]*betaGreenep1*mSelf+0.3535533905932737*uSelf[a0]*uRelDmnu[a0+1]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0]*uRelDmnu[a0+1]*betaGreenep1*mSelf-0.3535533905932737*uRelDmnu[a0]*uOther[a0+1]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0]*uSelf[a0+1]*betaGreenep1*mOther+0.3535533905932737*uSelf[a0]*uRelDmnu[a0+1]*betaGreenep1*mOther-0.3535533905932737*uOther[a0]*uRelDmnu[a0+1]*betaGreenep1*mOther-0.3535533905932737*uRelDmnu[a0]*uOther[a0+1]*betaGreenep1*mOther; 
  } 
...
{ 
  ...
  { 
    unsigned short int a0 = 3*vd; 
    // Contribution to dot-product from weak multiplication of vd component. 
    relKinE[0] += 0.3535533905932737*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0]*uSelf[a0]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0]*uRelDmnu[a0]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mOther-0.3535533905932737*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mOther+0.3535533905932737*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mOther-0.3535533905932737*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mOther+0.3535533905932737*uRelDmnu[a0]*uSelf[a0]*betaGreenep1*mOther-0.3535533905932737*uOther[a0]*uRelDmnu[a0]*betaGreenep1*mOther; 
    relKinE[1] += 0.3162277660168379*uRelDmnu[a0+1]*uSelf[a0+2]*betaGreenep1*mSelf+0.3162277660168379*uSelf[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.3162277660168379*uOther[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.3162277660168379*uRelDmnu[a0+1]*uOther[a0+2]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0]*uSelf[a0+1]*betaGreenep1*mSelf+0.3535533905932737*uSelf[a0]*uRelDmnu[a0+1]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0]*uRelDmnu[a0+1]*betaGreenep1*mSelf-0.3535533905932737*uRelDmnu[a0]*uOther[a0+1]*betaGreenep1*mSelf+0.3162277660168379*uRelDmnu[a0+1]*uSelf[a0+2]*betaGreenep1*mOther+0.3162277660168379*uSelf[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.3162277660168379*uOther[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.3162277660168379*uRelDmnu[a0+1]*uOther[a0+2]*betaGreenep1*mOther+0.3535533905932737*uRelDmnu[a0]*uSelf[a0+1]*betaGreenep1*mOther+0.3535533905932737*uSelf[a0]*uRelDmnu[a0+1]*betaGreenep1*mOther-0.3535533905932737*uOther[a0]*uRelDmnu[a0+1]*betaGreenep1*mOther-0.3535533905932737*uRelDmnu[a0]*uOther[a0+1]*betaGreenep1*mOther; 
    relKinE[2] += 0.2258769757263129*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0]*uSelf[a0+2]*betaGreenep1*mSelf-0.2258769757263129*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mSelf+0.3535533905932737*uSelf[a0]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.3535533905932737*uRelDmnu[a0]*uOther[a0+2]*betaGreenep1*mSelf+0.3162277660168379*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mSelf-0.3162277660168379*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mSelf+0.2258769757263129*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mOther+0.3535533905932737*uRelDmnu[a0]*uSelf[a0+2]*betaGreenep1*mOther-0.2258769757263129*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mOther+0.3535533905932737*uSelf[a0]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.3535533905932737*uOther[a0]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.3535533905932737*uRelDmnu[a0]*uOther[a0+2]*betaGreenep1*mOther+0.3162277660168379*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mOther-0.3162277660168379*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mOther; 
  } 
  ...
  double diffSelf[3]; 
  diffSelf[0] = (0.7071067811865475*m0rOther[2]*relKinE[2]+0.7071067811865475*m0rOther[1]*relKinE[1]+0.7071067811865475*m0rOther[0]*relKinE[0])*mnuOther-1.0*uRelSq[0]*mOther+2.0*Tdiff[0]; 
  diffSelf[1] = (0.6324555320336759*m0rOther[1]*relKinE[2]+0.6324555320336759*relKinE[1]*m0rOther[2]+0.7071067811865475*m0rOther[0]*relKinE[1]+0.7071067811865475*relKinE[0]*m0rOther[1])*mnuOther-1.0*uRelSq[1]*mOther+2.0*Tdiff[1]; 
  diffSelf[2] = (0.4517539514526256*m0rOther[2]*relKinE[2]+0.7071067811865475*m0rOther[0]*relKinE[2]+0.7071067811865475*relKinE[0]*m0rOther[2]+0.6324555320336759*m0rOther[1]*relKinE[1])*mnuOther-1.0*uRelSq[2]*mOther+2.0*Tdiff[2]; 
  ...
  double diffOther[3]; 
  diffOther[0] = (0.7071067811865475*m0rSelf[2]*relKinE[2]+0.7071067811865475*m0rSelf[1]*relKinE[1]+0.7071067811865475*m0rSelf[0]*relKinE[0])*mnuSelf-1.0*uRelSq[0]*mSelf-2.0*Tdiff[0]; 
  diffOther[1] = (0.6324555320336759*m0rSelf[1]*relKinE[2]+0.6324555320336759*relKinE[1]*m0rSelf[2]+0.7071067811865475*m0rSelf[0]*relKinE[1]+0.7071067811865475*relKinE[0]*m0rSelf[1])*mnuSelf-1.0*uRelSq[1]*mSelf-2.0*Tdiff[1]; 
  diffOther[2] = (0.4517539514526256*m0rSelf[2]*relKinE[2]+0.7071067811865475*m0rSelf[0]*relKinE[2]+0.7071067811865475*relKinE[0]*m0rSelf[2]+0.6324555320336759*m0rSelf[1]*relKinE[1])*mnuSelf-1.0*uRelSq[2]*mSelf-2.0*Tdiff[2]; 
...
{ 
  ...
  { 
    unsigned short int a0 = 4*vd; 
    // Contribution to dot-product from weak multiplication of vd component. 
    relKinE[0] += 0.3535533905932737*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0]*uSelf[a0]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0]*uRelDmnu[a0]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mOther-0.3535533905932737*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mOther+0.3535533905932737*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mOther-0.3535533905932737*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mOther+0.3535533905932737*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mOther-0.3535533905932737*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mOther+0.3535533905932737*uRelDmnu[a0]*uSelf[a0]*betaGreenep1*mOther-0.3535533905932737*uOther[a0]*uRelDmnu[a0]*betaGreenep1*mOther; 
    relKinE[1] += 0.3105295017040594*uRelDmnu[a0+2]*uSelf[a0+3]*betaGreenep1*mSelf+0.3105295017040594*uSelf[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.3105295017040594*uOther[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.3105295017040594*uRelDmnu[a0+2]*uOther[a0+3]*betaGreenep1*mSelf+0.3162277660168379*uRelDmnu[a0+1]*uSelf[a0+2]*betaGreenep1*mSelf+0.3162277660168379*uSelf[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.3162277660168379*uOther[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.3162277660168379*uRelDmnu[a0+1]*uOther[a0+2]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0]*uSelf[a0+1]*betaGreenep1*mSelf+0.3535533905932737*uSelf[a0]*uRelDmnu[a0+1]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0]*uRelDmnu[a0+1]*betaGreenep1*mSelf-0.3535533905932737*uRelDmnu[a0]*uOther[a0+1]*betaGreenep1*mSelf+0.3105295017040594*uRelDmnu[a0+2]*uSelf[a0+3]*betaGreenep1*mOther+0.3105295017040594*uSelf[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.3105295017040594*uOther[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.3105295017040594*uRelDmnu[a0+2]*uOther[a0+3]*betaGreenep1*mOther+0.3162277660168379*uRelDmnu[a0+1]*uSelf[a0+2]*betaGreenep1*mOther+0.3162277660168379*uSelf[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.3162277660168379*uOther[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.3162277660168379*uRelDmnu[a0+1]*uOther[a0+2]*betaGreenep1*mOther+0.3535533905932737*uRelDmnu[a0]*uSelf[a0+1]*betaGreenep1*mOther+0.3535533905932737*uSelf[a0]*uRelDmnu[a0+1]*betaGreenep1*mOther-0.3535533905932737*uOther[a0]*uRelDmnu[a0+1]*betaGreenep1*mOther-0.3535533905932737*uRelDmnu[a0]*uOther[a0+1]*betaGreenep1*mOther; 
    relKinE[2] += 0.210818510677892*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mSelf+0.3105295017040594*uRelDmnu[a0+1]*uSelf[a0+3]*betaGreenep1*mSelf-0.210818510677892*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mSelf+0.3105295017040594*uSelf[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.3105295017040594*uOther[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.3105295017040594*uRelDmnu[a0+1]*uOther[a0+3]*betaGreenep1*mSelf+0.2258769757263129*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0]*uSelf[a0+2]*betaGreenep1*mSelf-0.2258769757263129*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mSelf+0.3535533905932737*uSelf[a0]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.3535533905932737*uRelDmnu[a0]*uOther[a0+2]*betaGreenep1*mSelf+0.3162277660168379*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mSelf-0.3162277660168379*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mSelf+0.210818510677892*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mOther+0.3105295017040594*uRelDmnu[a0+1]*uSelf[a0+3]*betaGreenep1*mOther-0.210818510677892*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mOther+0.3105295017040594*uSelf[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.3105295017040594*uOther[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.3105295017040594*uRelDmnu[a0+1]*uOther[a0+3]*betaGreenep1*mOther+0.2258769757263129*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mOther+0.3535533905932737*uRelDmnu[a0]*uSelf[a0+2]*betaGreenep1*mOther-0.2258769757263129*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mOther+0.3535533905932737*uSelf[a0]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.3535533905932737*uOther[a0]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.3535533905932737*uRelDmnu[a0]*uOther[a0+2]*betaGreenep1*mOther+0.3162277660168379*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mOther-0.3162277660168379*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mOther; 
    relKinE[3] += 0.210818510677892*uRelDmnu[a0+2]*uSelf[a0+3]*betaGreenep1*mSelf+0.3535533905932737*uRelDmnu[a0]*uSelf[a0+3]*betaGreenep1*mSelf+0.210818510677892*uSelf[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.210818510677892*uOther[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mSelf+0.3535533905932737*uSelf[a0]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.3535533905932737*uOther[a0]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.210818510677892*uRelDmnu[a0+2]*uOther[a0+3]*betaGreenep1*mSelf-0.3535533905932737*uRelDmnu[a0]*uOther[a0+3]*betaGreenep1*mSelf+0.3105295017040594*uRelDmnu[a0+1]*uSelf[a0+2]*betaGreenep1*mSelf+0.3105295017040594*uSelf[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.3105295017040594*uOther[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.3105295017040594*uRelDmnu[a0+1]*uOther[a0+2]*betaGreenep1*mSelf+0.210818510677892*uRelDmnu[a0+2]*uSelf[a0+3]*betaGreenep1*mOther+0.3535533905932737*uRelDmnu[a0]*uSelf[a0+3]*betaGreenep1*mOther+0.210818510677892*uSelf[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.210818510677892*uOther[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mOther+0.3535533905932737*uSelf[a0]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.3535533905932737*uOther[a0]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.210818510677892*uRelDmnu[a0+2]*uOther[a0+3]*betaGreenep1*mOther-0.3535533905932737*uRelDmnu[a0]*uOther[a0+3]*betaGreenep1*mOther+0.3105295017040594*uRelDmnu[a0+1]*uSelf[a0+2]*betaGreenep1*mOther+0.3105295017040594*uSelf[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.3105295017040594*uOther[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.3105295017040594*uRelDmnu[a0+1]*uOther[a0+2]*betaGreenep1*mOther; 
  } 
  ...
  double diffSelf[4]; 
  diffSelf[0] = (0.7071067811865475*m0rOther[3]*relKinE[3]+0.7071067811865475*m0rOther[2]*relKinE[2]+0.7071067811865475*m0rOther[1]*relKinE[1]+0.7071067811865475*m0rOther[0]*relKinE[0])*mnuOther-1.0*uRelSq[0]*mOther+2.0*Tdiff[0]; 
  diffSelf[1] = (0.6210590034081186*m0rOther[2]*relKinE[3]+0.6210590034081186*relKinE[2]*m0rOther[3]+0.6324555320336759*m0rOther[1]*relKinE[2]+0.6324555320336759*relKinE[1]*m0rOther[2]+0.7071067811865475*m0rOther[0]*relKinE[1]+0.7071067811865475*relKinE[0]*m0rOther[1])*mnuOther-1.0*uRelSq[1]*mOther+2.0*Tdiff[1]; 
  diffSelf[2] = (0.421637021355784*m0rOther[3]*relKinE[3]+0.6210590034081186*m0rOther[1]*relKinE[3]+0.6210590034081186*relKinE[1]*m0rOther[3]+0.4517539514526256*m0rOther[2]*relKinE[2]+0.7071067811865475*m0rOther[0]*relKinE[2]+0.7071067811865475*relKinE[0]*m0rOther[2]+0.6324555320336759*m0rOther[1]*relKinE[1])*mnuOther-1.0*uRelSq[2]*mOther+2.0*Tdiff[2]; 
  diffSelf[3] = (0.421637021355784*m0rOther[2]*relKinE[3]+0.7071067811865475*m0rOther[0]*relKinE[3]+0.421637021355784*relKinE[2]*m0rOther[3]+0.7071067811865475*relKinE[0]*m0rOther[3]+0.6210590034081186*m0rOther[1]*relKinE[2]+0.6210590034081186*relKinE[1]*m0rOther[2])*mnuOther-1.0*uRelSq[3]*mOther+2.0*Tdiff[3]; 
  ...
  double diffOther[4]; 
  diffOther[0] = (0.7071067811865475*m0rSelf[3]*relKinE[3]+0.7071067811865475*m0rSelf[2]*relKinE[2]+0.7071067811865475*m0rSelf[1]*relKinE[1]+0.7071067811865475*m0rSelf[0]*relKinE[0])*mnuSelf-1.0*uRelSq[0]*mSelf-2.0*Tdiff[0]; 
  diffOther[1] = (0.6210590034081186*m0rSelf[2]*relKinE[3]+0.6210590034081186*relKinE[2]*m0rSelf[3]+0.6324555320336759*m0rSelf[1]*relKinE[2]+0.6324555320336759*relKinE[1]*m0rSelf[2]+0.7071067811865475*m0rSelf[0]*relKinE[1]+0.7071067811865475*relKinE[0]*m0rSelf[1])*mnuSelf-1.0*uRelSq[1]*mSelf-2.0*Tdiff[1]; 
  diffOther[2] = (0.421637021355784*m0rSelf[3]*relKinE[3]+0.6210590034081186*m0rSelf[1]*relKinE[3]+0.6210590034081186*relKinE[1]*m0rSelf[3]+0.4517539514526256*m0rSelf[2]*relKinE[2]+0.7071067811865475*m0rSelf[0]*relKinE[2]+0.7071067811865475*relKinE[0]*m0rSelf[2]+0.6324555320336759*m0rSelf[1]*relKinE[1])*mnuSelf-1.0*uRelSq[2]*mSelf-2.0*Tdiff[2]; 
  diffOther[3] = (0.421637021355784*m0rSelf[2]*relKinE[3]+0.7071067811865475*m0rSelf[0]*relKinE[3]+0.421637021355784*relKinE[2]*m0rSelf[3]+0.7071067811865475*relKinE[0]*m0rSelf[3]+0.6210590034081186*m0rSelf[1]*relKinE[2]+0.6210590034081186*relKinE[1]*m0rSelf[2])*mnuSelf-1.0*uRelSq[3]*mSelf-2.0*Tdiff[3]; 
