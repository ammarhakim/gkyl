...
{ 
  ...
  if (-0.5*(2.645751311064591*(m2[9]+m2[8])+3.872983346207417*(m2[7]+m2[6])-2.23606797749979*(m2[5]+m2[4])-3.0*m2[3]+1.732050807568877*(m2[2]+m2[1])-1.0*m2[0]) < 0) cellAvg = true; 
  if (-0.5*(2.645751311064591*m2[9]-2.645751311064591*m2[8]-3.872983346207417*m2[7]+3.872983346207417*m2[6]-2.23606797749979*(m2[5]+m2[4])+3.0*m2[3]+1.732050807568877*m2[2]-1.732050807568877*m2[1]-1.0*m2[0]) < 0) cellAvg = true; 
  if (0.5*(2.645751311064591*m2[9]-2.645751311064591*m2[8]-3.872983346207417*m2[7]+3.872983346207417*m2[6]+2.23606797749979*(m2[5]+m2[4])-3.0*m2[3]+1.732050807568877*m2[2]-1.732050807568877*m2[1]+m2[0]) < 0) cellAvg = true; 
  if (0.5*(2.645751311064591*(m2[9]+m2[8])+3.872983346207417*(m2[7]+m2[6])+2.23606797749979*(m2[5]+m2[4])+3.0*m2[3]+1.732050807568877*(m2[2]+m2[1])+m2[0]) < 0) cellAvg = true; 
  ...
  data->AEM_S(0,20) = -0.5*cMr[0]; 
  data->AEM_S(0,21) = -0.5*cMr[1]; 
  data->AEM_S(0,22) = -0.5*cMr[2]; 
  data->AEM_S(0,23) = -0.5*cMr[3]; 
  data->AEM_S(0,24) = -0.5*cMr[4]; 
  data->AEM_S(0,25) = -0.5*cMr[5]; 
  data->AEM_S(0,26) = -0.5*cMr[6]; 
  data->AEM_S(0,27) = -0.5*cMr[7]; 
  data->AEM_S(0,28) = -0.5*cMr[8]; 
  data->AEM_S(0,29) = -0.5*cMr[9]; 
  data->AEM_S(1,20) = -0.5*cMr[1]; 
  data->AEM_S(1,21) = (-0.4472135954999579*cMr[4])-0.5*cMr[0]; 
  data->AEM_S(1,22) = -0.5*cMr[3]; 
  data->AEM_S(1,23) = (-0.447213595499958*cMr[6])-0.5*cMr[2]; 
  data->AEM_S(1,24) = (-0.4391550328268398*cMr[8])-0.4472135954999579*cMr[1]; 
  data->AEM_S(1,25) = -0.5000000000000001*cMr[7]; 
  data->AEM_S(1,26) = -0.447213595499958*cMr[3]; 
  data->AEM_S(1,27) = -0.5000000000000001*cMr[5]; 
  data->AEM_S(1,28) = -0.4391550328268398*cMr[4]; 
  data->AEM_S(2,20) = -0.5*cMr[2]; 
  data->AEM_S(2,21) = -0.5*cMr[3]; 
  data->AEM_S(2,22) = (-0.4472135954999579*cMr[5])-0.5*cMr[0]; 
  data->AEM_S(2,23) = (-0.447213595499958*cMr[7])-0.5*cMr[1]; 
  data->AEM_S(2,24) = -0.5000000000000001*cMr[6]; 
  data->AEM_S(2,25) = (-0.4391550328268398*cMr[9])-0.4472135954999579*cMr[2]; 
  data->AEM_S(2,26) = -0.5000000000000001*cMr[4]; 
  data->AEM_S(2,27) = -0.447213595499958*cMr[3]; 
  data->AEM_S(2,29) = -0.4391550328268398*cMr[5]; 
  data->AEM_S(3,20) = -0.5*cMr[3]; 
  data->AEM_S(3,21) = (-0.447213595499958*cMr[6])-0.5*cMr[2]; 
  data->AEM_S(3,22) = (-0.447213595499958*cMr[7])-0.5*cMr[1]; 
  data->AEM_S(3,23) = (-0.4472135954999579*cMr[5])-0.4472135954999579*cMr[4]-0.5*cMr[0]; 
  data->AEM_S(3,24) = -0.4472135954999579*cMr[3]; 
  data->AEM_S(3,25) = -0.4472135954999579*cMr[3]; 
  data->AEM_S(3,26) = (-0.4391550328268399*cMr[8])-0.4*cMr[7]-0.447213595499958*cMr[1]; 
  data->AEM_S(3,27) = (-0.4391550328268399*cMr[9])-0.4*cMr[6]-0.447213595499958*cMr[2]; 
  data->AEM_S(3,28) = -0.4391550328268399*cMr[6]; 
  data->AEM_S(3,29) = -0.4391550328268399*cMr[7]; 
  data->AEM_S(4,20) = -0.5*cMr[4]; 
  data->AEM_S(4,21) = (-0.4391550328268398*cMr[8])-0.4472135954999579*cMr[1]; 
  data->AEM_S(4,22) = -0.5000000000000001*cMr[6]; 
  data->AEM_S(4,23) = -0.4472135954999579*cMr[3]; 
  data->AEM_S(4,24) = (-0.31943828249997*cMr[4])-0.5*cMr[0]; 
  data->AEM_S(4,26) = (-0.31943828249997*cMr[6])-0.5000000000000001*cMr[2]; 
  data->AEM_S(4,27) = -0.4472135954999579*cMr[7]; 
  data->AEM_S(4,28) = (-0.2981423969999719*cMr[8])-0.4391550328268398*cMr[1]; 
  data->AEM_S(5,20) = -0.5*cMr[5]; 
  data->AEM_S(5,21) = -0.5000000000000001*cMr[7]; 
  data->AEM_S(5,22) = (-0.4391550328268398*cMr[9])-0.4472135954999579*cMr[2]; 
  data->AEM_S(5,23) = -0.4472135954999579*cMr[3]; 
  data->AEM_S(5,25) = (-0.31943828249997*cMr[5])-0.5*cMr[0]; 
  data->AEM_S(5,26) = -0.4472135954999579*cMr[6]; 
  data->AEM_S(5,27) = (-0.31943828249997*cMr[7])-0.5000000000000001*cMr[1]; 
  data->AEM_S(5,29) = (-0.2981423969999719*cMr[9])-0.4391550328268398*cMr[2]; 
  data->AEM_S(6,20) = -0.5*cMr[6]; 
  data->AEM_S(6,21) = -0.447213595499958*cMr[3]; 
  data->AEM_S(6,22) = -0.5000000000000001*cMr[4]; 
  data->AEM_S(6,23) = (-0.4391550328268399*cMr[8])-0.4*cMr[7]-0.447213595499958*cMr[1]; 
  data->AEM_S(6,24) = (-0.31943828249997*cMr[6])-0.5000000000000001*cMr[2]; 
  data->AEM_S(6,25) = -0.4472135954999579*cMr[6]; 
  data->AEM_S(6,26) = (-0.4472135954999579*cMr[5])-0.31943828249997*cMr[4]-0.5*cMr[0]; 
  data->AEM_S(6,27) = -0.4*cMr[3]; 
  data->AEM_S(6,28) = -0.4391550328268399*cMr[3]; 
  data->AEM_S(7,20) = -0.5*cMr[7]; 
  data->AEM_S(7,21) = -0.5000000000000001*cMr[5]; 
  data->AEM_S(7,22) = -0.447213595499958*cMr[3]; 
  data->AEM_S(7,23) = (-0.4391550328268399*cMr[9])-0.4*cMr[6]-0.447213595499958*cMr[2]; 
  data->AEM_S(7,24) = -0.4472135954999579*cMr[7]; 
  data->AEM_S(7,25) = (-0.31943828249997*cMr[7])-0.5000000000000001*cMr[1]; 
  data->AEM_S(7,26) = -0.4*cMr[3]; 
  data->AEM_S(7,27) = (-0.31943828249997*cMr[5])-0.4472135954999579*cMr[4]-0.5*cMr[0]; 
  data->AEM_S(7,29) = -0.4391550328268399*cMr[3]; 
  data->AEM_S(8,20) = -0.5*cMr[8]; 
  data->AEM_S(8,21) = -0.4391550328268398*cMr[4]; 
  data->AEM_S(8,23) = -0.4391550328268399*cMr[6]; 
  data->AEM_S(8,24) = (-0.2981423969999719*cMr[8])-0.4391550328268398*cMr[1]; 
  data->AEM_S(8,26) = -0.4391550328268399*cMr[3]; 
  data->AEM_S(8,28) = (-0.2981423969999719*cMr[4])-0.5*cMr[0]; 
  data->AEM_S(9,20) = -0.5*cMr[9]; 
  data->AEM_S(9,22) = -0.4391550328268398*cMr[5]; 
  data->AEM_S(9,23) = -0.4391550328268399*cMr[7]; 
  data->AEM_S(9,25) = (-0.2981423969999719*cMr[9])-0.4391550328268398*cMr[2]; 
  data->AEM_S(9,27) = -0.4391550328268399*cMr[3]; 
  data->AEM_S(9,29) = (-0.2981423969999719*cMr[5])-0.5*cMr[0]; 
  ...
  data->AEM_S(10,20) = -0.5*cMr[10]; 
  data->AEM_S(10,21) = -0.5*cMr[11]; 
  data->AEM_S(10,22) = -0.5*cMr[12]; 
  data->AEM_S(10,23) = -0.5*cMr[13]; 
  data->AEM_S(10,24) = -0.5*cMr[14]; 
  data->AEM_S(10,25) = -0.5*cMr[15]; 
  data->AEM_S(10,26) = -0.5*cMr[16]; 
  data->AEM_S(10,27) = -0.5*cMr[17]; 
  data->AEM_S(10,28) = -0.5*cMr[18]; 
  data->AEM_S(10,29) = -0.5*cMr[19]; 
  data->AEM_S(11,20) = -0.5*cMr[11]; 
  data->AEM_S(11,21) = (-0.4472135954999579*cMr[14])-0.5*cMr[10]; 
  data->AEM_S(11,22) = -0.5*cMr[13]; 
  data->AEM_S(11,23) = (-0.447213595499958*cMr[16])-0.5*cMr[12]; 
  data->AEM_S(11,24) = (-0.4391550328268398*cMr[18])-0.4472135954999579*cMr[11]; 
  data->AEM_S(11,25) = -0.5000000000000001*cMr[17]; 
  data->AEM_S(11,26) = -0.447213595499958*cMr[13]; 
  data->AEM_S(11,27) = -0.5000000000000001*cMr[15]; 
  data->AEM_S(11,28) = -0.4391550328268398*cMr[14]; 
  data->AEM_S(12,20) = -0.5*cMr[12]; 
  data->AEM_S(12,21) = -0.5*cMr[13]; 
  data->AEM_S(12,22) = (-0.4472135954999579*cMr[15])-0.5*cMr[10]; 
  data->AEM_S(12,23) = (-0.447213595499958*cMr[17])-0.5*cMr[11]; 
  data->AEM_S(12,24) = -0.5000000000000001*cMr[16]; 
  data->AEM_S(12,25) = (-0.4391550328268398*cMr[19])-0.4472135954999579*cMr[12]; 
  data->AEM_S(12,26) = -0.5000000000000001*cMr[14]; 
  data->AEM_S(12,27) = -0.447213595499958*cMr[13]; 
  data->AEM_S(12,29) = -0.4391550328268398*cMr[15]; 
  data->AEM_S(13,20) = -0.5*cMr[13]; 
  data->AEM_S(13,21) = (-0.447213595499958*cMr[16])-0.5*cMr[12]; 
  data->AEM_S(13,22) = (-0.447213595499958*cMr[17])-0.5*cMr[11]; 
  data->AEM_S(13,23) = (-0.4472135954999579*cMr[15])-0.4472135954999579*cMr[14]-0.5*cMr[10]; 
  data->AEM_S(13,24) = -0.4472135954999579*cMr[13]; 
  data->AEM_S(13,25) = -0.4472135954999579*cMr[13]; 
  data->AEM_S(13,26) = (-0.4391550328268399*cMr[18])-0.4*cMr[17]-0.447213595499958*cMr[11]; 
  data->AEM_S(13,27) = (-0.4391550328268399*cMr[19])-0.4*cMr[16]-0.447213595499958*cMr[12]; 
  data->AEM_S(13,28) = -0.4391550328268399*cMr[16]; 
  data->AEM_S(13,29) = -0.4391550328268399*cMr[17]; 
  data->AEM_S(14,20) = -0.5*cMr[14]; 
  data->AEM_S(14,21) = (-0.4391550328268398*cMr[18])-0.4472135954999579*cMr[11]; 
  data->AEM_S(14,22) = -0.5000000000000001*cMr[16]; 
  data->AEM_S(14,23) = -0.4472135954999579*cMr[13]; 
  data->AEM_S(14,24) = (-0.31943828249997*cMr[14])-0.5*cMr[10]; 
  data->AEM_S(14,26) = (-0.31943828249997*cMr[16])-0.5000000000000001*cMr[12]; 
  data->AEM_S(14,27) = -0.4472135954999579*cMr[17]; 
  data->AEM_S(14,28) = (-0.2981423969999719*cMr[18])-0.4391550328268398*cMr[11]; 
  data->AEM_S(15,20) = -0.5*cMr[15]; 
  data->AEM_S(15,21) = -0.5000000000000001*cMr[17]; 
  data->AEM_S(15,22) = (-0.4391550328268398*cMr[19])-0.4472135954999579*cMr[12]; 
  data->AEM_S(15,23) = -0.4472135954999579*cMr[13]; 
  data->AEM_S(15,25) = (-0.31943828249997*cMr[15])-0.5*cMr[10]; 
  data->AEM_S(15,26) = -0.4472135954999579*cMr[16]; 
  data->AEM_S(15,27) = (-0.31943828249997*cMr[17])-0.5000000000000001*cMr[11]; 
  data->AEM_S(15,29) = (-0.2981423969999719*cMr[19])-0.4391550328268398*cMr[12]; 
  data->AEM_S(16,20) = -0.5*cMr[16]; 
  data->AEM_S(16,21) = -0.447213595499958*cMr[13]; 
  data->AEM_S(16,22) = -0.5000000000000001*cMr[14]; 
  data->AEM_S(16,23) = (-0.4391550328268399*cMr[18])-0.4*cMr[17]-0.447213595499958*cMr[11]; 
  data->AEM_S(16,24) = (-0.31943828249997*cMr[16])-0.5000000000000001*cMr[12]; 
  data->AEM_S(16,25) = -0.4472135954999579*cMr[16]; 
  data->AEM_S(16,26) = (-0.4472135954999579*cMr[15])-0.31943828249997*cMr[14]-0.5*cMr[10]; 
  data->AEM_S(16,27) = -0.4*cMr[13]; 
  data->AEM_S(16,28) = -0.4391550328268399*cMr[13]; 
  data->AEM_S(17,20) = -0.5*cMr[17]; 
  data->AEM_S(17,21) = -0.5000000000000001*cMr[15]; 
  data->AEM_S(17,22) = -0.447213595499958*cMr[13]; 
  data->AEM_S(17,23) = (-0.4391550328268399*cMr[19])-0.4*cMr[16]-0.447213595499958*cMr[12]; 
  data->AEM_S(17,24) = -0.4472135954999579*cMr[17]; 
  data->AEM_S(17,25) = (-0.31943828249997*cMr[17])-0.5000000000000001*cMr[11]; 
  data->AEM_S(17,26) = -0.4*cMr[13]; 
  data->AEM_S(17,27) = (-0.31943828249997*cMr[15])-0.4472135954999579*cMr[14]-0.5*cMr[10]; 
  data->AEM_S(17,29) = -0.4391550328268399*cMr[13]; 
  data->AEM_S(18,20) = -0.5*cMr[18]; 
  data->AEM_S(18,21) = -0.4391550328268398*cMr[14]; 
  data->AEM_S(18,23) = -0.4391550328268399*cMr[16]; 
  data->AEM_S(18,24) = (-0.2981423969999719*cMr[18])-0.4391550328268398*cMr[11]; 
  data->AEM_S(18,26) = -0.4391550328268399*cMr[13]; 
  data->AEM_S(18,28) = (-0.2981423969999719*cMr[14])-0.5*cMr[10]; 
  data->AEM_S(19,20) = -0.5*cMr[19]; 
  data->AEM_S(19,22) = -0.4391550328268398*cMr[15]; 
  data->AEM_S(19,23) = -0.4391550328268399*cMr[17]; 
  data->AEM_S(19,25) = (-0.2981423969999719*cMr[19])-0.4391550328268398*cMr[12]; 
  data->AEM_S(19,27) = -0.4391550328268399*cMr[13]; 
  data->AEM_S(19,29) = (-0.2981423969999719*cMr[15])-0.5*cMr[10]; 
  ...
  data->AEM_S(20,20) = m0r[0]-0.5*cEr[0]; 
  data->AEM_S(20,21) = m0r[1]-0.5*cEr[1]; 
  data->AEM_S(20,22) = m0r[2]-0.5*cEr[2]; 
  data->AEM_S(20,23) = m0r[3]-0.5*cEr[3]; 
  data->AEM_S(20,24) = m0r[4]-0.5*cEr[4]; 
  data->AEM_S(20,25) = m0r[5]-0.5*cEr[5]; 
  data->AEM_S(20,26) = m0r[6]-0.5*cEr[6]; 
  data->AEM_S(20,27) = m0r[7]-0.5*cEr[7]; 
  data->AEM_S(20,28) = m0r[8]-0.5*cEr[8]; 
  data->AEM_S(20,29) = m0r[9]-0.5*cEr[9]; 
  data->AEM_S(21,20) = m0r[1]-0.5*cEr[1]; 
  data->AEM_S(21,21) = 0.8944271909999159*m0r[4]-0.4472135954999579*cEr[4]+m0r[0]-0.5*cEr[0]; 
  data->AEM_S(21,22) = m0r[3]-0.5*cEr[3]; 
  data->AEM_S(21,23) = 0.8944271909999161*m0r[6]-0.447213595499958*cEr[6]+m0r[2]-0.5*cEr[2]; 
  data->AEM_S(21,24) = 0.8783100656536796*m0r[8]-0.4391550328268398*cEr[8]+0.8944271909999159*m0r[1]-0.4472135954999579*cEr[1]; 
  data->AEM_S(21,25) = 1.0*m0r[7]-0.5000000000000001*cEr[7]; 
  data->AEM_S(21,26) = 0.8944271909999161*m0r[3]-0.447213595499958*cEr[3]; 
  data->AEM_S(21,27) = 1.0*m0r[5]-0.5000000000000001*cEr[5]; 
  data->AEM_S(21,28) = 0.8783100656536796*m0r[4]-0.4391550328268398*cEr[4]; 
  data->AEM_S(22,20) = m0r[2]-0.5*cEr[2]; 
  data->AEM_S(22,21) = m0r[3]-0.5*cEr[3]; 
  data->AEM_S(22,22) = 0.8944271909999159*m0r[5]-0.4472135954999579*cEr[5]+m0r[0]-0.5*cEr[0]; 
  data->AEM_S(22,23) = 0.8944271909999161*m0r[7]-0.447213595499958*cEr[7]+m0r[1]-0.5*cEr[1]; 
  data->AEM_S(22,24) = 1.0*m0r[6]-0.5000000000000001*cEr[6]; 
  data->AEM_S(22,25) = 0.8783100656536796*m0r[9]-0.4391550328268398*cEr[9]+0.8944271909999159*m0r[2]-0.4472135954999579*cEr[2]; 
  data->AEM_S(22,26) = 1.0*m0r[4]-0.5000000000000001*cEr[4]; 
  data->AEM_S(22,27) = 0.8944271909999161*m0r[3]-0.447213595499958*cEr[3]; 
  data->AEM_S(22,29) = 0.8783100656536796*m0r[5]-0.4391550328268398*cEr[5]; 
  data->AEM_S(23,20) = m0r[3]-0.5*cEr[3]; 
  data->AEM_S(23,21) = 0.8944271909999161*m0r[6]-0.447213595499958*cEr[6]+m0r[2]-0.5*cEr[2]; 
  data->AEM_S(23,22) = 0.8944271909999161*m0r[7]-0.447213595499958*cEr[7]+m0r[1]-0.5*cEr[1]; 
  data->AEM_S(23,23) = 0.8944271909999159*m0r[5]-0.4472135954999579*cEr[5]+0.8944271909999159*m0r[4]-0.4472135954999579*cEr[4]+m0r[0]-0.5*cEr[0]; 
  data->AEM_S(23,24) = 0.8944271909999159*m0r[3]-0.4472135954999579*cEr[3]; 
  data->AEM_S(23,25) = 0.8944271909999159*m0r[3]-0.4472135954999579*cEr[3]; 
  data->AEM_S(23,26) = 0.8783100656536798*m0r[8]-0.4391550328268399*cEr[8]+0.8*m0r[7]-0.4*cEr[7]+0.8944271909999161*m0r[1]-0.447213595499958*cEr[1]; 
  data->AEM_S(23,27) = 0.8783100656536798*m0r[9]-0.4391550328268399*cEr[9]+0.8*m0r[6]-0.4*cEr[6]+0.8944271909999161*m0r[2]-0.447213595499958*cEr[2]; 
  data->AEM_S(23,28) = 0.8783100656536798*m0r[6]-0.4391550328268399*cEr[6]; 
  data->AEM_S(23,29) = 0.8783100656536798*m0r[7]-0.4391550328268399*cEr[7]; 
  data->AEM_S(24,20) = m0r[4]-0.5*cEr[4]; 
  data->AEM_S(24,21) = 0.8783100656536796*m0r[8]-0.4391550328268398*cEr[8]+0.8944271909999159*m0r[1]-0.4472135954999579*cEr[1]; 
  data->AEM_S(24,22) = 1.0*m0r[6]-0.5000000000000001*cEr[6]; 
  data->AEM_S(24,23) = 0.8944271909999159*m0r[3]-0.4472135954999579*cEr[3]; 
  data->AEM_S(24,24) = 0.6388765649999399*m0r[4]-0.31943828249997*cEr[4]+m0r[0]-0.5*cEr[0]; 
  data->AEM_S(24,26) = 0.6388765649999399*m0r[6]-0.31943828249997*cEr[6]+1.0*m0r[2]-0.5000000000000001*cEr[2]; 
  data->AEM_S(24,27) = 0.8944271909999159*m0r[7]-0.4472135954999579*cEr[7]; 
  data->AEM_S(24,28) = 0.5962847939999438*m0r[8]-0.2981423969999719*cEr[8]+0.8783100656536796*m0r[1]-0.4391550328268398*cEr[1]; 
  data->AEM_S(25,20) = m0r[5]-0.5*cEr[5]; 
  data->AEM_S(25,21) = 1.0*m0r[7]-0.5000000000000001*cEr[7]; 
  data->AEM_S(25,22) = 0.8783100656536796*m0r[9]-0.4391550328268398*cEr[9]+0.8944271909999159*m0r[2]-0.4472135954999579*cEr[2]; 
  data->AEM_S(25,23) = 0.8944271909999159*m0r[3]-0.4472135954999579*cEr[3]; 
  data->AEM_S(25,25) = 0.6388765649999399*m0r[5]-0.31943828249997*cEr[5]+m0r[0]-0.5*cEr[0]; 
  data->AEM_S(25,26) = 0.8944271909999159*m0r[6]-0.4472135954999579*cEr[6]; 
  data->AEM_S(25,27) = 0.6388765649999399*m0r[7]-0.31943828249997*cEr[7]+1.0*m0r[1]-0.5000000000000001*cEr[1]; 
  data->AEM_S(25,29) = 0.5962847939999438*m0r[9]-0.2981423969999719*cEr[9]+0.8783100656536796*m0r[2]-0.4391550328268398*cEr[2]; 
  data->AEM_S(26,20) = m0r[6]-0.5*cEr[6]; 
  data->AEM_S(26,21) = 0.8944271909999161*m0r[3]-0.447213595499958*cEr[3]; 
  data->AEM_S(26,22) = 1.0*m0r[4]-0.5000000000000001*cEr[4]; 
  data->AEM_S(26,23) = 0.8783100656536798*m0r[8]-0.4391550328268399*cEr[8]+0.8*m0r[7]-0.4*cEr[7]+0.8944271909999161*m0r[1]-0.447213595499958*cEr[1]; 
  data->AEM_S(26,24) = 0.6388765649999399*m0r[6]-0.31943828249997*cEr[6]+1.0*m0r[2]-0.5000000000000001*cEr[2]; 
  data->AEM_S(26,25) = 0.8944271909999159*m0r[6]-0.4472135954999579*cEr[6]; 
  data->AEM_S(26,26) = 0.8944271909999159*m0r[5]-0.4472135954999579*cEr[5]+0.6388765649999399*m0r[4]-0.31943828249997*cEr[4]+m0r[0]-0.5*cEr[0]; 
  data->AEM_S(26,27) = 0.8*m0r[3]-0.4*cEr[3]; 
  data->AEM_S(26,28) = 0.8783100656536798*m0r[3]-0.4391550328268399*cEr[3]; 
  data->AEM_S(27,20) = m0r[7]-0.5*cEr[7]; 
  data->AEM_S(27,21) = 1.0*m0r[5]-0.5000000000000001*cEr[5]; 
  data->AEM_S(27,22) = 0.8944271909999161*m0r[3]-0.447213595499958*cEr[3]; 
  data->AEM_S(27,23) = 0.8783100656536798*m0r[9]-0.4391550328268399*cEr[9]+0.8*m0r[6]-0.4*cEr[6]+0.8944271909999161*m0r[2]-0.447213595499958*cEr[2]; 
  data->AEM_S(27,24) = 0.8944271909999159*m0r[7]-0.4472135954999579*cEr[7]; 
  data->AEM_S(27,25) = 0.6388765649999399*m0r[7]-0.31943828249997*cEr[7]+1.0*m0r[1]-0.5000000000000001*cEr[1]; 
  data->AEM_S(27,26) = 0.8*m0r[3]-0.4*cEr[3]; 
  data->AEM_S(27,27) = 0.6388765649999399*m0r[5]-0.31943828249997*cEr[5]+0.8944271909999159*m0r[4]-0.4472135954999579*cEr[4]+m0r[0]-0.5*cEr[0]; 
  data->AEM_S(27,29) = 0.8783100656536798*m0r[3]-0.4391550328268399*cEr[3]; 
  data->AEM_S(28,20) = m0r[8]-0.5*cEr[8]; 
  data->AEM_S(28,21) = 0.8783100656536796*m0r[4]-0.4391550328268398*cEr[4]; 
  data->AEM_S(28,23) = 0.8783100656536798*m0r[6]-0.4391550328268399*cEr[6]; 
  data->AEM_S(28,24) = 0.5962847939999438*m0r[8]-0.2981423969999719*cEr[8]+0.8783100656536796*m0r[1]-0.4391550328268398*cEr[1]; 
  data->AEM_S(28,26) = 0.8783100656536798*m0r[3]-0.4391550328268399*cEr[3]; 
  data->AEM_S(28,28) = 0.5962847939999438*m0r[4]-0.2981423969999719*cEr[4]+m0r[0]-0.5*cEr[0]; 
  data->AEM_S(29,20) = m0r[9]-0.5*cEr[9]; 
  data->AEM_S(29,22) = 0.8783100656536796*m0r[5]-0.4391550328268398*cEr[5]; 
  data->AEM_S(29,23) = 0.8783100656536798*m0r[7]-0.4391550328268399*cEr[7]; 
  data->AEM_S(29,25) = 0.5962847939999438*m0r[9]-0.2981423969999719*cEr[9]+0.8783100656536796*m0r[2]-0.4391550328268398*cEr[2]; 
  data->AEM_S(29,27) = 0.8783100656536798*m0r[3]-0.4391550328268399*cEr[3]; 
  data->AEM_S(29,29) = 0.5962847939999438*m0r[5]-0.2981423969999719*cEr[5]+m0r[0]-0.5*cEr[0]; 
