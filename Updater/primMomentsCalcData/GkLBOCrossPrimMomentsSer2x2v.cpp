...
{ 
  ...
  data->AEM_S(0,4) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(0,5) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(0,6) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(0,7) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(1,4) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(1,5) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(1,6) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(1,7) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(2,4) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(2,5) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(2,6) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(2,7) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(3,4) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,5) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(3,6) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(3,7) = -0.5*cMrSelf[0]*mnuSelf; 
  ...
  data->AEM_S(0,12) = -0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(0,13) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(0,14) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(0,15) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(1,12) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(1,13) = -0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(1,14) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(1,15) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(2,12) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(2,13) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(2,14) = -0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(2,15) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(3,12) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(3,13) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(3,14) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(3,15) = -0.5*cMrOther[0]*mnuOther; 
  ...
  data->AEM_S(4,5) = m0rSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(4,6) = m0rSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(4,7) = m0rSelf[3]*mnuSelf+0.5*m0SrSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(5,4) = m0rSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(5,5) = m0rSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(5,6) = m0rSelf[3]*mnuSelf+0.5*m0SrSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(5,7) = m0rSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(6,4) = m0rSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(6,5) = m0rSelf[3]*mnuSelf+0.5*m0SrSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(6,6) = m0rSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(6,7) = m0rSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(7,4) = m0rSelf[3]*mnuSelf+0.5*m0SrSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(7,5) = m0rSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(7,6) = m0rSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(7,7) = m0rSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
 
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(4,12) = m0rOther[0]*mnuOther+0.5*m0SrOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(4,13) = m0rOther[1]*mnuOther+0.5*m0SrOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(4,14) = m0rOther[2]*mnuOther+0.5*m0SrOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(4,15) = m0rOther[3]*mnuOther+0.5*m0SrOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(5,12) = m0rOther[1]*mnuOther+0.5*m0SrOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(5,13) = m0rOther[0]*mnuOther+0.5*m0SrOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(5,14) = m0rOther[3]*mnuOther+0.5*m0SrOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(5,15) = m0rOther[2]*mnuOther+0.5*m0SrOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(6,12) = m0rOther[2]*mnuOther+0.5*m0SrOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(6,13) = m0rOther[3]*mnuOther+0.5*m0SrOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(6,14) = m0rOther[0]*mnuOther+0.5*m0SrOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(6,15) = m0rOther[1]*mnuOther+0.5*m0SrOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(7,12) = m0rOther[3]*mnuOther+0.5*m0SrOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(7,13) = m0rOther[2]*mnuOther+0.5*m0SrOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(7,14) = m0rOther[1]*mnuOther+0.5*m0SrOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(7,15) = m0rOther[0]*mnuOther+0.5*m0SrOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  ...
  data->AEM_S(8,4) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(8,5) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(8,6) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(8,7) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(9,4) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(9,5) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(9,6) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(9,7) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(10,4) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(10,5) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(10,6) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(10,7) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(11,4) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(11,5) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(11,6) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(11,7) = -0.5*cMrSelf[0]*mnuSelf; 
  ...
  data->AEM_S(8,12) = 0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(8,13) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(8,14) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(8,15) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(9,12) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(9,13) = 0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(9,14) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(9,15) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(10,12) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(10,13) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(10,14) = 0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(10,15) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(11,12) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(11,13) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(11,14) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(11,15) = 0.5*cMrOther[0]*mnuOther; 
  ...
  data->AEM_S(12,4) = 0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(12,5) = 0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(12,6) = 0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(12,7) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf+0.5*m0SrSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(13,4) = 0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(13,5) = 0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(13,6) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf+0.5*m0SrSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(13,7) = 0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(14,4) = 0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(14,5) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf+0.5*m0SrSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(14,6) = 0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(14,7) = 0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(15,4) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf+0.5*m0SrSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(15,5) = 0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(15,6) = 0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(15,7) = 0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  ...
  data->AEM_S(12,12) = (-0.5*ucMOther[0]*mnuOther)-1.0*m0rOther[0]*mnuOther-0.5*m0SrOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(12,13) = (-0.5*ucMOther[1]*mnuOther)-1.0*m0rOther[1]*mnuOther-0.5*m0SrOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(12,14) = (-0.5*ucMOther[2]*mnuOther)-1.0*m0rOther[2]*mnuOther-0.5*m0SrOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(12,15) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther-0.5*m0SrOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(13,12) = (-0.5*ucMOther[1]*mnuOther)-1.0*m0rOther[1]*mnuOther-0.5*m0SrOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(13,13) = (-0.5*ucMOther[0]*mnuOther)-1.0*m0rOther[0]*mnuOther-0.5*m0SrOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(13,14) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther-0.5*m0SrOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(13,15) = (-0.5*ucMOther[2]*mnuOther)-1.0*m0rOther[2]*mnuOther-0.5*m0SrOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(14,12) = (-0.5*ucMOther[2]*mnuOther)-1.0*m0rOther[2]*mnuOther-0.5*m0SrOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(14,13) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther-0.5*m0SrOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(14,14) = (-0.5*ucMOther[0]*mnuOther)-1.0*m0rOther[0]*mnuOther-0.5*m0SrOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(14,15) = (-0.5*ucMOther[1]*mnuOther)-1.0*m0rOther[1]*mnuOther-0.5*m0SrOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(15,12) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther-0.5*m0SrOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(15,13) = (-0.5*ucMOther[2]*mnuOther)-1.0*m0rOther[2]*mnuOther-0.5*m0SrOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(15,14) = (-0.5*ucMOther[1]*mnuOther)-1.0*m0rOther[1]*mnuOther-0.5*m0SrOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(15,15) = (-0.5*ucMOther[0]*mnuOther)-1.0*m0rOther[0]*mnuOther-0.5*m0SrOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
...
{ 
  ...
  data->AEM_S(0,12) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(0,13) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(0,14) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(0,15) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(1,8) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(1,9) = (-0.4472135954999579*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(1,10) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(1,11) = (-0.447213595499958*cMrSelf[6]*mnuSelf)-0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(1,12) = -0.4472135954999579*cMrSelf[1]*mnuSelf; 
  data->AEM_S(1,13) = -0.5000000000000001*cMrSelf[7]*mnuSelf; 
  data->AEM_S(1,14) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(1,15) = -0.5000000000000001*cMrSelf[5]*mnuSelf; 
  data->AEM_S(2,8) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(2,9) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(2,10) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(2,11) = (-0.447213595499958*cMrSelf[7]*mnuSelf)-0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(2,12) = -0.5000000000000001*cMrSelf[6]*mnuSelf; 
  data->AEM_S(2,13) = -0.4472135954999579*cMrSelf[2]*mnuSelf; 
  data->AEM_S(2,14) = -0.5000000000000001*cMrSelf[4]*mnuSelf; 
  data->AEM_S(2,15) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,8) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,9) = (-0.447213595499958*cMrSelf[6]*mnuSelf)-0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(3,10) = (-0.447213595499958*cMrSelf[7]*mnuSelf)-0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(3,11) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.4472135954999579*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(3,12) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,13) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,14) = (-0.4*cMrSelf[7]*mnuSelf)-0.447213595499958*cMrSelf[1]*mnuSelf; 
  data->AEM_S(3,15) = (-0.4*cMrSelf[6]*mnuSelf)-0.447213595499958*cMrSelf[2]*mnuSelf; 
  data->AEM_S(4,8) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(4,9) = -0.4472135954999579*cMrSelf[1]*mnuSelf; 
  data->AEM_S(4,10) = -0.5000000000000001*cMrSelf[6]*mnuSelf; 
  data->AEM_S(4,11) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(4,12) = (-0.31943828249997*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(4,14) = (-0.31943828249997*cMrSelf[6]*mnuSelf)-0.5000000000000001*cMrSelf[2]*mnuSelf; 
  data->AEM_S(4,15) = -0.4472135954999579*cMrSelf[7]*mnuSelf; 
  data->AEM_S(5,8) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(5,9) = -0.5000000000000001*cMrSelf[7]*mnuSelf; 
  data->AEM_S(5,10) = -0.4472135954999579*cMrSelf[2]*mnuSelf; 
  data->AEM_S(5,11) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(5,13) = (-0.31943828249997*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(5,14) = -0.4472135954999579*cMrSelf[6]*mnuSelf; 
  data->AEM_S(5,15) = (-0.31943828249997*cMrSelf[7]*mnuSelf)-0.5000000000000001*cMrSelf[1]*mnuSelf; 
  data->AEM_S(6,8) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(6,9) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(6,10) = -0.5000000000000001*cMrSelf[4]*mnuSelf; 
  data->AEM_S(6,11) = (-0.4*cMrSelf[7]*mnuSelf)-0.447213595499958*cMrSelf[1]*mnuSelf; 
  data->AEM_S(6,12) = (-0.31943828249997*cMrSelf[6]*mnuSelf)-0.5000000000000001*cMrSelf[2]*mnuSelf; 
  data->AEM_S(6,13) = -0.4472135954999579*cMrSelf[6]*mnuSelf; 
  data->AEM_S(6,14) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.31943828249997*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(6,15) = -0.4*cMrSelf[3]*mnuSelf; 
  data->AEM_S(7,8) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(7,9) = -0.5000000000000001*cMrSelf[5]*mnuSelf; 
  data->AEM_S(7,10) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(7,11) = (-0.4*cMrSelf[6]*mnuSelf)-0.447213595499958*cMrSelf[2]*mnuSelf; 
  data->AEM_S(7,12) = -0.4472135954999579*cMrSelf[7]*mnuSelf; 
  data->AEM_S(7,13) = (-0.31943828249997*cMrSelf[7]*mnuSelf)-0.5000000000000001*cMrSelf[1]*mnuSelf; 
  data->AEM_S(7,14) = -0.4*cMrSelf[3]*mnuSelf; 
  data->AEM_S(7,15) = (-0.31943828249997*cMrSelf[5]*mnuSelf)-0.4472135954999579*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(0,24) = -0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(0,25) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(0,26) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(0,27) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(0,28) = -0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(0,29) = -0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(0,30) = -0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(0,31) = -0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(1,24) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(1,25) = (-0.4472135954999579*cMrOther[4]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(1,26) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(1,27) = (-0.447213595499958*cMrOther[6]*mnuOther)-0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(1,28) = -0.4472135954999579*cMrOther[1]*mnuOther; 
  data->AEM_S(1,29) = -0.5000000000000001*cMrOther[7]*mnuOther; 
  data->AEM_S(1,30) = -0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(1,31) = -0.5000000000000001*cMrOther[5]*mnuOther; 
  data->AEM_S(2,24) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(2,25) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(2,26) = (-0.4472135954999579*cMrOther[5]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(2,27) = (-0.447213595499958*cMrOther[7]*mnuOther)-0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(2,28) = -0.5000000000000001*cMrOther[6]*mnuOther; 
  data->AEM_S(2,29) = -0.4472135954999579*cMrOther[2]*mnuOther; 
  data->AEM_S(2,30) = -0.5000000000000001*cMrOther[4]*mnuOther; 
  data->AEM_S(2,31) = -0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(3,24) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(3,25) = (-0.447213595499958*cMrOther[6]*mnuOther)-0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(3,26) = (-0.447213595499958*cMrOther[7]*mnuOther)-0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(3,27) = (-0.4472135954999579*cMrOther[5]*mnuOther)-0.4472135954999579*cMrOther[4]*mnuOther-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(3,28) = -0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(3,29) = -0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(3,30) = (-0.4*cMrOther[7]*mnuOther)-0.447213595499958*cMrOther[1]*mnuOther; 
  data->AEM_S(3,31) = (-0.4*cMrOther[6]*mnuOther)-0.447213595499958*cMrOther[2]*mnuOther; 
  data->AEM_S(4,24) = -0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(4,25) = -0.4472135954999579*cMrOther[1]*mnuOther; 
  data->AEM_S(4,26) = -0.5000000000000001*cMrOther[6]*mnuOther; 
  data->AEM_S(4,27) = -0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(4,28) = (-0.31943828249997*cMrOther[4]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(4,30) = (-0.31943828249997*cMrOther[6]*mnuOther)-0.5000000000000001*cMrOther[2]*mnuOther; 
  data->AEM_S(4,31) = -0.4472135954999579*cMrOther[7]*mnuOther; 
  data->AEM_S(5,24) = -0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(5,25) = -0.5000000000000001*cMrOther[7]*mnuOther; 
  data->AEM_S(5,26) = -0.4472135954999579*cMrOther[2]*mnuOther; 
  data->AEM_S(5,27) = -0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(5,29) = (-0.31943828249997*cMrOther[5]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(5,30) = -0.4472135954999579*cMrOther[6]*mnuOther; 
  data->AEM_S(5,31) = (-0.31943828249997*cMrOther[7]*mnuOther)-0.5000000000000001*cMrOther[1]*mnuOther; 
  data->AEM_S(6,24) = -0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(6,25) = -0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(6,26) = -0.5000000000000001*cMrOther[4]*mnuOther; 
  data->AEM_S(6,27) = (-0.4*cMrOther[7]*mnuOther)-0.447213595499958*cMrOther[1]*mnuOther; 
  data->AEM_S(6,28) = (-0.31943828249997*cMrOther[6]*mnuOther)-0.5000000000000001*cMrOther[2]*mnuOther; 
  data->AEM_S(6,29) = -0.4472135954999579*cMrOther[6]*mnuOther; 
  data->AEM_S(6,30) = (-0.4472135954999579*cMrOther[5]*mnuOther)-0.31943828249997*cMrOther[4]*mnuOther-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(6,31) = -0.4*cMrOther[3]*mnuOther; 
  data->AEM_S(7,24) = -0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(7,25) = -0.5000000000000001*cMrOther[5]*mnuOther; 
  data->AEM_S(7,26) = -0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(7,27) = (-0.4*cMrOther[6]*mnuOther)-0.447213595499958*cMrOther[2]*mnuOther; 
  data->AEM_S(7,28) = -0.4472135954999579*cMrOther[7]*mnuOther; 
  data->AEM_S(7,29) = (-0.31943828249997*cMrOther[7]*mnuOther)-0.5000000000000001*cMrOther[1]*mnuOther; 
  data->AEM_S(7,30) = -0.4*cMrOther[3]*mnuOther; 
  data->AEM_S(7,31) = (-0.31943828249997*cMrOther[5]*mnuOther)-0.4472135954999579*cMrOther[4]*mnuOther-0.5*cMrOther[0]*mnuOther; 
  ...
  // ... Block from correction to energy conservation (self) ... // 
  data->AEM_S(8,8) = 1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(8,9) = 1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(8,10) = 1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(8,11) = 1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(8,12) = 1.5*m0rSelf[4]*mnuSelf-0.5*cErSelf[4]*mnuSelf; 
  data->AEM_S(8,13) = 1.5*m0rSelf[5]*mnuSelf-0.5*cErSelf[5]*mnuSelf; 
  data->AEM_S(8,14) = 1.5*m0rSelf[6]*mnuSelf-0.5*cErSelf[6]*mnuSelf; 
  data->AEM_S(8,15) = 1.5*m0rSelf[7]*mnuSelf-0.5*cErSelf[7]*mnuSelf; 
  data->AEM_S(9,8) = 1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(9,9) = 1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(9,10) = 1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(9,11) = 1.341640786499874*m0rSelf[6]*mnuSelf-0.447213595499958*cErSelf[6]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(9,12) = 1.341640786499874*m0rSelf[1]*mnuSelf-0.4472135954999579*cErSelf[1]*mnuSelf; 
  data->AEM_S(9,13) = 1.5*m0rSelf[7]*mnuSelf-0.5000000000000001*cErSelf[7]*mnuSelf; 
  data->AEM_S(9,14) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(9,15) = 1.5*m0rSelf[5]*mnuSelf-0.5000000000000001*cErSelf[5]*mnuSelf; 
  data->AEM_S(10,8) = 1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(10,9) = 1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(10,10) = 1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(10,11) = 1.341640786499874*m0rSelf[7]*mnuSelf-0.447213595499958*cErSelf[7]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(10,12) = 1.5*m0rSelf[6]*mnuSelf-0.5000000000000001*cErSelf[6]*mnuSelf; 
  data->AEM_S(10,13) = 1.341640786499874*m0rSelf[2]*mnuSelf-0.4472135954999579*cErSelf[2]*mnuSelf; 
  data->AEM_S(10,14) = 1.5*m0rSelf[4]*mnuSelf-0.5000000000000001*cErSelf[4]*mnuSelf; 
  data->AEM_S(10,15) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(11,8) = 1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(11,9) = 1.341640786499874*m0rSelf[6]*mnuSelf-0.447213595499958*cErSelf[6]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(11,10) = 1.341640786499874*m0rSelf[7]*mnuSelf-0.447213595499958*cErSelf[7]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(11,11) = 1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(11,12) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(11,13) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(11,14) = 1.2*m0rSelf[7]*mnuSelf-0.4*cErSelf[7]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.447213595499958*cErSelf[1]*mnuSelf; 
  data->AEM_S(11,15) = 1.2*m0rSelf[6]*mnuSelf-0.4*cErSelf[6]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.447213595499958*cErSelf[2]*mnuSelf; 
  data->AEM_S(12,8) = 1.5*m0rSelf[4]*mnuSelf-0.5*cErSelf[4]*mnuSelf; 
  data->AEM_S(12,9) = 1.341640786499874*m0rSelf[1]*mnuSelf-0.4472135954999579*cErSelf[1]*mnuSelf; 
  data->AEM_S(12,10) = 1.5*m0rSelf[6]*mnuSelf-0.5000000000000001*cErSelf[6]*mnuSelf; 
  data->AEM_S(12,11) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(12,12) = 0.9583148474999099*m0rSelf[4]*mnuSelf-0.31943828249997*cErSelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(12,14) = 0.9583148474999099*m0rSelf[6]*mnuSelf-0.31943828249997*cErSelf[6]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5000000000000001*cErSelf[2]*mnuSelf; 
  data->AEM_S(12,15) = 1.341640786499874*m0rSelf[7]*mnuSelf-0.4472135954999579*cErSelf[7]*mnuSelf; 
  data->AEM_S(13,8) = 1.5*m0rSelf[5]*mnuSelf-0.5*cErSelf[5]*mnuSelf; 
  data->AEM_S(13,9) = 1.5*m0rSelf[7]*mnuSelf-0.5000000000000001*cErSelf[7]*mnuSelf; 
  data->AEM_S(13,10) = 1.341640786499874*m0rSelf[2]*mnuSelf-0.4472135954999579*cErSelf[2]*mnuSelf; 
  data->AEM_S(13,11) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(13,13) = 0.9583148474999099*m0rSelf[5]*mnuSelf-0.31943828249997*cErSelf[5]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(13,14) = 1.341640786499874*m0rSelf[6]*mnuSelf-0.4472135954999579*cErSelf[6]*mnuSelf; 
  data->AEM_S(13,15) = 0.9583148474999099*m0rSelf[7]*mnuSelf-0.31943828249997*cErSelf[7]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5000000000000001*cErSelf[1]*mnuSelf; 
  data->AEM_S(14,8) = 1.5*m0rSelf[6]*mnuSelf-0.5*cErSelf[6]*mnuSelf; 
  data->AEM_S(14,9) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(14,10) = 1.5*m0rSelf[4]*mnuSelf-0.5000000000000001*cErSelf[4]*mnuSelf; 
  data->AEM_S(14,11) = 1.2*m0rSelf[7]*mnuSelf-0.4*cErSelf[7]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.447213595499958*cErSelf[1]*mnuSelf; 
  data->AEM_S(14,12) = 0.9583148474999099*m0rSelf[6]*mnuSelf-0.31943828249997*cErSelf[6]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5000000000000001*cErSelf[2]*mnuSelf; 
  data->AEM_S(14,13) = 1.341640786499874*m0rSelf[6]*mnuSelf-0.4472135954999579*cErSelf[6]*mnuSelf; 
  data->AEM_S(14,14) = 1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+0.9583148474999099*m0rSelf[4]*mnuSelf-0.31943828249997*cErSelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(14,15) = 1.2*m0rSelf[3]*mnuSelf-0.4*cErSelf[3]*mnuSelf; 
  data->AEM_S(15,8) = 1.5*m0rSelf[7]*mnuSelf-0.5*cErSelf[7]*mnuSelf; 
  data->AEM_S(15,9) = 1.5*m0rSelf[5]*mnuSelf-0.5000000000000001*cErSelf[5]*mnuSelf; 
  data->AEM_S(15,10) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(15,11) = 1.2*m0rSelf[6]*mnuSelf-0.4*cErSelf[6]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.447213595499958*cErSelf[2]*mnuSelf; 
  data->AEM_S(15,12) = 1.341640786499874*m0rSelf[7]*mnuSelf-0.4472135954999579*cErSelf[7]*mnuSelf; 
  data->AEM_S(15,13) = 0.9583148474999099*m0rSelf[7]*mnuSelf-0.31943828249997*cErSelf[7]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5000000000000001*cErSelf[1]*mnuSelf; 
  data->AEM_S(15,14) = 1.2*m0rSelf[3]*mnuSelf-0.4*cErSelf[3]*mnuSelf; 
  data->AEM_S(15,15) = 0.9583148474999099*m0rSelf[5]*mnuSelf-0.31943828249997*cErSelf[5]*mnuSelf+1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
 
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(8,24) = 1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(8,25) = 1.5*m0rOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(8,26) = 1.5*m0rOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(8,27) = 1.5*m0rOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(8,28) = 1.5*m0rOther[4]*mnuOther-0.5*cErOther[4]*mnuOther; 
  data->AEM_S(8,29) = 1.5*m0rOther[5]*mnuOther-0.5*cErOther[5]*mnuOther; 
  data->AEM_S(8,30) = 1.5*m0rOther[6]*mnuOther-0.5*cErOther[6]*mnuOther; 
  data->AEM_S(8,31) = 1.5*m0rOther[7]*mnuOther-0.5*cErOther[7]*mnuOther; 
  data->AEM_S(9,24) = 1.5*m0rOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(9,25) = 1.341640786499874*m0rOther[4]*mnuOther-0.4472135954999579*cErOther[4]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(9,26) = 1.5*m0rOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(9,27) = 1.341640786499874*m0rOther[6]*mnuOther-0.447213595499958*cErOther[6]*mnuOther+1.5*m0rOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(9,28) = 1.341640786499874*m0rOther[1]*mnuOther-0.4472135954999579*cErOther[1]*mnuOther; 
  data->AEM_S(9,29) = 1.5*m0rOther[7]*mnuOther-0.5000000000000001*cErOther[7]*mnuOther; 
  data->AEM_S(9,30) = 1.341640786499874*m0rOther[3]*mnuOther-0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(9,31) = 1.5*m0rOther[5]*mnuOther-0.5000000000000001*cErOther[5]*mnuOther; 
  data->AEM_S(10,24) = 1.5*m0rOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(10,25) = 1.5*m0rOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(10,26) = 1.341640786499874*m0rOther[5]*mnuOther-0.4472135954999579*cErOther[5]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(10,27) = 1.341640786499874*m0rOther[7]*mnuOther-0.447213595499958*cErOther[7]*mnuOther+1.5*m0rOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(10,28) = 1.5*m0rOther[6]*mnuOther-0.5000000000000001*cErOther[6]*mnuOther; 
  data->AEM_S(10,29) = 1.341640786499874*m0rOther[2]*mnuOther-0.4472135954999579*cErOther[2]*mnuOther; 
  data->AEM_S(10,30) = 1.5*m0rOther[4]*mnuOther-0.5000000000000001*cErOther[4]*mnuOther; 
  data->AEM_S(10,31) = 1.341640786499874*m0rOther[3]*mnuOther-0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(11,24) = 1.5*m0rOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(11,25) = 1.341640786499874*m0rOther[6]*mnuOther-0.447213595499958*cErOther[6]*mnuOther+1.5*m0rOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(11,26) = 1.341640786499874*m0rOther[7]*mnuOther-0.447213595499958*cErOther[7]*mnuOther+1.5*m0rOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(11,27) = 1.341640786499874*m0rOther[5]*mnuOther-0.4472135954999579*cErOther[5]*mnuOther+1.341640786499874*m0rOther[4]*mnuOther-0.4472135954999579*cErOther[4]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(11,28) = 1.341640786499874*m0rOther[3]*mnuOther-0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(11,29) = 1.341640786499874*m0rOther[3]*mnuOther-0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(11,30) = 1.2*m0rOther[7]*mnuOther-0.4*cErOther[7]*mnuOther+1.341640786499874*m0rOther[1]*mnuOther-0.447213595499958*cErOther[1]*mnuOther; 
  data->AEM_S(11,31) = 1.2*m0rOther[6]*mnuOther-0.4*cErOther[6]*mnuOther+1.341640786499874*m0rOther[2]*mnuOther-0.447213595499958*cErOther[2]*mnuOther; 
  data->AEM_S(12,24) = 1.5*m0rOther[4]*mnuOther-0.5*cErOther[4]*mnuOther; 
  data->AEM_S(12,25) = 1.341640786499874*m0rOther[1]*mnuOther-0.4472135954999579*cErOther[1]*mnuOther; 
  data->AEM_S(12,26) = 1.5*m0rOther[6]*mnuOther-0.5000000000000001*cErOther[6]*mnuOther; 
  data->AEM_S(12,27) = 1.341640786499874*m0rOther[3]*mnuOther-0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(12,28) = 0.9583148474999099*m0rOther[4]*mnuOther-0.31943828249997*cErOther[4]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(12,30) = 0.9583148474999099*m0rOther[6]*mnuOther-0.31943828249997*cErOther[6]*mnuOther+1.5*m0rOther[2]*mnuOther-0.5000000000000001*cErOther[2]*mnuOther; 
  data->AEM_S(12,31) = 1.341640786499874*m0rOther[7]*mnuOther-0.4472135954999579*cErOther[7]*mnuOther; 
  data->AEM_S(13,24) = 1.5*m0rOther[5]*mnuOther-0.5*cErOther[5]*mnuOther; 
  data->AEM_S(13,25) = 1.5*m0rOther[7]*mnuOther-0.5000000000000001*cErOther[7]*mnuOther; 
  data->AEM_S(13,26) = 1.341640786499874*m0rOther[2]*mnuOther-0.4472135954999579*cErOther[2]*mnuOther; 
  data->AEM_S(13,27) = 1.341640786499874*m0rOther[3]*mnuOther-0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(13,29) = 0.9583148474999099*m0rOther[5]*mnuOther-0.31943828249997*cErOther[5]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(13,30) = 1.341640786499874*m0rOther[6]*mnuOther-0.4472135954999579*cErOther[6]*mnuOther; 
  data->AEM_S(13,31) = 0.9583148474999099*m0rOther[7]*mnuOther-0.31943828249997*cErOther[7]*mnuOther+1.5*m0rOther[1]*mnuOther-0.5000000000000001*cErOther[1]*mnuOther; 
  data->AEM_S(14,24) = 1.5*m0rOther[6]*mnuOther-0.5*cErOther[6]*mnuOther; 
  data->AEM_S(14,25) = 1.341640786499874*m0rOther[3]*mnuOther-0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(14,26) = 1.5*m0rOther[4]*mnuOther-0.5000000000000001*cErOther[4]*mnuOther; 
  data->AEM_S(14,27) = 1.2*m0rOther[7]*mnuOther-0.4*cErOther[7]*mnuOther+1.341640786499874*m0rOther[1]*mnuOther-0.447213595499958*cErOther[1]*mnuOther; 
  data->AEM_S(14,28) = 0.9583148474999099*m0rOther[6]*mnuOther-0.31943828249997*cErOther[6]*mnuOther+1.5*m0rOther[2]*mnuOther-0.5000000000000001*cErOther[2]*mnuOther; 
  data->AEM_S(14,29) = 1.341640786499874*m0rOther[6]*mnuOther-0.4472135954999579*cErOther[6]*mnuOther; 
  data->AEM_S(14,30) = 1.341640786499874*m0rOther[5]*mnuOther-0.4472135954999579*cErOther[5]*mnuOther+0.9583148474999099*m0rOther[4]*mnuOther-0.31943828249997*cErOther[4]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(14,31) = 1.2*m0rOther[3]*mnuOther-0.4*cErOther[3]*mnuOther; 
  data->AEM_S(15,24) = 1.5*m0rOther[7]*mnuOther-0.5*cErOther[7]*mnuOther; 
  data->AEM_S(15,25) = 1.5*m0rOther[5]*mnuOther-0.5000000000000001*cErOther[5]*mnuOther; 
  data->AEM_S(15,26) = 1.341640786499874*m0rOther[3]*mnuOther-0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(15,27) = 1.2*m0rOther[6]*mnuOther-0.4*cErOther[6]*mnuOther+1.341640786499874*m0rOther[2]*mnuOther-0.447213595499958*cErOther[2]*mnuOther; 
  data->AEM_S(15,28) = 1.341640786499874*m0rOther[7]*mnuOther-0.4472135954999579*cErOther[7]*mnuOther; 
  data->AEM_S(15,29) = 0.9583148474999099*m0rOther[7]*mnuOther-0.31943828249997*cErOther[7]*mnuOther+1.5*m0rOther[1]*mnuOther-0.5000000000000001*cErOther[1]*mnuOther; 
  data->AEM_S(15,30) = 1.2*m0rOther[3]*mnuOther-0.4*cErOther[3]*mnuOther; 
  data->AEM_S(15,31) = 0.9583148474999099*m0rOther[5]*mnuOther-0.31943828249997*cErOther[5]*mnuOther+1.341640786499874*m0rOther[4]*mnuOther-0.4472135954999579*cErOther[4]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  ...
  // ... Block from correction to (self) 1st moment of collision operator ... // 
  data->AEM_S(16,8) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(16,9) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(16,10) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(16,11) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(16,12) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(16,13) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(16,14) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(16,15) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(17,8) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(17,9) = (-0.4472135954999579*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(17,10) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(17,11) = (-0.447213595499958*cMrSelf[6]*mnuSelf)-0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(17,12) = -0.4472135954999579*cMrSelf[1]*mnuSelf; 
  data->AEM_S(17,13) = -0.5000000000000001*cMrSelf[7]*mnuSelf; 
  data->AEM_S(17,14) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(17,15) = -0.5000000000000001*cMrSelf[5]*mnuSelf; 
  data->AEM_S(18,8) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(18,9) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(18,10) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(18,11) = (-0.447213595499958*cMrSelf[7]*mnuSelf)-0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(18,12) = -0.5000000000000001*cMrSelf[6]*mnuSelf; 
  data->AEM_S(18,13) = -0.4472135954999579*cMrSelf[2]*mnuSelf; 
  data->AEM_S(18,14) = -0.5000000000000001*cMrSelf[4]*mnuSelf; 
  data->AEM_S(18,15) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(19,8) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(19,9) = (-0.447213595499958*cMrSelf[6]*mnuSelf)-0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(19,10) = (-0.447213595499958*cMrSelf[7]*mnuSelf)-0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(19,11) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.4472135954999579*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(19,12) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(19,13) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(19,14) = (-0.4*cMrSelf[7]*mnuSelf)-0.447213595499958*cMrSelf[1]*mnuSelf; 
  data->AEM_S(19,15) = (-0.4*cMrSelf[6]*mnuSelf)-0.447213595499958*cMrSelf[2]*mnuSelf; 
  data->AEM_S(20,8) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(20,9) = -0.4472135954999579*cMrSelf[1]*mnuSelf; 
  data->AEM_S(20,10) = -0.5000000000000001*cMrSelf[6]*mnuSelf; 
  data->AEM_S(20,11) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(20,12) = (-0.31943828249997*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(20,14) = (-0.31943828249997*cMrSelf[6]*mnuSelf)-0.5000000000000001*cMrSelf[2]*mnuSelf; 
  data->AEM_S(20,15) = -0.4472135954999579*cMrSelf[7]*mnuSelf; 
  data->AEM_S(21,8) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(21,9) = -0.5000000000000001*cMrSelf[7]*mnuSelf; 
  data->AEM_S(21,10) = -0.4472135954999579*cMrSelf[2]*mnuSelf; 
  data->AEM_S(21,11) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(21,13) = (-0.31943828249997*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(21,14) = -0.4472135954999579*cMrSelf[6]*mnuSelf; 
  data->AEM_S(21,15) = (-0.31943828249997*cMrSelf[7]*mnuSelf)-0.5000000000000001*cMrSelf[1]*mnuSelf; 
  data->AEM_S(22,8) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(22,9) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(22,10) = -0.5000000000000001*cMrSelf[4]*mnuSelf; 
  data->AEM_S(22,11) = (-0.4*cMrSelf[7]*mnuSelf)-0.447213595499958*cMrSelf[1]*mnuSelf; 
  data->AEM_S(22,12) = (-0.31943828249997*cMrSelf[6]*mnuSelf)-0.5000000000000001*cMrSelf[2]*mnuSelf; 
  data->AEM_S(22,13) = -0.4472135954999579*cMrSelf[6]*mnuSelf; 
  data->AEM_S(22,14) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.31943828249997*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(22,15) = -0.4*cMrSelf[3]*mnuSelf; 
  data->AEM_S(23,8) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(23,9) = -0.5000000000000001*cMrSelf[5]*mnuSelf; 
  data->AEM_S(23,10) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(23,11) = (-0.4*cMrSelf[6]*mnuSelf)-0.447213595499958*cMrSelf[2]*mnuSelf; 
  data->AEM_S(23,12) = -0.4472135954999579*cMrSelf[7]*mnuSelf; 
  data->AEM_S(23,13) = (-0.31943828249997*cMrSelf[7]*mnuSelf)-0.5000000000000001*cMrSelf[1]*mnuSelf; 
  data->AEM_S(23,14) = -0.4*cMrSelf[3]*mnuSelf; 
  data->AEM_S(23,15) = (-0.31943828249997*cMrSelf[5]*mnuSelf)-0.4472135954999579*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to (other) 1st moment of collision operator ... // 
  data->AEM_S(16,24) = 0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(16,25) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(16,26) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(16,27) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(16,28) = 0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(16,29) = 0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(16,30) = 0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(16,31) = 0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(17,24) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(17,25) = 0.4472135954999579*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(17,26) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(17,27) = 0.447213595499958*cMrOther[6]*mnuOther+0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(17,28) = 0.4472135954999579*cMrOther[1]*mnuOther; 
  data->AEM_S(17,29) = 0.5000000000000001*cMrOther[7]*mnuOther; 
  data->AEM_S(17,30) = 0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(17,31) = 0.5000000000000001*cMrOther[5]*mnuOther; 
  data->AEM_S(18,24) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(18,25) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(18,26) = 0.4472135954999579*cMrOther[5]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(18,27) = 0.447213595499958*cMrOther[7]*mnuOther+0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(18,28) = 0.5000000000000001*cMrOther[6]*mnuOther; 
  data->AEM_S(18,29) = 0.4472135954999579*cMrOther[2]*mnuOther; 
  data->AEM_S(18,30) = 0.5000000000000001*cMrOther[4]*mnuOther; 
  data->AEM_S(18,31) = 0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(19,24) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(19,25) = 0.447213595499958*cMrOther[6]*mnuOther+0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(19,26) = 0.447213595499958*cMrOther[7]*mnuOther+0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(19,27) = 0.4472135954999579*cMrOther[5]*mnuOther+0.4472135954999579*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(19,28) = 0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(19,29) = 0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(19,30) = 0.4*cMrOther[7]*mnuOther+0.447213595499958*cMrOther[1]*mnuOther; 
  data->AEM_S(19,31) = 0.4*cMrOther[6]*mnuOther+0.447213595499958*cMrOther[2]*mnuOther; 
  data->AEM_S(20,24) = 0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(20,25) = 0.4472135954999579*cMrOther[1]*mnuOther; 
  data->AEM_S(20,26) = 0.5000000000000001*cMrOther[6]*mnuOther; 
  data->AEM_S(20,27) = 0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(20,28) = 0.31943828249997*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(20,30) = 0.31943828249997*cMrOther[6]*mnuOther+0.5000000000000001*cMrOther[2]*mnuOther; 
  data->AEM_S(20,31) = 0.4472135954999579*cMrOther[7]*mnuOther; 
  data->AEM_S(21,24) = 0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(21,25) = 0.5000000000000001*cMrOther[7]*mnuOther; 
  data->AEM_S(21,26) = 0.4472135954999579*cMrOther[2]*mnuOther; 
  data->AEM_S(21,27) = 0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(21,29) = 0.31943828249997*cMrOther[5]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(21,30) = 0.4472135954999579*cMrOther[6]*mnuOther; 
  data->AEM_S(21,31) = 0.31943828249997*cMrOther[7]*mnuOther+0.5000000000000001*cMrOther[1]*mnuOther; 
  data->AEM_S(22,24) = 0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(22,25) = 0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(22,26) = 0.5000000000000001*cMrOther[4]*mnuOther; 
  data->AEM_S(22,27) = 0.4*cMrOther[7]*mnuOther+0.447213595499958*cMrOther[1]*mnuOther; 
  data->AEM_S(22,28) = 0.31943828249997*cMrOther[6]*mnuOther+0.5000000000000001*cMrOther[2]*mnuOther; 
  data->AEM_S(22,29) = 0.4472135954999579*cMrOther[6]*mnuOther; 
  data->AEM_S(22,30) = 0.4472135954999579*cMrOther[5]*mnuOther+0.31943828249997*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(22,31) = 0.4*cMrOther[3]*mnuOther; 
  data->AEM_S(23,24) = 0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(23,25) = 0.5000000000000001*cMrOther[5]*mnuOther; 
  data->AEM_S(23,26) = 0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(23,27) = 0.4*cMrOther[6]*mnuOther+0.447213595499958*cMrOther[2]*mnuOther; 
  data->AEM_S(23,28) = 0.4472135954999579*cMrOther[7]*mnuOther; 
  data->AEM_S(23,29) = 0.31943828249997*cMrOther[7]*mnuOther+0.5000000000000001*cMrOther[1]*mnuOther; 
  data->AEM_S(23,30) = 0.4*cMrOther[3]*mnuOther; 
  data->AEM_S(23,31) = 0.31943828249997*cMrOther[5]*mnuOther+0.4472135954999579*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  ...
  // ... Block from correction to (self) 2nd moment of collision operator ... // 
  data->AEM_S(24,8) = 0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(24,9) = 0.5*ucMSelf[1]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(24,10) = 0.5*ucMSelf[2]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(24,11) = 0.5*ucMSelf[3]*mnuSelf+1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(24,12) = 0.5*ucMSelf[4]*mnuSelf+1.5*m0rSelf[4]*mnuSelf-0.5*cErSelf[4]*mnuSelf; 
  data->AEM_S(24,13) = 0.5*ucMSelf[5]*mnuSelf+1.5*m0rSelf[5]*mnuSelf-0.5*cErSelf[5]*mnuSelf; 
  data->AEM_S(24,14) = 0.5*ucMSelf[6]*mnuSelf+1.5*m0rSelf[6]*mnuSelf-0.5*cErSelf[6]*mnuSelf; 
  data->AEM_S(24,15) = 0.5*ucMSelf[7]*mnuSelf+1.5*m0rSelf[7]*mnuSelf-0.5*cErSelf[7]*mnuSelf; 
  data->AEM_S(25,8) = 0.5*ucMSelf[1]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(25,9) = 0.4472135954999579*ucMSelf[4]*mnuSelf+1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(25,10) = 0.5*ucMSelf[3]*mnuSelf+1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(25,11) = 0.447213595499958*ucMSelf[6]*mnuSelf+1.341640786499874*m0rSelf[6]*mnuSelf-0.447213595499958*cErSelf[6]*mnuSelf+0.5*ucMSelf[2]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(25,12) = 0.4472135954999579*ucMSelf[1]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.4472135954999579*cErSelf[1]*mnuSelf; 
  data->AEM_S(25,13) = 0.5000000000000001*ucMSelf[7]*mnuSelf+1.5*m0rSelf[7]*mnuSelf-0.5000000000000001*cErSelf[7]*mnuSelf; 
  data->AEM_S(25,14) = 0.447213595499958*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(25,15) = 0.5000000000000001*ucMSelf[5]*mnuSelf+1.5*m0rSelf[5]*mnuSelf-0.5000000000000001*cErSelf[5]*mnuSelf; 
  data->AEM_S(26,8) = 0.5*ucMSelf[2]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(26,9) = 0.5*ucMSelf[3]*mnuSelf+1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(26,10) = 0.4472135954999579*ucMSelf[5]*mnuSelf+1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(26,11) = 0.447213595499958*ucMSelf[7]*mnuSelf+1.341640786499874*m0rSelf[7]*mnuSelf-0.447213595499958*cErSelf[7]*mnuSelf+0.5*ucMSelf[1]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(26,12) = 0.5000000000000001*ucMSelf[6]*mnuSelf+1.5*m0rSelf[6]*mnuSelf-0.5000000000000001*cErSelf[6]*mnuSelf; 
  data->AEM_S(26,13) = 0.4472135954999579*ucMSelf[2]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.4472135954999579*cErSelf[2]*mnuSelf; 
  data->AEM_S(26,14) = 0.5000000000000001*ucMSelf[4]*mnuSelf+1.5*m0rSelf[4]*mnuSelf-0.5000000000000001*cErSelf[4]*mnuSelf; 
  data->AEM_S(26,15) = 0.447213595499958*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(27,8) = 0.5*ucMSelf[3]*mnuSelf+1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(27,9) = 0.447213595499958*ucMSelf[6]*mnuSelf+1.341640786499874*m0rSelf[6]*mnuSelf-0.447213595499958*cErSelf[6]*mnuSelf+0.5*ucMSelf[2]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(27,10) = 0.447213595499958*ucMSelf[7]*mnuSelf+1.341640786499874*m0rSelf[7]*mnuSelf-0.447213595499958*cErSelf[7]*mnuSelf+0.5*ucMSelf[1]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  ...
  data->AEM_S(27,12) = 0.4472135954999579*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(27,13) = 0.4472135954999579*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(27,14) = 0.4*ucMSelf[7]*mnuSelf+1.2*m0rSelf[7]*mnuSelf-0.4*cErSelf[7]*mnuSelf+0.447213595499958*ucMSelf[1]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.447213595499958*cErSelf[1]*mnuSelf; 
  data->AEM_S(27,15) = 0.4*ucMSelf[6]*mnuSelf+1.2*m0rSelf[6]*mnuSelf-0.4*cErSelf[6]*mnuSelf+0.447213595499958*ucMSelf[2]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.447213595499958*cErSelf[2]*mnuSelf; 
  data->AEM_S(28,8) = 0.5*ucMSelf[4]*mnuSelf+1.5*m0rSelf[4]*mnuSelf-0.5*cErSelf[4]*mnuSelf; 
  data->AEM_S(28,9) = 0.4472135954999579*ucMSelf[1]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.4472135954999579*cErSelf[1]*mnuSelf; 
  data->AEM_S(28,10) = 0.5000000000000001*ucMSelf[6]*mnuSelf+1.5*m0rSelf[6]*mnuSelf-0.5000000000000001*cErSelf[6]*mnuSelf; 
  data->AEM_S(28,11) = 0.4472135954999579*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(28,12) = 0.31943828249997*ucMSelf[4]*mnuSelf+0.9583148474999099*m0rSelf[4]*mnuSelf-0.31943828249997*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(28,14) = 0.31943828249997*ucMSelf[6]*mnuSelf+0.9583148474999099*m0rSelf[6]*mnuSelf-0.31943828249997*cErSelf[6]*mnuSelf+0.5000000000000001*ucMSelf[2]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5000000000000001*cErSelf[2]*mnuSelf; 
  data->AEM_S(28,15) = 0.4472135954999579*ucMSelf[7]*mnuSelf+1.341640786499874*m0rSelf[7]*mnuSelf-0.4472135954999579*cErSelf[7]*mnuSelf; 
  data->AEM_S(29,8) = 0.5*ucMSelf[5]*mnuSelf+1.5*m0rSelf[5]*mnuSelf-0.5*cErSelf[5]*mnuSelf; 
  data->AEM_S(29,9) = 0.5000000000000001*ucMSelf[7]*mnuSelf+1.5*m0rSelf[7]*mnuSelf-0.5000000000000001*cErSelf[7]*mnuSelf; 
  data->AEM_S(29,10) = 0.4472135954999579*ucMSelf[2]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.4472135954999579*cErSelf[2]*mnuSelf; 
  data->AEM_S(29,11) = 0.4472135954999579*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(29,13) = 0.31943828249997*ucMSelf[5]*mnuSelf+0.9583148474999099*m0rSelf[5]*mnuSelf-0.31943828249997*cErSelf[5]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(29,14) = 0.4472135954999579*ucMSelf[6]*mnuSelf+1.341640786499874*m0rSelf[6]*mnuSelf-0.4472135954999579*cErSelf[6]*mnuSelf; 
  data->AEM_S(29,15) = 0.31943828249997*ucMSelf[7]*mnuSelf+0.9583148474999099*m0rSelf[7]*mnuSelf-0.31943828249997*cErSelf[7]*mnuSelf+0.5000000000000001*ucMSelf[1]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5000000000000001*cErSelf[1]*mnuSelf; 
  data->AEM_S(30,8) = 0.5*ucMSelf[6]*mnuSelf+1.5*m0rSelf[6]*mnuSelf-0.5*cErSelf[6]*mnuSelf; 
  data->AEM_S(30,9) = 0.447213595499958*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(30,10) = 0.5000000000000001*ucMSelf[4]*mnuSelf+1.5*m0rSelf[4]*mnuSelf-0.5000000000000001*cErSelf[4]*mnuSelf; 
  data->AEM_S(30,11) = 0.4*ucMSelf[7]*mnuSelf+1.2*m0rSelf[7]*mnuSelf-0.4*cErSelf[7]*mnuSelf+0.447213595499958*ucMSelf[1]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.447213595499958*cErSelf[1]*mnuSelf; 
  data->AEM_S(30,12) = 0.31943828249997*ucMSelf[6]*mnuSelf+0.9583148474999099*m0rSelf[6]*mnuSelf-0.31943828249997*cErSelf[6]*mnuSelf+0.5000000000000001*ucMSelf[2]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5000000000000001*cErSelf[2]*mnuSelf; 
  data->AEM_S(30,13) = 0.4472135954999579*ucMSelf[6]*mnuSelf+1.341640786499874*m0rSelf[6]*mnuSelf-0.4472135954999579*cErSelf[6]*mnuSelf; 
  data->AEM_S(30,14) = 0.4472135954999579*ucMSelf[5]*mnuSelf+1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+0.31943828249997*ucMSelf[4]*mnuSelf+0.9583148474999099*m0rSelf[4]*mnuSelf-0.31943828249997*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(30,15) = 0.4*ucMSelf[3]*mnuSelf+1.2*m0rSelf[3]*mnuSelf-0.4*cErSelf[3]*mnuSelf; 
  data->AEM_S(31,8) = 0.5*ucMSelf[7]*mnuSelf+1.5*m0rSelf[7]*mnuSelf-0.5*cErSelf[7]*mnuSelf; 
  data->AEM_S(31,9) = 0.5000000000000001*ucMSelf[5]*mnuSelf+1.5*m0rSelf[5]*mnuSelf-0.5000000000000001*cErSelf[5]*mnuSelf; 
  data->AEM_S(31,10) = 0.447213595499958*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(31,11) = 0.4*ucMSelf[6]*mnuSelf+1.2*m0rSelf[6]*mnuSelf-0.4*cErSelf[6]*mnuSelf+0.447213595499958*ucMSelf[2]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.447213595499958*cErSelf[2]*mnuSelf; 
  data->AEM_S(31,12) = 0.4472135954999579*ucMSelf[7]*mnuSelf+1.341640786499874*m0rSelf[7]*mnuSelf-0.4472135954999579*cErSelf[7]*mnuSelf; 
  data->AEM_S(31,13) = 0.31943828249997*ucMSelf[7]*mnuSelf+0.9583148474999099*m0rSelf[7]*mnuSelf-0.31943828249997*cErSelf[7]*mnuSelf+0.5000000000000001*ucMSelf[1]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5000000000000001*cErSelf[1]*mnuSelf; 
  data->AEM_S(31,14) = 0.4*ucMSelf[3]*mnuSelf+1.2*m0rSelf[3]*mnuSelf-0.4*cErSelf[3]*mnuSelf; 
  data->AEM_S(31,15) = 0.31943828249997*ucMSelf[5]*mnuSelf+0.9583148474999099*m0rSelf[5]*mnuSelf-0.31943828249997*cErSelf[5]*mnuSelf+0.4472135954999579*ucMSelf[4]*mnuSelf+1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to (other) 2nd moment of collision operator ... // 
  data->AEM_S(24,24) = (-0.5*ucMOther[0]*mnuOther)-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(24,25) = (-0.5*ucMOther[1]*mnuOther)-1.5*m0rOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(24,26) = (-0.5*ucMOther[2]*mnuOther)-1.5*m0rOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(24,27) = (-0.5*ucMOther[3]*mnuOther)-1.5*m0rOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(24,28) = (-0.5*ucMOther[4]*mnuOther)-1.5*m0rOther[4]*mnuOther+0.5*cErOther[4]*mnuOther; 
  data->AEM_S(24,29) = (-0.5*ucMOther[5]*mnuOther)-1.5*m0rOther[5]*mnuOther+0.5*cErOther[5]*mnuOther; 
  data->AEM_S(24,30) = (-0.5*ucMOther[6]*mnuOther)-1.5*m0rOther[6]*mnuOther+0.5*cErOther[6]*mnuOther; 
  data->AEM_S(24,31) = (-0.5*ucMOther[7]*mnuOther)-1.5*m0rOther[7]*mnuOther+0.5*cErOther[7]*mnuOther; 
  data->AEM_S(25,24) = (-0.5*ucMOther[1]*mnuOther)-1.5*m0rOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(25,25) = (-0.4472135954999579*ucMOther[4]*mnuOther)-1.341640786499874*m0rOther[4]*mnuOther+0.4472135954999579*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(25,26) = (-0.5*ucMOther[3]*mnuOther)-1.5*m0rOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(25,27) = (-0.447213595499958*ucMOther[6]*mnuOther)-1.341640786499874*m0rOther[6]*mnuOther+0.447213595499958*cErOther[6]*mnuOther-0.5*ucMOther[2]*mnuOther-1.5*m0rOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(25,28) = (-0.4472135954999579*ucMOther[1]*mnuOther)-1.341640786499874*m0rOther[1]*mnuOther+0.4472135954999579*cErOther[1]*mnuOther; 
  data->AEM_S(25,29) = (-0.5000000000000001*ucMOther[7]*mnuOther)-1.5*m0rOther[7]*mnuOther+0.5000000000000001*cErOther[7]*mnuOther; 
  data->AEM_S(25,30) = (-0.447213595499958*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(25,31) = (-0.5000000000000001*ucMOther[5]*mnuOther)-1.5*m0rOther[5]*mnuOther+0.5000000000000001*cErOther[5]*mnuOther; 
  data->AEM_S(26,24) = (-0.5*ucMOther[2]*mnuOther)-1.5*m0rOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(26,25) = (-0.5*ucMOther[3]*mnuOther)-1.5*m0rOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(26,26) = (-0.4472135954999579*ucMOther[5]*mnuOther)-1.341640786499874*m0rOther[5]*mnuOther+0.4472135954999579*cErOther[5]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(26,27) = (-0.447213595499958*ucMOther[7]*mnuOther)-1.341640786499874*m0rOther[7]*mnuOther+0.447213595499958*cErOther[7]*mnuOther-0.5*ucMOther[1]*mnuOther-1.5*m0rOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(26,28) = (-0.5000000000000001*ucMOther[6]*mnuOther)-1.5*m0rOther[6]*mnuOther+0.5000000000000001*cErOther[6]*mnuOther; 
  data->AEM_S(26,29) = (-0.4472135954999579*ucMOther[2]*mnuOther)-1.341640786499874*m0rOther[2]*mnuOther+0.4472135954999579*cErOther[2]*mnuOther; 
  data->AEM_S(26,30) = (-0.5000000000000001*ucMOther[4]*mnuOther)-1.5*m0rOther[4]*mnuOther+0.5000000000000001*cErOther[4]*mnuOther; 
  data->AEM_S(26,31) = (-0.447213595499958*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(27,24) = (-0.5*ucMOther[3]*mnuOther)-1.5*m0rOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(27,25) = (-0.447213595499958*ucMOther[6]*mnuOther)-1.341640786499874*m0rOther[6]*mnuOther+0.447213595499958*cErOther[6]*mnuOther-0.5*ucMOther[2]*mnuOther-1.5*m0rOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(27,26) = (-0.447213595499958*ucMOther[7]*mnuOther)-1.341640786499874*m0rOther[7]*mnuOther+0.447213595499958*cErOther[7]*mnuOther-0.5*ucMOther[1]*mnuOther-1.5*m0rOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(27,27) = (-0.4472135954999579*ucMOther[5]*mnuOther)-1.341640786499874*m0rOther[5]*mnuOther+0.4472135954999579*cErOther[5]*mnuOther-0.4472135954999579*ucMOther[4]*mnuOther-1.341640786499874*m0rOther[4]*mnuOther+0.4472135954999579*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(27,28) = (-0.4472135954999579*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(27,29) = (-0.4472135954999579*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(27,30) = (-0.4*ucMOther[7]*mnuOther)-1.2*m0rOther[7]*mnuOther+0.4*cErOther[7]*mnuOther-0.447213595499958*ucMOther[1]*mnuOther-1.341640786499874*m0rOther[1]*mnuOther+0.447213595499958*cErOther[1]*mnuOther; 
  data->AEM_S(27,31) = (-0.4*ucMOther[6]*mnuOther)-1.2*m0rOther[6]*mnuOther+0.4*cErOther[6]*mnuOther-0.447213595499958*ucMOther[2]*mnuOther-1.341640786499874*m0rOther[2]*mnuOther+0.447213595499958*cErOther[2]*mnuOther; 
  data->AEM_S(28,24) = (-0.5*ucMOther[4]*mnuOther)-1.5*m0rOther[4]*mnuOther+0.5*cErOther[4]*mnuOther; 
  data->AEM_S(28,25) = (-0.4472135954999579*ucMOther[1]*mnuOther)-1.341640786499874*m0rOther[1]*mnuOther+0.4472135954999579*cErOther[1]*mnuOther; 
  data->AEM_S(28,26) = (-0.5000000000000001*ucMOther[6]*mnuOther)-1.5*m0rOther[6]*mnuOther+0.5000000000000001*cErOther[6]*mnuOther; 
  data->AEM_S(28,27) = (-0.4472135954999579*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(28,28) = (-0.31943828249997*ucMOther[4]*mnuOther)-0.9583148474999099*m0rOther[4]*mnuOther+0.31943828249997*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(28,30) = (-0.31943828249997*ucMOther[6]*mnuOther)-0.9583148474999099*m0rOther[6]*mnuOther+0.31943828249997*cErOther[6]*mnuOther-0.5000000000000001*ucMOther[2]*mnuOther-1.5*m0rOther[2]*mnuOther+0.5000000000000001*cErOther[2]*mnuOther; 
  data->AEM_S(28,31) = (-0.4472135954999579*ucMOther[7]*mnuOther)-1.341640786499874*m0rOther[7]*mnuOther+0.4472135954999579*cErOther[7]*mnuOther; 
  data->AEM_S(29,24) = (-0.5*ucMOther[5]*mnuOther)-1.5*m0rOther[5]*mnuOther+0.5*cErOther[5]*mnuOther; 
  data->AEM_S(29,25) = (-0.5000000000000001*ucMOther[7]*mnuOther)-1.5*m0rOther[7]*mnuOther+0.5000000000000001*cErOther[7]*mnuOther; 
  data->AEM_S(29,26) = (-0.4472135954999579*ucMOther[2]*mnuOther)-1.341640786499874*m0rOther[2]*mnuOther+0.4472135954999579*cErOther[2]*mnuOther; 
  data->AEM_S(29,27) = (-0.4472135954999579*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(29,29) = (-0.31943828249997*ucMOther[5]*mnuOther)-0.9583148474999099*m0rOther[5]*mnuOther+0.31943828249997*cErOther[5]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(29,30) = (-0.4472135954999579*ucMOther[6]*mnuOther)-1.341640786499874*m0rOther[6]*mnuOther+0.4472135954999579*cErOther[6]*mnuOther; 
  data->AEM_S(29,31) = (-0.31943828249997*ucMOther[7]*mnuOther)-0.9583148474999099*m0rOther[7]*mnuOther+0.31943828249997*cErOther[7]*mnuOther-0.5000000000000001*ucMOther[1]*mnuOther-1.5*m0rOther[1]*mnuOther+0.5000000000000001*cErOther[1]*mnuOther; 
  data->AEM_S(30,24) = (-0.5*ucMOther[6]*mnuOther)-1.5*m0rOther[6]*mnuOther+0.5*cErOther[6]*mnuOther; 
  data->AEM_S(30,25) = (-0.447213595499958*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(30,26) = (-0.5000000000000001*ucMOther[4]*mnuOther)-1.5*m0rOther[4]*mnuOther+0.5000000000000001*cErOther[4]*mnuOther; 
  data->AEM_S(30,27) = (-0.4*ucMOther[7]*mnuOther)-1.2*m0rOther[7]*mnuOther+0.4*cErOther[7]*mnuOther-0.447213595499958*ucMOther[1]*mnuOther-1.341640786499874*m0rOther[1]*mnuOther+0.447213595499958*cErOther[1]*mnuOther; 
  data->AEM_S(30,28) = (-0.31943828249997*ucMOther[6]*mnuOther)-0.9583148474999099*m0rOther[6]*mnuOther+0.31943828249997*cErOther[6]*mnuOther-0.5000000000000001*ucMOther[2]*mnuOther-1.5*m0rOther[2]*mnuOther+0.5000000000000001*cErOther[2]*mnuOther; 
  data->AEM_S(30,29) = (-0.4472135954999579*ucMOther[6]*mnuOther)-1.341640786499874*m0rOther[6]*mnuOther+0.4472135954999579*cErOther[6]*mnuOther; 
  data->AEM_S(30,30) = (-0.4472135954999579*ucMOther[5]*mnuOther)-1.341640786499874*m0rOther[5]*mnuOther+0.4472135954999579*cErOther[5]*mnuOther-0.31943828249997*ucMOther[4]*mnuOther-0.9583148474999099*m0rOther[4]*mnuOther+0.31943828249997*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(30,31) = (-0.4*ucMOther[3]*mnuOther)-1.2*m0rOther[3]*mnuOther+0.4*cErOther[3]*mnuOther; 
  data->AEM_S(31,24) = (-0.5*ucMOther[7]*mnuOther)-1.5*m0rOther[7]*mnuOther+0.5*cErOther[7]*mnuOther; 
  data->AEM_S(31,25) = (-0.5000000000000001*ucMOther[5]*mnuOther)-1.5*m0rOther[5]*mnuOther+0.5000000000000001*cErOther[5]*mnuOther; 
  data->AEM_S(31,26) = (-0.447213595499958*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(31,27) = (-0.4*ucMOther[6]*mnuOther)-1.2*m0rOther[6]*mnuOther+0.4*cErOther[6]*mnuOther-0.447213595499958*ucMOther[2]*mnuOther-1.341640786499874*m0rOther[2]*mnuOther+0.447213595499958*cErOther[2]*mnuOther; 
  data->AEM_S(31,28) = (-0.4472135954999579*ucMOther[7]*mnuOther)-1.341640786499874*m0rOther[7]*mnuOther+0.4472135954999579*cErOther[7]*mnuOther; 
  data->AEM_S(31,29) = (-0.31943828249997*ucMOther[7]*mnuOther)-0.9583148474999099*m0rOther[7]*mnuOther+0.31943828249997*cErOther[7]*mnuOther-0.5000000000000001*ucMOther[1]*mnuOther-1.5*m0rOther[1]*mnuOther+0.5000000000000001*cErOther[1]*mnuOther; 
  data->AEM_S(31,30) = (-0.4*ucMOther[3]*mnuOther)-1.2*m0rOther[3]*mnuOther+0.4*cErOther[3]*mnuOther; 
  data->AEM_S(31,31) = (-0.31943828249997*ucMOther[5]*mnuOther)-0.9583148474999099*m0rOther[5]*mnuOther+0.31943828249997*cErOther[5]*mnuOther-0.4472135954999579*ucMOther[4]*mnuOther-1.341640786499874*m0rOther[4]*mnuOther+0.4472135954999579*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
