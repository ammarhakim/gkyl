...
{ 
  ...
  data->AEM_S(21,0) = (-0.25*m0SrSelf[2]*uSelf[2]*mnuSelf)-0.25*m0SrSelf[1]*uSelf[1]*mnuSelf-0.25*m0SrSelf[0]*uSelf[0]*mnuSelf+0.5*m1SrSelf[0]*mnuSelf; 
  data->AEM_S(21,1) = (-0.25*m0SrSelf[0]*uSelf[1]*mnuSelf)+0.5*m1SrSelf[1]*mnuSelf-0.25*uSelf[0]*m0SrSelf[1]*mnuSelf; 
  data->AEM_S(21,2) = (-0.25*m0SrSelf[0]*uSelf[2]*mnuSelf)+0.5*m1SrSelf[2]*mnuSelf-0.25*uSelf[0]*m0SrSelf[2]*mnuSelf; 
  data->AEM_S(22,0) = (-0.25*m0SrSelf[0]*uSelf[1]*mnuSelf)+0.5*m1SrSelf[1]*mnuSelf-0.25*uSelf[0]*m0SrSelf[1]*mnuSelf; 
  data->AEM_S(22,1) = (-0.25*m0SrSelf[2]*uSelf[2]*mnuSelf)-0.45*m0SrSelf[1]*uSelf[1]*mnuSelf-0.25*m0SrSelf[0]*uSelf[0]*mnuSelf+0.5*m1SrSelf[0]*mnuSelf; 
  data->AEM_S(22,2) = (-0.25*m0SrSelf[1]*uSelf[2]*mnuSelf)-0.25*uSelf[1]*m0SrSelf[2]*mnuSelf; 
  data->AEM_S(23,0) = (-0.25*m0SrSelf[0]*uSelf[2]*mnuSelf)+0.5*m1SrSelf[2]*mnuSelf-0.25*uSelf[0]*m0SrSelf[2]*mnuSelf; 
  data->AEM_S(23,1) = (-0.25*m0SrSelf[1]*uSelf[2]*mnuSelf)-0.25*uSelf[1]*m0SrSelf[2]*mnuSelf; 
  data->AEM_S(23,2) = (-0.45*m0SrSelf[2]*uSelf[2]*mnuSelf)-0.25*m0SrSelf[1]*uSelf[1]*mnuSelf-0.25*m0SrSelf[0]*uSelf[0]*mnuSelf+0.5*m1SrSelf[0]*mnuSelf; 
 
  // ... Block from weak multiply of mOther, nuOther, (m1OtherX-uOtherX*m0Other) and uCrossOtherX ... // 
  data->AEM_S(21,12) = 0.25*m0SrOther[2]*uOther[2]*mnuOther+0.25*m0SrOther[1]*uOther[1]*mnuOther+0.25*m0SrOther[0]*uOther[0]*mnuOther-0.5*m1SrOther[0]*mnuOther; 
  data->AEM_S(21,13) = 0.25*m0SrOther[0]*uOther[1]*mnuOther-0.5*m1SrOther[1]*mnuOther+0.25*uOther[0]*m0SrOther[1]*mnuOther; 
  data->AEM_S(21,14) = 0.25*m0SrOther[0]*uOther[2]*mnuOther-0.5*m1SrOther[2]*mnuOther+0.25*uOther[0]*m0SrOther[2]*mnuOther; 
  data->AEM_S(22,12) = 0.25*m0SrOther[0]*uOther[1]*mnuOther-0.5*m1SrOther[1]*mnuOther+0.25*uOther[0]*m0SrOther[1]*mnuOther; 
  data->AEM_S(22,13) = 0.25*m0SrOther[2]*uOther[2]*mnuOther+0.45*m0SrOther[1]*uOther[1]*mnuOther+0.25*m0SrOther[0]*uOther[0]*mnuOther-0.5*m1SrOther[0]*mnuOther; 
  data->AEM_S(22,14) = 0.25*m0SrOther[1]*uOther[2]*mnuOther+0.25*uOther[1]*m0SrOther[2]*mnuOther; 
  data->AEM_S(23,12) = 0.25*m0SrOther[0]*uOther[2]*mnuOther-0.5*m1SrOther[2]*mnuOther+0.25*uOther[0]*m0SrOther[2]*mnuOther; 
  data->AEM_S(23,13) = 0.25*m0SrOther[1]*uOther[2]*mnuOther+0.25*uOther[1]*m0SrOther[2]*mnuOther; 
  data->AEM_S(23,14) = 0.45*m0SrOther[2]*uOther[2]*mnuOther+0.25*m0SrOther[1]*uOther[1]*mnuOther+0.25*m0SrOther[0]*uOther[0]*mnuOther-0.5*m1SrOther[0]*mnuOther; 
  ...
  data->AEM_S(21,3) = (-0.25*m0SrSelf[2]*uSelf[5]*mnuSelf)-0.25*m0SrSelf[1]*uSelf[4]*mnuSelf-0.25*m0SrSelf[0]*uSelf[3]*mnuSelf+0.5*m1SrSelf[3]*mnuSelf; 
  data->AEM_S(21,4) = (-0.25*m0SrSelf[0]*uSelf[4]*mnuSelf)+0.5*m1SrSelf[4]*mnuSelf-0.25*m0SrSelf[1]*uSelf[3]*mnuSelf; 
  data->AEM_S(21,5) = (-0.25*m0SrSelf[0]*uSelf[5]*mnuSelf)+0.5*m1SrSelf[5]*mnuSelf-0.25*m0SrSelf[2]*uSelf[3]*mnuSelf; 
  data->AEM_S(22,3) = (-0.25*m0SrSelf[0]*uSelf[4]*mnuSelf)+0.5*m1SrSelf[4]*mnuSelf-0.25*m0SrSelf[1]*uSelf[3]*mnuSelf; 
  data->AEM_S(22,4) = (-0.25*m0SrSelf[2]*uSelf[5]*mnuSelf)-0.45*m0SrSelf[1]*uSelf[4]*mnuSelf-0.25*m0SrSelf[0]*uSelf[3]*mnuSelf+0.5*m1SrSelf[3]*mnuSelf; 
  data->AEM_S(22,5) = (-0.25*m0SrSelf[1]*uSelf[5]*mnuSelf)-0.25*m0SrSelf[2]*uSelf[4]*mnuSelf; 
  data->AEM_S(23,3) = (-0.25*m0SrSelf[0]*uSelf[5]*mnuSelf)+0.5*m1SrSelf[5]*mnuSelf-0.25*m0SrSelf[2]*uSelf[3]*mnuSelf; 
  data->AEM_S(23,4) = (-0.25*m0SrSelf[1]*uSelf[5]*mnuSelf)-0.25*m0SrSelf[2]*uSelf[4]*mnuSelf; 
  data->AEM_S(23,5) = (-0.45*m0SrSelf[2]*uSelf[5]*mnuSelf)-0.25*m0SrSelf[1]*uSelf[4]*mnuSelf-0.25*m0SrSelf[0]*uSelf[3]*mnuSelf+0.5*m1SrSelf[3]*mnuSelf; 
 
  // ... Block from weak multiply of mOther, nuOther, (m1OtherY-uOtherY*m0Other) and uCrossOtherY ... // 
  data->AEM_S(21,15) = 0.25*m0SrOther[2]*uOther[5]*mnuOther+0.25*m0SrOther[1]*uOther[4]*mnuOther+0.25*m0SrOther[0]*uOther[3]*mnuOther-0.5*m1SrOther[3]*mnuOther; 
  data->AEM_S(21,16) = 0.25*m0SrOther[0]*uOther[4]*mnuOther-0.5*m1SrOther[4]*mnuOther+0.25*m0SrOther[1]*uOther[3]*mnuOther; 
  data->AEM_S(21,17) = 0.25*m0SrOther[0]*uOther[5]*mnuOther-0.5*m1SrOther[5]*mnuOther+0.25*m0SrOther[2]*uOther[3]*mnuOther; 
  data->AEM_S(22,15) = 0.25*m0SrOther[0]*uOther[4]*mnuOther-0.5*m1SrOther[4]*mnuOther+0.25*m0SrOther[1]*uOther[3]*mnuOther; 
  data->AEM_S(22,16) = 0.25*m0SrOther[2]*uOther[5]*mnuOther+0.45*m0SrOther[1]*uOther[4]*mnuOther+0.25*m0SrOther[0]*uOther[3]*mnuOther-0.5*m1SrOther[3]*mnuOther; 
  data->AEM_S(22,17) = 0.25*m0SrOther[1]*uOther[5]*mnuOther+0.25*m0SrOther[2]*uOther[4]*mnuOther; 
  data->AEM_S(23,15) = 0.25*m0SrOther[0]*uOther[5]*mnuOther-0.5*m1SrOther[5]*mnuOther+0.25*m0SrOther[2]*uOther[3]*mnuOther; 
  data->AEM_S(23,16) = 0.25*m0SrOther[1]*uOther[5]*mnuOther+0.25*m0SrOther[2]*uOther[4]*mnuOther; 
  data->AEM_S(23,17) = 0.45*m0SrOther[2]*uOther[5]*mnuOther+0.25*m0SrOther[1]*uOther[4]*mnuOther+0.25*m0SrOther[0]*uOther[3]*mnuOther-0.5*m1SrOther[3]*mnuOther; 
  ...
  data->AEM_S(21,6) = (-0.25*m0SrSelf[2]*uSelf[8]*mnuSelf)-0.25*m0SrSelf[1]*uSelf[7]*mnuSelf-0.25*m0SrSelf[0]*uSelf[6]*mnuSelf+0.5*m1SrSelf[6]*mnuSelf; 
  data->AEM_S(21,7) = (-0.25*m0SrSelf[0]*uSelf[7]*mnuSelf)+0.5*m1SrSelf[7]*mnuSelf-0.25*m0SrSelf[1]*uSelf[6]*mnuSelf; 
  data->AEM_S(21,8) = (-0.25*m0SrSelf[0]*uSelf[8]*mnuSelf)+0.5*m1SrSelf[8]*mnuSelf-0.25*m0SrSelf[2]*uSelf[6]*mnuSelf; 
  data->AEM_S(22,6) = (-0.25*m0SrSelf[0]*uSelf[7]*mnuSelf)+0.5*m1SrSelf[7]*mnuSelf-0.25*m0SrSelf[1]*uSelf[6]*mnuSelf; 
  data->AEM_S(22,7) = (-0.25*m0SrSelf[2]*uSelf[8]*mnuSelf)-0.45*m0SrSelf[1]*uSelf[7]*mnuSelf-0.25*m0SrSelf[0]*uSelf[6]*mnuSelf+0.5*m1SrSelf[6]*mnuSelf; 
  data->AEM_S(22,8) = (-0.25*m0SrSelf[1]*uSelf[8]*mnuSelf)-0.25*m0SrSelf[2]*uSelf[7]*mnuSelf; 
  data->AEM_S(23,6) = (-0.25*m0SrSelf[0]*uSelf[8]*mnuSelf)+0.5*m1SrSelf[8]*mnuSelf-0.25*m0SrSelf[2]*uSelf[6]*mnuSelf; 
  data->AEM_S(23,7) = (-0.25*m0SrSelf[1]*uSelf[8]*mnuSelf)-0.25*m0SrSelf[2]*uSelf[7]*mnuSelf; 
  data->AEM_S(23,8) = (-0.45*m0SrSelf[2]*uSelf[8]*mnuSelf)-0.25*m0SrSelf[1]*uSelf[7]*mnuSelf-0.25*m0SrSelf[0]*uSelf[6]*mnuSelf+0.5*m1SrSelf[6]*mnuSelf; 
 
  // ... Block from weak multiply of mOther, nuOther, (m1OtherZ-uOtherZ*m0Other) and uCrossOtherZ ... // 
  data->AEM_S(21,18) = 0.25*m0SrOther[2]*uOther[8]*mnuOther+0.25*m0SrOther[1]*uOther[7]*mnuOther+0.25*m0SrOther[0]*uOther[6]*mnuOther-0.5*m1SrOther[6]*mnuOther; 
  data->AEM_S(21,19) = 0.25*m0SrOther[0]*uOther[7]*mnuOther-0.5*m1SrOther[7]*mnuOther+0.25*m0SrOther[1]*uOther[6]*mnuOther; 
  data->AEM_S(21,20) = 0.25*m0SrOther[0]*uOther[8]*mnuOther-0.5*m1SrOther[8]*mnuOther+0.25*m0SrOther[2]*uOther[6]*mnuOther; 
  data->AEM_S(22,18) = 0.25*m0SrOther[0]*uOther[7]*mnuOther-0.5*m1SrOther[7]*mnuOther+0.25*m0SrOther[1]*uOther[6]*mnuOther; 
  data->AEM_S(22,19) = 0.25*m0SrOther[2]*uOther[8]*mnuOther+0.45*m0SrOther[1]*uOther[7]*mnuOther+0.25*m0SrOther[0]*uOther[6]*mnuOther-0.5*m1SrOther[6]*mnuOther; 
  data->AEM_S(22,20) = 0.25*m0SrOther[1]*uOther[8]*mnuOther+0.25*m0SrOther[2]*uOther[7]*mnuOther; 
  data->AEM_S(23,18) = 0.25*m0SrOther[0]*uOther[8]*mnuOther-0.5*m1SrOther[8]*mnuOther+0.25*m0SrOther[2]*uOther[6]*mnuOther; 
  data->AEM_S(23,19) = 0.25*m0SrOther[1]*uOther[8]*mnuOther+0.25*m0SrOther[2]*uOther[7]*mnuOther; 
  data->AEM_S(23,20) = 0.45*m0SrOther[2]*uOther[8]*mnuOther+0.25*m0SrOther[1]*uOther[7]*mnuOther+0.25*m0SrOther[0]*uOther[6]*mnuOther-0.5*m1SrOther[6]*mnuOther; 
  ...
  data->AEM_S(21,9) = 0.25*cMSelf[8]*uSelf[8]*mnuSelf+0.25*cMSelf[7]*uSelf[7]*mnuSelf+0.25*cMSelf[6]*uSelf[6]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(21,10) = 0.25*cMSelf[6]*uSelf[7]*mnuSelf+0.25*uSelf[6]*cMSelf[7]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(21,11) = 0.25*cMSelf[6]*uSelf[8]*mnuSelf+0.25*uSelf[6]*cMSelf[8]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(22,9) = 0.25*cMSelf[6]*uSelf[7]*mnuSelf+0.25*uSelf[6]*cMSelf[7]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(22,10) = 0.25*cMSelf[8]*uSelf[8]*mnuSelf+0.25*cMSelf[7]*uSelf[7]*mnuSelf+0.25*cMSelf[6]*uSelf[6]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(23,9) = 0.25*cMSelf[6]*uSelf[8]*mnuSelf+0.25*uSelf[6]*cMSelf[8]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(23,11) = 0.25*cMSelf[8]*uSelf[8]*mnuSelf+0.25*cMSelf[7]*uSelf[7]*mnuSelf+0.25*cMSelf[6]*uSelf[6]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
 
  // ... Block from correction to (other) 2nd moment of collision operator ... // 
  data->AEM_S(21,21) = (-0.25*cMOther[8]*uOther[8]*mnuOther)-0.25*cMOther[7]*uOther[7]*mnuOther-0.25*cMOther[6]*uOther[6]*mnuOther-0.5*m0SrOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(21,22) = (-0.25*cMOther[6]*uOther[7]*mnuOther)-0.25*uOther[6]*cMOther[7]*mnuOther-0.5*m0SrOther[1]*mnuOther+0.5*cEOther[1]*mnuOther; 
  data->AEM_S(21,23) = (-0.25*cMOther[6]*uOther[8]*mnuOther)-0.25*uOther[6]*cMOther[8]*mnuOther-0.5*m0SrOther[2]*mnuOther+0.5*cEOther[2]*mnuOther; 
  data->AEM_S(22,21) = (-0.25*cMOther[6]*uOther[7]*mnuOther)-0.25*uOther[6]*cMOther[7]*mnuOther-0.5*m0SrOther[1]*mnuOther+0.5*cEOther[1]*mnuOther; 
  data->AEM_S(22,22) = (-0.25*cMOther[8]*uOther[8]*mnuOther)-0.25*cMOther[7]*uOther[7]*mnuOther-0.25*cMOther[6]*uOther[6]*mnuOther-0.5*m0SrOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(23,21) = (-0.25*cMOther[6]*uOther[8]*mnuOther)-0.25*uOther[6]*cMOther[8]*mnuOther-0.5*m0SrOther[2]*mnuOther+0.5*cEOther[2]*mnuOther; 
  data->AEM_S(23,23) = (-0.25*cMOther[8]*uOther[8]*mnuOther)-0.25*cMOther[7]*uOther[7]*mnuOther-0.25*cMOther[6]*uOther[6]*mnuOther-0.5*m0SrOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  ...
  m2Relax[2] = betaGreenep1*((-(0.5*relKinE[2]*mSelf)/(mSelf+mOther))-(1.0*m2SrSelf[2]*mSelf)/(mSelf+mOther)+(kinESelf[2]*mSelf)/(mSelf+mOther)+(0.5*relKinE[2]*mOther)/(mSelf+mOther)+(m2SrOther[2]*mOther)/(mSelf+mOther)-(1.0*kinEOther[2]*mOther)/(mSelf+mOther))*mnuSelf+(m2SrSelf[2]-1.0*kinESelf[2])*mnuSelf+(kinEOther[2]-1.0*m2SrOther[2])*mnuOther; 
...
{ 
  ...
  // ... Block from correction to (self) 2nd moment of collision operator ... // 
  data->AEM_S(42,18) = 0.25*cMSelf[17]*uSelf[17]*mnuSelf+0.25*cMSelf[16]*uSelf[16]*mnuSelf+0.25*cMSelf[15]*uSelf[15]*mnuSelf+0.25*cMSelf[14]*uSelf[14]*mnuSelf+0.25*cMSelf[13]*uSelf[13]*mnuSelf+0.25*cMSelf[12]*uSelf[12]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(42,19) = 0.223606797749979*cMSelf[13]*uSelf[16]*mnuSelf+0.223606797749979*uSelf[13]*cMSelf[16]*mnuSelf+0.25*cMSelf[14]*uSelf[15]*mnuSelf+0.25*uSelf[14]*cMSelf[15]*mnuSelf+0.25*cMSelf[12]*uSelf[13]*mnuSelf+0.25*uSelf[12]*cMSelf[13]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(42,20) = 0.223606797749979*cMSelf[14]*uSelf[17]*mnuSelf+0.223606797749979*uSelf[14]*cMSelf[17]*mnuSelf+0.25*cMSelf[13]*uSelf[15]*mnuSelf+0.25*uSelf[13]*cMSelf[15]*mnuSelf+0.25*cMSelf[12]*uSelf[14]*mnuSelf+0.25*uSelf[12]*cMSelf[14]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(42,21) = 0.223606797749979*cMSelf[15]*uSelf[17]*mnuSelf+0.223606797749979*uSelf[15]*cMSelf[17]*mnuSelf+0.223606797749979*cMSelf[15]*uSelf[16]*mnuSelf+0.223606797749979*uSelf[15]*cMSelf[16]*mnuSelf+0.25*cMSelf[12]*uSelf[15]*mnuSelf+0.25*uSelf[12]*cMSelf[15]*mnuSelf+0.25*cMSelf[13]*uSelf[14]*mnuSelf+0.25*uSelf[13]*cMSelf[14]*mnuSelf+1.5*m0rSelf[3]*mnuSelf-0.5*cESelf[3]*mnuSelf; 
  data->AEM_S(42,22) = 0.159719141249985*cMSelf[16]*uSelf[16]*mnuSelf+0.25*cMSelf[12]*uSelf[16]*mnuSelf+0.25*uSelf[12]*cMSelf[16]*mnuSelf+0.223606797749979*cMSelf[15]*uSelf[15]*mnuSelf+0.223606797749979*cMSelf[13]*uSelf[13]*mnuSelf+1.5*m0rSelf[4]*mnuSelf-0.5*cESelf[4]*mnuSelf; 
  data->AEM_S(42,23) = 0.159719141249985*cMSelf[17]*uSelf[17]*mnuSelf+0.25*cMSelf[12]*uSelf[17]*mnuSelf+0.25*uSelf[12]*cMSelf[17]*mnuSelf+0.223606797749979*cMSelf[15]*uSelf[15]*mnuSelf+0.223606797749979*cMSelf[14]*uSelf[14]*mnuSelf+1.5*m0rSelf[5]*mnuSelf-0.5*cESelf[5]*mnuSelf; 
  data->AEM_S(43,18) = 0.223606797749979*cMSelf[13]*uSelf[16]*mnuSelf+0.223606797749979*uSelf[13]*cMSelf[16]*mnuSelf+0.25*cMSelf[14]*uSelf[15]*mnuSelf+0.25*uSelf[14]*cMSelf[15]*mnuSelf+0.25*cMSelf[12]*uSelf[13]*mnuSelf+0.25*uSelf[12]*cMSelf[13]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(43,19) = 0.25*cMSelf[17]*uSelf[17]*mnuSelf+0.3928571428571428*cMSelf[16]*uSelf[16]*mnuSelf+0.223606797749979*cMSelf[12]*uSelf[16]*mnuSelf+0.223606797749979*uSelf[12]*cMSelf[16]*mnuSelf+0.45*cMSelf[15]*uSelf[15]*mnuSelf+0.25*cMSelf[14]*uSelf[14]*mnuSelf+0.45*cMSelf[13]*uSelf[13]*mnuSelf+0.25*cMSelf[12]*uSelf[12]*mnuSelf+1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cESelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(43,20) = 0.223606797749979*cMSelf[15]*uSelf[17]*mnuSelf+0.223606797749979*uSelf[15]*cMSelf[17]*mnuSelf+0.223606797749979*cMSelf[15]*uSelf[16]*mnuSelf+0.223606797749979*uSelf[15]*cMSelf[16]*mnuSelf+0.25*cMSelf[12]*uSelf[15]*mnuSelf+0.25*uSelf[12]*cMSelf[15]*mnuSelf+0.25*cMSelf[13]*uSelf[14]*mnuSelf+0.25*uSelf[13]*cMSelf[14]*mnuSelf+1.5*m0rSelf[3]*mnuSelf-0.5*cESelf[3]*mnuSelf; 
  data->AEM_S(43,21) = 0.223606797749979*cMSelf[14]*uSelf[17]*mnuSelf+0.223606797749979*uSelf[14]*cMSelf[17]*mnuSelf+0.25*cMSelf[13]*uSelf[15]*mnuSelf+0.25*uSelf[13]*cMSelf[15]*mnuSelf+0.25*cMSelf[12]*uSelf[14]*mnuSelf+0.25*uSelf[12]*cMSelf[14]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(43,22) = 0.2*cMSelf[13]*uSelf[16]*mnuSelf+0.2*uSelf[13]*cMSelf[16]*mnuSelf+0.223606797749979*cMSelf[14]*uSelf[15]*mnuSelf+0.223606797749979*uSelf[14]*cMSelf[15]*mnuSelf+0.223606797749979*cMSelf[12]*uSelf[13]*mnuSelf+0.223606797749979*uSelf[12]*cMSelf[13]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.4472135954999579*cESelf[1]*mnuSelf; 
  data->AEM_S(44,18) = 0.223606797749979*cMSelf[14]*uSelf[17]*mnuSelf+0.223606797749979*uSelf[14]*cMSelf[17]*mnuSelf+0.25*cMSelf[13]*uSelf[15]*mnuSelf+0.25*uSelf[13]*cMSelf[15]*mnuSelf+0.25*cMSelf[12]*uSelf[14]*mnuSelf+0.25*uSelf[12]*cMSelf[14]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(44,19) = 0.223606797749979*cMSelf[15]*uSelf[17]*mnuSelf+0.223606797749979*uSelf[15]*cMSelf[17]*mnuSelf+0.223606797749979*cMSelf[15]*uSelf[16]*mnuSelf+0.223606797749979*uSelf[15]*cMSelf[16]*mnuSelf+0.25*cMSelf[12]*uSelf[15]*mnuSelf+0.25*uSelf[12]*cMSelf[15]*mnuSelf+0.25*cMSelf[13]*uSelf[14]*mnuSelf+0.25*uSelf[13]*cMSelf[14]*mnuSelf+1.5*m0rSelf[3]*mnuSelf-0.5*cESelf[3]*mnuSelf; 
  data->AEM_S(44,20) = 0.3928571428571428*cMSelf[17]*uSelf[17]*mnuSelf+0.223606797749979*cMSelf[12]*uSelf[17]*mnuSelf+0.223606797749979*uSelf[12]*cMSelf[17]*mnuSelf+0.25*cMSelf[16]*uSelf[16]*mnuSelf+0.45*cMSelf[15]*uSelf[15]*mnuSelf+0.45*cMSelf[14]*uSelf[14]*mnuSelf+0.25*cMSelf[13]*uSelf[13]*mnuSelf+0.25*cMSelf[12]*uSelf[12]*mnuSelf+1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cESelf[5]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(44,21) = 0.223606797749979*cMSelf[13]*uSelf[16]*mnuSelf+0.223606797749979*uSelf[13]*cMSelf[16]*mnuSelf+0.25*cMSelf[14]*uSelf[15]*mnuSelf+0.25*uSelf[14]*cMSelf[15]*mnuSelf+0.25*cMSelf[12]*uSelf[13]*mnuSelf+0.25*uSelf[12]*cMSelf[13]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(44,23) = 0.2*cMSelf[14]*uSelf[17]*mnuSelf+0.2*uSelf[14]*cMSelf[17]*mnuSelf+0.223606797749979*cMSelf[13]*uSelf[15]*mnuSelf+0.223606797749979*uSelf[13]*cMSelf[15]*mnuSelf+0.223606797749979*cMSelf[12]*uSelf[14]*mnuSelf+0.223606797749979*uSelf[12]*cMSelf[14]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.4472135954999579*cESelf[2]*mnuSelf; 
  data->AEM_S(45,18) = 0.223606797749979*cMSelf[15]*uSelf[17]*mnuSelf+0.223606797749979*uSelf[15]*cMSelf[17]*mnuSelf+0.223606797749979*cMSelf[15]*uSelf[16]*mnuSelf+0.223606797749979*uSelf[15]*cMSelf[16]*mnuSelf+0.25*cMSelf[12]*uSelf[15]*mnuSelf+0.25*uSelf[12]*cMSelf[15]*mnuSelf+0.25*cMSelf[13]*uSelf[14]*mnuSelf+0.25*uSelf[13]*cMSelf[14]*mnuSelf+1.5*m0rSelf[3]*mnuSelf-0.5*cESelf[3]*mnuSelf; 
  data->AEM_S(45,19) = 0.223606797749979*cMSelf[14]*uSelf[17]*mnuSelf+0.223606797749979*uSelf[14]*cMSelf[17]*mnuSelf+0.25*cMSelf[13]*uSelf[15]*mnuSelf+0.25*uSelf[13]*cMSelf[15]*mnuSelf+0.25*cMSelf[12]*uSelf[14]*mnuSelf+0.25*uSelf[12]*cMSelf[14]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(45,20) = 0.223606797749979*cMSelf[13]*uSelf[16]*mnuSelf+0.223606797749979*uSelf[13]*cMSelf[16]*mnuSelf+0.25*cMSelf[14]*uSelf[15]*mnuSelf+0.25*uSelf[14]*cMSelf[15]*mnuSelf+0.25*cMSelf[12]*uSelf[13]*mnuSelf+0.25*uSelf[12]*cMSelf[13]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(45,21) = 0.3928571428571428*cMSelf[17]*uSelf[17]*mnuSelf+0.223606797749979*cMSelf[12]*uSelf[17]*mnuSelf+0.223606797749979*uSelf[12]*cMSelf[17]*mnuSelf+0.3928571428571428*cMSelf[16]*uSelf[16]*mnuSelf+0.223606797749979*cMSelf[12]*uSelf[16]*mnuSelf+0.223606797749979*uSelf[12]*cMSelf[16]*mnuSelf+0.65*cMSelf[15]*uSelf[15]*mnuSelf+0.45*cMSelf[14]*uSelf[14]*mnuSelf+0.45*cMSelf[13]*uSelf[13]*mnuSelf+0.25*cMSelf[12]*uSelf[12]*mnuSelf+1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cESelf[5]*mnuSelf+1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cESelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(45,22) = 0.2*cMSelf[15]*uSelf[17]*mnuSelf+0.2*uSelf[15]*cMSelf[17]*mnuSelf+0.2*cMSelf[15]*uSelf[16]*mnuSelf+0.2*uSelf[15]*cMSelf[16]*mnuSelf+0.223606797749979*cMSelf[12]*uSelf[15]*mnuSelf+0.223606797749979*uSelf[12]*cMSelf[15]*mnuSelf+0.223606797749979*cMSelf[13]*uSelf[14]*mnuSelf+0.223606797749979*uSelf[13]*cMSelf[14]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cESelf[3]*mnuSelf; 
  data->AEM_S(45,23) = 0.2*cMSelf[15]*uSelf[17]*mnuSelf+0.2*uSelf[15]*cMSelf[17]*mnuSelf+0.2*cMSelf[15]*uSelf[16]*mnuSelf+0.2*uSelf[15]*cMSelf[16]*mnuSelf+0.223606797749979*cMSelf[12]*uSelf[15]*mnuSelf+0.223606797749979*uSelf[12]*cMSelf[15]*mnuSelf+0.223606797749979*cMSelf[13]*uSelf[14]*mnuSelf+0.223606797749979*uSelf[13]*cMSelf[14]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cESelf[3]*mnuSelf; 
  data->AEM_S(46,18) = 0.159719141249985*cMSelf[16]*uSelf[16]*mnuSelf+0.25*cMSelf[12]*uSelf[16]*mnuSelf+0.25*uSelf[12]*cMSelf[16]*mnuSelf+0.223606797749979*cMSelf[15]*uSelf[15]*mnuSelf+0.223606797749979*cMSelf[13]*uSelf[13]*mnuSelf+1.5*m0rSelf[4]*mnuSelf-0.5*cESelf[4]*mnuSelf; 
  data->AEM_S(46,19) = 0.2*cMSelf[13]*uSelf[16]*mnuSelf+0.2*uSelf[13]*cMSelf[16]*mnuSelf+0.223606797749979*cMSelf[14]*uSelf[15]*mnuSelf+0.223606797749979*uSelf[14]*cMSelf[15]*mnuSelf+0.223606797749979*cMSelf[12]*uSelf[13]*mnuSelf+0.223606797749979*uSelf[12]*cMSelf[13]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.4472135954999579*cESelf[1]*mnuSelf; 
  data->AEM_S(46,21) = 0.2*cMSelf[15]*uSelf[17]*mnuSelf+0.2*uSelf[15]*cMSelf[17]*mnuSelf+0.2*cMSelf[15]*uSelf[16]*mnuSelf+0.2*uSelf[15]*cMSelf[16]*mnuSelf+0.223606797749979*cMSelf[12]*uSelf[15]*mnuSelf+0.223606797749979*uSelf[12]*cMSelf[15]*mnuSelf+0.223606797749979*cMSelf[13]*uSelf[14]*mnuSelf+0.223606797749979*uSelf[13]*cMSelf[14]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cESelf[3]*mnuSelf; 
  data->AEM_S(46,22) = 0.25*cMSelf[17]*uSelf[17]*mnuSelf+0.3520408163265306*cMSelf[16]*uSelf[16]*mnuSelf+0.159719141249985*cMSelf[12]*uSelf[16]*mnuSelf+0.159719141249985*uSelf[12]*cMSelf[16]*mnuSelf+0.3928571428571428*cMSelf[15]*uSelf[15]*mnuSelf+0.25*cMSelf[14]*uSelf[14]*mnuSelf+0.3928571428571428*cMSelf[13]*uSelf[13]*mnuSelf+0.25*cMSelf[12]*uSelf[12]*mnuSelf+0.9583148474999099*m0rSelf[4]*mnuSelf-0.31943828249997*cESelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(47,18) = 0.159719141249985*cMSelf[17]*uSelf[17]*mnuSelf+0.25*cMSelf[12]*uSelf[17]*mnuSelf+0.25*uSelf[12]*cMSelf[17]*mnuSelf+0.223606797749979*cMSelf[15]*uSelf[15]*mnuSelf+0.223606797749979*cMSelf[14]*uSelf[14]*mnuSelf+1.5*m0rSelf[5]*mnuSelf-0.5*cESelf[5]*mnuSelf; 
  data->AEM_S(47,20) = 0.2*cMSelf[14]*uSelf[17]*mnuSelf+0.2*uSelf[14]*cMSelf[17]*mnuSelf+0.223606797749979*cMSelf[13]*uSelf[15]*mnuSelf+0.223606797749979*uSelf[13]*cMSelf[15]*mnuSelf+0.223606797749979*cMSelf[12]*uSelf[14]*mnuSelf+0.223606797749979*uSelf[12]*cMSelf[14]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.4472135954999579*cESelf[2]*mnuSelf; 
  data->AEM_S(47,21) = 0.2*cMSelf[15]*uSelf[17]*mnuSelf+0.2*uSelf[15]*cMSelf[17]*mnuSelf+0.2*cMSelf[15]*uSelf[16]*mnuSelf+0.2*uSelf[15]*cMSelf[16]*mnuSelf+0.223606797749979*cMSelf[12]*uSelf[15]*mnuSelf+0.223606797749979*uSelf[12]*cMSelf[15]*mnuSelf+0.223606797749979*cMSelf[13]*uSelf[14]*mnuSelf+0.223606797749979*uSelf[13]*cMSelf[14]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cESelf[3]*mnuSelf; 
  data->AEM_S(47,23) = 0.3520408163265306*cMSelf[17]*uSelf[17]*mnuSelf+0.159719141249985*cMSelf[12]*uSelf[17]*mnuSelf+0.159719141249985*uSelf[12]*cMSelf[17]*mnuSelf+0.25*cMSelf[16]*uSelf[16]*mnuSelf+0.3928571428571428*cMSelf[15]*uSelf[15]*mnuSelf+0.3928571428571428*cMSelf[14]*uSelf[14]*mnuSelf+0.25*cMSelf[13]*uSelf[13]*mnuSelf+0.25*cMSelf[12]*uSelf[12]*mnuSelf+0.9583148474999099*m0rSelf[5]*mnuSelf-0.31943828249997*cESelf[5]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
 
  // ... Block from correction to (other) 2nd moment of collision operator ... // 
  data->AEM_S(42,42) = (-0.25*cMOther[17]*uOther[17]*mnuOther)-0.25*cMOther[16]*uOther[16]*mnuOther-0.25*cMOther[15]*uOther[15]*mnuOther-0.25*cMOther[14]*uOther[14]*mnuOther-0.25*cMOther[13]*uOther[13]*mnuOther-0.25*cMOther[12]*uOther[12]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S
  data->AEM_S(46,43) = (-0.2*cMOther[13]*uOther[16]*mnuOther)-0.2*uOther[13]*cMOther[16]*mnuOther-0.223606797749979*cMOther[14]*uOther[15]*mnuOther-0.223606797749979*uOther[14]*cMOther[15]*mnuOther-0.223606797749979*cMOther[12]*uOther[13]*mnuOther-0.223606797749979*uOther[12]*cMOther[13]*mnuOther-1.341640786499874*m0rOther[1]*mnuOther+0.4472135954999579*cEOther[1]*mnuOther; 
  data->AEM_S(46,45) = (-0.2*cMOther[15]*uOther[17]*mnuOther)-0.2*uOther[15]*cMOther[17]*mnuOther-0.2*cMOther[15]*uOther[16]*mnuOther-0.2*uOther[15]*cMOther[16]*mnuOther-0.223606797749979*cMOther[12]*uOther[15]*mnuOther-0.223606797749979*uOther[12]*cMOther[15]*mnuOther-0.223606797749979*cMOther[13]*uOther[14]*mnuOther-0.223606797749979*uOther[13]*cMOther[14]*mnuOther-1.341640786499874*m0rOther[3]*mnuOther+0.4472135954999579*cEOther[3]*mnuOther; 
  data->AEM_S(46,46) = (-0.25*cMOther[17]*uOther[17]*mnuOther)-0.3520408163265306*cMOther[16]*uOther[16]*mnuOther-0.159719141249985*cMOther[12]*uOther[16]*mnuOther-0.159719141249985*uOther[12]*cMOther[16]*mnuOther-0.3928571428571428*cMOther[15]*uOther[15]*mnuOther-0.25*cMOther[14]*uOther[14]*mnuOther-0.3928571428571428*cMOther[13]*uOther[13]*mnuOther-0.25*cMOther[12]*uOther[12]*mnuOther-0.9583148474999099*m0rOther[4]*mnuOther+0.31943828249997*cEOther[4]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(47,42) = (-0.159719141249985*cMOther[17]*uOther[17]*mnuOther)-0.25*cMOther[12]*uOther[17]*mnuOther-0.25*uOther[12]*cMOther[17]*mnuOther-0.223606797749979*cMOther[15]*uOther[15]*mnuOther-0.223606797749979*cMOther[14]*uOther[14]*mnuOther-1.5*m0rOther[5]*mnuOther+0.5*cEOther[5]*mnuOther; 
  data->AEM_S(47,44) = (-0.2*cMOther[14]*uOther[17]*mnuOther)-0.2*uOther[14]*cMOther[17]*mnuOther-0.223606797749979*cMOther[13]*uOther[15]*mnuOther-0.223606797749979*uOther[13]*cMOther[15]*mnuOther-0.223606797749979*cMOther[12]*uOther[14]*mnuOther-0.223606797749979*uOther[12]*cMOther[14]*mnuOther-1.341640786499874*m0rOther[2]*mnuOther+0.4472135954999579*cEOther[2]*mnuOther; 
  data->AEM_S(47,45) = (-0.2*cMOther[15]*uOther[17]*mnuOther)-0.2*uOther[15]*cMOther[17]*mnuOther-0.2*cMOther[15]*uOther[16]*mnuOther-0.2*uOther[15]*cMOther[16]*mnuOther-0.223606797749979*cMOther[12]*uOther[15]*mnuOther-0.223606797749979*uOther[12]*cMOther[15]*mnuOther-0.223606797749979*cMOther[13]*uOther[14]*mnuOther-0.223606797749979*uOther[13]*cMOther[14]*mnuOther-1.341640786499874*m0rOther[3]*mnuOther+0.4472135954999579*cEOther[3]*mnuOther; 
  data->AEM_S(47,47) = (-0.3520408163265306*cMOther[17]*uOther[17]*mnuOther)-0.159719141249985*cMOther[12]*uOther[17]*mnuOther-0.159719141249985*uOther[12]*cMOther[17]*mnuOther-0.25*cMOther[16]*uOther[16]*mnuOther-0.3928571428571428*cMOther[15]*uOther[15]*mnuOther-0.3928571428571428*cMOther[14]*uOther[14]*mnuOther-0.25*cMOther[13]*uOther[13]*mnuOther-0.25*cMOther[12]*uOther[12]*mnuOther-0.9583148474999099*m0rOther[5]*mnuOther+0.31943828249997*cEOther[5]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
