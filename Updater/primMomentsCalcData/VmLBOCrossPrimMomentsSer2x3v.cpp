...
{ 
  ...
  if (cellAvg) { 
    ...
    cMrSelf[20] = cMSelf[20]; 
    cMrSelf[21] = cMSelf[21]; 
    cMrSelf[22] = cMSelf[22]; 
    cMrSelf[23] = cMSelf[23]; 
    cErSelf[0] = cESelf[0]; 
    cErSelf[1] = cESelf[1]; 
    cErSelf[2] = cESelf[2]; 
    cErSelf[3] = cESelf[3]; 
  ...
  if (cellAvg) { 
    ...
    cMrOther[20] = cMOther[20]; 
    cMrOther[21] = cMOther[21]; 
    cMrOther[22] = cMOther[22]; 
    cMrOther[23] = cMOther[23]; 
    cErOther[0] = cEOther[0]; 
    cErOther[1] = cEOther[1]; 
    cErOther[2] = cEOther[2]; 
    cErOther[3] = cEOther[3]; 
  ...
  // ... Block from correction to momentum conservation (self) ... // 
  data->AEM_S(0,24) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(0,25) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(0,26) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(0,27) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(0,28) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(0,29) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(0,30) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(0,31) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(1,24) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(1,25) = (-0.4472135954999579*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(1,26) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(1,27) = (-0.447213595499958*cMrSelf[6]*mnuSelf)-0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(1,28) = -0.4472135954999579*cMrSelf[1]*mnuSelf; 
  data->AEM_S(1,29) = -0.5000000000000001*cMrSelf[7]*mnuSelf; 
  data->AEM_S(1,30) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(1,31) = -0.5000000000000001*cMrSelf[5]*mnuSelf; 
  data->AEM_S(2,24) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(2,25) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(2,26) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(2,27) = (-0.447213595499958*cMrSelf[7]*mnuSelf)-0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(2,28) = -0.5000000000000001*cMrSelf[6]*mnuSelf; 
  data->AEM_S(2,29) = -0.4472135954999579*cMrSelf[2]*mnuSelf; 
  data->AEM_S(2,30) = -0.5000000000000001*cMrSelf[4]*mnuSelf; 
  data->AEM_S(2,31) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,24) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,25) = (-0.447213595499958*cMrSelf[6]*mnuSelf)-0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(3,26) = (-0.447213595499958*cMrSelf[7]*mnuSelf)-0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(3,27) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.4472135954999579*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(3,28) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,29) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,30) = (-0.4*cMrSelf[7]*mnuSelf)-0.447213595499958*cMrSelf[1]*mnuSelf; 
  data->AEM_S(3,31) = (-0.4*cMrSelf[6]*mnuSelf)-0.447213595499958*cMrSelf[2]*mnuSelf; 
  data->AEM_S(4,24) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(4,25) = -0.4472135954999579*cMrSelf[1]*mnuSelf; 
  data->AEM_S(4,26) = -0.5000000000000001*cMrSelf[6]*mnuSelf; 
  data->AEM_S(4,27) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(4,28) = (-0.31943828249997*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(4,30) = (-0.31943828249997*cMrSelf[6]*mnuSelf)-0.5000000000000001*cMrSelf[2]*mnuSelf; 
  data->AEM_S(4,31) = -0.4472135954999579*cMrSelf[7]*mnuSelf; 
  data->AEM_S(5,24) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(5,25) = -0.5000000000000001*cMrSelf[7]*mnuSelf; 
  data->AEM_S(5,26) = -0.4472135954999579*cMrSelf[2]*mnuSelf; 
  data->AEM_S(5,27) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(5,29) = (-0.31943828249997*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(5,30) = -0.4472135954999579*cMrSelf[6]*mnuSelf; 
  data->AEM_S(5,31) = (-0.31943828249997*cMrSelf[7]*mnuSelf)-0.5000000000000001*cMrSelf[1]*mnuSelf; 
  data->AEM_S(6,24) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(6,25) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(6,26) = -0.5000000000000001*cMrSelf[4]*mnuSelf; 
  data->AEM_S(6,27) = (-0.4*cMrSelf[7]*mnuSelf)-0.447213595499958*cMrSelf[1]*mnuSelf; 
  data->AEM_S(6,28) = (-0.31943828249997*cMrSelf[6]*mnuSelf)-0.5000000000000001*cMrSelf[2]*mnuSelf; 
  data->AEM_S(6,29) = -0.4472135954999579*cMrSelf[6]*mnuSelf; 
  data->AEM_S(6,30) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.31943828249997*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(6,31) = -0.4*cMrSelf[3]*mnuSelf; 
  data->AEM_S(7,24) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(7,25) = -0.5000000000000001*cMrSelf[5]*mnuSelf; 
  data->AEM_S(7,26) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(7,27) = (-0.4*cMrSelf[6]*mnuSelf)-0.447213595499958*cMrSelf[2]*mnuSelf; 
  data->AEM_S(7,28) = -0.4472135954999579*cMrSelf[7]*mnuSelf; 
  data->AEM_S(7,29) = (-0.31943828249997*cMrSelf[7]*mnuSelf)-0.5000000000000001*cMrSelf[1]*mnuSelf; 
  data->AEM_S(7,30) = -0.4*cMrSelf[3]*mnuSelf; 
  data->AEM_S(7,31) = (-0.31943828249997*cMrSelf[5]*mnuSelf)-0.4472135954999579*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(0,56) = -0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(0,57) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(0,58) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(0,59) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(0,60) = -0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(0,61) = -0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(0,62) = -0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(0,63) = -0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(1,56) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(1,57) = (-0.4472135954999579*cMrOther[4]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(1,58) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(1,59) = (-0.447213595499958*cMrOther[6]*mnuOther)-0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(1,60) = -0.4472135954999579*cMrOther[1]*mnuOther; 
  data->AEM_S(1,61) = -0.5000000000000001*cMrOther[7]*mnuOther; 
  data->AEM_S(1,62) = -0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(1,63) = -0.5000000000000001*cMrOther[5]*mnuOther; 
  data->AEM_S(2,56) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(2,57) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(2,58) = (-0.4472135954999579*cMrOther[5]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(2,59) = (-0.447213595499958*cMrOther[7]*mnuOther)-0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(2,60) = -0.5000000000000001*cMrOther[6]*mnuOther; 
  data->AEM_S(2,61) = -0.4472135954999579*cMrOther[2]*mnuOther; 
  data->AEM_S(2,62) = -0.5000000000000001*cMrOther[4]*mnuOther; 
  data->AEM_S(2,63) = -0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(3,56) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(3,57) = (-0.447213595499958*cMrOther[6]*mnuOther)-0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(3,58) = (-0.447213595499958*cMrOther[7]*mnuOther)-0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(3,59) = (-0.4472135954999579*cMrOther[5]*mnuOther)-0.4472135954999579*cMrOther[4]*mnuOther-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(3,60) = -0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(3,61) = -0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(3,62) = (-0.4*cMrOther[7]*mnuOther)-0.447213595499958*cMrOther[1]*mnuOther; 
  data->AEM_S(3,63) = (-0.4*cMrOther[6]*mnuOther)-0.447213595499958*cMrOther[2]*mnuOther; 
  data->AEM_S(4,56) = -0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(4,57) = -0.4472135954999579*cMrOther[1]*mnuOther; 
  data->AEM_S(4,58) = -0.5000000000000001*cMrOther[6]*mnuOther; 
  data->AEM_S(4,59) = -0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(4,60) = (-0.31943828249997*cMrOther[4]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(4,62) = (-0.31943828249997*cMrOther[6]*mnuOther)-0.5000000000000001*cMrOther[2]*mnuOther; 
  data->AEM_S(4,63) = -0.4472135954999579*cMrOther[7]*mnuOther; 
  data->AEM_S(5,56) = -0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(5,57) = -0.5000000000000001*cMrOther[7]*mnuOther; 
  data->AEM_S(5,58) = -0.4472135954999579*cMrOther[2]*mnuOther; 
  data->AEM_S(5,59) = -0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(5,61) = (-0.31943828249997*cMrOther[5]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(5,62) = -0.4472135954999579*cMrOther[6]*mnuOther; 
  data->AEM_S(5,63) = (-0.31943828249997*cMrOther[7]*mnuOther)-0.5000000000000001*cMrOther[1]*mnuOther; 
  data->AEM_S(6,56) = -0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(6,57) = -0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(6,58) = -0.5000000000000001*cMrOther[4]*mnuOther; 
  data->AEM_S(6,59) = (-0.4*cMrOther[7]*mnuOther)-0.447213595499958*cMrOther[1]*mnuOther; 
  data->AEM_S(6,60) = (-0.31943828249997*cMrOther[6]*mnuOther)-0.5000000000000001*cMrOther[2]*mnuOther; 
  data->AEM_S(6,61) = -0.4472135954999579*cMrOther[6]*mnuOther; 
  data->AEM_S(6,62) = (-0.4472135954999579*cMrOther[5]*mnuOther)-0.31943828249997*cMrOther[4]*mnuOther-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(6,63) = -0.4*cMrOther[3]*mnuOther; 
  data->AEM_S(7,56) = -0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(7,57) = -0.5000000000000001*cMrOther[5]*mnuOther; 
  data->AEM_S(7,58) = -0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(7,59) = (-0.4*cMrOther[6]*mnuOther)-0.447213595499958*cMrOther[2]*mnuOther; 
  data->AEM_S(7,60) = -0.4472135954999579*cMrOther[7]*mnuOther; 
  data->AEM_S(7,61) = (-0.31943828249997*cMrOther[7]*mnuOther)-0.5000000000000001*cMrOther[1]*mnuOther; 
  data->AEM_S(7,62) = -0.4*cMrOther[3]*mnuOther; 
  data->AEM_S(7,63) = (-0.31943828249997*cMrOther[5]*mnuOther)-0.4472135954999579*cMrOther[4]*mnuOther-0.5*cMrOther[0]*mnuOther; 
  ...
  // ... Block from correction to momentum conservation (self) ... // 
  data->AEM_S(8,24) = -0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(8,25) = -0.5*cMrSelf[9]*mnuSelf; 
  data->AEM_S(8,26) = -0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(8,27) = -0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(8,28) = -0.5*cMrSelf[12]*mnuSelf; 
  data->AEM_S(8,29) = -0.5*cMrSelf[13]*mnuSelf; 
  data->AEM_S(8,30) = -0.5*cMrSelf[14]*mnuSelf; 
  data->AEM_S(8,31) = -0.5*cMrSelf[15]*mnuSelf; 
  data->AEM_S(9,24) = -0.5*cMrSelf[9]*mnuSelf; 
  data->AEM_S(9,25) = (-0.4472135954999579*cMrSelf[12]*mnuSelf)-0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(9,26) = -0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(9,27) = (-0.447213595499958*cMrSelf[14]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(9,28) = -0.4472135954999579*cMrSelf[9]*mnuSelf; 
  data->AEM_S(9,29) = -0.5000000000000001*cMrSelf[15]*mnuSelf; 
  data->AEM_S(9,30) = -0.447213595499958*cMrSelf[11]*mnuSelf; 
  data->AEM_S(9,31) = -0.5000000000000001*cMrSelf[13]*mnuSelf; 
  data->AEM_S(10,24) = -0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(10,25) = -0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(10,26) = (-0.4472135954999579*cMrSelf[13]*mnuSelf)-0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(10,27) = (-0.447213595499958*cMrSelf[15]*mnuSelf)-0.5*cMrSelf[9]*mnuSelf; 
  data->AEM_S(10,28) = -0.5000000000000001*cMrSelf[14]*mnuSelf; 
  data->AEM_S(10,29) = -0.4472135954999579*cMrSelf[10]*mnuSelf; 
  data->AEM_S(10,30) = -0.5000000000000001*cMrSelf[12]*mnuSelf; 
  data->AEM_S(10,31) = -0.447213595499958*cMrSelf[11]*mnuSelf; 
  data->AEM_S(11,24) = -0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(11,25) = (-0.447213595499958*cMrSelf[14]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(11,26) = (-0.447213595499958*cMrSelf[15]*mnuSelf)-0.5*cMrSelf[9]*mnuSelf; 
  data->AEM_S(11,27) = (-0.4472135954999579*cMrSelf[13]*mnuSelf)-0.4472135954999579*cMrSelf[12]*mnuSelf-0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(11,28) = -0.4472135954999579*cMrSelf[11]*mnuSelf; 
  data->AEM_S(11,29) = -0.4472135954999579*cMrSelf[11]*mnuSelf; 
  data->AEM_S(11,30) = (-0.4*cMrSelf[15]*mnuSelf)-0.447213595499958*cMrSelf[9]*mnuSelf; 
  data->AEM_S(11,31) = (-0.4*cMrSelf[14]*mnuSelf)-0.447213595499958*cMrSelf[10]*mnuSelf; 
  data->AEM_S(12,24) = -0.5*cMrSelf[12]*mnuSelf; 
  data->AEM_S(12,25) = -0.4472135954999579*cMrSelf[9]*mnuSelf; 
  data->AEM_S(12,26) = -0.5000000000000001*cMrSelf[14]*mnuSelf; 
  data->AEM_S(12,27) = -0.4472135954999579*cMrSelf[11]*mnuSelf; 
  data->AEM_S(12,28) = (-0.31943828249997*cMrSelf[12]*mnuSelf)-0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(12,30) = (-0.31943828249997*cMrSelf[14]*mnuSelf)-0.5000000000000001*cMrSelf[10]*mnuSelf; 
  data->AEM_S(12,31) = -0.4472135954999579*cMrSelf[15]*mnuSelf; 
  data->AEM_S(13,24) = -0.5*cMrSelf[13]*mnuSelf; 
  data->AEM_S(13,25) = -0.5000000000000001*cMrSelf[15]*mnuSelf; 
  data->AEM_S(13,26) = -0.4472135954999579*cMrSelf[10]*mnuSelf; 
  data->AEM_S(13,27) = -0.4472135954999579*cMrSelf[11]*mnuSelf; 
  data->AEM_S(13,29) = (-0.31943828249997*cMrSelf[13]*mnuSelf)-0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(13,30) = -0.4472135954999579*cMrSelf[14]*mnuSelf; 
  data->AEM_S(13,31) = (-0.31943828249997*cMrSelf[15]*mnuSelf)-0.5000000000000001*cMrSelf[9]*mnuSelf; 
  data->AEM_S(14,24) = -0.5*cMrSelf[14]*mnuSelf; 
  data->AEM_S(14,25) = -0.447213595499958*cMrSelf[11]*mnuSelf; 
  data->AEM_S(14,26) = -0.5000000000000001*cMrSelf[12]*mnuSelf; 
  data->AEM_S(14,27) = (-0.4*cMrSelf[15]*mnuSelf)-0.447213595499958*cMrSelf[9]*mnuSelf; 
  data->AEM_S(14,28) = (-0.31943828249997*cMrSelf[14]*mnuSelf)-0.5000000000000001*cMrSelf[10]*mnuSelf; 
  data->AEM_S(14,29) = -0.4472135954999579*cMrSelf[14]*mnuSelf; 
  data->AEM_S(14,30) = (-0.4472135954999579*cMrSelf[13]*mnuSelf)-0.31943828249997*cMrSelf[12]*mnuSelf-0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(14,31) = -0.4*cMrSelf[11]*mnuSelf; 
  data->AEM_S(15,24) = -0.5*cMrSelf[15]*mnuSelf; 
  data->AEM_S(15,25) = -0.5000000000000001*cMrSelf[13]*mnuSelf; 
  data->AEM_S(15,26) = -0.447213595499958*cMrSelf[11]*mnuSelf; 
  data->AEM_S(15,27) = (-0.4*cMrSelf[14]*mnuSelf)-0.447213595499958*cMrSelf[10]*mnuSelf; 
  data->AEM_S(15,28) = -0.4472135954999579*cMrSelf[15]*mnuSelf; 
  data->AEM_S(15,29) = (-0.31943828249997*cMrSelf[15]*mnuSelf)-0.5000000000000001*cMrSelf[9]*mnuSelf; 
  data->AEM_S(15,30) = -0.4*cMrSelf[11]*mnuSelf; 
  data->AEM_S(15,31) = (-0.31943828249997*cMrSelf[13]*mnuSelf)-0.4472135954999579*cMrSelf[12]*mnuSelf-0.5*cMrSelf[8]*mnuSelf; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(8,56) = -0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(8,57) = -0.5*cMrOther[9]*mnuOther; 
  data->AEM_S(8,58) = -0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(8,59) = -0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(8,60) = -0.5*cMrOther[12]*mnuOther; 
  data->AEM_S(8,61) = -0.5*cMrOther[13]*mnuOther; 
  data->AEM_S(8,62) = -0.5*cMrOther[14]*mnuOther; 
  data->AEM_S(8,63) = -0.5*cMrOther[15]*mnuOther; 
  data->AEM_S(9,56) = -0.5*cMrOther[9]*mnuOther; 
  data->AEM_S(9,57) = (-0.4472135954999579*cMrOther[12]*mnuOther)-0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(9,58) = -0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(9,59) = (-0.447213595499958*cMrOther[14]*mnuOther)-0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(9,60) = -0.4472135954999579*cMrOther[9]*mnuOther; 
  data->AEM_S(9,61) = -0.5000000000000001*cMrOther[15]*mnuOther; 
  data->AEM_S(9,62) = -0.447213595499958*cMrOther[11]*mnuOther; 
  data->AEM_S(9,63) = -0.5000000000000001*cMrOther[13]*mnuOther; 
  data->AEM_S(10,56) = -0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(10,57) = -0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(10,58) = (-0.4472135954999579*cMrOther[13]*mnuOther)-0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(10,59) = (-0.447213595499958*cMrOther[15]*mnuOther)-0.5*cMrOther[9]*mnuOther; 
  data->AEM_S(10,60) = -0.5000000000000001*cMrOther[14]*mnuOther; 
  data->AEM_S(10,61) = -0.4472135954999579*cMrOther[10]*mnuOther; 
  data->AEM_S(10,62) = -0.5000000000000001*cMrOther[12]*mnuOther; 
  data->AEM_S(10,63) = -0.447213595499958*cMrOther[11]*mnuOther; 
  data->AEM_S(11,56) = -0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(11,57) = (-0.447213595499958*cMrOther[14]*mnuOther)-0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(11,58) = (-0.447213595499958*cMrOther[15]*mnuOther)-0.5*cMrOther[9]*mnuOther; 
  data->AEM_S(11,59) = (-0.4472135954999579*cMrOther[13]*mnuOther)-0.4472135954999579*cMrOther[12]*mnuOther-0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(11,60) = -0.4472135954999579*cMrOther[11]*mnuOther; 
  data->AEM_S(11,61) = -0.4472135954999579*cMrOther[11]*mnuOther; 
  data->AEM_S(11,62) = (-0.4*cMrOther[15]*mnuOther)-0.447213595499958*cMrOther[9]*mnuOther; 
  data->AEM_S(11,63) = (-0.4*cMrOther[14]*mnuOther)-0.447213595499958*cMrOther[10]*mnuOther; 
  data->AEM_S(12,56) = -0.5*cMrOther[12]*mnuOther; 
  data->AEM_S(12,57) = -0.4472135954999579*cMrOther[9]*mnuOther; 
  data->AEM_S(12,58) = -0.5000000000000001*cMrOther[14]*mnuOther; 
  data->AEM_S(12,59) = -0.4472135954999579*cMrOther[11]*mnuOther; 
  data->AEM_S(12,60) = (-0.31943828249997*cMrOther[12]*mnuOther)-0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(12,62) = (-0.31943828249997*cMrOther[14]*mnuOther)-0.5000000000000001*cMrOther[10]*mnuOther; 
  data->AEM_S(12,63) = -0.4472135954999579*cMrOther[15]*mnuOther; 
  data->AEM_S(13,56) = -0.5*cMrOther[13]*mnuOther; 
  data->AEM_S(13,57) = -0.5000000000000001*cMrOther[15]*mnuOther; 
  data->AEM_S(13,58) = -0.4472135954999579*cMrOther[10]*mnuOther; 
  data->AEM_S(13,59) = -0.4472135954999579*cMrOther[11]*mnuOther; 
  data->AEM_S(13,61) = (-0.31943828249997*cMrOther[13]*mnuOther)-0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(13,62) = -0.4472135954999579*cMrOther[14]*mnuOther; 
  data->AEM_S(13,63) = (-0.31943828249997*cMrOther[15]*mnuOther)-0.5000000000000001*cMrOther[9]*mnuOther; 
  data->AEM_S(14,56) = -0.5*cMrOther[14]*mnuOther; 
  data->AEM_S(14,57) = -0.447213595499958*cMrOther[11]*mnuOther; 
  data->AEM_S(14,58) = -0.5000000000000001*cMrOther[12]*mnuOther; 
  data->AEM_S(14,59) = (-0.4*cMrOther[15]*mnuOther)-0.447213595499958*cMrOther[9]*mnuOther; 
  data->AEM_S(14,60) = (-0.31943828249997*cMrOther[14]*mnuOther)-0.5000000000000001*cMrOther[10]*mnuOther; 
  data->AEM_S(14,61) = -0.4472135954999579*cMrOther[14]*mnuOther; 
  data->AEM_S(14,62) = (-0.4472135954999579*cMrOther[13]*mnuOther)-0.31943828249997*cMrOther[12]*mnuOther-0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(14,63) = -0.4*cMrOther[11]*mnuOther; 
  data->AEM_S(15,56) = -0.5*cMrOther[15]*mnuOther; 
  data->AEM_S(15,57) = -0.5000000000000001*cMrOther[13]*mnuOther; 
  data->AEM_S(15,58) = -0.447213595499958*cMrOther[11]*mnuOther; 
  data->AEM_S(15,59) = (-0.4*cMrOther[14]*mnuOther)-0.447213595499958*cMrOther[10]*mnuOther; 
  data->AEM_S(15,60) = -0.4472135954999579*cMrOther[15]*mnuOther; 
  data->AEM_S(15,61) = (-0.31943828249997*cMrOther[15]*mnuOther)-0.5000000000000001*cMrOther[9]*mnuOther; 
  data->AEM_S(15,62) = -0.4*cMrOther[11]*mnuOther; 
  data->AEM_S(15,63) = (-0.31943828249997*cMrOther[13]*mnuOther)-0.4472135954999579*cMrOther[12]*mnuOther-0.5*cMrOther[8]*mnuOther; 
  ...
  // ... Block from correction to momentum conservation (self) ... // 
  data->AEM_S(16,24) = -0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(16,25) = -0.5*cMrSelf[17]*mnuSelf; 
  data->AEM_S(16,26) = -0.5*cMrSelf[18]*mnuSelf; 
  data->AEM_S(16,27) = -0.5*cMrSelf[19]*mnuSelf; 
  data->AEM_S(16,28) = -0.5*cMrSelf[20]*mnuSelf; 
  data->AEM_S(16,29) = -0.5*cMrSelf[21]*mnuSelf; 
  data->AEM_S(16,30) = -0.5*cMrSelf[22]*mnuSelf; 
  data->AEM_S(16,31) = -0.5*cMrSelf[23]*mnuSelf; 
  data->AEM_S(17,24) = -0.5*cMrSelf[17]*mnuSelf; 
  data->AEM_S(17,25) = (-0.4472135954999579*cMrSelf[20]*mnuSelf)-0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(17,26) = -0.5*cMrSelf[19]*mnuSelf; 
  data->AEM_S(17,27) = (-0.447213595499958*cMrSelf[22]*mnuSelf)-0.5*cMrSelf[18]*mnuSelf; 
  data->AEM_S(17,28) = -0.4472135954999579*cMrSelf[17]*mnuSelf; 
  data->AEM_S(17,29) = -0.5000000000000001*cMrSelf[23]*mnuSelf; 
  data->AEM_S(17,30) = -0.447213595499958*cMrSelf[19]*mnuSelf; 
  data->AEM_S(17,31) = -0.5000000000000001*cMrSelf[21]*mnuSelf; 
  data->AEM_S(18,24) = -0.5*cMrSelf[18]*mnuSelf; 
  data->AEM_S(18,25) = -0.5*cMrSelf[19]*mnuSelf; 
  data->AEM_S(18,26) = (-0.4472135954999579*cMrSelf[21]*mnuSelf)-0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(18,27) = (-0.447213595499958*cMrSelf[23]*mnuSelf)-0.5*cMrSelf[17]*mnuSelf; 
  data->AEM_S(18,28) = -0.5000000000000001*cMrSelf[22]*mnuSelf; 
  data->AEM_S(18,29) = -0.4472135954999579*cMrSelf[18]*mnuSelf; 
  data->AEM_S(18,30) = -0.5000000000000001*cMrSelf[20]*mnuSelf; 
  data->AEM_S(18,31) = -0.447213595499958*cMrSelf[19]*mnuSelf; 
  data->AEM_S(19,24) = -0.5*cMrSelf[19]*mnuSelf; 
  data->AEM_S(19,25) = (-0.447213595499958*cMrSelf[22]*mnuSelf)-0.5*cMrSelf[18]*mnuSelf; 
  data->AEM_S(19,26) = (-0.447213595499958*cMrSelf[23]*mnuSelf)-0.5*cMrSelf[17]*mnuSelf; 
  data->AEM_S(19,27) = (-0.4472135954999579*cMrSelf[21]*mnuSelf)-0.4472135954999579*cMrSelf[20]*mnuSelf-0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(19,28) = -0.4472135954999579*cMrSelf[19]*mnuSelf; 
  data->AEM_S(19,29) = -0.4472135954999579*cMrSelf[19]*mnuSelf; 
  data->AEM_S(19,30) = (-0.4*cMrSelf[23]*mnuSelf)-0.447213595499958*cMrSelf[17]*mnuSelf; 
  data->AEM_S(19,31) = (-0.4*cMrSelf[22]*mnuSelf)-0.447213595499958*cMrSelf[18]*mnuSelf; 
  data->AEM_S(20,24) = -0.5*cMrSelf[20]*mnuSelf; 
  data->AEM_S(20,25) = -0.4472135954999579*cMrSelf[17]*mnuSelf; 
  data->AEM_S(20,26) = -0.5000000000000001*cMrSelf[22]*mnuSelf; 
  data->AEM_S(20,27) = -0.4472135954999579*cMrSelf[19]*mnuSelf; 
  data->AEM_S(20,28) = (-0.31943828249997*cMrSelf[20]*mnuSelf)-0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(20,30) = (-0.31943828249997*cMrSelf[22]*mnuSelf)-0.5000000000000001*cMrSelf[18]*mnuSelf; 
  data->AEM_S(20,31) = -0.4472135954999579*cMrSelf[23]*mnuSelf; 
  data->AEM_S(21,24) = -0.5*cMrSelf[21]*mnuSelf; 
  data->AEM_S(21,25) = -0.5000000000000001*cMrSelf[23]*mnuSelf; 
  data->AEM_S(21,26) = -0.4472135954999579*cMrSelf[18]*mnuSelf; 
  data->AEM_S(21,27) = -0.4472135954999579*cMrSelf[19]*mnuSelf; 
  data->AEM_S(21,29) = (-0.31943828249997*cMrSelf[21]*mnuSelf)-0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(21,30) = -0.4472135954999579*cMrSelf[22]*mnuSelf; 
  data->AEM_S(21,31) = (-0.31943828249997*cMrSelf[23]*mnuSelf)-0.5000000000000001*cMrSelf[17]*mnuSelf; 
  data->AEM_S(22,24) = -0.5*cMrSelf[22]*mnuSelf; 
  data->AEM_S(22,25) = -0.447213595499958*cMrSelf[19]*mnuSelf; 
  data->AEM_S(22,26) = -0.5000000000000001*cMrSelf[20]*mnuSelf; 
  data->AEM_S(22,27) = (-0.4*cMrSelf[23]*mnuSelf)-0.447213595499958*cMrSelf[17]*mnuSelf; 
  data->AEM_S(22,28) = (-0.31943828249997*cMrSelf[22]*mnuSelf)-0.5000000000000001*cMrSelf[18]*mnuSelf; 
  data->AEM_S(22,29) = -0.4472135954999579*cMrSelf[22]*mnuSelf; 
  data->AEM_S(22,30) = (-0.4472135954999579*cMrSelf[21]*mnuSelf)-0.31943828249997*cMrSelf[20]*mnuSelf-0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(22,31) = -0.4*cMrSelf[19]*mnuSelf; 
  data->AEM_S(23,24) = -0.5*cMrSelf[23]*mnuSelf; 
  data->AEM_S(23,25) = -0.5000000000000001*cMrSelf[21]*mnuSelf; 
  data->AEM_S(23,26) = -0.447213595499958*cMrSelf[19]*mnuSelf; 
  data->AEM_S(23,27) = (-0.4*cMrSelf[22]*mnuSelf)-0.447213595499958*cMrSelf[18]*mnuSelf; 
  data->AEM_S(23,28) = -0.4472135954999579*cMrSelf[23]*mnuSelf; 
  data->AEM_S(23,29) = (-0.31943828249997*cMrSelf[23]*mnuSelf)-0.5000000000000001*cMrSelf[17]*mnuSelf; 
  data->AEM_S(23,30) = -0.4*cMrSelf[19]*mnuSelf; 
  data->AEM_S(23,31) = (-0.31943828249997*cMrSelf[21]*mnuSelf)-0.4472135954999579*cMrSelf[20]*mnuSelf-0.5*cMrSelf[16]*mnuSelf; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(16,56) = -0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(16,57) = -0.5*cMrOther[17]*mnuOther; 
  data->AEM_S(16,58) = -0.5*cMrOther[18]*mnuOther; 
  data->AEM_S(16,59) = -0.5*cMrOther[19]*mnuOther; 
  data->AEM_S(16,60) = -0.5*cMrOther[20]*mnuOther; 
  data->AEM_S(16,61) = -0.5*cMrOther[21]*mnuOther; 
  data->AEM_S(16,62) = -0.5*cMrOther[22]*mnuOther; 
  data->AEM_S(16,63) = -0.5*cMrOther[23]*mnuOther; 
  data->AEM_S(17,56) = -0.5*cMrOther[17]*mnuOther; 
  data->AEM_S(17,57) = (-0.4472135954999579*cMrOther[20]*mnuOther)-0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(17,58) = -0.5*cMrOther[19]*mnuOther; 
  data->AEM_S(17,59) = (-0.447213595499958*cMrOther[22]*mnuOther)-0.5*cMrOther[18]*mnuOther; 
  data->AEM_S(17,60) = -0.4472135954999579*cMrOther[17]*mnuOther; 
  data->AEM_S(17,61) = -0.5000000000000001*cMrOther[23]*mnuOther; 
  data->AEM_S(17,62) = -0.447213595499958*cMrOther[19]*mnuOther; 
  data->AEM_S(17,63) = -0.5000000000000001*cMrOther[21]*mnuOther; 
  data->AEM_S(18,56) = -0.5*cMrOther[18]*mnuOther; 
  data->AEM_S(18,57) = -0.5*cMrOther[19]*mnuOther; 
  data->AEM_S(18,58) = (-0.4472135954999579*cMrOther[21]*mnuOther)-0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(18,59) = (-0.447213595499958*cMrOther[23]*mnuOther)-0.5*cMrOther[17]*mnuOther; 
  data->AEM_S(18,60) = -0.5000000000000001*cMrOther[22]*mnuOther; 
  data->AEM_S(18,61) = -0.4472135954999579*cMrOther[18]*mnuOther; 
  data->AEM_S(18,62) = -0.5000000000000001*cMrOther[20]*mnuOther; 
  data->AEM_S(18,63) = -0.447213595499958*cMrOther[19]*mnuOther; 
  data->AEM_S(19,56) = -0.5*cMrOther[19]*mnuOther; 
  data->AEM_S(19,57) = (-0.447213595499958*cMrOther[22]*mnuOther)-0.5*cMrOther[18]*mnuOther; 
  data->AEM_S(19,58) = (-0.447213595499958*cMrOther[23]*mnuOther)-0.5*cMrOther[17]*mnuOther; 
  data->AEM_S(19,59) = (-0.4472135954999579*cMrOther[21]*mnuOther)-0.4472135954999579*cMrOther[20]*mnuOther-0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(19,60) = -0.4472135954999579*cMrOther[19]*mnuOther; 
  data->AEM_S(19,61) = -0.4472135954999579*cMrOther[19]*mnuOther; 
  data->AEM_S(19,62) = (-0.4*cMrOther[23]*mnuOther)-0.447213595499958*cMrOther[17]*mnuOther; 
  data->AEM_S(19,63) = (-0.4*cMrOther[22]*mnuOther)-0.447213595499958*cMrOther[18]*mnuOther; 
  data->AEM_S(20,56) = -0.5*cMrOther[20]*mnuOther; 
  data->AEM_S(20,57) = -0.4472135954999579*cMrOther[17]*mnuOther; 
  data->AEM_S(20,58) = -0.5000000000000001*cMrOther[22]*mnuOther; 
  data->AEM_S(20,59) = -0.4472135954999579*cMrOther[19]*mnuOther; 
  data->AEM_S(20,60) = (-0.31943828249997*cMrOther[20]*mnuOther)-0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(20,62) = (-0.31943828249997*cMrOther[22]*mnuOther)-0.5000000000000001*cMrOther[18]*mnuOther; 
  data->AEM_S(20,63) = -0.4472135954999579*cMrOther[23]*mnuOther; 
  data->AEM_S(21,56) = -0.5*cMrOther[21]*mnuOther; 
  data->AEM_S(21,57) = -0.5000000000000001*cMrOther[23]*mnuOther; 
  data->AEM_S(21,58) = -0.4472135954999579*cMrOther[18]*mnuOther; 
  data->AEM_S(21,59) = -0.4472135954999579*cMrOther[19]*mnuOther; 
  data->AEM_S(21,61) = (-0.31943828249997*cMrOther[21]*mnuOther)-0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(21,62) = -0.4472135954999579*cMrOther[22]*mnuOther; 
  data->AEM_S(21,63) = (-0.31943828249997*cMrOther[23]*mnuOther)-0.5000000000000001*cMrOther[17]*mnuOther; 
  data->AEM_S(22,56) = -0.5*cMrOther[22]*mnuOther; 
  data->AEM_S(22,57) = -0.447213595499958*cMrOther[19]*mnuOther; 
  data->AEM_S(22,58) = -0.5000000000000001*cMrOther[20]*mnuOther; 
  data->AEM_S(22,59) = (-0.4*cMrOther[23]*mnuOther)-0.447213595499958*cMrOther[17]*mnuOther; 
  data->AEM_S(22,60) = (-0.31943828249997*cMrOther[22]*mnuOther)-0.5000000000000001*cMrOther[18]*mnuOther; 
  data->AEM_S(22,61) = -0.4472135954999579*cMrOther[22]*mnuOther; 
  data->AEM_S(22,62) = (-0.4472135954999579*cMrOther[21]*mnuOther)-0.31943828249997*cMrOther[20]*mnuOther-0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(22,63) = -0.4*cMrOther[19]*mnuOther; 
  data->AEM_S(23,56) = -0.5*cMrOther[23]*mnuOther; 
  data->AEM_S(23,57) = -0.5000000000000001*cMrOther[21]*mnuOther; 
  data->AEM_S(23,58) = -0.447213595499958*cMrOther[19]*mnuOther; 
  data->AEM_S(23,59) = (-0.4*cMrOther[22]*mnuOther)-0.447213595499958*cMrOther[18]*mnuOther; 
  data->AEM_S(23,60) = -0.4472135954999579*cMrOther[23]*mnuOther; 
  data->AEM_S(23,61) = (-0.31943828249997*cMrOther[23]*mnuOther)-0.5000000000000001*cMrOther[17]*mnuOther; 
  data->AEM_S(23,62) = -0.4*cMrOther[19]*mnuOther; 
  data->AEM_S(23,63) = (-0.31943828249997*cMrOther[21]*mnuOther)-0.4472135954999579*cMrOther[20]*mnuOther-0.5*cMrOther[16]*mnuOther; 
  ...
  // ... Block from correction to energy conservation (self) ... // 
  data->AEM_S(24,24) = 1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(24,25) = 1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(24,26) = 1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(24,27) = 1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(24,28) = 1.5*m0rSelf[4]*mnuSelf-0.5*cErSelf[4]*mnuSelf; 
  data->AEM_S(24,29) = 1.5*m0rSelf[5]*mnuSelf-0.5*cErSelf[5]*mnuSelf; 
  data->AEM_S(24,30) = 1.5*m0rSelf[6]*mnuSelf-0.5*cErSelf[6]*mnuSelf; 
  data->AEM_S(24,31) = 1.5*m0rSelf[7]*mnuSelf-0.5*cErSelf[7]*mnuSelf; 
  data->AEM_S(25,24) = 1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(25,25) = 1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(25,26) = 1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(25,27) = 1.341640786499874*m0rSelf[6]*mnuSelf-0.447213595499958*cErSelf[6]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(25,28) = 1.341640786499874*m0rSelf[1]*mnuSelf-0.4472135954999579*cErSelf[1]*mnuSelf; 
  data->AEM_S(25,29) = 1.5*m0rSelf[7]*mnuSelf-0.5000000000000001*cErSelf[7]*mnuSelf; 
  data->AEM_S(25,30) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(25,31) = 1.5*m0rSelf[5]*mnuSelf-0.5000000000000001*cErSelf[5]*mnuSelf; 
  data->AEM_S(26,24) = 1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(26,25) = 1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(26,26) = 1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(26,27) = 1.341640786499874*m0rSelf[7]*mnuSelf-0.447213595499958*cErSelf[7]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(26,28) = 1.5*m0rSelf[6]*mnuSelf-0.5000000000000001*cErSelf[6]*mnuSelf; 
  data->AEM_S(26,29) = 1.341640786499874*m0rSelf[2]*mnuSelf-0.4472135954999579*cErSelf[2]*mnuSelf; 
  data->AEM_S(26,30) = 1.5*m0rSelf[4]*mnuSelf-0.5000000000000001*cErSelf[4]*mnuSelf; 
  data->AEM_S(26,31) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(27,24) = 1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(27,25) = 1.341640786499874*m0rSelf[6]*mnuSelf-0.447213595499958*cErSelf[6]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(27,26) = 1.341640786499874*m0rSelf[7]*mnuSelf-0.447213595499958*cErSelf[7]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(27,27) = 1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(27,28) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(27,29) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(27,30) = 1.2*m0rSelf[7]*mnuSelf-0.4*cErSelf[7]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.447213595499958*cErSelf[1]*mnuSelf; 
  data->AEM_S(27,31) = 1.2*m0rSelf[6]*mnuSelf-0.4*cErSelf[6]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.447213595499958*cErSelf[2]*mnuSelf; 
  data->AEM_S(28,24) = 1.5*m0rSelf[4]*mnuSelf-0.5*cErSelf[4]*mnuSelf; 
  data->AEM_S(28,25) = 1.341640786499874*m0rSelf[1]*mnuSelf-0.4472135954999579*cErSelf[1]*mnuSelf; 
  data->AEM_S(28,26) = 1.5*m0rSelf[6]*mnuSelf-0.5000000000000001*cErSelf[6]*mnuSelf; 
  data->AEM_S(28,27) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(28,28) = 0.9583148474999099*m0rSelf[4]*mnuSelf-0.31943828249997*cErSelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(28,30) = 0.9583148474999099*m0rSelf[6]*mnuSelf-0.31943828249997*cErSelf[6]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5000000000000001*cErSelf[2]*mnuSelf; 
  data->AEM_S(28,31) = 1.341640786499874*m0rSelf[7]*mnuSelf-0.4472135954999579*cErSelf[7]*mnuSelf; 
  data->AEM_S(29,24) = 1.5*m0rSelf[5]*mnuSelf-0.5*cErSelf[5]*mnuSelf; 
  data->AEM_S(29,25) = 1.5*m0rSelf[7]*mnuSelf-0.5000000000000001*cErSelf[7]*mnuSelf; 
  data->AEM_S(29,26) = 1.341640786499874*m0rSelf[2]*mnuSelf-0.4472135954999579*cErSelf[2]*mnuSelf; 
  data->AEM_S(29,27) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(29,29) = 0.9583148474999099*m0rSelf[5]*mnuSelf-0.31943828249997*cErSelf[5]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(29,30) = 1.341640786499874*m0rSelf[6]*mnuSelf-0.4472135954999579*cErSelf[6]*mnuSelf; 
  data->AEM_S(29,31) = 0.9583148474999099*m0rSelf[7]*mnuSelf-0.31943828249997*cErSelf[7]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5000000000000001*cErSelf[1]*mnuSelf; 
  data->AEM_S(30,24) = 1.5*m0rSelf[6]*mnuSelf-0.5*cErSelf[6]*mnuSelf; 
  data->AEM_S(30,25) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(30,26) = 1.5*m0rSelf[4]*mnuSelf-0.5000000000000001*cErSelf[4]*mnuSelf; 
  data->AEM_S(30,27) = 1.2*m0rSelf[7]*mnuSelf-0.4*cErSelf[7]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.447213595499958*cErSelf[1]*mnuSelf; 
  data->AEM_S(30,28) = 0.9583148474999099*m0rSelf[6]*mnuSelf-0.31943828249997*cErSelf[6]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5000000000000001*cErSelf[2]*mnuSelf; 
  data->AEM_S(30,29) = 1.341640786499874*m0rSelf[6]*mnuSelf-0.4472135954999579*cErSelf[6]*mnuSelf; 
  data->AEM_S(30,30) = 1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+0.9583148474999099*m0rSelf[4]*mnuSelf-0.31943828249997*cErSelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(30,31) = 1.2*m0rSelf[3]*mnuSelf-0.4*cErSelf[3]*mnuSelf; 
  data->AEM_S(31,24) = 1.5*m0rSelf[7]*mnuSelf-0.5*cErSelf[7]*mnuSelf; 
  data->AEM_S(31,25) = 1.5*m0rSelf[5]*mnuSelf-0.5000000000000001*cErSelf[5]*mnuSelf; 
  data->AEM_S(31,26) = 1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(31,27) = 1.2*m0rSelf[6]*mnuSelf-0.4*cErSelf[6]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.447213595499958*cErSelf[2]*mnuSelf; 
  data->AEM_S(31,28) = 1.341640786499874*m0rSelf[7]*mnuSelf-0.4472135954999579*cErSelf[7]*mnuSelf; 
  data->AEM_S(31,29) = 0.9583148474999099*m0rSelf[7]*mnuSelf-0.31943828249997*cErSelf[7]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5000000000000001*cErSelf[1]*mnuSelf; 
  data->AEM_S(31,30) = 1.2*m0rSelf[3]*mnuSelf-0.4*cErSelf[3]*mnuSelf; 
  data->AEM_S(31,31) = 0.9583148474999099*m0rSelf[5]*mnuSelf-0.31943828249997*cErSelf[5]*mnuSelf+1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
 
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(24,56) = 1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(24,57) = 1.5*m0rOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(24,58) = 1.5*m0rOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(24,59) = 1.5*m0rOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(24,60) = 1.5*m0rOther[4]*mnuOther-0.5*cErOther[4]*mnuOther; 
  data->AEM_S(24,61) = 1.5*m0rOther[5]*mnuOther-0.5*cErOther[5]*mnuOther; 
  data->AEM_S(24,62) = 1.5*m0rOther[6]*mnuOther-0.5*cErOther[6]*mnuOther; 
  data->AEM_S(24,63) = 1.5*m0rOther[7]*mnuOther-0.5*cErOther[7]*mnuOther; 
  data->AEM_S(25,56) = 1.5*m0rOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(25,57) = 1.341640786499874*m0rOther[4]*mnuOther-0.4472135954999579*cErOther[4]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(25,58) = 1.5*m0rOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(25,59) = 1.341640786499874*m0rOther[6]*mnuOther-0.447213595499958*cErOther[6]*mnuOther+1.5*m0rOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(25,60) = 1.341640786499874*m0rOther[1]*mnuOther-0.4472135954999579*cErOther[1]*mnuOther; 
  data->AEM_S(25,61) = 1.5*m0rOther[7]*mnuOther-0.5000000000000001*cErOther[7]*mnuOther; 
  data->AEM_S(25,62) = 1.341640786499874*m0rOther[3]*mnuOther-0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(25,63) = 1.5*m0rOther[5]*mnuOther-0.5000000000000001*cErOther[5]*mnuOther; 
  data->AEM_S(26,56) = 1.5*m0rOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(26,57) = 1.5*m0rOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(26,58) = 1.341640786499874*m0rOther[5]*mnuOther-0.4472135954999579*cErOther[5]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(26,59) = 1.341640786499874*m0rOther[7]*mnuOther-0.447213595499958*cErOther[7]*mnuOther+1.5*m0rOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(26,60) = 1.5*m0rOther[6]*mnuOther-0.5000000000000001*cErOther[6]*mnuOther; 
  data->AEM_S(26,61) = 1.341640786499874*m0rOther[2]*mnuOther-0.4472135954999579*cErOther[2]*mnuOther; 
  data->AEM_S(26,62) = 1.5*m0rOther[4]*mnuOther-0.5000000000000001*cErOther[4]*mnuOther; 
  data->AEM_S(26,63) = 1.341640786499874*m0rOther[3]*mnuOther-0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(27,56) = 1.5*m0rOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(27,57) = 1.341640786499874*m0rOther[6]*mnuOther-0.447213595499958*cErOther[6]*mnuOther+1.5*m0rOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(27,58) = 1.341640786499874*m0rOther[7]*mnuOther-0.447213595499958*cErOther[7]*mnuOther+1.5*m0rOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(27,59) = 1.341640786499874*m0rOther[5]*mnuOther-0.4472135954999579*cErOther[5]*mnuOther+1.341640786499874*m0rOther[4]*mnuOther-0.4472135954999579*cErOther[4]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(27,60) = 1.341640786499874*m0rOther[3]*mnuOther-0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(27,61) = 1.341640786499874*m0rOther[3]*mnuOther-0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(27,62) = 1.2*m0rOther[7]*mnuOther-0.4*cErOther[7]*mnuOther+1.341640786499874*m0rOther[1]*mnuOther-0.447213595499958*cErOther[1]*mnuOther; 
  data->AEM_S(27,63) = 1.2*m0rOther[6]*mnuOther-0.4*cErOther[6]*mnuOther+1.341640786499874*m0rOther[2]*mnuOther-0.447213595499958*cErOther[2]*mnuOther; 
  data->AEM_S(28,56) = 1.5*m0rOther[4]*mnuOther-0.5*cErOther[4]*mnuOther; 
  data->AEM_S(28,57) = 1.341640786499874*m0rOther[1]*mnuOther-0.4472135954999579*cErOther[1]*mnuOther; 
  data->AEM_S(28,58) = 1.5*m0rOther[6]*mnuOther-0.5000000000000001*cErOther[6]*mnuOther; 
  data->AEM_S(28,59) = 1.341640786499874*m0rOther[3]*mnuOther-0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(28,60) = 0.9583148474999099*m0rOther[4]*mnuOther-0.31943828249997*cErOther[4]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(28,62) = 0.9583148474999099*m0rOther[6]*mnuOther-0.31943828249997*cErOther[6]*mnuOther+1.5*m0rOther[2]*mnuOther-0.5000000000000001*cErOther[2]*mnuOther; 
  data->AEM_S(28,63) = 1.341640786499874*m0rOther[7]*mnuOther-0.4472135954999579*cErOther[7]*mnuOther; 
  data->AEM_S(29,56) = 1.5*m0rOther[5]*mnuOther-0.5*cErOther[5]*mnuOther; 
  data->AEM_S(29,57) = 1.5*m0rOther[7]*mnuOther-0.5000000000000001*cErOther[7]*mnuOther; 
  data->AEM_S(29,58) = 1.341640786499874*m0rOther[2]*mnuOther-0.4472135954999579*cErOther[2]*mnuOther; 
  data->AEM_S(29,59) = 1.341640786499874*m0rOther[3]*mnuOther-0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(29,61) = 0.9583148474999099*m0rOther[5]*mnuOther-0.31943828249997*cErOther[5]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(29,62) = 1.341640786499874*m0rOther[6]*mnuOther-0.4472135954999579*cErOther[6]*mnuOther; 
  data->AEM_S(29,63) = 0.9583148474999099*m0rOther[7]*mnuOther-0.31943828249997*cErOther[7]*mnuOther+1.5*m0rOther[1]*mnuOther-0.5000000000000001*cErOther[1]*mnuOther; 
  data->AEM_S(30,56) = 1.5*m0rOther[6]*mnuOther-0.5*cErOther[6]*mnuOther; 
  data->AEM_S(30,57) = 1.341640786499874*m0rOther[3]*mnuOther-0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(30,58) = 1.5*m0rOther[4]*mnuOther-0.5000000000000001*cErOther[4]*mnuOther; 
  data->AEM_S(30,59) = 1.2*m0rOther[7]*mnuOther-0.4*cErOther[7]*mnuOther+1.341640786499874*m0rOther[1]*mnuOther-0.447213595499958*cErOther[1]*mnuOther; 
  data->AEM_S(30,60) = 0.9583148474999099*m0rOther[6]*mnuOther-0.31943828249997*cErOther[6]*mnuOther+1.5*m0rOther[2]*mnuOther-0.5000000000000001*cErOther[2]*mnuOther; 
  data->AEM_S(30,61) = 1.341640786499874*m0rOther[6]*mnuOther-0.4472135954999579*cErOther[6]*mnuOther; 
  data->AEM_S(30,62) = 1.341640786499874*m0rOther[5]*mnuOther-0.4472135954999579*cErOther[5]*mnuOther+0.9583148474999099*m0rOther[4]*mnuOther-0.31943828249997*cErOther[4]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(30,63) = 1.2*m0rOther[3]*mnuOther-0.4*cErOther[3]*mnuOther; 
  data->AEM_S(31,56) = 1.5*m0rOther[7]*mnuOther-0.5*cErOther[7]*mnuOther; 
  data->AEM_S(31,57) = 1.5*m0rOther[5]*mnuOther-0.5000000000000001*cErOther[5]*mnuOther; 
  data->AEM_S(31,58) = 1.341640786499874*m0rOther[3]*mnuOther-0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(31,59) = 1.2*m0rOther[6]*mnuOther-0.4*cErOther[6]*mnuOther+1.341640786499874*m0rOther[2]*mnuOther-0.447213595499958*cErOther[2]*mnuOther; 
  data->AEM_S(31,60) = 1.341640786499874*m0rOther[7]*mnuOther-0.4472135954999579*cErOther[7]*mnuOther; 
  data->AEM_S(31,61) = 0.9583148474999099*m0rOther[7]*mnuOther-0.31943828249997*cErOther[7]*mnuOther+1.5*m0rOther[1]*mnuOther-0.5000000000000001*cErOther[1]*mnuOther; 
  data->AEM_S(31,62) = 1.2*m0rOther[3]*mnuOther-0.4*cErOther[3]*mnuOther; 
  data->AEM_S(31,63) = 0.9583148474999099*m0rOther[5]*mnuOther-0.31943828249997*cErOther[5]*mnuOther+1.341640786499874*m0rOther[4]*mnuOther-0.4472135954999579*cErOther[4]*mnuOther+1.5*m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  ...
  // ... Block from correction to (self) 1st moment of collision operator ... // 
  data->AEM_S(32,24) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(32,25) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(32,26) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(32,27) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(32,28) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(32,29) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(32,30) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(32,31) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(33,24) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(33,25) = (-0.4472135954999579*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(33,26) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(33,27) = (-0.447213595499958*cMrSelf[6]*mnuSelf)-0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(33,28) = -0.4472135954999579*cMrSelf[1]*mnuSelf; 
  data->AEM_S(33,29) = -0.5000000000000001*cMrSelf[7]*mnuSelf; 
  data->AEM_S(33,30) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(33,31) = -0.5000000000000001*cMrSelf[5]*mnuSelf; 
  data->AEM_S(34,24) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(34,25) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(34,26) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(34,27) = (-0.447213595499958*cMrSelf[7]*mnuSelf)-0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(34,28) = -0.5000000000000001*cMrSelf[6]*mnuSelf; 
  data->AEM_S(34,29) = -0.4472135954999579*cMrSelf[2]*mnuSelf; 
  data->AEM_S(34,30) = -0.5000000000000001*cMrSelf[4]*mnuSelf; 
  data->AEM_S(34,31) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(35,24) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(35,25) = (-0.447213595499958*cMrSelf[6]*mnuSelf)-0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(35,26) = (-0.447213595499958*cMrSelf[7]*mnuSelf)-0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(35,27) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.4472135954999579*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(35,28) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(35,29) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(35,30) = (-0.4*cMrSelf[7]*mnuSelf)-0.447213595499958*cMrSelf[1]*mnuSelf; 
  data->AEM_S(35,31) = (-0.4*cMrSelf[6]*mnuSelf)-0.447213595499958*cMrSelf[2]*mnuSelf; 
  data->AEM_S(36,24) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(36,25) = -0.4472135954999579*cMrSelf[1]*mnuSelf; 
  data->AEM_S(36,26) = -0.5000000000000001*cMrSelf[6]*mnuSelf; 
  data->AEM_S(36,27) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(36,28) = (-0.31943828249997*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(36,30) = (-0.31943828249997*cMrSelf[6]*mnuSelf)-0.5000000000000001*cMrSelf[2]*mnuSelf; 
  data->AEM_S(36,31) = -0.4472135954999579*cMrSelf[7]*mnuSelf; 
  data->AEM_S(37,24) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(37,25) = -0.5000000000000001*cMrSelf[7]*mnuSelf; 
  data->AEM_S(37,26) = -0.4472135954999579*cMrSelf[2]*mnuSelf; 
  data->AEM_S(37,27) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(37,29) = (-0.31943828249997*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(37,30) = -0.4472135954999579*cMrSelf[6]*mnuSelf; 
  data->AEM_S(37,31) = (-0.31943828249997*cMrSelf[7]*mnuSelf)-0.5000000000000001*cMrSelf[1]*mnuSelf; 
  data->AEM_S(38,24) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(38,25) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(38,26) = -0.5000000000000001*cMrSelf[4]*mnuSelf; 
  data->AEM_S(38,27) = (-0.4*cMrSelf[7]*mnuSelf)-0.447213595499958*cMrSelf[1]*mnuSelf; 
  data->AEM_S(38,28) = (-0.31943828249997*cMrSelf[6]*mnuSelf)-0.5000000000000001*cMrSelf[2]*mnuSelf; 
  data->AEM_S(38,29) = -0.4472135954999579*cMrSelf[6]*mnuSelf; 
  data->AEM_S(38,30) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.31943828249997*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(38,31) = -0.4*cMrSelf[3]*mnuSelf; 
  data->AEM_S(39,24) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(39,25) = -0.5000000000000001*cMrSelf[5]*mnuSelf; 
  data->AEM_S(39,26) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(39,27) = (-0.4*cMrSelf[6]*mnuSelf)-0.447213595499958*cMrSelf[2]*mnuSelf; 
  data->AEM_S(39,28) = -0.4472135954999579*cMrSelf[7]*mnuSelf; 
  data->AEM_S(39,29) = (-0.31943828249997*cMrSelf[7]*mnuSelf)-0.5000000000000001*cMrSelf[1]*mnuSelf; 
  data->AEM_S(39,30) = -0.4*cMrSelf[3]*mnuSelf; 
  data->AEM_S(39,31) = (-0.31943828249997*cMrSelf[5]*mnuSelf)-0.4472135954999579*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to (other) 1st moment of collision operator ... // 
  data->AEM_S(32,56) = 0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(32,57) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(32,58) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(32,59) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(32,60) = 0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(32,61) = 0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(32,62) = 0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(32,63) = 0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(33,56) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(33,57) = 0.4472135954999579*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(33,58) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(33,59) = 0.447213595499958*cMrOther[6]*mnuOther+0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(33,60) = 0.4472135954999579*cMrOther[1]*mnuOther; 
  data->AEM_S(33,61) = 0.5000000000000001*cMrOther[7]*mnuOther; 
  data->AEM_S(33,62) = 0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(33,63) = 0.5000000000000001*cMrOther[5]*mnuOther; 
  data->AEM_S(34,56) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(34,57) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(34,58) = 0.4472135954999579*cMrOther[5]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(34,59) = 0.447213595499958*cMrOther[7]*mnuOther+0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(34,60) = 0.5000000000000001*cMrOther[6]*mnuOther; 
  data->AEM_S(34,61) = 0.4472135954999579*cMrOther[2]*mnuOther; 
  data->AEM_S(34,62) = 0.5000000000000001*cMrOther[4]*mnuOther; 
  data->AEM_S(34,63) = 0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(35,56) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(35,57) = 0.447213595499958*cMrOther[6]*mnuOther+0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(35,58) = 0.447213595499958*cMrOther[7]*mnuOther+0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(35,59) = 0.4472135954999579*cMrOther[5]*mnuOther+0.4472135954999579*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(35,60) = 0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(35,61) = 0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(35,62) = 0.4*cMrOther[7]*mnuOther+0.447213595499958*cMrOther[1]*mnuOther; 
  data->AEM_S(35,63) = 0.4*cMrOther[6]*mnuOther+0.447213595499958*cMrOther[2]*mnuOther; 
  data->AEM_S(36,56) = 0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(36,57) = 0.4472135954999579*cMrOther[1]*mnuOther; 
  data->AEM_S(36,58) = 0.5000000000000001*cMrOther[6]*mnuOther; 
  data->AEM_S(36,59) = 0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(36,60) = 0.31943828249997*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(36,62) = 0.31943828249997*cMrOther[6]*mnuOther+0.5000000000000001*cMrOther[2]*mnuOther; 
  data->AEM_S(36,63) = 0.4472135954999579*cMrOther[7]*mnuOther; 
  data->AEM_S(37,56) = 0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(37,57) = 0.5000000000000001*cMrOther[7]*mnuOther; 
  data->AEM_S(37,58) = 0.4472135954999579*cMrOther[2]*mnuOther; 
  data->AEM_S(37,59) = 0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(37,61) = 0.31943828249997*cMrOther[5]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(37,62) = 0.4472135954999579*cMrOther[6]*mnuOther; 
  data->AEM_S(37,63) = 0.31943828249997*cMrOther[7]*mnuOther+0.5000000000000001*cMrOther[1]*mnuOther; 
  data->AEM_S(38,56) = 0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(38,57) = 0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(38,58) = 0.5000000000000001*cMrOther[4]*mnuOther; 
  data->AEM_S(38,59) = 0.4*cMrOther[7]*mnuOther+0.447213595499958*cMrOther[1]*mnuOther; 
  data->AEM_S(38,60) = 0.31943828249997*cMrOther[6]*mnuOther+0.5000000000000001*cMrOther[2]*mnuOther; 
  data->AEM_S(38,61) = 0.4472135954999579*cMrOther[6]*mnuOther; 
  data->AEM_S(38,62) = 0.4472135954999579*cMrOther[5]*mnuOther+0.31943828249997*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(38,63) = 0.4*cMrOther[3]*mnuOther; 
  data->AEM_S(39,56) = 0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(39,57) = 0.5000000000000001*cMrOther[5]*mnuOther; 
  data->AEM_S(39,58) = 0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(39,59) = 0.4*cMrOther[6]*mnuOther+0.447213595499958*cMrOther[2]*mnuOther; 
  data->AEM_S(39,60) = 0.4472135954999579*cMrOther[7]*mnuOther; 
  data->AEM_S(39,61) = 0.31943828249997*cMrOther[7]*mnuOther+0.5000000000000001*cMrOther[1]*mnuOther; 
  data->AEM_S(39,62) = 0.4*cMrOther[3]*mnuOther; 
  data->AEM_S(39,63) = 0.31943828249997*cMrOther[5]*mnuOther+0.4472135954999579*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  ...
  // ... Block from correction to (self) 1st moment of collision operator ... // 
  data->AEM_S(40,24) = -0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(40,25) = -0.5*cMrSelf[9]*mnuSelf; 
  data->AEM_S(40,26) = -0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(40,27) = -0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(40,28) = -0.5*cMrSelf[12]*mnuSelf; 
  data->AEM_S(40,29) = -0.5*cMrSelf[13]*mnuSelf; 
  data->AEM_S(40,30) = -0.5*cMrSelf[14]*mnuSelf; 
  data->AEM_S(40,31) = -0.5*cMrSelf[15]*mnuSelf; 
  data->AEM_S(41,24) = -0.5*cMrSelf[9]*mnuSelf; 
  data->AEM_S(41,25) = (-0.4472135954999579*cMrSelf[12]*mnuSelf)-0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(41,26) = -0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(41,27) = (-0.447213595499958*cMrSelf[14]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(41,28) = -0.4472135954999579*cMrSelf[9]*mnuSelf; 
  data->AEM_S(41,29) = -0.5000000000000001*cMrSelf[15]*mnuSelf; 
  data->AEM_S(41,30) = -0.447213595499958*cMrSelf[11]*mnuSelf; 
  data->AEM_S(41,31) = -0.5000000000000001*cMrSelf[13]*mnuSelf; 
  data->AEM_S(42,24) = -0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(42,25) = -0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(42,26) = (-0.4472135954999579*cMrSelf[13]*mnuSelf)-0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(42,27) = (-0.447213595499958*cMrSelf[15]*mnuSelf)-0.5*cMrSelf[9]*mnuSelf; 
  data->AEM_S(42,28) = -0.5000000000000001*cMrSelf[14]*mnuSelf; 
  data->AEM_S(42,29) = -0.4472135954999579*cMrSelf[10]*mnuSelf; 
  data->AEM_S(42,30) = -0.5000000000000001*cMrSelf[12]*mnuSelf; 
  data->AEM_S(42,31) = -0.447213595499958*cMrSelf[11]*mnuSelf; 
  data->AEM_S(43,24) = -0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(43,25) = (-0.447213595499958*cMrSelf[14]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(43,26) = (-0.447213595499958*cMrSelf[15]*mnuSelf)-0.5*cMrSelf[9]*mnuSelf; 
  data->AEM_S(43,27) = (-0.4472135954999579*cMrSelf[13]*mnuSelf)-0.4472135954999579*cMrSelf[12]*mnuSelf-0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(43,28) = -0.4472135954999579*cMrSelf[11]*mnuSelf; 
  data->AEM_S(43,29) = -0.4472135954999579*cMrSelf[11]*mnuSelf; 
  data->AEM_S(43,30) = (-0.4*cMrSelf[15]*mnuSelf)-0.447213595499958*cMrSelf[9]*mnuSelf; 
  data->AEM_S(43,31) = (-0.4*cMrSelf[14]*mnuSelf)-0.447213595499958*cMrSelf[10]*mnuSelf; 
  data->AEM_S(44,24) = -0.5*cMrSelf[12]*mnuSelf; 
  data->AEM_S(44,25) = -0.4472135954999579*cMrSelf[9]*mnuSelf; 
  data->AEM_S(44,26) = -0.5000000000000001*cMrSelf[14]*mnuSelf; 
  data->AEM_S(44,27) = -0.4472135954999579*cMrSelf[11]*mnuSelf; 
  data->AEM_S(44,28) = (-0.31943828249997*cMrSelf[12]*mnuSelf)-0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(44,30) = (-0.31943828249997*cMrSelf[14]*mnuSelf)-0.5000000000000001*cMrSelf[10]*mnuSelf; 
  data->AEM_S(44,31) = -0.4472135954999579*cMrSelf[15]*mnuSelf; 
  data->AEM_S(45,24) = -0.5*cMrSelf[13]*mnuSelf; 
  data->AEM_S(45,25) = -0.5000000000000001*cMrSelf[15]*mnuSelf; 
  data->AEM_S(45,26) = -0.4472135954999579*cMrSelf[10]*mnuSelf; 
  data->AEM_S(45,27) = -0.4472135954999579*cMrSelf[11]*mnuSelf; 
  data->AEM_S(45,29) = (-0.31943828249997*cMrSelf[13]*mnuSelf)-0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(45,30) = -0.4472135954999579*cMrSelf[14]*mnuSelf; 
  data->AEM_S(45,31) = (-0.31943828249997*cMrSelf[15]*mnuSelf)-0.5000000000000001*cMrSelf[9]*mnuSelf; 
  data->AEM_S(46,24) = -0.5*cMrSelf[14]*mnuSelf; 
  data->AEM_S(46,25) = -0.447213595499958*cMrSelf[11]*mnuSelf; 
  data->AEM_S(46,26) = -0.5000000000000001*cMrSelf[12]*mnuSelf; 
  data->AEM_S(46,27) = (-0.4*cMrSelf[15]*mnuSelf)-0.447213595499958*cMrSelf[9]*mnuSelf; 
  data->AEM_S(46,28) = (-0.31943828249997*cMrSelf[14]*mnuSelf)-0.5000000000000001*cMrSelf[10]*mnuSelf; 
  data->AEM_S(46,29) = -0.4472135954999579*cMrSelf[14]*mnuSelf; 
  data->AEM_S(46,30) = (-0.4472135954999579*cMrSelf[13]*mnuSelf)-0.31943828249997*cMrSelf[12]*mnuSelf-0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(46,31) = -0.4*cMrSelf[11]*mnuSelf; 
  data->AEM_S(47,24) = -0.5*cMrSelf[15]*mnuSelf; 
  data->AEM_S(47,25) = -0.5000000000000001*cMrSelf[13]*mnuSelf; 
  data->AEM_S(47,26) = -0.447213595499958*cMrSelf[11]*mnuSelf; 
  data->AEM_S(47,27) = (-0.4*cMrSelf[14]*mnuSelf)-0.447213595499958*cMrSelf[10]*mnuSelf; 
  data->AEM_S(47,28) = -0.4472135954999579*cMrSelf[15]*mnuSelf; 
  data->AEM_S(47,29) = (-0.31943828249997*cMrSelf[15]*mnuSelf)-0.5000000000000001*cMrSelf[9]*mnuSelf; 
  data->AEM_S(47,30) = -0.4*cMrSelf[11]*mnuSelf; 
  data->AEM_S(47,31) = (-0.31943828249997*cMrSelf[13]*mnuSelf)-0.4472135954999579*cMrSelf[12]*mnuSelf-0.5*cMrSelf[8]*mnuSelf; 
  ...
  // ... Block from correction to (other) 1st moment of collision operator ... // 
  data->AEM_S(40,56) = 0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(40,57) = 0.5*cMrOther[9]*mnuOther; 
  data->AEM_S(40,58) = 0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(40,59) = 0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(40,60) = 0.5*cMrOther[12]*mnuOther; 
  data->AEM_S(40,61) = 0.5*cMrOther[13]*mnuOther; 
  data->AEM_S(40,62) = 0.5*cMrOther[14]*mnuOther; 
  data->AEM_S(40,63) = 0.5*cMrOther[15]*mnuOther; 
  data->AEM_S(41,56) = 0.5*cMrOther[9]*mnuOther; 
  data->AEM_S(41,57) = 0.4472135954999579*cMrOther[12]*mnuOther+0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(41,58) = 0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(41,59) = 0.447213595499958*cMrOther[14]*mnuOther+0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(41,60) = 0.4472135954999579*cMrOther[9]*mnuOther; 
  data->AEM_S(41,61) = 0.5000000000000001*cMrOther[15]*mnuOther; 
  data->AEM_S(41,62) = 0.447213595499958*cMrOther[11]*mnuOther; 
  data->AEM_S(41,63) = 0.5000000000000001*cMrOther[13]*mnuOther; 
  data->AEM_S(42,56) = 0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(42,57) = 0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(42,58) = 0.4472135954999579*cMrOther[13]*mnuOther+0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(42,59) = 0.447213595499958*cMrOther[15]*mnuOther+0.5*cMrOther[9]*mnuOther; 
  data->AEM_S(42,60) = 0.5000000000000001*cMrOther[14]*mnuOther; 
  data->AEM_S(42,61) = 0.4472135954999579*cMrOther[10]*mnuOther; 
  data->AEM_S(42,62) = 0.5000000000000001*cMrOther[12]*mnuOther; 
  data->AEM_S(42,63) = 0.447213595499958*cMrOther[11]*mnuOther; 
  data->AEM_S(43,56) = 0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(43,57) = 0.447213595499958*cMrOther[14]*mnuOther+0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(43,58) = 0.447213595499958*cMrOther[15]*mnuOther+0.5*cMrOther[9]*mnuOther; 
  data->AEM_S(43,59) = 0.4472135954999579*cMrOther[13]*mnuOther+0.4472135954999579*cMrOther[12]*mnuOther+0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(43,60) = 0.4472135954999579*cMrOther[11]*mnuOther; 
  data->AEM_S(43,61) = 0.4472135954999579*cMrOther[11]*mnuOther; 
  data->AEM_S(43,62) = 0.4*cMrOther[15]*mnuOther+0.447213595499958*cMrOther[9]*mnuOther; 
  data->AEM_S(43,63) = 0.4*cMrOther[14]*mnuOther+0.447213595499958*cMrOther[10]*mnuOther; 
  data->AEM_S(44,56) = 0.5*cMrOther[12]*mnuOther; 
  data->AEM_S(44,57) = 0.4472135954999579*cMrOther[9]*mnuOther; 
  data->AEM_S(44,58) = 0.5000000000000001*cMrOther[14]*mnuOther; 
  data->AEM_S(44,59) = 0.4472135954999579*cMrOther[11]*mnuOther; 
  data->AEM_S(44,60) = 0.31943828249997*cMrOther[12]*mnuOther+0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(44,62) = 0.31943828249997*cMrOther[14]*mnuOther+0.5000000000000001*cMrOther[10]*mnuOther; 
  data->AEM_S(44,63) = 0.4472135954999579*cMrOther[15]*mnuOther; 
  data->AEM_S(45,56) = 0.5*cMrOther[13]*mnuOther; 
  data->AEM_S(45,57) = 0.5000000000000001*cMrOther[15]*mnuOther; 
  data->AEM_S(45,58) = 0.4472135954999579*cMrOther[10]*mnuOther; 
  data->AEM_S(45,59) = 0.4472135954999579*cMrOther[11]*mnuOther; 
  data->AEM_S(45,61) = 0.31943828249997*cMrOther[13]*mnuOther+0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(45,62) = 0.4472135954999579*cMrOther[14]*mnuOther; 
  data->AEM_S(45,63) = 0.31943828249997*cMrOther[15]*mnuOther+0.5000000000000001*cMrOther[9]*mnuOther; 
  data->AEM_S(46,56) = 0.5*cMrOther[14]*mnuOther; 
  data->AEM_S(46,57) = 0.447213595499958*cMrOther[11]*mnuOther; 
  data->AEM_S(46,58) = 0.5000000000000001*cMrOther[12]*mnuOther; 
  data->AEM_S(46,59) = 0.4*cMrOther[15]*mnuOther+0.447213595499958*cMrOther[9]*mnuOther; 
  data->AEM_S(46,60) = 0.31943828249997*cMrOther[14]*mnuOther+0.5000000000000001*cMrOther[10]*mnuOther; 
  data->AEM_S(46,61) = 0.4472135954999579*cMrOther[14]*mnuOther; 
  data->AEM_S(46,62) = 0.4472135954999579*cMrOther[13]*mnuOther+0.31943828249997*cMrOther[12]*mnuOther+0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(46,63) = 0.4*cMrOther[11]*mnuOther; 
  data->AEM_S(47,56) = 0.5*cMrOther[15]*mnuOther; 
  data->AEM_S(47,57) = 0.5000000000000001*cMrOther[13]*mnuOther; 
  data->AEM_S(47,58) = 0.447213595499958*cMrOther[11]*mnuOther; 
  data->AEM_S(47,59) = 0.4*cMrOther[14]*mnuOther+0.447213595499958*cMrOther[10]*mnuOther; 
  data->AEM_S(47,60) = 0.4472135954999579*cMrOther[15]*mnuOther; 
  data->AEM_S(47,61) = 0.31943828249997*cMrOther[15]*mnuOther+0.5000000000000001*cMrOther[9]*mnuOther; 
  data->AEM_S(47,62) = 0.4*cMrOther[11]*mnuOther; 
  data->AEM_S(47,63) = 0.31943828249997*cMrOther[13]*mnuOther+0.4472135954999579*cMrOther[12]*mnuOther+0.5*cMrOther[8]*mnuOther; 
  ...
  // ... Block from correction to (self) 1st moment of collision operator ... // 
  data->AEM_S(48,24) = -0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(48,25) = -0.5*cMrSelf[17]*mnuSelf; 
  data->AEM_S(48,26) = -0.5*cMrSelf[18]*mnuSelf; 
  data->AEM_S(48,27) = -0.5*cMrSelf[19]*mnuSelf; 
  data->AEM_S(48,28) = -0.5*cMrSelf[20]*mnuSelf; 
  data->AEM_S(48,29) = -0.5*cMrSelf[21]*mnuSelf; 
  data->AEM_S(48,30) = -0.5*cMrSelf[22]*mnuSelf; 
  data->AEM_S(48,31) = -0.5*cMrSelf[23]*mnuSelf; 
  data->AEM_S(49,24) = -0.5*cMrSelf[17]*mnuSelf; 
  data->AEM_S(49,25) = (-0.4472135954999579*cMrSelf[20]*mnuSelf)-0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(49,26) = -0.5*cMrSelf[19]*mnuSelf; 
  data->AEM_S(49,27) = (-0.447213595499958*cMrSelf[22]*mnuSelf)-0.5*cMrSelf[18]*mnuSelf; 
  data->AEM_S(49,28) = -0.4472135954999579*cMrSelf[17]*mnuSelf; 
  data->AEM_S(49,29) = -0.5000000000000001*cMrSelf[23]*mnuSelf; 
  data->AEM_S(49,30) = -0.447213595499958*cMrSelf[19]*mnuSelf; 
  data->AEM_S(49,31) = -0.5000000000000001*cMrSelf[21]*mnuSelf; 
  data->AEM_S(50,24) = -0.5*cMrSelf[18]*mnuSelf; 
  data->AEM_S(50,25) = -0.5*cMrSelf[19]*mnuSelf; 
  data->AEM_S(50,26) = (-0.4472135954999579*cMrSelf[21]*mnuSelf)-0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(50,27) = (-0.447213595499958*cMrSelf[23]*mnuSelf)-0.5*cMrSelf[17]*mnuSelf; 
  data->AEM_S(50,28) = -0.5000000000000001*cMrSelf[22]*mnuSelf; 
  data->AEM_S(50,29) = -0.4472135954999579*cMrSelf[18]*mnuSelf; 
  data->AEM_S(50,30) = -0.5000000000000001*cMrSelf[20]*mnuSelf; 
  data->AEM_S(50,31) = -0.447213595499958*cMrSelf[19]*mnuSelf; 
  data->AEM_S(51,24) = -0.5*cMrSelf[19]*mnuSelf; 
  data->AEM_S(51,25) = (-0.447213595499958*cMrSelf[22]*mnuSelf)-0.5*cMrSelf[18]*mnuSelf; 
  data->AEM_S(51,26) = (-0.447213595499958*cMrSelf[23]*mnuSelf)-0.5*cMrSelf[17]*mnuSelf; 
  data->AEM_S(51,27) = (-0.4472135954999579*cMrSelf[21]*mnuSelf)-0.4472135954999579*cMrSelf[20]*mnuSelf-0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(51,28) = -0.4472135954999579*cMrSelf[19]*mnuSelf; 
  data->AEM_S(51,29) = -0.4472135954999579*cMrSelf[19]*mnuSelf; 
  data->AEM_S(51,30) = (-0.4*cMrSelf[23]*mnuSelf)-0.447213595499958*cMrSelf[17]*mnuSelf; 
  data->AEM_S(51,31) = (-0.4*cMrSelf[22]*mnuSelf)-0.447213595499958*cMrSelf[18]*mnuSelf; 
  data->AEM_S(52,24) = -0.5*cMrSelf[20]*mnuSelf; 
  data->AEM_S(52,25) = -0.4472135954999579*cMrSelf[17]*mnuSelf; 
  data->AEM_S(52,26) = -0.5000000000000001*cMrSelf[22]*mnuSelf; 
  data->AEM_S(52,27) = -0.4472135954999579*cMrSelf[19]*mnuSelf; 
  data->AEM_S(52,28) = (-0.31943828249997*cMrSelf[20]*mnuSelf)-0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(52,30) = (-0.31943828249997*cMrSelf[22]*mnuSelf)-0.5000000000000001*cMrSelf[18]*mnuSelf; 
  data->AEM_S(52,31) = -0.4472135954999579*cMrSelf[23]*mnuSelf; 
  data->AEM_S(53,24) = -0.5*cMrSelf[21]*mnuSelf; 
  data->AEM_S(53,25) = -0.5000000000000001*cMrSelf[23]*mnuSelf; 
  data->AEM_S(53,26) = -0.4472135954999579*cMrSelf[18]*mnuSelf; 
  data->AEM_S(53,27) = -0.4472135954999579*cMrSelf[19]*mnuSelf; 
  data->AEM_S(53,29) = (-0.31943828249997*cMrSelf[21]*mnuSelf)-0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(53,30) = -0.4472135954999579*cMrSelf[22]*mnuSelf; 
  data->AEM_S(53,31) = (-0.31943828249997*cMrSelf[23]*mnuSelf)-0.5000000000000001*cMrSelf[17]*mnuSelf; 
  data->AEM_S(54,24) = -0.5*cMrSelf[22]*mnuSelf; 
  data->AEM_S(54,25) = -0.447213595499958*cMrSelf[19]*mnuSelf; 
  data->AEM_S(54,26) = -0.5000000000000001*cMrSelf[20]*mnuSelf; 
  data->AEM_S(54,27) = (-0.4*cMrSelf[23]*mnuSelf)-0.447213595499958*cMrSelf[17]*mnuSelf; 
  data->AEM_S(54,28) = (-0.31943828249997*cMrSelf[22]*mnuSelf)-0.5000000000000001*cMrSelf[18]*mnuSelf; 
  data->AEM_S(54,29) = -0.4472135954999579*cMrSelf[22]*mnuSelf; 
  data->AEM_S(54,30) = (-0.4472135954999579*cMrSelf[21]*mnuSelf)-0.31943828249997*cMrSelf[20]*mnuSelf-0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(54,31) = -0.4*cMrSelf[19]*mnuSelf; 
  data->AEM_S(55,24) = -0.5*cMrSelf[23]*mnuSelf; 
  data->AEM_S(55,25) = -0.5000000000000001*cMrSelf[21]*mnuSelf; 
  data->AEM_S(55,26) = -0.447213595499958*cMrSelf[19]*mnuSelf; 
  data->AEM_S(55,27) = (-0.4*cMrSelf[22]*mnuSelf)-0.447213595499958*cMrSelf[18]*mnuSelf; 
  data->AEM_S(55,28) = -0.4472135954999579*cMrSelf[23]*mnuSelf; 
  data->AEM_S(55,29) = (-0.31943828249997*cMrSelf[23]*mnuSelf)-0.5000000000000001*cMrSelf[17]*mnuSelf; 
  data->AEM_S(55,30) = -0.4*cMrSelf[19]*mnuSelf; 
  data->AEM_S(55,31) = (-0.31943828249997*cMrSelf[21]*mnuSelf)-0.4472135954999579*cMrSelf[20]*mnuSelf-0.5*cMrSelf[16]*mnuSelf; 
  ...
  // ... Block from correction to (other) 1st moment of collision operator ... // 
  data->AEM_S(48,56) = 0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(48,57) = 0.5*cMrOther[17]*mnuOther; 
  data->AEM_S(48,58) = 0.5*cMrOther[18]*mnuOther; 
  data->AEM_S(48,59) = 0.5*cMrOther[19]*mnuOther; 
  data->AEM_S(48,60) = 0.5*cMrOther[20]*mnuOther; 
  data->AEM_S(48,61) = 0.5*cMrOther[21]*mnuOther; 
  data->AEM_S(48,62) = 0.5*cMrOther[22]*mnuOther; 
  data->AEM_S(48,63) = 0.5*cMrOther[23]*mnuOther; 
  data->AEM_S(49,56) = 0.5*cMrOther[17]*mnuOther; 
  data->AEM_S(49,57) = 0.4472135954999579*cMrOther[20]*mnuOther+0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(49,58) = 0.5*cMrOther[19]*mnuOther; 
  data->AEM_S(49,59) = 0.447213595499958*cMrOther[22]*mnuOther+0.5*cMrOther[18]*mnuOther; 
  data->AEM_S(49,60) = 0.4472135954999579*cMrOther[17]*mnuOther; 
  data->AEM_S(49,61) = 0.5000000000000001*cMrOther[23]*mnuOther; 
  data->AEM_S(49,62) = 0.447213595499958*cMrOther[19]*mnuOther; 
  data->AEM_S(49,63) = 0.5000000000000001*cMrOther[21]*mnuOther; 
  data->AEM_S(50,56) = 0.5*cMrOther[18]*mnuOther; 
  data->AEM_S(50,57) = 0.5*cMrOther[19]*mnuOther; 
  data->AEM_S(50,58) = 0.4472135954999579*cMrOther[21]*mnuOther+0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(50,59) = 0.447213595499958*cMrOther[23]*mnuOther+0.5*cMrOther[17]*mnuOther; 
  data->AEM_S(50,60) = 0.5000000000000001*cMrOther[22]*mnuOther; 
  data->AEM_S(50,61) = 0.4472135954999579*cMrOther[18]*mnuOther; 
  data->AEM_S(50,62) = 0.5000000000000001*cMrOther[20]*mnuOther; 
  data->AEM_S(50,63) = 0.447213595499958*cMrOther[19]*mnuOther; 
  data->AEM_S(51,56) = 0.5*cMrOther[19]*mnuOther; 
  data->AEM_S(51,57) = 0.447213595499958*cMrOther[22]*mnuOther+0.5*cMrOther[18]*mnuOther; 
  data->AEM_S(51,58) = 0.447213595499958*cMrOther[23]*mnuOther+0.5*cMrOther[17]*mnuOther; 
  data->AEM_S(51,59) = 0.4472135954999579*cMrOther[21]*mnuOther+0.4472135954999579*cMrOther[20]*mnuOther+0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(51,60) = 0.4472135954999579*cMrOther[19]*mnuOther; 
  data->AEM_S(51,61) = 0.4472135954999579*cMrOther[19]*mnuOther; 
  data->AEM_S(51,62) = 0.4*cMrOther[23]*mnuOther+0.447213595499958*cMrOther[17]*mnuOther; 
  data->AEM_S(51,63) = 0.4*cMrOther[22]*mnuOther+0.447213595499958*cMrOther[18]*mnuOther; 
  data->AEM_S(52,56) = 0.5*cMrOther[20]*mnuOther; 
  data->AEM_S(52,57) = 0.4472135954999579*cMrOther[17]*mnuOther; 
  data->AEM_S(52,58) = 0.5000000000000001*cMrOther[22]*mnuOther; 
  data->AEM_S(52,59) = 0.4472135954999579*cMrOther[19]*mnuOther; 
  data->AEM_S(52,60) = 0.31943828249997*cMrOther[20]*mnuOther+0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(52,62) = 0.31943828249997*cMrOther[22]*mnuOther+0.5000000000000001*cMrOther[18]*mnuOther; 
  data->AEM_S(52,63) = 0.4472135954999579*cMrOther[23]*mnuOther; 
  data->AEM_S(53,56) = 0.5*cMrOther[21]*mnuOther; 
  data->AEM_S(53,57) = 0.5000000000000001*cMrOther[23]*mnuOther; 
  data->AEM_S(53,58) = 0.4472135954999579*cMrOther[18]*mnuOther; 
  data->AEM_S(53,59) = 0.4472135954999579*cMrOther[19]*mnuOther; 
  data->AEM_S(53,61) = 0.31943828249997*cMrOther[21]*mnuOther+0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(53,62) = 0.4472135954999579*cMrOther[22]*mnuOther; 
  data->AEM_S(53,63) = 0.31943828249997*cMrOther[23]*mnuOther+0.5000000000000001*cMrOther[17]*mnuOther; 
  data->AEM_S(54,56) = 0.5*cMrOther[22]*mnuOther; 
  data->AEM_S(54,57) = 0.447213595499958*cMrOther[19]*mnuOther; 
  data->AEM_S(54,58) = 0.5000000000000001*cMrOther[20]*mnuOther; 
  data->AEM_S(54,59) = 0.4*cMrOther[23]*mnuOther+0.447213595499958*cMrOther[17]*mnuOther; 
  data->AEM_S(54,60) = 0.31943828249997*cMrOther[22]*mnuOther+0.5000000000000001*cMrOther[18]*mnuOther; 
  data->AEM_S(54,61) = 0.4472135954999579*cMrOther[22]*mnuOther; 
  data->AEM_S(54,62) = 0.4472135954999579*cMrOther[21]*mnuOther+0.31943828249997*cMrOther[20]*mnuOther+0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(54,63) = 0.4*cMrOther[19]*mnuOther; 
  data->AEM_S(55,56) = 0.5*cMrOther[23]*mnuOther; 
  data->AEM_S(55,57) = 0.5000000000000001*cMrOther[21]*mnuOther; 
  data->AEM_S(55,58) = 0.447213595499958*cMrOther[19]*mnuOther; 
  data->AEM_S(55,59) = 0.4*cMrOther[22]*mnuOther+0.447213595499958*cMrOther[18]*mnuOther; 
  data->AEM_S(55,60) = 0.4472135954999579*cMrOther[23]*mnuOther; 
  data->AEM_S(55,61) = 0.31943828249997*cMrOther[23]*mnuOther+0.5000000000000001*cMrOther[17]*mnuOther; 
  data->AEM_S(55,62) = 0.4*cMrOther[19]*mnuOther; 
  data->AEM_S(55,63) = 0.31943828249997*cMrOther[21]*mnuOther+0.4472135954999579*cMrOther[20]*mnuOther+0.5*cMrOther[16]*mnuOther; 
  ...
  // ... Block from correction to (self) 2nd moment of collision operator ... // 
  data->AEM_S(56,24) = 0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(56,25) = 0.5*ucMSelf[1]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(56,26) = 0.5*ucMSelf[2]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(56,27) = 0.5*ucMSelf[3]*mnuSelf+1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(56,28) = 0.5*ucMSelf[4]*mnuSelf+1.5*m0rSelf[4]*mnuSelf-0.5*cErSelf[4]*mnuSelf; 
  data->AEM_S(56,29) = 0.5*ucMSelf[5]*mnuSelf+1.5*m0rSelf[5]*mnuSelf-0.5*cErSelf[5]*mnuSelf; 
  data->AEM_S(56,30) = 0.5*ucMSelf[6]*mnuSelf+1.5*m0rSelf[6]*mnuSelf-0.5*cErSelf[6]*mnuSelf; 
  data->AEM_S(56,31) = 0.5*ucMSelf[7]*mnuSelf+1.5*m0rSelf[7]*mnuSelf-0.5*cErSelf[7]*mnuSelf; 
  data->AEM_S(57,24) = 0.5*ucMSelf[1]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(57,25) = 0.4472135954999579*ucMSelf[4]*mnuSelf+1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(57,26) = 0.5*ucMSelf[3]*mnuSelf+1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(57,27) = 0.447213595499958*ucMSelf[6]*mnuSelf+1.341640786499874*m0rSelf[6]*mnuSelf-0.447213595499958*cErSelf[6]*mnuSelf+0.5*ucMSelf[2]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(57,28) = 0.4472135954999579*ucMSelf[1]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.4472135954999579*cErSelf[1]*mnuSelf; 
  data->AEM_S(57,29) = 0.5000000000000001*ucMSelf[7]*mnuSelf+1.5*m0rSelf[7]*mnuSelf-0.5000000000000001*cErSelf[7]*mnuSelf; 
  data->AEM_S(57,30) = 0.447213595499958*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(57,31) = 0.5000000000000001*ucMSelf[5]*mnuSelf+1.5*m0rSelf[5]*mnuSelf-0.5000000000000001*cErSelf[5]*mnuSelf; 
  data->AEM_S(58,24) = 0.5*ucMSelf[2]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(58,25) = 0.5*ucMSelf[3]*mnuSelf+1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(58,26) = 0.4472135954999579*ucMSelf[5]*mnuSelf+1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(58,27) = 0.447213595499958*ucMSelf[7]*mnuSelf+1.341640786499874*m0rSelf[7]*mnuSelf-0.447213595499958*cErSelf[7]*mnuSelf+0.5*ucMSelf[1]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(58,28) = 0.5000000000000001*ucMSelf[6]*mnuSelf+1.5*m0rSelf[6]*mnuSelf-0.5000000000000001*cErSelf[6]*mnuSelf; 
  data->AEM_S(58,29) = 0.4472135954999579*ucMSelf[2]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.4472135954999579*cErSelf[2]*mnuSelf; 
  data->AEM_S(58,30) = 0.5000000000000001*ucMSelf[4]*mnuSelf+1.5*m0rSelf[4]*mnuSelf-0.5000000000000001*cErSelf[4]*mnuSelf; 
  data->AEM_S(58,31) = 0.447213595499958*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(59,24) = 0.5*ucMSelf[3]*mnuSelf+1.5*m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(59,25) = 0.447213595499958*ucMSelf[6]*mnuSelf+1.341640786499874*m0rSelf[6]*mnuSelf-0.447213595499958*cErSelf[6]*mnuSelf+0.5*ucMSelf[2]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(59,26) = 0.447213595499958*ucMSelf[7]*mnuSelf+1.341640786499874*m0rSelf[7]*mnuSelf-0.447213595499958*cErSelf[7]*mnuSelf+0.5*ucMSelf[1]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(59,27) = 0.4472135954999579*ucMSelf[5]*mnuSelf+1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+0.4472135954999579*ucMSelf[4]*mnuSelf+1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(59,28) = 0.4472135954999579*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(59,29) = 0.4472135954999579*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(59,30) = 0.4*ucMSelf[7]*mnuSelf+1.2*m0rSelf[7]*mnuSelf-0.4*cErSelf[7]*mnuSelf+0.447213595499958*ucMSelf[1]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.447213595499958*cErSelf[1]*mnuSelf; 
  data->AEM_S(59,31) = 0.4*ucMSelf[6]*mnuSelf+1.2*m0rSelf[6]*mnuSelf-0.4*cErSelf[6]*mnuSelf+0.447213595499958*ucMSelf[2]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.447213595499958*cErSelf[2]*mnuSelf; 
  data->AEM_S(60,24) = 0.5*ucMSelf[4]*mnuSelf+1.5*m0rSelf[4]*mnuSelf-0.5*cErSelf[4]*mnuSelf; 
  data->AEM_S(60,25) = 0.4472135954999579*ucMSelf[1]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.4472135954999579*cErSelf[1]*mnuSelf; 
  data->AEM_S(60,26) = 0.5000000000000001*ucMSelf[6]*mnuSelf+1.5*m0rSelf[6]*mnuSelf-0.5000000000000001*cErSelf[6]*mnuSelf; 
  data->AEM_S(60,27) = 0.4472135954999579*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(60,28) = 0.31943828249997*ucMSelf[4]*mnuSelf+0.9583148474999099*m0rSelf[4]*mnuSelf-0.31943828249997*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(60,30) = 0.31943828249997*ucMSelf[6]*mnuSelf+0.9583148474999099*m0rSelf[6]*mnuSelf-0.31943828249997*cErSelf[6]*mnuSelf+0.5000000000000001*ucMSelf[2]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5000000000000001*cErSelf[2]*mnuSelf; 
  data->AEM_S(60,31) = 0.4472135954999579*ucMSelf[7]*mnuSelf+1.341640786499874*m0rSelf[7]*mnuSelf-0.4472135954999579*cErSelf[7]*mnuSelf; 
  data->AEM_S(61,24) = 0.5*ucMSelf[5]*mnuSelf+1.5*m0rSelf[5]*mnuSelf-0.5*cErSelf[5]*mnuSelf; 
  data->AEM_S(61,25) = 0.5000000000000001*ucMSelf[7]*mnuSelf+1.5*m0rSelf[7]*mnuSelf-0.5000000000000001*cErSelf[7]*mnuSelf; 
  data->AEM_S(61,26) = 0.4472135954999579*ucMSelf[2]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.4472135954999579*cErSelf[2]*mnuSelf; 
  data->AEM_S(61,27) = 0.4472135954999579*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(61,29) = 0.31943828249997*ucMSelf[5]*mnuSelf+0.9583148474999099*m0rSelf[5]*mnuSelf-0.31943828249997*cErSelf[5]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(61,30) = 0.4472135954999579*ucMSelf[6]*mnuSelf+1.341640786499874*m0rSelf[6]*mnuSelf-0.4472135954999579*cErSelf[6]*mnuSelf; 
  data->AEM_S(61,31) = 0.31943828249997*ucMSelf[7]*mnuSelf+0.9583148474999099*m0rSelf[7]*mnuSelf-0.31943828249997*cErSelf[7]*mnuSelf+0.5000000000000001*ucMSelf[1]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5000000000000001*cErSelf[1]*mnuSelf; 
  data->AEM_S(62,24) = 0.5*ucMSelf[6]*mnuSelf+1.5*m0rSelf[6]*mnuSelf-0.5*cErSelf[6]*mnuSelf; 
  data->AEM_S(62,25) = 0.447213595499958*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(62,26) = 0.5000000000000001*ucMSelf[4]*mnuSelf+1.5*m0rSelf[4]*mnuSelf-0.5000000000000001*cErSelf[4]*mnuSelf; 
  data->AEM_S(62,27) = 0.4*ucMSelf[7]*mnuSelf+1.2*m0rSelf[7]*mnuSelf-0.4*cErSelf[7]*mnuSelf+0.447213595499958*ucMSelf[1]*mnuSelf+1.341640786499874*m0rSelf[1]*mnuSelf-0.447213595499958*cErSelf[1]*mnuSelf; 
  data->AEM_S(62,28) = 0.31943828249997*ucMSelf[6]*mnuSelf+0.9583148474999099*m0rSelf[6]*mnuSelf-0.31943828249997*cErSelf[6]*mnuSelf+0.5000000000000001*ucMSelf[2]*mnuSelf+1.5*m0rSelf[2]*mnuSelf-0.5000000000000001*cErSelf[2]*mnuSelf; 
  data->AEM_S(62,29) = 0.4472135954999579*ucMSelf[6]*mnuSelf+1.341640786499874*m0rSelf[6]*mnuSelf-0.4472135954999579*cErSelf[6]*mnuSelf; 
  data->AEM_S(62,30) = 0.4472135954999579*ucMSelf[5]*mnuSelf+1.341640786499874*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+0.31943828249997*ucMSelf[4]*mnuSelf+0.9583148474999099*m0rSelf[4]*mnuSelf-0.31943828249997*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(62,31) = 0.4*ucMSelf[3]*mnuSelf+1.2*m0rSelf[3]*mnuSelf-0.4*cErSelf[3]*mnuSelf; 
  data->AEM_S(63,24) = 0.5*ucMSelf[7]*mnuSelf+1.5*m0rSelf[7]*mnuSelf-0.5*cErSelf[7]*mnuSelf; 
  data->AEM_S(63,25) = 0.5000000000000001*ucMSelf[5]*mnuSelf+1.5*m0rSelf[5]*mnuSelf-0.5000000000000001*cErSelf[5]*mnuSelf; 
  data->AEM_S(63,26) = 0.447213595499958*ucMSelf[3]*mnuSelf+1.341640786499874*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(63,27) = 0.4*ucMSelf[6]*mnuSelf+1.2*m0rSelf[6]*mnuSelf-0.4*cErSelf[6]*mnuSelf+0.447213595499958*ucMSelf[2]*mnuSelf+1.341640786499874*m0rSelf[2]*mnuSelf-0.447213595499958*cErSelf[2]*mnuSelf; 
  data->AEM_S(63,28) = 0.4472135954999579*ucMSelf[7]*mnuSelf+1.341640786499874*m0rSelf[7]*mnuSelf-0.4472135954999579*cErSelf[7]*mnuSelf; 
  data->AEM_S(63,29) = 0.31943828249997*ucMSelf[7]*mnuSelf+0.9583148474999099*m0rSelf[7]*mnuSelf-0.31943828249997*cErSelf[7]*mnuSelf+0.5000000000000001*ucMSelf[1]*mnuSelf+1.5*m0rSelf[1]*mnuSelf-0.5000000000000001*cErSelf[1]*mnuSelf; 
  data->AEM_S(63,30) = 0.4*ucMSelf[3]*mnuSelf+1.2*m0rSelf[3]*mnuSelf-0.4*cErSelf[3]*mnuSelf; 
  data->AEM_S(63,31) = 0.31943828249997*ucMSelf[5]*mnuSelf+0.9583148474999099*m0rSelf[5]*mnuSelf-0.31943828249997*cErSelf[5]*mnuSelf+0.4472135954999579*ucMSelf[4]*mnuSelf+1.341640786499874*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+1.5*m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to (other) 2nd moment of collision operator ... // 
  data->AEM_S(56,56) = (-0.5*ucMOther[0]*mnuOther)-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(56,57) = (-0.5*ucMOther[1]*mnuOther)-1.5*m0rOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(56,58) = (-0.5*ucMOther[2]*mnuOther)-1.5*m0rOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(56,59) = (-0.5*ucMOther[3]*mnuOther)-1.5*m0rOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(56,60) = (-0.5*ucMOther[4]*mnuOther)-1.5*m0rOther[4]*mnuOther+0.5*cErOther[4]*mnuOther; 
  data->AEM_S(56,61) = (-0.5*ucMOther[5]*mnuOther)-1.5*m0rOther[5]*mnuOther+0.5*cErOther[5]*mnuOther; 
  data->AEM_S(56,62) = (-0.5*ucMOther[6]*mnuOther)-1.5*m0rOther[6]*mnuOther+0.5*cErOther[6]*mnuOther; 
  data->AEM_S(56,63) = (-0.5*ucMOther[7]*mnuOther)-1.5*m0rOther[7]*mnuOther+0.5*cErOther[7]*mnuOther; 
  data->AEM_S(57,56) = (-0.5*ucMOther[1]*mnuOther)-1.5*m0rOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(57,57) = (-0.4472135954999579*ucMOther[4]*mnuOther)-1.341640786499874*m0rOther[4]*mnuOther+0.4472135954999579*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(57,58) = (-0.5*ucMOther[3]*mnuOther)-1.5*m0rOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(57,59) = (-0.447213595499958*ucMOther[6]*mnuOther)-1.341640786499874*m0rOther[6]*mnuOther+0.447213595499958*cErOther[6]*mnuOther-0.5*ucMOther[2]*mnuOther-1.5*m0rOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(57,60) = (-0.4472135954999579*ucMOther[1]*mnuOther)-1.341640786499874*m0rOther[1]*mnuOther+0.4472135954999579*cErOther[1]*mnuOther; 
  data->AEM_S(57,61) = (-0.5000000000000001*ucMOther[7]*mnuOther)-1.5*m0rOther[7]*mnuOther+0.5000000000000001*cErOther[7]*mnuOther; 
  data->AEM_S(57,62) = (-0.447213595499958*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(57,63) = (-0.5000000000000001*ucMOther[5]*mnuOther)-1.5*m0rOther[5]*mnuOther+0.5000000000000001*cErOther[5]*mnuOther; 
  data->AEM_S(58,56) = (-0.5*ucMOther[2]*mnuOther)-1.5*m0rOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(58,57) = (-0.5*ucMOther[3]*mnuOther)-1.5*m0rOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(58,58) = (-0.4472135954999579*ucMOther[5]*mnuOther)-1.341640786499874*m0rOther[5]*mnuOther+0.4472135954999579*cErOther[5]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(58,59) = (-0.447213595499958*ucMOther[7]*mnuOther)-1.341640786499874*m0rOther[7]*mnuOther+0.447213595499958*cErOther[7]*mnuOther-0.5*ucMOther[1]*mnuOther-1.5*m0rOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(58,60) = (-0.5000000000000001*ucMOther[6]*mnuOther)-1.5*m0rOther[6]*mnuOther+0.5000000000000001*cErOther[6]*mnuOther; 
  data->AEM_S(58,61) = (-0.4472135954999579*ucMOther[2]*mnuOther)-1.341640786499874*m0rOther[2]*mnuOther+0.4472135954999579*cErOther[2]*mnuOther; 
  data->AEM_S(58,62) = (-0.5000000000000001*ucMOther[4]*mnuOther)-1.5*m0rOther[4]*mnuOther+0.5000000000000001*cErOther[4]*mnuOther; 
  data->AEM_S(58,63) = (-0.447213595499958*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(59,56) = (-0.5*ucMOther[3]*mnuOther)-1.5*m0rOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(59,57) = (-0.447213595499958*ucMOther[6]*mnuOther)-1.341640786499874*m0rOther[6]*mnuOther+0.447213595499958*cErOther[6]*mnuOther-0.5*ucMOther[2]*mnuOther-1.5*m0rOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(59,58) = (-0.447213595499958*ucMOther[7]*mnuOther)-1.341640786499874*m0rOther[7]*mnuOther+0.447213595499958*cErOther[7]*mnuOther-0.5*ucMOther[1]*mnuOther-1.5*m0rOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(59,59) = (-0.4472135954999579*ucMOther[5]*mnuOther)-1.341640786499874*m0rOther[5]*mnuOther+0.4472135954999579*cErOther[5]*mnuOther-0.4472135954999579*ucMOther[4]*mnuOther-1.341640786499874*m0rOther[4]*mnuOther+0.4472135954999579*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(59,60) = (-0.4472135954999579*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(59,61) = (-0.4472135954999579*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(59,62) = (-0.4*ucMOther[7]*mnuOther)-1.2*m0rOther[7]*mnuOther+0.4*cErOther[7]*mnuOther-0.447213595499958*ucMOther[1]*mnuOther-1.341640786499874*m0rOther[1]*mnuOther+0.447213595499958*cErOther[1]*mnuOther; 
  data->AEM_S(59,63) = (-0.4*ucMOther[6]*mnuOther)-1.2*m0rOther[6]*mnuOther+0.4*cErOther[6]*mnuOther-0.447213595499958*ucMOther[2]*mnuOther-1.341640786499874*m0rOther[2]*mnuOther+0.447213595499958*cErOther[2]*mnuOther; 
  data->AEM_S(60,56) = (-0.5*ucMOther[4]*mnuOther)-1.5*m0rOther[4]*mnuOther+0.5*cErOther[4]*mnuOther; 
  data->AEM_S(60,57) = (-0.4472135954999579*ucMOther[1]*mnuOther)-1.341640786499874*m0rOther[1]*mnuOther+0.4472135954999579*cErOther[1]*mnuOther; 
  data->AEM_S(60,58) = (-0.5000000000000001*ucMOther[6]*mnuOther)-1.5*m0rOther[6]*mnuOther+0.5000000000000001*cErOther[6]*mnuOther; 
  data->AEM_S(60,59) = (-0.4472135954999579*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(60,60) = (-0.31943828249997*ucMOther[4]*mnuOther)-0.9583148474999099*m0rOther[4]*mnuOther+0.31943828249997*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(60,62) = (-0.31943828249997*ucMOther[6]*mnuOther)-0.9583148474999099*m0rOther[6]*mnuOther+0.31943828249997*cErOther[6]*mnuOther-0.5000000000000001*ucMOther[2]*mnuOther-1.5*m0rOther[2]*mnuOther+0.5000000000000001*cErOther[2]*mnuOther; 
  data->AEM_S(60,63) = (-0.4472135954999579*ucMOther[7]*mnuOther)-1.341640786499874*m0rOther[7]*mnuOther+0.4472135954999579*cErOther[7]*mnuOther; 
  data->AEM_S(61,56) = (-0.5*ucMOther[5]*mnuOther)-1.5*m0rOther[5]*mnuOther+0.5*cErOther[5]*mnuOther; 
  data->AEM_S(61,57) = (-0.5000000000000001*ucMOther[7]*mnuOther)-1.5*m0rOther[7]*mnuOther+0.5000000000000001*cErOther[7]*mnuOther; 
  data->AEM_S(61,58) = (-0.4472135954999579*ucMOther[2]*mnuOther)-1.341640786499874*m0rOther[2]*mnuOther+0.4472135954999579*cErOther[2]*mnuOther; 
  data->AEM_S(61,59) = (-0.4472135954999579*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(61,61) = (-0.31943828249997*ucMOther[5]*mnuOther)-0.9583148474999099*m0rOther[5]*mnuOther+0.31943828249997*cErOther[5]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(61,62) = (-0.4472135954999579*ucMOther[6]*mnuOther)-1.341640786499874*m0rOther[6]*mnuOther+0.4472135954999579*cErOther[6]*mnuOther; 
  data->AEM_S(61,63) = (-0.31943828249997*ucMOther[7]*mnuOther)-0.9583148474999099*m0rOther[7]*mnuOther+0.31943828249997*cErOther[7]*mnuOther-0.5000000000000001*ucMOther[1]*mnuOther-1.5*m0rOther[1]*mnuOther+0.5000000000000001*cErOther[1]*mnuOther; 
  data->AEM_S(62,56) = (-0.5*ucMOther[6]*mnuOther)-1.5*m0rOther[6]*mnuOther+0.5*cErOther[6]*mnuOther; 
  data->AEM_S(62,57) = (-0.447213595499958*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(62,58) = (-0.5000000000000001*ucMOther[4]*mnuOther)-1.5*m0rOther[4]*mnuOther+0.5000000000000001*cErOther[4]*mnuOther; 
  data->AEM_S(62,59) = (-0.4*ucMOther[7]*mnuOther)-1.2*m0rOther[7]*mnuOther+0.4*cErOther[7]*mnuOther-0.447213595499958*ucMOther[1]*mnuOther-1.341640786499874*m0rOther[1]*mnuOther+0.447213595499958*cErOther[1]*mnuOther; 
  data->AEM_S(62,60) = (-0.31943828249997*ucMOther[6]*mnuOther)-0.9583148474999099*m0rOther[6]*mnuOther+0.31943828249997*cErOther[6]*mnuOther-0.5000000000000001*ucMOther[2]*mnuOther-1.5*m0rOther[2]*mnuOther+0.5000000000000001*cErOther[2]*mnuOther; 
  data->AEM_S(62,61) = (-0.4472135954999579*ucMOther[6]*mnuOther)-1.341640786499874*m0rOther[6]*mnuOther+0.4472135954999579*cErOther[6]*mnuOther; 
  data->AEM_S(62,62) = (-0.4472135954999579*ucMOther[5]*mnuOther)-1.341640786499874*m0rOther[5]*mnuOther+0.4472135954999579*cErOther[5]*mnuOther-0.31943828249997*ucMOther[4]*mnuOther-0.9583148474999099*m0rOther[4]*mnuOther+0.31943828249997*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(62,63) = (-0.4*ucMOther[3]*mnuOther)-1.2*m0rOther[3]*mnuOther+0.4*cErOther[3]*mnuOther; 
  data->AEM_S(63,56) = (-0.5*ucMOther[7]*mnuOther)-1.5*m0rOther[7]*mnuOther+0.5*cErOther[7]*mnuOther; 
  data->AEM_S(63,57) = (-0.5000000000000001*ucMOther[5]*mnuOther)-1.5*m0rOther[5]*mnuOther+0.5000000000000001*cErOther[5]*mnuOther; 
  data->AEM_S(63,58) = (-0.447213595499958*ucMOther[3]*mnuOther)-1.341640786499874*m0rOther[3]*mnuOther+0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(63,59) = (-0.4*ucMOther[6]*mnuOther)-1.2*m0rOther[6]*mnuOther+0.4*cErOther[6]*mnuOther-0.447213595499958*ucMOther[2]*mnuOther-1.341640786499874*m0rOther[2]*mnuOther+0.447213595499958*cErOther[2]*mnuOther; 
  data->AEM_S(63,60) = (-0.4472135954999579*ucMOther[7]*mnuOther)-1.341640786499874*m0rOther[7]*mnuOther+0.4472135954999579*cErOther[7]*mnuOther; 
  data->AEM_S(63,61) = (-0.31943828249997*ucMOther[7]*mnuOther)-0.9583148474999099*m0rOther[7]*mnuOther+0.31943828249997*cErOther[7]*mnuOther-0.5000000000000001*ucMOther[1]*mnuOther-1.5*m0rOther[1]*mnuOther+0.5000000000000001*cErOther[1]*mnuOther; 
  data->AEM_S(63,62) = (-0.4*ucMOther[3]*mnuOther)-1.2*m0rOther[3]*mnuOther+0.4*cErOther[3]*mnuOther; 
  data->AEM_S(63,63) = (-0.31943828249997*ucMOther[5]*mnuOther)-0.9583148474999099*m0rOther[5]*mnuOther+0.31943828249997*cErOther[5]*mnuOther-0.4472135954999579*ucMOther[4]*mnuOther-1.341640786499874*m0rOther[4]*mnuOther+0.4472135954999579*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.5*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
