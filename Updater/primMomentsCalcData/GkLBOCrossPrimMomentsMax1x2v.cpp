...
{ 
  ...
  data->AEM_S(2,2) = 1.414213562373095*m0rSelf[0]*mnuSelf+0.7071067811865475*m0SrSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  data->AEM_S(2,3) = 1.414213562373095*m0rSelf[1]*mnuSelf+0.7071067811865475*m0SrSelf[1]*mnuSelf-0.7071067811865475*cErSelf[1]*mnuSelf; 
  data->AEM_S(3,2) = 1.414213562373095*m0rSelf[1]*mnuSelf+0.7071067811865475*m0SrSelf[1]*mnuSelf-0.7071067811865475*cErSelf[1]*mnuSelf; 
  data->AEM_S(3,3) = 1.414213562373095*m0rSelf[0]*mnuSelf+0.7071067811865475*m0SrSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
 
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(2,6) = 1.414213562373095*m0rOther[0]*mnuOther+0.7071067811865475*m0SrOther[0]*mnuOther-0.7071067811865475*cErOther[0]*mnuOther; 
  data->AEM_S(2,7) = 1.414213562373095*m0rOther[1]*mnuOther+0.7071067811865475*m0SrOther[1]*mnuOther-0.7071067811865475*cErOther[1]*mnuOther; 
  data->AEM_S(3,6) = 1.414213562373095*m0rOther[1]*mnuOther+0.7071067811865475*m0SrOther[1]*mnuOther-0.7071067811865475*cErOther[1]*mnuOther; 
  data->AEM_S(3,7) = 1.414213562373095*m0rOther[0]*mnuOther+0.7071067811865475*m0SrOther[0]*mnuOther-0.7071067811865475*cErOther[0]*mnuOther; 
  ...
  data->AEM_S(6,2) = 0.7071067811865475*ucMSelf[0]*mnuSelf+1.414213562373095*m0rSelf[0]*mnuSelf+0.7071067811865475*m0SrSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  data->AEM_S(6,3) = 0.7071067811865475*ucMSelf[1]*mnuSelf+1.414213562373095*m0rSelf[1]*mnuSelf+0.7071067811865475*m0SrSelf[1]*mnuSelf-0.7071067811865475*cErSelf[1]*mnuSelf; 
  data->AEM_S(7,2) = 0.7071067811865475*ucMSelf[1]*mnuSelf+1.414213562373095*m0rSelf[1]*mnuSelf+0.7071067811865475*m0SrSelf[1]*mnuSelf-0.7071067811865475*cErSelf[1]*mnuSelf; 
  data->AEM_S(7,3) = 0.7071067811865475*ucMSelf[0]*mnuSelf+1.414213562373095*m0rSelf[0]*mnuSelf+0.7071067811865475*m0SrSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  ...
  data->AEM_S(6,6) = (-0.7071067811865475*ucMOther[0]*mnuOther)-1.414213562373095*m0rOther[0]*mnuOther-0.7071067811865475*m0SrOther[0]*mnuOther+0.7071067811865475*cErOther[0]*mnuOther; 
  data->AEM_S(6,7) = (-0.7071067811865475*ucMOther[1]*mnuOther)-1.414213562373095*m0rOther[1]*mnuOther-0.7071067811865475*m0SrOther[1]*mnuOther+0.7071067811865475*cErOther[1]*mnuOther; 
  data->AEM_S(7,6) = (-0.7071067811865475*ucMOther[1]*mnuOther)-1.414213562373095*m0rOther[1]*mnuOther-0.7071067811865475*m0SrOther[1]*mnuOther+0.7071067811865475*cErOther[1]*mnuOther; 
  data->AEM_S(7,7) = (-0.7071067811865475*ucMOther[0]*mnuOther)-1.414213562373095*m0rOther[0]*mnuOther-0.7071067811865475*m0SrOther[0]*mnuOther+0.7071067811865475*cErOther[0]*mnuOther; 
...
{ 
  ...
  // ... Block from correction to energy conservation (self) ... // 
  data->AEM_S(3,3) = 2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  data->AEM_S(3,4) = 2.121320343559642*m0rSelf[1]*mnuSelf-0.7071067811865475*cErSelf[1]*mnuSelf; 
  data->AEM_S(3,5) = 2.121320343559642*m0rSelf[2]*mnuSelf-0.7071067811865475*cErSelf[2]*mnuSelf; 
  data->AEM_S(4,3) = 2.121320343559642*m0rSelf[1]*mnuSelf-0.7071067811865475*cErSelf[1]*mnuSelf; 
  data->AEM_S(4,4) = 1.897366596101028*m0rSelf[2]*mnuSelf-0.6324555320336759*cErSelf[2]*mnuSelf+2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  data->AEM_S(4,5) = 1.897366596101028*m0rSelf[1]*mnuSelf-0.6324555320336759*cErSelf[1]*mnuSelf; 
  data->AEM_S(5,3) = 2.121320343559642*m0rSelf[2]*mnuSelf-0.7071067811865475*cErSelf[2]*mnuSelf; 
  data->AEM_S(5,4) = 1.897366596101028*m0rSelf[1]*mnuSelf-0.6324555320336759*cErSelf[1]*mnuSelf; 
  data->AEM_S(5,5) = 1.355261854357877*m0rSelf[2]*mnuSelf-0.4517539514526256*cErSelf[2]*mnuSelf+2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
 
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(3,9) = 2.121320343559642*m0rOther[0]*mnuOther-0.7071067811865475*cErOther[0]*mnuOther; 
  data->AEM_S(3,10) = 2.121320343559642*m0rOther[1]*mnuOther-0.7071067811865475*cErOther[1]*mnuOther; 
  data->AEM_S(3,11) = 2.121320343559642*m0rOther[2]*mnuOther-0.7071067811865475*cErOther[2]*mnuOther; 
  data->AEM_S(4,9) = 2.121320343559642*m0rOther[1]*mnuOther-0.7071067811865475*cErOther[1]*mnuOther; 
  data->AEM_S(4,10) = 1.897366596101028*m0rOther[2]*mnuOther-0.6324555320336759*cErOther[2]*mnuOther+2.121320343559642*m0rOther[0]*mnuOther-0.7071067811865475*cErOther[0]*mnuOther; 
  data->AEM_S(4,11) = 1.897366596101028*m0rOther[1]*mnuOther-0.6324555320336759*cErOther[1]*mnuOther; 
  data->AEM_S(5,9) = 2.121320343559642*m0rOther[2]*mnuOther-0.7071067811865475*cErOther[2]*mnuOther; 
  data->AEM_S(5,10) = 1.897366596101028*m0rOther[1]*mnuOther-0.6324555320336759*cErOther[1]*mnuOther; 
  data->AEM_S(5,11) = 1.355261854357877*m0rOther[2]*mnuOther-0.4517539514526256*cErOther[2]*mnuOther+2.121320343559642*m0rOther[0]*mnuOther-0.7071067811865475*cErOther[0]*mnuOther; 
  ...
  // ... Block from correction to (self) 2nd moment of collision operator ... // 
  data->AEM_S(9,3) = 0.7071067811865475*ucMSelf[0]*mnuSelf+2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  data->AEM_S(9,4) = 0.7071067811865475*ucMSelf[1]*mnuSelf+2.121320343559642*m0rSelf[1]*mnuSelf-0.7071067811865475*cErSelf[1]*mnuSelf; 
  data->AEM_S(9,5) = 0.7071067811865475*ucMSelf[2]*mnuSelf+2.121320343559642*m0rSelf[2]*mnuSelf-0.7071067811865475*cErSelf[2]*mnuSelf; 
  data->AEM_S(10,3) = 0.7071067811865475*ucMSelf[1]*mnuSelf+2.121320343559642*m0rSelf[1]*mnuSelf-0.7071067811865475*cErSelf[1]*mnuSelf; 
  data->AEM_S(10,4) = 0.6324555320336759*ucMSelf[2]*mnuSelf+1.897366596101028*m0rSelf[2]*mnuSelf-0.6324555320336759*cErSelf[2]*mnuSelf+0.7071067811865475*ucMSelf[0]*mnuSelf+2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  data->AEM_S(10,5) = 0.6324555320336759*ucMSelf[1]*mnuSelf+1.897366596101028*m0rSelf[1]*mnuSelf-0.6324555320336759*cErSelf[1]*mnuSelf; 
  data->AEM_S(11,3) = 0.7071067811865475*ucMSelf[2]*mnuSelf+2.121320343559642*m0rSelf[2]*mnuSelf-0.7071067811865475*cErSelf[2]*mnuSelf; 
  data->AEM_S(11,4) = 0.6324555320336759*ucMSelf[1]*mnuSelf+1.897366596101028*m0rSelf[1]*mnuSelf-0.6324555320336759*cErSelf[1]*mnuSelf; 
  data->AEM_S(11,5) = 0.4517539514526256*ucMSelf[2]*mnuSelf+1.355261854357877*m0rSelf[2]*mnuSelf-0.4517539514526256*cErSelf[2]*mnuSelf+0.7071067811865475*ucMSelf[0]*mnuSelf+2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to (other) 2nd moment of collision operator ... // 
  data->AEM_S(9,9) = (-0.7071067811865475*ucMOther[0]*mnuOther)-2.121320343559642*m0rOther[0]*mnuOther+0.7071067811865475*cErOther[0]*mnuOther; 
  data->AEM_S(9,10) = (-0.7071067811865475*ucMOther[1]*mnuOther)-2.121320343559642*m0rOther[1]*mnuOther+0.7071067811865475*cErOther[1]*mnuOther; 
  data->AEM_S(9,11) = (-0.7071067811865475*ucMOther[2]*mnuOther)-2.121320343559642*m0rOther[2]*mnuOther+0.7071067811865475*cErOther[2]*mnuOther; 
  data->AEM_S(10,9) = (-0.7071067811865475*ucMOther[1]*mnuOther)-2.121320343559642*m0rOther[1]*mnuOther+0.7071067811865475*cErOther[1]*mnuOther; 
  data->AEM_S(10,10) = (-0.6324555320336759*ucMOther[2]*mnuOther)-1.897366596101028*m0rOther[2]*mnuOther+0.6324555320336759*cErOther[2]*mnuOther-0.7071067811865475*ucMOther[0]*mnuOther-2.121320343559642*m0rOther[0]*mnuOther+0.7071067811865475*cErOther[0]*mnuOther; 
  data->AEM_S(10,11) = (-0.6324555320336759*ucMOther[1]*mnuOther)-1.897366596101028*m0rOther[1]*mnuOther+0.6324555320336759*cErOther[1]*mnuOther; 
  data->AEM_S(11,9) = (-0.7071067811865475*ucMOther[2]*mnuOther)-2.121320343559642*m0rOther[2]*mnuOther+0.7071067811865475*cErOther[2]*mnuOther; 
  data->AEM_S(11,10) = (-0.6324555320336759*ucMOther[1]*mnuOther)-1.897366596101028*m0rOther[1]*mnuOther+0.6324555320336759*cErOther[1]*mnuOther; 
  data->AEM_S(11,11) = (-0.4517539514526256*ucMOther[2]*mnuOther)-1.355261854357877*m0rOther[2]*mnuOther+0.4517539514526256*cErOther[2]*mnuOther-0.7071067811865475*ucMOther[0]*mnuOther-2.121320343559642*m0rOther[0]*mnuOther+0.7071067811865475*cErOther[0]*mnuOther; 
...
{ 
  ...
  // ... Block from correction to energy conservation (self) ... // 
  data->AEM_S(4,4) = 2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  data->AEM_S(4,5) = 2.121320343559642*m0rSelf[1]*mnuSelf-0.7071067811865475*cErSelf[1]*mnuSelf; 
  data->AEM_S(4,6) = 2.121320343559642*m0rSelf[2]*mnuSelf-0.7071067811865475*cErSelf[2]*mnuSelf; 
  data->AEM_S(4,7) = 2.121320343559642*m0rSelf[3]*mnuSelf-0.7071067811865475*cErSelf[3]*mnuSelf; 
  data->AEM_S(5,4) = 2.121320343559642*m0rSelf[1]*mnuSelf-0.7071067811865475*cErSelf[1]*mnuSelf; 
  data->AEM_S(5,5) = 1.897366596101028*m0rSelf[2]*mnuSelf-0.6324555320336759*cErSelf[2]*mnuSelf+2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  data->AEM_S(5,6) = 1.863177010224355*m0rSelf[3]*mnuSelf-0.6210590034081186*cErSelf[3]*mnuSelf+1.897366596101028*m0rSelf[1]*mnuSelf-0.6324555320336759*cErSelf[1]*mnuSelf; 
  data->AEM_S(5,7) = 1.863177010224355*m0rSelf[2]*mnuSelf-0.6210590034081186*cErSelf[2]*mnuSelf; 
  data->AEM_S(6,4) = 2.121320343559642*m0rSelf[2]*mnuSelf-0.7071067811865475*cErSelf[2]*mnuSelf; 
  data->AEM_S(6,5) = 1.863177010224355*m0rSelf[3]*mnuSelf-0.6210590034081186*cErSelf[3]*mnuSelf+1.897366596101028*m0rSelf[1]*mnuSelf-0.6324555320336759*cErSelf[1]*mnuSelf; 
  data->AEM_S(6,6) = 1.355261854357877*m0rSelf[2]*mnuSelf-0.4517539514526256*cErSelf[2]*mnuSelf+2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  data->AEM_S(6,7) = 1.264911064067352*m0rSelf[3]*mnuSelf-0.421637021355784*cErSelf[3]*mnuSelf+1.863177010224355*m0rSelf[1]*mnuSelf-0.6210590034081186*cErSelf[1]*mnuSelf; 
  data->AEM_S(7,4) = 2.121320343559642*m0rSelf[3]*mnuSelf-0.7071067811865475*cErSelf[3]*mnuSelf; 
  data->AEM_S(7,5) = 1.863177010224355*m0rSelf[2]*mnuSelf-0.6210590034081186*cErSelf[2]*mnuSelf; 
  data->AEM_S(7,6) = 1.264911064067352*m0rSelf[3]*mnuSelf-0.421637021355784*cErSelf[3]*mnuSelf+1.863177010224355*m0rSelf[1]*mnuSelf-0.6210590034081186*cErSelf[1]*mnuSelf; 
  data->AEM_S(7,7) = 1.264911064067352*m0rSelf[2]*mnuSelf-0.421637021355784*cErSelf[2]*mnuSelf+2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
 
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(4,12) = 2.121320343559642*m0rOther[0]*mnuOther-0.7071067811865475*cErOther[0]*mnuOther; 
  data->AEM_S(4,13) = 2.121320343559642*m0rOther[1]*mnuOther-0.7071067811865475*cErOther[1]*mnuOther; 
  data->AEM_S(4,14) = 2.121320343559642*m0rOther[2]*mnuOther-0.7071067811865475*cErOther[2]*mnuOther; 
  data->AEM_S(4,15) = 2.121320343559642*m0rOther[3]*mnuOther-0.7071067811865475*cErOther[3]*mnuOther; 
  data->AEM_S(5,12) = 2.121320343559642*m0rOther[1]*mnuOther-0.7071067811865475*cErOther[1]*mnuOther; 
  data->AEM_S(5,13) = 1.897366596101028*m0rOther[2]*mnuOther-0.6324555320336759*cErOther[2]*mnuOther+2.121320343559642*m0rOther[0]*mnuOther-0.7071067811865475*cErOther[0]*mnuOther; 
  data->AEM_S(5,14) = 1.863177010224355*m0rOther[3]*mnuOther-0.6210590034081186*cErOther[3]*mnuOther+1.897366596101028*m0rOther[1]*mnuOther-0.6324555320336759*cErOther[1]*mnuOther; 
  data->AEM_S(5,15) = 1.863177010224355*m0rOther[2]*mnuOther-0.6210590034081186*cErOther[2]*mnuOther; 
  data->AEM_S(6,12) = 2.121320343559642*m0rOther[2]*mnuOther-0.7071067811865475*cErOther[2]*mnuOther; 
  data->AEM_S(6,13) = 1.863177010224355*m0rOther[3]*mnuOther-0.6210590034081186*cErOther[3]*mnuOther+1.897366596101028*m0rOther[1]*mnuOther-0.6324555320336759*cErOther[1]*mnuOther; 
  data->AEM_S(6,14) = 1.355261854357877*m0rOther[2]*mnuOther-0.4517539514526256*cErOther[2]*mnuOther+2.121320343559642*m0rOther[0]*mnuOther-0.7071067811865475*cErOther[0]*mnuOther; 
  data->AEM_S(6,15) = 1.264911064067352*m0rOther[3]*mnuOther-0.421637021355784*cErOther[3]*mnuOther+1.863177010224355*m0rOther[1]*mnuOther-0.6210590034081186*cErOther[1]*mnuOther; 
  data->AEM_S(7,12) = 2.121320343559642*m0rOther[3]*mnuOther-0.7071067811865475*cErOther[3]*mnuOther; 
  data->AEM_S(7,13) = 1.863177010224355*m0rOther[2]*mnuOther-0.6210590034081186*cErOther[2]*mnuOther; 
  data->AEM_S(7,14) = 1.264911064067352*m0rOther[3]*mnuOther-0.421637021355784*cErOther[3]*mnuOther+1.863177010224355*m0rOther[1]*mnuOther-0.6210590034081186*cErOther[1]*mnuOther; 
  data->AEM_S(7,15) = 1.264911064067352*m0rOther[2]*mnuOther-0.421637021355784*cErOther[2]*mnuOther+2.121320343559642*m0rOther[0]*mnuOther-0.7071067811865475*cErOther[0]*mnuOther; 
  ...
  // ... Block from correction to (self) 2nd moment of collision operator ... // 
  data->AEM_S(12,4) = 0.7071067811865475*ucMSelf[0]*mnuSelf+2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  data->AEM_S(12,5) = 0.7071067811865475*ucMSelf[1]*mnuSelf+2.121320343559642*m0rSelf[1]*mnuSelf-0.7071067811865475*cErSelf[1]*mnuSelf; 
  data->AEM_S(12,6) = 0.7071067811865475*ucMSelf[2]*mnuSelf+2.121320343559642*m0rSelf[2]*mnuSelf-0.7071067811865475*cErSelf[2]*mnuSelf; 
  data->AEM_S(12,7) = 0.7071067811865475*ucMSelf[3]*mnuSelf+2.121320343559642*m0rSelf[3]*mnuSelf-0.7071067811865475*cErSelf[3]*mnuSelf; 
  data->AEM_S(13,4) = 0.7071067811865475*ucMSelf[1]*mnuSelf+2.121320343559642*m0rSelf[1]*mnuSelf-0.7071067811865475*cErSelf[1]*mnuSelf; 
  data->AEM_S(13,5) = 0.6324555320336759*ucMSelf[2]*mnuSelf+1.897366596101028*m0rSelf[2]*mnuSelf-0.6324555320336759*cErSelf[2]*mnuSelf+0.7071067811865475*ucMSelf[0]*mnuSelf+2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  data->AEM_S(13,6) = 0.6210590034081186*ucMSelf[3]*mnuSelf+1.863177010224355*m0rSelf[3]*mnuSelf-0.6210590034081186*cErSelf[3]*mnuSelf+0.6324555320336759*ucMSelf[1]*mnuSelf+1.897366596101028*m0rSelf[1]*mnuSelf-0.6324555320336759*cErSelf[1]*mnuSelf; 
  data->AEM_S(13,7) = 0.6210590034081186*ucMSelf[2]*mnuSelf+1.863177010224355*m0rSelf[2]*mnuSelf-0.6210590034081186*cErSelf[2]*mnuSelf; 
  data->AEM_S(14,4) = 0.7071067811865475*ucMSelf[2]*mnuSelf+2.121320343559642*m0rSelf[2]*mnuSelf-0.7071067811865475*cErSelf[2]*mnuSelf; 
  data->AEM_S(14,5) = 0.6210590034081186*ucMSelf[3]*mnuSelf+1.863177010224355*m0rSelf[3]*mnuSelf-0.6210590034081186*cErSelf[3]*mnuSelf+0.6324555320336759*ucMSelf[1]*mnuSelf+1.897366596101028*m0rSelf[1]*mnuSelf-0.6324555320336759*cErSelf[1]*mnuSelf; 
  data->AEM_S(14,6) = 0.4517539514526256*ucMSelf[2]*mnuSelf+1.355261854357877*m0rSelf[2]*mnuSelf-0.4517539514526256*cErSelf[2]*mnuSelf+0.7071067811865475*ucMSelf[0]*mnuSelf+2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  data->AEM_S(14,7) = 0.421637021355784*ucMSelf[3]*mnuSelf+1.264911064067352*m0rSelf[3]*mnuSelf-0.421637021355784*cErSelf[3]*mnuSelf+0.6210590034081186*ucMSelf[1]*mnuSelf+1.863177010224355*m0rSelf[1]*mnuSelf-0.6210590034081186*cErSelf[1]*mnuSelf; 
  data->AEM_S(15,4) = 0.7071067811865475*ucMSelf[3]*mnuSelf+2.121320343559642*m0rSelf[3]*mnuSelf-0.7071067811865475*cErSelf[3]*mnuSelf; 
  data->AEM_S(15,5) = 0.6210590034081186*ucMSelf[2]*mnuSelf+1.863177010224355*m0rSelf[2]*mnuSelf-0.6210590034081186*cErSelf[2]*mnuSelf; 
  data->AEM_S(15,6) = 0.421637021355784*ucMSelf[3]*mnuSelf+1.264911064067352*m0rSelf[3]*mnuSelf-0.421637021355784*cErSelf[3]*mnuSelf+0.6210590034081186*ucMSelf[1]*mnuSelf+1.863177010224355*m0rSelf[1]*mnuSelf-0.6210590034081186*cErSelf[1]*mnuSelf; 
  data->AEM_S(15,7) = 0.421637021355784*ucMSelf[2]*mnuSelf+1.264911064067352*m0rSelf[2]*mnuSelf-0.421637021355784*cErSelf[2]*mnuSelf+0.7071067811865475*ucMSelf[0]*mnuSelf+2.121320343559642*m0rSelf[0]*mnuSelf-0.7071067811865475*cErSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to (other) 2nd moment of collision operator ... // 
  data->AEM_S(12,12) = (-0.7071067811865475*ucMOther[0]*mnuOther)-2.121320343559642*m0rOther[0]*mnuOther+0.7071067811865475*cErOther[0]*mnuOther; 
  data->AEM_S(12,13) = (-0.7071067811865475*ucMOther[1]*mnuOther)-2.121320343559642*m0rOther[1]*mnuOther+0.7071067811865475*cErOther[1]*mnuOther; 
  data->AEM_S(12,14) = (-0.7071067811865475*ucMOther[2]*mnuOther)-2.121320343559642*m0rOther[2]*mnuOther+0.7071067811865475*cErOther[2]*mnuOther; 
  data->AEM_S(12,15) = (-0.7071067811865475*ucMOther[3]*mnuOther)-2.121320343559642*m0rOther[3]*mnuOther+0.7071067811865475*cErOther[3]*mnuOther; 
  data->AEM_S(13,12) = (-0.7071067811865475*ucMOther[1]*mnuOther)-2.121320343559642*m0rOther[1]*mnuOther+0.7071067811865475*cErOther[1]*mnuOther; 
  data->AEM_S(13,13) = (-0.6324555320336759*ucMOther[2]*mnuOther)-1.897366596101028*m0rOther[2]*mnuOther+0.6324555320336759*cErOther[2]*mnuOther-0.7071067811865475*ucMOther[0]*mnuOther-2.121320343559642*m0rOther[0]*mnuOther+0.7071067811865475*cErOther[0]*mnuOther; 
  data->AEM_S(13,14) = (-0.6210590034081186*ucMOther[3]*mnuOther)-1.863177010224355*m0rOther[3]*mnuOther+0.6210590034081186*cErOther[3]*mnuOther-0.6324555320336759*ucMOther[1]*mnuOther-1.897366596101028*m0rOther[1]*mnuOther+0.6324555320336759*cErOther[1]*mnuOther; 
  data->AEM_S(13,15) = (-0.6210590034081186*ucMOther[2]*mnuOther)-1.863177010224355*m0rOther[2]*mnuOther+0.6210590034081186*cErOther[2]*mnuOther; 
  data->AEM_S(14,12) = (-0.7071067811865475*ucMOther[2]*mnuOther)-2.121320343559642*m0rOther[2]*mnuOther+0.7071067811865475*cErOther[2]*mnuOther; 
  data->AEM_S(14,13) = (-0.6210590034081186*ucMOther[3]*mnuOther)-1.863177010224355*m0rOther[3]*mnuOther+0.6210590034081186*cErOther[3]*mnuOther-0.6324555320336759*ucMOther[1]*mnuOther-1.897366596101028*m0rOther[1]*mnuOther+0.6324555320336759*cErOther[1]*mnuOther; 
  data->AEM_S(14,14) = (-0.4517539514526256*ucMOther[2]*mnuOther)-1.355261854357877*m0rOther[2]*mnuOther+0.4517539514526256*cErOther[2]*mnuOther-0.7071067811865475*ucMOther[0]*mnuOther-2.121320343559642*m0rOther[0]*mnuOther+0.7071067811865475*cErOther[0]*mnuOther; 
  data->AEM_S(14,15) = (-0.421637021355784*ucMOther[3]*mnuOther)-1.264911064067352*m0rOther[3]*mnuOther+0.421637021355784*cErOther[3]*mnuOther-0.6210590034081186*ucMOther[1]*mnuOther-1.863177010224355*m0rOther[1]*mnuOther+0.6210590034081186*cErOther[1]*mnuOther; 
  data->AEM_S(15,12) = (-0.7071067811865475*ucMOther[3]*mnuOther)-2.121320343559642*m0rOther[3]*mnuOther+0.7071067811865475*cErOther[3]*mnuOther; 
  data->AEM_S(15,13) = (-0.6210590034081186*ucMOther[2]*mnuOther)-1.863177010224355*m0rOther[2]*mnuOther+0.6210590034081186*cErOther[2]*mnuOther; 
  data->AEM_S(15,14) = (-0.421637021355784*ucMOther[3]*mnuOther)-1.264911064067352*m0rOther[3]*mnuOther+0.421637021355784*cErOther[3]*mnuOther-0.6210590034081186*ucMOther[1]*mnuOther-1.863177010224355*m0rOther[1]*mnuOther+0.6210590034081186*cErOther[1]*mnuOther; 
  data->AEM_S(15,15) = (-0.421637021355784*ucMOther[2]*mnuOther)-1.264911064067352*m0rOther[2]*mnuOther+0.421637021355784*cErOther[2]*mnuOther-0.7071067811865475*ucMOther[0]*mnuOther-2.121320343559642*m0rOther[0]*mnuOther+0.7071067811865475*cErOther[0]*mnuOther; 
