...
{ 
  ...
  if (cellAvg) { 
    ...
    cMrSelf[24] = cMSelf[24]; 
    cMrSelf[25] = cMSelf[25]; 
    cMrSelf[26] = cMSelf[26]; 
    cMrSelf[27] = cMSelf[27]; 
    cMrSelf[28] = cMSelf[28]; 
    cMrSelf[29] = cMSelf[29]; 
    cErSelf[0] = cESelf[0]; 
    cErSelf[1] = cESelf[1]; 
    cErSelf[2] = cESelf[2]; 
    cErSelf[3] = cESelf[3]; 
  ...
  if (cellAvg) { 
    ...
    cMrOther[24] = cMOther[24]; 
    cMrOther[25] = cMOther[25]; 
    cMrOther[26] = cMOther[26]; 
    cMrOther[27] = cMOther[27]; 
    cMrOther[28] = cMOther[28]; 
    cMrOther[29] = cMOther[29]; 
    cErOther[0] = cEOther[0]; 
    cErOther[1] = cEOther[1]; 
    cErOther[2] = cEOther[2]; 
    cErOther[3] = cEOther[3]; 
  ...
  // ... Block from correction to momentum conservation (self) ... // 
  data->AEM_S(0,30) = -0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(0,31) = -0.3535533905932737*cMrSelf[1]*mnuSelf; 
  data->AEM_S(0,32) = -0.3535533905932737*cMrSelf[2]*mnuSelf; 
  data->AEM_S(0,33) = -0.3535533905932737*cMrSelf[3]*mnuSelf; 
  data->AEM_S(0,34) = -0.3535533905932737*cMrSelf[4]*mnuSelf; 
  data->AEM_S(0,35) = -0.3535533905932737*cMrSelf[5]*mnuSelf; 
  data->AEM_S(0,36) = -0.3535533905932737*cMrSelf[6]*mnuSelf; 
  data->AEM_S(0,37) = -0.3535533905932737*cMrSelf[7]*mnuSelf; 
  data->AEM_S(0,38) = -0.3535533905932737*cMrSelf[8]*mnuSelf; 
  data->AEM_S(0,39) = -0.3535533905932737*cMrSelf[9]*mnuSelf; 
  data->AEM_S(1,30) = -0.3535533905932737*cMrSelf[1]*mnuSelf; 
  data->AEM_S(1,31) = (-0.3162277660168379*cMrSelf[7]*mnuSelf)-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(1,32) = -0.3535533905932737*cMrSelf[4]*mnuSelf; 
  data->AEM_S(1,33) = -0.3535533905932737*cMrSelf[5]*mnuSelf; 
  data->AEM_S(1,34) = -0.3535533905932737*cMrSelf[2]*mnuSelf; 
  data->AEM_S(1,35) = -0.3535533905932737*cMrSelf[3]*mnuSelf; 
  data->AEM_S(1,37) = -0.3162277660168379*cMrSelf[1]*mnuSelf; 
  data->AEM_S(2,30) = -0.3535533905932737*cMrSelf[2]*mnuSelf; 
  data->AEM_S(2,31) = -0.3535533905932737*cMrSelf[4]*mnuSelf; 
  data->AEM_S(2,32) = (-0.3162277660168379*cMrSelf[8]*mnuSelf)-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(2,33) = -0.3535533905932737*cMrSelf[6]*mnuSelf; 
  data->AEM_S(2,34) = -0.3535533905932737*cMrSelf[1]*mnuSelf; 
  data->AEM_S(2,36) = -0.3535533905932737*cMrSelf[3]*mnuSelf; 
  data->AEM_S(2,38) = -0.3162277660168379*cMrSelf[2]*mnuSelf; 
  data->AEM_S(3,30) = -0.3535533905932737*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,31) = -0.3535533905932737*cMrSelf[5]*mnuSelf; 
  data->AEM_S(3,32) = -0.3535533905932737*cMrSelf[6]*mnuSelf; 
  data->AEM_S(3,33) = (-0.3162277660168379*cMrSelf[9]*mnuSelf)-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(3,35) = -0.3535533905932737*cMrSelf[1]*mnuSelf; 
  data->AEM_S(3,36) = -0.3535533905932737*cMrSelf[2]*mnuSelf; 
  data->AEM_S(3,39) = -0.3162277660168379*cMrSelf[3]*mnuSelf; 
  data->AEM_S(4,30) = -0.3535533905932737*cMrSelf[4]*mnuSelf; 
  data->AEM_S(4,31) = -0.3535533905932737*cMrSelf[2]*mnuSelf; 
  data->AEM_S(4,32) = -0.3535533905932737*cMrSelf[1]*mnuSelf; 
  data->AEM_S(4,34) = (-0.3162277660168379*cMrSelf[8]*mnuSelf)-0.3162277660168379*cMrSelf[7]*mnuSelf-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(4,35) = -0.3535533905932737*cMrSelf[6]*mnuSelf; 
  data->AEM_S(4,36) = -0.3535533905932737*cMrSelf[5]*mnuSelf; 
  data->AEM_S(4,37) = -0.3162277660168379*cMrSelf[4]*mnuSelf; 
  data->AEM_S(4,38) = -0.3162277660168379*cMrSelf[4]*mnuSelf; 
  data->AEM_S(5,30) = -0.3535533905932737*cMrSelf[5]*mnuSelf; 
  data->AEM_S(5,31) = -0.3535533905932737*cMrSelf[3]*mnuSelf; 
  data->AEM_S(5,33) = -0.3535533905932737*cMrSelf[1]*mnuSelf; 
  data->AEM_S(5,34) = -0.3535533905932737*cMrSelf[6]*mnuSelf; 
  data->AEM_S(5,35) = (-0.3162277660168379*cMrSelf[9]*mnuSelf)-0.3162277660168379*cMrSelf[7]*mnuSelf-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(5,36) = -0.3535533905932737*cMrSelf[4]*mnuSelf; 
  data->AEM_S(5,37) = -0.3162277660168379*cMrSelf[5]*mnuSelf; 
  data->AEM_S(5,39) = -0.3162277660168379*cMrSelf[5]*mnuSelf; 
  data->AEM_S(6,30) = -0.3535533905932737*cMrSelf[6]*mnuSelf; 
  data->AEM_S(6,32) = -0.3535533905932737*cMrSelf[3]*mnuSelf; 
  data->AEM_S(6,33) = -0.3535533905932737*cMrSelf[2]*mnuSelf; 
  data->AEM_S(6,34) = -0.3535533905932737*cMrSelf[5]*mnuSelf; 
  data->AEM_S(6,35) = -0.3535533905932737*cMrSelf[4]*mnuSelf; 
  data->AEM_S(6,36) = (-0.3162277660168379*cMrSelf[9]*mnuSelf)-0.3162277660168379*cMrSelf[8]*mnuSelf-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(6,38) = -0.3162277660168379*cMrSelf[6]*mnuSelf; 
  data->AEM_S(6,39) = -0.3162277660168379*cMrSelf[6]*mnuSelf; 
  data->AEM_S(7,30) = -0.3535533905932737*cMrSelf[7]*mnuSelf; 
  data->AEM_S(7,31) = -0.3162277660168379*cMrSelf[1]*mnuSelf; 
  data->AEM_S(7,34) = -0.3162277660168379*cMrSelf[4]*mnuSelf; 
  data->AEM_S(7,35) = -0.3162277660168379*cMrSelf[5]*mnuSelf; 
  data->AEM_S(7,37) = (-0.2258769757263128*cMrSelf[7]*mnuSelf)-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(8,30) = -0.3535533905932737*cMrSelf[8]*mnuSelf; 
  data->AEM_S(8,32) = -0.3162277660168379*cMrSelf[2]*mnuSelf; 
  data->AEM_S(8,34) = -0.3162277660168379*cMrSelf[4]*mnuSelf; 
  data->AEM_S(8,36) = -0.3162277660168379*cMrSelf[6]*mnuSelf; 
  data->AEM_S(8,38) = (-0.2258769757263128*cMrSelf[8]*mnuSelf)-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(9,30) = -0.3535533905932737*cMrSelf[9]*mnuSelf; 
  data->AEM_S(9,33) = -0.3162277660168379*cMrSelf[3]*mnuSelf; 
  data->AEM_S(9,35) = -0.3162277660168379*cMrSelf[5]*mnuSelf; 
  data->AEM_S(9,36) = -0.3162277660168379*cMrSelf[6]*mnuSelf; 
  data->AEM_S(9,39) = (-0.2258769757263128*cMrSelf[9]*mnuSelf)-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(0,70) = -0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(0,71) = -0.3535533905932737*cMrOther[1]*mnuOther; 
  data->AEM_S(0,72) = -0.3535533905932737*cMrOther[2]*mnuOther; 
  data->AEM_S(0,73) = -0.3535533905932737*cMrOther[3]*mnuOther; 
  data->AEM_S(0,74) = -0.3535533905932737*cMrOther[4]*mnuOther; 
  data->AEM_S(0,75) = -0.3535533905932737*cMrOther[5]*mnuOther; 
  data->AEM_S(0,76) = -0.3535533905932737*cMrOther[6]*mnuOther; 
  data->AEM_S(0,77) = -0.3535533905932737*cMrOther[7]*mnuOther; 
  data->AEM_S(0,78) = -0.3535533905932737*cMrOther[8]*mnuOther; 
  data->AEM_S(0,79) = -0.3535533905932737*cMrOther[9]*mnuOther; 
  data->AEM_S(1,70) = -0.3535533905932737*cMrOther[1]*mnuOther; 
  data->AEM_S(1,71) = (-0.3162277660168379*cMrOther[7]*mnuOther)-0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(1,72) = -0.3535533905932737*cMrOther[4]*mnuOther; 
  data->AEM_S(1,73) = -0.3535533905932737*cMrOther[5]*mnuOther; 
  data->AEM_S(1,74) = -0.3535533905932737*cMrOther[2]*mnuOther; 
  data->AEM_S(1,75) = -0.3535533905932737*cMrOther[3]*mnuOther; 
  data->AEM_S(1,77) = -0.3162277660168379*cMrOther[1]*mnuOther; 
  data->AEM_S(2,70) = -0.3535533905932737*cMrOther[2]*mnuOther; 
  data->AEM_S(2,71) = -0.3535533905932737*cMrOther[4]*mnuOther; 
  data->AEM_S(2,72) = (-0.3162277660168379*cMrOther[8]*mnuOther)-0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(2,73) = -0.3535533905932737*cMrOther[6]*mnuOther; 
  data->AEM_S(2,74) = -0.3535533905932737*cMrOther[1]*mnuOther; 
  data->AEM_S(2,76) = -0.3535533905932737*cMrOther[3]*mnuOther; 
  data->AEM_S(2,78) = -0.3162277660168379*cMrOther[2]*mnuOther; 
  data->AEM_S(3,70) = -0.3535533905932737*cMrOther[3]*mnuOther; 
  data->AEM_S(3,71) = -0.3535533905932737*cMrOther[5]*mnuOther; 
  data->AEM_S(3,72) = -0.3535533905932737*cMrOther[6]*mnuOther; 
  data->AEM_S(3,73) = (-0.3162277660168379*cMrOther[9]*mnuOther)-0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(3,75) = -0.3535533905932737*cMrOther[1]*mnuOther; 
  data->AEM_S(3,76) = -0.3535533905932737*cMrOther[2]*mnuOther; 
  data->AEM_S(3,79) = -0.3162277660168379*cMrOther[3]*mnuOther; 
  data->AEM_S(4,70) = -0.3535533905932737*cMrOther[4]*mnuOther; 
  data->AEM_S(4,71) = -0.3535533905932737*cMrOther[2]*mnuOther; 
  data->AEM_S(4,72) = -0.3535533905932737*cMrOther[1]*mnuOther; 
  data->AEM_S(4,74) = (-0.3162277660168379*cMrOther[8]*mnuOther)-0.3162277660168379*cMrOther[7]*mnuOther-0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(4,75) = -0.3535533905932737*cMrOther[6]*mnuOther; 
  data->AEM_S(4,76) = -0.3535533905932737*cMrOther[5]*mnuOther; 
  data->AEM_S(4,77) = -0.3162277660168379*cMrOther[4]*mnuOther; 
  data->AEM_S(4,78) = -0.3162277660168379*cMrOther[4]*mnuOther; 
  data->AEM_S(5,70) = -0.3535533905932737*cMrOther[5]*mnuOther; 
  data->AEM_S(5,71) = -0.3535533905932737*cMrOther[3]*mnuOther; 
  data->AEM_S(5,73) = -0.3535533905932737*cMrOther[1]*mnuOther; 
  data->AEM_S(5,74) = -0.3535533905932737*cMrOther[6]*mnuOther; 
  data->AEM_S(5,75) = (-0.3162277660168379*cMrOther[9]*mnuOther)-0.3162277660168379*cMrOther[7]*mnuOther-0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(5,76) = -0.3535533905932737*cMrOther[4]*mnuOther; 
  data->AEM_S(5,77) = -0.3162277660168379*cMrOther[5]*mnuOther; 
  data->AEM_S(5,79) = -0.3162277660168379*cMrOther[5]*mnuOther; 
  data->AEM_S(6,70) = -0.3535533905932737*cMrOther[6]*mnuOther; 
  data->AEM_S(6,72) = -0.3535533905932737*cMrOther[3]*mnuOther; 
  data->AEM_S(6,73) = -0.3535533905932737*cMrOther[2]*mnuOther; 
  data->AEM_S(6,74) = -0.3535533905932737*cMrOther[5]*mnuOther; 
  data->AEM_S(6,75) = -0.3535533905932737*cMrOther[4]*mnuOther; 
  data->AEM_S(6,76) = (-0.3162277660168379*cMrOther[9]*mnuOther)-0.3162277660168379*cMrOther[8]*mnuOther-0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(6,78) = -0.3162277660168379*cMrOther[6]*mnuOther; 
  data->AEM_S(6,79) = -0.3162277660168379*cMrOther[6]*mnuOther; 
  data->AEM_S(7,70) = -0.3535533905932737*cMrOther[7]*mnuOther; 
  data->AEM_S(7,71) = -0.3162277660168379*cMrOther[1]*mnuOther; 
  data->AEM_S(7,74) = -0.3162277660168379*cMrOther[4]*mnuOther; 
  data->AEM_S(7,75) = -0.3162277660168379*cMrOther[5]*mnuOther; 
  data->AEM_S(7,77) = (-0.2258769757263128*cMrOther[7]*mnuOther)-0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(8,70) = -0.3535533905932737*cMrOther[8]*mnuOther; 
  data->AEM_S(8,72) = -0.3162277660168379*cMrOther[2]*mnuOther; 
  data->AEM_S(8,74) = -0.3162277660168379*cMrOther[4]*mnuOther; 
  data->AEM_S(8,76) = -0.3162277660168379*cMrOther[6]*mnuOther; 
  data->AEM_S(8,78) = (-0.2258769757263128*cMrOther[8]*mnuOther)-0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(9,70) = -0.3535533905932737*cMrOther[9]*mnuOther; 
  data->AEM_S(9,73) = -0.3162277660168379*cMrOther[3]*mnuOther; 
  data->AEM_S(9,75) = -0.3162277660168379*cMrOther[5]*mnuOther; 
  data->AEM_S(9,76) = -0.3162277660168379*cMrOther[6]*mnuOther; 
  data->AEM_S(9,79) = (-0.2258769757263128*cMrOther[9]*mnuOther)-0.3535533905932737*cMrOther[0]*mnuOther; 
  ...
  // ... Block from correction to momentum conservation (self) ... // 
  data->AEM_S(10,30) = -0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(10,31) = -0.3535533905932737*cMrSelf[11]*mnuSelf; 
  data->AEM_S(10,32) = -0.3535533905932737*cMrSelf[12]*mnuSelf; 
  data->AEM_S(10,33) = -0.3535533905932737*cMrSelf[13]*mnuSelf; 
  data->AEM_S(10,34) = -0.3535533905932737*cMrSelf[14]*mnuSelf; 
  data->AEM_S(10,35) = -0.3535533905932737*cMrSelf[15]*mnuSelf; 
  data->AEM_S(10,36) = -0.3535533905932737*cMrSelf[16]*mnuSelf; 
  data->AEM_S(10,37) = -0.3535533905932737*cMrSelf[17]*mnuSelf; 
  data->AEM_S(10,38) = -0.3535533905932737*cMrSelf[18]*mnuSelf; 
  data->AEM_S(10,39) = -0.3535533905932737*cMrSelf[19]*mnuSelf; 
  data->AEM_S(11,30) = -0.3535533905932737*cMrSelf[11]*mnuSelf; 
  data->AEM_S(11,31) = (-0.3162277660168379*cMrSelf[17]*mnuSelf)-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(11,32) = -0.3535533905932737*cMrSelf[14]*mnuSelf; 
  data->AEM_S(11,33) = -0.3535533905932737*cMrSelf[15]*mnuSelf; 
  data->AEM_S(11,34) = -0.3535533905932737*cMrSelf[12]*mnuSelf; 
  data->AEM_S(11,35) = -0.3535533905932737*cMrSelf[13]*mnuSelf; 
  data->AEM_S(11,37) = -0.3162277660168379*cMrSelf[11]*mnuSelf; 
  data->AEM_S(12,30) = -0.3535533905932737*cMrSelf[12]*mnuSelf; 
  data->AEM_S(12,31) = -0.3535533905932737*cMrSelf[14]*mnuSelf; 
  data->AEM_S(12,32) = (-0.3162277660168379*cMrSelf[18]*mnuSelf)-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(12,33) = -0.3535533905932737*cMrSelf[16]*mnuSelf; 
  data->AEM_S(12,34) = -0.3535533905932737*cMrSelf[11]*mnuSelf; 
  data->AEM_S(12,36) = -0.3535533905932737*cMrSelf[13]*mnuSelf; 
  data->AEM_S(12,38) = -0.3162277660168379*cMrSelf[12]*mnuSelf; 
  data->AEM_S(13,30) = -0.3535533905932737*cMrSelf[13]*mnuSelf; 
  data->AEM_S(13,31) = -0.3535533905932737*cMrSelf[15]*mnuSelf; 
  data->AEM_S(13,32) = -0.3535533905932737*cMrSelf[16]*mnuSelf; 
  data->AEM_S(13,33) = (-0.3162277660168379*cMrSelf[19]*mnuSelf)-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(13,35) = -0.3535533905932737*cMrSelf[11]*mnuSelf; 
  data->AEM_S(13,36) = -0.3535533905932737*cMrSelf[12]*mnuSelf; 
  data->AEM_S(13,39) = -0.3162277660168379*cMrSelf[13]*mnuSelf; 
  data->AEM_S(14,30) = -0.3535533905932737*cMrSelf[14]*mnuSelf; 
  data->AEM_S(14,31) = -0.3535533905932737*cMrSelf[12]*mnuSelf; 
  data->AEM_S(14,32) = -0.3535533905932737*cMrSelf[11]*mnuSelf; 
  data->AEM_S(14,34) = (-0.3162277660168379*cMrSelf[18]*mnuSelf)-0.3162277660168379*cMrSelf[17]*mnuSelf-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(14,35) = -0.3535533905932737*cMrSelf[16]*mnuSelf; 
  data->AEM_S(14,36) = -0.3535533905932737*cMrSelf[15]*mnuSelf; 
  data->AEM_S(14,37) = -0.3162277660168379*cMrSelf[14]*mnuSelf; 
  data->AEM_S(14,38) = -0.3162277660168379*cMrSelf[14]*mnuSelf; 
  data->AEM_S(15,30) = -0.3535533905932737*cMrSelf[15]*mnuSelf; 
  data->AEM_S(15,31) = -0.3535533905932737*cMrSelf[13]*mnuSelf; 
  data->AEM_S(15,33) = -0.3535533905932737*cMrSelf[11]*mnuSelf; 
  data->AEM_S(15,34) = -0.3535533905932737*cMrSelf[16]*mnuSelf; 
  data->AEM_S(15,35) = (-0.3162277660168379*cMrSelf[19]*mnuSelf)-0.3162277660168379*cMrSelf[17]*mnuSelf-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(15,36) = -0.3535533905932737*cMrSelf[14]*mnuSelf; 
  data->AEM_S(15,37) = -0.3162277660168379*cMrSelf[15]*mnuSelf; 
  data->AEM_S(15,39) = -0.3162277660168379*cMrSelf[15]*mnuSelf; 
  data->AEM_S(16,30) = -0.3535533905932737*cMrSelf[16]*mnuSelf; 
  data->AEM_S(16,32) = -0.3535533905932737*cMrSelf[13]*mnuSelf; 
  data->AEM_S(16,33) = -0.3535533905932737*cMrSelf[12]*mnuSelf; 
  data->AEM_S(16,34) = -0.3535533905932737*cMrSelf[15]*mnuSelf; 
  data->AEM_S(16,35) = -0.3535533905932737*cMrSelf[14]*mnuSelf; 
  data->AEM_S(16,36) = (-0.3162277660168379*cMrSelf[19]*mnuSelf)-0.3162277660168379*cMrSelf[18]*mnuSelf-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(16,38) = -0.3162277660168379*cMrSelf[16]*mnuSelf; 
  data->AEM_S(16,39) = -0.3162277660168379*cMrSelf[16]*mnuSelf; 
  data->AEM_S(17,30) = -0.3535533905932737*cMrSelf[17]*mnuSelf; 
  data->AEM_S(17,31) = -0.3162277660168379*cMrSelf[11]*mnuSelf; 
  data->AEM_S(17,34) = -0.3162277660168379*cMrSelf[14]*mnuSelf; 
  data->AEM_S(17,35) = -0.3162277660168379*cMrSelf[15]*mnuSelf; 
  data->AEM_S(17,37) = (-0.2258769757263128*cMrSelf[17]*mnuSelf)-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(18,30) = -0.3535533905932737*cMrSelf[18]*mnuSelf; 
  data->AEM_S(18,32) = -0.3162277660168379*cMrSelf[12]*mnuSelf; 
  data->AEM_S(18,34) = -0.3162277660168379*cMrSelf[14]*mnuSelf; 
  data->AEM_S(18,36) = -0.3162277660168379*cMrSelf[16]*mnuSelf; 
  data->AEM_S(18,38) = (-0.2258769757263128*cMrSelf[18]*mnuSelf)-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(19,30) = -0.3535533905932737*cMrSelf[19]*mnuSelf; 
  data->AEM_S(19,33) = -0.3162277660168379*cMrSelf[13]*mnuSelf; 
  data->AEM_S(19,35) = -0.3162277660168379*cMrSelf[15]*mnuSelf; 
  data->AEM_S(19,36) = -0.3162277660168379*cMrSelf[16]*mnuSelf; 
  data->AEM_S(19,39) = (-0.2258769757263128*cMrSelf[19]*mnuSelf)-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(10,70) = -0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(10,71) = -0.3535533905932737*cMrOther[11]*mnuOther; 
  data->AEM_S(10,72) = -0.3535533905932737*cMrOther[12]*mnuOther; 
  data->AEM_S(10,73) = -0.3535533905932737*cMrOther[13]*mnuOther; 
  data->AEM_S(10,74) = -0.3535533905932737*cMrOther[14]*mnuOther; 
  data->AEM_S(10,75) = -0.3535533905932737*cMrOther[15]*mnuOther; 
  data->AEM_S(10,76) = -0.3535533905932737*cMrOther[16]*mnuOther; 
  data->AEM_S(10,77) = -0.3535533905932737*cMrOther[17]*mnuOther; 
  data->AEM_S(10,78) = -0.3535533905932737*cMrOther[18]*mnuOther; 
  data->AEM_S(10,79) = -0.3535533905932737*cMrOther[19]*mnuOther; 
  data->AEM_S(11,70) = -0.3535533905932737*cMrOther[11]*mnuOther; 
  data->AEM_S(11,71) = (-0.3162277660168379*cMrOther[17]*mnuOther)-0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(11,72) = -0.3535533905932737*cMrOther[14]*mnuOther; 
  data->AEM_S(11,73) = -0.3535533905932737*cMrOther[15]*mnuOther; 
  data->AEM_S(11,74) = -0.3535533905932737*cMrOther[12]*mnuOther; 
  data->AEM_S(11,75) = -0.3535533905932737*cMrOther[13]*mnuOther; 
  data->AEM_S(11,77) = -0.3162277660168379*cMrOther[11]*mnuOther; 
  data->AEM_S(12,70) = -0.3535533905932737*cMrOther[12]*mnuOther; 
  data->AEM_S(12,71) = -0.3535533905932737*cMrOther[14]*mnuOther; 
  data->AEM_S(12,72) = (-0.3162277660168379*cMrOther[18]*mnuOther)-0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(12,73) = -0.3535533905932737*cMrOther[16]*mnuOther; 
  data->AEM_S(12,74) = -0.3535533905932737*cMrOther[11]*mnuOther; 
  data->AEM_S(12,76) = -0.3535533905932737*cMrOther[13]*mnuOther; 
  data->AEM_S(12,78) = -0.3162277660168379*cMrOther[12]*mnuOther; 
  data->AEM_S(13,70) = -0.3535533905932737*cMrOther[13]*mnuOther; 
  data->AEM_S(13,71) = -0.3535533905932737*cMrOther[15]*mnuOther; 
  data->AEM_S(13,72) = -0.3535533905932737*cMrOther[16]*mnuOther; 
  data->AEM_S(13,73) = (-0.3162277660168379*cMrOther[19]*mnuOther)-0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(13,75) = -0.3535533905932737*cMrOther[11]*mnuOther; 
  data->AEM_S(13,76) = -0.3535533905932737*cMrOther[12]*mnuOther; 
  data->AEM_S(13,79) = -0.3162277660168379*cMrOther[13]*mnuOther; 
  data->AEM_S(14,70) = -0.3535533905932737*cMrOther[14]*mnuOther; 
  data->AEM_S(14,71) = -0.3535533905932737*cMrOther[12]*mnuOther; 
  data->AEM_S(14,72) = -0.3535533905932737*cMrOther[11]*mnuOther; 
  data->AEM_S(14,74) = (-0.3162277660168379*cMrOther[18]*mnuOther)-0.3162277660168379*cMrOther[17]*mnuOther-0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(14,75) = -0.3535533905932737*cMrOther[16]*mnuOther; 
  data->AEM_S(14,76) = -0.3535533905932737*cMrOther[15]*mnuOther; 
  data->AEM_S(14,77) = -0.3162277660168379*cMrOther[14]*mnuOther; 
  data->AEM_S(14,78) = -0.3162277660168379*cMrOther[14]*mnuOther; 
  data->AEM_S(15,70) = -0.3535533905932737*cMrOther[15]*mnuOther; 
  data->AEM_S(15,71) = -0.3535533905932737*cMrOther[13]*mnuOther; 
  data->AEM_S(15,73) = -0.3535533905932737*cMrOther[11]*mnuOther; 
  data->AEM_S(15,74) = -0.3535533905932737*cMrOther[16]*mnuOther; 
  data->AEM_S(15,75) = (-0.3162277660168379*cMrOther[19]*mnuOther)-0.3162277660168379*cMrOther[17]*mnuOther-0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(15,76) = -0.3535533905932737*cMrOther[14]*mnuOther; 
  data->AEM_S(15,77) = -0.3162277660168379*cMrOther[15]*mnuOther; 
  data->AEM_S(15,79) = -0.3162277660168379*cMrOther[15]*mnuOther; 
  data->AEM_S(16,70) = -0.3535533905932737*cMrOther[16]*mnuOther; 
  data->AEM_S(16,72) = -0.3535533905932737*cMrOther[13]*mnuOther; 
  data->AEM_S(16,73) = -0.3535533905932737*cMrOther[12]*mnuOther; 
  data->AEM_S(16,74) = -0.3535533905932737*cMrOther[15]*mnuOther; 
  data->AEM_S(16,75) = -0.3535533905932737*cMrOther[14]*mnuOther; 
  data->AEM_S(16,76) = (-0.3162277660168379*cMrOther[19]*mnuOther)-0.3162277660168379*cMrOther[18]*mnuOther-0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(16,78) = -0.3162277660168379*cMrOther[16]*mnuOther; 
  data->AEM_S(16,79) = -0.3162277660168379*cMrOther[16]*mnuOther; 
  data->AEM_S(17,70) = -0.3535533905932737*cMrOther[17]*mnuOther; 
  data->AEM_S(17,71) = -0.3162277660168379*cMrOther[11]*mnuOther; 
  data->AEM_S(17,74) = -0.3162277660168379*cMrOther[14]*mnuOther; 
  data->AEM_S(17,75) = -0.3162277660168379*cMrOther[15]*mnuOther; 
  data->AEM_S(17,77) = (-0.2258769757263128*cMrOther[17]*mnuOther)-0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(18,70) = -0.3535533905932737*cMrOther[18]*mnuOther; 
  data->AEM_S(18,72) = -0.3162277660168379*cMrOther[12]*mnuOther; 
  data->AEM_S(18,74) = -0.3162277660168379*cMrOther[14]*mnuOther; 
  data->AEM_S(18,76) = -0.3162277660168379*cMrOther[16]*mnuOther; 
  data->AEM_S(18,78) = (-0.2258769757263128*cMrOther[18]*mnuOther)-0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(19,70) = -0.3535533905932737*cMrOther[19]*mnuOther; 
  data->AEM_S(19,73) = -0.3162277660168379*cMrOther[13]*mnuOther; 
  data->AEM_S(19,75) = -0.3162277660168379*cMrOther[15]*mnuOther; 
  data->AEM_S(19,76) = -0.3162277660168379*cMrOther[16]*mnuOther; 
  data->AEM_S(19,79) = (-0.2258769757263128*cMrOther[19]*mnuOther)-0.3535533905932737*cMrOther[10]*mnuOther; 
  ...
  // ... Block from correction to momentum conservation (self) ... // 
  data->AEM_S(20,30) = -0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(20,31) = -0.3535533905932737*cMrSelf[21]*mnuSelf; 
  data->AEM_S(20,32) = -0.3535533905932737*cMrSelf[22]*mnuSelf; 
  data->AEM_S(20,33) = -0.3535533905932737*cMrSelf[23]*mnuSelf; 
  data->AEM_S(20,34) = -0.3535533905932737*cMrSelf[24]*mnuSelf; 
  data->AEM_S(20,35) = -0.3535533905932737*cMrSelf[25]*mnuSelf; 
  data->AEM_S(20,36) = -0.3535533905932737*cMrSelf[26]*mnuSelf; 
  data->AEM_S(20,37) = -0.3535533905932737*cMrSelf[27]*mnuSelf; 
  data->AEM_S(20,38) = -0.3535533905932737*cMrSelf[28]*mnuSelf; 
  data->AEM_S(20,39) = -0.3535533905932737*cMrSelf[29]*mnuSelf; 
  data->AEM_S(21,30) = -0.3535533905932737*cMrSelf[21]*mnuSelf; 
  data->AEM_S(21,31) = (-0.3162277660168379*cMrSelf[27]*mnuSelf)-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(21,32) = -0.3535533905932737*cMrSelf[24]*mnuSelf; 
  data->AEM_S(21,33) = -0.3535533905932737*cMrSelf[25]*mnuSelf; 
  data->AEM_S(21,34) = -0.3535533905932737*cMrSelf[22]*mnuSelf; 
  data->AEM_S(21,35) = -0.3535533905932737*cMrSelf[23]*mnuSelf; 
  data->AEM_S(21,37) = -0.3162277660168379*cMrSelf[21]*mnuSelf; 
  data->AEM_S(22,30) = -0.3535533905932737*cMrSelf[22]*mnuSelf; 
  data->AEM_S(22,31) = -0.3535533905932737*cMrSelf[24]*mnuSelf; 
  data->AEM_S(22,32) = (-0.3162277660168379*cMrSelf[28]*mnuSelf)-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(22,33) = -0.3535533905932737*cMrSelf[26]*mnuSelf; 
  data->AEM_S(22,34) = -0.3535533905932737*cMrSelf[21]*mnuSelf; 
  data->AEM_S(22,36) = -0.3535533905932737*cMrSelf[23]*mnuSelf; 
  data->AEM_S(22,38) = -0.3162277660168379*cMrSelf[22]*mnuSelf; 
  data->AEM_S(23,30) = -0.3535533905932737*cMrSelf[23]*mnuSelf; 
  data->AEM_S(23,31) = -0.3535533905932737*cMrSelf[25]*mnuSelf; 
  data->AEM_S(23,32) = -0.3535533905932737*cMrSelf[26]*mnuSelf; 
  data->AEM_S(23,33) = (-0.3162277660168379*cMrSelf[29]*mnuSelf)-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(23,35) = -0.3535533905932737*cMrSelf[21]*mnuSelf; 
  data->AEM_S(23,36) = -0.3535533905932737*cMrSelf[22]*mnuSelf; 
  data->AEM_S(23,39) = -0.3162277660168379*cMrSelf[23]*mnuSelf; 
  data->AEM_S(24,30) = -0.3535533905932737*cMrSelf[24]*mnuSelf; 
  data->AEM_S(24,31) = -0.3535533905932737*cMrSelf[22]*mnuSelf; 
  data->AEM_S(24,32) = -0.3535533905932737*cMrSelf[21]*mnuSelf; 
  data->AEM_S(24,34) = (-0.3162277660168379*cMrSelf[28]*mnuSelf)-0.3162277660168379*cMrSelf[27]*mnuSelf-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(24,35) = -0.3535533905932737*cMrSelf[26]*mnuSelf; 
  data->AEM_S(24,36) = -0.3535533905932737*cMrSelf[25]*mnuSelf; 
  data->AEM_S(24,37) = -0.3162277660168379*cMrSelf[24]*mnuSelf; 
  data->AEM_S(24,38) = -0.3162277660168379*cMrSelf[24]*mnuSelf; 
  data->AEM_S(25,30) = -0.3535533905932737*cMrSelf[25]*mnuSelf; 
  data->AEM_S(25,31) = -0.3535533905932737*cMrSelf[23]*mnuSelf; 
  data->AEM_S(25,33) = -0.3535533905932737*cMrSelf[21]*mnuSelf; 
  data->AEM_S(25,34) = -0.3535533905932737*cMrSelf[26]*mnuSelf; 
  data->AEM_S(25,35) = (-0.3162277660168379*cMrSelf[29]*mnuSelf)-0.3162277660168379*cMrSelf[27]*mnuSelf-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(25,36) = -0.3535533905932737*cMrSelf[24]*mnuSelf; 
  data->AEM_S(25,37) = -0.3162277660168379*cMrSelf[25]*mnuSelf; 
  data->AEM_S(25,39) = -0.3162277660168379*cMrSelf[25]*mnuSelf; 
  data->AEM_S(26,30) = -0.3535533905932737*cMrSelf[26]*mnuSelf; 
  data->AEM_S(26,32) = -0.3535533905932737*cMrSelf[23]*mnuSelf; 
  data->AEM_S(26,33) = -0.3535533905932737*cMrSelf[22]*mnuSelf; 
  data->AEM_S(26,34) = -0.3535533905932737*cMrSelf[25]*mnuSelf; 
  data->AEM_S(26,35) = -0.3535533905932737*cMrSelf[24]*mnuSelf; 
  data->AEM_S(26,36) = (-0.3162277660168379*cMrSelf[29]*mnuSelf)-0.3162277660168379*cMrSelf[28]*mnuSelf-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(26,38) = -0.3162277660168379*cMrSelf[26]*mnuSelf; 
  data->AEM_S(26,39) = -0.3162277660168379*cMrSelf[26]*mnuSelf; 
  data->AEM_S(27,30) = -0.3535533905932737*cMrSelf[27]*mnuSelf; 
  data->AEM_S(27,31) = -0.3162277660168379*cMrSelf[21]*mnuSelf; 
  data->AEM_S(27,34) = -0.3162277660168379*cMrSelf[24]*mnuSelf; 
  data->AEM_S(27,35) = -0.3162277660168379*cMrSelf[25]*mnuSelf; 
  data->AEM_S(27,37) = (-0.2258769757263128*cMrSelf[27]*mnuSelf)-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(28,30) = -0.3535533905932737*cMrSelf[28]*mnuSelf; 
  data->AEM_S(28,32) = -0.3162277660168379*cMrSelf[22]*mnuSelf; 
  data->AEM_S(28,34) = -0.3162277660168379*cMrSelf[24]*mnuSelf; 
  data->AEM_S(28,36) = -0.3162277660168379*cMrSelf[26]*mnuSelf; 
  data->AEM_S(28,38) = (-0.2258769757263128*cMrSelf[28]*mnuSelf)-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(29,30) = -0.3535533905932737*cMrSelf[29]*mnuSelf; 
  data->AEM_S(29,33) = -0.3162277660168379*cMrSelf[23]*mnuSelf; 
  data->AEM_S(29,35) = -0.3162277660168379*cMrSelf[25]*mnuSelf; 
  data->AEM_S(29,36) = -0.3162277660168379*cMrSelf[26]*mnuSelf; 
  data->AEM_S(29,39) = (-0.2258769757263128*cMrSelf[29]*mnuSelf)-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(20,70) = -0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(20,71) = -0.3535533905932737*cMrOther[21]*mnuOther; 
  data->AEM_S(20,72) = -0.3535533905932737*cMrOther[22]*mnuOther; 
  data->AEM_S(20,73) = -0.3535533905932737*cMrOther[23]*mnuOther; 
  data->AEM_S(20,74) = -0.3535533905932737*cMrOther[24]*mnuOther; 
  data->AEM_S(20,75) = -0.3535533905932737*cMrOther[25]*mnuOther; 
  data->AEM_S(20,76) = -0.3535533905932737*cMrOther[26]*mnuOther; 
  data->AEM_S(20,77) = -0.3535533905932737*cMrOther[27]*mnuOther; 
  data->AEM_S(20,78) = -0.3535533905932737*cMrOther[28]*mnuOther; 
  data->AEM_S(20,79) = -0.3535533905932737*cMrOther[29]*mnuOther; 
  data->AEM_S(21,70) = -0.3535533905932737*cMrOther[21]*mnuOther; 
  data->AEM_S(21,71) = (-0.3162277660168379*cMrOther[27]*mnuOther)-0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(21,72) = -0.3535533905932737*cMrOther[24]*mnuOther; 
  data->AEM_S(21,73) = -0.3535533905932737*cMrOther[25]*mnuOther; 
  data->AEM_S(21,74) = -0.3535533905932737*cMrOther[22]*mnuOther; 
  data->AEM_S(21,75) = -0.3535533905932737*cMrOther[23]*mnuOther; 
  data->AEM_S(21,77) = -0.3162277660168379*cMrOther[21]*mnuOther; 
  data->AEM_S(22,70) = -0.3535533905932737*cMrOther[22]*mnuOther; 
  data->AEM_S(22,71) = -0.3535533905932737*cMrOther[24]*mnuOther; 
  data->AEM_S(22,72) = (-0.3162277660168379*cMrOther[28]*mnuOther)-0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(22,73) = -0.3535533905932737*cMrOther[26]*mnuOther; 
  data->AEM_S(22,74) = -0.3535533905932737*cMrOther[21]*mnuOther; 
  data->AEM_S(22,76) = -0.3535533905932737*cMrOther[23]*mnuOther; 
  data->AEM_S(22,78) = -0.3162277660168379*cMrOther[22]*mnuOther; 
  data->AEM_S(23,70) = -0.3535533905932737*cMrOther[23]*mnuOther; 
  data->AEM_S(23,71) = -0.3535533905932737*cMrOther[25]*mnuOther; 
  data->AEM_S(23,72) = -0.3535533905932737*cMrOther[26]*mnuOther; 
  data->AEM_S(23,73) = (-0.3162277660168379*cMrOther[29]*mnuOther)-0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(23,75) = -0.3535533905932737*cMrOther[21]*mnuOther; 
  data->AEM_S(23,76) = -0.3535533905932737*cMrOther[22]*mnuOther; 
  data->AEM_S(23,79) = -0.3162277660168379*cMrOther[23]*mnuOther; 
  data->AEM_S(24,70) = -0.3535533905932737*cMrOther[24]*mnuOther; 
  data->AEM_S(24,71) = -0.3535533905932737*cMrOther[22]*mnuOther; 
  data->AEM_S(24,72) = -0.3535533905932737*cMrOther[21]*mnuOther; 
  data->AEM_S(24,74) = (-0.3162277660168379*cMrOther[28]*mnuOther)-0.3162277660168379*cMrOther[27]*mnuOther-0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(24,75) = -0.3535533905932737*cMrOther[26]*mnuOther; 
  data->AEM_S(24,76) = -0.3535533905932737*cMrOther[25]*mnuOther; 
  data->AEM_S(24,77) = -0.3162277660168379*cMrOther[24]*mnuOther; 
  data->AEM_S(24,78) = -0.3162277660168379*cMrOther[24]*mnuOther; 
  data->AEM_S(25,70) = -0.3535533905932737*cMrOther[25]*mnuOther; 
  data->AEM_S(25,71) = -0.3535533905932737*cMrOther[23]*mnuOther; 
  data->AEM_S(25,73) = -0.3535533905932737*cMrOther[21]*mnuOther; 
  data->AEM_S(25,74) = -0.3535533905932737*cMrOther[26]*mnuOther; 
  data->AEM_S(25,75) = (-0.3162277660168379*cMrOther[29]*mnuOther)-0.3162277660168379*cMrOther[27]*mnuOther-0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(25,76) = -0.3535533905932737*cMrOther[24]*mnuOther; 
  data->AEM_S(25,77) = -0.3162277660168379*cMrOther[25]*mnuOther; 
  data->AEM_S(25,79) = -0.3162277660168379*cMrOther[25]*mnuOther; 
  data->AEM_S(26,70) = -0.3535533905932737*cMrOther[26]*mnuOther; 
  data->AEM_S(26,72) = -0.3535533905932737*cMrOther[23]*mnuOther; 
  data->AEM_S(26,73) = -0.3535533905932737*cMrOther[22]*mnuOther; 
  data->AEM_S(26,74) = -0.3535533905932737*cMrOther[25]*mnuOther; 
  data->AEM_S(26,75) = -0.3535533905932737*cMrOther[24]*mnuOther; 
  data->AEM_S(26,76) = (-0.3162277660168379*cMrOther[29]*mnuOther)-0.3162277660168379*cMrOther[28]*mnuOther-0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(26,78) = -0.3162277660168379*cMrOther[26]*mnuOther; 
  data->AEM_S(26,79) = -0.3162277660168379*cMrOther[26]*mnuOther; 
  data->AEM_S(27,70) = -0.3535533905932737*cMrOther[27]*mnuOther; 
  data->AEM_S(27,71) = -0.3162277660168379*cMrOther[21]*mnuOther; 
  data->AEM_S(27,74) = -0.3162277660168379*cMrOther[24]*mnuOther; 
  data->AEM_S(27,75) = -0.3162277660168379*cMrOther[25]*mnuOther; 
  data->AEM_S(27,77) = (-0.2258769757263128*cMrOther[27]*mnuOther)-0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(28,70) = -0.3535533905932737*cMrOther[28]*mnuOther; 
  data->AEM_S(28,72) = -0.3162277660168379*cMrOther[22]*mnuOther; 
  data->AEM_S(28,74) = -0.3162277660168379*cMrOther[24]*mnuOther; 
  data->AEM_S(28,76) = -0.3162277660168379*cMrOther[26]*mnuOther; 
  data->AEM_S(28,78) = (-0.2258769757263128*cMrOther[28]*mnuOther)-0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(29,70) = -0.3535533905932737*cMrOther[29]*mnuOther; 
  data->AEM_S(29,73) = -0.3162277660168379*cMrOther[23]*mnuOther; 
  data->AEM_S(29,75) = -0.3162277660168379*cMrOther[25]*mnuOther; 
  data->AEM_S(29,76) = -0.3162277660168379*cMrOther[26]*mnuOther; 
  data->AEM_S(29,79) = (-0.2258769757263128*cMrOther[29]*mnuOther)-0.3535533905932737*cMrOther[20]*mnuOther; 
  ...
  // ... Block from correction to energy conservation (self) ... // 
  data->AEM_S(30,30) = 1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(30,31) = 1.060660171779821*m0rSelf[1]*mnuSelf-0.3535533905932737*cErSelf[1]*mnuSelf; 
  data->AEM_S(30,32) = 1.060660171779821*m0rSelf[2]*mnuSelf-0.3535533905932737*cErSelf[2]*mnuSelf; 
  data->AEM_S(30,33) = 1.060660171779821*m0rSelf[3]*mnuSelf-0.3535533905932737*cErSelf[3]*mnuSelf; 
  data->AEM_S(30,34) = 1.060660171779821*m0rSelf[4]*mnuSelf-0.3535533905932737*cErSelf[4]*mnuSelf; 
  data->AEM_S(30,35) = 1.060660171779821*m0rSelf[5]*mnuSelf-0.3535533905932737*cErSelf[5]*mnuSelf; 
  data->AEM_S(30,36) = 1.060660171779821*m0rSelf[6]*mnuSelf-0.3535533905932737*cErSelf[6]*mnuSelf; 
  data->AEM_S(30,37) = 1.060660171779821*m0rSelf[7]*mnuSelf-0.3535533905932737*cErSelf[7]*mnuSelf; 
  data->AEM_S(30,38) = 1.060660171779821*m0rSelf[8]*mnuSelf-0.3535533905932737*cErSelf[8]*mnuSelf; 
  data->AEM_S(30,39) = 1.060660171779821*m0rSelf[9]*mnuSelf-0.3535533905932737*cErSelf[9]*mnuSelf; 
  data->AEM_S(31,30) = 1.060660171779821*m0rSelf[1]*mnuSelf-0.3535533905932737*cErSelf[1]*mnuSelf; 
  data->AEM_S(31,31) = 0.9486832980505137*m0rSelf[7]*mnuSelf-0.3162277660168379*cErSelf[7]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(31,32) = 1.060660171779821*m0rSelf[4]*mnuSelf-0.3535533905932737*cErSelf[4]*mnuSelf; 
  data->AEM_S(31,33) = 1.060660171779821*m0rSelf[5]*mnuSelf-0.3535533905932737*cErSelf[5]*mnuSelf; 
  data->AEM_S(31,34) = 1.060660171779821*m0rSelf[2]*mnuSelf-0.3535533905932737*cErSelf[2]*mnuSelf; 
  data->AEM_S(31,35) = 1.060660171779821*m0rSelf[3]*mnuSelf-0.3535533905932737*cErSelf[3]*mnuSelf; 
  data->AEM_S(31,37) = 0.9486832980505137*m0rSelf[1]*mnuSelf-0.3162277660168379*cErSelf[1]*mnuSelf; 
  data->AEM_S(32,30) = 1.060660171779821*m0rSelf[2]*mnuSelf-0.3535533905932737*cErSelf[2]*mnuSelf; 
  data->AEM_S(32,31) = 1.060660171779821*m0rSelf[4]*mnuSelf-0.3535533905932737*cErSelf[4]*mnuSelf; 
  data->AEM_S(32,32) = 0.9486832980505137*m0rSelf[8]*mnuSelf-0.3162277660168379*cErSelf[8]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(32,33) = 1.060660171779821*m0rSelf[6]*mnuSelf-0.3535533905932737*cErSelf[6]*mnuSelf; 
  data->AEM_S(32,34) = 1.060660171779821*m0rSelf[1]*mnuSelf-0.3535533905932737*cErSelf[1]*mnuSelf; 
  data->AEM_S(32,36) = 1.060660171779821*m0rSelf[3]*mnuSelf-0.3535533905932737*cErSelf[3]*mnuSelf; 
  data->AEM_S(32,38) = 0.9486832980505137*m0rSelf[2]*mnuSelf-0.3162277660168379*cErSelf[2]*mnuSelf; 
  data->AEM_S(33,30) = 1.060660171779821*m0rSelf[3]*mnuSelf-0.3535533905932737*cErSelf[3]*mnuSelf; 
  data->AEM_S(33,31) = 1.060660171779821*m0rSelf[5]*mnuSelf-0.3535533905932737*cErSelf[5]*mnuSelf; 
  data->AEM_S(33,32) = 1.060660171779821*m0rSelf[6]*mnuSelf-0.3535533905932737*cErSelf[6]*mnuSelf; 
  data->AEM_S(33,33) = 0.9486832980505137*m0rSelf[9]*mnuSelf-0.3162277660168379*cErSelf[9]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(33,35) = 1.060660171779821*m0rSelf[1]*mnuSelf-0.3535533905932737*cErSelf[1]*mnuSelf; 
  data->AEM_S(33,36) = 1.060660171779821*m0rSelf[2]*mnuSelf-0.3535533905932737*cErSelf[2]*mnuSelf; 
  data->AEM_S(33,39) = 0.9486832980505137*m0rSelf[3]*mnuSelf-0.3162277660168379*cErSelf[3]*mnuSelf; 
  data->AEM_S(34,30) = 1.060660171779821*m0rSelf[4]*mnuSelf-0.3535533905932737*cErSelf[4]*mnuSelf; 
  data->AEM_S(34,31) = 1.060660171779821*m0rSelf[2]*mnuSelf-0.3535533905932737*cErSelf[2]*mnuSelf; 
  data->AEM_S(34,32) = 1.060660171779821*m0rSelf[1]*mnuSelf-0.3535533905932737*cErSelf[1]*mnuSelf; 
  data->AEM_S(34,34) = 0.9486832980505137*m0rSelf[8]*mnuSelf-0.3162277660168379*cErSelf[8]*mnuSelf+0.9486832980505137*m0rSelf[7]*mnuSelf-0.3162277660168379*cErSelf[7]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(34,35) = 1.060660171779821*m0rSelf[6]*mnuSelf-0.3535533905932737*cErSelf[6]*mnuSelf; 
  data->AEM_S(34,36) = 1.060660171779821*m0rSelf[5]*mnuSelf-0.3535533905932737*cErSelf[5]*mnuSelf; 
  data->AEM_S(34,37) = 0.9486832980505137*m0rSelf[4]*mnuSelf-0.3162277660168379*cErSelf[4]*mnuSelf; 
  data->AEM_S(34,38) = 0.9486832980505137*m0rSelf[4]*mnuSelf-0.3162277660168379*cErSelf[4]*mnuSelf; 
  data->AEM_S(35,30) = 1.060660171779821*m0rSelf[5]*mnuSelf-0.3535533905932737*cErSelf[5]*mnuSelf; 
  data->AEM_S(35,31) = 1.060660171779821*m0rSelf[3]*mnuSelf-0.3535533905932737*cErSelf[3]*mnuSelf; 
  data->AEM_S(35,33) = 1.060660171779821*m0rSelf[1]*mnuSelf-0.3535533905932737*cErSelf[1]*mnuSelf; 
  data->AEM_S(35,34) = 1.060660171779821*m0rSelf[6]*mnuSelf-0.3535533905932737*cErSelf[6]*mnuSelf; 
  data->AEM_S(35,35) = 0.9486832980505137*m0rSelf[9]*mnuSelf-0.3162277660168379*cErSelf[9]*mnuSelf+0.9486832980505137*m0rSelf[7]*mnuSelf-0.3162277660168379*cErSelf[7]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(35,36) = 1.060660171779821*m0rSelf[4]*mnuSelf-0.3535533905932737*cErSelf[4]*mnuSelf; 
  data->AEM_S(35,37) = 0.9486832980505137*m0rSelf[5]*mnuSelf-0.3162277660168379*cErSelf[5]*mnuSelf; 
  data->AEM_S(35,39) = 0.9486832980505137*m0rSelf[5]*mnuSelf-0.3162277660168379*cErSelf[5]*mnuSelf; 
  data->AEM_S(36,30) = 1.060660171779821*m0rSelf[6]*mnuSelf-0.3535533905932737*cErSelf[6]*mnuSelf; 
  data->AEM_S(36,32) = 1.060660171779821*m0rSelf[3]*mnuSelf-0.3535533905932737*cErSelf[3]*mnuSelf; 
  data->AEM_S(36,33) = 1.060660171779821*m0rSelf[2]*mnuSelf-0.3535533905932737*cErSelf[2]*mnuSelf; 
  data->AEM_S(36,34) = 1.060660171779821*m0rSelf[5]*mnuSelf-0.3535533905932737*cErSelf[5]*mnuSelf; 
  data->AEM_S(36,35) = 1.060660171779821*m0rSelf[4]*mnuSelf-0.3535533905932737*cErSelf[4]*mnuSelf; 
  data->AEM_S(36,36) = 0.9486832980505137*m0rSelf[9]*mnuSelf-0.3162277660168379*cErSelf[9]*mnuSelf+0.9486832980505137*m0rSelf[8]*mnuSelf-0.3162277660168379*cErSelf[8]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(36,38) = 0.9486832980505137*m0rSelf[6]*mnuSelf-0.3162277660168379*cErSelf[6]*mnuSelf; 
  data->AEM_S(36,39) = 0.9486832980505137*m0rSelf[6]*mnuSelf-0.3162277660168379*cErSelf[6]*mnuSelf; 
  data->AEM_S(37,30) = 1.060660171779821*m0rSelf[7]*mnuSelf-0.3535533905932737*cErSelf[7]*mnuSelf; 
  data->AEM_S(37,31) = 0.9486832980505137*m0rSelf[1]*mnuSelf-0.3162277660168379*cErSelf[1]*mnuSelf; 
  data->AEM_S(37,34) = 0.9486832980505137*m0rSelf[4]*mnuSelf-0.3162277660168379*cErSelf[4]*mnuSelf; 
  data->AEM_S(37,35) = 0.9486832980505137*m0rSelf[5]*mnuSelf-0.3162277660168379*cErSelf[5]*mnuSelf; 
  data->AEM_S(37,37) = 0.6776309271789384*m0rSelf[7]*mnuSelf-0.2258769757263128*cErSelf[7]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(38,30) = 1.060660171779821*m0rSelf[8]*mnuSelf-0.3535533905932737*cErSelf[8]*mnuSelf; 
  data->AEM_S(38,32) = 0.9486832980505137*m0rSelf[2]*mnuSelf-0.3162277660168379*cErSelf[2]*mnuSelf; 
  data->AEM_S(38,34) = 0.9486832980505137*m0rSelf[4]*mnuSelf-0.3162277660168379*cErSelf[4]*mnuSelf; 
  data->AEM_S(38,36) = 0.9486832980505137*m0rSelf[6]*mnuSelf-0.3162277660168379*cErSelf[6]*mnuSelf; 
  data->AEM_S(38,38) = 0.6776309271789384*m0rSelf[8]*mnuSelf-0.2258769757263128*cErSelf[8]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(39,30) = 1.060660171779821*m0rSelf[9]*mnuSelf-0.3535533905932737*cErSelf[9]*mnuSelf; 
  data->AEM_S(39,33) = 0.9486832980505137*m0rSelf[3]*mnuSelf-0.3162277660168379*cErSelf[3]*mnuSelf; 
  data->AEM_S(39,35) = 0.9486832980505137*m0rSelf[5]*mnuSelf-0.3162277660168379*cErSelf[5]*mnuSelf; 
  data->AEM_S(39,36) = 0.9486832980505137*m0rSelf[6]*mnuSelf-0.3162277660168379*cErSelf[6]*mnuSelf; 
  data->AEM_S(39,39) = 0.6776309271789384*m0rSelf[9]*mnuSelf-0.2258769757263128*cErSelf[9]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
 
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(30,70) = 1.060660171779821*m0rOther[0]*mnuOther-0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(30,71) = 1.060660171779821*m0rOther[1]*mnuOther-0.3535533905932737*cErOther[1]*mnuOther; 
  data->AEM_S(30,72) = 1.060660171779821*m0rOther[2]*mnuOther-0.3535533905932737*cErOther[2]*mnuOther; 
  data->AEM_S(30,73) = 1.060660171779821*m0rOther[3]*mnuOther-0.3535533905932737*cErOther[3]*mnuOther; 
  data->AEM_S(30,74) = 1.060660171779821*m0rOther[4]*mnuOther-0.3535533905932737*cErOther[4]*mnuOther; 
  data->AEM_S(30,75) = 1.060660171779821*m0rOther[5]*mnuOther-0.3535533905932737*cErOther[5]*mnuOther; 
  data->AEM_S(30,76) = 1.060660171779821*m0rOther[6]*mnuOther-0.3535533905932737*cErOther[6]*mnuOther; 
  data->AEM_S(30,77) = 1.060660171779821*m0rOther[7]*mnuOther-0.3535533905932737*cErOther[7]*mnuOther; 
  data->AEM_S(30,78) = 1.060660171779821*m0rOther[8]*mnuOther-0.3535533905932737*cErOther[8]*mnuOther; 
  data->AEM_S(30,79) = 1.060660171779821*m0rOther[9]*mnuOther-0.3535533905932737*cErOther[9]*mnuOther; 
  data->AEM_S(31,70) = 1.060660171779821*m0rOther[1]*mnuOther-0.3535533905932737*cErOther[1]*mnuOther; 
  data->AEM_S(31,71) = 0.9486832980505137*m0rOther[7]*mnuOther-0.3162277660168379*cErOther[7]*mnuOther+1.060660171779821*m0rOther[0]*mnuOther-0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(31,72) = 1.060660171779821*m0rOther[4]*mnuOther-0.3535533905932737*cErOther[4]*mnuOther; 
  data->AEM_S(31,73) = 1.060660171779821*m0rOther[5]*mnuOther-0.3535533905932737*cErOther[5]*mnuOther; 
  data->AEM_S(31,74) = 1.060660171779821*m0rOther[2]*mnuOther-0.3535533905932737*cErOther[2]*mnuOther; 
  data->AEM_S(31,75) = 1.060660171779821*m0rOther[3]*mnuOther-0.3535533905932737*cErOther[3]*mnuOther; 
  data->AEM_S(31,77) = 0.9486832980505137*m0rOther[1]*mnuOther-0.3162277660168379*cErOther[1]*mnuOther; 
  data->AEM_S(32,70) = 1.060660171779821*m0rOther[2]*mnuOther-0.3535533905932737*cErOther[2]*mnuOther; 
  data->AEM_S(32,71) = 1.060660171779821*m0rOther[4]*mnuOther-0.3535533905932737*cErOther[4]*mnuOther; 
  data->AEM_S(32,72) = 0.9486832980505137*m0rOther[8]*mnuOther-0.3162277660168379*cErOther[8]*mnuOther+1.060660171779821*m0rOther[0]*mnuOther-0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(32,73) = 1.060660171779821*m0rOther[6]*mnuOther-0.3535533905932737*cErOther[6]*mnuOther; 
  data->AEM_S(32,74) = 1.060660171779821*m0rOther[1]*mnuOther-0.3535533905932737*cErOther[1]*mnuOther; 
  data->AEM_S(32,76) = 1.060660171779821*m0rOther[3]*mnuOther-0.3535533905932737*cErOther[3]*mnuOther; 
  data->AEM_S(32,78) = 0.9486832980505137*m0rOther[2]*mnuOther-0.3162277660168379*cErOther[2]*mnuOther; 
  data->AEM_S(33,70) = 1.060660171779821*m0rOther[3]*mnuOther-0.3535533905932737*cErOther[3]*mnuOther; 
  data->AEM_S(33,71) = 1.060660171779821*m0rOther[5]*mnuOther-0.3535533905932737*cErOther[5]*mnuOther; 
  data->AEM_S(33,72) = 1.060660171779821*m0rOther[6]*mnuOther-0.3535533905932737*cErOther[6]*mnuOther; 
  data->AEM_S(33,73) = 0.9486832980505137*m0rOther[9]*mnuOther-0.3162277660168379*cErOther[9]*mnuOther+1.060660171779821*m0rOther[0]*mnuOther-0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(33,75) = 1.060660171779821*m0rOther[1]*mnuOther-0.3535533905932737*cErOther[1]*mnuOther; 
  data->AEM_S(33,76) = 1.060660171779821*m0rOther[2]*mnuOther-0.3535533905932737*cErOther[2]*mnuOther; 
  data->AEM_S(33,79) = 0.9486832980505137*m0rOther[3]*mnuOther-0.3162277660168379*cErOther[3]*mnuOther; 
  data->AEM_S(34,70) = 1.060660171779821*m0rOther[4]*mnuOther-0.3535533905932737*cErOther[4]*mnuOther; 
  data->AEM_S(34,71) = 1.060660171779821*m0rOther[2]*mnuOther-0.3535533905932737*cErOther[2]*mnuOther; 
  data->AEM_S(34,72) = 1.060660171779821*m0rOther[1]*mnuOther-0.3535533905932737*cErOther[1]*mnuOther; 
  data->AEM_S(34,74) = 0.9486832980505137*m0rOther[8]*mnuOther-0.3162277660168379*cErOther[8]*mnuOther+0.9486832980505137*m0rOther[7]*mnuOther-0.3162277660168379*cErOther[7]*mnuOther+1.060660171779821*m0rOther[0]*mnuOther-0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(34,75) = 1.060660171779821*m0rOther[6]*mnuOther-0.3535533905932737*cErOther[6]*mnuOther; 
  data->AEM_S(34,76) = 1.060660171779821*m0rOther[5]*mnuOther-0.3535533905932737*cErOther[5]*mnuOther; 
  data->AEM_S(34,77) = 0.9486832980505137*m0rOther[4]*mnuOther-0.3162277660168379*cErOther[4]*mnuOther; 
  data->AEM_S(34,78) = 0.9486832980505137*m0rOther[4]*mnuOther-0.3162277660168379*cErOther[4]*mnuOther; 
  data->AEM_S(35,70) = 1.060660171779821*m0rOther[5]*mnuOther-0.3535533905932737*cErOther[5]*mnuOther; 
  data->AEM_S(35,71) = 1.060660171779821*m0rOther[3]*mnuOther-0.3535533905932737*cErOther[3]*mnuOther; 
  data->AEM_S(35,73) = 1.060660171779821*m0rOther[1]*mnuOther-0.3535533905932737*cErOther[1]*mnuOther; 
  data->AEM_S(35,74) = 1.060660171779821*m0rOther[6]*mnuOther-0.3535533905932737*cErOther[6]*mnuOther; 
  data->AEM_S(35,75) = 0.9486832980505137*m0rOther[9]*mnuOther-0.3162277660168379*cErOther[9]*mnuOther+0.9486832980505137*m0rOther[7]*mnuOther-0.3162277660168379*cErOther[7]*mnuOther+1.060660171779821*m0rOther[0]*mnuOther-0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(35,76) = 1.060660171779821*m0rOther[4]*mnuOther-0.3535533905932737*cErOther[4]*mnuOther; 
  data->AEM_S(35,77) = 0.9486832980505137*m0rOther[5]*mnuOther-0.3162277660168379*cErOther[5]*mnuOther; 
  data->AEM_S(35,79) = 0.9486832980505137*m0rOther[5]*mnuOther-0.3162277660168379*cErOther[5]*mnuOther; 
  data->AEM_S(36,70) = 1.060660171779821*m0rOther[6]*mnuOther-0.3535533905932737*cErOther[6]*mnuOther; 
  data->AEM_S(36,72) = 1.060660171779821*m0rOther[3]*mnuOther-0.3535533905932737*cErOther[3]*mnuOther; 
  data->AEM_S(36,73) = 1.060660171779821*m0rOther[2]*mnuOther-0.3535533905932737*cErOther[2]*mnuOther; 
  data->AEM_S(36,74) = 1.060660171779821*m0rOther[5]*mnuOther-0.3535533905932737*cErOther[5]*mnuOther; 
  data->AEM_S(36,75) = 1.060660171779821*m0rOther[4]*mnuOther-0.3535533905932737*cErOther[4]*mnuOther; 
  data->AEM_S(36,76) = 0.9486832980505137*m0rOther[9]*mnuOther-0.3162277660168379*cErOther[9]*mnuOther+0.9486832980505137*m0rOther[8]*mnuOther-0.3162277660168379*cErOther[8]*mnuOther+1.060660171779821*m0rOther[0]*mnuOther-0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(36,78) = 0.9486832980505137*m0rOther[6]*mnuOther-0.3162277660168379*cErOther[6]*mnuOther; 
  data->AEM_S(36,79) = 0.9486832980505137*m0rOther[6]*mnuOther-0.3162277660168379*cErOther[6]*mnuOther; 
  data->AEM_S(37,70) = 1.060660171779821*m0rOther[7]*mnuOther-0.3535533905932737*cErOther[7]*mnuOther; 
  data->AEM_S(37,71) = 0.9486832980505137*m0rOther[1]*mnuOther-0.3162277660168379*cErOther[1]*mnuOther; 
  data->AEM_S(37,74) = 0.9486832980505137*m0rOther[4]*mnuOther-0.3162277660168379*cErOther[4]*mnuOther; 
  data->AEM_S(37,75) = 0.9486832980505137*m0rOther[5]*mnuOther-0.3162277660168379*cErOther[5]*mnuOther; 
  data->AEM_S(37,77) = 0.6776309271789384*m0rOther[7]*mnuOther-0.2258769757263128*cErOther[7]*mnuOther+1.060660171779821*m0rOther[0]*mnuOther-0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(38,70) = 1.060660171779821*m0rOther[8]*mnuOther-0.3535533905932737*cErOther[8]*mnuOther; 
  data->AEM_S(38,72) = 0.9486832980505137*m0rOther[2]*mnuOther-0.3162277660168379*cErOther[2]*mnuOther; 
  data->AEM_S(38,74) = 0.9486832980505137*m0rOther[4]*mnuOther-0.3162277660168379*cErOther[4]*mnuOther; 
  data->AEM_S(38,76) = 0.9486832980505137*m0rOther[6]*mnuOther-0.3162277660168379*cErOther[6]*mnuOther; 
  data->AEM_S(38,78) = 0.6776309271789384*m0rOther[8]*mnuOther-0.2258769757263128*cErOther[8]*mnuOther+1.060660171779821*m0rOther[0]*mnuOther-0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(39,70) = 1.060660171779821*m0rOther[9]*mnuOther-0.3535533905932737*cErOther[9]*mnuOther; 
  data->AEM_S(39,73) = 0.9486832980505137*m0rOther[3]*mnuOther-0.3162277660168379*cErOther[3]*mnuOther; 
  data->AEM_S(39,75) = 0.9486832980505137*m0rOther[5]*mnuOther-0.3162277660168379*cErOther[5]*mnuOther; 
  data->AEM_S(39,76) = 0.9486832980505137*m0rOther[6]*mnuOther-0.3162277660168379*cErOther[6]*mnuOther; 
  data->AEM_S(39,79) = 0.6776309271789384*m0rOther[9]*mnuOther-0.2258769757263128*cErOther[9]*mnuOther+1.060660171779821*m0rOther[0]*mnuOther-0.3535533905932737*cErOther[0]*mnuOther; 
  ...
  // ... Block from correction to (self) 1st moment of collision operator ... // 
  data->AEM_S(40,30) = -0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(40,31) = -0.3535533905932737*cMrSelf[1]*mnuSelf; 
  data->AEM_S(40,32) = -0.3535533905932737*cMrSelf[2]*mnuSelf; 
  data->AEM_S(40,33) = -0.3535533905932737*cMrSelf[3]*mnuSelf; 
  data->AEM_S(40,34) = -0.3535533905932737*cMrSelf[4]*mnuSelf; 
  data->AEM_S(40,35) = -0.3535533905932737*cMrSelf[5]*mnuSelf; 
  data->AEM_S(40,36) = -0.3535533905932737*cMrSelf[6]*mnuSelf; 
  data->AEM_S(40,37) = -0.3535533905932737*cMrSelf[7]*mnuSelf; 
  data->AEM_S(40,38) = -0.3535533905932737*cMrSelf[8]*mnuSelf; 
  data->AEM_S(40,39) = -0.3535533905932737*cMrSelf[9]*mnuSelf; 
  data->AEM_S(41,30) = -0.3535533905932737*cMrSelf[1]*mnuSelf; 
  data->AEM_S(41,31) = (-0.3162277660168379*cMrSelf[7]*mnuSelf)-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(41,32) = -0.3535533905932737*cMrSelf[4]*mnuSelf; 
  data->AEM_S(41,33) = -0.3535533905932737*cMrSelf[5]*mnuSelf; 
  data->AEM_S(41,34) = -0.3535533905932737*cMrSelf[2]*mnuSelf; 
  data->AEM_S(41,35) = -0.3535533905932737*cMrSelf[3]*mnuSelf; 
  data->AEM_S(41,37) = -0.3162277660168379*cMrSelf[1]*mnuSelf; 
  data->AEM_S(42,30) = -0.3535533905932737*cMrSelf[2]*mnuSelf; 
  data->AEM_S(42,31) = -0.3535533905932737*cMrSelf[4]*mnuSelf; 
  data->AEM_S(42,32) = (-0.3162277660168379*cMrSelf[8]*mnuSelf)-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(42,33) = -0.3535533905932737*cMrSelf[6]*mnuSelf; 
  data->AEM_S(42,34) = -0.3535533905932737*cMrSelf[1]*mnuSelf; 
  data->AEM_S(42,36) = -0.3535533905932737*cMrSelf[3]*mnuSelf; 
  data->AEM_S(42,38) = -0.3162277660168379*cMrSelf[2]*mnuSelf; 
  data->AEM_S(43,30) = -0.3535533905932737*cMrSelf[3]*mnuSelf; 
  data->AEM_S(43,31) = -0.3535533905932737*cMrSelf[5]*mnuSelf; 
  data->AEM_S(43,32) = -0.3535533905932737*cMrSelf[6]*mnuSelf; 
  data->AEM_S(43,33) = (-0.3162277660168379*cMrSelf[9]*mnuSelf)-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(43,35) = -0.3535533905932737*cMrSelf[1]*mnuSelf; 
  data->AEM_S(43,36) = -0.3535533905932737*cMrSelf[2]*mnuSelf; 
  data->AEM_S(43,39) = -0.3162277660168379*cMrSelf[3]*mnuSelf; 
  data->AEM_S(44,30) = -0.3535533905932737*cMrSelf[4]*mnuSelf; 
  data->AEM_S(44,31) = -0.3535533905932737*cMrSelf[2]*mnuSelf; 
  data->AEM_S(44,32) = -0.3535533905932737*cMrSelf[1]*mnuSelf; 
  data->AEM_S(44,34) = (-0.3162277660168379*cMrSelf[8]*mnuSelf)-0.3162277660168379*cMrSelf[7]*mnuSelf-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(44,35) = -0.3535533905932737*cMrSelf[6]*mnuSelf; 
  data->AEM_S(44,36) = -0.3535533905932737*cMrSelf[5]*mnuSelf; 
  data->AEM_S(44,37) = -0.3162277660168379*cMrSelf[4]*mnuSelf; 
  data->AEM_S(44,38) = -0.3162277660168379*cMrSelf[4]*mnuSelf; 
  data->AEM_S(45,30) = -0.3535533905932737*cMrSelf[5]*mnuSelf; 
  data->AEM_S(45,31) = -0.3535533905932737*cMrSelf[3]*mnuSelf; 
  data->AEM_S(45,33) = -0.3535533905932737*cMrSelf[1]*mnuSelf; 
  data->AEM_S(45,34) = -0.3535533905932737*cMrSelf[6]*mnuSelf; 
  data->AEM_S(45,35) = (-0.3162277660168379*cMrSelf[9]*mnuSelf)-0.3162277660168379*cMrSelf[7]*mnuSelf-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(45,36) = -0.3535533905932737*cMrSelf[4]*mnuSelf; 
  data->AEM_S(45,37) = -0.3162277660168379*cMrSelf[5]*mnuSelf; 
  data->AEM_S(45,39) = -0.3162277660168379*cMrSelf[5]*mnuSelf; 
  data->AEM_S(46,30) = -0.3535533905932737*cMrSelf[6]*mnuSelf; 
  data->AEM_S(46,32) = -0.3535533905932737*cMrSelf[3]*mnuSelf; 
  data->AEM_S(46,33) = -0.3535533905932737*cMrSelf[2]*mnuSelf; 
  data->AEM_S(46,34) = -0.3535533905932737*cMrSelf[5]*mnuSelf; 
  data->AEM_S(46,35) = -0.3535533905932737*cMrSelf[4]*mnuSelf; 
  data->AEM_S(46,36) = (-0.3162277660168379*cMrSelf[9]*mnuSelf)-0.3162277660168379*cMrSelf[8]*mnuSelf-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(46,38) = -0.3162277660168379*cMrSelf[6]*mnuSelf; 
  data->AEM_S(46,39) = -0.3162277660168379*cMrSelf[6]*mnuSelf; 
  data->AEM_S(47,30) = -0.3535533905932737*cMrSelf[7]*mnuSelf; 
  data->AEM_S(47,31) = -0.3162277660168379*cMrSelf[1]*mnuSelf; 
  data->AEM_S(47,34) = -0.3162277660168379*cMrSelf[4]*mnuSelf; 
  data->AEM_S(47,35) = -0.3162277660168379*cMrSelf[5]*mnuSelf; 
  data->AEM_S(47,37) = (-0.2258769757263128*cMrSelf[7]*mnuSelf)-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(48,30) = -0.3535533905932737*cMrSelf[8]*mnuSelf; 
  data->AEM_S(48,32) = -0.3162277660168379*cMrSelf[2]*mnuSelf; 
  data->AEM_S(48,34) = -0.3162277660168379*cMrSelf[4]*mnuSelf; 
  data->AEM_S(48,36) = -0.3162277660168379*cMrSelf[6]*mnuSelf; 
  data->AEM_S(48,38) = (-0.2258769757263128*cMrSelf[8]*mnuSelf)-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  data->AEM_S(49,30) = -0.3535533905932737*cMrSelf[9]*mnuSelf; 
  data->AEM_S(49,33) = -0.3162277660168379*cMrSelf[3]*mnuSelf; 
  data->AEM_S(49,35) = -0.3162277660168379*cMrSelf[5]*mnuSelf; 
  data->AEM_S(49,36) = -0.3162277660168379*cMrSelf[6]*mnuSelf; 
  data->AEM_S(49,39) = (-0.2258769757263128*cMrSelf[9]*mnuSelf)-0.3535533905932737*cMrSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to (other) 1st moment of collision operator ... // 
  data->AEM_S(40,70) = 0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(40,71) = 0.3535533905932737*cMrOther[1]*mnuOther; 
  data->AEM_S(40,72) = 0.3535533905932737*cMrOther[2]*mnuOther; 
  data->AEM_S(40,73) = 0.3535533905932737*cMrOther[3]*mnuOther; 
  data->AEM_S(40,74) = 0.3535533905932737*cMrOther[4]*mnuOther; 
  data->AEM_S(40,75) = 0.3535533905932737*cMrOther[5]*mnuOther; 
  data->AEM_S(40,76) = 0.3535533905932737*cMrOther[6]*mnuOther; 
  data->AEM_S(40,77) = 0.3535533905932737*cMrOther[7]*mnuOther; 
  data->AEM_S(40,78) = 0.3535533905932737*cMrOther[8]*mnuOther; 
  data->AEM_S(40,79) = 0.3535533905932737*cMrOther[9]*mnuOther; 
  data->AEM_S(41,70) = 0.3535533905932737*cMrOther[1]*mnuOther; 
  data->AEM_S(41,71) = 0.3162277660168379*cMrOther[7]*mnuOther+0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(41,72) = 0.3535533905932737*cMrOther[4]*mnuOther; 
  data->AEM_S(41,73) = 0.3535533905932737*cMrOther[5]*mnuOther; 
  data->AEM_S(41,74) = 0.3535533905932737*cMrOther[2]*mnuOther; 
  data->AEM_S(41,75) = 0.3535533905932737*cMrOther[3]*mnuOther; 
  data->AEM_S(41,77) = 0.3162277660168379*cMrOther[1]*mnuOther; 
  data->AEM_S(42,70) = 0.3535533905932737*cMrOther[2]*mnuOther; 
  data->AEM_S(42,71) = 0.3535533905932737*cMrOther[4]*mnuOther; 
  data->AEM_S(42,72) = 0.3162277660168379*cMrOther[8]*mnuOther+0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(42,73) = 0.3535533905932737*cMrOther[6]*mnuOther; 
  data->AEM_S(42,74) = 0.3535533905932737*cMrOther[1]*mnuOther; 
  data->AEM_S(42,76) = 0.3535533905932737*cMrOther[3]*mnuOther; 
  data->AEM_S(42,78) = 0.3162277660168379*cMrOther[2]*mnuOther; 
  data->AEM_S(43,70) = 0.3535533905932737*cMrOther[3]*mnuOther; 
  data->AEM_S(43,71) = 0.3535533905932737*cMrOther[5]*mnuOther; 
  data->AEM_S(43,72) = 0.3535533905932737*cMrOther[6]*mnuOther; 
  data->AEM_S(43,73) = 0.3162277660168379*cMrOther[9]*mnuOther+0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(43,75) = 0.3535533905932737*cMrOther[1]*mnuOther; 
  data->AEM_S(43,76) = 0.3535533905932737*cMrOther[2]*mnuOther; 
  data->AEM_S(43,79) = 0.3162277660168379*cMrOther[3]*mnuOther; 
  data->AEM_S(44,70) = 0.3535533905932737*cMrOther[4]*mnuOther; 
  data->AEM_S(44,71) = 0.3535533905932737*cMrOther[2]*mnuOther; 
  data->AEM_S(44,72) = 0.3535533905932737*cMrOther[1]*mnuOther; 
  data->AEM_S(44,74) = 0.3162277660168379*cMrOther[8]*mnuOther+0.3162277660168379*cMrOther[7]*mnuOther+0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(44,75) = 0.3535533905932737*cMrOther[6]*mnuOther; 
  data->AEM_S(44,76) = 0.3535533905932737*cMrOther[5]*mnuOther; 
  data->AEM_S(44,77) = 0.3162277660168379*cMrOther[4]*mnuOther; 
  data->AEM_S(44,78) = 0.3162277660168379*cMrOther[4]*mnuOther; 
  data->AEM_S(45,70) = 0.3535533905932737*cMrOther[5]*mnuOther; 
  data->AEM_S(45,71) = 0.3535533905932737*cMrOther[3]*mnuOther; 
  data->AEM_S(45,73) = 0.3535533905932737*cMrOther[1]*mnuOther; 
  data->AEM_S(45,74) = 0.3535533905932737*cMrOther[6]*mnuOther; 
  data->AEM_S(45,75) = 0.3162277660168379*cMrOther[9]*mnuOther+0.3162277660168379*cMrOther[7]*mnuOther+0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(45,76) = 0.3535533905932737*cMrOther[4]*mnuOther; 
  data->AEM_S(45,77) = 0.3162277660168379*cMrOther[5]*mnuOther; 
  data->AEM_S(45,79) = 0.3162277660168379*cMrOther[5]*mnuOther; 
  data->AEM_S(46,70) = 0.3535533905932737*cMrOther[6]*mnuOther; 
  data->AEM_S(46,72) = 0.3535533905932737*cMrOther[3]*mnuOther; 
  data->AEM_S(46,73) = 0.3535533905932737*cMrOther[2]*mnuOther; 
  data->AEM_S(46,74) = 0.3535533905932737*cMrOther[5]*mnuOther; 
  data->AEM_S(46,75) = 0.3535533905932737*cMrOther[4]*mnuOther; 
  data->AEM_S(46,76) = 0.3162277660168379*cMrOther[9]*mnuOther+0.3162277660168379*cMrOther[8]*mnuOther+0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(46,78) = 0.3162277660168379*cMrOther[6]*mnuOther; 
  data->AEM_S(46,79) = 0.3162277660168379*cMrOther[6]*mnuOther; 
  data->AEM_S(47,70) = 0.3535533905932737*cMrOther[7]*mnuOther; 
  data->AEM_S(47,71) = 0.3162277660168379*cMrOther[1]*mnuOther; 
  data->AEM_S(47,74) = 0.3162277660168379*cMrOther[4]*mnuOther; 
  data->AEM_S(47,75) = 0.3162277660168379*cMrOther[5]*mnuOther; 
  data->AEM_S(47,77) = 0.2258769757263128*cMrOther[7]*mnuOther+0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(48,70) = 0.3535533905932737*cMrOther[8]*mnuOther; 
  data->AEM_S(48,72) = 0.3162277660168379*cMrOther[2]*mnuOther; 
  data->AEM_S(48,74) = 0.3162277660168379*cMrOther[4]*mnuOther; 
  data->AEM_S(48,76) = 0.3162277660168379*cMrOther[6]*mnuOther; 
  data->AEM_S(48,78) = 0.2258769757263128*cMrOther[8]*mnuOther+0.3535533905932737*cMrOther[0]*mnuOther; 
  data->AEM_S(49,70) = 0.3535533905932737*cMrOther[9]*mnuOther; 
  data->AEM_S(49,73) = 0.3162277660168379*cMrOther[3]*mnuOther; 
  data->AEM_S(49,75) = 0.3162277660168379*cMrOther[5]*mnuOther; 
  data->AEM_S(49,76) = 0.3162277660168379*cMrOther[6]*mnuOther; 
  data->AEM_S(49,79) = 0.2258769757263128*cMrOther[9]*mnuOther+0.3535533905932737*cMrOther[0]*mnuOther; 
  ...
  // ... Block from correction to (self) 1st moment of collision operator ... // 
  data->AEM_S(50,30) = -0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(50,31) = -0.3535533905932737*cMrSelf[11]*mnuSelf; 
  data->AEM_S(50,32) = -0.3535533905932737*cMrSelf[12]*mnuSelf; 
  data->AEM_S(50,33) = -0.3535533905932737*cMrSelf[13]*mnuSelf; 
  data->AEM_S(50,34) = -0.3535533905932737*cMrSelf[14]*mnuSelf; 
  data->AEM_S(50,35) = -0.3535533905932737*cMrSelf[15]*mnuSelf; 
  data->AEM_S(50,36) = -0.3535533905932737*cMrSelf[16]*mnuSelf; 
  data->AEM_S(50,37) = -0.3535533905932737*cMrSelf[17]*mnuSelf; 
  data->AEM_S(50,38) = -0.3535533905932737*cMrSelf[18]*mnuSelf; 
  data->AEM_S(50,39) = -0.3535533905932737*cMrSelf[19]*mnuSelf; 
  data->AEM_S(51,30) = -0.3535533905932737*cMrSelf[11]*mnuSelf; 
  data->AEM_S(51,31) = (-0.3162277660168379*cMrSelf[17]*mnuSelf)-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(51,32) = -0.3535533905932737*cMrSelf[14]*mnuSelf; 
  data->AEM_S(51,33) = -0.3535533905932737*cMrSelf[15]*mnuSelf; 
  data->AEM_S(51,34) = -0.3535533905932737*cMrSelf[12]*mnuSelf; 
  data->AEM_S(51,35) = -0.3535533905932737*cMrSelf[13]*mnuSelf; 
  data->AEM_S(51,37) = -0.3162277660168379*cMrSelf[11]*mnuSelf; 
  data->AEM_S(52,30) = -0.3535533905932737*cMrSelf[12]*mnuSelf; 
  data->AEM_S(52,31) = -0.3535533905932737*cMrSelf[14]*mnuSelf; 
  data->AEM_S(52,32) = (-0.3162277660168379*cMrSelf[18]*mnuSelf)-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(52,33) = -0.3535533905932737*cMrSelf[16]*mnuSelf; 
  data->AEM_S(52,34) = -0.3535533905932737*cMrSelf[11]*mnuSelf; 
  data->AEM_S(52,36) = -0.3535533905932737*cMrSelf[13]*mnuSelf; 
  data->AEM_S(52,38) = -0.3162277660168379*cMrSelf[12]*mnuSelf; 
  data->AEM_S(53,30) = -0.3535533905932737*cMrSelf[13]*mnuSelf; 
  data->AEM_S(53,31) = -0.3535533905932737*cMrSelf[15]*mnuSelf; 
  data->AEM_S(53,32) = -0.3535533905932737*cMrSelf[16]*mnuSelf; 
  data->AEM_S(53,33) = (-0.3162277660168379*cMrSelf[19]*mnuSelf)-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(53,35) = -0.3535533905932737*cMrSelf[11]*mnuSelf; 
  data->AEM_S(53,36) = -0.3535533905932737*cMrSelf[12]*mnuSelf; 
  data->AEM_S(53,39) = -0.3162277660168379*cMrSelf[13]*mnuSelf; 
  data->AEM_S(54,30) = -0.3535533905932737*cMrSelf[14]*mnuSelf; 
  data->AEM_S(54,31) = -0.3535533905932737*cMrSelf[12]*mnuSelf; 
  data->AEM_S(54,32) = -0.3535533905932737*cMrSelf[11]*mnuSelf; 
  data->AEM_S(54,34) = (-0.3162277660168379*cMrSelf[18]*mnuSelf)-0.3162277660168379*cMrSelf[17]*mnuSelf-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(54,35) = -0.3535533905932737*cMrSelf[16]*mnuSelf; 
  data->AEM_S(54,36) = -0.3535533905932737*cMrSelf[15]*mnuSelf; 
  data->AEM_S(54,37) = -0.3162277660168379*cMrSelf[14]*mnuSelf; 
  data->AEM_S(54,38) = -0.3162277660168379*cMrSelf[14]*mnuSelf; 
  data->AEM_S(55,30) = -0.3535533905932737*cMrSelf[15]*mnuSelf; 
  data->AEM_S(55,31) = -0.3535533905932737*cMrSelf[13]*mnuSelf; 
  data->AEM_S(55,33) = -0.3535533905932737*cMrSelf[11]*mnuSelf; 
  data->AEM_S(55,34) = -0.3535533905932737*cMrSelf[16]*mnuSelf; 
  data->AEM_S(55,35) = (-0.3162277660168379*cMrSelf[19]*mnuSelf)-0.3162277660168379*cMrSelf[17]*mnuSelf-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(55,36) = -0.3535533905932737*cMrSelf[14]*mnuSelf; 
  data->AEM_S(55,37) = -0.3162277660168379*cMrSelf[15]*mnuSelf; 
  data->AEM_S(55,39) = -0.3162277660168379*cMrSelf[15]*mnuSelf; 
  data->AEM_S(56,30) = -0.3535533905932737*cMrSelf[16]*mnuSelf; 
  data->AEM_S(56,32) = -0.3535533905932737*cMrSelf[13]*mnuSelf; 
  data->AEM_S(56,33) = -0.3535533905932737*cMrSelf[12]*mnuSelf; 
  data->AEM_S(56,34) = -0.3535533905932737*cMrSelf[15]*mnuSelf; 
  data->AEM_S(56,35) = -0.3535533905932737*cMrSelf[14]*mnuSelf; 
  data->AEM_S(56,36) = (-0.3162277660168379*cMrSelf[19]*mnuSelf)-0.3162277660168379*cMrSelf[18]*mnuSelf-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(56,38) = -0.3162277660168379*cMrSelf[16]*mnuSelf; 
  data->AEM_S(56,39) = -0.3162277660168379*cMrSelf[16]*mnuSelf; 
  data->AEM_S(57,30) = -0.3535533905932737*cMrSelf[17]*mnuSelf; 
  data->AEM_S(57,31) = -0.3162277660168379*cMrSelf[11]*mnuSelf; 
  data->AEM_S(57,34) = -0.3162277660168379*cMrSelf[14]*mnuSelf; 
  data->AEM_S(57,35) = -0.3162277660168379*cMrSelf[15]*mnuSelf; 
  data->AEM_S(57,37) = (-0.2258769757263128*cMrSelf[17]*mnuSelf)-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(58,30) = -0.3535533905932737*cMrSelf[18]*mnuSelf; 
  data->AEM_S(58,32) = -0.3162277660168379*cMrSelf[12]*mnuSelf; 
  data->AEM_S(58,34) = -0.3162277660168379*cMrSelf[14]*mnuSelf; 
  data->AEM_S(58,36) = -0.3162277660168379*cMrSelf[16]*mnuSelf; 
  data->AEM_S(58,38) = (-0.2258769757263128*cMrSelf[18]*mnuSelf)-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  data->AEM_S(59,30) = -0.3535533905932737*cMrSelf[19]*mnuSelf; 
  data->AEM_S(59,33) = -0.3162277660168379*cMrSelf[13]*mnuSelf; 
  data->AEM_S(59,35) = -0.3162277660168379*cMrSelf[15]*mnuSelf; 
  data->AEM_S(59,36) = -0.3162277660168379*cMrSelf[16]*mnuSelf; 
  data->AEM_S(59,39) = (-0.2258769757263128*cMrSelf[19]*mnuSelf)-0.3535533905932737*cMrSelf[10]*mnuSelf; 
  ...
  // ... Block from correction to (other) 1st moment of collision operator ... // 
  data->AEM_S(50,70) = 0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(50,71) = 0.3535533905932737*cMrOther[11]*mnuOther; 
  data->AEM_S(50,72) = 0.3535533905932737*cMrOther[12]*mnuOther; 
  data->AEM_S(50,73) = 0.3535533905932737*cMrOther[13]*mnuOther; 
  data->AEM_S(50,74) = 0.3535533905932737*cMrOther[14]*mnuOther; 
  data->AEM_S(50,75) = 0.3535533905932737*cMrOther[15]*mnuOther; 
  data->AEM_S(50,76) = 0.3535533905932737*cMrOther[16]*mnuOther; 
  data->AEM_S(50,77) = 0.3535533905932737*cMrOther[17]*mnuOther; 
  data->AEM_S(50,78) = 0.3535533905932737*cMrOther[18]*mnuOther; 
  data->AEM_S(50,79) = 0.3535533905932737*cMrOther[19]*mnuOther; 
  data->AEM_S(51,70) = 0.3535533905932737*cMrOther[11]*mnuOther; 
  data->AEM_S(51,71) = 0.3162277660168379*cMrOther[17]*mnuOther+0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(51,72) = 0.3535533905932737*cMrOther[14]*mnuOther; 
  data->AEM_S(51,73) = 0.3535533905932737*cMrOther[15]*mnuOther; 
  data->AEM_S(51,74) = 0.3535533905932737*cMrOther[12]*mnuOther; 
  data->AEM_S(51,75) = 0.3535533905932737*cMrOther[13]*mnuOther; 
  data->AEM_S(51,77) = 0.3162277660168379*cMrOther[11]*mnuOther; 
  data->AEM_S(52,70) = 0.3535533905932737*cMrOther[12]*mnuOther; 
  data->AEM_S(52,71) = 0.3535533905932737*cMrOther[14]*mnuOther; 
  data->AEM_S(52,72) = 0.3162277660168379*cMrOther[18]*mnuOther+0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(52,73) = 0.3535533905932737*cMrOther[16]*mnuOther; 
  data->AEM_S(52,74) = 0.3535533905932737*cMrOther[11]*mnuOther; 
  data->AEM_S(52,76) = 0.3535533905932737*cMrOther[13]*mnuOther; 
  data->AEM_S(52,78) = 0.3162277660168379*cMrOther[12]*mnuOther; 
  data->AEM_S(53,70) = 0.3535533905932737*cMrOther[13]*mnuOther; 
  data->AEM_S(53,71) = 0.3535533905932737*cMrOther[15]*mnuOther; 
  data->AEM_S(53,72) = 0.3535533905932737*cMrOther[16]*mnuOther; 
  data->AEM_S(53,73) = 0.3162277660168379*cMrOther[19]*mnuOther+0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(53,75) = 0.3535533905932737*cMrOther[11]*mnuOther; 
  data->AEM_S(53,76) = 0.3535533905932737*cMrOther[12]*mnuOther; 
  data->AEM_S(53,79) = 0.3162277660168379*cMrOther[13]*mnuOther; 
  data->AEM_S(54,70) = 0.3535533905932737*cMrOther[14]*mnuOther; 
  data->AEM_S(54,71) = 0.3535533905932737*cMrOther[12]*mnuOther; 
  data->AEM_S(54,72) = 0.3535533905932737*cMrOther[11]*mnuOther; 
  data->AEM_S(54,74) = 0.3162277660168379*cMrOther[18]*mnuOther+0.3162277660168379*cMrOther[17]*mnuOther+0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(54,75) = 0.3535533905932737*cMrOther[16]*mnuOther; 
  data->AEM_S(54,76) = 0.3535533905932737*cMrOther[15]*mnuOther; 
  data->AEM_S(54,77) = 0.3162277660168379*cMrOther[14]*mnuOther; 
  data->AEM_S(54,78) = 0.3162277660168379*cMrOther[14]*mnuOther; 
  data->AEM_S(55,70) = 0.3535533905932737*cMrOther[15]*mnuOther; 
  data->AEM_S(55,71) = 0.3535533905932737*cMrOther[13]*mnuOther; 
  data->AEM_S(55,73) = 0.3535533905932737*cMrOther[11]*mnuOther; 
  data->AEM_S(55,74) = 0.3535533905932737*cMrOther[16]*mnuOther; 
  data->AEM_S(55,75) = 0.3162277660168379*cMrOther[19]*mnuOther+0.3162277660168379*cMrOther[17]*mnuOther+0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(55,76) = 0.3535533905932737*cMrOther[14]*mnuOther; 
  data->AEM_S(55,77) = 0.3162277660168379*cMrOther[15]*mnuOther; 
  data->AEM_S(55,79) = 0.3162277660168379*cMrOther[15]*mnuOther; 
  data->AEM_S(56,70) = 0.3535533905932737*cMrOther[16]*mnuOther; 
  data->AEM_S(56,72) = 0.3535533905932737*cMrOther[13]*mnuOther; 
  data->AEM_S(56,73) = 0.3535533905932737*cMrOther[12]*mnuOther; 
  data->AEM_S(56,74) = 0.3535533905932737*cMrOther[15]*mnuOther; 
  data->AEM_S(56,75) = 0.3535533905932737*cMrOther[14]*mnuOther; 
  data->AEM_S(56,76) = 0.3162277660168379*cMrOther[19]*mnuOther+0.3162277660168379*cMrOther[18]*mnuOther+0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(56,78) = 0.3162277660168379*cMrOther[16]*mnuOther; 
  data->AEM_S(56,79) = 0.3162277660168379*cMrOther[16]*mnuOther; 
  data->AEM_S(57,70) = 0.3535533905932737*cMrOther[17]*mnuOther; 
  data->AEM_S(57,71) = 0.3162277660168379*cMrOther[11]*mnuOther; 
  data->AEM_S(57,74) = 0.3162277660168379*cMrOther[14]*mnuOther; 
  data->AEM_S(57,75) = 0.3162277660168379*cMrOther[15]*mnuOther; 
  data->AEM_S(57,77) = 0.2258769757263128*cMrOther[17]*mnuOther+0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(58,70) = 0.3535533905932737*cMrOther[18]*mnuOther; 
  data->AEM_S(58,72) = 0.3162277660168379*cMrOther[12]*mnuOther; 
  data->AEM_S(58,74) = 0.3162277660168379*cMrOther[14]*mnuOther; 
  data->AEM_S(58,76) = 0.3162277660168379*cMrOther[16]*mnuOther; 
  data->AEM_S(58,78) = 0.2258769757263128*cMrOther[18]*mnuOther+0.3535533905932737*cMrOther[10]*mnuOther; 
  data->AEM_S(59,70) = 0.3535533905932737*cMrOther[19]*mnuOther; 
  data->AEM_S(59,73) = 0.3162277660168379*cMrOther[13]*mnuOther; 
  data->AEM_S(59,75) = 0.3162277660168379*cMrOther[15]*mnuOther; 
  data->AEM_S(59,76) = 0.3162277660168379*cMrOther[16]*mnuOther; 
  data->AEM_S(59,79) = 0.2258769757263128*cMrOther[19]*mnuOther+0.3535533905932737*cMrOther[10]*mnuOther; 
  ...
  // ... Block from correction to (self) 1st moment of collision operator ... // 
  data->AEM_S(60,30) = -0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(60,31) = -0.3535533905932737*cMrSelf[21]*mnuSelf; 
  data->AEM_S(60,32) = -0.3535533905932737*cMrSelf[22]*mnuSelf; 
  data->AEM_S(60,33) = -0.3535533905932737*cMrSelf[23]*mnuSelf; 
  data->AEM_S(60,34) = -0.3535533905932737*cMrSelf[24]*mnuSelf; 
  data->AEM_S(60,35) = -0.3535533905932737*cMrSelf[25]*mnuSelf; 
  data->AEM_S(60,36) = -0.3535533905932737*cMrSelf[26]*mnuSelf; 
  data->AEM_S(60,37) = -0.3535533905932737*cMrSelf[27]*mnuSelf; 
  data->AEM_S(60,38) = -0.3535533905932737*cMrSelf[28]*mnuSelf; 
  data->AEM_S(60,39) = -0.3535533905932737*cMrSelf[29]*mnuSelf; 
  data->AEM_S(61,30) = -0.3535533905932737*cMrSelf[21]*mnuSelf; 
  data->AEM_S(61,31) = (-0.3162277660168379*cMrSelf[27]*mnuSelf)-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(61,32) = -0.3535533905932737*cMrSelf[24]*mnuSelf; 
  data->AEM_S(61,33) = -0.3535533905932737*cMrSelf[25]*mnuSelf; 
  data->AEM_S(61,34) = -0.3535533905932737*cMrSelf[22]*mnuSelf; 
  data->AEM_S(61,35) = -0.3535533905932737*cMrSelf[23]*mnuSelf; 
  data->AEM_S(61,37) = -0.3162277660168379*cMrSelf[21]*mnuSelf; 
  data->AEM_S(62,30) = -0.3535533905932737*cMrSelf[22]*mnuSelf; 
  data->AEM_S(62,31) = -0.3535533905932737*cMrSelf[24]*mnuSelf; 
  data->AEM_S(62,32) = (-0.3162277660168379*cMrSelf[28]*mnuSelf)-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(62,33) = -0.3535533905932737*cMrSelf[26]*mnuSelf; 
  data->AEM_S(62,34) = -0.3535533905932737*cMrSelf[21]*mnuSelf; 
  data->AEM_S(62,36) = -0.3535533905932737*cMrSelf[23]*mnuSelf; 
  data->AEM_S(62,38) = -0.3162277660168379*cMrSelf[22]*mnuSelf; 
  data->AEM_S(63,30) = -0.3535533905932737*cMrSelf[23]*mnuSelf; 
  data->AEM_S(63,31) = -0.3535533905932737*cMrSelf[25]*mnuSelf; 
  data->AEM_S(63,32) = -0.3535533905932737*cMrSelf[26]*mnuSelf; 
  data->AEM_S(63,33) = (-0.3162277660168379*cMrSelf[29]*mnuSelf)-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(63,35) = -0.3535533905932737*cMrSelf[21]*mnuSelf; 
  data->AEM_S(63,36) = -0.3535533905932737*cMrSelf[22]*mnuSelf; 
  data->AEM_S(63,39) = -0.3162277660168379*cMrSelf[23]*mnuSelf; 
  data->AEM_S(64,30) = -0.3535533905932737*cMrSelf[24]*mnuSelf; 
  data->AEM_S(64,31) = -0.3535533905932737*cMrSelf[22]*mnuSelf; 
  data->AEM_S(64,32) = -0.3535533905932737*cMrSelf[21]*mnuSelf; 
  data->AEM_S(64,34) = (-0.3162277660168379*cMrSelf[28]*mnuSelf)-0.3162277660168379*cMrSelf[27]*mnuSelf-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(64,35) = -0.3535533905932737*cMrSelf[26]*mnuSelf; 
  data->AEM_S(64,36) = -0.3535533905932737*cMrSelf[25]*mnuSelf; 
  data->AEM_S(64,37) = -0.3162277660168379*cMrSelf[24]*mnuSelf; 
  data->AEM_S(64,38) = -0.3162277660168379*cMrSelf[24]*mnuSelf; 
  data->AEM_S(65,30) = -0.3535533905932737*cMrSelf[25]*mnuSelf; 
  data->AEM_S(65,31) = -0.3535533905932737*cMrSelf[23]*mnuSelf; 
  data->AEM_S(65,33) = -0.3535533905932737*cMrSelf[21]*mnuSelf; 
  data->AEM_S(65,34) = -0.3535533905932737*cMrSelf[26]*mnuSelf; 
  data->AEM_S(65,35) = (-0.3162277660168379*cMrSelf[29]*mnuSelf)-0.3162277660168379*cMrSelf[27]*mnuSelf-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(65,36) = -0.3535533905932737*cMrSelf[24]*mnuSelf; 
  data->AEM_S(65,37) = -0.3162277660168379*cMrSelf[25]*mnuSelf; 
  data->AEM_S(65,39) = -0.3162277660168379*cMrSelf[25]*mnuSelf; 
  data->AEM_S(66,30) = -0.3535533905932737*cMrSelf[26]*mnuSelf; 
  data->AEM_S(66,32) = -0.3535533905932737*cMrSelf[23]*mnuSelf; 
  data->AEM_S(66,33) = -0.3535533905932737*cMrSelf[22]*mnuSelf; 
  data->AEM_S(66,34) = -0.3535533905932737*cMrSelf[25]*mnuSelf; 
  data->AEM_S(66,35) = -0.3535533905932737*cMrSelf[24]*mnuSelf; 
  data->AEM_S(66,36) = (-0.3162277660168379*cMrSelf[29]*mnuSelf)-0.3162277660168379*cMrSelf[28]*mnuSelf-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(66,38) = -0.3162277660168379*cMrSelf[26]*mnuSelf; 
  data->AEM_S(66,39) = -0.3162277660168379*cMrSelf[26]*mnuSelf; 
  data->AEM_S(67,30) = -0.3535533905932737*cMrSelf[27]*mnuSelf; 
  data->AEM_S(67,31) = -0.3162277660168379*cMrSelf[21]*mnuSelf; 
  data->AEM_S(67,34) = -0.3162277660168379*cMrSelf[24]*mnuSelf; 
  data->AEM_S(67,35) = -0.3162277660168379*cMrSelf[25]*mnuSelf; 
  data->AEM_S(67,37) = (-0.2258769757263128*cMrSelf[27]*mnuSelf)-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(68,30) = -0.3535533905932737*cMrSelf[28]*mnuSelf; 
  data->AEM_S(68,32) = -0.3162277660168379*cMrSelf[22]*mnuSelf; 
  data->AEM_S(68,34) = -0.3162277660168379*cMrSelf[24]*mnuSelf; 
  data->AEM_S(68,36) = -0.3162277660168379*cMrSelf[26]*mnuSelf; 
  data->AEM_S(68,38) = (-0.2258769757263128*cMrSelf[28]*mnuSelf)-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  data->AEM_S(69,30) = -0.3535533905932737*cMrSelf[29]*mnuSelf; 
  data->AEM_S(69,33) = -0.3162277660168379*cMrSelf[23]*mnuSelf; 
  data->AEM_S(69,35) = -0.3162277660168379*cMrSelf[25]*mnuSelf; 
  data->AEM_S(69,36) = -0.3162277660168379*cMrSelf[26]*mnuSelf; 
  data->AEM_S(69,39) = (-0.2258769757263128*cMrSelf[29]*mnuSelf)-0.3535533905932737*cMrSelf[20]*mnuSelf; 
  ...
  // ... Block from correction to (other) 1st moment of collision operator ... // 
  data->AEM_S(60,70) = 0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(60,71) = 0.3535533905932737*cMrOther[21]*mnuOther; 
  data->AEM_S(60,72) = 0.3535533905932737*cMrOther[22]*mnuOther; 
  data->AEM_S(60,73) = 0.3535533905932737*cMrOther[23]*mnuOther; 
  data->AEM_S(60,74) = 0.3535533905932737*cMrOther[24]*mnuOther; 
  data->AEM_S(60,75) = 0.3535533905932737*cMrOther[25]*mnuOther; 
  data->AEM_S(60,76) = 0.3535533905932737*cMrOther[26]*mnuOther; 
  data->AEM_S(60,77) = 0.3535533905932737*cMrOther[27]*mnuOther; 
  data->AEM_S(60,78) = 0.3535533905932737*cMrOther[28]*mnuOther; 
  data->AEM_S(60,79) = 0.3535533905932737*cMrOther[29]*mnuOther; 
  data->AEM_S(61,70) = 0.3535533905932737*cMrOther[21]*mnuOther; 
  data->AEM_S(61,71) = 0.3162277660168379*cMrOther[27]*mnuOther+0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(61,72) = 0.3535533905932737*cMrOther[24]*mnuOther; 
  data->AEM_S(61,73) = 0.3535533905932737*cMrOther[25]*mnuOther; 
  data->AEM_S(61,74) = 0.3535533905932737*cMrOther[22]*mnuOther; 
  data->AEM_S(61,75) = 0.3535533905932737*cMrOther[23]*mnuOther; 
  data->AEM_S(61,77) = 0.3162277660168379*cMrOther[21]*mnuOther; 
  data->AEM_S(62,70) = 0.3535533905932737*cMrOther[22]*mnuOther; 
  data->AEM_S(62,71) = 0.3535533905932737*cMrOther[24]*mnuOther; 
  data->AEM_S(62,72) = 0.3162277660168379*cMrOther[28]*mnuOther+0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(62,73) = 0.3535533905932737*cMrOther[26]*mnuOther; 
  data->AEM_S(62,74) = 0.3535533905932737*cMrOther[21]*mnuOther; 
  data->AEM_S(62,76) = 0.3535533905932737*cMrOther[23]*mnuOther; 
  data->AEM_S(62,78) = 0.3162277660168379*cMrOther[22]*mnuOther; 
  data->AEM_S(63,70) = 0.3535533905932737*cMrOther[23]*mnuOther; 
  data->AEM_S(63,71) = 0.3535533905932737*cMrOther[25]*mnuOther; 
  data->AEM_S(63,72) = 0.3535533905932737*cMrOther[26]*mnuOther; 
  data->AEM_S(63,73) = 0.3162277660168379*cMrOther[29]*mnuOther+0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(63,75) = 0.3535533905932737*cMrOther[21]*mnuOther; 
  data->AEM_S(63,76) = 0.3535533905932737*cMrOther[22]*mnuOther; 
  data->AEM_S(63,79) = 0.3162277660168379*cMrOther[23]*mnuOther; 
  data->AEM_S(64,70) = 0.3535533905932737*cMrOther[24]*mnuOther; 
  data->AEM_S(64,71) = 0.3535533905932737*cMrOther[22]*mnuOther; 
  data->AEM_S(64,72) = 0.3535533905932737*cMrOther[21]*mnuOther; 
  data->AEM_S(64,74) = 0.3162277660168379*cMrOther[28]*mnuOther+0.3162277660168379*cMrOther[27]*mnuOther+0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(64,75) = 0.3535533905932737*cMrOther[26]*mnuOther; 
  data->AEM_S(64,76) = 0.3535533905932737*cMrOther[25]*mnuOther; 
  data->AEM_S(64,77) = 0.3162277660168379*cMrOther[24]*mnuOther; 
  data->AEM_S(64,78) = 0.3162277660168379*cMrOther[24]*mnuOther; 
  data->AEM_S(65,70) = 0.3535533905932737*cMrOther[25]*mnuOther; 
  data->AEM_S(65,71) = 0.3535533905932737*cMrOther[23]*mnuOther; 
  data->AEM_S(65,73) = 0.3535533905932737*cMrOther[21]*mnuOther; 
  data->AEM_S(65,74) = 0.3535533905932737*cMrOther[26]*mnuOther; 
  data->AEM_S(65,75) = 0.3162277660168379*cMrOther[29]*mnuOther+0.3162277660168379*cMrOther[27]*mnuOther+0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(65,76) = 0.3535533905932737*cMrOther[24]*mnuOther; 
  data->AEM_S(65,77) = 0.3162277660168379*cMrOther[25]*mnuOther; 
  data->AEM_S(65,79) = 0.3162277660168379*cMrOther[25]*mnuOther; 
  data->AEM_S(66,70) = 0.3535533905932737*cMrOther[26]*mnuOther; 
  data->AEM_S(66,72) = 0.3535533905932737*cMrOther[23]*mnuOther; 
  data->AEM_S(66,73) = 0.3535533905932737*cMrOther[22]*mnuOther; 
  data->AEM_S(66,74) = 0.3535533905932737*cMrOther[25]*mnuOther; 
  data->AEM_S(66,75) = 0.3535533905932737*cMrOther[24]*mnuOther; 
  data->AEM_S(66,76) = 0.3162277660168379*cMrOther[29]*mnuOther+0.3162277660168379*cMrOther[28]*mnuOther+0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(66,78) = 0.3162277660168379*cMrOther[26]*mnuOther; 
  data->AEM_S(66,79) = 0.3162277660168379*cMrOther[26]*mnuOther; 
  data->AEM_S(67,70) = 0.3535533905932737*cMrOther[27]*mnuOther; 
  data->AEM_S(67,71) = 0.3162277660168379*cMrOther[21]*mnuOther; 
  data->AEM_S(67,74) = 0.3162277660168379*cMrOther[24]*mnuOther; 
  data->AEM_S(67,75) = 0.3162277660168379*cMrOther[25]*mnuOther; 
  data->AEM_S(67,77) = 0.2258769757263128*cMrOther[27]*mnuOther+0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(68,70) = 0.3535533905932737*cMrOther[28]*mnuOther; 
  data->AEM_S(68,72) = 0.3162277660168379*cMrOther[22]*mnuOther; 
  data->AEM_S(68,74) = 0.3162277660168379*cMrOther[24]*mnuOther; 
  data->AEM_S(68,76) = 0.3162277660168379*cMrOther[26]*mnuOther; 
  data->AEM_S(68,78) = 0.2258769757263128*cMrOther[28]*mnuOther+0.3535533905932737*cMrOther[20]*mnuOther; 
  data->AEM_S(69,70) = 0.3535533905932737*cMrOther[29]*mnuOther; 
  data->AEM_S(69,73) = 0.3162277660168379*cMrOther[23]*mnuOther; 
  data->AEM_S(69,75) = 0.3162277660168379*cMrOther[25]*mnuOther; 
  data->AEM_S(69,76) = 0.3162277660168379*cMrOther[26]*mnuOther; 
  data->AEM_S(69,79) = 0.2258769757263128*cMrOther[29]*mnuOther+0.3535533905932737*cMrOther[20]*mnuOther; 
  ...
  // ... Block from correction to (self) 2nd moment of collision operator ... // 
  data->AEM_S(70,30) = 0.3535533905932737*ucMSelf[0]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(70,31) = 0.3535533905932737*ucMSelf[1]*mnuSelf+1.060660171779821*m0rSelf[1]*mnuSelf-0.3535533905932737*cErSelf[1]*mnuSelf; 
  data->AEM_S(70,32) = 0.3535533905932737*ucMSelf[2]*mnuSelf+1.060660171779821*m0rSelf[2]*mnuSelf-0.3535533905932737*cErSelf[2]*mnuSelf; 
  data->AEM_S(70,33) = 0.3535533905932737*ucMSelf[3]*mnuSelf+1.060660171779821*m0rSelf[3]*mnuSelf-0.3535533905932737*cErSelf[3]*mnuSelf; 
  data->AEM_S(70,34) = 0.3535533905932737*ucMSelf[4]*mnuSelf+1.060660171779821*m0rSelf[4]*mnuSelf-0.3535533905932737*cErSelf[4]*mnuSelf; 
  data->AEM_S(70,35) = 0.3535533905932737*ucMSelf[5]*mnuSelf+1.060660171779821*m0rSelf[5]*mnuSelf-0.3535533905932737*cErSelf[5]*mnuSelf; 
  data->AEM_S(70,36) = 0.3535533905932737*ucMSelf[6]*mnuSelf+1.060660171779821*m0rSelf[6]*mnuSelf-0.3535533905932737*cErSelf[6]*mnuSelf; 
  data->AEM_S(70,37) = 0.3535533905932737*ucMSelf[7]*mnuSelf+1.060660171779821*m0rSelf[7]*mnuSelf-0.3535533905932737*cErSelf[7]*mnuSelf; 
  data->AEM_S(70,38) = 0.3535533905932737*ucMSelf[8]*mnuSelf+1.060660171779821*m0rSelf[8]*mnuSelf-0.3535533905932737*cErSelf[8]*mnuSelf; 
  data->AEM_S(70,39) = 0.3535533905932737*ucMSelf[9]*mnuSelf+1.060660171779821*m0rSelf[9]*mnuSelf-0.3535533905932737*cErSelf[9]*mnuSelf; 
  data->AEM_S(71,30) = 0.3535533905932737*ucMSelf[1]*mnuSelf+1.060660171779821*m0rSelf[1]*mnuSelf-0.3535533905932737*cErSelf[1]*mnuSelf; 
  data->AEM_S(71,31) = 0.3162277660168379*ucMSelf[7]*mnuSelf+0.9486832980505137*m0rSelf[7]*mnuSelf-0.3162277660168379*cErSelf[7]*mnuSelf+0.3535533905932737*ucMSelf[0]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(71,32) = 0.3535533905932737*ucMSelf[4]*mnuSelf+1.060660171779821*m0rSelf[4]*mnuSelf-0.3535533905932737*cErSelf[4]*mnuSelf; 
  data->AEM_S(71,33) = 0.3535533905932737*ucMSelf[5]*mnuSelf+1.060660171779821*m0rSelf[5]*mnuSelf-0.3535533905932737*cErSelf[5]*mnuSelf; 
  data->AEM_S(71,34) = 0.3535533905932737*ucMSelf[2]*mnuSelf+1.060660171779821*m0rSelf[2]*mnuSelf-0.3535533905932737*cErSelf[2]*mnuSelf; 
  data->AEM_S(71,35) = 0.3535533905932737*ucMSelf[3]*mnuSelf+1.060660171779821*m0rSelf[3]*mnuSelf-0.3535533905932737*cErSelf[3]*mnuSelf; 
  data->AEM_S(71,37) = 0.3162277660168379*ucMSelf[1]*mnuSelf+0.9486832980505137*m0rSelf[1]*mnuSelf-0.3162277660168379*cErSelf[1]*mnuSelf; 
  data->AEM_S(72,30) = 0.3535533905932737*ucMSelf[2]*mnuSelf+1.060660171779821*m0rSelf[2]*mnuSelf-0.3535533905932737*cErSelf[2]*mnuSelf; 
  data->AEM_S(72,31) = 0.3535533905932737*ucMSelf[4]*mnuSelf+1.060660171779821*m0rSelf[4]*mnuSelf-0.3535533905932737*cErSelf[4]*mnuSelf; 
  data->AEM_S(72,32) = 0.3162277660168379*ucMSelf[8]*mnuSelf+0.9486832980505137*m0rSelf[8]*mnuSelf-0.3162277660168379*cErSelf[8]*mnuSelf+0.3535533905932737*ucMSelf[0]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(72,33) = 0.3535533905932737*ucMSelf[6]*mnuSelf+1.060660171779821*m0rSelf[6]*mnuSelf-0.3535533905932737*cErSelf[6]*mnuSelf; 
  data->AEM_S(72,34) = 0.3535533905932737*ucMSelf[1]*mnuSelf+1.060660171779821*m0rSelf[1]*mnuSelf-0.3535533905932737*cErSelf[1]*mnuSelf; 
  data->AEM_S(72,36) = 0.3535533905932737*ucMSelf[3]*mnuSelf+1.060660171779821*m0rSelf[3]*mnuSelf-0.3535533905932737*cErSelf[3]*mnuSelf; 
  data->AEM_S(72,38) = 0.3162277660168379*ucMSelf[2]*mnuSelf+0.9486832980505137*m0rSelf[2]*mnuSelf-0.3162277660168379*cErSelf[2]*mnuSelf; 
  data->AEM_S(73,30) = 0.3535533905932737*ucMSelf[3]*mnuSelf+1.060660171779821*m0rSelf[3]*mnuSelf-0.3535533905932737*cErSelf[3]*mnuSelf; 
  data->AEM_S(73,31) = 0.3535533905932737*ucMSelf[5]*mnuSelf+1.060660171779821*m0rSelf[5]*mnuSelf-0.3535533905932737*cErSelf[5]*mnuSelf; 
  data->AEM_S(73,32) = 0.3535533905932737*ucMSelf[6]*mnuSelf+1.060660171779821*m0rSelf[6]*mnuSelf-0.3535533905932737*cErSelf[6]*mnuSelf; 
  data->AEM_S(73,33) = 0.3162277660168379*ucMSelf[9]*mnuSelf+0.9486832980505137*m0rSelf[9]*mnuSelf-0.3162277660168379*cErSelf[9]*mnuSelf+0.3535533905932737*ucMSelf[0]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(73,35) = 0.3535533905932737*ucMSelf[1]*mnuSelf+1.060660171779821*m0rSelf[1]*mnuSelf-0.3535533905932737*cErSelf[1]*mnuSelf; 
  data->AEM_S(73,36) = 0.3535533905932737*ucMSelf[2]*mnuSelf+1.060660171779821*m0rSelf[2]*mnuSelf-0.3535533905932737*cErSelf[2]*mnuSelf; 
  data->AEM_S(73,39) = 0.3162277660168379*ucMSelf[3]*mnuSelf+0.9486832980505137*m0rSelf[3]*mnuSelf-0.3162277660168379*cErSelf[3]*mnuSelf; 
  data->AEM_S(74,30) = 0.3535533905932737*ucMSelf[4]*mnuSelf+1.060660171779821*m0rSelf[4]*mnuSelf-0.3535533905932737*cErSelf[4]*mnuSelf; 
  data->AEM_S(74,31) = 0.3535533905932737*ucMSelf[2]*mnuSelf+1.060660171779821*m0rSelf[2]*mnuSelf-0.3535533905932737*cErSelf[2]*mnuSelf; 
  data->AEM_S(74,32) = 0.3535533905932737*ucMSelf[1]*mnuSelf+1.060660171779821*m0rSelf[1]*mnuSelf-0.3535533905932737*cErSelf[1]*mnuSelf; 
  data->AEM_S(74,34) = 0.3162277660168379*ucMSelf[8]*mnuSelf+0.9486832980505137*m0rSelf[8]*mnuSelf-0.3162277660168379*cErSelf[8]*mnuSelf+0.3162277660168379*ucMSelf[7]*mnuSelf+0.9486832980505137*m0rSelf[7]*mnuSelf-0.3162277660168379*cErSelf[7]*mnuSelf+0.3535533905932737*ucMSelf[0]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(74,35) = 0.3535533905932737*ucMSelf[6]*mnuSelf+1.060660171779821*m0rSelf[6]*mnuSelf-0.3535533905932737*cErSelf[6]*mnuSelf; 
  data->AEM_S(74,36) = 0.3535533905932737*ucMSelf[5]*mnuSelf+1.060660171779821*m0rSelf[5]*mnuSelf-0.3535533905932737*cErSelf[5]*mnuSelf; 
  data->AEM_S(74,37) = 0.3162277660168379*ucMSelf[4]*mnuSelf+0.9486832980505137*m0rSelf[4]*mnuSelf-0.3162277660168379*cErSelf[4]*mnuSelf; 
  data->AEM_S(74,38) = 0.3162277660168379*ucMSelf[4]*mnuSelf+0.9486832980505137*m0rSelf[4]*mnuSelf-0.3162277660168379*cErSelf[4]*mnuSelf; 
  data->AEM_S(75,30) = 0.3535533905932737*ucMSelf[5]*mnuSelf+1.060660171779821*m0rSelf[5]*mnuSelf-0.3535533905932737*cErSelf[5]*mnuSelf; 
  data->AEM_S(75,31) = 0.3535533905932737*ucMSelf[3]*mnuSelf+1.060660171779821*m0rSelf[3]*mnuSelf-0.3535533905932737*cErSelf[3]*mnuSelf; 
  data->AEM_S(75,33) = 0.3535533905932737*ucMSelf[1]*mnuSelf+1.060660171779821*m0rSelf[1]*mnuSelf-0.3535533905932737*cErSelf[1]*mnuSelf; 
  data->AEM_S(75,34) = 0.3535533905932737*ucMSelf[6]*mnuSelf+1.060660171779821*m0rSelf[6]*mnuSelf-0.3535533905932737*cErSelf[6]*mnuSelf; 
  data->AEM_S(75,35) = 0.3162277660168379*ucMSelf[9]*mnuSelf+0.9486832980505137*m0rSelf[9]*mnuSelf-0.3162277660168379*cErSelf[9]*mnuSelf+0.3162277660168379*ucMSelf[7]*mnuSelf+0.9486832980505137*m0rSelf[7]*mnuSelf-0.3162277660168379*cErSelf[7]*mnuSelf+0.3535533905932737*ucMSelf[0]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(75,36) = 0.3535533905932737*ucMSelf[4]*mnuSelf+1.060660171779821*m0rSelf[4]*mnuSelf-0.3535533905932737*cErSelf[4]*mnuSelf; 
  data->AEM_S(75,37) = 0.3162277660168379*ucMSelf[5]*mnuSelf+0.9486832980505137*m0rSelf[5]*mnuSelf-0.3162277660168379*cErSelf[5]*mnuSelf; 
  data->AEM_S(75,39) = 0.3162277660168379*ucMSelf[5]*mnuSelf+0.9486832980505137*m0rSelf[5]*mnuSelf-0.3162277660168379*cErSelf[5]*mnuSelf; 
  data->AEM_S(76,30) = 0.3535533905932737*ucMSelf[6]*mnuSelf+1.060660171779821*m0rSelf[6]*mnuSelf-0.3535533905932737*cErSelf[6]*mnuSelf; 
  data->AEM_S(76,32) = 0.3535533905932737*ucMSelf[3]*mnuSelf+1.060660171779821*m0rSelf[3]*mnuSelf-0.3535533905932737*cErSelf[3]*mnuSelf; 
  data->AEM_S(76,33) = 0.3535533905932737*ucMSelf[2]*mnuSelf+1.060660171779821*m0rSelf[2]*mnuSelf-0.3535533905932737*cErSelf[2]*mnuSelf; 
  data->AEM_S(76,34) = 0.3535533905932737*ucMSelf[5]*mnuSelf+1.060660171779821*m0rSelf[5]*mnuSelf-0.3535533905932737*cErSelf[5]*mnuSelf; 
  data->AEM_S(76,35) = 0.3535533905932737*ucMSelf[4]*mnuSelf+1.060660171779821*m0rSelf[4]*mnuSelf-0.3535533905932737*cErSelf[4]*mnuSelf; 
  data->AEM_S(76,36) = 0.3162277660168379*ucMSelf[9]*mnuSelf+0.9486832980505137*m0rSelf[9]*mnuSelf-0.3162277660168379*cErSelf[9]*mnuSelf+0.3162277660168379*ucMSelf[8]*mnuSelf+0.9486832980505137*m0rSelf[8]*mnuSelf-0.3162277660168379*cErSelf[8]*mnuSelf+0.3535533905932737*ucMSelf[0]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(76,38) = 0.3162277660168379*ucMSelf[6]*mnuSelf+0.9486832980505137*m0rSelf[6]*mnuSelf-0.3162277660168379*cErSelf[6]*mnuSelf; 
  data->AEM_S(76,39) = 0.3162277660168379*ucMSelf[6]*mnuSelf+0.9486832980505137*m0rSelf[6]*mnuSelf-0.3162277660168379*cErSelf[6]*mnuSelf; 
  data->AEM_S(77,30) = 0.3535533905932737*ucMSelf[7]*mnuSelf+1.060660171779821*m0rSelf[7]*mnuSelf-0.3535533905932737*cErSelf[7]*mnuSelf; 
  data->AEM_S(77,31) = 0.3162277660168379*ucMSelf[1]*mnuSelf+0.9486832980505137*m0rSelf[1]*mnuSelf-0.3162277660168379*cErSelf[1]*mnuSelf; 
  data->AEM_S(77,34) = 0.3162277660168379*ucMSelf[4]*mnuSelf+0.9486832980505137*m0rSelf[4]*mnuSelf-0.3162277660168379*cErSelf[4]*mnuSelf; 
  data->AEM_S(77,35) = 0.3162277660168379*ucMSelf[5]*mnuSelf+0.9486832980505137*m0rSelf[5]*mnuSelf-0.3162277660168379*cErSelf[5]*mnuSelf; 
  data->AEM_S(77,37) = 0.2258769757263128*ucMSelf[7]*mnuSelf+0.6776309271789384*m0rSelf[7]*mnuSelf-0.2258769757263128*cErSelf[7]*mnuSelf+0.3535533905932737*ucMSelf[0]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(78,30) = 0.3535533905932737*ucMSelf[8]*mnuSelf+1.060660171779821*m0rSelf[8]*mnuSelf-0.3535533905932737*cErSelf[8]*mnuSelf; 
  data->AEM_S(78,32) = 0.3162277660168379*ucMSelf[2]*mnuSelf+0.9486832980505137*m0rSelf[2]*mnuSelf-0.3162277660168379*cErSelf[2]*mnuSelf; 
  data->AEM_S(78,34) = 0.3162277660168379*ucMSelf[4]*mnuSelf+0.9486832980505137*m0rSelf[4]*mnuSelf-0.3162277660168379*cErSelf[4]*mnuSelf; 
  data->AEM_S(78,36) = 0.3162277660168379*ucMSelf[6]*mnuSelf+0.9486832980505137*m0rSelf[6]*mnuSelf-0.3162277660168379*cErSelf[6]*mnuSelf; 
  data->AEM_S(78,38) = 0.2258769757263128*ucMSelf[8]*mnuSelf+0.6776309271789384*m0rSelf[8]*mnuSelf-0.2258769757263128*cErSelf[8]*mnuSelf+0.3535533905932737*ucMSelf[0]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  data->AEM_S(79,30) = 0.3535533905932737*ucMSelf[9]*mnuSelf+1.060660171779821*m0rSelf[9]*mnuSelf-0.3535533905932737*cErSelf[9]*mnuSelf; 
  data->AEM_S(79,33) = 0.3162277660168379*ucMSelf[3]*mnuSelf+0.9486832980505137*m0rSelf[3]*mnuSelf-0.3162277660168379*cErSelf[3]*mnuSelf; 
  data->AEM_S(79,35) = 0.3162277660168379*ucMSelf[5]*mnuSelf+0.9486832980505137*m0rSelf[5]*mnuSelf-0.3162277660168379*cErSelf[5]*mnuSelf; 
  data->AEM_S(79,36) = 0.3162277660168379*ucMSelf[6]*mnuSelf+0.9486832980505137*m0rSelf[6]*mnuSelf-0.3162277660168379*cErSelf[6]*mnuSelf; 
  data->AEM_S(79,39) = 0.2258769757263128*ucMSelf[9]*mnuSelf+0.6776309271789384*m0rSelf[9]*mnuSelf-0.2258769757263128*cErSelf[9]*mnuSelf+0.3535533905932737*ucMSelf[0]*mnuSelf+1.060660171779821*m0rSelf[0]*mnuSelf-0.3535533905932737*cErSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to (other) 2nd moment of collision operator ... // 
  data->AEM_S(70,70) = (-0.3535533905932737*ucMOther[0]*mnuOther)-1.060660171779821*m0rOther[0]*mnuOther+0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(70,71) = (-0.3535533905932737*ucMOther[1]*mnuOther)-1.060660171779821*m0rOther[1]*mnuOther+0.3535533905932737*cErOther[1]*mnuOther; 
  data->AEM_S(70,72) = (-0.3535533905932737*ucMOther[2]*mnuOther)-1.060660171779821*m0rOther[2]*mnuOther+0.3535533905932737*cErOther[2]*mnuOther; 
  data->AEM_S(70,73) = (-0.3535533905932737*ucMOther[3]*mnuOther)-1.060660171779821*m0rOther[3]*mnuOther+0.3535533905932737*cErOther[3]*mnuOther; 
  data->AEM_S(70,74) = (-0.3535533905932737*ucMOther[4]*mnuOther)-1.060660171779821*m0rOther[4]*mnuOther+0.3535533905932737*cErOther[4]*mnuOther; 
  data->AEM_S(70,75) = (-0.3535533905932737*ucMOther[5]*mnuOther)-1.060660171779821*m0rOther[5]*mnuOther+0.3535533905932737*cErOther[5]*mnuOther; 
  data->AEM_S(70,76) = (-0.3535533905932737*ucMOther[6]*mnuOther)-1.060660171779821*m0rOther[6]*mnuOther+0.3535533905932737*cErOther[6]*mnuOther; 
  data->AEM_S(70,77) = (-0.3535533905932737*ucMOther[7]*mnuOther)-1.060660171779821*m0rOther[7]*mnuOther+0.3535533905932737*cErOther[7]*mnuOther; 
  data->AEM_S(70,78) = (-0.3535533905932737*ucMOther[8]*mnuOther)-1.060660171779821*m0rOther[8]*mnuOther+0.3535533905932737*cErOther[8]*mnuOther; 
  data->AEM_S(70,79) = (-0.3535533905932737*ucMOther[9]*mnuOther)-1.060660171779821*m0rOther[9]*mnuOther+0.3535533905932737*cErOther[9]*mnuOther; 
  data->AEM_S(71,70) = (-0.3535533905932737*ucMOther[1]*mnuOther)-1.060660171779821*m0rOther[1]*mnuOther+0.3535533905932737*cErOther[1]*mnuOther; 
  data->AEM_S(71,71) = (-0.3162277660168379*ucMOther[7]*mnuOther)-0.9486832980505137*m0rOther[7]*mnuOther+0.3162277660168379*cErOther[7]*mnuOther-0.3535533905932737*ucMOther[0]*mnuOther-1.060660171779821*m0rOther[0]*mnuOther+0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(71,72) = (-0.3535533905932737*ucMOther[4]*mnuOther)-1.060660171779821*m0rOther[4]*mnuOther+0.3535533905932737*cErOther[4]*mnuOther; 
  data->AEM_S(71,73) = (-0.3535533905932737*ucMOther[5]*mnuOther)-1.060660171779821*m0rOther[5]*mnuOther+0.3535533905932737*cErOther[5]*mnuOther; 
  data->AEM_S(71,74) = (-0.3535533905932737*ucMOther[2]*mnuOther)-1.060660171779821*m0rOther[2]*mnuOther+0.3535533905932737*cErOther[2]*mnuOther; 
  data->AEM_S(71,75) = (-0.3535533905932737*ucMOther[3]*mnuOther)-1.060660171779821*m0rOther[3]*mnuOther+0.3535533905932737*cErOther[3]*mnuOther; 
  data->AEM_S(71,77) = (-0.3162277660168379*ucMOther[1]*mnuOther)-0.9486832980505137*m0rOther[1]*mnuOther+0.3162277660168379*cErOther[1]*mnuOther; 
  data->AEM_S(72,70) = (-0.3535533905932737*ucMOther[2]*mnuOther)-1.060660171779821*m0rOther[2]*mnuOther+0.3535533905932737*cErOther[2]*mnuOther; 
  data->AEM_S(72,71) = (-0.3535533905932737*ucMOther[4]*mnuOther)-1.060660171779821*m0rOther[4]*mnuOther+0.3535533905932737*cErOther[4]*mnuOther; 
  data->AEM_S(72,72) = (-0.3162277660168379*ucMOther[8]*mnuOther)-0.9486832980505137*m0rOther[8]*mnuOther+0.3162277660168379*cErOther[8]*mnuOther-0.3535533905932737*ucMOther[0]*mnuOther-1.060660171779821*m0rOther[0]*mnuOther+0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(72,73) = (-0.3535533905932737*ucMOther[6]*mnuOther)-1.060660171779821*m0rOther[6]*mnuOther+0.3535533905932737*cErOther[6]*mnuOther; 
  data->AEM_S(72,74) = (-0.3535533905932737*ucMOther[1]*mnuOther)-1.060660171779821*m0rOther[1]*mnuOther+0.3535533905932737*cErOther[1]*mnuOther; 
  data->AEM_S(72,76) = (-0.3535533905932737*ucMOther[3]*mnuOther)-1.060660171779821*m0rOther[3]*mnuOther+0.3535533905932737*cErOther[3]*mnuOther; 
  data->AEM_S(72,78) = (-0.3162277660168379*ucMOther[2]*mnuOther)-0.9486832980505137*m0rOther[2]*mnuOther+0.3162277660168379*cErOther[2]*mnuOther; 
  data->AEM_S(73,70) = (-0.3535533905932737*ucMOther[3]*mnuOther)-1.060660171779821*m0rOther[3]*mnuOther+0.3535533905932737*cErOther[3]*mnuOther; 
  data->AEM_S(73,71) = (-0.3535533905932737*ucMOther[5]*mnuOther)-1.060660171779821*m0rOther[5]*mnuOther+0.3535533905932737*cErOther[5]*mnuOther; 
  data->AEM_S(73,72) = (-0.3535533905932737*ucMOther[6]*mnuOther)-1.060660171779821*m0rOther[6]*mnuOther+0.3535533905932737*cErOther[6]*mnuOther; 
  data->AEM_S(73,73) = (-0.3162277660168379*ucMOther[9]*mnuOther)-0.9486832980505137*m0rOther[9]*mnuOther+0.3162277660168379*cErOther[9]*mnuOther-0.3535533905932737*ucMOther[0]*mnuOther-1.060660171779821*m0rOther[0]*mnuOther+0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(73,75) = (-0.3535533905932737*ucMOther[1]*mnuOther)-1.060660171779821*m0rOther[1]*mnuOther+0.3535533905932737*cErOther[1]*mnuOther; 
  data->AEM_S(73,76) = (-0.3535533905932737*ucMOther[2]*mnuOther)-1.060660171779821*m0rOther[2]*mnuOther+0.3535533905932737*cErOther[2]*mnuOther; 
  data->AEM_S(73,79) = (-0.3162277660168379*ucMOther[3]*mnuOther)-0.9486832980505137*m0rOther[3]*mnuOther+0.3162277660168379*cErOther[3]*mnuOther; 
  data->AEM_S(74,70) = (-0.3535533905932737*ucMOther[4]*mnuOther)-1.060660171779821*m0rOther[4]*mnuOther+0.3535533905932737*cErOther[4]*mnuOther; 
  data->AEM_S(74,71) = (-0.3535533905932737*ucMOther[2]*mnuOther)-1.060660171779821*m0rOther[2]*mnuOther+0.3535533905932737*cErOther[2]*mnuOther; 
  data->AEM_S(74,72) = (-0.3535533905932737*ucMOther[1]*mnuOther)-1.060660171779821*m0rOther[1]*mnuOther+0.3535533905932737*cErOther[1]*mnuOther; 
  ...
  data->AEM_S(74,75) = (-0.3535533905932737*ucMOther[6]*mnuOther)-1.060660171779821*m0rOther[6]*mnuOther+0.3535533905932737*cErOther[6]*mnuOther; 
  data->AEM_S(74,76) = (-0.3535533905932737*ucMOther[5]*mnuOther)-1.060660171779821*m0rOther[5]*mnuOther+0.3535533905932737*cErOther[5]*mnuOther; 
  data->AEM_S(74,77) = (-0.3162277660168379*ucMOther[4]*mnuOther)-0.9486832980505137*m0rOther[4]*mnuOther+0.3162277660168379*cErOther[4]*mnuOther; 
  data->AEM_S(74,78) = (-0.3162277660168379*ucMOther[4]*mnuOther)-0.9486832980505137*m0rOther[4]*mnuOther+0.3162277660168379*cErOther[4]*mnuOther; 
  data->AEM_S(75,70) = (-0.3535533905932737*ucMOther[5]*mnuOther)-1.060660171779821*m0rOther[5]*mnuOther+0.3535533905932737*cErOther[5]*mnuOther; 
  data->AEM_S(75,71) = (-0.3535533905932737*ucMOther[3]*mnuOther)-1.060660171779821*m0rOther[3]*mnuOther+0.3535533905932737*cErOther[3]*mnuOther; 
  data->AEM_S(75,73) = (-0.3535533905932737*ucMOther[1]*mnuOther)-1.060660171779821*m0rOther[1]*mnuOther+0.3535533905932737*cErOther[1]*mnuOther; 
  data->AEM_S(75,74) = (-0.3535533905932737*ucMOther[6]*mnuOther)-1.060660171779821*m0rOther[6]*mnuOther+0.3535533905932737*cErOther[6]*mnuOther; 
  ...
  data->AEM_S(75,76) = (-0.3535533905932737*ucMOther[4]*mnuOther)-1.060660171779821*m0rOther[4]*mnuOther+0.3535533905932737*cErOther[4]*mnuOther; 
  data->AEM_S(75,77) = (-0.3162277660168379*ucMOther[5]*mnuOther)-0.9486832980505137*m0rOther[5]*mnuOther+0.3162277660168379*cErOther[5]*mnuOther; 
  data->AEM_S(75,79) = (-0.3162277660168379*ucMOther[5]*mnuOther)-0.9486832980505137*m0rOther[5]*mnuOther+0.3162277660168379*cErOther[5]*mnuOther; 
  data->AEM_S(76,70) = (-0.3535533905932737*ucMOther[6]*mnuOther)-1.060660171779821*m0rOther[6]*mnuOther+0.3535533905932737*cErOther[6]*mnuOther; 
  data->AEM_S(76,72) = (-0.3535533905932737*ucMOther[3]*mnuOther)-1.060660171779821*m0rOther[3]*mnuOther+0.3535533905932737*cErOther[3]*mnuOther; 
  data->AEM_S(76,73) = (-0.3535533905932737*ucMOther[2]*mnuOther)-1.060660171779821*m0rOther[2]*mnuOther+0.3535533905932737*cErOther[2]*mnuOther; 
  data->AEM_S(76,74) = (-0.3535533905932737*ucMOther[5]*mnuOther)-1.060660171779821*m0rOther[5]*mnuOther+0.3535533905932737*cErOther[5]*mnuOther; 
  data->AEM_S(76,75) = (-0.3535533905932737*ucMOther[4]*mnuOther)-1.060660171779821*m0rOther[4]*mnuOther+0.3535533905932737*cErOther[4]*mnuOther; 
  ...
  data->AEM_S(76,78) = (-0.3162277660168379*ucMOther[6]*mnuOther)-0.9486832980505137*m0rOther[6]*mnuOther+0.3162277660168379*cErOther[6]*mnuOther; 
  data->AEM_S(76,79) = (-0.3162277660168379*ucMOther[6]*mnuOther)-0.9486832980505137*m0rOther[6]*mnuOther+0.3162277660168379*cErOther[6]*mnuOther; 
  data->AEM_S(77,70) = (-0.3535533905932737*ucMOther[7]*mnuOther)-1.060660171779821*m0rOther[7]*mnuOther+0.3535533905932737*cErOther[7]*mnuOther; 
  data->AEM_S(77,71) = (-0.3162277660168379*ucMOther[1]*mnuOther)-0.9486832980505137*m0rOther[1]*mnuOther+0.3162277660168379*cErOther[1]*mnuOther; 
  data->AEM_S(77,74) = (-0.3162277660168379*ucMOther[4]*mnuOther)-0.9486832980505137*m0rOther[4]*mnuOther+0.3162277660168379*cErOther[4]*mnuOther; 
  data->AEM_S(77,75) = (-0.3162277660168379*ucMOther[5]*mnuOther)-0.9486832980505137*m0rOther[5]*mnuOther+0.3162277660168379*cErOther[5]*mnuOther; 
  data->AEM_S(77,77) = (-0.2258769757263128*ucMOther[7]*mnuOther)-0.6776309271789384*m0rOther[7]*mnuOther+0.2258769757263128*cErOther[7]*mnuOther-0.3535533905932737*ucMOther[0]*mnuOther-1.060660171779821*m0rOther[0]*mnuOther+0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(78,70) = (-0.3535533905932737*ucMOther[8]*mnuOther)-1.060660171779821*m0rOther[8]*mnuOther+0.3535533905932737*cErOther[8]*mnuOther; 
  data->AEM_S(78,72) = (-0.3162277660168379*ucMOther[2]*mnuOther)-0.9486832980505137*m0rOther[2]*mnuOther+0.3162277660168379*cErOther[2]*mnuOther; 
  data->AEM_S(78,74) = (-0.3162277660168379*ucMOther[4]*mnuOther)-0.9486832980505137*m0rOther[4]*mnuOther+0.3162277660168379*cErOther[4]*mnuOther; 
  data->AEM_S(78,76) = (-0.3162277660168379*ucMOther[6]*mnuOther)-0.9486832980505137*m0rOther[6]*mnuOther+0.3162277660168379*cErOther[6]*mnuOther; 
  data->AEM_S(78,78) = (-0.2258769757263128*ucMOther[8]*mnuOther)-0.6776309271789384*m0rOther[8]*mnuOther+0.2258769757263128*cErOther[8]*mnuOther-0.3535533905932737*ucMOther[0]*mnuOther-1.060660171779821*m0rOther[0]*mnuOther+0.3535533905932737*cErOther[0]*mnuOther; 
  data->AEM_S(79,70) = (-0.3535533905932737*ucMOther[9]*mnuOther)-1.060660171779821*m0rOther[9]*mnuOther+0.3535533905932737*cErOther[9]*mnuOther; 
  data->AEM_S(79,73) = (-0.3162277660168379*ucMOther[3]*mnuOther)-0.9486832980505137*m0rOther[3]*mnuOther+0.3162277660168379*cErOther[3]*mnuOther; 
  data->AEM_S(79,75) = (-0.3162277660168379*ucMOther[5]*mnuOther)-0.9486832980505137*m0rOther[5]*mnuOther+0.3162277660168379*cErOther[5]*mnuOther; 
  data->AEM_S(79,76) = (-0.3162277660168379*ucMOther[6]*mnuOther)-0.9486832980505137*m0rOther[6]*mnuOther+0.3162277660168379*cErOther[6]*mnuOther; 
  data->AEM_S(79,79) = (-0.2258769757263128*ucMOther[9]*mnuOther)-0.6776309271789384*m0rOther[9]*mnuOther+0.2258769757263128*cErOther[9]*mnuOther-0.3535533905932737*ucMOther[0]*mnuOther-1.060660171779821*m0rOther[0]*mnuOther+0.3535533905932737*cErOther[0]*mnuOther; 
