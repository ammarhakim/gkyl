...
{ 
  ...
  data->AEM_S(8,8) = 1.060660171779821*m0r[0]-0.3535533905932737*cE[0]; 
  data->AEM_S(8,9) = 1.060660171779821*m0r[1]-0.3535533905932737*cE[1]; 
  data->AEM_S(8,10) = 1.060660171779821*m0r[2]-0.3535533905932737*cE[2]; 
  data->AEM_S(8,11) = 1.060660171779821*m0r[3]-0.3535533905932737*cE[3]; 
  data->AEM_S(8,12) = 1.060660171779821*m0r[4]-0.3535533905932737*cE[4]; 
  data->AEM_S(8,13) = 1.060660171779821*m0r[5]-0.3535533905932737*cE[5]; 
  data->AEM_S(8,14) = 1.060660171779821*m0r[6]-0.3535533905932737*cE[6]; 
  data->AEM_S(8,15) = 1.060660171779821*m0r[7]-0.3535533905932737*cE[7]; 
  data->AEM_S(9,8) = 1.060660171779821*m0r[1]-0.3535533905932737*cE[1]; 
  data->AEM_S(9,9) = 1.060660171779821*m0r[0]-0.3535533905932737*cE[0]; 
  data->AEM_S(9,10) = 1.060660171779821*m0r[4]-0.3535533905932737*cE[4]; 
  data->AEM_S(9,11) = 1.060660171779821*m0r[5]-0.3535533905932737*cE[5]; 
  data->AEM_S(9,12) = 1.060660171779821*m0r[2]-0.3535533905932737*cE[2]; 
  data->AEM_S(9,13) = 1.060660171779821*m0r[3]-0.3535533905932737*cE[3]; 
  data->AEM_S(9,14) = 1.060660171779821*m0r[7]-0.3535533905932737*cE[7]; 
  data->AEM_S(9,15) = 1.060660171779821*m0r[6]-0.3535533905932737*cE[6]; 
  data->AEM_S(10,8) = 1.060660171779821*m0r[2]-0.3535533905932737*cE[2]; 
  data->AEM_S(10,9) = 1.060660171779821*m0r[4]-0.3535533905932737*cE[4]; 
  data->AEM_S(10,10) = 1.060660171779821*m0r[0]-0.3535533905932737*cE[0]; 
  data->AEM_S(10,11) = 1.060660171779821*m0r[6]-0.3535533905932737*cE[6]; 
  data->AEM_S(10,12) = 1.060660171779821*m0r[1]-0.3535533905932737*cE[1]; 
  data->AEM_S(10,13) = 1.060660171779821*m0r[7]-0.3535533905932737*cE[7]; 
  data->AEM_S(10,14) = 1.060660171779821*m0r[3]-0.3535533905932737*cE[3]; 
  data->AEM_S(10,15) = 1.060660171779821*m0r[5]-0.3535533905932737*cE[5]; 
  data->AEM_S(11,8) = 1.060660171779821*m0r[3]-0.3535533905932737*cE[3]; 
  data->AEM_S(11,9) = 1.060660171779821*m0r[5]-0.3535533905932737*cE[5]; 
  data->AEM_S(11,10) = 1.060660171779821*m0r[6]-0.3535533905932737*cE[6]; 
  data->AEM_S(11,11) = 1.060660171779821*m0r[0]-0.3535533905932737*cE[0]; 
  data->AEM_S(11,12) = 1.060660171779821*m0r[7]-0.3535533905932737*cE[7]; 
  data->AEM_S(11,13) = 1.060660171779821*m0r[1]-0.3535533905932737*cE[1]; 
  data->AEM_S(11,14) = 1.060660171779821*m0r[2]-0.3535533905932737*cE[2]; 
  data->AEM_S(11,15) = 1.060660171779821*m0r[4]-0.3535533905932737*cE[4]; 
  data->AEM_S(12,8) = 1.060660171779821*m0r[4]-0.3535533905932737*cE[4]; 
  data->AEM_S(12,9) = 1.060660171779821*m0r[2]-0.3535533905932737*cE[2]; 
  data->AEM_S(12,10) = 1.060660171779821*m0r[1]-0.3535533905932737*cE[1]; 
  data->AEM_S(12,11) = 1.060660171779821*m0r[7]-0.3535533905932737*cE[7]; 
  data->AEM_S(12,12) = 1.060660171779821*m0r[0]-0.3535533905932737*cE[0]; 
  data->AEM_S(12,13) = 1.060660171779821*m0r[6]-0.3535533905932737*cE[6]; 
  data->AEM_S(12,14) = 1.060660171779821*m0r[5]-0.3535533905932737*cE[5]; 
  data->AEM_S(12,15) = 1.060660171779821*m0r[3]-0.3535533905932737*cE[3]; 
  data->AEM_S(13,8) = 1.060660171779821*m0r[5]-0.3535533905932737*cE[5]; 
  data->AEM_S(13,9) = 1.060660171779821*m0r[3]-0.3535533905932737*cE[3]; 
  data->AEM_S(13,10) = 1.060660171779821*m0r[7]-0.3535533905932737*cE[7]; 
  data->AEM_S(13,11) = 1.060660171779821*m0r[1]-0.3535533905932737*cE[1]; 
  data->AEM_S(13,12) = 1.060660171779821*m0r[6]-0.3535533905932737*cE[6]; 
  data->AEM_S(13,13) = 1.060660171779821*m0r[0]-0.3535533905932737*cE[0]; 
  data->AEM_S(13,14) = 1.060660171779821*m0r[4]-0.3535533905932737*cE[4]; 
  data->AEM_S(13,15) = 1.060660171779821*m0r[2]-0.3535533905932737*cE[2]; 
  data->AEM_S(14,8) = 1.060660171779821*m0r[6]-0.3535533905932737*cE[6]; 
  data->AEM_S(14,9) = 1.060660171779821*m0r[7]-0.3535533905932737*cE[7]; 
  data->AEM_S(14,10) = 1.060660171779821*m0r[3]-0.3535533905932737*cE[3]; 
  data->AEM_S(14,11) = 1.060660171779821*m0r[2]-0.3535533905932737*cE[2]; 
  data->AEM_S(14,12) = 1.060660171779821*m0r[5]-0.3535533905932737*cE[5]; 
  data->AEM_S(14,13) = 1.060660171779821*m0r[4]-0.3535533905932737*cE[4]; 
  data->AEM_S(14,14) = 1.060660171779821*m0r[0]-0.3535533905932737*cE[0]; 
  data->AEM_S(14,15) = 1.060660171779821*m0r[1]-0.3535533905932737*cE[1]; 
  data->AEM_S(15,8) = 1.060660171779821*m0r[7]-0.3535533905932737*cE[7]; 
  data->AEM_S(15,9) = 1.060660171779821*m0r[6]-0.3535533905932737*cE[6]; 
  data->AEM_S(15,10) = 1.060660171779821*m0r[5]-0.3535533905932737*cE[5]; 
  data->AEM_S(15,11) = 1.060660171779821*m0r[4]-0.3535533905932737*cE[4]; 
  data->AEM_S(15,12) = 1.060660171779821*m0r[3]-0.3535533905932737*cE[3]; 
  data->AEM_S(15,13) = 1.060660171779821*m0r[2]-0.3535533905932737*cE[2]; 
  data->AEM_S(15,14) = 1.060660171779821*m0r[1]-0.3535533905932737*cE[1]; 
  data->AEM_S(15,15) = 1.060660171779821*m0r[0]-0.3535533905932737*cE[0]; 
