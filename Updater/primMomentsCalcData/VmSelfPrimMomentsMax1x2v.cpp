...
{ 
  ...
  BigAEM(4,4) = 0.7071067811865475*m0Sr[0]-0.7071067811865475*cE[0]; 
  BigAEM(4,5) = 0.7071067811865475*m0Sr[1]-0.7071067811865475*cE[1]; 
  BigAEM(5,4) = 0.7071067811865475*m0Sr[1]-0.7071067811865475*cE[1]; 
  BigAEM(5,5) = 0.7071067811865475*m0Sr[0]-0.7071067811865475*cE[0]; 
  ...
  bEV << m1r[0],m1r[1],m1r[2],m1r[3],m2Sr[0],m2Sr[1]; 
...
{ 
  ...
  // ....... Block from correction to vtSq .......... // 
  BigAEM(6,6) = 1.414213562373095*m0r[0]-0.7071067811865475*cE[0]; 
  BigAEM(6,7) = 1.414213562373095*m0r[1]-0.7071067811865475*cE[1]; 
  BigAEM(6,8) = 1.414213562373095*m0r[2]-0.7071067811865475*cE[2]; 
  BigAEM(7,6) = 1.414213562373095*m0r[1]-0.7071067811865475*cE[1]; 
  BigAEM(7,7) = 1.264911064067352*m0r[2]-0.6324555320336759*cE[2]+1.414213562373095*m0r[0]-0.7071067811865475*cE[0]; 
  BigAEM(7,8) = 1.264911064067352*m0r[1]-0.6324555320336759*cE[1]; 
  BigAEM(8,6) = 1.414213562373095*m0r[2]-0.7071067811865475*cE[2]; 
  BigAEM(8,7) = 1.264911064067352*m0r[1]-0.6324555320336759*cE[1]; 
  BigAEM(8,8) = 0.9035079029052515*m0r[2]-0.4517539514526256*cE[2]+1.414213562373095*m0r[0]-0.7071067811865475*cE[0]; 
...
{ 
  ...
  // ....... Block from correction to vtSq .......... // 
  BigAEM(8,8) = 1.414213562373095*m0r[0]-0.7071067811865475*cE[0]; 
  BigAEM(8,9) = 1.414213562373095*m0r[1]-0.7071067811865475*cE[1]; 
  BigAEM(8,10) = 1.414213562373095*m0r[2]-0.7071067811865475*cE[2]; 
  BigAEM(8,11) = 1.414213562373095*m0r[3]-0.7071067811865475*cE[3]; 
  BigAEM(9,8) = 1.414213562373095*m0r[1]-0.7071067811865475*cE[1]; 
  BigAEM(9,9) = 1.264911064067352*m0r[2]-0.6324555320336759*cE[2]+1.414213562373095*m0r[0]-0.7071067811865475*cE[0]; 
  BigAEM(9,10) = 1.242118006816237*m0r[3]-0.6210590034081186*cE[3]+1.264911064067352*m0r[1]-0.6324555320336759*cE[1]; 
  BigAEM(9,11) = 1.242118006816237*m0r[2]-0.6210590034081186*cE[2]; 
  BigAEM(10,8) = 1.414213562373095*m0r[2]-0.7071067811865475*cE[2]; 
  BigAEM(10,9) = 1.242118006816237*m0r[3]-0.6210590034081186*cE[3]+1.264911064067352*m0r[1]-0.6324555320336759*cE[1]; 
  BigAEM(10,10) = 0.9035079029052515*m0r[2]-0.4517539514526256*cE[2]+1.414213562373095*m0r[0]-0.7071067811865475*cE[0]; 
  BigAEM(10,11) = 0.8432740427115681*m0r[3]-0.421637021355784*cE[3]+1.242118006816237*m0r[1]-0.6210590034081186*cE[1]; 
  BigAEM(11,8) = 1.414213562373095*m0r[3]-0.7071067811865475*cE[3]; 
  BigAEM(11,9) = 1.242118006816237*m0r[2]-0.6210590034081186*cE[2]; 
  BigAEM(11,10) = 0.8432740427115681*m0r[3]-0.421637021355784*cE[3]+1.242118006816237*m0r[1]-0.6210590034081186*cE[1]; 
  BigAEM(11,11) = 0.8432740427115681*m0r[2]-0.421637021355784*cE[2]+1.414213562373095*m0r[0]-0.7071067811865475*cE[0]; 
