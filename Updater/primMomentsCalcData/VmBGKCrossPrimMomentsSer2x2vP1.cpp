...
{ 
  ...
  double diffSelf[4]; 
  diffSelf[0] = (0.5*m0rOther[3]*relKinE[3]+0.5*m0rOther[2]*relKinE[2]+0.5*m0rOther[1]*relKinE[1]+0.5*m0rOther[0]*relKinE[0])*mnuOther-1.0*uRelSq[0]*mOther+2.0*Tdiff[0]; 
  diffSelf[1] = (0.5*m0rOther[2]*relKinE[3]+0.5*relKinE[2]*m0rOther[3]+0.5*m0rOther[0]*relKinE[1]+0.5*relKinE[0]*m0rOther[1])*mnuOther-1.0*uRelSq[1]*mOther+2.0*Tdiff[1]; 
  diffSelf[2] = (0.5*m0rOther[1]*relKinE[3]+0.5*relKinE[1]*m0rOther[3]+0.5*m0rOther[0]*relKinE[2]+0.5*relKinE[0]*m0rOther[2])*mnuOther-1.0*uRelSq[2]*mOther+2.0*Tdiff[2]; 
  diffSelf[3] = (0.5*m0rOther[0]*relKinE[3]+0.5*relKinE[0]*m0rOther[3]+0.5*m0rOther[1]*relKinE[2]+0.5*relKinE[1]*m0rOther[2])*mnuOther-1.0*uRelSq[3]*mOther+2.0*Tdiff[3]; 
  ...
  double diffOther[4]; 
  diffOther[0] = (0.5*m0rSelf[3]*relKinE[3]+0.5*m0rSelf[2]*relKinE[2]+0.5*m0rSelf[1]*relKinE[1]+0.5*m0rSelf[0]*relKinE[0])*mnuSelf-1.0*uRelSq[0]*mSelf-2.0*Tdiff[0]; 
  diffOther[1] = (0.5*m0rSelf[2]*relKinE[3]+0.5*relKinE[2]*m0rSelf[3]+0.5*m0rSelf[0]*relKinE[1]+0.5*relKinE[0]*m0rSelf[1])*mnuSelf-1.0*uRelSq[1]*mSelf-2.0*Tdiff[1]; 
  diffOther[2] = (0.5*m0rSelf[1]*relKinE[3]+0.5*relKinE[1]*m0rSelf[3]+0.5*m0rSelf[0]*relKinE[2]+0.5*relKinE[0]*m0rSelf[2])*mnuSelf-1.0*uRelSq[2]*mSelf-2.0*Tdiff[2]; 
  diffOther[3] = (0.5*m0rSelf[0]*relKinE[3]+0.5*relKinE[0]*m0rSelf[3]+0.5*m0rSelf[1]*relKinE[2]+0.5*relKinE[1]*m0rSelf[2])*mnuSelf-1.0*uRelSq[3]*mSelf-2.0*Tdiff[3]; 
