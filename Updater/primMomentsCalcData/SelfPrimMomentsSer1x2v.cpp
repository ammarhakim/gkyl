...
void SelfPrimMoments1x2vSer_P1(const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
...
void SelfPrimMoments1x2vSer_P2(const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  // m0,m1,m2: moments of the distribution function. 
  // cM, cE: vtSq*cM and vtSq*cE are corrections to u and vtSq, respectively. 
  // u:        velocity. 
...
void SelfPrimMoments1x2vSer_P3(const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  // m0,m1,m2: moments of the distribution function. 
  // cM, cE: vtSq*cM and vtSq*cE are corrections to u and vtSq, respectively. 
  // u:        velocity. 
...
{ 
  ...
  out[1] += 2.645751311064591*fvmin[24]*dS+2.645751311064591*fvmax[24]*dS-2.23606797749979*fvmin[12]*dS+2.23606797749979*fvmax[12]*dS+1.732050807568877*fvmin[4]*dS+1.732050807568877*fvmax[4]*dS-1.0*fvmin[1]*dS+fvmax[1]*dS; 
  out[2] += 1.732050807568877*fvmin[11]*dS+1.732050807568877*fvmax[11]*dS-1.0*fvmin[7]*dS+fvmax[7]*dS; 
  out[3] += 1.732050807568877*fvmin[23]*dS+1.732050807568877*fvmax[23]*dS-1.0*fvmin[17]*dS+fvmax[17]*dS; 
...
{ 
  ...
  out[1] += (-2.645751311064591*fvmin[24]*dS*vmin)+2.23606797749979*fvmin[12]*dS*vmin-1.732050807568877*fvmin[4]*dS*vmin+fvmin[1]*dS*vmin+2.645751311064591*fvmax[24]*dS*vmax+2.23606797749979*fvmax[12]*dS*vmax+1.732050807568877*fvmax[4]*dS*vmax+fvmax[1]*dS*vmax; 
  out[2] += (-1.732050807568877*fvmin[11]*dS*vmin)+fvmin[7]*dS*vmin+1.732050807568877*fvmax[11]*dS*vmax+fvmax[7]*dS*vmax; 
  out[3] += (-1.732050807568877*fvmin[23]*dS*vmin)+fvmin[17]*dS*vmin+1.732050807568877*fvmax[23]*dS*vmax+fvmax[17]*dS*vmax; 
...
{ 
  ...
  out[3] += 1.732050807568877*fvmin[5]*dS+1.732050807568877*fvmax[5]*dS-1.0*fvmin[1]*dS+fvmax[1]*dS; 
...
{ 
  ...
  out[4] += (-2.23606797749979*fvmin[15]*dS)+2.23606797749979*fvmax[15]*dS+1.732050807568877*fvmin[5]*dS+1.732050807568877*fvmax[5]*dS-1.0*fvmin[1]*dS+fvmax[1]*dS; 
  out[5] += 1.732050807568877*fvmin[13]*dS+1.732050807568877*fvmax[13]*dS-1.0*fvmin[7]*dS+fvmax[7]*dS; 
...
{ 
  ...
  out[5] += 2.645751311064591*fvmin[27]*dS+2.645751311064591*fvmax[27]*dS-2.23606797749979*fvmin[15]*dS+2.23606797749979*fvmax[15]*dS+1.732050807568877*fvmin[5]*dS+1.732050807568877*fvmax[5]*dS-1.0*fvmin[1]*dS+fvmax[1]*dS; 
  out[6] += 1.732050807568877*fvmin[13]*dS+1.732050807568877*fvmax[13]*dS-1.0*fvmin[7]*dS+fvmax[7]*dS; 
  out[7] += 1.732050807568877*fvmin[25]*dS+1.732050807568877*fvmax[25]*dS-1.0*fvmin[17]*dS+fvmax[17]*dS; 
...
{ 
  ...
  out[1] += (-2.645751311064591*fvmin[27]*dS*vmin)+2.23606797749979*fvmin[15]*dS*vmin-1.732050807568877*fvmin[5]*dS*vmin+fvmin[1]*dS*vmin+2.645751311064591*fvmax[27]*dS*vmax+2.23606797749979*fvmax[15]*dS*vmax+1.732050807568877*fvmax[5]*dS*vmax+fvmax[1]*dS*vmax; 
  out[2] += (-1.732050807568877*fvmin[13]*dS*vmin)+fvmin[7]*dS*vmin+1.732050807568877*fvmax[13]*dS*vmax+fvmax[7]*dS*vmax; 
  out[3] += (-1.732050807568877*fvmin[25]*dS*vmin)+fvmin[17]*dS*vmin+1.732050807568877*fvmax[25]*dS*vmax+fvmax[17]*dS*vmax; 
