...
{ 
  ...
  BigAEM(10,11) = 0.5*m0[1]*pVdim-0.5*cE[1]; 
  BigAEM(11,8) = 0.5*m0[3]*pVdim-0.5*cE[3]; 
  BigAEM(11,9) = 0.5*m0[2]*pVdim-0.5*cE[2]; 
  BigAEM(11,10) = 0.5*m0[1]*pVdim-0.5*cE[1]; 
...
{ 
  ...
  // ....... Block from correction to vtSq .......... // 
  BigAEM(16,16) = 0.5*m0[0]*pVdim-0.5*cE[0]; 
  BigAEM(16,17) = 0.5*m0[1]*pVdim-0.5*cE[1]; 
  BigAEM(16,18) = 0.5*m0[2]*pVdim-0.5*cE[2]; 
  BigAEM(16,19) = 0.5*m0[3]*pVdim-0.5*cE[3]; 
  BigAEM(16,20) = 0.5*m0[4]*pVdim-0.5*cE[4]; 
  BigAEM(16,21) = 0.5*m0[5]*pVdim-0.5*cE[5]; 
  BigAEM(16,22) = 0.5*m0[6]*pVdim-0.5*cE[6]; 
  BigAEM(16,23) = 0.5*m0[7]*pVdim-0.5*cE[7]; 
  BigAEM(17,16) = 0.5*m0[1]*pVdim-0.5*cE[1]; 
  BigAEM(17,17) = 0.4472135954999579*m0[4]*pVdim+0.5*m0[0]*pVdim-0.4472135954999579*cE[4]-0.5*cE[0]; 
  BigAEM(17,18) = 0.5*m0[3]*pVdim-0.5*cE[3]; 
  BigAEM(17,19) = 0.447213595499958*m0[6]*pVdim+0.5*m0[2]*pVdim-0.447213595499958*cE[6]-0.5*cE[2]; 
  BigAEM(17,20) = 0.4472135954999579*m0[1]*pVdim-0.4472135954999579*cE[1]; 
  BigAEM(17,21) = 0.5000000000000001*m0[7]*pVdim-0.5000000000000001*cE[7]; 
  BigAEM(17,22) = 0.447213595499958*m0[3]*pVdim-0.447213595499958*cE[3]; 
  BigAEM(17,23) = 0.5000000000000001*m0[5]*pVdim-0.5000000000000001*cE[5]; 
  BigAEM(18,16) = 0.5*m0[2]*pVdim-0.5*cE[2]; 
  BigAEM(18,17) = 0.5*m0[3]*pVdim-0.5*cE[3]; 
  BigAEM(18,18) = 0.4472135954999579*m0[5]*pVdim+0.5*m0[0]*pVdim-0.4472135954999579*cE[5]-0.5*cE[0]; 
  BigAEM(18,19) = 0.447213595499958*m0[7]*pVdim+0.5*m0[1]*pVdim-0.447213595499958*cE[7]-0.5*cE[1]; 
  BigAEM(18,20) = 0.5000000000000001*m0[6]*pVdim-0.5000000000000001*cE[6]; 
  BigAEM(18,21) = 0.4472135954999579*m0[2]*pVdim-0.4472135954999579*cE[2]; 
  BigAEM(18,22) = 0.5000000000000001*m0[4]*pVdim-0.5000000000000001*cE[4]; 
  BigAEM(18,23) = 0.447213595499958*m0[3]*pVdim-0.447213595499958*cE[3]; 
  BigAEM(19,16) = 0.5*m0[3]*pVdim-0.5*cE[3]; 
  BigAEM(19,17) = 0.447213595499958*m0[6]*pVdim+0.5*m0[2]*pVdim-0.447213595499958*cE[6]-0.5*cE[2]; 
  BigAEM(19,18) = 0.447213595499958*m0[7]*pVdim+0.5*m0[1]*pVdim-0.447213595499958*cE[7]-0.5*cE[1]; 
  BigAEM(19,19) = 0.4472135954999579*m0[5]*pVdim+0.4472135954999579*m0[4]*pVdim+0.5*m0[0]*pVdim-0.4472135954999579*cE[5]-0.4472135954999579*cE[4]-0.5*cE[0]; 
  BigAEM(19,20) = 0.4472135954999579*m0[3]*pVdim-0.4472135954999579*cE[3]; 
  BigAEM(19,21) = 0.4472135954999579*m0[3]*pVdim-0.4472135954999579*cE[3]; 
  BigAEM(19,22) = 0.4*m0[7]*pVdim+0.447213595499958*m0[1]*pVdim-0.4*cE[7]-0.447213595499958*cE[1]; 
  BigAEM(19,23) = 0.4*m0[6]*pVdim+0.447213595499958*m0[2]*pVdim-0.4*cE[6]-0.447213595499958*cE[2]; 
  BigAEM(20,16) = 0.5*m0[4]*pVdim-0.5*cE[4]; 
  BigAEM(20,17) = 0.4472135954999579*m0[1]*pVdim-0.4472135954999579*cE[1]; 
  BigAEM(20,18) = 0.5000000000000001*m0[6]*pVdim-0.5000000000000001*cE[6]; 
  BigAEM(20,19) = 0.4472135954999579*m0[3]*pVdim-0.4472135954999579*cE[3]; 
  BigAEM(20,20) = 0.31943828249997*m0[4]*pVdim+0.5*m0[0]*pVdim-0.31943828249997*cE[4]-0.5*cE[0]; 
  BigAEM(20,22) = 0.31943828249997*m0[6]*pVdim+0.5000000000000001*m0[2]*pVdim-0.31943828249997*cE[6]-0.5000000000000001*cE[2]; 
  BigAEM(20,23) = 0.4472135954999579*m0[7]*pVdim-0.4472135954999579*cE[7]; 
  BigAEM(21,16) = 0.5*m0[5]*pVdim-0.5*cE[5]; 
  BigAEM(21,17) = 0.5000000000000001*m0[7]*pVdim-0.5000000000000001*cE[7]; 
  BigAEM(21,18) = 0.4472135954999579*m0[2]*pVdim-0.4472135954999579*cE[2]; 
  BigAEM(21,19) = 0.4472135954999579*m0[3]*pVdim-0.4472135954999579*cE[3]; 
  BigAEM(21,21) = 0.31943828249997*m0[5]*pVdim+0.5*m0[0]*pVdim-0.31943828249997*cE[5]-0.5*cE[0]; 
  BigAEM(21,22) = 0.4472135954999579*m0[6]*pVdim-0.4472135954999579*cE[6]; 
  BigAEM(21,23) = 0.31943828249997*m0[7]*pVdim+0.5000000000000001*m0[1]*pVdim-0.31943828249997*cE[7]-0.5000000000000001*cE[1]; 
  BigAEM(22,16) = 0.5*m0[6]*pVdim-0.5*cE[6]; 
  BigAEM(22,17) = 0.447213595499958*m0[3]*pVdim-0.447213595499958*cE[3]; 
  BigAEM(22,18) = 0.5000000000000001*m0[4]*pVdim-0.5000000000000001*cE[4]; 
  BigAEM(22,19) = 0.4*m0[7]*pVdim+0.447213595499958*m0[1]*pVdim-0.4*cE[7]-0.447213595499958*cE[1]; 
  BigAEM(22,20) = 0.31943828249997*m0[6]*pVdim+0.5000000000000001*m0[2]*pVdim-0.31943828249997*cE[6]-0.5000000000000001*cE[2]; 
  BigAEM(22,21) = 0.4472135954999579*m0[6]*pVdim-0.4472135954999579*cE[6]; 
  BigAEM(22,22) = 0.4472135954999579*m0[5]*pVdim+0.31943828249997*m0[4]*pVdim+0.5*m0[0]*pVdim-0.4472135954999579*cE[5]-0.31943828249997*cE[4]-0.5*cE[0]; 
  BigAEM(22,23) = 0.4*m0[3]*pVdim-0.4*cE[3]; 
  BigAEM(23,16) = 0.5*m0[7]*pVdim-0.5*cE[7]; 
  BigAEM(23,17) = 0.5000000000000001*m0[5]*pVdim-0.5000000000000001*cE[5]; 
  BigAEM(23,18) = 0.447213595499958*m0[3]*pVdim-0.447213595499958*cE[3]; 
  BigAEM(23,19) = 0.4*m0[6]*pVdim+0.447213595499958*m0[2]*pVdim-0.4*cE[6]-0.447213595499958*cE[2]; 
  BigAEM(23,20) = 0.4472135954999579*m0[7]*pVdim-0.4472135954999579*cE[7]; 
  BigAEM(23,21) = 0.31943828249997*m0[7]*pVdim+0.5000000000000001*m0[1]*pVdim-0.31943828249997*cE[7]-0.5000000000000001*cE[1]; 
  BigAEM(23,22) = 0.4*m0[3]*pVdim-0.4*cE[3]; 
  BigAEM(23,23) = 0.31943828249997*m0[5]*pVdim+0.4472135954999579*m0[4]*pVdim+0.5*m0[0]*pVdim-0.31943828249997*cE[5]-0.4472135954999579*cE[4]-0.5*cE[0]; 
...
{ 
  ...
  BigAEM(24,32) = 0.5*m0[8]*pVdim-0.5*cE[8]; 
  BigAEM(24,33) = 0.5*m0[9]*pVdim-0.5*cE[9]; 
  BigAEM(24,34) = 0.5*m0[10]*pVdim-0.5*cE[10]; 
  BigAEM(24,35) = 0.5*m0[11]*pVdim-0.5*cE[11]; 
  ...
  BigAEM(25,28) = 0.4391550328268398*m0[8]*pVdim+0.4472135954999579*m0[1]*pVdim-0.4391550328268398*cE[8]-0.4472135954999579*cE[1]; 
  BigAEM(25,29) = 0.5000000000000001*m0[7]*pVdim-0.5000000000000001*cE[7]; 
  BigAEM(25,30) = 0.4391550328268399*m0[10]*pVdim+0.447213595499958*m0[3]*pVdim-0.4391550328268399*cE[10]-0.447213595499958*cE[3]; 
  BigAEM(25,31) = 0.5000000000000001*m0[5]*pVdim-0.5000000000000001*cE[5]; 
  BigAEM(25,32) = 0.4391550328268398*m0[4]*pVdim-0.4391550328268398*cE[4]; 
  BigAEM(25,33) = 0.5*m0[11]*pVdim-0.5*cE[11]; 
  BigAEM(25,34) = 0.4391550328268399*m0[6]*pVdim-0.4391550328268399*cE[6]; 
  BigAEM(25,35) = 0.5*m0[9]*pVdim-0.5*cE[9]; 
  ...
  BigAEM(26,29) = 0.4391550328268398*m0[9]*pVdim+0.4472135954999579*m0[2]*pVdim-0.4391550328268398*cE[9]-0.4472135954999579*cE[2]; 
  BigAEM(26,30) = 0.5000000000000001*m0[4]*pVdim-0.5000000000000001*cE[4]; 
  BigAEM(26,31) = 0.4391550328268399*m0[11]*pVdim+0.447213595499958*m0[3]*pVdim-0.4391550328268399*cE[11]-0.447213595499958*cE[3]; 
  BigAEM(26,32) = 0.5*m0[10]*pVdim-0.5*cE[10]; 
  BigAEM(26,33) = 0.4391550328268398*m0[5]*pVdim-0.4391550328268398*cE[5]; 
  BigAEM(26,34) = 0.5*m0[8]*pVdim-0.5*cE[8]; 
  BigAEM(26,35) = 0.4391550328268399*m0[7]*pVdim-0.4391550328268399*cE[7]; 
  ...
  BigAEM(27,28) = 0.4391550328268399*m0[10]*pVdim+0.4472135954999579*m0[3]*pVdim-0.4391550328268399*cE[10]-0.4472135954999579*cE[3]; 
  BigAEM(27,29) = 0.4391550328268399*m0[11]*pVdim+0.4472135954999579*m0[3]*pVdim-0.4391550328268399*cE[11]-0.4472135954999579*cE[3]; 
  BigAEM(27,30) = 0.4391550328268399*m0[8]*pVdim+0.4*m0[7]*pVdim+0.447213595499958*m0[1]*pVdim-0.4391550328268399*cE[8]-0.4*cE[7]-0.447213595499958*cE[1]; 
  BigAEM(27,31) = 0.4391550328268399*m0[9]*pVdim+0.4*m0[6]*pVdim+0.447213595499958*m0[2]*pVdim-0.4391550328268399*cE[9]-0.4*cE[6]-0.447213595499958*cE[2]; 
  BigAEM(27,32) = 0.4391550328268399*m0[6]*pVdim-0.4391550328268399*cE[6]; 
  BigAEM(27,33) = 0.4391550328268399*m0[7]*pVdim-0.4391550328268399*cE[7]; 
  BigAEM(27,34) = 0.4391550328268399*m0[4]*pVdim-0.4391550328268399*cE[4]; 
  BigAEM(27,35) = 0.4391550328268399*m0[5]*pVdim-0.4391550328268399*cE[5]; 
  BigAEM(28,24) = 0.5*m0[4]*pVdim-0.5*cE[4]; 
  BigAEM(28,25) = 0.4391550328268398*m0[8]*pVdim+0.4472135954999579*m0[1]*pVdim-0.4391550328268398*cE[8]-0.4472135954999579*cE[1]; 
  BigAEM(28,26) = 0.5000000000000001*m0[6]*pVdim-0.5000000000000001*cE[6]; 
  BigAEM(28,27) = 0.4391550328268399*m0[10]*pVdim+0.4472135954999579*m0[3]*pVdim-0.4391550328268399*cE[10]-0.4472135954999579*cE[3]; 
  ...
  BigAEM(28,32) = 0.2981423969999719*m0[8]*pVdim+0.4391550328268398*m0[1]*pVdim-0.2981423969999719*cE[8]-0.4391550328268398*cE[1]; 
  BigAEM(28,34) = 0.2981423969999719*m0[10]*pVdim+0.4391550328268399*m0[3]*pVdim-0.2981423969999719*cE[10]-0.4391550328268399*cE[3]; 
  BigAEM(28,35) = 0.4472135954999579*m0[11]*pVdim-0.4472135954999579*cE[11]; 
  BigAEM(29,24) = 0.5*m0[5]*pVdim-0.5*cE[5]; 
  BigAEM(29,25) = 0.5000000000000001*m0[7]*pVdim-0.5000000000000001*cE[7]; 
  BigAEM(29,26) = 0.4391550328268398*m0[9]*pVdim+0.4472135954999579*m0[2]*pVdim-0.4391550328268398*cE[9]-0.4472135954999579*cE[2]; 
  BigAEM(29,27) = 0.4391550328268399*m0[11]*pVdim+0.4472135954999579*m0[3]*pVdim-0.4391550328268399*cE[11]-0.4472135954999579*cE[3]; 
  ...
  BigAEM(29,33) = 0.2981423969999719*m0[9]*pVdim+0.4391550328268398*m0[2]*pVdim-0.2981423969999719*cE[9]-0.4391550328268398*cE[2]; 
  BigAEM(29,34) = 0.4472135954999579*m0[10]*pVdim-0.4472135954999579*cE[10]; 
  BigAEM(29,35) = 0.2981423969999719*m0[11]*pVdim+0.4391550328268399*m0[3]*pVdim-0.2981423969999719*cE[11]-0.4391550328268399*cE[3]; 
  BigAEM(30,24) = 0.5*m0[6]*pVdim-0.5*cE[6]; 
  BigAEM(30,25) = 0.4391550328268399*m0[10]*pVdim+0.447213595499958*m0[3]*pVdim-0.4391550328268399*cE[10]-0.447213595499958*cE[3]; 
  BigAEM(30,26) = 0.5000000000000001*m0[4]*pVdim-0.5000000000000001*cE[4]; 
  BigAEM(30,27) = 0.4391550328268399*m0[8]*pVdim+0.4*m0[7]*pVdim+0.447213595499958*m0[1]*pVdim-0.4391550328268399*cE[8]-0.4*cE[7]-0.447213595499958*cE[1]; 
  ...
  BigAEM(30,31) = 0.3927922024247863*m0[11]*pVdim+0.3927922024247863*m0[10]*pVdim+0.4*m0[3]*pVdim-0.3927922024247863*cE[11]-0.3927922024247863*cE[10]-0.4*cE[3]; 
  BigAEM(30,32) = 0.2981423969999719*m0[10]*pVdim+0.4391550328268399*m0[3]*pVdim-0.2981423969999719*cE[10]-0.4391550328268399*cE[3]; 
  BigAEM(30,34) = 0.2981423969999719*m0[8]*pVdim+0.3927922024247863*m0[7]*pVdim+0.4391550328268399*m0[1]*pVdim-0.2981423969999719*cE[8]-0.3927922024247863*cE[7]-0.4391550328268399*cE[1]; 
  BigAEM(30,35) = 0.3927922024247863*m0[7]*pVdim-0.3927922024247863*cE[7]; 
  BigAEM(31,24) = 0.5*m0[7]*pVdim-0.5*cE[7]; 
  BigAEM(31,25) = 0.5000000000000001*m0[5]*pVdim-0.5000000000000001*cE[5]; 
  BigAEM(31,26) = 0.4391550328268399*m0[11]*pVdim+0.447213595499958*m0[3]*pVdim-0.4391550328268399*cE[11]-0.447213595499958*cE[3]; 
  BigAEM(31,27) = 0.4391550328268399*m0[9]*pVdim+0.4*m0[6]*pVdim+0.447213595499958*m0[2]*pVdim-0.4391550328268399*cE[9]-0.4*cE[6]-0.447213595499958*cE[2]; 
  ...
  BigAEM(31,30) = 0.3927922024247863*m0[11]*pVdim+0.3927922024247863*m0[10]*pVdim+0.4*m0[3]*pVdim-0.3927922024247863*cE[11]-0.3927922024247863*cE[10]-0.4*cE[3]; 
  ...
  BigAEM(31,33) = 0.2981423969999719*m0[11]*pVdim+0.4391550328268399*m0[3]*pVdim-0.2981423969999719*cE[11]-0.4391550328268399*cE[3]; 
  BigAEM(31,34) = 0.3927922024247863*m0[6]*pVdim-0.3927922024247863*cE[6]; 
  BigAEM(31,35) = 0.2981423969999719*m0[9]*pVdim+0.3927922024247863*m0[6]*pVdim+0.4391550328268399*m0[2]*pVdim-0.2981423969999719*cE[9]-0.3927922024247863*cE[6]-0.4391550328268399*cE[2]; 
  BigAEM(32,24) = 0.5*m0[8]*pVdim-0.5*cE[8]; 
  BigAEM(32,25) = 0.4391550328268398*m0[4]*pVdim-0.4391550328268398*cE[4]; 
  BigAEM(32,26) = 0.5*m0[10]*pVdim-0.5*cE[10]; 
  BigAEM(32,27) = 0.4391550328268399*m0[6]*pVdim-0.4391550328268399*cE[6]; 
  BigAEM(32,28) = 0.2981423969999719*m0[8]*pVdim+0.4391550328268398*m0[1]*pVdim-0.2981423969999719*cE[8]-0.4391550328268398*cE[1]; 
  BigAEM(32,30) = 0.2981423969999719*m0[10]*pVdim+0.4391550328268399*m0[3]*pVdim-0.2981423969999719*cE[10]-0.4391550328268399*cE[3]; 
  BigAEM(32,32) = 0.2981423969999719*m0[4]*pVdim+0.5*m0[0]*pVdim-0.2981423969999719*cE[4]-0.5*cE[0]; 
  BigAEM(32,34) = 0.2981423969999719*m0[6]*pVdim+0.5*m0[2]*pVdim-0.2981423969999719*cE[6]-0.5*cE[2]; 
  BigAEM(33,24) = 0.5*m0[9]*pVdim-0.5*cE[9]; 
  BigAEM(33,25) = 0.5*m0[11]*pVdim-0.5*cE[11]; 
  BigAEM(33,26) = 0.4391550328268398*m0[5]*pVdim-0.4391550328268398*cE[5]; 
  BigAEM(33,27) = 0.4391550328268399*m0[7]*pVdim-0.4391550328268399*cE[7]; 
  BigAEM(33,29) = 0.2981423969999719*m0[9]*pVdim+0.4391550328268398*m0[2]*pVdim-0.2981423969999719*cE[9]-0.4391550328268398*cE[2]; 
  BigAEM(33,31) = 0.2981423969999719*m0[11]*pVdim+0.4391550328268399*m0[3]*pVdim-0.2981423969999719*cE[11]-0.4391550328268399*cE[3]; 
  BigAEM(33,33) = 0.2981423969999719*m0[5]*pVdim+0.5*m0[0]*pVdim-0.2981423969999719*cE[5]-0.5*cE[0]; 
  BigAEM(33,35) = 0.2981423969999719*m0[7]*pVdim+0.5*m0[1]*pVdim-0.2981423969999719*cE[7]-0.5*cE[1]; 
  BigAEM(34,24) = 0.5*m0[10]*pVdim-0.5*cE[10]; 
  BigAEM(34,25) = 0.4391550328268399*m0[6]*pVdim-0.4391550328268399*cE[6]; 
  BigAEM(34,26) = 0.5*m0[8]*pVdim-0.5*cE[8]; 
  BigAEM(34,27) = 0.4391550328268399*m0[4]*pVdim-0.4391550328268399*cE[4]; 
  BigAEM(34,28) = 0.2981423969999719*m0[10]*pVdim+0.4391550328268399*m0[3]*pVdim-0.2981423969999719*cE[10]-0.4391550328268399*cE[3]; 
  BigAEM(34,29) = 0.4472135954999579*m0[10]*pVdim-0.4472135954999579*cE[10]; 
  BigAEM(34,30) = 0.2981423969999719*m0[8]*pVdim+0.3927922024247863*m0[7]*pVdim+0.4391550328268399*m0[1]*pVdim-0.2981423969999719*cE[8]-0.3927922024247863*cE[7]-0.4391550328268399*cE[1]; 
  BigAEM(34,31) = 0.3927922024247863*m0[6]*pVdim-0.3927922024247863*cE[6]; 
  BigAEM(34,32) = 0.2981423969999719*m0[6]*pVdim+0.5*m0[2]*pVdim-0.2981423969999719*cE[6]-0.5*cE[2]; 
  BigAEM(34,34) = 0.4472135954999579*m0[5]*pVdim+0.2981423969999719*m0[4]*pVdim+0.5*m0[0]*pVdim-0.4472135954999579*cE[5]-0.2981423969999719*cE[4]-0.5*cE[0]; 
  BigAEM(35,24) = 0.5*m0[11]*pVdim-0.5*cE[11]; 
  BigAEM(35,25) = 0.5*m0[9]*pVdim-0.5*cE[9]; 
  BigAEM(35,26) = 0.4391550328268399*m0[7]*pVdim-0.4391550328268399*cE[7]; 
  BigAEM(35,27) = 0.4391550328268399*m0[5]*pVdim-0.4391550328268399*cE[5]; 
  BigAEM(35,28) = 0.4472135954999579*m0[11]*pVdim-0.4472135954999579*cE[11]; 
  BigAEM(35,29) = 0.2981423969999719*m0[11]*pVdim+0.4391550328268399*m0[3]*pVdim-0.2981423969999719*cE[11]-0.4391550328268399*cE[3]; 
  BigAEM(35,30) = 0.3927922024247863*m0[7]*pVdim-0.3927922024247863*cE[7]; 
  BigAEM(35,31) = 0.2981423969999719*m0[9]*pVdim+0.3927922024247863*m0[6]*pVdim+0.4391550328268399*m0[2]*pVdim-0.2981423969999719*cE[9]-0.3927922024247863*cE[6]-0.4391550328268399*cE[2]; 
  BigAEM(35,33) = 0.2981423969999719*m0[7]*pVdim+0.5*m0[1]*pVdim-0.2981423969999719*cE[7]-0.5*cE[1]; 
  BigAEM(35,35) = 0.2981423969999719*m0[5]*pVdim+0.4472135954999579*m0[4]*pVdim+0.5*m0[0]*pVdim-0.2981423969999719*cE[5]-0.4472135954999579*cE[4]-0.5*cE[0]; 
