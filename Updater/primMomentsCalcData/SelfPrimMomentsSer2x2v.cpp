...
{ 
  ...
  BigAEM(9,1) = 0.5*m1s[0]; 
  BigAEM(9,2) = 0.5*m1s[3]; 
  BigAEM(9,3) = 0.5*m1s[2]; 
  BigAEM(10,0) = 0.5*m1s[2]; 
  BigAEM(10,1) = 0.5*m1s[3]; 
  BigAEM(10,2) = 0.5*m1s[0]; 
  BigAEM(10,3) = 0.5*m1s[1]; 
  BigAEM(11,0) = 0.5*m1s[3]; 
  BigAEM(11,1) = 0.5*m1s[2]; 
  BigAEM(11,2) = 0.5*m1s[1]; 
  BigAEM(11,3) = 0.5*m1s[0]; 
  ...
  BigAEM(9,4) = 0.5*m1s[5]; 
  BigAEM(9,5) = 0.5*m1s[4]; 
  BigAEM(9,6) = 0.5*m1s[7]; 
  BigAEM(9,7) = 0.5*m1s[6]; 
  BigAEM(10,4) = 0.5*m1s[6]; 
  BigAEM(10,5) = 0.5*m1s[7]; 
  BigAEM(10,6) = 0.5*m1s[4]; 
  BigAEM(10,7) = 0.5*m1s[5]; 
  BigAEM(11,4) = 0.5*m1s[7]; 
  BigAEM(11,5) = 0.5*m1s[6]; 
  BigAEM(11,6) = 0.5*m1s[5]; 
  BigAEM(11,7) = 0.5*m1s[4]; 
...
{ 
  ...
  // ....... Block from weak multiply of uX and m1X  .......... // 
  BigAEM(16,0) = 0.5*m1s[0]; 
  BigAEM(16,1) = 0.5*m1s[1]; 
  BigAEM(16,2) = 0.5*m1s[2]; 
  BigAEM(16,3) = 0.5*m1s[3]; 
  BigAEM(16,4) = 0.5*m1s[4]; 
  BigAEM(16,5) = 0.5*m1s[5]; 
  BigAEM(16,6) = 0.5*m1s[6]; 
  BigAEM(16,7) = 0.5*m1s[7]; 
  BigAEM(17,0) = 0.5*m1s[1]; 
  BigAEM(17,1) = 0.4472135954999579*m1s[4]+0.5*m1s[0]; 
  BigAEM(17,2) = 0.5*m1s[3]; 
  BigAEM(17,3) = 0.447213595499958*m1s[6]+0.5*m1s[2]; 
  BigAEM(17,4) = 0.4472135954999579*m1s[1]; 
  BigAEM(17,5) = 0.5000000000000001*m1s[7]; 
  BigAEM(17,6) = 0.447213595499958*m1s[3]; 
  BigAEM(17,7) = 0.5000000000000001*m1s[5]; 
  BigAEM(18,0) = 0.5*m1s[2]; 
  BigAEM(18,1) = 0.5*m1s[3]; 
  BigAEM(18,2) = 0.4472135954999579*m1s[5]+0.5*m1s[0]; 
  BigAEM(18,3) = 0.447213595499958*m1s[7]+0.5*m1s[1]; 
  BigAEM(18,4) = 0.5000000000000001*m1s[6]; 
  BigAEM(18,5) = 0.4472135954999579*m1s[2]; 
  BigAEM(18,6) = 0.5000000000000001*m1s[4]; 
  BigAEM(18,7) = 0.447213595499958*m1s[3]; 
  BigAEM(19,0) = 0.5*m1s[3]; 
  BigAEM(19,1) = 0.447213595499958*m1s[6]+0.5*m1s[2]; 
  BigAEM(19,2) = 0.447213595499958*m1s[7]+0.5*m1s[1]; 
  BigAEM(19,3) = 0.4472135954999579*m1s[5]+0.4472135954999579*m1s[4]+0.5*m1s[0]; 
  BigAEM(19,4) = 0.4472135954999579*m1s[3]; 
  BigAEM(19,5) = 0.4472135954999579*m1s[3]; 
  BigAEM(19,6) = 0.4*m1s[7]+0.447213595499958*m1s[1]; 
  BigAEM(19,7) = 0.4*m1s[6]+0.447213595499958*m1s[2]; 
  BigAEM(20,0) = 0.5*m1s[4]; 
  BigAEM(20,1) = 0.4472135954999579*m1s[1]; 
  BigAEM(20,2) = 0.5000000000000001*m1s[6]; 
  BigAEM(20,3) = 0.4472135954999579*m1s[3]; 
  BigAEM(20,4) = 0.31943828249997*m1s[4]+0.5*m1s[0]; 
  BigAEM(20,6) = 0.31943828249997*m1s[6]+0.5000000000000001*m1s[2]; 
  BigAEM(20,7) = 0.4472135954999579*m1s[7]; 
  BigAEM(21,0) = 0.5*m1s[5]; 
  BigAEM(21,1) = 0.5000000000000001*m1s[7]; 
  BigAEM(21,2) = 0.4472135954999579*m1s[2]; 
  BigAEM(21,3) = 0.4472135954999579*m1s[3]; 
  BigAEM(21,5) = 0.31943828249997*m1s[5]+0.5*m1s[0]; 
  BigAEM(21,6) = 0.4472135954999579*m1s[6]; 
  BigAEM(21,7) = 0.31943828249997*m1s[7]+0.5000000000000001*m1s[1]; 
  BigAEM(22,0) = 0.5*m1s[6]; 
  BigAEM(22,1) = 0.447213595499958*m1s[3]; 
  BigAEM(22,2) = 0.5000000000000001*m1s[4]; 
  BigAEM(22,3) = 0.4*m1s[7]+0.447213595499958*m1s[1]; 
  BigAEM(22,4) = 0.31943828249997*m1s[6]+0.5000000000000001*m1s[2]; 
  BigAEM(22,5) = 0.4472135954999579*m1s[6]; 
  BigAEM(22,6) = 0.4472135954999579*m1s[5]+0.31943828249997*m1s[4]+0.5*m1s[0]; 
  BigAEM(22,7) = 0.4*m1s[3]; 
  BigAEM(23,0) = 0.5*m1s[7]; 
  BigAEM(23,1) = 0.5000000000000001*m1s[5]; 
  BigAEM(23,2) = 0.447213595499958*m1s[3]; 
  BigAEM(23,3) = 0.4*m1s[6]+0.447213595499958*m1s[2]; 
  BigAEM(23,4) = 0.4472135954999579*m1s[7]; 
  BigAEM(23,5) = 0.31943828249997*m1s[7]+0.5000000000000001*m1s[1]; 
  BigAEM(23,6) = 0.4*m1s[3]; 
  BigAEM(23,7) = 0.31943828249997*m1s[5]+0.4472135954999579*m1s[4]+0.5*m1s[0]; 
  ...
  // ....... Block from weak multiply of uY and m1Y  .......... // 
  BigAEM(16,8) = 0.5*m1s[8]; 
  BigAEM(16,9) = 0.5*m1s[9]; 
  BigAEM(16,10) = 0.5*m1s[10]; 
  BigAEM(16,11) = 0.5*m1s[11]; 
  BigAEM(16,12) = 0.5*m1s[12]; 
  BigAEM(16,13) = 0.5*m1s[13]; 
  BigAEM(16,14) = 0.5*m1s[14]; 
  BigAEM(16,15) = 0.5*m1s[15]; 
  BigAEM(17,8) = 0.5*m1s[9]; 
  BigAEM(17,9) = 0.4472135954999579*m1s[12]+0.5*m1s[8]; 
  BigAEM(17,10) = 0.5*m1s[11]; 
  BigAEM(17,11) = 0.447213595499958*m1s[14]+0.5*m1s[10]; 
  BigAEM(17,12) = 0.4472135954999579*m1s[9]; 
  BigAEM(17,13) = 0.5000000000000001*m1s[15]; 
  BigAEM(17,14) = 0.447213595499958*m1s[11]; 
  BigAEM(17,15) = 0.5000000000000001*m1s[13]; 
  BigAEM(18,8) = 0.5*m1s[10]; 
  BigAEM(18,9) = 0.5*m1s[11]; 
  BigAEM(18,10) = 0.4472135954999579*m1s[13]+0.5*m1s[8]; 
  BigAEM(18,11) = 0.447213595499958*m1s[15]+0.5*m1s[9]; 
  BigAEM(18,12) = 0.5000000000000001*m1s[14]; 
  BigAEM(18,13) = 0.4472135954999579*m1s[10]; 
  BigAEM(18,14) = 0.5000000000000001*m1s[12]; 
  BigAEM(18,15) = 0.447213595499958*m1s[11]; 
  BigAEM(19,8) = 0.5*m1s[11]; 
  BigAEM(19,9) = 0.447213595499958*m1s[14]+0.5*m1s[10]; 
  BigAEM(19,10) = 0.447213595499958*m1s[15]+0.5*m1s[9]; 
  BigAEM(19,11) = 0.4472135954999579*m1s[13]+0.4472135954999579*m1s[12]+0.5*m1s[8]; 
  BigAEM(19,12) = 0.4472135954999579*m1s[11]; 
  BigAEM(19,13) = 0.4472135954999579*m1s[11]; 
  BigAEM(19,14) = 0.4*m1s[15]+0.447213595499958*m1s[9]; 
  BigAEM(19,15) = 0.4*m1s[14]+0.447213595499958*m1s[10]; 
  BigAEM(20,8) = 0.5*m1s[12]; 
  BigAEM(20,9) = 0.4472135954999579*m1s[9]; 
  BigAEM(20,10) = 0.5000000000000001*m1s[14]; 
  BigAEM(20,11) = 0.4472135954999579*m1s[11]; 
  BigAEM(20,12) = 0.31943828249997*m1s[12]+0.5*m1s[8]; 
  BigAEM(20,14) = 0.31943828249997*m1s[14]+0.5000000000000001*m1s[10]; 
  BigAEM(20,15) = 0.4472135954999579*m1s[15]; 
  BigAEM(21,8) = 0.5*m1s[13]; 
  BigAEM(21,9) = 0.5000000000000001*m1s[15]; 
  BigAEM(21,10) = 0.4472135954999579*m1s[10]; 
  BigAEM(21,11) = 0.4472135954999579*m1s[11]; 
  BigAEM(21,13) = 0.31943828249997*m1s[13]+0.5*m1s[8]; 
  BigAEM(21,14) = 0.4472135954999579*m1s[14]; 
  BigAEM(21,15) = 0.31943828249997*m1s[15]+0.5000000000000001*m1s[9]; 
  BigAEM(22,8) = 0.5*m1s[14]; 
  BigAEM(22,9) = 0.447213595499958*m1s[11]; 
  BigAEM(22,10) = 0.5000000000000001*m1s[12]; 
  BigAEM(22,11) = 0.4*m1s[15]+0.447213595499958*m1s[9]; 
  BigAEM(22,12) = 0.31943828249997*m1s[14]+0.5000000000000001*m1s[10]; 
  BigAEM(22,13) = 0.4472135954999579*m1s[14]; 
  BigAEM(22,14) = 0.4472135954999579*m1s[13]+0.31943828249997*m1s[12]+0.5*m1s[8]; 
  BigAEM(22,15) = 0.4*m1s[11]; 
  BigAEM(23,8) = 0.5*m1s[15]; 
  BigAEM(23,9) = 0.5000000000000001*m1s[13]; 
  BigAEM(23,10) = 0.447213595499958*m1s[11]; 
  BigAEM(23,11) = 0.4*m1s[14]+0.447213595499958*m1s[10]; 
  BigAEM(23,12) = 0.4472135954999579*m1s[15]; 
  BigAEM(23,13) = 0.31943828249997*m1s[15]+0.5000000000000001*m1s[9]; 
  BigAEM(23,14) = 0.4*m1s[11]; 
  BigAEM(23,15) = 0.31943828249997*m1s[13]+0.4472135954999579*m1s[12]+0.5*m1s[8]; 
  ...
  // ....... RHS vector is composed of m1 and m2 .......... // 
  bEV << m1s[0],m1s[1],m1s[2],m1s[3],m1s[4],m1s[5],m1s[6],m1s[7],m1s[8],m1s[9],m1s[10],m1s[11],m1s[12],m1s[13],m1s[14],m1s[15],m2s[0],m2s[1],m2s[2],m2s[3],m2s[4],m2s[5],m2s[6],m2s[7]; 
...
{ 
  ...
  // ....... Block from weak multiply of uX and m1X  .......... // 
  BigAEM(24,0) = 0.5*m1s[0]; 
  BigAEM(24,1) = 0.5*m1s[1]; 
  BigAEM(24,2) = 0.5*m1s[2]; 
  BigAEM(24,3) = 0.5*m1s[3]; 
  BigAEM(24,4) = 0.5*m1s[4]; 
  BigAEM(24,5) = 0.5*m1s[5]; 
  BigAEM(24,6) = 0.5*m1s[6]; 
  BigAEM(24,7) = 0.5*m1s[7]; 
  BigAEM(24,8) = 0.5*m1s[8]; 
  BigAEM(24,9) = 0.5*m1s[9]; 
  BigAEM(24,10) = 0.5*m1s[10]; 
  BigAEM(24,11) = 0.5*m1s[11]; 
  BigAEM(25,0) = 0.5*m1s[1]; 
  BigAEM(25,1) = 0.4472135954999579*m1s[4]+0.5*m1s[0]; 
  BigAEM(25,2) = 0.5*m1s[3]; 
  BigAEM(25,3) = 0.447213595499958*m1s[6]+0.5*m1s[2]; 
  BigAEM(25,4) = 0.4391550328268398*m1s[8]+0.4472135954999579*m1s[1]; 
  BigAEM(25,5) = 0.5000000000000001*m1s[7]; 
  BigAEM(25,6) = 0.4391550328268399*m1s[10]+0.447213595499958*m1s[3]; 
  BigAEM(25,7) = 0.5000000000000001*m1s[5]; 
  BigAEM(25,8) = 0.4391550328268398*m1s[4]; 
  BigAEM(25,9) = 0.5*m1s[11]; 
  BigAEM(25,10) = 0.4391550328268399*m1s[6]; 
  BigAEM(25,11) = 0.5*m1s[9]; 
  BigAEM(26,0) = 0.5*m1s[2]; 
  BigAEM(26,1) = 0.5*m1s[3]; 
  BigAEM(26,2) = 0.4472135954999579*m1s[5]+0.5*m1s[0]; 
  BigAEM(26,3) = 0.447213595499958*m1s[7]+0.5*m1s[1]; 
  BigAEM(26,4) = 0.5000000000000001*m1s[6]; 
  BigAEM(26,5) = 0.4391550328268398*m1s[9]+0.4472135954999579*m1s[2]; 
  BigAEM(26,6) = 0.5000000000000001*m1s[4]; 
  BigAEM(26,7) = 0.4391550328268399*m1s[11]+0.447213595499958*m1s[3]; 
  BigAEM(26,8) = 0.5*m1s[10]; 
  BigAEM(26,9) = 0.4391550328268398*m1s[5]; 
  BigAEM(26,10) = 0.5*m1s[8]; 
  BigAEM(26,11) = 0.4391550328268399*m1s[7]; 
  BigAEM(27,0) = 0.5*m1s[3]; 
  BigAEM(27,1) = 0.447213595499958*m1s[6]+0.5*m1s[2]; 
  BigAEM(27,2) = 0.447213595499958*m1s[7]+0.5*m1s[1]; 
  BigAEM(27,3) = 0.4472135954999579*m1s[5]+0.4472135954999579*m1s[4]+0.5*m1s[0]; 
  BigAEM(27,4) = 0.4391550328268399*m1s[10]+0.4472135954999579*m1s[3]; 
  BigAEM(27,5) = 0.4391550328268399*m1s[11]+0.4472135954999579*m1s[3]; 
  BigAEM(27,6) = 0.4391550328268399*m1s[8]+0.4*m1s[7]+0.447213595499958*m1s[1]; 
  BigAEM(27,7) = 0.4391550328268399*m1s[9]+0.4*m1s[6]+0.447213595499958*m1s[2]; 
  BigAEM(27,8) = 0.4391550328268399*m1s[6]; 
  BigAEM(27,9) = 0.4391550328268399*m1s[7]; 
  BigAEM(27,10) = 0.4391550328268399*m1s[4]; 
  BigAEM(27,11) = 0.4391550328268399*m1s[5]; 
  BigAEM(28,0) = 0.5*m1s[4]; 
  BigAEM(28,1) = 0.4391550328268398*m1s[8]+0.4472135954999579*m1s[1]; 
  BigAEM(28,2) = 0.5000000000000001*m1s[6]; 
  BigAEM(28,3) = 0.4391550328268399*m1s[10]+0.4472135954999579*m1s[3]; 
  BigAEM(28,4) = 0.31943828249997*m1s[4]+0.5*m1s[0]; 
  BigAEM(28,6) = 0.31943828249997*m1s[6]+0.5000000000000001*m1s[2]; 
  BigAEM(28,7) = 0.4472135954999579*m1s[7]; 
  BigAEM(28,8) = 0.2981423969999719*m1s[8]+0.4391550328268398*m1s[1]; 
  BigAEM(28,10) = 0.2981423969999719*m1s[10]+0.4391550328268399*m1s[3]; 
  BigAEM(28,11) = 0.4472135954999579*m1s[11]; 
  BigAEM(29,0) = 0.5*m1s[5]; 
  BigAEM(29,1) = 0.5000000000000001*m1s[7]; 
  BigAEM(29,2) = 0.4391550328268398*m1s[9]+0.4472135954999579*m1s[2]; 
  BigAEM(29,3) = 0.4391550328268399*m1s[11]+0.4472135954999579*m1s[3]; 
  BigAEM(29,5) = 0.31943828249997*m1s[5]+0.5*m1s[0]; 
  BigAEM(29,6) = 0.4472135954999579*m1s[6]; 
  BigAEM(29,7) = 0.31943828249997*m1s[7]+0.5000000000000001*m1s[1]; 
  BigAEM(29,9) = 0.2981423969999719*m1s[9]+0.4391550328268398*m1s[2]; 
  BigAEM(29,10) = 0.4472135954999579*m1s[10]; 
  BigAEM(29,11) = 0.2981423969999719*m1s[11]+0.4391550328268399*m1s[3]; 
  BigAEM(30,0) = 0.5*m1s[6]; 
  BigAEM(30,1) = 0.4391550328268399*m1s[10]+0.447213595499958*m1s[3]; 
  BigAEM(30,2) = 0.5000000000000001*m1s[4]; 
  BigAEM(30,3) = 0.4391550328268399*m1s[8]+0.4*m1s[7]+0.447213595499958*m1s[1]; 
  BigAEM(30,4) = 0.31943828249997*m1s[6]+0.5000000000000001*m1s[2]; 
  BigAEM(30,5) = 0.4472135954999579*m1s[6]; 
  BigAEM(30,6) = 0.4472135954999579*m1s[5]+0.31943828249997*m1s[4]+0.5*m1s[0]; 
  BigAEM(30,7) = 0.3927922024247863*m1s[11]+0.3927922024247863*m1s[10]+0.4*m1s[3]; 
  BigAEM(30,8) = 0.2981423969999719*m1s[10]+0.4391550328268399*m1s[3]; 
  BigAEM(30,10) = 0.2981423969999719*m1s[8]+0.3927922024247863*m1s[7]+0.4391550328268399*m1s[1]; 
  BigAEM(30,11) = 0.3927922024247863*m1s[7]; 
  BigAEM(31,0) = 0.5*m1s[7]; 
  BigAEM(31,1) = 0.5000000000000001*m1s[5]; 
  BigAEM(31,2) = 0.4391550328268399*m1s[11]+0.447213595499958*m1s[3]; 
  BigAEM(31,3) = 0.4391550328268399*m1s[9]+0.4*m1s[6]+0.447213595499958*m1s[2]; 
  BigAEM(31,4) = 0.4472135954999579*m1s[7]; 
  BigAEM(31,5) = 0.31943828249997*m1s[7]+0.5000000000000001*m1s[1]; 
  BigAEM(31,6) = 0.3927922024247863*m1s[11]+0.3927922024247863*m1s[10]+0.4*m1s[3]; 
  BigAEM(31,7) = 0.31943828249997*m1s[5]+0.4472135954999579*m1s[4]+0.5*m1s[0]; 
  BigAEM(31,9) = 0.2981423969999719*m1s[11]+0.4391550328268399*m1s[3]; 
  BigAEM(31,10) = 0.3927922024247863*m1s[6]; 
  BigAEM(31,11) = 0.2981423969999719*m1s[9]+0.3927922024247863*m1s[6]+0.4391550328268399*m1s[2]; 
  BigAEM(32,0) = 0.5*m1s[8]; 
  BigAEM(32,1) = 0.4391550328268398*m1s[4]; 
  BigAEM(32,2) = 0.5*m1s[10]; 
  BigAEM(32,3) = 0.4391550328268399*m1s[6]; 
  BigAEM(32,4) = 0.2981423969999719*m1s[8]+0.4391550328268398*m1s[1]; 
  BigAEM(32,6) = 0.2981423969999719*m1s[10]+0.4391550328268399*m1s[3]; 
  BigAEM(32,8) = 0.2981423969999719*m1s[4]+0.5*m1s[0]; 
  BigAEM(32,10) = 0.2981423969999719*m1s[6]+0.5*m1s[2]; 
  BigAEM(33,0) = 0.5*m1s[9]; 
  BigAEM(33,1) = 0.5*m1s[11]; 
  BigAEM(33,2) = 0.4391550328268398*m1s[5]; 
  BigAEM(33,3) = 0.4391550328268399*m1s[7]; 
  BigAEM(33,5) = 0.2981423969999719*m1s[9]+0.4391550328268398*m1s[2]; 
  BigAEM(33,7) = 0.2981423969999719*m1s[11]+0.4391550328268399*m1s[3]; 
  BigAEM(33,9) = 0.2981423969999719*m1s[5]+0.5*m1s[0]; 
  BigAEM(33,11) = 0.2981423969999719*m1s[7]+0.5*m1s[1]; 
  BigAEM(34,0) = 0.5*m1s[10]; 
  BigAEM(34,1) = 0.4391550328268399*m1s[6]; 
  BigAEM(34,2) = 0.5*m1s[8]; 
  BigAEM(34,3) = 0.4391550328268399*m1s[4]; 
  BigAEM(34,4) = 0.2981423969999719*m1s[10]+0.4391550328268399*m1s[3]; 
  BigAEM(34,5) = 0.4472135954999579*m1s[10]; 
  BigAEM(34,6) = 0.2981423969999719*m1s[8]+0.3927922024247863*m1s[7]+0.4391550328268399*m1s[1]; 
  BigAEM(34,7) = 0.3927922024247863*m1s[6]; 
  BigAEM(34,8) = 0.2981423969999719*m1s[6]+0.5*m1s[2]; 
  BigAEM(34,10) = 0.4472135954999579*m1s[5]+0.2981423969999719*m1s[4]+0.5*m1s[0]; 
  BigAEM(35,0) = 0.5*m1s[11]; 
  BigAEM(35,1) = 0.5*m1s[9]; 
  BigAEM(35,2) = 0.4391550328268399*m1s[7]; 
  BigAEM(35,3) = 0.4391550328268399*m1s[5]; 
  BigAEM(35,4) = 0.4472135954999579*m1s[11]; 
  BigAEM(35,5) = 0.2981423969999719*m1s[11]+0.4391550328268399*m1s[3]; 
  BigAEM(35,6) = 0.3927922024247863*m1s[7]; 
  BigAEM(35,7) = 0.2981423969999719*m1s[9]+0.3927922024247863*m1s[6]+0.4391550328268399*m1s[2]; 
  BigAEM(35,9) = 0.2981423969999719*m1s[7]+0.5*m1s[1]; 
  BigAEM(35,11) = 0.2981423969999719*m1s[5]+0.4472135954999579*m1s[4]+0.5*m1s[0]; 
  ...
  // ....... Block from weak multiply of uY and m1Y  .......... // 
  BigAEM(24,12) = 0.5*m1s[12]; 
  BigAEM(24,13) = 0.5*m1s[13]; 
  BigAEM(24,14) = 0.5*m1s[14]; 
  BigAEM(24,15) = 0.5*m1s[15]; 
  BigAEM(24,16) = 0.5*m1s[16]; 
  BigAEM(24,17) = 0.5*m1s[17]; 
  BigAEM(24,18) = 0.5*m1s[18]; 
  BigAEM(24,19) = 0.5*m1s[19]; 
  BigAEM(24,20) = 0.5*m1s[20]; 
  BigAEM(24,21) = 0.5*m1s[21]; 
  BigAEM(24,22) = 0.5*m1s[22]; 
  BigAEM(24,23) = 0.5*m1s[23]; 
  BigAEM(25,12) = 0.5*m1s[13]; 
  BigAEM(25,13) = 0.4472135954999579*m1s[16]+0.5*m1s[12]; 
  BigAEM(25,14) = 0.5*m1s[15]; 
  BigAEM(25,15) = 0.447213595499958*m1s[18]+0.5*m1s[14]; 
  BigAEM(25,16) = 0.4391550328268398*m1s[20]+0.4472135954999579*m1s[13]; 
  BigAEM(25,17) = 0.5000000000000001*m1s[19]; 
  BigAEM(25,18) = 0.4391550328268399*m1s[22]+0.447213595499958*m1s[15]; 
  BigAEM(25,19) = 0.5000000000000001*m1s[17]; 
  BigAEM(25,20) = 0.4391550328268398*m1s[16]; 
  BigAEM(25,21) = 0.5*m1s[23]; 
  BigAEM(25,22) = 0.4391550328268399*m1s[18]; 
  BigAEM(25,23) = 0.5*m1s[21]; 
  BigAEM(26,12) = 0.5*m1s[14]; 
  BigAEM(26,13) = 0.5*m1s[15]; 
  BigAEM(26,14) = 0.4472135954999579*m1s[17]+0.5*m1s[12]; 
  BigAEM(26,15) = 0.447213595499958*m1s[19]+0.5*m1s[13]; 
  BigAEM(26,16) = 0.5000000000000001*m1s[18]; 
  BigAEM(26,17) = 0.4391550328268398*m1s[21]+0.4472135954999579*m1s[14]; 
  BigAEM(26,18) = 0.5000000000000001*m1s[16]; 
  BigAEM(26,19) = 0.4391550328268399*m1s[23]+0.447213595499958*m1s[15]; 
  BigAEM(26,20) = 0.5*m1s[22]; 
  BigAEM(26,21) = 0.4391550328268398*m1s[17]; 
  BigAEM(26,22) = 0.5*m1s[20]; 
  BigAEM(26,23) = 0.4391550328268399*m1s[19]; 
  BigAEM(27,12) = 0.5*m1s[15]; 
  BigAEM(27,13) = 0.447213595499958*m1s[18]+0.5*m1s[14]; 
  BigAEM(27,14) = 0.447213595499958*m1s[19]+0.5*m1s[13]; 
  BigAEM(27,15) = 0.4472135954999579*m1s[17]+0.4472135954999579*m1s[16]+0.5*m1s[12]; 
  BigAEM(27,16) = 0.4391550328268399*m1s[22]+0.4472135954999579*m1s[15]; 
  BigAEM(27,17) = 0.4391550328268399*m1s[23]+0.4472135954999579*m1s[15]; 
  BigAEM(27,18) = 0.4391550328268399*m1s[20]+0.4*m1s[19]+0.447213595499958*m1s[13]; 
  BigAEM(27,19) = 0.4391550328268399*m1s[21]+0.4*m1s[18]+0.447213595499958*m1s[14]; 
  BigAEM(27,20) = 0.4391550328268399*m1s[18]; 
  BigAEM(27,21) = 0.4391550328268399*m1s[19]; 
  BigAEM(27,22) = 0.4391550328268399*m1s[16]; 
  BigAEM(27,23) = 0.4391550328268399*m1s[17]; 
  BigAEM(28,12) = 0.5*m1s[16]; 
  BigAEM(28,13) = 0.4391550328268398*m1s[20]+0.4472135954999579*m1s[13]; 
  BigAEM(28,14) = 0.5000000000000001*m1s[18]; 
  BigAEM(28,15) = 0.4391550328268399*m1s[22]+0.4472135954999579*m1s[15]; 
  BigAEM(28,16) = 0.31943828249997*m1s[16]+0.5*m1s[12]; 
  BigAEM(28,18) = 0.31943828249997*m1s[18]+0.5000000000000001*m1s[14]; 
  BigAEM(28,19) = 0.4472135954999579*m1s[19]; 
  BigAEM(28,20) = 0.2981423969999719*m1s[20]+0.4391550328268398*m1s[13]; 
  BigAEM(28,22) = 0.2981423969999719*m1s[22]+0.4391550328268399*m1s[15]; 
  BigAEM(28,23) = 0.4472135954999579*m1s[23]; 
  BigAEM(29,12) = 0.5*m1s[17]; 
  BigAEM(29,13) = 0.5000000000000001*m1s[19]; 
  BigAEM(29,14) = 0.4391550328268398*m1s[21]+0.4472135954999579*m1s[14]; 
  BigAEM(29,15) = 0.4391550328268399*m1s[23]+0.4472135954999579*m1s[15]; 
  BigAEM(29,17) = 0.31943828249997*m1s[17]+0.5*m1s[12]; 
  BigAEM(29,18) = 0.4472135954999579*m1s[18]; 
  BigAEM(29,19) = 0.31943828249997*m1s[19]+0.5000000000000001*m1s[13]; 
  BigAEM(29,21) = 0.2981423969999719*m1s[21]+0.4391550328268398*m1s[14]; 
  BigAEM(29,22) = 0.4472135954999579*m1s[22]; 
  BigAEM(29,23) = 0.2981423969999719*m1s[23]+0.4391550328268399*m1s[15]; 
  BigAEM(30,12) = 0.5*m1s[18]; 
  BigAEM(30,13) = 0.4391550328268399*m1s[22]+0.447213595499958*m1s[15]; 
  BigAEM(30,14) = 0.5000000000000001*m1s[16]; 
  BigAEM(30,15) = 0.4391550328268399*m1s[20]+0.4*m1s[19]+0.447213595499958*m1s[13]; 
  BigAEM(30,16) = 0.31943828249997*m1s[18]+0.5000000000000001*m1s[14]; 
  BigAEM(30,17) = 0.4472135954999579*m1s[18]; 
  BigAEM(30,18) = 0.4472135954999579*m1s[17]+0.31943828249997*m1s[16]+0.5*m1s[12]; 
  BigAEM(30,19) = 0.3927922024247863*m1s[23]+0.3927922024247863*m1s[22]+0.4*m1s[15]; 
  BigAEM(30,20) = 0.2981423969999719*m1s[22]+0.4391550328268399*m1s[15]; 
  BigAEM(30,22) = 0.2981423969999719*m1s[20]+0.3927922024247863*m1s[19]+0.4391550328268399*m1s[13]; 
  BigAEM(30,23) = 0.3927922024247863*m1s[19]; 
  BigAEM(31,12) = 0.5*m1s[19]; 
  BigAEM(31,13) = 0.5000000000000001*m1s[17]; 
  BigAEM(31,14) = 0.4391550328268399*m1s[23]+0.447213595499958*m1s[15]; 
  BigAEM(31,15) = 0.4391550328268399*m1s[21]+0.4*m1s[18]+0.447213595499958*m1s[14]; 
  BigAEM(31,16) = 0.4472135954999579*m1s[19]; 
  BigAEM(31,17) = 0.31943828249997*m1s[19]+0.5000000000000001*m1s[13]; 
  BigAEM(31,18) = 0.3927922024247863*m1s[23]+0.3927922024247863*m1s[22]+0.4*m1s[15]; 
  BigAEM(31,19) = 0.31943828249997*m1s[17]+0.4472135954999579*m1s[16]+0.5*m1s[12]; 
  BigAEM(31,21) = 0.2981423969999719*m1s[23]+0.4391550328268399*m1s[15]; 
  BigAEM(31,22) = 0.3927922024247863*m1s[18]; 
  BigAEM(31,23) = 0.2981423969999719*m1s[21]+0.3927922024247863*m1s[18]+0.4391550328268399*m1s[14]; 
  BigAEM(32,12) = 0.5*m1s[20]; 
  BigAEM(32,13) = 0.4391550328268398*m1s[16]; 
  BigAEM(32,14) = 0.5*m1s[22]; 
  BigAEM(32,15) = 0.4391550328268399*m1s[18]; 
  BigAEM(32,16) = 0.2981423969999719*m1s[20]+0.4391550328268398*m1s[13]; 
  BigAEM(32,18) = 0.2981423969999719*m1s[22]+0.4391550328268399*m1s[15]; 
  BigAEM(32,20) = 0.2981423969999719*m1s[16]+0.5*m1s[12]; 
  BigAEM(32,22) = 0.2981423969999719*m1s[18]+0.5*m1s[14]; 
  BigAEM(33,12) = 0.5*m1s[21]; 
  BigAEM(33,13) = 0.5*m1s[23]; 
  BigAEM(33,14) = 0.4391550328268398*m1s[17]; 
  BigAEM(33,15) = 0.4391550328268399*m1s[19]; 
  BigAEM(33,17) = 0.2981423969999719*m1s[21]+0.4391550328268398*m1s[14]; 
  BigAEM(33,19) = 0.2981423969999719*m1s[23]+0.4391550328268399*m1s[15]; 
  BigAEM(33,21) = 0.2981423969999719*m1s[17]+0.5*m1s[12]; 
  BigAEM(33,23) = 0.2981423969999719*m1s[19]+0.5*m1s[13]; 
  BigAEM(34,12) = 0.5*m1s[22]; 
  BigAEM(34,13) = 0.4391550328268399*m1s[18]; 
  BigAEM(34,14) = 0.5*m1s[20]; 
  BigAEM(34,15) = 0.4391550328268399*m1s[16]; 
  BigAEM(34,16) = 0.2981423969999719*m1s[22]+0.4391550328268399*m1s[15]; 
  BigAEM(34,17) = 0.4472135954999579*m1s[22]; 
  BigAEM(34,18) = 0.2981423969999719*m1s[20]+0.3927922024247863*m1s[19]+0.4391550328268399*m1s[13]; 
  BigAEM(34,19) = 0.3927922024247863*m1s[18]; 
  BigAEM(34,20) = 0.2981423969999719*m1s[18]+0.5*m1s[14]; 
  BigAEM(34,22) = 0.4472135954999579*m1s[17]+0.2981423969999719*m1s[16]+0.5*m1s[12]; 
  BigAEM(35,12) = 0.5*m1s[23]; 
  BigAEM(35,13) = 0.5*m1s[21]; 
  BigAEM(35,14) = 0.4391550328268399*m1s[19]; 
  BigAEM(35,15) = 0.4391550328268399*m1s[17]; 
  BigAEM(35,16) = 0.4472135954999579*m1s[23]; 
  BigAEM(35,17) = 0.2981423969999719*m1s[23]+0.4391550328268399*m1s[15]; 
  BigAEM(35,18) = 0.3927922024247863*m1s[19]; 
  BigAEM(35,19) = 0.2981423969999719*m1s[21]+0.3927922024247863*m1s[18]+0.4391550328268399*m1s[14]; 
  BigAEM(35,21) = 0.2981423969999719*m1s[19]+0.5*m1s[13]; 
  BigAEM(35,23) = 0.2981423969999719*m1s[17]+0.4472135954999579*m1s[16]+0.5*m1s[12]; 
  ...
  // ....... RHS vector is composed of m1 and m2 .......... // 
  bEV << m1s[0],m1s[1],m1s[2],m1s[3],m1s[4],m1s[5],m1s[6],m1s[7],m1s[8],m1s[9],m1s[10],m1s[11],m1s[12],m1s[13],m1s[14],m1s[15],m1s[16],m1s[17],m1s[18],m1s[19],m1s[20],m1s[21],m1s[22],m1s[23],m2s[0],m2s[1],m2s[2],m2s[3],m2s[4],m2s[5],m2s[6],m2s[7],m2s[8],m2s[9],m2s[10],m2s[11]; 
