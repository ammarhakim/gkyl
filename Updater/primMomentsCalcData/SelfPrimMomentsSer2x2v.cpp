...
void SelfPrimMoments2x2vSer_P1(const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  ...
  BigAEM(8,9) = m0[1]-0.5*cE[1]; 
  BigAEM(8,10) = m0[2]-0.5*cE[2]; 
  BigAEM(8,11) = m0[3]-0.5*cE[3]; 
  BigAEM(9,8) = m0[1]-0.5*cE[1]; 
  BigAEM(9,9) = m0[0]-0.5*cE[0]; 
  BigAEM(9,10) = m0[3]-0.5*cE[3]; 
  BigAEM(9,11) = m0[2]-0.5*cE[2]; 
  BigAEM(10,8) = m0[2]-0.5*cE[2]; 
  BigAEM(10,9) = m0[3]-0.5*cE[3]; 
  BigAEM(10,10) = m0[0]-0.5*cE[0]; 
  BigAEM(10,11) = m0[1]-0.5*cE[1]; 
  BigAEM(11,8) = m0[3]-0.5*cE[3]; 
  BigAEM(11,9) = m0[2]-0.5*cE[2]; 
  BigAEM(11,10) = m0[1]-0.5*cE[1]; 
  BigAEM(11,11) = m0[0]-0.5*cE[0]; 
...
void SelfPrimMoments2x2vSer_P2(const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  // m0,m1,m2: moments of the distribution function. 
  // cM, cE: vtSq*cM and vtSq*cE are corrections to u and vtSq, respectively. 
  // u:        velocity. 
  ...
  // ....... Block from correction to vtSq .......... // 
  BigAEM(16,16) = m0[0]-0.5*cE[0]; 
  BigAEM(16,17) = m0[1]-0.5*cE[1]; 
  BigAEM(16,18) = m0[2]-0.5*cE[2]; 
  BigAEM(16,19) = m0[3]-0.5*cE[3]; 
  BigAEM(16,20) = m0[4]-0.5*cE[4]; 
  BigAEM(16,21) = m0[5]-0.5*cE[5]; 
  BigAEM(16,22) = m0[6]-0.5*cE[6]; 
  BigAEM(16,23) = m0[7]-0.5*cE[7]; 
  BigAEM(17,16) = m0[1]-0.5*cE[1]; 
  BigAEM(17,17) = 0.8944271909999159*m0[4]-0.4472135954999579*cE[4]+m0[0]-0.5*cE[0]; 
  BigAEM(17,18) = m0[3]-0.5*cE[3]; 
  BigAEM(17,19) = 0.8944271909999161*m0[6]-0.447213595499958*cE[6]+m0[2]-0.5*cE[2]; 
  BigAEM(17,20) = 0.8944271909999159*m0[1]-0.4472135954999579*cE[1]; 
  BigAEM(17,21) = 1.0*m0[7]-0.5000000000000001*cE[7]; 
  BigAEM(17,22) = 0.8944271909999161*m0[3]-0.447213595499958*cE[3]; 
  BigAEM(17,23) = 1.0*m0[5]-0.5000000000000001*cE[5]; 
  BigAEM(18,16) = m0[2]-0.5*cE[2]; 
  BigAEM(18,17) = m0[3]-0.5*cE[3]; 
  BigAEM(18,18) = 0.8944271909999159*m0[5]-0.4472135954999579*cE[5]+m0[0]-0.5*cE[0]; 
  BigAEM(18,19) = 0.8944271909999161*m0[7]-0.447213595499958*cE[7]+m0[1]-0.5*cE[1]; 
  BigAEM(18,20) = 1.0*m0[6]-0.5000000000000001*cE[6]; 
  BigAEM(18,21) = 0.8944271909999159*m0[2]-0.4472135954999579*cE[2]; 
  BigAEM(18,22) = 1.0*m0[4]-0.5000000000000001*cE[4]; 
  BigAEM(18,23) = 0.8944271909999161*m0[3]-0.447213595499958*cE[3]; 
  BigAEM(19,16) = m0[3]-0.5*cE[3]; 
  BigAEM(19,17) = 0.8944271909999161*m0[6]-0.447213595499958*cE[6]+m0[2]-0.5*cE[2]; 
  BigAEM(19,18) = 0.8944271909999161*m0[7]-0.447213595499958*cE[7]+m0[1]-0.5*cE[1]; 
  BigAEM(19,19) = 0.8944271909999159*m0[5]-0.4472135954999579*cE[5]+0.8944271909999159*m0[4]-0.4472135954999579*cE[4]+m0[0]-0.5*cE[0]; 
  BigAEM(19,20) = 0.8944271909999159*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(19,21) = 0.8944271909999159*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(19,22) = 0.8*m0[7]-0.4*cE[7]+0.8944271909999161*m0[1]-0.447213595499958*cE[1]; 
  BigAEM(19,23) = 0.8*m0[6]-0.4*cE[6]+0.8944271909999161*m0[2]-0.447213595499958*cE[2]; 
  BigAEM(20,16) = m0[4]-0.5*cE[4]; 
  BigAEM(20,17) = 0.8944271909999159*m0[1]-0.4472135954999579*cE[1]; 
  BigAEM(20,18) = 1.0*m0[6]-0.5000000000000001*cE[6]; 
  BigAEM(20,19) = 0.8944271909999159*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(20,20) = 0.6388765649999399*m0[4]-0.31943828249997*cE[4]+m0[0]-0.5*cE[0]; 
  BigAEM(20,22) = 0.6388765649999399*m0[6]-0.31943828249997*cE[6]+1.0*m0[2]-0.5000000000000001*cE[2]; 
  BigAEM(20,23) = 0.8944271909999159*m0[7]-0.4472135954999579*cE[7]; 
  BigAEM(21,16) = m0[5]-0.5*cE[5]; 
  BigAEM(21,17) = 1.0*m0[7]-0.5000000000000001*cE[7]; 
  BigAEM(21,18) = 0.8944271909999159*m0[2]-0.4472135954999579*cE[2]; 
  BigAEM(21,19) = 0.8944271909999159*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(21,21) = 0.6388765649999399*m0[5]-0.31943828249997*cE[5]+m0[0]-0.5*cE[0]; 
  BigAEM(21,22) = 0.8944271909999159*m0[6]-0.4472135954999579*cE[6]; 
  BigAEM(21,23) = 0.6388765649999399*m0[7]-0.31943828249997*cE[7]+1.0*m0[1]-0.5000000000000001*cE[1]; 
  BigAEM(22,16) = m0[6]-0.5*cE[6]; 
  BigAEM(22,17) = 0.8944271909999161*m0[3]-0.447213595499958*cE[3]; 
  BigAEM(22,18) = 1.0*m0[4]-0.5000000000000001*cE[4]; 
  BigAEM(22,19) = 0.8*m0[7]-0.4*cE[7]+0.8944271909999161*m0[1]-0.447213595499958*cE[1]; 
  BigAEM(22,20) = 0.6388765649999399*m0[6]-0.31943828249997*cE[6]+1.0*m0[2]-0.5000000000000001*cE[2]; 
  BigAEM(22,21) = 0.8944271909999159*m0[6]-0.4472135954999579*cE[6]; 
  BigAEM(22,22) = 0.8944271909999159*m0[5]-0.4472135954999579*cE[5]+0.6388765649999399*m0[4]-0.31943828249997*cE[4]+m0[0]-0.5*cE[0]; 
  BigAEM(22,23) = 0.8*m0[3]-0.4*cE[3]; 
  BigAEM(23,16) = m0[7]-0.5*cE[7]; 
  BigAEM(23,17) = 1.0*m0[5]-0.5000000000000001*cE[5]; 
  BigAEM(23,18) = 0.8944271909999161*m0[3]-0.447213595499958*cE[3]; 
  BigAEM(23,19) = 0.8*m0[6]-0.4*cE[6]+0.8944271909999161*m0[2]-0.447213595499958*cE[2]; 
  BigAEM(23,20) = 0.8944271909999159*m0[7]-0.4472135954999579*cE[7]; 
  BigAEM(23,21) = 0.6388765649999399*m0[7]-0.31943828249997*cE[7]+1.0*m0[1]-0.5000000000000001*cE[1]; 
  BigAEM(23,22) = 0.8*m0[3]-0.4*cE[3]; 
  BigAEM(23,23) = 0.6388765649999399*m0[5]-0.31943828249997*cE[5]+0.8944271909999159*m0[4]-0.4472135954999579*cE[4]+m0[0]-0.5*cE[0]; 
...
void SelfPrimMoments2x2vSer_P3(const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  // m0,m1,m2: moments of the distribution function. 
  // cM, cE: vtSq*cM and vtSq*cE are corrections to u and vtSq, respectively. 
  // u:        velocity. 
  ...
  // Declare Eigen matrix and vectors for weak division. 
  Eigen::MatrixXd BigAEM(36,36); 
  Eigen::VectorXd bEV(36); 
  Eigen::VectorXd xEV(36); 
  ...
  // ....... Block from correction to vtSq .......... // 
  BigAEM(24,24) = m0[0]-0.5*cE[0]; 
  BigAEM(24,25) = m0[1]-0.5*cE[1]; 
  BigAEM(24,26) = m0[2]-0.5*cE[2]; 
  BigAEM(24,27) = m0[3]-0.5*cE[3]; 
  BigAEM(24,28) = m0[4]-0.5*cE[4]; 
  BigAEM(24,29) = m0[5]-0.5*cE[5]; 
  BigAEM(24,30) = m0[6]-0.5*cE[6]; 
  BigAEM(24,31) = m0[7]-0.5*cE[7]; 
  BigAEM(24,32) = m0[8]-0.5*cE[8]; 
  BigAEM(24,33) = m0[9]-0.5*cE[9]; 
  BigAEM(24,34) = m0[10]-0.5*cE[10]; 
  BigAEM(24,35) = m0[11]-0.5*cE[11]; 
  BigAEM(25,24) = m0[1]-0.5*cE[1]; 
  BigAEM(25,25) = 0.8944271909999159*m0[4]-0.4472135954999579*cE[4]+m0[0]-0.5*cE[0]; 
  BigAEM(25,26) = m0[3]-0.5*cE[3]; 
  BigAEM(25,27) = 0.8944271909999161*m0[6]-0.447213595499958*cE[6]+m0[2]-0.5*cE[2]; 
  BigAEM(25,28) = 0.8783100656536796*m0[8]-0.4391550328268398*cE[8]+0.8944271909999159*m0[1]-0.4472135954999579*cE[1]; 
  BigAEM(25,29) = 1.0*m0[7]-0.5000000000000001*cE[7]; 
  BigAEM(25,30) = 0.8783100656536798*m0[10]-0.4391550328268399*cE[10]+0.8944271909999161*m0[3]-0.447213595499958*cE[3]; 
  BigAEM(25,31) = 1.0*m0[5]-0.5000000000000001*cE[5]; 
  BigAEM(25,32) = 0.8783100656536796*m0[4]-0.4391550328268398*cE[4]; 
  BigAEM(25,33) = 1.0*m0[11]-0.5*cE[11]; 
  BigAEM(25,34) = 0.8783100656536798*m0[6]-0.4391550328268399*cE[6]; 
  BigAEM(25,35) = 1.0*m0[9]-0.5*cE[9]; 
  BigAEM(26,24) = m0[2]-0.5*cE[2]; 
  BigAEM(26,25) = m0[3]-0.5*cE[3]; 
  BigAEM(26,26) = 0.8944271909999159*m0[5]-0.4472135954999579*cE[5]+m0[0]-0.5*cE[0]; 
  BigAEM(26,27) = 0.8944271909999161*m0[7]-0.447213595499958*cE[7]+m0[1]-0.5*cE[1]; 
  BigAEM(26,28) = 1.0*m0[6]-0.5000000000000001*cE[6]; 
  BigAEM(26,29) = 0.8783100656536796*m0[9]-0.4391550328268398*cE[9]+0.8944271909999159*m0[2]-0.4472135954999579*cE[2]; 
  BigAEM(26,30) = 1.0*m0[4]-0.5000000000000001*cE[4]; 
  BigAEM(26,31) = 0.8783100656536798*m0[11]-0.4391550328268399*cE[11]+0.8944271909999161*m0[3]-0.447213595499958*cE[3]; 
  BigAEM(26,32) = 1.0*m0[10]-0.5*cE[10]; 
  BigAEM(26,33) = 0.8783100656536796*m0[5]-0.4391550328268398*cE[5]; 
  BigAEM(26,34) = 1.0*m0[8]-0.5*cE[8]; 
  BigAEM(26,35) = 0.8783100656536798*m0[7]-0.4391550328268399*cE[7]; 
  BigAEM(27,24) = m0[3]-0.5*cE[3]; 
  BigAEM(27,25) = 0.8944271909999161*m0[6]-0.447213595499958*cE[6]+m0[2]-0.5*cE[2]; 
  BigAEM(27,26) = 0.8944271909999161*m0[7]-0.447213595499958*cE[7]+m0[1]-0.5*cE[1]; 
  BigAEM(27,27) = 0.8944271909999159*m0[5]-0.4472135954999579*cE[5]+0.8944271909999159*m0[4]-0.4472135954999579*cE[4]+m0[0]-0.5*cE[0]; 
  BigAEM(27,28) = 0.8783100656536798*m0[10]-0.4391550328268399*cE[10]+0.8944271909999159*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(27,29) = 0.8783100656536798*m0[11]-0.4391550328268399*cE[11]+0.8944271909999159*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(27,30) = 0.8783100656536798*m0[8]-0.4391550328268399*cE[8]+0.8*m0[7]-0.4*cE[7]+0.8944271909999161*m0[1]-0.447213595499958*cE[1]; 
  BigAEM(27,31) = 0.8783100656536798*m0[9]-0.4391550328268399*cE[9]+0.8*m0[6]-0.4*cE[6]+0.8944271909999161*m0[2]-0.447213595499958*cE[2]; 
  BigAEM(27,32) = 0.8783100656536798*m0[6]-0.4391550328268399*cE[6]; 
  BigAEM(27,33) = 0.8783100656536798*m0[7]-0.4391550328268399*cE[7]; 
  BigAEM(27,34) = 0.8783100656536798*m0[4]-0.4391550328268399*cE[4]; 
  BigAEM(27,35) = 0.8783100656536798*m0[5]-0.4391550328268399*cE[5]; 
  BigAEM(28,24) = m0[4]-0.5*cE[4]; 
  BigAEM(28,25) = 0.8783100656536796*m0[8]-0.4391550328268398*cE[8]+0.8944271909999159*m0[1]-0.4472135954999579*cE[1]; 
  BigAEM(28,26) = 1.0*m0[6]-0.5000000000000001*cE[6]; 
  BigAEM(28,27) = 0.8783100656536798*m0[10]-0.4391550328268399*cE[10]+0.8944271909999159*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(28,28) = 0.6388765649999399*m0[4]-0.31943828249997*cE[4]+m0[0]-0.5*cE[0]; 
  BigAEM(28,30) = 0.6388765649999399*m0[6]-0.31943828249997*cE[6]+1.0*m0[2]-0.5000000000000001*cE[2]; 
  BigAEM(28,31) = 0.8944271909999159*m0[7]-0.4472135954999579*cE[7]; 
  BigAEM(28,32) = 0.5962847939999438*m0[8]-0.2981423969999719*cE[8]+0.8783100656536796*m0[1]-0.4391550328268398*cE[1]; 
  BigAEM(28,34) = 0.5962847939999438*m0[10]-0.2981423969999719*cE[10]+0.8783100656536798*m0[3]-0.4391550328268399*cE[3]; 
  BigAEM(28,35) = 0.8944271909999159*m0[11]-0.4472135954999579*cE[11]; 
  BigAEM(29,24) = m0[5]-0.5*cE[5]; 
  BigAEM(29,25) = 1.0*m0[7]-0.5000000000000001*cE[7]; 
  BigAEM(29,26) = 0.8783100656536796*m0[9]-0.4391550328268398*cE[9]+0.8944271909999159*m0[2]-0.4472135954999579*cE[2]; 
  BigAEM(29,27) = 0.8783100656536798*m0[11]-0.4391550328268399*cE[11]+0.8944271909999159*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(29,29) = 0.6388765649999399*m0[5]-0.31943828249997*cE[5]+m0[0]-0.5*cE[0]; 
  BigAEM(29,30) = 0.8944271909999159*m0[6]-0.4472135954999579*cE[6]; 
  BigAEM(29,31) = 0.6388765649999399*m0[7]-0.31943828249997*cE[7]+1.0*m0[1]-0.5000000000000001*cE[1]; 
  BigAEM(29,33) = 0.5962847939999438*m0[9]-0.2981423969999719*cE[9]+0.8783100656536796*m0[2]-0.4391550328268398*cE[2]; 
  BigAEM(29,34) = 0.8944271909999159*m0[10]-0.4472135954999579*cE[10]; 
  BigAEM(29,35) = 0.5962847939999438*m0[11]-0.2981423969999719*cE[11]+0.8783100656536798*m0[3]-0.4391550328268399*cE[3]; 
  BigAEM(30,24) = m0[6]-0.5*cE[6]; 
  BigAEM(30,25) = 0.8783100656536798*m0[10]-0.4391550328268399*cE[10]+0.8944271909999161*m0[3]-0.447213595499958*cE[3]; 
  BigAEM(30,26) = 1.0*m0[4]-0.5000000000000001*cE[4]; 
  BigAEM(30,27) = 0.8783100656536798*m0[8]-0.4391550328268399*cE[8]+0.8*m0[7]-0.4*cE[7]+0.8944271909999161*m0[1]-0.447213595499958*cE[1]; 
  BigAEM(30,28) = 0.6388765649999399*m0[6]-0.31943828249997*cE[6]+1.0*m0[2]-0.5000000000000001*cE[2]; 
  BigAEM(30,29) = 0.8944271909999159*m0[6]-0.4472135954999579*cE[6]; 
  BigAEM(30,30) = 0.8944271909999159*m0[5]-0.4472135954999579*cE[5]+0.6388765649999399*m0[4]-0.31943828249997*cE[4]+m0[0]-0.5*cE[0]; 
  BigAEM(30,31) = 0.7855844048495726*m0[11]-0.3927922024247863*cE[11]+0.7855844048495726*m0[10]-0.3927922024247863*cE[10]+0.8*m0[3]-0.4*cE[3]; 
  BigAEM(30,32) = 0.5962847939999437*m0[10]-0.2981423969999719*cE[10]+0.8783100656536798*m0[3]-0.4391550328268399*cE[3]; 
  BigAEM(30,34) = 0.5962847939999437*m0[8]-0.2981423969999719*cE[8]+0.7855844048495726*m0[7]-0.3927922024247863*cE[7]+0.8783100656536798*m0[1]-0.4391550328268399*cE[1]; 
  BigAEM(30,35) = 0.7855844048495726*m0[7]-0.3927922024247863*cE[7]; 
  BigAEM(31,24) = m0[7]-0.5*cE[7]; 
  BigAEM(31,25) = 1.0*m0[5]-0.5000000000000001*cE[5]; 
  BigAEM(31,26) = 0.8783100656536798*m0[11]-0.4391550328268399*cE[11]+0.8944271909999161*m0[3]-0.447213595499958*cE[3]; 
  BigAEM(31,27) = 0.8783100656536798*m0[9]-0.4391550328268399*cE[9]+0.8*m0[6]-0.4*cE[6]+0.8944271909999161*m0[2]-0.447213595499958*cE[2]; 
  BigAEM(31,28) = 0.8944271909999159*m0[7]-0.4472135954999579*cE[7]; 
  BigAEM(31,29) = 0.6388765649999399*m0[7]-0.31943828249997*cE[7]+1.0*m0[1]-0.5000000000000001*cE[1]; 
  BigAEM(31,30) = 0.7855844048495726*m0[11]-0.3927922024247863*cE[11]+0.7855844048495726*m0[10]-0.3927922024247863*cE[10]+0.8*m0[3]-0.4*cE[3]; 
  BigAEM(31,31) = 0.6388765649999399*m0[5]-0.31943828249997*cE[5]+0.8944271909999159*m0[4]-0.4472135954999579*cE[4]+m0[0]-0.5*cE[0]; 
  BigAEM(31,33) = 0.5962847939999437*m0[11]-0.2981423969999719*cE[11]+0.8783100656536798*m0[3]-0.4391550328268399*cE[3]; 
  BigAEM(31,34) = 0.7855844048495726*m0[6]-0.3927922024247863*cE[6]; 
  BigAEM(31,35) = 0.5962847939999437*m0[9]-0.2981423969999719*cE[9]+0.7855844048495726*m0[6]-0.3927922024247863*cE[6]+0.8783100656536798*m0[2]-0.4391550328268399*cE[2]; 
  BigAEM(32,24) = m0[8]-0.5*cE[8]; 
  BigAEM(32,25) = 0.8783100656536796*m0[4]-0.4391550328268398*cE[4]; 
  BigAEM(32,26) = 1.0*m0[10]-0.5*cE[10]; 
  BigAEM(32,27) = 0.8783100656536798*m0[6]-0.4391550328268399*cE[6]; 
  BigAEM(32,28) = 0.5962847939999438*m0[8]-0.2981423969999719*cE[8]+0.8783100656536796*m0[1]-0.4391550328268398*cE[1]; 
  BigAEM(32,30) = 0.5962847939999437*m0[10]-0.2981423969999719*cE[10]+0.8783100656536798*m0[3]-0.4391550328268399*cE[3]; 
  BigAEM(32,32) = 0.5962847939999438*m0[4]-0.2981423969999719*cE[4]+m0[0]-0.5*cE[0]; 
  BigAEM(32,34) = 0.5962847939999437*m0[6]-0.2981423969999719*cE[6]+1.0*m0[2]-0.5*cE[2]; 
  BigAEM(33,24) = m0[9]-0.5*cE[9]; 
  BigAEM(33,25) = 1.0*m0[11]-0.5*cE[11]; 
  BigAEM(33,26) = 0.8783100656536796*m0[5]-0.4391550328268398*cE[5]; 
  BigAEM(33,27) = 0.8783100656536798*m0[7]-0.4391550328268399*cE[7]; 
  BigAEM(33,29) = 0.5962847939999438*m0[9]-0.2981423969999719*cE[9]+0.8783100656536796*m0[2]-0.4391550328268398*cE[2]; 
  BigAEM(33,31) = 0.5962847939999437*m0[11]-0.2981423969999719*cE[11]+0.8783100656536798*m0[3]-0.4391550328268399*cE[3]; 
  BigAEM(33,33) = 0.5962847939999438*m0[5]-0.2981423969999719*cE[5]+m0[0]-0.5*cE[0]; 
  BigAEM(33,35) = 0.5962847939999437*m0[7]-0.2981423969999719*cE[7]+1.0*m0[1]-0.5*cE[1]; 
  BigAEM(34,24) = m0[10]-0.5*cE[10]; 
  BigAEM(34,25) = 0.8783100656536798*m0[6]-0.4391550328268399*cE[6]; 
  BigAEM(34,26) = 1.0*m0[8]-0.5*cE[8]; 
  BigAEM(34,27) = 0.8783100656536798*m0[4]-0.4391550328268399*cE[4]; 
  BigAEM(34,28) = 0.5962847939999438*m0[10]-0.2981423969999719*cE[10]+0.8783100656536798*m0[3]-0.4391550328268399*cE[3]; 
  BigAEM(34,29) = 0.8944271909999159*m0[10]-0.4472135954999579*cE[10]; 
  BigAEM(34,30) = 0.5962847939999437*m0[8]-0.2981423969999719*cE[8]+0.7855844048495726*m0[7]-0.3927922024247863*cE[7]+0.8783100656536798*m0[1]-0.4391550328268399*cE[1]; 
  BigAEM(34,31) = 0.7855844048495726*m0[6]-0.3927922024247863*cE[6]; 
  BigAEM(34,32) = 0.5962847939999437*m0[6]-0.2981423969999719*cE[6]+1.0*m0[2]-0.5*cE[2]; 
  BigAEM(34,34) = 0.8944271909999159*m0[5]-0.4472135954999579*cE[5]+0.5962847939999438*m0[4]-0.2981423969999719*cE[4]+m0[0]-0.5*cE[0]; 
  BigAEM(35,24) = m0[11]-0.5*cE[11]; 
  BigAEM(35,25) = 1.0*m0[9]-0.5*cE[9]; 
  BigAEM(35,26) = 0.8783100656536798*m0[7]-0.4391550328268399*cE[7]; 
  BigAEM(35,27) = 0.8783100656536798*m0[5]-0.4391550328268399*cE[5]; 
  BigAEM(35,28) = 0.8944271909999159*m0[11]-0.4472135954999579*cE[11]; 
  BigAEM(35,29) = 0.5962847939999438*m0[11]-0.2981423969999719*cE[11]+0.8783100656536798*m0[3]-0.4391550328268399*cE[3]; 
  BigAEM(35,30) = 0.7855844048495726*m0[7]-0.3927922024247863*cE[7]; 
  BigAEM(35,31) = 0.5962847939999437*m0[9]-0.2981423969999719*cE[9]+0.7855844048495726*m0[6]-0.3927922024247863*cE[6]+0.8783100656536798*m0[2]-0.4391550328268399*cE[2]; 
  BigAEM(35,33) = 0.5962847939999437*m0[7]-0.2981423969999719*cE[7]+1.0*m0[1]-0.5*cE[1]; 
  BigAEM(35,35) = 0.5962847939999438*m0[5]-0.2981423969999719*cE[5]+0.8944271909999159*m0[4]-0.4472135954999579*cE[4]+m0[0]-0.5*cE[0]; 
...
{ 
  ...
  out[3] += 1.732050807568877*fvmin[11]*dS+1.732050807568877*fvmax[11]*dS-1.0*fvmin[5]*dS+fvmax[5]*dS; 
...
{ 
  ...
  out[3] += (-2.23606797749979*fvmin[34]*dS)+2.23606797749979*fvmax[34]*dS+1.732050807568877*fvmin[15]*dS+1.732050807568877*fvmax[15]*dS-1.0*fvmin[5]*dS+fvmax[5]*dS; 
  ...
  out[6] += 1.732050807568877*fvmin[32]*dS+1.732050807568877*fvmax[32]*dS-1.0*fvmin[19]*dS+fvmax[19]*dS; 
  out[7] += 1.732050807568877*fvmin[33]*dS+1.732050807568877*fvmax[33]*dS-1.0*fvmin[20]*dS+fvmax[20]*dS; 
...
{ 
  ...
  out[1] += 2.645751311064591*fvmin[52]*dS+2.645751311064591*fvmax[52]*dS-2.23606797749979*fvmin[23]*dS+2.23606797749979*fvmax[23]*dS+1.732050807568877*fvmin[6]*dS+1.732050807568877*fvmax[6]*dS-1.0*fvmin[1]*dS+fvmax[1]*dS; 
  out[2] += 2.645751311064591*fvmin[53]*dS+2.645751311064591*fvmax[53]*dS-2.23606797749979*fvmin[24]*dS+2.23606797749979*fvmax[24]*dS+1.732050807568877*fvmin[7]*dS+1.732050807568877*fvmax[7]*dS-1.0*fvmin[2]*dS+fvmax[2]*dS; 
  out[3] += 2.645751311064591*fvmin[66]*dS+2.645751311064591*fvmax[66]*dS-2.23606797749979*fvmin[38]*dS+2.23606797749979*fvmax[38]*dS+1.732050807568877*fvmin[15]*dS+1.732050807568877*fvmax[15]*dS-1.0*fvmin[5]*dS+fvmax[5]*dS; 
  out[4] += 1.732050807568877*fvmin[21]*dS+1.732050807568877*fvmax[21]*dS-1.0*fvmin[11]*dS+fvmax[11]*dS; 
  out[5] += 1.732050807568877*fvmin[22]*dS+1.732050807568877*fvmax[22]*dS-1.0*fvmin[12]*dS+fvmax[12]*dS; 
  out[6] += 1.732050807568877*fvmin[36]*dS+1.732050807568877*fvmax[36]*dS-1.0*fvmin[19]*dS+fvmax[19]*dS; 
  out[7] += 1.732050807568877*fvmin[37]*dS+1.732050807568877*fvmax[37]*dS-1.0*fvmin[20]*dS+fvmax[20]*dS; 
  out[8] += 1.732050807568877*fvmin[50]*dS+1.732050807568877*fvmax[50]*dS-1.0*fvmin[31]*dS+fvmax[31]*dS; 
  out[9] += 1.732050807568877*fvmin[51]*dS+1.732050807568877*fvmax[51]*dS-1.0*fvmin[32]*dS+fvmax[32]*dS; 
  out[10] += 1.732050807568877*fvmin[64]*dS+1.732050807568877*fvmax[64]*dS-1.0*fvmin[48]*dS+fvmax[48]*dS; 
  out[11] += 1.732050807568877*fvmin[65]*dS+1.732050807568877*fvmax[65]*dS-1.0*fvmin[49]*dS+fvmax[49]*dS; 
...
{ 
  ...
  out[3] += (-1.732050807568877*fvmin[11]*dS*vmin)+fvmin[5]*dS*vmin+1.732050807568877*fvmax[11]*dS*vmax+fvmax[5]*dS*vmax; 
...
{ 
  ...
  out[3] += 2.23606797749979*fvmin[34]*dS*vmin-1.732050807568877*fvmin[15]*dS*vmin+fvmin[5]*dS*vmin+2.23606797749979*fvmax[34]*dS*vmax+1.732050807568877*fvmax[15]*dS*vmax+fvmax[5]*dS*vmax; 
  ...
  out[6] += (-1.732050807568877*fvmin[32]*dS*vmin)+fvmin[19]*dS*vmin+1.732050807568877*fvmax[32]*dS*vmax+fvmax[19]*dS*vmax; 
  out[7] += (-1.732050807568877*fvmin[33]*dS*vmin)+fvmin[20]*dS*vmin+1.732050807568877*fvmax[33]*dS*vmax+fvmax[20]*dS*vmax; 
...
{ 
  ...
  out[1] += (-2.645751311064591*fvmin[52]*dS*vmin)+2.23606797749979*fvmin[23]*dS*vmin-1.732050807568877*fvmin[6]*dS*vmin+fvmin[1]*dS*vmin+2.645751311064591*fvmax[52]*dS*vmax+2.23606797749979*fvmax[23]*dS*vmax+1.732050807568877*fvmax[6]*dS*vmax+fvmax[1]*dS*vmax; 
  out[2] += (-2.645751311064591*fvmin[53]*dS*vmin)+2.23606797749979*fvmin[24]*dS*vmin-1.732050807568877*fvmin[7]*dS*vmin+fvmin[2]*dS*vmin+2.645751311064591*fvmax[53]*dS*vmax+2.23606797749979*fvmax[24]*dS*vmax+1.732050807568877*fvmax[7]*dS*vmax+fvmax[2]*dS*vmax; 
  out[3] += (-2.645751311064591*fvmin[66]*dS*vmin)+2.23606797749979*fvmin[38]*dS*vmin-1.732050807568877*fvmin[15]*dS*vmin+fvmin[5]*dS*vmin+2.645751311064591*fvmax[66]*dS*vmax+2.23606797749979*fvmax[38]*dS*vmax+1.732050807568877*fvmax[15]*dS*vmax+fvmax[5]*dS*vmax; 
  out[4] += (-1.732050807568877*fvmin[21]*dS*vmin)+fvmin[11]*dS*vmin+1.732050807568877*fvmax[21]*dS*vmax+fvmax[11]*dS*vmax; 
  out[5] += (-1.732050807568877*fvmin[22]*dS*vmin)+fvmin[12]*dS*vmin+1.732050807568877*fvmax[22]*dS*vmax+fvmax[12]*dS*vmax; 
  out[6] += (-1.732050807568877*fvmin[36]*dS*vmin)+fvmin[19]*dS*vmin+1.732050807568877*fvmax[36]*dS*vmax+fvmax[19]*dS*vmax; 
  out[7] += (-1.732050807568877*fvmin[37]*dS*vmin)+fvmin[20]*dS*vmin+1.732050807568877*fvmax[37]*dS*vmax+fvmax[20]*dS*vmax; 
  out[8] += (-1.732050807568877*fvmin[50]*dS*vmin)+fvmin[31]*dS*vmin+1.732050807568877*fvmax[50]*dS*vmax+fvmax[31]*dS*vmax; 
  out[9] += (-1.732050807568877*fvmin[51]*dS*vmin)+fvmin[32]*dS*vmin+1.732050807568877*fvmax[51]*dS*vmax+fvmax[32]*dS*vmax; 
  out[10] += (-1.732050807568877*fvmin[64]*dS*vmin)+fvmin[48]*dS*vmin+1.732050807568877*fvmax[64]*dS*vmax+fvmax[48]*dS*vmax; 
  out[11] += (-1.732050807568877*fvmin[65]*dS*vmin)+fvmin[49]*dS*vmin+1.732050807568877*fvmax[65]*dS*vmax+fvmax[49]*dS*vmax; 
...
{ 
  ...
  out[4] += 1.732050807568877*fvmin[4]*dS+1.732050807568877*fvmax[4]*dS-1.0*fvmin[0]*dS+fvmax[0]*dS; 
  out[5] += 1.732050807568877*fvmin[8]*dS+1.732050807568877*fvmax[8]*dS-1.0*fvmin[1]*dS+fvmax[1]*dS; 
  out[6] += 1.732050807568877*fvmin[9]*dS+1.732050807568877*fvmax[9]*dS-1.0*fvmin[2]*dS+fvmax[2]*dS; 
  out[7] += 1.732050807568877*fvmin[12]*dS+1.732050807568877*fvmax[12]*dS-1.0*fvmin[5]*dS+fvmax[5]*dS; 
...
{ 
  ...
  out[8] += (-2.23606797749979*fvmin[14]*dS)+2.23606797749979*fvmax[14]*dS+1.732050807568877*fvmin[4]*dS+1.732050807568877*fvmax[4]*dS-1.0*fvmin[0]*dS+fvmax[0]*dS; 
  out[9] += (-2.23606797749979*fvmin[28]*dS)+2.23606797749979*fvmax[28]*dS+1.732050807568877*fvmin[8]*dS+1.732050807568877*fvmax[8]*dS-1.0*fvmin[1]*dS+fvmax[1]*dS; 
  out[10] += (-2.23606797749979*fvmin[29]*dS)+2.23606797749979*fvmax[29]*dS+1.732050807568877*fvmin[9]*dS+1.732050807568877*fvmax[9]*dS-1.0*fvmin[2]*dS+fvmax[2]*dS; 
  out[11] += (-2.23606797749979*fvmin[41]*dS)+2.23606797749979*fvmax[41]*dS+1.732050807568877*fvmin[16]*dS+1.732050807568877*fvmax[16]*dS-1.0*fvmin[5]*dS+fvmax[5]*dS; 
  out[12] += 1.732050807568877*fvmin[25]*dS+1.732050807568877*fvmax[25]*dS-1.0*fvmin[11]*dS+fvmax[11]*dS; 
  out[13] += 1.732050807568877*fvmin[26]*dS+1.732050807568877*fvmax[26]*dS-1.0*fvmin[12]*dS+fvmax[12]*dS; 
  out[14] += 1.732050807568877*fvmin[35]*dS+1.732050807568877*fvmax[35]*dS-1.0*fvmin[19]*dS+fvmax[19]*dS; 
  out[15] += 1.732050807568877*fvmin[36]*dS+1.732050807568877*fvmax[36]*dS-1.0*fvmin[20]*dS+fvmax[20]*dS; 
...
{ 
  ...
  out[12] += 2.645751311064591*fvmin[34]*dS+2.645751311064591*fvmax[34]*dS-2.23606797749979*fvmin[14]*dS+2.23606797749979*fvmax[14]*dS+1.732050807568877*fvmin[4]*dS+1.732050807568877*fvmax[4]*dS-1.0*fvmin[0]*dS+fvmax[0]*dS; 
  out[13] += 2.645751311064591*fvmin[57]*dS+2.645751311064591*fvmax[57]*dS-2.23606797749979*fvmin[28]*dS+2.23606797749979*fvmax[28]*dS+1.732050807568877*fvmin[8]*dS+1.732050807568877*fvmax[8]*dS-1.0*fvmin[1]*dS+fvmax[1]*dS; 
  out[14] += 2.645751311064591*fvmin[58]*dS+2.645751311064591*fvmax[58]*dS-2.23606797749979*fvmin[29]*dS+2.23606797749979*fvmax[29]*dS+1.732050807568877*fvmin[9]*dS+1.732050807568877*fvmax[9]*dS-1.0*fvmin[2]*dS+fvmax[2]*dS; 
  out[15] += 2.645751311064591*fvmin[73]*dS+2.645751311064591*fvmax[73]*dS-2.23606797749979*fvmin[45]*dS+2.23606797749979*fvmax[45]*dS+1.732050807568877*fvmin[16]*dS+1.732050807568877*fvmax[16]*dS-1.0*fvmin[5]*dS+fvmax[5]*dS; 
  out[16] += 1.732050807568877*fvmin[25]*dS+1.732050807568877*fvmax[25]*dS-1.0*fvmin[11]*dS+fvmax[11]*dS; 
  out[17] += 1.732050807568877*fvmin[26]*dS+1.732050807568877*fvmax[26]*dS-1.0*fvmin[12]*dS+fvmax[12]*dS; 
  out[18] += 1.732050807568877*fvmin[39]*dS+1.732050807568877*fvmax[39]*dS-1.0*fvmin[19]*dS+fvmax[19]*dS; 
  out[19] += 1.732050807568877*fvmin[40]*dS+1.732050807568877*fvmax[40]*dS-1.0*fvmin[20]*dS+fvmax[20]*dS; 
  out[20] += 1.732050807568877*fvmin[54]*dS+1.732050807568877*fvmax[54]*dS-1.0*fvmin[31]*dS+fvmax[31]*dS; 
  out[21] += 1.732050807568877*fvmin[55]*dS+1.732050807568877*fvmax[55]*dS-1.0*fvmin[32]*dS+fvmax[32]*dS; 
  out[22] += 1.732050807568877*fvmin[67]*dS+1.732050807568877*fvmax[67]*dS-1.0*fvmin[48]*dS+fvmax[48]*dS; 
  out[23] += 1.732050807568877*fvmin[68]*dS+1.732050807568877*fvmax[68]*dS-1.0*fvmin[49]*dS+fvmax[49]*dS; 
...
{ 
  ...
  out[3] += (-1.732050807568877*fvmin[12]*dS*vmin)+fvmin[5]*dS*vmin+1.732050807568877*fvmax[12]*dS*vmax+fvmax[5]*dS*vmax; 
...
{ 
  ...
  out[3] += 2.23606797749979*fvmin[41]*dS*vmin-1.732050807568877*fvmin[16]*dS*vmin+fvmin[5]*dS*vmin+2.23606797749979*fvmax[41]*dS*vmax+1.732050807568877*fvmax[16]*dS*vmax+fvmax[5]*dS*vmax; 
  ...
  out[6] += (-1.732050807568877*fvmin[35]*dS*vmin)+fvmin[19]*dS*vmin+1.732050807568877*fvmax[35]*dS*vmax+fvmax[19]*dS*vmax; 
  out[7] += (-1.732050807568877*fvmin[36]*dS*vmin)+fvmin[20]*dS*vmin+1.732050807568877*fvmax[36]*dS*vmax+fvmax[20]*dS*vmax; 
...
{ 
  ...
  out[1] += (-2.645751311064591*fvmin[57]*dS*vmin)+2.23606797749979*fvmin[28]*dS*vmin-1.732050807568877*fvmin[8]*dS*vmin+fvmin[1]*dS*vmin+2.645751311064591*fvmax[57]*dS*vmax+2.23606797749979*fvmax[28]*dS*vmax+1.732050807568877*fvmax[8]*dS*vmax+fvmax[1]*dS*vmax; 
  out[2] += (-2.645751311064591*fvmin[58]*dS*vmin)+2.23606797749979*fvmin[29]*dS*vmin-1.732050807568877*fvmin[9]*dS*vmin+fvmin[2]*dS*vmin+2.645751311064591*fvmax[58]*dS*vmax+2.23606797749979*fvmax[29]*dS*vmax+1.732050807568877*fvmax[9]*dS*vmax+fvmax[2]*dS*vmax; 
  out[3] += (-2.645751311064591*fvmin[73]*dS*vmin)+2.23606797749979*fvmin[45]*dS*vmin-1.732050807568877*fvmin[16]*dS*vmin+fvmin[5]*dS*vmin+2.645751311064591*fvmax[73]*dS*vmax+2.23606797749979*fvmax[45]*dS*vmax+1.732050807568877*fvmax[16]*dS*vmax+fvmax[5]*dS*vmax; 
  out[4] += (-1.732050807568877*fvmin[25]*dS*vmin)+fvmin[11]*dS*vmin+1.732050807568877*fvmax[25]*dS*vmax+fvmax[11]*dS*vmax; 
  out[5] += (-1.732050807568877*fvmin[26]*dS*vmin)+fvmin[12]*dS*vmin+1.732050807568877*fvmax[26]*dS*vmax+fvmax[12]*dS*vmax; 
  out[6] += (-1.732050807568877*fvmin[39]*dS*vmin)+fvmin[19]*dS*vmin+1.732050807568877*fvmax[39]*dS*vmax+fvmax[19]*dS*vmax; 
  out[7] += (-1.732050807568877*fvmin[40]*dS*vmin)+fvmin[20]*dS*vmin+1.732050807568877*fvmax[40]*dS*vmax+fvmax[20]*dS*vmax; 
  out[8] += (-1.732050807568877*fvmin[54]*dS*vmin)+fvmin[31]*dS*vmin+1.732050807568877*fvmax[54]*dS*vmax+fvmax[31]*dS*vmax; 
  out[9] += (-1.732050807568877*fvmin[55]*dS*vmin)+fvmin[32]*dS*vmin+1.732050807568877*fvmax[55]*dS*vmax+fvmax[32]*dS*vmax; 
  out[10] += (-1.732050807568877*fvmin[67]*dS*vmin)+fvmin[48]*dS*vmin+1.732050807568877*fvmax[67]*dS*vmax+fvmax[48]*dS*vmax; 
  out[11] += (-1.732050807568877*fvmin[68]*dS*vmin)+fvmin[49]*dS*vmin+1.732050807568877*fvmax[68]*dS*vmax+fvmax[49]*dS*vmax; 
