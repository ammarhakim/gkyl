...
void GkSelfPrimMoments1x1vSer_P1(const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  ...
  BigAEM(2,2) = 0.7071067811865475*m0r[0]-0.7071067811865475*cE[0]; 
  BigAEM(2,3) = 0.7071067811865475*m0r[1]-0.7071067811865475*cE[1]; 
  BigAEM(3,2) = 0.7071067811865475*m0r[1]-0.7071067811865475*cE[1]; 
