...
{ 
  ...
  data->AEM_S(1,7) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(2,6) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(2,8) = -0.5*cMrSelf[0]*mnuSelf; 
  ...
  data->AEM_S(0,15) = -0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(0,16) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(0,17) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(1,15) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(1,16) = -0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(2,15) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(2,17) = -0.5*cMrOther[0]*mnuOther; 
  ...
  data->AEM_S(3,7) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(3,8) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(4,6) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(4,7) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(5,6) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(5,8) = -0.5*cMrSelf[3]*mnuSelf; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(3,15) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(3,16) = -0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(3,17) = -0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(4,15) = -0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(4,16) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(5,15) = -0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(5,17) = -0.5*cMrOther[3]*mnuOther; 
  ...
  data->AEM_S(6,6) = 0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(6,7) = 0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(6,8) = 0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(7,6) = 0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(7,7) = 0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(8,6) = 0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(8,8) = 0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
 
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(6,15) = 0.5*m0SrOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(6,16) = 0.5*m0SrOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(6,17) = 0.5*m0SrOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(7,15) = 0.5*m0SrOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(7,16) = 0.5*m0SrOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(8,15) = 0.5*m0SrOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(8,17) = 0.5*m0SrOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  ...
  data->AEM_S(9,6) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(9,7) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(9,8) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(10,6) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(10,7) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(11,6) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(11,8) = -0.5*cMrSelf[0]*mnuSelf; 
  ...
  data->AEM_S(9,15) = 0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(9,16) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(9,17) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(10,15) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(10,16) = 0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(11,15) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(11,17) = 0.5*cMrOther[0]*mnuOther; 
  ...
  // ... Block from correction to (self) 1st moment of collision operator ... // 
  data->AEM_S(12,6) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(12,7) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(12,8) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(13,6) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(13,7) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(14,6) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(14,8) = -0.5*cMrSelf[3]*mnuSelf; 
  ...
  // ... Block from correction to (other) 1st moment of collision operator ... // 
  data->AEM_S(12,15) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(12,16) = 0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(12,17) = 0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(13,15) = 0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(13,16) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(14,15) = 0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(14,17) = 0.5*cMrOther[3]*mnuOther; 
  ...
  // Compute m0Other*m1Self-m0Self*m1Other. 
  m1EffD[3] = 0.5*m0rOther[2]*m1rSelf[5]-0.5*m0rSelf[2]*m1rOther[5]+0.5*m0rOther[1]*m1rSelf[4]-0.5*m0rSelf[1]*m1rOther[4]+0.5*m0rOther[0]*m1rSelf[3]-0.5*m0rSelf[0]*m1rOther[3]; 
  m1EffD[4] = 0.5*m0rOther[0]*m1rSelf[4]-0.5*m0rSelf[0]*m1rOther[4]+0.5*m0rOther[1]*m1rSelf[3]-0.5*m0rSelf[1]*m1rOther[3]; 
  m1EffD[5] = 0.5*m0rOther[0]*m1rSelf[5]-0.5*m0rSelf[0]*m1rOther[5]+0.5*m0rOther[2]*m1rSelf[3]-0.5*m0rSelf[2]*m1rOther[3]; 
  // Fill BEV. 
  ...
  data->AEM_S(15,6) = 0.5*ucMSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(15,7) = 0.5*ucMSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(15,8) = 0.5*ucMSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(16,6) = 0.5*ucMSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(16,7) = 0.5*ucMSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(17,6) = 0.5*ucMSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(17,8) = 0.5*ucMSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  ...
  data->AEM_S(15,15) = (-0.5*ucMOther[0]*mnuOther)-0.5*m0SrOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(15,16) = (-0.5*ucMOther[1]*mnuOther)-0.5*m0SrOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(15,17) = (-0.5*ucMOther[2]*mnuOther)-0.5*m0SrOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(16,15) = (-0.5*ucMOther[1]*mnuOther)-0.5*m0SrOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(16,16) = (-0.5*ucMOther[0]*mnuOther)-0.5*m0SrOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(17,15) = (-0.5*ucMOther[2]*mnuOther)-0.5*m0SrOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(17,17) = (-0.5*ucMOther[0]*mnuOther)-0.5*m0SrOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
...
void VmLBOCrossPrimMoments2x2vMax_P3(binOpData_t *data, binOpData_t *dataDiv,const double betaGreenep1, const double mSelf, const double nuSelf, const double *m0Self, const double *m1Self, const double *m2Self, const double *uSelf, const double *vtSqSelf, const double *cMSelf, const double *cESelf, const double mOther, const double nuOther, const double *m0Other, const double *m1Other, const double *m2Other, const double *uOther, const double *vtSqOther, const double *cMOther, const double *cEOther, double *uCrossSelf, double *vtSqCrossSelf, double *uCrossOther, double *vtSqCrossOther) 
{ 
  // betaGreenep1:       free parameter beta+1. This has to be >0. 
  // nu, m:              collisionality and mass. 
  // m0,m1,m2:           moments of the distribution function. 
  ...
  if (cellAvg) { 
    ...
    cMrSelf[18] = cMSelf[18]; 
    cMrSelf[19] = cMSelf[19]; 
    cErSelf[0] = cESelf[0]; 
    cErSelf[1] = cESelf[1]; 
    cErSelf[2] = cESelf[2]; 
    cErSelf[3] = cESelf[3]; 
  ...
  if (cellAvg) { 
    ...
    cMrOther[18] = cMOther[18]; 
    cMrOther[19] = cMOther[19]; 
    cErOther[0] = cEOther[0]; 
    cErOther[1] = cEOther[1]; 
    cErOther[2] = cEOther[2]; 
    cErOther[3] = cEOther[3]; 
  ...
  // ... Block from correction to momentum conservation (self) ... // 
  data->AEM_S(0,20) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(0,21) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(0,22) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(0,23) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(0,24) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(0,25) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(0,26) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(0,27) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(0,28) = -0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(0,29) = -0.5*cMrSelf[9]*mnuSelf; 
  data->AEM_S(1,20) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(1,21) = (-0.4472135954999579*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(1,22) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(1,23) = (-0.447213595499958*cMrSelf[6]*mnuSelf)-0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(1,24) = (-0.4391550328268398*cMrSelf[8]*mnuSelf)-0.4472135954999579*cMrSelf[1]*mnuSelf; 
  data->AEM_S(1,25) = -0.5000000000000001*cMrSelf[7]*mnuSelf; 
  data->AEM_S(1,26) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(1,27) = -0.5000000000000001*cMrSelf[5]*mnuSelf; 
  data->AEM_S(1,28) = -0.4391550328268398*cMrSelf[4]*mnuSelf; 
  data->AEM_S(2,20) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(2,21) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(2,22) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(2,23) = (-0.447213595499958*cMrSelf[7]*mnuSelf)-0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(2,24) = -0.5000000000000001*cMrSelf[6]*mnuSelf; 
  data->AEM_S(2,25) = (-0.4391550328268398*cMrSelf[9]*mnuSelf)-0.4472135954999579*cMrSelf[2]*mnuSelf; 
  data->AEM_S(2,26) = -0.5000000000000001*cMrSelf[4]*mnuSelf; 
  data->AEM_S(2,27) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(2,29) = -0.4391550328268398*cMrSelf[5]*mnuSelf; 
  data->AEM_S(3,20) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,21) = (-0.447213595499958*cMrSelf[6]*mnuSelf)-0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(3,22) = (-0.447213595499958*cMrSelf[7]*mnuSelf)-0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(3,23) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.4472135954999579*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(3,24) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,25) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,26) = (-0.4391550328268399*cMrSelf[8]*mnuSelf)-0.4*cMrSelf[7]*mnuSelf-0.447213595499958*cMrSelf[1]*mnuSelf; 
  data->AEM_S(3,27) = (-0.4391550328268399*cMrSelf[9]*mnuSelf)-0.4*cMrSelf[6]*mnuSelf-0.447213595499958*cMrSelf[2]*mnuSelf; 
  data->AEM_S(3,28) = -0.4391550328268399*cMrSelf[6]*mnuSelf; 
  data->AEM_S(3,29) = -0.4391550328268399*cMrSelf[7]*mnuSelf; 
  data->AEM_S(4,20) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(4,21) = (-0.4391550328268398*cMrSelf[8]*mnuSelf)-0.4472135954999579*cMrSelf[1]*mnuSelf; 
  data->AEM_S(4,22) = -0.5000000000000001*cMrSelf[6]*mnuSelf; 
  data->AEM_S(4,23) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(4,24) = (-0.31943828249997*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(4,26) = (-0.31943828249997*cMrSelf[6]*mnuSelf)-0.5000000000000001*cMrSelf[2]*mnuSelf; 
  data->AEM_S(4,27) = -0.4472135954999579*cMrSelf[7]*mnuSelf; 
  data->AEM_S(4,28) = (-0.2981423969999719*cMrSelf[8]*mnuSelf)-0.4391550328268398*cMrSelf[1]*mnuSelf; 
  data->AEM_S(5,20) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(5,21) = -0.5000000000000001*cMrSelf[7]*mnuSelf; 
  data->AEM_S(5,22) = (-0.4391550328268398*cMrSelf[9]*mnuSelf)-0.4472135954999579*cMrSelf[2]*mnuSelf; 
  data->AEM_S(5,23) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(5,25) = (-0.31943828249997*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(5,26) = -0.4472135954999579*cMrSelf[6]*mnuSelf; 
  data->AEM_S(5,27) = (-0.31943828249997*cMrSelf[7]*mnuSelf)-0.5000000000000001*cMrSelf[1]*mnuSelf; 
  data->AEM_S(5,29) = (-0.2981423969999719*cMrSelf[9]*mnuSelf)-0.4391550328268398*cMrSelf[2]*mnuSelf; 
  data->AEM_S(6,20) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(6,21) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(6,22) = -0.5000000000000001*cMrSelf[4]*mnuSelf; 
  data->AEM_S(6,23) = (-0.4391550328268399*cMrSelf[8]*mnuSelf)-0.4*cMrSelf[7]*mnuSelf-0.447213595499958*cMrSelf[1]*mnuSelf; 
  data->AEM_S(6,24) = (-0.31943828249997*cMrSelf[6]*mnuSelf)-0.5000000000000001*cMrSelf[2]*mnuSelf; 
  data->AEM_S(6,25) = -0.4472135954999579*cMrSelf[6]*mnuSelf; 
  data->AEM_S(6,26) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.31943828249997*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(6,27) = -0.4*cMrSelf[3]*mnuSelf; 
  data->AEM_S(6,28) = -0.4391550328268399*cMrSelf[3]*mnuSelf; 
  data->AEM_S(7,20) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(7,21) = -0.5000000000000001*cMrSelf[5]*mnuSelf; 
  data->AEM_S(7,22) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(7,23) = (-0.4391550328268399*cMrSelf[9]*mnuSelf)-0.4*cMrSelf[6]*mnuSelf-0.447213595499958*cMrSelf[2]*mnuSelf; 
  data->AEM_S(7,24) = -0.4472135954999579*cMrSelf[7]*mnuSelf; 
  data->AEM_S(7,25) = (-0.31943828249997*cMrSelf[7]*mnuSelf)-0.5000000000000001*cMrSelf[1]*mnuSelf; 
  data->AEM_S(7,26) = -0.4*cMrSelf[3]*mnuSelf; 
  data->AEM_S(7,27) = (-0.31943828249997*cMrSelf[5]*mnuSelf)-0.4472135954999579*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(7,29) = -0.4391550328268399*cMrSelf[3]*mnuSelf; 
  data->AEM_S(8,20) = -0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(8,21) = -0.4391550328268398*cMrSelf[4]*mnuSelf; 
  data->AEM_S(8,23) = -0.4391550328268399*cMrSelf[6]*mnuSelf; 
  data->AEM_S(8,24) = (-0.2981423969999719*cMrSelf[8]*mnuSelf)-0.4391550328268398*cMrSelf[1]*mnuSelf; 
  data->AEM_S(8,26) = -0.4391550328268399*cMrSelf[3]*mnuSelf; 
  data->AEM_S(8,28) = (-0.2981423969999719*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(9,20) = -0.5*cMrSelf[9]*mnuSelf; 
  data->AEM_S(9,22) = -0.4391550328268398*cMrSelf[5]*mnuSelf; 
  data->AEM_S(9,23) = -0.4391550328268399*cMrSelf[7]*mnuSelf; 
  data->AEM_S(9,25) = (-0.2981423969999719*cMrSelf[9]*mnuSelf)-0.4391550328268398*cMrSelf[2]*mnuSelf; 
  data->AEM_S(9,27) = -0.4391550328268399*cMrSelf[3]*mnuSelf; 
  data->AEM_S(9,29) = (-0.2981423969999719*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(0,50) = -0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(0,51) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(0,52) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(0,53) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(0,54) = -0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(0,55) = -0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(0,56) = -0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(0,57) = -0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(0,58) = -0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(0,59) = -0.5*cMrOther[9]*mnuOther; 
  data->AEM_S(1,50) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(1,51) = (-0.4472135954999579*cMrOther[4]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(1,52) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(1,53) = (-0.447213595499958*cMrOther[6]*mnuOther)-0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(1,54) = (-0.4391550328268398*cMrOther[8]*mnuOther)-0.4472135954999579*cMrOther[1]*mnuOther; 
  data->AEM_S(1,55) = -0.5000000000000001*cMrOther[7]*mnuOther; 
  data->AEM_S(1,56) = -0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(1,57) = -0.5000000000000001*cMrOther[5]*mnuOther; 
  data->AEM_S(1,58) = -0.4391550328268398*cMrOther[4]*mnuOther; 
  data->AEM_S(2,50) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(2,51) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(2,52) = (-0.4472135954999579*cMrOther[5]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(2,53) = (-0.447213595499958*cMrOther[7]*mnuOther)-0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(2,54) = -0.5000000000000001*cMrOther[6]*mnuOther; 
  data->AEM_S(2,55) = (-0.4391550328268398*cMrOther[9]*mnuOther)-0.4472135954999579*cMrOther[2]*mnuOther; 
  data->AEM_S(2,56) = -0.5000000000000001*cMrOther[4]*mnuOther; 
  data->AEM_S(2,57) = -0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(2,59) = -0.4391550328268398*cMrOther[5]*mnuOther; 
  data->AEM_S(3,50) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(3,51) = (-0.447213595499958*cMrOther[6]*mnuOther)-0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(3,52) = (-0.447213595499958*cMrOther[7]*mnuOther)-0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(3,53) = (-0.4472135954999579*cMrOther[5]*mnuOther)-0.4472135954999579*cMrOther[4]*mnuOther-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(3,54) = -0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(3,55) = -0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(3,56) = (-0.4391550328268399*cMrOther[8]*mnuOther)-0.4*cMrOther[7]*mnuOther-0.447213595499958*cMrOther[1]*mnuOther; 
  data->AEM_S(3,57) = (-0.4391550328268399*cMrOther[9]*mnuOther)-0.4*cMrOther[6]*mnuOther-0.447213595499958*cMrOther[2]*mnuOther; 
  data->AEM_S(3,58) = -0.4391550328268399*cMrOther[6]*mnuOther; 
  data->AEM_S(3,59) = -0.4391550328268399*cMrOther[7]*mnuOther; 
  data->AEM_S(4,50) = -0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(4,51) = (-0.4391550328268398*cMrOther[8]*mnuOther)-0.4472135954999579*cMrOther[1]*mnuOther; 
  data->AEM_S(4,52) = -0.5000000000000001*cMrOther[6]*mnuOther; 
  data->AEM_S(4,53) = -0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(4,54) = (-0.31943828249997*cMrOther[4]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(4,56) = (-0.31943828249997*cMrOther[6]*mnuOther)-0.5000000000000001*cMrOther[2]*mnuOther; 
  data->AEM_S(4,57) = -0.4472135954999579*cMrOther[7]*mnuOther; 
  data->AEM_S(4,58) = (-0.2981423969999719*cMrOther[8]*mnuOther)-0.4391550328268398*cMrOther[1]*mnuOther; 
  data->AEM_S(5,50) = -0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(5,51) = -0.5000000000000001*cMrOther[7]*mnuOther; 
  data->AEM_S(5,52) = (-0.4391550328268398*cMrOther[9]*mnuOther)-0.4472135954999579*cMrOther[2]*mnuOther; 
  data->AEM_S(5,53) = -0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(5,55) = (-0.31943828249997*cMrOther[5]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(5,56) = -0.4472135954999579*cMrOther[6]*mnuOther; 
  data->AEM_S(5,57) = (-0.31943828249997*cMrOther[7]*mnuOther)-0.5000000000000001*cMrOther[1]*mnuOther; 
  data->AEM_S(5,59) = (-0.2981423969999719*cMrOther[9]*mnuOther)-0.4391550328268398*cMrOther[2]*mnuOther; 
  data->AEM_S(6,50) = -0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(6,51) = -0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(6,52) = -0.5000000000000001*cMrOther[4]*mnuOther; 
  data->AEM_S(6,53) = (-0.4391550328268399*cMrOther[8]*mnuOther)-0.4*cMrOther[7]*mnuOther-0.447213595499958*cMrOther[1]*mnuOther; 
  data->AEM_S(6,54) = (-0.31943828249997*cMrOther[6]*mnuOther)-0.5000000000000001*cMrOther[2]*mnuOther; 
  data->AEM_S(6,55) = -0.4472135954999579*cMrOther[6]*mnuOther; 
  data->AEM_S(6,56) = (-0.4472135954999579*cMrOther[5]*mnuOther)-0.31943828249997*cMrOther[4]*mnuOther-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(6,57) = -0.4*cMrOther[3]*mnuOther; 
  data->AEM_S(6,58) = -0.4391550328268399*cMrOther[3]*mnuOther; 
  data->AEM_S(7,50) = -0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(7,51) = -0.5000000000000001*cMrOther[5]*mnuOther; 
  data->AEM_S(7,52) = -0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(7,53) = (-0.4391550328268399*cMrOther[9]*mnuOther)-0.4*cMrOther[6]*mnuOther-0.447213595499958*cMrOther[2]*mnuOther; 
  data->AEM_S(7,54) = -0.4472135954999579*cMrOther[7]*mnuOther; 
  data->AEM_S(7,55) = (-0.31943828249997*cMrOther[7]*mnuOther)-0.5000000000000001*cMrOther[1]*mnuOther; 
  data->AEM_S(7,56) = -0.4*cMrOther[3]*mnuOther; 
  data->AEM_S(7,57) = (-0.31943828249997*cMrOther[5]*mnuOther)-0.4472135954999579*cMrOther[4]*mnuOther-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(7,59) = -0.4391550328268399*cMrOther[3]*mnuOther; 
  data->AEM_S(8,50) = -0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(8,51) = -0.4391550328268398*cMrOther[4]*mnuOther; 
  data->AEM_S(8,53) = -0.4391550328268399*cMrOther[6]*mnuOther; 
  data->AEM_S(8,54) = (-0.2981423969999719*cMrOther[8]*mnuOther)-0.4391550328268398*cMrOther[1]*mnuOther; 
  data->AEM_S(8,56) = -0.4391550328268399*cMrOther[3]*mnuOther; 
  data->AEM_S(8,58) = (-0.2981423969999719*cMrOther[4]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(9,50) = -0.5*cMrOther[9]*mnuOther; 
  data->AEM_S(9,52) = -0.4391550328268398*cMrOther[5]*mnuOther; 
  data->AEM_S(9,53) = -0.4391550328268399*cMrOther[7]*mnuOther; 
  data->AEM_S(9,55) = (-0.2981423969999719*cMrOther[9]*mnuOther)-0.4391550328268398*cMrOther[2]*mnuOther; 
  data->AEM_S(9,57) = -0.4391550328268399*cMrOther[3]*mnuOther; 
  data->AEM_S(9,59) = (-0.2981423969999719*cMrOther[5]*mnuOther)-0.5*cMrOther[0]*mnuOther; 
  ...
  // ... Block from correction to momentum conservation (self) ... // 
  data->AEM_S(10,20) = -0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(10,21) = -0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(10,22) = -0.5*cMrSelf[12]*mnuSelf; 
  data->AEM_S(10,23) = -0.5*cMrSelf[13]*mnuSelf; 
  data->AEM_S(10,24) = -0.5*cMrSelf[14]*mnuSelf; 
  data->AEM_S(10,25) = -0.5*cMrSelf[15]*mnuSelf; 
  data->AEM_S(10,26) = -0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(10,27) = -0.5*cMrSelf[17]*mnuSelf; 
  data->AEM_S(10,28) = -0.5*cMrSelf[18]*mnuSelf; 
  data->AEM_S(10,29) = -0.5*cMrSelf[19]*mnuSelf; 
  data->AEM_S(11,20) = -0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(11,21) = (-0.4472135954999579*cMrSelf[14]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(11,22) = -0.5*cMrSelf[13]*mnuSelf; 
  data->AEM_S(11,23) = (-0.447213595499958*cMrSelf[16]*mnuSelf)-0.5*cMrSelf[12]*mnuSelf; 
  data->AEM_S(11,24) = (-0.4391550328268398*cMrSelf[18]*mnuSelf)-0.4472135954999579*cMrSelf[11]*mnuSelf; 
  data->AEM_S(11,25) = -0.5000000000000001*cMrSelf[17]*mnuSelf; 
  data->AEM_S(11,26) = -0.447213595499958*cMrSelf[13]*mnuSelf; 
  data->AEM_S(11,27) = -0.5000000000000001*cMrSelf[15]*mnuSelf; 
  data->AEM_S(11,28) = -0.4391550328268398*cMrSelf[14]*mnuSelf; 
  data->AEM_S(12,20) = -0.5*cMrSelf[12]*mnuSelf; 
  data->AEM_S(12,21) = -0.5*cMrSelf[13]*mnuSelf; 
  data->AEM_S(12,22) = (-0.4472135954999579*cMrSelf[15]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(12,23) = (-0.447213595499958*cMrSelf[17]*mnuSelf)-0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(12,24) = -0.5000000000000001*cMrSelf[16]*mnuSelf; 
  data->AEM_S(12,25) = (-0.4391550328268398*cMrSelf[19]*mnuSelf)-0.4472135954999579*cMrSelf[12]*mnuSelf; 
  data->AEM_S(12,26) = -0.5000000000000001*cMrSelf[14]*mnuSelf; 
  data->AEM_S(12,27) = -0.447213595499958*cMrSelf[13]*mnuSelf; 
  data->AEM_S(12,29) = -0.4391550328268398*cMrSelf[15]*mnuSelf; 
  data->AEM_S(13,20) = -0.5*cMrSelf[13]*mnuSelf; 
  data->AEM_S(13,21) = (-0.447213595499958*cMrSelf[16]*mnuSelf)-0.5*cMrSelf[12]*mnuSelf; 
  data->AEM_S(13,22) = (-0.447213595499958*cMrSelf[17]*mnuSelf)-0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(13,23) = (-0.4472135954999579*cMrSelf[15]*mnuSelf)-0.4472135954999579*cMrSelf[14]*mnuSelf-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(13,24) = -0.4472135954999579*cMrSelf[13]*mnuSelf; 
  data->AEM_S(13,25) = -0.4472135954999579*cMrSelf[13]*mnuSelf; 
  data->AEM_S(13,26) = (-0.4391550328268399*cMrSelf[18]*mnuSelf)-0.4*cMrSelf[17]*mnuSelf-0.447213595499958*cMrSelf[11]*mnuSelf; 
  data->AEM_S(13,27) = (-0.4391550328268399*cMrSelf[19]*mnuSelf)-0.4*cMrSelf[16]*mnuSelf-0.447213595499958*cMrSelf[12]*mnuSelf; 
  data->AEM_S(13,28) = -0.4391550328268399*cMrSelf[16]*mnuSelf; 
  data->AEM_S(13,29) = -0.4391550328268399*cMrSelf[17]*mnuSelf; 
  data->AEM_S(14,20) = -0.5*cMrSelf[14]*mnuSelf; 
  data->AEM_S(14,21) = (-0.4391550328268398*cMrSelf[18]*mnuSelf)-0.4472135954999579*cMrSelf[11]*mnuSelf; 
  data->AEM_S(14,22) = -0.5000000000000001*cMrSelf[16]*mnuSelf; 
  data->AEM_S(14,23) = -0.4472135954999579*cMrSelf[13]*mnuSelf; 
  data->AEM_S(14,24) = (-0.31943828249997*cMrSelf[14]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(14,26) = (-0.31943828249997*cMrSelf[16]*mnuSelf)-0.5000000000000001*cMrSelf[12]*mnuSelf; 
  data->AEM_S(14,27) = -0.4472135954999579*cMrSelf[17]*mnuSelf; 
  data->AEM_S(14,28) = (-0.2981423969999719*cMrSelf[18]*mnuSelf)-0.4391550328268398*cMrSelf[11]*mnuSelf; 
  data->AEM_S(15,20) = -0.5*cMrSelf[15]*mnuSelf; 
  data->AEM_S(15,21) = -0.5000000000000001*cMrSelf[17]*mnuSelf; 
  data->AEM_S(15,22) = (-0.4391550328268398*cMrSelf[19]*mnuSelf)-0.4472135954999579*cMrSelf[12]*mnuSelf; 
  data->AEM_S(15,23) = -0.4472135954999579*cMrSelf[13]*mnuSelf; 
  data->AEM_S(15,25) = (-0.31943828249997*cMrSelf[15]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(15,26) = -0.4472135954999579*cMrSelf[16]*mnuSelf; 
  data->AEM_S(15,27) = (-0.31943828249997*cMrSelf[17]*mnuSelf)-0.5000000000000001*cMrSelf[11]*mnuSelf; 
  data->AEM_S(15,29) = (-0.2981423969999719*cMrSelf[19]*mnuSelf)-0.4391550328268398*cMrSelf[12]*mnuSelf; 
  data->AEM_S(16,20) = -0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(16,21) = -0.447213595499958*cMrSelf[13]*mnuSelf; 
  data->AEM_S(16,22) = -0.5000000000000001*cMrSelf[14]*mnuSelf; 
  data->AEM_S(16,23) = (-0.4391550328268399*cMrSelf[18]*mnuSelf)-0.4*cMrSelf[17]*mnuSelf-0.447213595499958*cMrSelf[11]*mnuSelf; 
  data->AEM_S(16,24) = (-0.31943828249997*cMrSelf[16]*mnuSelf)-0.5000000000000001*cMrSelf[12]*mnuSelf; 
  data->AEM_S(16,25) = -0.4472135954999579*cMrSelf[16]*mnuSelf; 
  data->AEM_S(16,26) = (-0.4472135954999579*cMrSelf[15]*mnuSelf)-0.31943828249997*cMrSelf[14]*mnuSelf-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(16,27) = -0.4*cMrSelf[13]*mnuSelf; 
  data->AEM_S(16,28) = -0.4391550328268399*cMrSelf[13]*mnuSelf; 
  data->AEM_S(17,20) = -0.5*cMrSelf[17]*mnuSelf; 
  data->AEM_S(17,21) = -0.5000000000000001*cMrSelf[15]*mnuSelf; 
  data->AEM_S(17,22) = -0.447213595499958*cMrSelf[13]*mnuSelf; 
  data->AEM_S(17,23) = (-0.4391550328268399*cMrSelf[19]*mnuSelf)-0.4*cMrSelf[16]*mnuSelf-0.447213595499958*cMrSelf[12]*mnuSelf; 
  data->AEM_S(17,24) = -0.4472135954999579*cMrSelf[17]*mnuSelf; 
  data->AEM_S(17,25) = (-0.31943828249997*cMrSelf[17]*mnuSelf)-0.5000000000000001*cMrSelf[11]*mnuSelf; 
  data->AEM_S(17,26) = -0.4*cMrSelf[13]*mnuSelf; 
  data->AEM_S(17,27) = (-0.31943828249997*cMrSelf[15]*mnuSelf)-0.4472135954999579*cMrSelf[14]*mnuSelf-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(17,29) = -0.4391550328268399*cMrSelf[13]*mnuSelf; 
  data->AEM_S(18,20) = -0.5*cMrSelf[18]*mnuSelf; 
  data->AEM_S(18,21) = -0.4391550328268398*cMrSelf[14]*mnuSelf; 
  data->AEM_S(18,23) = -0.4391550328268399*cMrSelf[16]*mnuSelf; 
  data->AEM_S(18,24) = (-0.2981423969999719*cMrSelf[18]*mnuSelf)-0.4391550328268398*cMrSelf[11]*mnuSelf; 
  data->AEM_S(18,26) = -0.4391550328268399*cMrSelf[13]*mnuSelf; 
  data->AEM_S(18,28) = (-0.2981423969999719*cMrSelf[14]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(19,20) = -0.5*cMrSelf[19]*mnuSelf; 
  data->AEM_S(19,22) = -0.4391550328268398*cMrSelf[15]*mnuSelf; 
  data->AEM_S(19,23) = -0.4391550328268399*cMrSelf[17]*mnuSelf; 
  data->AEM_S(19,25) = (-0.2981423969999719*cMrSelf[19]*mnuSelf)-0.4391550328268398*cMrSelf[12]*mnuSelf; 
  data->AEM_S(19,27) = -0.4391550328268399*cMrSelf[13]*mnuSelf; 
  data->AEM_S(19,29) = (-0.2981423969999719*cMrSelf[15]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(10,50) = -0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(10,51) = -0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(10,52) = -0.5*cMrOther[12]*mnuOther; 
  data->AEM_S(10,53) = -0.5*cMrOther[13]*mnuOther; 
  data->AEM_S(10,54) = -0.5*cMrOther[14]*mnuOther; 
  data->AEM_S(10,55) = -0.5*cMrOther[15]*mnuOther; 
  data->AEM_S(10,56) = -0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(10,57) = -0.5*cMrOther[17]*mnuOther; 
  data->AEM_S(10,58) = -0.5*cMrOther[18]*mnuOther; 
  data->AEM_S(10,59) = -0.5*cMrOther[19]*mnuOther; 
  data->AEM_S(11,50) = -0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(11,51) = (-0.4472135954999579*cMrOther[14]*mnuOther)-0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(11,52) = -0.5*cMrOther[13]*mnuOther; 
  data->AEM_S(11,53) = (-0.447213595499958*cMrOther[16]*mnuOther)-0.5*cMrOther[12]*mnuOther; 
  data->AEM_S(11,54) = (-0.4391550328268398*cMrOther[18]*mnuOther)-0.4472135954999579*cMrOther[11]*mnuOther; 
  data->AEM_S(11,55) = -0.5000000000000001*cMrOther[17]*mnuOther; 
  data->AEM_S(11,56) = -0.447213595499958*cMrOther[13]*mnuOther; 
  data->AEM_S(11,57) = -0.5000000000000001*cMrOther[15]*mnuOther; 
  data->AEM_S(11,58) = -0.4391550328268398*cMrOther[14]*mnuOther; 
  data->AEM_S(12,50) = -0.5*cMrOther[12]*mnuOther; 
  data->AEM_S(12,51) = -0.5*cMrOther[13]*mnuOther; 
  data->AEM_S(12,52) = (-0.4472135954999579*cMrOther[15]*mnuOther)-0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(12,53) = (-0.447213595499958*cMrOther[17]*mnuOther)-0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(12,54) = -0.5000000000000001*cMrOther[16]*mnuOther; 
  data->AEM_S(12,55) = (-0.4391550328268398*cMrOther[19]*mnuOther)-0.4472135954999579*cMrOther[12]*mnuOther; 
  data->AEM_S(12,56) = -0.5000000000000001*cMrOther[14]*mnuOther; 
  data->AEM_S(12,57) = -0.447213595499958*cMrOther[13]*mnuOther; 
  data->AEM_S(12,59) = -0.4391550328268398*cMrOther[15]*mnuOther; 
  data->AEM_S(13,50) = -0.5*cMrOther[13]*mnuOther; 
  data->AEM_S(13,51) = (-0.447213595499958*cMrOther[16]*mnuOther)-0.5*cMrOther[12]*mnuOther; 
  data->AEM_S(13,52) = (-0.447213595499958*cMrOther[17]*mnuOther)-0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(13,53) = (-0.4472135954999579*cMrOther[15]*mnuOther)-0.4472135954999579*cMrOther[14]*mnuOther-0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(13,54) = -0.4472135954999579*cMrOther[13]*mnuOther; 
  data->AEM_S(13,55) = -0.4472135954999579*cMrOther[13]*mnuOther; 
  data->AEM_S(13,56) = (-0.4391550328268399*cMrOther[18]*mnuOther)-0.4*cMrOther[17]*mnuOther-0.447213595499958*cMrOther[11]*mnuOther; 
  data->AEM_S(13,57) = (-0.4391550328268399*cMrOther[19]*mnuOther)-0.4*cMrOther[16]*mnuOther-0.447213595499958*cMrOther[12]*mnuOther; 
  data->AEM_S(13,58) = -0.4391550328268399*cMrOther[16]*mnuOther; 
  data->AEM_S(13,59) = -0.4391550328268399*cMrOther[17]*mnuOther; 
  data->AEM_S(14,50) = -0.5*cMrOther[14]*mnuOther; 
  data->AEM_S(14,51) = (-0.4391550328268398*cMrOther[18]*mnuOther)-0.4472135954999579*cMrOther[11]*mnuOther; 
  data->AEM_S(14,52) = -0.5000000000000001*cMrOther[16]*mnuOther; 
  data->AEM_S(14,53) = -0.4472135954999579*cMrOther[13]*mnuOther; 
  data->AEM_S(14,54) = (-0.31943828249997*cMrOther[14]*mnuOther)-0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(14,56) = (-0.31943828249997*cMrOther[16]*mnuOther)-0.5000000000000001*cMrOther[12]*mnuOther; 
  data->AEM_S(14,57) = -0.4472135954999579*cMrOther[17]*mnuOther; 
  data->AEM_S(14,58) = (-0.2981423969999719*cMrOther[18]*mnuOther)-0.4391550328268398*cMrOther[11]*mnuOther; 
  data->AEM_S(15,50) = -0.5*cMrOther[15]*mnuOther; 
  data->AEM_S(15,51) = -0.5000000000000001*cMrOther[17]*mnuOther; 
  data->AEM_S(15,52) = (-0.4391550328268398*cMrOther[19]*mnuOther)-0.4472135954999579*cMrOther[12]*mnuOther; 
  data->AEM_S(15,53) = -0.4472135954999579*cMrOther[13]*mnuOther; 
  data->AEM_S(15,55) = (-0.31943828249997*cMrOther[15]*mnuOther)-0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(15,56) = -0.4472135954999579*cMrOther[16]*mnuOther; 
  data->AEM_S(15,57) = (-0.31943828249997*cMrOther[17]*mnuOther)-0.5000000000000001*cMrOther[11]*mnuOther; 
  data->AEM_S(15,59) = (-0.2981423969999719*cMrOther[19]*mnuOther)-0.4391550328268398*cMrOther[12]*mnuOther; 
  data->AEM_S(16,50) = -0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(16,51) = -0.447213595499958*cMrOther[13]*mnuOther; 
  data->AEM_S(16,52) = -0.5000000000000001*cMrOther[14]*mnuOther; 
  data->AEM_S(16,53) = (-0.4391550328268399*cMrOther[18]*mnuOther)-0.4*cMrOther[17]*mnuOther-0.447213595499958*cMrOther[11]*mnuOther; 
  data->AEM_S(16,54) = (-0.31943828249997*cMrOther[16]*mnuOther)-0.5000000000000001*cMrOther[12]*mnuOther; 
  data->AEM_S(16,55) = -0.4472135954999579*cMrOther[16]*mnuOther; 
  data->AEM_S(16,56) = (-0.4472135954999579*cMrOther[15]*mnuOther)-0.31943828249997*cMrOther[14]*mnuOther-0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(16,57) = -0.4*cMrOther[13]*mnuOther; 
  data->AEM_S(16,58) = -0.4391550328268399*cMrOther[13]*mnuOther; 
  data->AEM_S(17,50) = -0.5*cMrOther[17]*mnuOther; 
  data->AEM_S(17,51) = -0.5000000000000001*cMrOther[15]*mnuOther; 
  data->AEM_S(17,52) = -0.447213595499958*cMrOther[13]*mnuOther; 
  data->AEM_S(17,53) = (-0.4391550328268399*cMrOther[19]*mnuOther)-0.4*cMrOther[16]*mnuOther-0.447213595499958*cMrOther[12]*mnuOther; 
  data->AEM_S(17,54) = -0.4472135954999579*cMrOther[17]*mnuOther; 
  data->AEM_S(17,55) = (-0.31943828249997*cMrOther[17]*mnuOther)-0.5000000000000001*cMrOther[11]*mnuOther; 
  data->AEM_S(17,56) = -0.4*cMrOther[13]*mnuOther; 
  data->AEM_S(17,57) = (-0.31943828249997*cMrOther[15]*mnuOther)-0.4472135954999579*cMrOther[14]*mnuOther-0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(17,59) = -0.4391550328268399*cMrOther[13]*mnuOther; 
  data->AEM_S(18,50) = -0.5*cMrOther[18]*mnuOther; 
  data->AEM_S(18,51) = -0.4391550328268398*cMrOther[14]*mnuOther; 
  data->AEM_S(18,53) = -0.4391550328268399*cMrOther[16]*mnuOther; 
  data->AEM_S(18,54) = (-0.2981423969999719*cMrOther[18]*mnuOther)-0.4391550328268398*cMrOther[11]*mnuOther; 
  data->AEM_S(18,56) = -0.4391550328268399*cMrOther[13]*mnuOther; 
  data->AEM_S(18,58) = (-0.2981423969999719*cMrOther[14]*mnuOther)-0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(19,50) = -0.5*cMrOther[19]*mnuOther; 
  data->AEM_S(19,52) = -0.4391550328268398*cMrOther[15]*mnuOther; 
  data->AEM_S(19,53) = -0.4391550328268399*cMrOther[17]*mnuOther; 
  data->AEM_S(19,55) = (-0.2981423969999719*cMrOther[19]*mnuOther)-0.4391550328268398*cMrOther[12]*mnuOther; 
  data->AEM_S(19,57) = -0.4391550328268399*cMrOther[13]*mnuOther; 
  data->AEM_S(19,59) = (-0.2981423969999719*cMrOther[15]*mnuOther)-0.5*cMrOther[10]*mnuOther; 
  ...
  // ... Block from correction to energy conservation (self) ... // 
  data->AEM_S(20,20) = m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(20,21) = m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(20,22) = m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(20,23) = m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(20,24) = m0rSelf[4]*mnuSelf-0.5*cErSelf[4]*mnuSelf; 
  data->AEM_S(20,25) = m0rSelf[5]*mnuSelf-0.5*cErSelf[5]*mnuSelf; 
  data->AEM_S(20,26) = m0rSelf[6]*mnuSelf-0.5*cErSelf[6]*mnuSelf; 
  data->AEM_S(20,27) = m0rSelf[7]*mnuSelf-0.5*cErSelf[7]*mnuSelf; 
  data->AEM_S(20,28) = m0rSelf[8]*mnuSelf-0.5*cErSelf[8]*mnuSelf; 
  data->AEM_S(20,29) = m0rSelf[9]*mnuSelf-0.5*cErSelf[9]*mnuSelf; 
  data->AEM_S(21,20) = m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(21,21) = 0.8944271909999159*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(21,22) = m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(21,23) = 0.8944271909999161*m0rSelf[6]*mnuSelf-0.447213595499958*cErSelf[6]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(21,24) = 0.8783100656536796*m0rSelf[8]*mnuSelf-0.4391550328268398*cErSelf[8]*mnuSelf+0.8944271909999159*m0rSelf[1]*mnuSelf-0.4472135954999579*cErSelf[1]*mnuSelf; 
  data->AEM_S(21,25) = 1.0*m0rSelf[7]*mnuSelf-0.5000000000000001*cErSelf[7]*mnuSelf; 
  data->AEM_S(21,26) = 0.8944271909999161*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(21,27) = 1.0*m0rSelf[5]*mnuSelf-0.5000000000000001*cErSelf[5]*mnuSelf; 
  data->AEM_S(21,28) = 0.8783100656536796*m0rSelf[4]*mnuSelf-0.4391550328268398*cErSelf[4]*mnuSelf; 
  data->AEM_S(22,20) = m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(22,21) = m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(22,22) = 0.8944271909999159*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(22,23) = 0.8944271909999161*m0rSelf[7]*mnuSelf-0.447213595499958*cErSelf[7]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(22,24) = 1.0*m0rSelf[6]*mnuSelf-0.5000000000000001*cErSelf[6]*mnuSelf; 
  data->AEM_S(22,25) = 0.8783100656536796*m0rSelf[9]*mnuSelf-0.4391550328268398*cErSelf[9]*mnuSelf+0.8944271909999159*m0rSelf[2]*mnuSelf-0.4472135954999579*cErSelf[2]*mnuSelf; 
  data->AEM_S(22,26) = 1.0*m0rSelf[4]*mnuSelf-0.5000000000000001*cErSelf[4]*mnuSelf; 
  data->AEM_S(22,27) = 0.8944271909999161*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(22,29) = 0.8783100656536796*m0rSelf[5]*mnuSelf-0.4391550328268398*cErSelf[5]*mnuSelf; 
  data->AEM_S(23,20) = m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(23,21) = 0.8944271909999161*m0rSelf[6]*mnuSelf-0.447213595499958*cErSelf[6]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(23,22) = 0.8944271909999161*m0rSelf[7]*mnuSelf-0.447213595499958*cErSelf[7]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(23,23) = 0.8944271909999159*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+0.8944271909999159*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(23,24) = 0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(23,25) = 0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(23,26) = 0.8783100656536798*m0rSelf[8]*mnuSelf-0.4391550328268399*cErSelf[8]*mnuSelf+0.8*m0rSelf[7]*mnuSelf-0.4*cErSelf[7]*mnuSelf+0.8944271909999161*m0rSelf[1]*mnuSelf-0.447213595499958*cErSelf[1]*mnuSelf; 
  data->AEM_S(23,27) = 0.8783100656536798*m0rSelf[9]*mnuSelf-0.4391550328268399*cErSelf[9]*mnuSelf+0.8*m0rSelf[6]*mnuSelf-0.4*cErSelf[6]*mnuSelf+0.8944271909999161*m0rSelf[2]*mnuSelf-0.447213595499958*cErSelf[2]*mnuSelf; 
  data->AEM_S(23,28) = 0.8783100656536798*m0rSelf[6]*mnuSelf-0.4391550328268399*cErSelf[6]*mnuSelf; 
  data->AEM_S(23,29) = 0.8783100656536798*m0rSelf[7]*mnuSelf-0.4391550328268399*cErSelf[7]*mnuSelf; 
  data->AEM_S(24,20) = m0rSelf[4]*mnuSelf-0.5*cErSelf[4]*mnuSelf; 
  data->AEM_S(24,21) = 0.8783100656536796*m0rSelf[8]*mnuSelf-0.4391550328268398*cErSelf[8]*mnuSelf+0.8944271909999159*m0rSelf[1]*mnuSelf-0.4472135954999579*cErSelf[1]*mnuSelf; 
  data->AEM_S(24,22) = 1.0*m0rSelf[6]*mnuSelf-0.5000000000000001*cErSelf[6]*mnuSelf; 
  data->AEM_S(24,23) = 0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(24,24) = 0.6388765649999399*m0rSelf[4]*mnuSelf-0.31943828249997*cErSelf[4]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(24,26) = 0.6388765649999399*m0rSelf[6]*mnuSelf-0.31943828249997*cErSelf[6]*mnuSelf+1.0*m0rSelf[2]*mnuSelf-0.5000000000000001*cErSelf[2]*mnuSelf; 
  data->AEM_S(24,27) = 0.8944271909999159*m0rSelf[7]*mnuSelf-0.4472135954999579*cErSelf[7]*mnuSelf; 
  data->AEM_S(24,28) = 0.5962847939999438*m0rSelf[8]*mnuSelf-0.2981423969999719*cErSelf[8]*mnuSelf+0.8783100656536796*m0rSelf[1]*mnuSelf-0.4391550328268398*cErSelf[1]*mnuSelf; 
  data->AEM_S(25,20) = m0rSelf[5]*mnuSelf-0.5*cErSelf[5]*mnuSelf; 
  data->AEM_S(25,21) = 1.0*m0rSelf[7]*mnuSelf-0.5000000000000001*cErSelf[7]*mnuSelf; 
  data->AEM_S(25,22) = 0.8783100656536796*m0rSelf[9]*mnuSelf-0.4391550328268398*cErSelf[9]*mnuSelf+0.8944271909999159*m0rSelf[2]*mnuSelf-0.4472135954999579*cErSelf[2]*mnuSelf; 
  data->AEM_S(25,23) = 0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(25,25) = 0.6388765649999399*m0rSelf[5]*mnuSelf-0.31943828249997*cErSelf[5]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(25,26) = 0.8944271909999159*m0rSelf[6]*mnuSelf-0.4472135954999579*cErSelf[6]*mnuSelf; 
  data->AEM_S(25,27) = 0.6388765649999399*m0rSelf[7]*mnuSelf-0.31943828249997*cErSelf[7]*mnuSelf+1.0*m0rSelf[1]*mnuSelf-0.5000000000000001*cErSelf[1]*mnuSelf; 
  data->AEM_S(25,29) = 0.5962847939999438*m0rSelf[9]*mnuSelf-0.2981423969999719*cErSelf[9]*mnuSelf+0.8783100656536796*m0rSelf[2]*mnuSelf-0.4391550328268398*cErSelf[2]*mnuSelf; 
  data->AEM_S(26,20) = m0rSelf[6]*mnuSelf-0.5*cErSelf[6]*mnuSelf; 
  data->AEM_S(26,21) = 0.8944271909999161*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(26,22) = 1.0*m0rSelf[4]*mnuSelf-0.5000000000000001*cErSelf[4]*mnuSelf; 
  data->AEM_S(26,23) = 0.8783100656536798*m0rSelf[8]*mnuSelf-0.4391550328268399*cErSelf[8]*mnuSelf+0.8*m0rSelf[7]*mnuSelf-0.4*cErSelf[7]*mnuSelf+0.8944271909999161*m0rSelf[1]*mnuSelf-0.447213595499958*cErSelf[1]*mnuSelf; 
  data->AEM_S(26,24) = 0.6388765649999399*m0rSelf[6]*mnuSelf-0.31943828249997*cErSelf[6]*mnuSelf+1.0*m0rSelf[2]*mnuSelf-0.5000000000000001*cErSelf[2]*mnuSelf; 
  data->AEM_S(26,25) = 0.8944271909999159*m0rSelf[6]*mnuSelf-0.4472135954999579*cErSelf[6]*mnuSelf; 
  data->AEM_S(26,26) = 0.8944271909999159*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+0.6388765649999399*m0rSelf[4]*mnuSelf-0.31943828249997*cErSelf[4]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(26,27) = 0.8*m0rSelf[3]*mnuSelf-0.4*cErSelf[3]*mnuSelf; 
  data->AEM_S(26,28) = 0.8783100656536798*m0rSelf[3]*mnuSelf-0.4391550328268399*cErSelf[3]*mnuSelf; 
  data->AEM_S(27,20) = m0rSelf[7]*mnuSelf-0.5*cErSelf[7]*mnuSelf; 
  data->AEM_S(27,21) = 1.0*m0rSelf[5]*mnuSelf-0.5000000000000001*cErSelf[5]*mnuSelf; 
  data->AEM_S(27,22) = 0.8944271909999161*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(27,23) = 0.8783100656536798*m0rSelf[9]*mnuSelf-0.4391550328268399*cErSelf[9]*mnuSelf+0.8*m0rSelf[6]*mnuSelf-0.4*cErSelf[6]*mnuSelf+0.8944271909999161*m0rSelf[2]*mnuSelf-0.447213595499958*cErSelf[2]*mnuSelf; 
  data->AEM_S(27,24) = 0.8944271909999159*m0rSelf[7]*mnuSelf-0.4472135954999579*cErSelf[7]*mnuSelf; 
  data->AEM_S(27,25) = 0.6388765649999399*m0rSelf[7]*mnuSelf-0.31943828249997*cErSelf[7]*mnuSelf+1.0*m0rSelf[1]*mnuSelf-0.5000000000000001*cErSelf[1]*mnuSelf; 
  data->AEM_S(27,26) = 0.8*m0rSelf[3]*mnuSelf-0.4*cErSelf[3]*mnuSelf; 
  data->AEM_S(27,27) = 0.6388765649999399*m0rSelf[5]*mnuSelf-0.31943828249997*cErSelf[5]*mnuSelf+0.8944271909999159*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(27,29) = 0.8783100656536798*m0rSelf[3]*mnuSelf-0.4391550328268399*cErSelf[3]*mnuSelf; 
  data->AEM_S(28,20) = m0rSelf[8]*mnuSelf-0.5*cErSelf[8]*mnuSelf; 
  data->AEM_S(28,21) = 0.8783100656536796*m0rSelf[4]*mnuSelf-0.4391550328268398*cErSelf[4]*mnuSelf; 
  data->AEM_S(28,23) = 0.8783100656536798*m0rSelf[6]*mnuSelf-0.4391550328268399*cErSelf[6]*mnuSelf; 
  data->AEM_S(28,24) = 0.5962847939999438*m0rSelf[8]*mnuSelf-0.2981423969999719*cErSelf[8]*mnuSelf+0.8783100656536796*m0rSelf[1]*mnuSelf-0.4391550328268398*cErSelf[1]*mnuSelf; 
  data->AEM_S(28,26) = 0.8783100656536798*m0rSelf[3]*mnuSelf-0.4391550328268399*cErSelf[3]*mnuSelf; 
  data->AEM_S(28,28) = 0.5962847939999438*m0rSelf[4]*mnuSelf-0.2981423969999719*cErSelf[4]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(29,20) = m0rSelf[9]*mnuSelf-0.5*cErSelf[9]*mnuSelf; 
  data->AEM_S(29,22) = 0.8783100656536796*m0rSelf[5]*mnuSelf-0.4391550328268398*cErSelf[5]*mnuSelf; 
  data->AEM_S(29,23) = 0.8783100656536798*m0rSelf[7]*mnuSelf-0.4391550328268399*cErSelf[7]*mnuSelf; 
  data->AEM_S(29,25) = 0.5962847939999438*m0rSelf[9]*mnuSelf-0.2981423969999719*cErSelf[9]*mnuSelf+0.8783100656536796*m0rSelf[2]*mnuSelf-0.4391550328268398*cErSelf[2]*mnuSelf; 
  data->AEM_S(29,27) = 0.8783100656536798*m0rSelf[3]*mnuSelf-0.4391550328268399*cErSelf[3]*mnuSelf; 
  data->AEM_S(29,29) = 0.5962847939999438*m0rSelf[5]*mnuSelf-0.2981423969999719*cErSelf[5]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
 
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(20,50) = m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(20,51) = m0rOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(20,52) = m0rOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(20,53) = m0rOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(20,54) = m0rOther[4]*mnuOther-0.5*cErOther[4]*mnuOther; 
  data->AEM_S(20,55) = m0rOther[5]*mnuOther-0.5*cErOther[5]*mnuOther; 
  data->AEM_S(20,56) = m0rOther[6]*mnuOther-0.5*cErOther[6]*mnuOther; 
  data->AEM_S(20,57) = m0rOther[7]*mnuOther-0.5*cErOther[7]*mnuOther; 
  data->AEM_S(20,58) = m0rOther[8]*mnuOther-0.5*cErOther[8]*mnuOther; 
  data->AEM_S(20,59) = m0rOther[9]*mnuOther-0.5*cErOther[9]*mnuOther; 
  data->AEM_S(21,50) = m0rOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(21,51) = 0.8944271909999159*m0rOther[4]*mnuOther-0.4472135954999579*cErOther[4]*mnuOther+m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(21,52) = m0rOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(21,53) = 0.8944271909999161*m0rOther[6]*mnuOther-0.447213595499958*cErOther[6]*mnuOther+m0rOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(21,54) = 0.8783100656536796*m0rOther[8]*mnuOther-0.4391550328268398*cErOther[8]*mnuOther+0.8944271909999159*m0rOther[1]*mnuOther-0.4472135954999579*cErOther[1]*mnuOther; 
  data->AEM_S(21,55) = 1.0*m0rOther[7]*mnuOther-0.5000000000000001*cErOther[7]*mnuOther; 
  data->AEM_S(21,56) = 0.8944271909999161*m0rOther[3]*mnuOther-0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(21,57) = 1.0*m0rOther[5]*mnuOther-0.5000000000000001*cErOther[5]*mnuOther; 
  data->AEM_S(21,58) = 0.8783100656536796*m0rOther[4]*mnuOther-0.4391550328268398*cErOther[4]*mnuOther; 
  data->AEM_S(22,50) = m0rOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(22,51) = m0rOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(22,52) = 0.8944271909999159*m0rOther[5]*mnuOther-0.4472135954999579*cErOther[5]*mnuOther+m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(22,53) = 0.8944271909999161*m0rOther[7]*mnuOther-0.447213595499958*cErOther[7]*mnuOther+m0rOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(22,54) = 1.0*m0rOther[6]*mnuOther-0.5000000000000001*cErOther[6]*mnuOther; 
  data->AEM_S(22,55) = 0.8783100656536796*m0rOther[9]*mnuOther-0.4391550328268398*cErOther[9]*mnuOther+0.8944271909999159*m0rOther[2]*mnuOther-0.4472135954999579*cErOther[2]*mnuOther; 
  data->AEM_S(22,56) = 1.0*m0rOther[4]*mnuOther-0.5000000000000001*cErOther[4]*mnuOther; 
  data->AEM_S(22,57) = 0.8944271909999161*m0rOther[3]*mnuOther-0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(22,59) = 0.8783100656536796*m0rOther[5]*mnuOther-0.4391550328268398*cErOther[5]*mnuOther; 
  data->AEM_S(23,50) = m0rOther[3]*mnuOther-0.5*cErOther[3]*mnuOther; 
  data->AEM_S(23,51) = 0.8944271909999161*m0rOther[6]*mnuOther-0.447213595499958*cErOther[6]*mnuOther+m0rOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(23,52) = 0.8944271909999161*m0rOther[7]*mnuOther-0.447213595499958*cErOther[7]*mnuOther+m0rOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(23,53) = 0.8944271909999159*m0rOther[5]*mnuOther-0.4472135954999579*cErOther[5]*mnuOther+0.8944271909999159*m0rOther[4]*mnuOther-0.4472135954999579*cErOther[4]*mnuOther+m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(23,54) = 0.8944271909999159*m0rOther[3]*mnuOther-0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(23,55) = 0.8944271909999159*m0rOther[3]*mnuOther-0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(23,56) = 0.8783100656536798*m0rOther[8]*mnuOther-0.4391550328268399*cErOther[8]*mnuOther+0.8*m0rOther[7]*mnuOther-0.4*cErOther[7]*mnuOther+0.8944271909999161*m0rOther[1]*mnuOther-0.447213595499958*cErOther[1]*mnuOther; 
  data->AEM_S(23,57) = 0.8783100656536798*m0rOther[9]*mnuOther-0.4391550328268399*cErOther[9]*mnuOther+0.8*m0rOther[6]*mnuOther-0.4*cErOther[6]*mnuOther+0.8944271909999161*m0rOther[2]*mnuOther-0.447213595499958*cErOther[2]*mnuOther; 
  data->AEM_S(23,58) = 0.8783100656536798*m0rOther[6]*mnuOther-0.4391550328268399*cErOther[6]*mnuOther; 
  data->AEM_S(23,59) = 0.8783100656536798*m0rOther[7]*mnuOther-0.4391550328268399*cErOther[7]*mnuOther; 
  data->AEM_S(24,50) = m0rOther[4]*mnuOther-0.5*cErOther[4]*mnuOther; 
  data->AEM_S(24,51) = 0.8783100656536796*m0rOther[8]*mnuOther-0.4391550328268398*cErOther[8]*mnuOther+0.8944271909999159*m0rOther[1]*mnuOther-0.4472135954999579*cErOther[1]*mnuOther; 
  data->AEM_S(24,52) = 1.0*m0rOther[6]*mnuOther-0.5000000000000001*cErOther[6]*mnuOther; 
  data->AEM_S(24,53) = 0.8944271909999159*m0rOther[3]*mnuOther-0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(24,54) = 0.6388765649999399*m0rOther[4]*mnuOther-0.31943828249997*cErOther[4]*mnuOther+m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(24,56) = 0.6388765649999399*m0rOther[6]*mnuOther-0.31943828249997*cErOther[6]*mnuOther+1.0*m0rOther[2]*mnuOther-0.5000000000000001*cErOther[2]*mnuOther; 
  data->AEM_S(24,57) = 0.8944271909999159*m0rOther[7]*mnuOther-0.4472135954999579*cErOther[7]*mnuOther; 
  data->AEM_S(24,58) = 0.5962847939999438*m0rOther[8]*mnuOther-0.2981423969999719*cErOther[8]*mnuOther+0.8783100656536796*m0rOther[1]*mnuOther-0.4391550328268398*cErOther[1]*mnuOther; 
  data->AEM_S(25,50) = m0rOther[5]*mnuOther-0.5*cErOther[5]*mnuOther; 
  data->AEM_S(25,51) = 1.0*m0rOther[7]*mnuOther-0.5000000000000001*cErOther[7]*mnuOther; 
  data->AEM_S(25,52) = 0.8783100656536796*m0rOther[9]*mnuOther-0.4391550328268398*cErOther[9]*mnuOther+0.8944271909999159*m0rOther[2]*mnuOther-0.4472135954999579*cErOther[2]*mnuOther; 
  data->AEM_S(25,53) = 0.8944271909999159*m0rOther[3]*mnuOther-0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(25,55) = 0.6388765649999399*m0rOther[5]*mnuOther-0.31943828249997*cErOther[5]*mnuOther+m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(25,56) = 0.8944271909999159*m0rOther[6]*mnuOther-0.4472135954999579*cErOther[6]*mnuOther; 
  data->AEM_S(25,57) = 0.6388765649999399*m0rOther[7]*mnuOther-0.31943828249997*cErOther[7]*mnuOther+1.0*m0rOther[1]*mnuOther-0.5000000000000001*cErOther[1]*mnuOther; 
  data->AEM_S(25,59) = 0.5962847939999438*m0rOther[9]*mnuOther-0.2981423969999719*cErOther[9]*mnuOther+0.8783100656536796*m0rOther[2]*mnuOther-0.4391550328268398*cErOther[2]*mnuOther; 
  data->AEM_S(26,50) = m0rOther[6]*mnuOther-0.5*cErOther[6]*mnuOther; 
  data->AEM_S(26,51) = 0.8944271909999161*m0rOther[3]*mnuOther-0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(26,52) = 1.0*m0rOther[4]*mnuOther-0.5000000000000001*cErOther[4]*mnuOther; 
  data->AEM_S(26,53) = 0.8783100656536798*m0rOther[8]*mnuOther-0.4391550328268399*cErOther[8]*mnuOther+0.8*m0rOther[7]*mnuOther-0.4*cErOther[7]*mnuOther+0.8944271909999161*m0rOther[1]*mnuOther-0.447213595499958*cErOther[1]*mnuOther; 
  data->AEM_S(26,54) = 0.6388765649999399*m0rOther[6]*mnuOther-0.31943828249997*cErOther[6]*mnuOther+1.0*m0rOther[2]*mnuOther-0.5000000000000001*cErOther[2]*mnuOther; 
  data->AEM_S(26,55) = 0.8944271909999159*m0rOther[6]*mnuOther-0.4472135954999579*cErOther[6]*mnuOther; 
  data->AEM_S(26,56) = 0.8944271909999159*m0rOther[5]*mnuOther-0.4472135954999579*cErOther[5]*mnuOther+0.6388765649999399*m0rOther[4]*mnuOther-0.31943828249997*cErOther[4]*mnuOther+m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(26,57) = 0.8*m0rOther[3]*mnuOther-0.4*cErOther[3]*mnuOther; 
  data->AEM_S(26,58) = 0.8783100656536798*m0rOther[3]*mnuOther-0.4391550328268399*cErOther[3]*mnuOther; 
  data->AEM_S(27,50) = m0rOther[7]*mnuOther-0.5*cErOther[7]*mnuOther; 
  data->AEM_S(27,51) = 1.0*m0rOther[5]*mnuOther-0.5000000000000001*cErOther[5]*mnuOther; 
  data->AEM_S(27,52) = 0.8944271909999161*m0rOther[3]*mnuOther-0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(27,53) = 0.8783100656536798*m0rOther[9]*mnuOther-0.4391550328268399*cErOther[9]*mnuOther+0.8*m0rOther[6]*mnuOther-0.4*cErOther[6]*mnuOther+0.8944271909999161*m0rOther[2]*mnuOther-0.447213595499958*cErOther[2]*mnuOther; 
  data->AEM_S(27,54) = 0.8944271909999159*m0rOther[7]*mnuOther-0.4472135954999579*cErOther[7]*mnuOther; 
  data->AEM_S(27,55) = 0.6388765649999399*m0rOther[7]*mnuOther-0.31943828249997*cErOther[7]*mnuOther+1.0*m0rOther[1]*mnuOther-0.5000000000000001*cErOther[1]*mnuOther; 
  data->AEM_S(27,56) = 0.8*m0rOther[3]*mnuOther-0.4*cErOther[3]*mnuOther; 
  data->AEM_S(27,57) = 0.6388765649999399*m0rOther[5]*mnuOther-0.31943828249997*cErOther[5]*mnuOther+0.8944271909999159*m0rOther[4]*mnuOther-0.4472135954999579*cErOther[4]*mnuOther+m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(27,59) = 0.8783100656536798*m0rOther[3]*mnuOther-0.4391550328268399*cErOther[3]*mnuOther; 
  data->AEM_S(28,50) = m0rOther[8]*mnuOther-0.5*cErOther[8]*mnuOther; 
  data->AEM_S(28,51) = 0.8783100656536796*m0rOther[4]*mnuOther-0.4391550328268398*cErOther[4]*mnuOther; 
  data->AEM_S(28,53) = 0.8783100656536798*m0rOther[6]*mnuOther-0.4391550328268399*cErOther[6]*mnuOther; 
  data->AEM_S(28,54) = 0.5962847939999438*m0rOther[8]*mnuOther-0.2981423969999719*cErOther[8]*mnuOther+0.8783100656536796*m0rOther[1]*mnuOther-0.4391550328268398*cErOther[1]*mnuOther; 
  data->AEM_S(28,56) = 0.8783100656536798*m0rOther[3]*mnuOther-0.4391550328268399*cErOther[3]*mnuOther; 
  data->AEM_S(28,58) = 0.5962847939999438*m0rOther[4]*mnuOther-0.2981423969999719*cErOther[4]*mnuOther+m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  data->AEM_S(29,50) = m0rOther[9]*mnuOther-0.5*cErOther[9]*mnuOther; 
  data->AEM_S(29,52) = 0.8783100656536796*m0rOther[5]*mnuOther-0.4391550328268398*cErOther[5]*mnuOther; 
  data->AEM_S(29,53) = 0.8783100656536798*m0rOther[7]*mnuOther-0.4391550328268399*cErOther[7]*mnuOther; 
  data->AEM_S(29,55) = 0.5962847939999438*m0rOther[9]*mnuOther-0.2981423969999719*cErOther[9]*mnuOther+0.8783100656536796*m0rOther[2]*mnuOther-0.4391550328268398*cErOther[2]*mnuOther; 
  data->AEM_S(29,57) = 0.8783100656536798*m0rOther[3]*mnuOther-0.4391550328268399*cErOther[3]*mnuOther; 
  data->AEM_S(29,59) = 0.5962847939999438*m0rOther[5]*mnuOther-0.2981423969999719*cErOther[5]*mnuOther+m0rOther[0]*mnuOther-0.5*cErOther[0]*mnuOther; 
  ...
  // ... Block from correction to (self) 1st moment of collision operator ... // 
  data->AEM_S(30,20) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(30,21) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(30,22) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(30,23) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(30,24) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(30,25) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(30,26) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(30,27) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(30,28) = -0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(30,29) = -0.5*cMrSelf[9]*mnuSelf; 
  data->AEM_S(31,20) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(31,21) = (-0.4472135954999579*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(31,22) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(31,23) = (-0.447213595499958*cMrSelf[6]*mnuSelf)-0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(31,24) = (-0.4391550328268398*cMrSelf[8]*mnuSelf)-0.4472135954999579*cMrSelf[1]*mnuSelf; 
  data->AEM_S(31,25) = -0.5000000000000001*cMrSelf[7]*mnuSelf; 
  data->AEM_S(31,26) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(31,27) = -0.5000000000000001*cMrSelf[5]*mnuSelf; 
  data->AEM_S(31,28) = -0.4391550328268398*cMrSelf[4]*mnuSelf; 
  data->AEM_S(32,20) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(32,21) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(32,22) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(32,23) = (-0.447213595499958*cMrSelf[7]*mnuSelf)-0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(32,24) = -0.5000000000000001*cMrSelf[6]*mnuSelf; 
  data->AEM_S(32,25) = (-0.4391550328268398*cMrSelf[9]*mnuSelf)-0.4472135954999579*cMrSelf[2]*mnuSelf; 
  data->AEM_S(32,26) = -0.5000000000000001*cMrSelf[4]*mnuSelf; 
  data->AEM_S(32,27) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(32,29) = -0.4391550328268398*cMrSelf[5]*mnuSelf; 
  data->AEM_S(33,20) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(33,21) = (-0.447213595499958*cMrSelf[6]*mnuSelf)-0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(33,22) = (-0.447213595499958*cMrSelf[7]*mnuSelf)-0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(33,23) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.4472135954999579*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(33,24) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(33,25) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(33,26) = (-0.4391550328268399*cMrSelf[8]*mnuSelf)-0.4*cMrSelf[7]*mnuSelf-0.447213595499958*cMrSelf[1]*mnuSelf; 
  data->AEM_S(33,27) = (-0.4391550328268399*cMrSelf[9]*mnuSelf)-0.4*cMrSelf[6]*mnuSelf-0.447213595499958*cMrSelf[2]*mnuSelf; 
  data->AEM_S(33,28) = -0.4391550328268399*cMrSelf[6]*mnuSelf; 
  data->AEM_S(33,29) = -0.4391550328268399*cMrSelf[7]*mnuSelf; 
  data->AEM_S(34,20) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(34,21) = (-0.4391550328268398*cMrSelf[8]*mnuSelf)-0.4472135954999579*cMrSelf[1]*mnuSelf; 
  data->AEM_S(34,22) = -0.5000000000000001*cMrSelf[6]*mnuSelf; 
  data->AEM_S(34,23) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(34,24) = (-0.31943828249997*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(34,26) = (-0.31943828249997*cMrSelf[6]*mnuSelf)-0.5000000000000001*cMrSelf[2]*mnuSelf; 
  data->AEM_S(34,27) = -0.4472135954999579*cMrSelf[7]*mnuSelf; 
  data->AEM_S(34,28) = (-0.2981423969999719*cMrSelf[8]*mnuSelf)-0.4391550328268398*cMrSelf[1]*mnuSelf; 
  data->AEM_S(35,20) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(35,21) = -0.5000000000000001*cMrSelf[7]*mnuSelf; 
  data->AEM_S(35,22) = (-0.4391550328268398*cMrSelf[9]*mnuSelf)-0.4472135954999579*cMrSelf[2]*mnuSelf; 
  data->AEM_S(35,23) = -0.4472135954999579*cMrSelf[3]*mnuSelf; 
  data->AEM_S(35,25) = (-0.31943828249997*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(35,26) = -0.4472135954999579*cMrSelf[6]*mnuSelf; 
  data->AEM_S(35,27) = (-0.31943828249997*cMrSelf[7]*mnuSelf)-0.5000000000000001*cMrSelf[1]*mnuSelf; 
  data->AEM_S(35,29) = (-0.2981423969999719*cMrSelf[9]*mnuSelf)-0.4391550328268398*cMrSelf[2]*mnuSelf; 
  data->AEM_S(36,20) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(36,21) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(36,22) = -0.5000000000000001*cMrSelf[4]*mnuSelf; 
  data->AEM_S(36,23) = (-0.4391550328268399*cMrSelf[8]*mnuSelf)-0.4*cMrSelf[7]*mnuSelf-0.447213595499958*cMrSelf[1]*mnuSelf; 
  data->AEM_S(36,24) = (-0.31943828249997*cMrSelf[6]*mnuSelf)-0.5000000000000001*cMrSelf[2]*mnuSelf; 
  data->AEM_S(36,25) = -0.4472135954999579*cMrSelf[6]*mnuSelf; 
  data->AEM_S(36,26) = (-0.4472135954999579*cMrSelf[5]*mnuSelf)-0.31943828249997*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(36,27) = -0.4*cMrSelf[3]*mnuSelf; 
  data->AEM_S(36,28) = -0.4391550328268399*cMrSelf[3]*mnuSelf; 
  data->AEM_S(37,20) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(37,21) = -0.5000000000000001*cMrSelf[5]*mnuSelf; 
  data->AEM_S(37,22) = -0.447213595499958*cMrSelf[3]*mnuSelf; 
  data->AEM_S(37,23) = (-0.4391550328268399*cMrSelf[9]*mnuSelf)-0.4*cMrSelf[6]*mnuSelf-0.447213595499958*cMrSelf[2]*mnuSelf; 
  data->AEM_S(37,24) = -0.4472135954999579*cMrSelf[7]*mnuSelf; 
  data->AEM_S(37,25) = (-0.31943828249997*cMrSelf[7]*mnuSelf)-0.5000000000000001*cMrSelf[1]*mnuSelf; 
  data->AEM_S(37,26) = -0.4*cMrSelf[3]*mnuSelf; 
  data->AEM_S(37,27) = (-0.31943828249997*cMrSelf[5]*mnuSelf)-0.4472135954999579*cMrSelf[4]*mnuSelf-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(37,29) = -0.4391550328268399*cMrSelf[3]*mnuSelf; 
  data->AEM_S(38,20) = -0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(38,21) = -0.4391550328268398*cMrSelf[4]*mnuSelf; 
  data->AEM_S(38,23) = -0.4391550328268399*cMrSelf[6]*mnuSelf; 
  data->AEM_S(38,24) = (-0.2981423969999719*cMrSelf[8]*mnuSelf)-0.4391550328268398*cMrSelf[1]*mnuSelf; 
  data->AEM_S(38,26) = -0.4391550328268399*cMrSelf[3]*mnuSelf; 
  data->AEM_S(38,28) = (-0.2981423969999719*cMrSelf[4]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(39,20) = -0.5*cMrSelf[9]*mnuSelf; 
  data->AEM_S(39,22) = -0.4391550328268398*cMrSelf[5]*mnuSelf; 
  data->AEM_S(39,23) = -0.4391550328268399*cMrSelf[7]*mnuSelf; 
  data->AEM_S(39,25) = (-0.2981423969999719*cMrSelf[9]*mnuSelf)-0.4391550328268398*cMrSelf[2]*mnuSelf; 
  data->AEM_S(39,27) = -0.4391550328268399*cMrSelf[3]*mnuSelf; 
  data->AEM_S(39,29) = (-0.2981423969999719*cMrSelf[5]*mnuSelf)-0.5*cMrSelf[0]*mnuSelf; 
  ...
  // ... Block from correction to (other) 1st moment of collision operator ... // 
  data->AEM_S(30,50) = 0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(30,51) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(30,52) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(30,53) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(30,54) = 0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(30,55) = 0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(30,56) = 0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(30,57) = 0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(30,58) = 0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(30,59) = 0.5*cMrOther[9]*mnuOther; 
  data->AEM_S(31,50) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(31,51) = 0.4472135954999579*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(31,52) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(31,53) = 0.447213595499958*cMrOther[6]*mnuOther+0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(31,54) = 0.4391550328268398*cMrOther[8]*mnuOther+0.4472135954999579*cMrOther[1]*mnuOther; 
  data->AEM_S(31,55) = 0.5000000000000001*cMrOther[7]*mnuOther; 
  data->AEM_S(31,56) = 0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(31,57) = 0.5000000000000001*cMrOther[5]*mnuOther; 
  data->AEM_S(31,58) = 0.4391550328268398*cMrOther[4]*mnuOther; 
  data->AEM_S(32,50) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(32,51) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(32,52) = 0.4472135954999579*cMrOther[5]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(32,53) = 0.447213595499958*cMrOther[7]*mnuOther+0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(32,54) = 0.5000000000000001*cMrOther[6]*mnuOther; 
  data->AEM_S(32,55) = 0.4391550328268398*cMrOther[9]*mnuOther+0.4472135954999579*cMrOther[2]*mnuOther; 
  data->AEM_S(32,56) = 0.5000000000000001*cMrOther[4]*mnuOther; 
  data->AEM_S(32,57) = 0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(32,59) = 0.4391550328268398*cMrOther[5]*mnuOther; 
  data->AEM_S(33,50) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(33,51) = 0.447213595499958*cMrOther[6]*mnuOther+0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(33,52) = 0.447213595499958*cMrOther[7]*mnuOther+0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(33,53) = 0.4472135954999579*cMrOther[5]*mnuOther+0.4472135954999579*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(33,54) = 0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(33,55) = 0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(33,56) = 0.4391550328268399*cMrOther[8]*mnuOther+0.4*cMrOther[7]*mnuOther+0.447213595499958*cMrOther[1]*mnuOther; 
  data->AEM_S(33,57) = 0.4391550328268399*cMrOther[9]*mnuOther+0.4*cMrOther[6]*mnuOther+0.447213595499958*cMrOther[2]*mnuOther; 
  data->AEM_S(33,58) = 0.4391550328268399*cMrOther[6]*mnuOther; 
  data->AEM_S(33,59) = 0.4391550328268399*cMrOther[7]*mnuOther; 
  data->AEM_S(34,50) = 0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(34,51) = 0.4391550328268398*cMrOther[8]*mnuOther+0.4472135954999579*cMrOther[1]*mnuOther; 
  data->AEM_S(34,52) = 0.5000000000000001*cMrOther[6]*mnuOther; 
  data->AEM_S(34,53) = 0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(34,54) = 0.31943828249997*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(34,56) = 0.31943828249997*cMrOther[6]*mnuOther+0.5000000000000001*cMrOther[2]*mnuOther; 
  data->AEM_S(34,57) = 0.4472135954999579*cMrOther[7]*mnuOther; 
  data->AEM_S(34,58) = 0.2981423969999719*cMrOther[8]*mnuOther+0.4391550328268398*cMrOther[1]*mnuOther; 
  data->AEM_S(35,50) = 0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(35,51) = 0.5000000000000001*cMrOther[7]*mnuOther; 
  data->AEM_S(35,52) = 0.4391550328268398*cMrOther[9]*mnuOther+0.4472135954999579*cMrOther[2]*mnuOther; 
  data->AEM_S(35,53) = 0.4472135954999579*cMrOther[3]*mnuOther; 
  data->AEM_S(35,55) = 0.31943828249997*cMrOther[5]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(35,56) = 0.4472135954999579*cMrOther[6]*mnuOther; 
  data->AEM_S(35,57) = 0.31943828249997*cMrOther[7]*mnuOther+0.5000000000000001*cMrOther[1]*mnuOther; 
  data->AEM_S(35,59) = 0.2981423969999719*cMrOther[9]*mnuOther+0.4391550328268398*cMrOther[2]*mnuOther; 
  data->AEM_S(36,50) = 0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(36,51) = 0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(36,52) = 0.5000000000000001*cMrOther[4]*mnuOther; 
  data->AEM_S(36,53) = 0.4391550328268399*cMrOther[8]*mnuOther+0.4*cMrOther[7]*mnuOther+0.447213595499958*cMrOther[1]*mnuOther; 
  data->AEM_S(36,54) = 0.31943828249997*cMrOther[6]*mnuOther+0.5000000000000001*cMrOther[2]*mnuOther; 
  data->AEM_S(36,55) = 0.4472135954999579*cMrOther[6]*mnuOther; 
  data->AEM_S(36,56) = 0.4472135954999579*cMrOther[5]*mnuOther+0.31943828249997*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(36,57) = 0.4*cMrOther[3]*mnuOther; 
  data->AEM_S(36,58) = 0.4391550328268399*cMrOther[3]*mnuOther; 
  data->AEM_S(37,50) = 0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(37,51) = 0.5000000000000001*cMrOther[5]*mnuOther; 
  data->AEM_S(37,52) = 0.447213595499958*cMrOther[3]*mnuOther; 
  data->AEM_S(37,53) = 0.4391550328268399*cMrOther[9]*mnuOther+0.4*cMrOther[6]*mnuOther+0.447213595499958*cMrOther[2]*mnuOther; 
  data->AEM_S(37,54) = 0.4472135954999579*cMrOther[7]*mnuOther; 
  data->AEM_S(37,55) = 0.31943828249997*cMrOther[7]*mnuOther+0.5000000000000001*cMrOther[1]*mnuOther; 
  data->AEM_S(37,56) = 0.4*cMrOther[3]*mnuOther; 
  data->AEM_S(37,57) = 0.31943828249997*cMrOther[5]*mnuOther+0.4472135954999579*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(37,59) = 0.4391550328268399*cMrOther[3]*mnuOther; 
  data->AEM_S(38,50) = 0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(38,51) = 0.4391550328268398*cMrOther[4]*mnuOther; 
  data->AEM_S(38,53) = 0.4391550328268399*cMrOther[6]*mnuOther; 
  data->AEM_S(38,54) = 0.2981423969999719*cMrOther[8]*mnuOther+0.4391550328268398*cMrOther[1]*mnuOther; 
  data->AEM_S(38,56) = 0.4391550328268399*cMrOther[3]*mnuOther; 
  data->AEM_S(38,58) = 0.2981423969999719*cMrOther[4]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(39,50) = 0.5*cMrOther[9]*mnuOther; 
  data->AEM_S(39,52) = 0.4391550328268398*cMrOther[5]*mnuOther; 
  data->AEM_S(39,53) = 0.4391550328268399*cMrOther[7]*mnuOther; 
  data->AEM_S(39,55) = 0.2981423969999719*cMrOther[9]*mnuOther+0.4391550328268398*cMrOther[2]*mnuOther; 
  data->AEM_S(39,57) = 0.4391550328268399*cMrOther[3]*mnuOther; 
  data->AEM_S(39,59) = 0.2981423969999719*cMrOther[5]*mnuOther+0.5*cMrOther[0]*mnuOther; 
  ...
  // ... Divide (m0Other*m1SelfX-m0Self*m1OtherX)/(mnuSelf*m0Self+mnuOther*m0Other) ... // 
  // Compute m0Other*m1Self-m0Self*m1Other. 
  m1EffD[0] = 0.5*m0rOther[9]*m1rSelf[9]-0.5*m0rSelf[9]*m1rOther[9]+0.5*m0rOther[8]*m1rSelf[8]-0.5*m0rSelf[8]*m1rOther[8]+0.5*m0rOther[7]*m1rSelf[7]-0.5*m0rSelf[7]*m1rOther[7]+0.5*m0rOther[6]*m1rSelf[6]-0.5*m0rSelf[6]*m1rOther[6]+0.5*m0rOther[5]*m1rSelf[5]-0.5*m0rSelf[5]*m1rOther[5]+0.5*m0rOther[4]*m1rSelf[4]-0.5*m0rSelf[4]*m1rOther[4]+0.5*m0rOther[3]*m1rSelf[3]-0.5*m0rSelf[3]*m1rOther[3]+0.5*m0rOther[2]*m1rSelf[2]-0.5*m0rSelf[2]*m1rOther[2]+0.5*m0rOther[1]*m1rSelf[1]-0.5*m0rSelf[1]*m1rOther[1]+0.5*m0rOther[0]*m1rSelf[0]-0.5*m0rSelf[0]*m1rOther[0]; 
  m1EffD[1] = 0.4391550328268398*m0rOther[4]*m1rSelf[8]-0.4391550328268398*m0rSelf[4]*m1rOther[8]-0.4391550328268398*m1rOther[4]*m0rSelf[8]+0.4391550328268398*m1rSelf[4]*m0rOther[8]+0.5000000000000001*m0rOther[5]*m1rSelf[7]-0.5000000000000001*m0rSelf[5]*m1rOther[7]-0.5000000000000001*m1rOther[5]*m0rSelf[7]+0.5000000000000001*m1rSelf[5]*m0rOther[7]+0.447213595499958*m0rOther[3]*m1rSelf[6]-0.447213595499958*m0rSelf[3]*m1rOther[6]-0.447213595499958*m1rOther[3]*m0rSelf[6]+0.447213595499958*m1rSelf[3]*m0rOther[6]+0.4472135954999579*m0rOther[1]*m1rSelf[4]-0.4472135954999579*m0rSelf[1]*m1rOther[4]-0.4472135954999579*m1rOther[1]*m0rSelf[4]+0.4472135954999579*m1rSelf[1]*m0rOther[4]+0.5*m0rOther[2]*m1rSelf[3]-0.5*m0rSelf[2]*m1rOther[3]-0.5*m1rOther[2]*m0rSelf[3]+0.5*m1rSelf[2]*m0rOther[3]+0.5*m0rOther[0]*m1rSelf[1]-0.5*m0rSelf[0]*m1rOther[1]-0.5*m1rOther[0]*m0rSelf[1]+0.5*m1rSelf[0]*m0rOther[1]; 
  m1EffD[2] = 0.4391550328268398*m0rOther[5]*m1rSelf[9]-0.4391550328268398*m0rSelf[5]*m1rOther[9]-0.4391550328268398*m1rOther[5]*m0rSelf[9]+0.4391550328268398*m1rSelf[5]*m0rOther[9]+0.447213595499958*m0rOther[3]*m1rSelf[7]-0.447213595499958*m0rSelf[3]*m1rOther[7]-0.447213595499958*m1rOther[3]*m0rSelf[7]+0.447213595499958*m1rSelf[3]*m0rOther[7]+0.5000000000000001*m0rOther[4]*m1rSelf[6]-0.5000000000000001*m0rSelf[4]*m1rOther[6]-0.5000000000000001*m1rOther[4]*m0rSelf[6]+0.5000000000000001*m1rSelf[4]*m0rOther[6]+0.4472135954999579*m0rOther[2]*m1rSelf[5]-0.4472135954999579*m0rSelf[2]*m1rOther[5]-0.4472135954999579*m1rOther[2]*m0rSelf[5]+0.4472135954999579*m1rSelf[2]*m0rOther[5]+0.5*m0rOther[1]*m1rSelf[3]-0.5*m0rSelf[1]*m1rOther[3]-0.5*m1rOther[1]*m0rSelf[3]+0.5*m1rSelf[1]*m0rOther[3]+0.5*m0rOther[0]*m1rSelf[2]-0.5*m0rSelf[0]*m1rOther[2]-0.5*m1rOther[0]*m0rSelf[2]+0.5*m1rSelf[0]*m0rOther[2]; 
  m1EffD[3] = 0.4391550328268399*m0rOther[7]*m1rSelf[9]-0.4391550328268399*m0rSelf[7]*m1rOther[9]-0.4391550328268399*m1rOther[7]*m0rSelf[9]+0.4391550328268399*m1rSelf[7]*m0rOther[9]+0.4391550328268399*m0rOther[6]*m1rSelf[8]-0.4391550328268399*m0rSelf[6]*m1rOther[8]-0.4391550328268399*m1rOther[6]*m0rSelf[8]+0.4391550328268399*m1rSelf[6]*m0rOther[8]+0.4*m0rOther[6]*m1rSelf[7]+0.447213595499958*m0rOther[2]*m1rSelf[7]-0.4*m0rSelf[6]*m1rOther[7]-0.447213595499958*m0rSelf[2]*m1rOther[7]-0.4*m1rOther[6]*m0rSelf[7]-0.447213595499958*m1rOther[2]*m0rSelf[7]+0.4*m1rSelf[6]*m0rOther[7]+0.447213595499958*m1rSelf[2]*m0rOther[7]+0.447213595499958*m0rOther[1]*m1rSelf[6]-0.447213595499958*m0rSelf[1]*m1rOther[6]-0.447213595499958*m1rOther[1]*m0rSelf[6]+0.447213595499958*m1rSelf[1]*m0rOther[6]+0.4472135954999579*m0rOther[3]*m1rSelf[5]-0.4472135954999579*m0rSelf[3]*m1rOther[5]-0.4472135954999579*m1rOther[3]*m0rSelf[5]+0.4472135954999579*m1rSelf[3]*m0rOther[5]+0.4472135954999579*m0rOther[3]*m1rSelf[4]-0.4472135954999579*m0rSelf[3]*m1rOther[4]-0.4472135954999579*m1rOther[3]*m0rSelf[4]+0.4472135954999579*m1rSelf[3]*m0rOther[4]+0.5*m0rOther[0]*m1rSelf[3]-0.5*m0rSelf[0]*m1rOther[3]-0.5*m1rOther[0]*m0rSelf[3]+0.5*m1rSelf[0]*m0rOther[3]+0.5*m0rOther[1]*m1rSelf[2]-0.5*m0rSelf[1]*m1rOther[2]-0.5*m1rOther[1]*m0rSelf[2]+0.5*m1rSelf[1]*m0rOther[2]; 
  m1EffD[4] = 0.2981423969999719*m0rOther[8]*m1rSelf[8]+0.4391550328268398*m0rOther[1]*m1rSelf[8]-0.2981423969999719*m0rSelf[8]*m1rOther[8]-0.4391550328268398*m0rSelf[1]*m1rOther[8]-0.4391550328268398*m1rOther[1]*m0rSelf[8]+0.4391550328268398*m1rSelf[1]*m0rOther[8]+0.4472135954999579*m0rOther[7]*m1rSelf[7]-0.4472135954999579*m0rSelf[7]*m1rOther[7]+0.31943828249997*m0rOther[6]*m1rSelf[6]+0.5000000000000001*m0rOther[2]*m1rSelf[6]-0.31943828249997*m0rSelf[6]*m1rOther[6]-0.5000000000000001*m0rSelf[2]*m1rOther[6]-0.5000000000000001*m1rOther[2]*m0rSelf[6]+0.5000000000000001*m1rSelf[2]*m0rOther[6]+0.31943828249997*m0rOther[4]*m1rSelf[4]+0.5*m0rOther[0]*m1rSelf[4]-0.31943828249997*m0rSelf[4]*m1rOther[4]-0.5*m0rSelf[0]*m1rOther[4]-0.5*m1rOther[0]*m0rSelf[4]+0.5*m1rSelf[0]*m0rOther[4]+0.4472135954999579*m0rOther[3]*m1rSelf[3]-0.4472135954999579*m0rSelf[3]*m1rOther[3]+0.4472135954999579*m0rOther[1]*m1rSelf[1]-0.4472135954999579*m0rSelf[1]*m1rOther[1]; 
  m1EffD[5] = 0.2981423969999719*m0rOther[9]*m1rSelf[9]+0.4391550328268398*m0rOther[2]*m1rSelf[9]-0.2981423969999719*m0rSelf[9]*m1rOther[9]-0.4391550328268398*m0rSelf[2]*m1rOther[9]-0.4391550328268398*m1rOther[2]*m0rSelf[9]+0.4391550328268398*m1rSelf[2]*m0rOther[9]+0.31943828249997*m0rOther[7]*m1rSelf[7]+0.5000000000000001*m0rOther[1]*m1rSelf[7]-0.31943828249997*m0rSelf[7]*m1rOther[7]-0.5000000000000001*m0rSelf[1]*m1rOther[7]-0.5000000000000001*m1rOther[1]*m0rSelf[7]+0.5000000000000001*m1rSelf[1]*m0rOther[7]+0.4472135954999579*m0rOther[6]*m1rSelf[6]-0.4472135954999579*m0rSelf[6]*m1rOther[6]+0.31943828249997*m0rOther[5]*m1rSelf[5]+0.5*m0rOther[0]*m1rSelf[5]-0.31943828249997*m0rSelf[5]*m1rOther[5]-0.5*m0rSelf[0]*m1rOther[5]-0.5*m1rOther[0]*m0rSelf[5]+0.5*m1rSelf[0]*m0rOther[5]+0.4472135954999579*m0rOther[3]*m1rSelf[3]-0.4472135954999579*m0rSelf[3]*m1rOther[3]+0.4472135954999579*m0rOther[2]*m1rSelf[2]-0.4472135954999579*m0rSelf[2]*m1rOther[2]; 
  m1EffD[6] = 0.4391550328268399*m0rOther[3]*m1rSelf[8]-0.4391550328268399*m0rSelf[3]*m1rOther[8]-0.4391550328268399*m1rOther[3]*m0rSelf[8]+0.4391550328268399*m1rSelf[3]*m0rOther[8]+0.4*m0rOther[3]*m1rSelf[7]-0.4*m0rSelf[3]*m1rOther[7]-0.4*m1rOther[3]*m0rSelf[7]+0.4*m1rSelf[3]*m0rOther[7]+0.4472135954999579*m0rOther[5]*m1rSelf[6]+0.31943828249997*m0rOther[4]*m1rSelf[6]+0.5*m0rOther[0]*m1rSelf[6]-0.4472135954999579*m0rSelf[5]*m1rOther[6]-0.31943828249997*m0rSelf[4]*m1rOther[6]-0.5*m0rSelf[0]*m1rOther[6]-0.4472135954999579*m1rOther[5]*m0rSelf[6]-0.31943828249997*m1rOther[4]*m0rSelf[6]-0.5*m1rOther[0]*m0rSelf[6]+0.4472135954999579*m1rSelf[5]*m0rOther[6]+0.31943828249997*m1rSelf[4]*m0rOther[6]+0.5*m1rSelf[0]*m0rOther[6]+0.5000000000000001*m0rOther[2]*m1rSelf[4]-0.5000000000000001*m0rSelf[2]*m1rOther[4]-0.5000000000000001*m1rOther[2]*m0rSelf[4]+0.5000000000000001*m1rSelf[2]*m0rOther[4]+0.447213595499958*m0rOther[1]*m1rSelf[3]-0.447213595499958*m0rSelf[1]*m1rOther[3]-0.447213595499958*m1rOther[1]*m0rSelf[3]+0.447213595499958*m1rSelf[1]*m0rOther[3]; 
  m1EffD[7] = 0.4391550328268399*m0rOther[3]*m1rSelf[9]-0.4391550328268399*m0rSelf[3]*m1rOther[9]-0.4391550328268399*m1rOther[3]*m0rSelf[9]+0.4391550328268399*m1rSelf[3]*m0rOther[9]+0.31943828249997*m0rOther[5]*m1rSelf[7]+0.4472135954999579*m0rOther[4]*m1rSelf[7]+0.5*m0rOther[0]*m1rSelf[7]-0.31943828249997*m0rSelf[5]*m1rOther[7]-0.4472135954999579*m0rSelf[4]*m1rOther[7]-0.5*m0rSelf[0]*m1rOther[7]-0.31943828249997*m1rOther[5]*m0rSelf[7]-0.4472135954999579*m1rOther[4]*m0rSelf[7]-0.5*m1rOther[0]*m0rSelf[7]+0.31943828249997*m1rSelf[5]*m0rOther[7]+0.4472135954999579*m1rSelf[4]*m0rOther[7]+0.5*m1rSelf[0]*m0rOther[7]+0.4*m0rOther[3]*m1rSelf[6]-0.4*m0rSelf[3]*m1rOther[6]-0.4*m1rOther[3]*m0rSelf[6]+0.4*m1rSelf[3]*m0rOther[6]+0.5000000000000001*m0rOther[1]*m1rSelf[5]-0.5000000000000001*m0rSelf[1]*m1rOther[5]-0.5000000000000001*m1rOther[1]*m0rSelf[5]+0.5000000000000001*m1rSelf[1]*m0rOther[5]+0.447213595499958*m0rOther[2]*m1rSelf[3]-0.447213595499958*m0rSelf[2]*m1rOther[3]-0.447213595499958*m1rOther[2]*m0rSelf[3]+0.447213595499958*m1rSelf[2]*m0rOther[3]; 
  m1EffD[8] = 0.2981423969999719*m0rOther[4]*m1rSelf[8]+0.5*m0rOther[0]*m1rSelf[8]-0.2981423969999719*m0rSelf[4]*m1rOther[8]-0.5*m0rSelf[0]*m1rOther[8]-0.2981423969999719*m1rOther[4]*m0rSelf[8]-0.5*m1rOther[0]*m0rSelf[8]+0.2981423969999719*m1rSelf[4]*m0rOther[8]+0.5*m1rSelf[0]*m0rOther[8]+0.4391550328268399*m0rOther[3]*m1rSelf[6]-0.4391550328268399*m0rSelf[3]*m1rOther[6]-0.4391550328268399*m1rOther[3]*m0rSelf[6]+0.4391550328268399*m1rSelf[3]*m0rOther[6]+0.4391550328268398*m0rOther[1]*m1rSelf[4]-0.4391550328268398*m0rSelf[1]*m1rOther[4]-0.4391550328268398*m1rOther[1]*m0rSelf[4]+0.4391550328268398*m1rSelf[1]*m0rOther[4]; 
  m1EffD[9] = 0.2981423969999719*m0rOther[5]*m1rSelf[9]+0.5*m0rOther[0]*m1rSelf[9]-0.2981423969999719*m0rSelf[5]*m1rOther[9]-0.5*m0rSelf[0]*m1rOther[9]-0.2981423969999719*m1rOther[5]*m0rSelf[9]-0.5*m1rOther[0]*m0rSelf[9]+0.2981423969999719*m1rSelf[5]*m0rOther[9]+0.5*m1rSelf[0]*m0rOther[9]+0.4391550328268399*m0rOther[3]*m1rSelf[7]-0.4391550328268399*m0rSelf[3]*m1rOther[7]-0.4391550328268399*m1rOther[3]*m0rSelf[7]+0.4391550328268399*m1rSelf[3]*m0rOther[7]+0.4391550328268398*m0rOther[2]*m1rSelf[5]-0.4391550328268398*m0rSelf[2]*m1rOther[5]-0.4391550328268398*m1rOther[2]*m0rSelf[5]+0.4391550328268398*m1rSelf[2]*m0rOther[5]; 
  // Fill AEM matrix. 
  ...
  // ... Block from correction to (self) 1st moment of collision operator ... // 
  data->AEM_S(40,20) = -0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(40,21) = -0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(40,22) = -0.5*cMrSelf[12]*mnuSelf; 
  data->AEM_S(40,23) = -0.5*cMrSelf[13]*mnuSelf; 
  data->AEM_S(40,24) = -0.5*cMrSelf[14]*mnuSelf; 
  data->AEM_S(40,25) = -0.5*cMrSelf[15]*mnuSelf; 
  data->AEM_S(40,26) = -0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(40,27) = -0.5*cMrSelf[17]*mnuSelf; 
  data->AEM_S(40,28) = -0.5*cMrSelf[18]*mnuSelf; 
  data->AEM_S(40,29) = -0.5*cMrSelf[19]*mnuSelf; 
  data->AEM_S(41,20) = -0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(41,21) = (-0.4472135954999579*cMrSelf[14]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(41,22) = -0.5*cMrSelf[13]*mnuSelf; 
  data->AEM_S(41,23) = (-0.447213595499958*cMrSelf[16]*mnuSelf)-0.5*cMrSelf[12]*mnuSelf; 
  data->AEM_S(41,24) = (-0.4391550328268398*cMrSelf[18]*mnuSelf)-0.4472135954999579*cMrSelf[11]*mnuSelf; 
  data->AEM_S(41,25) = -0.5000000000000001*cMrSelf[17]*mnuSelf; 
  data->AEM_S(41,26) = -0.447213595499958*cMrSelf[13]*mnuSelf; 
  data->AEM_S(41,27) = -0.5000000000000001*cMrSelf[15]*mnuSelf; 
  data->AEM_S(41,28) = -0.4391550328268398*cMrSelf[14]*mnuSelf; 
  data->AEM_S(42,20) = -0.5*cMrSelf[12]*mnuSelf; 
  data->AEM_S(42,21) = -0.5*cMrSelf[13]*mnuSelf; 
  data->AEM_S(42,22) = (-0.4472135954999579*cMrSelf[15]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(42,23) = (-0.447213595499958*cMrSelf[17]*mnuSelf)-0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(42,24) = -0.5000000000000001*cMrSelf[16]*mnuSelf; 
  data->AEM_S(42,25) = (-0.4391550328268398*cMrSelf[19]*mnuSelf)-0.4472135954999579*cMrSelf[12]*mnuSelf; 
  data->AEM_S(42,26) = -0.5000000000000001*cMrSelf[14]*mnuSelf; 
  data->AEM_S(42,27) = -0.447213595499958*cMrSelf[13]*mnuSelf; 
  data->AEM_S(42,29) = -0.4391550328268398*cMrSelf[15]*mnuSelf; 
  data->AEM_S(43,20) = -0.5*cMrSelf[13]*mnuSelf; 
  data->AEM_S(43,21) = (-0.447213595499958*cMrSelf[16]*mnuSelf)-0.5*cMrSelf[12]*mnuSelf; 
  data->AEM_S(43,22) = (-0.447213595499958*cMrSelf[17]*mnuSelf)-0.5*cMrSelf[11]*mnuSelf; 
  data->AEM_S(43,23) = (-0.4472135954999579*cMrSelf[15]*mnuSelf)-0.4472135954999579*cMrSelf[14]*mnuSelf-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(43,24) = -0.4472135954999579*cMrSelf[13]*mnuSelf; 
  data->AEM_S(43,25) = -0.4472135954999579*cMrSelf[13]*mnuSelf; 
  data->AEM_S(43,26) = (-0.4391550328268399*cMrSelf[18]*mnuSelf)-0.4*cMrSelf[17]*mnuSelf-0.447213595499958*cMrSelf[11]*mnuSelf; 
  data->AEM_S(43,27) = (-0.4391550328268399*cMrSelf[19]*mnuSelf)-0.4*cMrSelf[16]*mnuSelf-0.447213595499958*cMrSelf[12]*mnuSelf; 
  data->AEM_S(43,28) = -0.4391550328268399*cMrSelf[16]*mnuSelf; 
  data->AEM_S(43,29) = -0.4391550328268399*cMrSelf[17]*mnuSelf; 
  data->AEM_S(44,20) = -0.5*cMrSelf[14]*mnuSelf; 
  data->AEM_S(44,21) = (-0.4391550328268398*cMrSelf[18]*mnuSelf)-0.4472135954999579*cMrSelf[11]*mnuSelf; 
  data->AEM_S(44,22) = -0.5000000000000001*cMrSelf[16]*mnuSelf; 
  data->AEM_S(44,23) = -0.4472135954999579*cMrSelf[13]*mnuSelf; 
  data->AEM_S(44,24) = (-0.31943828249997*cMrSelf[14]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(44,26) = (-0.31943828249997*cMrSelf[16]*mnuSelf)-0.5000000000000001*cMrSelf[12]*mnuSelf; 
  data->AEM_S(44,27) = -0.4472135954999579*cMrSelf[17]*mnuSelf; 
  data->AEM_S(44,28) = (-0.2981423969999719*cMrSelf[18]*mnuSelf)-0.4391550328268398*cMrSelf[11]*mnuSelf; 
  data->AEM_S(45,20) = -0.5*cMrSelf[15]*mnuSelf; 
  data->AEM_S(45,21) = -0.5000000000000001*cMrSelf[17]*mnuSelf; 
  data->AEM_S(45,22) = (-0.4391550328268398*cMrSelf[19]*mnuSelf)-0.4472135954999579*cMrSelf[12]*mnuSelf; 
  data->AEM_S(45,23) = -0.4472135954999579*cMrSelf[13]*mnuSelf; 
  data->AEM_S(45,25) = (-0.31943828249997*cMrSelf[15]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(45,26) = -0.4472135954999579*cMrSelf[16]*mnuSelf; 
  data->AEM_S(45,27) = (-0.31943828249997*cMrSelf[17]*mnuSelf)-0.5000000000000001*cMrSelf[11]*mnuSelf; 
  data->AEM_S(45,29) = (-0.2981423969999719*cMrSelf[19]*mnuSelf)-0.4391550328268398*cMrSelf[12]*mnuSelf; 
  data->AEM_S(46,20) = -0.5*cMrSelf[16]*mnuSelf; 
  data->AEM_S(46,21) = -0.447213595499958*cMrSelf[13]*mnuSelf; 
  data->AEM_S(46,22) = -0.5000000000000001*cMrSelf[14]*mnuSelf; 
  data->AEM_S(46,23) = (-0.4391550328268399*cMrSelf[18]*mnuSelf)-0.4*cMrSelf[17]*mnuSelf-0.447213595499958*cMrSelf[11]*mnuSelf; 
  data->AEM_S(46,24) = (-0.31943828249997*cMrSelf[16]*mnuSelf)-0.5000000000000001*cMrSelf[12]*mnuSelf; 
  data->AEM_S(46,25) = -0.4472135954999579*cMrSelf[16]*mnuSelf; 
  data->AEM_S(46,26) = (-0.4472135954999579*cMrSelf[15]*mnuSelf)-0.31943828249997*cMrSelf[14]*mnuSelf-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(46,27) = -0.4*cMrSelf[13]*mnuSelf; 
  data->AEM_S(46,28) = -0.4391550328268399*cMrSelf[13]*mnuSelf; 
  data->AEM_S(47,20) = -0.5*cMrSelf[17]*mnuSelf; 
  data->AEM_S(47,21) = -0.5000000000000001*cMrSelf[15]*mnuSelf; 
  data->AEM_S(47,22) = -0.447213595499958*cMrSelf[13]*mnuSelf; 
  data->AEM_S(47,23) = (-0.4391550328268399*cMrSelf[19]*mnuSelf)-0.4*cMrSelf[16]*mnuSelf-0.447213595499958*cMrSelf[12]*mnuSelf; 
  data->AEM_S(47,24) = -0.4472135954999579*cMrSelf[17]*mnuSelf; 
  data->AEM_S(47,25) = (-0.31943828249997*cMrSelf[17]*mnuSelf)-0.5000000000000001*cMrSelf[11]*mnuSelf; 
  data->AEM_S(47,26) = -0.4*cMrSelf[13]*mnuSelf; 
  data->AEM_S(47,27) = (-0.31943828249997*cMrSelf[15]*mnuSelf)-0.4472135954999579*cMrSelf[14]*mnuSelf-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(47,29) = -0.4391550328268399*cMrSelf[13]*mnuSelf; 
  data->AEM_S(48,20) = -0.5*cMrSelf[18]*mnuSelf; 
  data->AEM_S(48,21) = -0.4391550328268398*cMrSelf[14]*mnuSelf; 
  data->AEM_S(48,23) = -0.4391550328268399*cMrSelf[16]*mnuSelf; 
  data->AEM_S(48,24) = (-0.2981423969999719*cMrSelf[18]*mnuSelf)-0.4391550328268398*cMrSelf[11]*mnuSelf; 
  data->AEM_S(48,26) = -0.4391550328268399*cMrSelf[13]*mnuSelf; 
  data->AEM_S(48,28) = (-0.2981423969999719*cMrSelf[14]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  data->AEM_S(49,20) = -0.5*cMrSelf[19]*mnuSelf; 
  data->AEM_S(49,22) = -0.4391550328268398*cMrSelf[15]*mnuSelf; 
  data->AEM_S(49,23) = -0.4391550328268399*cMrSelf[17]*mnuSelf; 
  data->AEM_S(49,25) = (-0.2981423969999719*cMrSelf[19]*mnuSelf)-0.4391550328268398*cMrSelf[12]*mnuSelf; 
  data->AEM_S(49,27) = -0.4391550328268399*cMrSelf[13]*mnuSelf; 
  data->AEM_S(49,29) = (-0.2981423969999719*cMrSelf[15]*mnuSelf)-0.5*cMrSelf[10]*mnuSelf; 
  ...
  // ... Block from correction to (other) 1st moment of collision operator ... // 
  data->AEM_S(40,50) = 0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(40,51) = 0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(40,52) = 0.5*cMrOther[12]*mnuOther; 
  data->AEM_S(40,53) = 0.5*cMrOther[13]*mnuOther; 
  data->AEM_S(40,54) = 0.5*cMrOther[14]*mnuOther; 
  data->AEM_S(40,55) = 0.5*cMrOther[15]*mnuOther; 
  data->AEM_S(40,56) = 0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(40,57) = 0.5*cMrOther[17]*mnuOther; 
  data->AEM_S(40,58) = 0.5*cMrOther[18]*mnuOther; 
  data->AEM_S(40,59) = 0.5*cMrOther[19]*mnuOther; 
  data->AEM_S(41,50) = 0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(41,51) = 0.4472135954999579*cMrOther[14]*mnuOther+0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(41,52) = 0.5*cMrOther[13]*mnuOther; 
  data->AEM_S(41,53) = 0.447213595499958*cMrOther[16]*mnuOther+0.5*cMrOther[12]*mnuOther; 
  data->AEM_S(41,54) = 0.4391550328268398*cMrOther[18]*mnuOther+0.4472135954999579*cMrOther[11]*mnuOther; 
  data->AEM_S(41,55) = 0.5000000000000001*cMrOther[17]*mnuOther; 
  data->AEM_S(41,56) = 0.447213595499958*cMrOther[13]*mnuOther; 
  data->AEM_S(41,57) = 0.5000000000000001*cMrOther[15]*mnuOther; 
  data->AEM_S(41,58) = 0.4391550328268398*cMrOther[14]*mnuOther; 
  data->AEM_S(42,50) = 0.5*cMrOther[12]*mnuOther; 
  data->AEM_S(42,51) = 0.5*cMrOther[13]*mnuOther; 
  data->AEM_S(42,52) = 0.4472135954999579*cMrOther[15]*mnuOther+0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(42,53) = 0.447213595499958*cMrOther[17]*mnuOther+0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(42,54) = 0.5000000000000001*cMrOther[16]*mnuOther; 
  data->AEM_S(42,55) = 0.4391550328268398*cMrOther[19]*mnuOther+0.4472135954999579*cMrOther[12]*mnuOther; 
  data->AEM_S(42,56) = 0.5000000000000001*cMrOther[14]*mnuOther; 
  data->AEM_S(42,57) = 0.447213595499958*cMrOther[13]*mnuOther; 
  data->AEM_S(42,59) = 0.4391550328268398*cMrOther[15]*mnuOther; 
  data->AEM_S(43,50) = 0.5*cMrOther[13]*mnuOther; 
  data->AEM_S(43,51) = 0.447213595499958*cMrOther[16]*mnuOther+0.5*cMrOther[12]*mnuOther; 
  data->AEM_S(43,52) = 0.447213595499958*cMrOther[17]*mnuOther+0.5*cMrOther[11]*mnuOther; 
  data->AEM_S(43,53) = 0.4472135954999579*cMrOther[15]*mnuOther+0.4472135954999579*cMrOther[14]*mnuOther+0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(43,54) = 0.4472135954999579*cMrOther[13]*mnuOther; 
  data->AEM_S(43,55) = 0.4472135954999579*cMrOther[13]*mnuOther; 
  data->AEM_S(43,56) = 0.4391550328268399*cMrOther[18]*mnuOther+0.4*cMrOther[17]*mnuOther+0.447213595499958*cMrOther[11]*mnuOther; 
  data->AEM_S(43,57) = 0.4391550328268399*cMrOther[19]*mnuOther+0.4*cMrOther[16]*mnuOther+0.447213595499958*cMrOther[12]*mnuOther; 
  data->AEM_S(43,58) = 0.4391550328268399*cMrOther[16]*mnuOther; 
  data->AEM_S(43,59) = 0.4391550328268399*cMrOther[17]*mnuOther; 
  data->AEM_S(44,50) = 0.5*cMrOther[14]*mnuOther; 
  data->AEM_S(44,51) = 0.4391550328268398*cMrOther[18]*mnuOther+0.4472135954999579*cMrOther[11]*mnuOther; 
  data->AEM_S(44,52) = 0.5000000000000001*cMrOther[16]*mnuOther; 
  data->AEM_S(44,53) = 0.4472135954999579*cMrOther[13]*mnuOther; 
  data->AEM_S(44,54) = 0.31943828249997*cMrOther[14]*mnuOther+0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(44,56) = 0.31943828249997*cMrOther[16]*mnuOther+0.5000000000000001*cMrOther[12]*mnuOther; 
  data->AEM_S(44,57) = 0.4472135954999579*cMrOther[17]*mnuOther; 
  data->AEM_S(44,58) = 0.2981423969999719*cMrOther[18]*mnuOther+0.4391550328268398*cMrOther[11]*mnuOther; 
  data->AEM_S(45,50) = 0.5*cMrOther[15]*mnuOther; 
  data->AEM_S(45,51) = 0.5000000000000001*cMrOther[17]*mnuOther; 
  data->AEM_S(45,52) = 0.4391550328268398*cMrOther[19]*mnuOther+0.4472135954999579*cMrOther[12]*mnuOther; 
  data->AEM_S(45,53) = 0.4472135954999579*cMrOther[13]*mnuOther; 
  data->AEM_S(45,55) = 0.31943828249997*cMrOther[15]*mnuOther+0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(45,56) = 0.4472135954999579*cMrOther[16]*mnuOther; 
  data->AEM_S(45,57) = 0.31943828249997*cMrOther[17]*mnuOther+0.5000000000000001*cMrOther[11]*mnuOther; 
  data->AEM_S(45,59) = 0.2981423969999719*cMrOther[19]*mnuOther+0.4391550328268398*cMrOther[12]*mnuOther; 
  data->AEM_S(46,50) = 0.5*cMrOther[16]*mnuOther; 
  data->AEM_S(46,51) = 0.447213595499958*cMrOther[13]*mnuOther; 
  data->AEM_S(46,52) = 0.5000000000000001*cMrOther[14]*mnuOther; 
  data->AEM_S(46,53) = 0.4391550328268399*cMrOther[18]*mnuOther+0.4*cMrOther[17]*mnuOther+0.447213595499958*cMrOther[11]*mnuOther; 
  data->AEM_S(46,54) = 0.31943828249997*cMrOther[16]*mnuOther+0.5000000000000001*cMrOther[12]*mnuOther; 
  data->AEM_S(46,55) = 0.4472135954999579*cMrOther[16]*mnuOther; 
  data->AEM_S(46,56) = 0.4472135954999579*cMrOther[15]*mnuOther+0.31943828249997*cMrOther[14]*mnuOther+0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(46,57) = 0.4*cMrOther[13]*mnuOther; 
  data->AEM_S(46,58) = 0.4391550328268399*cMrOther[13]*mnuOther; 
  data->AEM_S(47,50) = 0.5*cMrOther[17]*mnuOther; 
  data->AEM_S(47,51) = 0.5000000000000001*cMrOther[15]*mnuOther; 
  data->AEM_S(47,52) = 0.447213595499958*cMrOther[13]*mnuOther; 
  data->AEM_S(47,53) = 0.4391550328268399*cMrOther[19]*mnuOther+0.4*cMrOther[16]*mnuOther+0.447213595499958*cMrOther[12]*mnuOther; 
  data->AEM_S(47,54) = 0.4472135954999579*cMrOther[17]*mnuOther; 
  data->AEM_S(47,55) = 0.31943828249997*cMrOther[17]*mnuOther+0.5000000000000001*cMrOther[11]*mnuOther; 
  data->AEM_S(47,56) = 0.4*cMrOther[13]*mnuOther; 
  data->AEM_S(47,57) = 0.31943828249997*cMrOther[15]*mnuOther+0.4472135954999579*cMrOther[14]*mnuOther+0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(47,59) = 0.4391550328268399*cMrOther[13]*mnuOther; 
  data->AEM_S(48,50) = 0.5*cMrOther[18]*mnuOther; 
  data->AEM_S(48,51) = 0.4391550328268398*cMrOther[14]*mnuOther; 
  data->AEM_S(48,53) = 0.4391550328268399*cMrOther[16]*mnuOther; 
  data->AEM_S(48,54) = 0.2981423969999719*cMrOther[18]*mnuOther+0.4391550328268398*cMrOther[11]*mnuOther; 
  data->AEM_S(48,56) = 0.4391550328268399*cMrOther[13]*mnuOther; 
  data->AEM_S(48,58) = 0.2981423969999719*cMrOther[14]*mnuOther+0.5*cMrOther[10]*mnuOther; 
  data->AEM_S(49,50) = 0.5*cMrOther[19]*mnuOther; 
  data->AEM_S(49,52) = 0.4391550328268398*cMrOther[15]*mnuOther; 
  data->AEM_S(49,53) = 0.4391550328268399*cMrOther[17]*mnuOther; 
  data->AEM_S(49,55) = 0.2981423969999719*cMrOther[19]*mnuOther+0.4391550328268398*cMrOther[12]*mnuOther; 
  data->AEM_S(49,57) = 0.4391550328268399*cMrOther[13]*mnuOther; 
  data->AEM_S(49,59) = 0.2981423969999719*cMrOther[15]*mnuOther+0.5*cMrOther[10]*mnuOther; 
  ...
  // ... Divide (m0Other*m1SelfY-m0Self*m1OtherY)/(mnuSelf*m0Self+mnuOther*m0Other) ... // 
  // Compute m0Other*m1Self-m0Self*m1Other. 
  m1EffD[10] = 0.5*m0rOther[9]*m1rSelf[19]-0.5*m0rSelf[9]*m1rOther[19]+0.5*m0rOther[8]*m1rSelf[18]-0.5*m0rSelf[8]*m1rOther[18]+0.5*m0rOther[7]*m1rSelf[17]-0.5*m0rSelf[7]*m1rOther[17]+0.5*m0rOther[6]*m1rSelf[16]-0.5*m0rSelf[6]*m1rOther[16]+0.5*m0rOther[5]*m1rSelf[15]-0.5*m0rSelf[5]*m1rOther[15]+0.5*m0rOther[4]*m1rSelf[14]-0.5*m0rSelf[4]*m1rOther[14]+0.5*m0rOther[3]*m1rSelf[13]-0.5*m0rSelf[3]*m1rOther[13]+0.5*m0rOther[2]*m1rSelf[12]-0.5*m0rSelf[2]*m1rOther[12]+0.5*m0rOther[1]*m1rSelf[11]-0.5*m0rSelf[1]*m1rOther[11]+0.5*m0rOther[0]*m1rSelf[10]-0.5*m0rSelf[0]*m1rOther[10]; 
  m1EffD[11] = 0.4391550328268398*m0rOther[4]*m1rSelf[18]-0.4391550328268398*m0rSelf[4]*m1rOther[18]+0.5000000000000001*m0rOther[5]*m1rSelf[17]-0.5000000000000001*m0rSelf[5]*m1rOther[17]+0.447213595499958*m0rOther[3]*m1rSelf[16]-0.447213595499958*m0rSelf[3]*m1rOther[16]+0.5000000000000001*m0rOther[7]*m1rSelf[15]-0.5000000000000001*m0rSelf[7]*m1rOther[15]+0.4391550328268398*m0rOther[8]*m1rSelf[14]+0.4472135954999579*m0rOther[1]*m1rSelf[14]-0.4391550328268398*m0rSelf[8]*m1rOther[14]-0.4472135954999579*m0rSelf[1]*m1rOther[14]+0.447213595499958*m0rOther[6]*m1rSelf[13]+0.5*m0rOther[2]*m1rSelf[13]-0.447213595499958*m0rSelf[6]*m1rOther[13]-0.5*m0rSelf[2]*m1rOther[13]+0.5*m0rOther[3]*m1rSelf[12]-0.5*m0rSelf[3]*m1rOther[12]+0.4472135954999579*m0rOther[4]*m1rSelf[11]+0.5*m0rOther[0]*m1rSelf[11]-0.4472135954999579*m0rSelf[4]*m1rOther[11]-0.5*m0rSelf[0]*m1rOther[11]+0.5*m0rOther[1]*m1rSelf[10]-0.5*m0rSelf[1]*m1rOther[10]; 
  m1EffD[12] = 0.4391550328268398*m0rOther[5]*m1rSelf[19]-0.4391550328268398*m0rSelf[5]*m1rOther[19]+0.447213595499958*m0rOther[3]*m1rSelf[17]-0.447213595499958*m0rSelf[3]*m1rOther[17]+0.5000000000000001*m0rOther[4]*m1rSelf[16]-0.5000000000000001*m0rSelf[4]*m1rOther[16]+0.4391550328268398*m0rOther[9]*m1rSelf[15]+0.4472135954999579*m0rOther[2]*m1rSelf[15]-0.4391550328268398*m0rSelf[9]*m1rOther[15]-0.4472135954999579*m0rSelf[2]*m1rOther[15]+0.5000000000000001*m0rOther[6]*m1rSelf[14]-0.5000000000000001*m0rSelf[6]*m1rOther[14]+0.447213595499958*m0rOther[7]*m1rSelf[13]+0.5*m0rOther[1]*m1rSelf[13]-0.447213595499958*m0rSelf[7]*m1rOther[13]-0.5*m0rSelf[1]*m1rOther[13]+0.4472135954999579*m0rOther[5]*m1rSelf[12]+0.5*m0rOther[0]*m1rSelf[12]-0.4472135954999579*m0rSelf[5]*m1rOther[12]-0.5*m0rSelf[0]*m1rOther[12]+0.5*m0rOther[3]*m1rSelf[11]-0.5*m0rSelf[3]*m1rOther[11]+0.5*m0rOther[2]*m1rSelf[10]-0.5*m0rSelf[2]*m1rOther[10]; 
  m1EffD[13] = 0.4391550328268399*m0rOther[7]*m1rSelf[19]-0.4391550328268399*m0rSelf[7]*m1rOther[19]+0.4391550328268399*m0rOther[6]*m1rSelf[18]-0.4391550328268399*m0rSelf[6]*m1rOther[18]+0.4391550328268399*m0rOther[9]*m1rSelf[17]+0.4*m0rOther[6]*m1rSelf[17]+0.447213595499958*m0rOther[2]*m1rSelf[17]-0.4391550328268399*m0rSelf[9]*m1rOther[17]-0.4*m0rSelf[6]*m1rOther[17]-0.447213595499958*m0rSelf[2]*m1rOther[17]+0.4391550328268399*m0rOther[8]*m1rSelf[16]+0.4*m0rOther[7]*m1rSelf[16]+0.447213595499958*m0rOther[1]*m1rSelf[16]-0.4391550328268399*m0rSelf[8]*m1rOther[16]-0.4*m0rSelf[7]*m1rOther[16]-0.447213595499958*m0rSelf[1]*m1rOther[16]+0.4472135954999579*m0rOther[3]*m1rSelf[15]-0.4472135954999579*m0rSelf[3]*m1rOther[15]+0.4472135954999579*m0rOther[3]*m1rSelf[14]-0.4472135954999579*m0rSelf[3]*m1rOther[14]+0.4472135954999579*m0rOther[5]*m1rSelf[13]+0.4472135954999579*m0rOther[4]*m1rSelf[13]+0.5*m0rOther[0]*m1rSelf[13]-0.4472135954999579*m0rSelf[5]*m1rOther[13]-0.4472135954999579*m0rSelf[4]*m1rOther[13]-0.5*m0rSelf[0]*m1rOther[13]+0.447213595499958*m0rOther[7]*m1rSelf[12]+0.5*m0rOther[1]*m1rSelf[12]-0.447213595499958*m0rSelf[7]*m1rOther[12]-0.5*m0rSelf[1]*m1rOther[12]+0.447213595499958*m0rOther[6]*m1rSelf[11]+0.5*m0rOther[2]*m1rSelf[11]-0.447213595499958*m0rSelf[6]*m1rOther[11]-0.5*m0rSelf[2]*m1rOther[11]+0.5*m0rOther[3]*m1rSelf[10]-0.5*m0rSelf[3]*m1rOther[10]; 
  m1EffD[14] = 0.2981423969999719*m0rOther[8]*m1rSelf[18]+0.4391550328268398*m0rOther[1]*m1rSelf[18]-0.2981423969999719*m0rSelf[8]*m1rOther[18]-0.4391550328268398*m0rSelf[1]*m1rOther[18]+0.4472135954999579*m0rOther[7]*m1rSelf[17]-0.4472135954999579*m0rSelf[7]*m1rOther[17]+0.31943828249997*m0rOther[6]*m1rSelf[16]+0.5000000000000001*m0rOther[2]*m1rSelf[16]-0.31943828249997*m0rSelf[6]*m1rOther[16]-0.5000000000000001*m0rSelf[2]*m1rOther[16]+0.31943828249997*m0rOther[4]*m1rSelf[14]+0.5*m0rOther[0]*m1rSelf[14]-0.31943828249997*m0rSelf[4]*m1rOther[14]-0.5*m0rSelf[0]*m1rOther[14]+0.4472135954999579*m0rOther[3]*m1rSelf[13]-0.4472135954999579*m0rSelf[3]*m1rOther[13]+0.5000000000000001*m0rOther[6]*m1rSelf[12]-0.5000000000000001*m0rSelf[6]*m1rOther[12]+0.4391550328268398*m0rOther[8]*m1rSelf[11]+0.4472135954999579*m0rOther[1]*m1rSelf[11]-0.4391550328268398*m0rSelf[8]*m1rOther[11]-0.4472135954999579*m0rSelf[1]*m1rOther[11]+0.5*m0rOther[4]*m1rSelf[10]-0.5*m0rSelf[4]*m1rOther[10]; 
  m1EffD[15] = 0.2981423969999719*m0rOther[9]*m1rSelf[19]+0.4391550328268398*m0rOther[2]*m1rSelf[19]-0.2981423969999719*m0rSelf[9]*m1rOther[19]-0.4391550328268398*m0rSelf[2]*m1rOther[19]+0.31943828249997*m0rOther[7]*m1rSelf[17]+0.5000000000000001*m0rOther[1]*m1rSelf[17]-0.31943828249997*m0rSelf[7]*m1rOther[17]-0.5000000000000001*m0rSelf[1]*m1rOther[17]+0.4472135954999579*m0rOther[6]*m1rSelf[16]-0.4472135954999579*m0rSelf[6]*m1rOther[16]+0.31943828249997*m0rOther[5]*m1rSelf[15]+0.5*m0rOther[0]*m1rSelf[15]-0.31943828249997*m0rSelf[5]*m1rOther[15]-0.5*m0rSelf[0]*m1rOther[15]+0.4472135954999579*m0rOther[3]*m1rSelf[13]-0.4472135954999579*m0rSelf[3]*m1rOther[13]+0.4391550328268398*m0rOther[9]*m1rSelf[12]+0.4472135954999579*m0rOther[2]*m1rSelf[12]-0.4391550328268398*m0rSelf[9]*m1rOther[12]-0.4472135954999579*m0rSelf[2]*m1rOther[12]+0.5000000000000001*m0rOther[7]*m1rSelf[11]-0.5000000000000001*m0rSelf[7]*m1rOther[11]+0.5*m0rOther[5]*m1rSelf[10]-0.5*m0rSelf[5]*m1rOther[10]; 
  m1EffD[16] = 0.4391550328268399*m0rOther[3]*m1rSelf[18]-0.4391550328268399*m0rSelf[3]*m1rOther[18]+0.4*m0rOther[3]*m1rSelf[17]-0.4*m0rSelf[3]*m1rOther[17]+0.4472135954999579*m0rOther[5]*m1rSelf[16]+0.31943828249997*m0rOther[4]*m1rSelf[16]+0.5*m0rOther[0]*m1rSelf[16]-0.4472135954999579*m0rSelf[5]*m1rOther[16]-0.31943828249997*m0rSelf[4]*m1rOther[16]-0.5*m0rSelf[0]*m1rOther[16]+0.4472135954999579*m0rOther[6]*m1rSelf[15]-0.4472135954999579*m0rSelf[6]*m1rOther[15]+0.31943828249997*m0rOther[6]*m1rSelf[14]+0.5000000000000001*m0rOther[2]*m1rSelf[14]-0.31943828249997*m0rSelf[6]*m1rOther[14]-0.5000000000000001*m0rSelf[2]*m1rOther[14]+0.4391550328268399*m0rOther[8]*m1rSelf[13]+0.4*m0rOther[7]*m1rSelf[13]+0.447213595499958*m0rOther[1]*m1rSelf[13]-0.4391550328268399*m0rSelf[8]*m1rOther[13]-0.4*m0rSelf[7]*m1rOther[13]-0.447213595499958*m0rSelf[1]*m1rOther[13]+0.5000000000000001*m0rOther[4]*m1rSelf[12]-0.5000000000000001*m0rSelf[4]*m1rOther[12]+0.447213595499958*m0rOther[3]*m1rSelf[11]-0.447213595499958*m0rSelf[3]*m1rOther[11]+0.5*m0rOther[6]*m1rSelf[10]-0.5*m0rSelf[6]*m1rOther[10]; 
  m1EffD[17] = 0.4391550328268399*m0rOther[3]*m1rSelf[19]-0.4391550328268399*m0rSelf[3]*m1rOther[19]+0.31943828249997*m0rOther[5]*m1rSelf[17]+0.4472135954999579*m0rOther[4]*m1rSelf[17]+0.5*m0rOther[0]*m1rSelf[17]-0.31943828249997*m0rSelf[5]*m1rOther[17]-0.4472135954999579*m0rSelf[4]*m1rOther[17]-0.5*m0rSelf[0]*m1rOther[17]+0.4*m0rOther[3]*m1rSelf[16]-0.4*m0rSelf[3]*m1rOther[16]+0.31943828249997*m0rOther[7]*m1rSelf[15]+0.5000000000000001*m0rOther[1]*m1rSelf[15]-0.31943828249997*m0rSelf[7]*m1rOther[15]-0.5000000000000001*m0rSelf[1]*m1rOther[15]+0.4472135954999579*m0rOther[7]*m1rSelf[14]-0.4472135954999579*m0rSelf[7]*m1rOther[14]+0.4391550328268399*m0rOther[9]*m1rSelf[13]+0.4*m0rOther[6]*m1rSelf[13]+0.447213595499958*m0rOther[2]*m1rSelf[13]-0.4391550328268399*m0rSelf[9]*m1rOther[13]-0.4*m0rSelf[6]*m1rOther[13]-0.447213595499958*m0rSelf[2]*m1rOther[13]+0.447213595499958*m0rOther[3]*m1rSelf[12]-0.447213595499958*m0rSelf[3]*m1rOther[12]+0.5000000000000001*m0rOther[5]*m1rSelf[11]-0.5000000000000001*m0rSelf[5]*m1rOther[11]+0.5*m0rOther[7]*m1rSelf[10]-0.5*m0rSelf[7]*m1rOther[10]; 
  m1EffD[18] = 0.2981423969999719*m0rOther[4]*m1rSelf[18]+0.5*m0rOther[0]*m1rSelf[18]-0.2981423969999719*m0rSelf[4]*m1rOther[18]-0.5*m0rSelf[0]*m1rOther[18]+0.4391550328268399*m0rOther[3]*m1rSelf[16]-0.4391550328268399*m0rSelf[3]*m1rOther[16]+0.2981423969999719*m0rOther[8]*m1rSelf[14]+0.4391550328268398*m0rOther[1]*m1rSelf[14]-0.2981423969999719*m0rSelf[8]*m1rOther[14]-0.4391550328268398*m0rSelf[1]*m1rOther[14]+0.4391550328268399*m0rOther[6]*m1rSelf[13]-0.4391550328268399*m0rSelf[6]*m1rOther[13]+0.4391550328268398*m0rOther[4]*m1rSelf[11]-0.4391550328268398*m0rSelf[4]*m1rOther[11]+0.5*m0rOther[8]*m1rSelf[10]-0.5*m0rSelf[8]*m1rOther[10]; 
  m1EffD[19] = 0.2981423969999719*m0rOther[5]*m1rSelf[19]+0.5*m0rOther[0]*m1rSelf[19]-0.2981423969999719*m0rSelf[5]*m1rOther[19]-0.5*m0rSelf[0]*m1rOther[19]+0.4391550328268399*m0rOther[3]*m1rSelf[17]-0.4391550328268399*m0rSelf[3]*m1rOther[17]+0.2981423969999719*m0rOther[9]*m1rSelf[15]+0.4391550328268398*m0rOther[2]*m1rSelf[15]-0.2981423969999719*m0rSelf[9]*m1rOther[15]-0.4391550328268398*m0rSelf[2]*m1rOther[15]+0.4391550328268399*m0rOther[7]*m1rSelf[13]-0.4391550328268399*m0rSelf[7]*m1rOther[13]+0.4391550328268398*m0rOther[5]*m1rSelf[12]-0.4391550328268398*m0rSelf[5]*m1rOther[12]+0.5*m0rOther[9]*m1rSelf[10]-0.5*m0rSelf[9]*m1rOther[10]; 
  // Fill BEV. 
  ...
  { 
    ...
    // Contribution to dot-product from weak multiplication of vd component. 
    ucMSelf[0] += 0.5*cMrSelf[a0+9]*uSelf[a0+9]+0.5*cMrSelf[a0+8]*uSelf[a0+8]+0.5*cMrSelf[a0+7]*uSelf[a0+7]+0.5*cMrSelf[a0+6]*uSelf[a0+6]+0.5*cMrSelf[a0+5]*uSelf[a0+5]+0.5*cMrSelf[a0+4]*uSelf[a0+4]+0.5*cMrSelf[a0+3]*uSelf[a0+3]+0.5*cMrSelf[a0+2]*uSelf[a0+2]+0.5*cMrSelf[a0+1]*uSelf[a0+1]+0.5*cMrSelf[a0]*uSelf[a0]; 
    ucMSelf[1] += 0.4391550328268398*cMrSelf[a0+4]*uSelf[a0+8]+0.4391550328268398*uSelf[a0+4]*cMrSelf[a0+8]+0.5000000000000001*cMrSelf[a0+5]*uSelf[a0+7]+0.5000000000000001*uSelf[a0+5]*cMrSelf[a0+7]+0.447213595499958*cMrSelf[a0+3]*uSelf[a0+6]+0.447213595499958*uSelf[a0+3]*cMrSelf[a0+6]+0.4472135954999579*cMrSelf[a0+1]*uSelf[a0+4]+0.4472135954999579*uSelf[a0+1]*cMrSelf[a0+4]+0.5*cMrSelf[a0+2]*uSelf[a0+3]+0.5*uSelf[a0+2]*cMrSelf[a0+3]+0.5*cMrSelf[a0]*uSelf[a0+1]+0.5*uSelf[a0]*cMrSelf[a0+1]; 
    ucMSelf[2] += 0.4391550328268398*cMrSelf[a0+5]*uSelf[a0+9]+0.4391550328268398*uSelf[a0+5]*cMrSelf[a0+9]+0.447213595499958*cMrSelf[a0+3]*uSelf[a0+7]+0.447213595499958*uSelf[a0+3]*cMrSelf[a0+7]+0.5000000000000001*cMrSelf[a0+4]*uSelf[a0+6]+0.5000000000000001*uSelf[a0+4]*cMrSelf[a0+6]+0.4472135954999579*cMrSelf[a0+2]*uSelf[a0+5]+0.4472135954999579*uSelf[a0+2]*cMrSelf[a0+5]+0.5*cMrSelf[a0+1]*uSelf[a0+3]+0.5*uSelf[a0+1]*cMrSelf[a0+3]+0.5*cMrSelf[a0]*uSelf[a0+2]+0.5*uSelf[a0]*cMrSelf[a0+2]; 
    ucMSelf[3] += 0.4391550328268399*cMrSelf[a0+7]*uSelf[a0+9]+0.4391550328268399*uSelf[a0+7]*cMrSelf[a0+9]+0.4391550328268399*cMrSelf[a0+6]*uSelf[a0+8]+0.4391550328268399*uSelf[a0+6]*cMrSelf[a0+8]+0.4*cMrSelf[a0+6]*uSelf[a0+7]+0.447213595499958*cMrSelf[a0+2]*uSelf[a0+7]+0.4*uSelf[a0+6]*cMrSelf[a0+7]+0.447213595499958*uSelf[a0+2]*cMrSelf[a0+7]+0.447213595499958*cMrSelf[a0+1]*uSelf[a0+6]+0.447213595499958*uSelf[a0+1]*cMrSelf[a0+6]+0.4472135954999579*cMrSelf[a0+3]*uSelf[a0+5]+0.4472135954999579*uSelf[a0+3]*cMrSelf[a0+5]+0.4472135954999579*cMrSelf[a0+3]*uSelf[a0+4]+0.4472135954999579*uSelf[a0+3]*cMrSelf[a0+4]+0.5*cMrSelf[a0]*uSelf[a0+3]+0.5*uSelf[a0]*cMrSelf[a0+3]+0.5*cMrSelf[a0+1]*uSelf[a0+2]+0.5*uSelf[a0+1]*cMrSelf[a0+2]; 
    ucMSelf[4] += 0.2981423969999719*cMrSelf[a0+8]*uSelf[a0+8]+0.4391550328268398*cMrSelf[a0+1]*uSelf[a0+8]+0.4391550328268398*uSelf[a0+1]*cMrSelf[a0+8]+0.4472135954999579*cMrSelf[a0+7]*uSelf[a0+7]+0.31943828249997*cMrSelf[a0+6]*uSelf[a0+6]+0.5000000000000001*cMrSelf[a0+2]*uSelf[a0+6]+0.5000000000000001*uSelf[a0+2]*cMrSelf[a0+6]+0.31943828249997*cMrSelf[a0+4]*uSelf[a0+4]+0.5*cMrSelf[a0]*uSelf[a0+4]+0.5*uSelf[a0]*cMrSelf[a0+4]+0.4472135954999579*cMrSelf[a0+3]*uSelf[a0+3]+0.4472135954999579*cMrSelf[a0+1]*uSelf[a0+1]; 
    ucMSelf[5] += 0.2981423969999719*cMrSelf[a0+9]*uSelf[a0+9]+0.4391550328268398*cMrSelf[a0+2]*uSelf[a0+9]+0.4391550328268398*uSelf[a0+2]*cMrSelf[a0+9]+0.31943828249997*cMrSelf[a0+7]*uSelf[a0+7]+0.5000000000000001*cMrSelf[a0+1]*uSelf[a0+7]+0.5000000000000001*uSelf[a0+1]*cMrSelf[a0+7]+0.4472135954999579*cMrSelf[a0+6]*uSelf[a0+6]+0.31943828249997*cMrSelf[a0+5]*uSelf[a0+5]+0.5*cMrSelf[a0]*uSelf[a0+5]+0.5*uSelf[a0]*cMrSelf[a0+5]+0.4472135954999579*cMrSelf[a0+3]*uSelf[a0+3]+0.4472135954999579*cMrSelf[a0+2]*uSelf[a0+2]; 
    ucMSelf[6] += 0.4391550328268399*cMrSelf[a0+3]*uSelf[a0+8]+0.4391550328268399*uSelf[a0+3]*cMrSelf[a0+8]+0.4*cMrSelf[a0+3]*uSelf[a0+7]+0.4*uSelf[a0+3]*cMrSelf[a0+7]+0.4472135954999579*cMrSelf[a0+5]*uSelf[a0+6]+0.31943828249997*cMrSelf[a0+4]*uSelf[a0+6]+0.5*cMrSelf[a0]*uSelf[a0+6]+0.4472135954999579*uSelf[a0+5]*cMrSelf[a0+6]+0.31943828249997*uSelf[a0+4]*cMrSelf[a0+6]+0.5*uSelf[a0]*cMrSelf[a0+6]+0.5000000000000001*cMrSelf[a0+2]*uSelf[a0+4]+0.5000000000000001*uSelf[a0+2]*cMrSelf[a0+4]+0.447213595499958*cMrSelf[a0+1]*uSelf[a0+3]+0.447213595499958*uSelf[a0+1]*cMrSelf[a0+3]; 
    ucMSelf[7] += 0.4391550328268399*cMrSelf[a0+3]*uSelf[a0+9]+0.4391550328268399*uSelf[a0+3]*cMrSelf[a0+9]+0.31943828249997*cMrSelf[a0+5]*uSelf[a0+7]+0.4472135954999579*cMrSelf[a0+4]*uSelf[a0+7]+0.5*cMrSelf[a0]*uSelf[a0+7]+0.31943828249997*uSelf[a0+5]*cMrSelf[a0+7]+0.4472135954999579*uSelf[a0+4]*cMrSelf[a0+7]+0.5*uSelf[a0]*cMrSelf[a0+7]+0.4*cMrSelf[a0+3]*uSelf[a0+6]+0.4*uSelf[a0+3]*cMrSelf[a0+6]+0.5000000000000001*cMrSelf[a0+1]*uSelf[a0+5]+0.5000000000000001*uSelf[a0+1]*cMrSelf[a0+5]+0.447213595499958*cMrSelf[a0+2]*uSelf[a0+3]+0.447213595499958*uSelf[a0+2]*cMrSelf[a0+3]; 
    ucMSelf[8] += 0.2981423969999719*cMrSelf[a0+4]*uSelf[a0+8]+0.5*cMrSelf[a0]*uSelf[a0+8]+0.2981423969999719*uSelf[a0+4]*cMrSelf[a0+8]+0.5*uSelf[a0]*cMrSelf[a0+8]+0.4391550328268399*cMrSelf[a0+3]*uSelf[a0+6]+0.4391550328268399*uSelf[a0+3]*cMrSelf[a0+6]+0.4391550328268398*cMrSelf[a0+1]*uSelf[a0+4]+0.4391550328268398*uSelf[a0+1]*cMrSelf[a0+4]; 
    ucMSelf[9] += 0.2981423969999719*cMrSelf[a0+5]*uSelf[a0+9]+0.5*cMrSelf[a0]*uSelf[a0+9]+0.2981423969999719*uSelf[a0+5]*cMrSelf[a0+9]+0.5*uSelf[a0]*cMrSelf[a0+9]+0.4391550328268399*cMrSelf[a0+3]*uSelf[a0+7]+0.4391550328268399*uSelf[a0+3]*cMrSelf[a0+7]+0.4391550328268398*cMrSelf[a0+2]*uSelf[a0+5]+0.4391550328268398*uSelf[a0+2]*cMrSelf[a0+5]; 
  } 
 
  // ... Block from correction to (self) 2nd moment of collision operator ... // 
  data->AEM_S(50,20) = 0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(50,21) = 0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(50,22) = 0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(50,23) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(50,24) = 0.5*ucMSelf[4]*mnuSelf+m0rSelf[4]*mnuSelf-0.5*cErSelf[4]*mnuSelf; 
  data->AEM_S(50,25) = 0.5*ucMSelf[5]*mnuSelf+m0rSelf[5]*mnuSelf-0.5*cErSelf[5]*mnuSelf; 
  data->AEM_S(50,26) = 0.5*ucMSelf[6]*mnuSelf+m0rSelf[6]*mnuSelf-0.5*cErSelf[6]*mnuSelf; 
  data->AEM_S(50,27) = 0.5*ucMSelf[7]*mnuSelf+m0rSelf[7]*mnuSelf-0.5*cErSelf[7]*mnuSelf; 
  data->AEM_S(50,28) = 0.5*ucMSelf[8]*mnuSelf+m0rSelf[8]*mnuSelf-0.5*cErSelf[8]*mnuSelf; 
  data->AEM_S(50,29) = 0.5*ucMSelf[9]*mnuSelf+m0rSelf[9]*mnuSelf-0.5*cErSelf[9]*mnuSelf; 
  data->AEM_S(51,20) = 0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(51,21) = 0.4472135954999579*ucMSelf[4]*mnuSelf+0.8944271909999159*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(51,22) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(51,23) = 0.447213595499958*ucMSelf[6]*mnuSelf+0.8944271909999161*m0rSelf[6]*mnuSelf-0.447213595499958*cErSelf[6]*mnuSelf+0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(51,24) = 0.4391550328268398*ucMSelf[8]*mnuSelf+0.8783100656536796*m0rSelf[8]*mnuSelf-0.4391550328268398*cErSelf[8]*mnuSelf+0.4472135954999579*ucMSelf[1]*mnuSelf+0.8944271909999159*m0rSelf[1]*mnuSelf-0.4472135954999579*cErSelf[1]*mnuSelf; 
  data->AEM_S(51,25) = 0.5000000000000001*ucMSelf[7]*mnuSelf+1.0*m0rSelf[7]*mnuSelf-0.5000000000000001*cErSelf[7]*mnuSelf; 
  data->AEM_S(51,26) = 0.447213595499958*ucMSelf[3]*mnuSelf+0.8944271909999161*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(51,27) = 0.5000000000000001*ucMSelf[5]*mnuSelf+1.0*m0rSelf[5]*mnuSelf-0.5000000000000001*cErSelf[5]*mnuSelf; 
  data->AEM_S(51,28) = 0.4391550328268398*ucMSelf[4]*mnuSelf+0.8783100656536796*m0rSelf[4]*mnuSelf-0.4391550328268398*cErSelf[4]*mnuSelf; 
  data->AEM_S(52,20) = 0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(52,21) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(52,22) = 0.4472135954999579*ucMSelf[5]*mnuSelf+0.8944271909999159*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(52,23) = 0.447213595499958*ucMSelf[7]*mnuSelf+0.8944271909999161*m0rSelf[7]*mnuSelf-0.447213595499958*cErSelf[7]*mnuSelf+0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(52,24) = 0.5000000000000001*ucMSelf[6]*mnuSelf+1.0*m0rSelf[6]*mnuSelf-0.5000000000000001*cErSelf[6]*mnuSelf; 
  data->AEM_S(52,25) = 0.4391550328268398*ucMSelf[9]*mnuSelf+0.8783100656536796*m0rSelf[9]*mnuSelf-0.4391550328268398*cErSelf[9]*mnuSelf+0.4472135954999579*ucMSelf[2]*mnuSelf+0.8944271909999159*m0rSelf[2]*mnuSelf-0.4472135954999579*cErSelf[2]*mnuSelf; 
  data->AEM_S(52,26) = 0.5000000000000001*ucMSelf[4]*mnuSelf+1.0*m0rSelf[4]*mnuSelf-0.5000000000000001*cErSelf[4]*mnuSelf; 
  data->AEM_S(52,27) = 0.447213595499958*ucMSelf[3]*mnuSelf+0.8944271909999161*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(52,29) = 0.4391550328268398*ucMSelf[5]*mnuSelf+0.8783100656536796*m0rSelf[5]*mnuSelf-0.4391550328268398*cErSelf[5]*mnuSelf; 
  data->AEM_S(53,20) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf-0.5*cErSelf[3]*mnuSelf; 
  data->AEM_S(53,21) = 0.447213595499958*ucMSelf[6]*mnuSelf+0.8944271909999161*m0rSelf[6]*mnuSelf-0.447213595499958*cErSelf[6]*mnuSelf+0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(53,22) = 0.447213595499958*ucMSelf[7]*mnuSelf+0.8944271909999161*m0rSelf[7]*mnuSelf-0.447213595499958*cErSelf[7]*mnuSelf+0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(53,23) = 0.4472135954999579*ucMSelf[5]*mnuSelf+0.8944271909999159*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+0.4472135954999579*ucMSelf[4]*mnuSelf+0.8944271909999159*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(53,24) = 0.4472135954999579*ucMSelf[3]*mnuSelf+0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(53,25) = 0.4472135954999579*ucMSelf[3]*mnuSelf+0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(53,26) = 0.4391550328268399*ucMSelf[8]*mnuSelf+0.8783100656536798*m0rSelf[8]*mnuSelf-0.4391550328268399*cErSelf[8]*mnuSelf+0.4*ucMSelf[7]*mnuSelf+0.8*m0rSelf[7]*mnuSelf-0.4*cErSelf[7]*mnuSelf+0.447213595499958*ucMSelf[1]*mnuSelf+0.8944271909999161*m0rSelf[1]*mnuSelf-0.447213595499958*cErSelf[1]*mnuSelf; 
  data->AEM_S(53,27) = 0.4391550328268399*ucMSelf[9]*mnuSelf+0.8783100656536798*m0rSelf[9]*mnuSelf-0.4391550328268399*cErSelf[9]*mnuSelf+0.4*ucMSelf[6]*mnuSelf+0.8*m0rSelf[6]*mnuSelf-0.4*cErSelf[6]*mnuSelf+0.447213595499958*ucMSelf[2]*mnuSelf+0.8944271909999161*m0rSelf[2]*mnuSelf-0.447213595499958*cErSelf[2]*mnuSelf; 
  data->AEM_S(53,28) = 0.4391550328268399*ucMSelf[6]*mnuSelf+0.8783100656536798*m0rSelf[6]*mnuSelf-0.4391550328268399*cErSelf[6]*mnuSelf; 
  data->AEM_S(53,29) = 0.4391550328268399*ucMSelf[7]*mnuSelf+0.8783100656536798*m0rSelf[7]*mnuSelf-0.4391550328268399*cErSelf[7]*mnuSelf; 
  data->AEM_S(54,20) = 0.5*ucMSelf[4]*mnuSelf+m0rSelf[4]*mnuSelf-0.5*cErSelf[4]*mnuSelf; 
  data->AEM_S(54,21) = 0.4391550328268398*ucMSelf[8]*mnuSelf+0.8783100656536796*m0rSelf[8]*mnuSelf-0.4391550328268398*cErSelf[8]*mnuSelf+0.4472135954999579*ucMSelf[1]*mnuSelf+0.8944271909999159*m0rSelf[1]*mnuSelf-0.4472135954999579*cErSelf[1]*mnuSelf; 
  data->AEM_S(54,22) = 0.5000000000000001*ucMSelf[6]*mnuSelf+1.0*m0rSelf[6]*mnuSelf-0.5000000000000001*cErSelf[6]*mnuSelf; 
  data->AEM_S(54,23) = 0.4472135954999579*ucMSelf[3]*mnuSelf+0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(54,24) = 0.31943828249997*ucMSelf[4]*mnuSelf+0.6388765649999399*m0rSelf[4]*mnuSelf-0.31943828249997*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(54,26) = 0.31943828249997*ucMSelf[6]*mnuSelf+0.6388765649999399*m0rSelf[6]*mnuSelf-0.31943828249997*cErSelf[6]*mnuSelf+0.5000000000000001*ucMSelf[2]*mnuSelf+1.0*m0rSelf[2]*mnuSelf-0.5000000000000001*cErSelf[2]*mnuSelf; 
  data->AEM_S(54,27) = 0.4472135954999579*ucMSelf[7]*mnuSelf+0.8944271909999159*m0rSelf[7]*mnuSelf-0.4472135954999579*cErSelf[7]*mnuSelf; 
  data->AEM_S(54,28) = 0.2981423969999719*ucMSelf[8]*mnuSelf+0.5962847939999438*m0rSelf[8]*mnuSelf-0.2981423969999719*cErSelf[8]*mnuSelf+0.4391550328268398*ucMSelf[1]*mnuSelf+0.8783100656536796*m0rSelf[1]*mnuSelf-0.4391550328268398*cErSelf[1]*mnuSelf; 
  data->AEM_S(55,20) = 0.5*ucMSelf[5]*mnuSelf+m0rSelf[5]*mnuSelf-0.5*cErSelf[5]*mnuSelf; 
  data->AEM_S(55,21) = 0.5000000000000001*ucMSelf[7]*mnuSelf+1.0*m0rSelf[7]*mnuSelf-0.5000000000000001*cErSelf[7]*mnuSelf; 
  data->AEM_S(55,22) = 0.4391550328268398*ucMSelf[9]*mnuSelf+0.8783100656536796*m0rSelf[9]*mnuSelf-0.4391550328268398*cErSelf[9]*mnuSelf+0.4472135954999579*ucMSelf[2]*mnuSelf+0.8944271909999159*m0rSelf[2]*mnuSelf-0.4472135954999579*cErSelf[2]*mnuSelf; 
  data->AEM_S(55,23) = 0.4472135954999579*ucMSelf[3]*mnuSelf+0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cErSelf[3]*mnuSelf; 
  data->AEM_S(55,25) = 0.31943828249997*ucMSelf[5]*mnuSelf+0.6388765649999399*m0rSelf[5]*mnuSelf-0.31943828249997*cErSelf[5]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(55,26) = 0.4472135954999579*ucMSelf[6]*mnuSelf+0.8944271909999159*m0rSelf[6]*mnuSelf-0.4472135954999579*cErSelf[6]*mnuSelf; 
  data->AEM_S(55,27) = 0.31943828249997*ucMSelf[7]*mnuSelf+0.6388765649999399*m0rSelf[7]*mnuSelf-0.31943828249997*cErSelf[7]*mnuSelf+0.5000000000000001*ucMSelf[1]*mnuSelf+1.0*m0rSelf[1]*mnuSelf-0.5000000000000001*cErSelf[1]*mnuSelf; 
  data->AEM_S(55,29) = 0.2981423969999719*ucMSelf[9]*mnuSelf+0.5962847939999438*m0rSelf[9]*mnuSelf-0.2981423969999719*cErSelf[9]*mnuSelf+0.4391550328268398*ucMSelf[2]*mnuSelf+0.8783100656536796*m0rSelf[2]*mnuSelf-0.4391550328268398*cErSelf[2]*mnuSelf; 
  data->AEM_S(56,20) = 0.5*ucMSelf[6]*mnuSelf+m0rSelf[6]*mnuSelf-0.5*cErSelf[6]*mnuSelf; 
  data->AEM_S(56,21) = 0.447213595499958*ucMSelf[3]*mnuSelf+0.8944271909999161*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(56,22) = 0.5000000000000001*ucMSelf[4]*mnuSelf+1.0*m0rSelf[4]*mnuSelf-0.5000000000000001*cErSelf[4]*mnuSelf; 
  data->AEM_S(56,23) = 0.4391550328268399*ucMSelf[8]*mnuSelf+0.8783100656536798*m0rSelf[8]*mnuSelf-0.4391550328268399*cErSelf[8]*mnuSelf+0.4*ucMSelf[7]*mnuSelf+0.8*m0rSelf[7]*mnuSelf-0.4*cErSelf[7]*mnuSelf+0.447213595499958*ucMSelf[1]*mnuSelf+0.8944271909999161*m0rSelf[1]*mnuSelf-0.447213595499958*cErSelf[1]*mnuSelf; 
  data->AEM_S(56,24) = 0.31943828249997*ucMSelf[6]*mnuSelf+0.6388765649999399*m0rSelf[6]*mnuSelf-0.31943828249997*cErSelf[6]*mnuSelf+0.5000000000000001*ucMSelf[2]*mnuSelf+1.0*m0rSelf[2]*mnuSelf-0.5000000000000001*cErSelf[2]*mnuSelf; 
  data->AEM_S(56,25) = 0.4472135954999579*ucMSelf[6]*mnuSelf+0.8944271909999159*m0rSelf[6]*mnuSelf-0.4472135954999579*cErSelf[6]*mnuSelf; 
  data->AEM_S(56,26) = 0.4472135954999579*ucMSelf[5]*mnuSelf+0.8944271909999159*m0rSelf[5]*mnuSelf-0.4472135954999579*cErSelf[5]*mnuSelf+0.31943828249997*ucMSelf[4]*mnuSelf+0.6388765649999399*m0rSelf[4]*mnuSelf-0.31943828249997*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(56,27) = 0.4*ucMSelf[3]*mnuSelf+0.8*m0rSelf[3]*mnuSelf-0.4*cErSelf[3]*mnuSelf; 
  data->AEM_S(56,28) = 0.4391550328268399*ucMSelf[3]*mnuSelf+0.8783100656536798*m0rSelf[3]*mnuSelf-0.4391550328268399*cErSelf[3]*mnuSelf; 
  data->AEM_S(57,20) = 0.5*ucMSelf[7]*mnuSelf+m0rSelf[7]*mnuSelf-0.5*cErSelf[7]*mnuSelf; 
  data->AEM_S(57,21) = 0.5000000000000001*ucMSelf[5]*mnuSelf+1.0*m0rSelf[5]*mnuSelf-0.5000000000000001*cErSelf[5]*mnuSelf; 
  data->AEM_S(57,22) = 0.447213595499958*ucMSelf[3]*mnuSelf+0.8944271909999161*m0rSelf[3]*mnuSelf-0.447213595499958*cErSelf[3]*mnuSelf; 
  data->AEM_S(57,23) = 0.4391550328268399*ucMSelf[9]*mnuSelf+0.8783100656536798*m0rSelf[9]*mnuSelf-0.4391550328268399*cErSelf[9]*mnuSelf+0.4*ucMSelf[6]*mnuSelf+0.8*m0rSelf[6]*mnuSelf-0.4*cErSelf[6]*mnuSelf+0.447213595499958*ucMSelf[2]*mnuSelf+0.8944271909999161*m0rSelf[2]*mnuSelf-0.447213595499958*cErSelf[2]*mnuSelf; 
  data->AEM_S(57,24) = 0.4472135954999579*ucMSelf[7]*mnuSelf+0.8944271909999159*m0rSelf[7]*mnuSelf-0.4472135954999579*cErSelf[7]*mnuSelf; 
  data->AEM_S(57,25) = 0.31943828249997*ucMSelf[7]*mnuSelf+0.6388765649999399*m0rSelf[7]*mnuSelf-0.31943828249997*cErSelf[7]*mnuSelf+0.5000000000000001*ucMSelf[1]*mnuSelf+1.0*m0rSelf[1]*mnuSelf-0.5000000000000001*cErSelf[1]*mnuSelf; 
  data->AEM_S(57,26) = 0.4*ucMSelf[3]*mnuSelf+0.8*m0rSelf[3]*mnuSelf-0.4*cErSelf[3]*mnuSelf; 
  data->AEM_S(57,27) = 0.31943828249997*ucMSelf[5]*mnuSelf+0.6388765649999399*m0rSelf[5]*mnuSelf-0.31943828249997*cErSelf[5]*mnuSelf+0.4472135954999579*ucMSelf[4]*mnuSelf+0.8944271909999159*m0rSelf[4]*mnuSelf-0.4472135954999579*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(57,29) = 0.4391550328268399*ucMSelf[3]*mnuSelf+0.8783100656536798*m0rSelf[3]*mnuSelf-0.4391550328268399*cErSelf[3]*mnuSelf; 
  data->AEM_S(58,20) = 0.5*ucMSelf[8]*mnuSelf+m0rSelf[8]*mnuSelf-0.5*cErSelf[8]*mnuSelf; 
  data->AEM_S(58,21) = 0.4391550328268398*ucMSelf[4]*mnuSelf+0.8783100656536796*m0rSelf[4]*mnuSelf-0.4391550328268398*cErSelf[4]*mnuSelf; 
  data->AEM_S(58,23) = 0.4391550328268399*ucMSelf[6]*mnuSelf+0.8783100656536798*m0rSelf[6]*mnuSelf-0.4391550328268399*cErSelf[6]*mnuSelf; 
  data->AEM_S(58,24) = 0.2981423969999719*ucMSelf[8]*mnuSelf+0.5962847939999438*m0rSelf[8]*mnuSelf-0.2981423969999719*cErSelf[8]*mnuSelf+0.4391550328268398*ucMSelf[1]*mnuSelf+0.8783100656536796*m0rSelf[1]*mnuSelf-0.4391550328268398*cErSelf[1]*mnuSelf; 
  data->AEM_S(58,26) = 0.4391550328268399*ucMSelf[3]*mnuSelf+0.8783100656536798*m0rSelf[3]*mnuSelf-0.4391550328268399*cErSelf[3]*mnuSelf; 
  data->AEM_S(58,28) = 0.2981423969999719*ucMSelf[4]*mnuSelf+0.5962847939999438*m0rSelf[4]*mnuSelf-0.2981423969999719*cErSelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  data->AEM_S(59,20) = 0.5*ucMSelf[9]*mnuSelf+m0rSelf[9]*mnuSelf-0.5*cErSelf[9]*mnuSelf; 
  data->AEM_S(59,22) = 0.4391550328268398*ucMSelf[5]*mnuSelf+0.8783100656536796*m0rSelf[5]*mnuSelf-0.4391550328268398*cErSelf[5]*mnuSelf; 
  data->AEM_S(59,23) = 0.4391550328268399*ucMSelf[7]*mnuSelf+0.8783100656536798*m0rSelf[7]*mnuSelf-0.4391550328268399*cErSelf[7]*mnuSelf; 
  data->AEM_S(59,25) = 0.2981423969999719*ucMSelf[9]*mnuSelf+0.5962847939999438*m0rSelf[9]*mnuSelf-0.2981423969999719*cErSelf[9]*mnuSelf+0.4391550328268398*ucMSelf[2]*mnuSelf+0.8783100656536796*m0rSelf[2]*mnuSelf-0.4391550328268398*cErSelf[2]*mnuSelf; 
  data->AEM_S(59,27) = 0.4391550328268399*ucMSelf[3]*mnuSelf+0.8783100656536798*m0rSelf[3]*mnuSelf-0.4391550328268399*cErSelf[3]*mnuSelf; 
  data->AEM_S(59,29) = 0.2981423969999719*ucMSelf[5]*mnuSelf+0.5962847939999438*m0rSelf[5]*mnuSelf-0.2981423969999719*cErSelf[5]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cErSelf[0]*mnuSelf; 
  ...
  { 
    unsigned short int a0 = 10*vd; 
    // Contribution to dot-product from weak multiplication of vd component. 
    ucMOther[0] += 0.5*cMrOther[a0+9]*uOther[a0+9]+0.5*cMrOther[a0+8]*uOther[a0+8]+0.5*cMrOther[a0+7]*uOther[a0+7]+0.5*cMrOther[a0+6]*uOther[a0+6]+0.5*cMrOther[a0+5]*uOther[a0+5]+0.5*cMrOther[a0+4]*uOther[a0+4]+0.5*cMrOther[a0+3]*uOther[a0+3]+0.5*cMrOther[a0+2]*uOther[a0+2]+0.5*cMrOther[a0+1]*uOther[a0+1]+0.5*cMrOther[a0]*uOther[a0]; 
    ucMOther[1] += 0.4391550328268398*cMrOther[a0+4]*uOther[a0+8]+0.4391550328268398*uOther[a0+4]*cMrOther[a0+8]+0.5000000000000001*cMrOther[a0+5]*uOther[a0+7]+0.5000000000000001*uOther[a0+5]*cMrOther[a0+7]+0.447213595499958*cMrOther[a0+3]*uOther[a0+6]+0.447213595499958*uOther[a0+3]*cMrOther[a0+6]+0.4472135954999579*cMrOther[a0+1]*uOther[a0+4]+0.4472135954999579*uOther[a0+1]*cMrOther[a0+4]+0.5*cMrOther[a0+2]*uOther[a0+3]+0.5*uOther[a0+2]*cMrOther[a0+3]+0.5*cMrOther[a0]*uOther[a0+1]+0.5*uOther[a0]*cMrOther[a0+1]; 
    ucMOther[2] += 0.4391550328268398*cMrOther[a0+5]*uOther[a0+9]+0.4391550328268398*uOther[a0+5]*cMrOther[a0+9]+0.447213595499958*cMrOther[a0+3]*uOther[a0+7]+0.447213595499958*uOther[a0+3]*cMrOther[a0+7]+0.5000000000000001*cMrOther[a0+4]*uOther[a0+6]+0.5000000000000001*uOther[a0+4]*cMrOther[a0+6]+0.4472135954999579*cMrOther[a0+2]*uOther[a0+5]+0.4472135954999579*uOther[a0+2]*cMrOther[a0+5]+0.5*cMrOther[a0+1]*uOther[a0+3]+0.5*uOther[a0+1]*cMrOther[a0+3]+0.5*cMrOther[a0]*uOther[a0+2]+0.5*uOther[a0]*cMrOther[a0+2]; 
    ucMOther[3] += 0.4391550328268399*cMrOther[a0+7]*uOther[a0+9]+0.4391550328268399*uOther[a0+7]*cMrOther[a0+9]+0.4391550328268399*cMrOther[a0+6]*uOther[a0+8]+0.4391550328268399*uOther[a0+6]*cMrOther[a0+8]+0.4*cMrOther[a0+6]*uOther[a0+7]+0.447213595499958*cMrOther[a0+2]*uOther[a0+7]+0.4*uOther[a0+6]*cMrOther[a0+7]+0.447213595499958*uOther[a0+2]*cMrOther[a0+7]+0.447213595499958*cMrOther[a0+1]*uOther[a0+6]+0.447213595499958*uOther[a0+1]*cMrOther[a0+6]+0.4472135954999579*cMrOther[a0+3]*uOther[a0+5]+0.4472135954999579*uOther[a0+3]*cMrOther[a0+5]+0.4472135954999579*cMrOther[a0+3]*uOther[a0+4]+0.4472135954999579*uOther[a0+3]*cMrOther[a0+4]+0.5*cMrOther[a0]*uOther[a0+3]+0.5*uOther[a0]*cMrOther[a0+3]+0.5*cMrOther[a0+1]*uOther[a0+2]+0.5*uOther[a0+1]*cMrOther[a0+2]; 
    ucMOther[4] += 0.2981423969999719*cMrOther[a0+8]*uOther[a0+8]+0.4391550328268398*cMrOther[a0+1]*uOther[a0+8]+0.4391550328268398*uOther[a0+1]*cMrOther[a0+8]+0.4472135954999579*cMrOther[a0+7]*uOther[a0+7]+0.31943828249997*cMrOther[a0+6]*uOther[a0+6]+0.5000000000000001*cMrOther[a0+2]*uOther[a0+6]+0.5000000000000001*uOther[a0+2]*cMrOther[a0+6]+0.31943828249997*cMrOther[a0+4]*uOther[a0+4]+0.5*cMrOther[a0]*uOther[a0+4]+0.5*uOther[a0]*cMrOther[a0+4]+0.4472135954999579*cMrOther[a0+3]*uOther[a0+3]+0.4472135954999579*cMrOther[a0+1]*uOther[a0+1]; 
    ucMOther[5] += 0.2981423969999719*cMrOther[a0+9]*uOther[a0+9]+0.4391550328268398*cMrOther[a0+2]*uOther[a0+9]+0.4391550328268398*uOther[a0+2]*cMrOther[a0+9]+0.31943828249997*cMrOther[a0+7]*uOther[a0+7]+0.5000000000000001*cMrOther[a0+1]*uOther[a0+7]+0.5000000000000001*uOther[a0+1]*cMrOther[a0+7]+0.4472135954999579*cMrOther[a0+6]*uOther[a0+6]+0.31943828249997*cMrOther[a0+5]*uOther[a0+5]+0.5*cMrOther[a0]*uOther[a0+5]+0.5*uOther[a0]*cMrOther[a0+5]+0.4472135954999579*cMrOther[a0+3]*uOther[a0+3]+0.4472135954999579*cMrOther[a0+2]*uOther[a0+2]; 
    ucMOther[6] += 0.4391550328268399*cMrOther[a0+3]*uOther[a0+8]+0.4391550328268399*uOther[a0+3]*cMrOther[a0+8]+0.4*cMrOther[a0+3]*uOther[a0+7]+0.4*uOther[a0+3]*cMrOther[a0+7]+0.4472135954999579*cMrOther[a0+5]*uOther[a0+6]+0.31943828249997*cMrOther[a0+4]*uOther[a0+6]+0.5*cMrOther[a0]*uOther[a0+6]+0.4472135954999579*uOther[a0+5]*cMrOther[a0+6]+0.31943828249997*uOther[a0+4]*cMrOther[a0+6]+0.5*uOther[a0]*cMrOther[a0+6]+0.5000000000000001*cMrOther[a0+2]*uOther[a0+4]+0.5000000000000001*uOther[a0+2]*cMrOther[a0+4]+0.447213595499958*cMrOther[a0+1]*uOther[a0+3]+0.447213595499958*uOther[a0+1]*cMrOther[a0+3]; 
    ucMOther[7] += 0.4391550328268399*cMrOther[a0+3]*uOther[a0+9]+0.4391550328268399*uOther[a0+3]*cMrOther[a0+9]+0.31943828249997*cMrOther[a0+5]*uOther[a0+7]+0.4472135954999579*cMrOther[a0+4]*uOther[a0+7]+0.5*cMrOther[a0]*uOther[a0+7]+0.31943828249997*uOther[a0+5]*cMrOther[a0+7]+0.4472135954999579*uOther[a0+4]*cMrOther[a0+7]+0.5*uOther[a0]*cMrOther[a0+7]+0.4*cMrOther[a0+3]*uOther[a0+6]+0.4*uOther[a0+3]*cMrOther[a0+6]+0.5000000000000001*cMrOther[a0+1]*uOther[a0+5]+0.5000000000000001*uOther[a0+1]*cMrOther[a0+5]+0.447213595499958*cMrOther[a0+2]*uOther[a0+3]+0.447213595499958*uOther[a0+2]*cMrOther[a0+3]; 
    ucMOther[8] += 0.2981423969999719*cMrOther[a0+4]*uOther[a0+8]+0.5*cMrOther[a0]*uOther[a0+8]+0.2981423969999719*uOther[a0+4]*cMrOther[a0+8]+0.5*uOther[a0]*cMrOther[a0+8]+0.4391550328268399*cMrOther[a0+3]*uOther[a0+6]+0.4391550328268399*uOther[a0+3]*cMrOther[a0+6]+0.4391550328268398*cMrOther[a0+1]*uOther[a0+4]+0.4391550328268398*uOther[a0+1]*cMrOther[a0+4]; 
    ucMOther[9] += 0.2981423969999719*cMrOther[a0+5]*uOther[a0+9]+0.5*cMrOther[a0]*uOther[a0+9]+0.2981423969999719*uOther[a0+5]*cMrOther[a0+9]+0.5*uOther[a0]*cMrOther[a0+9]+0.4391550328268399*cMrOther[a0+3]*uOther[a0+7]+0.4391550328268399*uOther[a0+3]*cMrOther[a0+7]+0.4391550328268398*cMrOther[a0+2]*uOther[a0+5]+0.4391550328268398*uOther[a0+2]*cMrOther[a0+5]; 
  } 
 
  // ... Block from correction to (other) 2nd moment of collision operator ... // 
  data->AEM_S(50,50) = (-0.5*ucMOther[0]*mnuOther)-1.0*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(50,51) = (-0.5*ucMOther[1]*mnuOther)-1.0*m0rOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(50,52) = (-0.5*ucMOther[2]*mnuOther)-1.0*m0rOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(50,53) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(50,54) = (-0.5*ucMOther[4]*mnuOther)-1.0*m0rOther[4]*mnuOther+0.5*cErOther[4]*mnuOther; 
  data->AEM_S(50,55) = (-0.5*ucMOther[5]*mnuOther)-1.0*m0rOther[5]*mnuOther+0.5*cErOther[5]*mnuOther; 
  data->AEM_S(50,56) = (-0.5*ucMOther[6]*mnuOther)-1.0*m0rOther[6]*mnuOther+0.5*cErOther[6]*mnuOther; 
  data->AEM_S(50,57) = (-0.5*ucMOther[7]*mnuOther)-1.0*m0rOther[7]*mnuOther+0.5*cErOther[7]*mnuOther; 
  data->AEM_S(50,58) = (-0.5*ucMOther[8]*mnuOther)-1.0*m0rOther[8]*mnuOther+0.5*cErOther[8]*mnuOther; 
  data->AEM_S(50,59) = (-0.5*ucMOther[9]*mnuOther)-1.0*m0rOther[9]*mnuOther+0.5*cErOther[9]*mnuOther; 
  data->AEM_S(51,50) = (-0.5*ucMOther[1]*mnuOther)-1.0*m0rOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(51,51) = (-0.4472135954999579*ucMOther[4]*mnuOther)-0.8944271909999159*m0rOther[4]*mnuOther+0.4472135954999579*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(51,52) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(51,53) = (-0.447213595499958*ucMOther[6]*mnuOther)-0.8944271909999161*m0rOther[6]*mnuOther+0.447213595499958*cErOther[6]*mnuOther-0.5*ucMOther[2]*mnuOther-1.0*m0rOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(51,54) = (-0.4391550328268398*ucMOther[8]*mnuOther)-0.8783100656536796*m0rOther[8]*mnuOther+0.4391550328268398*cErOther[8]*mnuOther-0.4472135954999579*ucMOther[1]*mnuOther-0.8944271909999159*m0rOther[1]*mnuOther+0.4472135954999579*cErOther[1]*mnuOther; 
  data->AEM_S(51,55) = (-0.5000000000000001*ucMOther[7]*mnuOther)-1.0*m0rOther[7]*mnuOther+0.5000000000000001*cErOther[7]*mnuOther; 
  data->AEM_S(51,56) = (-0.447213595499958*ucMOther[3]*mnuOther)-0.8944271909999161*m0rOther[3]*mnuOther+0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(51,57) = (-0.5000000000000001*ucMOther[5]*mnuOther)-1.0*m0rOther[5]*mnuOther+0.5000000000000001*cErOther[5]*mnuOther; 
  data->AEM_S(51,58) = (-0.4391550328268398*ucMOther[4]*mnuOther)-0.8783100656536796*m0rOther[4]*mnuOther+0.4391550328268398*cErOther[4]*mnuOther; 
  data->AEM_S(52,50) = (-0.5*ucMOther[2]*mnuOther)-1.0*m0rOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(52,51) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(52,52) = (-0.4472135954999579*ucMOther[5]*mnuOther)-0.8944271909999159*m0rOther[5]*mnuOther+0.4472135954999579*cErOther[5]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(52,53) = (-0.447213595499958*ucMOther[7]*mnuOther)-0.8944271909999161*m0rOther[7]*mnuOther+0.447213595499958*cErOther[7]*mnuOther-0.5*ucMOther[1]*mnuOther-1.0*m0rOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(52,54) = (-0.5000000000000001*ucMOther[6]*mnuOther)-1.0*m0rOther[6]*mnuOther+0.5000000000000001*cErOther[6]*mnuOther; 
  data->AEM_S(52,55) = (-0.4391550328268398*ucMOther[9]*mnuOther)-0.8783100656536796*m0rOther[9]*mnuOther+0.4391550328268398*cErOther[9]*mnuOther-0.4472135954999579*ucMOther[2]*mnuOther-0.8944271909999159*m0rOther[2]*mnuOther+0.4472135954999579*cErOther[2]*mnuOther; 
  data->AEM_S(52,56) = (-0.5000000000000001*ucMOther[4]*mnuOther)-1.0*m0rOther[4]*mnuOther+0.5000000000000001*cErOther[4]*mnuOther; 
  data->AEM_S(52,57) = (-0.447213595499958*ucMOther[3]*mnuOther)-0.8944271909999161*m0rOther[3]*mnuOther+0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(52,59) = (-0.4391550328268398*ucMOther[5]*mnuOther)-0.8783100656536796*m0rOther[5]*mnuOther+0.4391550328268398*cErOther[5]*mnuOther; 
  data->AEM_S(53,50) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther+0.5*cErOther[3]*mnuOther; 
  data->AEM_S(53,51) = (-0.447213595499958*ucMOther[6]*mnuOther)-0.8944271909999161*m0rOther[6]*mnuOther+0.447213595499958*cErOther[6]*mnuOther-0.5*ucMOther[2]*mnuOther-1.0*m0rOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(53,52) = (-0.447213595499958*ucMOther[7]*mnuOther)-0.8944271909999161*m0rOther[7]*mnuOther+0.447213595499958*cErOther[7]*mnuOther-0.5*ucMOther[1]*mnuOther-1.0*m0rOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(53,53) = (-0.4472135954999579*ucMOther[5]*mnuOther)-0.8944271909999159*m0rOther[5]*mnuOther+0.4472135954999579*cErOther[5]*mnuOther-0.4472135954999579*ucMOther[4]*mnuOther-0.8944271909999159*m0rOther[4]*mnuOther+0.4472135954999579*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(53,54) = (-0.4472135954999579*ucMOther[3]*mnuOther)-0.8944271909999159*m0rOther[3]*mnuOther+0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(53,55) = (-0.4472135954999579*ucMOther[3]*mnuOther)-0.8944271909999159*m0rOther[3]*mnuOther+0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(53,56) = (-0.4391550328268399*ucMOther[8]*mnuOther)-0.8783100656536798*m0rOther[8]*mnuOther+0.4391550328268399*cErOther[8]*mnuOther-0.4*ucMOther[7]*mnuOther-0.8*m0rOther[7]*mnuOther+0.4*cErOther[7]*mnuOther-0.447213595499958*ucMOther[1]*mnuOther-0.8944271909999161*m0rOther[1]*mnuOther+0.447213595499958*cErOther[1]*mnuOther; 
  data->AEM_S(53,57) = (-0.4391550328268399*ucMOther[9]*mnuOther)-0.8783100656536798*m0rOther[9]*mnuOther+0.4391550328268399*cErOther[9]*mnuOther-0.4*ucMOther[6]*mnuOther-0.8*m0rOther[6]*mnuOther+0.4*cErOther[6]*mnuOther-0.447213595499958*ucMOther[2]*mnuOther-0.8944271909999161*m0rOther[2]*mnuOther+0.447213595499958*cErOther[2]*mnuOther; 
  data->AEM_S(53,58) = (-0.4391550328268399*ucMOther[6]*mnuOther)-0.8783100656536798*m0rOther[6]*mnuOther+0.4391550328268399*cErOther[6]*mnuOther; 
  data->AEM_S(53,59) = (-0.4391550328268399*ucMOther[7]*mnuOther)-0.8783100656536798*m0rOther[7]*mnuOther+0.4391550328268399*cErOther[7]*mnuOther; 
  data->AEM_S(54,50) = (-0.5*ucMOther[4]*mnuOther)-1.0*m0rOther[4]*mnuOther+0.5*cErOther[4]*mnuOther; 
  data->AEM_S(54,51) = (-0.4391550328268398*ucMOther[8]*mnuOther)-0.8783100656536796*m0rOther[8]*mnuOther+0.4391550328268398*cErOther[8]*mnuOther-0.4472135954999579*ucMOther[1]*mnuOther-0.8944271909999159*m0rOther[1]*mnuOther+0.4472135954999579*cErOther[1]*mnuOther; 
  data->AEM_S(54,52) = (-0.5000000000000001*ucMOther[6]*mnuOther)-1.0*m0rOther[6]*mnuOther+0.5000000000000001*cErOther[6]*mnuOther; 
  data->AEM_S(54,53) = (-0.4472135954999579*ucMOther[3]*mnuOther)-0.8944271909999159*m0rOther[3]*mnuOther+0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(54,54) = (-0.31943828249997*ucMOther[4]*mnuOther)-0.6388765649999399*m0rOther[4]*mnuOther+0.31943828249997*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(54,56) = (-0.31943828249997*ucMOther[6]*mnuOther)-0.6388765649999399*m0rOther[6]*mnuOther+0.31943828249997*cErOther[6]*mnuOther-0.5000000000000001*ucMOther[2]*mnuOther-1.0*m0rOther[2]*mnuOther+0.5000000000000001*cErOther[2]*mnuOther; 
  data->AEM_S(54,57) = (-0.4472135954999579*ucMOther[7]*mnuOther)-0.8944271909999159*m0rOther[7]*mnuOther+0.4472135954999579*cErOther[7]*mnuOther; 
  data->AEM_S(54,58) = (-0.2981423969999719*ucMOther[8]*mnuOther)-0.5962847939999438*m0rOther[8]*mnuOther+0.2981423969999719*cErOther[8]*mnuOther-0.4391550328268398*ucMOther[1]*mnuOther-0.8783100656536796*m0rOther[1]*mnuOther+0.4391550328268398*cErOther[1]*mnuOther; 
  data->AEM_S(55,50) = (-0.5*ucMOther[5]*mnuOther)-1.0*m0rOther[5]*mnuOther+0.5*cErOther[5]*mnuOther; 
  data->AEM_S(55,51) = (-0.5000000000000001*ucMOther[7]*mnuOther)-1.0*m0rOther[7]*mnuOther+0.5000000000000001*cErOther[7]*mnuOther; 
  data->AEM_S(55,52) = (-0.4391550328268398*ucMOther[9]*mnuOther)-0.8783100656536796*m0rOther[9]*mnuOther+0.4391550328268398*cErOther[9]*mnuOther-0.4472135954999579*ucMOther[2]*mnuOther-0.8944271909999159*m0rOther[2]*mnuOther+0.4472135954999579*cErOther[2]*mnuOther; 
  data->AEM_S(55,53) = (-0.4472135954999579*ucMOther[3]*mnuOther)-0.8944271909999159*m0rOther[3]*mnuOther+0.4472135954999579*cErOther[3]*mnuOther; 
  data->AEM_S(55,55) = (-0.31943828249997*ucMOther[5]*mnuOther)-0.6388765649999399*m0rOther[5]*mnuOther+0.31943828249997*cErOther[5]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(55,56) = (-0.4472135954999579*ucMOther[6]*mnuOther)-0.8944271909999159*m0rOther[6]*mnuOther+0.4472135954999579*cErOther[6]*mnuOther; 
  data->AEM_S(55,57) = (-0.31943828249997*ucMOther[7]*mnuOther)-0.6388765649999399*m0rOther[7]*mnuOther+0.31943828249997*cErOther[7]*mnuOther-0.5000000000000001*ucMOther[1]*mnuOther-1.0*m0rOther[1]*mnuOther+0.5000000000000001*cErOther[1]*mnuOther; 
  data->AEM_S(55,59) = (-0.2981423969999719*ucMOther[9]*mnuOther)-0.5962847939999438*m0rOther[9]*mnuOther+0.2981423969999719*cErOther[9]*mnuOther-0.4391550328268398*ucMOther[2]*mnuOther-0.8783100656536796*m0rOther[2]*mnuOther+0.4391550328268398*cErOther[2]*mnuOther; 
  data->AEM_S(56,50) = (-0.5*ucMOther[6]*mnuOther)-1.0*m0rOther[6]*mnuOther+0.5*cErOther[6]*mnuOther; 
  data->AEM_S(56,51) = (-0.447213595499958*ucMOther[3]*mnuOther)-0.8944271909999161*m0rOther[3]*mnuOther+0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(56,52) = (-0.5000000000000001*ucMOther[4]*mnuOther)-1.0*m0rOther[4]*mnuOther+0.5000000000000001*cErOther[4]*mnuOther; 
  data->AEM_S(56,53) = (-0.4391550328268399*ucMOther[8]*mnuOther)-0.8783100656536798*m0rOther[8]*mnuOther+0.4391550328268399*cErOther[8]*mnuOther-0.4*ucMOther[7]*mnuOther-0.8*m0rOther[7]*mnuOther+0.4*cErOther[7]*mnuOther-0.447213595499958*ucMOther[1]*mnuOther-0.8944271909999161*m0rOther[1]*mnuOther+0.447213595499958*cErOther[1]*mnuOther; 
  data->AEM_S(56,54) = (-0.31943828249997*ucMOther[6]*mnuOther)-0.6388765649999399*m0rOther[6]*mnuOther+0.31943828249997*cErOther[6]*mnuOther-0.5000000000000001*ucMOther[2]*mnuOther-1.0*m0rOther[2]*mnuOther+0.5000000000000001*cErOther[2]*mnuOther; 
  data->AEM_S(56,55) = (-0.4472135954999579*ucMOther[6]*mnuOther)-0.8944271909999159*m0rOther[6]*mnuOther+0.4472135954999579*cErOther[6]*mnuOther; 
  data->AEM_S(56,56) = (-0.4472135954999579*ucMOther[5]*mnuOther)-0.8944271909999159*m0rOther[5]*mnuOther+0.4472135954999579*cErOther[5]*mnuOther-0.31943828249997*ucMOther[4]*mnuOther-0.6388765649999399*m0rOther[4]*mnuOther+0.31943828249997*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(56,57) = (-0.4*ucMOther[3]*mnuOther)-0.8*m0rOther[3]*mnuOther+0.4*cErOther[3]*mnuOther; 
  data->AEM_S(56,58) = (-0.4391550328268399*ucMOther[3]*mnuOther)-0.8783100656536798*m0rOther[3]*mnuOther+0.4391550328268399*cErOther[3]*mnuOther; 
  data->AEM_S(57,50) = (-0.5*ucMOther[7]*mnuOther)-1.0*m0rOther[7]*mnuOther+0.5*cErOther[7]*mnuOther; 
  data->AEM_S(57,51) = (-0.5000000000000001*ucMOther[5]*mnuOther)-1.0*m0rOther[5]*mnuOther+0.5000000000000001*cErOther[5]*mnuOther; 
  data->AEM_S(57,52) = (-0.447213595499958*ucMOther[3]*mnuOther)-0.8944271909999161*m0rOther[3]*mnuOther+0.447213595499958*cErOther[3]*mnuOther; 
  data->AEM_S(57,53) = (-0.4391550328268399*ucMOther[9]*mnuOther)-0.8783100656536798*m0rOther[9]*mnuOther+0.4391550328268399*cErOther[9]*mnuOther-0.4*ucMOther[6]*mnuOther-0.8*m0rOther[6]*mnuOther+0.4*cErOther[6]*mnuOther-0.447213595499958*ucMOther[2]*mnuOther-0.8944271909999161*m0rOther[2]*mnuOther+0.447213595499958*cErOther[2]*mnuOther; 
  data->AEM_S(57,54) = (-0.4472135954999579*ucMOther[7]*mnuOther)-0.8944271909999159*m0rOther[7]*mnuOther+0.4472135954999579*cErOther[7]*mnuOther; 
  data->AEM_S(57,55) = (-0.31943828249997*ucMOther[7]*mnuOther)-0.6388765649999399*m0rOther[7]*mnuOther+0.31943828249997*cErOther[7]*mnuOther-0.5000000000000001*ucMOther[1]*mnuOther-1.0*m0rOther[1]*mnuOther+0.5000000000000001*cErOther[1]*mnuOther; 
  data->AEM_S(57,56) = (-0.4*ucMOther[3]*mnuOther)-0.8*m0rOther[3]*mnuOther+0.4*cErOther[3]*mnuOther; 
  data->AEM_S(57,57) = (-0.31943828249997*ucMOther[5]*mnuOther)-0.6388765649999399*m0rOther[5]*mnuOther+0.31943828249997*cErOther[5]*mnuOther-0.4472135954999579*ucMOther[4]*mnuOther-0.8944271909999159*m0rOther[4]*mnuOther+0.4472135954999579*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(57,59) = (-0.4391550328268399*ucMOther[3]*mnuOther)-0.8783100656536798*m0rOther[3]*mnuOther+0.4391550328268399*cErOther[3]*mnuOther; 
  data->AEM_S(58,50) = (-0.5*ucMOther[8]*mnuOther)-1.0*m0rOther[8]*mnuOther+0.5*cErOther[8]*mnuOther; 
  data->AEM_S(58,51) = (-0.4391550328268398*ucMOther[4]*mnuOther)-0.8783100656536796*m0rOther[4]*mnuOther+0.4391550328268398*cErOther[4]*mnuOther; 
  data->AEM_S(58,53) = (-0.4391550328268399*ucMOther[6]*mnuOther)-0.8783100656536798*m0rOther[6]*mnuOther+0.4391550328268399*cErOther[6]*mnuOther; 
  data->AEM_S(58,54) = (-0.2981423969999719*ucMOther[8]*mnuOther)-0.5962847939999438*m0rOther[8]*mnuOther+0.2981423969999719*cErOther[8]*mnuOther-0.4391550328268398*ucMOther[1]*mnuOther-0.8783100656536796*m0rOther[1]*mnuOther+0.4391550328268398*cErOther[1]*mnuOther; 
  data->AEM_S(58,56) = (-0.4391550328268399*ucMOther[3]*mnuOther)-0.8783100656536798*m0rOther[3]*mnuOther+0.4391550328268399*cErOther[3]*mnuOther; 
  data->AEM_S(58,58) = (-0.2981423969999719*ucMOther[4]*mnuOther)-0.5962847939999438*m0rOther[4]*mnuOther+0.2981423969999719*cErOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  data->AEM_S(59,50) = (-0.5*ucMOther[9]*mnuOther)-1.0*m0rOther[9]*mnuOther+0.5*cErOther[9]*mnuOther; 
  data->AEM_S(59,52) = (-0.4391550328268398*ucMOther[5]*mnuOther)-0.8783100656536796*m0rOther[5]*mnuOther+0.4391550328268398*cErOther[5]*mnuOther; 
  data->AEM_S(59,53) = (-0.4391550328268399*ucMOther[7]*mnuOther)-0.8783100656536798*m0rOther[7]*mnuOther+0.4391550328268399*cErOther[7]*mnuOther; 
  data->AEM_S(59,55) = (-0.2981423969999719*ucMOther[9]*mnuOther)-0.5962847939999438*m0rOther[9]*mnuOther+0.2981423969999719*cErOther[9]*mnuOther-0.4391550328268398*ucMOther[2]*mnuOther-0.8783100656536796*m0rOther[2]*mnuOther+0.4391550328268398*cErOther[2]*mnuOther; 
  data->AEM_S(59,57) = (-0.4391550328268399*ucMOther[3]*mnuOther)-0.8783100656536798*m0rOther[3]*mnuOther+0.4391550328268399*cErOther[3]*mnuOther; 
  data->AEM_S(59,59) = (-0.2981423969999719*ucMOther[5]*mnuOther)-0.5962847939999438*m0rOther[5]*mnuOther+0.2981423969999719*cErOther[5]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cErOther[0]*mnuOther; 
  ...
  { 
    unsigned short int a0 = 10*vd; 
    // Contribution to dot-product from weak multiplication of vd component. 
    relKinE[0] += 0.5*m1EffD[a0+9]*uSelf[a0+9]-0.5*m1EffD[a0+9]*uOther[a0+9]+0.5*m1EffD[a0+8]*uSelf[a0+8]-0.5*m1EffD[a0+8]*uOther[a0+8]+0.5*m1EffD[a0+7]*uSelf[a0+7]-0.5*m1EffD[a0+7]*uOther[a0+7]+0.5*m1EffD[a0+6]*uSelf[a0+6]-0.5*m1EffD[a0+6]*uOther[a0+6]+0.5*m1EffD[a0+5]*uSelf[a0+5]-0.5*m1EffD[a0+5]*uOther[a0+5]+0.5*m1EffD[a0+4]*uSelf[a0+4]-0.5*m1EffD[a0+4]*uOther[a0+4]+0.5*m1EffD[a0+3]*uSelf[a0+3]-0.5*m1EffD[a0+3]*uOther[a0+3]+0.5*m1EffD[a0+2]*uSelf[a0+2]-0.5*m1EffD[a0+2]*uOther[a0+2]+0.5*m1EffD[a0+1]*uSelf[a0+1]-0.5*m1EffD[a0+1]*uOther[a0+1]+0.5*m1EffD[a0]*uSelf[a0]-0.5*m1EffD[a0]*uOther[a0]; 
    relKinE[1] += 0.4391550328268398*m1EffD[a0+4]*uSelf[a0+8]-0.4391550328268398*m1EffD[a0+4]*uOther[a0+8]+0.4391550328268398*uSelf[a0+4]*m1EffD[a0+8]-0.4391550328268398*uOther[a0+4]*m1EffD[a0+8]+0.5000000000000001*m1EffD[a0+5]*uSelf[a0+7]-0.5000000000000001*m1EffD[a0+5]*uOther[a0+7]+0.5000000000000001*uSelf[a0+5]*m1EffD[a0+7]-0.5000000000000001*uOther[a0+5]*m1EffD[a0+7]+0.447213595499958*m1EffD[a0+3]*uSelf[a0+6]-0.447213595499958*m1EffD[a0+3]*uOther[a0+6]+0.447213595499958*uSelf[a0+3]*m1EffD[a0+6]-0.447213595499958*uOther[a0+3]*m1EffD[a0+6]+0.4472135954999579*m1EffD[a0+1]*uSelf[a0+4]-0.4472135954999579*m1EffD[a0+1]*uOther[a0+4]+0.4472135954999579*uSelf[a0+1]*m1EffD[a0+4]-0.4472135954999579*uOther[a0+1]*m1EffD[a0+4]+0.5*m1EffD[a0+2]*uSelf[a0+3]-0.5*m1EffD[a0+2]*uOther[a0+3]+0.5*uSelf[a0+2]*m1EffD[a0+3]-0.5*uOther[a0+2]*m1EffD[a0+3]+0.5*m1EffD[a0]*uSelf[a0+1]-0.5*m1EffD[a0]*uOther[a0+1]+0.5*uSelf[a0]*m1EffD[a0+1]-0.5*uOther[a0]*m1EffD[a0+1]; 
    relKinE[2] += 0.4391550328268398*m1EffD[a0+5]*uSelf[a0+9]-0.4391550328268398*m1EffD[a0+5]*uOther[a0+9]+0.4391550328268398*uSelf[a0+5]*m1EffD[a0+9]-0.4391550328268398*uOther[a0+5]*m1EffD[a0+9]+0.447213595499958*m1EffD[a0+3]*uSelf[a0+7]-0.447213595499958*m1EffD[a0+3]*uOther[a0+7]+0.447213595499958*uSelf[a0+3]*m1EffD[a0+7]-0.447213595499958*uOther[a0+3]*m1EffD[a0+7]+0.5000000000000001*m1EffD[a0+4]*uSelf[a0+6]-0.5000000000000001*m1EffD[a0+4]*uOther[a0+6]+0.5000000000000001*uSelf[a0+4]*m1EffD[a0+6]-0.5000000000000001*uOther[a0+4]*m1EffD[a0+6]+0.4472135954999579*m1EffD[a0+2]*uSelf[a0+5]-0.4472135954999579*m1EffD[a0+2]*uOther[a0+5]+0.4472135954999579*uSelf[a0+2]*m1EffD[a0+5]-0.4472135954999579*uOther[a0+2]*m1EffD[a0+5]+0.5*m1EffD[a0+1]*uSelf[a0+3]-0.5*m1EffD[a0+1]*uOther[a0+3]+0.5*uSelf[a0+1]*m1EffD[a0+3]-0.5*uOther[a0+1]*m1EffD[a0+3]+0.5*m1EffD[a0]*uSelf[a0+2]-0.5*m1EffD[a0]*uOther[a0+2]+0.5*uSelf[a0]*m1EffD[a0+2]-0.5*uOther[a0]*m1EffD[a0+2]; 
    relKinE[3] += 0.4391550328268399*m1EffD[a0+7]*uSelf[a0+9]-0.4391550328268399*m1EffD[a0+7]*uOther[a0+9]+0.4391550328268399*uSelf[a0+7]*m1EffD[a0+9]-0.4391550328268399*uOther[a0+7]*m1EffD[a0+9]+0.4391550328268399*m1EffD[a0+6]*uSelf[a0+8]-0.4391550328268399*m1EffD[a0+6]*uOther[a0+8]+0.4391550328268399*uSelf[a0+6]*m1EffD[a0+8]-0.4391550328268399*uOther[a0+6]*m1EffD[a0+8]+0.4*m1EffD[a0+6]*uSelf[a0+7]+0.447213595499958*m1EffD[a0+2]*uSelf[a0+7]-0.4*m1EffD[a0+6]*uOther[a0+7]-0.447213595499958*m1EffD[a0+2]*uOther[a0+7]+0.4*uSelf[a0+6]*m1EffD[a0+7]-0.4*uOther[a0+6]*m1EffD[a0+7]+0.447213595499958*uSelf[a0+2]*m1EffD[a0+7]-0.447213595499958*uOther[a0+2]*m1EffD[a0+7]+0.447213595499958*m1EffD[a0+1]*uSelf[a0+6]-0.447213595499958*m1EffD[a0+1]*uOther[a0+6]+0.447213595499958*uSelf[a0+1]*m1EffD[a0+6]-0.447213595499958*uOther[a0+1]*m1EffD[a0+6]+0.4472135954999579*m1EffD[a0+3]*uSelf[a0+5]-0.4472135954999579*m1EffD[a0+3]*uOther[a0+5]+0.4472135954999579*uSelf[a0+3]*m1EffD[a0+5]-0.4472135954999579*uOther[a0+3]*m1EffD[a0+5]+0.4472135954999579*m1EffD[a0+3]*uSelf[a0+4]-0.4472135954999579*m1EffD[a0+3]*uOther[a0+4]+0.4472135954999579*uSelf[a0+3]*m1EffD[a0+4]-0.4472135954999579*uOther[a0+3]*m1EffD[a0+4]+0.5*m1EffD[a0]*uSelf[a0+3]-0.5*m1EffD[a0]*uOther[a0+3]+0.5*uSelf[a0]*m1EffD[a0+3]-0.5*uOther[a0]*m1EffD[a0+3]+0.5*m1EffD[a0+1]*uSelf[a0+2]-0.5*m1EffD[a0+1]*uOther[a0+2]+0.5*uSelf[a0+1]*m1EffD[a0+2]-0.5*uOther[a0+1]*m1EffD[a0+2]; 
    relKinE[4] += 0.2981423969999719*m1EffD[a0+8]*uSelf[a0+8]+0.4391550328268398*m1EffD[a0+1]*uSelf[a0+8]-0.2981423969999719*m1EffD[a0+8]*uOther[a0+8]-0.4391550328268398*m1EffD[a0+1]*uOther[a0+8]+0.4391550328268398*uSelf[a0+1]*m1EffD[a0+8]-0.4391550328268398*uOther[a0+1]*m1EffD[a0+8]+0.4472135954999579*m1EffD[a0+7]*uSelf[a0+7]-0.4472135954999579*m1EffD[a0+7]*uOther[a0+7]+0.31943828249997*m1EffD[a0+6]*uSelf[a0+6]+0.5000000000000001*m1EffD[a0+2]*uSelf[a0+6]-0.31943828249997*m1EffD[a0+6]*uOther[a0+6]-0.5000000000000001*m1EffD[a0+2]*uOther[a0+6]+0.5000000000000001*uSelf[a0+2]*m1EffD[a0+6]-0.5000000000000001*uOther[a0+2]*m1EffD[a0+6]+0.31943828249997*m1EffD[a0+4]*uSelf[a0+4]+0.5*m1EffD[a0]*uSelf[a0+4]-0.31943828249997*m1EffD[a0+4]*uOther[a0+4]-0.5*m1EffD[a0]*uOther[a0+4]+0.5*uSelf[a0]*m1EffD[a0+4]-0.5*uOther[a0]*m1EffD[a0+4]+0.4472135954999579*m1EffD[a0+3]*uSelf[a0+3]-0.4472135954999579*m1EffD[a0+3]*uOther[a0+3]+0.4472135954999579*m1EffD[a0+1]*uSelf[a0+1]-0.4472135954999579*m1EffD[a0+1]*uOther[a0+1]; 
    relKinE[5] += 0.2981423969999719*m1EffD[a0+9]*uSelf[a0+9]+0.4391550328268398*m1EffD[a0+2]*uSelf[a0+9]-0.2981423969999719*m1EffD[a0+9]*uOther[a0+9]-0.4391550328268398*m1EffD[a0+2]*uOther[a0+9]+0.4391550328268398*uSelf[a0+2]*m1EffD[a0+9]-0.4391550328268398*uOther[a0+2]*m1EffD[a0+9]+0.31943828249997*m1EffD[a0+7]*uSelf[a0+7]+0.5000000000000001*m1EffD[a0+1]*uSelf[a0+7]-0.31943828249997*m1EffD[a0+7]*uOther[a0+7]-0.5000000000000001*m1EffD[a0+1]*uOther[a0+7]+0.5000000000000001*uSelf[a0+1]*m1EffD[a0+7]-0.5000000000000001*uOther[a0+1]*m1EffD[a0+7]+0.4472135954999579*m1EffD[a0+6]*uSelf[a0+6]-0.4472135954999579*m1EffD[a0+6]*uOther[a0+6]+0.31943828249997*m1EffD[a0+5]*uSelf[a0+5]+0.5*m1EffD[a0]*uSelf[a0+5]-0.31943828249997*m1EffD[a0+5]*uOther[a0+5]-0.5*m1EffD[a0]*uOther[a0+5]+0.5*uSelf[a0]*m1EffD[a0+5]-0.5*uOther[a0]*m1EffD[a0+5]+0.4472135954999579*m1EffD[a0+3]*uSelf[a0+3]-0.4472135954999579*m1EffD[a0+3]*uOther[a0+3]+0.4472135954999579*m1EffD[a0+2]*uSelf[a0+2]-0.4472135954999579*m1EffD[a0+2]*uOther[a0+2]; 
    relKinE[6] += 0.4391550328268399*m1EffD[a0+3]*uSelf[a0+8]-0.4391550328268399*m1EffD[a0+3]*uOther[a0+8]+0.4391550328268399*uSelf[a0+3]*m1EffD[a0+8]-0.4391550328268399*uOther[a0+3]*m1EffD[a0+8]+0.4*m1EffD[a0+3]*uSelf[a0+7]-0.4*m1EffD[a0+3]*uOther[a0+7]+0.4*uSelf[a0+3]*m1EffD[a0+7]-0.4*uOther[a0+3]*m1EffD[a0+7]+0.4472135954999579*m1EffD[a0+5]*uSelf[a0+6]+0.31943828249997*m1EffD[a0+4]*uSelf[a0+6]+0.5*m1EffD[a0]*uSelf[a0+6]-0.4472135954999579*m1EffD[a0+5]*uOther[a0+6]-0.31943828249997*m1EffD[a0+4]*uOther[a0+6]-0.5*m1EffD[a0]*uOther[a0+6]+0.4472135954999579*uSelf[a0+5]*m1EffD[a0+6]-0.4472135954999579*uOther[a0+5]*m1EffD[a0+6]+0.31943828249997*uSelf[a0+4]*m1EffD[a0+6]-0.31943828249997*uOther[a0+4]*m1EffD[a0+6]+0.5*uSelf[a0]*m1EffD[a0+6]-0.5*uOther[a0]*m1EffD[a0+6]+0.5000000000000001*m1EffD[a0+2]*uSelf[a0+4]-0.5000000000000001*m1EffD[a0+2]*uOther[a0+4]+0.5000000000000001*uSelf[a0+2]*m1EffD[a0+4]-0.5000000000000001*uOther[a0+2]*m1EffD[a0+4]+0.447213595499958*m1EffD[a0+1]*uSelf[a0+3]-0.447213595499958*m1EffD[a0+1]*uOther[a0+3]+0.447213595499958*uSelf[a0+1]*m1EffD[a0+3]-0.447213595499958*uOther[a0+1]*m1EffD[a0+3]; 
    relKinE[7] += 0.4391550328268399*m1EffD[a0+3]*uSelf[a0+9]-0.4391550328268399*m1EffD[a0+3]*uOther[a0+9]+0.4391550328268399*uSelf[a0+3]*m1EffD[a0+9]-0.4391550328268399*uOther[a0+3]*m1EffD[a0+9]+0.31943828249997*m1EffD[a0+5]*uSelf[a0+7]+0.4472135954999579*m1EffD[a0+4]*uSelf[a0+7]+0.5*m1EffD[a0]*uSelf[a0+7]-0.31943828249997*m1EffD[a0+5]*uOther[a0+7]-0.4472135954999579*m1EffD[a0+4]*uOther[a0+7]-0.5*m1EffD[a0]*uOther[a0+7]+0.31943828249997*uSelf[a0+5]*m1EffD[a0+7]-0.31943828249997*uOther[a0+5]*m1EffD[a0+7]+0.4472135954999579*uSelf[a0+4]*m1EffD[a0+7]-0.4472135954999579*uOther[a0+4]*m1EffD[a0+7]+0.5*uSelf[a0]*m1EffD[a0+7]-0.5*uOther[a0]*m1EffD[a0+7]+0.4*m1EffD[a0+3]*uSelf[a0+6]-0.4*m1EffD[a0+3]*uOther[a0+6]+0.4*uSelf[a0+3]*m1EffD[a0+6]-0.4*uOther[a0+3]*m1EffD[a0+6]+0.5000000000000001*m1EffD[a0+1]*uSelf[a0+5]-0.5000000000000001*m1EffD[a0+1]*uOther[a0+5]+0.5000000000000001*uSelf[a0+1]*m1EffD[a0+5]-0.5000000000000001*uOther[a0+1]*m1EffD[a0+5]+0.447213595499958*m1EffD[a0+2]*uSelf[a0+3]-0.447213595499958*m1EffD[a0+2]*uOther[a0+3]+0.447213595499958*uSelf[a0+2]*m1EffD[a0+3]-0.447213595499958*uOther[a0+2]*m1EffD[a0+3]; 
    relKinE[8] += 0.2981423969999719*m1EffD[a0+4]*uSelf[a0+8]+0.5*m1EffD[a0]*uSelf[a0+8]-0.2981423969999719*m1EffD[a0+4]*uOther[a0+8]-0.5*m1EffD[a0]*uOther[a0+8]+0.2981423969999719*uSelf[a0+4]*m1EffD[a0+8]-0.2981423969999719*uOther[a0+4]*m1EffD[a0+8]+0.5*uSelf[a0]*m1EffD[a0+8]-0.5*uOther[a0]*m1EffD[a0+8]+0.4391550328268399*m1EffD[a0+3]*uSelf[a0+6]-0.4391550328268399*m1EffD[a0+3]*uOther[a0+6]+0.4391550328268399*uSelf[a0+3]*m1EffD[a0+6]-0.4391550328268399*uOther[a0+3]*m1EffD[a0+6]+0.4391550328268398*m1EffD[a0+1]*uSelf[a0+4]-0.4391550328268398*m1EffD[a0+1]*uOther[a0+4]+0.4391550328268398*uSelf[a0+1]*m1EffD[a0+4]-0.4391550328268398*uOther[a0+1]*m1EffD[a0+4]; 
    relKinE[9] += 0.2981423969999719*m1EffD[a0+5]*uSelf[a0+9]+0.5*m1EffD[a0]*uSelf[a0+9]-0.2981423969999719*m1EffD[a0+5]*uOther[a0+9]-0.5*m1EffD[a0]*uOther[a0+9]+0.2981423969999719*uSelf[a0+5]*m1EffD[a0+9]-0.2981423969999719*uOther[a0+5]*m1EffD[a0+9]+0.5*uSelf[a0]*m1EffD[a0+9]-0.5*uOther[a0]*m1EffD[a0+9]+0.4391550328268399*m1EffD[a0+3]*uSelf[a0+7]-0.4391550328268399*m1EffD[a0+3]*uOther[a0+7]+0.4391550328268399*uSelf[a0+3]*m1EffD[a0+7]-0.4391550328268399*uOther[a0+3]*m1EffD[a0+7]+0.4391550328268398*m1EffD[a0+2]*uSelf[a0+5]-0.4391550328268398*m1EffD[a0+2]*uOther[a0+5]+0.4391550328268398*uSelf[a0+2]*m1EffD[a0+5]-0.4391550328268398*uOther[a0+2]*m1EffD[a0+5]; 
  } 
 
  // Divide m0Other*(m2Self-kinESelf) by mnuSelf*m0Self+mnuOther*m0Other. 
  // Product of m0Other and m2Self-uSelf.m1Self. 
  double m0OtherThESelf[10]; 
  m0OtherThESelf[0] = 0.5*m0rOther[9]*m2rSelf[9]-0.5*kinESelf[9]*m0rOther[9]+0.5*m0rOther[8]*m2rSelf[8]-0.5*kinESelf[8]*m0rOther[8]+0.5*m0rOther[7]*m2rSelf[7]-0.5*kinESelf[7]*m0rOther[7]+0.5*m0rOther[6]*m2rSelf[6]-0.5*kinESelf[6]*m0rOther[6]+0.5*m0rOther[5]*m2rSelf[5]-0.5*kinESelf[5]*m0rOther[5]+0.5*m0rOther[4]*m2rSelf[4]-0.5*kinESelf[4]*m0rOther[4]+0.5*m0rOther[3]*m2rSelf[3]-0.5*kinESelf[3]*m0rOther[3]+0.5*m0rOther[2]*m2rSelf[2]-0.5*kinESelf[2]*m0rOther[2]+0.5*m0rOther[1]*m2rSelf[1]-0.5*kinESelf[1]*m0rOther[1]+0.5*m0rOther[0]*m2rSelf[0]-0.5*kinESelf[0]*m0rOther[0]; 
  m0OtherThESelf[1] = 0.4391550328268398*m0rOther[4]*m2rSelf[8]+0.4391550328268398*m2rSelf[4]*m0rOther[8]-0.4391550328268398*kinESelf[4]*m0rOther[8]-0.4391550328268398*m0rOther[4]*kinESelf[8]+0.5000000000000001*m0rOther[5]*m2rSelf[7]+0.5000000000000001*m2rSelf[5]*m0rOther[7]-0.5000000000000001*kinESelf[5]*m0rOther[7]-0.5000000000000001*m0rOther[5]*kinESelf[7]+0.447213595499958*m0rOther[3]*m2rSelf[6]+0.447213595499958*m2rSelf[3]*m0rOther[6]-0.447213595499958*kinESelf[3]*m0rOther[6]-0.447213595499958*m0rOther[3]*kinESelf[6]+0.4472135954999579*m0rOther[1]*m2rSelf[4]+0.4472135954999579*m2rSelf[1]*m0rOther[4]-0.4472135954999579*kinESelf[1]*m0rOther[4]-0.4472135954999579*m0rOther[1]*kinESelf[4]+0.5*m0rOther[2]*m2rSelf[3]+0.5*m2rSelf[2]*m0rOther[3]-0.5*kinESelf[2]*m0rOther[3]-0.5*m0rOther[2]*kinESelf[3]+0.5*m0rOther[0]*m2rSelf[1]+0.5*m2rSelf[0]*m0rOther[1]-0.5*kinESelf[0]*m0rOther[1]-0.5*m0rOther[0]*kinESelf[1]; 
  m0OtherThESelf[2] = 0.4391550328268398*m0rOther[5]*m2rSelf[9]+0.4391550328268398*m2rSelf[5]*m0rOther[9]-0.4391550328268398*kinESelf[5]*m0rOther[9]-0.4391550328268398*m0rOther[5]*kinESelf[9]+0.447213595499958*m0rOther[3]*m2rSelf[7]+0.447213595499958*m2rSelf[3]*m0rOther[7]-0.447213595499958*kinESelf[3]*m0rOther[7]-0.447213595499958*m0rOther[3]*kinESelf[7]+0.5000000000000001*m0rOther[4]*m2rSelf[6]+0.5000000000000001*m2rSelf[4]*m0rOther[6]-0.5000000000000001*kinESelf[4]*m0rOther[6]-0.5000000000000001*m0rOther[4]*kinESelf[6]+0.4472135954999579*m0rOther[2]*m2rSelf[5]+0.4472135954999579*m2rSelf[2]*m0rOther[5]-0.4472135954999579*kinESelf[2]*m0rOther[5]-0.4472135954999579*m0rOther[2]*kinESelf[5]+0.5*m0rOther[1]*m2rSelf[3]+0.5*m2rSelf[1]*m0rOther[3]-0.5*kinESelf[1]*m0rOther[3]-0.5*m0rOther[1]*kinESelf[3]+0.5*m0rOther[0]*m2rSelf[2]+0.5*m2rSelf[0]*m0rOther[2]-0.5*kinESelf[0]*m0rOther[2]-0.5*m0rOther[0]*kinESelf[2]; 
  m0OtherThESelf[3] = 0.4391550328268399*m0rOther[7]*m2rSelf[9]+0.4391550328268399*m2rSelf[7]*m0rOther[9]-0.4391550328268399*kinESelf[7]*m0rOther[9]-0.4391550328268399*m0rOther[7]*kinESelf[9]+0.4391550328268399*m0rOther[6]*m2rSelf[8]+0.4391550328268399*m2rSelf[6]*m0rOther[8]-0.4391550328268399*kinESelf[6]*m0rOther[8]-0.4391550328268399*m0rOther[6]*kinESelf[8]+0.4*m0rOther[6]*m2rSelf[7]+0.447213595499958*m0rOther[2]*m2rSelf[7]+0.4*m2rSelf[6]*m0rOther[7]-0.4*kinESelf[6]*m0rOther[7]+0.447213595499958*m2rSelf[2]*m0rOther[7]-0.447213595499958*kinESelf[2]*m0rOther[7]-0.4*m0rOther[6]*kinESelf[7]-0.447213595499958*m0rOther[2]*kinESelf[7]+0.447213595499958*m0rOther[1]*m2rSelf[6]+0.447213595499958*m2rSelf[1]*m0rOther[6]-0.447213595499958*kinESelf[1]*m0rOther[6]-0.447213595499958*m0rOther[1]*kinESelf[6]+0.4472135954999579*m0rOther[3]*m2rSelf[5]+0.4472135954999579*m2rSelf[3]*m0rOther[5]-0.4472135954999579*kinESelf[3]*m0rOther[5]-0.4472135954999579*m0rOther[3]*kinESelf[5]+0.4472135954999579*m0rOther[3]*m2rSelf[4]+0.4472135954999579*m2rSelf[3]*m0rOther[4]-0.4472135954999579*kinESelf[3]*m0rOther[4]-0.4472135954999579*m0rOther[3]*kinESelf[4]+0.5*m0rOther[0]*m2rSelf[3]+0.5*m2rSelf[0]*m0rOther[3]-0.5*kinESelf[0]*m0rOther[3]-0.5*m0rOther[0]*kinESelf[3]+0.5*m0rOther[1]*m2rSelf[2]+0.5*m2rSelf[1]*m0rOther[2]-0.5*kinESelf[1]*m0rOther[2]-0.5*m0rOther[1]*kinESelf[2]; 
  m0OtherThESelf[4] = 0.2981423969999719*m0rOther[8]*m2rSelf[8]+0.4391550328268398*m0rOther[1]*m2rSelf[8]-0.2981423969999719*kinESelf[8]*m0rOther[8]+0.4391550328268398*m2rSelf[1]*m0rOther[8]-0.4391550328268398*kinESelf[1]*m0rOther[8]-0.4391550328268398*m0rOther[1]*kinESelf[8]+0.4472135954999579*m0rOther[7]*m2rSelf[7]-0.4472135954999579*kinESelf[7]*m0rOther[7]+0.31943828249997*m0rOther[6]*m2rSelf[6]+0.5000000000000001*m0rOther[2]*m2rSelf[6]-0.31943828249997*kinESelf[6]*m0rOther[6]+0.5000000000000001*m2rSelf[2]*m0rOther[6]-0.5000000000000001*kinESelf[2]*m0rOther[6]-0.5000000000000001*m0rOther[2]*kinESelf[6]+0.31943828249997*m0rOther[4]*m2rSelf[4]+0.5*m0rOther[0]*m2rSelf[4]-0.31943828249997*kinESelf[4]*m0rOther[4]+0.5*m2rSelf[0]*m0rOther[4]-0.5*kinESelf[0]*m0rOther[4]-0.5*m0rOther[0]*kinESelf[4]+0.4472135954999579*m0rOther[3]*m2rSelf[3]-0.4472135954999579*kinESelf[3]*m0rOther[3]+0.4472135954999579*m0rOther[1]*m2rSelf[1]-0.4472135954999579*kinESelf[1]*m0rOther[1]; 
  m0OtherThESelf[5] = 0.2981423969999719*m0rOther[9]*m2rSelf[9]+0.4391550328268398*m0rOther[2]*m2rSelf[9]-0.2981423969999719*kinESelf[9]*m0rOther[9]+0.4391550328268398*m2rSelf[2]*m0rOther[9]-0.4391550328268398*kinESelf[2]*m0rOther[9]-0.4391550328268398*m0rOther[2]*kinESelf[9]+0.31943828249997*m0rOther[7]*m2rSelf[7]+0.5000000000000001*m0rOther[1]*m2rSelf[7]-0.31943828249997*kinESelf[7]*m0rOther[7]+0.5000000000000001*m2rSelf[1]*m0rOther[7]-0.5000000000000001*kinESelf[1]*m0rOther[7]-0.5000000000000001*m0rOther[1]*kinESelf[7]+0.4472135954999579*m0rOther[6]*m2rSelf[6]-0.4472135954999579*kinESelf[6]*m0rOther[6]+0.31943828249997*m0rOther[5]*m2rSelf[5]+0.5*m0rOther[0]*m2rSelf[5]-0.31943828249997*kinESelf[5]*m0rOther[5]+0.5*m2rSelf[0]*m0rOther[5]-0.5*kinESelf[0]*m0rOther[5]-0.5*m0rOther[0]*kinESelf[5]+0.4472135954999579*m0rOther[3]*m2rSelf[3]-0.4472135954999579*kinESelf[3]*m0rOther[3]+0.4472135954999579*m0rOther[2]*m2rSelf[2]-0.4472135954999579*kinESelf[2]*m0rOther[2]; 
  m0OtherThESelf[6] = 0.4391550328268399*m0rOther[3]*m2rSelf[8]+0.4391550328268399*m2rSelf[3]*m0rOther[8]-0.4391550328268399*kinESelf[3]*m0rOther[8]-0.4391550328268399*m0rOther[3]*kinESelf[8]+0.4*m0rOther[3]*m2rSelf[7]+0.4*m2rSelf[3]*m0rOther[7]-0.4*kinESelf[3]*m0rOther[7]-0.4*m0rOther[3]*kinESelf[7]+0.4472135954999579*m0rOther[5]*m2rSelf[6]+0.31943828249997*m0rOther[4]*m2rSelf[6]+0.5*m0rOther[0]*m2rSelf[6]+0.4472135954999579*m2rSelf[5]*m0rOther[6]-0.4472135954999579*kinESelf[5]*m0rOther[6]+0.31943828249997*m2rSelf[4]*m0rOther[6]-0.31943828249997*kinESelf[4]*m0rOther[6]+0.5*m2rSelf[0]*m0rOther[6]-0.5*kinESelf[0]*m0rOther[6]-0.4472135954999579*m0rOther[5]*kinESelf[6]-0.31943828249997*m0rOther[4]*kinESelf[6]-0.5*m0rOther[0]*kinESelf[6]+0.5000000000000001*m0rOther[2]*m2rSelf[4]+0.5000000000000001*m2rSelf[2]*m0rOther[4]-0.5000000000000001*kinESelf[2]*m0rOther[4]-0.5000000000000001*m0rOther[2]*kinESelf[4]+0.447213595499958*m0rOther[1]*m2rSelf[3]+0.447213595499958*m2rSelf[1]*m0rOther[3]-0.447213595499958*kinESelf[1]*m0rOther[3]-0.447213595499958*m0rOther[1]*kinESelf[3]; 
  m0OtherThESelf[7] = 0.4391550328268399*m0rOther[3]*m2rSelf[9]+0.4391550328268399*m2rSelf[3]*m0rOther[9]-0.4391550328268399*kinESelf[3]*m0rOther[9]-0.4391550328268399*m0rOther[3]*kinESelf[9]+0.31943828249997*m0rOther[5]*m2rSelf[7]+0.4472135954999579*m0rOther[4]*m2rSelf[7]+0.5*m0rOther[0]*m2rSelf[7]+0.31943828249997*m2rSelf[5]*m0rOther[7]-0.31943828249997*kinESelf[5]*m0rOther[7]+0.4472135954999579*m2rSelf[4]*m0rOther[7]-0.4472135954999579*kinESelf[4]*m0rOther[7]+0.5*m2rSelf[0]*m0rOther[7]-0.5*kinESelf[0]*m0rOther[7]-0.31943828249997*m0rOther[5]*kinESelf[7]-0.4472135954999579*m0rOther[4]*kinESelf[7]-0.5*m0rOther[0]*kinESelf[7]+0.4*m0rOther[3]*m2rSelf[6]+0.4*m2rSelf[3]*m0rOther[6]-0.4*kinESelf[3]*m0rOther[6]-0.4*m0rOther[3]*kinESelf[6]+0.5000000000000001*m0rOther[1]*m2rSelf[5]+0.5000000000000001*m2rSelf[1]*m0rOther[5]-0.5000000000000001*kinESelf[1]*m0rOther[5]-0.5000000000000001*m0rOther[1]*kinESelf[5]+0.447213595499958*m0rOther[2]*m2rSelf[3]+0.447213595499958*m2rSelf[2]*m0rOther[3]-0.447213595499958*kinESelf[2]*m0rOther[3]-0.447213595499958*m0rOther[2]*kinESelf[3]; 
  m0OtherThESelf[8] = 0.2981423969999719*m0rOther[4]*m2rSelf[8]+0.5*m0rOther[0]*m2rSelf[8]+0.2981423969999719*m2rSelf[4]*m0rOther[8]-0.2981423969999719*kinESelf[4]*m0rOther[8]+0.5*m2rSelf[0]*m0rOther[8]-0.5*kinESelf[0]*m0rOther[8]-0.2981423969999719*m0rOther[4]*kinESelf[8]-0.5*m0rOther[0]*kinESelf[8]+0.4391550328268399*m0rOther[3]*m2rSelf[6]+0.4391550328268399*m2rSelf[3]*m0rOther[6]-0.4391550328268399*kinESelf[3]*m0rOther[6]-0.4391550328268399*m0rOther[3]*kinESelf[6]+0.4391550328268398*m0rOther[1]*m2rSelf[4]+0.4391550328268398*m2rSelf[1]*m0rOther[4]-0.4391550328268398*kinESelf[1]*m0rOther[4]-0.4391550328268398*m0rOther[1]*kinESelf[4]; 
  m0OtherThESelf[9] = 0.2981423969999719*m0rOther[5]*m2rSelf[9]+0.5*m0rOther[0]*m2rSelf[9]+0.2981423969999719*m2rSelf[5]*m0rOther[9]-0.2981423969999719*kinESelf[5]*m0rOther[9]+0.5*m2rSelf[0]*m0rOther[9]-0.5*kinESelf[0]*m0rOther[9]-0.2981423969999719*m0rOther[5]*kinESelf[9]-0.5*m0rOther[0]*kinESelf[9]+0.4391550328268399*m0rOther[3]*m2rSelf[7]+0.4391550328268399*m2rSelf[3]*m0rOther[7]-0.4391550328268399*kinESelf[3]*m0rOther[7]-0.4391550328268399*m0rOther[3]*kinESelf[7]+0.4391550328268398*m0rOther[2]*m2rSelf[5]+0.4391550328268398*m2rSelf[2]*m0rOther[5]-0.4391550328268398*kinESelf[2]*m0rOther[5]-0.4391550328268398*m0rOther[2]*kinESelf[5]; 
  ...
  m0SelfThEOther[0] = 0.5*m0rSelf[9]*m2rOther[9]-0.5*kinEOther[9]*m0rSelf[9]+0.5*m0rSelf[8]*m2rOther[8]-0.5*kinEOther[8]*m0rSelf[8]+0.5*m0rSelf[7]*m2rOther[7]-0.5*kinEOther[7]*m0rSelf[7]+0.5*m0rSelf[6]*m2rOther[6]-0.5*kinEOther[6]*m0rSelf[6]+0.5*m0rSelf[5]*m2rOther[5]-0.5*kinEOther[5]*m0rSelf[5]+0.5*m0rSelf[4]*m2rOther[4]-0.5*kinEOther[4]*m0rSelf[4]+0.5*m0rSelf[3]*m2rOther[3]-0.5*kinEOther[3]*m0rSelf[3]+0.5*m0rSelf[2]*m2rOther[2]-0.5*kinEOther[2]*m0rSelf[2]+0.5*m0rSelf[1]*m2rOther[1]-0.5*kinEOther[1]*m0rSelf[1]+0.5*m0rSelf[0]*m2rOther[0]-0.5*kinEOther[0]*m0rSelf[0]; 
  m0SelfThEOther[1] = 0.4391550328268398*m0rSelf[4]*m2rOther[8]+0.4391550328268398*m2rOther[4]*m0rSelf[8]-0.4391550328268398*kinEOther[4]*m0rSelf[8]-0.4391550328268398*m0rSelf[4]*kinEOther[8]+0.5000000000000001*m0rSelf[5]*m2rOther[7]+0.5000000000000001*m2rOther[5]*m0rSelf[7]-0.5000000000000001*kinEOther[5]*m0rSelf[7]-0.5000000000000001*m0rSelf[5]*kinEOther[7]+0.447213595499958*m0rSelf[3]*m2rOther[6]+0.447213595499958*m2rOther[3]*m0rSelf[6]-0.447213595499958*kinEOther[3]*m0rSelf[6]-0.447213595499958*m0rSelf[3]*kinEOther[6]+0.4472135954999579*m0rSelf[1]*m2rOther[4]+0.4472135954999579*m2rOther[1]*m0rSelf[4]-0.4472135954999579*kinEOther[1]*m0rSelf[4]-0.4472135954999579*m0rSelf[1]*kinEOther[4]+0.5*m0rSelf[2]*m2rOther[3]+0.5*m2rOther[2]*m0rSelf[3]-0.5*kinEOther[2]*m0rSelf[3]-0.5*m0rSelf[2]*kinEOther[3]+0.5*m0rSelf[0]*m2rOther[1]+0.5*m2rOther[0]*m0rSelf[1]-0.5*kinEOther[0]*m0rSelf[1]-0.5*m0rSelf[0]*kinEOther[1]; 
  m0SelfThEOther[2] = 0.4391550328268398*m0rSelf[5]*m2rOther[9]+0.4391550328268398*m2rOther[5]*m0rSelf[9]-0.4391550328268398*kinEOther[5]*m0rSelf[9]-0.4391550328268398*m0rSelf[5]*kinEOther[9]+0.447213595499958*m0rSelf[3]*m2rOther[7]+0.447213595499958*m2rOther[3]*m0rSelf[7]-0.447213595499958*kinEOther[3]*m0rSelf[7]-0.447213595499958*m0rSelf[3]*kinEOther[7]+0.5000000000000001*m0rSelf[4]*m2rOther[6]+0.5000000000000001*m2rOther[4]*m0rSelf[6]-0.5000000000000001*kinEOther[4]*m0rSelf[6]-0.5000000000000001*m0rSelf[4]*kinEOther[6]+0.4472135954999579*m0rSelf[2]*m2rOther[5]+0.4472135954999579*m2rOther[2]*m0rSelf[5]-0.4472135954999579*kinEOther[2]*m0rSelf[5]-0.4472135954999579*m0rSelf[2]*kinEOther[5]+0.5*m0rSelf[1]*m2rOther[3]+0.5*m2rOther[1]*m0rSelf[3]-0.5*kinEOther[1]*m0rSelf[3]-0.5*m0rSelf[1]*kinEOther[3]+0.5*m0rSelf[0]*m2rOther[2]+0.5*m2rOther[0]*m0rSelf[2]-0.5*kinEOther[0]*m0rSelf[2]-0.5*m0rSelf[0]*kinEOther[2]; 
  m0SelfThEOther[3] = 0.4391550328268399*m0rSelf[7]*m2rOther[9]+0.4391550328268399*m2rOther[7]*m0rSelf[9]-0.4391550328268399*kinEOther[7]*m0rSelf[9]-0.4391550328268399*m0rSelf[7]*kinEOther[9]+0.4391550328268399*m0rSelf[6]*m2rOther[8]+0.4391550328268399*m2rOther[6]*m0rSelf[8]-0.4391550328268399*kinEOther[6]*m0rSelf[8]-0.4391550328268399*m0rSelf[6]*kinEOther[8]+0.4*m0rSelf[6]*m2rOther[7]+0.447213595499958*m0rSelf[2]*m2rOther[7]+0.4*m2rOther[6]*m0rSelf[7]-0.4*kinEOther[6]*m0rSelf[7]+0.447213595499958*m2rOther[2]*m0rSelf[7]-0.447213595499958*kinEOther[2]*m0rSelf[7]-0.4*m0rSelf[6]*kinEOther[7]-0.447213595499958*m0rSelf[2]*kinEOther[7]+0.447213595499958*m0rSelf[1]*m2rOther[6]+0.447213595499958*m2rOther[1]*m0rSelf[6]-0.447213595499958*kinEOther[1]*m0rSelf[6]-0.447213595499958*m0rSelf[1]*kinEOther[6]+0.4472135954999579*m0rSelf[3]*m2rOther[5]+0.4472135954999579*m2rOther[3]*m0rSelf[5]-0.4472135954999579*kinEOther[3]*m0rSelf[5]-0.4472135954999579*m0rSelf[3]*kinEOther[5]+0.4472135954999579*m0rSelf[3]*m2rOther[4]+0.4472135954999579*m2rOther[3]*m0rSelf[4]-0.4472135954999579*kinEOther[3]*m0rSelf[4]-0.4472135954999579*m0rSelf[3]*kinEOther[4]+0.5*m0rSelf[0]*m2rOther[3]+0.5*m2rOther[0]*m0rSelf[3]-0.5*kinEOther[0]*m0rSelf[3]-0.5*m0rSelf[0]*kinEOther[3]+0.5*m0rSelf[1]*m2rOther[2]+0.5*m2rOther[1]*m0rSelf[2]-0.5*kinEOther[1]*m0rSelf[2]-0.5*m0rSelf[1]*kinEOther[2]; 
  m0SelfThEOther[4] = 0.2981423969999719*m0rSelf[8]*m2rOther[8]+0.4391550328268398*m0rSelf[1]*m2rOther[8]-0.2981423969999719*kinEOther[8]*m0rSelf[8]+0.4391550328268398*m2rOther[1]*m0rSelf[8]-0.4391550328268398*kinEOther[1]*m0rSelf[8]-0.4391550328268398*m0rSelf[1]*kinEOther[8]+0.4472135954999579*m0rSelf[7]*m2rOther[7]-0.4472135954999579*kinEOther[7]*m0rSelf[7]+0.31943828249997*m0rSelf[6]*m2rOther[6]+0.5000000000000001*m0rSelf[2]*m2rOther[6]-0.31943828249997*kinEOther[6]*m0rSelf[6]+0.5000000000000001*m2rOther[2]*m0rSelf[6]-0.5000000000000001*kinEOther[2]*m0rSelf[6]-0.5000000000000001*m0rSelf[2]*kinEOther[6]+0.31943828249997*m0rSelf[4]*m2rOther[4]+0.5*m0rSelf[0]*m2rOther[4]-0.31943828249997*kinEOther[4]*m0rSelf[4]+0.5*m2rOther[0]*m0rSelf[4]-0.5*kinEOther[0]*m0rSelf[4]-0.5*m0rSelf[0]*kinEOther[4]+0.4472135954999579*m0rSelf[3]*m2rOther[3]-0.4472135954999579*kinEOther[3]*m0rSelf[3]+0.4472135954999579*m0rSelf[1]*m2rOther[1]-0.4472135954999579*kinEOther[1]*m0rSelf[1]; 
  m0SelfThEOther[5] = 0.2981423969999719*m0rSelf[9]*m2rOther[9]+0.4391550328268398*m0rSelf[2]*m2rOther[9]-0.2981423969999719*kinEOther[9]*m0rSelf[9]+0.4391550328268398*m2rOther[2]*m0rSelf[9]-0.4391550328268398*kinEOther[2]*m0rSelf[9]-0.4391550328268398*m0rSelf[2]*kinEOther[9]+0.31943828249997*m0rSelf[7]*m2rOther[7]+0.5000000000000001*m0rSelf[1]*m2rOther[7]-0.31943828249997*kinEOther[7]*m0rSelf[7]+0.5000000000000001*m2rOther[1]*m0rSelf[7]-0.5000000000000001*kinEOther[1]*m0rSelf[7]-0.5000000000000001*m0rSelf[1]*kinEOther[7]+0.4472135954999579*m0rSelf[6]*m2rOther[6]-0.4472135954999579*kinEOther[6]*m0rSelf[6]+0.31943828249997*m0rSelf[5]*m2rOther[5]+0.5*m0rSelf[0]*m2rOther[5]-0.31943828249997*kinEOther[5]*m0rSelf[5]+0.5*m2rOther[0]*m0rSelf[5]-0.5*kinEOther[0]*m0rSelf[5]-0.5*m0rSelf[0]*kinEOther[5]+0.4472135954999579*m0rSelf[3]*m2rOther[3]-0.4472135954999579*kinEOther[3]*m0rSelf[3]+0.4472135954999579*m0rSelf[2]*m2rOther[2]-0.4472135954999579*kinEOther[2]*m0rSelf[2]; 
  m0SelfThEOther[6] = 0.4391550328268399*m0rSelf[3]*m2rOther[8]+0.4391550328268399*m2rOther[3]*m0rSelf[8]-0.4391550328268399*kinEOther[3]*m0rSelf[8]-0.4391550328268399*m0rSelf[3]*kinEOther[8]+0.4*m0rSelf[3]*m2rOther[7]+0.4*m2rOther[3]*m0rSelf[7]-0.4*kinEOther[3]*m0rSelf[7]-0.4*m0rSelf[3]*kinEOther[7]+0.4472135954999579*m0rSelf[5]*m2rOther[6]+0.31943828249997*m0rSelf[4]*m2rOther[6]+0.5*m0rSelf[0]*m2rOther[6]+0.4472135954999579*m2rOther[5]*m0rSelf[6]-0.4472135954999579*kinEOther[5]*m0rSelf[6]+0.31943828249997*m2rOther[4]*m0rSelf[6]-0.31943828249997*kinEOther[4]*m0rSelf[6]+0.5*m2rOther[0]*m0rSelf[6]-0.5*kinEOther[0]*m0rSelf[6]-0.4472135954999579*m0rSelf[5]*kinEOther[6]-0.31943828249997*m0rSelf[4]*kinEOther[6]-0.5*m0rSelf[0]*kinEOther[6]+0.5000000000000001*m0rSelf[2]*m2rOther[4]+0.5000000000000001*m2rOther[2]*m0rSelf[4]-0.5000000000000001*kinEOther[2]*m0rSelf[4]-0.5000000000000001*m0rSelf[2]*kinEOther[4]+0.447213595499958*m0rSelf[1]*m2rOther[3]+0.447213595499958*m2rOther[1]*m0rSelf[3]-0.447213595499958*kinEOther[1]*m0rSelf[3]-0.447213595499958*m0rSelf[1]*kinEOther[3]; 
  m0SelfThEOther[7] = 0.4391550328268399*m0rSelf[3]*m2rOther[9]+0.4391550328268399*m2rOther[3]*m0rSelf[9]-0.4391550328268399*kinEOther[3]*m0rSelf[9]-0.4391550328268399*m0rSelf[3]*kinEOther[9]+0.31943828249997*m0rSelf[5]*m2rOther[7]+0.4472135954999579*m0rSelf[4]*m2rOther[7]+0.5*m0rSelf[0]*m2rOther[7]+0.31943828249997*m2rOther[5]*m0rSelf[7]-0.31943828249997*kinEOther[5]*m0rSelf[7]+0.4472135954999579*m2rOther[4]*m0rSelf[7]-0.4472135954999579*kinEOther[4]*m0rSelf[7]+0.5*m2rOther[0]*m0rSelf[7]-0.5*kinEOther[0]*m0rSelf[7]-0.31943828249997*m0rSelf[5]*kinEOther[7]-0.4472135954999579*m0rSelf[4]*kinEOther[7]-0.5*m0rSelf[0]*kinEOther[7]+0.4*m0rSelf[3]*m2rOther[6]+0.4*m2rOther[3]*m0rSelf[6]-0.4*kinEOther[3]*m0rSelf[6]-0.4*m0rSelf[3]*kinEOther[6]+0.5000000000000001*m0rSelf[1]*m2rOther[5]+0.5000000000000001*m2rOther[1]*m0rSelf[5]-0.5000000000000001*kinEOther[1]*m0rSelf[5]-0.5000000000000001*m0rSelf[1]*kinEOther[5]+0.447213595499958*m0rSelf[2]*m2rOther[3]+0.447213595499958*m2rOther[2]*m0rSelf[3]-0.447213595499958*kinEOther[2]*m0rSelf[3]-0.447213595499958*m0rSelf[2]*kinEOther[3]; 
  m0SelfThEOther[8] = 0.2981423969999719*m0rSelf[4]*m2rOther[8]+0.5*m0rSelf[0]*m2rOther[8]+0.2981423969999719*m2rOther[4]*m0rSelf[8]-0.2981423969999719*kinEOther[4]*m0rSelf[8]+0.5*m2rOther[0]*m0rSelf[8]-0.5*kinEOther[0]*m0rSelf[8]-0.2981423969999719*m0rSelf[4]*kinEOther[8]-0.5*m0rSelf[0]*kinEOther[8]+0.4391550328268399*m0rSelf[3]*m2rOther[6]+0.4391550328268399*m2rOther[3]*m0rSelf[6]-0.4391550328268399*kinEOther[3]*m0rSelf[6]-0.4391550328268399*m0rSelf[3]*kinEOther[6]+0.4391550328268398*m0rSelf[1]*m2rOther[4]+0.4391550328268398*m2rOther[1]*m0rSelf[4]-0.4391550328268398*kinEOther[1]*m0rSelf[4]-0.4391550328268398*m0rSelf[1]*kinEOther[4]; 
  m0SelfThEOther[9] = 0.2981423969999719*m0rSelf[5]*m2rOther[9]+0.5*m0rSelf[0]*m2rOther[9]+0.2981423969999719*m2rOther[5]*m0rSelf[9]-0.2981423969999719*kinEOther[5]*m0rSelf[9]+0.5*m2rOther[0]*m0rSelf[9]-0.5*kinEOther[0]*m0rSelf[9]-0.2981423969999719*m0rSelf[5]*kinEOther[9]-0.5*m0rSelf[0]*kinEOther[9]+0.4391550328268399*m0rSelf[3]*m2rOther[7]+0.4391550328268399*m2rOther[3]*m0rSelf[7]-0.4391550328268399*kinEOther[3]*m0rSelf[7]-0.4391550328268399*m0rSelf[3]*kinEOther[7]+0.4391550328268398*m0rSelf[2]*m2rOther[5]+0.4391550328268398*m2rOther[2]*m0rSelf[5]-0.4391550328268398*kinEOther[2]*m0rSelf[5]-0.4391550328268398*m0rSelf[2]*kinEOther[5]; 
