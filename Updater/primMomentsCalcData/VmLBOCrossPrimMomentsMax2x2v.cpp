...
{ 
  ...
  data->AEM_S(15,6) = 0.5*ucMSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(15,7) = 0.5*ucMSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(15,8) = 0.5*ucMSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(16,6) = 0.5*ucMSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(16,7) = 0.5*ucMSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(17,6) = 0.5*ucMSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(17,8) = 0.5*ucMSelf[0]*mnuSelf+0.5*m0SrSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  ...
  data->AEM_S(15,15) = (-0.5*ucMOther[0]*mnuOther)-0.5*m0SrOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(15,16) = (-0.5*ucMOther[1]*mnuOther)-0.5*m0SrOther[1]*mnuOther+0.5*cEOther[1]*mnuOther; 
  data->AEM_S(15,17) = (-0.5*ucMOther[2]*mnuOther)-0.5*m0SrOther[2]*mnuOther+0.5*cEOther[2]*mnuOther; 
  data->AEM_S(16,15) = (-0.5*ucMOther[1]*mnuOther)-0.5*m0SrOther[1]*mnuOther+0.5*cEOther[1]*mnuOther; 
  data->AEM_S(16,16) = (-0.5*ucMOther[0]*mnuOther)-0.5*m0SrOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(17,15) = (-0.5*ucMOther[2]*mnuOther)-0.5*m0SrOther[2]*mnuOther+0.5*cEOther[2]*mnuOther; 
  data->AEM_S(17,17) = (-0.5*ucMOther[0]*mnuOther)-0.5*m0SrOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
...
{ 
  ...
  // ... Block from correction to (self) 2nd moment of collision operator ... // 
  data->AEM_S(30,12) = 0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(30,13) = 0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(30,14) = 0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(30,15) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf-0.5*cESelf[3]*mnuSelf; 
  data->AEM_S(30,16) = 0.5*ucMSelf[4]*mnuSelf+m0rSelf[4]*mnuSelf-0.5*cESelf[4]*mnuSelf; 
  data->AEM_S(30,17) = 0.5*ucMSelf[5]*mnuSelf+m0rSelf[5]*mnuSelf-0.5*cESelf[5]*mnuSelf; 
  data->AEM_S(31,12) = 0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(31,13) = 0.4472135954999579*ucMSelf[4]*mnuSelf+0.8944271909999159*m0rSelf[4]*mnuSelf-0.4472135954999579*cESelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(31,14) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf-0.5*cESelf[3]*mnuSelf; 
  data->AEM_S(31,15) = 0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(31,16) = 0.4472135954999579*ucMSelf[1]*mnuSelf+0.8944271909999159*m0rSelf[1]*mnuSelf-0.4472135954999579*cESelf[1]*mnuSelf; 
  data->AEM_S(32,12) = 0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(32,13) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf-0.5*cESelf[3]*mnuSelf; 
  data->AEM_S(32,14) = 0.4472135954999579*ucMSelf[5]*mnuSelf+0.8944271909999159*m0rSelf[5]*mnuSelf-0.4472135954999579*cESelf[5]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(32,15) = 0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(32,17) = 0.4472135954999579*ucMSelf[2]*mnuSelf+0.8944271909999159*m0rSelf[2]*mnuSelf-0.4472135954999579*cESelf[2]*mnuSelf; 
  data->AEM_S(33,12) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf-0.5*cESelf[3]*mnuSelf; 
  data->AEM_S(33,13) = 0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(33,14) = 0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(33,15) = 0.4472135954999579*ucMSelf[5]*mnuSelf+0.8944271909999159*m0rSelf[5]*mnuSelf-0.4472135954999579*cESelf[5]*mnuSelf+0.4472135954999579*ucMSelf[4]*mnuSelf+0.8944271909999159*m0rSelf[4]*mnuSelf-0.4472135954999579*cESelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(33,16) = 0.4472135954999579*ucMSelf[3]*mnuSelf+0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cESelf[3]*mnuSelf; 
  data->AEM_S(33,17) = 0.4472135954999579*ucMSelf[3]*mnuSelf+0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cESelf[3]*mnuSelf; 
  data->AEM_S(34,12) = 0.5*ucMSelf[4]*mnuSelf+m0rSelf[4]*mnuSelf-0.5*cESelf[4]*mnuSelf; 
  data->AEM_S(34,13) = 0.4472135954999579*ucMSelf[1]*mnuSelf+0.8944271909999159*m0rSelf[1]*mnuSelf-0.4472135954999579*cESelf[1]*mnuSelf; 
  data->AEM_S(34,15) = 0.4472135954999579*ucMSelf[3]*mnuSelf+0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cESelf[3]*mnuSelf; 
  data->AEM_S(34,16) = 0.31943828249997*ucMSelf[4]*mnuSelf+0.6388765649999399*m0rSelf[4]*mnuSelf-0.31943828249997*cESelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(35,12) = 0.5*ucMSelf[5]*mnuSelf+m0rSelf[5]*mnuSelf-0.5*cESelf[5]*mnuSelf; 
  data->AEM_S(35,14) = 0.4472135954999579*ucMSelf[2]*mnuSelf+0.8944271909999159*m0rSelf[2]*mnuSelf-0.4472135954999579*cESelf[2]*mnuSelf; 
  data->AEM_S(35,15) = 0.4472135954999579*ucMSelf[3]*mnuSelf+0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cESelf[3]*mnuSelf; 
  data->AEM_S(35,17) = 0.31943828249997*ucMSelf[5]*mnuSelf+0.6388765649999399*m0rSelf[5]*mnuSelf-0.31943828249997*cESelf[5]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  ...
  // ... Block from correction to (other) 2nd moment of collision operator ... // 
  data->AEM_S(30,30) = (-0.5*ucMOther[0]*mnuOther)-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(30,31) = (-0.5*ucMOther[1]*mnuOther)-1.0*m0rOther[1]*mnuOther+0.5*cEOther[1]*mnuOther; 
  data->AEM_S(30,32) = (-0.5*ucMOther[2]*mnuOther)-1.0*m0rOther[2]*mnuOther+0.5*cEOther[2]*mnuOther; 
  data->AEM_S(30,33) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther+0.5*cEOther[3]*mnuOther; 
  data->AEM_S(30,34) = (-0.5*ucMOther[4]*mnuOther)-1.0*m0rOther[4]*mnuOther+0.5*cEOther[4]*mnuOther; 
  data->AEM_S(30,35) = (-0.5*ucMOther[5]*mnuOther)-1.0*m0rOther[5]*mnuOther+0.5*cEOther[5]*mnuOther; 
  data->AEM_S(31,30) = (-0.5*ucMOther[1]*mnuOther)-1.0*m0rOther[1]*mnuOther+0.5*cEOther[1]*mnuOther; 
  data->AEM_S(31,31) = (-0.4472135954999579*ucMOther[4]*mnuOther)-0.8944271909999159*m0rOther[4]*mnuOther+0.4472135954999579*cEOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(31,32) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther+0.5*cEOther[3]*mnuOther; 
  data->AEM_S(31,33) = (-0.5*ucMOther[2]*mnuOther)-1.0*m0rOther[2]*mnuOther+0.5*cEOther[2]*mnuOther; 
  data->AEM_S(31,34) = (-0.4472135954999579*ucMOther[1]*mnuOther)-0.8944271909999159*m0rOther[1]*mnuOther+0.4472135954999579*cEOther[1]*mnuOther; 
  data->AEM_S(32,30) = (-0.5*ucMOther[2]*mnuOther)-1.0*m0rOther[2]*mnuOther+0.5*cEOther[2]*mnuOther; 
  data->AEM_S(32,31) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther+0.5*cEOther[3]*mnuOther; 
  data->AEM_S(32,32) = (-0.4472135954999579*ucMOther[5]*mnuOther)-0.8944271909999159*m0rOther[5]*mnuOther+0.4472135954999579*cEOther[5]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(32,33) = (-0.5*ucMOther[1]*mnuOther)-1.0*m0rOther[1]*mnuOther+0.5*cEOther[1]*mnuOther; 
  data->AEM_S(32,35) = (-0.4472135954999579*ucMOther[2]*mnuOther)-0.8944271909999159*m0rOther[2]*mnuOther+0.4472135954999579*cEOther[2]*mnuOther; 
  data->AEM_S(33,30) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther+0.5*cEOther[3]*mnuOther; 
  data->AEM_S(33,31) = (-0.5*ucMOther[2]*mnuOther)-1.0*m0rOther[2]*mnuOther+0.5*cEOther[2]*mnuOther; 
  data->AEM_S(33,32) = (-0.5*ucMOther[1]*mnuOther)-1.0*m0rOther[1]*mnuOther+0.5*cEOther[1]*mnuOther; 
  data->AEM_S(33,33) = (-0.4472135954999579*ucMOther[5]*mnuOther)-0.8944271909999159*m0rOther[5]*mnuOther+0.4472135954999579*cEOther[5]*mnuOther-0.4472135954999579*ucMOther[4]*mnuOther-0.8944271909999159*m0rOther[4]*mnuOther+0.4472135954999579*cEOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(33,34) = (-0.4472135954999579*ucMOther[3]*mnuOther)-0.8944271909999159*m0rOther[3]*mnuOther+0.4472135954999579*cEOther[3]*mnuOther; 
  data->AEM_S(33,35) = (-0.4472135954999579*ucMOther[3]*mnuOther)-0.8944271909999159*m0rOther[3]*mnuOther+0.4472135954999579*cEOther[3]*mnuOther; 
  data->AEM_S(34,30) = (-0.5*ucMOther[4]*mnuOther)-1.0*m0rOther[4]*mnuOther+0.5*cEOther[4]*mnuOther; 
  data->AEM_S(34,31) = (-0.4472135954999579*ucMOther[1]*mnuOther)-0.8944271909999159*m0rOther[1]*mnuOther+0.4472135954999579*cEOther[1]*mnuOther; 
  data->AEM_S(34,33) = (-0.4472135954999579*ucMOther[3]*mnuOther)-0.8944271909999159*m0rOther[3]*mnuOther+0.4472135954999579*cEOther[3]*mnuOther; 
  data->AEM_S(34,34) = (-0.31943828249997*ucMOther[4]*mnuOther)-0.6388765649999399*m0rOther[4]*mnuOther+0.31943828249997*cEOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(35,30) = (-0.5*ucMOther[5]*mnuOther)-1.0*m0rOther[5]*mnuOther+0.5*cEOther[5]*mnuOther; 
  data->AEM_S(35,32) = (-0.4472135954999579*ucMOther[2]*mnuOther)-0.8944271909999159*m0rOther[2]*mnuOther+0.4472135954999579*cEOther[2]*mnuOther; 
  data->AEM_S(35,33) = (-0.4472135954999579*ucMOther[3]*mnuOther)-0.8944271909999159*m0rOther[3]*mnuOther+0.4472135954999579*cEOther[3]*mnuOther; 
  data->AEM_S(35,35) = (-0.31943828249997*ucMOther[5]*mnuOther)-0.6388765649999399*m0rOther[5]*mnuOther+0.31943828249997*cEOther[5]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
...
{ 
  ...
  { 
    ...
    // Contribution to dot-product from weak multiplication of vd component. 
    ucMSelf[0] += 0.5*cMSelf[a0+9]*uSelf[a0+9]+0.5*cMSelf[a0+8]*uSelf[a0+8]+0.5*cMSelf[a0+7]*uSelf[a0+7]+0.5*cMSelf[a0+6]*uSelf[a0+6]+0.5*cMSelf[a0+5]*uSelf[a0+5]+0.5*cMSelf[a0+4]*uSelf[a0+4]+0.5*cMSelf[a0+3]*uSelf[a0+3]+0.5*cMSelf[a0+2]*uSelf[a0+2]+0.5*cMSelf[a0+1]*uSelf[a0+1]+0.5*cMSelf[a0]*uSelf[a0]; 
    ucMSelf[1] += 0.4391550328268398*cMSelf[a0+4]*uSelf[a0+8]+0.4391550328268398*uSelf[a0+4]*cMSelf[a0+8]+0.5000000000000001*cMSelf[a0+5]*uSelf[a0+7]+0.5000000000000001*uSelf[a0+5]*cMSelf[a0+7]+0.447213595499958*cMSelf[a0+3]*uSelf[a0+6]+0.447213595499958*uSelf[a0+3]*cMSelf[a0+6]+0.4472135954999579*cMSelf[a0+1]*uSelf[a0+4]+0.4472135954999579*uSelf[a0+1]*cMSelf[a0+4]+0.5*cMSelf[a0+2]*uSelf[a0+3]+0.5*uSelf[a0+2]*cMSelf[a0+3]+0.5*cMSelf[a0]*uSelf[a0+1]+0.5*uSelf[a0]*cMSelf[a0+1]; 
    ucMSelf[2] += 0.4391550328268398*cMSelf[a0+5]*uSelf[a0+9]+0.4391550328268398*uSelf[a0+5]*cMSelf[a0+9]+0.447213595499958*cMSelf[a0+3]*uSelf[a0+7]+0.447213595499958*uSelf[a0+3]*cMSelf[a0+7]+0.5000000000000001*cMSelf[a0+4]*uSelf[a0+6]+0.5000000000000001*uSelf[a0+4]*cMSelf[a0+6]+0.4472135954999579*cMSelf[a0+2]*uSelf[a0+5]+0.4472135954999579*uSelf[a0+2]*cMSelf[a0+5]+0.5*cMSelf[a0+1]*uSelf[a0+3]+0.5*uSelf[a0+1]*cMSelf[a0+3]+0.5*cMSelf[a0]*uSelf[a0+2]+0.5*uSelf[a0]*cMSelf[a0+2]; 
    ucMSelf[3] += 0.4391550328268399*cMSelf[a0+7]*uSelf[a0+9]+0.4391550328268399*uSelf[a0+7]*cMSelf[a0+9]+0.4391550328268399*cMSelf[a0+6]*uSelf[a0+8]+0.4391550328268399*uSelf[a0+6]*cMSelf[a0+8]+0.4*cMSelf[a0+6]*uSelf[a0+7]+0.447213595499958*cMSelf[a0+2]*uSelf[a0+7]+0.4*uSelf[a0+6]*cMSelf[a0+7]+0.447213595499958*uSelf[a0+2]*cMSelf[a0+7]+0.447213595499958*cMSelf[a0+1]*uSelf[a0+6]+0.447213595499958*uSelf[a0+1]*cMSelf[a0+6]+0.4472135954999579*cMSelf[a0+3]*uSelf[a0+5]+0.4472135954999579*uSelf[a0+3]*cMSelf[a0+5]+0.4472135954999579*cMSelf[a0+3]*uSelf[a0+4]+0.4472135954999579*uSelf[a0+3]*cMSelf[a0+4]+0.5*cMSelf[a0]*uSelf[a0+3]+0.5*uSelf[a0]*cMSelf[a0+3]+0.5*cMSelf[a0+1]*uSelf[a0+2]+0.5*uSelf[a0+1]*cMSelf[a0+2]; 
    ucMSelf[4] += 0.2981423969999719*cMSelf[a0+8]*uSelf[a0+8]+0.4391550328268398*cMSelf[a0+1]*uSelf[a0+8]+0.4391550328268398*uSelf[a0+1]*cMSelf[a0+8]+0.4472135954999579*cMSelf[a0+7]*uSelf[a0+7]+0.31943828249997*cMSelf[a0+6]*uSelf[a0+6]+0.5000000000000001*cMSelf[a0+2]*uSelf[a0+6]+0.5000000000000001*uSelf[a0+2]*cMSelf[a0+6]+0.31943828249997*cMSelf[a0+4]*uSelf[a0+4]+0.5*cMSelf[a0]*uSelf[a0+4]+0.5*uSelf[a0]*cMSelf[a0+4]+0.4472135954999579*cMSelf[a0+3]*uSelf[a0+3]+0.4472135954999579*cMSelf[a0+1]*uSelf[a0+1]; 
    ucMSelf[5] += 0.2981423969999719*cMSelf[a0+9]*uSelf[a0+9]+0.4391550328268398*cMSelf[a0+2]*uSelf[a0+9]+0.4391550328268398*uSelf[a0+2]*cMSelf[a0+9]+0.31943828249997*cMSelf[a0+7]*uSelf[a0+7]+0.5000000000000001*cMSelf[a0+1]*uSelf[a0+7]+0.5000000000000001*uSelf[a0+1]*cMSelf[a0+7]+0.4472135954999579*cMSelf[a0+6]*uSelf[a0+6]+0.31943828249997*cMSelf[a0+5]*uSelf[a0+5]+0.5*cMSelf[a0]*uSelf[a0+5]+0.5*uSelf[a0]*cMSelf[a0+5]+0.4472135954999579*cMSelf[a0+3]*uSelf[a0+3]+0.4472135954999579*cMSelf[a0+2]*uSelf[a0+2]; 
    ucMSelf[6] += 0.4391550328268399*cMSelf[a0+3]*uSelf[a0+8]+0.4391550328268399*uSelf[a0+3]*cMSelf[a0+8]+0.4*cMSelf[a0+3]*uSelf[a0+7]+0.4*uSelf[a0+3]*cMSelf[a0+7]+0.4472135954999579*cMSelf[a0+5]*uSelf[a0+6]+0.31943828249997*cMSelf[a0+4]*uSelf[a0+6]+0.5*cMSelf[a0]*uSelf[a0+6]+0.4472135954999579*uSelf[a0+5]*cMSelf[a0+6]+0.31943828249997*uSelf[a0+4]*cMSelf[a0+6]+0.5*uSelf[a0]*cMSelf[a0+6]+0.5000000000000001*cMSelf[a0+2]*uSelf[a0+4]+0.5000000000000001*uSelf[a0+2]*cMSelf[a0+4]+0.447213595499958*cMSelf[a0+1]*uSelf[a0+3]+0.447213595499958*uSelf[a0+1]*cMSelf[a0+3]; 
    ucMSelf[7] += 0.4391550328268399*cMSelf[a0+3]*uSelf[a0+9]+0.4391550328268399*uSelf[a0+3]*cMSelf[a0+9]+0.31943828249997*cMSelf[a0+5]*uSelf[a0+7]+0.4472135954999579*cMSelf[a0+4]*uSelf[a0+7]+0.5*cMSelf[a0]*uSelf[a0+7]+0.31943828249997*uSelf[a0+5]*cMSelf[a0+7]+0.4472135954999579*uSelf[a0+4]*cMSelf[a0+7]+0.5*uSelf[a0]*cMSelf[a0+7]+0.4*cMSelf[a0+3]*uSelf[a0+6]+0.4*uSelf[a0+3]*cMSelf[a0+6]+0.5000000000000001*cMSelf[a0+1]*uSelf[a0+5]+0.5000000000000001*uSelf[a0+1]*cMSelf[a0+5]+0.447213595499958*cMSelf[a0+2]*uSelf[a0+3]+0.447213595499958*uSelf[a0+2]*cMSelf[a0+3]; 
    ucMSelf[8] += 0.2981423969999719*cMSelf[a0+4]*uSelf[a0+8]+0.5*cMSelf[a0]*uSelf[a0+8]+0.2981423969999719*uSelf[a0+4]*cMSelf[a0+8]+0.5*uSelf[a0]*cMSelf[a0+8]+0.4391550328268399*cMSelf[a0+3]*uSelf[a0+6]+0.4391550328268399*uSelf[a0+3]*cMSelf[a0+6]+0.4391550328268398*cMSelf[a0+1]*uSelf[a0+4]+0.4391550328268398*uSelf[a0+1]*cMSelf[a0+4]; 
    ucMSelf[9] += 0.2981423969999719*cMSelf[a0+5]*uSelf[a0+9]+0.5*cMSelf[a0]*uSelf[a0+9]+0.2981423969999719*uSelf[a0+5]*cMSelf[a0+9]+0.5*uSelf[a0]*cMSelf[a0+9]+0.4391550328268399*cMSelf[a0+3]*uSelf[a0+7]+0.4391550328268399*uSelf[a0+3]*cMSelf[a0+7]+0.4391550328268398*cMSelf[a0+2]*uSelf[a0+5]+0.4391550328268398*uSelf[a0+2]*cMSelf[a0+5]; 
  } 
 
  // ... Block from correction to (self) 2nd moment of collision operator ... // 
  data->AEM_S(50,20) = 0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(50,21) = 0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(50,22) = 0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(50,23) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf-0.5*cESelf[3]*mnuSelf; 
  data->AEM_S(50,24) = 0.5*ucMSelf[4]*mnuSelf+m0rSelf[4]*mnuSelf-0.5*cESelf[4]*mnuSelf; 
  data->AEM_S(50,25) = 0.5*ucMSelf[5]*mnuSelf+m0rSelf[5]*mnuSelf-0.5*cESelf[5]*mnuSelf; 
  data->AEM_S(50,26) = 0.5*ucMSelf[6]*mnuSelf+m0rSelf[6]*mnuSelf-0.5*cESelf[6]*mnuSelf; 
  data->AEM_S(50,27) = 0.5*ucMSelf[7]*mnuSelf+m0rSelf[7]*mnuSelf-0.5*cESelf[7]*mnuSelf; 
  data->AEM_S(50,28) = 0.5*ucMSelf[8]*mnuSelf+m0rSelf[8]*mnuSelf-0.5*cESelf[8]*mnuSelf; 
  data->AEM_S(50,29) = 0.5*ucMSelf[9]*mnuSelf+m0rSelf[9]*mnuSelf-0.5*cESelf[9]*mnuSelf; 
  data->AEM_S(51,20) = 0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(51,21) = 0.4472135954999579*ucMSelf[4]*mnuSelf+0.8944271909999159*m0rSelf[4]*mnuSelf-0.4472135954999579*cESelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(51,22) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf-0.5*cESelf[3]*mnuSelf; 
  data->AEM_S(51,23) = 0.447213595499958*ucMSelf[6]*mnuSelf+0.8944271909999161*m0rSelf[6]*mnuSelf-0.447213595499958*cESelf[6]*mnuSelf+0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(51,24) = 0.4391550328268398*ucMSelf[8]*mnuSelf+0.8783100656536796*m0rSelf[8]*mnuSelf-0.4391550328268398*cESelf[8]*mnuSelf+0.4472135954999579*ucMSelf[1]*mnuSelf+0.8944271909999159*m0rSelf[1]*mnuSelf-0.4472135954999579*cESelf[1]*mnuSelf; 
  data->AEM_S(51,25) = 0.5000000000000001*ucMSelf[7]*mnuSelf+1.0*m0rSelf[7]*mnuSelf-0.5000000000000001*cESelf[7]*mnuSelf; 
  data->AEM_S(51,26) = 0.447213595499958*ucMSelf[3]*mnuSelf+0.8944271909999161*m0rSelf[3]*mnuSelf-0.447213595499958*cESelf[3]*mnuSelf; 
  data->AEM_S(51,27) = 0.5000000000000001*ucMSelf[5]*mnuSelf+1.0*m0rSelf[5]*mnuSelf-0.5000000000000001*cESelf[5]*mnuSelf; 
  data->AEM_S(51,28) = 0.4391550328268398*ucMSelf[4]*mnuSelf+0.8783100656536796*m0rSelf[4]*mnuSelf-0.4391550328268398*cESelf[4]*mnuSelf; 
  data->AEM_S(52,20) = 0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(52,21) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf-0.5*cESelf[3]*mnuSelf; 
  data->AEM_S(52,22) = 0.4472135954999579*ucMSelf[5]*mnuSelf+0.8944271909999159*m0rSelf[5]*mnuSelf-0.4472135954999579*cESelf[5]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(52,23) = 0.447213595499958*ucMSelf[7]*mnuSelf+0.8944271909999161*m0rSelf[7]*mnuSelf-0.447213595499958*cESelf[7]*mnuSelf+0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(52,24) = 0.5000000000000001*ucMSelf[6]*mnuSelf+1.0*m0rSelf[6]*mnuSelf-0.5000000000000001*cESelf[6]*mnuSelf; 
  data->AEM_S(52,25) = 0.4391550328268398*ucMSelf[9]*mnuSelf+0.8783100656536796*m0rSelf[9]*mnuSelf-0.4391550328268398*cESelf[9]*mnuSelf+0.4472135954999579*ucMSelf[2]*mnuSelf+0.8944271909999159*m0rSelf[2]*mnuSelf-0.4472135954999579*cESelf[2]*mnuSelf; 
  data->AEM_S(52,26) = 0.5000000000000001*ucMSelf[4]*mnuSelf+1.0*m0rSelf[4]*mnuSelf-0.5000000000000001*cESelf[4]*mnuSelf; 
  data->AEM_S(52,27) = 0.447213595499958*ucMSelf[3]*mnuSelf+0.8944271909999161*m0rSelf[3]*mnuSelf-0.447213595499958*cESelf[3]*mnuSelf; 
  data->AEM_S(52,29) = 0.4391550328268398*ucMSelf[5]*mnuSelf+0.8783100656536796*m0rSelf[5]*mnuSelf-0.4391550328268398*cESelf[5]*mnuSelf; 
  data->AEM_S(53,20) = 0.5*ucMSelf[3]*mnuSelf+m0rSelf[3]*mnuSelf-0.5*cESelf[3]*mnuSelf; 
  data->AEM_S(53,21) = 0.447213595499958*ucMSelf[6]*mnuSelf+0.8944271909999161*m0rSelf[6]*mnuSelf-0.447213595499958*cESelf[6]*mnuSelf+0.5*ucMSelf[2]*mnuSelf+m0rSelf[2]*mnuSelf-0.5*cESelf[2]*mnuSelf; 
  data->AEM_S(53,22) = 0.447213595499958*ucMSelf[7]*mnuSelf+0.8944271909999161*m0rSelf[7]*mnuSelf-0.447213595499958*cESelf[7]*mnuSelf+0.5*ucMSelf[1]*mnuSelf+m0rSelf[1]*mnuSelf-0.5*cESelf[1]*mnuSelf; 
  data->AEM_S(53,23) = 0.4472135954999579*ucMSelf[5]*mnuSelf+0.8944271909999159*m0rSelf[5]*mnuSelf-0.4472135954999579*cESelf[5]*mnuSelf+0.4472135954999579*ucMSelf[4]*mnuSelf+0.8944271909999159*m0rSelf[4]*mnuSelf-0.4472135954999579*cESelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(53,24) = 0.4472135954999579*ucMSelf[3]*mnuSelf+0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cESelf[3]*mnuSelf; 
  data->AEM_S(53,25) = 0.4472135954999579*ucMSelf[3]*mnuSelf+0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cESelf[3]*mnuSelf; 
  data->AEM_S(53,26) = 0.4391550328268399*ucMSelf[8]*mnuSelf+0.8783100656536798*m0rSelf[8]*mnuSelf-0.4391550328268399*cESelf[8]*mnuSelf+0.4*ucMSelf[7]*mnuSelf+0.8*m0rSelf[7]*mnuSelf-0.4*cESelf[7]*mnuSelf+0.447213595499958*ucMSelf[1]*mnuSelf+0.8944271909999161*m0rSelf[1]*mnuSelf-0.447213595499958*cESelf[1]*mnuSelf; 
  data->AEM_S(53,27) = 0.4391550328268399*ucMSelf[9]*mnuSelf+0.8783100656536798*m0rSelf[9]*mnuSelf-0.4391550328268399*cESelf[9]*mnuSelf+0.4*ucMSelf[6]*mnuSelf+0.8*m0rSelf[6]*mnuSelf-0.4*cESelf[6]*mnuSelf+0.447213595499958*ucMSelf[2]*mnuSelf+0.8944271909999161*m0rSelf[2]*mnuSelf-0.447213595499958*cESelf[2]*mnuSelf; 
  data->AEM_S(53,28) = 0.4391550328268399*ucMSelf[6]*mnuSelf+0.8783100656536798*m0rSelf[6]*mnuSelf-0.4391550328268399*cESelf[6]*mnuSelf; 
  data->AEM_S(53,29) = 0.4391550328268399*ucMSelf[7]*mnuSelf+0.8783100656536798*m0rSelf[7]*mnuSelf-0.4391550328268399*cESelf[7]*mnuSelf; 
  data->AEM_S(54,20) = 0.5*ucMSelf[4]*mnuSelf+m0rSelf[4]*mnuSelf-0.5*cESelf[4]*mnuSelf; 
  data->AEM_S(54,21) = 0.4391550328268398*ucMSelf[8]*mnuSelf+0.8783100656536796*m0rSelf[8]*mnuSelf-0.4391550328268398*cESelf[8]*mnuSelf+0.4472135954999579*ucMSelf[1]*mnuSelf+0.8944271909999159*m0rSelf[1]*mnuSelf-0.4472135954999579*cESelf[1]*mnuSelf; 
  data->AEM_S(54,22) = 0.5000000000000001*ucMSelf[6]*mnuSelf+1.0*m0rSelf[6]*mnuSelf-0.5000000000000001*cESelf[6]*mnuSelf; 
  data->AEM_S(54,23) = 0.4472135954999579*ucMSelf[3]*mnuSelf+0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cESelf[3]*mnuSelf; 
  data->AEM_S(54,24) = 0.31943828249997*ucMSelf[4]*mnuSelf+0.6388765649999399*m0rSelf[4]*mnuSelf-0.31943828249997*cESelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(54,26) = 0.31943828249997*ucMSelf[6]*mnuSelf+0.6388765649999399*m0rSelf[6]*mnuSelf-0.31943828249997*cESelf[6]*mnuSelf+0.5000000000000001*ucMSelf[2]*mnuSelf+1.0*m0rSelf[2]*mnuSelf-0.5000000000000001*cESelf[2]*mnuSelf; 
  data->AEM_S(54,27) = 0.4472135954999579*ucMSelf[7]*mnuSelf+0.8944271909999159*m0rSelf[7]*mnuSelf-0.4472135954999579*cESelf[7]*mnuSelf; 
  data->AEM_S(54,28) = 0.2981423969999719*ucMSelf[8]*mnuSelf+0.5962847939999438*m0rSelf[8]*mnuSelf-0.2981423969999719*cESelf[8]*mnuSelf+0.4391550328268398*ucMSelf[1]*mnuSelf+0.8783100656536796*m0rSelf[1]*mnuSelf-0.4391550328268398*cESelf[1]*mnuSelf; 
  data->AEM_S(55,20) = 0.5*ucMSelf[5]*mnuSelf+m0rSelf[5]*mnuSelf-0.5*cESelf[5]*mnuSelf; 
  data->AEM_S(55,21) = 0.5000000000000001*ucMSelf[7]*mnuSelf+1.0*m0rSelf[7]*mnuSelf-0.5000000000000001*cESelf[7]*mnuSelf; 
  data->AEM_S(55,22) = 0.4391550328268398*ucMSelf[9]*mnuSelf+0.8783100656536796*m0rSelf[9]*mnuSelf-0.4391550328268398*cESelf[9]*mnuSelf+0.4472135954999579*ucMSelf[2]*mnuSelf+0.8944271909999159*m0rSelf[2]*mnuSelf-0.4472135954999579*cESelf[2]*mnuSelf; 
  data->AEM_S(55,23) = 0.4472135954999579*ucMSelf[3]*mnuSelf+0.8944271909999159*m0rSelf[3]*mnuSelf-0.4472135954999579*cESelf[3]*mnuSelf; 
  data->AEM_S(55,25) = 0.31943828249997*ucMSelf[5]*mnuSelf+0.6388765649999399*m0rSelf[5]*mnuSelf-0.31943828249997*cESelf[5]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(55,26) = 0.4472135954999579*ucMSelf[6]*mnuSelf+0.8944271909999159*m0rSelf[6]*mnuSelf-0.4472135954999579*cESelf[6]*mnuSelf; 
  data->AEM_S(55,27) = 0.31943828249997*ucMSelf[7]*mnuSelf+0.6388765649999399*m0rSelf[7]*mnuSelf-0.31943828249997*cESelf[7]*mnuSelf+0.5000000000000001*ucMSelf[1]*mnuSelf+1.0*m0rSelf[1]*mnuSelf-0.5000000000000001*cESelf[1]*mnuSelf; 
  data->AEM_S(55,29) = 0.2981423969999719*ucMSelf[9]*mnuSelf+0.5962847939999438*m0rSelf[9]*mnuSelf-0.2981423969999719*cESelf[9]*mnuSelf+0.4391550328268398*ucMSelf[2]*mnuSelf+0.8783100656536796*m0rSelf[2]*mnuSelf-0.4391550328268398*cESelf[2]*mnuSelf; 
  data->AEM_S(56,20) = 0.5*ucMSelf[6]*mnuSelf+m0rSelf[6]*mnuSelf-0.5*cESelf[6]*mnuSelf; 
  data->AEM_S(56,21) = 0.447213595499958*ucMSelf[3]*mnuSelf+0.8944271909999161*m0rSelf[3]*mnuSelf-0.447213595499958*cESelf[3]*mnuSelf; 
  data->AEM_S(56,22) = 0.5000000000000001*ucMSelf[4]*mnuSelf+1.0*m0rSelf[4]*mnuSelf-0.5000000000000001*cESelf[4]*mnuSelf; 
  data->AEM_S(56,23) = 0.4391550328268399*ucMSelf[8]*mnuSelf+0.8783100656536798*m0rSelf[8]*mnuSelf-0.4391550328268399*cESelf[8]*mnuSelf+0.4*ucMSelf[7]*mnuSelf+0.8*m0rSelf[7]*mnuSelf-0.4*cESelf[7]*mnuSelf+0.447213595499958*ucMSelf[1]*mnuSelf+0.8944271909999161*m0rSelf[1]*mnuSelf-0.447213595499958*cESelf[1]*mnuSelf; 
  data->AEM_S(56,24) = 0.31943828249997*ucMSelf[6]*mnuSelf+0.6388765649999399*m0rSelf[6]*mnuSelf-0.31943828249997*cESelf[6]*mnuSelf+0.5000000000000001*ucMSelf[2]*mnuSelf+1.0*m0rSelf[2]*mnuSelf-0.5000000000000001*cESelf[2]*mnuSelf; 
  data->AEM_S(56,25) = 0.4472135954999579*ucMSelf[6]*mnuSelf+0.8944271909999159*m0rSelf[6]*mnuSelf-0.4472135954999579*cESelf[6]*mnuSelf; 
  data->AEM_S(56,26) = 0.4472135954999579*ucMSelf[5]*mnuSelf+0.8944271909999159*m0rSelf[5]*mnuSelf-0.4472135954999579*cESelf[5]*mnuSelf+0.31943828249997*ucMSelf[4]*mnuSelf+0.6388765649999399*m0rSelf[4]*mnuSelf-0.31943828249997*cESelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(56,27) = 0.4*ucMSelf[3]*mnuSelf+0.8*m0rSelf[3]*mnuSelf-0.4*cESelf[3]*mnuSelf; 
  data->AEM_S(56,28) = 0.4391550328268399*ucMSelf[3]*mnuSelf+0.8783100656536798*m0rSelf[3]*mnuSelf-0.4391550328268399*cESelf[3]*mnuSelf; 
  data->AEM_S(57,20) = 0.5*ucMSelf[7]*mnuSelf+m0rSelf[7]*mnuSelf-0.5*cESelf[7]*mnuSelf; 
  data->AEM_S(57,21) = 0.5000000000000001*ucMSelf[5]*mnuSelf+1.0*m0rSelf[5]*mnuSelf-0.5000000000000001*cESelf[5]*mnuSelf; 
  data->AEM_S(57,22) = 0.447213595499958*ucMSelf[3]*mnuSelf+0.8944271909999161*m0rSelf[3]*mnuSelf-0.447213595499958*cESelf[3]*mnuSelf; 
  data->AEM_S(57,23) = 0.4391550328268399*ucMSelf[9]*mnuSelf+0.8783100656536798*m0rSelf[9]*mnuSelf-0.4391550328268399*cESelf[9]*mnuSelf+0.4*ucMSelf[6]*mnuSelf+0.8*m0rSelf[6]*mnuSelf-0.4*cESelf[6]*mnuSelf+0.447213595499958*ucMSelf[2]*mnuSelf+0.8944271909999161*m0rSelf[2]*mnuSelf-0.447213595499958*cESelf[2]*mnuSelf; 
  data->AEM_S(57,24) = 0.4472135954999579*ucMSelf[7]*mnuSelf+0.8944271909999159*m0rSelf[7]*mnuSelf-0.4472135954999579*cESelf[7]*mnuSelf; 
  data->AEM_S(57,25) = 0.31943828249997*ucMSelf[7]*mnuSelf+0.6388765649999399*m0rSelf[7]*mnuSelf-0.31943828249997*cESelf[7]*mnuSelf+0.5000000000000001*ucMSelf[1]*mnuSelf+1.0*m0rSelf[1]*mnuSelf-0.5000000000000001*cESelf[1]*mnuSelf; 
  data->AEM_S(57,26) = 0.4*ucMSelf[3]*mnuSelf+0.8*m0rSelf[3]*mnuSelf-0.4*cESelf[3]*mnuSelf; 
  data->AEM_S(57,27) = 0.31943828249997*ucMSelf[5]*mnuSelf+0.6388765649999399*m0rSelf[5]*mnuSelf-0.31943828249997*cESelf[5]*mnuSelf+0.4472135954999579*ucMSelf[4]*mnuSelf+0.8944271909999159*m0rSelf[4]*mnuSelf-0.4472135954999579*cESelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(57,29) = 0.4391550328268399*ucMSelf[3]*mnuSelf+0.8783100656536798*m0rSelf[3]*mnuSelf-0.4391550328268399*cESelf[3]*mnuSelf; 
  data->AEM_S(58,20) = 0.5*ucMSelf[8]*mnuSelf+m0rSelf[8]*mnuSelf-0.5*cESelf[8]*mnuSelf; 
  data->AEM_S(58,21) = 0.4391550328268398*ucMSelf[4]*mnuSelf+0.8783100656536796*m0rSelf[4]*mnuSelf-0.4391550328268398*cESelf[4]*mnuSelf; 
  data->AEM_S(58,23) = 0.4391550328268399*ucMSelf[6]*mnuSelf+0.8783100656536798*m0rSelf[6]*mnuSelf-0.4391550328268399*cESelf[6]*mnuSelf; 
  data->AEM_S(58,24) = 0.2981423969999719*ucMSelf[8]*mnuSelf+0.5962847939999438*m0rSelf[8]*mnuSelf-0.2981423969999719*cESelf[8]*mnuSelf+0.4391550328268398*ucMSelf[1]*mnuSelf+0.8783100656536796*m0rSelf[1]*mnuSelf-0.4391550328268398*cESelf[1]*mnuSelf; 
  data->AEM_S(58,26) = 0.4391550328268399*ucMSelf[3]*mnuSelf+0.8783100656536798*m0rSelf[3]*mnuSelf-0.4391550328268399*cESelf[3]*mnuSelf; 
  data->AEM_S(58,28) = 0.2981423969999719*ucMSelf[4]*mnuSelf+0.5962847939999438*m0rSelf[4]*mnuSelf-0.2981423969999719*cESelf[4]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  data->AEM_S(59,20) = 0.5*ucMSelf[9]*mnuSelf+m0rSelf[9]*mnuSelf-0.5*cESelf[9]*mnuSelf; 
  data->AEM_S(59,22) = 0.4391550328268398*ucMSelf[5]*mnuSelf+0.8783100656536796*m0rSelf[5]*mnuSelf-0.4391550328268398*cESelf[5]*mnuSelf; 
  data->AEM_S(59,23) = 0.4391550328268399*ucMSelf[7]*mnuSelf+0.8783100656536798*m0rSelf[7]*mnuSelf-0.4391550328268399*cESelf[7]*mnuSelf; 
  data->AEM_S(59,25) = 0.2981423969999719*ucMSelf[9]*mnuSelf+0.5962847939999438*m0rSelf[9]*mnuSelf-0.2981423969999719*cESelf[9]*mnuSelf+0.4391550328268398*ucMSelf[2]*mnuSelf+0.8783100656536796*m0rSelf[2]*mnuSelf-0.4391550328268398*cESelf[2]*mnuSelf; 
  data->AEM_S(59,27) = 0.4391550328268399*ucMSelf[3]*mnuSelf+0.8783100656536798*m0rSelf[3]*mnuSelf-0.4391550328268399*cESelf[3]*mnuSelf; 
  data->AEM_S(59,29) = 0.2981423969999719*ucMSelf[5]*mnuSelf+0.5962847939999438*m0rSelf[5]*mnuSelf-0.2981423969999719*cESelf[5]*mnuSelf+0.5*ucMSelf[0]*mnuSelf+m0rSelf[0]*mnuSelf-0.5*cESelf[0]*mnuSelf; 
  ...
  { 
    unsigned short int a0 = 10*vd; 
    // Contribution to dot-product from weak multiplication of vd component. 
    ucMOther[0] += 0.5*cMOther[a0+9]*uOther[a0+9]+0.5*cMOther[a0+8]*uOther[a0+8]+0.5*cMOther[a0+7]*uOther[a0+7]+0.5*cMOther[a0+6]*uOther[a0+6]+0.5*cMOther[a0+5]*uOther[a0+5]+0.5*cMOther[a0+4]*uOther[a0+4]+0.5*cMOther[a0+3]*uOther[a0+3]+0.5*cMOther[a0+2]*uOther[a0+2]+0.5*cMOther[a0+1]*uOther[a0+1]+0.5*cMOther[a0]*uOther[a0]; 
    ucMOther[1] += 0.4391550328268398*cMOther[a0+4]*uOther[a0+8]+0.4391550328268398*uOther[a0+4]*cMOther[a0+8]+0.5000000000000001*cMOther[a0+5]*uOther[a0+7]+0.5000000000000001*uOther[a0+5]*cMOther[a0+7]+0.447213595499958*cMOther[a0+3]*uOther[a0+6]+0.447213595499958*uOther[a0+3]*cMOther[a0+6]+0.4472135954999579*cMOther[a0+1]*uOther[a0+4]+0.4472135954999579*uOther[a0+1]*cMOther[a0+4]+0.5*cMOther[a0+2]*uOther[a0+3]+0.5*uOther[a0+2]*cMOther[a0+3]+0.5*cMOther[a0]*uOther[a0+1]+0.5*uOther[a0]*cMOther[a0+1]; 
    ucMOther[2] += 0.4391550328268398*cMOther[a0+5]*uOther[a0+9]+0.4391550328268398*uOther[a0+5]*cMOther[a0+9]+0.447213595499958*cMOther[a0+3]*uOther[a0+7]+0.447213595499958*uOther[a0+3]*cMOther[a0+7]+0.5000000000000001*cMOther[a0+4]*uOther[a0+6]+0.5000000000000001*uOther[a0+4]*cMOther[a0+6]+0.4472135954999579*cMOther[a0+2]*uOther[a0+5]+0.4472135954999579*uOther[a0+2]*cMOther[a0+5]+0.5*cMOther[a0+1]*uOther[a0+3]+0.5*uOther[a0+1]*cMOther[a0+3]+0.5*cMOther[a0]*uOther[a0+2]+0.5*uOther[a0]*cMOther[a0+2]; 
    ucMOther[3] += 0.4391550328268399*cMOther[a0+7]*uOther[a0+9]+0.4391550328268399*uOther[a0+7]*cMOther[a0+9]+0.4391550328268399*cMOther[a0+6]*uOther[a0+8]+0.4391550328268399*uOther[a0+6]*cMOther[a0+8]+0.4*cMOther[a0+6]*uOther[a0+7]+0.447213595499958*cMOther[a0+2]*uOther[a0+7]+0.4*uOther[a0+6]*cMOther[a0+7]+0.447213595499958*uOther[a0+2]*cMOther[a0+7]+0.447213595499958*cMOther[a0+1]*uOther[a0+6]+0.447213595499958*uOther[a0+1]*cMOther[a0+6]+0.4472135954999579*cMOther[a0+3]*uOther[a0+5]+0.4472135954999579*uOther[a0+3]*cMOther[a0+5]+0.4472135954999579*cMOther[a0+3]*uOther[a0+4]+0.4472135954999579*uOther[a0+3]*cMOther[a0+4]+0.5*cMOther[a0]*uOther[a0+3]+0.5*uOther[a0]*cMOther[a0+3]+0.5*cMOther[a0+1]*uOther[a0+2]+0.5*uOther[a0+1]*cMOther[a0+2]; 
    ucMOther[4] += 0.2981423969999719*cMOther[a0+8]*uOther[a0+8]+0.4391550328268398*cMOther[a0+1]*uOther[a0+8]+0.4391550328268398*uOther[a0+1]*cMOther[a0+8]+0.4472135954999579*cMOther[a0+7]*uOther[a0+7]+0.31943828249997*cMOther[a0+6]*uOther[a0+6]+0.5000000000000001*cMOther[a0+2]*uOther[a0+6]+0.5000000000000001*uOther[a0+2]*cMOther[a0+6]+0.31943828249997*cMOther[a0+4]*uOther[a0+4]+0.5*cMOther[a0]*uOther[a0+4]+0.5*uOther[a0]*cMOther[a0+4]+0.4472135954999579*cMOther[a0+3]*uOther[a0+3]+0.4472135954999579*cMOther[a0+1]*uOther[a0+1]; 
    ucMOther[5] += 0.2981423969999719*cMOther[a0+9]*uOther[a0+9]+0.4391550328268398*cMOther[a0+2]*uOther[a0+9]+0.4391550328268398*uOther[a0+2]*cMOther[a0+9]+0.31943828249997*cMOther[a0+7]*uOther[a0+7]+0.5000000000000001*cMOther[a0+1]*uOther[a0+7]+0.5000000000000001*uOther[a0+1]*cMOther[a0+7]+0.4472135954999579*cMOther[a0+6]*uOther[a0+6]+0.31943828249997*cMOther[a0+5]*uOther[a0+5]+0.5*cMOther[a0]*uOther[a0+5]+0.5*uOther[a0]*cMOther[a0+5]+0.4472135954999579*cMOther[a0+3]*uOther[a0+3]+0.4472135954999579*cMOther[a0+2]*uOther[a0+2]; 
    ucMOther[6] += 0.4391550328268399*cMOther[a0+3]*uOther[a0+8]+0.4391550328268399*uOther[a0+3]*cMOther[a0+8]+0.4*cMOther[a0+3]*uOther[a0+7]+0.4*uOther[a0+3]*cMOther[a0+7]+0.4472135954999579*cMOther[a0+5]*uOther[a0+6]+0.31943828249997*cMOther[a0+4]*uOther[a0+6]+0.5*cMOther[a0]*uOther[a0+6]+0.4472135954999579*uOther[a0+5]*cMOther[a0+6]+0.31943828249997*uOther[a0+4]*cMOther[a0+6]+0.5*uOther[a0]*cMOther[a0+6]+0.5000000000000001*cMOther[a0+2]*uOther[a0+4]+0.5000000000000001*uOther[a0+2]*cMOther[a0+4]+0.447213595499958*cMOther[a0+1]*uOther[a0+3]+0.447213595499958*uOther[a0+1]*cMOther[a0+3]; 
    ucMOther[7] += 0.4391550328268399*cMOther[a0+3]*uOther[a0+9]+0.4391550328268399*uOther[a0+3]*cMOther[a0+9]+0.31943828249997*cMOther[a0+5]*uOther[a0+7]+0.4472135954999579*cMOther[a0+4]*uOther[a0+7]+0.5*cMOther[a0]*uOther[a0+7]+0.31943828249997*uOther[a0+5]*cMOther[a0+7]+0.4472135954999579*uOther[a0+4]*cMOther[a0+7]+0.5*uOther[a0]*cMOther[a0+7]+0.4*cMOther[a0+3]*uOther[a0+6]+0.4*uOther[a0+3]*cMOther[a0+6]+0.5000000000000001*cMOther[a0+1]*uOther[a0+5]+0.5000000000000001*uOther[a0+1]*cMOther[a0+5]+0.447213595499958*cMOther[a0+2]*uOther[a0+3]+0.447213595499958*uOther[a0+2]*cMOther[a0+3]; 
    ucMOther[8] += 0.2981423969999719*cMOther[a0+4]*uOther[a0+8]+0.5*cMOther[a0]*uOther[a0+8]+0.2981423969999719*uOther[a0+4]*cMOther[a0+8]+0.5*uOther[a0]*cMOther[a0+8]+0.4391550328268399*cMOther[a0+3]*uOther[a0+6]+0.4391550328268399*uOther[a0+3]*cMOther[a0+6]+0.4391550328268398*cMOther[a0+1]*uOther[a0+4]+0.4391550328268398*uOther[a0+1]*cMOther[a0+4]; 
    ucMOther[9] += 0.2981423969999719*cMOther[a0+5]*uOther[a0+9]+0.5*cMOther[a0]*uOther[a0+9]+0.2981423969999719*uOther[a0+5]*cMOther[a0+9]+0.5*uOther[a0]*cMOther[a0+9]+0.4391550328268399*cMOther[a0+3]*uOther[a0+7]+0.4391550328268399*uOther[a0+3]*cMOther[a0+7]+0.4391550328268398*cMOther[a0+2]*uOther[a0+5]+0.4391550328268398*uOther[a0+2]*cMOther[a0+5]; 
  } 
 
  // ... Block from correction to (other) 2nd moment of collision operator ... // 
  data->AEM_S(50,50) = (-0.5*ucMOther[0]*mnuOther)-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(50,51) = (-0.5*ucMOther[1]*mnuOther)-1.0*m0rOther[1]*mnuOther+0.5*cEOther[1]*mnuOther; 
  data->AEM_S(50,52) = (-0.5*ucMOther[2]*mnuOther)-1.0*m0rOther[2]*mnuOther+0.5*cEOther[2]*mnuOther; 
  data->AEM_S(50,53) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther+0.5*cEOther[3]*mnuOther; 
  data->AEM_S(50,54) = (-0.5*ucMOther[4]*mnuOther)-1.0*m0rOther[4]*mnuOther+0.5*cEOther[4]*mnuOther; 
  data->AEM_S(50,55) = (-0.5*ucMOther[5]*mnuOther)-1.0*m0rOther[5]*mnuOther+0.5*cEOther[5]*mnuOther; 
  data->AEM_S(50,56) = (-0.5*ucMOther[6]*mnuOther)-1.0*m0rOther[6]*mnuOther+0.5*cEOther[6]*mnuOther; 
  data->AEM_S(50,57) = (-0.5*ucMOther[7]*mnuOther)-1.0*m0rOther[7]*mnuOther+0.5*cEOther[7]*mnuOther; 
  data->AEM_S(50,58) = (-0.5*ucMOther[8]*mnuOther)-1.0*m0rOther[8]*mnuOther+0.5*cEOther[8]*mnuOther; 
  data->AEM_S(50,59) = (-0.5*ucMOther[9]*mnuOther)-1.0*m0rOther[9]*mnuOther+0.5*cEOther[9]*mnuOther; 
  data->AEM_S(51,50) = (-0.5*ucMOther[1]*mnuOther)-1.0*m0rOther[1]*mnuOther+0.5*cEOther[1]*mnuOther; 
  data->AEM_S(51,51) = (-0.4472135954999579*ucMOther[4]*mnuOther)-0.8944271909999159*m0rOther[4]*mnuOther+0.4472135954999579*cEOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(51,52) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther+0.5*cEOther[3]*mnuOther; 
  data->AEM_S(51,53) = (-0.447213595499958*ucMOther[6]*mnuOther)-0.8944271909999161*m0rOther[6]*mnuOther+0.447213595499958*cEOther[6]*mnuOther-0.5*ucMOther[2]*mnuOther-1.0*m0rOther[2]*mnuOther+0.5*cEOther[2]*mnuOther; 
  data->AEM_S(51,54) = (-0.4391550328268398*ucMOther[8]*mnuOther)-0.8783100656536796*m0rOther[8]*mnuOther+0.4391550328268398*cEOther[8]*mnuOther-0.4472135954999579*ucMOther[1]*mnuOther-0.8944271909999159*m0rOther[1]*mnuOther+0.4472135954999579*cEOther[1]*mnuOther; 
  data->AEM_S(51,55) = (-0.5000000000000001*ucMOther[7]*mnuOther)-1.0*m0rOther[7]*mnuOther+0.5000000000000001*cEOther[7]*mnuOther; 
  data->AEM_S(51,56) = (-0.447213595499958*ucMOther[3]*mnuOther)-0.8944271909999161*m0rOther[3]*mnuOther+0.447213595499958*cEOther[3]*mnuOther; 
  data->AEM_S(51,57) = (-0.5000000000000001*ucMOther[5]*mnuOther)-1.0*m0rOther[5]*mnuOther+0.5000000000000001*cEOther[5]*mnuOther; 
  data->AEM_S(51,58) = (-0.4391550328268398*ucMOther[4]*mnuOther)-0.8783100656536796*m0rOther[4]*mnuOther+0.4391550328268398*cEOther[4]*mnuOther; 
  data->AEM_S(52,50) = (-0.5*ucMOther[2]*mnuOther)-1.0*m0rOther[2]*mnuOther+0.5*cEOther[2]*mnuOther; 
  data->AEM_S(52,51) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther+0.5*cEOther[3]*mnuOther; 
  data->AEM_S(52,52) = (-0.4472135954999579*ucMOther[5]*mnuOther)-0.8944271909999159*m0rOther[5]*mnuOther+0.4472135954999579*cEOther[5]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(52,53) = (-0.447213595499958*ucMOther[7]*mnuOther)-0.8944271909999161*m0rOther[7]*mnuOther+0.447213595499958*cEOther[7]*mnuOther-0.5*ucMOther[1]*mnuOther-1.0*m0rOther[1]*mnuOther+0.5*cEOther[1]*mnuOther; 
  data->AEM_S(52,54) = (-0.5000000000000001*ucMOther[6]*mnuOther)-1.0*m0rOther[6]*mnuOther+0.5000000000000001*cEOther[6]*mnuOther; 
  data->AEM_S(52,55) = (-0.4391550328268398*ucMOther[9]*mnuOther)-0.8783100656536796*m0rOther[9]*mnuOther+0.4391550328268398*cEOther[9]*mnuOther-0.4472135954999579*ucMOther[2]*mnuOther-0.8944271909999159*m0rOther[2]*mnuOther+0.4472135954999579*cEOther[2]*mnuOther; 
  data->AEM_S(52,56) = (-0.5000000000000001*ucMOther[4]*mnuOther)-1.0*m0rOther[4]*mnuOther+0.5000000000000001*cEOther[4]*mnuOther; 
  data->AEM_S(52,57) = (-0.447213595499958*ucMOther[3]*mnuOther)-0.8944271909999161*m0rOther[3]*mnuOther+0.447213595499958*cEOther[3]*mnuOther; 
  data->AEM_S(52,59) = (-0.4391550328268398*ucMOther[5]*mnuOther)-0.8783100656536796*m0rOther[5]*mnuOther+0.4391550328268398*cEOther[5]*mnuOther; 
  data->AEM_S(53,50) = (-0.5*ucMOther[3]*mnuOther)-1.0*m0rOther[3]*mnuOther+0.5*cEOther[3]*mnuOther; 
  data->AEM_S(53,51) = (-0.447213595499958*ucMOther[6]*mnuOther)-0.8944271909999161*m0rOther[6]*mnuOther+0.447213595499958*cEOther[6]*mnuOther-0.5*ucMOther[2]*mnuOther-1.0*m0rOther[2]*mnuOther+0.5*cEOther[2]*mnuOther; 
  data->AEM_S(53,52) = (-0.447213595499958*ucMOther[7]*mnuOther)-0.8944271909999161*m0rOther[7]*mnuOther+0.447213595499958*cEOther[7]*mnuOther-0.5*ucMOther[1]*mnuOther-1.0*m0rOther[1]*mnuOther+0.5*cEOther[1]*mnuOther; 
  data->AEM_S(53,53) = (-0.4472135954999579*ucMOther[5]*mnuOther)-0.8944271909999159*m0rOther[5]*mnuOther+0.4472135954999579*cEOther[5]*mnuOther-0.4472135954999579*ucMOther[4]*mnuOther-0.8944271909999159*m0rOther[4]*mnuOther+0.4472135954999579*cEOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(53,54) = (-0.4472135954999579*ucMOther[3]*mnuOther)-0.8944271909999159*m0rOther[3]*mnuOther+0.4472135954999579*cEOther[3]*mnuOther; 
  data->AEM_S(53,55) = (-0.4472135954999579*ucMOther[3]*mnuOther)-0.8944271909999159*m0rOther[3]*mnuOther+0.4472135954999579*cEOther[3]*mnuOther; 
  data->AEM_S(53,56) = (-0.4391550328268399*ucMOther[8]*mnuOther)-0.8783100656536798*m0rOther[8]*mnuOther+0.4391550328268399*cEOther[8]*mnuOther-0.4*ucMOther[7]*mnuOther-0.8*m0rOther[7]*mnuOther+0.4*cEOther[7]*mnuOther-0.447213595499958*ucMOther[1]*mnuOther-0.8944271909999161*m0rOther[1]*mnuOther+0.447213595499958*cEOther[1]*mnuOther; 
  data->AEM_S(53,57) = (-0.4391550328268399*ucMOther[9]*mnuOther)-0.8783100656536798*m0rOther[9]*mnuOther+0.4391550328268399*cEOther[9]*mnuOther-0.4*ucMOther[6]*mnuOther-0.8*m0rOther[6]*mnuOther+0.4*cEOther[6]*mnuOther-0.447213595499958*ucMOther[2]*mnuOther-0.8944271909999161*m0rOther[2]*mnuOther+0.447213595499958*cEOther[2]*mnuOther; 
  data->AEM_S(53,58) = (-0.4391550328268399*ucMOther[6]*mnuOther)-0.8783100656536798*m0rOther[6]*mnuOther+0.4391550328268399*cEOther[6]*mnuOther; 
  data->AEM_S(53,59) = (-0.4391550328268399*ucMOther[7]*mnuOther)-0.8783100656536798*m0rOther[7]*mnuOther+0.4391550328268399*cEOther[7]*mnuOther; 
  data->AEM_S(54,50) = (-0.5*ucMOther[4]*mnuOther)-1.0*m0rOther[4]*mnuOther+0.5*cEOther[4]*mnuOther; 
  data->AEM_S(54,51) = (-0.4391550328268398*ucMOther[8]*mnuOther)-0.8783100656536796*m0rOther[8]*mnuOther+0.4391550328268398*cEOther[8]*mnuOther-0.4472135954999579*ucMOther[1]*mnuOther-0.8944271909999159*m0rOther[1]*mnuOther+0.4472135954999579*cEOther[1]*mnuOther; 
  data->AEM_S(54,52) = (-0.5000000000000001*ucMOther[6]*mnuOther)-1.0*m0rOther[6]*mnuOther+0.5000000000000001*cEOther[6]*mnuOther; 
  data->AEM_S(54,53) = (-0.4472135954999579*ucMOther[3]*mnuOther)-0.8944271909999159*m0rOther[3]*mnuOther+0.4472135954999579*cEOther[3]*mnuOther; 
  data->AEM_S(54,54) = (-0.31943828249997*ucMOther[4]*mnuOther)-0.6388765649999399*m0rOther[4]*mnuOther+0.31943828249997*cEOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(54,56) = (-0.31943828249997*ucMOther[6]*mnuOther)-0.6388765649999399*m0rOther[6]*mnuOther+0.31943828249997*cEOther[6]*mnuOther-0.5000000000000001*ucMOther[2]*mnuOther-1.0*m0rOther[2]*mnuOther+0.5000000000000001*cEOther[2]*mnuOther; 
  data->AEM_S(54,57) = (-0.4472135954999579*ucMOther[7]*mnuOther)-0.8944271909999159*m0rOther[7]*mnuOther+0.4472135954999579*cEOther[7]*mnuOther; 
  data->AEM_S(54,58) = (-0.2981423969999719*ucMOther[8]*mnuOther)-0.5962847939999438*m0rOther[8]*mnuOther+0.2981423969999719*cEOther[8]*mnuOther-0.4391550328268398*ucMOther[1]*mnuOther-0.8783100656536796*m0rOther[1]*mnuOther+0.4391550328268398*cEOther[1]*mnuOther; 
  data->AEM_S(55,50) = (-0.5*ucMOther[5]*mnuOther)-1.0*m0rOther[5]*mnuOther+0.5*cEOther[5]*mnuOther; 
  data->AEM_S(55,51) = (-0.5000000000000001*ucMOther[7]*mnuOther)-1.0*m0rOther[7]*mnuOther+0.5000000000000001*cEOther[7]*mnuOther; 
  data->AEM_S(55,52) = (-0.4391550328268398*ucMOther[9]*mnuOther)-0.8783100656536796*m0rOther[9]*mnuOther+0.4391550328268398*cEOther[9]*mnuOther-0.4472135954999579*ucMOther[2]*mnuOther-0.8944271909999159*m0rOther[2]*mnuOther+0.4472135954999579*cEOther[2]*mnuOther; 
  data->AEM_S(55,53) = (-0.4472135954999579*ucMOther[3]*mnuOther)-0.8944271909999159*m0rOther[3]*mnuOther+0.4472135954999579*cEOther[3]*mnuOther; 
  data->AEM_S(55,55) = (-0.31943828249997*ucMOther[5]*mnuOther)-0.6388765649999399*m0rOther[5]*mnuOther+0.31943828249997*cEOther[5]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(55,56) = (-0.4472135954999579*ucMOther[6]*mnuOther)-0.8944271909999159*m0rOther[6]*mnuOther+0.4472135954999579*cEOther[6]*mnuOther; 
  data->AEM_S(55,57) = (-0.31943828249997*ucMOther[7]*mnuOther)-0.6388765649999399*m0rOther[7]*mnuOther+0.31943828249997*cEOther[7]*mnuOther-0.5000000000000001*ucMOther[1]*mnuOther-1.0*m0rOther[1]*mnuOther+0.5000000000000001*cEOther[1]*mnuOther; 
  data->AEM_S(55,59) = (-0.2981423969999719*ucMOther[9]*mnuOther)-0.5962847939999438*m0rOther[9]*mnuOther+0.2981423969999719*cEOther[9]*mnuOther-0.4391550328268398*ucMOther[2]*mnuOther-0.8783100656536796*m0rOther[2]*mnuOther+0.4391550328268398*cEOther[2]*mnuOther; 
  data->AEM_S(56,50) = (-0.5*ucMOther[6]*mnuOther)-1.0*m0rOther[6]*mnuOther+0.5*cEOther[6]*mnuOther; 
  data->AEM_S(56,51) = (-0.447213595499958*ucMOther[3]*mnuOther)-0.8944271909999161*m0rOther[3]*mnuOther+0.447213595499958*cEOther[3]*mnuOther; 
  data->AEM_S(56,52) = (-0.5000000000000001*ucMOther[4]*mnuOther)-1.0*m0rOther[4]*mnuOther+0.5000000000000001*cEOther[4]*mnuOther; 
  data->AEM_S(56,53) = (-0.4391550328268399*ucMOther[8]*mnuOther)-0.8783100656536798*m0rOther[8]*mnuOther+0.4391550328268399*cEOther[8]*mnuOther-0.4*ucMOther[7]*mnuOther-0.8*m0rOther[7]*mnuOther+0.4*cEOther[7]*mnuOther-0.447213595499958*ucMOther[1]*mnuOther-0.8944271909999161*m0rOther[1]*mnuOther+0.447213595499958*cEOther[1]*mnuOther; 
  data->AEM_S(56,54) = (-0.31943828249997*ucMOther[6]*mnuOther)-0.6388765649999399*m0rOther[6]*mnuOther+0.31943828249997*cEOther[6]*mnuOther-0.5000000000000001*ucMOther[2]*mnuOther-1.0*m0rOther[2]*mnuOther+0.5000000000000001*cEOther[2]*mnuOther; 
  data->AEM_S(56,55) = (-0.4472135954999579*ucMOther[6]*mnuOther)-0.8944271909999159*m0rOther[6]*mnuOther+0.4472135954999579*cEOther[6]*mnuOther; 
  data->AEM_S(56,56) = (-0.4472135954999579*ucMOther[5]*mnuOther)-0.8944271909999159*m0rOther[5]*mnuOther+0.4472135954999579*cEOther[5]*mnuOther-0.31943828249997*ucMOther[4]*mnuOther-0.6388765649999399*m0rOther[4]*mnuOther+0.31943828249997*cEOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(56,57) = (-0.4*ucMOther[3]*mnuOther)-0.8*m0rOther[3]*mnuOther+0.4*cEOther[3]*mnuOther; 
  data->AEM_S(56,58) = (-0.4391550328268399*ucMOther[3]*mnuOther)-0.8783100656536798*m0rOther[3]*mnuOther+0.4391550328268399*cEOther[3]*mnuOther; 
  data->AEM_S(57,50) = (-0.5*ucMOther[7]*mnuOther)-1.0*m0rOther[7]*mnuOther+0.5*cEOther[7]*mnuOther; 
  data->AEM_S(57,51) = (-0.5000000000000001*ucMOther[5]*mnuOther)-1.0*m0rOther[5]*mnuOther+0.5000000000000001*cEOther[5]*mnuOther; 
  data->AEM_S(57,52) = (-0.447213595499958*ucMOther[3]*mnuOther)-0.8944271909999161*m0rOther[3]*mnuOther+0.447213595499958*cEOther[3]*mnuOther; 
  data->AEM_S(57,53) = (-0.4391550328268399*ucMOther[9]*mnuOther)-0.8783100656536798*m0rOther[9]*mnuOther+0.4391550328268399*cEOther[9]*mnuOther-0.4*ucMOther[6]*mnuOther-0.8*m0rOther[6]*mnuOther+0.4*cEOther[6]*mnuOther-0.447213595499958*ucMOther[2]*mnuOther-0.8944271909999161*m0rOther[2]*mnuOther+0.447213595499958*cEOther[2]*mnuOther; 
  data->AEM_S(57,54) = (-0.4472135954999579*ucMOther[7]*mnuOther)-0.8944271909999159*m0rOther[7]*mnuOther+0.4472135954999579*cEOther[7]*mnuOther; 
  data->AEM_S(57,55) = (-0.31943828249997*ucMOther[7]*mnuOther)-0.6388765649999399*m0rOther[7]*mnuOther+0.31943828249997*cEOther[7]*mnuOther-0.5000000000000001*ucMOther[1]*mnuOther-1.0*m0rOther[1]*mnuOther+0.5000000000000001*cEOther[1]*mnuOther; 
  data->AEM_S(57,56) = (-0.4*ucMOther[3]*mnuOther)-0.8*m0rOther[3]*mnuOther+0.4*cEOther[3]*mnuOther; 
  data->AEM_S(57,57) = (-0.31943828249997*ucMOther[5]*mnuOther)-0.6388765649999399*m0rOther[5]*mnuOther+0.31943828249997*cEOther[5]*mnuOther-0.4472135954999579*ucMOther[4]*mnuOther-0.8944271909999159*m0rOther[4]*mnuOther+0.4472135954999579*cEOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(57,59) = (-0.4391550328268399*ucMOther[3]*mnuOther)-0.8783100656536798*m0rOther[3]*mnuOther+0.4391550328268399*cEOther[3]*mnuOther; 
  data->AEM_S(58,50) = (-0.5*ucMOther[8]*mnuOther)-1.0*m0rOther[8]*mnuOther+0.5*cEOther[8]*mnuOther; 
  data->AEM_S(58,51) = (-0.4391550328268398*ucMOther[4]*mnuOther)-0.8783100656536796*m0rOther[4]*mnuOther+0.4391550328268398*cEOther[4]*mnuOther; 
  data->AEM_S(58,53) = (-0.4391550328268399*ucMOther[6]*mnuOther)-0.8783100656536798*m0rOther[6]*mnuOther+0.4391550328268399*cEOther[6]*mnuOther; 
  data->AEM_S(58,54) = (-0.2981423969999719*ucMOther[8]*mnuOther)-0.5962847939999438*m0rOther[8]*mnuOther+0.2981423969999719*cEOther[8]*mnuOther-0.4391550328268398*ucMOther[1]*mnuOther-0.8783100656536796*m0rOther[1]*mnuOther+0.4391550328268398*cEOther[1]*mnuOther; 
  data->AEM_S(58,56) = (-0.4391550328268399*ucMOther[3]*mnuOther)-0.8783100656536798*m0rOther[3]*mnuOther+0.4391550328268399*cEOther[3]*mnuOther; 
  data->AEM_S(58,58) = (-0.2981423969999719*ucMOther[4]*mnuOther)-0.5962847939999438*m0rOther[4]*mnuOther+0.2981423969999719*cEOther[4]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
  data->AEM_S(59,50) = (-0.5*ucMOther[9]*mnuOther)-1.0*m0rOther[9]*mnuOther+0.5*cEOther[9]*mnuOther; 
  data->AEM_S(59,52) = (-0.4391550328268398*ucMOther[5]*mnuOther)-0.8783100656536796*m0rOther[5]*mnuOther+0.4391550328268398*cEOther[5]*mnuOther; 
  data->AEM_S(59,53) = (-0.4391550328268399*ucMOther[7]*mnuOther)-0.8783100656536798*m0rOther[7]*mnuOther+0.4391550328268399*cEOther[7]*mnuOther; 
  data->AEM_S(59,55) = (-0.2981423969999719*ucMOther[9]*mnuOther)-0.5962847939999438*m0rOther[9]*mnuOther+0.2981423969999719*cEOther[9]*mnuOther-0.4391550328268398*ucMOther[2]*mnuOther-0.8783100656536796*m0rOther[2]*mnuOther+0.4391550328268398*cEOther[2]*mnuOther; 
  data->AEM_S(59,57) = (-0.4391550328268399*ucMOther[3]*mnuOther)-0.8783100656536798*m0rOther[3]*mnuOther+0.4391550328268399*cEOther[3]*mnuOther; 
  data->AEM_S(59,59) = (-0.2981423969999719*ucMOther[5]*mnuOther)-0.5962847939999438*m0rOther[5]*mnuOther+0.2981423969999719*cEOther[5]*mnuOther-0.5*ucMOther[0]*mnuOther-1.0*m0rOther[0]*mnuOther+0.5*cEOther[0]*mnuOther; 
