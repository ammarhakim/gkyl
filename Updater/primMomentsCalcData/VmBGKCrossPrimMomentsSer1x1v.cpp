...
{ 
  ...
  double diffSelf[2]; 
  diffSelf[0] = (0.7071067811865475*m0rOther[1]*relKinE[1]+0.7071067811865475*m0rOther[0]*relKinE[0])*mnuOther-1.0*uRelSq[0]*mOther+Tdiff[0]; 
  diffSelf[1] = (0.7071067811865475*m0rOther[0]*relKinE[1]+0.7071067811865475*relKinE[0]*m0rOther[1])*mnuOther-1.0*uRelSq[1]*mOther+Tdiff[1]; 
  ...
  double diffOther[2]; 
  diffOther[0] = (0.7071067811865475*m0rSelf[1]*relKinE[1]+0.7071067811865475*m0rSelf[0]*relKinE[0])*mnuSelf-1.0*uRelSq[0]*mSelf-1.0*Tdiff[0]; 
  diffOther[1] = (0.7071067811865475*m0rSelf[0]*relKinE[1]+0.7071067811865475*relKinE[0]*m0rSelf[1])*mnuSelf-1.0*uRelSq[1]*mSelf-1.0*Tdiff[1]; 
...
{ 
  ...
  double diffSelf[4]; 
  diffSelf[0] = (0.7071067811865475*m0rOther[3]*relKinE[3]+0.7071067811865475*m0rOther[2]*relKinE[2]+0.7071067811865475*m0rOther[1]*relKinE[1]+0.7071067811865475*m0rOther[0]*relKinE[0])*mnuOther-1.0*uRelSq[0]*mOther+Tdiff[0]; 
  diffSelf[1] = (0.6210590034081186*m0rOther[2]*relKinE[3]+0.6210590034081186*relKinE[2]*m0rOther[3]+0.6324555320336759*m0rOther[1]*relKinE[2]+0.6324555320336759*relKinE[1]*m0rOther[2]+0.7071067811865475*m0rOther[0]*relKinE[1]+0.7071067811865475*relKinE[0]*m0rOther[1])*mnuOther-1.0*uRelSq[1]*mOther+Tdiff[1]; 
  diffSelf[2] = (0.421637021355784*m0rOther[3]*relKinE[3]+0.6210590034081186*m0rOther[1]*relKinE[3]+0.6210590034081186*relKinE[1]*m0rOther[3]+0.4517539514526256*m0rOther[2]*relKinE[2]+0.7071067811865475*m0rOther[0]*relKinE[2]+0.7071067811865475*relKinE[0]*m0rOther[2]+0.6324555320336759*m0rOther[1]*relKinE[1])*mnuOther-1.0*uRelSq[2]*mOther+Tdiff[2]; 
  diffSelf[3] = (0.421637021355784*m0rOther[2]*relKinE[3]+0.7071067811865475*m0rOther[0]*relKinE[3]+0.421637021355784*relKinE[2]*m0rOther[3]+0.7071067811865475*relKinE[0]*m0rOther[3]+0.6210590034081186*m0rOther[1]*relKinE[2]+0.6210590034081186*relKinE[1]*m0rOther[2])*mnuOther-1.0*uRelSq[3]*mOther+Tdiff[3]; 
  ...
  double diffOther[4]; 
  diffOther[0] = (0.7071067811865475*m0rSelf[3]*relKinE[3]+0.7071067811865475*m0rSelf[2]*relKinE[2]+0.7071067811865475*m0rSelf[1]*relKinE[1]+0.7071067811865475*m0rSelf[0]*relKinE[0])*mnuSelf-1.0*uRelSq[0]*mSelf-1.0*Tdiff[0]; 
  diffOther[1] = (0.6210590034081186*m0rSelf[2]*relKinE[3]+0.6210590034081186*relKinE[2]*m0rSelf[3]+0.6324555320336759*m0rSelf[1]*relKinE[2]+0.6324555320336759*relKinE[1]*m0rSelf[2]+0.7071067811865475*m0rSelf[0]*relKinE[1]+0.7071067811865475*relKinE[0]*m0rSelf[1])*mnuSelf-1.0*uRelSq[1]*mSelf-1.0*Tdiff[1]; 
  diffOther[2] = (0.421637021355784*m0rSelf[3]*relKinE[3]+0.6210590034081186*m0rSelf[1]*relKinE[3]+0.6210590034081186*relKinE[1]*m0rSelf[3]+0.4517539514526256*m0rSelf[2]*relKinE[2]+0.7071067811865475*m0rSelf[0]*relKinE[2]+0.7071067811865475*relKinE[0]*m0rSelf[2]+0.6324555320336759*m0rSelf[1]*relKinE[1])*mnuSelf-1.0*uRelSq[2]*mSelf-1.0*Tdiff[2]; 
  diffOther[3] = (0.421637021355784*m0rSelf[2]*relKinE[3]+0.7071067811865475*m0rSelf[0]*relKinE[3]+0.421637021355784*relKinE[2]*m0rSelf[3]+0.7071067811865475*relKinE[0]*m0rSelf[3]+0.6210590034081186*m0rSelf[1]*relKinE[2]+0.6210590034081186*relKinE[1]*m0rSelf[2])*mnuSelf-1.0*uRelSq[3]*mSelf-1.0*Tdiff[3]; 
