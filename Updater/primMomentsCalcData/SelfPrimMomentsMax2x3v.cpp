...
void SelfPrimMoments2x3vMax_P1(const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  ...
  BigAEM(9,9) = 1.5*m0[0]-0.5*cE[0]; 
  BigAEM(9,10) = 1.5*m0[1]-0.5*cE[1]; 
  BigAEM(9,11) = 1.5*m0[2]-0.5*cE[2]; 
  BigAEM(10,9) = 1.5*m0[1]-0.5*cE[1]; 
  BigAEM(10,10) = 1.5*m0[0]-0.5*cE[0]; 
  BigAEM(11,9) = 1.5*m0[2]-0.5*cE[2]; 
  BigAEM(11,11) = 1.5*m0[0]-0.5*cE[0]; 
...
void SelfPrimMoments2x3vMax_P2(const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  // m0,m1,m2: moments of the distribution function. 
  // cM, cE: vtSq*cM and vtSq*cE are corrections to u and vtSq, respectively. 
  // u:        velocity. 
  ...
  // Declare Eigen matrix and vectors for weak division. 
  Eigen::MatrixXd BigAEM(24,24); 
  Eigen::VectorXd bEV(24); 
  Eigen::VectorXd xEV(24); 
  ...
  // ....... Block from correction to vtSq .......... // 
  BigAEM(18,18) = 1.5*m0[0]-0.5*cE[0]; 
  BigAEM(18,19) = 1.5*m0[1]-0.5*cE[1]; 
  BigAEM(18,20) = 1.5*m0[2]-0.5*cE[2]; 
  BigAEM(18,21) = 1.5*m0[3]-0.5*cE[3]; 
  BigAEM(18,22) = 1.5*m0[4]-0.5*cE[4]; 
  BigAEM(18,23) = 1.5*m0[5]-0.5*cE[5]; 
  BigAEM(19,18) = 1.5*m0[1]-0.5*cE[1]; 
  BigAEM(19,19) = 1.341640786499874*m0[4]-0.4472135954999579*cE[4]+1.5*m0[0]-0.5*cE[0]; 
  BigAEM(19,20) = 1.5*m0[3]-0.5*cE[3]; 
  BigAEM(19,21) = 1.5*m0[2]-0.5*cE[2]; 
  BigAEM(19,22) = 1.341640786499874*m0[1]-0.4472135954999579*cE[1]; 
  BigAEM(20,18) = 1.5*m0[2]-0.5*cE[2]; 
  BigAEM(20,19) = 1.5*m0[3]-0.5*cE[3]; 
  BigAEM(20,20) = 1.341640786499874*m0[5]-0.4472135954999579*cE[5]+1.5*m0[0]-0.5*cE[0]; 
  BigAEM(20,21) = 1.5*m0[1]-0.5*cE[1]; 
  BigAEM(20,23) = 1.341640786499874*m0[2]-0.4472135954999579*cE[2]; 
  BigAEM(21,18) = 1.5*m0[3]-0.5*cE[3]; 
  BigAEM(21,19) = 1.5*m0[2]-0.5*cE[2]; 
  BigAEM(21,20) = 1.5*m0[1]-0.5*cE[1]; 
  BigAEM(21,21) = 1.341640786499874*m0[5]-0.4472135954999579*cE[5]+1.341640786499874*m0[4]-0.4472135954999579*cE[4]+1.5*m0[0]-0.5*cE[0]; 
  BigAEM(21,22) = 1.341640786499874*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(21,23) = 1.341640786499874*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(22,18) = 1.5*m0[4]-0.5*cE[4]; 
  BigAEM(22,19) = 1.341640786499874*m0[1]-0.4472135954999579*cE[1]; 
  BigAEM(22,21) = 1.341640786499874*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(22,22) = 0.9583148474999099*m0[4]-0.31943828249997*cE[4]+1.5*m0[0]-0.5*cE[0]; 
  BigAEM(23,18) = 1.5*m0[5]-0.5*cE[5]; 
  BigAEM(23,20) = 1.341640786499874*m0[2]-0.4472135954999579*cE[2]; 
  BigAEM(23,21) = 1.341640786499874*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(23,23) = 0.9583148474999099*m0[5]-0.31943828249997*cE[5]+1.5*m0[0]-0.5*cE[0]; 
...
{ 
  ...
  out[0] += 2.449489742783178*fvmin[3]*dS+2.449489742783178*fvmax[3]*dS-1.414213562373095*fvmin[0]*dS+1.414213562373095*fvmax[0]*dS; 
  out[1] += 1.414213562373095*fvmax[1]*dS-1.414213562373095*fvmin[1]*dS; 
  out[2] += 1.414213562373095*fvmax[2]*dS-1.414213562373095*fvmin[2]*dS; 
...
{ 
  ...
  out[0] += (-3.16227766016838*fvmin[18]*dS)+3.16227766016838*fvmax[18]*dS+2.449489742783178*fvmin[3]*dS+2.449489742783178*fvmax[3]*dS-1.414213562373095*fvmin[0]*dS+1.414213562373095*fvmax[0]*dS; 
  out[1] += 2.449489742783178*fvmin[7]*dS+2.449489742783178*fvmax[7]*dS-1.414213562373095*fvmin[1]*dS+1.414213562373095*fvmax[1]*dS; 
  out[2] += 2.449489742783178*fvmin[8]*dS+2.449489742783178*fvmax[8]*dS-1.414213562373095*fvmin[2]*dS+1.414213562373095*fvmax[2]*dS; 
  out[3] += 1.414213562373095*fvmax[6]*dS-1.414213562373095*fvmin[6]*dS; 
  out[4] += 1.414213562373095*fvmax[16]*dS-1.414213562373095*fvmin[16]*dS; 
  out[5] += 1.414213562373095*fvmax[17]*dS-1.414213562373095*fvmin[17]*dS; 
...
{ 
  ...
  out[2] += 1.414213562373095*fvmin[2]*dS*vmin+1.414213562373095*fvmax[2]*dS*vmax; 
...
{ 
  ...
  out[0] += 3.16227766016838*fvmin[18]*dS*vmin-2.449489742783178*fvmin[3]*dS*vmin+1.414213562373095*fvmin[0]*dS*vmin+3.16227766016838*fvmax[18]*dS*vmax+2.449489742783178*fvmax[3]*dS*vmax+1.414213562373095*fvmax[0]*dS*vmax; 
  out[1] += (-2.449489742783178*fvmin[7]*dS*vmin)+1.414213562373095*fvmin[1]*dS*vmin+2.449489742783178*fvmax[7]*dS*vmax+1.414213562373095*fvmax[1]*dS*vmax; 
  out[2] += (-2.449489742783178*fvmin[8]*dS*vmin)+1.414213562373095*fvmin[2]*dS*vmin+2.449489742783178*fvmax[8]*dS*vmax+1.414213562373095*fvmax[2]*dS*vmax; 
  out[3] += 1.414213562373095*fvmin[6]*dS*vmin+1.414213562373095*fvmax[6]*dS*vmax; 
  out[4] += 1.414213562373095*fvmin[16]*dS*vmin+1.414213562373095*fvmax[16]*dS*vmax; 
  out[5] += 1.414213562373095*fvmin[17]*dS*vmin+1.414213562373095*fvmax[17]*dS*vmax; 
...
{ 
  ...
  out[3] += 2.449489742783178*fvmin[4]*dS+2.449489742783178*fvmax[4]*dS-1.414213562373095*fvmin[0]*dS+1.414213562373095*fvmax[0]*dS; 
  out[4] += 1.414213562373095*fvmax[1]*dS-1.414213562373095*fvmin[1]*dS; 
  out[5] += 1.414213562373095*fvmax[2]*dS-1.414213562373095*fvmin[2]*dS; 
...
{ 
  ...
  out[6] += (-3.16227766016838*fvmin[19]*dS)+3.16227766016838*fvmax[19]*dS+2.449489742783178*fvmin[4]*dS+2.449489742783178*fvmax[4]*dS-1.414213562373095*fvmin[0]*dS+1.414213562373095*fvmax[0]*dS; 
  out[7] += 2.449489742783178*fvmin[9]*dS+2.449489742783178*fvmax[9]*dS-1.414213562373095*fvmin[1]*dS+1.414213562373095*fvmax[1]*dS; 
  out[8] += 2.449489742783178*fvmin[10]*dS+2.449489742783178*fvmax[10]*dS-1.414213562373095*fvmin[2]*dS+1.414213562373095*fvmax[2]*dS; 
  out[9] += 1.414213562373095*fvmax[6]*dS-1.414213562373095*fvmin[6]*dS; 
  out[10] += 1.414213562373095*fvmax[16]*dS-1.414213562373095*fvmin[16]*dS; 
  out[11] += 1.414213562373095*fvmax[17]*dS-1.414213562373095*fvmin[17]*dS; 
...
{ 
  ...
  out[0] += 3.16227766016838*fvmin[19]*dS*vmin-2.449489742783178*fvmin[4]*dS*vmin+1.414213562373095*fvmin[0]*dS*vmin+3.16227766016838*fvmax[19]*dS*vmax+2.449489742783178*fvmax[4]*dS*vmax+1.414213562373095*fvmax[0]*dS*vmax; 
  out[1] += (-2.449489742783178*fvmin[9]*dS*vmin)+1.414213562373095*fvmin[1]*dS*vmin+2.449489742783178*fvmax[9]*dS*vmax+1.414213562373095*fvmax[1]*dS*vmax; 
  out[2] += (-2.449489742783178*fvmin[10]*dS*vmin)+1.414213562373095*fvmin[2]*dS*vmin+2.449489742783178*fvmax[10]*dS*vmax+1.414213562373095*fvmax[2]*dS*vmax; 
  out[3] += 1.414213562373095*fvmin[6]*dS*vmin+1.414213562373095*fvmax[6]*dS*vmax; 
  out[4] += 1.414213562373095*fvmin[16]*dS*vmin+1.414213562373095*fvmax[16]*dS*vmax; 
  out[5] += 1.414213562373095*fvmin[17]*dS*vmin+1.414213562373095*fvmax[17]*dS*vmax; 
...
{ 
  ...
  out[6] += 2.449489742783178*fvmin[5]*dS+2.449489742783178*fvmax[5]*dS-1.414213562373095*fvmin[0]*dS+1.414213562373095*fvmax[0]*dS; 
  out[7] += 1.414213562373095*fvmax[1]*dS-1.414213562373095*fvmin[1]*dS; 
  out[8] += 1.414213562373095*fvmax[2]*dS-1.414213562373095*fvmin[2]*dS; 
...
{ 
  ...
  out[12] += (-3.16227766016838*fvmin[20]*dS)+3.16227766016838*fvmax[20]*dS+2.449489742783178*fvmin[5]*dS+2.449489742783178*fvmax[5]*dS-1.414213562373095*fvmin[0]*dS+1.414213562373095*fvmax[0]*dS; 
  out[13] += 2.449489742783178*fvmin[12]*dS+2.449489742783178*fvmax[12]*dS-1.414213562373095*fvmin[1]*dS+1.414213562373095*fvmax[1]*dS; 
  out[14] += 2.449489742783178*fvmin[13]*dS+2.449489742783178*fvmax[13]*dS-1.414213562373095*fvmin[2]*dS+1.414213562373095*fvmax[2]*dS; 
  out[15] += 1.414213562373095*fvmax[6]*dS-1.414213562373095*fvmin[6]*dS; 
  out[16] += 1.414213562373095*fvmax[16]*dS-1.414213562373095*fvmin[16]*dS; 
  out[17] += 1.414213562373095*fvmax[17]*dS-1.414213562373095*fvmin[17]*dS; 
...
{ 
  ...
  out[0] += (-2.449489742783178*fvmin[5]*dS*vmin)+1.414213562373095*fvmin[0]*dS*vmin+2.449489742783178*fvmax[5]*dS*vmax+1.414213562373095*fvmax[0]*dS*vmax; 
  out[1] += 1.414213562373095*fvmin[1]*dS*vmin+1.414213562373095*fvmax[1]*dS*vmax; 
  out[2] += 1.414213562373095*fvmin[2]*dS*vmin+1.414213562373095*fvmax[2]*dS*vmax; 
...
{ 
  ...
  out[0] += 3.16227766016838*fvmin[20]*dS*vmin-2.449489742783178*fvmin[5]*dS*vmin+1.414213562373095*fvmin[0]*dS*vmin+3.16227766016838*fvmax[20]*dS*vmax+2.449489742783178*fvmax[5]*dS*vmax+1.414213562373095*fvmax[0]*dS*vmax; 
  out[1] += (-2.449489742783178*fvmin[12]*dS*vmin)+1.414213562373095*fvmin[1]*dS*vmin+2.449489742783178*fvmax[12]*dS*vmax+1.414213562373095*fvmax[1]*dS*vmax; 
  out[2] += (-2.449489742783178*fvmin[13]*dS*vmin)+1.414213562373095*fvmin[2]*dS*vmin+2.449489742783178*fvmax[13]*dS*vmax+1.414213562373095*fvmax[2]*dS*vmax; 
  out[3] += 1.414213562373095*fvmin[6]*dS*vmin+1.414213562373095*fvmax[6]*dS*vmax; 
  out[4] += 1.414213562373095*fvmin[16]*dS*vmin+1.414213562373095*fvmax[16]*dS*vmax; 
  out[5] += 1.414213562373095*fvmin[17]*dS*vmin+1.414213562373095*fvmax[17]*dS*vmax; 
