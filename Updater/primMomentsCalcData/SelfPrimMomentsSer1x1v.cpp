...
{ 
  ...
  BigAEM(2,2) = 0.7071067811865475*m0[0]-0.7071067811865475*cE[0]; 
  BigAEM(2,3) = 0.7071067811865475*m0[1]-0.7071067811865475*cE[1]; 
  BigAEM(3,2) = 0.7071067811865475*m0[1]-0.7071067811865475*cE[1]; 
  BigAEM(3,3) = 0.7071067811865475*m0[0]-0.7071067811865475*cE[0]; 
...
{ 
  ...
  // ....... Block from correction to vtSq .......... // 
  BigAEM(3,3) = 0.7071067811865475*m0[0]-0.7071067811865475*cE[0]; 
  BigAEM(3,4) = 0.7071067811865475*m0[1]-0.7071067811865475*cE[1]; 
  BigAEM(3,5) = 0.7071067811865475*m0[2]-0.7071067811865475*cE[2]; 
  BigAEM(4,3) = 0.7071067811865475*m0[1]-0.7071067811865475*cE[1]; 
  BigAEM(4,4) = 0.6324555320336759*m0[2]-0.6324555320336759*cE[2]+0.7071067811865475*m0[0]-0.7071067811865475*cE[0]; 
  BigAEM(4,5) = 0.6324555320336759*m0[1]-0.6324555320336759*cE[1]; 
  BigAEM(5,3) = 0.7071067811865475*m0[2]-0.7071067811865475*cE[2]; 
  BigAEM(5,4) = 0.6324555320336759*m0[1]-0.6324555320336759*cE[1]; 
  BigAEM(5,5) = 0.4517539514526256*m0[2]-0.4517539514526256*cE[2]+0.7071067811865475*m0[0]-0.7071067811865475*cE[0]; 
...
{ 
  ...
  // ....... Block from correction to vtSq .......... // 
  BigAEM(4,4) = 0.7071067811865475*m0[0]-0.7071067811865475*cE[0]; 
  BigAEM(4,5) = 0.7071067811865475*m0[1]-0.7071067811865475*cE[1]; 
  BigAEM(4,6) = 0.7071067811865475*m0[2]-0.7071067811865475*cE[2]; 
  BigAEM(4,7) = 0.7071067811865475*m0[3]-0.7071067811865475*cE[3]; 
  BigAEM(5,4) = 0.7071067811865475*m0[1]-0.7071067811865475*cE[1]; 
  BigAEM(5,5) = 0.6324555320336759*m0[2]-0.6324555320336759*cE[2]+0.7071067811865475*m0[0]-0.7071067811865475*cE[0]; 
  BigAEM(5,6) = 0.6210590034081186*m0[3]-0.6210590034081186*cE[3]+0.6324555320336759*m0[1]-0.6324555320336759*cE[1]; 
  BigAEM(5,7) = 0.6210590034081186*m0[2]-0.6210590034081186*cE[2]; 
  BigAEM(6,4) = 0.7071067811865475*m0[2]-0.7071067811865475*cE[2]; 
  BigAEM(6,5) = 0.6210590034081186*m0[3]-0.6210590034081186*cE[3]+0.6324555320336759*m0[1]-0.6324555320336759*cE[1]; 
  BigAEM(6,6) = 0.4517539514526256*m0[2]-0.4517539514526256*cE[2]+0.7071067811865475*m0[0]-0.7071067811865475*cE[0]; 
  BigAEM(6,7) = 0.421637021355784*m0[3]-0.421637021355784*cE[3]+0.6210590034081186*m0[1]-0.6210590034081186*cE[1]; 
  BigAEM(7,4) = 0.7071067811865475*m0[3]-0.7071067811865475*cE[3]; 
  BigAEM(7,5) = 0.6210590034081186*m0[2]-0.6210590034081186*cE[2]; 
  BigAEM(7,6) = 0.421637021355784*m0[3]-0.421637021355784*cE[3]+0.6210590034081186*m0[1]-0.6210590034081186*cE[1]; 
  BigAEM(7,7) = 0.421637021355784*m0[2]-0.421637021355784*cE[2]+0.7071067811865475*m0[0]-0.7071067811865475*cE[0]; 
