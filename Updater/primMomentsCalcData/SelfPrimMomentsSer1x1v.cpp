...
void SelfPrimMoments1x1vSer_P1(const int pVdim, const double *m0, const double *m1, const double *m2, const double *m0S, const double *m1S, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
...
void SelfPrimMoments1x1vSer_P2(const int pVdim, const double *m0, const double *m1, const double *m2, const double *m0S, const double *m1S, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  // m0,m1,m2: moments of the distribution function. 
  // m0S,m1S:  star moments (only used for piecewise linear). 
  // cM, cE:   vtSq*cM and vtSq*cE are corrections to u and vtSq, respectively. 
...
void SelfPrimMoments1x1vSer_P3(const int pVdim, const double *m0, const double *m1, const double *m2, const double *m0S, const double *m1S, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  // m0,m1,m2: moments of the distribution function. 
  // m0S,m1S:  star moments (only used for piecewise linear). 
  // cM, cE:   vtSq*cM and vtSq*cE are corrections to u and vtSq, respectively. 
...
{ 
  ...
  out[1] += (1.870828693386971*fvmin[11]+1.870828693386971*fvmax[11]-1.58113883008419*fvmin[7]+1.58113883008419*fvmax[7]+1.224744871391589*fvmin[3]+1.224744871391589*fvmax[3]-0.7071067811865475*fvmin[1]+0.7071067811865475*fvmax[1])*dS; 
  out[2] += (1.224744871391589*fvmin[6]+1.224744871391589*fvmax[6]-0.7071067811865475*fvmin[4]+0.7071067811865475*fvmax[4])*dS; 
  out[3] += (1.224744871391589*fvmin[10]+1.224744871391589*fvmax[10]-0.7071067811865475*fvmin[8]+0.7071067811865475*fvmax[8])*dS; 
...
{ 
  ...
  out[1] += dS*(1.224744871391589*fvmin[3]*vmin-0.7071067811865475*fvmin[1]*vmin+1.224744871391589*fvmax[3]*vmax+0.7071067811865475*fvmax[1]*vmax+0.6123724356957944*dxv[1]*fvmin[3]-0.6123724356957944*dxv[1]*fvmax[3]-0.3535533905932737*dxv[1]*fvmin[1]-0.3535533905932737*dxv[1]*fvmax[1]); 
...
{ 
  ...
  out[1] += dS*(1.870828693386971*fvmin[11]*vmin-1.58113883008419*fvmin[7]*vmin+1.224744871391589*fvmin[3]*vmin-0.7071067811865475*fvmin[1]*vmin+1.870828693386971*fvmax[11]*vmax+1.58113883008419*fvmax[7]*vmax+1.224744871391589*fvmax[3]*vmax+0.7071067811865475*fvmax[1]*vmax); 
  out[2] += dS*(1.224744871391589*fvmin[6]*vmin-0.7071067811865475*fvmin[4]*vmin+1.224744871391589*fvmax[6]*vmax+0.7071067811865475*fvmax[4]*vmax); 
  out[3] += dS*(1.224744871391589*fvmin[10]*vmin-0.7071067811865475*fvmin[8]*vmin+1.224744871391589*fvmax[10]*vmax+0.7071067811865475*fvmax[8]*vmax); 
