...
{ 
  ...
  data->AEM_S(0,9) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(0,10) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(0,11) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(1,9) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(1,10) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(2,9) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(2,11) = -0.5*cMrSelf[0]*mnuSelf; 
  ...
  data->AEM_S(0,21) = -0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(0,22) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(0,23) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(1,21) = -0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(1,22) = -0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(2,21) = -0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(2,23) = -0.5*cMrOther[0]*mnuOther; 
  ...
  // ... Block from correction to momentum conservation (self) ... // 
  data->AEM_S(3,9) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(3,10) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(3,11) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(4,9) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(4,10) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(5,9) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(5,11) = -0.5*cMrSelf[3]*mnuSelf; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(3,21) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(3,22) = -0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(3,23) = -0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(4,21) = -0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(4,22) = -0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(5,21) = -0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(5,23) = -0.5*cMrOther[3]*mnuOther; 
  ...
  // ... Block from correction to momentum conservation (self) ... // 
  data->AEM_S(6,9) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(6,10) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(6,11) = -0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(7,9) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(7,10) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(8,9) = -0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(8,11) = -0.5*cMrSelf[6]*mnuSelf; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(6,21) = -0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(6,22) = -0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(6,23) = -0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(7,21) = -0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(7,22) = -0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(8,21) = -0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(8,23) = -0.5*cMrOther[6]*mnuOther; 
  ...
  data->AEM_S(9,10) = 0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(9,11) = 0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(10,9) = 0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  ...
  data->AEM_S(9,22) = 0.5*m0SrOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  data->AEM_S(9,23) = 0.5*m0SrOther[2]*mnuOther-0.5*cErOther[2]*mnuOther; 
  data->AEM_S(10,21) = 0.5*m0SrOther[1]*mnuOther-0.5*cErOther[1]*mnuOther; 
  ...
  data->AEM_S(12,9) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(12,10) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(12,11) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(13,9) = -0.5*cMrSelf[1]*mnuSelf; 
  data->AEM_S(13,10) = -0.5*cMrSelf[0]*mnuSelf; 
  data->AEM_S(14,9) = -0.5*cMrSelf[2]*mnuSelf; 
  data->AEM_S(14,11) = -0.5*cMrSelf[0]*mnuSelf; 
  ...
  data->AEM_S(12,21) = 0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(12,22) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(12,23) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(13,21) = 0.5*cMrOther[1]*mnuOther; 
  data->AEM_S(13,22) = 0.5*cMrOther[0]*mnuOther; 
  data->AEM_S(14,21) = 0.5*cMrOther[2]*mnuOther; 
  data->AEM_S(14,23) = 0.5*cMrOther[0]*mnuOther; 
  ...
  // ... Block from correction to (self) 1st moment of collision operator ... // 
  data->AEM_S(15,9) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(15,10) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(15,11) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(16,9) = -0.5*cMrSelf[4]*mnuSelf; 
  data->AEM_S(16,10) = -0.5*cMrSelf[3]*mnuSelf; 
  data->AEM_S(17,9) = -0.5*cMrSelf[5]*mnuSelf; 
  data->AEM_S(17,11) = -0.5*cMrSelf[3]*mnuSelf; 
  ...
  // ... Block from correction to (other) 1st moment of collision operator ... // 
  data->AEM_S(15,21) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(15,22) = 0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(15,23) = 0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(16,21) = 0.5*cMrOther[4]*mnuOther; 
  data->AEM_S(16,22) = 0.5*cMrOther[3]*mnuOther; 
  data->AEM_S(17,21) = 0.5*cMrOther[5]*mnuOther; 
  data->AEM_S(17,23) = 0.5*cMrOther[3]*mnuOther; 
  ...
  // ... Block from correction to (self) 1st moment of collision operator ... // 
  data->AEM_S(18,9) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(18,10) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(18,11) = -0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(19,9) = -0.5*cMrSelf[7]*mnuSelf; 
  data->AEM_S(19,10) = -0.5*cMrSelf[6]*mnuSelf; 
  data->AEM_S(20,9) = -0.5*cMrSelf[8]*mnuSelf; 
  data->AEM_S(20,11) = -0.5*cMrSelf[6]*mnuSelf; 
  ...
  // ... Block from correction to (other) 1st moment of collision operator ... // 
  data->AEM_S(18,21) = 0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(18,22) = 0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(18,23) = 0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(19,21) = 0.5*cMrOther[7]*mnuOther; 
  data->AEM_S(19,22) = 0.5*cMrOther[6]*mnuOther; 
  data->AEM_S(20,21) = 0.5*cMrOther[8]*mnuOther; 
  data->AEM_S(20,23) = 0.5*cMrOther[6]*mnuOther; 
  ...
  // Compute m0Other*m1Self-m0Self*m1Other. 
  m1EffD[6] = 0.5*m0rOther[2]*m1rSelf[8]-0.5*m0rSelf[2]*m1rOther[8]+0.5*m0rOther[1]*m1rSelf[7]-0.5*m0rSelf[1]*m1rOther[7]+0.5*m0rOther[0]*m1rSelf[6]-0.5*m0rSelf[0]*m1rOther[6]; 
  m1EffD[7] = 0.5*m0rOther[0]*m1rSelf[7]-0.5*m0rSelf[0]*m1rOther[7]+0.5*m0rOther[1]*m1rSelf[6]-0.5*m0rSelf[1]*m1rOther[6]; 
  m1EffD[8] = 0.5*m0rOther[0]*m1rSelf[8]-0.5*m0rSelf[0]*m1rOther[8]+0.5*m0rOther[2]*m1rSelf[6]-0.5*m0rSelf[2]*m1rOther[6]; 
  // Fill BEV. 
  ...
  data->AEM_S(21,10) = 0.5*ucMSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  data->AEM_S(21,11) = 0.5*ucMSelf[2]*mnuSelf+0.5*m0SrSelf[2]*mnuSelf-0.5*cErSelf[2]*mnuSelf; 
  data->AEM_S(22,9) = 0.5*ucMSelf[1]*mnuSelf+0.5*m0SrSelf[1]*mnuSelf-0.5*cErSelf[1]*mnuSelf; 
  ...
  data->AEM_S(21,22) = (-0.5*ucMOther[1]*mnuOther)-0.5*m0SrOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
  data->AEM_S(21,23) = (-0.5*ucMOther[2]*mnuOther)-0.5*m0SrOther[2]*mnuOther+0.5*cErOther[2]*mnuOther; 
  data->AEM_S(22,21) = (-0.5*ucMOther[1]*mnuOther)-0.5*m0SrOther[1]*mnuOther+0.5*cErOther[1]*mnuOther; 
