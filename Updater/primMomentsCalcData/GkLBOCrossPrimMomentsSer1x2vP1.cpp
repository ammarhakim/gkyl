...
{ 
  ...
  data->AEM_S(6,2) = mSelf; 
  data->AEM_S(7,3) = mSelf; 
 
  // ... Equality block from mOther*vtSqCrossOther ... // 
  data->AEM_S(6,6) = -1.0*mOther; 
  data->AEM_S(7,7) = -1.0*mOther; 
 
  // ... Contribution to RHS vector from mSelf*vtSqCrossSelf = mOther*vtSqCrossOther. 
 
  // ....... RHS vector is composed of m1 and m2 .......... // 
  data->BEV_S << mnuM1sum[0],mnuM1sum[1],mnuM2sum[0],mnuM2sum[1],0,0,0,0; 
