...
{ 
  ...
  BigAEM(4,5) = m0r[1]+0.5*m0Sr[1]-0.5*cE[1]; 
  BigAEM(4,6) = m0r[2]+0.5*m0Sr[2]-0.5*cE[2]; 
  BigAEM(4,7) = m0r[3]+0.5*m0Sr[3]-0.5*cE[3]; 
  BigAEM(5,4) = m0r[1]+0.5*m0Sr[1]-0.5*cE[1]; 
  BigAEM(5,5) = m0r[0]+0.5*m0Sr[0]-0.5*cE[0]; 
  BigAEM(5,6) = m0r[3]+0.5*m0Sr[3]-0.5*cE[3]; 
  BigAEM(5,7) = m0r[2]+0.5*m0Sr[2]-0.5*cE[2]; 
  BigAEM(6,4) = m0r[2]+0.5*m0Sr[2]-0.5*cE[2]; 
  BigAEM(6,5) = m0r[3]+0.5*m0Sr[3]-0.5*cE[3]; 
  BigAEM(6,6) = m0r[0]+0.5*m0Sr[0]-0.5*cE[0]; 
  BigAEM(6,7) = m0r[1]+0.5*m0Sr[1]-0.5*cE[1]; 
  BigAEM(7,4) = m0r[3]+0.5*m0Sr[3]-0.5*cE[3]; 
  BigAEM(7,5) = m0r[2]+0.5*m0Sr[2]-0.5*cE[2]; 
  BigAEM(7,6) = m0r[1]+0.5*m0Sr[1]-0.5*cE[1]; 
  BigAEM(7,7) = m0r[0]+0.5*m0Sr[0]-0.5*cE[0]; 
