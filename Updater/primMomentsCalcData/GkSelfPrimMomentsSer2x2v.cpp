...
{ 
  ...
  data->AEM_S(4,5) = 1.5*m0r[1]-0.5*cEr[1]; 
  data->AEM_S(4,6) = 1.5*m0r[2]-0.5*cEr[2]; 
  data->AEM_S(4,7) = 1.5*m0r[3]-0.5*cEr[3]; 
  data->AEM_S(5,4) = 1.5*m0r[1]-0.5*cEr[1]; 
  data->AEM_S(5,5) = 1.5*m0r[0]-0.5*cEr[0]; 
  data->AEM_S(5,6) = 1.5*m0r[3]-0.5*cEr[3]; 
  data->AEM_S(5,7) = 1.5*m0r[2]-0.5*cEr[2]; 
  data->AEM_S(6,4) = 1.5*m0r[2]-0.5*cEr[2]; 
  data->AEM_S(6,5) = 1.5*m0r[3]-0.5*cEr[3]; 
  data->AEM_S(6,6) = 1.5*m0r[0]-0.5*cEr[0]; 
  data->AEM_S(6,7) = 1.5*m0r[1]-0.5*cEr[1]; 
  data->AEM_S(7,4) = 1.5*m0r[3]-0.5*cEr[3]; 
  data->AEM_S(7,5) = 1.5*m0r[2]-0.5*cEr[2]; 
  data->AEM_S(7,6) = 1.5*m0r[1]-0.5*cEr[1]; 
  data->AEM_S(7,7) = 1.5*m0r[0]-0.5*cEr[0]; 
