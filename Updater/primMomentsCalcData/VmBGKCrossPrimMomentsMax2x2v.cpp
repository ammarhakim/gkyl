...
{ 
  ...
  { 
    unsigned short int a0 = 3*vd; 
    // Contribution to dot-product from weak multiplication of vd component. 
    relKinE[0] += 0.25*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mSelf-0.25*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mSelf-0.25*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mOther-0.25*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mOther+0.25*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mOther-0.25*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0]*betaGreenep1*mOther; 
    relKinE[1] += 0.25*uRelDmnu[a0]*uSelf[a0+1]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+1]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+1]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+1]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+1]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+1]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+1]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+1]*betaGreenep1*mOther; 
    relKinE[2] += 0.25*uRelDmnu[a0]*uSelf[a0+2]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+2]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+2]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+2]*betaGreenep1*mOther; 
  } 
...
{ 
  ...
  { 
    unsigned short int a0 = 6*vd; 
    // Contribution to dot-product from weak multiplication of vd component. 
    relKinE[0] += 0.25*uRelDmnu[a0+5]*uSelf[a0+5]*betaGreenep1*mSelf-0.25*uOther[a0+5]*uRelDmnu[a0+5]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+4]*uSelf[a0+4]*betaGreenep1*mSelf-0.25*uOther[a0+4]*uRelDmnu[a0+4]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mSelf-0.25*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mSelf-0.25*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mSelf-0.25*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+5]*uSelf[a0+5]*betaGreenep1*mOther-0.25*uOther[a0+5]*uRelDmnu[a0+5]*betaGreenep1*mOther+0.25*uRelDmnu[a0+4]*uSelf[a0+4]*betaGreenep1*mOther-0.25*uOther[a0+4]*uRelDmnu[a0+4]*betaGreenep1*mOther+0.25*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mOther-0.25*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mOther+0.25*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mOther-0.25*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mOther+0.25*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mOther-0.25*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0]*betaGreenep1*mOther; 
    relKinE[1] += 0.223606797749979*uRelDmnu[a0+1]*uSelf[a0+4]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+1]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+1]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+1]*uOther[a0+4]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+2]*uSelf[a0+3]*betaGreenep1*mSelf+0.25*uSelf[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.25*uOther[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.25*uRelDmnu[a0+2]*uOther[a0+3]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+1]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+1]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+1]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+1]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+1]*uSelf[a0+4]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+1]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.223606797749979*uOther[a0+1]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+1]*uOther[a0+4]*betaGreenep1*mOther+0.25*uRelDmnu[a0+2]*uSelf[a0+3]*betaGreenep1*mOther+0.25*uSelf[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.25*uOther[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.25*uRelDmnu[a0+2]*uOther[a0+3]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+1]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+1]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+1]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+1]*betaGreenep1*mOther; 
    relKinE[2] += 0.223606797749979*uRelDmnu[a0+2]*uSelf[a0+5]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+2]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+2]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+2]*uOther[a0+5]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+1]*uSelf[a0+3]*betaGreenep1*mSelf+0.25*uSelf[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.25*uOther[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.25*uRelDmnu[a0+1]*uOther[a0+3]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+2]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+2]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+2]*uSelf[a0+5]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+2]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.223606797749979*uOther[a0+2]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+2]*uOther[a0+5]*betaGreenep1*mOther+0.25*uRelDmnu[a0+1]*uSelf[a0+3]*betaGreenep1*mOther+0.25*uSelf[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.25*uOther[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.25*uRelDmnu[a0+1]*uOther[a0+3]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+2]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+2]*betaGreenep1*mOther; 
    relKinE[3] += 0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+5]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+3]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+3]*uOther[a0+5]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+4]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+3]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+3]*uOther[a0+4]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+3]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+3]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+1]*uSelf[a0+2]*betaGreenep1*mSelf+0.25*uSelf[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.25*uOther[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.25*uRelDmnu[a0+1]*uOther[a0+2]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+5]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+3]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+3]*uOther[a0+5]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+4]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+3]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+3]*uOther[a0+4]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+3]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+3]*betaGreenep1*mOther+0.25*uRelDmnu[a0+1]*uSelf[a0+2]*betaGreenep1*mOther+0.25*uSelf[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.25*uOther[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.25*uRelDmnu[a0+1]*uOther[a0+2]*betaGreenep1*mOther; 
    relKinE[4] += 0.159719141249985*uRelDmnu[a0+4]*uSelf[a0+4]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+4]*betaGreenep1*mSelf-0.159719141249985*uOther[a0+4]*uRelDmnu[a0+4]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+4]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mSelf+0.159719141249985*uRelDmnu[a0+4]*uSelf[a0+4]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+4]*betaGreenep1*mOther-0.159719141249985*uOther[a0+4]*uRelDmnu[a0+4]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+4]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mOther-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mOther-0.223606797749979*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mOther; 
    relKinE[5] += 0.159719141249985*uRelDmnu[a0+5]*uSelf[a0+5]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+5]*betaGreenep1*mSelf-0.159719141249985*uOther[a0+5]*uRelDmnu[a0+5]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+5]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mSelf+0.159719141249985*uRelDmnu[a0+5]*uSelf[a0+5]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+5]*betaGreenep1*mOther-0.159719141249985*uOther[a0+5]*uRelDmnu[a0+5]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+5]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mOther-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mOther-0.223606797749979*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mOther; 
  } 
...
{ 
  ...
  { 
    unsigned short int a0 = 10*vd; 
    // Contribution to dot-product from weak multiplication of vd component. 
    relKinE[0] += 0.25*uRelDmnu[a0+9]*uSelf[a0+9]*betaGreenep1*mSelf-0.25*uOther[a0+9]*uRelDmnu[a0+9]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+8]*uSelf[a0+8]*betaGreenep1*mSelf-0.25*uOther[a0+8]*uRelDmnu[a0+8]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+7]*uSelf[a0+7]*betaGreenep1*mSelf-0.25*uOther[a0+7]*uRelDmnu[a0+7]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+6]*uSelf[a0+6]*betaGreenep1*mSelf-0.25*uOther[a0+6]*uRelDmnu[a0+6]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+5]*uSelf[a0+5]*betaGreenep1*mSelf-0.25*uOther[a0+5]*uRelDmnu[a0+5]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+4]*uSelf[a0+4]*betaGreenep1*mSelf-0.25*uOther[a0+4]*uRelDmnu[a0+4]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mSelf-0.25*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mSelf-0.25*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mSelf-0.25*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+9]*uSelf[a0+9]*betaGreenep1*mOther-0.25*uOther[a0+9]*uRelDmnu[a0+9]*betaGreenep1*mOther+0.25*uRelDmnu[a0+8]*uSelf[a0+8]*betaGreenep1*mOther-0.25*uOther[a0+8]*uRelDmnu[a0+8]*betaGreenep1*mOther+0.25*uRelDmnu[a0+7]*uSelf[a0+7]*betaGreenep1*mOther-0.25*uOther[a0+7]*uRelDmnu[a0+7]*betaGreenep1*mOther+0.25*uRelDmnu[a0+6]*uSelf[a0+6]*betaGreenep1*mOther-0.25*uOther[a0+6]*uRelDmnu[a0+6]*betaGreenep1*mOther+0.25*uRelDmnu[a0+5]*uSelf[a0+5]*betaGreenep1*mOther-0.25*uOther[a0+5]*uRelDmnu[a0+5]*betaGreenep1*mOther+0.25*uRelDmnu[a0+4]*uSelf[a0+4]*betaGreenep1*mOther-0.25*uOther[a0+4]*uRelDmnu[a0+4]*betaGreenep1*mOther+0.25*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mOther-0.25*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mOther+0.25*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mOther-0.25*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mOther+0.25*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mOther-0.25*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0]*betaGreenep1*mOther; 
    relKinE[1] += 0.21957751641342*uRelDmnu[a0+4]*uSelf[a0+8]*betaGreenep1*mSelf+0.21957751641342*uSelf[a0+4]*uRelDmnu[a0+8]*betaGreenep1*mSelf-0.21957751641342*uOther[a0+4]*uRelDmnu[a0+8]*betaGreenep1*mSelf-0.21957751641342*uRelDmnu[a0+4]*uOther[a0+8]*betaGreenep1*mSelf+0.2500000000000001*uRelDmnu[a0+5]*uSelf[a0+7]*betaGreenep1*mSelf+0.2500000000000001*uSelf[a0+5]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.2500000000000001*uOther[a0+5]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.2500000000000001*uRelDmnu[a0+5]*uOther[a0+7]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+6]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+3]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+3]*uOther[a0+6]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+1]*uSelf[a0+4]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+1]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+1]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+1]*uOther[a0+4]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+2]*uSelf[a0+3]*betaGreenep1*mSelf+0.25*uSelf[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.25*uOther[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.25*uRelDmnu[a0+2]*uOther[a0+3]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+1]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+1]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+1]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+1]*betaGreenep1*mSelf+0.21957751641342*uRelDmnu[a0+4]*uSelf[a0+8]*betaGreenep1*mOther+0.21957751641342*uSelf[a0+4]*uRelDmnu[a0+8]*betaGreenep1*mOther-0.21957751641342*uOther[a0+4]*uRelDmnu[a0+8]*betaGreenep1*mOther-0.21957751641342*uRelDmnu[a0+4]*uOther[a0+8]*betaGreenep1*mOther+0.2500000000000001*uRelDmnu[a0+5]*uSelf[a0+7]*betaGreenep1*mOther+0.2500000000000001*uSelf[a0+5]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.2500000000000001*uOther[a0+5]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.2500000000000001*uRelDmnu[a0+5]*uOther[a0+7]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+6]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+3]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+3]*uOther[a0+6]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+1]*uSelf[a0+4]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+1]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.223606797749979*uOther[a0+1]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+1]*uOther[a0+4]*betaGreenep1*mOther+0.25*uRelDmnu[a0+2]*uSelf[a0+3]*betaGreenep1*mOther+0.25*uSelf[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.25*uOther[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.25*uRelDmnu[a0+2]*uOther[a0+3]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+1]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+1]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+1]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+1]*betaGreenep1*mOther; 
    relKinE[2] += 0.21957751641342*uRelDmnu[a0+5]*uSelf[a0+9]*betaGreenep1*mSelf+0.21957751641342*uSelf[a0+5]*uRelDmnu[a0+9]*betaGreenep1*mSelf-0.21957751641342*uOther[a0+5]*uRelDmnu[a0+9]*betaGreenep1*mSelf-0.21957751641342*uRelDmnu[a0+5]*uOther[a0+9]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+7]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+3]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+3]*uOther[a0+7]*betaGreenep1*mSelf+0.2500000000000001*uRelDmnu[a0+4]*uSelf[a0+6]*betaGreenep1*mSelf+0.2500000000000001*uSelf[a0+4]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.2500000000000001*uOther[a0+4]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.2500000000000001*uRelDmnu[a0+4]*uOther[a0+6]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+2]*uSelf[a0+5]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+2]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+2]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+2]*uOther[a0+5]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+1]*uSelf[a0+3]*betaGreenep1*mSelf+0.25*uSelf[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.25*uOther[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.25*uRelDmnu[a0+1]*uOther[a0+3]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+2]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+2]*betaGreenep1*mSelf+0.21957751641342*uRelDmnu[a0+5]*uSelf[a0+9]*betaGreenep1*mOther+0.21957751641342*uSelf[a0+5]*uRelDmnu[a0+9]*betaGreenep1*mOther-0.21957751641342*uOther[a0+5]*uRelDmnu[a0+9]*betaGreenep1*mOther-0.21957751641342*uRelDmnu[a0+5]*uOther[a0+9]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+7]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+3]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+3]*uOther[a0+7]*betaGreenep1*mOther+0.2500000000000001*uRelDmnu[a0+4]*uSelf[a0+6]*betaGreenep1*mOther+0.2500000000000001*uSelf[a0+4]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.2500000000000001*uOther[a0+4]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.2500000000000001*uRelDmnu[a0+4]*uOther[a0+6]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+2]*uSelf[a0+5]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+2]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.223606797749979*uOther[a0+2]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+2]*uOther[a0+5]*betaGreenep1*mOther+0.25*uRelDmnu[a0+1]*uSelf[a0+3]*betaGreenep1*mOther+0.25*uSelf[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.25*uOther[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.25*uRelDmnu[a0+1]*uOther[a0+3]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+2]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+2]*betaGreenep1*mOther; 
    relKinE[3] += 0.21957751641342*uRelDmnu[a0+7]*uSelf[a0+9]*betaGreenep1*mSelf+0.21957751641342*uSelf[a0+7]*uRelDmnu[a0+9]*betaGreenep1*mSelf-0.21957751641342*uOther[a0+7]*uRelDmnu[a0+9]*betaGreenep1*mSelf-0.21957751641342*uRelDmnu[a0+7]*uOther[a0+9]*betaGreenep1*mSelf+0.21957751641342*uRelDmnu[a0+6]*uSelf[a0+8]*betaGreenep1*mSelf+0.21957751641342*uSelf[a0+6]*uRelDmnu[a0+8]*betaGreenep1*mSelf-0.21957751641342*uOther[a0+6]*uRelDmnu[a0+8]*betaGreenep1*mSelf-0.21957751641342*uRelDmnu[a0+6]*uOther[a0+8]*betaGreenep1*mSelf+0.2*uRelDmnu[a0+6]*uSelf[a0+7]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+2]*uSelf[a0+7]*betaGreenep1*mSelf+0.2*uSelf[a0+6]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.2*uOther[a0+6]*uRelDmnu[a0+7]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+2]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+2]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.2*uRelDmnu[a0+6]*uOther[a0+7]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+2]*uOther[a0+7]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+1]*uSelf[a0+6]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+1]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+1]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+1]*uOther[a0+6]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+5]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+3]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+3]*uOther[a0+5]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+4]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+3]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+3]*uOther[a0+4]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+3]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+3]*betaGreenep1*mSelf+0.25*uRelDmnu[a0+1]*uSelf[a0+2]*betaGreenep1*mSelf+0.25*uSelf[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.25*uOther[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mSelf-0.25*uRelDmnu[a0+1]*uOther[a0+2]*betaGreenep1*mSelf+0.21957751641342*uRelDmnu[a0+7]*uSelf[a0+9]*betaGreenep1*mOther+0.21957751641342*uSelf[a0+7]*uRelDmnu[a0+9]*betaGreenep1*mOther-0.21957751641342*uOther[a0+7]*uRelDmnu[a0+9]*betaGreenep1*mOther-0.21957751641342*uRelDmnu[a0+7]*uOther[a0+9]*betaGreenep1*mOther+0.21957751641342*uRelDmnu[a0+6]*uSelf[a0+8]*betaGreenep1*mOther+0.21957751641342*uSelf[a0+6]*uRelDmnu[a0+8]*betaGreenep1*mOther-0.21957751641342*uOther[a0+6]*uRelDmnu[a0+8]*betaGreenep1*mOther-0.21957751641342*uRelDmnu[a0+6]*uOther[a0+8]*betaGreenep1*mOther+0.2*uRelDmnu[a0+6]*uSelf[a0+7]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+2]*uSelf[a0+7]*betaGreenep1*mOther+0.2*uSelf[a0+6]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.2*uOther[a0+6]*uRelDmnu[a0+7]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+2]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.223606797749979*uOther[a0+2]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.2*uRelDmnu[a0+6]*uOther[a0+7]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+2]*uOther[a0+7]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+1]*uSelf[a0+6]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+1]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.223606797749979*uOther[a0+1]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+1]*uOther[a0+6]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+5]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+3]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+3]*uOther[a0+5]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+4]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+3]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+3]*uOther[a0+4]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+3]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+3]*betaGreenep1*mOther+0.25*uRelDmnu[a0+1]*uSelf[a0+2]*betaGreenep1*mOther+0.25*uSelf[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.25*uOther[a0+1]*uRelDmnu[a0+2]*betaGreenep1*mOther-0.25*uRelDmnu[a0+1]*uOther[a0+2]*betaGreenep1*mOther; 
    relKinE[4] += 0.149071198499986*uRelDmnu[a0+8]*uSelf[a0+8]*betaGreenep1*mSelf+0.21957751641342*uRelDmnu[a0+1]*uSelf[a0+8]*betaGreenep1*mSelf-0.149071198499986*uOther[a0+8]*uRelDmnu[a0+8]*betaGreenep1*mSelf+0.21957751641342*uSelf[a0+1]*uRelDmnu[a0+8]*betaGreenep1*mSelf-0.21957751641342*uOther[a0+1]*uRelDmnu[a0+8]*betaGreenep1*mSelf-0.21957751641342*uRelDmnu[a0+1]*uOther[a0+8]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+7]*uSelf[a0+7]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+7]*uRelDmnu[a0+7]*betaGreenep1*mSelf+0.159719141249985*uRelDmnu[a0+6]*uSelf[a0+6]*betaGreenep1*mSelf+0.2500000000000001*uRelDmnu[a0+2]*uSelf[a0+6]*betaGreenep1*mSelf-0.159719141249985*uOther[a0+6]*uRelDmnu[a0+6]*betaGreenep1*mSelf+0.2500000000000001*uSelf[a0+2]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.2500000000000001*uOther[a0+2]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.2500000000000001*uRelDmnu[a0+2]*uOther[a0+6]*betaGreenep1*mSelf+0.159719141249985*uRelDmnu[a0+4]*uSelf[a0+4]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+4]*betaGreenep1*mSelf-0.159719141249985*uOther[a0+4]*uRelDmnu[a0+4]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+4]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mSelf+0.149071198499986*uRelDmnu[a0+8]*uSelf[a0+8]*betaGreenep1*mOther+0.21957751641342*uRelDmnu[a0+1]*uSelf[a0+8]*betaGreenep1*mOther-0.149071198499986*uOther[a0+8]*uRelDmnu[a0+8]*betaGreenep1*mOther+0.21957751641342*uSelf[a0+1]*uRelDmnu[a0+8]*betaGreenep1*mOther-0.21957751641342*uOther[a0+1]*uRelDmnu[a0+8]*betaGreenep1*mOther-0.21957751641342*uRelDmnu[a0+1]*uOther[a0+8]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+7]*uSelf[a0+7]*betaGreenep1*mOther-0.223606797749979*uOther[a0+7]*uRelDmnu[a0+7]*betaGreenep1*mOther+0.159719141249985*uRelDmnu[a0+6]*uSelf[a0+6]*betaGreenep1*mOther+0.2500000000000001*uRelDmnu[a0+2]*uSelf[a0+6]*betaGreenep1*mOther-0.159719141249985*uOther[a0+6]*uRelDmnu[a0+6]*betaGreenep1*mOther+0.2500000000000001*uSelf[a0+2]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.2500000000000001*uOther[a0+2]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.2500000000000001*uRelDmnu[a0+2]*uOther[a0+6]*betaGreenep1*mOther+0.159719141249985*uRelDmnu[a0+4]*uSelf[a0+4]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+4]*betaGreenep1*mOther-0.159719141249985*uOther[a0+4]*uRelDmnu[a0+4]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+4]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mOther-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+1]*uSelf[a0+1]*betaGreenep1*mOther-0.223606797749979*uOther[a0+1]*uRelDmnu[a0+1]*betaGreenep1*mOther; 
    relKinE[5] += 0.149071198499986*uRelDmnu[a0+9]*uSelf[a0+9]*betaGreenep1*mSelf+0.21957751641342*uRelDmnu[a0+2]*uSelf[a0+9]*betaGreenep1*mSelf-0.149071198499986*uOther[a0+9]*uRelDmnu[a0+9]*betaGreenep1*mSelf+0.21957751641342*uSelf[a0+2]*uRelDmnu[a0+9]*betaGreenep1*mSelf-0.21957751641342*uOther[a0+2]*uRelDmnu[a0+9]*betaGreenep1*mSelf-0.21957751641342*uRelDmnu[a0+2]*uOther[a0+9]*betaGreenep1*mSelf+0.159719141249985*uRelDmnu[a0+7]*uSelf[a0+7]*betaGreenep1*mSelf+0.2500000000000001*uRelDmnu[a0+1]*uSelf[a0+7]*betaGreenep1*mSelf-0.159719141249985*uOther[a0+7]*uRelDmnu[a0+7]*betaGreenep1*mSelf+0.2500000000000001*uSelf[a0+1]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.2500000000000001*uOther[a0+1]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.2500000000000001*uRelDmnu[a0+1]*uOther[a0+7]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+6]*uSelf[a0+6]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+6]*uRelDmnu[a0+6]*betaGreenep1*mSelf+0.159719141249985*uRelDmnu[a0+5]*uSelf[a0+5]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+5]*betaGreenep1*mSelf-0.159719141249985*uOther[a0+5]*uRelDmnu[a0+5]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+5]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mSelf+0.149071198499986*uRelDmnu[a0+9]*uSelf[a0+9]*betaGreenep1*mOther+0.21957751641342*uRelDmnu[a0+2]*uSelf[a0+9]*betaGreenep1*mOther-0.149071198499986*uOther[a0+9]*uRelDmnu[a0+9]*betaGreenep1*mOther+0.21957751641342*uSelf[a0+2]*uRelDmnu[a0+9]*betaGreenep1*mOther-0.21957751641342*uOther[a0+2]*uRelDmnu[a0+9]*betaGreenep1*mOther-0.21957751641342*uRelDmnu[a0+2]*uOther[a0+9]*betaGreenep1*mOther+0.159719141249985*uRelDmnu[a0+7]*uSelf[a0+7]*betaGreenep1*mOther+0.2500000000000001*uRelDmnu[a0+1]*uSelf[a0+7]*betaGreenep1*mOther-0.159719141249985*uOther[a0+7]*uRelDmnu[a0+7]*betaGreenep1*mOther+0.2500000000000001*uSelf[a0+1]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.2500000000000001*uOther[a0+1]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.2500000000000001*uRelDmnu[a0+1]*uOther[a0+7]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+6]*uSelf[a0+6]*betaGreenep1*mOther-0.223606797749979*uOther[a0+6]*uRelDmnu[a0+6]*betaGreenep1*mOther+0.159719141249985*uRelDmnu[a0+5]*uSelf[a0+5]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+5]*betaGreenep1*mOther-0.159719141249985*uOther[a0+5]*uRelDmnu[a0+5]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+5]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+3]*uSelf[a0+3]*betaGreenep1*mOther-0.223606797749979*uOther[a0+3]*uRelDmnu[a0+3]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+2]*uSelf[a0+2]*betaGreenep1*mOther-0.223606797749979*uOther[a0+2]*uRelDmnu[a0+2]*betaGreenep1*mOther; 
    relKinE[6] += 0.21957751641342*uRelDmnu[a0+3]*uSelf[a0+8]*betaGreenep1*mSelf+0.21957751641342*uSelf[a0+3]*uRelDmnu[a0+8]*betaGreenep1*mSelf-0.21957751641342*uOther[a0+3]*uRelDmnu[a0+8]*betaGreenep1*mSelf-0.21957751641342*uRelDmnu[a0+3]*uOther[a0+8]*betaGreenep1*mSelf+0.2*uRelDmnu[a0+3]*uSelf[a0+7]*betaGreenep1*mSelf+0.2*uSelf[a0+3]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.2*uOther[a0+3]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.2*uRelDmnu[a0+3]*uOther[a0+7]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+5]*uSelf[a0+6]*betaGreenep1*mSelf+0.159719141249985*uRelDmnu[a0+4]*uSelf[a0+6]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+6]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+5]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+5]*uRelDmnu[a0+6]*betaGreenep1*mSelf+0.159719141249985*uSelf[a0+4]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.159719141249985*uOther[a0+4]*uRelDmnu[a0+6]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+5]*uOther[a0+6]*betaGreenep1*mSelf-0.159719141249985*uRelDmnu[a0+4]*uOther[a0+6]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+6]*betaGreenep1*mSelf+0.2500000000000001*uRelDmnu[a0+2]*uSelf[a0+4]*betaGreenep1*mSelf+0.2500000000000001*uSelf[a0+2]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.2500000000000001*uOther[a0+2]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.2500000000000001*uRelDmnu[a0+2]*uOther[a0+4]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+1]*uSelf[a0+3]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+1]*uOther[a0+3]*betaGreenep1*mSelf+0.21957751641342*uRelDmnu[a0+3]*uSelf[a0+8]*betaGreenep1*mOther+0.21957751641342*uSelf[a0+3]*uRelDmnu[a0+8]*betaGreenep1*mOther-0.21957751641342*uOther[a0+3]*uRelDmnu[a0+8]*betaGreenep1*mOther-0.21957751641342*uRelDmnu[a0+3]*uOther[a0+8]*betaGreenep1*mOther+0.2*uRelDmnu[a0+3]*uSelf[a0+7]*betaGreenep1*mOther+0.2*uSelf[a0+3]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.2*uOther[a0+3]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.2*uRelDmnu[a0+3]*uOther[a0+7]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+5]*uSelf[a0+6]*betaGreenep1*mOther+0.159719141249985*uRelDmnu[a0+4]*uSelf[a0+6]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+6]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+5]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.223606797749979*uOther[a0+5]*uRelDmnu[a0+6]*betaGreenep1*mOther+0.159719141249985*uSelf[a0+4]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.159719141249985*uOther[a0+4]*uRelDmnu[a0+6]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+5]*uOther[a0+6]*betaGreenep1*mOther-0.159719141249985*uRelDmnu[a0+4]*uOther[a0+6]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+6]*betaGreenep1*mOther+0.2500000000000001*uRelDmnu[a0+2]*uSelf[a0+4]*betaGreenep1*mOther+0.2500000000000001*uSelf[a0+2]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.2500000000000001*uOther[a0+2]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.2500000000000001*uRelDmnu[a0+2]*uOther[a0+4]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+1]*uSelf[a0+3]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.223606797749979*uOther[a0+1]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+1]*uOther[a0+3]*betaGreenep1*mOther; 
    relKinE[7] += 0.21957751641342*uRelDmnu[a0+3]*uSelf[a0+9]*betaGreenep1*mSelf+0.21957751641342*uSelf[a0+3]*uRelDmnu[a0+9]*betaGreenep1*mSelf-0.21957751641342*uOther[a0+3]*uRelDmnu[a0+9]*betaGreenep1*mSelf-0.21957751641342*uRelDmnu[a0+3]*uOther[a0+9]*betaGreenep1*mSelf+0.159719141249985*uRelDmnu[a0+5]*uSelf[a0+7]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+4]*uSelf[a0+7]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+7]*betaGreenep1*mSelf+0.159719141249985*uSelf[a0+5]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.159719141249985*uOther[a0+5]*uRelDmnu[a0+7]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+4]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+4]*uRelDmnu[a0+7]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.159719141249985*uRelDmnu[a0+5]*uOther[a0+7]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+4]*uOther[a0+7]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+7]*betaGreenep1*mSelf+0.2*uRelDmnu[a0+3]*uSelf[a0+6]*betaGreenep1*mSelf+0.2*uSelf[a0+3]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.2*uOther[a0+3]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.2*uRelDmnu[a0+3]*uOther[a0+6]*betaGreenep1*mSelf+0.2500000000000001*uRelDmnu[a0+1]*uSelf[a0+5]*betaGreenep1*mSelf+0.2500000000000001*uSelf[a0+1]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.2500000000000001*uOther[a0+1]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.2500000000000001*uRelDmnu[a0+1]*uOther[a0+5]*betaGreenep1*mSelf+0.223606797749979*uRelDmnu[a0+2]*uSelf[a0+3]*betaGreenep1*mSelf+0.223606797749979*uSelf[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.223606797749979*uOther[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mSelf-0.223606797749979*uRelDmnu[a0+2]*uOther[a0+3]*betaGreenep1*mSelf+0.21957751641342*uRelDmnu[a0+3]*uSelf[a0+9]*betaGreenep1*mOther+0.21957751641342*uSelf[a0+3]*uRelDmnu[a0+9]*betaGreenep1*mOther-0.21957751641342*uOther[a0+3]*uRelDmnu[a0+9]*betaGreenep1*mOther-0.21957751641342*uRelDmnu[a0+3]*uOther[a0+9]*betaGreenep1*mOther+0.159719141249985*uRelDmnu[a0+5]*uSelf[a0+7]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+4]*uSelf[a0+7]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+7]*betaGreenep1*mOther+0.159719141249985*uSelf[a0+5]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.159719141249985*uOther[a0+5]*uRelDmnu[a0+7]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+4]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.223606797749979*uOther[a0+4]*uRelDmnu[a0+7]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.159719141249985*uRelDmnu[a0+5]*uOther[a0+7]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+4]*uOther[a0+7]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+7]*betaGreenep1*mOther+0.2*uRelDmnu[a0+3]*uSelf[a0+6]*betaGreenep1*mOther+0.2*uSelf[a0+3]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.2*uOther[a0+3]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.2*uRelDmnu[a0+3]*uOther[a0+6]*betaGreenep1*mOther+0.2500000000000001*uRelDmnu[a0+1]*uSelf[a0+5]*betaGreenep1*mOther+0.2500000000000001*uSelf[a0+1]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.2500000000000001*uOther[a0+1]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.2500000000000001*uRelDmnu[a0+1]*uOther[a0+5]*betaGreenep1*mOther+0.223606797749979*uRelDmnu[a0+2]*uSelf[a0+3]*betaGreenep1*mOther+0.223606797749979*uSelf[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.223606797749979*uOther[a0+2]*uRelDmnu[a0+3]*betaGreenep1*mOther-0.223606797749979*uRelDmnu[a0+2]*uOther[a0+3]*betaGreenep1*mOther; 
    relKinE[8] += 0.149071198499986*uRelDmnu[a0+4]*uSelf[a0+8]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+8]*betaGreenep1*mSelf+0.149071198499986*uSelf[a0+4]*uRelDmnu[a0+8]*betaGreenep1*mSelf-0.149071198499986*uOther[a0+4]*uRelDmnu[a0+8]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+8]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+8]*betaGreenep1*mSelf-0.149071198499986*uRelDmnu[a0+4]*uOther[a0+8]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+8]*betaGreenep1*mSelf+0.21957751641342*uRelDmnu[a0+3]*uSelf[a0+6]*betaGreenep1*mSelf+0.21957751641342*uSelf[a0+3]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.21957751641342*uOther[a0+3]*uRelDmnu[a0+6]*betaGreenep1*mSelf-0.21957751641342*uRelDmnu[a0+3]*uOther[a0+6]*betaGreenep1*mSelf+0.21957751641342*uRelDmnu[a0+1]*uSelf[a0+4]*betaGreenep1*mSelf+0.21957751641342*uSelf[a0+1]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.21957751641342*uOther[a0+1]*uRelDmnu[a0+4]*betaGreenep1*mSelf-0.21957751641342*uRelDmnu[a0+1]*uOther[a0+4]*betaGreenep1*mSelf+0.149071198499986*uRelDmnu[a0+4]*uSelf[a0+8]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+8]*betaGreenep1*mOther+0.149071198499986*uSelf[a0+4]*uRelDmnu[a0+8]*betaGreenep1*mOther-0.149071198499986*uOther[a0+4]*uRelDmnu[a0+8]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+8]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+8]*betaGreenep1*mOther-0.149071198499986*uRelDmnu[a0+4]*uOther[a0+8]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+8]*betaGreenep1*mOther+0.21957751641342*uRelDmnu[a0+3]*uSelf[a0+6]*betaGreenep1*mOther+0.21957751641342*uSelf[a0+3]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.21957751641342*uOther[a0+3]*uRelDmnu[a0+6]*betaGreenep1*mOther-0.21957751641342*uRelDmnu[a0+3]*uOther[a0+6]*betaGreenep1*mOther+0.21957751641342*uRelDmnu[a0+1]*uSelf[a0+4]*betaGreenep1*mOther+0.21957751641342*uSelf[a0+1]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.21957751641342*uOther[a0+1]*uRelDmnu[a0+4]*betaGreenep1*mOther-0.21957751641342*uRelDmnu[a0+1]*uOther[a0+4]*betaGreenep1*mOther; 
    relKinE[9] += 0.149071198499986*uRelDmnu[a0+5]*uSelf[a0+9]*betaGreenep1*mSelf+0.25*uRelDmnu[a0]*uSelf[a0+9]*betaGreenep1*mSelf+0.149071198499986*uSelf[a0+5]*uRelDmnu[a0+9]*betaGreenep1*mSelf-0.149071198499986*uOther[a0+5]*uRelDmnu[a0+9]*betaGreenep1*mSelf+0.25*uSelf[a0]*uRelDmnu[a0+9]*betaGreenep1*mSelf-0.25*uOther[a0]*uRelDmnu[a0+9]*betaGreenep1*mSelf-0.149071198499986*uRelDmnu[a0+5]*uOther[a0+9]*betaGreenep1*mSelf-0.25*uRelDmnu[a0]*uOther[a0+9]*betaGreenep1*mSelf+0.21957751641342*uRelDmnu[a0+3]*uSelf[a0+7]*betaGreenep1*mSelf+0.21957751641342*uSelf[a0+3]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.21957751641342*uOther[a0+3]*uRelDmnu[a0+7]*betaGreenep1*mSelf-0.21957751641342*uRelDmnu[a0+3]*uOther[a0+7]*betaGreenep1*mSelf+0.21957751641342*uRelDmnu[a0+2]*uSelf[a0+5]*betaGreenep1*mSelf+0.21957751641342*uSelf[a0+2]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.21957751641342*uOther[a0+2]*uRelDmnu[a0+5]*betaGreenep1*mSelf-0.21957751641342*uRelDmnu[a0+2]*uOther[a0+5]*betaGreenep1*mSelf+0.149071198499986*uRelDmnu[a0+5]*uSelf[a0+9]*betaGreenep1*mOther+0.25*uRelDmnu[a0]*uSelf[a0+9]*betaGreenep1*mOther+0.149071198499986*uSelf[a0+5]*uRelDmnu[a0+9]*betaGreenep1*mOther-0.149071198499986*uOther[a0+5]*uRelDmnu[a0+9]*betaGreenep1*mOther+0.25*uSelf[a0]*uRelDmnu[a0+9]*betaGreenep1*mOther-0.25*uOther[a0]*uRelDmnu[a0+9]*betaGreenep1*mOther-0.149071198499986*uRelDmnu[a0+5]*uOther[a0+9]*betaGreenep1*mOther-0.25*uRelDmnu[a0]*uOther[a0+9]*betaGreenep1*mOther+0.21957751641342*uRelDmnu[a0+3]*uSelf[a0+7]*betaGreenep1*mOther+0.21957751641342*uSelf[a0+3]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.21957751641342*uOther[a0+3]*uRelDmnu[a0+7]*betaGreenep1*mOther-0.21957751641342*uRelDmnu[a0+3]*uOther[a0+7]*betaGreenep1*mOther+0.21957751641342*uRelDmnu[a0+2]*uSelf[a0+5]*betaGreenep1*mOther+0.21957751641342*uSelf[a0+2]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.21957751641342*uOther[a0+2]*uRelDmnu[a0+5]*betaGreenep1*mOther-0.21957751641342*uRelDmnu[a0+2]*uOther[a0+5]*betaGreenep1*mOther; 
  } 
