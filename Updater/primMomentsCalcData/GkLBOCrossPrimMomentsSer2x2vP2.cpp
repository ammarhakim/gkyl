...
void GkLBOECrossPrimMoments2x2vSer_P2(binOpData_t *data, binOpData_t *dataDiv,const double betaGreenep1, const double mSelf, const double nuSelf, const double *m0Self, const double *m1Self, const double *m2Self, const double *uSelf, const double *vtSqSelf, const double *cMSelf, const double *cESelf, const double mOther, const double nuOther, const double *m0Other, const double *m1Other, const double *m2Other, const double *uOther, const double *vtSqOther, const double *cMOther, const double *cEOther, double *uCrossSelf, double *vtSqCrossSelf, double *uCrossOther, double *vtSqCrossOther) 
{ 
  // betaGreenep1:       free parameter beta+1. This has to be >0. 
  // nu, m:              collisionality and mass. 
  // m0,m1,m2:           moments of the distribution function. 
  ...
  data->AEM_S(0,12) += -(0.5*cMrOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,13) += -(0.5*cMrOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,14) += -(0.5*cMrOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,15) += -(0.5*cMrOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,8) += -(0.5*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,9) += (-(0.4472135954999579*cMrOther[4]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,10) += -(0.5*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,11) += (-(0.447213595499958*cMrOther[6]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,12) += -(0.4472135954999579*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,13) += -(0.5000000000000001*cMrOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,14) += -(0.447213595499958*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,15) += -(0.5000000000000001*cMrOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,8) += -(0.5*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,9) += -(0.5*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,10) += (-(0.4472135954999579*cMrOther[5]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,11) += (-(0.447213595499958*cMrOther[7]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,12) += -(0.5000000000000001*cMrOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,13) += -(0.4472135954999579*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,14) += -(0.5000000000000001*cMrOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,15) += -(0.447213595499958*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,8) += -(0.5*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,9) += (-(0.447213595499958*cMrOther[6]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,10) += (-(0.447213595499958*cMrOther[7]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,11) += (-(0.4472135954999579*cMrOther[5]*mSelf*mnuOther)/mOther)-(0.4472135954999579*cMrOther[4]*mSelf*mnuOther)/mOther-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,12) += -(0.4472135954999579*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,13) += -(0.4472135954999579*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,14) += (-(0.4*cMrOther[7]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,15) += (-(0.4*cMrOther[6]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,8) += -(0.5*cMrOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,9) += -(0.4472135954999579*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,10) += -(0.5000000000000001*cMrOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,11) += -(0.4472135954999579*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,12) += (-(0.31943828249997*cMrOther[4]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,14) += (-(0.31943828249997*cMrOther[6]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,15) += -(0.4472135954999579*cMrOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,8) += -(0.5*cMrOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,9) += -(0.5000000000000001*cMrOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,10) += -(0.4472135954999579*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,11) += -(0.4472135954999579*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,13) += (-(0.31943828249997*cMrOther[5]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,14) += -(0.4472135954999579*cMrOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,15) += (-(0.31943828249997*cMrOther[7]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,8) += -(0.5*cMrOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,9) += -(0.447213595499958*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,10) += -(0.5000000000000001*cMrOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,11) += (-(0.4*cMrOther[7]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,12) += (-(0.31943828249997*cMrOther[6]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,13) += -(0.4472135954999579*cMrOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,14) += (-(0.4472135954999579*cMrOther[5]*mSelf*mnuOther)/mOther)-(0.31943828249997*cMrOther[4]*mSelf*mnuOther)/mOther-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,15) += -(0.4*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,8) += -(0.5*cMrOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,9) += -(0.5000000000000001*cMrOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,10) += -(0.447213595499958*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,11) += (-(0.4*cMrOther[6]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,12) += -(0.4472135954999579*cMrOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,13) += (-(0.31943828249997*cMrOther[7]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,14) += -(0.4*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,15) += (-(0.31943828249997*cMrOther[5]*mSelf*mnuOther)/mOther)-(0.4472135954999579*cMrOther[4]*mSelf*mnuOther)/mOther-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  ...
  // ... Block from weak multiply of mOther, nuOther, m1OtherX and uCrossOtherX ... // 
  data->AEM_S(8,0) += 0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(8,1) += 0.5*m1rOther[1]*mnuOther; 
  data->AEM_S(8,2) += 0.5*m1rOther[2]*mnuOther; 
  data->AEM_S(8,3) += 0.5*m1rOther[3]*mnuOther; 
  data->AEM_S(8,4) += 0.5*m1rOther[4]*mnuOther; 
  data->AEM_S(8,5) += 0.5*m1rOther[5]*mnuOther; 
  data->AEM_S(8,6) += 0.5*m1rOther[6]*mnuOther; 
  data->AEM_S(8,7) += 0.5*m1rOther[7]*mnuOther; 
  data->AEM_S(9,0) += 0.5*m1rOther[1]*mnuOther; 
  data->AEM_S(9,1) += 0.4472135954999579*m1rOther[4]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(9,2) += 0.5*m1rOther[3]*mnuOther; 
  data->AEM_S(9,3) += 0.447213595499958*m1rOther[6]*mnuOther+0.5*m1rOther[2]*mnuOther; 
  data->AEM_S(9,4) += 0.4472135954999579*m1rOther[1]*mnuOther; 
  data->AEM_S(9,5) += 0.5000000000000001*m1rOther[7]*mnuOther; 
  data->AEM_S(9,6) += 0.447213595499958*m1rOther[3]*mnuOther; 
  data->AEM_S(9,7) += 0.5000000000000001*m1rOther[5]*mnuOther; 
  data->AEM_S(10,0) += 0.5*m1rOther[2]*mnuOther; 
  data->AEM_S(10,1) += 0.5*m1rOther[3]*mnuOther; 
  data->AEM_S(10,2) += 0.4472135954999579*m1rOther[5]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(10,3) += 0.447213595499958*m1rOther[7]*mnuOther+0.5*m1rOther[1]*mnuOther; 
  data->AEM_S(10,4) += 0.5000000000000001*m1rOther[6]*mnuOther; 
  data->AEM_S(10,5) += 0.4472135954999579*m1rOther[2]*mnuOther; 
  data->AEM_S(10,6) += 0.5000000000000001*m1rOther[4]*mnuOther; 
  data->AEM_S(10,7) += 0.447213595499958*m1rOther[3]*mnuOther; 
  data->AEM_S(11,0) += 0.5*m1rOther[3]*mnuOther; 
  data->AEM_S(11,1) += 0.447213595499958*m1rOther[6]*mnuOther+0.5*m1rOther[2]*mnuOther; 
  data->AEM_S(11,2) += 0.447213595499958*m1rOther[7]*mnuOther+0.5*m1rOther[1]*mnuOther; 
  data->AEM_S(11,3) += 0.4472135954999579*m1rOther[5]*mnuOther+0.4472135954999579*m1rOther[4]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(11,4) += 0.4472135954999579*m1rOther[3]*mnuOther; 
  data->AEM_S(11,5) += 0.4472135954999579*m1rOther[3]*mnuOther; 
  data->AEM_S(11,6) += 0.4*m1rOther[7]*mnuOther+0.447213595499958*m1rOther[1]*mnuOther; 
  data->AEM_S(11,7) += 0.4*m1rOther[6]*mnuOther+0.447213595499958*m1rOther[2]*mnuOther; 
  data->AEM_S(12,0) += 0.5*m1rOther[4]*mnuOther; 
  data->AEM_S(12,1) += 0.4472135954999579*m1rOther[1]*mnuOther; 
  data->AEM_S(12,2) += 0.5000000000000001*m1rOther[6]*mnuOther; 
  data->AEM_S(12,3) += 0.4472135954999579*m1rOther[3]*mnuOther; 
  data->AEM_S(12,4) += 0.31943828249997*m1rOther[4]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(12,6) += 0.31943828249997*m1rOther[6]*mnuOther+0.5000000000000001*m1rOther[2]*mnuOther; 
  data->AEM_S(12,7) += 0.4472135954999579*m1rOther[7]*mnuOther; 
  data->AEM_S(13,0) += 0.5*m1rOther[5]*mnuOther; 
  data->AEM_S(13,1) += 0.5000000000000001*m1rOther[7]*mnuOther; 
  data->AEM_S(13,2) += 0.4472135954999579*m1rOther[2]*mnuOther; 
  data->AEM_S(13,3) += 0.4472135954999579*m1rOther[3]*mnuOther; 
  data->AEM_S(13,5) += 0.31943828249997*m1rOther[5]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(13,6) += 0.4472135954999579*m1rOther[6]*mnuOther; 
  data->AEM_S(13,7) += 0.31943828249997*m1rOther[7]*mnuOther+0.5000000000000001*m1rOther[1]*mnuOther; 
  data->AEM_S(14,0) += 0.5*m1rOther[6]*mnuOther; 
  data->AEM_S(14,1) += 0.447213595499958*m1rOther[3]*mnuOther; 
  data->AEM_S(14,2) += 0.5000000000000001*m1rOther[4]*mnuOther; 
  data->AEM_S(14,3) += 0.4*m1rOther[7]*mnuOther+0.447213595499958*m1rOther[1]*mnuOther; 
  data->AEM_S(14,4) += 0.31943828249997*m1rOther[6]*mnuOther+0.5000000000000001*m1rOther[2]*mnuOther; 
  data->AEM_S(14,5) += 0.4472135954999579*m1rOther[6]*mnuOther; 
  data->AEM_S(14,6) += 0.4472135954999579*m1rOther[5]*mnuOther+0.31943828249997*m1rOther[4]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(14,7) += 0.4*m1rOther[3]*mnuOther; 
  data->AEM_S(15,0) += 0.5*m1rOther[7]*mnuOther; 
  data->AEM_S(15,1) += 0.5000000000000001*m1rOther[5]*mnuOther; 
  data->AEM_S(15,2) += 0.447213595499958*m1rOther[3]*mnuOther; 
  data->AEM_S(15,3) += 0.4*m1rOther[6]*mnuOther+0.447213595499958*m1rOther[2]*mnuOther; 
  data->AEM_S(15,4) += 0.4472135954999579*m1rOther[7]*mnuOther; 
  data->AEM_S(15,5) += 0.31943828249997*m1rOther[7]*mnuOther+0.5000000000000001*m1rOther[1]*mnuOther; 
  data->AEM_S(15,6) += 0.4*m1rOther[3]*mnuOther; 
  data->AEM_S(15,7) += 0.31943828249997*m1rOther[5]*mnuOther+0.4472135954999579*m1rOther[4]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  ...
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(8,8) += (1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,9) += (1.5*m0rOther[1]*mSelf*mnuOther)/mOther-(0.5*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,10) += (1.5*m0rOther[2]*mSelf*mnuOther)/mOther-(0.5*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,11) += (1.5*m0rOther[3]*mSelf*mnuOther)/mOther-(0.5*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,12) += (1.5*m0rOther[4]*mSelf*mnuOther)/mOther-(0.5*cErOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,13) += (1.5*m0rOther[5]*mSelf*mnuOther)/mOther-(0.5*cErOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,14) += (1.5*m0rOther[6]*mSelf*mnuOther)/mOther-(0.5*cErOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,15) += (1.5*m0rOther[7]*mSelf*mnuOther)/mOther-(0.5*cErOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,8) += (1.5*m0rOther[1]*mSelf*mnuOther)/mOther-(0.5*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,9) += (1.341640786499874*m0rOther[4]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[4]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,10) += (1.5*m0rOther[3]*mSelf*mnuOther)/mOther-(0.5*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,11) += (1.341640786499874*m0rOther[6]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[6]*mSelf*mnuOther)/mOther+(1.5*m0rOther[2]*mSelf*mnuOther)/mOther-(0.5*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,12) += (1.341640786499874*m0rOther[1]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,13) += (1.5*m0rOther[7]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,14) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,15) += (1.5*m0rOther[5]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,8) += (1.5*m0rOther[2]*mSelf*mnuOther)/mOther-(0.5*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,9) += (1.5*m0rOther[3]*mSelf*mnuOther)/mOther-(0.5*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,10) += (1.341640786499874*m0rOther[5]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[5]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,11) += (1.341640786499874*m0rOther[7]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[7]*mSelf*mnuOther)/mOther+(1.5*m0rOther[1]*mSelf*mnuOther)/mOther-(0.5*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,12) += (1.5*m0rOther[6]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,13) += (1.341640786499874*m0rOther[2]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,14) += (1.5*m0rOther[4]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,15) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,8) += (1.5*m0rOther[3]*mSelf*mnuOther)/mOther-(0.5*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,9) += (1.341640786499874*m0rOther[6]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[6]*mSelf*mnuOther)/mOther+(1.5*m0rOther[2]*mSelf*mnuOther)/mOther-(0.5*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,10) += (1.341640786499874*m0rOther[7]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[7]*mSelf*mnuOther)/mOther+(1.5*m0rOther[1]*mSelf*mnuOther)/mOther-(0.5*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,11) += (1.341640786499874*m0rOther[5]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[5]*mSelf*mnuOther)/mOther+(1.341640786499874*m0rOther[4]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[4]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,12) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,13) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,14) += (1.2*m0rOther[7]*mSelf*mnuOther)/mOther-(0.4*cErOther[7]*mSelf*mnuOther)/mOther+(1.341640786499874*m0rOther[1]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,15) += (1.2*m0rOther[6]*mSelf*mnuOther)/mOther-(0.4*cErOther[6]*mSelf*mnuOther)/mOther+(1.341640786499874*m0rOther[2]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,8) += (1.5*m0rOther[4]*mSelf*mnuOther)/mOther-(0.5*cErOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,9) += (1.341640786499874*m0rOther[1]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,10) += (1.5*m0rOther[6]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,11) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,12) += (0.9583148474999099*m0rOther[4]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[4]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,14) += (0.9583148474999099*m0rOther[6]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[6]*mSelf*mnuOther)/mOther+(1.5*m0rOther[2]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,15) += (1.341640786499874*m0rOther[7]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,8) += (1.5*m0rOther[5]*mSelf*mnuOther)/mOther-(0.5*cErOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,9) += (1.5*m0rOther[7]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,10) += (1.341640786499874*m0rOther[2]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,11) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,13) += (0.9583148474999099*m0rOther[5]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[5]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,14) += (1.341640786499874*m0rOther[6]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,15) += (0.9583148474999099*m0rOther[7]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[7]*mSelf*mnuOther)/mOther+(1.5*m0rOther[1]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,8) += (1.5*m0rOther[6]*mSelf*mnuOther)/mOther-(0.5*cErOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,9) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,10) += (1.5*m0rOther[4]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,11) += (1.2*m0rOther[7]*mSelf*mnuOther)/mOther-(0.4*cErOther[7]*mSelf*mnuOther)/mOther+(1.341640786499874*m0rOther[1]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,12) += (0.9583148474999099*m0rOther[6]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[6]*mSelf*mnuOther)/mOther+(1.5*m0rOther[2]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,13) += (1.341640786499874*m0rOther[6]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,14) += (1.341640786499874*m0rOther[5]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[5]*mSelf*mnuOther)/mOther+(0.9583148474999099*m0rOther[4]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[4]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,15) += (1.2*m0rOther[3]*mSelf*mnuOther)/mOther-(0.4*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,8) += (1.5*m0rOther[7]*mSelf*mnuOther)/mOther-(0.5*cErOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,9) += (1.5*m0rOther[5]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,10) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,11) += (1.2*m0rOther[6]*mSelf*mnuOther)/mOther-(0.4*cErOther[6]*mSelf*mnuOther)/mOther+(1.341640786499874*m0rOther[2]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,12) += (1.341640786499874*m0rOther[7]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,13) += (0.9583148474999099*m0rOther[7]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[7]*mSelf*mnuOther)/mOther+(1.5*m0rOther[1]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,14) += (1.2*m0rOther[3]*mSelf*mnuOther)/mOther-(0.4*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,15) += (0.9583148474999099*m0rOther[5]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[5]*mSelf*mnuOther)/mOther+(1.341640786499874*m0rOther[4]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[4]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
