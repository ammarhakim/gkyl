...
void VmLBOECrossPrimMoments2x3vSer_P2(binOpData_t *data, binOpData_t *dataDiv,const double betaGreenep1, const double mSelf, const double nuSelf, const double *m0Self, const double *m1Self, const double *m2Self, const double *uSelf, const double *vtSqSelf, const double *cMSelf, const double *cESelf, const double mOther, const double nuOther, const double *m0Other, const double *m1Other, const double *m2Other, const double *uOther, const double *vtSqOther, const double *cMOther, const double *cEOther, double *uCrossSelf, double *vtSqCrossSelf, double *uCrossOther, double *vtSqCrossOther) 
{ 
  // betaGreenep1:       free parameter beta+1. This has to be >0. 
  // nu, m:              collisionality and mass. 
  // m0,m1,m2:           moments of the distribution function. 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(0,24) += -(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,25) += -(0.5*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,26) += -(0.5*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,27) += -(0.5*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,28) += -(0.5*cMrOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,29) += -(0.5*cMrOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,30) += -(0.5*cMrOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,31) += -(0.5*cMrOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,24) += -(0.5*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,25) += (-(0.4472135954999579*cMrOther[4]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,26) += -(0.5*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,27) += (-(0.447213595499958*cMrOther[6]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,28) += -(0.4472135954999579*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,29) += -(0.5000000000000001*cMrOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,30) += -(0.447213595499958*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,31) += -(0.5000000000000001*cMrOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,24) += -(0.5*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,25) += -(0.5*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,26) += (-(0.4472135954999579*cMrOther[5]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,27) += (-(0.447213595499958*cMrOther[7]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,28) += -(0.5000000000000001*cMrOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,29) += -(0.4472135954999579*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,30) += -(0.5000000000000001*cMrOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,31) += -(0.447213595499958*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,24) += -(0.5*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,25) += (-(0.447213595499958*cMrOther[6]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,26) += (-(0.447213595499958*cMrOther[7]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,27) += (-(0.4472135954999579*cMrOther[5]*mSelf*mnuOther)/mOther)-(0.4472135954999579*cMrOther[4]*mSelf*mnuOther)/mOther-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,28) += -(0.4472135954999579*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,29) += -(0.4472135954999579*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,30) += (-(0.4*cMrOther[7]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,31) += (-(0.4*cMrOther[6]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,24) += -(0.5*cMrOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,25) += -(0.4472135954999579*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,26) += -(0.5000000000000001*cMrOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,27) += -(0.4472135954999579*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,28) += (-(0.31943828249997*cMrOther[4]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,30) += (-(0.31943828249997*cMrOther[6]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,31) += -(0.4472135954999579*cMrOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,24) += -(0.5*cMrOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,25) += -(0.5000000000000001*cMrOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,26) += -(0.4472135954999579*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,27) += -(0.4472135954999579*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,29) += (-(0.31943828249997*cMrOther[5]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,30) += -(0.4472135954999579*cMrOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,31) += (-(0.31943828249997*cMrOther[7]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,24) += -(0.5*cMrOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,25) += -(0.447213595499958*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,26) += -(0.5000000000000001*cMrOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,27) += (-(0.4*cMrOther[7]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,28) += (-(0.31943828249997*cMrOther[6]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,29) += -(0.4472135954999579*cMrOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,30) += (-(0.4472135954999579*cMrOther[5]*mSelf*mnuOther)/mOther)-(0.31943828249997*cMrOther[4]*mSelf*mnuOther)/mOther-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,31) += -(0.4*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,24) += -(0.5*cMrOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,25) += -(0.5000000000000001*cMrOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,26) += -(0.447213595499958*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,27) += (-(0.4*cMrOther[6]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,28) += -(0.4472135954999579*cMrOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,29) += (-(0.31943828249997*cMrOther[7]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,30) += -(0.4*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,31) += (-(0.31943828249997*cMrOther[5]*mSelf*mnuOther)/mOther)-(0.4472135954999579*cMrOther[4]*mSelf*mnuOther)/mOther-(0.5*cMrOther[0]*mSelf*mnuOther)/mOther; 
  ...
  // ... Block from weak multiply of mOther, nuOther, m1OtherX and uCrossOtherX ... // 
  data->AEM_S(24,0) += 0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(24,1) += 0.5*m1rOther[1]*mnuOther; 
  data->AEM_S(24,2) += 0.5*m1rOther[2]*mnuOther; 
  data->AEM_S(24,3) += 0.5*m1rOther[3]*mnuOther; 
  data->AEM_S(24,4) += 0.5*m1rOther[4]*mnuOther; 
  data->AEM_S(24,5) += 0.5*m1rOther[5]*mnuOther; 
  data->AEM_S(24,6) += 0.5*m1rOther[6]*mnuOther; 
  data->AEM_S(24,7) += 0.5*m1rOther[7]*mnuOther; 
  data->AEM_S(25,0) += 0.5*m1rOther[1]*mnuOther; 
  data->AEM_S(25,1) += 0.4472135954999579*m1rOther[4]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(25,2) += 0.5*m1rOther[3]*mnuOther; 
  data->AEM_S(25,3) += 0.447213595499958*m1rOther[6]*mnuOther+0.5*m1rOther[2]*mnuOther; 
  data->AEM_S(25,4) += 0.4472135954999579*m1rOther[1]*mnuOther; 
  data->AEM_S(25,5) += 0.5000000000000001*m1rOther[7]*mnuOther; 
  data->AEM_S(25,6) += 0.447213595499958*m1rOther[3]*mnuOther; 
  data->AEM_S(25,7) += 0.5000000000000001*m1rOther[5]*mnuOther; 
  data->AEM_S(26,0) += 0.5*m1rOther[2]*mnuOther; 
  data->AEM_S(26,1) += 0.5*m1rOther[3]*mnuOther; 
  data->AEM_S(26,2) += 0.4472135954999579*m1rOther[5]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(26,3) += 0.447213595499958*m1rOther[7]*mnuOther+0.5*m1rOther[1]*mnuOther; 
  data->AEM_S(26,4) += 0.5000000000000001*m1rOther[6]*mnuOther; 
  data->AEM_S(26,5) += 0.4472135954999579*m1rOther[2]*mnuOther; 
  data->AEM_S(26,6) += 0.5000000000000001*m1rOther[4]*mnuOther; 
  data->AEM_S(26,7) += 0.447213595499958*m1rOther[3]*mnuOther; 
  data->AEM_S(27,0) += 0.5*m1rOther[3]*mnuOther; 
  data->AEM_S(27,1) += 0.447213595499958*m1rOther[6]*mnuOther+0.5*m1rOther[2]*mnuOther; 
  data->AEM_S(27,2) += 0.447213595499958*m1rOther[7]*mnuOther+0.5*m1rOther[1]*mnuOther; 
  data->AEM_S(27,3) += 0.4472135954999579*m1rOther[5]*mnuOther+0.4472135954999579*m1rOther[4]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(27,4) += 0.4472135954999579*m1rOther[3]*mnuOther; 
  data->AEM_S(27,5) += 0.4472135954999579*m1rOther[3]*mnuOther; 
  data->AEM_S(27,6) += 0.4*m1rOther[7]*mnuOther+0.447213595499958*m1rOther[1]*mnuOther; 
  data->AEM_S(27,7) += 0.4*m1rOther[6]*mnuOther+0.447213595499958*m1rOther[2]*mnuOther; 
  data->AEM_S(28,0) += 0.5*m1rOther[4]*mnuOther; 
  data->AEM_S(28,1) += 0.4472135954999579*m1rOther[1]*mnuOther; 
  data->AEM_S(28,2) += 0.5000000000000001*m1rOther[6]*mnuOther; 
  data->AEM_S(28,3) += 0.4472135954999579*m1rOther[3]*mnuOther; 
  data->AEM_S(28,4) += 0.31943828249997*m1rOther[4]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(28,6) += 0.31943828249997*m1rOther[6]*mnuOther+0.5000000000000001*m1rOther[2]*mnuOther; 
  data->AEM_S(28,7) += 0.4472135954999579*m1rOther[7]*mnuOther; 
  data->AEM_S(29,0) += 0.5*m1rOther[5]*mnuOther; 
  data->AEM_S(29,1) += 0.5000000000000001*m1rOther[7]*mnuOther; 
  data->AEM_S(29,2) += 0.4472135954999579*m1rOther[2]*mnuOther; 
  data->AEM_S(29,3) += 0.4472135954999579*m1rOther[3]*mnuOther; 
  data->AEM_S(29,5) += 0.31943828249997*m1rOther[5]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(29,6) += 0.4472135954999579*m1rOther[6]*mnuOther; 
  data->AEM_S(29,7) += 0.31943828249997*m1rOther[7]*mnuOther+0.5000000000000001*m1rOther[1]*mnuOther; 
  data->AEM_S(30,0) += 0.5*m1rOther[6]*mnuOther; 
  data->AEM_S(30,1) += 0.447213595499958*m1rOther[3]*mnuOther; 
  data->AEM_S(30,2) += 0.5000000000000001*m1rOther[4]*mnuOther; 
  data->AEM_S(30,3) += 0.4*m1rOther[7]*mnuOther+0.447213595499958*m1rOther[1]*mnuOther; 
  data->AEM_S(30,4) += 0.31943828249997*m1rOther[6]*mnuOther+0.5000000000000001*m1rOther[2]*mnuOther; 
  data->AEM_S(30,5) += 0.4472135954999579*m1rOther[6]*mnuOther; 
  data->AEM_S(30,6) += 0.4472135954999579*m1rOther[5]*mnuOther+0.31943828249997*m1rOther[4]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  data->AEM_S(30,7) += 0.4*m1rOther[3]*mnuOther; 
  data->AEM_S(31,0) += 0.5*m1rOther[7]*mnuOther; 
  data->AEM_S(31,1) += 0.5000000000000001*m1rOther[5]*mnuOther; 
  data->AEM_S(31,2) += 0.447213595499958*m1rOther[3]*mnuOther; 
  data->AEM_S(31,3) += 0.4*m1rOther[6]*mnuOther+0.447213595499958*m1rOther[2]*mnuOther; 
  data->AEM_S(31,4) += 0.4472135954999579*m1rOther[7]*mnuOther; 
  data->AEM_S(31,5) += 0.31943828249997*m1rOther[7]*mnuOther+0.5000000000000001*m1rOther[1]*mnuOther; 
  data->AEM_S(31,6) += 0.4*m1rOther[3]*mnuOther; 
  data->AEM_S(31,7) += 0.31943828249997*m1rOther[5]*mnuOther+0.4472135954999579*m1rOther[4]*mnuOther+0.5*m1rOther[0]*mnuOther; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(8,24) += -(0.5*cMrOther[8]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,25) += -(0.5*cMrOther[9]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,26) += -(0.5*cMrOther[10]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,27) += -(0.5*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,28) += -(0.5*cMrOther[12]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,29) += -(0.5*cMrOther[13]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,30) += -(0.5*cMrOther[14]*mSelf*mnuOther)/mOther; 
  data->AEM_S(8,31) += -(0.5*cMrOther[15]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,24) += -(0.5*cMrOther[9]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,25) += (-(0.4472135954999579*cMrOther[12]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[8]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,26) += -(0.5*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,27) += (-(0.447213595499958*cMrOther[14]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[10]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,28) += -(0.4472135954999579*cMrOther[9]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,29) += -(0.5000000000000001*cMrOther[15]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,30) += -(0.447213595499958*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(9,31) += -(0.5000000000000001*cMrOther[13]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,24) += -(0.5*cMrOther[10]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,25) += -(0.5*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,26) += (-(0.4472135954999579*cMrOther[13]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[8]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,27) += (-(0.447213595499958*cMrOther[15]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[9]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,28) += -(0.5000000000000001*cMrOther[14]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,29) += -(0.4472135954999579*cMrOther[10]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,30) += -(0.5000000000000001*cMrOther[12]*mSelf*mnuOther)/mOther; 
  data->AEM_S(10,31) += -(0.447213595499958*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,24) += -(0.5*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,25) += (-(0.447213595499958*cMrOther[14]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[10]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,26) += (-(0.447213595499958*cMrOther[15]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[9]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,27) += (-(0.4472135954999579*cMrOther[13]*mSelf*mnuOther)/mOther)-(0.4472135954999579*cMrOther[12]*mSelf*mnuOther)/mOther-(0.5*cMrOther[8]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,28) += -(0.4472135954999579*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,29) += -(0.4472135954999579*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,30) += (-(0.4*cMrOther[15]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[9]*mSelf*mnuOther)/mOther; 
  data->AEM_S(11,31) += (-(0.4*cMrOther[14]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[10]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,24) += -(0.5*cMrOther[12]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,25) += -(0.4472135954999579*cMrOther[9]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,26) += -(0.5000000000000001*cMrOther[14]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,27) += -(0.4472135954999579*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,28) += (-(0.31943828249997*cMrOther[12]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[8]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,30) += (-(0.31943828249997*cMrOther[14]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[10]*mSelf*mnuOther)/mOther; 
  data->AEM_S(12,31) += -(0.4472135954999579*cMrOther[15]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,24) += -(0.5*cMrOther[13]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,25) += -(0.5000000000000001*cMrOther[15]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,26) += -(0.4472135954999579*cMrOther[10]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,27) += -(0.4472135954999579*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,29) += (-(0.31943828249997*cMrOther[13]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[8]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,30) += -(0.4472135954999579*cMrOther[14]*mSelf*mnuOther)/mOther; 
  data->AEM_S(13,31) += (-(0.31943828249997*cMrOther[15]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[9]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,24) += -(0.5*cMrOther[14]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,25) += -(0.447213595499958*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,26) += -(0.5000000000000001*cMrOther[12]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,27) += (-(0.4*cMrOther[15]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[9]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,28) += (-(0.31943828249997*cMrOther[14]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[10]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,29) += -(0.4472135954999579*cMrOther[14]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,30) += (-(0.4472135954999579*cMrOther[13]*mSelf*mnuOther)/mOther)-(0.31943828249997*cMrOther[12]*mSelf*mnuOther)/mOther-(0.5*cMrOther[8]*mSelf*mnuOther)/mOther; 
  data->AEM_S(14,31) += -(0.4*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,24) += -(0.5*cMrOther[15]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,25) += -(0.5000000000000001*cMrOther[13]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,26) += -(0.447213595499958*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,27) += (-(0.4*cMrOther[14]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[10]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,28) += -(0.4472135954999579*cMrOther[15]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,29) += (-(0.31943828249997*cMrOther[15]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[9]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,30) += -(0.4*cMrOther[11]*mSelf*mnuOther)/mOther; 
  data->AEM_S(15,31) += (-(0.31943828249997*cMrOther[13]*mSelf*mnuOther)/mOther)-(0.4472135954999579*cMrOther[12]*mSelf*mnuOther)/mOther-(0.5*cMrOther[8]*mSelf*mnuOther)/mOther; 
  ...
  // ... Block from weak multiply of mOther, nuOther, m1OtherY and uCrossOtherY ... // 
  data->AEM_S(24,8) += 0.5*m1rOther[8]*mnuOther; 
  data->AEM_S(24,9) += 0.5*m1rOther[9]*mnuOther; 
  data->AEM_S(24,10) += 0.5*m1rOther[10]*mnuOther; 
  data->AEM_S(24,11) += 0.5*m1rOther[11]*mnuOther; 
  data->AEM_S(24,12) += 0.5*m1rOther[12]*mnuOther; 
  data->AEM_S(24,13) += 0.5*m1rOther[13]*mnuOther; 
  data->AEM_S(24,14) += 0.5*m1rOther[14]*mnuOther; 
  data->AEM_S(24,15) += 0.5*m1rOther[15]*mnuOther; 
  data->AEM_S(25,8) += 0.5*m1rOther[9]*mnuOther; 
  data->AEM_S(25,9) += 0.4472135954999579*m1rOther[12]*mnuOther+0.5*m1rOther[8]*mnuOther; 
  data->AEM_S(25,10) += 0.5*m1rOther[11]*mnuOther; 
  data->AEM_S(25,11) += 0.447213595499958*m1rOther[14]*mnuOther+0.5*m1rOther[10]*mnuOther; 
  data->AEM_S(25,12) += 0.4472135954999579*m1rOther[9]*mnuOther; 
  data->AEM_S(25,13) += 0.5000000000000001*m1rOther[15]*mnuOther; 
  data->AEM_S(25,14) += 0.447213595499958*m1rOther[11]*mnuOther; 
  data->AEM_S(25,15) += 0.5000000000000001*m1rOther[13]*mnuOther; 
  data->AEM_S(26,8) += 0.5*m1rOther[10]*mnuOther; 
  data->AEM_S(26,9) += 0.5*m1rOther[11]*mnuOther; 
  data->AEM_S(26,10) += 0.4472135954999579*m1rOther[13]*mnuOther+0.5*m1rOther[8]*mnuOther; 
  data->AEM_S(26,11) += 0.447213595499958*m1rOther[15]*mnuOther+0.5*m1rOther[9]*mnuOther; 
  data->AEM_S(26,12) += 0.5000000000000001*m1rOther[14]*mnuOther; 
  data->AEM_S(26,13) += 0.4472135954999579*m1rOther[10]*mnuOther; 
  data->AEM_S(26,14) += 0.5000000000000001*m1rOther[12]*mnuOther; 
  data->AEM_S(26,15) += 0.447213595499958*m1rOther[11]*mnuOther; 
  data->AEM_S(27,8) += 0.5*m1rOther[11]*mnuOther; 
  data->AEM_S(27,9) += 0.447213595499958*m1rOther[14]*mnuOther+0.5*m1rOther[10]*mnuOther; 
  data->AEM_S(27,10) += 0.447213595499958*m1rOther[15]*mnuOther+0.5*m1rOther[9]*mnuOther; 
  data->AEM_S(27,11) += 0.4472135954999579*m1rOther[13]*mnuOther+0.4472135954999579*m1rOther[12]*mnuOther+0.5*m1rOther[8]*mnuOther; 
  data->AEM_S(27,12) += 0.4472135954999579*m1rOther[11]*mnuOther; 
  data->AEM_S(27,13) += 0.4472135954999579*m1rOther[11]*mnuOther; 
  data->AEM_S(27,14) += 0.4*m1rOther[15]*mnuOther+0.447213595499958*m1rOther[9]*mnuOther; 
  data->AEM_S(27,15) += 0.4*m1rOther[14]*mnuOther+0.447213595499958*m1rOther[10]*mnuOther; 
  data->AEM_S(28,8) += 0.5*m1rOther[12]*mnuOther; 
  data->AEM_S(28,9) += 0.4472135954999579*m1rOther[9]*mnuOther; 
  data->AEM_S(28,10) += 0.5000000000000001*m1rOther[14]*mnuOther; 
  data->AEM_S(28,11) += 0.4472135954999579*m1rOther[11]*mnuOther; 
  data->AEM_S(28,12) += 0.31943828249997*m1rOther[12]*mnuOther+0.5*m1rOther[8]*mnuOther; 
  data->AEM_S(28,14) += 0.31943828249997*m1rOther[14]*mnuOther+0.5000000000000001*m1rOther[10]*mnuOther; 
  data->AEM_S(28,15) += 0.4472135954999579*m1rOther[15]*mnuOther; 
  data->AEM_S(29,8) += 0.5*m1rOther[13]*mnuOther; 
  data->AEM_S(29,9) += 0.5000000000000001*m1rOther[15]*mnuOther; 
  data->AEM_S(29,10) += 0.4472135954999579*m1rOther[10]*mnuOther; 
  data->AEM_S(29,11) += 0.4472135954999579*m1rOther[11]*mnuOther; 
  data->AEM_S(29,13) += 0.31943828249997*m1rOther[13]*mnuOther+0.5*m1rOther[8]*mnuOther; 
  data->AEM_S(29,14) += 0.4472135954999579*m1rOther[14]*mnuOther; 
  data->AEM_S(29,15) += 0.31943828249997*m1rOther[15]*mnuOther+0.5000000000000001*m1rOther[9]*mnuOther; 
  data->AEM_S(30,8) += 0.5*m1rOther[14]*mnuOther; 
  data->AEM_S(30,9) += 0.447213595499958*m1rOther[11]*mnuOther; 
  data->AEM_S(30,10) += 0.5000000000000001*m1rOther[12]*mnuOther; 
  data->AEM_S(30,11) += 0.4*m1rOther[15]*mnuOther+0.447213595499958*m1rOther[9]*mnuOther; 
  data->AEM_S(30,12) += 0.31943828249997*m1rOther[14]*mnuOther+0.5000000000000001*m1rOther[10]*mnuOther; 
  data->AEM_S(30,13) += 0.4472135954999579*m1rOther[14]*mnuOther; 
  data->AEM_S(30,14) += 0.4472135954999579*m1rOther[13]*mnuOther+0.31943828249997*m1rOther[12]*mnuOther+0.5*m1rOther[8]*mnuOther; 
  data->AEM_S(30,15) += 0.4*m1rOther[11]*mnuOther; 
  data->AEM_S(31,8) += 0.5*m1rOther[15]*mnuOther; 
  data->AEM_S(31,9) += 0.5000000000000001*m1rOther[13]*mnuOther; 
  data->AEM_S(31,10) += 0.447213595499958*m1rOther[11]*mnuOther; 
  data->AEM_S(31,11) += 0.4*m1rOther[14]*mnuOther+0.447213595499958*m1rOther[10]*mnuOther; 
  data->AEM_S(31,12) += 0.4472135954999579*m1rOther[15]*mnuOther; 
  data->AEM_S(31,13) += 0.31943828249997*m1rOther[15]*mnuOther+0.5000000000000001*m1rOther[9]*mnuOther; 
  data->AEM_S(31,14) += 0.4*m1rOther[11]*mnuOther; 
  data->AEM_S(31,15) += 0.31943828249997*m1rOther[13]*mnuOther+0.4472135954999579*m1rOther[12]*mnuOther+0.5*m1rOther[8]*mnuOther; 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(16,24) += -(0.5*cMrOther[16]*mSelf*mnuOther)/mOther; 
  data->AEM_S(16,25) += -(0.5*cMrOther[17]*mSelf*mnuOther)/mOther; 
  data->AEM_S(16,26) += -(0.5*cMrOther[18]*mSelf*mnuOther)/mOther; 
  data->AEM_S(16,27) += -(0.5*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(16,28) += -(0.5*cMrOther[20]*mSelf*mnuOther)/mOther; 
  data->AEM_S(16,29) += -(0.5*cMrOther[21]*mSelf*mnuOther)/mOther; 
  data->AEM_S(16,30) += -(0.5*cMrOther[22]*mSelf*mnuOther)/mOther; 
  data->AEM_S(16,31) += -(0.5*cMrOther[23]*mSelf*mnuOther)/mOther; 
  data->AEM_S(17,24) += -(0.5*cMrOther[17]*mSelf*mnuOther)/mOther; 
  data->AEM_S(17,25) += (-(0.4472135954999579*cMrOther[20]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[16]*mSelf*mnuOther)/mOther; 
  data->AEM_S(17,26) += -(0.5*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(17,27) += (-(0.447213595499958*cMrOther[22]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[18]*mSelf*mnuOther)/mOther; 
  data->AEM_S(17,28) += -(0.4472135954999579*cMrOther[17]*mSelf*mnuOther)/mOther; 
  data->AEM_S(17,29) += -(0.5000000000000001*cMrOther[23]*mSelf*mnuOther)/mOther; 
  data->AEM_S(17,30) += -(0.447213595499958*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(17,31) += -(0.5000000000000001*cMrOther[21]*mSelf*mnuOther)/mOther; 
  data->AEM_S(18,24) += -(0.5*cMrOther[18]*mSelf*mnuOther)/mOther; 
  data->AEM_S(18,25) += -(0.5*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(18,26) += (-(0.4472135954999579*cMrOther[21]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[16]*mSelf*mnuOther)/mOther; 
  data->AEM_S(18,27) += (-(0.447213595499958*cMrOther[23]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[17]*mSelf*mnuOther)/mOther; 
  data->AEM_S(18,28) += -(0.5000000000000001*cMrOther[22]*mSelf*mnuOther)/mOther; 
  data->AEM_S(18,29) += -(0.4472135954999579*cMrOther[18]*mSelf*mnuOther)/mOther; 
  data->AEM_S(18,30) += -(0.5000000000000001*cMrOther[20]*mSelf*mnuOther)/mOther; 
  data->AEM_S(18,31) += -(0.447213595499958*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(19,24) += -(0.5*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(19,25) += (-(0.447213595499958*cMrOther[22]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[18]*mSelf*mnuOther)/mOther; 
  data->AEM_S(19,26) += (-(0.447213595499958*cMrOther[23]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[17]*mSelf*mnuOther)/mOther; 
  data->AEM_S(19,27) += (-(0.4472135954999579*cMrOther[21]*mSelf*mnuOther)/mOther)-(0.4472135954999579*cMrOther[20]*mSelf*mnuOther)/mOther-(0.5*cMrOther[16]*mSelf*mnuOther)/mOther; 
  data->AEM_S(19,28) += -(0.4472135954999579*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(19,29) += -(0.4472135954999579*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(19,30) += (-(0.4*cMrOther[23]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[17]*mSelf*mnuOther)/mOther; 
  data->AEM_S(19,31) += (-(0.4*cMrOther[22]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[18]*mSelf*mnuOther)/mOther; 
  data->AEM_S(20,24) += -(0.5*cMrOther[20]*mSelf*mnuOther)/mOther; 
  data->AEM_S(20,25) += -(0.4472135954999579*cMrOther[17]*mSelf*mnuOther)/mOther; 
  data->AEM_S(20,26) += -(0.5000000000000001*cMrOther[22]*mSelf*mnuOther)/mOther; 
  data->AEM_S(20,27) += -(0.4472135954999579*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(20,28) += (-(0.31943828249997*cMrOther[20]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[16]*mSelf*mnuOther)/mOther; 
  data->AEM_S(20,30) += (-(0.31943828249997*cMrOther[22]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[18]*mSelf*mnuOther)/mOther; 
  data->AEM_S(20,31) += -(0.4472135954999579*cMrOther[23]*mSelf*mnuOther)/mOther; 
  data->AEM_S(21,24) += -(0.5*cMrOther[21]*mSelf*mnuOther)/mOther; 
  data->AEM_S(21,25) += -(0.5000000000000001*cMrOther[23]*mSelf*mnuOther)/mOther; 
  data->AEM_S(21,26) += -(0.4472135954999579*cMrOther[18]*mSelf*mnuOther)/mOther; 
  data->AEM_S(21,27) += -(0.4472135954999579*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(21,29) += (-(0.31943828249997*cMrOther[21]*mSelf*mnuOther)/mOther)-(0.5*cMrOther[16]*mSelf*mnuOther)/mOther; 
  data->AEM_S(21,30) += -(0.4472135954999579*cMrOther[22]*mSelf*mnuOther)/mOther; 
  data->AEM_S(21,31) += (-(0.31943828249997*cMrOther[23]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[17]*mSelf*mnuOther)/mOther; 
  data->AEM_S(22,24) += -(0.5*cMrOther[22]*mSelf*mnuOther)/mOther; 
  data->AEM_S(22,25) += -(0.447213595499958*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(22,26) += -(0.5000000000000001*cMrOther[20]*mSelf*mnuOther)/mOther; 
  data->AEM_S(22,27) += (-(0.4*cMrOther[23]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[17]*mSelf*mnuOther)/mOther; 
  data->AEM_S(22,28) += (-(0.31943828249997*cMrOther[22]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[18]*mSelf*mnuOther)/mOther; 
  data->AEM_S(22,29) += -(0.4472135954999579*cMrOther[22]*mSelf*mnuOther)/mOther; 
  data->AEM_S(22,30) += (-(0.4472135954999579*cMrOther[21]*mSelf*mnuOther)/mOther)-(0.31943828249997*cMrOther[20]*mSelf*mnuOther)/mOther-(0.5*cMrOther[16]*mSelf*mnuOther)/mOther; 
  data->AEM_S(22,31) += -(0.4*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(23,24) += -(0.5*cMrOther[23]*mSelf*mnuOther)/mOther; 
  data->AEM_S(23,25) += -(0.5000000000000001*cMrOther[21]*mSelf*mnuOther)/mOther; 
  data->AEM_S(23,26) += -(0.447213595499958*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(23,27) += (-(0.4*cMrOther[22]*mSelf*mnuOther)/mOther)-(0.447213595499958*cMrOther[18]*mSelf*mnuOther)/mOther; 
  data->AEM_S(23,28) += -(0.4472135954999579*cMrOther[23]*mSelf*mnuOther)/mOther; 
  data->AEM_S(23,29) += (-(0.31943828249997*cMrOther[23]*mSelf*mnuOther)/mOther)-(0.5000000000000001*cMrOther[17]*mSelf*mnuOther)/mOther; 
  data->AEM_S(23,30) += -(0.4*cMrOther[19]*mSelf*mnuOther)/mOther; 
  data->AEM_S(23,31) += (-(0.31943828249997*cMrOther[21]*mSelf*mnuOther)/mOther)-(0.4472135954999579*cMrOther[20]*mSelf*mnuOther)/mOther-(0.5*cMrOther[16]*mSelf*mnuOther)/mOther; 
  ...
  // ... Block from weak multiply of mOther, nuOther, m1OtherZ and uCrossOtherZ ... // 
  data->AEM_S(24,16) += 0.5*m1rOther[16]*mnuOther; 
  data->AEM_S(24,17) += 0.5*m1rOther[17]*mnuOther; 
  data->AEM_S(24,18) += 0.5*m1rOther[18]*mnuOther; 
  data->AEM_S(24,19) += 0.5*m1rOther[19]*mnuOther; 
  data->AEM_S(24,20) += 0.5*m1rOther[20]*mnuOther; 
  data->AEM_S(24,21) += 0.5*m1rOther[21]*mnuOther; 
  data->AEM_S(24,22) += 0.5*m1rOther[22]*mnuOther; 
  data->AEM_S(24,23) += 0.5*m1rOther[23]*mnuOther; 
  data->AEM_S(25,16) += 0.5*m1rOther[17]*mnuOther; 
  data->AEM_S(25,17) += 0.4472135954999579*m1rOther[20]*mnuOther+0.5*m1rOther[16]*mnuOther; 
  data->AEM_S(25,18) += 0.5*m1rOther[19]*mnuOther; 
  data->AEM_S(25,19) += 0.447213595499958*m1rOther[22]*mnuOther+0.5*m1rOther[18]*mnuOther; 
  data->AEM_S(25,20) += 0.4472135954999579*m1rOther[17]*mnuOther; 
  data->AEM_S(25,21) += 0.5000000000000001*m1rOther[23]*mnuOther; 
  data->AEM_S(25,22) += 0.447213595499958*m1rOther[19]*mnuOther; 
  data->AEM_S(25,23) += 0.5000000000000001*m1rOther[21]*mnuOther; 
  data->AEM_S(26,16) += 0.5*m1rOther[18]*mnuOther; 
  data->AEM_S(26,17) += 0.5*m1rOther[19]*mnuOther; 
  data->AEM_S(26,18) += 0.4472135954999579*m1rOther[21]*mnuOther+0.5*m1rOther[16]*mnuOther; 
  data->AEM_S(26,19) += 0.447213595499958*m1rOther[23]*mnuOther+0.5*m1rOther[17]*mnuOther; 
  data->AEM_S(26,20) += 0.5000000000000001*m1rOther[22]*mnuOther; 
  data->AEM_S(26,21) += 0.4472135954999579*m1rOther[18]*mnuOther; 
  data->AEM_S(26,22) += 0.5000000000000001*m1rOther[20]*mnuOther; 
  data->AEM_S(26,23) += 0.447213595499958*m1rOther[19]*mnuOther; 
  data->AEM_S(27,16) += 0.5*m1rOther[19]*mnuOther; 
  data->AEM_S(27,17) += 0.447213595499958*m1rOther[22]*mnuOther+0.5*m1rOther[18]*mnuOther; 
  data->AEM_S(27,18) += 0.447213595499958*m1rOther[23]*mnuOther+0.5*m1rOther[17]*mnuOther; 
  data->AEM_S(27,19) += 0.4472135954999579*m1rOther[21]*mnuOther+0.4472135954999579*m1rOther[20]*mnuOther+0.5*m1rOther[16]*mnuOther; 
  data->AEM_S(27,20) += 0.4472135954999579*m1rOther[19]*mnuOther; 
  data->AEM_S(27,21) += 0.4472135954999579*m1rOther[19]*mnuOther; 
  data->AEM_S(27,22) += 0.4*m1rOther[23]*mnuOther+0.447213595499958*m1rOther[17]*mnuOther; 
  data->AEM_S(27,23) += 0.4*m1rOther[22]*mnuOther+0.447213595499958*m1rOther[18]*mnuOther; 
  data->AEM_S(28,16) += 0.5*m1rOther[20]*mnuOther; 
  data->AEM_S(28,17) += 0.4472135954999579*m1rOther[17]*mnuOther; 
  data->AEM_S(28,18) += 0.5000000000000001*m1rOther[22]*mnuOther; 
  data->AEM_S(28,19) += 0.4472135954999579*m1rOther[19]*mnuOther; 
  data->AEM_S(28,20) += 0.31943828249997*m1rOther[20]*mnuOther+0.5*m1rOther[16]*mnuOther; 
  data->AEM_S(28,22) += 0.31943828249997*m1rOther[22]*mnuOther+0.5000000000000001*m1rOther[18]*mnuOther; 
  data->AEM_S(28,23) += 0.4472135954999579*m1rOther[23]*mnuOther; 
  data->AEM_S(29,16) += 0.5*m1rOther[21]*mnuOther; 
  data->AEM_S(29,17) += 0.5000000000000001*m1rOther[23]*mnuOther; 
  data->AEM_S(29,18) += 0.4472135954999579*m1rOther[18]*mnuOther; 
  data->AEM_S(29,19) += 0.4472135954999579*m1rOther[19]*mnuOther; 
  data->AEM_S(29,21) += 0.31943828249997*m1rOther[21]*mnuOther+0.5*m1rOther[16]*mnuOther; 
  data->AEM_S(29,22) += 0.4472135954999579*m1rOther[22]*mnuOther; 
  data->AEM_S(29,23) += 0.31943828249997*m1rOther[23]*mnuOther+0.5000000000000001*m1rOther[17]*mnuOther; 
  data->AEM_S(30,16) += 0.5*m1rOther[22]*mnuOther; 
  data->AEM_S(30,17) += 0.447213595499958*m1rOther[19]*mnuOther; 
  data->AEM_S(30,18) += 0.5000000000000001*m1rOther[20]*mnuOther; 
  data->AEM_S(30,19) += 0.4*m1rOther[23]*mnuOther+0.447213595499958*m1rOther[17]*mnuOther; 
  data->AEM_S(30,20) += 0.31943828249997*m1rOther[22]*mnuOther+0.5000000000000001*m1rOther[18]*mnuOther; 
  data->AEM_S(30,21) += 0.4472135954999579*m1rOther[22]*mnuOther; 
  data->AEM_S(30,22) += 0.4472135954999579*m1rOther[21]*mnuOther+0.31943828249997*m1rOther[20]*mnuOther+0.5*m1rOther[16]*mnuOther; 
  data->AEM_S(30,23) += 0.4*m1rOther[19]*mnuOther; 
  data->AEM_S(31,16) += 0.5*m1rOther[23]*mnuOther; 
  data->AEM_S(31,17) += 0.5000000000000001*m1rOther[21]*mnuOther; 
  data->AEM_S(31,18) += 0.447213595499958*m1rOther[19]*mnuOther; 
  data->AEM_S(31,19) += 0.4*m1rOther[22]*mnuOther+0.447213595499958*m1rOther[18]*mnuOther; 
  data->AEM_S(31,20) += 0.4472135954999579*m1rOther[23]*mnuOther; 
  data->AEM_S(31,21) += 0.31943828249997*m1rOther[23]*mnuOther+0.5000000000000001*m1rOther[17]*mnuOther; 
  data->AEM_S(31,22) += 0.4*m1rOther[19]*mnuOther; 
  data->AEM_S(31,23) += 0.31943828249997*m1rOther[21]*mnuOther+0.4472135954999579*m1rOther[20]*mnuOther+0.5*m1rOther[16]*mnuOther; 
  ...
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(24,24) += (1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(24,25) += (1.5*m0rOther[1]*mSelf*mnuOther)/mOther-(0.5*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(24,26) += (1.5*m0rOther[2]*mSelf*mnuOther)/mOther-(0.5*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(24,27) += (1.5*m0rOther[3]*mSelf*mnuOther)/mOther-(0.5*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(24,28) += (1.5*m0rOther[4]*mSelf*mnuOther)/mOther-(0.5*cErOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(24,29) += (1.5*m0rOther[5]*mSelf*mnuOther)/mOther-(0.5*cErOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(24,30) += (1.5*m0rOther[6]*mSelf*mnuOther)/mOther-(0.5*cErOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(24,31) += (1.5*m0rOther[7]*mSelf*mnuOther)/mOther-(0.5*cErOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(25,24) += (1.5*m0rOther[1]*mSelf*mnuOther)/mOther-(0.5*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(25,25) += (1.341640786499874*m0rOther[4]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[4]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(25,26) += (1.5*m0rOther[3]*mSelf*mnuOther)/mOther-(0.5*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(25,27) += (1.341640786499874*m0rOther[6]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[6]*mSelf*mnuOther)/mOther+(1.5*m0rOther[2]*mSelf*mnuOther)/mOther-(0.5*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(25,28) += (1.341640786499874*m0rOther[1]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(25,29) += (1.5*m0rOther[7]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(25,30) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(25,31) += (1.5*m0rOther[5]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(26,24) += (1.5*m0rOther[2]*mSelf*mnuOther)/mOther-(0.5*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(26,25) += (1.5*m0rOther[3]*mSelf*mnuOther)/mOther-(0.5*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(26,26) += (1.341640786499874*m0rOther[5]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[5]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(26,27) += (1.341640786499874*m0rOther[7]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[7]*mSelf*mnuOther)/mOther+(1.5*m0rOther[1]*mSelf*mnuOther)/mOther-(0.5*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(26,28) += (1.5*m0rOther[6]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(26,29) += (1.341640786499874*m0rOther[2]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(26,30) += (1.5*m0rOther[4]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(26,31) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(27,24) += (1.5*m0rOther[3]*mSelf*mnuOther)/mOther-(0.5*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(27,25) += (1.341640786499874*m0rOther[6]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[6]*mSelf*mnuOther)/mOther+(1.5*m0rOther[2]*mSelf*mnuOther)/mOther-(0.5*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(27,26) += (1.341640786499874*m0rOther[7]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[7]*mSelf*mnuOther)/mOther+(1.5*m0rOther[1]*mSelf*mnuOther)/mOther-(0.5*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(27,27) += (1.341640786499874*m0rOther[5]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[5]*mSelf*mnuOther)/mOther+(1.341640786499874*m0rOther[4]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[4]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(27,28) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(27,29) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(27,30) += (1.2*m0rOther[7]*mSelf*mnuOther)/mOther-(0.4*cErOther[7]*mSelf*mnuOther)/mOther+(1.341640786499874*m0rOther[1]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(27,31) += (1.2*m0rOther[6]*mSelf*mnuOther)/mOther-(0.4*cErOther[6]*mSelf*mnuOther)/mOther+(1.341640786499874*m0rOther[2]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(28,24) += (1.5*m0rOther[4]*mSelf*mnuOther)/mOther-(0.5*cErOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(28,25) += (1.341640786499874*m0rOther[1]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(28,26) += (1.5*m0rOther[6]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(28,27) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(28,28) += (0.9583148474999099*m0rOther[4]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[4]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(28,30) += (0.9583148474999099*m0rOther[6]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[6]*mSelf*mnuOther)/mOther+(1.5*m0rOther[2]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(28,31) += (1.341640786499874*m0rOther[7]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(29,24) += (1.5*m0rOther[5]*mSelf*mnuOther)/mOther-(0.5*cErOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(29,25) += (1.5*m0rOther[7]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(29,26) += (1.341640786499874*m0rOther[2]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(29,27) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(29,29) += (0.9583148474999099*m0rOther[5]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[5]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(29,30) += (1.341640786499874*m0rOther[6]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(29,31) += (0.9583148474999099*m0rOther[7]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[7]*mSelf*mnuOther)/mOther+(1.5*m0rOther[1]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(30,24) += (1.5*m0rOther[6]*mSelf*mnuOther)/mOther-(0.5*cErOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(30,25) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(30,26) += (1.5*m0rOther[4]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[4]*mSelf*mnuOther)/mOther; 
  data->AEM_S(30,27) += (1.2*m0rOther[7]*mSelf*mnuOther)/mOther-(0.4*cErOther[7]*mSelf*mnuOther)/mOther+(1.341640786499874*m0rOther[1]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(30,28) += (0.9583148474999099*m0rOther[6]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[6]*mSelf*mnuOther)/mOther+(1.5*m0rOther[2]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(30,29) += (1.341640786499874*m0rOther[6]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[6]*mSelf*mnuOther)/mOther; 
  data->AEM_S(30,30) += (1.341640786499874*m0rOther[5]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[5]*mSelf*mnuOther)/mOther+(0.9583148474999099*m0rOther[4]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[4]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(30,31) += (1.2*m0rOther[3]*mSelf*mnuOther)/mOther-(0.4*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(31,24) += (1.5*m0rOther[7]*mSelf*mnuOther)/mOther-(0.5*cErOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(31,25) += (1.5*m0rOther[5]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[5]*mSelf*mnuOther)/mOther; 
  data->AEM_S(31,26) += (1.341640786499874*m0rOther[3]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(31,27) += (1.2*m0rOther[6]*mSelf*mnuOther)/mOther-(0.4*cErOther[6]*mSelf*mnuOther)/mOther+(1.341640786499874*m0rOther[2]*mSelf*mnuOther)/mOther-(0.447213595499958*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(31,28) += (1.341640786499874*m0rOther[7]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[7]*mSelf*mnuOther)/mOther; 
  data->AEM_S(31,29) += (0.9583148474999099*m0rOther[7]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[7]*mSelf*mnuOther)/mOther+(1.5*m0rOther[1]*mSelf*mnuOther)/mOther-(0.5000000000000001*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(31,30) += (1.2*m0rOther[3]*mSelf*mnuOther)/mOther-(0.4*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(31,31) += (0.9583148474999099*m0rOther[5]*mSelf*mnuOther)/mOther-(0.31943828249997*cErOther[5]*mSelf*mnuOther)/mOther+(1.341640786499874*m0rOther[4]*mSelf*mnuOther)/mOther-(0.4472135954999579*cErOther[4]*mSelf*mnuOther)/mOther+(1.5*m0rOther[0]*mSelf*mnuOther)/mOther-(0.5*cErOther[0]*mSelf*mnuOther)/mOther; 
