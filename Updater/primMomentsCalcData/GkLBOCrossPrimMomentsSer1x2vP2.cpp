...
{ 
  ...
  bool cellAvg;
  cellAvg = false;
  if (1.58113883008419*m0Self[2]-1.224744871391589*m0Self[1]+0.7071067811865475*m0Self[0] < 0) cellAvg = true; 
  if (1.58113883008419*m2Self[2]-1.224744871391589*m2Self[1]+0.7071067811865475*m2Self[0] < 0) cellAvg = true; 
  if (0.7071067811865475*m0Self[0]-0.7905694150420947*m0Self[2] < 0) cellAvg = true; 
  if (0.7071067811865475*m2Self[0]-0.7905694150420947*m2Self[2] < 0) cellAvg = true; 
  if (1.58113883008419*m0Self[2]+1.224744871391589*m0Self[1]+0.7071067811865475*m0Self[0] < 0) cellAvg = true; 
  if (1.58113883008419*m2Self[2]+1.224744871391589*m2Self[1]+0.7071067811865475*m2Self[0] < 0) cellAvg = true; 
  ...
  cellAvg = false;
  if (1.58113883008419*m0Other[2]-1.224744871391589*m0Other[1]+0.7071067811865475*m0Other[0] < 0) cellAvg = true; 
  if (1.58113883008419*m2Other[2]-1.224744871391589*m2Other[1]+0.7071067811865475*m2Other[0] < 0) cellAvg = true; 
  if (0.7071067811865475*m0Other[0]-0.7905694150420947*m0Other[2] < 0) cellAvg = true; 
  if (0.7071067811865475*m2Other[0]-0.7905694150420947*m2Other[2] < 0) cellAvg = true; 
  if (1.58113883008419*m0Other[2]+1.224744871391589*m0Other[1]+0.7071067811865475*m0Other[0] < 0) cellAvg = true; 
  if (1.58113883008419*m2Other[2]+1.224744871391589*m2Other[1]+0.7071067811865475*m2Other[0] < 0) cellAvg = true; 
...
void GkLBOECrossPrimMoments1x2vSer_P2(binOpData_t *data, binOpData_t *dataDiv,const double betaGreenep1, const double mSelf, const double nuSelf, const double *m0Self, const double *m1Self, const double *m2Self, const double *uSelf, const double *vtSqSelf, const double *cMSelf, const double *cESelf, const double mOther, const double nuOther, const double *m0Other, const double *m1Other, const double *m2Other, const double *uOther, const double *vtSqOther, const double *cMOther, const double *cEOther, double *uCrossSelf, double *vtSqCrossSelf, double *uCrossOther, double *vtSqCrossOther) 
{ 
  // betaGreenep1:       free parameter beta+1. This has to be >0. 
  // nu, m:              collisionality and mass. 
  // m0,m1,m2:           moments of the distribution function. 
  ...
  data->AEM_S(1,2) += 0.6324555320336759*m0rOther[1]*mnuOther; 
  data->AEM_S(2,0) += 0.7071067811865475*m0rOther[2]*mnuOther; 
  data->AEM_S(2,1) += 0.6324555320336759*m0rOther[1]*mnuOther; 
  data->AEM_S(2,2) += 0.4517539514526256*m0rOther[2]*mnuOther+0.7071067811865475*m0rOther[0]*mnuOther; 
 
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(0,3) += -(0.7071067811865475*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,4) += -(0.7071067811865475*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,5) += -(0.7071067811865475*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,3) += -(0.7071067811865475*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,4) += (-(0.6324555320336759*cMrOther[2]*mSelf*mnuOther)/mOther)-(0.7071067811865475*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,5) += -(0.6324555320336759*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,3) += -(0.7071067811865475*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,4) += -(0.6324555320336759*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,5) += (-(0.4517539514526256*cMrOther[2]*mSelf*mnuOther)/mOther)-(0.7071067811865475*cMrOther[0]*mSelf*mnuOther)/mOther; 
  ...
  // ... Block from weak multiply of mOther, nuOther, m1OtherX and uCrossOtherX ... // 
  data->AEM_S(3,0) += 0.7071067811865475*m1rOther[0]*mnuOther; 
  data->AEM_S(3,1) += 0.7071067811865475*m1rOther[1]*mnuOther; 
  data->AEM_S(3,2) += 0.7071067811865475*m1rOther[2]*mnuOther; 
  data->AEM_S(4,0) += 0.7071067811865475*m1rOther[1]*mnuOther; 
  data->AEM_S(4,1) += 0.6324555320336759*m1rOther[2]*mnuOther+0.7071067811865475*m1rOther[0]*mnuOther; 
  data->AEM_S(4,2) += 0.6324555320336759*m1rOther[1]*mnuOther; 
  data->AEM_S(5,0) += 0.7071067811865475*m1rOther[2]*mnuOther; 
  data->AEM_S(5,1) += 0.6324555320336759*m1rOther[1]*mnuOther; 
  data->AEM_S(5,2) += 0.4517539514526256*m1rOther[2]*mnuOther+0.7071067811865475*m1rOther[0]*mnuOther; 
  ...
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(3,3) += (2.121320343559642*m0rOther[0]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,4) += (2.121320343559642*m0rOther[1]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,5) += (2.121320343559642*m0rOther[2]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,3) += (2.121320343559642*m0rOther[1]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,4) += (1.897366596101028*m0rOther[2]*mSelf*mnuOther)/mOther-(0.6324555320336759*cErOther[2]*mSelf*mnuOther)/mOther+(2.121320343559642*m0rOther[0]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,5) += (1.897366596101028*m0rOther[1]*mSelf*mnuOther)/mOther-(0.6324555320336759*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,3) += (2.121320343559642*m0rOther[2]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,4) += (1.897366596101028*m0rOther[1]*mSelf*mnuOther)/mOther-(0.6324555320336759*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,5) += (1.355261854357877*m0rOther[2]*mSelf*mnuOther)/mOther-(0.4517539514526256*cErOther[2]*mSelf*mnuOther)/mOther+(2.121320343559642*m0rOther[0]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[0]*mSelf*mnuOther)/mOther; 
  ...
  // ....... RHS vector is composed of m1 and m2 .......... // 
  data->BEV_S << mnuM1sum[0],mnuM1sum[1],mnuM1sum[2],mnuM2sum[0],mnuM2sum[1],mnuM2sum[2]; 
