...
void SelfPrimMoments1x3vMax_P1(const int pVdim, const double *m0, const double *m1, const double *m2, const double *m0S, const double *m1S, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
...
void SelfPrimMoments1x3vMax_P2(const int pVdim, const double *m0, const double *m1, const double *m2, const double *m0S, const double *m1S, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  // m0,m1,m2: moments of the distribution function. 
  // m0S,m1S:  star moments (only used for piecewise linear). 
  // cM, cE:   vtSq*cM and vtSq*cE are corrections to u and vtSq, respectively. 
...
void SelfPrimMoments1x3vMax_P3(const int pVdim, const double *m0, const double *m1, const double *m2, const double *m0S, const double *m1S, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  // m0,m1,m2: moments of the distribution function. 
  // m0S,m1S:  star moments (only used for piecewise linear). 
  // cM, cE:   vtSq*cM and vtSq*cE are corrections to u and vtSq, respectively. 
...
{ 
  ...
  out[2] += (1.414213562373095*fvmax[11]-1.414213562373095*fvmin[11])*dS; 
...
{ 
  ...
  out[3] += (1.414213562373095*fvmax[31]-1.414213562373095*fvmin[31])*dS; 
...
{ 
  ...
  out[1] += dS*((-1.414213562373095*fvmin[1]*vmin)+1.414213562373095*fvmax[1]*vmax-0.7071067811865475*dxv[1]*fvmin[1]-0.7071067811865475*dxv[1]*fvmax[1]); 
...
{ 
  ...
  out[1] += dS*(2.449489742783178*fvmin[5]*vmin-1.414213562373095*fvmin[1]*vmin+2.449489742783178*fvmax[5]*vmax+1.414213562373095*fvmax[1]*vmax); 
  out[2] += dS*(1.414213562373095*fvmax[11]*vmax-1.414213562373095*fvmin[11]*vmin); 
...
{ 
  ...
  out[3] += dS*(1.414213562373095*fvmax[31]*vmax-1.414213562373095*fvmin[31]*vmin); 
...
{ 
  ...
  out[3] += (1.414213562373095*fvmax[1]-1.414213562373095*fvmin[1])*dS; 
...
{ 
  ...
  out[4] += (2.449489742783178*fvmin[6]+2.449489742783178*fvmax[6]-1.414213562373095*fvmin[1]+1.414213562373095*fvmax[1])*dS; 
  out[5] += (1.414213562373095*fvmax[11]-1.414213562373095*fvmin[11])*dS; 
...
{ 
  ...
  out[5] += ((-3.16227766016838*fvmin[23])+3.16227766016838*fvmax[23]+2.449489742783178*fvmin[6]+2.449489742783178*fvmax[6]-1.414213562373095*fvmin[1]+1.414213562373095*fvmax[1])*dS; 
  out[6] += (2.449489742783178*fvmin[21]+2.449489742783178*fvmax[21]-1.414213562373095*fvmin[11]+1.414213562373095*fvmax[11])*dS; 
  out[7] += (1.414213562373095*fvmax[31]-1.414213562373095*fvmin[31])*dS; 
...
{ 
  ...
  out[1] += dS*(2.449489742783178*fvmin[6]*vmin-1.414213562373095*fvmin[1]*vmin+2.449489742783178*fvmax[6]*vmax+1.414213562373095*fvmax[1]*vmax); 
  out[2] += dS*(1.414213562373095*fvmax[11]*vmax-1.414213562373095*fvmin[11]*vmin); 
...
{ 
  ...
  out[7] += (2.449489742783178*fvmin[8]+2.449489742783178*fvmax[8]-1.414213562373095*fvmin[1]+1.414213562373095*fvmax[1])*dS; 
  out[8] += (1.414213562373095*fvmax[11]-1.414213562373095*fvmin[11])*dS; 
...
{ 
  ...
  out[9] += ((-3.16227766016838*fvmin[28])+3.16227766016838*fvmax[28]+2.449489742783178*fvmin[8]+2.449489742783178*fvmax[8]-1.414213562373095*fvmin[1]+1.414213562373095*fvmax[1])*dS; 
  out[10] += (2.449489742783178*fvmin[25]+2.449489742783178*fvmax[25]-1.414213562373095*fvmin[11]+1.414213562373095*fvmax[11])*dS; 
  out[11] += (1.414213562373095*fvmax[31]-1.414213562373095*fvmin[31])*dS; 
...
{ 
  ...
  out[1] += dS*(2.449489742783178*fvmin[8]*vmin-1.414213562373095*fvmin[1]*vmin+2.449489742783178*fvmax[8]*vmax+1.414213562373095*fvmax[1]*vmax); 
  out[2] += dS*(1.414213562373095*fvmax[11]*vmax-1.414213562373095*fvmin[11]*vmin); 
