...
{ 
  ...
  { 
    unsigned short int a0 = 2*vd; 
    // Contribution to dot-product from weak multiplication of vd component. 
    relDriftSq[0] += 0.7071067811865475*m1rSelf[a0+1]*uSelf[a0+1]-0.7071067811865475*m1rOther[a0+1]*uSelf[a0+1]-0.7071067811865475*m1rSelf[a0+1]*uOther[a0+1]+0.7071067811865475*m1rOther[a0+1]*uOther[a0+1]+0.7071067811865475*m1rSelf[a0]*uSelf[a0]-0.7071067811865475*m1rOther[a0]*uSelf[a0]-0.7071067811865475*m1rSelf[a0]*uOther[a0]+0.7071067811865475*m1rOther[a0]*uOther[a0]; 
    relDriftSq[1] += 0.7071067811865475*m1rSelf[a0]*uSelf[a0+1]-0.7071067811865475*m1rOther[a0]*uSelf[a0+1]-0.7071067811865475*m1rSelf[a0]*uOther[a0+1]+0.7071067811865475*m1rOther[a0]*uOther[a0+1]+0.7071067811865475*uSelf[a0]*m1rSelf[a0+1]-0.7071067811865475*uOther[a0]*m1rSelf[a0+1]-0.7071067811865475*uSelf[a0]*m1rOther[a0+1]+0.7071067811865475*uOther[a0]*m1rOther[a0+1]; 
  } 
 
  double m2Relax[2]; 
  // ... Contribution to RHS vector from energy relaxation. 
  m2Relax[0] = betaGreenep1*((-(0.5*relDriftSq[0]*mSelf)/(mSelf+mOther))-(1.0*m2SrSelf[0]*mSelf)/(mSelf+mOther)+(kinESelf[0]*mSelf)/(mSelf+mOther)+(0.5*relDriftSq[0]*mOther)/(mSelf+mOther)+(m2SrOther[0]*mOther)/(mSelf+mOther)-(1.0*kinEOther[0]*mOther)/(mSelf+mOther))*mnuSelf+(m2SrSelf[0]-1.0*kinESelf[0])*mnuSelf+(kinEOther[0]-1.0*m2SrOther[0])*mnuOther; 
  m2Relax[1] = betaGreenep1*((-(0.5*relDriftSq[1]*mSelf)/(mSelf+mOther))-(1.0*m2SrSelf[1]*mSelf)/(mSelf+mOther)+(kinESelf[1]*mSelf)/(mSelf+mOther)+(0.5*relDriftSq[1]*mOther)/(mSelf+mOther)+(m2SrOther[1]*mOther)/(mSelf+mOther)-(1.0*kinEOther[1]*mOther)/(mSelf+mOther))*mnuSelf+(m2SrSelf[1]-1.0*kinESelf[1])*mnuSelf+(kinEOther[1]-1.0*m2SrOther[1])*mnuOther; 
...
{ 
  ...
  { 
    unsigned short int a0 = 3*vd; 
    // Contribution to dot-product from weak multiplication of vd component. 
    relDriftSq[0] += 0.7071067811865475*m1rSelf[a0+2]*uSelf[a0+2]-0.7071067811865475*m1rOther[a0+2]*uSelf[a0+2]-0.7071067811865475*m1rSelf[a0+2]*uOther[a0+2]+0.7071067811865475*m1rOther[a0+2]*uOther[a0+2]+0.7071067811865475*m1rSelf[a0+1]*uSelf[a0+1]-0.7071067811865475*m1rOther[a0+1]*uSelf[a0+1]-0.7071067811865475*m1rSelf[a0+1]*uOther[a0+1]+0.7071067811865475*m1rOther[a0+1]*uOther[a0+1]+0.7071067811865475*m1rSelf[a0]*uSelf[a0]-0.7071067811865475*m1rOther[a0]*uSelf[a0]-0.7071067811865475*m1rSelf[a0]*uOther[a0]+0.7071067811865475*m1rOther[a0]*uOther[a0]; 
    relDriftSq[1] += 0.6324555320336759*m1rSelf[a0+1]*uSelf[a0+2]-0.6324555320336759*m1rOther[a0+1]*uSelf[a0+2]-0.6324555320336759*m1rSelf[a0+1]*uOther[a0+2]+0.6324555320336759*m1rOther[a0+1]*uOther[a0+2]+0.6324555320336759*uSelf[a0+1]*m1rSelf[a0+2]-0.6324555320336759*uOther[a0+1]*m1rSelf[a0+2]-0.6324555320336759*uSelf[a0+1]*m1rOther[a0+2]+0.6324555320336759*uOther[a0+1]*m1rOther[a0+2]+0.7071067811865475*m1rSelf[a0]*uSelf[a0+1]-0.7071067811865475*m1rOther[a0]*uSelf[a0+1]-0.7071067811865475*m1rSelf[a0]*uOther[a0+1]+0.7071067811865475*m1rOther[a0]*uOther[a0+1]+0.7071067811865475*uSelf[a0]*m1rSelf[a0+1]-0.7071067811865475*uOther[a0]*m1rSelf[a0+1]-0.7071067811865475*uSelf[a0]*m1rOther[a0+1]+0.7071067811865475*uOther[a0]*m1rOther[a0+1]; 
    relDriftSq[2] += 0.4517539514526256*m1rSelf[a0+2]*uSelf[a0+2]-0.4517539514526256*m1rOther[a0+2]*uSelf[a0+2]+0.7071067811865475*m1rSelf[a0]*uSelf[a0+2]-0.7071067811865475*m1rOther[a0]*uSelf[a0+2]-0.4517539514526256*m1rSelf[a0+2]*uOther[a0+2]+0.4517539514526256*m1rOther[a0+2]*uOther[a0+2]-0.7071067811865475*m1rSelf[a0]*uOther[a0+2]+0.7071067811865475*m1rOther[a0]*uOther[a0+2]+0.7071067811865475*uSelf[a0]*m1rSelf[a0+2]-0.7071067811865475*uOther[a0]*m1rSelf[a0+2]-0.7071067811865475*uSelf[a0]*m1rOther[a0+2]+0.7071067811865475*uOther[a0]*m1rOther[a0+2]+0.6324555320336759*m1rSelf[a0+1]*uSelf[a0+1]-0.6324555320336759*m1rOther[a0+1]*uSelf[a0+1]-0.6324555320336759*m1rSelf[a0+1]*uOther[a0+1]+0.6324555320336759*m1rOther[a0+1]*uOther[a0+1]; 
  } 
 
  double m2Relax[3]; 
  // ... Contribution to RHS vector from energy relaxation. 
  m2Relax[0] = betaGreenep1*((-(0.5*relDriftSq[0]*mSelf)/(mSelf+mOther))-(1.0*m2rSelf[0]*mSelf)/(mSelf+mOther)+(kinESelf[0]*mSelf)/(mSelf+mOther)+(0.5*relDriftSq[0]*mOther)/(mSelf+mOther)+(m2rOther[0]*mOther)/(mSelf+mOther)-(1.0*kinEOther[0]*mOther)/(mSelf+mOther))*mnuSelf+(m2rSelf[0]-1.0*kinESelf[0])*mnuSelf+(kinEOther[0]-1.0*m2rOther[0])*mnuOther; 
  m2Relax[1] = betaGreenep1*((-(0.5*relDriftSq[1]*mSelf)/(mSelf+mOther))-(1.0*m2rSelf[1]*mSelf)/(mSelf+mOther)+(kinESelf[1]*mSelf)/(mSelf+mOther)+(0.5*relDriftSq[1]*mOther)/(mSelf+mOther)+(m2rOther[1]*mOther)/(mSelf+mOther)-(1.0*kinEOther[1]*mOther)/(mSelf+mOther))*mnuSelf+(m2rSelf[1]-1.0*kinESelf[1])*mnuSelf+(kinEOther[1]-1.0*m2rOther[1])*mnuOther; 
  m2Relax[2] = betaGreenep1*((-(0.5*relDriftSq[2]*mSelf)/(mSelf+mOther))-(1.0*m2rSelf[2]*mSelf)/(mSelf+mOther)+(kinESelf[2]*mSelf)/(mSelf+mOther)+(0.5*relDriftSq[2]*mOther)/(mSelf+mOther)+(m2rOther[2]*mOther)/(mSelf+mOther)-(1.0*kinEOther[2]*mOther)/(mSelf+mOther))*mnuSelf+(m2rSelf[2]-1.0*kinESelf[2])*mnuSelf+(kinEOther[2]-1.0*m2rOther[2])*mnuOther; 
