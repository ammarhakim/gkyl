...
void GkLBOECrossPrimMoments1x2vSer_P3(binOpData_t *data, binOpData_t *dataDiv,const double betaGreenep1, const double mSelf, const double nuSelf, const double *m0Self, const double *m1Self, const double *m2Self, const double *uSelf, const double *vtSqSelf, const double *cMSelf, const double *cESelf, const double mOther, const double nuOther, const double *m0Other, const double *m1Other, const double *m2Other, const double *uOther, const double *vtSqOther, const double *cMOther, const double *cEOther, double *uCrossSelf, double *vtSqCrossSelf, double *uCrossOther, double *vtSqCrossOther) 
{ 
  // betaGreenep1:       free parameter beta+1. This has to be >0. 
  // nu, m:              collisionality and mass. 
  // m0,m1,m2:           moments of the distribution function. 
  ...
  // ... Block from correction to momentum conservation (other) ... // 
  data->AEM_S(0,4) += -(0.7071067811865475*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,5) += -(0.7071067811865475*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,6) += -(0.7071067811865475*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(0,7) += -(0.7071067811865475*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,4) += -(0.7071067811865475*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,5) += (-(0.6324555320336759*cMrOther[2]*mSelf*mnuOther)/mOther)-(0.7071067811865475*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,6) += (-(0.6210590034081186*cMrOther[3]*mSelf*mnuOther)/mOther)-(0.6324555320336759*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(1,7) += -(0.6210590034081186*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,4) += -(0.7071067811865475*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,5) += (-(0.6210590034081186*cMrOther[3]*mSelf*mnuOther)/mOther)-(0.6324555320336759*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,6) += (-(0.4517539514526256*cMrOther[2]*mSelf*mnuOther)/mOther)-(0.7071067811865475*cMrOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(2,7) += (-(0.421637021355784*cMrOther[3]*mSelf*mnuOther)/mOther)-(0.6210590034081186*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,4) += -(0.7071067811865475*cMrOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,5) += -(0.6210590034081186*cMrOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,6) += (-(0.421637021355784*cMrOther[3]*mSelf*mnuOther)/mOther)-(0.6210590034081186*cMrOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(3,7) += (-(0.421637021355784*cMrOther[2]*mSelf*mnuOther)/mOther)-(0.7071067811865475*cMrOther[0]*mSelf*mnuOther)/mOther; 
  ...
  // ... Block from weak multiply of mOther, nuOther, m1OtherX and uCrossOtherX ... // 
  data->AEM_S(4,0) += 0.7071067811865475*m1rOther[0]*mnuOther; 
  data->AEM_S(4,1) += 0.7071067811865475*m1rOther[1]*mnuOther; 
  data->AEM_S(4,2) += 0.7071067811865475*m1rOther[2]*mnuOther; 
  data->AEM_S(4,3) += 0.7071067811865475*m1rOther[3]*mnuOther; 
  data->AEM_S(5,0) += 0.7071067811865475*m1rOther[1]*mnuOther; 
  data->AEM_S(5,1) += 0.6324555320336759*m1rOther[2]*mnuOther+0.7071067811865475*m1rOther[0]*mnuOther; 
  data->AEM_S(5,2) += 0.6210590034081186*m1rOther[3]*mnuOther+0.6324555320336759*m1rOther[1]*mnuOther; 
  data->AEM_S(5,3) += 0.6210590034081186*m1rOther[2]*mnuOther; 
  data->AEM_S(6,0) += 0.7071067811865475*m1rOther[2]*mnuOther; 
  data->AEM_S(6,1) += 0.6210590034081186*m1rOther[3]*mnuOther+0.6324555320336759*m1rOther[1]*mnuOther; 
  data->AEM_S(6,2) += 0.4517539514526256*m1rOther[2]*mnuOther+0.7071067811865475*m1rOther[0]*mnuOther; 
  data->AEM_S(6,3) += 0.421637021355784*m1rOther[3]*mnuOther+0.6210590034081186*m1rOther[1]*mnuOther; 
  data->AEM_S(7,0) += 0.7071067811865475*m1rOther[3]*mnuOther; 
  data->AEM_S(7,1) += 0.6210590034081186*m1rOther[2]*mnuOther; 
  data->AEM_S(7,2) += 0.421637021355784*m1rOther[3]*mnuOther+0.6210590034081186*m1rOther[1]*mnuOther; 
  data->AEM_S(7,3) += 0.421637021355784*m1rOther[2]*mnuOther+0.7071067811865475*m1rOther[0]*mnuOther; 
  ...
  // ... Block from correction to energy conservation (other) ... // 
  data->AEM_S(4,4) += (2.121320343559642*m0rOther[0]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,5) += (2.121320343559642*m0rOther[1]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,6) += (2.121320343559642*m0rOther[2]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(4,7) += (2.121320343559642*m0rOther[3]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,4) += (2.121320343559642*m0rOther[1]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,5) += (1.897366596101028*m0rOther[2]*mSelf*mnuOther)/mOther-(0.6324555320336759*cErOther[2]*mSelf*mnuOther)/mOther+(2.121320343559642*m0rOther[0]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,6) += (1.863177010224355*m0rOther[3]*mSelf*mnuOther)/mOther-(0.6210590034081186*cErOther[3]*mSelf*mnuOther)/mOther+(1.897366596101028*m0rOther[1]*mSelf*mnuOther)/mOther-(0.6324555320336759*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(5,7) += (1.863177010224355*m0rOther[2]*mSelf*mnuOther)/mOther-(0.6210590034081186*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,4) += (2.121320343559642*m0rOther[2]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,5) += (1.863177010224355*m0rOther[3]*mSelf*mnuOther)/mOther-(0.6210590034081186*cErOther[3]*mSelf*mnuOther)/mOther+(1.897366596101028*m0rOther[1]*mSelf*mnuOther)/mOther-(0.6324555320336759*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,6) += (1.355261854357877*m0rOther[2]*mSelf*mnuOther)/mOther-(0.4517539514526256*cErOther[2]*mSelf*mnuOther)/mOther+(2.121320343559642*m0rOther[0]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[0]*mSelf*mnuOther)/mOther; 
  data->AEM_S(6,7) += (1.264911064067352*m0rOther[3]*mSelf*mnuOther)/mOther-(0.421637021355784*cErOther[3]*mSelf*mnuOther)/mOther+(1.863177010224355*m0rOther[1]*mSelf*mnuOther)/mOther-(0.6210590034081186*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,4) += (2.121320343559642*m0rOther[3]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[3]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,5) += (1.863177010224355*m0rOther[2]*mSelf*mnuOther)/mOther-(0.6210590034081186*cErOther[2]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,6) += (1.264911064067352*m0rOther[3]*mSelf*mnuOther)/mOther-(0.421637021355784*cErOther[3]*mSelf*mnuOther)/mOther+(1.863177010224355*m0rOther[1]*mSelf*mnuOther)/mOther-(0.6210590034081186*cErOther[1]*mSelf*mnuOther)/mOther; 
  data->AEM_S(7,7) += (1.264911064067352*m0rOther[2]*mSelf*mnuOther)/mOther-(0.421637021355784*cErOther[2]*mSelf*mnuOther)/mOther+(2.121320343559642*m0rOther[0]*mSelf*mnuOther)/mOther-(0.7071067811865475*cErOther[0]*mSelf*mnuOther)/mOther; 
  ...
  // ....... RHS vector is composed of m1 and m2 .......... // 
  data->BEV_S << mnuM1sum[0],mnuM1sum[1],mnuM1sum[2],mnuM1sum[3],mnuM2sum[0],mnuM2sum[1],mnuM2sum[2],mnuM2sum[3]; 
