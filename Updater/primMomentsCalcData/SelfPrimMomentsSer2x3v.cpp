...
{ 
  ...
  BigAEM(13,4) = 0.5*m1s[5]; 
  BigAEM(13,5) = 0.5*m1s[4]; 
  BigAEM(13,6) = 0.5*m1s[7]; 
  BigAEM(13,7) = 0.5*m1s[6]; 
  BigAEM(14,4) = 0.5*m1s[6]; 
  BigAEM(14,5) = 0.5*m1s[7]; 
  BigAEM(14,6) = 0.5*m1s[4]; 
  BigAEM(14,7) = 0.5*m1s[5]; 
  BigAEM(15,4) = 0.5*m1s[7]; 
  BigAEM(15,5) = 0.5*m1s[6]; 
  BigAEM(15,6) = 0.5*m1s[5]; 
  BigAEM(15,7) = 0.5*m1s[4]; 
  ...
  BigAEM(13,10) = 0.5*m1s[11]; 
  BigAEM(13,11) = 0.5*m1s[10]; 
  BigAEM(14,8) = 0.5*m1s[10]; 
  BigAEM(14,9) = 0.5*m1s[11]; 
  BigAEM(14,10) = 0.5*m1s[8]; 
  BigAEM(14,11) = 0.5*m1s[9]; 
  BigAEM(15,8) = 0.5*m1s[11]; 
  BigAEM(15,9) = 0.5*m1s[10]; 
  BigAEM(15,10) = 0.5*m1s[9]; 
  BigAEM(15,11) = 0.5*m1s[8]; 
...
{ 
  ...
  BigAEM(25,4) = 0.4472135954999579*m1s[1]; 
  BigAEM(25,5) = 0.5000000000000001*m1s[7]; 
  BigAEM(25,6) = 0.447213595499958*m1s[3]; 
  ...
  BigAEM(26,5) = 0.4472135954999579*m1s[2]; 
  BigAEM(26,6) = 0.5000000000000001*m1s[4]; 
  BigAEM(26,7) = 0.447213595499958*m1s[3]; 
  ...
  BigAEM(27,4) = 0.4472135954999579*m1s[3]; 
  BigAEM(27,5) = 0.4472135954999579*m1s[3]; 
  BigAEM(27,6) = 0.4*m1s[7]+0.447213595499958*m1s[1]; 
  BigAEM(27,7) = 0.4*m1s[6]+0.447213595499958*m1s[2]; 
  BigAEM(28,0) = 0.5*m1s[4]; 
  BigAEM(28,1) = 0.4472135954999579*m1s[1]; 
  BigAEM(28,2) = 0.5000000000000001*m1s[6]; 
  BigAEM(28,3) = 0.4472135954999579*m1s[3]; 
  ...
  BigAEM(29,2) = 0.4472135954999579*m1s[2]; 
  BigAEM(29,3) = 0.4472135954999579*m1s[3]; 
  ...
  BigAEM(30,1) = 0.447213595499958*m1s[3]; 
  BigAEM(30,2) = 0.5000000000000001*m1s[4]; 
  BigAEM(30,3) = 0.4*m1s[7]+0.447213595499958*m1s[1]; 
  ...
  BigAEM(25,8) = 0.5*m1s[9]; 
  BigAEM(25,9) = 0.4472135954999579*m1s[12]+0.5*m1s[8]; 
  BigAEM(25,10) = 0.5*m1s[11]; 
  BigAEM(25,11) = 0.447213595499958*m1s[14]+0.5*m1s[10]; 
  BigAEM(25,12) = 0.4472135954999579*m1s[9]; 
  BigAEM(25,13) = 0.5000000000000001*m1s[15]; 
  BigAEM(25,14) = 0.447213595499958*m1s[11]; 
  BigAEM(25,15) = 0.5000000000000001*m1s[13]; 
  BigAEM(26,8) = 0.5*m1s[10]; 
  BigAEM(26,9) = 0.5*m1s[11]; 
  BigAEM(26,10) = 0.4472135954999579*m1s[13]+0.5*m1s[8]; 
  BigAEM(26,11) = 0.447213595499958*m1s[15]+0.5*m1s[9]; 
  BigAEM(26,12) = 0.5000000000000001*m1s[14]; 
  BigAEM(26,13) = 0.4472135954999579*m1s[10]; 
  BigAEM(26,14) = 0.5000000000000001*m1s[12]; 
  BigAEM(26,15) = 0.447213595499958*m1s[11]; 
  BigAEM(27,8) = 0.5*m1s[11]; 
  BigAEM(27,9) = 0.447213595499958*m1s[14]+0.5*m1s[10]; 
  BigAEM(27,10) = 0.447213595499958*m1s[15]+0.5*m1s[9]; 
  BigAEM(27,11) = 0.4472135954999579*m1s[13]+0.4472135954999579*m1s[12]+0.5*m1s[8]; 
  BigAEM(27,12) = 0.4472135954999579*m1s[11]; 
  BigAEM(27,13) = 0.4472135954999579*m1s[11]; 
  BigAEM(27,14) = 0.4*m1s[15]+0.447213595499958*m1s[9]; 
  BigAEM(27,15) = 0.4*m1s[14]+0.447213595499958*m1s[10]; 
  BigAEM(28,8) = 0.5*m1s[12]; 
  BigAEM(28,9) = 0.4472135954999579*m1s[9]; 
  BigAEM(28,10) = 0.5000000000000001*m1s[14]; 
  BigAEM(28,11) = 0.4472135954999579*m1s[11]; 
  BigAEM(28,12) = 0.31943828249997*m1s[12]+0.5*m1s[8]; 
  BigAEM(28,14) = 0.31943828249997*m1s[14]+0.5000000000000001*m1s[10]; 
  BigAEM(28,15) = 0.4472135954999579*m1s[15]; 
  BigAEM(29,8) = 0.5*m1s[13]; 
  BigAEM(29,9) = 0.5000000000000001*m1s[15]; 
  BigAEM(29,10) = 0.4472135954999579*m1s[10]; 
  BigAEM(29,11) = 0.4472135954999579*m1s[11]; 
  BigAEM(29,13) = 0.31943828249997*m1s[13]+0.5*m1s[8]; 
  BigAEM(29,14) = 0.4472135954999579*m1s[14]; 
  BigAEM(29,15) = 0.31943828249997*m1s[15]+0.5000000000000001*m1s[9]; 
  BigAEM(30,8) = 0.5*m1s[14]; 
  BigAEM(30,9) = 0.447213595499958*m1s[11]; 
  BigAEM(30,10) = 0.5000000000000001*m1s[12]; 
  BigAEM(30,11) = 0.4*m1s[15]+0.447213595499958*m1s[9]; 
  BigAEM(30,12) = 0.31943828249997*m1s[14]+0.5000000000000001*m1s[10]; 
  BigAEM(30,13) = 0.4472135954999579*m1s[14]; 
  BigAEM(30,14) = 0.4472135954999579*m1s[13]+0.31943828249997*m1s[12]+0.5*m1s[8]; 
  BigAEM(30,15) = 0.4*m1s[11]; 
  BigAEM(31,8) = 0.5*m1s[15]; 
  BigAEM(31,9) = 0.5000000000000001*m1s[13]; 
  BigAEM(31,10) = 0.447213595499958*m1s[11]; 
  BigAEM(31,11) = 0.4*m1s[14]+0.447213595499958*m1s[10]; 
  BigAEM(31,12) = 0.4472135954999579*m1s[15]; 
  BigAEM(31,13) = 0.31943828249997*m1s[15]+0.5000000000000001*m1s[9]; 
  BigAEM(31,14) = 0.4*m1s[11]; 
  BigAEM(31,15) = 0.31943828249997*m1s[13]+0.4472135954999579*m1s[12]+0.5*m1s[8]; 
  ...
  BigAEM(25,16) = 0.5*m1s[17]; 
  BigAEM(25,17) = 0.4472135954999579*m1s[20]+0.5*m1s[16]; 
  BigAEM(25,18) = 0.5*m1s[19]; 
  BigAEM(25,19) = 0.447213595499958*m1s[22]+0.5*m1s[18]; 
  BigAEM(25,20) = 0.4472135954999579*m1s[17]; 
  BigAEM(25,21) = 0.5000000000000001*m1s[23]; 
  BigAEM(25,22) = 0.447213595499958*m1s[19]; 
  BigAEM(25,23) = 0.5000000000000001*m1s[21]; 
  BigAEM(26,16) = 0.5*m1s[18]; 
  BigAEM(26,17) = 0.5*m1s[19]; 
  BigAEM(26,18) = 0.4472135954999579*m1s[21]+0.5*m1s[16]; 
  BigAEM(26,19) = 0.447213595499958*m1s[23]+0.5*m1s[17]; 
  BigAEM(26,20) = 0.5000000000000001*m1s[22]; 
  BigAEM(26,21) = 0.4472135954999579*m1s[18]; 
  BigAEM(26,22) = 0.5000000000000001*m1s[20]; 
  BigAEM(26,23) = 0.447213595499958*m1s[19]; 
  BigAEM(27,16) = 0.5*m1s[19]; 
  BigAEM(27,17) = 0.447213595499958*m1s[22]+0.5*m1s[18]; 
  BigAEM(27,18) = 0.447213595499958*m1s[23]+0.5*m1s[17]; 
  BigAEM(27,19) = 0.4472135954999579*m1s[21]+0.4472135954999579*m1s[20]+0.5*m1s[16]; 
  BigAEM(27,20) = 0.4472135954999579*m1s[19]; 
  BigAEM(27,21) = 0.4472135954999579*m1s[19]; 
  BigAEM(27,22) = 0.4*m1s[23]+0.447213595499958*m1s[17]; 
  BigAEM(27,23) = 0.4*m1s[22]+0.447213595499958*m1s[18]; 
  BigAEM(28,16) = 0.5*m1s[20]; 
  BigAEM(28,17) = 0.4472135954999579*m1s[17]; 
  BigAEM(28,18) = 0.5000000000000001*m1s[22]; 
  BigAEM(28,19) = 0.4472135954999579*m1s[19]; 
  BigAEM(28,20) = 0.31943828249997*m1s[20]+0.5*m1s[16]; 
  BigAEM(28,22) = 0.31943828249997*m1s[22]+0.5000000000000001*m1s[18]; 
  BigAEM(28,23) = 0.4472135954999579*m1s[23]; 
  BigAEM(29,16) = 0.5*m1s[21]; 
  BigAEM(29,17) = 0.5000000000000001*m1s[23]; 
  BigAEM(29,18) = 0.4472135954999579*m1s[18]; 
  BigAEM(29,19) = 0.4472135954999579*m1s[19]; 
  BigAEM(29,21) = 0.31943828249997*m1s[21]+0.5*m1s[16]; 
  BigAEM(29,22) = 0.4472135954999579*m1s[22]; 
  BigAEM(29,23) = 0.31943828249997*m1s[23]+0.5000000000000001*m1s[17]; 
  BigAEM(30,16) = 0.5*m1s[22]; 
  BigAEM(30,17) = 0.447213595499958*m1s[19]; 
  BigAEM(30,18) = 0.5000000000000001*m1s[20]; 
  BigAEM(30,19) = 0.4*m1s[23]+0.447213595499958*m1s[17]; 
  BigAEM(30,20) = 0.31943828249997*m1s[22]+0.5000000000000001*m1s[18]; 
  BigAEM(30,21) = 0.4472135954999579*m1s[22]; 
  BigAEM(30,22) = 0.4472135954999579*m1s[21]+0.31943828249997*m1s[20]+0.5*m1s[16]; 
  BigAEM(30,23) = 0.4*m1s[19]; 
  BigAEM(31,16) = 0.5*m1s[23]; 
  BigAEM(31,17) = 0.5000000000000001*m1s[21]; 
  BigAEM(31,18) = 0.447213595499958*m1s[19]; 
  BigAEM(31,19) = 0.4*m1s[22]+0.447213595499958*m1s[18]; 
  BigAEM(31,20) = 0.4472135954999579*m1s[23]; 
  BigAEM(31,21) = 0.31943828249997*m1s[23]+0.5000000000000001*m1s[17]; 
  BigAEM(31,22) = 0.4*m1s[19]; 
  BigAEM(31,23) = 0.31943828249997*m1s[21]+0.4472135954999579*m1s[20]+0.5*m1s[16]; 
  ...
  // ....... RHS vector is composed of m1 and m2 .......... // 
  bEV << m1s[0],m1s[1],m1s[2],m1s[3],m1s[4],m1s[5],m1s[6],m1s[7],m1s[8],m1s[9],m1s[10],m1s[11],m1s[12],m1s[13],m1s[14],m1s[15],m1s[16],m1s[17],m1s[18],m1s[19],m1s[20],m1s[21],m1s[22],m1s[23],m2s[0],m2s[1],m2s[2],m2s[3],m2s[4],m2s[5],m2s[6],m2s[7]; 
