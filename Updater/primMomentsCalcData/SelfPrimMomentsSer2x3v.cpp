...
void SelfPrimMoments2x3vSer_P1(const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  ...
  BigAEM(12,12) = 1.5*m0[0]-0.5*cE[0]; 
  BigAEM(12,13) = 1.5*m0[1]-0.5*cE[1]; 
  BigAEM(12,14) = 1.5*m0[2]-0.5*cE[2]; 
  BigAEM(12,15) = 1.5*m0[3]-0.5*cE[3]; 
  BigAEM(13,12) = 1.5*m0[1]-0.5*cE[1]; 
  BigAEM(13,13) = 1.5*m0[0]-0.5*cE[0]; 
  BigAEM(13,14) = 1.5*m0[3]-0.5*cE[3]; 
  BigAEM(13,15) = 1.5*m0[2]-0.5*cE[2]; 
  BigAEM(14,12) = 1.5*m0[2]-0.5*cE[2]; 
  BigAEM(14,13) = 1.5*m0[3]-0.5*cE[3]; 
  BigAEM(14,14) = 1.5*m0[0]-0.5*cE[0]; 
  BigAEM(14,15) = 1.5*m0[1]-0.5*cE[1]; 
  BigAEM(15,12) = 1.5*m0[3]-0.5*cE[3]; 
  BigAEM(15,13) = 1.5*m0[2]-0.5*cE[2]; 
  BigAEM(15,14) = 1.5*m0[1]-0.5*cE[1]; 
  BigAEM(15,15) = 1.5*m0[0]-0.5*cE[0]; 
...
void SelfPrimMoments2x3vSer_P2(const double *m0, const double *m1, const double *m2, const double *cM, const double *cE, double *u, double *vtSq) 
{ 
  // m0,m1,m2: moments of the distribution function. 
  // cM, cE: vtSq*cM and vtSq*cE are corrections to u and vtSq, respectively. 
  // u:        velocity. 
  ...
  // Declare Eigen matrix and vectors for weak division. 
  Eigen::MatrixXd BigAEM(32,32); 
  Eigen::VectorXd bEV(32); 
  Eigen::VectorXd xEV(32); 
  ...
  // ....... Block from correction to vtSq .......... // 
  BigAEM(24,24) = 1.5*m0[0]-0.5*cE[0]; 
  BigAEM(24,25) = 1.5*m0[1]-0.5*cE[1]; 
  BigAEM(24,26) = 1.5*m0[2]-0.5*cE[2]; 
  BigAEM(24,27) = 1.5*m0[3]-0.5*cE[3]; 
  BigAEM(24,28) = 1.5*m0[4]-0.5*cE[4]; 
  BigAEM(24,29) = 1.5*m0[5]-0.5*cE[5]; 
  BigAEM(24,30) = 1.5*m0[6]-0.5*cE[6]; 
  BigAEM(24,31) = 1.5*m0[7]-0.5*cE[7]; 
  BigAEM(25,24) = 1.5*m0[1]-0.5*cE[1]; 
  BigAEM(25,25) = 1.341640786499874*m0[4]-0.4472135954999579*cE[4]+1.5*m0[0]-0.5*cE[0]; 
  BigAEM(25,26) = 1.5*m0[3]-0.5*cE[3]; 
  BigAEM(25,27) = 1.341640786499874*m0[6]-0.447213595499958*cE[6]+1.5*m0[2]-0.5*cE[2]; 
  BigAEM(25,28) = 1.341640786499874*m0[1]-0.4472135954999579*cE[1]; 
  BigAEM(25,29) = 1.5*m0[7]-0.5000000000000001*cE[7]; 
  BigAEM(25,30) = 1.341640786499874*m0[3]-0.447213595499958*cE[3]; 
  BigAEM(25,31) = 1.5*m0[5]-0.5000000000000001*cE[5]; 
  BigAEM(26,24) = 1.5*m0[2]-0.5*cE[2]; 
  BigAEM(26,25) = 1.5*m0[3]-0.5*cE[3]; 
  BigAEM(26,26) = 1.341640786499874*m0[5]-0.4472135954999579*cE[5]+1.5*m0[0]-0.5*cE[0]; 
  BigAEM(26,27) = 1.341640786499874*m0[7]-0.447213595499958*cE[7]+1.5*m0[1]-0.5*cE[1]; 
  BigAEM(26,28) = 1.5*m0[6]-0.5000000000000001*cE[6]; 
  BigAEM(26,29) = 1.341640786499874*m0[2]-0.4472135954999579*cE[2]; 
  BigAEM(26,30) = 1.5*m0[4]-0.5000000000000001*cE[4]; 
  BigAEM(26,31) = 1.341640786499874*m0[3]-0.447213595499958*cE[3]; 
  BigAEM(27,24) = 1.5*m0[3]-0.5*cE[3]; 
  BigAEM(27,25) = 1.341640786499874*m0[6]-0.447213595499958*cE[6]+1.5*m0[2]-0.5*cE[2]; 
  BigAEM(27,26) = 1.341640786499874*m0[7]-0.447213595499958*cE[7]+1.5*m0[1]-0.5*cE[1]; 
  BigAEM(27,27) = 1.341640786499874*m0[5]-0.4472135954999579*cE[5]+1.341640786499874*m0[4]-0.4472135954999579*cE[4]+1.5*m0[0]-0.5*cE[0]; 
  BigAEM(27,28) = 1.341640786499874*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(27,29) = 1.341640786499874*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(27,30) = 1.2*m0[7]-0.4*cE[7]+1.341640786499874*m0[1]-0.447213595499958*cE[1]; 
  BigAEM(27,31) = 1.2*m0[6]-0.4*cE[6]+1.341640786499874*m0[2]-0.447213595499958*cE[2]; 
  BigAEM(28,24) = 1.5*m0[4]-0.5*cE[4]; 
  BigAEM(28,25) = 1.341640786499874*m0[1]-0.4472135954999579*cE[1]; 
  BigAEM(28,26) = 1.5*m0[6]-0.5000000000000001*cE[6]; 
  BigAEM(28,27) = 1.341640786499874*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(28,28) = 0.9583148474999099*m0[4]-0.31943828249997*cE[4]+1.5*m0[0]-0.5*cE[0]; 
  BigAEM(28,30) = 0.9583148474999099*m0[6]-0.31943828249997*cE[6]+1.5*m0[2]-0.5000000000000001*cE[2]; 
  BigAEM(28,31) = 1.341640786499874*m0[7]-0.4472135954999579*cE[7]; 
  BigAEM(29,24) = 1.5*m0[5]-0.5*cE[5]; 
  BigAEM(29,25) = 1.5*m0[7]-0.5000000000000001*cE[7]; 
  BigAEM(29,26) = 1.341640786499874*m0[2]-0.4472135954999579*cE[2]; 
  BigAEM(29,27) = 1.341640786499874*m0[3]-0.4472135954999579*cE[3]; 
  BigAEM(29,29) = 0.9583148474999099*m0[5]-0.31943828249997*cE[5]+1.5*m0[0]-0.5*cE[0]; 
  BigAEM(29,30) = 1.341640786499874*m0[6]-0.4472135954999579*cE[6]; 
  BigAEM(29,31) = 0.9583148474999099*m0[7]-0.31943828249997*cE[7]+1.5*m0[1]-0.5000000000000001*cE[1]; 
  BigAEM(30,24) = 1.5*m0[6]-0.5*cE[6]; 
  BigAEM(30,25) = 1.341640786499874*m0[3]-0.447213595499958*cE[3]; 
  BigAEM(30,26) = 1.5*m0[4]-0.5000000000000001*cE[4]; 
  BigAEM(30,27) = 1.2*m0[7]-0.4*cE[7]+1.341640786499874*m0[1]-0.447213595499958*cE[1]; 
  BigAEM(30,28) = 0.9583148474999099*m0[6]-0.31943828249997*cE[6]+1.5*m0[2]-0.5000000000000001*cE[2]; 
  BigAEM(30,29) = 1.341640786499874*m0[6]-0.4472135954999579*cE[6]; 
  BigAEM(30,30) = 1.341640786499874*m0[5]-0.4472135954999579*cE[5]+0.9583148474999099*m0[4]-0.31943828249997*cE[4]+1.5*m0[0]-0.5*cE[0]; 
  BigAEM(30,31) = 1.2*m0[3]-0.4*cE[3]; 
  BigAEM(31,24) = 1.5*m0[7]-0.5*cE[7]; 
  BigAEM(31,25) = 1.5*m0[5]-0.5000000000000001*cE[5]; 
  BigAEM(31,26) = 1.341640786499874*m0[3]-0.447213595499958*cE[3]; 
  BigAEM(31,27) = 1.2*m0[6]-0.4*cE[6]+1.341640786499874*m0[2]-0.447213595499958*cE[2]; 
  BigAEM(31,28) = 1.341640786499874*m0[7]-0.4472135954999579*cE[7]; 
  BigAEM(31,29) = 0.9583148474999099*m0[7]-0.31943828249997*cE[7]+1.5*m0[1]-0.5000000000000001*cE[1]; 
  BigAEM(31,30) = 1.2*m0[3]-0.4*cE[3]; 
  BigAEM(31,31) = 0.9583148474999099*m0[5]-0.31943828249997*cE[5]+1.341640786499874*m0[4]-0.4472135954999579*cE[4]+1.5*m0[0]-0.5*cE[0]; 
...
{ 
  ...
  out[3] += 2.449489742783178*fvmin[16]*dS+2.449489742783178*fvmax[16]*dS-1.414213562373095*fvmin[6]*dS+1.414213562373095*fvmax[6]*dS; 
...
{ 
  ...
  out[1] += (-3.16227766016838*fvmin[35]*dS)+3.16227766016838*fvmax[35]*dS+2.449489742783178*fvmin[7]*dS+2.449489742783178*fvmax[7]*dS-1.414213562373095*fvmin[1]*dS+1.414213562373095*fvmax[1]*dS; 
  out[2] += (-3.16227766016838*fvmin[36]*dS)+3.16227766016838*fvmax[36]*dS+2.449489742783178*fvmin[8]*dS+2.449489742783178*fvmax[8]*dS-1.414213562373095*fvmin[2]*dS+1.414213562373095*fvmax[2]*dS; 
  out[3] += (-3.16227766016838*fvmin[58]*dS)+3.16227766016838*fvmax[58]*dS+2.449489742783178*fvmin[21]*dS+2.449489742783178*fvmax[21]*dS-1.414213562373095*fvmin[6]*dS+1.414213562373095*fvmax[6]*dS; 
  out[4] += 2.449489742783178*fvmin[33]*dS+2.449489742783178*fvmax[33]*dS-1.414213562373095*fvmin[16]*dS+1.414213562373095*fvmax[16]*dS; 
  out[5] += 2.449489742783178*fvmin[34]*dS+2.449489742783178*fvmax[34]*dS-1.414213562373095*fvmin[17]*dS+1.414213562373095*fvmax[17]*dS; 
  out[6] += 2.449489742783178*fvmin[56]*dS+2.449489742783178*fvmax[56]*dS-1.414213562373095*fvmin[31]*dS+1.414213562373095*fvmax[31]*dS; 
  out[7] += 2.449489742783178*fvmin[57]*dS+2.449489742783178*fvmax[57]*dS-1.414213562373095*fvmin[32]*dS+1.414213562373095*fvmax[32]*dS; 
...
{ 
  ...
  out[3] += (-2.449489742783178*fvmin[16]*dS*vmin)+1.414213562373095*fvmin[6]*dS*vmin+2.449489742783178*fvmax[16]*dS*vmax+1.414213562373095*fvmax[6]*dS*vmax; 
...
{ 
  ...
  out[1] += 3.16227766016838*fvmin[35]*dS*vmin-2.449489742783178*fvmin[7]*dS*vmin+1.414213562373095*fvmin[1]*dS*vmin+3.16227766016838*fvmax[35]*dS*vmax+2.449489742783178*fvmax[7]*dS*vmax+1.414213562373095*fvmax[1]*dS*vmax; 
  out[2] += 3.16227766016838*fvmin[36]*dS*vmin-2.449489742783178*fvmin[8]*dS*vmin+1.414213562373095*fvmin[2]*dS*vmin+3.16227766016838*fvmax[36]*dS*vmax+2.449489742783178*fvmax[8]*dS*vmax+1.414213562373095*fvmax[2]*dS*vmax; 
  out[3] += 3.16227766016838*fvmin[58]*dS*vmin-2.449489742783178*fvmin[21]*dS*vmin+1.414213562373095*fvmin[6]*dS*vmin+3.16227766016838*fvmax[58]*dS*vmax+2.449489742783178*fvmax[21]*dS*vmax+1.414213562373095*fvmax[6]*dS*vmax; 
  out[4] += (-2.449489742783178*fvmin[33]*dS*vmin)+1.414213562373095*fvmin[16]*dS*vmin+2.449489742783178*fvmax[33]*dS*vmax+1.414213562373095*fvmax[16]*dS*vmax; 
  out[5] += (-2.449489742783178*fvmin[34]*dS*vmin)+1.414213562373095*fvmin[17]*dS*vmin+2.449489742783178*fvmax[34]*dS*vmax+1.414213562373095*fvmax[17]*dS*vmax; 
  out[6] += (-2.449489742783178*fvmin[56]*dS*vmin)+1.414213562373095*fvmin[31]*dS*vmin+2.449489742783178*fvmax[56]*dS*vmax+1.414213562373095*fvmax[31]*dS*vmax; 
  out[7] += (-2.449489742783178*fvmin[57]*dS*vmin)+1.414213562373095*fvmin[32]*dS*vmin+2.449489742783178*fvmax[57]*dS*vmax+1.414213562373095*fvmax[32]*dS*vmax; 
...
{ 
  ...
  out[5] += 2.449489742783178*fvmin[9]*dS+2.449489742783178*fvmax[9]*dS-1.414213562373095*fvmin[1]*dS+1.414213562373095*fvmax[1]*dS; 
  out[6] += 2.449489742783178*fvmin[10]*dS+2.449489742783178*fvmax[10]*dS-1.414213562373095*fvmin[2]*dS+1.414213562373095*fvmax[2]*dS; 
  out[7] += 2.449489742783178*fvmin[17]*dS+2.449489742783178*fvmax[17]*dS-1.414213562373095*fvmin[6]*dS+1.414213562373095*fvmax[6]*dS; 
...
{ 
  ...
  out[8] += (-3.16227766016838*fvmin[19]*dS)+3.16227766016838*fvmax[19]*dS+2.449489742783178*fvmin[4]*dS+2.449489742783178*fvmax[4]*dS-1.414213562373095*fvmin[0]*dS+1.414213562373095*fvmax[0]*dS; 
  out[9] += (-3.16227766016838*fvmin[40]*dS)+3.16227766016838*fvmax[40]*dS+2.449489742783178*fvmin[9]*dS+2.449489742783178*fvmax[9]*dS-1.414213562373095*fvmin[1]*dS+1.414213562373095*fvmax[1]*dS; 
  out[10] += (-3.16227766016838*fvmin[41]*dS)+3.16227766016838*fvmax[41]*dS+2.449489742783178*fvmin[10]*dS+2.449489742783178*fvmax[10]*dS-1.414213562373095*fvmin[2]*dS+1.414213562373095*fvmax[2]*dS; 
  out[11] += (-3.16227766016838*fvmin[65]*dS)+3.16227766016838*fvmax[65]*dS+2.449489742783178*fvmin[22]*dS+2.449489742783178*fvmax[22]*dS-1.414213562373095*fvmin[6]*dS+1.414213562373095*fvmax[6]*dS; 
  out[12] += 2.449489742783178*fvmin[37]*dS+2.449489742783178*fvmax[37]*dS-1.414213562373095*fvmin[16]*dS+1.414213562373095*fvmax[16]*dS; 
  out[13] += 2.449489742783178*fvmin[38]*dS+2.449489742783178*fvmax[38]*dS-1.414213562373095*fvmin[17]*dS+1.414213562373095*fvmax[17]*dS; 
  out[14] += 2.449489742783178*fvmin[59]*dS+2.449489742783178*fvmax[59]*dS-1.414213562373095*fvmin[31]*dS+1.414213562373095*fvmax[31]*dS; 
  out[15] += 2.449489742783178*fvmin[60]*dS+2.449489742783178*fvmax[60]*dS-1.414213562373095*fvmin[32]*dS+1.414213562373095*fvmax[32]*dS; 
...
{ 
  ...
  out[3] += (-2.449489742783178*fvmin[17]*dS*vmin)+1.414213562373095*fvmin[6]*dS*vmin+2.449489742783178*fvmax[17]*dS*vmax+1.414213562373095*fvmax[6]*dS*vmax; 
...
{ 
  ...
  out[1] += 3.16227766016838*fvmin[40]*dS*vmin-2.449489742783178*fvmin[9]*dS*vmin+1.414213562373095*fvmin[1]*dS*vmin+3.16227766016838*fvmax[40]*dS*vmax+2.449489742783178*fvmax[9]*dS*vmax+1.414213562373095*fvmax[1]*dS*vmax; 
  out[2] += 3.16227766016838*fvmin[41]*dS*vmin-2.449489742783178*fvmin[10]*dS*vmin+1.414213562373095*fvmin[2]*dS*vmin+3.16227766016838*fvmax[41]*dS*vmax+2.449489742783178*fvmax[10]*dS*vmax+1.414213562373095*fvmax[2]*dS*vmax; 
  out[3] += 3.16227766016838*fvmin[65]*dS*vmin-2.449489742783178*fvmin[22]*dS*vmin+1.414213562373095*fvmin[6]*dS*vmin+3.16227766016838*fvmax[65]*dS*vmax+2.449489742783178*fvmax[22]*dS*vmax+1.414213562373095*fvmax[6]*dS*vmax; 
  out[4] += (-2.449489742783178*fvmin[37]*dS*vmin)+1.414213562373095*fvmin[16]*dS*vmin+2.449489742783178*fvmax[37]*dS*vmax+1.414213562373095*fvmax[16]*dS*vmax; 
  out[5] += (-2.449489742783178*fvmin[38]*dS*vmin)+1.414213562373095*fvmin[17]*dS*vmin+2.449489742783178*fvmax[38]*dS*vmax+1.414213562373095*fvmax[17]*dS*vmax; 
  out[6] += (-2.449489742783178*fvmin[59]*dS*vmin)+1.414213562373095*fvmin[31]*dS*vmin+2.449489742783178*fvmax[59]*dS*vmax+1.414213562373095*fvmax[31]*dS*vmax; 
  out[7] += (-2.449489742783178*fvmin[60]*dS*vmin)+1.414213562373095*fvmin[32]*dS*vmin+2.449489742783178*fvmax[60]*dS*vmax+1.414213562373095*fvmax[32]*dS*vmax; 
...
{ 
  ...
  out[8] += 2.449489742783178*fvmin[5]*dS+2.449489742783178*fvmax[5]*dS-1.414213562373095*fvmin[0]*dS+1.414213562373095*fvmax[0]*dS; 
  out[9] += 2.449489742783178*fvmin[12]*dS+2.449489742783178*fvmax[12]*dS-1.414213562373095*fvmin[1]*dS+1.414213562373095*fvmax[1]*dS; 
  out[10] += 2.449489742783178*fvmin[13]*dS+2.449489742783178*fvmax[13]*dS-1.414213562373095*fvmin[2]*dS+1.414213562373095*fvmax[2]*dS; 
  out[11] += 2.449489742783178*fvmin[20]*dS+2.449489742783178*fvmax[20]*dS-1.414213562373095*fvmin[6]*dS+1.414213562373095*fvmax[6]*dS; 
...
{ 
  ...
  out[16] += (-3.16227766016838*fvmin[20]*dS)+3.16227766016838*fvmax[20]*dS+2.449489742783178*fvmin[5]*dS+2.449489742783178*fvmax[5]*dS-1.414213562373095*fvmin[0]*dS+1.414213562373095*fvmax[0]*dS; 
  out[17] += (-3.16227766016838*fvmin[47]*dS)+3.16227766016838*fvmax[47]*dS+2.449489742783178*fvmin[12]*dS+2.449489742783178*fvmax[12]*dS-1.414213562373095*fvmin[1]*dS+1.414213562373095*fvmax[1]*dS; 
  out[18] += (-3.16227766016838*fvmin[48]*dS)+3.16227766016838*fvmax[48]*dS+2.449489742783178*fvmin[13]*dS+2.449489742783178*fvmax[13]*dS-1.414213562373095*fvmin[2]*dS+1.414213562373095*fvmax[2]*dS; 
  out[19] += (-3.16227766016838*fvmin[80]*dS)+3.16227766016838*fvmax[80]*dS+2.449489742783178*fvmin[25]*dS+2.449489742783178*fvmax[25]*dS-1.414213562373095*fvmin[6]*dS+1.414213562373095*fvmax[6]*dS; 
  out[20] += 2.449489742783178*fvmin[43]*dS+2.449489742783178*fvmax[43]*dS-1.414213562373095*fvmin[16]*dS+1.414213562373095*fvmax[16]*dS; 
  out[21] += 2.449489742783178*fvmin[44]*dS+2.449489742783178*fvmax[44]*dS-1.414213562373095*fvmin[17]*dS+1.414213562373095*fvmax[17]*dS; 
  out[22] += 2.449489742783178*fvmin[68]*dS+2.449489742783178*fvmax[68]*dS-1.414213562373095*fvmin[31]*dS+1.414213562373095*fvmax[31]*dS; 
  out[23] += 2.449489742783178*fvmin[69]*dS+2.449489742783178*fvmax[69]*dS-1.414213562373095*fvmin[32]*dS+1.414213562373095*fvmax[32]*dS; 
...
{ 
  ...
  out[3] += (-2.449489742783178*fvmin[20]*dS*vmin)+1.414213562373095*fvmin[6]*dS*vmin+2.449489742783178*fvmax[20]*dS*vmax+1.414213562373095*fvmax[6]*dS*vmax; 
...
{ 
  ...
  out[1] += 3.16227766016838*fvmin[47]*dS*vmin-2.449489742783178*fvmin[12]*dS*vmin+1.414213562373095*fvmin[1]*dS*vmin+3.16227766016838*fvmax[47]*dS*vmax+2.449489742783178*fvmax[12]*dS*vmax+1.414213562373095*fvmax[1]*dS*vmax; 
  out[2] += 3.16227766016838*fvmin[48]*dS*vmin-2.449489742783178*fvmin[13]*dS*vmin+1.414213562373095*fvmin[2]*dS*vmin+3.16227766016838*fvmax[48]*dS*vmax+2.449489742783178*fvmax[13]*dS*vmax+1.414213562373095*fvmax[2]*dS*vmax; 
  out[3] += 3.16227766016838*fvmin[80]*dS*vmin-2.449489742783178*fvmin[25]*dS*vmin+1.414213562373095*fvmin[6]*dS*vmin+3.16227766016838*fvmax[80]*dS*vmax+2.449489742783178*fvmax[25]*dS*vmax+1.414213562373095*fvmax[6]*dS*vmax; 
  out[4] += (-2.449489742783178*fvmin[43]*dS*vmin)+1.414213562373095*fvmin[16]*dS*vmin+2.449489742783178*fvmax[43]*dS*vmax+1.414213562373095*fvmax[16]*dS*vmax; 
  out[5] += (-2.449489742783178*fvmin[44]*dS*vmin)+1.414213562373095*fvmin[17]*dS*vmin+2.449489742783178*fvmax[44]*dS*vmax+1.414213562373095*fvmax[17]*dS*vmax; 
  out[6] += (-2.449489742783178*fvmin[68]*dS*vmin)+1.414213562373095*fvmin[31]*dS*vmin+2.449489742783178*fvmax[68]*dS*vmax+1.414213562373095*fvmax[31]*dS*vmax; 
  out[7] += (-2.449489742783178*fvmin[69]*dS*vmin)+1.414213562373095*fvmin[32]*dS*vmin+2.449489742783178*fvmax[69]*dS*vmax+1.414213562373095*fvmax[32]*dS*vmax; 
