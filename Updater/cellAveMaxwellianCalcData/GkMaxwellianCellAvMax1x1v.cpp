...
#include <math.h> 
void GkMaxwellianCellAvMax1x1v_P1(const double m_, const double *w, const double *m0, const double *uPar, const double *vtSq, double *bmag, double *fMax) 
{ 
...
void GkMaxwellianCellAvMax1x1v_P2(const double m_, const double *w, const double *m0, const double *uPar, const double *vtSq, double *bmag, double *fMax) 
{ 
  // w[2]:      cell-center coordinates. 
