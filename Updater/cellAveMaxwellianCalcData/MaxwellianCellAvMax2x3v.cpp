...
{ 
  ...
  double vSqAv = 0.25*pow(u[6],2.0)-1.0*w[4]*u[6]+pow(w[4],2.0)+pow(w[3],2.0)-1.0*u[3]*w[3]+0.25*pow(u[3],2.0)+pow(w[2],2.0)-1.0*u[0]*w[2]+0.25*pow(u[0],2.0); 
...
{ 
  ...
  double m0Av = 0.5*m0[0]; 
  double vtSqAv = 0.5*vtSq[0]; 
  double vSqAv = 0.25*pow(u[12],2.0)-1.0*w[4]*u[12]+0.25*pow(u[6],2.0)-1.0*w[3]*u[6]+pow(w[4],2.0)+pow(w[3],2.0)+pow(w[2],2.0)-1.0*u[0]*w[2]+0.25*pow(u[0],2.0); 
