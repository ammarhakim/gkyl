...
{ 
  ...
  double vSqAv = 0.125*pow(u[16],2.0)-0.7071067811865475*w[5]*u[16]+0.125*pow(u[8],2.0)-0.7071067811865475*w[4]*u[8]+pow(w[5],2.0)+pow(w[4],2.0)+pow(w[3],2.0)-0.7071067811865475*u[0]*w[3]+0.125*pow(u[0],2.0); 
...
{ 
  ...
  double m0Av = 0.3535533905932738*m0[0]; 
  double vtSqAv = 0.3535533905932738*vtSq[0]; 
  double vSqAv = 0.125*pow(u[40],2.0)-0.7071067811865475*w[5]*u[40]+0.125*pow(u[20],2.0)-0.7071067811865475*w[4]*u[20]+pow(w[5],2.0)+pow(w[4],2.0)+pow(w[3],2.0)-0.7071067811865475*u[0]*w[3]+0.125*pow(u[0],2.0); 
