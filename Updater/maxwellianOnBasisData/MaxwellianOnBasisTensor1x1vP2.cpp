...
void MaxwellianOnBasisGauss1x1vTensor_P2_phaseQuad(const double *flowUOrd, const double *vtSqOrd, const double *fMFacOrd, const double *bmagOrd, const double m_, const double *wc, const double *dxv, double *fMOut) {
  ...
  fMOut[8] = 0.1234567901234569*(fMquad[8]+fMquad[7])-0.2469135802469136*fMquad[6]+0.1234567901234569*(fMquad[5]+fMquad[4])-0.2469135802469136*fMquad[3]-0.2469135802469137*(fMquad[2]+fMquad[1])+0.4938271604938271*fMquad[0]; 
...
void GkMaxwellianOnBasisGauss1x1vTensor_P2_evAtConfOrd(const double *den, const double *flowU, const double *vtSq, const double *bmag, double *flowUOrd, double *vtSqOrd, double *fMFacOrd, double *bmagOrd) {
  ...
  if (vtSqOrd[0] <= 0.0)
    ...
    fMFacOrd[0] = (0.3989422804014326*(0.7071067811865475*bmag[0]-0.7905694150420947*bmag[2])*(0.7071067811865475*den[0]-0.7905694150420947*den[2]))/sqrt(vtSqOrd[0])+9.999999999999999e-41; 
  if (vtSqOrd[1] <= 0.0)
    fMFacOrd[1] = 9.999999999999999e-41;
  else
    fMFacOrd[1] = (0.3989422804014326*(0.6324555320336759*bmag[2]-0.9486832980505137*bmag[1]+0.7071067811865475*bmag[0])*(0.6324555320336759*den[2]-0.9486832980505137*den[1]+0.7071067811865475*den[0]))/sqrt(vtSqOrd[1])+9.999999999999999e-41; 
  if (vtSqOrd[2] <= 0.0)
    fMFacOrd[2] = 9.999999999999999e-41;
  else
    fMFacOrd[2] = (0.3989422804014326*(0.6324555320336759*bmag[2]+0.9486832980505137*bmag[1]+0.7071067811865475*bmag[0])*(0.6324555320336759*den[2]+0.9486832980505137*den[1]+0.7071067811865475*den[0]))/sqrt(vtSqOrd[2])+9.999999999999999e-41; 
