...
void MaxwellianOnBasisGauss1x1vTensor_P2_evAtConfOrd(const double *den, const double *flowU, const double *vtSq, double *flowUOrd, double *vtSqOrd, double *fMFacOrd) {
  ...
  fMFacOrd[0] = (0.3989422804014326*(0.7071067811865475*den[0]-0.7905694150420947*den[2]))/sqrt(0.7071067811865475*vtSq[0]-0.7905694150420947*vtSq[2]); 
  fMFacOrd[1] = (0.3989422804014326*(0.6324555320336759*den[2]-0.9486832980505137*den[1]+0.7071067811865475*den[0]))/sqrt(0.6324555320336759*vtSq[2]-0.9486832980505137*vtSq[1]+0.7071067811865475*vtSq[0]); 
  fMFacOrd[2] = (0.3989422804014326*(0.6324555320336759*den[2]+0.9486832980505137*den[1]+0.7071067811865475*den[0]))/sqrt(0.6324555320336759*vtSq[2]+0.9486832980505137*vtSq[1]+0.7071067811865475*vtSq[0]); 
