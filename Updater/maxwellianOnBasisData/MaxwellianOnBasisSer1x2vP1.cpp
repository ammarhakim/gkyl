...
void GkMaxwellianOnBasisGauss1x2vSer_P1_evAtConfOrd(const double *den, const double *flowU, const double *vtSq, const double *bmag, double *flowUOrd, double *vtSqOrd, double *fMFacOrd, double *bmagOrd) {
  ...
  if (vtSqOrd[0] <= 0.0)
    ...
    fMFacOrd[0] = (bmagOrd[0]*(0.7071067811865475*den[0]-0.7071067811865474*den[1]))/std::pow(2.506628274631001*sqrt(vtSqOrd[0]),3.0)+9.999999999999999e-41; 
  if (vtSqOrd[1] <= 0.0)
    fMFacOrd[1] = 9.999999999999999e-41;
  else
    fMFacOrd[1] = (bmagOrd[1]*(0.7071067811865474*den[1]+0.7071067811865475*den[0]))/std::pow(2.506628274631001*sqrt(vtSqOrd[1]),3.0)+9.999999999999999e-41; 
...
void GkMaxwellianOnBasisGauss1x2vSer_P1_phaseQuad(const double *flowUOrd, const double *vtSqOrd, const double *fMFacOrd, const double *bmagOrd, const double m_, const double *wc, const double *dxv, double *fMOut) {
  ...
  double fMquad[8];
  fMquad[0] = fMFacOrd[0]*exp(((-(1.0*bmagOrd[0]*(wc[2]-0.2886751345948129*dxv[2]))/m_)-0.5*std::pow(wc[1]-0.2886751345948129*dxv[1]-1.0*flowUOrd[0],2.0))/vtSqOrd[0]); 
  fMquad[1] = fMFacOrd[0]*exp(((-(1.0*bmagOrd[0]*(wc[2]+0.2886751345948129*dxv[2]))/m_)-0.5*std::pow(wc[1]-0.2886751345948129*dxv[1]-1.0*flowUOrd[0],2.0))/vtSqOrd[0]); 
  fMquad[2] = fMFacOrd[0]*exp(((-(1.0*bmagOrd[0]*(wc[2]-0.2886751345948129*dxv[2]))/m_)-0.5*std::pow(wc[1]+0.2886751345948129*dxv[1]-1.0*flowUOrd[0],2.0))/vtSqOrd[0]); 
  fMquad[3] = fMFacOrd[0]*exp(((-(1.0*bmagOrd[0]*(wc[2]+0.2886751345948129*dxv[2]))/m_)-0.5*std::pow(wc[1]+0.2886751345948129*dxv[1]-1.0*flowUOrd[0],2.0))/vtSqOrd[0]); 
  fMquad[4] = fMFacOrd[1]*exp(((-(1.0*bmagOrd[1]*(wc[2]-0.2886751345948129*dxv[2]))/m_)-0.5*std::pow(wc[1]-1.0*flowUOrd[1]-0.2886751345948129*dxv[1],2.0))/vtSqOrd[1]); 
  fMquad[5] = fMFacOrd[1]*exp(((-(1.0*bmagOrd[1]*(wc[2]+0.2886751345948129*dxv[2]))/m_)-0.5*std::pow(wc[1]-1.0*flowUOrd[1]-0.2886751345948129*dxv[1],2.0))/vtSqOrd[1]); 
  fMquad[6] = fMFacOrd[1]*exp(((-(1.0*bmagOrd[1]*(wc[2]-0.2886751345948129*dxv[2]))/m_)-0.5*std::pow(wc[1]-1.0*flowUOrd[1]+0.2886751345948129*dxv[1],2.0))/vtSqOrd[1]); 
  fMquad[7] = fMFacOrd[1]*exp(((-(1.0*bmagOrd[1]*(wc[2]+0.2886751345948129*dxv[2]))/m_)-0.5*std::pow(wc[1]-1.0*flowUOrd[1]+0.2886751345948129*dxv[1],2.0))/vtSqOrd[1]); 
