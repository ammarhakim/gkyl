...
void MaxwellianOnBasisGauss1x1vSer_P1_evAtConfOrd(const double *den, const double *flowU, const double *vtSq, double *flowUOrd, double *vtSqOrd, double *fMFacOrd) {
  ...
  fMFacOrd[0] = (0.3989422804014326*(0.7071067811865475*den[0]-0.7071067811865474*den[1]))/sqrt(0.7071067811865475*vtSq[0]-0.7071067811865474*vtSq[1]); 
  fMFacOrd[1] = (0.3989422804014326*(0.7071067811865474*den[1]+0.7071067811865475*den[0]))/sqrt(0.7071067811865474*vtSq[1]+0.7071067811865475*vtSq[0]); 

}
void MaxwellianOnBasisGauss1x1vSer_P1_phaseQuad(const double *flowUOrd, const double *vtSqOrd, const double *fMFacOrd, const double *wc, const double *dxv, double *fMOut) {
