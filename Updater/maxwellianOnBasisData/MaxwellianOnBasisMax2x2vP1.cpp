...
void GkMaxwellianOnBasisGauss2x2vMax_P1_phaseQuad(const double *flowUOrd, const double *vtSqOrd, const double *fMFacOrd, const double *bmagOrd, const double m_, const double *wc, const double *dxv, double *fMOut) {
  ...
  double fMquad[16];
  if ((vtSqOrd[0] > 0.) && (fMFacOrd[0] > 0.)) {
    fMquad[0] = fMFacOrd[0]*exp(((-(1.0*bmagOrd[0]*(wc[3]-0.2886751345948129*dxv[3]))/m_)-0.5*std::pow(wc[2]-0.2886751345948129*dxv[2]-1.0*flowUOrd[0],2.0))/vtSqOrd[0])+9.999999999999999e-41; 
    fMquad[1] = fMFacOrd[0]*exp(((-(1.0*bmagOrd[0]*(wc[3]+0.2886751345948129*dxv[3]))/m_)-0.5*std::pow(wc[2]-0.2886751345948129*dxv[2]-1.0*flowUOrd[0],2.0))/vtSqOrd[0])+9.999999999999999e-41; 
    fMquad[2] = fMFacOrd[0]*exp(((-(1.0*bmagOrd[0]*(wc[3]-0.2886751345948129*dxv[3]))/m_)-0.5*std::pow(wc[2]+0.2886751345948129*dxv[2]-1.0*flowUOrd[0],2.0))/vtSqOrd[0])+9.999999999999999e-41; 
    fMquad[3] = fMFacOrd[0]*exp(((-(1.0*bmagOrd[0]*(wc[3]+0.2886751345948129*dxv[3]))/m_)-0.5*std::pow(wc[2]+0.2886751345948129*dxv[2]-1.0*flowUOrd[0],2.0))/vtSqOrd[0])+9.999999999999999e-41; 
  } else {
  ...
  if ((vtSqOrd[1] > 0.) && (fMFacOrd[1] > 0.)) {
    fMquad[4] = fMFacOrd[1]*exp(((-(1.0*bmagOrd[1]*(wc[3]-0.2886751345948129*dxv[3]))/m_)-0.5*std::pow(wc[2]-0.2886751345948129*dxv[2]-1.0*flowUOrd[1],2.0))/vtSqOrd[1])+9.999999999999999e-41; 
    fMquad[5] = fMFacOrd[1]*exp(((-(1.0*bmagOrd[1]*(wc[3]+0.2886751345948129*dxv[3]))/m_)-0.5*std::pow(wc[2]-0.2886751345948129*dxv[2]-1.0*flowUOrd[1],2.0))/vtSqOrd[1])+9.999999999999999e-41; 
    fMquad[6] = fMFacOrd[1]*exp(((-(1.0*bmagOrd[1]*(wc[3]-0.2886751345948129*dxv[3]))/m_)-0.5*std::pow(wc[2]+0.2886751345948129*dxv[2]-1.0*flowUOrd[1],2.0))/vtSqOrd[1])+9.999999999999999e-41; 
    fMquad[7] = fMFacOrd[1]*exp(((-(1.0*bmagOrd[1]*(wc[3]+0.2886751345948129*dxv[3]))/m_)-0.5*std::pow(wc[2]+0.2886751345948129*dxv[2]-1.0*flowUOrd[1],2.0))/vtSqOrd[1])+9.999999999999999e-41; 
  } else {
  ...
  if ((vtSqOrd[2] > 0.) && (fMFacOrd[2] > 0.)) {
    fMquad[8] = fMFacOrd[2]*exp(((-(1.0*bmagOrd[2]*(wc[3]-0.2886751345948129*dxv[3]))/m_)-0.5*std::pow(wc[2]-1.0*flowUOrd[2]-0.2886751345948129*dxv[2],2.0))/vtSqOrd[2])+9.999999999999999e-41; 
    fMquad[9] = fMFacOrd[2]*exp(((-(1.0*bmagOrd[2]*(wc[3]+0.2886751345948129*dxv[3]))/m_)-0.5*std::pow(wc[2]-1.0*flowUOrd[2]-0.2886751345948129*dxv[2],2.0))/vtSqOrd[2])+9.999999999999999e-41; 
    fMquad[10] = fMFacOrd[2]*exp(((-(1.0*bmagOrd[2]*(wc[3]-0.2886751345948129*dxv[3]))/m_)-0.5*std::pow(wc[2]-1.0*flowUOrd[2]+0.2886751345948129*dxv[2],2.0))/vtSqOrd[2])+9.999999999999999e-41; 
    fMquad[11] = fMFacOrd[2]*exp(((-(1.0*bmagOrd[2]*(wc[3]+0.2886751345948129*dxv[3]))/m_)-0.5*std::pow(wc[2]-1.0*flowUOrd[2]+0.2886751345948129*dxv[2],2.0))/vtSqOrd[2])+9.999999999999999e-41; 
  } else {
  ...
  if ((vtSqOrd[3] > 0.) && (fMFacOrd[3] > 0.)) {
    fMquad[12] = fMFacOrd[3]*exp(((-(1.0*bmagOrd[3]*(wc[3]-0.2886751345948129*dxv[3]))/m_)-0.5*std::pow((-1.0*flowUOrd[3])+wc[2]-0.2886751345948129*dxv[2],2.0))/vtSqOrd[3])+9.999999999999999e-41; 
    fMquad[13] = fMFacOrd[3]*exp(((-(1.0*bmagOrd[3]*(wc[3]+0.2886751345948129*dxv[3]))/m_)-0.5*std::pow((-1.0*flowUOrd[3])+wc[2]-0.2886751345948129*dxv[2],2.0))/vtSqOrd[3])+9.999999999999999e-41; 
    fMquad[14] = fMFacOrd[3]*exp(((-(1.0*bmagOrd[3]*(wc[3]-0.2886751345948129*dxv[3]))/m_)-0.5*std::pow((-1.0*flowUOrd[3])+wc[2]+0.2886751345948129*dxv[2],2.0))/vtSqOrd[3])+9.999999999999999e-41; 
    fMquad[15] = fMFacOrd[3]*exp(((-(1.0*bmagOrd[3]*(wc[3]+0.2886751345948129*dxv[3]))/m_)-0.5*std::pow((-1.0*flowUOrd[3])+wc[2]+0.2886751345948129*dxv[2],2.0))/vtSqOrd[3])+9.999999999999999e-41; 
  } else {
