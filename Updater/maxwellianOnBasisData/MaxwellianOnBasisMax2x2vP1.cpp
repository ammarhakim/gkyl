...
void MaxwellianOnBasisGauss2x2vMax_P1_evAtConfOrd(const double *den, const double *flowU, const double *vtSq, double *flowUOrd, double *vtSqOrd, double *fMFacOrd) {
  ...
  fMFacOrd[0] = (0.1591549430918953*(0.5*den[0]-0.4999999999999999*(den[2]+den[1])))/(0.5*vtSq[0]-0.4999999999999999*(vtSq[2]+vtSq[1])); 
  fMFacOrd[1] = (0.1591549430918953*(0.4999999999999999*den[2]-0.4999999999999999*den[1]+0.5*den[0]))/(0.4999999999999999*vtSq[2]-0.4999999999999999*vtSq[1]+0.5*vtSq[0]); 
  fMFacOrd[2] = (0.1591549430918953*((-0.4999999999999999*den[2])+0.4999999999999999*den[1]+0.5*den[0]))/((-0.4999999999999999*vtSq[2])+0.4999999999999999*vtSq[1]+0.5*vtSq[0]); 
  fMFacOrd[3] = (0.1591549430918953*(0.4999999999999999*(den[2]+den[1])+0.5*den[0]))/(0.4999999999999999*(vtSq[2]+vtSq[1])+0.5*vtSq[0]); 
