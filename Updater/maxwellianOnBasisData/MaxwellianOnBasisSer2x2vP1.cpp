...
void GkMaxwellianOnBasisGauss2x2vSer_P1_evAtConfOrd(const double *den, const double *flowU, const double *vtSq, const double *bmag, double *flowUOrd, double *vtSqOrd, double *fMFacOrd, double *bmagOrd) {
  ...
  if (vtSqOrd[0] <= 0.0)
    ...
    fMFacOrd[0] = (bmagOrd[0]*(0.4999999999999999*den[3]-0.4999999999999999*(den[2]+den[1])+0.5*den[0]))/std::pow(2.506628274631001*sqrt(vtSqOrd[0]),3.0)+9.999999999999999e-41; 
  if (vtSqOrd[1] <= 0.0)
    fMFacOrd[1] = 9.999999999999999e-41;
  else
    fMFacOrd[1] = (bmagOrd[1]*((-0.4999999999999999*den[3])+0.4999999999999999*den[2]-0.4999999999999999*den[1]+0.5*den[0]))/std::pow(2.506628274631001*sqrt(vtSqOrd[1]),3.0)+9.999999999999999e-41; 
  if (vtSqOrd[2] <= 0.0)
    fMFacOrd[2] = 9.999999999999999e-41;
  else
    fMFacOrd[2] = (bmagOrd[2]*((-0.4999999999999999*(den[3]+den[2]))+0.4999999999999999*den[1]+0.5*den[0]))/std::pow(2.506628274631001*sqrt(vtSqOrd[2]),3.0)+9.999999999999999e-41; 
  if (vtSqOrd[3] <= 0.0)
    fMFacOrd[3] = 9.999999999999999e-41;
  else
    fMFacOrd[3] = (bmagOrd[3]*(0.4999999999999999*(den[3]+den[2]+den[1])+0.5*den[0]))/std::pow(2.506628274631001*sqrt(vtSqOrd[3]),3.0)+9.999999999999999e-41; 
