...
void GkBiMaxwellianOnBasisGauss1x2vTensor_P2_evAtConfOrd(const double *den, const double *flowU, const double *vtparSq, const double *vtperpSq, const double *bmag, double *flowUOrd, double *vtparSqOrd, double *vtperpSqOrd, double *fMFacOrd, double *bmagOrd) {
  ...
  vtparSqOrd[0] = 0.7071067811865475*vtparSq[0]-0.7905694150420947*vtparSq[2]; 
  vtparSqOrd[1] = 0.6324555320336759*vtparSq[2]-0.9486832980505137*vtparSq[1]+0.7071067811865475*vtparSq[0]; 
  vtparSqOrd[2] = 0.6324555320336759*vtparSq[2]+0.9486832980505137*vtparSq[1]+0.7071067811865475*vtparSq[0]; 

  vtperpSqOrd[0] = 0.7071067811865475*vtperpSq[0]-0.7905694150420947*vtperpSq[2]; 
  vtperpSqOrd[1] = 0.6324555320336759*vtperpSq[2]-0.9486832980505137*vtperpSq[1]+0.7071067811865475*vtperpSq[0]; 
  vtperpSqOrd[2] = 0.6324555320336759*vtperpSq[2]+0.9486832980505137*vtperpSq[1]+0.7071067811865475*vtperpSq[0]; 
  ...
  if ((vtparSqOrd[1] > 0.) && (vtperpSqOrd[1] > 0.) && (m0Ord[1] > 0.))
    ...
    fMFacOrd[1] = 0.0;
  if ((vtparSqOrd[2] > 0.) && (vtperpSqOrd[2] > 0.) && (m0Ord[2] > 0.))
    fMFacOrd[2] = (0.06349363593424097*bmagOrd[2]*m0Ord[2])/(sqrt(vtparSqOrd[2])*vtperpSqOrd[2]); 
  else
    fMFacOrd[2] = 0.0;
...
void GkBiMaxwellianOnBasisGauss1x2vTensor_P2_phaseQuad(const double *flowUOrd, const double *vtparSqOrd, const double *vtperpSqOrd, const double *fMFacOrd, const double *bmagOrd, const double m_, const double *wc, const double *dxv, double *fMOut) {
  ...
  if ((vtparSqOrd[0] > 0.) && (vtperpSqOrd[0] > 0.) && (fMFacOrd[0] > 0.)) {
    fMquad[0] = fMFacOrd[0]*exp((-(1.0*bmagOrd[0]*std::abs(wc[2]))/(vtperpSqOrd[0]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[0],2.0))/vtparSqOrd[0])+9.999999999999999e-41; 
    fMquad[1] = fMFacOrd[0]*exp((-(1.0*bmagOrd[0]*std::abs(wc[2]-0.3872983346207417*dxv[2]))/(vtperpSqOrd[0]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[0],2.0))/vtparSqOrd[0])+9.999999999999999e-41; 
    fMquad[2] = fMFacOrd[0]*exp((-(1.0*bmagOrd[0]*std::abs(wc[2]+0.3872983346207417*dxv[2]))/(vtperpSqOrd[0]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[0],2.0))/vtparSqOrd[0])+9.999999999999999e-41; 
    fMquad[3] = fMFacOrd[0]*exp((-(1.0*bmagOrd[0]*std::abs(wc[2]))/(vtperpSqOrd[0]*m_))-(0.5*std::pow(wc[1]-0.3872983346207417*dxv[1]-1.0*flowUOrd[0],2.0))/vtparSqOrd[0])+9.999999999999999e-41; 
    fMquad[4] = fMFacOrd[0]*exp((-(1.0*bmagOrd[0]*std::abs(wc[2]-0.3872983346207417*dxv[2]))/(vtperpSqOrd[0]*m_))-(0.5*std::pow(wc[1]-0.3872983346207417*dxv[1]-1.0*flowUOrd[0],2.0))/vtparSqOrd[0])+9.999999999999999e-41; 
    fMquad[5] = fMFacOrd[0]*exp((-(1.0*bmagOrd[0]*std::abs(wc[2]+0.3872983346207417*dxv[2]))/(vtperpSqOrd[0]*m_))-(0.5*std::pow(wc[1]-0.3872983346207417*dxv[1]-1.0*flowUOrd[0],2.0))/vtparSqOrd[0])+9.999999999999999e-41; 
    fMquad[6] = fMFacOrd[0]*exp((-(1.0*bmagOrd[0]*std::abs(wc[2]))/(vtperpSqOrd[0]*m_))-(0.5*std::pow(wc[1]+0.3872983346207417*dxv[1]-1.0*flowUOrd[0],2.0))/vtparSqOrd[0])+9.999999999999999e-41; 
    fMquad[7] = fMFacOrd[0]*exp((-(1.0*bmagOrd[0]*std::abs(wc[2]-0.3872983346207417*dxv[2]))/(vtperpSqOrd[0]*m_))-(0.5*std::pow(wc[1]+0.3872983346207417*dxv[1]-1.0*flowUOrd[0],2.0))/vtparSqOrd[0])+9.999999999999999e-41; 
    fMquad[8] = fMFacOrd[0]*exp((-(1.0*bmagOrd[0]*std::abs(wc[2]+0.3872983346207417*dxv[2]))/(vtperpSqOrd[0]*m_))-(0.5*std::pow(wc[1]+0.3872983346207417*dxv[1]-1.0*flowUOrd[0],2.0))/vtparSqOrd[0])+9.999999999999999e-41; 
  } else {
  ...
  if ((vtparSqOrd[1] > 0.) && (vtperpSqOrd[1] > 0.) && (fMFacOrd[1] > 0.)) {
    fMquad[9] = fMFacOrd[1]*exp((-(1.0*bmagOrd[1]*std::abs(wc[2]))/(vtperpSqOrd[1]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[1],2.0))/vtparSqOrd[1])+9.999999999999999e-41; 
    fMquad[10] = fMFacOrd[1]*exp((-(1.0*bmagOrd[1]*std::abs(wc[2]-0.3872983346207417*dxv[2]))/(vtperpSqOrd[1]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[1],2.0))/vtparSqOrd[1])+9.999999999999999e-41; 
    fMquad[11] = fMFacOrd[1]*exp((-(1.0*bmagOrd[1]*std::abs(wc[2]+0.3872983346207417*dxv[2]))/(vtperpSqOrd[1]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[1],2.0))/vtparSqOrd[1])+9.999999999999999e-41; 
    fMquad[12] = fMFacOrd[1]*exp((-(1.0*bmagOrd[1]*std::abs(wc[2]))/(vtperpSqOrd[1]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[1]-0.3872983346207417*dxv[1],2.0))/vtparSqOrd[1])+9.999999999999999e-41; 
    fMquad[13] = fMFacOrd[1]*exp((-(1.0*bmagOrd[1]*std::abs(wc[2]-0.3872983346207417*dxv[2]))/(vtperpSqOrd[1]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[1]-0.3872983346207417*dxv[1],2.0))/vtparSqOrd[1])+9.999999999999999e-41; 
    fMquad[14] = fMFacOrd[1]*exp((-(1.0*bmagOrd[1]*std::abs(wc[2]+0.3872983346207417*dxv[2]))/(vtperpSqOrd[1]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[1]-0.3872983346207417*dxv[1],2.0))/vtparSqOrd[1])+9.999999999999999e-41; 
    fMquad[15] = fMFacOrd[1]*exp((-(1.0*bmagOrd[1]*std::abs(wc[2]))/(vtperpSqOrd[1]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[1]+0.3872983346207417*dxv[1],2.0))/vtparSqOrd[1])+9.999999999999999e-41; 
    fMquad[16] = fMFacOrd[1]*exp((-(1.0*bmagOrd[1]*std::abs(wc[2]-0.3872983346207417*dxv[2]))/(vtperpSqOrd[1]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[1]+0.3872983346207417*dxv[1],2.0))/vtparSqOrd[1])+9.999999999999999e-41; 
    fMquad[17] = fMFacOrd[1]*exp((-(1.0*bmagOrd[1]*std::abs(wc[2]+0.3872983346207417*dxv[2]))/(vtperpSqOrd[1]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[1]+0.3872983346207417*dxv[1],2.0))/vtparSqOrd[1])+9.999999999999999e-41; 
  } else {
  ...
  if ((vtparSqOrd[2] > 0.) && (vtperpSqOrd[2] > 0.) && (fMFacOrd[2] > 0.)) {
    fMquad[18] = fMFacOrd[2]*exp((-(1.0*bmagOrd[2]*std::abs(wc[2]))/(vtperpSqOrd[2]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[2],2.0))/vtparSqOrd[2])+9.999999999999999e-41; 
    fMquad[19] = fMFacOrd[2]*exp((-(1.0*bmagOrd[2]*std::abs(wc[2]-0.3872983346207417*dxv[2]))/(vtperpSqOrd[2]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[2],2.0))/vtparSqOrd[2])+9.999999999999999e-41; 
    fMquad[20] = fMFacOrd[2]*exp((-(1.0*bmagOrd[2]*std::abs(wc[2]+0.3872983346207417*dxv[2]))/(vtperpSqOrd[2]*m_))-(0.5*std::pow(wc[1]-1.0*flowUOrd[2],2.0))/vtparSqOrd[2])+9.999999999999999e-41; 
    fMquad[21] = fMFacOrd[2]*exp((-(1.0*bmagOrd[2]*std::abs(wc[2]))/(vtperpSqOrd[2]*m_))-(0.5*std::pow((-1.0*flowUOrd[2])+wc[1]-0.3872983346207417*dxv[1],2.0))/vtparSqOrd[2])+9.999999999999999e-41; 
    fMquad[22] = fMFacOrd[2]*exp((-(1.0*bmagOrd[2]*std::abs(wc[2]-0.3872983346207417*dxv[2]))/(vtperpSqOrd[2]*m_))-(0.5*std::pow((-1.0*flowUOrd[2])+wc[1]-0.3872983346207417*dxv[1],2.0))/vtparSqOrd[2])+9.999999999999999e-41; 
    fMquad[23] = fMFacOrd[2]*exp((-(1.0*bmagOrd[2]*std::abs(wc[2]+0.3872983346207417*dxv[2]))/(vtperpSqOrd[2]*m_))-(0.5*std::pow((-1.0*flowUOrd[2])+wc[1]-0.3872983346207417*dxv[1],2.0))/vtparSqOrd[2])+9.999999999999999e-41; 
    fMquad[24] = fMFacOrd[2]*exp((-(1.0*bmagOrd[2]*std::abs(wc[2]))/(vtperpSqOrd[2]*m_))-(0.5*std::pow((-1.0*flowUOrd[2])+wc[1]+0.3872983346207417*dxv[1],2.0))/vtparSqOrd[2])+9.999999999999999e-41; 
    fMquad[25] = fMFacOrd[2]*exp((-(1.0*bmagOrd[2]*std::abs(wc[2]-0.3872983346207417*dxv[2]))/(vtperpSqOrd[2]*m_))-(0.5*std::pow((-1.0*flowUOrd[2])+wc[1]+0.3872983346207417*dxv[1],2.0))/vtparSqOrd[2])+9.999999999999999e-41; 
    fMquad[26] = fMFacOrd[2]*exp((-(1.0*bmagOrd[2]*std::abs(wc[2]+0.3872983346207417*dxv[2]))/(vtperpSqOrd[2]*m_))-(0.5*std::pow((-1.0*flowUOrd[2])+wc[1]+0.3872983346207417*dxv[1],2.0))/vtparSqOrd[2])+9.999999999999999e-41; 
  } else {
