...
void lagrangeFix_gk_1x1v_max_p2(double *dm0, double *dm1, double *dm2, double *B, double mass, double *lo, double *L, double *Nv, double *vc, double *f) {
  double lambda0 [3];
  double lambda1 [3];
  double lambda2 [3];
  ...
  lambda0[2] = (360.0*dm0[2]*pow(Nv[0],5)*pow(lo[0],4)+(720.0*L[0]*dm0[2]-720.0*dm1[2])*pow(Nv[0],5)*pow(lo[0],3)+((504.0*dm0[2]*pow(L[0],2)+360.0*dm2[2]-1080.0*L[0]*dm1[2])*pow(Nv[0],5)-96.0*dm0[2]*pow(L[0],2)*pow(Nv[0],3))*pow(lo[0],2)+lo[0]*((144.0*dm0[2]*pow(L[0],3)-504.0*dm1[2]*pow(L[0],2)+360.0*L[0]*dm2[2])*pow(Nv[0],5)+(96.0*dm1[2]*pow(L[0],2)-96.0*dm0[2]*pow(L[0],3))*pow(Nv[0],3))+(18.0*dm0[2]*pow(L[0],4)-72.0*dm1[2]*pow(L[0],3)+60.0*dm2[2]*pow(L[0],2))*pow(Nv[0],5)+(48.0*dm1[2]*pow(L[0],3)-34.0*dm0[2]*pow(L[0],4))*pow(Nv[0],3)+8.0*Nv[0]*dm0[2]*pow(L[0],4))*pow(pow(L[0],6)*pow(Nv[0],4)-5.0*pow(L[0],6)*pow(Nv[0],2)+4.0*pow(L[0],6),-1);
  ...
  lambda1[2] = -1.0*(720.0*dm0[2]*pow(Nv[0],5)*pow(lo[0],3)+(1080.0*L[0]*dm0[2]-1440.0*dm1[2])*pow(Nv[0],5)*pow(lo[0],2)+lo[0]*((504.0*dm0[2]*pow(L[0],2)+720.0*dm2[2]-1440.0*L[0]*dm1[2])*pow(Nv[0],5)-96.0*dm0[2]*pow(L[0],2)*pow(Nv[0],3))+(72.0*dm0[2]*pow(L[0],3)-384.0*dm1[2]*pow(L[0],2)+360.0*L[0]*dm2[2])*pow(Nv[0],5)+(96.0*dm1[2]*pow(L[0],2)-48.0*dm0[2]*pow(L[0],3))*pow(Nv[0],3))*pow(pow(L[0],6)*pow(Nv[0],4)-5.0*pow(L[0],6)*pow(Nv[0],2)+4.0*pow(L[0],6),-1);
  ...
  lambda2[2] = (360.0*dm0[2]*pow(Nv[0],5)*pow(lo[0],2)+(60.0*dm0[2]*pow(L[0],2)+360.0*dm2[2]-360.0*L[0]*dm1[2])*pow(Nv[0],5)+lo[0]*(360.0*L[0]*dm0[2]-720.0*dm1[2])*pow(Nv[0],5))*pow(pow(L[0],6)*pow(Nv[0],4)-5.0*pow(L[0],6)*pow(Nv[0],2)+4.0*pow(L[0],6),-1);
