...
void SpitzerNuCellAvScale3xSer_P3(const double normNu, const double rmR3d2, const double massSq, const double chargeR4, const double eps0Sq, const double *m0, const double *vtSq, double *nu) 
{ 
  // nuNorm:  collisionality normalized by (T_0^(3/2)/n_0). 
  // rmR3d2:  reciprocal of mass raised to the (3/2) power. 
  // m0[32]:   number density. 
...
void SpitzerNuCellAvBuild3xSer_P3(const double elemCharge, const double mass, const double massSq, const double chargeR4, const double eps0Sq, const double *m0, const double *vtSq, double *nu) 
{ 
  // elemCharge: elementary charge. 
  // mass:       mass of this species. 
  // massSq:     mass of this species squared. 
