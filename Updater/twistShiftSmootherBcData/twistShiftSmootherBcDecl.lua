...
function _M.selectBcModifier(edge, basisNm, CDIM, polyOrder)
   local funcType = "void"
   local funcNm = string.format("twist_shift_smoother_bc_mod_%s_%dx_%s_p%d",edge, CDIM,basisNmMap[basisNm],polyOrder)
   local funcSign = "(double *confField, double *confFieldGhost)"
