...
{ 
  ...
  out[1] += (1.414213562373095*f[1]*wx1+0.408248290463863*f[3]*dv1)*volFact; 
  out[2] += (1.414213562373095*f[4]*wx1+0.408248290463863*f[6]*dv1)*volFact; 
  out[3] += (1.414213562373095*f[8]*wx1+0.4082482904638629*f[11]*dv1)*volFact; 
} 
...
{ 
  ...
  out[2] += (1.414213562373095*f[4]*wx1_sq+0.816496580927726*f[6]*dv1*wx1+0.105409255338946*f[8]*dv1_sq+0.1178511301977579*f[4]*dv1_sq)*volFact; 
} 
...
{ 
  ...
  out[0] += (1.414213562373095*f[0]*wx1_sq+0.8164965809277261*f[2]*dv1*wx1+0.105409255338946*f[5]*dv1_sq+0.1178511301977579*f[0]*dv1_sq)*volFact; 
  out[1] += (1.414213562373095*f[1]*wx1_sq+0.8164965809277261*f[3]*dv1*wx1+0.105409255338946*f[7]*dv1_sq+0.1178511301977579*f[1]*dv1_sq)*volFact; 
  out[2] += (1.414213562373095*f[4]*wx1_sq+0.816496580927726*f[6]*dv1*wx1+0.105409255338946*f[10]*dv1_sq+0.1178511301977579*f[4]*dv1_sq)*volFact; 
  out[3] += (1.414213562373095*f[8]*wx1_sq+0.8164965809277258*f[11]*dv1*wx1+0.1054092553389459*f[13]*dv1_sq+0.1178511301977579*f[8]*dv1_sq)*volFact; 
} 
...
{ 
  ...
  out[2] += (1.414213562373095*f[4]*wx1*wx1_sq+1.224744871391589*f[6]*dv1*wx1_sq+0.3162277660168379*f[8]*dv1_sq*wx1+0.3535533905932737*f[4]*dv1_sq*wx1+0.06123724356957942*f[6]*dv1*dv1_sq)*volFact; 
} 
...
{ 
  ...
  out[1] += (1.414213562373095*f[1]*wx1*wx1_sq+1.224744871391589*f[3]*dv1*wx1_sq+0.3162277660168379*f[7]*dv1_sq*wx1+0.3535533905932737*f[1]*dv1_sq*wx1+0.02672612419124244*f[12]*dv1*dv1_sq+0.06123724356957942*f[3]*dv1*dv1_sq)*volFact; 
  out[2] += (1.414213562373095*f[4]*wx1*wx1_sq+1.224744871391589*f[6]*dv1*wx1_sq+0.3162277660168379*f[10]*dv1_sq*wx1+0.3535533905932737*f[4]*dv1_sq*wx1+0.02672612419124243*f[14]*dv1*dv1_sq+0.06123724356957942*f[6]*dv1*dv1_sq)*volFact; 
  out[3] += (1.414213562373095*f[8]*wx1*wx1_sq+1.224744871391589*f[11]*dv1*wx1_sq+0.3162277660168379*f[13]*dv1_sq*wx1+0.3535533905932737*f[8]*dv1_sq*wx1+0.02672612419124243*f[15]*dv1*dv1_sq+0.06123724356957942*f[11]*dv1*dv1_sq)*volFact; 
} 
...
{ 
  ...
  outM2[2] += (0.105409255338946*f[8]*dv1_sq+0.1178511301977579*f[4]*dv1_sq)*volFact-1.0*tempM0[2]*wx1_sq+2.0*tempM1i[2]*wx1; 
} 
...
{ 
  ...
  tempM1i[1] = 0.408248290463863*f[3]*dv1*volFact+tempM0[1]*wx1; 
  tempM1i[2] = 0.408248290463863*f[6]*dv1*volFact+tempM0[2]*wx1; 
  tempM1i[3] = 0.4082482904638629*f[11]*dv1*volFact+tempM0[3]*wx1; 
  ...
  outM2[0] += (0.105409255338946*f[5]*dv1_sq+0.1178511301977579*f[0]*dv1_sq)*volFact-1.0*tempM0[0]*wx1_sq+2.0*tempM1i[0]*wx1; 
  outM2[1] += (0.105409255338946*f[7]*dv1_sq+0.1178511301977579*f[1]*dv1_sq)*volFact-1.0*tempM0[1]*wx1_sq+2.0*tempM1i[1]*wx1; 
  outM2[2] += (0.105409255338946*f[10]*dv1_sq+0.1178511301977579*f[4]*dv1_sq)*volFact-1.0*tempM0[2]*wx1_sq+2.0*tempM1i[2]*wx1; 
  outM2[3] += (0.1054092553389459*f[13]*dv1_sq+0.1178511301977579*f[8]*dv1_sq)*volFact-1.0*tempM0[3]*wx1_sq+2.0*tempM1i[3]*wx1; 
} 
void MomentCalc1x1vTensor_StarMoments_P1(const double *w, const double *dxv, const double *f, double *outM0, double *outM1i, double *outM2) 
{ 
  const double volFact = dxv[1]/2; 
  const double wx1 = w[1], dv1 = dxv[1]; 
  const double wx1_sq = wx1*wx1, dv1_sq = dv1*dv1; 
