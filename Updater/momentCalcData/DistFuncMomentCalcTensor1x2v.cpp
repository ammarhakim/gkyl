...
{ 
  ...
  out[1] += volFact*(2.0*f[1]*wx1+0.5773502691896258*f[4]*dv1); 
  out[2] += volFact*(2.0*f[7]*wx1+0.5773502691896257*f[11]*dv1); 
  out[3] += volFact*(2.0*f[17]*wx1+0.5773502691896256*f[26]*dv1); 
  ...
  out[7] += volFact*(2.0*f[17]*wx2+0.5773502691896256*f[28]*dv2); 
} 
...
{ 
  ...
  out[8] += volFact*(2.0*f[7]*wx2_sq+1.154700538379251*f[13]*dv2*wx2+0.149071198499986*f[21]*dv2_sq+0.1666666666666667*f[7]*dv2_sq); 
} 
...
{ 
  ...
  out[0] += volFact*(2.0*f[0]*wx1_sq+1.154700538379252*f[2]*dv1*wx1+0.149071198499986*f[8]*dv1_sq+0.1666666666666667*f[0]*dv1_sq); 
  out[1] += volFact*(2.0*f[1]*wx1_sq+1.154700538379252*f[4]*dv1*wx1+0.149071198499986*f[12]*dv1_sq+0.1666666666666667*f[1]*dv1_sq); 
  out[2] += volFact*(2.0*f[7]*wx1_sq+1.154700538379251*f[11]*dv1*wx1+0.149071198499986*f[23]*dv1_sq+0.1666666666666667*f[7]*dv1_sq); 
  out[3] += volFact*(2.0*f[17]*wx1_sq+1.154700538379251*f[26]*dv1*wx1+0.149071198499986*f[38]*dv1_sq+0.1666666666666667*f[17]*dv1_sq); 
  ...
  out[6] += volFact*(2.0*f[7]*wx1*wx2+0.5773502691896257*f[11]*dv1*wx2+0.5773502691896257*f[13]*dv2*wx1+0.1666666666666667*f[20]*dv1*dv2); 
  out[7] += volFact*(2.0*f[17]*wx1*wx2+0.5773502691896256*f[26]*dv1*wx2+0.5773502691896256*f[28]*dv2*wx1+0.1666666666666667*f[35]*dv1*dv2); 
  ...
  out[10] += volFact*(2.0*f[7]*wx2_sq+1.154700538379251*f[13]*dv2*wx2+0.149071198499986*f[24]*dv2_sq+0.1666666666666667*f[7]*dv2_sq); 
  out[11] += volFact*(2.0*f[17]*wx2_sq+1.154700538379251*f[28]*dv2*wx2+0.149071198499986*f[40]*dv2_sq+0.1666666666666667*f[17]*dv2_sq); 
} 
...
{ 
  ...
  out[2] += volFact*(2.0*f[7]*wx2_sq+1.154700538379251*f[13]*dv2*wx2+2.0*f[7]*wx1_sq+1.154700538379251*f[11]*dv1*wx1+0.149071198499986*f[21]*dv2_sq+0.1666666666666667*f[7]*dv2_sq+0.149071198499986*f[20]*dv1_sq+0.1666666666666667*f[7]*dv1_sq); 
} 
...
{ 
  ...
  out[0] += volFact*(2.0*f[0]*wx2_sq+1.154700538379252*f[3]*dv2*wx2+2.0*f[0]*wx1_sq+1.154700538379252*f[2]*dv1*wx1+0.149071198499986*f[9]*dv2_sq+0.1666666666666667*f[0]*dv2_sq+0.149071198499986*f[8]*dv1_sq+0.1666666666666667*f[0]*dv1_sq); 
  out[1] += volFact*(2.0*f[1]*wx2_sq+1.154700538379252*f[5]*dv2*wx2+2.0*f[1]*wx1_sq+1.154700538379252*f[4]*dv1*wx1+0.149071198499986*f[15]*dv2_sq+0.1666666666666667*f[1]*dv2_sq+0.149071198499986*f[12]*dv1_sq+0.1666666666666667*f[1]*dv1_sq); 
  out[2] += volFact*(2.0*f[7]*wx2_sq+1.154700538379251*f[13]*dv2*wx2+2.0*f[7]*wx1_sq+1.154700538379251*f[11]*dv1*wx1+0.149071198499986*f[24]*dv2_sq+0.1666666666666667*f[7]*dv2_sq+0.149071198499986*f[23]*dv1_sq+0.1666666666666667*f[7]*dv1_sq); 
  out[3] += volFact*(2.0*f[17]*wx2_sq+1.154700538379251*f[28]*dv2*wx2+2.0*f[17]*wx1_sq+1.154700538379251*f[26]*dv1*wx1+0.149071198499986*f[40]*dv2_sq+0.1666666666666667*f[17]*dv2_sq+0.149071198499986*f[38]*dv1_sq+0.1666666666666667*f[17]*dv1_sq); 
} 
...
{ 
  ...
  out[2] += volFact*(2.0*f[7]*wx1*wx2_sq+0.5773502691896257*f[11]*dv1*wx2_sq+1.154700538379251*f[13]*dv2*wx1*wx2+0.3333333333333333*f[17]*dv1*dv2*wx2+2.0*f[7]*wx1*wx1_sq+1.732050807568877*f[11]*dv1*wx1_sq+0.149071198499986*f[21]*dv2_sq*wx1+0.1666666666666667*f[7]*dv2_sq*wx1+0.4472135954999579*f[20]*dv1_sq*wx1+0.5*f[7]*dv1_sq*wx1+0.04303314829119353*f[24]*dv1*dv2_sq+0.04811252243246881*f[11]*dv1*dv2_sq+0.08660254037844385*f[11]*dv1*dv1_sq); 
  ...
  out[5] += volFact*(2.0*f[7]*wx2*wx2_sq+1.732050807568877*f[13]*dv2*wx2_sq+2.0*f[7]*wx1_sq*wx2+1.154700538379251*f[11]*dv1*wx1*wx2+0.4472135954999579*f[21]*dv2_sq*wx2+0.5*f[7]*dv2_sq*wx2+0.149071198499986*f[20]*dv1_sq*wx2+0.1666666666666667*f[7]*dv1_sq*wx2+0.5773502691896257*f[13]*dv2*wx1_sq+0.3333333333333333*f[17]*dv1*dv2*wx1+0.08660254037844385*f[13]*dv2*dv2_sq+0.04303314829119353*f[23]*dv1_sq*dv2+0.04811252243246881*f[13]*dv1_sq*dv2); 
} 
...
{ 
  ...
  out[1] += volFact*(2.0*f[1]*wx1*wx2_sq+0.5773502691896258*f[4]*dv1*wx2_sq+1.154700538379252*f[5]*dv2*wx1*wx2+0.3333333333333333*f[10]*dv1*dv2*wx2+2.0*f[1]*wx1*wx1_sq+1.732050807568877*f[4]*dv1*wx1_sq+0.149071198499986*f[15]*dv2_sq*wx1+0.1666666666666667*f[1]*dv2_sq*wx1+0.447213595499958*f[12]*dv1_sq*wx1+0.5*f[1]*dv1_sq*wx1+0.04303314829119353*f[22]*dv1*dv2_sq+0.04811252243246882*f[4]*dv1*dv2_sq+0.03779644730092273*f[27]*dv1*dv1_sq+0.08660254037844387*f[4]*dv1*dv1_sq); 
  out[2] += volFact*(2.0*f[7]*wx1*wx2_sq+0.5773502691896257*f[11]*dv1*wx2_sq+1.154700538379251*f[13]*dv2*wx1*wx2+0.3333333333333333*f[20]*dv1*dv2*wx2+2.0*f[7]*wx1*wx1_sq+1.732050807568877*f[11]*dv1*wx1_sq+0.149071198499986*f[24]*dv2_sq*wx1+0.1666666666666667*f[7]*dv2_sq*wx1+0.4472135954999579*f[23]*dv1_sq*wx1+0.5*f[7]*dv1_sq*wx1+0.04303314829119353*f[33]*dv1*dv2_sq+0.04811252243246881*f[11]*dv1*dv2_sq+0.03779644730092271*f[39]*dv1*dv1_sq+0.08660254037844385*f[11]*dv1*dv1_sq); 
  out[3] += volFact*(2.0*f[17]*wx1*wx2_sq+0.5773502691896256*f[26]*dv1*wx2_sq+1.154700538379251*f[28]*dv2*wx1*wx2+0.3333333333333333*f[35]*dv1*dv2*wx2+2.0*f[17]*wx1*wx1_sq+1.732050807568877*f[26]*dv1*wx1_sq+0.149071198499986*f[40]*dv2_sq*wx1+0.1666666666666667*f[17]*dv2_sq*wx1+0.4472135954999579*f[38]*dv1_sq*wx1+0.5*f[17]*dv1_sq*wx1+0.04303314829119351*f[47]*dv1*dv2_sq+0.0481125224324688*f[26]*dv1*dv2_sq+0.03779644730092272*f[51]*dv1*dv1_sq+0.08660254037844385*f[26]*dv1*dv1_sq); 
  ...
  out[5] += volFact*(2.0*f[1]*wx2*wx2_sq+1.732050807568877*f[5]*dv2*wx2_sq+2.0*f[1]*wx1_sq*wx2+1.154700538379252*f[4]*dv1*wx1*wx2+0.447213595499958*f[15]*dv2_sq*wx2+0.5*f[1]*dv2_sq*wx2+0.149071198499986*f[12]*dv1_sq*wx2+0.1666666666666667*f[1]*dv1_sq*wx2+0.5773502691896258*f[5]*dv2*wx1_sq+0.3333333333333333*f[10]*dv1*dv2*wx1+0.03779644730092273*f[30]*dv2*dv2_sq+0.08660254037844387*f[5]*dv2*dv2_sq+0.04303314829119353*f[21]*dv1_sq*dv2+0.04811252243246882*f[5]*dv1_sq*dv2); 
  out[6] += volFact*(2.0*f[7]*wx2*wx2_sq+1.732050807568877*f[13]*dv2*wx2_sq+2.0*f[7]*wx1_sq*wx2+1.154700538379251*f[11]*dv1*wx1*wx2+0.4472135954999579*f[24]*dv2_sq*wx2+0.5*f[7]*dv2_sq*wx2+0.149071198499986*f[23]*dv1_sq*wx2+0.1666666666666667*f[7]*dv1_sq*wx2+0.5773502691896257*f[13]*dv2*wx1_sq+0.3333333333333333*f[20]*dv1*dv2*wx1+0.03779644730092271*f[42]*dv2*dv2_sq+0.08660254037844385*f[13]*dv2*dv2_sq+0.04303314829119353*f[32]*dv1_sq*dv2+0.04811252243246881*f[13]*dv1_sq*dv2); 
  out[7] += volFact*(2.0*f[17]*wx2*wx2_sq+1.732050807568877*f[28]*dv2*wx2_sq+2.0*f[17]*wx1_sq*wx2+1.154700538379251*f[26]*dv1*wx1*wx2+0.4472135954999579*f[40]*dv2_sq*wx2+0.5*f[17]*dv2_sq*wx2+0.149071198499986*f[38]*dv1_sq*wx2+0.1666666666666667*f[17]*dv1_sq*wx2+0.5773502691896256*f[28]*dv2*wx1_sq+0.3333333333333333*f[35]*dv1*dv2*wx1+0.03779644730092272*f[52]*dv2*dv2_sq+0.08660254037844385*f[28]*dv2*dv2_sq+0.04303314829119351*f[45]*dv1_sq*dv2+0.0481125224324688*f[28]*dv1_sq*dv2); 
} 
...
{ 
  ...
  outM2[2] += tempM0[2]*((-1.0*wx2_sq)-1.0*wx1_sq)+2.0*tempM1i[5]*wx2+2.0*tempM1i[2]*wx1+(0.149071198499986*f[21]*dv2_sq+0.1666666666666667*f[7]*dv2_sq+0.149071198499986*f[20]*dv1_sq+0.1666666666666667*f[7]*dv1_sq)*volFact; 
} 
...
{ 
  ...
  tempM1i[1] = tempM0[1]*wx1+0.5773502691896258*f[4]*dv1*volFact; 
  tempM1i[2] = tempM0[2]*wx1+0.5773502691896257*f[11]*dv1*volFact; 
  tempM1i[3] = tempM0[3]*wx1+0.5773502691896256*f[26]*dv1*volFact; 
  ...
  tempM1i[7] = tempM0[3]*wx2+0.5773502691896256*f[28]*dv2*volFact; 
  ...
  outM2[2] += tempM0[2]*((-1.0*wx2_sq)-1.0*wx1_sq)+2.0*tempM1i[6]*wx2+2.0*tempM1i[2]*wx1+(0.149071198499986*f[24]*dv2_sq+0.1666666666666667*f[7]*dv2_sq+0.149071198499986*f[23]*dv1_sq+0.1666666666666667*f[7]*dv1_sq)*volFact; 
  outM2[3] += tempM0[3]*((-1.0*wx2_sq)-1.0*wx1_sq)+2.0*tempM1i[7]*wx2+2.0*tempM1i[3]*wx1+(0.149071198499986*f[40]*dv2_sq+0.1666666666666667*f[17]*dv2_sq+0.149071198499986*f[38]*dv1_sq+0.1666666666666667*f[17]*dv1_sq)*volFact; 
} 
