...
{ 
  ...
  out[4] += 4.0*f[0]*volFact*wx3_sq+2.309401076758503*f[4]*dv3*volFact*wx3+4.0*f[0]*volFact*wx2_sq+2.309401076758503*f[3]*dv2*volFact*wx2+4.0*f[0]*volFact*wx1_sq+2.309401076758503*f[2]*dv1*volFact*wx1+0.3333333333333333*f[0]*dv3_sq*volFact+0.3333333333333333*f[0]*dv2_sq*volFact+0.3333333333333333*f[0]*dv1_sq*volFact; 
} 
...
{ 
  ...
  out[0] += 4.0*f[0]*volFact; 
  out[4] += 4.0*f[0]*volFact*wx3_sq+2.309401076758503*f[4]*dv3*volFact*wx3+4.0*f[0]*volFact*wx2_sq+2.309401076758503*f[3]*dv2*volFact*wx2+4.0*f[0]*volFact*wx1_sq+2.309401076758503*f[2]*dv1*volFact*wx1+0.2981423969999719*f[14]*dv3_sq*volFact+0.3333333333333333*f[0]*dv3_sq*volFact+0.2981423969999719*f[13]*dv2_sq*volFact+0.3333333333333333*f[0]*dv2_sq*volFact+0.2981423969999719*f[12]*dv1_sq*volFact+0.3333333333333333*f[0]*dv1_sq*volFact; 
} 
