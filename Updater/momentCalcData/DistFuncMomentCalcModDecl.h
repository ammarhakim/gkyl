...
void GkMomentCalc1x1vSer_Dens_P4(const double *w, const double *dxv, const double *f, double *out); 
void GkMomentCalc1x1vSer_Upar_P4(const double *w, const double *dxv, const double *f, double *out); 
void GkMomentCalc1x1vSer_Ppar_P4(const double *w, const double *dxv, const double *f, double *out); 
void GkMomentCalc1x1vSer_Qpar_P4(const double *w, const double *dxv, const double *f, double *out); 
...
void GkMomentCalc1x1vMax_Pperp_P4(const double *w, const double *dxv, const double *f, double *out); 
void GkMomentCalc1x1vMax_Qpar_P4(const double *w, const double *dxv, const double *f, double *out); 
void GkMomentCalc1x1vMax_Qperp_P4(const double *w, const double *dxv, const double *f, double *out); 
