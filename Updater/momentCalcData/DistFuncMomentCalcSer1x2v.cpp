...
{ 
  ...
  zeta2[6] = 0.2357022603955158*dv1*dv2; 
  double zeta3[8]; 
  ...
  out[1] += (0.7071067811865475*zeta1[2]*f[4]+0.7071067811865475*zeta1[0]*f[1])*volFact; 
  out[2] += (0.7071067811865475*f[6]*zeta2[6]+0.7071067811865475*f[3]*zeta2[3]+0.7071067811865475*f[2]*zeta2[2]+0.7071067811865475*f[0]*zeta2[0])*volFact; 
  out[3] += (0.7071067811865475*zeta2[6]*f[7]+0.7071067811865475*zeta2[3]*f[5]+0.7071067811865475*zeta2[2]*f[4]+0.7071067811865475*zeta2[0]*f[1])*volFact; 
  out[4] += (0.7071067811865475*f[3]*zeta3[3]+0.7071067811865475*f[0]*zeta3[0])*volFact; 
  out[5] += (0.7071067811865475*zeta3[3]*f[5]+0.7071067811865475*zeta3[0]*f[1])*volFact; 
} 
...
{ 
  ...
  out[1] += (0.7071067811865475*zeta[3]*f[5]+0.7071067811865475*zeta[2]*f[4]+0.7071067811865475*zeta[0]*f[1])*volFact; 
} 
...
{ 
  ...
  out[0] += (0.7071067811865475*f[6]*zeta1[6]+0.7071067811865475*f[3]*zeta1[3]+0.7071067811865475*f[2]*zeta1[2]+0.7071067811865475*f[0]*zeta1[0])*volFact; 
  out[1] += (0.7071067811865475*zeta1[6]*f[7]+0.7071067811865475*zeta1[3]*f[5]+0.7071067811865475*zeta1[2]*f[4]+0.7071067811865475*zeta1[0]*f[1])*volFact; 
  out[2] += (0.7071067811865475*f[6]*zeta2[6]+0.7071067811865475*f[3]*zeta2[3]+0.7071067811865475*f[2]*zeta2[2]+0.7071067811865475*f[0]*zeta2[0])*volFact; 
  out[3] += (0.7071067811865475*zeta2[6]*f[7]+0.7071067811865475*zeta2[3]*f[5]+0.7071067811865475*zeta2[2]*f[4]+0.7071067811865475*zeta2[0]*f[1])*volFact; 
} 
...
{ 
  ...
  zeta1[16] = 0.06085806194501844*dv1*dv2_sq; 
  double zeta2[20]; 
  ...
  zeta2[14] = 0.06085806194501844*dv1_sq*dv2; 
  out[0] += (0.7071067811865475*f[16]*zeta1[16]+0.7071067811865475*f[9]*zeta1[9]+0.7071067811865475*f[8]*zeta1[8]+0.7071067811865475*f[6]*zeta1[6]+0.7071067811865475*f[3]*zeta1[3]+0.7071067811865475*f[2]*zeta1[2]+0.7071067811865475*f[0]*zeta1[0])*volFact; 
  out[1] += (0.7071067811865475*zeta1[16]*f[19]+0.7071067811865475*zeta1[9]*f[15]+0.7071067811865475*zeta1[8]*f[12]+0.7071067811865475*zeta1[6]*f[10]+0.7071067811865475*zeta1[3]*f[5]+0.7071067811865475*zeta1[2]*f[4]+0.7071067811865475*zeta1[0]*f[1])*volFact; 
  out[2] += (0.7071067811865475*zeta1[6]*f[17]+0.7071067811865475*zeta1[3]*f[13]+0.7071067811865475*zeta1[2]*f[11]+0.7071067811865475*zeta1[0]*f[7])*volFact; 
  out[3] += (0.7071067811865475*f[14]*zeta2[14]+0.7071067811865475*f[9]*zeta2[9]+0.7071067811865475*f[8]*zeta2[8]+0.7071067811865475*f[6]*zeta2[6]+0.7071067811865475*f[3]*zeta2[3]+0.7071067811865475*f[2]*zeta2[2]+0.7071067811865475*f[0]*zeta2[0])*volFact; 
  out[4] += (0.7071067811865475*zeta2[14]*f[18]+0.7071067811865475*zeta2[9]*f[15]+0.7071067811865475*zeta2[8]*f[12]+0.7071067811865475*zeta2[6]*f[10]+0.7071067811865475*zeta2[3]*f[5]+0.7071067811865475*zeta2[2]*f[4]+0.7071067811865475*zeta2[0]*f[1])*volFact; 
  out[5] += (0.7071067811865475*zeta2[6]*f[17]+0.7071067811865475*zeta2[3]*f[13]+0.7071067811865475*zeta2[2]*f[11]+0.7071067811865475*zeta2[0]*f[7])*volFact; 
} 
...
{ 
  ...
  out[1] += (2.0*f[1]*wx1*wx2_sq+0.5773502691896258*f[4]*dv1*wx2_sq+1.154700538379252*f[5]*dv2*wx1*wx2+0.3333333333333333*f[10]*dv1*dv2*wx2+1.732050807568877*f[4]*dv1*wx1_sq+2.0*f[1]*wx1_cu+0.149071198499986*f[15]*dv2_sq*wx1+0.1666666666666667*f[1]*dv2_sq*wx1+0.447213595499958*f[12]*dv1_sq*wx1+0.5*f[1]*dv1_sq*wx1+0.04303314829119353*f[22]*dv1*dv2_sq+0.04811252243246882*f[4]*dv1*dv2_sq+0.03779644730092273*f[24]*dv1_cu+0.08660254037844387*f[4]*dv1_cu)*volFact; 
  out[2] += (2.0*f[7]*wx1*wx2_sq+0.5773502691896257*f[11]*dv1*wx2_sq+1.154700538379251*f[13]*dv2*wx1*wx2+0.3333333333333333*f[20]*dv1*dv2*wx2+1.732050807568877*f[11]*dv1*wx1_sq+2.0*f[7]*wx1_cu+0.1666666666666667*f[7]*dv2_sq*wx1+0.5*f[7]*dv1_sq*wx1+0.04811252243246881*f[11]*dv1*dv2_sq+0.08660254037844385*f[11]*dv1_cu)*volFact; 
  out[3] += (2.0*f[17]*wx1*wx2_sq+0.5773502691896256*f[23]*dv1*wx2_sq+1.154700538379251*f[25]*dv2*wx1*wx2+0.3333333333333333*f[29]*dv1*dv2*wx2+1.732050807568877*f[23]*dv1*wx1_sq+2.0*f[17]*wx1_cu+0.1666666666666667*f[17]*dv2_sq*wx1+0.5*f[17]*dv1_sq*wx1+0.0481125224324688*f[23]*dv1*dv2_sq+0.08660254037844385*f[23]*dv1_cu)*volFact; 
  ...
  out[5] += (1.732050807568877*f[5]*dv2*wx2_sq+2.0*f[1]*wx2_cu+2.0*f[1]*wx1_sq*wx2+1.154700538379252*f[4]*dv1*wx1*wx2+0.447213595499958*f[15]*dv2_sq*wx2+0.5*f[1]*dv2_sq*wx2+0.149071198499986*f[12]*dv1_sq*wx2+0.1666666666666667*f[1]*dv1_sq*wx2+0.5773502691896258*f[5]*dv2*wx1_sq+0.3333333333333333*f[10]*dv1*dv2*wx1+0.03779644730092273*f[27]*dv2_cu+0.08660254037844387*f[5]*dv2_cu+0.04303314829119353*f[21]*dv1_sq*dv2+0.04811252243246882*f[5]*dv1_sq*dv2)*volFact; 
  out[6] += (1.732050807568877*f[13]*dv2*wx2_sq+2.0*f[7]*wx2_cu+2.0*f[7]*wx1_sq*wx2+1.154700538379251*f[11]*dv1*wx1*wx2+0.5*f[7]*dv2_sq*wx2+0.1666666666666667*f[7]*dv1_sq*wx2+0.5773502691896257*f[13]*dv2*wx1_sq+0.3333333333333333*f[20]*dv1*dv2*wx1+0.08660254037844385*f[13]*dv2_cu+0.04811252243246881*f[13]*dv1_sq*dv2)*volFact; 
  out[7] += (1.732050807568877*f[25]*dv2*wx2_sq+2.0*f[17]*wx2_cu+2.0*f[17]*wx1_sq*wx2+1.154700538379251*f[23]*dv1*wx1*wx2+0.5*f[17]*dv2_sq*wx2+0.1666666666666667*f[17]*dv1_sq*wx2+0.5773502691896256*f[25]*dv2*wx1_sq+0.3333333333333333*f[29]*dv1*dv2*wx1+0.08660254037844385*f[25]*dv2_cu+0.0481125224324688*f[25]*dv1_sq*dv2)*volFact; 
} 
...
{ 
  ...
  outM2[1] += (0.7071067811865475*zeta[3]*f[5]+0.7071067811865475*zeta[2]*f[4]+0.7071067811865475*zeta[0]*f[1])*volFact; 
} 
