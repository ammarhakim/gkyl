...
{ 
  ...
  out[0] += (2.0*f[0]*wx1_sq+1.154700538379252*f[4]*dv1*wx1+0.1666666666666667*f[0]*dv1_sq)*volFact; 
  out[1] += (2.0*f[1]*wx1_sq+0.1666666666666667*f[1]*dv1_sq)*volFact; 
  out[2] += (2.0*f[2]*wx1_sq+0.1666666666666667*f[2]*dv1_sq)*volFact; 
  out[3] += (2.0*f[3]*wx1_sq+0.1666666666666667*f[3]*dv1_sq)*volFact; 
  double tmp[4]; 
...
{ 
  ...
  out[0] += (2.0*f[0]*wx1*wx1_sq+1.732050807568877*f[4]*dv1*wx1_sq+0.5*f[0]*dv1_sq*wx1+0.08660254037844387*f[4]*dv1*dv1_sq)*volFact; 
  out[1] += (2.0*f[1]*wx1*wx1_sq+0.5*f[1]*dv1_sq*wx1)*volFact; 
  out[2] += (2.0*f[2]*wx1*wx1_sq+0.5*f[2]*dv1_sq*wx1)*volFact; 
  out[3] += (2.0*f[3]*wx1*wx1_sq+0.5*f[3]*dv1_sq*wx1)*volFact; 
} 
...
{ 
  ...
  const double wx2_sq = wx2*wx2, dv2_sq = dv2*dv2; 
  const double wx2_cu = wx2*wx2*wx2, dv2_cu = dv2*dv2*dv2; 
  out[0] += (2.0*f[0]*wx1*wx1_sq+1.732050807568877*f[4]*dv1*wx1_sq+0.4472135954999579*f[19]*dv1_sq*wx1+0.5*f[0]*dv1_sq*wx1+0.08660254037844387*f[4]*dv1*dv1_sq)*volFact; 
  out[1] += (2.0*f[1]*wx1*wx1_sq+1.732050807568877*f[9]*dv1*wx1_sq+0.5*f[1]*dv1_sq*wx1+0.08660254037844387*f[9]*dv1*dv1_sq)*volFact; 
  out[2] += (2.0*f[2]*wx1*wx1_sq+1.732050807568877*f[10]*dv1*wx1_sq+0.5*f[2]*dv1_sq*wx1+0.08660254037844387*f[10]*dv1*dv1_sq)*volFact; 
  out[3] += (2.0*f[3]*wx1*wx1_sq+1.732050807568877*f[11]*dv1*wx1_sq+0.5*f[3]*dv1_sq*wx1+0.08660254037844387*f[11]*dv1*dv1_sq)*volFact; 
  out[4] += (2.0*f[6]*wx1*wx1_sq+0.5*f[6]*dv1_sq*wx1)*volFact; 
  out[5] += (2.0*f[7]*wx1*wx1_sq+0.5*f[7]*dv1_sq*wx1)*volFact; 
  out[6] += (2.0*f[8]*wx1*wx1_sq+0.5*f[8]*dv1_sq*wx1)*volFact; 
  out[7] += (2.0*f[16]*wx1*wx1_sq+0.5*f[16]*dv1_sq*wx1)*volFact; 
  out[8] += (2.0*f[17]*wx1*wx1_sq+0.5*f[17]*dv1_sq*wx1)*volFact; 
  out[9] += (2.0*f[18]*wx1*wx1_sq+0.5*f[18]*dv1_sq*wx1)*volFact; 
} 
...
{ 
  ...
  outM2[0] += (2.0*f[0]*wx1_sq+1.154700538379252*f[4]*dv1*wx1+0.1666666666666667*f[0]*dv1_sq)*volFact; 
  outM2[1] += (2.0*f[1]*wx1_sq+0.1666666666666667*f[1]*dv1_sq)*volFact; 
  outM2[2] += (2.0*f[2]*wx1_sq+0.1666666666666667*f[2]*dv1_sq)*volFact; 
  outM2[3] += (2.0*f[3]*wx1_sq+0.1666666666666667*f[3]*dv1_sq)*volFact; 
  double tmp[4]; 
  tmp[0] = 2.0*f[0]*wx2+0.5773502691896258*f[5]*dv2; 
  tmp[1] = 2.0*f[1]*wx2; 
  tmp[2] = 2.0*f[2]*wx2; 
