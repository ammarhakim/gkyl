...
{ 
  ...
  zeta[0] = 4.0*wx1_sq+0.3333333333333333*dv1_sq; 
  zeta[3] = 2.309401076758503*dv1*wx1; 
  out[0] += (0.5*f[3]*zeta[3]+0.5*f[0]*zeta[0])*volFact; 
  out[1] += (0.5*zeta[3]*f[6]+0.5*zeta[0]*f[1])*volFact; 
  out[2] += (0.5*zeta[3]*f[7]+0.5*zeta[0]*f[2])*volFact; 
  out[3] += (0.5*zeta[3]*f[11]+0.5*zeta[0]*f[5])*volFact; 
  double tmp[4]; 
...
{ 
  ...
  zeta[0] = 4.0*wx1_cu+dv1_sq*wx1; 
  zeta[3] = 3.464101615137754*dv1*wx1_sq+0.1732050807568877*dv1_cu; 
  out[0] += (0.5*f[3]*zeta[3]+0.5*f[0]*zeta[0])*volFact; 
  out[1] += (0.5*zeta[3]*f[6]+0.5*zeta[0]*f[1])*volFact; 
  out[2] += (0.5*zeta[3]*f[7]+0.5*zeta[0]*f[2])*volFact; 
  out[3] += (0.5*zeta[3]*f[11]+0.5*zeta[0]*f[5])*volFact; 
...
{ 
  ...
  zeta[0] = 4.0*wx1_cu+dv1_sq*wx1; 
  zeta[3] = 3.464101615137754*dv1*wx1_sq+0.1732050807568877*dv1_cu; 
  zeta[13] = 0.8944271909999159*dv1_sq*wx1; 
  out[0] += (0.5*f[13]*zeta[13]+0.5*f[3]*zeta[3]+0.5*f[0]*zeta[0])*volFact; 
  out[1] += (0.5000000000000001*zeta[13]*f[23]+0.5*zeta[3]*f[6]+0.5*zeta[0]*f[1])*volFact; 
  out[2] += (0.5000000000000001*zeta[13]*f[24]+0.5*zeta[3]*f[7]+0.5*zeta[0]*f[2])*volFact; 
  out[3] += (0.5*zeta[13]*f[34]+0.5*zeta[3]*f[15]+0.5*zeta[0]*f[5])*volFact; 
  out[4] += (0.5000000000000001*zeta[3]*f[21]+0.5*zeta[0]*f[11])*volFact; 
  out[5] += (0.5000000000000001*zeta[3]*f[22]+0.5*zeta[0]*f[12])*volFact; 
  out[6] += (0.5000000000000001*zeta[3]*f[32]+0.5*zeta[0]*f[19])*volFact; 
  out[7] += (0.5000000000000001*zeta[3]*f[33]+0.5*zeta[0]*f[20])*volFact; 
} 
...
{ 
  ...
  zeta[0] = 4.0*wx1_sq+0.3333333333333333*dv1_sq; 
  zeta[3] = 2.309401076758503*dv1*wx1; 
  outM2[0] += (0.5*f[3]*zeta[3]+0.5*f[0]*zeta[0])*volFact; 
  outM2[1] += (0.5*zeta[3]*f[6]+0.5*zeta[0]*f[1])*volFact; 
  outM2[2] += (0.5*zeta[3]*f[7]+0.5*zeta[0]*f[2])*volFact; 
  outM2[3] += (0.5*zeta[3]*f[11]+0.5*zeta[0]*f[5])*volFact; 
  double tmp[4]; 
  tmp[0] = 2.0*f[0]*wx2+0.5773502691896258*f[4]*dv2; 
  tmp[1] = 2.0*f[1]*wx2+0.5773502691896258*f[8]*dv2; 
  tmp[2] = 2.0*f[2]*wx2+0.5773502691896258*f[9]*dv2; 
