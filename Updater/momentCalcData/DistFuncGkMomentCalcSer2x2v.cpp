...
{ 
  ...
  outM2[0] += volFact*(2.0*f[0]*wx1_sq+0.5773502691896258*f[3]*dv1*wx1); 
  outM2[1] += volFact*(2.0*f[1]*wx1_sq+0.5773502691896258*f[6]*dv1*wx1); 
  outM2[2] += volFact*(2.0*f[2]*wx1_sq+0.5773502691896258*f[7]*dv1*wx1); 
  outM2[3] += volFact*(2.0*f[5]*wx1_sq+0.5773502691896258*f[11]*dv1*wx1); 
  double tmp[4]; 
  tmp[0] = 2.0*f[0]*wx2+0.5773502691896258*f[4]*dv2; 
  tmp[1] = 2.0*f[1]*wx2+0.5773502691896258*f[8]*dv2; 
  tmp[2] = 2.0*f[2]*wx2+0.5773502691896258*f[9]*dv2; 
