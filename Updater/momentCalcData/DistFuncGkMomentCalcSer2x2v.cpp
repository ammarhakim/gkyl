...
{ 
  ...
  out[0] += (2.0*(0.5*Bmag[1]*tmp[1]+0.5*Bmag[0]*tmp[0])*volFact)/m_; 
  out[1] += (2.0*(0.5*Bmag[0]*tmp[1]+0.5*tmp[0]*Bmag[1])*volFact)/m_; 
  out[2] += (2.0*(0.5*Bmag[1]*tmp[3]+0.5*Bmag[0]*tmp[2])*volFact)/m_; 
  out[3] += (2.0*(0.5*Bmag[0]*tmp[3]+0.5*Bmag[1]*tmp[2])*volFact)/m_; 
} 
...
{ 
  ...
  out[0] += (2.0*(0.5*Bmag[4]*tmp[4]+0.5*Bmag[1]*tmp[1]+0.5*Bmag[0]*tmp[0])*volFact)/m_; 
  out[1] += (2.0*(0.4472135954999579*Bmag[1]*tmp[4]+0.4472135954999579*tmp[1]*Bmag[4]+0.5*Bmag[0]*tmp[1]+0.5*tmp[0]*Bmag[1])*volFact)/m_; 
  out[2] += (2.0*(0.5000000000000001*Bmag[4]*tmp[6]+0.5*Bmag[1]*tmp[3]+0.5*Bmag[0]*tmp[2])*volFact)/m_; 
  out[3] += (2.0*(0.447213595499958*Bmag[1]*tmp[6]+0.4472135954999579*tmp[3]*Bmag[4]+0.5*Bmag[0]*tmp[3]+0.5*Bmag[1]*tmp[2])*volFact)/m_; 
  out[4] += (2.0*(0.31943828249997*Bmag[4]*tmp[4]+0.5*Bmag[0]*tmp[4]+0.5*tmp[0]*Bmag[4]+0.4472135954999579*Bmag[1]*tmp[1])*volFact)/m_; 
  out[5] += (2.0*(0.5000000000000001*Bmag[1]*tmp[7]+0.5*Bmag[0]*tmp[5])*volFact)/m_; 
  out[6] += (2.0*(0.31943828249997*Bmag[4]*tmp[6]+0.5*Bmag[0]*tmp[6]+0.5000000000000001*tmp[2]*Bmag[4]+0.447213595499958*Bmag[1]*tmp[3])*volFact)/m_; 
  out[7] += (2.0*(0.4472135954999579*Bmag[4]*tmp[7]+0.5*Bmag[0]*tmp[7]+0.5000000000000001*Bmag[1]*tmp[5])*volFact)/m_; 
} 
...
{ 
  ...
  tmp[2] = 2.0*f[2]*wx2+0.5773502691896258*f[9]*dv2; 
  tmp[3] = 2.0*f[5]*wx2+0.5773502691896258*f[12]*dv2; 
  out[0] += ((0.5*Bmag[1]*tmp[1]+0.5*Bmag[0]*tmp[0])*volFact)/m_; 
  out[1] += ((0.5*Bmag[0]*tmp[1]+0.5*tmp[0]*Bmag[1])*volFact)/m_; 
  out[2] += ((0.5*Bmag[1]*tmp[3]+0.5*Bmag[0]*tmp[2])*volFact)/m_; 
  out[3] += ((0.5*Bmag[0]*tmp[3]+0.5*Bmag[1]*tmp[2])*volFact)/m_; 
} 
...
{ 
  ...
  tmp[6] = 2.0*f[19]*wx2+0.5773502691896257*f[35]*dv2; 
  tmp[7] = 2.0*f[20]*wx2+0.5773502691896257*f[36]*dv2; 
  out[0] += ((0.5*Bmag[4]*tmp[4]+0.5*Bmag[1]*tmp[1]+0.5*Bmag[0]*tmp[0])*volFact)/m_; 
  out[1] += ((0.4472135954999579*Bmag[1]*tmp[4]+0.4472135954999579*tmp[1]*Bmag[4]+0.5*Bmag[0]*tmp[1]+0.5*tmp[0]*Bmag[1])*volFact)/m_; 
  out[2] += ((0.5000000000000001*Bmag[4]*tmp[6]+0.5*Bmag[1]*tmp[3]+0.5*Bmag[0]*tmp[2])*volFact)/m_; 
  out[3] += ((0.447213595499958*Bmag[1]*tmp[6]+0.4472135954999579*tmp[3]*Bmag[4]+0.5*Bmag[0]*tmp[3]+0.5*Bmag[1]*tmp[2])*volFact)/m_; 
  out[4] += ((0.31943828249997*Bmag[4]*tmp[4]+0.5*Bmag[0]*tmp[4]+0.5*tmp[0]*Bmag[4]+0.4472135954999579*Bmag[1]*tmp[1])*volFact)/m_; 
  out[5] += ((0.5000000000000001*Bmag[1]*tmp[7]+0.5*Bmag[0]*tmp[5])*volFact)/m_; 
  out[6] += ((0.31943828249997*Bmag[4]*tmp[6]+0.5*Bmag[0]*tmp[6]+0.5000000000000001*tmp[2]*Bmag[4]+0.447213595499958*Bmag[1]*tmp[3])*volFact)/m_; 
  out[7] += ((0.4472135954999579*Bmag[4]*tmp[7]+0.5*Bmag[0]*tmp[7]+0.5000000000000001*Bmag[1]*tmp[5])*volFact)/m_; 
} 
...
{ 
  ...
  const double wx1 = w[2], dv1 = dxv[2]; 
  const double wx2 = w[3], dv2 = dxv[3]; 
  out[0] += (volFact*(Bmag[1]*f[1]*wx1*wx2+Bmag[0]*f[0]*wx1*wx2+0.2886751345948129*Bmag[1]*f[6]*dv1*wx2+0.2886751345948129*Bmag[0]*f[3]*dv1*wx2+0.2886751345948129*Bmag[1]*f[8]*dv2*wx1+0.2886751345948129*Bmag[0]*f[4]*dv2*wx1+0.08333333333333333*Bmag[1]*f[13]*dv1*dv2+0.08333333333333333*Bmag[0]*f[10]*dv1*dv2))/m_; 
  out[1] += (volFact*(Bmag[0]*f[1]*wx1*wx2+f[0]*Bmag[1]*wx1*wx2+0.2886751345948129*Bmag[0]*f[6]*dv1*wx2+0.2886751345948129*Bmag[1]*f[3]*dv1*wx2+0.2886751345948129*Bmag[0]*f[8]*dv2*wx1+0.2886751345948129*Bmag[1]*f[4]*dv2*wx1+0.08333333333333333*Bmag[0]*f[13]*dv1*dv2+0.08333333333333333*Bmag[1]*f[10]*dv1*dv2))/m_; 
  out[2] += (volFact*(Bmag[1]*f[5]*wx1*wx2+Bmag[0]*f[2]*wx1*wx2+0.2886751345948129*Bmag[1]*f[11]*dv1*wx2+0.2886751345948129*Bmag[0]*f[7]*dv1*wx2+0.2886751345948129*Bmag[1]*f[12]*dv2*wx1+0.2886751345948129*Bmag[0]*f[9]*dv2*wx1+0.08333333333333333*Bmag[1]*f[15]*dv1*dv2+0.08333333333333333*Bmag[0]*f[14]*dv1*dv2))/m_; 
  out[3] += (volFact*(Bmag[0]*f[5]*wx1*wx2+Bmag[1]*f[2]*wx1*wx2+0.2886751345948129*Bmag[0]*f[11]*dv1*wx2+0.2886751345948129*Bmag[1]*f[7]*dv1*wx2+0.2886751345948129*Bmag[0]*f[12]*dv2*wx1+0.2886751345948129*Bmag[1]*f[9]*dv2*wx1+0.08333333333333333*Bmag[0]*f[15]*dv1*dv2+0.08333333333333333*Bmag[1]*f[14]*dv1*dv2))/m_; 
} 
...
{ 
  ...
  const double wx1 = w[2], dv1 = dxv[2]; 
  const double wx2 = w[3], dv2 = dxv[3]; 
  out[0] += (volFact*(Bmag[4]*f[11]*wx1*wx2+Bmag[1]*f[1]*wx1*wx2+Bmag[0]*f[0]*wx1*wx2+0.2886751345948129*Bmag[4]*f[21]*dv1*wx2+0.2886751345948129*Bmag[1]*f[6]*dv1*wx2+0.2886751345948129*Bmag[0]*f[3]*dv1*wx2+0.2886751345948129*Bmag[4]*f[25]*dv2*wx1+0.2886751345948129*Bmag[1]*f[8]*dv2*wx1+0.2886751345948129*Bmag[0]*f[4]*dv2*wx1+0.08333333333333333*Bmag[4]*f[37]*dv1*dv2+0.08333333333333333*Bmag[1]*f[17]*dv1*dv2+0.08333333333333333*Bmag[0]*f[10]*dv1*dv2))/m_; 
  out[1] += (volFact*(0.8944271909999159*Bmag[1]*f[11]*wx1*wx2+0.8944271909999159*f[1]*Bmag[4]*wx1*wx2+Bmag[0]*f[1]*wx1*wx2+f[0]*Bmag[1]*wx1*wx2+0.2581988897471611*Bmag[1]*f[21]*dv1*wx2+0.2581988897471612*Bmag[4]*f[6]*dv1*wx2+0.2886751345948129*Bmag[0]*f[6]*dv1*wx2+0.2886751345948129*Bmag[1]*f[3]*dv1*wx2+0.2581988897471611*Bmag[1]*f[25]*dv2*wx1+0.2581988897471612*Bmag[4]*f[8]*dv2*wx1+0.2886751345948129*Bmag[0]*f[8]*dv2*wx1+0.2886751345948129*Bmag[1]*f[4]*dv2*wx1+0.07453559924999298*Bmag[1]*f[37]*dv1*dv2+0.07453559924999298*Bmag[4]*f[17]*dv1*dv2+0.08333333333333333*Bmag[0]*f[17]*dv1*dv2+0.08333333333333333*Bmag[1]*f[10]*dv1*dv2))/m_; 
  out[2] += (volFact*(1.0*Bmag[4]*f[19]*wx1*wx2+Bmag[1]*f[5]*wx1*wx2+Bmag[0]*f[2]*wx1*wx2+0.2886751345948129*Bmag[4]*f[32]*dv1*wx2+0.2886751345948129*Bmag[1]*f[15]*dv1*wx2+0.2886751345948129*Bmag[0]*f[7]*dv1*wx2+0.2886751345948129*Bmag[4]*f[35]*dv2*wx1+0.2886751345948129*Bmag[1]*f[16]*dv2*wx1+0.2886751345948129*Bmag[0]*f[9]*dv2*wx1+0.08333333333333336*Bmag[4]*f[44]*dv1*dv2+0.08333333333333333*Bmag[1]*f[31]*dv1*dv2+0.08333333333333333*Bmag[0]*f[18]*dv1*dv2))/m_; 
  out[3] += (volFact*(0.8944271909999161*Bmag[1]*f[19]*wx1*wx2+0.8944271909999159*Bmag[4]*f[5]*wx1*wx2+Bmag[0]*f[5]*wx1*wx2+Bmag[1]*f[2]*wx1*wx2+0.2581988897471612*Bmag[1]*f[32]*dv1*wx2+0.2581988897471612*Bmag[4]*f[15]*dv1*wx2+0.2886751345948129*Bmag[0]*f[15]*dv1*wx2+0.2886751345948129*Bmag[1]*f[7]*dv1*wx2+0.2581988897471612*Bmag[1]*f[35]*dv2*wx1+0.2581988897471612*Bmag[4]*f[16]*dv2*wx1+0.2886751345948129*Bmag[0]*f[16]*dv2*wx1+0.2886751345948129*Bmag[1]*f[9]*dv2*wx1+0.07453559924999302*Bmag[1]*f[44]*dv1*dv2+0.07453559924999298*Bmag[4]*f[31]*dv1*dv2+0.08333333333333333*Bmag[0]*f[31]*dv1*dv2+0.08333333333333333*Bmag[1]*f[18]*dv1*dv2))/m_; 
  out[4] += (volFact*(0.6388765649999399*Bmag[4]*f[11]*wx1*wx2+Bmag[0]*f[11]*wx1*wx2+f[0]*Bmag[4]*wx1*wx2+0.8944271909999159*Bmag[1]*f[1]*wx1*wx2+0.1844277783908294*Bmag[4]*f[21]*dv1*wx2+0.2886751345948129*Bmag[0]*f[21]*dv1*wx2+0.2581988897471612*Bmag[1]*f[6]*dv1*wx2+0.2886751345948129*f[3]*Bmag[4]*dv1*wx2+0.1844277783908294*Bmag[4]*f[25]*dv2*wx1+0.2886751345948129*Bmag[0]*f[25]*dv2*wx1+0.2581988897471612*Bmag[1]*f[8]*dv2*wx1+0.2886751345948129*Bmag[4]*f[4]*dv2*wx1+0.05323971374999499*Bmag[4]*f[37]*dv1*dv2+0.08333333333333333*Bmag[0]*f[37]*dv1*dv2+0.07453559924999298*Bmag[1]*f[17]*dv1*dv2+0.08333333333333333*Bmag[4]*f[10]*dv1*dv2))/m_; 
  out[5] += (volFact*(1.0*Bmag[1]*f[20]*wx1*wx2+Bmag[0]*f[12]*wx1*wx2+0.2886751345948129*Bmag[1]*f[33]*dv1*wx2+0.2886751345948129*Bmag[0]*f[22]*dv1*wx2+0.2886751345948129*Bmag[1]*f[36]*dv2*wx1+0.2886751345948129*Bmag[0]*f[26]*dv2*wx1+0.08333333333333336*Bmag[1]*f[45]*dv1*dv2+0.08333333333333333*Bmag[0]*f[38]*dv1*dv2))/m_; 
  out[6] += (volFact*(0.6388765649999399*Bmag[4]*f[19]*wx1*wx2+Bmag[0]*f[19]*wx1*wx2+0.8944271909999161*Bmag[1]*f[5]*wx1*wx2+1.0*f[2]*Bmag[4]*wx1*wx2+0.1844277783908294*Bmag[4]*f[32]*dv1*wx2+0.2886751345948129*Bmag[0]*f[32]*dv1*wx2+0.2581988897471611*Bmag[1]*f[15]*dv1*wx2+0.2886751345948129*Bmag[4]*f[7]*dv1*wx2+0.1844277783908294*Bmag[4]*f[35]*dv2*wx1+0.2886751345948129*Bmag[0]*f[35]*dv2*wx1+0.2581988897471611*Bmag[1]*f[16]*dv2*wx1+0.2886751345948129*Bmag[4]*f[9]*dv2*wx1+0.05323971374999499*Bmag[4]*f[44]*dv1*dv2+0.08333333333333333*Bmag[0]*f[44]*dv1*dv2+0.07453559924999302*Bmag[1]*f[31]*dv1*dv2+0.08333333333333336*Bmag[4]*f[18]*dv1*dv2))/m_; 
  out[7] += (volFact*(0.8944271909999159*Bmag[4]*f[20]*wx1*wx2+Bmag[0]*f[20]*wx1*wx2+1.0*Bmag[1]*f[12]*wx1*wx2+0.2581988897471611*Bmag[4]*f[33]*dv1*wx2+0.2886751345948129*Bmag[0]*f[33]*dv1*wx2+0.2886751345948129*Bmag[1]*f[22]*dv1*wx2+0.2581988897471611*Bmag[4]*f[36]*dv2*wx1+0.2886751345948129*Bmag[0]*f[36]*dv2*wx1+0.2886751345948129*Bmag[1]*f[26]*dv2*wx1+0.07453559924999298*Bmag[4]*f[45]*dv1*dv2+0.08333333333333333*Bmag[0]*f[45]*dv1*dv2+0.08333333333333336*Bmag[1]*f[38]*dv1*dv2))/m_; 
} 
...
{ 
  ...
  outM2[0] += volFact*(2.0*f[0]*wx1_sq+1.154700538379252*f[3]*dv1*wx1+0.149071198499986*f[16]*dv1_sq+0.1666666666666667*f[0]*dv1_sq); 
  ...
  tmp[2] = 2.0*f[2]*wx2+0.5773502691896258*f[9]*dv2; 
  tmp[3] = 2.0*f[5]*wx2+0.5773502691896258*f[12]*dv2; 
  outM2[0] += (2.0*(0.5*Bmag[1]*tmp[1]+0.5*Bmag[0]*tmp[0])*volFact)/m_; 
  outM2[1] += (2.0*(0.5*Bmag[0]*tmp[1]+0.5*tmp[0]*Bmag[1])*volFact)/m_; 
  outM2[2] += (2.0*(0.5*Bmag[1]*tmp[3]+0.5*Bmag[0]*tmp[2])*volFact)/m_; 
  outM2[3] += (2.0*(0.5*Bmag[0]*tmp[3]+0.5*Bmag[1]*tmp[2])*volFact)/m_; 
} 
...
{ 
  ...
  tmp[6] = 2.0*f[19]*wx2+0.5773502691896257*f[35]*dv2; 
  tmp[7] = 2.0*f[20]*wx2+0.5773502691896257*f[36]*dv2; 
  outM2[0] += (2.0*(0.5*Bmag[4]*tmp[4]+0.5*Bmag[1]*tmp[1]+0.5*Bmag[0]*tmp[0])*volFact)/m_; 
  outM2[1] += (2.0*(0.4472135954999579*Bmag[1]*tmp[4]+0.4472135954999579*tmp[1]*Bmag[4]+0.5*Bmag[0]*tmp[1]+0.5*tmp[0]*Bmag[1])*volFact)/m_; 
  outM2[2] += (2.0*(0.5000000000000001*Bmag[4]*tmp[6]+0.5*Bmag[1]*tmp[3]+0.5*Bmag[0]*tmp[2])*volFact)/m_; 
  outM2[3] += (2.0*(0.447213595499958*Bmag[1]*tmp[6]+0.4472135954999579*tmp[3]*Bmag[4]+0.5*Bmag[0]*tmp[3]+0.5*Bmag[1]*tmp[2])*volFact)/m_; 
  outM2[4] += (2.0*(0.31943828249997*Bmag[4]*tmp[4]+0.5*Bmag[0]*tmp[4]+0.5*tmp[0]*Bmag[4]+0.4472135954999579*Bmag[1]*tmp[1])*volFact)/m_; 
  outM2[5] += (2.0*(0.5000000000000001*Bmag[1]*tmp[7]+0.5*Bmag[0]*tmp[5])*volFact)/m_; 
  outM2[6] += (2.0*(0.31943828249997*Bmag[4]*tmp[6]+0.5*Bmag[0]*tmp[6]+0.5000000000000001*tmp[2]*Bmag[4]+0.447213595499958*Bmag[1]*tmp[3])*volFact)/m_; 
  outM2[7] += (2.0*(0.4472135954999579*Bmag[4]*tmp[7]+0.5*Bmag[0]*tmp[7]+0.5000000000000001*Bmag[1]*tmp[5])*volFact)/m_; 
} 
