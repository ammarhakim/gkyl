...
void GkMomentCalc3x2vSer_StarMoments_P1(const double *w, const double *dxv, const double m_, const double *Bmag, const double *f, double *outM0, double *outM1, double *outM2) 
{ 
  const double volFact = 2.0*M_PI/m_*dxv[3]*dxv[4]/4; 
  const double wx1 = w[3], dv1 = dxv[3]; 
  const double wx1_sq = wx1*wx1, dv1_sq = dv1*dv1; 
  ...
  outM2[0] += volFact*(2.0*f[0]*wx1_sq+0.5773502691896258*f[4]*dv1*wx1); 
  outM2[1] += volFact*(2.0*f[1]*wx1_sq+0.5773502691896258*f[9]*dv1*wx1); 
  outM2[2] += volFact*(2.0*f[2]*wx1_sq+0.5773502691896258*f[10]*dv1*wx1); 
  outM2[3] += volFact*(2.0*f[3]*wx1_sq+0.5773502691896258*f[11]*dv1*wx1); 
  outM2[4] += volFact*(2.0*f[6]*wx1_sq+0.5773502691896258*f[17]*dv1*wx1); 
  outM2[5] += volFact*(2.0*f[7]*wx1_sq+0.5773502691896258*f[18]*dv1*wx1); 
  outM2[6] += volFact*(2.0*f[8]*wx1_sq+0.5773502691896258*f[19]*dv1*wx1); 
  outM2[7] += volFact*(2.0*f[16]*wx1_sq+0.5773502691896258*f[26]*dv1*wx1); 
  double tmp[8]; 
  tmp[0] = 2.0*f[0]*wx2+0.5773502691896258*f[5]*dv2; 
  tmp[1] = 2.0*f[1]*wx2+0.5773502691896258*f[12]*dv2; 
  tmp[2] = 2.0*f[2]*wx2+0.5773502691896258*f[13]*dv2; 
