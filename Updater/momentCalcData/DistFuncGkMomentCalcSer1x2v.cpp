...
void GkMomentCalc1x2vSer_Dens_P4(const double *w, const double *dxv, const double *f, double *out) 
{ 
  const double volFact = 2.0*M_PI*dxv[1]*dxv[2]/4; 
  out[0] += 2.0*f[0]*volFact; 
  out[1] += 2.0*f[1]*volFact; 
...
{ 
  ...
  out[1] += 2.0*f[1]*volFact*wx1+0.5773502691896258*f[4]*dv1*volFact; 
  out[2] += 2.0*f[7]*volFact*wx1+0.5773502691896257*f[11]*dv1*volFact; 
  out[3] += 2.0*f[17]*volFact*wx1+0.5773502691896256*f[23]*dv1*volFact; 
} 
void GkMomentCalc1x2vSer_Upar_P4(const double *w, const double *dxv, const double *f, double *out) 
{ 
  const double volFact = 2.0*M_PI*dxv[1]*dxv[2]/4; 
  const double wx1 = w[1], dv1 = dxv[1]; 
  const double wx2 = w[2], dv2 = dxv[2]; 
  ...
  out[4] += 2.0*f[32]*volFact*wx1+0.5773502691896258*f[41]*dv1*volFact; 
} 
...
{ 
  ...
  out[1] += 2.0*f[1]*volFact*wx1_sq+1.154700538379252*f[4]*dv1*volFact*wx1+0.149071198499986*f[12]*dv1_sq*volFact+0.1666666666666667*f[1]*dv1_sq*volFact; 
  out[2] += 2.0*f[7]*volFact*wx1_sq+1.154700538379251*f[11]*dv1*volFact*wx1+0.1666666666666667*f[7]*dv1_sq*volFact; 
  out[3] += 2.0*f[17]*volFact*wx1_sq+1.154700538379251*f[23]*dv1*volFact*wx1+0.1666666666666667*f[17]*dv1_sq*volFact; 
} 
void GkMomentCalc1x2vSer_Ppar_P4(const double *w, const double *dxv, const double *f, double *out) 
{ 
  const double volFact = 2.0*M_PI*dxv[1]*dxv[2]/4; 
  const double wx1 = w[1], dv1 = dxv[1]; 
  const double wx1_sq = wx1*wx1, dv1_sq = dv1*dv1; 
  ...
  out[4] += 2.0*f[32]*volFact*wx1_sq+1.154700538379252*f[41]*dv1*volFact*wx1+0.1666666666666667*f[32]*dv1_sq*volFact; 
} 
...
{ 
  ...
  out[1] += 2.0*f[1]*volFact*wx2+0.5773502691896258*f[5]*dv2*volFact; 
  out[2] += 2.0*f[7]*volFact*wx2+0.5773502691896257*f[13]*dv2*volFact; 
  out[3] += 2.0*f[17]*volFact*wx2+0.5773502691896256*f[25]*dv2*volFact; 
} 
void GkMomentCalc1x2vSer_Pperp_P4(const double *w, const double *dxv, const double *f, double *out) 
{ 
  const double volFact = 2.0*M_PI*dxv[1]*dxv[2]/4; 
  const double wx1 = w[1], dv1 = dxv[1]; 
  const double wx2 = w[2], dv2 = dxv[2]; 
  ...
  out[4] += 2.0*f[32]*volFact*wx2+0.5773502691896258*f[43]*dv2*volFact; 
} 
...
{ 
  ...
  out[1] += 2.0*f[1]*volFact*wx1*wx1_sq+1.732050807568877*f[4]*dv1*volFact*wx1_sq+0.447213595499958*f[12]*dv1_sq*volFact*wx1+0.5*f[1]*dv1_sq*volFact*wx1+0.03779644730092273*f[24]*dv1*dv1_sq*volFact+0.08660254037844387*f[4]*dv1*dv1_sq*volFact; 
  out[2] += 2.0*f[7]*volFact*wx1*wx1_sq+1.732050807568877*f[11]*dv1*volFact*wx1_sq+0.5*f[7]*dv1_sq*volFact*wx1+0.08660254037844385*f[11]*dv1*dv1_sq*volFact; 
  out[3] += 2.0*f[17]*volFact*wx1*wx1_sq+1.732050807568877*f[23]*dv1*volFact*wx1_sq+0.5*f[17]*dv1_sq*volFact*wx1+0.08660254037844385*f[23]*dv1*dv1_sq*volFact; 
} 
void GkMomentCalc1x2vSer_Qpar_P4(const double *w, const double *dxv, const double *f, double *out) 
{ 
  const double volFact = 2.0*M_PI*dxv[1]*dxv[2]/4; 
  const double wx1 = w[1], dv1 = dxv[1]; 
  const double wx1_sq = wx1*wx1, dv1_sq = dv1*dv1; 
  ...
  out[4] += 2.0*f[32]*volFact*wx1*wx1_sq+1.732050807568877*f[41]*dv1*volFact*wx1_sq+0.5*f[32]*dv1_sq*volFact*wx1+0.08660254037844387*f[41]*dv1*dv1_sq*volFact; 
} 
...
{ 
  ...
  out[1] += 2.0*f[1]*volFact*wx1*wx2+0.5773502691896258*f[4]*dv1*volFact*wx2+0.5773502691896258*f[5]*dv2*volFact*wx1+0.1666666666666667*f[7]*dv1*dv2*volFact; 
} 
...
{ 
  ...
  out[2] += 2.0*f[7]*volFact*wx1*wx2+0.5773502691896257*f[11]*dv1*volFact*wx2+0.5773502691896257*f[13]*dv2*volFact*wx1+0.1666666666666667*f[17]*dv1*dv2*volFact; 
} 
...
{ 
  ...
  out[3] += 2.0*f[17]*volFact*wx1*wx2+0.5773502691896256*f[23]*dv1*volFact*wx2+0.5773502691896256*f[25]*dv2*volFact*wx1+0.1666666666666667*f[29]*dv1*dv2*volFact; 
} 
void GkMomentCalc1x2vSer_Qperp_P4(const double *w, const double *dxv, const double *f, double *out) 
{ 
  const double volFact = 2.0*M_PI*dxv[1]*dxv[2]/4; 
  const double wx1 = w[1], dv1 = dxv[1]; 
  const double wx2 = w[2], dv2 = dxv[2]; 
  ...
  out[1] += 2.0*f[1]*volFact*wx1*wx2+0.5773502691896258*f[4]*dv1*volFact*wx2+0.5773502691896258*f[5]*dv2*volFact*wx1+0.1666666666666667*f[10]*dv1*dv2*volFact; 
  out[2] += 2.0*f[7]*volFact*wx1*wx2+0.5773502691896257*f[11]*dv1*volFact*wx2+0.5773502691896257*f[13]*dv2*volFact*wx1+0.1666666666666667*f[20]*dv1*dv2*volFact; 
  out[3] += 2.0*f[17]*volFact*wx1*wx2+0.5773502691896256*f[26]*dv1*volFact*wx2+0.5773502691896256*f[28]*dv2*volFact*wx1+0.1666666666666667*f[38]*dv1*dv2*volFact; 
  out[4] += 2.0*f[32]*volFact*wx1*wx2+0.5773502691896258*f[41]*dv1*volFact*wx2+0.5773502691896258*f[43]*dv2*volFact*wx1+0.1666666666666667*f[47]*dv1*dv2*volFact; 
} 
