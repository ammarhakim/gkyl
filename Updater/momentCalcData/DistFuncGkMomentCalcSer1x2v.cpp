...
{ 
  ...
  out[1] += (0.7071067811865475*zeta[8]*f[12]+0.7071067811865475*zeta[2]*f[4]+0.7071067811865475*zeta[0]*f[1])*volFact; 
  out[2] += (0.7071067811865475*zeta[2]*f[11]+0.7071067811865475*zeta[0]*f[7])*volFact; 
} 
...
{ 
  ...
  outM2[1] += (0.7071067811865475*zeta[2]*f[4]+0.7071067811865475*zeta[0]*f[1])*volFact; 
  double tmp[2]; 
  tmp[0] = 2.0*f[0]*wx2+0.5773502691896258*f[3]*dv2; 
  tmp[1] = 2.0*f[1]*wx2+0.5773502691896258*f[5]*dv2; 
