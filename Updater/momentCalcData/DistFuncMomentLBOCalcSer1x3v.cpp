...
void VmM0StarNonuniform1x3vSer_VX(const double *wl, const double *wr, const double *dxvl, const double *dxvr, const double *fl, const double *fr, double *out) 
{ 
  // intFac:  =2pi/m for gyrokinetics (not used in Vlasov). 
  // w[NDIM]: Cell-center coordinates. 
  // dxv[4]:  cell length in each direction. 
  ...
  out[1] += ((-(17.32050807568877*dxvl1R2*dxvr[1]*fr[5])/(4.242640687119286*dxvr1R3+12.72792206135786*dxvl[1]*dxvr1R2+12.72792206135786*dxvl1R2*dxvr[1]+4.242640687119286*dxvl1R3))-(10.39230484541326*dxvl1R3*fr[5])/(4.242640687119286*dxvr1R3+12.72792206135786*dxvl[1]*dxvr1R2+12.72792206135786*dxvl1R2*dxvr[1]+4.242640687119286*dxvl1R3)+(10.39230484541326*dxvr1R3*fl[5])/(4.242640687119286*dxvr1R3+12.72792206135786*dxvl[1]*dxvr1R2+12.72792206135786*dxvl1R2*dxvr[1]+4.242640687119286*dxvl1R3)+(17.32050807568877*dxvl[1]*dxvr1R2*fl[5])/(4.242640687119286*dxvr1R3+12.72792206135786*dxvl[1]*dxvr1R2+12.72792206135786*dxvl1R2*dxvr[1]+4.242640687119286*dxvl1R3)+(18.0*dxvl1R2*dxvr[1]*fr[1])/(4.242640687119286*dxvr1R3+12.72792206135786*dxvl[1]*dxvr1R2+12.72792206135786*dxvl1R2*dxvr[1]+4.242640687119286*dxvl1R3)+(6.0*dxvl1R3*fr[1])/(4.242640687119286*dxvr1R3+12.72792206135786*dxvl[1]*dxvr1R2+12.72792206135786*dxvl1R2*dxvr[1]+4.242640687119286*dxvl1R3)+(6.0*dxvr1R3*fl[1])/(4.242640687119286*dxvr1R3+12.72792206135786*dxvl[1]*dxvr1R2+12.72792206135786*dxvl1R2*dxvr[1]+4.242640687119286*dxvl1R3)+(18.0*dxvl[1]*dxvr1R2*fl[1])/(4.242640687119286*dxvr1R3+12.72792206135786*dxvl[1]*dxvr1R2+12.72792206135786*dxvl1R2*dxvr[1]+4.242640687119286*dxvl1R3))*dS; 
 
} 
 
void VmM0StarNonuniform1x3vSer_VY(const double *wl, const double *wr, const double *dxvl, const double *dxvr, const double *fl, const double *fr, double *out) 
{ 
  // intFac:  =2pi/m for gyrokinetics (not used in Vlasov). 
  // w[NDIM]: Cell-center coordinates. 
  // dxv[4]:  cell length in each direction. 
  ...
  out[1] += ((-(17.32050807568877*dxvl2R2*dxvr[2]*fr[6])/(4.242640687119286*dxvr2R3+12.72792206135786*dxvl[2]*dxvr2R2+12.72792206135786*dxvl2R2*dxvr[2]+4.242640687119286*dxvl2R3))-(10.39230484541326*dxvl2R3*fr[6])/(4.242640687119286*dxvr2R3+12.72792206135786*dxvl[2]*dxvr2R2+12.72792206135786*dxvl2R2*dxvr[2]+4.242640687119286*dxvl2R3)+(10.39230484541326*dxvr2R3*fl[6])/(4.242640687119286*dxvr2R3+12.72792206135786*dxvl[2]*dxvr2R2+12.72792206135786*dxvl2R2*dxvr[2]+4.242640687119286*dxvl2R3)+(17.32050807568877*dxvl[2]*dxvr2R2*fl[6])/(4.242640687119286*dxvr2R3+12.72792206135786*dxvl[2]*dxvr2R2+12.72792206135786*dxvl2R2*dxvr[2]+4.242640687119286*dxvl2R3)+(6.0*fl[1]*dxvr2R3)/(4.242640687119286*dxvr2R3+12.72792206135786*dxvl[2]*dxvr2R2+12.72792206135786*dxvl2R2*dxvr[2]+4.242640687119286*dxvl2R3)+(18.0*fl[1]*dxvl[2]*dxvr2R2)/(4.242640687119286*dxvr2R3+12.72792206135786*dxvl[2]*dxvr2R2+12.72792206135786*dxvl2R2*dxvr[2]+4.242640687119286*dxvl2R3)+(18.0*fr[1]*dxvl2R2*dxvr[2])/(4.242640687119286*dxvr2R3+12.72792206135786*dxvl[2]*dxvr2R2+12.72792206135786*dxvl2R2*dxvr[2]+4.242640687119286*dxvl2R3)+(6.0*fr[1]*dxvl2R3)/(4.242640687119286*dxvr2R3+12.72792206135786*dxvl[2]*dxvr2R2+12.72792206135786*dxvl2R2*dxvr[2]+4.242640687119286*dxvl2R3))*dS; 
 
} 
 
void VmM0StarNonuniform1x3vSer_VZ(const double *wl, const double *wr, const double *dxvl, const double *dxvr, const double *fl, const double *fr, double *out) 
{ 
  // intFac:  =2pi/m for gyrokinetics (not used in Vlasov). 
  // w[NDIM]: Cell-center coordinates. 
  // dxv[4]:  cell length in each direction. 
  ...
  out[1] += ((-(8.660254037844386*dxvl3R2*dxvr3R2*fr[8])/(4.242640687119286*dxvr3R3+12.72792206135786*dxvl[3]*dxvr3R2+12.72792206135786*dxvl3R2*dxvr[3]+4.242640687119286*dxvl3R3))-(5.196152422706631*dxvl3R3*dxvr[3]*fr[8])/(4.242640687119286*dxvr3R3+12.72792206135786*dxvl[3]*dxvr3R2+12.72792206135786*dxvl3R2*dxvr[3]+4.242640687119286*dxvl3R3)+(5.196152422706631*dxvl[3]*dxvr3R3*fl[8])/(4.242640687119286*dxvr3R3+12.72792206135786*dxvl[3]*dxvr3R2+12.72792206135786*dxvl3R2*dxvr[3]+4.242640687119286*dxvl3R3)+(8.660254037844386*dxvl3R2*dxvr3R2*fl[8])/(4.242640687119286*dxvr3R3+12.72792206135786*dxvl[3]*dxvr3R2+12.72792206135786*dxvl3R2*dxvr[3]+4.242640687119286*dxvl3R3)+(6.0*fl[1]*dxvr3R3)/(4.242640687119286*dxvr3R3+12.72792206135786*dxvl[3]*dxvr3R2+12.72792206135786*dxvl3R2*dxvr[3]+4.242640687119286*dxvl3R3)+(18.0*fl[1]*dxvl[3]*dxvr3R2)/(4.242640687119286*dxvr3R3+12.72792206135786*dxvl[3]*dxvr3R2+12.72792206135786*dxvl3R2*dxvr[3]+4.242640687119286*dxvl3R3)+(18.0*fr[1]*dxvl3R2*dxvr[3])/(4.242640687119286*dxvr3R3+12.72792206135786*dxvl[3]*dxvr3R2+12.72792206135786*dxvl3R2*dxvr[3]+4.242640687119286*dxvl3R3)+(6.0*fr[1]*dxvl3R3)/(4.242640687119286*dxvr3R3+12.72792206135786*dxvl[3]*dxvr3R2+12.72792206135786*dxvl3R2*dxvr[3]+4.242640687119286*dxvl3R3))*dS; 
