...
{ 
  ...
  out[3] += (2.0*f[0]*wx1*wx2+0.5773502691896258*f[3]*dv1*wx2+0.5773502691896258*f[4]*dv2*wx1)*volFact; 
  out[4] += 2.0*f[1]*wx1*wx2*volFact; 
  out[5] += 2.0*f[2]*wx1*wx2*volFact; 
  out[6] += (2.0*f[0]*wx2_sq+1.154700538379252*f[4]*dv2*wx2+0.1666666666666667*f[0]*dv2_sq)*volFact; 
  out[7] += (2.0*f[1]*wx2_sq+0.1666666666666667*f[1]*dv2_sq)*volFact; 
  out[8] += (2.0*f[2]*wx2_sq+0.1666666666666667*f[2]*dv2_sq)*volFact; 
} 
...
{ 
  ...
  out[2] += (2.0*f[2]*wx2_sq+2.0*f[2]*wx1_sq+0.1666666666666667*f[2]*dv2_sq+0.1666666666666667*f[2]*dv1_sq)*volFact; 
} 
...
{ 
  ...
  out[0] += (2.0*f[0]*wx1*wx2_sq+0.5773502691896258*f[3]*dv1*wx2_sq+1.154700538379252*f[4]*dv2*wx1*wx2+2.0*f[0]*wx1*wx1_sq+1.732050807568877*f[3]*dv1*wx1_sq+0.1666666666666667*f[0]*dv2_sq*wx1+0.5*f[0]*dv1_sq*wx1+0.04811252243246882*f[3]*dv1*dv2_sq+0.08660254037844387*f[3]*dv1*dv1_sq)*volFact; 
  out[1] += (2.0*f[1]*wx1*wx2_sq+2.0*f[1]*wx1*wx1_sq+0.1666666666666667*f[1]*dv2_sq*wx1+0.5*f[1]*dv1_sq*wx1)*volFact; 
  out[2] += (2.0*f[2]*wx1*wx2_sq+2.0*f[2]*wx1*wx1_sq+0.1666666666666667*f[2]*dv2_sq*wx1+0.5*f[2]*dv1_sq*wx1)*volFact; 
  out[3] += (2.0*f[0]*wx2*wx2_sq+1.732050807568877*f[4]*dv2*wx2_sq+2.0*f[0]*wx1_sq*wx2+1.154700538379252*f[3]*dv1*wx1*wx2+0.5*f[0]*dv2_sq*wx2+0.1666666666666667*f[0]*dv1_sq*wx2+0.5773502691896258*f[4]*dv2*wx1_sq+0.08660254037844387*f[4]*dv2*dv2_sq+0.04811252243246882*f[4]*dv1_sq*dv2)*volFact; 
  out[4] += (2.0*f[1]*wx2*wx2_sq+2.0*f[1]*wx1_sq*wx2+0.5*f[1]*dv2_sq*wx2+0.1666666666666667*f[1]*dv1_sq*wx2)*volFact; 
  out[5] += (2.0*f[2]*wx2*wx2_sq+2.0*f[2]*wx1_sq*wx2+0.5*f[2]*dv2_sq*wx2+0.1666666666666667*f[2]*dv1_sq*wx2)*volFact; 
} 
...
{ 
  ...
  const double wx2_sq = wx2*wx2, dv2_sq = dv2*dv2; 
  const double wx2_cu = wx2*wx2*wx2, dv2_cu = dv2*dv2*dv2; 
  out[0] += (2.0*f[0]*wx1*wx2_sq+0.5773502691896258*f[3]*dv1*wx2_sq+1.154700538379252*f[4]*dv2*wx1*wx2+0.3333333333333333*f[10]*dv1*dv2*wx2+2.0*f[0]*wx1*wx1_sq+1.732050807568877*f[3]*dv1*wx1_sq+0.149071198499986*f[14]*dv2_sq*wx1+0.1666666666666667*f[0]*dv2_sq*wx1+0.4472135954999579*f[13]*dv1_sq*wx1+0.5*f[0]*dv1_sq*wx1+0.04811252243246882*f[3]*dv1*dv2_sq+0.08660254037844387*f[3]*dv1*dv1_sq)*volFact; 
  out[1] += (2.0*f[1]*wx1*wx2_sq+0.5773502691896258*f[6]*dv1*wx2_sq+1.154700538379252*f[8]*dv2*wx1*wx2+2.0*f[1]*wx1*wx1_sq+1.732050807568877*f[6]*dv1*wx1_sq+0.1666666666666667*f[1]*dv2_sq*wx1+0.5*f[1]*dv1_sq*wx1+0.04811252243246882*f[6]*dv1*dv2_sq+0.08660254037844387*f[6]*dv1*dv1_sq)*volFact; 
  out[2] += (2.0*f[2]*wx1*wx2_sq+0.5773502691896258*f[7]*dv1*wx2_sq+1.154700538379252*f[9]*dv2*wx1*wx2+2.0*f[2]*wx1*wx1_sq+1.732050807568877*f[7]*dv1*wx1_sq+0.1666666666666667*f[2]*dv2_sq*wx1+0.5*f[2]*dv1_sq*wx1+0.04811252243246882*f[7]*dv1*dv2_sq+0.08660254037844387*f[7]*dv1*dv1_sq)*volFact; 
  out[3] += (2.0*f[5]*wx1*wx2_sq+2.0*f[5]*wx1*wx1_sq+0.1666666666666667*f[5]*dv2_sq*wx1+0.5*f[5]*dv1_sq*wx1)*volFact; 
  out[4] += (2.0*f[11]*wx1*wx2_sq+2.0*f[11]*wx1*wx1_sq+0.1666666666666667*f[11]*dv2_sq*wx1+0.5*f[11]*dv1_sq*wx1)*volFact; 
  out[5] += (2.0*f[12]*wx1*wx2_sq+2.0*f[12]*wx1*wx1_sq+0.1666666666666667*f[12]*dv2_sq*wx1+0.5*f[12]*dv1_sq*wx1)*volFact; 
  out[6] += (2.0*f[0]*wx2*wx2_sq+1.732050807568877*f[4]*dv2*wx2_sq+2.0*f[0]*wx1_sq*wx2+1.154700538379252*f[3]*dv1*wx1*wx2+0.4472135954999579*f[14]*dv2_sq*wx2+0.5*f[0]*dv2_sq*wx2+0.149071198499986*f[13]*dv1_sq*wx2+0.1666666666666667*f[0]*dv1_sq*wx2+0.5773502691896258*f[4]*dv2*wx1_sq+0.3333333333333333*f[10]*dv1*dv2*wx1+0.08660254037844387*f[4]*dv2*dv2_sq+0.04811252243246882*f[4]*dv1_sq*dv2)*volFact; 
  out[7] += (2.0*f[1]*wx2*wx2_sq+1.732050807568877*f[8]*dv2*wx2_sq+2.0*f[1]*wx1_sq*wx2+1.154700538379252*f[6]*dv1*wx1*wx2+0.5*f[1]*dv2_sq*wx2+0.1666666666666667*f[1]*dv1_sq*wx2+0.5773502691896258*f[8]*dv2*wx1_sq+0.08660254037844387*f[8]*dv2*dv2_sq+0.04811252243246882*f[8]*dv1_sq*dv2)*volFact; 
  out[8] += (2.0*f[2]*wx2*wx2_sq+1.732050807568877*f[9]*dv2*wx2_sq+2.0*f[2]*wx1_sq*wx2+1.154700538379252*f[7]*dv1*wx1*wx2+0.5*f[2]*dv2_sq*wx2+0.1666666666666667*f[2]*dv1_sq*wx2+0.5773502691896258*f[9]*dv2*wx1_sq+0.08660254037844387*f[9]*dv2*dv2_sq+0.04811252243246882*f[9]*dv1_sq*dv2)*volFact; 
  out[9] += (2.0*f[5]*wx2*wx2_sq+2.0*f[5]*wx1_sq*wx2+0.5*f[5]*dv2_sq*wx2+0.1666666666666667*f[5]*dv1_sq*wx2)*volFact; 
  out[10] += (2.0*f[11]*wx2*wx2_sq+2.0*f[11]*wx1_sq*wx2+0.5*f[11]*dv2_sq*wx2+0.1666666666666667*f[11]*dv1_sq*wx2)*volFact; 
  out[11] += (2.0*f[12]*wx2*wx2_sq+2.0*f[12]*wx1_sq*wx2+0.5*f[12]*dv2_sq*wx2+0.1666666666666667*f[12]*dv1_sq*wx2)*volFact; 
} 
...
{ 
  ...
  out[1] += (2.0*f[1]*wx1*wx2_sq+0.5773502691896258*f[6]*dv1*wx2_sq+1.154700538379252*f[8]*dv2*wx1*wx2+0.3333333333333333*f[17]*dv1*dv2*wx2+2.0*f[1]*wx1*wx1_sq+1.732050807568877*f[6]*dv1*wx1_sq+0.149071198499986*f[28]*dv2_sq*wx1+0.1666666666666667*f[1]*dv2_sq*wx1+0.447213595499958*f[23]*dv1_sq*wx1+0.5*f[1]*dv1_sq*wx1+0.04811252243246882*f[6]*dv1*dv2_sq+0.08660254037844387*f[6]*dv1*dv1_sq)*volFact; 
  out[2] += (2.0*f[2]*wx1*wx2_sq+0.5773502691896258*f[7]*dv1*wx2_sq+1.154700538379252*f[9]*dv2*wx1*wx2+0.3333333333333333*f[18]*dv1*dv2*wx2+2.0*f[2]*wx1*wx1_sq+1.732050807568877*f[7]*dv1*wx1_sq+0.149071198499986*f[29]*dv2_sq*wx1+0.1666666666666667*f[2]*dv2_sq*wx1+0.447213595499958*f[24]*dv1_sq*wx1+0.5*f[2]*dv1_sq*wx1+0.04811252243246882*f[7]*dv1*dv2_sq+0.08660254037844387*f[7]*dv1*dv1_sq)*volFact; 
  out[3] += (2.0*f[5]*wx1*wx2_sq+0.5773502691896258*f[15]*dv1*wx2_sq+1.154700538379252*f[16]*dv2*wx1*wx2+2.0*f[5]*wx1*wx1_sq+1.732050807568877*f[15]*dv1*wx1_sq+0.1666666666666667*f[5]*dv2_sq*wx1+0.5*f[5]*dv1_sq*wx1+0.04811252243246882*f[15]*dv1*dv2_sq+0.08660254037844387*f[15]*dv1*dv1_sq)*volFact; 
  out[4] += (2.0*f[11]*wx1*wx2_sq+0.5773502691896257*f[21]*dv1*wx2_sq+1.154700538379251*f[25]*dv2*wx1*wx2+2.0*f[11]*wx1*wx1_sq+1.732050807568877*f[21]*dv1*wx1_sq+0.1666666666666667*f[11]*dv2_sq*wx1+0.5*f[11]*dv1_sq*wx1+0.04811252243246881*f[21]*dv1*dv2_sq+0.08660254037844385*f[21]*dv1*dv1_sq)*volFact; 
  out[5] += (2.0*f[12]*wx1*wx2_sq+0.5773502691896257*f[22]*dv1*wx2_sq+1.154700538379251*f[26]*dv2*wx1*wx2+2.0*f[12]*wx1*wx1_sq+1.732050807568877*f[22]*dv1*wx1_sq+0.1666666666666667*f[12]*dv2_sq*wx1+0.5*f[12]*dv1_sq*wx1+0.04811252243246881*f[22]*dv1*dv2_sq+0.08660254037844385*f[22]*dv1*dv1_sq)*volFact; 
  out[6] += (2.0*f[19]*wx1*wx2_sq+2.0*f[19]*wx1*wx1_sq+0.1666666666666667*f[19]*dv2_sq*wx1+0.5*f[19]*dv1_sq*wx1)*volFact; 
  out[7] += (2.0*f[20]*wx1*wx2_sq+2.0*f[20]*wx1*wx1_sq+0.1666666666666667*f[20]*dv2_sq*wx1+0.5*f[20]*dv1_sq*wx1)*volFact; 
  out[8] += (2.0*f[31]*wx1*wx2_sq+2.0*f[31]*wx1*wx1_sq+0.1666666666666667*f[31]*dv2_sq*wx1+0.5*f[31]*dv1_sq*wx1)*volFact; 
  out[9] += (2.0*f[32]*wx1*wx2_sq+2.0*f[32]*wx1*wx1_sq+0.1666666666666667*f[32]*dv2_sq*wx1+0.5*f[32]*dv1_sq*wx1)*volFact; 
  out[10] += (2.0*f[0]*wx2*wx2_sq+1.732050807568877*f[4]*dv2*wx2_sq+2.0*f[0]*wx1_sq*wx2+1.154700538379252*f[3]*dv1*wx1*wx2+0.4472135954999579*f[14]*dv2_sq*wx2+0.5*f[0]*dv2_sq*wx2+0.149071198499986*f[13]*dv1_sq*wx2+0.1666666666666667*f[0]*dv1_sq*wx2+0.5773502691896258*f[4]*dv2*wx1_sq+0.3333333333333333*f[10]*dv1*dv2*wx1+0.03779644730092272*f[34]*dv2*dv2_sq+0.08660254037844387*f[4]*dv2*dv2_sq+0.04303314829119351*f[27]*dv1_sq*dv2+0.04811252243246882*f[4]*dv1_sq*dv2)*volFact; 
  out[11] += (2.0*f[1]*wx2*wx2_sq+1.732050807568877*f[8]*dv2*wx2_sq+2.0*f[1]*wx1_sq*wx2+1.154700538379252*f[6]*dv1*wx1*wx2+0.447213595499958*f[28]*dv2_sq*wx2+0.5*f[1]*dv2_sq*wx2+0.149071198499986*f[23]*dv1_sq*wx2+0.1666666666666667*f[1]*dv1_sq*wx2+0.5773502691896258*f[8]*dv2*wx1_sq+0.3333333333333333*f[17]*dv1*dv2*wx1+0.08660254037844387*f[8]*dv2*dv2_sq+0.04811252243246882*f[8]*dv1_sq*dv2)*volFact; 
  out[12] += (2.0*f[2]*wx2*wx2_sq+1.732050807568877*f[9]*dv2*wx2_sq+2.0*f[2]*wx1_sq*wx2+1.154700538379252*f[7]*dv1*wx1*wx2+0.447213595499958*f[29]*dv2_sq*wx2+0.5*f[2]*dv2_sq*wx2+0.149071198499986*f[24]*dv1_sq*wx2+0.1666666666666667*f[2]*dv1_sq*wx2+0.5773502691896258*f[9]*dv2*wx1_sq+0.3333333333333333*f[18]*dv1*dv2*wx1+0.08660254037844387*f[9]*dv2*dv2_sq+0.04811252243246882*f[9]*dv1_sq*dv2)*volFact; 
  out[13] += (2.0*f[5]*wx2*wx2_sq+1.732050807568877*f[16]*dv2*wx2_sq+2.0*f[5]*wx1_sq*wx2+1.154700538379252*f[15]*dv1*wx1*wx2+0.5*f[5]*dv2_sq*wx2+0.1666666666666667*f[5]*dv1_sq*wx2+0.5773502691896258*f[16]*dv2*wx1_sq+0.08660254037844387*f[16]*dv2*dv2_sq+0.04811252243246882*f[16]*dv1_sq*dv2)*volFact; 
  out[14] += (2.0*f[11]*wx2*wx2_sq+1.732050807568877*f[25]*dv2*wx2_sq+2.0*f[11]*wx1_sq*wx2+1.154700538379251*f[21]*dv1*wx1*wx2+0.5*f[11]*dv2_sq*wx2+0.1666666666666667*f[11]*dv1_sq*wx2+0.5773502691896257*f[25]*dv2*wx1_sq+0.08660254037844385*f[25]*dv2*dv2_sq+0.04811252243246881*f[25]*dv1_sq*dv2)*volFact; 
  out[15] += (2.0*f[12]*wx2*wx2_sq+1.732050807568877*f[26]*dv2*wx2_sq+2.0*f[12]*wx1_sq*wx2+1.154700538379251*f[22]*dv1*wx1*wx2+0.5*f[12]*dv2_sq*wx2+0.1666666666666667*f[12]*dv1_sq*wx2+0.5773502691896257*f[26]*dv2*wx1_sq+0.08660254037844385*f[26]*dv2*dv2_sq+0.04811252243246881*f[26]*dv1_sq*dv2)*volFact; 
  out[16] += (2.0*f[19]*wx2*wx2_sq+2.0*f[19]*wx1_sq*wx2+0.5*f[19]*dv2_sq*wx2+0.1666666666666667*f[19]*dv1_sq*wx2)*volFact; 
  out[17] += (2.0*f[20]*wx2*wx2_sq+2.0*f[20]*wx1_sq*wx2+0.5*f[20]*dv2_sq*wx2+0.1666666666666667*f[20]*dv1_sq*wx2)*volFact; 
  out[18] += (2.0*f[31]*wx2*wx2_sq+2.0*f[31]*wx1_sq*wx2+0.5*f[31]*dv2_sq*wx2+0.1666666666666667*f[31]*dv1_sq*wx2)*volFact; 
  out[19] += (2.0*f[32]*wx2*wx2_sq+2.0*f[32]*wx1_sq*wx2+0.5*f[32]*dv2_sq*wx2+0.1666666666666667*f[32]*dv1_sq*wx2)*volFact; 
} 
...
{ 
  ...
  outM1i[4] += tempM1i[4]; 
  outM1i[5] += tempM1i[5]; 
  outM2[0] += (0.1666666666666667*f[0]*dv2_sq+0.1666666666666667*f[0]*dv1_sq)*volFact+tempM0[0]*((-1.0*wx2_sq)-1.0*wx1_sq)+2.0*tempM1i[3]*wx2+2.0*tempM1i[0]*wx1; 
  ...
  outM2[2] += (0.1666666666666667*f[2]*dv2_sq+0.1666666666666667*f[2]*dv1_sq)*volFact+tempM0[2]*((-1.0*wx2_sq)-1.0*wx1_sq)+2.0*tempM1i[5]*wx2+2.0*tempM1i[2]*wx1; 
} 
...
{ 
  ...
  outM1i[3] += tempM0[0]*wx2; 
  outM1i[4] += tempM0[1]*wx2; 
  outM1i[5] += tempM0[2]*wx2; 
  outM2[0] += tempM0[0]*((-1.0*wx2_sq)-1.0*wx1_sq)+2.0*tempM1i[3]*wx2+2.0*tempM1i[0]*wx1; 
  outM2[1] += tempM0[1]*((-1.0*wx2_sq)-1.0*wx1_sq)+2.0*tempM1i[4]*wx2+2.0*tempM1i[1]*wx1; 
  outM2[2] += tempM0[2]*((-1.0*wx2_sq)-1.0*wx1_sq)+2.0*tempM1i[5]*wx2+2.0*tempM1i[2]*wx1; 
} 
