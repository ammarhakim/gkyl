...
{ 
  ...
  out[0] += 2.0*f[0]*volFact*wx1*wx2_sq+0.5773502691896258*f[3]*dv1*volFact*wx2_sq+1.154700538379252*f[4]*dv2*volFact*wx1*wx2+2.0*f[0]*volFact*wx1*wx1_sq+1.732050807568877*f[3]*dv1*volFact*wx1_sq+0.1666666666666667*f[0]*dv2_sq*volFact*wx1+0.5*f[0]*dv1_sq*volFact*wx1+0.04811252243246882*f[3]*dv1*dv2_sq*volFact+0.08660254037844387*f[3]*dv1*dv1_sq*volFact; 
  out[1] += 2.0*f[1]*volFact*wx1*wx2_sq+2.0*f[1]*volFact*wx1*wx1_sq+0.1666666666666667*f[1]*dv2_sq*volFact*wx1+0.5*f[1]*dv1_sq*volFact*wx1; 
  out[2] += 2.0*f[2]*volFact*wx1*wx2_sq+2.0*f[2]*volFact*wx1*wx1_sq+0.1666666666666667*f[2]*dv2_sq*volFact*wx1+0.5*f[2]*dv1_sq*volFact*wx1; 
  out[3] += 2.0*f[0]*volFact*wx2*wx2_sq+1.732050807568877*f[4]*dv2*volFact*wx2_sq+2.0*f[0]*volFact*wx1_sq*wx2+1.154700538379252*f[3]*dv1*volFact*wx1*wx2+0.5*f[0]*dv2_sq*volFact*wx2+0.1666666666666667*f[0]*dv1_sq*volFact*wx2+0.5773502691896258*f[4]*dv2*volFact*wx1_sq+0.08660254037844387*f[4]*dv2*dv2_sq*volFact+0.04811252243246882*f[4]*dv1_sq*dv2*volFact; 
  out[4] += 2.0*f[1]*volFact*wx2*wx2_sq+2.0*f[1]*volFact*wx1_sq*wx2+0.5*f[1]*dv2_sq*volFact*wx2+0.1666666666666667*f[1]*dv1_sq*volFact*wx2; 
  out[5] += 2.0*f[2]*volFact*wx2*wx2_sq+2.0*f[2]*volFact*wx1_sq*wx2+0.5*f[2]*dv2_sq*volFact*wx2+0.1666666666666667*f[2]*dv1_sq*volFact*wx2; 
} 
...
{ 
  ...
  const double wx2_sq = wx2*wx2, dv2_sq = dv2*dv2; 
  const double wx2_cu = wx2*wx2*wx2, dv2_cu = dv2*dv2*dv2; 
  out[0] += 2.0*f[0]*volFact*wx1*wx2_sq+0.5773502691896258*f[3]*dv1*volFact*wx2_sq+1.154700538379252*f[4]*dv2*volFact*wx1*wx2+0.3333333333333333*f[10]*dv1*dv2*volFact*wx2+2.0*f[0]*volFact*wx1*wx1_sq+1.732050807568877*f[3]*dv1*volFact*wx1_sq+0.149071198499986*f[14]*dv2_sq*volFact*wx1+0.1666666666666667*f[0]*dv2_sq*volFact*wx1+0.4472135954999579*f[13]*dv1_sq*volFact*wx1+0.5*f[0]*dv1_sq*volFact*wx1+0.04811252243246882*f[3]*dv1*dv2_sq*volFact+0.08660254037844387*f[3]*dv1*dv1_sq*volFact; 
  out[1] += 2.0*f[1]*volFact*wx1*wx2_sq+0.5773502691896258*f[6]*dv1*volFact*wx2_sq+1.154700538379252*f[8]*dv2*volFact*wx1*wx2+2.0*f[1]*volFact*wx1*wx1_sq+1.732050807568877*f[6]*dv1*volFact*wx1_sq+0.1666666666666667*f[1]*dv2_sq*volFact*wx1+0.5*f[1]*dv1_sq*volFact*wx1+0.04811252243246882*f[6]*dv1*dv2_sq*volFact+0.08660254037844387*f[6]*dv1*dv1_sq*volFact; 
  out[2] += 2.0*f[2]*volFact*wx1*wx2_sq+0.5773502691896258*f[7]*dv1*volFact*wx2_sq+1.154700538379252*f[9]*dv2*volFact*wx1*wx2+2.0*f[2]*volFact*wx1*wx1_sq+1.732050807568877*f[7]*dv1*volFact*wx1_sq+0.1666666666666667*f[2]*dv2_sq*volFact*wx1+0.5*f[2]*dv1_sq*volFact*wx1+0.04811252243246882*f[7]*dv1*dv2_sq*volFact+0.08660254037844387*f[7]*dv1*dv1_sq*volFact; 
  out[3] += 2.0*f[5]*volFact*wx1*wx2_sq+2.0*f[5]*volFact*wx1*wx1_sq+0.1666666666666667*f[5]*dv2_sq*volFact*wx1+0.5*f[5]*dv1_sq*volFact*wx1; 
  out[4] += 2.0*f[11]*volFact*wx1*wx2_sq+2.0*f[11]*volFact*wx1*wx1_sq+0.1666666666666667*f[11]*dv2_sq*volFact*wx1+0.5*f[11]*dv1_sq*volFact*wx1; 
  out[5] += 2.0*f[12]*volFact*wx1*wx2_sq+2.0*f[12]*volFact*wx1*wx1_sq+0.1666666666666667*f[12]*dv2_sq*volFact*wx1+0.5*f[12]*dv1_sq*volFact*wx1; 
  out[6] += 2.0*f[0]*volFact*wx2*wx2_sq+1.732050807568877*f[4]*dv2*volFact*wx2_sq+2.0*f[0]*volFact*wx1_sq*wx2+1.154700538379252*f[3]*dv1*volFact*wx1*wx2+0.4472135954999579*f[14]*dv2_sq*volFact*wx2+0.5*f[0]*dv2_sq*volFact*wx2+0.149071198499986*f[13]*dv1_sq*volFact*wx2+0.1666666666666667*f[0]*dv1_sq*volFact*wx2+0.5773502691896258*f[4]*dv2*volFact*wx1_sq+0.3333333333333333*f[10]*dv1*dv2*volFact*wx1+0.08660254037844387*f[4]*dv2*dv2_sq*volFact+0.04811252243246882*f[4]*dv1_sq*dv2*volFact; 
  out[7] += 2.0*f[1]*volFact*wx2*wx2_sq+1.732050807568877*f[8]*dv2*volFact*wx2_sq+2.0*f[1]*volFact*wx1_sq*wx2+1.154700538379252*f[6]*dv1*volFact*wx1*wx2+0.5*f[1]*dv2_sq*volFact*wx2+0.1666666666666667*f[1]*dv1_sq*volFact*wx2+0.5773502691896258*f[8]*dv2*volFact*wx1_sq+0.08660254037844387*f[8]*dv2*dv2_sq*volFact+0.04811252243246882*f[8]*dv1_sq*dv2*volFact; 
  out[8] += 2.0*f[2]*volFact*wx2*wx2_sq+1.732050807568877*f[9]*dv2*volFact*wx2_sq+2.0*f[2]*volFact*wx1_sq*wx2+1.154700538379252*f[7]*dv1*volFact*wx1*wx2+0.5*f[2]*dv2_sq*volFact*wx2+0.1666666666666667*f[2]*dv1_sq*volFact*wx2+0.5773502691896258*f[9]*dv2*volFact*wx1_sq+0.08660254037844387*f[9]*dv2*dv2_sq*volFact+0.04811252243246882*f[9]*dv1_sq*dv2*volFact; 
  out[9] += 2.0*f[5]*volFact*wx2*wx2_sq+2.0*f[5]*volFact*wx1_sq*wx2+0.5*f[5]*dv2_sq*volFact*wx2+0.1666666666666667*f[5]*dv1_sq*volFact*wx2; 
  out[10] += 2.0*f[11]*volFact*wx2*wx2_sq+2.0*f[11]*volFact*wx1_sq*wx2+0.5*f[11]*dv2_sq*volFact*wx2+0.1666666666666667*f[11]*dv1_sq*volFact*wx2; 
  out[11] += 2.0*f[12]*volFact*wx2*wx2_sq+2.0*f[12]*volFact*wx1_sq*wx2+0.5*f[12]*dv2_sq*volFact*wx2+0.1666666666666667*f[12]*dv1_sq*volFact*wx2; 
} 
