...
{ 
  ...
  const double wx2 = w[2], dv2 = dxv[2]; 
  double tmp[2]; 
  tmp[0] = 4.0*f[0]*wx2+1.154700538379252*f[3]*dv2; 
  tmp[1] = 4.0*f[1]*wx2+1.154700538379252*f[5]*dv2; 
...
{ 
  ...
  tmp[0] = 4.0*f[0]*wx2+1.154700538379252*f[3]*dv2; 
  tmp[1] = 4.0*f[1]*wx2+1.154700538379252*f[5]*dv2; 
  tmp[2] = 4.0*f[7]*wx2+1.154700538379251*f[13]*dv2; 
...
{ 
  ...
  const double wx1 = w[1], dv1 = dxv[1]; 
  const double wx2 = w[2], dv2 = dxv[2]; 
  out[0] += (volFact*(2.828427124746191*Bmag[1]*f[1]*wx1*wx2+2.828427124746191*Bmag[0]*f[0]*wx1*wx2+0.8164965809277261*Bmag[1]*f[4]*dv1*wx2+0.8164965809277261*Bmag[0]*f[2]*dv1*wx2+0.8164965809277261*Bmag[1]*f[5]*dv2*wx1+0.8164965809277261*Bmag[0]*f[3]*dv2*wx1+0.2357022603955158*Bmag[1]*f[7]*dv1*dv2+0.2357022603955158*Bmag[0]*f[6]*dv1*dv2))/m_; 
  out[1] += (volFact*(2.828427124746191*Bmag[0]*f[1]*wx1*wx2+2.828427124746191*f[0]*Bmag[1]*wx1*wx2+0.8164965809277261*Bmag[0]*f[4]*dv1*wx2+0.8164965809277261*Bmag[1]*f[2]*dv1*wx2+0.8164965809277261*Bmag[0]*f[5]*dv2*wx1+0.8164965809277261*Bmag[1]*f[3]*dv2*wx1+0.2357022603955158*Bmag[0]*f[7]*dv1*dv2+0.2357022603955158*Bmag[1]*f[6]*dv1*dv2))/m_; 
} 
...
{ 
  ...
  const double wx1 = w[1], dv1 = dxv[1]; 
  const double wx2 = w[2], dv2 = dxv[2]; 
  out[0] += (volFact*(2.828427124746191*Bmag[2]*f[7]*wx1*wx2+2.828427124746191*Bmag[1]*f[1]*wx1*wx2+2.828427124746191*Bmag[0]*f[0]*wx1*wx2+0.816496580927726*Bmag[2]*f[11]*dv1*wx2+0.8164965809277261*Bmag[1]*f[4]*dv1*wx2+0.8164965809277261*Bmag[0]*f[2]*dv1*wx2+0.816496580927726*Bmag[2]*f[13]*dv2*wx1+0.8164965809277261*Bmag[1]*f[5]*dv2*wx1+0.8164965809277261*Bmag[0]*f[3]*dv2*wx1+0.2357022603955158*Bmag[2]*f[17]*dv1*dv2+0.2357022603955158*Bmag[1]*f[10]*dv1*dv2+0.2357022603955158*Bmag[0]*f[6]*dv1*dv2))/m_; 
  out[1] += (volFact*(2.529822128134704*Bmag[1]*f[7]*wx1*wx2+2.529822128134704*f[1]*Bmag[2]*wx1*wx2+2.828427124746191*Bmag[0]*f[1]*wx1*wx2+2.828427124746191*f[0]*Bmag[1]*wx1*wx2+0.7302967433402215*Bmag[1]*f[11]*dv1*wx2+0.7302967433402218*Bmag[2]*f[4]*dv1*wx2+0.8164965809277261*Bmag[0]*f[4]*dv1*wx2+0.8164965809277261*Bmag[1]*f[2]*dv1*wx2+0.7302967433402215*Bmag[1]*f[13]*dv2*wx1+0.7302967433402218*Bmag[2]*f[5]*dv2*wx1+0.8164965809277261*Bmag[0]*f[5]*dv2*wx1+0.8164965809277261*Bmag[1]*f[3]*dv2*wx1+0.210818510677892*Bmag[1]*f[17]*dv1*dv2+0.210818510677892*Bmag[2]*f[10]*dv1*dv2+0.2357022603955158*Bmag[0]*f[10]*dv1*dv2+0.2357022603955158*Bmag[1]*f[6]*dv1*dv2))/m_; 
  out[2] += (volFact*(1.807015805810503*Bmag[2]*f[7]*wx1*wx2+2.828427124746191*Bmag[0]*f[7]*wx1*wx2+2.828427124746191*f[0]*Bmag[2]*wx1*wx2+2.529822128134704*Bmag[1]*f[1]*wx1*wx2+0.5216405309573011*Bmag[2]*f[11]*dv1*wx2+0.816496580927726*Bmag[0]*f[11]*dv1*wx2+0.7302967433402218*Bmag[1]*f[4]*dv1*wx2+0.8164965809277261*Bmag[2]*f[2]*dv1*wx2+0.5216405309573011*Bmag[2]*f[13]*dv2*wx1+0.816496580927726*Bmag[0]*f[13]*dv2*wx1+0.7302967433402218*Bmag[1]*f[5]*dv2*wx1+0.8164965809277261*Bmag[2]*f[3]*dv2*wx1+0.1505846504842085*Bmag[2]*f[17]*dv1*dv2+0.2357022603955158*Bmag[0]*f[17]*dv1*dv2+0.210818510677892*Bmag[1]*f[10]*dv1*dv2+0.2357022603955158*Bmag[2]*f[6]*dv1*dv2))/m_; 
} 
__host__ __device__ void GkMomentCalc1x2vTensor_ThreeMoments_P1(const double *w, const double *dxv, const double m_, const double *Bmag, const double *f, double *outM0, double *outM1, double *outM2) 
{ 
  const double volFact = 2.0*M_PI/m_*dxv[1]*dxv[2]/4; 
  const double wx1 = w[1], dv1 = dxv[1]; 
  const double wx1_sq = wx1*wx1, dv1_sq = dv1*dv1; 
...
__host__ __device__ void GkMomentCalc1x2vTensor_ThreeMoments_P2(const double *w, const double *dxv, const double m_, const double *Bmag, const double *f, double *outM0, double *outM1, double *outM2) 
{ 
  const double volFact = 2.0*M_PI/m_*dxv[1]*dxv[2]/4; 
  const double wx1 = w[1], dv1 = dxv[1]; 
  const double wx1_sq = wx1*wx1, dv1_sq = dv1*dv1; 
...
__host__ __device__ void GkMomentCalc1x2vTensor_M0_step1_P1(const double *w, const double *dxv, const double m_, const double *Bmag, const double *f, double *out) 
{ 
...
__host__ __device__ void GkMomentCalc1x2vTensor_M0_step1_P2(const double *w, const double *dxv, const double m_, const double *Bmag, const double *f, double *out) 
{ 
  const double volFact = dxv[1]/2; 
  out[0] += 1.414213562373095*f[0]*volFact; 
  out[1] += 1.414213562373095*f[1]*volFact; 
...
__host__ __device__ void GkMomentCalc1x2vTensor_M0_step2_P1(const double *w, const double *dxv, const double m_, const double *Bmag, const double *f, double *out) 
{ 
  const double volFact = 2.0*M_PI/m_*dxv[2]/2; 
  out[0] += 2.828427124746191*f[0]*volFact; 
  out[1] += 2.828427124746191*f[1]*volFact; 
} 
__host__ __device__ void GkMomentCalc1x2vTensor_M0_step2_P2(const double *w, const double *dxv, const double m_, const double *Bmag, const double *f, double *out) 
{ 
  const double volFact = 2.0*M_PI/m_*dxv[2]/2; 
  out[0] += 2.828427124746191*f[0]*volFact; 
  out[1] += 2.828427124746191*f[1]*volFact; 
