...
{ 
  ...
  out[2] += volFact*(1.118033988749895*f[20]*vparLimLogicalR3+0.8660254037844387*f[11]*vparLimLogicalR2-1.118033988749895*f[20]*vparLimLogical+f[7]*vparLimLogical-0.8660254037844387*f[11]+f[7]); 
} 
...
{ 
  ...
  out[2] += volFact*((-1.118033988749895*f[20]*vparLimLogicalR3)-0.8660254037844387*f[11]*vparLimLogicalR2+1.118033988749895*f[20]*vparLimLogical-1.0*f[7]*vparLimLogical+0.8660254037844387*f[11]+f[7]); 
} 
