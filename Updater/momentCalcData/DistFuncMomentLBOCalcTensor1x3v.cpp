...
{ 
  ...
  if (atLower) {
    ...
    out[2] += ((-3.16227766016838*fIn[44])+2.449489742783178*fIn[19]-1.414213562373095*fIn[11])*dS; 
...
{ 
  ...
  if (atLower) {
    ...
    out[2] += ((-3.16227766016838*fIn[44])+2.449489742783178*fIn[19]-1.414213562373095*fIn[11])*dS*vBoundary; 
...
{ 
  ...
  if (atLower) {
    ...
    out[5] += ((-3.16227766016838*fIn[45])+2.449489742783178*fIn[21]-1.414213562373095*fIn[11])*dS; 
...
{ 
  ...
  if (atLower) {
    ...
    out[2] += ((-3.16227766016838*fIn[45])+2.449489742783178*fIn[21]-1.414213562373095*fIn[11])*dS*vBoundary; 
...
{ 
  ...
  if (atLower) {
    ...
    out[8] += ((-3.16227766016838*fIn[47])+2.449489742783178*fIn[25]-1.414213562373095*fIn[11])*dS; 
...
{ 
  ...
  if (atLower) {
    ...
    out[2] += ((-3.16227766016838*fIn[47])+2.449489742783178*fIn[25]-1.414213562373095*fIn[11])*dS*vBoundary; 
