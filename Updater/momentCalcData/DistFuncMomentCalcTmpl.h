...
template <>
class MomentModDecl<1,1,1,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc1x1vMax_M0_P1(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<1,1,2,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc1x1vMax_M0_P2(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<1,1,3,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc1x1vMax_M0_P3(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<1,2,1,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc1x2vMax_M0_P1(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<1,2,2,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc1x2vMax_M0_P2(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<1,2,3,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc1x2vMax_M0_P3(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<1,3,1,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc1x3vMax_M0_P1(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<1,3,2,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc1x3vMax_M0_P2(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<1,3,3,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc1x3vMax_M0_P3(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<2,2,1,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc2x2vMax_M0_P1(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<2,2,2,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc2x2vMax_M0_P2(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<2,2,3,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc2x2vMax_M0_P3(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<2,3,1,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc2x3vMax_M0_P1(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<2,3,2,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc2x3vMax_M0_P2(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<2,3,3,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc2x3vMax_M0_P3(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<3,3,1,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc3x3vMax_M0_P1(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<3,3,2,Gkyl::G_MAX_ORDER_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc3x3vMax_M0_P2(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<2,3,3,Gkyl::G_SERENDIPITY_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc2x3vSer_M0_P3(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
...
template <>
class MomentModDecl<3,3,2,Gkyl::G_SERENDIPITY_C> {
  public:
    __host__ __device__ static void calcM0(const double *w, const double *dxv, const double *f, double *out) {
      MomentCalc3x3vSer_M0_P2(w, dxv, f, out);
    }
    __host__ __device__ static void calcM1i(const double *w, const double *dxv, const double *f, double *out) {
