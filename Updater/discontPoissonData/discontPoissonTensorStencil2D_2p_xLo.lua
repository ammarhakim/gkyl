...
local function stencilFn(dx, a, b, val)
  ...
  _M[2][8][4] = 0.0
  _M[2][8][5] = 0.0
  _M[2][8][6] = -(1.0*(727.4613391789285*b+588.8972745734183*a))/(180.0*dx[1]^2*b-20.0*dx[1]^2*a)
  _M[2][8][7] = 0.0
  _M[2][8][8] = -(1.0*(2097.0*b-729.0*a))/(144.0*dx[1]^2*b-16.0*dx[1]^2*a)
  _M[2][8][9] = (848.1833528194243*b-4907.069899644797*a)/(720.0*dx[1]^2*b-80.0*dx[1]^2*a)
  _M[2][9][1] = 0.0
  _M[2][9][2] = 0.0
  _M[2][9][3] = 0.0
  _M[2][9][4] = 0.0
  ...
  _M[2][9][7] = 0.0
  _M[2][9][8] = -(1.0*(731.9938524332018*b+398.9172846593639*a))/(144.0*dx[1]^2*b-16.0*dx[1]^2*a)
  ...
  _M[3][6][9] = (965.9813662799093*b-261.6199533674754*a)/(360.0*dx[1]^2*b-40.0*dx[1]^2*a)
  _M[3][7][1] = 0.0
  _M[3][7][2] = 0.0
  ...
  _M[3][8][4] = 0.0
  _M[3][8][5] = 0.0
  _M[3][8][6] = (181.8653347947321*b+8.660254037844387*a)/(45.0*dx[1]^2*b-5.0*dx[1]^2*a)
  _M[3][8][7] = 0.0
  _M[3][8][8] = -(1.0*(687.0*b+57.0*a))/(144.0*dx[1]^2*b-16.0*dx[1]^2*a)
  _M[3][8][9] = (1591.796155291248*b+298.2197176579711*a)/(720.0*dx[1]^2*b-80.0*dx[1]^2*a)
  _M[3][9][1] = 0.0
  _M[3][9][2] = 0.0
  _M[3][9][3] = 0.0
  _M[3][9][4] = 0.0
  _M[3][9][5] = 0.0
  _M[3][9][6] = (80.49844718999243*b-20.12461179749811*a)/(18.0*dx[1]^2*b-2.0*dx[1]^2*a)
  _M[3][9][7] = 0.0
  _M[3][9][8] = -(1.0*(755.2317525104464*b-213.0140840414079*a))/(144.0*dx[1]^2*b-16.0*dx[1]^2*a)
  _M[3][9][9] = (333.0*b-129.0*a)/(144.0*dx[1]^2*b-16.0*dx[1]^2*a)
  return(_M)
end
