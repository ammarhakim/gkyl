...
local function stencilFn(dx, a, b, val)
  ...
  _M[1][6][9] = (214.6625258399798*b+78.26237921249266*a)/(80.0*dx[1]^2*b+8.0*dx[1]^2*a)
  _M[1][7][1] = 0.0
  _M[1][7][2] = 0.0
  ...
  _M[1][8][9] = -(1.0*(1378.78207124984*b-747.4857858180314*a))/(800.0*dx[1]^2*b+80.0*dx[1]^2*a)
  _M[1][9][1] = 0.0
  _M[1][9][2] = 0.0
  _M[1][9][3] = 0.0
  _M[1][9][4] = 0.0
  _M[1][9][5] = 0.0
  _M[1][9][6] = (234.787137637478*b+62.60990336999411*a)/(40.0*dx[1]^2*b+4.0*dx[1]^2*a)
  _M[1][9][7] = 0.0
  _M[1][9][8] = (1192.878870631884*b+352.441484504875*a)/(160.0*dx[1]^2*b+16.0*dx[1]^2*a)
  _M[1][9][9] = (672.0*b+245.0*a)/(160.0*dx[1]^2*b+16.0*dx[1]^2*a)
  _M[2] = Lin.Mat(9,9)
  ...
  _M[2][8][9] = -(1.0*(1874.52393956439*b+6440.771304742934*a))/(800.0*dx[1]^2*b+80.0*dx[1]^2*a)
  _M[2][9][1] = 0.0
  _M[2][9][2] = 0.0
  _M[2][9][3] = 0.0
  _M[2][9][4] = 0.0
  ...
  _M[2][9][7] = 0.0
  _M[2][9][8] = (1192.878870631884*b-352.441484504875*a)/(160.0*dx[1]^2*b+16.0*dx[1]^2*a)
