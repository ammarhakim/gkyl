...
{ 
  ...
  out[7] += 3.464101615137754*f[5]*w0dx0+0.8944271909999159*f[2]*dv0dx0; 
} 
...
{ 
  ...
  out[10] += 11.83215956619923*f[6]*w0dx0+5.291502622129181*f[2]*w0dx0+1.366260102127947*f[5]*dv0dx0+3.415650255319867*f[4]*dv0dx0+1.527525231651947*f[0]*dv0dx0; 
  out[11] += 3.464101615137754*f[9]*w0dx0+0.8783100656536796*f[5]*dv0dx0; 
} 
...
{ 
  ...
  out[15] += 15.87450786638754*f[11]*w0dx0+10.39230484541326*f[3]*w0dx0+4.58257569495584*f[8]*dv0dx0+2.683281572999748*f[7]*dv0dx0+3.0*f[1]*dv0dx0; 
  out[16] += 3.464101615137754*f[14]*w0dx0+0.8728715609439696*f[9]*dv0dx0; 
} 
