...
{ 
  ...
  out[12] += 3.464101615137754*f[8]*w0dx0+0.8783100656536796*f[18]*dv0dx0+0.8944271909999159*f[2]*dv0dx0; 
  out[13] += 7.745966692414834*f[5]*w0dx0+2.23606797749979*f[10]*dv0dx0; 
  out[15] += 3.464101615137754*f[9]*w0dx0+f[16]*dv0dx0; 
  out[17] += 11.83215956619923*f[7]*w0dx0+5.291502622129181*f[0]*w0dx0+3.415650255319867*f[11]*dv0dx0+1.527525231651947*f[2]*dv0dx0; 
} 
...
{ 
  ...
  out[21] += 3.464101615137754*f[14]*w0dx0+0.8783100656536796*f[29]*dv0dx0+0.8944271909999159*f[6]*dv0dx0; 
  out[22] += 3.464101615137754*f[16]*w0dx0+0.8944271909999159*f[25]*dv0dx0+f[9]*dv0dx0; 
  ...
  out[26] += 11.83215956619923*f[11]*w0dx0+5.291502622129181*f[2]*w0dx0+3.055050463303894*f[23]*dv0dx0+1.366260102127947*f[8]*dv0dx0+3.415650255319867*f[7]*dv0dx0+1.527525231651947*f[0]*dv0dx0; 
  out[27] += 3.464101615137754*f[18]*w0dx0+0.8728715609439696*f[33]*dv0dx0+0.8783100656536796*f[8]*dv0dx0; 
  out[28] += 11.83215956619923*f[13]*w0dx0+5.291502622129181*f[3]*w0dx0+3.415650255319867*f[20]*dv0dx0+1.527525231651947*f[6]*dv0dx0; 
