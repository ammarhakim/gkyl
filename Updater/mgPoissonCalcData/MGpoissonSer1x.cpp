...
{ 
  ...
  phiC[0] = -(1.0*(((69.28203230275508*rdxUx[0]-69.28203230275508*rdxLx[0])*rho[1]+((-184.0*rdxUx[0])-184.0*rdxLx[0])*rho[0])*omega*volFac+((69.28203230275508*rdxUxSq[0]+129.9038105676658*rdxLx[0]*rdxUx[0])*phiUx[1]+((-129.9038105676658*rdxLx[0]*rdxUx[0])-69.28203230275508*rdxLxSq[0])*phiLx[1]+(6.0*phiPrevC[0]-66.0*phiUx[0])*rdxUxSq[0]+((-141.0*phiUx[0])+402.0*phiPrevC[0]-141.0*phiLx[0])*rdxLx[0]*rdxUx[0]+(6.0*phiPrevC[0]-66.0*phiLx[0])*rdxLxSq[0])*omega-6.0*phiPrevC[0]*rdxUxSq[0]-402.0*phiPrevC[0]*rdxLx[0]*rdxUx[0]-6.0*phiPrevC[0]*rdxLxSq[0]))/(6.0*rdxUxSq[0]+402.0*rdxLx[0]*rdxUx[0]+6.0*rdxLxSq[0]); 
  phiC[1] = (((72.0*rdxUx[0]+72.0*rdxLx[0])*rho[1]+(180.1332839871632*rdxLx[0]-180.1332839871632*rdxUx[0])*rho[0])*omega*volFac+((66.0*rdxUxSq[0]-129.0*rdxLx[0]*rdxUx[0])*phiUx[1]+((-6.0*rdxUxSq[0])-402.0*rdxLx[0]*rdxUx[0]-6.0*rdxLxSq[0])*phiPrevC[1]+(66.0*rdxLxSq[0]-129.0*rdxLx[0]*rdxUx[0])*phiLx[1]-62.35382907247956*phiUx[0]*rdxUxSq[0]+(140.296115413079*phiUx[0]-140.296115413079*phiLx[0])*rdxLx[0]*rdxUx[0]+62.35382907247956*phiLx[0]*rdxLxSq[0])*omega+(6.0*rdxUxSq[0]+402.0*rdxLx[0]*rdxUx[0]+6.0*rdxLxSq[0])*phiPrevC[1])/(6.0*rdxUxSq[0]+402.0*rdxLx[0]*rdxUx[0]+6.0*rdxLxSq[0]); 
...
{ 
  ...
  phiC[0] = (8.951166964180246e-4*((324.0*rho[1]+692.8203230275509*rho[0])*omega*volFac+((441.6729559300637*phiUx[0]-1117.172770881926*phiPrevC[0]+955.3009996854395*bcVals[0])*rdxCp2[0]-360.0*rdxCp2[0]*phiUx[1])*omega+1117.172770881926*phiPrevC[0]*rdxCp2[0]))/rdxCp2[0]; 
  phiC[1] = (0.002685350089254074*((48.49742261192856*rho[1]+40.0*rho[0])*omega*volFac+((-95.26279441628824*rdxCp2[0]*phiUx[1])-372.3909236273086*rdxCp2[0]*phiPrevC[1]+(90.0*phiUx[0]-127.2792206135786*bcVals[0])*rdxCp2[0])*omega+372.3909236273086*rdxCp2[0]*phiPrevC[1]))/rdxCp2[0]; 
...
{ 
  ...
  phiC[0] = -(0.06415002990995844*((6.0*rho[1]-36.37306695894642*rho[0])*omega*volFac+(15.0*rdxCp2[0]*phiUx[1]+((-15.58845726811989*phiUx[0])+15.58845726811989*phiPrevC[0]+31.84336665618132*bcVals[0])*rdxCp2[0])*omega-15.58845726811989*phiPrevC[0]*rdxCp2[0]))/rdxCp2[0]; 
  phiC[1] = (0.1154700538379252*((3.464101615137754*rho[1]-5.0*rho[0])*omega*volFac+(7.071067811865476*bcVals[0]*rdxCp2[0]-8.660254037844386*rdxCp2[0]*phiPrevC[1])*omega+8.660254037844386*rdxCp2[0]*phiPrevC[1]))/rdxCp2[0]; 
...
{ 
  ...
  phiC[0] = -(8.951166964180246e-4*((324.0*rho[1]-692.8203230275509*rho[0])*omega*volFac+((-360.0*rdxCp2[0]*phiLx[1])-955.3009996854395*rdxCp2[0]*bcVals[1]+(1117.172770881926*phiPrevC[0]-441.6729559300637*phiLx[0])*rdxCp2[0])*omega-1117.172770881926*phiPrevC[0]*rdxCp2[0]))/rdxCp2[0]; 
  phiC[1] = (0.002685350089254074*((48.49742261192856*rho[1]-40.0*rho[0])*omega*volFac+((-372.3909236273086*rdxCp2[0]*phiPrevC[1])-95.26279441628824*rdxCp2[0]*phiLx[1]+127.2792206135786*rdxCp2[0]*bcVals[1]-90.0*phiLx[0]*rdxCp2[0])*omega+372.3909236273086*rdxCp2[0]*phiPrevC[1]))/rdxCp2[0]; 
...
{ 
  ...
  phiC[0] = (0.06415002990995844*((6.0*rho[1]+36.37306695894642*rho[0])*omega*volFac+(15.0*rdxCp2[0]*phiLx[1]+31.84336665618132*rdxCp2[0]*bcVals[1]+(15.58845726811989*phiLx[0]-15.58845726811989*phiPrevC[0])*rdxCp2[0])*omega+15.58845726811989*phiPrevC[0]*rdxCp2[0]))/rdxCp2[0]; 
  phiC[1] = (0.1154700538379252*((3.464101615137754*rho[1]+5.0*rho[0])*omega*volFac+(7.071067811865476*rdxCp2[0]*bcVals[1]-8.660254037844386*rdxCp2[0]*phiPrevC[1])*omega+8.660254037844386*rdxCp2[0]*phiPrevC[1]))/rdxCp2[0]; 
