...
-- planet dipole streghth
                     ...
                     Dy =   51.8e-9*Re^3
                     Dz = -716.8e-9*Re^3
                     local r1 = 0.5*Re -- zero B field when r < r1
...
-----------------------
function init(x, y, z)
   return common.mirdip_init5m(x, y, z, xmir, r1)
end

function setStaticField(x, y, z)
   local Exs, Eys, Ezs = 0, 0, 0
   local Bxs, Bys, Bzs = common.mirdip_staticB(x, y, z, xmir, r1)
...
-- distribution of grid size centered at x0
   ...
   field = Moments.Field {
      ...
      init = function (t, xn)
         ...
         local rho_e, rhovx_e, rhovy_e, rhovz_e, e_e,
               rho_i, rhovx_i, rhovy_i, rhovz_i, e_i,
               Ex, Ey, Ez, Bx, By, Bz, phiE, phiB = init(x, y, z, xmir)
