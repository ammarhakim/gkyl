...
__host__ __device__ double VlasovSurfElcMag2x3vSer_VX_P1_v1(const int stride_f, const int stride_em, const double* __restrict__ wl, const double* __restrict__ wr, const double* __restrict__ dxvl, const double* __restrict__ dxvr, const double amax, const double* __restrict__ EM, const double* __restrict__ fl, const double* __restrict__ fr, double *outl, double *outr) 
{ 
