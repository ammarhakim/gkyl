...
plasmaApp = Plasma.App {
   ...
   electron = Plasma.GkSpecies {
      ...
      diagnosticIntegratedMoments = {"intM0", "intM1", "intM2", "intKE", "intHE", "intL1"},
      diagnosticIntegratedBoundaryFluxMoments = {"intM0", "intM1", "intM2", "intHE", "intL1"},
   ...
   ion = Plasma.GkSpecies {
      ...
      randomseed = randomseed,
      bcx = {Plasma.GkSpecies.bcZeroFlux, Plasma.GkSpecies.bcZeroFlux},
      bcz = {Plasma.GkSpecies.bcAbsorb, Plasma.GkSpecies.bcAbsorb},
   },
