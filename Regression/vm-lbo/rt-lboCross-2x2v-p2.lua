...
plasmaApp = Plasma.App {
   ...
   tEnd         = 0.05/nuElcIon,          -- End time.
   nFrame       = 1,                     -- Number of output frames.
   lower        = {-LX/2.0, -LY/2.0},    -- Configuration space lower left.
   upper        = { LX/2.0,  LY/2.0},    -- Configuration space upper right.
   cells        = {8, 8},                -- Configuration space cells.
   basis        = "serendipity",         -- One of "serendipity" or "maximal-order".
   polyOrder    = 2,                     -- Polynomial order.
   timeStepper  = "rk3",                 -- One of "rk2" or "rk3".
   -- Boundary conditions for configuration space.
   periodicDirs = {1, 1},           -- Periodic directions.
   ...
   elc = Plasma.Species {
      ...
      init = Plasma.MaxwellianProjection{
         density = function (t, zn)
            local x, y, vx, vy = zn[1], zn[2], zn[3], zn[4]
            local xm = -0.125*LX
            if x>xm then
      ...
      diagnostics = { "M0", "M1i", "M2", "M3i", "uFlow", "vtSq", "intM0", "intM1i", "intM2Flow", "intM2Thermal", "intL2" },
