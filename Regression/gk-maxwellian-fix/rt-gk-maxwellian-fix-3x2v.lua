-- Gkyl ------------------------------------------------------------------------
--
-- Test for updater to fix GK maxwellian with iteration method, 3x2v.
--------------------------------------------------------------------------------
...
-- Phase space mesh.
local lower = {-0.50, -0.50, -0.50, -6.0*vt0, 0.0}
local upper = { 0.50,  0.50,  0.50,  6.0*vt0, mass*(6.0*(vt0)^2)/(2*B0)}
