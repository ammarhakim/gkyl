...
--
-- Emission BC test.
-- This tests the feedback BC option, and also the 1st moment
-- calculated only over the velocities directed in one direction.
--
----------------------------------------------------------------------
...
sim = Plasma.App {
   ...
   elc = Plasma.Species {
	 ...
	 return maxwellian(n_e, 0.0, vth_e, v)
      ...
      feedbackBC = true,
      evolveBC   = true,
      diagnostics = { "M0", "M1i", "M2", "M3i", "vtSq", "uFlow", "intM0", "intM1i", "intM2Flow", "intM2Thermal" },
   },
