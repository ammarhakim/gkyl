...
local m_n           = 10.0*m_i
local n_0           = 1.0e17
local n_e, n_i, n_n = n_0, n_0, n_0
local vd_e, vd_i    = 0.0, 0.0
local T_e, T_i      = 20*elemCharge, 20*elemCharge
...
sim = Plasma.App {
   ...
   tEnd        = 1/omega_pe,  --1000/omega_pe,    -- End time.
   ...
   elc = Plasma.Species {
      ...
      init = function (t, xn)
         local x, v = xn[1], xn[2]
         return maxwellian(n_e, 0, vth_e, v)
      end,
   ...
   neut = Plasma.Species {
      ...
      init = function (t, xn)
         local x, v = xn[1], xn[2]
         return maxwellian(n_n, 0, vth_i, v)
      end,
      diagnosticMoments = { "M0", "M1i", "M2" },
      diagnosticIntegratedMoments = {"intM0", "intM1i",
      				     "intM2Flow", "intM2Thermal" },
