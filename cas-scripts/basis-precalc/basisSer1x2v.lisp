...
(DSKSETQ |$basisP|
         '((MLIST SIMP
           ...
           ((MLIST SIMP
              ...
              ((MTIMES SIMP) $VX
               ((MEXPT SIMP
                 (62. "/Users/JunoRavin/gkyl/cas-scripts/modal-basis.mac" SRC
                  |$calcPowers| 62.))
                $VY 6.))))
            ((MTIMES SIMP) 693. ((MEXPT SIMP) 2. ((RAT SIMP) -11. 2.))
             ((MEXPT SIMP) 13. ((RAT SIMP) 1. 2.))
             ((MPLUS SIMP) ((MTIMES SIMP) ((RAT SIMP) -1. 7.) $VX $VY)
              ((MTIMES SIMP) ((RAT SIMP) -5. 7.)
               ((MPLUS SIMP) ((MTIMES SIMP) ((RAT SIMP) -1. 3.) $VX $VY)
                ((MTIMES SIMP) $VX $VY
                 ((MEXPT SIMP
            ...
            ((MTIMES SIMP) 693. ((MEXPT SIMP) 2. ((RAT SIMP) -11. 2.))
             ((MEXPT SIMP) 13. ((RAT SIMP) 1. 2.))
             ((MPLUS SIMP) ((MTIMES SIMP) ((RAT SIMP) -1. 7.) $VY $X)
              ((MTIMES SIMP)
               ((MEXPT SIMP
                 (62. "/Users/JunoRavin/gkyl/cas-scripts/modal-basis.mac" SRC
                  |$calcPowers| 62.))
            ...
            ((MTIMES SIMP) 693. ((MEXPT SIMP) 2. ((RAT SIMP) -11. 2.))
             ((MEXPT SIMP) 13. ((RAT SIMP) 1. 2.))
             ((MPLUS SIMP) ((MTIMES SIMP) ((RAT SIMP) -1. 7.) $VX $X)
              ((MTIMES SIMP) $VX
               ((MEXPT SIMP
                 (62. "/Users/JunoRavin/gkyl/cas-scripts/modal-basis.mac" SRC
                  |$calcPowers| 62.))
